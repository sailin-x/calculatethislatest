import { financial_agility_calculatorInputs } from './types';

export function validateInputs(inputs: financial_agility_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
