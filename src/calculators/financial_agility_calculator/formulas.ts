import { financial_agility_calculatorInputs, financial_agility_calculatorMetrics, financial_agility_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_agility_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_agility_calculatorInputs, metrics: financial_agility_calculatorMetrics): financial_agility_calculatorAnalysis {
