import { registerGPUMiningProfitabilityCalculatorInputs } from './types';

export function validateInputs(inputs: registerGPUMiningProfitabilityCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
