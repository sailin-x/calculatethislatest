import { registerGpuMiningProfitabilityCalculatorInputs, registerGpuMiningProfitabilityCalculatorMetrics, registerGpuMiningProfitabilityCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerGpuMiningProfitabilityCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerGpuMiningProfitabilityCalculatorInputs, metrics: registerGpuMiningProfitabilityCalculatorMetrics): registerGpuMiningProfitabilityCalculatorAnalysis {
