import { financial_performance_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: financial_performance_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
