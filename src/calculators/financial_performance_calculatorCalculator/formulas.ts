import { financial_performance_calculatorCalculatorInputs, financial_performance_calculatorCalculatorMetrics, financial_performance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_performance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_performance_calculatorCalculatorInputs, metrics: financial_performance_calculatorCalculatorMetrics): financial_performance_calculatorCalculatorAnalysis {
