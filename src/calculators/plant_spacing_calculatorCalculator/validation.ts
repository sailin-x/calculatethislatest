import { plant_spacing_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: plant_spacing_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
