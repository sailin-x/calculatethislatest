import { plant_spacing_calculatorCalculatorInputs, plant_spacing_calculatorCalculatorMetrics, plant_spacing_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: plant_spacing_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: plant_spacing_calculatorCalculatorInputs, metrics: plant_spacing_calculatorCalculatorMetrics): plant_spacing_calculatorCalculatorAnalysis {
