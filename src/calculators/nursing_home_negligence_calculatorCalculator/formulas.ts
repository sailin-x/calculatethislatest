import { nursing_home_negligence_calculatorCalculatorInputs, nursing_home_negligence_calculatorCalculatorMetrics, nursing_home_negligence_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: nursing_home_negligence_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: nursing_home_negligence_calculatorCalculatorInputs, metrics: nursing_home_negligence_calculatorCalculatorMetrics): nursing_home_negligence_calculatorCalculatorAnalysis {
