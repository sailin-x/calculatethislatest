import { cost_of_poor_quality_copq_calculatorCalculatorInputs, cost_of_poor_quality_copq_calculatorCalculatorMetrics, cost_of_poor_quality_copq_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cost_of_poor_quality_copq_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cost_of_poor_quality_copq_calculatorCalculatorInputs, metrics: cost_of_poor_quality_copq_calculatorCalculatorMetrics): cost_of_poor_quality_copq_calculatorCalculatorAnalysis {
