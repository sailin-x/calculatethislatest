import { skydiving_cost_calculatorCalculatorInputs, skydiving_cost_calculatorCalculatorMetrics, skydiving_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: skydiving_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: skydiving_cost_calculatorCalculatorInputs, metrics: skydiving_cost_calculatorCalculatorMetrics): skydiving_cost_calculatorCalculatorAnalysis {
