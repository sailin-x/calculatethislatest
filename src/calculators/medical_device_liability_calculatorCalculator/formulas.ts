import { medical_device_liability_calculatorCalculatorInputs, medical_device_liability_calculatorCalculatorMetrics, medical_device_liability_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: medical_device_liability_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: medical_device_liability_calculatorCalculatorInputs, metrics: medical_device_liability_calculatorCalculatorMetrics): medical_device_liability_calculatorCalculatorAnalysis {
