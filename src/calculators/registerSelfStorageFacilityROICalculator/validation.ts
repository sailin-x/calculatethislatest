import { registerSelfStorageFacilityROICalculatorInputs } from './types';

export function validateInputs(inputs: registerSelfStorageFacilityROICalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
