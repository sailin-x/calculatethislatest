import { registerSelfStorageFacilityROICalculatorInputs, registerSelfStorageFacilityROICalculatorMetrics, registerSelfStorageFacilityROICalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerSelfStorageFacilityROICalculatorInputs): number {
...
export function generateAnalysis(inputs: registerSelfStorageFacilityROICalculatorInputs, metrics: registerSelfStorageFacilityROICalculatorMetrics): registerSelfStorageFacilityROICalculatorAnalysis {
