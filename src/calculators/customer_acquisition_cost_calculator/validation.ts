import { customer_acquisition_cost_calculatorInputs } from './types';

export function validateInputs(inputs: customer_acquisition_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
