import { marine_cargo_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: marine_cargo_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
