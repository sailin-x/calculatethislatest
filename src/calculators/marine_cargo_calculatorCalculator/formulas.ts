import { marine_cargo_calculatorCalculatorInputs, marine_cargo_calculatorCalculatorMetrics, marine_cargo_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: marine_cargo_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: marine_cargo_calculatorCalculatorInputs, metrics: marine_cargo_calculatorCalculatorMetrics): marine_cargo_calculatorCalculatorAnalysis {
