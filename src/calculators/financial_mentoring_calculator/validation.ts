import { financial_mentoring_calculatorInputs } from './types';

export function validateInputs(inputs: financial_mentoring_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
