import { financial_mentoring_calculatorInputs, financial_mentoring_calculatorMetrics, financial_mentoring_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_mentoring_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_mentoring_calculatorInputs, metrics: financial_mentoring_calculatorMetrics): financial_mentoring_calculatorAnalysis {
