import { flexible_spending_account_calculatorInputs } from './types';

export function validateInputs(inputs: flexible_spending_account_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
