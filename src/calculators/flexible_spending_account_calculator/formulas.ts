import { flexible_spending_account_calculatorInputs, flexible_spending_account_calculatorMetrics, flexible_spending_account_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: flexible_spending_account_calculatorInputs): number {
...
export function generateAnalysis(inputs: flexible_spending_account_calculatorInputs, metrics: flexible_spending_account_calculatorMetrics): flexible_spending_account_calculatorAnalysis {
