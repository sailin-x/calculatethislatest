import { matrix_calculatorCalculatorInputs, matrix_calculatorCalculatorMetrics, matrix_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: matrix_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: matrix_calculatorCalculatorInputs, metrics: matrix_calculatorCalculatorMetrics): matrix_calculatorCalculatorAnalysis {
