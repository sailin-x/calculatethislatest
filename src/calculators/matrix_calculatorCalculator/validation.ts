import { matrix_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: matrix_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
