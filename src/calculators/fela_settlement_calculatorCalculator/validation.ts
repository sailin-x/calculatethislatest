import { fela_settlement_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: fela_settlement_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
