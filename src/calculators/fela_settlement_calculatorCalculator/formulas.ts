import { fela_settlement_calculatorCalculatorInputs, fela_settlement_calculatorCalculatorMetrics, fela_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fela_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: fela_settlement_calculatorCalculatorInputs, metrics: fela_settlement_calculatorCalculatorMetrics): fela_settlement_calculatorCalculatorAnalysis {
