import { calorie_calculatorCalculatorInputs, calorie_calculatorCalculatorMetrics, calorie_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: calorie_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: calorie_calculatorCalculatorInputs, metrics: calorie_calculatorCalculatorMetrics): calorie_calculatorCalculatorAnalysis {
