import { calorie_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: calorie_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
