import { ad_reach_and_frequency_calculatorCalculatorInputs, ad_reach_and_frequency_calculatorCalculatorMetrics, ad_reach_and_frequency_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: ad_reach_and_frequency_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: ad_reach_and_frequency_calculatorCalculatorInputs, metrics: ad_reach_and_frequency_calculatorCalculatorMetrics): ad_reach_and_frequency_calculatorCalculatorAnalysis {
