import { ad_reach_and_frequency_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: ad_reach_and_frequency_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
