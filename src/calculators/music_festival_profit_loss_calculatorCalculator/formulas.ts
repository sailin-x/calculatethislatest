import { music_festival_profit_loss_calculatorCalculatorInputs, music_festival_profit_loss_calculatorCalculatorMetrics, music_festival_profit_loss_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: music_festival_profit_loss_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: music_festival_profit_loss_calculatorCalculatorInputs, metrics: music_festival_profit_loss_calculatorCalculatorMetrics): music_festival_profit_loss_calculatorCalculatorAnalysis {
