import { price_fixing_overcharge_estimatorCalculatorInputs } from './types';

export function validateInputs(inputs: price_fixing_overcharge_estimatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
