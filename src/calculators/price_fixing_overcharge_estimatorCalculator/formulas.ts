import { price_fixing_overcharge_estimatorCalculatorInputs, price_fixing_overcharge_estimatorCalculatorMetrics, price_fixing_overcharge_estimatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: price_fixing_overcharge_estimatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: price_fixing_overcharge_estimatorCalculatorInputs, metrics: price_fixing_overcharge_estimatorCalculatorMetrics): price_fixing_overcharge_estimatorCalculatorAnalysis {
