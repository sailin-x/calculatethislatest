import { medical_malpractice_settlement_calculatorCalculatorInputs, medical_malpractice_settlement_calculatorCalculatorMetrics, medical_malpractice_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: medical_malpractice_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: medical_malpractice_settlement_calculatorCalculatorInputs, metrics: medical_malpractice_settlement_calculatorCalculatorMetrics): medical_malpractice_settlement_calculatorCalculatorAnalysis {
