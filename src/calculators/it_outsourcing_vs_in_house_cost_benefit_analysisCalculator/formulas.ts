import { it_outsourcing_vs_in_house_cost_benefit_analysisCalculatorInputs, it_outsourcing_vs_in_house_cost_benefit_analysisCalculatorMetrics, it_outsourcing_vs_in_house_cost_benefit_analysisCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: it_outsourcing_vs_in_house_cost_benefit_analysisCalculatorInputs): number {
...
export function generateAnalysis(inputs: it_outsourcing_vs_in_house_cost_benefit_analysisCalculatorInputs, metrics: it_outsourcing_vs_in_house_cost_benefit_analysisCalculatorMetrics): it_outsourcing_vs_in_house_cost_benefit_analysisCalculatorAnalysis {
