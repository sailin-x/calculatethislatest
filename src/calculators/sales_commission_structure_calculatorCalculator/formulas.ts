import { sales_commission_structure_calculatorCalculatorInputs, sales_commission_structure_calculatorCalculatorMetrics, sales_commission_structure_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: sales_commission_structure_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: sales_commission_structure_calculatorCalculatorInputs, metrics: sales_commission_structure_calculatorCalculatorMetrics): sales_commission_structure_calculatorCalculatorAnalysis {
