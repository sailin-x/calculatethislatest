import { cd_interest_calculatorInputs, cd_interest_calculatorMetrics, cd_interest_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cd_interest_calculatorInputs): number {
...
export function generateAnalysis(inputs: cd_interest_calculatorInputs, metrics: cd_interest_calculatorMetrics): cd_interest_calculatorAnalysis {
