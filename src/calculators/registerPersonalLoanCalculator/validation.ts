import { registerPersonalLoanCalculatorInputs } from './types';

export function validateInputs(inputs: registerPersonalLoanCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
