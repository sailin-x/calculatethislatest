import { registerPersonalLoanCalculatorInputs, registerPersonalLoanCalculatorMetrics, registerPersonalLoanCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerPersonalLoanCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerPersonalLoanCalculatorInputs, metrics: registerPersonalLoanCalculatorMetrics): registerPersonalLoanCalculatorAnalysis {
