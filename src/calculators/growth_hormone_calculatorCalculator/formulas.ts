import { growth_hormone_calculatorCalculatorInputs, growth_hormone_calculatorCalculatorMetrics, growth_hormone_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: growth_hormone_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: growth_hormone_calculatorCalculatorInputs, metrics: growth_hormone_calculatorCalculatorMetrics): growth_hormone_calculatorCalculatorAnalysis {
