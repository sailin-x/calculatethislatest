import { growth_hormone_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: growth_hormone_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
