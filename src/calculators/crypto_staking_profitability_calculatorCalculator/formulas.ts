import { crypto_staking_profitability_calculatorCalculatorInputs, crypto_staking_profitability_calculatorCalculatorMetrics, crypto_staking_profitability_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: crypto_staking_profitability_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: crypto_staking_profitability_calculatorCalculatorInputs, metrics: crypto_staking_profitability_calculatorCalculatorMetrics): crypto_staking_profitability_calculatorCalculatorAnalysis {
