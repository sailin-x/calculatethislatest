import { human_capital_due_diligence_calculatorInputs } from './types';

export function validateInputs(inputs: human_capital_due_diligence_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
