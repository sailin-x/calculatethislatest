import { human_capital_due_diligence_calculatorInputs, human_capital_due_diligence_calculatorMetrics, human_capital_due_diligence_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: human_capital_due_diligence_calculatorInputs): number {
...
export function generateAnalysis(inputs: human_capital_due_diligence_calculatorInputs, metrics: human_capital_due_diligence_calculatorMetrics): human_capital_due_diligence_calculatorAnalysis {
