import { line_of_credit_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: line_of_credit_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
