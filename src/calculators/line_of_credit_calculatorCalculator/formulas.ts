import { line_of_credit_calculatorCalculatorInputs, line_of_credit_calculatorCalculatorMetrics, line_of_credit_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: line_of_credit_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: line_of_credit_calculatorCalculatorInputs, metrics: line_of_credit_calculatorCalculatorMetrics): line_of_credit_calculatorCalculatorAnalysis {
