import { defective_drug_settlement_calculatorCalculatorInputs, defective_drug_settlement_calculatorCalculatorMetrics, defective_drug_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: defective_drug_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: defective_drug_settlement_calculatorCalculatorInputs, metrics: defective_drug_settlement_calculatorCalculatorMetrics): defective_drug_settlement_calculatorCalculatorAnalysis {
