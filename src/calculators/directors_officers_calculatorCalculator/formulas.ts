import { directors_officers_calculatorCalculatorInputs, directors_officers_calculatorCalculatorMetrics, directors_officers_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: directors_officers_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: directors_officers_calculatorCalculatorInputs, metrics: directors_officers_calculatorCalculatorMetrics): directors_officers_calculatorCalculatorAnalysis {
