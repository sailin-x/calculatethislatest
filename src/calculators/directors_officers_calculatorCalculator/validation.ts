import { directors_officers_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: directors_officers_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
