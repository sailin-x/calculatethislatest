import { cohort_analysis_calculatorCalculatorInputs, cohort_analysis_calculatorCalculatorMetrics, cohort_analysis_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cohort_analysis_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cohort_analysis_calculatorCalculatorInputs, metrics: cohort_analysis_calculatorCalculatorMetrics): cohort_analysis_calculatorCalculatorAnalysis {
