import { kidnap_ransom_insurance_calculatorCalculatorInputs, kidnap_ransom_insurance_calculatorCalculatorMetrics, kidnap_ransom_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: kidnap_ransom_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: kidnap_ransom_insurance_calculatorCalculatorInputs, metrics: kidnap_ransom_insurance_calculatorCalculatorMetrics): kidnap_ransom_insurance_calculatorCalculatorAnalysis {
