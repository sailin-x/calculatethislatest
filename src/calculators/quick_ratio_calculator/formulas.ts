import { quick_ratio_calculatorInputs, quick_ratio_calculatorMetrics, quick_ratio_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: quick_ratio_calculatorInputs): number {
...
export function generateAnalysis(inputs: quick_ratio_calculatorInputs, metrics: quick_ratio_calculatorMetrics): quick_ratio_calculatorAnalysis {
