import { price_per_square_footCalculatorInputs, price_per_square_footCalculatorMetrics, price_per_square_footCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: price_per_square_footCalculatorInputs): number {
...
export function generateAnalysis(inputs: price_per_square_footCalculatorInputs, metrics: price_per_square_footCalculatorMetrics): price_per_square_footCalculatorAnalysis {
