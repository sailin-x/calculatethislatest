import { price_per_square_footCalculatorInputs } from './types';

export function validateInputs(inputs: price_per_square_footCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
