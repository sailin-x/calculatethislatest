import { appliance_repair_cost_calculatorCalculatorInputs, appliance_repair_cost_calculatorCalculatorMetrics, appliance_repair_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: appliance_repair_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: appliance_repair_cost_calculatorCalculatorInputs, metrics: appliance_repair_cost_calculatorCalculatorMetrics): appliance_repair_cost_calculatorCalculatorAnalysis {
