import { health_insurance_calculatorInputs, health_insurance_calculatorMetrics, health_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: health_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: health_insurance_calculatorInputs, metrics: health_insurance_calculatorMetrics): health_insurance_calculatorAnalysis {
