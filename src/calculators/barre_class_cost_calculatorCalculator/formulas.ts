import { barre_class_cost_calculatorCalculatorInputs, barre_class_cost_calculatorCalculatorMetrics, barre_class_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: barre_class_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: barre_class_cost_calculatorCalculatorInputs, metrics: barre_class_cost_calculatorCalculatorMetrics): barre_class_cost_calculatorCalculatorAnalysis {
