import { kidnap_ransom_insurance_calculatorInputs, kidnap_ransom_insurance_calculatorMetrics, kidnap_ransom_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: kidnap_ransom_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: kidnap_ransom_insurance_calculatorInputs, metrics: kidnap_ransom_insurance_calculatorMetrics): kidnap_ransom_insurance_calculatorAnalysis {
