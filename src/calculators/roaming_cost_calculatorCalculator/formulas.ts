import { roaming_cost_calculatorCalculatorInputs, roaming_cost_calculatorCalculatorMetrics, roaming_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: roaming_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: roaming_cost_calculatorCalculatorInputs, metrics: roaming_cost_calculatorCalculatorMetrics): roaming_cost_calculatorCalculatorAnalysis {
