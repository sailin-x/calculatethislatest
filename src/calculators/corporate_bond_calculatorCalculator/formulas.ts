import { corporate_bond_calculatorCalculatorInputs, corporate_bond_calculatorCalculatorMetrics, corporate_bond_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: corporate_bond_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: corporate_bond_calculatorCalculatorInputs, metrics: corporate_bond_calculatorCalculatorMetrics): corporate_bond_calculatorCalculatorAnalysis {
