import { corporate_bond_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: corporate_bond_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
