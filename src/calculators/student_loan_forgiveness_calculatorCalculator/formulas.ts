import { student_loan_forgiveness_calculatorCalculatorInputs, student_loan_forgiveness_calculatorCalculatorMetrics, student_loan_forgiveness_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: student_loan_forgiveness_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: student_loan_forgiveness_calculatorCalculatorInputs, metrics: student_loan_forgiveness_calculatorCalculatorMetrics): student_loan_forgiveness_calculatorCalculatorAnalysis {
