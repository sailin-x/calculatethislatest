import { golf_lesson_cost_calculatorCalculatorInputs, golf_lesson_cost_calculatorCalculatorMetrics, golf_lesson_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: golf_lesson_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: golf_lesson_cost_calculatorCalculatorInputs, metrics: golf_lesson_cost_calculatorCalculatorMetrics): golf_lesson_cost_calculatorCalculatorAnalysis {
