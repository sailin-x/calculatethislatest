import { government_contract_bid_calculatorInputs, government_contract_bid_calculatorMetrics, government_contract_bid_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: government_contract_bid_calculatorInputs): number {
...
export function generateAnalysis(inputs: government_contract_bid_calculatorInputs, metrics: government_contract_bid_calculatorMetrics): government_contract_bid_calculatorAnalysis {
