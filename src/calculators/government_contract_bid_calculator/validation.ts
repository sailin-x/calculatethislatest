import { government_contract_bid_calculatorInputs } from './types';

export function validateInputs(inputs: government_contract_bid_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
