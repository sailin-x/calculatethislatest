import { debt_management_calculatorInputs } from './types';

export function validateInputs(inputs: debt_management_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
