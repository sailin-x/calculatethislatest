import { debt_management_calculatorInputs, debt_management_calculatorMetrics, debt_management_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_management_calculatorInputs): number {
...
export function generateAnalysis(inputs: debt_management_calculatorInputs, metrics: debt_management_calculatorMetrics): debt_management_calculatorAnalysis {
