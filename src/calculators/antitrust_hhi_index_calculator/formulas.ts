import { antitrust_hhi_index_calculatorInputs, antitrust_hhi_index_calculatorMetrics, antitrust_hhi_index_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: antitrust_hhi_index_calculatorInputs): number {
...
export function generateAnalysis(inputs: antitrust_hhi_index_calculatorInputs, metrics: antitrust_hhi_index_calculatorMetrics): antitrust_hhi_index_calculatorAnalysis {
