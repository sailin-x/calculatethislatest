import { free_cash_flow_to_firm_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: free_cash_flow_to_firm_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
