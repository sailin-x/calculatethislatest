import { free_cash_flow_to_firm_calculatorCalculatorInputs, free_cash_flow_to_firm_calculatorCalculatorMetrics, free_cash_flow_to_firm_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: free_cash_flow_to_firm_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: free_cash_flow_to_firm_calculatorCalculatorInputs, metrics: free_cash_flow_to_firm_calculatorCalculatorMetrics): free_cash_flow_to_firm_calculatorCalculatorAnalysis {
