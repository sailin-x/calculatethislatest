import { sleep_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: sleep_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
