import { sleep_calculatorCalculatorInputs, sleep_calculatorCalculatorMetrics, sleep_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: sleep_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: sleep_calculatorCalculatorInputs, metrics: sleep_calculatorCalculatorMetrics): sleep_calculatorCalculatorAnalysis {
