import { debt_management_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: debt_management_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
