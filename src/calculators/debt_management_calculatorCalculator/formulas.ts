import { debt_management_calculatorCalculatorInputs, debt_management_calculatorCalculatorMetrics, debt_management_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_management_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: debt_management_calculatorCalculatorInputs, metrics: debt_management_calculatorCalculatorMetrics): debt_management_calculatorCalculatorAnalysis {
