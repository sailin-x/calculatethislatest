import { conservation_easement_tax_benefitCalculatorInputs, conservation_easement_tax_benefitCalculatorMetrics, conservation_easement_tax_benefitCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: conservation_easement_tax_benefitCalculatorInputs): number {
...
export function generateAnalysis(inputs: conservation_easement_tax_benefitCalculatorInputs, metrics: conservation_easement_tax_benefitCalculatorMetrics): conservation_easement_tax_benefitCalculatorAnalysis {
