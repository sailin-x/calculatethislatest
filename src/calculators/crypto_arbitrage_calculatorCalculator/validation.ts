import { crypto_arbitrage_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: crypto_arbitrage_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
