import { crypto_arbitrage_calculatorCalculatorInputs, crypto_arbitrage_calculatorCalculatorMetrics, crypto_arbitrage_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: crypto_arbitrage_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: crypto_arbitrage_calculatorCalculatorInputs, metrics: crypto_arbitrage_calculatorCalculatorMetrics): crypto_arbitrage_calculatorCalculatorAnalysis {
