import { aptValueCalculatorInputs, aptValueCalculatorMetrics, aptValueCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: aptValueCalculatorInputs): number {
...
export function generateAnalysis(inputs: aptValueCalculatorInputs, metrics: aptValueCalculatorMetrics): aptValueCalculatorAnalysis {
