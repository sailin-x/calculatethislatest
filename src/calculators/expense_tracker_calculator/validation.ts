import { expense_tracker_calculatorInputs } from './types';

export function validateInputs(inputs: expense_tracker_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
