import { expense_tracker_calculatorInputs, expense_tracker_calculatorMetrics, expense_tracker_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: expense_tracker_calculatorInputs): number {
...
export function generateAnalysis(inputs: expense_tracker_calculatorInputs, metrics: expense_tracker_calculatorMetrics): expense_tracker_calculatorAnalysis {
