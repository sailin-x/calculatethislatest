import { sharpe_ratio_calculatorCalculatorInputs, sharpe_ratio_calculatorCalculatorMetrics, sharpe_ratio_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: sharpe_ratio_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: sharpe_ratio_calculatorCalculatorInputs, metrics: sharpe_ratio_calculatorCalculatorMetrics): sharpe_ratio_calculatorCalculatorAnalysis {
