import { foundation_repair_cost_calculatorInputs, foundation_repair_cost_calculatorMetrics, foundation_repair_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: foundation_repair_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: foundation_repair_cost_calculatorInputs, metrics: foundation_repair_cost_calculatorMetrics): foundation_repair_cost_calculatorAnalysis {
