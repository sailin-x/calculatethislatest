import { foundation_repair_cost_calculatorInputs } from './types';

export function validateInputs(inputs: foundation_repair_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
