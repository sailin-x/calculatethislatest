import { self_storage_roiCalculatorInputs } from './types';

export function validateInputs(inputs: self_storage_roiCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
