import { self_storage_roiCalculatorInputs, self_storage_roiCalculatorMetrics, self_storage_roiCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: self_storage_roiCalculatorInputs): number {
...
export function generateAnalysis(inputs: self_storage_roiCalculatorInputs, metrics: self_storage_roiCalculatorMetrics): self_storage_roiCalculatorAnalysis {
