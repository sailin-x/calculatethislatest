import { flooring_calculatorInputs, flooring_calculatorMetrics, flooring_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: flooring_calculatorInputs): number {
...
export function generateAnalysis(inputs: flooring_calculatorInputs, metrics: flooring_calculatorMetrics): flooring_calculatorAnalysis {
