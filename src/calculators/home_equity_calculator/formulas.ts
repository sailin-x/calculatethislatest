import { home_equity_calculatorInputs, home_equity_calculatorMetrics, home_equity_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: home_equity_calculatorInputs): number {
...
export function generateAnalysis(inputs: home_equity_calculatorInputs, metrics: home_equity_calculatorMetrics): home_equity_calculatorAnalysis {
