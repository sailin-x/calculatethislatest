import { intellectual_property_calculatorInputs, intellectual_property_calculatorMetrics, intellectual_property_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: intellectual_property_calculatorInputs): number {
...
export function generateAnalysis(inputs: intellectual_property_calculatorInputs, metrics: intellectual_property_calculatorMetrics): intellectual_property_calculatorAnalysis {
