import { staking_rewards_calculatorCalculatorInputs, staking_rewards_calculatorCalculatorMetrics, staking_rewards_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: staking_rewards_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: staking_rewards_calculatorCalculatorInputs, metrics: staking_rewards_calculatorCalculatorMetrics): staking_rewards_calculatorCalculatorAnalysis {
