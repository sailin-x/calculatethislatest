import { staking_rewards_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: staking_rewards_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
