import { business_valuation_calculatorInputs, business_valuation_calculatorMetrics, business_valuation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_valuation_calculatorInputs): number {
...
export function generateAnalysis(inputs: business_valuation_calculatorInputs, metrics: business_valuation_calculatorMetrics): business_valuation_calculatorAnalysis {
