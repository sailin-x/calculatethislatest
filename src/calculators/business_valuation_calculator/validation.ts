import { business_valuation_calculatorInputs } from './types';

export function validateInputs(inputs: business_valuation_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
