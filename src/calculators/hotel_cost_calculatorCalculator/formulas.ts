import { hotel_cost_calculatorCalculatorInputs, hotel_cost_calculatorCalculatorMetrics, hotel_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hotel_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: hotel_cost_calculatorCalculatorInputs, metrics: hotel_cost_calculatorCalculatorMetrics): hotel_cost_calculatorCalculatorAnalysis {
