import { financial_transformation_calculatorInputs } from './types';

export function validateInputs(inputs: financial_transformation_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
