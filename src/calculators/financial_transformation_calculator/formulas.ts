import { financial_transformation_calculatorInputs, financial_transformation_calculatorMetrics, financial_transformation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_transformation_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_transformation_calculatorInputs, metrics: financial_transformation_calculatorMetrics): financial_transformation_calculatorAnalysis {
