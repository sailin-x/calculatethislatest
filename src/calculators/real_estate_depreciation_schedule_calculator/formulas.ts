import { real_estate_depreciation_schedule_calculatorInputs, real_estate_depreciation_schedule_calculatorMetrics, real_estate_depreciation_schedule_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: real_estate_depreciation_schedule_calculatorInputs): number {
...
export function generateAnalysis(inputs: real_estate_depreciation_schedule_calculatorInputs, metrics: real_estate_depreciation_schedule_calculatorMetrics): real_estate_depreciation_schedule_calculatorAnalysis {
