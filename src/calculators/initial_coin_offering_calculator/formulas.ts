import { initial_coin_offering_calculatorInputs, initial_coin_offering_calculatorMetrics, initial_coin_offering_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: initial_coin_offering_calculatorInputs): number {
...
export function generateAnalysis(inputs: initial_coin_offering_calculatorInputs, metrics: initial_coin_offering_calculatorMetrics): initial_coin_offering_calculatorAnalysis {
