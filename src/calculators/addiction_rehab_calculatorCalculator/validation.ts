import { addiction_rehab_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: addiction_rehab_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
