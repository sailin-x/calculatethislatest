import { addiction_rehab_calculatorCalculatorInputs, addiction_rehab_calculatorCalculatorMetrics, addiction_rehab_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: addiction_rehab_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: addiction_rehab_calculatorCalculatorInputs, metrics: addiction_rehab_calculatorCalculatorMetrics): addiction_rehab_calculatorCalculatorAnalysis {
