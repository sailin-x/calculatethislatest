import { business_process_re_engineering_calculatorCalculatorInputs, business_process_re_engineering_calculatorCalculatorMetrics, business_process_re_engineering_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_process_re_engineering_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: business_process_re_engineering_calculatorCalculatorInputs, metrics: business_process_re_engineering_calculatorCalculatorMetrics): business_process_re_engineering_calculatorCalculatorAnalysis {
