import { investment_calculatorInputs, investment_calculatorMetrics, investment_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: investment_calculatorInputs): number {
...
export function generateAnalysis(inputs: investment_calculatorInputs, metrics: investment_calculatorMetrics): investment_calculatorAnalysis {
