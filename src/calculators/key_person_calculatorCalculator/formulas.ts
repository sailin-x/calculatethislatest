import { key_person_calculatorCalculatorInputs, key_person_calculatorCalculatorMetrics, key_person_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: key_person_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: key_person_calculatorCalculatorInputs, metrics: key_person_calculatorCalculatorMetrics): key_person_calculatorCalculatorAnalysis {
