import { registerEstatePlanningCalculatorInputs } from './types';

export function validateInputs(inputs: registerEstatePlanningCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
