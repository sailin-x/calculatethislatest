import { registerEstatePlanningCalculatorInputs, registerEstatePlanningCalculatorMetrics, registerEstatePlanningCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerEstatePlanningCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerEstatePlanningCalculatorInputs, metrics: registerEstatePlanningCalculatorMetrics): registerEstatePlanningCalculatorAnalysis {
