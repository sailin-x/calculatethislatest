import { cam_girl_revenue_calculatorCalculatorInputs, cam_girl_revenue_calculatorCalculatorMetrics, cam_girl_revenue_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cam_girl_revenue_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cam_girl_revenue_calculatorCalculatorInputs, metrics: cam_girl_revenue_calculatorCalculatorMetrics): cam_girl_revenue_calculatorCalculatorAnalysis {
