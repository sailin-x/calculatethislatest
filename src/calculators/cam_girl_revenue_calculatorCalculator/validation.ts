import { cam_girl_revenue_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: cam_girl_revenue_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
