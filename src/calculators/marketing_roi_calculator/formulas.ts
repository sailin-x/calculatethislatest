import { marketing_roi_calculatorInputs, marketing_roi_calculatorMetrics, marketing_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: marketing_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: marketing_roi_calculatorInputs, metrics: marketing_roi_calculatorMetrics): marketing_roi_calculatorAnalysis {
