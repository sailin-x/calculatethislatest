import { financial_consulting_calculatorCalculatorInputs, financial_consulting_calculatorCalculatorMetrics, financial_consulting_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_consulting_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_consulting_calculatorCalculatorInputs, metrics: financial_consulting_calculatorCalculatorMetrics): financial_consulting_calculatorCalculatorAnalysis {
