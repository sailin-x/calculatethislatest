import { premises_liability_settlement_calculatorCalculatorInputs, premises_liability_settlement_calculatorCalculatorMetrics, premises_liability_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: premises_liability_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: premises_liability_settlement_calculatorCalculatorInputs, metrics: premises_liability_settlement_calculatorCalculatorMetrics): premises_liability_settlement_calculatorCalculatorAnalysis {
