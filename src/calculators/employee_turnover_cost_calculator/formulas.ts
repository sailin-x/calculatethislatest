import { employee_turnover_cost_calculatorInputs, employee_turnover_cost_calculatorMetrics, employee_turnover_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: employee_turnover_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: employee_turnover_cost_calculatorInputs, metrics: employee_turnover_cost_calculatorMetrics): employee_turnover_cost_calculatorAnalysis {
