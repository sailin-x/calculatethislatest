import { black_litterman_calculatorCalculatorInputs, black_litterman_calculatorCalculatorMetrics, black_litterman_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: black_litterman_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: black_litterman_calculatorCalculatorInputs, metrics: black_litterman_calculatorCalculatorMetrics): black_litterman_calculatorCalculatorAnalysis {
