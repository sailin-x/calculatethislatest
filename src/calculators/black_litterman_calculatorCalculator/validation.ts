import { black_litterman_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: black_litterman_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
