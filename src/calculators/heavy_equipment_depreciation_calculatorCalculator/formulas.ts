import { heavy_equipment_depreciation_calculatorCalculatorInputs, heavy_equipment_depreciation_calculatorCalculatorMetrics, heavy_equipment_depreciation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: heavy_equipment_depreciation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: heavy_equipment_depreciation_calculatorCalculatorInputs, metrics: heavy_equipment_depreciation_calculatorCalculatorMetrics): heavy_equipment_depreciation_calculatorCalculatorAnalysis {
