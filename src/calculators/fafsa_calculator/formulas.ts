import { fafsa_calculatorInputs, fafsa_calculatorMetrics, fafsa_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fafsa_calculatorInputs): number {
...
export function generateAnalysis(inputs: fafsa_calculatorInputs, metrics: fafsa_calculatorMetrics): fafsa_calculatorAnalysis {
