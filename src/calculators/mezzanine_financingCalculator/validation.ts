import { mezzanine_financingCalculatorInputs } from './types';

export function validateInputs(inputs: mezzanine_financingCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
