import { mezzanine_financingCalculatorInputs, mezzanine_financingCalculatorMetrics, mezzanine_financingCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mezzanine_financingCalculatorInputs): number {
...
export function generateAnalysis(inputs: mezzanine_financingCalculatorInputs, metrics: mezzanine_financingCalculatorMetrics): mezzanine_financingCalculatorAnalysis {
