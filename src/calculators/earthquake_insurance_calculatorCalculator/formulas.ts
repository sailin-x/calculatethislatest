import { earthquake_insurance_calculatorCalculatorInputs, earthquake_insurance_calculatorCalculatorMetrics, earthquake_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: earthquake_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: earthquake_insurance_calculatorCalculatorInputs, metrics: earthquake_insurance_calculatorCalculatorMetrics): earthquake_insurance_calculatorCalculatorAnalysis {
