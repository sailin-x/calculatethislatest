import { financial_analysis_calculatorInputs } from './types';

export function validateInputs(inputs: financial_analysis_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
