import { financial_analysis_calculatorInputs, financial_analysis_calculatorMetrics, financial_analysis_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_analysis_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_analysis_calculatorInputs, metrics: financial_analysis_calculatorMetrics): financial_analysis_calculatorAnalysis {
