import { crossfit_gym_cost_calculatorCalculatorInputs, crossfit_gym_cost_calculatorCalculatorMetrics, crossfit_gym_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: crossfit_gym_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: crossfit_gym_cost_calculatorCalculatorInputs, metrics: crossfit_gym_cost_calculatorCalculatorMetrics): crossfit_gym_cost_calculatorCalculatorAnalysis {
