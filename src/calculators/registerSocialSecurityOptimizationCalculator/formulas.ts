import { registerSocialSecurityOptimizationCalculatorInputs, registerSocialSecurityOptimizationCalculatorMetrics, registerSocialSecurityOptimizationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerSocialSecurityOptimizationCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerSocialSecurityOptimizationCalculatorInputs, metrics: registerSocialSecurityOptimizationCalculatorMetrics): registerSocialSecurityOptimizationCalculatorAnalysis {
