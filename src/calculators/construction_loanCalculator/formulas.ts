import { construction_loanCalculatorInputs, construction_loanCalculatorMetrics, construction_loanCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: construction_loanCalculatorInputs): number {
...
export function generateAnalysis(inputs: construction_loanCalculatorInputs, metrics: construction_loanCalculatorMetrics): construction_loanCalculatorAnalysis {
