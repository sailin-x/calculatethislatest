import { construction_loanCalculatorInputs } from './types';

export function validateInputs(inputs: construction_loanCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
