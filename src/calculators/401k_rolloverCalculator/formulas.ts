import { 401k_rolloverCalculatorInputs, 401k_rolloverCalculatorMetrics, 401k_rolloverCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: 401k_rolloverCalculatorInputs): number {
...
export function generateAnalysis(inputs: 401k_rolloverCalculatorInputs, metrics: 401k_rolloverCalculatorMetrics): 401k_rolloverCalculatorAnalysis {
