import { probate_calculatorCalculatorInputs, probate_calculatorCalculatorMetrics, probate_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: probate_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: probate_calculatorCalculatorInputs, metrics: probate_calculatorCalculatorMetrics): probate_calculatorCalculatorAnalysis {
