import { registerDividendCalculatorInputs } from './types';

export function validateInputs(inputs: registerDividendCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
