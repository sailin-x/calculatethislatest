import { registerDividendCalculatorInputs, registerDividendCalculatorMetrics, registerDividendCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerDividendCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerDividendCalculatorInputs, metrics: registerDividendCalculatorMetrics): registerDividendCalculatorAnalysis {
