import { physical_therapy_cost_calculatorInputs, physical_therapy_cost_calculatorMetrics, physical_therapy_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: physical_therapy_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: physical_therapy_cost_calculatorInputs, metrics: physical_therapy_cost_calculatorMetrics): physical_therapy_cost_calculatorAnalysis {
