import { physical_therapy_cost_calculatorInputs } from './types';

export function validateInputs(inputs: physical_therapy_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
