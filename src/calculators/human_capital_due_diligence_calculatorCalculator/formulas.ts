import { human_capital_due_diligence_calculatorCalculatorInputs, human_capital_due_diligence_calculatorCalculatorMetrics, human_capital_due_diligence_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: human_capital_due_diligence_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: human_capital_due_diligence_calculatorCalculatorInputs, metrics: human_capital_due_diligence_calculatorCalculatorMetrics): human_capital_due_diligence_calculatorCalculatorAnalysis {
