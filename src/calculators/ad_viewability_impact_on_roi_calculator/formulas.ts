import { ad_viewability_impact_on_roi_calculatorInputs, ad_viewability_impact_on_roi_calculatorMetrics, ad_viewability_impact_on_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ad_viewability_impact_on_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: ad_viewability_impact_on_roi_calculatorInputs, metrics: ad_viewability_impact_on_roi_calculatorMetrics): ad_viewability_impact_on_roi_calculatorAnalysis {
