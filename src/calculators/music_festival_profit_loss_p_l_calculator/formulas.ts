import { music_festival_profit_loss_p_l_calculatorInputs, music_festival_profit_loss_p_l_calculatorMetrics, music_festival_profit_loss_p_l_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: music_festival_profit_loss_p_l_calculatorInputs): number {
...
export function generateAnalysis(inputs: music_festival_profit_loss_p_l_calculatorInputs, metrics: music_festival_profit_loss_p_l_calculatorMetrics): music_festival_profit_loss_p_l_calculatorAnalysis {
