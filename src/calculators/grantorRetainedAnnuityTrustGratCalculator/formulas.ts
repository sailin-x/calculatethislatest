import { grantorRetainedAnnuityTrustGratCalculatorInputs, grantorRetainedAnnuityTrustGratCalculatorMetrics, grantorRetainedAnnuityTrustGratCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: grantorRetainedAnnuityTrustGratCalculatorInputs): number {
...
export function generateAnalysis(inputs: grantorRetainedAnnuityTrustGratCalculatorInputs, metrics: grantorRetainedAnnuityTrustGratCalculatorMetrics): grantorRetainedAnnuityTrustGratCalculatorAnalysis {
