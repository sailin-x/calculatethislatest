import { ad_viewability_impact_calculatorCalculatorInputs, ad_viewability_impact_calculatorCalculatorMetrics, ad_viewability_impact_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: ad_viewability_impact_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: ad_viewability_impact_calculatorCalculatorInputs, metrics: ad_viewability_impact_calculatorCalculatorMetrics): ad_viewability_impact_calculatorCalculatorAnalysis {
