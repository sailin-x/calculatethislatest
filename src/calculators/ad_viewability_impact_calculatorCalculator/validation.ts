import { ad_viewability_impact_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: ad_viewability_impact_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
