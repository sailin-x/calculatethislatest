import { liquidity_mining_calculatorInputs, liquidity_mining_calculatorMetrics, liquidity_mining_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: liquidity_mining_calculatorInputs): number {
...
export function generateAnalysis(inputs: liquidity_mining_calculatorInputs, metrics: liquidity_mining_calculatorMetrics): liquidity_mining_calculatorAnalysis {
