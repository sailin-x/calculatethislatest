import { financial_fulfillment_calculatorCalculatorInputs, financial_fulfillment_calculatorCalculatorMetrics, financial_fulfillment_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_fulfillment_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_fulfillment_calculatorCalculatorInputs, metrics: financial_fulfillment_calculatorCalculatorMetrics): financial_fulfillment_calculatorCalculatorAnalysis {
