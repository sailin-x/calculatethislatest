import { merger_acquisition_divestiture_calculatorInputs, merger_acquisition_divestiture_calculatorMetrics, merger_acquisition_divestiture_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: merger_acquisition_divestiture_calculatorInputs): number {
...
export function generateAnalysis(inputs: merger_acquisition_divestiture_calculatorInputs, metrics: merger_acquisition_divestiture_calculatorMetrics): merger_acquisition_divestiture_calculatorAnalysis {
