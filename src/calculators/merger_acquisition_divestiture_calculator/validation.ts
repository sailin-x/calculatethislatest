import { merger_acquisition_divestiture_calculatorInputs } from './types';

export function validateInputs(inputs: merger_acquisition_divestiture_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
