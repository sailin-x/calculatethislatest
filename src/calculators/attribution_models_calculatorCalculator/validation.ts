import { attribution_models_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: attribution_models_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
