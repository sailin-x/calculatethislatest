import { attribution_models_calculatorCalculatorInputs, attribution_models_calculatorCalculatorMetrics, attribution_models_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: attribution_models_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: attribution_models_calculatorCalculatorInputs, metrics: attribution_models_calculatorCalculatorMetrics): attribution_models_calculatorCalculatorAnalysis {
