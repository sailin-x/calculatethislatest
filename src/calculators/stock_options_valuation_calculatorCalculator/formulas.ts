import { stock_options_valuation_calculatorCalculatorInputs, stock_options_valuation_calculatorCalculatorMetrics, stock_options_valuation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: stock_options_valuation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: stock_options_valuation_calculatorCalculatorInputs, metrics: stock_options_valuation_calculatorCalculatorMetrics): stock_options_valuation_calculatorCalculatorAnalysis {
