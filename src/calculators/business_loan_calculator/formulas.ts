import { business_loan_calculatorInputs, business_loan_calculatorMetrics, business_loan_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_loan_calculatorInputs): number {
...
export function generateAnalysis(inputs: business_loan_calculatorInputs, metrics: business_loan_calculatorMetrics): business_loan_calculatorAnalysis {
