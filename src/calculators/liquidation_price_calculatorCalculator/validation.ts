import { liquidation_price_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: liquidation_price_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
