import { liquidation_price_calculatorCalculatorInputs, liquidation_price_calculatorCalculatorMetrics, liquidation_price_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: liquidation_price_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: liquidation_price_calculatorCalculatorInputs, metrics: liquidation_price_calculatorCalculatorMetrics): liquidation_price_calculatorCalculatorAnalysis {
