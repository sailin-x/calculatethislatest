import { titleInsuranceCalculatorInputs, titleInsuranceCalculatorMetrics, titleInsuranceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: titleInsuranceCalculatorInputs): number {
...
export function generateAnalysis(inputs: titleInsuranceCalculatorInputs, metrics: titleInsuranceCalculatorMetrics): titleInsuranceCalculatorAnalysis {
