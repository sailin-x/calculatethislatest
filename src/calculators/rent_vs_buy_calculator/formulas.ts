import { rent_vs_buy_calculatorInputs, rent_vs_buy_calculatorMetrics, rent_vs_buy_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: rent_vs_buy_calculatorInputs): number {
...
export function generateAnalysis(inputs: rent_vs_buy_calculatorInputs, metrics: rent_vs_buy_calculatorMetrics): rent_vs_buy_calculatorAnalysis {
