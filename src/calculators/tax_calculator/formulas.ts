import { tax_calculatorInputs, tax_calculatorMetrics, tax_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: tax_calculatorInputs): number {
...
export function generateAnalysis(inputs: tax_calculatorInputs, metrics: tax_calculatorMetrics): tax_calculatorAnalysis {
