import { income_calculatorInputs, income_calculatorMetrics, income_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: income_calculatorInputs): number {
...
export function generateAnalysis(inputs: income_calculatorInputs, metrics: income_calculatorMetrics): income_calculatorAnalysis {
