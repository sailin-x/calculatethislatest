import { realEstateDevelopmentProFormaCalculatorInputs, realEstateDevelopmentProFormaCalculatorMetrics, realEstateDevelopmentProFormaCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: realEstateDevelopmentProFormaCalculatorInputs): number {
...
export function generateAnalysis(inputs: realEstateDevelopmentProFormaCalculatorInputs, metrics: realEstateDevelopmentProFormaCalculatorMetrics): realEstateDevelopmentProFormaCalculatorAnalysis {
