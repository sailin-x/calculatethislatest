import { employee_turnover_cost_calculatorCalculatorInputs, employee_turnover_cost_calculatorCalculatorMetrics, employee_turnover_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: employee_turnover_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: employee_turnover_cost_calculatorCalculatorInputs, metrics: employee_turnover_cost_calculatorCalculatorMetrics): employee_turnover_cost_calculatorCalculatorAnalysis {
