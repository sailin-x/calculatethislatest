import { property_tax_prorationCalculatorInputs, property_tax_prorationCalculatorMetrics, property_tax_prorationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: property_tax_prorationCalculatorInputs): number {
...
export function generateAnalysis(inputs: property_tax_prorationCalculatorInputs, metrics: property_tax_prorationCalculatorMetrics): property_tax_prorationCalculatorAnalysis {
