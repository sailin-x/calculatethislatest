import { property_tax_prorationCalculatorInputs } from './types';

export function validateInputs(inputs: property_tax_prorationCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
