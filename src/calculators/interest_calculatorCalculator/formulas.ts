import { interest_calculatorCalculatorInputs, interest_calculatorCalculatorMetrics, interest_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: interest_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: interest_calculatorCalculatorInputs, metrics: interest_calculatorCalculatorMetrics): interest_calculatorCalculatorAnalysis {
