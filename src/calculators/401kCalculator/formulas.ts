import { 401kCalculatorInputs, 401kCalculatorMetrics, 401kCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: 401kCalculatorInputs): number {
...
export function generateAnalysis(inputs: 401kCalculatorInputs, metrics: 401kCalculatorMetrics): 401kCalculatorAnalysis {
