import { total_return_swap_calculatorInputs, total_return_swap_calculatorMetrics, total_return_swap_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: total_return_swap_calculatorInputs): number {
...
export function generateAnalysis(inputs: total_return_swap_calculatorInputs, metrics: total_return_swap_calculatorMetrics): total_return_swap_calculatorAnalysis {
