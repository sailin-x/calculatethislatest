import { price_fixing_overcharge_calculatorCalculatorInputs, price_fixing_overcharge_calculatorCalculatorMetrics, price_fixing_overcharge_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: price_fixing_overcharge_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: price_fixing_overcharge_calculatorCalculatorInputs, metrics: price_fixing_overcharge_calculatorCalculatorMetrics): price_fixing_overcharge_calculatorCalculatorAnalysis {
