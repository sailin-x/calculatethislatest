import { irs_offer_in_compromise_calculatorCalculatorInputs, irs_offer_in_compromise_calculatorCalculatorMetrics, irs_offer_in_compromise_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: irs_offer_in_compromise_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: irs_offer_in_compromise_calculatorCalculatorInputs, metrics: irs_offer_in_compromise_calculatorCalculatorMetrics): irs_offer_in_compromise_calculatorCalculatorAnalysis {
