import { estate_tax_liability_calculatorCalculatorInputs, estate_tax_liability_calculatorCalculatorMetrics, estate_tax_liability_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: estate_tax_liability_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: estate_tax_liability_calculatorCalculatorInputs, metrics: estate_tax_liability_calculatorCalculatorMetrics): estate_tax_liability_calculatorCalculatorAnalysis {
