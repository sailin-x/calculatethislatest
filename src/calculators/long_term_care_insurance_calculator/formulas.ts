import { long_term_care_insurance_calculatorInputs, long_term_care_insurance_calculatorMetrics, long_term_care_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: long_term_care_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: long_term_care_insurance_calculatorInputs, metrics: long_term_care_insurance_calculatorMetrics): long_term_care_insurance_calculatorAnalysis {
