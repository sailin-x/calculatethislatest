import { financial_literacy_calculatorCalculatorInputs, financial_literacy_calculatorCalculatorMetrics, financial_literacy_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_literacy_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_literacy_calculatorCalculatorInputs, metrics: financial_literacy_calculatorCalculatorMetrics): financial_literacy_calculatorCalculatorAnalysis {
