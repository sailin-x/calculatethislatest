import { expected_shortfall_calculatorCalculatorInputs, expected_shortfall_calculatorCalculatorMetrics, expected_shortfall_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: expected_shortfall_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: expected_shortfall_calculatorCalculatorInputs, metrics: expected_shortfall_calculatorCalculatorMetrics): expected_shortfall_calculatorCalculatorAnalysis {
