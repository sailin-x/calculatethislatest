import { expected_shortfall_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: expected_shortfall_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
