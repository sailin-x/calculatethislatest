import { free_cash_flow_to_equity_fcfe_valuationCalculatorInputs, free_cash_flow_to_equity_fcfe_valuationCalculatorMetrics, free_cash_flow_to_equity_fcfe_valuationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: free_cash_flow_to_equity_fcfe_valuationCalculatorInputs): number {
...
export function generateAnalysis(inputs: free_cash_flow_to_equity_fcfe_valuationCalculatorInputs, metrics: free_cash_flow_to_equity_fcfe_valuationCalculatorMetrics): free_cash_flow_to_equity_fcfe_valuationCalculatorAnalysis {
