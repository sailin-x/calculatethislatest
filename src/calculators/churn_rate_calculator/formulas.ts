import { churn_rate_calculatorInputs, churn_rate_calculatorMetrics, churn_rate_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: churn_rate_calculatorInputs): number {
...
export function generateAnalysis(inputs: churn_rate_calculatorInputs, metrics: churn_rate_calculatorMetrics): churn_rate_calculatorAnalysis {
