import { registerReverseMortgageCalculatorInputs, registerReverseMortgageCalculatorMetrics, registerReverseMortgageCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerReverseMortgageCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerReverseMortgageCalculatorInputs, metrics: registerReverseMortgageCalculatorMetrics): registerReverseMortgageCalculatorAnalysis {
