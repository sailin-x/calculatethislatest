import { registerReverseMortgageCalculatorInputs } from './types';

export function validateInputs(inputs: registerReverseMortgageCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
