import { calories_burned_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: calories_burned_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
