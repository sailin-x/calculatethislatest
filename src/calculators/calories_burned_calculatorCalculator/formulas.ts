import { calories_burned_calculatorCalculatorInputs, calories_burned_calculatorCalculatorMetrics, calories_burned_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: calories_burned_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: calories_burned_calculatorCalculatorInputs, metrics: calories_burned_calculatorCalculatorMetrics): calories_burned_calculatorCalculatorAnalysis {
