import { manyvids_revenue_calculatorInputs, manyvids_revenue_calculatorMetrics, manyvids_revenue_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: manyvids_revenue_calculatorInputs): number {
...
export function generateAnalysis(inputs: manyvids_revenue_calculatorInputs, metrics: manyvids_revenue_calculatorMetrics): manyvids_revenue_calculatorAnalysis {
