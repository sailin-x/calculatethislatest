import { propertyTaxProrationCalculatorInputs, propertyTaxProrationCalculatorMetrics, propertyTaxProrationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: propertyTaxProrationCalculatorInputs): number {
...
export function generateAnalysis(inputs: propertyTaxProrationCalculatorInputs, metrics: propertyTaxProrationCalculatorMetrics): propertyTaxProrationCalculatorAnalysis {
