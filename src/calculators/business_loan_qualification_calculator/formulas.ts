import { business_loan_qualification_calculatorInputs, business_loan_qualification_calculatorMetrics, business_loan_qualification_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_loan_qualification_calculatorInputs): number {
...
export function generateAnalysis(inputs: business_loan_qualification_calculatorInputs, metrics: business_loan_qualification_calculatorMetrics): business_loan_qualification_calculatorAnalysis {
