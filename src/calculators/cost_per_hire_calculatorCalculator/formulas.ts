import { cost_per_hire_calculatorCalculatorInputs, cost_per_hire_calculatorCalculatorMetrics, cost_per_hire_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cost_per_hire_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cost_per_hire_calculatorCalculatorInputs, metrics: cost_per_hire_calculatorCalculatorMetrics): cost_per_hire_calculatorCalculatorAnalysis {
