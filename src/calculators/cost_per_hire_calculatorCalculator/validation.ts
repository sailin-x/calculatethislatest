import { cost_per_hire_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: cost_per_hire_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
