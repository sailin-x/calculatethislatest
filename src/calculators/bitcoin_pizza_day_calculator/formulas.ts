import { bitcoin_pizza_day_calculatorInputs, bitcoin_pizza_day_calculatorMetrics, bitcoin_pizza_day_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: bitcoin_pizza_day_calculatorInputs): number {
...
export function generateAnalysis(inputs: bitcoin_pizza_day_calculatorInputs, metrics: bitcoin_pizza_day_calculatorMetrics): bitcoin_pizza_day_calculatorAnalysis {
