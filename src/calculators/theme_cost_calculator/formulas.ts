import { theme_cost_calculatorInputs, theme_cost_calculatorMetrics, theme_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: theme_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: theme_cost_calculatorInputs, metrics: theme_cost_calculatorMetrics): theme_cost_calculatorAnalysis {
