import { scuba_diving_cost_calculatorInputs, scuba_diving_cost_calculatorMetrics, scuba_diving_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: scuba_diving_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: scuba_diving_cost_calculatorInputs, metrics: scuba_diving_cost_calculatorMetrics): scuba_diving_cost_calculatorAnalysis {
