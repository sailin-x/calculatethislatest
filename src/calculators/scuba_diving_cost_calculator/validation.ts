import { scuba_diving_cost_calculatorInputs } from './types';

export function validateInputs(inputs: scuba_diving_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
