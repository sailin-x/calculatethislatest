import { meal_prep_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: meal_prep_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
