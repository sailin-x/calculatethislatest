import { patent_filing_calculatorCalculatorInputs, patent_filing_calculatorCalculatorMetrics, patent_filing_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: patent_filing_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: patent_filing_calculatorCalculatorInputs, metrics: patent_filing_calculatorCalculatorMetrics): patent_filing_calculatorCalculatorAnalysis {
