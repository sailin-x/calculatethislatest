import { patent_filing_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: patent_filing_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
