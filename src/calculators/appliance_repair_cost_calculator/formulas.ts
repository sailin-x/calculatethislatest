import { appliance_repair_cost_calculatorInputs, appliance_repair_cost_calculatorMetrics, appliance_repair_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: appliance_repair_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: appliance_repair_cost_calculatorInputs, metrics: appliance_repair_cost_calculatorMetrics): appliance_repair_cost_calculatorAnalysis {
