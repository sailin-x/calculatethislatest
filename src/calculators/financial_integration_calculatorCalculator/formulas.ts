import { financial_integration_calculatorCalculatorInputs, financial_integration_calculatorCalculatorMetrics, financial_integration_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_integration_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_integration_calculatorCalculatorInputs, metrics: financial_integration_calculatorCalculatorMetrics): financial_integration_calculatorCalculatorAnalysis {
