import { rent_vs_buy_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: rent_vs_buy_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
