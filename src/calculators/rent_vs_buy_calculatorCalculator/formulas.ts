import { rent_vs_buy_calculatorCalculatorInputs, rent_vs_buy_calculatorCalculatorMetrics, rent_vs_buy_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: rent_vs_buy_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: rent_vs_buy_calculatorCalculatorInputs, metrics: rent_vs_buy_calculatorCalculatorMetrics): rent_vs_buy_calculatorCalculatorAnalysis {
