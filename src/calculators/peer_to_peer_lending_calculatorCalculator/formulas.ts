import { peer_to_peer_lending_calculatorCalculatorInputs, peer_to_peer_lending_calculatorCalculatorMetrics, peer_to_peer_lending_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: peer_to_peer_lending_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: peer_to_peer_lending_calculatorCalculatorInputs, metrics: peer_to_peer_lending_calculatorCalculatorMetrics): peer_to_peer_lending_calculatorCalculatorAnalysis {
