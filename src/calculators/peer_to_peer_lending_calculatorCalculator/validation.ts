import { peer_to_peer_lending_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: peer_to_peer_lending_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
