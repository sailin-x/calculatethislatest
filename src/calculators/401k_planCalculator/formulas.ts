import { K401PlanCalculatorInputs, K401PlanCalculatorMetrics, K401PlanCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: K401PlanCalculatorInputs): number {
...
export function generateAnalysis(inputs: K401PlanCalculatorInputs, metrics: K401PlanCalculatorMetrics): K401PlanCalculatorAnalysis {
