import { 401k_planCalculatorInputs, 401k_planCalculatorMetrics, 401k_planCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: 401k_planCalculatorInputs): number {
...
export function generateAnalysis(inputs: 401k_planCalculatorInputs, metrics: 401k_planCalculatorMetrics): 401k_planCalculatorAnalysis {
