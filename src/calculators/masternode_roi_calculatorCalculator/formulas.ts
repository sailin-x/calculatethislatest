import { masternode_roi_calculatorCalculatorInputs, masternode_roi_calculatorCalculatorMetrics, masternode_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: masternode_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: masternode_roi_calculatorCalculatorInputs, metrics: masternode_roi_calculatorCalculatorMetrics): masternode_roi_calculatorCalculatorAnalysis {
