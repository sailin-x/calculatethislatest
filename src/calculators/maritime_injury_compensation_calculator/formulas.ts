import { maritime_injury_compensation_calculatorInputs, maritime_injury_compensation_calculatorMetrics, maritime_injury_compensation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: maritime_injury_compensation_calculatorInputs): number {
...
export function generateAnalysis(inputs: maritime_injury_compensation_calculatorInputs, metrics: maritime_injury_compensation_calculatorMetrics): maritime_injury_compensation_calculatorAnalysis {
