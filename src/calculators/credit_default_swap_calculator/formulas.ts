import { credit_default_swap_calculatorInputs, credit_default_swap_calculatorMetrics, credit_default_swap_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: credit_default_swap_calculatorInputs): number {
...
export function generateAnalysis(inputs: credit_default_swap_calculatorInputs, metrics: credit_default_swap_calculatorMetrics): credit_default_swap_calculatorAnalysis {
