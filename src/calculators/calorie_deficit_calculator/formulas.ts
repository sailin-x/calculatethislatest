import { calorie_deficit_calculatorInputs, calorie_deficit_calculatorMetrics, calorie_deficit_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: calorie_deficit_calculatorInputs): number {
...
export function generateAnalysis(inputs: calorie_deficit_calculatorInputs, metrics: calorie_deficit_calculatorMetrics): calorie_deficit_calculatorAnalysis {
