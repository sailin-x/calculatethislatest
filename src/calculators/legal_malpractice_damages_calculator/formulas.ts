import { legal_malpractice_damages_calculatorInputs, legal_malpractice_damages_calculatorMetrics, legal_malpractice_damages_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: legal_malpractice_damages_calculatorInputs): number {
...
export function generateAnalysis(inputs: legal_malpractice_damages_calculatorInputs, metrics: legal_malpractice_damages_calculatorMetrics): legal_malpractice_damages_calculatorAnalysis {
