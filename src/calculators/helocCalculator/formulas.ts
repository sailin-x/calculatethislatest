import { helocCalculatorInputs, helocCalculatorMetrics, helocCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: helocCalculatorInputs): number {
...
export function generateAnalysis(inputs: helocCalculatorInputs, metrics: helocCalculatorMetrics): helocCalculatorAnalysis {
