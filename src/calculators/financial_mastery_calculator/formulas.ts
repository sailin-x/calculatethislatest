import { financial_mastery_calculatorInputs, financial_mastery_calculatorMetrics, financial_mastery_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_mastery_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_mastery_calculatorInputs, metrics: financial_mastery_calculatorMetrics): financial_mastery_calculatorAnalysis {
