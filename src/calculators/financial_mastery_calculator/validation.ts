import { financial_mastery_calculatorInputs } from './types';

export function validateInputs(inputs: financial_mastery_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
