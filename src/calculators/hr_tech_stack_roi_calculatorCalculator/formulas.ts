import { hr_tech_stack_roi_calculatorCalculatorInputs, hr_tech_stack_roi_calculatorCalculatorMetrics, hr_tech_stack_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hr_tech_stack_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: hr_tech_stack_roi_calculatorCalculatorInputs, metrics: hr_tech_stack_roi_calculatorCalculatorMetrics): hr_tech_stack_roi_calculatorCalculatorAnalysis {
