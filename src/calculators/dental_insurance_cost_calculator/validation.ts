import { dental_insurance_cost_calculatorInputs } from './types';

export function validateInputs(inputs: dental_insurance_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
