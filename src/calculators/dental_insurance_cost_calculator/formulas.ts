import { dental_insurance_cost_calculatorInputs, dental_insurance_cost_calculatorMetrics, dental_insurance_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: dental_insurance_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: dental_insurance_cost_calculatorInputs, metrics: dental_insurance_cost_calculatorMetrics): dental_insurance_cost_calculatorAnalysis {
