import { fafsaCalculatorInputs, fafsaCalculatorMetrics, fafsaCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fafsaCalculatorInputs): number {
...
export function generateAnalysis(inputs: fafsaCalculatorInputs, metrics: fafsaCalculatorMetrics): fafsaCalculatorAnalysis {
