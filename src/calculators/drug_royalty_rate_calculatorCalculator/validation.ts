import { drug_royalty_rate_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: drug_royalty_rate_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
