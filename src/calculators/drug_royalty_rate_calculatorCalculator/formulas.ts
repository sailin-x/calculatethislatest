import { drug_royalty_rate_calculatorCalculatorInputs, drug_royalty_rate_calculatorCalculatorMetrics, drug_royalty_rate_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: drug_royalty_rate_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: drug_royalty_rate_calculatorCalculatorInputs, metrics: drug_royalty_rate_calculatorCalculatorMetrics): drug_royalty_rate_calculatorCalculatorAnalysis {
