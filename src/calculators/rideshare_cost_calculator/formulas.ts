import { rideshare_cost_calculatorInputs, rideshare_cost_calculatorMetrics, rideshare_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: rideshare_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: rideshare_cost_calculatorInputs, metrics: rideshare_cost_calculatorMetrics): rideshare_cost_calculatorAnalysis {
