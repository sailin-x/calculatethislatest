import { registerStretchIRACalculatorInputs } from './types';

export function validateInputs(inputs: registerStretchIRACalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
