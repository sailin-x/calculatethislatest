import { registerStretchIRACalculatorInputs, registerStretchIRACalculatorMetrics, registerStretchIRACalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerStretchIRACalculatorInputs): number {
...
export function generateAnalysis(inputs: registerStretchIRACalculatorInputs, metrics: registerStretchIRACalculatorMetrics): registerStretchIRACalculatorAnalysis {
