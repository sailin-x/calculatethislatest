import { omega_3_calculatorCalculatorInputs, omega_3_calculatorCalculatorMetrics, omega_3_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: omega_3_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: omega_3_calculatorCalculatorInputs, metrics: omega_3_calculatorCalculatorMetrics): omega_3_calculatorCalculatorAnalysis {
