import { omega_3_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: omega_3_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
