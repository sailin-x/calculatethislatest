import { self_funded_health_plan_vs_fully_insured_calculatorInputs, self_funded_health_plan_vs_fully_insured_calculatorMetrics, self_funded_health_plan_vs_fully_insured_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: self_funded_health_plan_vs_fully_insured_calculatorInputs): number {
...
export function generateAnalysis(inputs: self_funded_health_plan_vs_fully_insured_calculatorInputs, metrics: self_funded_health_plan_vs_fully_insured_calculatorMetrics): self_funded_health_plan_vs_fully_insured_calculatorAnalysis {
