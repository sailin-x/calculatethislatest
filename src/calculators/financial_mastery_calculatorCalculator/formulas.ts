import { financial_mastery_calculatorCalculatorInputs, financial_mastery_calculatorCalculatorMetrics, financial_mastery_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_mastery_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_mastery_calculatorCalculatorInputs, metrics: financial_mastery_calculatorCalculatorMetrics): financial_mastery_calculatorCalculatorAnalysis {
