import { airline_ticket_cost_calculatorCalculatorInputs, airline_ticket_cost_calculatorCalculatorMetrics, airline_ticket_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: airline_ticket_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: airline_ticket_cost_calculatorCalculatorInputs, metrics: airline_ticket_cost_calculatorCalculatorMetrics): airline_ticket_cost_calculatorCalculatorAnalysis {
