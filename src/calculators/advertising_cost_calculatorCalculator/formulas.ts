import { advertising_cost_calculatorCalculatorInputs, advertising_cost_calculatorCalculatorMetrics, advertising_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: advertising_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: advertising_cost_calculatorCalculatorInputs, metrics: advertising_cost_calculatorCalculatorMetrics): advertising_cost_calculatorCalculatorAnalysis {
