import { composting_savings_calculatorCalculatorInputs, composting_savings_calculatorCalculatorMetrics, composting_savings_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: composting_savings_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: composting_savings_calculatorCalculatorInputs, metrics: composting_savings_calculatorCalculatorMetrics): composting_savings_calculatorCalculatorAnalysis {
