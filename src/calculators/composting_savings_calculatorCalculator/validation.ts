import { composting_savings_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: composting_savings_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
