import { dental_malpractice_settlement_calculatorCalculatorInputs, dental_malpractice_settlement_calculatorCalculatorMetrics, dental_malpractice_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: dental_malpractice_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: dental_malpractice_settlement_calculatorCalculatorInputs, metrics: dental_malpractice_settlement_calculatorCalculatorMetrics): dental_malpractice_settlement_calculatorCalculatorAnalysis {
