import { music_catalogue_valuation_calculatorInputs, music_catalogue_valuation_calculatorMetrics, music_catalogue_valuation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: music_catalogue_valuation_calculatorInputs): number {
...
export function generateAnalysis(inputs: music_catalogue_valuation_calculatorInputs, metrics: music_catalogue_valuation_calculatorMetrics): music_catalogue_valuation_calculatorAnalysis {
