import { non_compete_agreement_buyout_calculatorCalculatorInputs, non_compete_agreement_buyout_calculatorCalculatorMetrics, non_compete_agreement_buyout_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: non_compete_agreement_buyout_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: non_compete_agreement_buyout_calculatorCalculatorInputs, metrics: non_compete_agreement_buyout_calculatorCalculatorMetrics): non_compete_agreement_buyout_calculatorCalculatorAnalysis {
