import { distressed_debt_investing_roi_calculatorCalculatorInputs, distressed_debt_investing_roi_calculatorCalculatorMetrics, distressed_debt_investing_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: distressed_debt_investing_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: distressed_debt_investing_roi_calculatorCalculatorInputs, metrics: distressed_debt_investing_roi_calculatorCalculatorMetrics): distressed_debt_investing_roi_calculatorCalculatorAnalysis {
