import { hot_air_balloon_cost_calculatorCalculatorInputs, hot_air_balloon_cost_calculatorCalculatorMetrics, hot_air_balloon_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hot_air_balloon_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: hot_air_balloon_cost_calculatorCalculatorInputs, metrics: hot_air_balloon_cost_calculatorCalculatorMetrics): hot_air_balloon_cost_calculatorCalculatorAnalysis {
