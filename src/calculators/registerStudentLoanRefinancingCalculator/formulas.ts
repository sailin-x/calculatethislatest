import { registerStudentLoanRefinancingCalculatorInputs, registerStudentLoanRefinancingCalculatorMetrics, registerStudentLoanRefinancingCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerStudentLoanRefinancingCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerStudentLoanRefinancingCalculatorInputs, metrics: registerStudentLoanRefinancingCalculatorMetrics): registerStudentLoanRefinancingCalculatorAnalysis {
