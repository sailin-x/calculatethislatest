import { registerStudentLoanRefinancingCalculatorInputs } from './types';

export function validateInputs(inputs: registerStudentLoanRefinancingCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
