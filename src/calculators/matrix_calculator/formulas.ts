import { matrix_calculatorInputs, matrix_calculatorMetrics, matrix_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: matrix_calculatorInputs): number {
...
export function generateAnalysis(inputs: matrix_calculatorInputs, metrics: matrix_calculatorMetrics): matrix_calculatorAnalysis {
