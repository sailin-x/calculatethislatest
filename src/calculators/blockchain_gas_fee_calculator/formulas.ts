import { blockchain_gas_fee_calculatorInputs, blockchain_gas_fee_calculatorMetrics, blockchain_gas_fee_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: blockchain_gas_fee_calculatorInputs): number {
...
export function generateAnalysis(inputs: blockchain_gas_fee_calculatorInputs, metrics: blockchain_gas_fee_calculatorMetrics): blockchain_gas_fee_calculatorAnalysis {
