import { ad_viewability_impact_on_roi_calculatorCalculatorInputs, ad_viewability_impact_on_roi_calculatorCalculatorMetrics, ad_viewability_impact_on_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: ad_viewability_impact_on_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: ad_viewability_impact_on_roi_calculatorCalculatorInputs, metrics: ad_viewability_impact_on_roi_calculatorCalculatorMetrics): ad_viewability_impact_on_roi_calculatorCalculatorAnalysis {
