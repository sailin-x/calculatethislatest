import { paycheck_calculatorInputs, paycheck_calculatorMetrics, paycheck_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: paycheck_calculatorInputs): number {
...
export function generateAnalysis(inputs: paycheck_calculatorInputs, metrics: paycheck_calculatorMetrics): paycheck_calculatorAnalysis {
