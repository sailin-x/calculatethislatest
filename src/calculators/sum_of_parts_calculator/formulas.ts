import { sum_of_parts_calculatorInputs, sum_of_parts_calculatorMetrics, sum_of_parts_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: sum_of_parts_calculatorInputs): number {
...
export function generateAnalysis(inputs: sum_of_parts_calculatorInputs, metrics: sum_of_parts_calculatorMetrics): sum_of_parts_calculatorAnalysis {
