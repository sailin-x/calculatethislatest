import { registerDebtAvalancheCalculatorInputs, registerDebtAvalancheCalculatorMetrics, registerDebtAvalancheCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerDebtAvalancheCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerDebtAvalancheCalculatorInputs, metrics: registerDebtAvalancheCalculatorMetrics): registerDebtAvalancheCalculatorAnalysis {
