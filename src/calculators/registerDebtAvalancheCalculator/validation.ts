import { registerDebtAvalancheCalculatorInputs } from './types';

export function validateInputs(inputs: registerDebtAvalancheCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
