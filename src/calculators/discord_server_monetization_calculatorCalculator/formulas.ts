import { discord_server_monetization_calculatorCalculatorInputs, discord_server_monetization_calculatorCalculatorMetrics, discord_server_monetization_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: discord_server_monetization_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: discord_server_monetization_calculatorCalculatorInputs, metrics: discord_server_monetization_calculatorCalculatorMetrics): discord_server_monetization_calculatorCalculatorAnalysis {
