import { jones_act_settlement_calculatorCalculatorInputs, jones_act_settlement_calculatorCalculatorMetrics, jones_act_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: jones_act_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: jones_act_settlement_calculatorCalculatorInputs, metrics: jones_act_settlement_calculatorCalculatorMetrics): jones_act_settlement_calculatorCalculatorAnalysis {
