import { real_estate_closing_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: real_estate_closing_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
