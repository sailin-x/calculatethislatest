import { real_estate_closing_calculatorCalculatorInputs, real_estate_closing_calculatorCalculatorMetrics, real_estate_closing_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: real_estate_closing_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: real_estate_closing_calculatorCalculatorInputs, metrics: real_estate_closing_calculatorCalculatorMetrics): real_estate_closing_calculatorCalculatorAnalysis {
