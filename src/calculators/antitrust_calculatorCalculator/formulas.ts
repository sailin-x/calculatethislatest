import { antitrust_calculatorCalculatorInputs, antitrust_calculatorCalculatorMetrics, antitrust_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: antitrust_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: antitrust_calculatorCalculatorInputs, metrics: antitrust_calculatorCalculatorMetrics): antitrust_calculatorCalculatorAnalysis {
