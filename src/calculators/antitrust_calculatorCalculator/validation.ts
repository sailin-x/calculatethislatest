import { antitrust_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: antitrust_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
