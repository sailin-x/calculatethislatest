import { ConstructionAccidentClaimsCalculatorInputs } from './types';

export function validateConstructionAccidentClaimsCalculatorInputs(inputs: ConstructionAccidentClaimsCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateConstructionAccidentClaimsCalculatorBusinessRules(inputs: ConstructionAccidentClaimsCalculatorInputs): Array<{ field: string; message: string }> {
