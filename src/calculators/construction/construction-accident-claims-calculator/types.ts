export interface ConstructionAccidentClaimsCalculatorInputs {
...
export interface ConstructionAccidentClaimsCalculatorOutputs {
...
export interface ConstructionAccidentClaimsCalculatorMetrics {
...
export interface ConstructionAccidentClaimsCalculatorAnalysis {
