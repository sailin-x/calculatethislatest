import { InsulationCalculatorInputs } from './types';

export function validateInsulationCalculatorInputs(inputs: InsulationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateInsulationCalculatorBusinessRules(inputs: InsulationCalculatorInputs): Array<{ field: string; message: string }> {
