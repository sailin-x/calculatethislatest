export interface InsulationCalculatorInputs {
...
export interface InsulationCalculatorOutputs {
...
export interface InsulationCalculatorMetrics {
...
export interface InsulationCalculatorAnalysis {
