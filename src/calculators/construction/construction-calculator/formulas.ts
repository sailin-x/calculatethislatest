import { construction-calculatorInputs, construction-calculatorMetrics, construction-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: construction-calculatorInputs): number {
...
export function generateAnalysis(inputs: construction-calculatorInputs, metrics: construction-calculatorMetrics): construction-calculatorAnalysis {
