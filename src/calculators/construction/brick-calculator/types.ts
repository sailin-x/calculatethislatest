export interface BrickCalculatorInputs {
...
export interface BrickCalculatorOutputs {
...
export interface BrickCalculatorMetrics {
...
export interface BrickCalculatorAnalysis {
