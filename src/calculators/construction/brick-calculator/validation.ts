import { BrickCalculatorInputs } from './types';

export function validateBrickCalculatorInputs(inputs: BrickCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBrickCalculatorBusinessRules(inputs: BrickCalculatorInputs): Array<{ field: string; message: string }> {
