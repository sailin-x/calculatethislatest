import { SidingCalculatorInputs } from './types';

export function validateSidingCalculatorInputs(inputs: SidingCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateSidingCalculatorBusinessRules(inputs: SidingCalculatorInputs): Array<{ field: string; message: string }> {
