import { AsphaltCalculatorInputs } from './types';

export function validateAsphaltCalculatorInputs(inputs: AsphaltCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAsphaltCalculatorBusinessRules(inputs: AsphaltCalculatorInputs): Array<{ field: string; message: string }> {
