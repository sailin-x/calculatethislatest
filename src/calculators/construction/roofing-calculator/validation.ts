import { RoofingCalculatorInputs } from './types';

export function validateRoofingCalculatorInputs(inputs: RoofingCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateRoofingCalculatorBusinessRules(inputs: RoofingCalculatorInputs): Array<{ field: string; message: string }> {
