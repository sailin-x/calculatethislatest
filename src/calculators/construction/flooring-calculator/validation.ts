import { FlooringCalculatorInputs } from './types';

export function validateFlooringCalculatorInputs(inputs: FlooringCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateFlooringCalculatorBusinessRules(inputs: FlooringCalculatorInputs): Array<{ field: string; message: string }> {
