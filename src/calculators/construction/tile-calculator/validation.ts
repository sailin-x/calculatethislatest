import { TileCalculatorInputs } from './types';

export function validateTileCalculatorInputs(inputs: TileCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTileCalculatorBusinessRules(inputs: TileCalculatorInputs): Array<{ field: string; message: string }> {
