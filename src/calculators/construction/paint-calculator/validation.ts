import { PaintCalculatorInputs } from './types';

export function validatePaintCalculatorInputs(inputs: PaintCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePaintCalculatorBusinessRules(inputs: PaintCalculatorInputs): Array<{ field: string; message: string }> {
