import { DrywallCalculatorInputs } from './types';

export function validateDrywallCalculatorInputs(inputs: DrywallCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDrywallCalculatorBusinessRules(inputs: DrywallCalculatorInputs): Array<{ field: string; message: string }> {
