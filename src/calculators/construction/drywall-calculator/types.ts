export interface DrywallCalculatorInputs {
...
export interface DrywallCalculatorOutputs {
...
export interface DrywallCalculatorMetrics {
...
export interface DrywallCalculatorAnalysis {
