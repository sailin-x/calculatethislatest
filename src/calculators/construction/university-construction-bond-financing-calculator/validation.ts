import { UniversityConstructionBondFinancingCalculatorInputs } from './types';

export function validateUniversityConstructionBondFinancingCalculatorInputs(inputs: UniversityConstructionBondFinancingCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateUniversityConstructionBondFinancingCalculatorBusinessRules(inputs: UniversityConstructionBondFinancingCalculatorInputs): Array<{ field: string; message: string }> {
