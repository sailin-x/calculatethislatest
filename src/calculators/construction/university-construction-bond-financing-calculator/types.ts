export interface UniversityConstructionBondFinancingCalculatorInputs {
...
export interface UniversityConstructionBondFinancingCalculatorOutputs {
...
export interface UniversityConstructionBondFinancingCalculatorMetrics {
...
export interface UniversityConstructionBondFinancingCalculatorAnalysis {
