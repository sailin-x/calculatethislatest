import { concreteInputs, concreteMetrics, concreteAnalysis } from './types';
...
export function calculateResult(inputs: concreteInputs): number {
...
export function generateAnalysis(inputs: concreteInputs, metrics: concreteMetrics): concreteAnalysis {
