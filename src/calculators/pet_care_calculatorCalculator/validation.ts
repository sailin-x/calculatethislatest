import { pet_care_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: pet_care_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
