import { pet_care_calculatorCalculatorInputs, pet_care_calculatorCalculatorMetrics, pet_care_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: pet_care_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: pet_care_calculatorCalculatorInputs, metrics: pet_care_calculatorCalculatorMetrics): pet_care_calculatorCalculatorAnalysis {
