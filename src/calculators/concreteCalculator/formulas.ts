import { concreteCalculatorInputs, concreteCalculatorMetrics, concreteCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: concreteCalculatorInputs): number {
...
export function generateAnalysis(inputs: concreteCalculatorInputs, metrics: concreteCalculatorMetrics): concreteCalculatorAnalysis {
