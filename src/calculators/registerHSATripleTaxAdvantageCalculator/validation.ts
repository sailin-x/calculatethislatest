import { registerHSATripleTaxAdvantageCalculatorInputs } from './types';

export function validateInputs(inputs: registerHSATripleTaxAdvantageCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
