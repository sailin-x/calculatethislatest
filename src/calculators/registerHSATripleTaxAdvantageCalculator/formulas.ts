import { registerHSATripleTaxAdvantageCalculatorInputs, registerHSATripleTaxAdvantageCalculatorMetrics, registerHSATripleTaxAdvantageCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerHSATripleTaxAdvantageCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerHSATripleTaxAdvantageCalculatorInputs, metrics: registerHSATripleTaxAdvantageCalculatorMetrics): registerHSATripleTaxAdvantageCalculatorAnalysis {
