import { body_surface_area_calculatorInputs, body_surface_area_calculatorMetrics, body_surface_area_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: body_surface_area_calculatorInputs): number {
...
export function generateAnalysis(inputs: body_surface_area_calculatorInputs, metrics: body_surface_area_calculatorMetrics): body_surface_area_calculatorAnalysis {
