import { property_insurance_calculatorCalculatorInputs, property_insurance_calculatorCalculatorMetrics, property_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: property_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: property_insurance_calculatorCalculatorInputs, metrics: property_insurance_calculatorCalculatorMetrics): property_insurance_calculatorCalculatorAnalysis {
