import { storm_damage_repair_cost_calculatorCalculatorInputs, storm_damage_repair_cost_calculatorCalculatorMetrics, storm_damage_repair_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: storm_damage_repair_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: storm_damage_repair_cost_calculatorCalculatorInputs, metrics: storm_damage_repair_cost_calculatorCalculatorMetrics): storm_damage_repair_cost_calculatorCalculatorAnalysis {
