import { blockchain_gas_fee_calculatorCalculatorInputs, blockchain_gas_fee_calculatorCalculatorMetrics, blockchain_gas_fee_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: blockchain_gas_fee_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: blockchain_gas_fee_calculatorCalculatorInputs, metrics: blockchain_gas_fee_calculatorCalculatorMetrics): blockchain_gas_fee_calculatorCalculatorAnalysis {
