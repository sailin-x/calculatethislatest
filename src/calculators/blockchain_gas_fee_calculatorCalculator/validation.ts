import { blockchain_gas_fee_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: blockchain_gas_fee_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
