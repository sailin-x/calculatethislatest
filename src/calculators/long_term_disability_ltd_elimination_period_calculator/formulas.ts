import { long_term_disability_ltd_elimination_period_calculatorInputs, long_term_disability_ltd_elimination_period_calculatorMetrics, long_term_disability_ltd_elimination_period_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: long_term_disability_ltd_elimination_period_calculatorInputs): number {
...
export function generateAnalysis(inputs: long_term_disability_ltd_elimination_period_calculatorInputs, metrics: long_term_disability_ltd_elimination_period_calculatorMetrics): long_term_disability_ltd_elimination_period_calculatorAnalysis {
