import { current_ratio_calculatorCalculatorInputs, current_ratio_calculatorCalculatorMetrics, current_ratio_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: current_ratio_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: current_ratio_calculatorCalculatorInputs, metrics: current_ratio_calculatorCalculatorMetrics): current_ratio_calculatorCalculatorAnalysis {
