import { burn_mechanism_calculatorInputs, burn_mechanism_calculatorMetrics, burn_mechanism_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: burn_mechanism_calculatorInputs): number {
...
export function generateAnalysis(inputs: burn_mechanism_calculatorInputs, metrics: burn_mechanism_calculatorMetrics): burn_mechanism_calculatorAnalysis {
