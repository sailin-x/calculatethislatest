import { equipment_financing_calculatorInputs, equipment_financing_calculatorMetrics, equipment_financing_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: equipment_financing_calculatorInputs): number {
...
export function generateAnalysis(inputs: equipment_financing_calculatorInputs, metrics: equipment_financing_calculatorMetrics): equipment_financing_calculatorAnalysis {
