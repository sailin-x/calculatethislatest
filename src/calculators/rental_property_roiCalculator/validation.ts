import { rental_property_roiCalculatorInputs } from './types';

export function validateInputs(inputs: rental_property_roiCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
