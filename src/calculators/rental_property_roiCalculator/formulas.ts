import { rental_property_roiCalculatorInputs, rental_property_roiCalculatorMetrics, rental_property_roiCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: rental_property_roiCalculatorInputs): number {
...
export function generateAnalysis(inputs: rental_property_roiCalculatorInputs, metrics: rental_property_roiCalculatorMetrics): rental_property_roiCalculatorAnalysis {
