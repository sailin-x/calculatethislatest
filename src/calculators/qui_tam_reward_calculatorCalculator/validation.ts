import { qui_tam_reward_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: qui_tam_reward_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
