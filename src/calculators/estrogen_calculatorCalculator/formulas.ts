import { estrogen_calculatorCalculatorInputs, estrogen_calculatorCalculatorMetrics, estrogen_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: estrogen_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: estrogen_calculatorCalculatorInputs, metrics: estrogen_calculatorCalculatorMetrics): estrogen_calculatorCalculatorAnalysis {
