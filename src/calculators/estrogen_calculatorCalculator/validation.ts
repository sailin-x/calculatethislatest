import { estrogen_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: estrogen_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
