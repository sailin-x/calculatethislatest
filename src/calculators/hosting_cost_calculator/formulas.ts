import { hosting_cost_calculatorInputs, hosting_cost_calculatorMetrics, hosting_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: hosting_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: hosting_cost_calculatorInputs, metrics: hosting_cost_calculatorMetrics): hosting_cost_calculatorAnalysis {
