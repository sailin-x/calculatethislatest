import { flood_insuranceCalculatorInputs, flood_insuranceCalculatorMetrics, flood_insuranceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: flood_insuranceCalculatorInputs): number {
...
export function generateAnalysis(inputs: flood_insuranceCalculatorInputs, metrics: flood_insuranceCalculatorMetrics): flood_insuranceCalculatorAnalysis {
