import { irrigation_calculatorInputs, irrigation_calculatorMetrics, irrigation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: irrigation_calculatorInputs): number {
...
export function generateAnalysis(inputs: irrigation_calculatorInputs, metrics: irrigation_calculatorMetrics): irrigation_calculatorAnalysis {
