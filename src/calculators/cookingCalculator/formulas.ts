import { cookingCalculatorInputs, cookingCalculatorMetrics, cookingCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cookingCalculatorInputs): number {
...
export function generateAnalysis(inputs: cookingCalculatorInputs, metrics: cookingCalculatorMetrics): cookingCalculatorAnalysis {
