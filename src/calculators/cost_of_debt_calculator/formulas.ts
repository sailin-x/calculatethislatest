import { cost_of_debt_calculatorInputs, cost_of_debt_calculatorMetrics, cost_of_debt_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cost_of_debt_calculatorInputs): number {
...
export function generateAnalysis(inputs: cost_of_debt_calculatorInputs, metrics: cost_of_debt_calculatorMetrics): cost_of_debt_calculatorAnalysis {
