import { addiction_rehab_calculatorInputs } from './types';

export function validateInputs(inputs: addiction_rehab_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
