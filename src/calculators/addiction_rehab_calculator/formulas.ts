import { addiction_rehab_calculatorInputs, addiction_rehab_calculatorMetrics, addiction_rehab_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: addiction_rehab_calculatorInputs): number {
...
export function generateAnalysis(inputs: addiction_rehab_calculatorInputs, metrics: addiction_rehab_calculatorMetrics): addiction_rehab_calculatorAnalysis {
