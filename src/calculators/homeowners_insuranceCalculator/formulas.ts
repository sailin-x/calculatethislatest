import { homeowners_insuranceCalculatorInputs, homeowners_insuranceCalculatorMetrics, homeowners_insuranceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: homeowners_insuranceCalculatorInputs): number {
...
export function generateAnalysis(inputs: homeowners_insuranceCalculatorInputs, metrics: homeowners_insuranceCalculatorMetrics): homeowners_insuranceCalculatorAnalysis {
