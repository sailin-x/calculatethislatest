import { homeowners_insuranceCalculatorInputs } from './types';

export function validateInputs(inputs: homeowners_insuranceCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
