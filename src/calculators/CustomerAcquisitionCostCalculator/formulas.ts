import { CustomerAcquisitionCostCalculatorInputs, CustomerAcquisitionCostCalculatorMetrics, CustomerAcquisitionCostCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: CustomerAcquisitionCostCalculatorInputs): number {
...
export function generateAnalysis(inputs: CustomerAcquisitionCostCalculatorInputs, metrics: CustomerAcquisitionCostCalculatorMetrics): CustomerAcquisitionCostCalculatorAnalysis {
