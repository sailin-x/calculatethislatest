import { copyright_infringement_damages_calculatorCalculatorInputs, copyright_infringement_damages_calculatorCalculatorMetrics, copyright_infringement_damages_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: copyright_infringement_damages_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: copyright_infringement_damages_calculatorCalculatorInputs, metrics: copyright_infringement_damages_calculatorCalculatorMetrics): copyright_infringement_damages_calculatorCalculatorAnalysis {
