import { balance_transfer_calculatorInputs } from './types';

export function validateInputs(inputs: balance_transfer_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
