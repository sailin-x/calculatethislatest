import { balance_transfer_calculatorInputs, balance_transfer_calculatorMetrics, balance_transfer_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: balance_transfer_calculatorInputs): number {
...
export function generateAnalysis(inputs: balance_transfer_calculatorInputs, metrics: balance_transfer_calculatorMetrics): balance_transfer_calculatorAnalysis {
