import { clinical_trial_cost_calculatorInputs, clinical_trial_cost_calculatorMetrics, clinical_trial_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: clinical_trial_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: clinical_trial_cost_calculatorInputs, metrics: clinical_trial_cost_calculatorMetrics): clinical_trial_cost_calculatorAnalysis {
