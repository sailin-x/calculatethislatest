import { clinical_trial_cost_calculatorInputs } from './types';

export function validateInputs(inputs: clinical_trial_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
