import { mortgage_qualificationCalculatorInputs } from './types';

export function validateInputs(inputs: mortgage_qualificationCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
