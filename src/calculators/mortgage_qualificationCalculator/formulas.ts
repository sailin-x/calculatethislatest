import { mortgage_qualificationCalculatorInputs, mortgage_qualificationCalculatorMetrics, mortgage_qualificationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgage_qualificationCalculatorInputs): number {
...
export function generateAnalysis(inputs: mortgage_qualificationCalculatorInputs, metrics: mortgage_qualificationCalculatorMetrics): mortgage_qualificationCalculatorAnalysis {
