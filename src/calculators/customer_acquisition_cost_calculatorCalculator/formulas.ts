import { customer_acquisition_cost_calculatorCalculatorInputs, customer_acquisition_cost_calculatorCalculatorMetrics, customer_acquisition_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: customer_acquisition_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: customer_acquisition_cost_calculatorCalculatorInputs, metrics: customer_acquisition_cost_calculatorCalculatorMetrics): customer_acquisition_cost_calculatorCalculatorAnalysis {
