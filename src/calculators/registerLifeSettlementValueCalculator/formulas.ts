import { registerLifeSettlementValueCalculatorInputs, registerLifeSettlementValueCalculatorMetrics, registerLifeSettlementValueCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerLifeSettlementValueCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerLifeSettlementValueCalculatorInputs, metrics: registerLifeSettlementValueCalculatorMetrics): registerLifeSettlementValueCalculatorAnalysis {
