import { registerLifeSettlementValueCalculatorInputs } from './types';

export function validateInputs(inputs: registerLifeSettlementValueCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
