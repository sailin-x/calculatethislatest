import { fixed_index_annuity_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: fixed_index_annuity_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
