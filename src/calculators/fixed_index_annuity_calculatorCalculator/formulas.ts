import { fixed_index_annuity_calculatorCalculatorInputs, fixed_index_annuity_calculatorCalculatorMetrics, fixed_index_annuity_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fixed_index_annuity_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: fixed_index_annuity_calculatorCalculatorInputs, metrics: fixed_index_annuity_calculatorCalculatorMetrics): fixed_index_annuity_calculatorCalculatorAnalysis {
