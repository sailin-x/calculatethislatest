import { fire_damage_repair_cost_calculatorCalculatorInputs, fire_damage_repair_cost_calculatorCalculatorMetrics, fire_damage_repair_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fire_damage_repair_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: fire_damage_repair_cost_calculatorCalculatorInputs, metrics: fire_damage_repair_cost_calculatorCalculatorMetrics): fire_damage_repair_cost_calculatorCalculatorAnalysis {
