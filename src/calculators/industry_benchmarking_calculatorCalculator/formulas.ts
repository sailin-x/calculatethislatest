import { industry_benchmarking_calculatorCalculatorInputs, industry_benchmarking_calculatorCalculatorMetrics, industry_benchmarking_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: industry_benchmarking_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: industry_benchmarking_calculatorCalculatorInputs, metrics: industry_benchmarking_calculatorCalculatorMetrics): industry_benchmarking_calculatorCalculatorAnalysis {
