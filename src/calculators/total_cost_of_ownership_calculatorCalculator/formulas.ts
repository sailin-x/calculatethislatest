import { total_cost_of_ownership_calculatorCalculatorInputs, total_cost_of_ownership_calculatorCalculatorMetrics, total_cost_of_ownership_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: total_cost_of_ownership_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: total_cost_of_ownership_calculatorCalculatorInputs, metrics: total_cost_of_ownership_calculatorCalculatorMetrics): total_cost_of_ownership_calculatorCalculatorAnalysis {
