import { financial_analysis_calculatorCalculatorInputs, financial_analysis_calculatorCalculatorMetrics, financial_analysis_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_analysis_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_analysis_calculatorCalculatorInputs, metrics: financial_analysis_calculatorCalculatorMetrics): financial_analysis_calculatorCalculatorAnalysis {
