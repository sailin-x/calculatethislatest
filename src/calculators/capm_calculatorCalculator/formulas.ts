import { capm_calculatorCalculatorInputs, capm_calculatorCalculatorMetrics, capm_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: capm_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: capm_calculatorCalculatorInputs, metrics: capm_calculatorCalculatorMetrics): capm_calculatorCalculatorAnalysis {
