import { gpu_mining_profitability_calculatorCalculatorInputs, gpu_mining_profitability_calculatorCalculatorMetrics, gpu_mining_profitability_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: gpu_mining_profitability_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: gpu_mining_profitability_calculatorCalculatorInputs, metrics: gpu_mining_profitability_calculatorCalculatorMetrics): gpu_mining_profitability_calculatorCalculatorAnalysis {
