import { complex_numbersCalculatorInputs, complex_numbersCalculatorMetrics, complex_numbersCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: complex_numbersCalculatorInputs): number {
...
export function generateAnalysis(inputs: complex_numbersCalculatorInputs, metrics: complex_numbersCalculatorMetrics): complex_numbersCalculatorAnalysis {
