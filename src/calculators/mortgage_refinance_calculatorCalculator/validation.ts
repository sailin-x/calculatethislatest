import { mortgage_refinance_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: mortgage_refinance_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
