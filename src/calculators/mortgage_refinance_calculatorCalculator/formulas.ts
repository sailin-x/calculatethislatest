import { mortgage_refinance_calculatorCalculatorInputs, mortgage_refinance_calculatorCalculatorMetrics, mortgage_refinance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgage_refinance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: mortgage_refinance_calculatorCalculatorInputs, metrics: mortgage_refinance_calculatorCalculatorMetrics): mortgage_refinance_calculatorCalculatorAnalysis {
