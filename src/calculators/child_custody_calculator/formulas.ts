import { child_custody_calculatorInputs, child_custody_calculatorMetrics, child_custody_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: child_custody_calculatorInputs): number {
...
export function generateAnalysis(inputs: child_custody_calculatorInputs, metrics: child_custody_calculatorMetrics): child_custody_calculatorAnalysis {
