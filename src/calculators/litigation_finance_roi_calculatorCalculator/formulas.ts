import { litigation_finance_roi_calculatorCalculatorInputs, litigation_finance_roi_calculatorCalculatorMetrics, litigation_finance_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: litigation_finance_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: litigation_finance_roi_calculatorCalculatorInputs, metrics: litigation_finance_roi_calculatorCalculatorMetrics): litigation_finance_roi_calculatorCalculatorAnalysis {
