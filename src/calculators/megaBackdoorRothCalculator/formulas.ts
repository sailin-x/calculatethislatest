import { megaBackdoorRothCalculatorInputs, megaBackdoorRothCalculatorMetrics, megaBackdoorRothCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: megaBackdoorRothCalculatorInputs): number {
...
export function generateAnalysis(inputs: megaBackdoorRothCalculatorInputs, metrics: megaBackdoorRothCalculatorMetrics): megaBackdoorRothCalculatorAnalysis {
