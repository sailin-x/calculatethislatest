import { antitrust_calculatorInputs, antitrust_calculatorMetrics, antitrust_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: antitrust_calculatorInputs): number {
...
export function generateAnalysis(inputs: antitrust_calculatorInputs, metrics: antitrust_calculatorMetrics): antitrust_calculatorAnalysis {
