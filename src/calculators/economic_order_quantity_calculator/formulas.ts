import { economic_order_quantity_calculatorInputs, economic_order_quantity_calculatorMetrics, economic_order_quantity_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: economic_order_quantity_calculatorInputs): number {
...
export function generateAnalysis(inputs: economic_order_quantity_calculatorInputs, metrics: economic_order_quantity_calculatorMetrics): economic_order_quantity_calculatorAnalysis {
