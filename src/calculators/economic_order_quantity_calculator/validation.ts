import { economic_order_quantity_calculatorInputs } from './types';

export function validateInputs(inputs: economic_order_quantity_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
