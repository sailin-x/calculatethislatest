import { balanced_scorecard_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: balanced_scorecard_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
