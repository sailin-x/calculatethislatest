import { balanced_scorecard_calculatorCalculatorInputs, balanced_scorecard_calculatorCalculatorMetrics, balanced_scorecard_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: balanced_scorecard_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: balanced_scorecard_calculatorCalculatorInputs, metrics: balanced_scorecard_calculatorCalculatorMetrics): balanced_scorecard_calculatorCalculatorAnalysis {
