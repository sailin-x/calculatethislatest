import { financial_alignment_calculatorCalculatorInputs, financial_alignment_calculatorCalculatorMetrics, financial_alignment_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_alignment_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_alignment_calculatorCalculatorInputs, metrics: financial_alignment_calculatorCalculatorMetrics): financial_alignment_calculatorCalculatorAnalysis {
