import { directors_officers_insurance_calculatorCalculatorInputs, directors_officers_insurance_calculatorCalculatorMetrics, directors_officers_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: directors_officers_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: directors_officers_insurance_calculatorCalculatorInputs, metrics: directors_officers_insurance_calculatorCalculatorMetrics): directors_officers_insurance_calculatorCalculatorAnalysis {
