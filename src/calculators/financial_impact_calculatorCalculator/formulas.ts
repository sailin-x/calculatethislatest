import { financial_impact_calculatorCalculatorInputs, financial_impact_calculatorCalculatorMetrics, financial_impact_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_impact_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_impact_calculatorCalculatorInputs, metrics: financial_impact_calculatorCalculatorMetrics): financial_impact_calculatorCalculatorAnalysis {
