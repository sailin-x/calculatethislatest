import { customer_acquisition_costCalculatorInputs, customer_acquisition_costCalculatorMetrics, customer_acquisition_costCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: customer_acquisition_costCalculatorInputs): number {
...
export function generateAnalysis(inputs: customer_acquisition_costCalculatorInputs, metrics: customer_acquisition_costCalculatorMetrics): customer_acquisition_costCalculatorAnalysis {
