import { capital_call_schedule_plannerCalculatorInputs } from './types';

export function validateInputs(inputs: capital_call_schedule_plannerCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
