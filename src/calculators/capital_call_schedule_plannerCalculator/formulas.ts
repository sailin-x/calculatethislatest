import { capital_call_schedule_plannerCalculatorInputs, capital_call_schedule_plannerCalculatorMetrics, capital_call_schedule_plannerCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: capital_call_schedule_plannerCalculatorInputs): number {
...
export function generateAnalysis(inputs: capital_call_schedule_plannerCalculatorInputs, metrics: capital_call_schedule_plannerCalculatorMetrics): capital_call_schedule_plannerCalculatorAnalysis {
