import { bridge_loanCalculatorInputs, bridge_loanCalculatorMetrics, bridge_loanCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: bridge_loanCalculatorInputs): number {
...
export function generateAnalysis(inputs: bridge_loanCalculatorInputs, metrics: bridge_loanCalculatorMetrics): bridge_loanCalculatorAnalysis {
