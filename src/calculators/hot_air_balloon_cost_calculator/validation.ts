import { hot_air_balloon_cost_calculatorInputs } from './types';

export function validateInputs(inputs: hot_air_balloon_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
