import { hot_air_balloon_cost_calculatorInputs, hot_air_balloon_cost_calculatorMetrics, hot_air_balloon_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: hot_air_balloon_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: hot_air_balloon_cost_calculatorInputs, metrics: hot_air_balloon_cost_calculatorMetrics): hot_air_balloon_cost_calculatorAnalysis {
