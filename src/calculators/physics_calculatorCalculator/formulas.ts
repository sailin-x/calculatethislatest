import { physics_calculatorCalculatorInputs, physics_calculatorCalculatorMetrics, physics_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: physics_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: physics_calculatorCalculatorInputs, metrics: physics_calculatorCalculatorMetrics): physics_calculatorCalculatorAnalysis {
