import { physics_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: physics_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
