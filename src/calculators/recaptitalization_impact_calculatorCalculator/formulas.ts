import { recaptitalization_impact_calculatorCalculatorInputs, recaptitalization_impact_calculatorCalculatorMetrics, recaptitalization_impact_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: recaptitalization_impact_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: recaptitalization_impact_calculatorCalculatorInputs, metrics: recaptitalization_impact_calculatorCalculatorMetrics): recaptitalization_impact_calculatorCalculatorAnalysis {
