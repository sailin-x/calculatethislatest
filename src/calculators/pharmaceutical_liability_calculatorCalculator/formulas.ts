import { pharmaceutical_liability_calculatorCalculatorInputs, pharmaceutical_liability_calculatorCalculatorMetrics, pharmaceutical_liability_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: pharmaceutical_liability_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: pharmaceutical_liability_calculatorCalculatorInputs, metrics: pharmaceutical_liability_calculatorCalculatorMetrics): pharmaceutical_liability_calculatorCalculatorAnalysis {
