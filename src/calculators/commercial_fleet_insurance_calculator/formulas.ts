import { commercial_fleet_insurance_calculatorInputs, commercial_fleet_insurance_calculatorMetrics, commercial_fleet_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: commercial_fleet_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: commercial_fleet_insurance_calculatorInputs, metrics: commercial_fleet_insurance_calculatorMetrics): commercial_fleet_insurance_calculatorAnalysis {
