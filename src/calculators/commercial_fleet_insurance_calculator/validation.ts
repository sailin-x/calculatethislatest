import { commercial_fleet_insurance_calculatorInputs } from './types';

export function validateInputs(inputs: commercial_fleet_insurance_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
