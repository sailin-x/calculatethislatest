import { sep_ira_calculatorCalculatorInputs, sep_ira_calculatorCalculatorMetrics, sep_ira_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: sep_ira_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: sep_ira_calculatorCalculatorInputs, metrics: sep_ira_calculatorCalculatorMetrics): sep_ira_calculatorCalculatorAnalysis {
