import { divorce_settlement_calculatorInputs } from './types';

export function validateInputs(inputs: divorce_settlement_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
