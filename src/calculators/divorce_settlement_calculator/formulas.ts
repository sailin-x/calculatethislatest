import { divorce_settlement_calculatorInputs, divorce_settlement_calculatorMetrics, divorce_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: divorce_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: divorce_settlement_calculatorInputs, metrics: divorce_settlement_calculatorMetrics): divorce_settlement_calculatorAnalysis {
