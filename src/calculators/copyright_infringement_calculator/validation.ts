import { copyright_infringement_calculatorInputs } from './types';

export function validateInputs(inputs: copyright_infringement_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
