import { copyright_infringement_calculatorInputs, copyright_infringement_calculatorMetrics, copyright_infringement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: copyright_infringement_calculatorInputs): number {
...
export function generateAnalysis(inputs: copyright_infringement_calculatorInputs, metrics: copyright_infringement_calculatorMetrics): copyright_infringement_calculatorAnalysis {
