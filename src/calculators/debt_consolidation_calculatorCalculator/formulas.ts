import { debt_consolidation_calculatorCalculatorInputs, debt_consolidation_calculatorCalculatorMetrics, debt_consolidation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_consolidation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: debt_consolidation_calculatorCalculatorInputs, metrics: debt_consolidation_calculatorCalculatorMetrics): debt_consolidation_calculatorCalculatorAnalysis {
