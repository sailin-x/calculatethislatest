import { personal_injury_multiplier_calculatorCalculatorInputs, personal_injury_multiplier_calculatorCalculatorMetrics, personal_injury_multiplier_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: personal_injury_multiplier_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: personal_injury_multiplier_calculatorCalculatorInputs, metrics: personal_injury_multiplier_calculatorCalculatorMetrics): personal_injury_multiplier_calculatorCalculatorAnalysis {
