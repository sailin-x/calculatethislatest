import { medical_bill_negotiation_calculatorCalculatorInputs, medical_bill_negotiation_calculatorCalculatorMetrics, medical_bill_negotiation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: medical_bill_negotiation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: medical_bill_negotiation_calculatorCalculatorInputs, metrics: medical_bill_negotiation_calculatorCalculatorMetrics): medical_bill_negotiation_calculatorCalculatorAnalysis {
