import { gap_insurance_calculatorCalculatorInputs, gap_insurance_calculatorCalculatorMetrics, gap_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: gap_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: gap_insurance_calculatorCalculatorInputs, metrics: gap_insurance_calculatorCalculatorMetrics): gap_insurance_calculatorCalculatorAnalysis {
