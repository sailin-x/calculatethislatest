import { mortgage_insuranceCalculatorInputs, mortgage_insuranceCalculatorMetrics, mortgage_insuranceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgage_insuranceCalculatorInputs): number {
...
export function generateAnalysis(inputs: mortgage_insuranceCalculatorInputs, metrics: mortgage_insuranceCalculatorMetrics): mortgage_insuranceCalculatorAnalysis {
