import { mortgage_insuranceCalculatorInputs } from './types';

export function validateInputs(inputs: mortgage_insuranceCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
