import { pedestrian_accident_settlement_calculatorCalculatorInputs, pedestrian_accident_settlement_calculatorCalculatorMetrics, pedestrian_accident_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: pedestrian_accident_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: pedestrian_accident_settlement_calculatorCalculatorInputs, metrics: pedestrian_accident_settlement_calculatorCalculatorMetrics): pedestrian_accident_settlement_calculatorCalculatorAnalysis {
