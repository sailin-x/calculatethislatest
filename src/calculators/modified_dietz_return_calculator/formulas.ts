import { modified_dietz_return_calculatorInputs, modified_dietz_return_calculatorMetrics, modified_dietz_return_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: modified_dietz_return_calculatorInputs): number {
...
export function generateAnalysis(inputs: modified_dietz_return_calculatorInputs, metrics: modified_dietz_return_calculatorMetrics): modified_dietz_return_calculatorAnalysis {
