import { fertilizer_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: fertilizer_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
