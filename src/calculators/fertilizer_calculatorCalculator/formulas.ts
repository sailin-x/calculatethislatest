import { fertilizer_calculatorCalculatorInputs, fertilizer_calculatorCalculatorMetrics, fertilizer_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fertilizer_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: fertilizer_calculatorCalculatorInputs, metrics: fertilizer_calculatorCalculatorMetrics): fertilizer_calculatorCalculatorAnalysis {
