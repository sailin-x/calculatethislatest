import { combined_ratio_calculatorInputs, combined_ratio_calculatorMetrics, combined_ratio_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: combined_ratio_calculatorInputs): number {
...
export function generateAnalysis(inputs: combined_ratio_calculatorInputs, metrics: combined_ratio_calculatorMetrics): combined_ratio_calculatorAnalysis {
