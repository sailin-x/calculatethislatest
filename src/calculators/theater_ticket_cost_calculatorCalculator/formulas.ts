import { theater_ticket_cost_calculatorCalculatorInputs, theater_ticket_cost_calculatorCalculatorMetrics, theater_ticket_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: theater_ticket_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: theater_ticket_cost_calculatorCalculatorInputs, metrics: theater_ticket_cost_calculatorCalculatorMetrics): theater_ticket_cost_calculatorCalculatorAnalysis {
