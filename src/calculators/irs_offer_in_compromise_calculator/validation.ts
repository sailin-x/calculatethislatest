import { irs_offer_in_compromise_calculatorInputs } from './types';

export function validateInputs(inputs: irs_offer_in_compromise_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
