import { irs_offer_in_compromise_calculatorInputs, irs_offer_in_compromise_calculatorMetrics, irs_offer_in_compromise_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: irs_offer_in_compromise_calculatorInputs): number {
...
export function generateAnalysis(inputs: irs_offer_in_compromise_calculatorInputs, metrics: irs_offer_in_compromise_calculatorMetrics): irs_offer_in_compromise_calculatorAnalysis {
