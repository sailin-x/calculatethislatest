import { carb_cycling_calculatorInputs, carb_cycling_calculatorMetrics, carb_cycling_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: carb_cycling_calculatorInputs): number {
...
export function generateAnalysis(inputs: carb_cycling_calculatorInputs, metrics: carb_cycling_calculatorMetrics): carb_cycling_calculatorAnalysis {
