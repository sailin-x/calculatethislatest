import { churn_rate_calculatorCalculatorInputs, churn_rate_calculatorCalculatorMetrics, churn_rate_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: churn_rate_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: churn_rate_calculatorCalculatorInputs, metrics: churn_rate_calculatorCalculatorMetrics): churn_rate_calculatorCalculatorAnalysis {
