import { mortgage_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: mortgage_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
