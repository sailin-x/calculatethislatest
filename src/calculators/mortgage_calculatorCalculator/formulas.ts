import { mortgage_calculatorCalculatorInputs, mortgage_calculatorCalculatorMetrics, mortgage_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgage_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: mortgage_calculatorCalculatorInputs, metrics: mortgage_calculatorCalculatorMetrics): mortgage_calculatorCalculatorAnalysis {
