import { record_label_deal_calculatorInputs, record_label_deal_calculatorMetrics, record_label_deal_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: record_label_deal_calculatorInputs): number {
...
export function generateAnalysis(inputs: record_label_deal_calculatorInputs, metrics: record_label_deal_calculatorMetrics): record_label_deal_calculatorAnalysis {
