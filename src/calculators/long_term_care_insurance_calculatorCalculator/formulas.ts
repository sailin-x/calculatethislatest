import { long_term_care_insurance_calculatorCalculatorInputs, long_term_care_insurance_calculatorCalculatorMetrics, long_term_care_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: long_term_care_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: long_term_care_insurance_calculatorCalculatorInputs, metrics: long_term_care_insurance_calculatorCalculatorMetrics): long_term_care_insurance_calculatorCalculatorAnalysis {
