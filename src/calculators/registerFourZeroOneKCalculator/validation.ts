import { registerFourZeroOneKCalculatorInputs } from './types';

export function validateInputs(inputs: registerFourZeroOneKCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
