import { registerFourZeroOneKCalculatorInputs, registerFourZeroOneKCalculatorMetrics, registerFourZeroOneKCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerFourZeroOneKCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerFourZeroOneKCalculatorInputs, metrics: registerFourZeroOneKCalculatorMetrics): registerFourZeroOneKCalculatorAnalysis {
