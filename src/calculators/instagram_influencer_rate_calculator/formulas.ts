import { instagram_influencer_rate_calculatorInputs, instagram_influencer_rate_calculatorMetrics, instagram_influencer_rate_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: instagram_influencer_rate_calculatorInputs): number {
...
export function generateAnalysis(inputs: instagram_influencer_rate_calculatorInputs, metrics: instagram_influencer_rate_calculatorMetrics): instagram_influencer_rate_calculatorAnalysis {
