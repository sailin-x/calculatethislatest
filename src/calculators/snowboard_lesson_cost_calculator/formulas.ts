import { snowboard_lesson_cost_calculatorInputs, snowboard_lesson_cost_calculatorMetrics, snowboard_lesson_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: snowboard_lesson_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: snowboard_lesson_cost_calculatorInputs, metrics: snowboard_lesson_cost_calculatorMetrics): snowboard_lesson_cost_calculatorAnalysis {
