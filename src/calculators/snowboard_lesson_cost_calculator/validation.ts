import { snowboard_lesson_cost_calculatorInputs } from './types';

export function validateInputs(inputs: snowboard_lesson_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
