import { hvac_maintenance_cost_calculatorCalculatorInputs, hvac_maintenance_cost_calculatorCalculatorMetrics, hvac_maintenance_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hvac_maintenance_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: hvac_maintenance_cost_calculatorCalculatorInputs, metrics: hvac_maintenance_cost_calculatorCalculatorMetrics): hvac_maintenance_cost_calculatorCalculatorAnalysis {
