import { domain_cost_calculatorCalculatorInputs, domain_cost_calculatorCalculatorMetrics, domain_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: domain_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: domain_cost_calculatorCalculatorInputs, metrics: domain_cost_calculatorCalculatorMetrics): domain_cost_calculatorCalculatorAnalysis {
