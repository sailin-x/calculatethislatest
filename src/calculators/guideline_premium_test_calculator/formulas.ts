import { guideline_premium_test_calculatorInputs, guideline_premium_test_calculatorMetrics, guideline_premium_test_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: guideline_premium_test_calculatorInputs): number {
...
export function generateAnalysis(inputs: guideline_premium_test_calculatorInputs, metrics: guideline_premium_test_calculatorMetrics): guideline_premium_test_calculatorAnalysis {
