import { guideline_premium_test_calculatorInputs } from './types';

export function validateInputs(inputs: guideline_premium_test_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
