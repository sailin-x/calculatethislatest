import { retirement_savings_calculatorInputs } from './types';

export function validateInputs(inputs: retirement_savings_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
