import { retirement_savings_calculatorInputs, retirement_savings_calculatorMetrics, retirement_savings_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: retirement_savings_calculatorInputs): number {
...
export function generateAnalysis(inputs: retirement_savings_calculatorInputs, metrics: retirement_savings_calculatorMetrics): retirement_savings_calculatorAnalysis {
