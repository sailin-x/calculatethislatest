import { budget_optimization_calculatorInputs, budget_optimization_calculatorMetrics, budget_optimization_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: budget_optimization_calculatorInputs): number {
...
export function generateAnalysis(inputs: budget_optimization_calculatorInputs, metrics: budget_optimization_calculatorMetrics): budget_optimization_calculatorAnalysis {
