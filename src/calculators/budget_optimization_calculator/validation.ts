import { budget_optimization_calculatorInputs } from './types';

export function validateInputs(inputs: budget_optimization_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
