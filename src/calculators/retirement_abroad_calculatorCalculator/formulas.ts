import { retirement_abroad_calculatorCalculatorInputs, retirement_abroad_calculatorCalculatorMetrics, retirement_abroad_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: retirement_abroad_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: retirement_abroad_calculatorCalculatorInputs, metrics: retirement_abroad_calculatorCalculatorMetrics): retirement_abroad_calculatorCalculatorAnalysis {
