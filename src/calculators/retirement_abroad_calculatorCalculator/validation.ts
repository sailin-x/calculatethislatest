import { retirement_abroad_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: retirement_abroad_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
