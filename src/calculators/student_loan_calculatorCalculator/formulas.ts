import { student_loan_calculatorCalculatorInputs, student_loan_calculatorCalculatorMetrics, student_loan_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: student_loan_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: student_loan_calculatorCalculatorInputs, metrics: student_loan_calculatorCalculatorMetrics): student_loan_calculatorCalculatorAnalysis {
