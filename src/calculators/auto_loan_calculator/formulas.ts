import { auto_loan_calculatorInputs, auto_loan_calculatorMetrics, auto_loan_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: auto_loan_calculatorInputs): number {
...
export function generateAnalysis(inputs: auto_loan_calculatorInputs, metrics: auto_loan_calculatorMetrics): auto_loan_calculatorAnalysis {
