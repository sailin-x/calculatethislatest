import { commercial_fleet_insurance_calculatorCalculatorInputs, commercial_fleet_insurance_calculatorCalculatorMetrics, commercial_fleet_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: commercial_fleet_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: commercial_fleet_insurance_calculatorCalculatorInputs, metrics: commercial_fleet_insurance_calculatorCalculatorMetrics): commercial_fleet_insurance_calculatorCalculatorAnalysis {
