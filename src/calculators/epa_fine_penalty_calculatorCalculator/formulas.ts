import { epa_fine_penalty_calculatorCalculatorInputs, epa_fine_penalty_calculatorCalculatorMetrics, epa_fine_penalty_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: epa_fine_penalty_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: epa_fine_penalty_calculatorCalculatorInputs, metrics: epa_fine_penalty_calculatorCalculatorMetrics): epa_fine_penalty_calculatorCalculatorAnalysis {
