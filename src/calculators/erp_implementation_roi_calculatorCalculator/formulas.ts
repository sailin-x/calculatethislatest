import { erp_implementation_roi_calculatorCalculatorInputs, erp_implementation_roi_calculatorCalculatorMetrics, erp_implementation_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: erp_implementation_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: erp_implementation_roi_calculatorCalculatorInputs, metrics: erp_implementation_roi_calculatorCalculatorMetrics): erp_implementation_roi_calculatorCalculatorAnalysis {
