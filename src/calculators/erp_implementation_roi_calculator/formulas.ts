import { erp_implementation_roi_calculatorInputs, erp_implementation_roi_calculatorMetrics, erp_implementation_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: erp_implementation_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: erp_implementation_roi_calculatorInputs, metrics: erp_implementation_roi_calculatorMetrics): erp_implementation_roi_calculatorAnalysis {
