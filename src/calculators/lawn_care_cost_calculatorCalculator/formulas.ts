import { lawn_care_cost_calculatorCalculatorInputs, lawn_care_cost_calculatorCalculatorMetrics, lawn_care_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: lawn_care_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: lawn_care_cost_calculatorCalculatorInputs, metrics: lawn_care_cost_calculatorCalculatorMetrics): lawn_care_cost_calculatorCalculatorAnalysis {
