import { hospital_negligence_calculatorInputs, hospital_negligence_calculatorMetrics, hospital_negligence_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: hospital_negligence_calculatorInputs): number {
...
export function generateAnalysis(inputs: hospital_negligence_calculatorInputs, metrics: hospital_negligence_calculatorMetrics): hospital_negligence_calculatorAnalysis {
