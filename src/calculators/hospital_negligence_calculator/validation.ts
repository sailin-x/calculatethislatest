import { hospital_negligence_calculatorInputs } from './types';

export function validateInputs(inputs: hospital_negligence_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
