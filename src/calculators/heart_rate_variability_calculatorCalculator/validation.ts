import { heart_rate_variability_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: heart_rate_variability_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
