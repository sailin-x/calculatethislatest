import { heart_rate_variability_calculatorCalculatorInputs, heart_rate_variability_calculatorCalculatorMetrics, heart_rate_variability_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: heart_rate_variability_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: heart_rate_variability_calculatorCalculatorInputs, metrics: heart_rate_variability_calculatorCalculatorMetrics): heart_rate_variability_calculatorCalculatorAnalysis {
