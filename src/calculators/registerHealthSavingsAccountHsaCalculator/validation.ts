import { registerHealthSavingsAccountHsaCalculatorInputs } from './types';

export function validateInputs(inputs: registerHealthSavingsAccountHsaCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
