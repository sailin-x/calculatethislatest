import { registerHealthSavingsAccountHsaCalculatorInputs, registerHealthSavingsAccountHsaCalculatorMetrics, registerHealthSavingsAccountHsaCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerHealthSavingsAccountHsaCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerHealthSavingsAccountHsaCalculatorInputs, metrics: registerHealthSavingsAccountHsaCalculatorMetrics): registerHealthSavingsAccountHsaCalculatorAnalysis {
