import { data_breach_cost_calculatorInputs, data_breach_cost_calculatorMetrics, data_breach_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: data_breach_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: data_breach_cost_calculatorInputs, metrics: data_breach_cost_calculatorMetrics): data_breach_cost_calculatorAnalysis {
