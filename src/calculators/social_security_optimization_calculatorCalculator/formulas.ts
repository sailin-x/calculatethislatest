import { social_security_optimization_calculatorCalculatorInputs, social_security_optimization_calculatorCalculatorMetrics, social_security_optimization_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: social_security_optimization_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: social_security_optimization_calculatorCalculatorInputs, metrics: social_security_optimization_calculatorCalculatorMetrics): social_security_optimization_calculatorCalculatorAnalysis {
