import { registerDebtSnowballCalculatorInputs } from './types';

export function validateInputs(inputs: registerDebtSnowballCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
