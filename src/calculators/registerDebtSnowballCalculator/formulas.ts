import { registerDebtSnowballCalculatorInputs, registerDebtSnowballCalculatorMetrics, registerDebtSnowballCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerDebtSnowballCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerDebtSnowballCalculatorInputs, metrics: registerDebtSnowballCalculatorMetrics): registerDebtSnowballCalculatorAnalysis {
