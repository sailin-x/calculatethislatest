import { amazon_fba_profit_calculatorInputs, amazon_fba_profit_calculatorMetrics, amazon_fba_profit_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: amazon_fba_profit_calculatorInputs): number {
...
export function generateAnalysis(inputs: amazon_fba_profit_calculatorInputs, metrics: amazon_fba_profit_calculatorMetrics): amazon_fba_profit_calculatorAnalysis {
