import { brand_equity_valuation_calculatorInputs, brand_equity_valuation_calculatorMetrics, brand_equity_valuation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: brand_equity_valuation_calculatorInputs): number {
...
export function generateAnalysis(inputs: brand_equity_valuation_calculatorInputs, metrics: brand_equity_valuation_calculatorMetrics): brand_equity_valuation_calculatorAnalysis {
