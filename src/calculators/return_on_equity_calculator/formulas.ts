import { return_on_equity_calculatorInputs, return_on_equity_calculatorMetrics, return_on_equity_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: return_on_equity_calculatorInputs): number {
...
export function generateAnalysis(inputs: return_on_equity_calculatorInputs, metrics: return_on_equity_calculatorMetrics): return_on_equity_calculatorAnalysis {
