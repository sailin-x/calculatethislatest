import { return_on_equity_calculatorInputs } from './types';

export function validateInputs(inputs: return_on_equity_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
