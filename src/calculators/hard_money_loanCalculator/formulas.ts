import { hard_money_loanCalculatorInputs, hard_money_loanCalculatorMetrics, hard_money_loanCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hard_money_loanCalculatorInputs): number {
...
export function generateAnalysis(inputs: hard_money_loanCalculatorInputs, metrics: hard_money_loanCalculatorMetrics): hard_money_loanCalculatorAnalysis {
