import { registerDebtConsolidationLoanCalculatorInputs, registerDebtConsolidationLoanCalculatorMetrics, registerDebtConsolidationLoanCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerDebtConsolidationLoanCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerDebtConsolidationLoanCalculatorInputs, metrics: registerDebtConsolidationLoanCalculatorMetrics): registerDebtConsolidationLoanCalculatorAnalysis {
