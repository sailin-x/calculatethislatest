import { registerDebtConsolidationLoanCalculatorInputs } from './types';

export function validateInputs(inputs: registerDebtConsolidationLoanCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
