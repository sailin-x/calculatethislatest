import { macro_calculatorInputs, macro_calculatorMetrics, macro_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: macro_calculatorInputs): number {
...
export function generateAnalysis(inputs: macro_calculatorInputs, metrics: macro_calculatorMetrics): macro_calculatorAnalysis {
