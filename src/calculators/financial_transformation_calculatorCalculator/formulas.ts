import { financial_transformation_calculatorCalculatorInputs, financial_transformation_calculatorCalculatorMetrics, financial_transformation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_transformation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_transformation_calculatorCalculatorInputs, metrics: financial_transformation_calculatorCalculatorMetrics): financial_transformation_calculatorCalculatorAnalysis {
