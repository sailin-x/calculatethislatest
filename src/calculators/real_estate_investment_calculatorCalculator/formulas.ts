import { real_estate_investment_calculatorCalculatorInputs, real_estate_investment_calculatorCalculatorMetrics, real_estate_investment_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: real_estate_investment_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: real_estate_investment_calculatorCalculatorInputs, metrics: real_estate_investment_calculatorCalculatorMetrics): real_estate_investment_calculatorCalculatorAnalysis {
