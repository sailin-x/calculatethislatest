import { real_estate_investment_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: real_estate_investment_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
