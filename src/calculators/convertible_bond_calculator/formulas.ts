import { convertible_bond_calculatorInputs, convertible_bond_calculatorMetrics, convertible_bond_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: convertible_bond_calculatorInputs): number {
...
export function generateAnalysis(inputs: convertible_bond_calculatorInputs, metrics: convertible_bond_calculatorMetrics): convertible_bond_calculatorAnalysis {
