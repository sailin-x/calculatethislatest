import { out_of_home_ooh_advertising_roi_calculatorCalculatorInputs, out_of_home_ooh_advertising_roi_calculatorCalculatorMetrics, out_of_home_ooh_advertising_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: out_of_home_ooh_advertising_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: out_of_home_ooh_advertising_roi_calculatorCalculatorInputs, metrics: out_of_home_ooh_advertising_roi_calculatorCalculatorMetrics): out_of_home_ooh_advertising_roi_calculatorCalculatorAnalysis {
