import { home_improvement_calculatorInputs, home_improvement_calculatorMetrics, home_improvement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: home_improvement_calculatorInputs): number {
...
export function generateAnalysis(inputs: home_improvement_calculatorInputs, metrics: home_improvement_calculatorMetrics): home_improvement_calculatorAnalysis {
