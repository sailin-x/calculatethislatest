import { anti_aging_regenerative_medicine_cost_calculatorCalculatorInputs, anti_aging_regenerative_medicine_cost_calculatorCalculatorMetrics, anti_aging_regenerative_medicine_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: anti_aging_regenerative_medicine_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: anti_aging_regenerative_medicine_cost_calculatorCalculatorInputs, metrics: anti_aging_regenerative_medicine_cost_calculatorCalculatorMetrics): anti_aging_regenerative_medicine_cost_calculatorCalculatorAnalysis {
