import { airdrop_value_calculatorCalculatorInputs, airdrop_value_calculatorCalculatorMetrics, airdrop_value_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: airdrop_value_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: airdrop_value_calculatorCalculatorInputs, metrics: airdrop_value_calculatorCalculatorMetrics): airdrop_value_calculatorCalculatorAnalysis {
