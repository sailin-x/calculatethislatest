import { fera_settlement_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: fera_settlement_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
