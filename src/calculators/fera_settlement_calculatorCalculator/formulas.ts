import { fera_settlement_calculatorCalculatorInputs, fera_settlement_calculatorCalculatorMetrics, fera_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fera_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: fera_settlement_calculatorCalculatorInputs, metrics: fera_settlement_calculatorCalculatorMetrics): fera_settlement_calculatorCalculatorAnalysis {
