import { registerTitleInsuranceCalculatorInputs, registerTitleInsuranceCalculatorMetrics, registerTitleInsuranceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerTitleInsuranceCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerTitleInsuranceCalculatorInputs, metrics: registerTitleInsuranceCalculatorMetrics): registerTitleInsuranceCalculatorAnalysis {
