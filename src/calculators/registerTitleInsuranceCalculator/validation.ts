import { registerTitleInsuranceCalculatorInputs } from './types';

export function validateInputs(inputs: registerTitleInsuranceCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
