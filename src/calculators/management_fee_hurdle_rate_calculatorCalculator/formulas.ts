import { management_fee_hurdle_rate_calculatorCalculatorInputs, management_fee_hurdle_rate_calculatorCalculatorMetrics, management_fee_hurdle_rate_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: management_fee_hurdle_rate_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: management_fee_hurdle_rate_calculatorCalculatorInputs, metrics: management_fee_hurdle_rate_calculatorCalculatorMetrics): management_fee_hurdle_rate_calculatorCalculatorAnalysis {
