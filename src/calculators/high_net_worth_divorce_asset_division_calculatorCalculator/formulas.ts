import { high_net_worth_divorce_asset_division_calculatorCalculatorInputs, high_net_worth_divorce_asset_division_calculatorCalculatorMetrics, high_net_worth_divorce_asset_division_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: high_net_worth_divorce_asset_division_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: high_net_worth_divorce_asset_division_calculatorCalculatorInputs, metrics: high_net_worth_divorce_asset_division_calculatorCalculatorMetrics): high_net_worth_divorce_asset_division_calculatorCalculatorAnalysis {
