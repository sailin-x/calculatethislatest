import { dao_governance_token_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: dao_governance_token_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
