import { dao_governance_token_calculatorCalculatorInputs, dao_governance_token_calculatorCalculatorMetrics, dao_governance_token_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: dao_governance_token_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: dao_governance_token_calculatorCalculatorInputs, metrics: dao_governance_token_calculatorCalculatorMetrics): dao_governance_token_calculatorCalculatorAnalysis {
