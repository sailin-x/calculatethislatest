import { dog_bite_settlement_calculatorInputs, dog_bite_settlement_calculatorMetrics, dog_bite_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: dog_bite_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: dog_bite_settlement_calculatorInputs, metrics: dog_bite_settlement_calculatorMetrics): dog_bite_settlement_calculatorAnalysis {
