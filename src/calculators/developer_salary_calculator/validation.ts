import { developer_salary_calculatorInputs } from './types';

export function validateInputs(inputs: developer_salary_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
