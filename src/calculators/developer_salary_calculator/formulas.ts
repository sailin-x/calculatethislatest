import { developer_salary_calculatorInputs, developer_salary_calculatorMetrics, developer_salary_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: developer_salary_calculatorInputs): number {
...
export function generateAnalysis(inputs: developer_salary_calculatorInputs, metrics: developer_salary_calculatorMetrics): developer_salary_calculatorAnalysis {
