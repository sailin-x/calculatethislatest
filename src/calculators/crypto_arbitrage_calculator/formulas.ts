import { crypto_arbitrage_calculatorInputs, crypto_arbitrage_calculatorMetrics, crypto_arbitrage_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: crypto_arbitrage_calculatorInputs): number {
...
export function generateAnalysis(inputs: crypto_arbitrage_calculatorInputs, metrics: crypto_arbitrage_calculatorMetrics): crypto_arbitrage_calculatorAnalysis {
