import { invoice_financing_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: invoice_financing_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
