import { invoice_financing_calculatorCalculatorInputs, invoice_financing_calculatorCalculatorMetrics, invoice_financing_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: invoice_financing_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: invoice_financing_calculatorCalculatorInputs, metrics: invoice_financing_calculatorCalculatorMetrics): invoice_financing_calculatorCalculatorAnalysis {
