import { commercial_auto_insurance_calculatorCalculatorInputs, commercial_auto_insurance_calculatorCalculatorMetrics, commercial_auto_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: commercial_auto_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: commercial_auto_insurance_calculatorCalculatorInputs, metrics: commercial_auto_insurance_calculatorCalculatorMetrics): commercial_auto_insurance_calculatorCalculatorAnalysis {
