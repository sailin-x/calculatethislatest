import { data_science_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: data_science_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
