import { data_science_calculatorCalculatorInputs, data_science_calculatorCalculatorMetrics, data_science_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: data_science_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: data_science_calculatorCalculatorInputs, metrics: data_science_calculatorCalculatorMetrics): data_science_calculatorCalculatorAnalysis {
