import { arm_mortgageCalculatorInputs, arm_mortgageCalculatorMetrics, arm_mortgageCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: arm_mortgageCalculatorInputs): number {
...
export function generateAnalysis(inputs: arm_mortgageCalculatorInputs, metrics: arm_mortgageCalculatorMetrics): arm_mortgageCalculatorAnalysis {
