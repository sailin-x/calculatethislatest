import { qui_tam_whistleblower_reward_calculatorCalculatorInputs, qui_tam_whistleblower_reward_calculatorCalculatorMetrics, qui_tam_whistleblower_reward_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: qui_tam_whistleblower_reward_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: qui_tam_whistleblower_reward_calculatorCalculatorInputs, metrics: qui_tam_whistleblower_reward_calculatorCalculatorMetrics): qui_tam_whistleblower_reward_calculatorCalculatorAnalysis {
