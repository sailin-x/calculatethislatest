import { database_calculatorCalculatorInputs, database_calculatorCalculatorMetrics, database_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: database_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: database_calculatorCalculatorInputs, metrics: database_calculatorCalculatorMetrics): database_calculatorCalculatorAnalysis {
