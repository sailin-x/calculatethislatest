import { insurance_claim_calculatorInputs } from './types';

export function validateInputs(inputs: insurance_claim_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
