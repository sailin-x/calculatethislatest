import { film_slate_financing_roi_calculatorCalculatorInputs, film_slate_financing_roi_calculatorCalculatorMetrics, film_slate_financing_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: film_slate_financing_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: film_slate_financing_roi_calculatorCalculatorInputs, metrics: film_slate_financing_roi_calculatorCalculatorMetrics): film_slate_financing_roi_calculatorCalculatorAnalysis {
