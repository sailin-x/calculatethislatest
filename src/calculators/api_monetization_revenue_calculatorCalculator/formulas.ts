import { api_monetization_revenue_calculatorCalculatorInputs, api_monetization_revenue_calculatorCalculatorMetrics, api_monetization_revenue_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: api_monetization_revenue_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: api_monetization_revenue_calculatorCalculatorInputs, metrics: api_monetization_revenue_calculatorCalculatorMetrics): api_monetization_revenue_calculatorCalculatorAnalysis {
