import { marine_cargo_calculatorInputs, marine_cargo_calculatorMetrics, marine_cargo_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: marine_cargo_calculatorInputs): number {
...
export function generateAnalysis(inputs: marine_cargo_calculatorInputs, metrics: marine_cargo_calculatorMetrics): marine_cargo_calculatorAnalysis {
