import { real_estate_waterfall_model_calculatorCalculatorInputs, real_estate_waterfall_model_calculatorCalculatorMetrics, real_estate_waterfall_model_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: real_estate_waterfall_model_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: real_estate_waterfall_model_calculatorCalculatorInputs, metrics: real_estate_waterfall_model_calculatorCalculatorMetrics): real_estate_waterfall_model_calculatorCalculatorAnalysis {
