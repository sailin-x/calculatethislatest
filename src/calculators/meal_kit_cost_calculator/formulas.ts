import { meal_kit_cost_calculatorInputs, meal_kit_cost_calculatorMetrics, meal_kit_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: meal_kit_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: meal_kit_cost_calculatorInputs, metrics: meal_kit_cost_calculatorMetrics): meal_kit_cost_calculatorAnalysis {
