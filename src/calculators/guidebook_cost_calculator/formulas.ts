import { guidebook_cost_calculatorInputs, guidebook_cost_calculatorMetrics, guidebook_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: guidebook_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: guidebook_cost_calculatorInputs, metrics: guidebook_cost_calculatorMetrics): guidebook_cost_calculatorAnalysis {
