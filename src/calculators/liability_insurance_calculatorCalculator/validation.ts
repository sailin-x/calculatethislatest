import { liability_insurance_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: liability_insurance_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
