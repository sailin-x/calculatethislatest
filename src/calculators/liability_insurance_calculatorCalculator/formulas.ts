import { liability_insurance_calculatorCalculatorInputs, liability_insurance_calculatorCalculatorMetrics, liability_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: liability_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: liability_insurance_calculatorCalculatorInputs, metrics: liability_insurance_calculatorCalculatorMetrics): liability_insurance_calculatorCalculatorAnalysis {
