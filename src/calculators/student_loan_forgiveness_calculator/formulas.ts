import { student_loan_forgiveness_calculatorInputs, student_loan_forgiveness_calculatorMetrics, student_loan_forgiveness_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: student_loan_forgiveness_calculatorInputs): number {
...
export function generateAnalysis(inputs: student_loan_forgiveness_calculatorInputs, metrics: student_loan_forgiveness_calculatorMetrics): student_loan_forgiveness_calculatorAnalysis {
