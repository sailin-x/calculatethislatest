import { accretion_dilutionCalculatorInputs } from './types';

export function validateInputs(inputs: accretion_dilutionCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
