import { accretion_dilutionCalculatorInputs, accretion_dilutionCalculatorMetrics, accretion_dilutionCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: accretion_dilutionCalculatorInputs): number {
...
export function generateAnalysis(inputs: accretion_dilutionCalculatorInputs, metrics: accretion_dilutionCalculatorMetrics): accretion_dilutionCalculatorAnalysis {
