import { statisticsCalculatorInputs, statisticsCalculatorMetrics, statisticsCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: statisticsCalculatorInputs): number {
...
export function generateAnalysis(inputs: statisticsCalculatorInputs, metrics: statisticsCalculatorMetrics): statisticsCalculatorAnalysis {
