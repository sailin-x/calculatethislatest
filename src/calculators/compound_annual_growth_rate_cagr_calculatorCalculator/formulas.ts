import { compound_annual_growth_rate_cagr_calculatorCalculatorInputs, compound_annual_growth_rate_cagr_calculatorCalculatorMetrics, compound_annual_growth_rate_cagr_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: compound_annual_growth_rate_cagr_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: compound_annual_growth_rate_cagr_calculatorCalculatorInputs, metrics: compound_annual_growth_rate_cagr_calculatorCalculatorMetrics): compound_annual_growth_rate_cagr_calculatorCalculatorAnalysis {
