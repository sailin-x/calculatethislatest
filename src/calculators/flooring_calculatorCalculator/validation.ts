import { flooring_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: flooring_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
