import { flooring_calculatorCalculatorInputs, flooring_calculatorCalculatorMetrics, flooring_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: flooring_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: flooring_calculatorCalculatorInputs, metrics: flooring_calculatorCalculatorMetrics): flooring_calculatorCalculatorAnalysis {
