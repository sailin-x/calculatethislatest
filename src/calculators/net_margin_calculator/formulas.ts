import { net_margin_calculatorInputs, net_margin_calculatorMetrics, net_margin_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: net_margin_calculatorInputs): number {
...
export function generateAnalysis(inputs: net_margin_calculatorInputs, metrics: net_margin_calculatorMetrics): net_margin_calculatorAnalysis {
