import { flexible_spending_account_calculatorCalculatorInputs, flexible_spending_account_calculatorCalculatorMetrics, flexible_spending_account_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: flexible_spending_account_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: flexible_spending_account_calculatorCalculatorInputs, metrics: flexible_spending_account_calculatorCalculatorMetrics): flexible_spending_account_calculatorCalculatorAnalysis {
