import { overall_equipment_effectiveness_oee_calculatorCalculatorInputs, overall_equipment_effectiveness_oee_calculatorCalculatorMetrics, overall_equipment_effectiveness_oee_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: overall_equipment_effectiveness_oee_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: overall_equipment_effectiveness_oee_calculatorCalculatorInputs, metrics: overall_equipment_effectiveness_oee_calculatorCalculatorMetrics): overall_equipment_effectiveness_oee_calculatorCalculatorAnalysis {
