import { golf_lesson_cost_calculatorInputs, golf_lesson_cost_calculatorMetrics, golf_lesson_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: golf_lesson_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: golf_lesson_cost_calculatorInputs, metrics: golf_lesson_cost_calculatorMetrics): golf_lesson_cost_calculatorAnalysis {
