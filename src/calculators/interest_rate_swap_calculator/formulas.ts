import { interest_rate_swap_calculatorInputs, interest_rate_swap_calculatorMetrics, interest_rate_swap_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: interest_rate_swap_calculatorInputs): number {
...
export function generateAnalysis(inputs: interest_rate_swap_calculatorInputs, metrics: interest_rate_swap_calculatorMetrics): interest_rate_swap_calculatorAnalysis {
