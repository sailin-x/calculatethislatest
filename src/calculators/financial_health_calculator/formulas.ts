import { financial_health_calculatorInputs, financial_health_calculatorMetrics, financial_health_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_health_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_health_calculatorInputs, metrics: financial_health_calculatorMetrics): financial_health_calculatorAnalysis {
