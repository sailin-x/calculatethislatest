import { financial_health_calculatorInputs } from './types';

export function validateInputs(inputs: financial_health_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
