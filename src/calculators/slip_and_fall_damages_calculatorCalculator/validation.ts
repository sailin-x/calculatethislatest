import { slip_and_fall_damages_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: slip_and_fall_damages_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
