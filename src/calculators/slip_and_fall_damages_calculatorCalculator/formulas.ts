import { slip_and_fall_damages_calculatorCalculatorInputs, slip_and_fall_damages_calculatorCalculatorMetrics, slip_and_fall_damages_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: slip_and_fall_damages_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: slip_and_fall_damages_calculatorCalculatorInputs, metrics: slip_and_fall_damages_calculatorCalculatorMetrics): slip_and_fall_damages_calculatorCalculatorAnalysis {
