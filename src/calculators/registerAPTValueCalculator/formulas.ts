import { registerAPTValueCalculatorInputs, registerAPTValueCalculatorMetrics, registerAPTValueCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerAPTValueCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerAPTValueCalculatorInputs, metrics: registerAPTValueCalculatorMetrics): registerAPTValueCalculatorAnalysis {
