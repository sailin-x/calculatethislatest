import { registerAPTValueCalculatorInputs } from './types';

export function validateInputs(inputs: registerAPTValueCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
