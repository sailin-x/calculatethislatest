import { protein_calculatorInputs, protein_calculatorMetrics, protein_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: protein_calculatorInputs): number {
...
export function generateAnalysis(inputs: protein_calculatorInputs, metrics: protein_calculatorMetrics): protein_calculatorAnalysis {
