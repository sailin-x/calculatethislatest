import { split_dollar_life_insurance_calculatorInputs, split_dollar_life_insurance_calculatorMetrics, split_dollar_life_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: split_dollar_life_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: split_dollar_life_insurance_calculatorInputs, metrics: split_dollar_life_insurance_calculatorMetrics): split_dollar_life_insurance_calculatorAnalysis {
