import { lifeSettlementValueCalculatorInputs, lifeSettlementValueCalculatorMetrics, lifeSettlementValueCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: lifeSettlementValueCalculatorInputs): number {
...
export function generateAnalysis(inputs: lifeSettlementValueCalculatorInputs, metrics: lifeSettlementValueCalculatorMetrics): lifeSettlementValueCalculatorAnalysis {
