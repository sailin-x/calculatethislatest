import { registerExecutiveDeferredCompensationCalculatorInputs, registerExecutiveDeferredCompensationCalculatorMetrics, registerExecutiveDeferredCompensationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerExecutiveDeferredCompensationCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerExecutiveDeferredCompensationCalculatorInputs, metrics: registerExecutiveDeferredCompensationCalculatorMetrics): registerExecutiveDeferredCompensationCalculatorAnalysis {
