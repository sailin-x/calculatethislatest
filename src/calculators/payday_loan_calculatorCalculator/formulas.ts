import { payday_loan_calculatorCalculatorInputs, payday_loan_calculatorCalculatorMetrics, payday_loan_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: payday_loan_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: payday_loan_calculatorCalculatorInputs, metrics: payday_loan_calculatorCalculatorMetrics): payday_loan_calculatorCalculatorAnalysis {
