import { asbestos_settlement_calculatorInputs, asbestos_settlement_calculatorMetrics, asbestos_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: asbestos_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: asbestos_settlement_calculatorInputs, metrics: asbestos_settlement_calculatorMetrics): asbestos_settlement_calculatorAnalysis {
