import { timberlandInvestmentCalculatorInputs } from './types';

export function validateInputs(inputs: timberlandInvestmentCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
