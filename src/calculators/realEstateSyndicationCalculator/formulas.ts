import { realEstateSyndicationCalculatorInputs, realEstateSyndicationCalculatorMetrics, realEstateSyndicationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: realEstateSyndicationCalculatorInputs): number {
...
export function generateAnalysis(inputs: realEstateSyndicationCalculatorInputs, metrics: realEstateSyndicationCalculatorMetrics): realEstateSyndicationCalculatorAnalysis {
