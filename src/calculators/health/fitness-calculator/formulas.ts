import { fitness-calculatorInputs, fitness-calculatorMetrics, fitness-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fitness-calculatorInputs): number {
...
export function generateAnalysis(inputs: fitness-calculatorInputs, metrics: fitness-calculatorMetrics): fitness-calculatorAnalysis {
