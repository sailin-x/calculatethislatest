...
import { FitnessCalculatorInputs, FitnessCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateFitnessCalculatorInputs } from './validation';

export const FitnessCalculator: Calculator = {
  id: 'fitness-calculator',
  title: 'Fitness Calculator',
  category: 'health',
  subcategory: 'General',
  description: 'Calculate fitness metrics and goals',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
