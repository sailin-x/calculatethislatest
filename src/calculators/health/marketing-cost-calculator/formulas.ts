import { MarketingCostCalculatorinputs, MarketingCostCalculatormetrics, MarketingCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: MarketingCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: MarketingCostCalculatorinputs, metrics: MarketingCostCalculatormetrics): MarketingCostCalculatoranalysis {
