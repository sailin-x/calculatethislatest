import { marketing-cost-calculatorInputs, marketing-cost-calculatorMetrics, marketing-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: marketing-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: marketing-cost-calculatorInputs, metrics: marketing-cost-calculatorMetrics): marketing-cost-calculatorAnalysis {
