import { CarRentalCost-calculatorInputs, CarRentalCost-calculatorMetrics, CarRentalCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: CarRentalCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: CarRentalCost-calculatorInputs, metrics: CarRentalCost-calculatorMetrics): CarRentalCost-calculatorAnalysis {
