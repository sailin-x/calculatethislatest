import { car-rental-cost-calculatorInputs, car-rental-cost-calculatorMetrics, car-rental-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: car-rental-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: car-rental-cost-calculatorInputs, metrics: car-rental-cost-calculatorMetrics): car-rental-cost-calculatorAnalysis {
