import { national-park-cost-calculatorInputs, national-park-cost-calculatorMetrics, national-park-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: national-park-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: national-park-cost-calculatorInputs, metrics: national-park-cost-calculatorMetrics): national-park-cost-calculatorAnalysis {
