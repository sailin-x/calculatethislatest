import { NationalParkCost-calculatorInputs, NationalParkCost-calculatorMetrics, NationalParkCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: NationalParkCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: NationalParkCost-calculatorInputs, metrics: NationalParkCost-calculatorMetrics): NationalParkCost-calculatorAnalysis {
