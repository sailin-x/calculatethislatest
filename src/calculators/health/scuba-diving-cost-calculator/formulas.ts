import { ScubaDivingCost-calculatorInputs, ScubaDivingCost-calculatorMetrics, ScubaDivingCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ScubaDivingCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: ScubaDivingCost-calculatorInputs, metrics: ScubaDivingCost-calculatorMetrics): ScubaDivingCost-calculatorAnalysis {
