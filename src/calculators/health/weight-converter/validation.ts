import { WeightConverterInputs } from './types';

export function validateWeightConverterInputs(inputs: WeightConverterInputs): Array<{ field: string; message: string }> {
...
export function validateWeightConverterBusinessRules(inputs: WeightConverterInputs): Array<{ field: string; message: string }> {
