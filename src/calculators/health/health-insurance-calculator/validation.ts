import { HealthInsuranceCalculatorInputs } from './types';

export function validateHealthInsuranceCalculatorInputs(inputs: HealthInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateHealthInsuranceCalculatorBusinessRules(inputs: HealthInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
