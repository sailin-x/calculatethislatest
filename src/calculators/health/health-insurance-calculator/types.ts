export interface HealthInsuranceCalculatorInputs {
...
export interface HealthInsuranceCalculatorOutputs {
...
export interface HealthInsuranceCalculatorMetrics {
...
export interface HealthInsuranceCalculatorAnalysis {
