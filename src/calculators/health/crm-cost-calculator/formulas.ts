import { CrmCostCalculatorinputs, CrmCostCalculatormetrics, CrmCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: CrmCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: CrmCostCalculatorinputs, metrics: CrmCostCalculatormetrics): CrmCostCalculatoranalysis {
