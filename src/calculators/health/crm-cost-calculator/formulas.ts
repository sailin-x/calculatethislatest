import { crm-cost-calculatorInputs, crm-cost-calculatorMetrics, crm-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: crm-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: crm-cost-calculatorInputs, metrics: crm-cost-calculatorMetrics): crm-cost-calculatorAnalysis {
