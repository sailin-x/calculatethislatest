import { TelehealthProgramRoiCalculatorInputs } from './types';

export function validateTelehealthProgramRoiCalculatorInputs(inputs: TelehealthProgramRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTelehealthProgramRoiCalculatorBusinessRules(inputs: TelehealthProgramRoiCalculatorInputs): Array<{ field: string; message: string }> {
