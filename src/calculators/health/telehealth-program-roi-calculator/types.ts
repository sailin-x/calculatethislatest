export interface TelehealthProgramRoiCalculatorInputs {
...
export interface TelehealthProgramRoiCalculatorOutputs {
...
export interface TelehealthProgramRoiCalculatorMetrics {
...
export interface TelehealthProgramRoiCalculatorAnalysis {
