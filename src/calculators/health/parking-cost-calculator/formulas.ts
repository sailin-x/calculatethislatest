import { parking-cost-calculatorInputs, parking-cost-calculatorMetrics, parking-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: parking-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: parking-cost-calculatorInputs, metrics: parking-cost-calculatorMetrics): parking-cost-calculatorAnalysis {
