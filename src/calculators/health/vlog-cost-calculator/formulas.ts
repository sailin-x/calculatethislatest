import { vlog-cost-calculatorInputs, vlog-cost-calculatorMetrics, vlog-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: vlog-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: vlog-cost-calculatorInputs, metrics: vlog-cost-calculatorMetrics): vlog-cost-calculatorAnalysis {
