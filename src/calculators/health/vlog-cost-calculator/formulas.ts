import { VlogCostCalculatorinputs, VlogCostCalculatormetrics, VlogCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: VlogCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: VlogCostCalculatorinputs, metrics: VlogCostCalculatormetrics): VlogCostCalculatoranalysis {
