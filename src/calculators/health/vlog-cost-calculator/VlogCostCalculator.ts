...
import { VlogCostCalculatorInputs, VlogCostCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateVlogCostCalculatorInputs } from './validation';

export const VlogCostCalculator: Calculator = {
  id: 'vlog-cost-calculator',
  title: 'Vlog Cost Calculator',
  category: 'health',
  subcategory: 'General',
  description: 'Calculate travel vlogging costs',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
