import { LandscapingCostCalculatorinputs, LandscapingCostCalculatormetrics, LandscapingCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: LandscapingCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: LandscapingCostCalculatorinputs, metrics: LandscapingCostCalculatormetrics): LandscapingCostCalculatoranalysis {
