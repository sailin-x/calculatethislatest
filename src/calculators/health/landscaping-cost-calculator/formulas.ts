import { landscaping-cost-calculatorInputs, landscaping-cost-calculatorMetrics, landscaping-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: landscaping-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: landscaping-cost-calculatorInputs, metrics: landscaping-cost-calculatorMetrics): landscaping-cost-calculatorAnalysis {
