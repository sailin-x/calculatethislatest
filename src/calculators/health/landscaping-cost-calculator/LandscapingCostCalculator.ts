...
import { LandscapingCostCalculatorInputs, LandscapingCostCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateLandscapingCostCalculatorInputs } from './validation';

export const LandscapingCostCalculator: Calculator = {
  id: 'LandscapingCostCalculator',
  title: 'Landscaping Cost Calculator',
  category: 'health',
  subcategory: 'General',
  description: 'Calculate landscaping costs',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
