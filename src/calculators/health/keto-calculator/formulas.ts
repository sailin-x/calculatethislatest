import { keto-calculatorInputs, keto-calculatorMetrics, keto-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: keto-calculatorInputs): number {
...
export function generateAnalysis(inputs: keto-calculatorInputs, metrics: keto-calculatorMetrics): keto-calculatorAnalysis {
