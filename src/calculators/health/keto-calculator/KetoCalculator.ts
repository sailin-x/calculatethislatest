...
import { KetoCalculatorInputs, KetoCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateKetoCalculatorInputs } from './validation';

export const KetoCalculator: Calculator = {
  id: 'keto-calculator',
  title: 'Keto Calculator',
  category: 'health',
  subcategory: 'General',
  description: 'Calculate ketogenic diet macros',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
