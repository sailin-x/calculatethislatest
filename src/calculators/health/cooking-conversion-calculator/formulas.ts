import { cooking-conversion-calculatorInputs, cooking-conversion-calculatorMetrics, cooking-conversion-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cooking-conversion-calculatorInputs): number {
...
export function generateAnalysis(inputs: cooking-conversion-calculatorInputs, metrics: cooking-conversion-calculatorMetrics): cooking-conversion-calculatorAnalysis {
