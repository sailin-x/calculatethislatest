import { CookingConversionCalculatorinputs, CookingConversionCalculatormetrics, CookingConversionCalculatoranalysis } from './types';
...
export function calculateResult(inputs: CookingConversionCalculatorinputs): number {
...
export function generateAnalysis(inputs: CookingConversionCalculatorinputs, metrics: CookingConversionCalculatormetrics): CookingConversionCalculatoranalysis {
