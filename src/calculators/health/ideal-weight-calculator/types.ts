export interface IdealWeightCalculatorInputs {
...
export interface IdealWeightCalculatorOutputs {
...
export interface IdealWeightCalculatorMetrics {
...
export interface IdealWeightCalculatorAnalysis {
