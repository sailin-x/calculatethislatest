import { IdealWeightCalculatorInputs } from './types';

export function validateIdealWeightCalculatorInputs(inputs: IdealWeightCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateIdealWeightCalculatorBusinessRules(inputs: IdealWeightCalculatorInputs): Array<{ field: string; message: string }> {
