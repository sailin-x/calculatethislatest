import { composting-savings-calculatorInputs, composting-savings-calculatorMetrics, composting-savings-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: composting-savings-calculatorInputs): number {
...
export function generateAnalysis(inputs: composting-savings-calculatorInputs, metrics: composting-savings-calculatorMetrics): composting-savings-calculatorAnalysis {
