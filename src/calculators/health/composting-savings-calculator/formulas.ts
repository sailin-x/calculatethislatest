import { CompostingSavingsCalculatorinputs, CompostingSavingsCalculatormetrics, CompostingSavingsCalculatoranalysis } from './types';
...
export function calculateResult(inputs: CompostingSavingsCalculatorinputs): number {
...
export function generateAnalysis(inputs: CompostingSavingsCalculatorinputs, metrics: CompostingSavingsCalculatormetrics): CompostingSavingsCalculatoranalysis {
