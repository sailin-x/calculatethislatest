import { LuggageCostCalculatorinputs, LuggageCostCalculatormetrics, LuggageCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: LuggageCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: LuggageCostCalculatorinputs, metrics: LuggageCostCalculatormetrics): LuggageCostCalculatoranalysis {
