import { luggage-cost-calculatorInputs, luggage-cost-calculatorMetrics, luggage-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: luggage-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: luggage-cost-calculatorInputs, metrics: luggage-cost-calculatorMetrics): luggage-cost-calculatorAnalysis {
