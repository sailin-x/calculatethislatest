import { RestaurantTipCalculatorinputs, RestaurantTipCalculatormetrics, RestaurantTipCalculatoranalysis } from './types';
...
export function calculateResult(inputs: RestaurantTipCalculatorinputs): number {
...
export function generateAnalysis(inputs: RestaurantTipCalculatorinputs, metrics: RestaurantTipCalculatormetrics): RestaurantTipCalculatoranalysis {
