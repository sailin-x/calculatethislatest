import { restaurant-tip-calculatorInputs, restaurant-tip-calculatorMetrics, restaurant-tip-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: restaurant-tip-calculatorInputs): number {
...
export function generateAnalysis(inputs: restaurant-tip-calculatorInputs, metrics: restaurant-tip-calculatorMetrics): restaurant-tip-calculatorAnalysis {
