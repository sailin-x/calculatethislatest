...
import { ConcertTicketCostCalculatorInputs, ConcertTicketCostCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateConcertTicketCostCalculatorInputs } from './validation';

export const ConcertTicketCostCalculator: Calculator = {
  id: 'concert-ticket-cost-calculator',
  title: 'Concert Ticket Cost Calculator',
  category: 'health',
  subcategory: 'General',
  description: 'Calculate concert ticket costs',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
