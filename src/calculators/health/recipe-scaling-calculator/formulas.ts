import { recipe-scaling-calculatorInputs, recipe-scaling-calculatorMetrics, recipe-scaling-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: recipe-scaling-calculatorInputs): number {
...
export function generateAnalysis(inputs: recipe-scaling-calculatorInputs, metrics: recipe-scaling-calculatorMetrics): recipe-scaling-calculatorAnalysis {
