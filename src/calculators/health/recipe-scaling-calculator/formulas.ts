import { RecipeScalingCalculatorinputs, RecipeScalingCalculatormetrics, RecipeScalingCalculatoranalysis } from './types';
...
export function calculateResult(inputs: RecipeScalingCalculatorinputs): number {
...
export function generateAnalysis(inputs: RecipeScalingCalculatorinputs, metrics: RecipeScalingCalculatormetrics): RecipeScalingCalculatoranalysis {
