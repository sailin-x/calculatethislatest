import { irrigation-calculatorInputs, irrigation-calculatorMetrics, irrigation-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: irrigation-calculatorInputs): number {
...
export function generateAnalysis(inputs: irrigation-calculatorInputs, metrics: irrigation-calculatorMetrics): irrigation-calculatorAnalysis {
