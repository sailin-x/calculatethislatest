import { anti-aging-cost-calculatorInputs, anti-aging-cost-calculatorMetrics, anti-aging-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: anti-aging-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: anti-aging-cost-calculatorInputs, metrics: anti-aging-cost-calculatorMetrics): anti-aging-cost-calculatorAnalysis {
