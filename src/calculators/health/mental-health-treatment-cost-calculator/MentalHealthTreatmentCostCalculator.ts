...
import { MentalHealthTreatmentCostCalculatorInputs, MentalHealthTreatmentCostCalculatorOutputs } from './types';
...
export const MentalHealthTreatmentCostCalculator: Calculator = {
  ...
  category: 'health',
  subcategory: 'General',
  description: 'Calculate mental health treatment costs',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
