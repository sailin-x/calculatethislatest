import { passport-cost-calculatorInputs, passport-cost-calculatorMetrics, passport-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: passport-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: passport-cost-calculatorInputs, metrics: passport-cost-calculatorMetrics): passport-cost-calculatorAnalysis {
