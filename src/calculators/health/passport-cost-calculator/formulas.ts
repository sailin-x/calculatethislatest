import { PassportCostCalculatorinputs, PassportCostCalculatormetrics, PassportCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: PassportCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: PassportCostCalculatorinputs, metrics: PassportCostCalculatormetrics): PassportCostCalculatoranalysis {
