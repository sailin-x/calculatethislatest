import { CurrencyExchangeCost-calculatorInputs, CurrencyExchangeCost-calculatorMetrics, CurrencyExchangeCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: CurrencyExchangeCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: CurrencyExchangeCost-calculatorInputs, metrics: CurrencyExchangeCost-calculatorMetrics): CurrencyExchangeCost-calculatorAnalysis {
