import { currency-exchange-cost-calculatorInputs, currency-exchange-cost-calculatorMetrics, currency-exchange-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: currency-exchange-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: currency-exchange-cost-calculatorInputs, metrics: currency-exchange-cost-calculatorMetrics): currency-exchange-cost-calculatorAnalysis {
