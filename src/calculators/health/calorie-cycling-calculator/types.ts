export interface CalorieCyclingCalculatorInputs {
...
export interface CalorieCyclingCalculatorOutputs {
...
export interface CalorieCyclingCalculatorMetrics {
...
export interface CalorieCyclingCalculatorAnalysis {
