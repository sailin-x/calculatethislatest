import { CalorieCyclingCalculatorInputs } from './types';

export function validateCalorieCyclingCalculatorInputs(inputs: CalorieCyclingCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCalorieCyclingCalculatorBusinessRules(inputs: CalorieCyclingCalculatorInputs): Array<{ field: string; message: string }> {
