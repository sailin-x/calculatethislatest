import { spin-class-cost-calculatorInputs, spin-class-cost-calculatorMetrics, spin-class-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: spin-class-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: spin-class-cost-calculatorInputs, metrics: spin-class-cost-calculatorMetrics): spin-class-cost-calculatorAnalysis {
