import { SpinClassCost-calculatorInputs, SpinClassCost-calculatorMetrics, SpinClassCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: SpinClassCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: SpinClassCost-calculatorInputs, metrics: SpinClassCost-calculatorMetrics): SpinClassCost-calculatorAnalysis {
