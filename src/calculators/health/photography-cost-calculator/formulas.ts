import { PhotographyCostCalculatorinputs, PhotographyCostCalculatormetrics, PhotographyCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: PhotographyCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: PhotographyCostCalculatorinputs, metrics: PhotographyCostCalculatormetrics): PhotographyCostCalculatoranalysis {
