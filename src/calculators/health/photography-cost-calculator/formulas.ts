import { photography-cost-calculatorInputs, photography-cost-calculatorMetrics, photography-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: photography-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: photography-cost-calculatorInputs, metrics: photography-cost-calculatorMetrics): photography-cost-calculatorAnalysis {
