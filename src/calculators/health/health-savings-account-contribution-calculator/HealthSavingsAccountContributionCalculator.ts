...
import { HealthSavingsAccountContributionCalculatorInputs, HealthSavingsAccountContributionCalculatorOutputs } from './types';
...
export const HealthSavingsAccountContributionCalculator: Calculator = {
  ...
  category: 'health',
  subcategory: 'General',
  description: 'Calculate HSA contribution limits',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
