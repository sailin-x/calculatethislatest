import { PaintingCostCalculatorinputs, PaintingCostCalculatormetrics, PaintingCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: PaintingCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: PaintingCostCalculatorinputs, metrics: PaintingCostCalculatormetrics): PaintingCostCalculatoranalysis {
