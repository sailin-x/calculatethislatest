import { painting-cost-calculatorInputs, painting-cost-calculatorMetrics, painting-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: painting-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: painting-cost-calculatorInputs, metrics: painting-cost-calculatorMetrics): painting-cost-calculatorAnalysis {
