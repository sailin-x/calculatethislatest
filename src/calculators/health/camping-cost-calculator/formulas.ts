import { CampingCostCalculatorinputs, CampingCostCalculatormetrics, CampingCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: CampingCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: CampingCostCalculatorinputs, metrics: CampingCostCalculatormetrics): CampingCostCalculatoranalysis {
