import { camping-cost-calculatorInputs, camping-cost-calculatorMetrics, camping-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: camping-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: camping-cost-calculatorInputs, metrics: camping-cost-calculatorMetrics): camping-cost-calculatorAnalysis {
