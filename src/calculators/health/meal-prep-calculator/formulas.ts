import { meal-prep-calculatorInputs, meal-prep-calculatorMetrics, meal-prep-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: meal-prep-calculatorInputs): number {
...
export function generateAnalysis(inputs: meal-prep-calculatorInputs, metrics: meal-prep-calculatorMetrics): meal-prep-calculatorAnalysis {
