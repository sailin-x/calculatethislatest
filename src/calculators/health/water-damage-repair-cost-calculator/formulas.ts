import { water-damage-repair-cost-calculatorInputs, water-damage-repair-cost-calculatorMetrics, water-damage-repair-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: water-damage-repair-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: water-damage-repair-cost-calculatorInputs, metrics: water-damage-repair-cost-calculatorMetrics): water-damage-repair-cost-calculatorAnalysis {
