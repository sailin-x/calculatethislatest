import { WaterDamageRepair-cost-calculatorInputs, WaterDamageRepair-cost-calculatorMetrics, WaterDamageRepair-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: WaterDamageRepair-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: WaterDamageRepair-cost-calculatorInputs, metrics: WaterDamageRepair-cost-calculatorMetrics): WaterDamageRepair-cost-calculatorAnalysis {
