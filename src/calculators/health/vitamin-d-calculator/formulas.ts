import { vitamin-d-calculatorInputs, vitamin-d-calculatorMetrics, vitamin-d-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: vitamin-d-calculatorInputs): number {
...
export function generateAnalysis(inputs: vitamin-d-calculatorInputs, metrics: vitamin-d-calculatorMetrics): vitamin-d-calculatorAnalysis {
