import { VitaminDCalculatorinputs, VitaminDCalculatormetrics, VitaminDCalculatoranalysis } from './types';
...
export function calculateResult(inputs: VitaminDCalculatorinputs): number {
...
export function generateAnalysis(inputs: VitaminDCalculatorinputs, metrics: VitaminDCalculatormetrics): VitaminDCalculatoranalysis {
