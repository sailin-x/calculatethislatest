import { personal-trainer-cost-calculatorInputs, personal-trainer-cost-calculatorMetrics, personal-trainer-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: personal-trainer-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: personal-trainer-cost-calculatorInputs, metrics: personal-trainer-cost-calculatorMetrics): personal-trainer-cost-calculatorAnalysis {
