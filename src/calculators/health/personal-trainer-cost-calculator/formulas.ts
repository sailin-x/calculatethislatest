import { PersonalTrainerCost-calculatorInputs, PersonalTrainerCost-calculatorMetrics, PersonalTrainerCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: PersonalTrainerCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: PersonalTrainerCost-calculatorInputs, metrics: PersonalTrainerCost-calculatorMetrics): PersonalTrainerCost-calculatorAnalysis {
