import { mold-remediation-cost-calculatorInputs, mold-remediation-cost-calculatorMetrics, mold-remediation-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: mold-remediation-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: mold-remediation-cost-calculatorInputs, metrics: mold-remediation-cost-calculatorMetrics): mold-remediation-cost-calculatorAnalysis {
