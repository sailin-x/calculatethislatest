import { MoldRemediationCost-calculatorInputs, MoldRemediationCost-calculatorMetrics, MoldRemediationCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: MoldRemediationCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: MoldRemediationCost-calculatorInputs, metrics: MoldRemediationCost-calculatorMetrics): MoldRemediationCost-calculatorAnalysis {
