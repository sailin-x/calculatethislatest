import { TheaterTicketCost-calculatorInputs, TheaterTicketCost-calculatorMetrics, TheaterTicketCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: TheaterTicketCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: TheaterTicketCost-calculatorInputs, metrics: TheaterTicketCost-calculatorMetrics): TheaterTicketCost-calculatorAnalysis {
