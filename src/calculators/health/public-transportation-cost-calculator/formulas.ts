import { PublicTransportationCost-calculatorInputs, PublicTransportationCost-calculatorMetrics, PublicTransportationCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: PublicTransportationCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: PublicTransportationCost-calculatorInputs, metrics: PublicTransportationCost-calculatorMetrics): PublicTransportationCost-calculatorAnalysis {
