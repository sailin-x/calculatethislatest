...
import { InsuranceClaimCalculatorInputs, InsuranceClaimCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateInsuranceClaimCalculatorInputs } from './validation';

export const InsuranceClaimCalculator: Calculator = {
  id: 'insurance-claim-calculator',
  title: 'Insurance Claim Calculator',
  category: 'health',
  subcategory: 'General',
  description: 'Calculate insurance claim settlements',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
