import { WeightWatchersCalculatorInputs } from './types';

export function validateWeightWatchersCalculatorInputs(inputs: WeightWatchersCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateWeightWatchersCalculatorBusinessRules(inputs: WeightWatchersCalculatorInputs): Array<{ field: string; message: string }> {
