export interface WeightWatchersCalculatorInputs {
...
export interface WeightWatchersCalculatorOutputs {
...
export interface WeightWatchersCalculatorMetrics {
...
export interface WeightWatchersCalculatorAnalysis {
