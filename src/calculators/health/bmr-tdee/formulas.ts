import { bmr-tdeeInputs, bmr-tdeeMetrics, bmr-tdeeAnalysis } from './types';
...
export function calculateResult(inputs: bmr-tdeeInputs): number {
...
export function generateAnalysis(inputs: bmr-tdeeInputs, metrics: bmr-tdeeMetrics): bmr-tdeeAnalysis {
