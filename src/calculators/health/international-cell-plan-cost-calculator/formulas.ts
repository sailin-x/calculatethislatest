import { InternationalCellPlan-cost-calculatorInputs, InternationalCellPlan-cost-calculatorMetrics, InternationalCellPlan-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: InternationalCellPlan-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: InternationalCellPlan-cost-calculatorInputs, metrics: InternationalCellPlan-cost-calculatorMetrics): InternationalCellPlan-cost-calculatorAnalysis {
