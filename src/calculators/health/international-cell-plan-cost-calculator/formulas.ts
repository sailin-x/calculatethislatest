import { international-cell-plan-cost-calculatorInputs, international-cell-plan-cost-calculatorMetrics, international-cell-plan-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: international-cell-plan-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: international-cell-plan-cost-calculatorInputs, metrics: international-cell-plan-cost-calculatorMetrics): international-cell-plan-cost-calculatorAnalysis {
