...
import { InternationalCellPlanCostCalculatorInputs, InternationalCellPlanCostCalculatorOutputs } from './types';
...
export const InternationalCellPlanCostCalculator: Calculator = {
  ...
  category: 'health',
  subcategory: 'General',
  description: 'Calculate international cell plan costs',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
