import { SkiLessonCost-calculatorInputs, SkiLessonCost-calculatorMetrics, SkiLessonCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: SkiLessonCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: SkiLessonCost-calculatorInputs, metrics: SkiLessonCost-calculatorMetrics): SkiLessonCost-calculatorAnalysis {
