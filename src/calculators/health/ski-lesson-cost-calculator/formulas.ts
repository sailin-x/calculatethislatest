import { ski-lesson-cost-calculatorInputs, ski-lesson-cost-calculatorMetrics, ski-lesson-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ski-lesson-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: ski-lesson-cost-calculatorInputs, metrics: ski-lesson-cost-calculatorMetrics): ski-lesson-cost-calculatorAnalysis {
