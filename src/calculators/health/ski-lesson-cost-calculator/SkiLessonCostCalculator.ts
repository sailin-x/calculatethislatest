...
import { SkiLessonCostCalculatorInputs, SkiLessonCostCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateSkiLessonCostCalculatorInputs } from './validation';

export const SkiLessonCostCalculator: Calculator = {
  id: 'ski-lesson-cost-calculator',
  title: 'Ski Lesson Cost Calculator',
  category: 'health',
  subcategory: 'General',
  description: 'Calculate ski lesson costs',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
