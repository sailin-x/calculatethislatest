import { CaloriesBurnedCalculatorInputs } from './types';

export function validateCaloriesBurnedCalculatorInputs(inputs: CaloriesBurnedCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCaloriesBurnedCalculatorBusinessRules(inputs: CaloriesBurnedCalculatorInputs): Array<{ field: string; message: string }> {
