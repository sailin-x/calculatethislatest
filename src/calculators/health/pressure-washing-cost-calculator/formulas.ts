import { pressure-washing-cost-calculatorInputs, pressure-washing-cost-calculatorMetrics, pressure-washing-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: pressure-washing-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: pressure-washing-cost-calculatorInputs, metrics: pressure-washing-cost-calculatorMetrics): pressure-washing-cost-calculatorAnalysis {
