import { PressureWashingCost-calculatorInputs, PressureWashingCost-calculatorMetrics, PressureWashingCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: PressureWashingCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: PressureWashingCost-calculatorInputs, metrics: PressureWashingCost-calculatorMetrics): PressureWashingCost-calculatorAnalysis {
