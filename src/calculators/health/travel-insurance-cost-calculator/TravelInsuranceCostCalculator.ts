...
import { TravelInsuranceCostCalculatorInputs, TravelInsuranceCostCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateTravelInsuranceCostCalculatorInputs } from './validation';

export const TravelInsuranceCostCalculator: Calculator = {
  id: 'travel-insurance-cost-calculator',
  title: 'Travel Insurance Cost Calculator',
  category: 'health',
  subcategory: 'General',
  description: 'Calculate travel insurance costs',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
