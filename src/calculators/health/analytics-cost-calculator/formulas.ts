import { analytics-cost-calculatorInputs, analytics-cost-calculatorMetrics, analytics-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: analytics-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: analytics-cost-calculatorInputs, metrics: analytics-cost-calculatorMetrics): analytics-cost-calculatorAnalysis {
