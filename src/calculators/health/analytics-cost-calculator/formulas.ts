import { AnalyticsCostCalculatorinputs, AnalyticsCostCalculatormetrics, AnalyticsCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: AnalyticsCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: AnalyticsCostCalculatorinputs, metrics: AnalyticsCostCalculatormetrics): AnalyticsCostCalculatoranalysis {
