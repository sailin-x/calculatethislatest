import { AdvertisingCostCalculatorinputs, AdvertisingCostCalculatormetrics, AdvertisingCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: AdvertisingCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: AdvertisingCostCalculatorinputs, metrics: AdvertisingCostCalculatormetrics): AdvertisingCostCalculatoranalysis {
