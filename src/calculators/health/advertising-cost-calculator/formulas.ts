import { advertising-cost-calculatorInputs, advertising-cost-calculatorMetrics, advertising-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: advertising-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: advertising-cost-calculatorInputs, metrics: advertising-cost-calculatorMetrics): advertising-cost-calculatorAnalysis {
