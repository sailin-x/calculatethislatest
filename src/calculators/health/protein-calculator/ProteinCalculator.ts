...
import { ProteinCalculatorInputs, ProteinCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateProteinCalculatorInputs } from './validation';

export const ProteinCalculator: Calculator = {
  id: 'protein-calculator',
  title: 'Protein Calculator',
  category: 'health',
  subcategory: 'General',
  description: 'Calculate protein requirements',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
