import { protein-calculatorInputs, protein-calculatorMetrics, protein-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: protein-calculatorInputs): number {
...
export function generateAnalysis(inputs: protein-calculatorInputs, metrics: protein-calculatorMetrics): protein-calculatorAnalysis {
