import { pool-maintenance-cost-calculatorInputs, pool-maintenance-cost-calculatorMetrics, pool-maintenance-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: pool-maintenance-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: pool-maintenance-cost-calculatorInputs, metrics: pool-maintenance-cost-calculatorMetrics): pool-maintenance-cost-calculatorAnalysis {
