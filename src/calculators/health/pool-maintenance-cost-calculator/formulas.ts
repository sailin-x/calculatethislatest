import { PoolMaintenanceCost-calculatorInputs, PoolMaintenanceCost-calculatorMetrics, PoolMaintenanceCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: PoolMaintenanceCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: PoolMaintenanceCost-calculatorInputs, metrics: PoolMaintenanceCost-calculatorMetrics): PoolMaintenanceCost-calculatorAnalysis {
