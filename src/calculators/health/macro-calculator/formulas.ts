import { macro-calculatorInputs, macro-calculatorMetrics, macro-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: macro-calculatorInputs): number {
...
export function generateAnalysis(inputs: macro-calculatorInputs, metrics: macro-calculatorMetrics): macro-calculatorAnalysis {
