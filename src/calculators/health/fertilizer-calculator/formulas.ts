import { fertilizer-calculatorInputs, fertilizer-calculatorMetrics, fertilizer-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fertilizer-calculatorInputs): number {
...
export function generateAnalysis(inputs: fertilizer-calculatorInputs, metrics: fertilizer-calculatorMetrics): fertilizer-calculatorAnalysis {
