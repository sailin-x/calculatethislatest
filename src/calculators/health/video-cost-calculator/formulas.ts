import { video-cost-calculatorInputs, video-cost-calculatorMetrics, video-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: video-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: video-cost-calculatorInputs, metrics: video-cost-calculatorMetrics): video-cost-calculatorAnalysis {
