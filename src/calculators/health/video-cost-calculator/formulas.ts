import { VideoCostCalculatorinputs, VideoCostCalculatormetrics, VideoCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: VideoCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: VideoCostCalculatorinputs, metrics: VideoCostCalculatormetrics): VideoCostCalculatoranalysis {
