import { FitnessAgeCalculatorInputs } from './types';

export function validateFitnessAgeCalculatorInputs(inputs: FitnessAgeCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateFitnessAgeCalculatorBusinessRules(inputs: FitnessAgeCalculatorInputs): Array<{ field: string; message: string }> {
