export interface FitnessAgeCalculatorInputs {
...
export interface FitnessAgeCalculatorOutputs {
...
export interface FitnessAgeCalculatorMetrics {
...
export interface FitnessAgeCalculatorAnalysis {
