import { ClinicalTrialCost-calculatorInputs, ClinicalTrialCost-calculatorMetrics, ClinicalTrialCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ClinicalTrialCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: ClinicalTrialCost-calculatorInputs, metrics: ClinicalTrialCost-calculatorMetrics): ClinicalTrialCost-calculatorAnalysis {
