import { clinical-trial-cost-calculatorInputs, clinical-trial-cost-calculatorMetrics, clinical-trial-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: clinical-trial-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: clinical-trial-cost-calculatorInputs, metrics: clinical-trial-cost-calculatorMetrics): clinical-trial-cost-calculatorAnalysis {
