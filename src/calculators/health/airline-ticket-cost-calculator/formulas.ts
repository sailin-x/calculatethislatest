import { airline-ticket-cost-calculatorInputs, airline-ticket-cost-calculatorMetrics, airline-ticket-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: airline-ticket-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: airline-ticket-cost-calculatorInputs, metrics: airline-ticket-cost-calculatorMetrics): airline-ticket-cost-calculatorAnalysis {
