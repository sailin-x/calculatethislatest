import { AirlineTicketCost-calculatorInputs, AirlineTicketCost-calculatorMetrics, AirlineTicketCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: AirlineTicketCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: AirlineTicketCost-calculatorInputs, metrics: AirlineTicketCost-calculatorMetrics): AirlineTicketCost-calculatorAnalysis {
