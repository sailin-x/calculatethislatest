import { aquarium-cost-calculatorInputs, aquarium-cost-calculatorMetrics, aquarium-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: aquarium-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: aquarium-cost-calculatorInputs, metrics: aquarium-cost-calculatorMetrics): aquarium-cost-calculatorAnalysis {
