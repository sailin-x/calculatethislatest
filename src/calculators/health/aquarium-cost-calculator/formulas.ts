import { AquariumCostCalculatorinputs, AquariumCostCalculatormetrics, AquariumCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: AquariumCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: AquariumCostCalculatorinputs, metrics: AquariumCostCalculatormetrics): AquariumCostCalculatoranalysis {
