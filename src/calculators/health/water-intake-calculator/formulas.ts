import { water-intake-calculatorInputs, water-intake-calculatorMetrics, water-intake-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: water-intake-calculatorInputs): number {
...
export function generateAnalysis(inputs: water-intake-calculatorInputs, metrics: water-intake-calculatorMetrics): water-intake-calculatorAnalysis {
