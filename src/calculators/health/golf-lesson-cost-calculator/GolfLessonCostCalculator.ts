...
import { GolfLessonCostCalculatorInputs, GolfLessonCostCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateGolfLessonCostCalculatorInputs } from './validation';

export const GolfLessonCostCalculator: Calculator = {
  id: 'golf-lesson-cost-calculator',
  title: 'Golf Lesson Cost Calculator',
  category: 'health',
  subcategory: 'General',
  description: 'Calculate golf lesson costs',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
