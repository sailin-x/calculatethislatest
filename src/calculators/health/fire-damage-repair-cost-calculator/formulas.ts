import { FireDamageRepair-cost-calculatorInputs, FireDamageRepair-cost-calculatorMetrics, FireDamageRepair-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: FireDamageRepair-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: FireDamageRepair-cost-calculatorInputs, metrics: FireDamageRepair-cost-calculatorMetrics): FireDamageRepair-cost-calculatorAnalysis {
