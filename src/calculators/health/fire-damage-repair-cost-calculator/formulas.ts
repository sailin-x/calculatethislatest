import { fire-damage-repair-cost-calculatorInputs, fire-damage-repair-cost-calculatorMetrics, fire-damage-repair-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fire-damage-repair-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: fire-damage-repair-cost-calculatorInputs, metrics: fire-damage-repair-cost-calculatorMetrics): fire-damage-repair-cost-calculatorAnalysis {
