...
import { CarpetCleaningCostCalculatorInputs, CarpetCleaningCostCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateCarpetCleaningCostCalculatorInputs } from './validation';

export const CarpetCleaningCostCalculator: Calculator = {
  id: 'carpet-cleaning-cost-calculator',
  title: 'Carpet Cleaning Cost Calculator',
  category: 'health',
  subcategory: 'General',
  description: 'Calculate carpet cleaning costs',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
