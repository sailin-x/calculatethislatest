import { CalorieDeficitCalculatorInputs } from './types';

export function validateCalorieDeficitCalculatorInputs(inputs: CalorieDeficitCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCalorieDeficitCalculatorBusinessRules(inputs: CalorieDeficitCalculatorInputs): Array<{ field: string; message: string }> {
