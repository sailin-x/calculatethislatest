export interface CalorieDeficitCalculatorInputs {
...
export interface CalorieDeficitCalculatorOutputs {
...
export interface CalorieDeficitCalculatorMetrics {
...
export interface CalorieDeficitCalculatorAnalysis {
