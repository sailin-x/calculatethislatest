import { MediterraneanDietCalculatorInputs } from './types';

export function validateMediterraneanDietCalculatorInputs(inputs: MediterraneanDietCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMediterraneanDietCalculatorBusinessRules(inputs: MediterraneanDietCalculatorInputs): Array<{ field: string; message: string }> {
