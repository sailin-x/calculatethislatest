export interface MediterraneanDietCalculatorInputs {
...
export interface MediterraneanDietCalculatorOutputs {
...
export interface MediterraneanDietCalculatorMetrics {
...
export interface MediterraneanDietCalculatorAnalysis {
