import { SurfingLessonCost-calculatorInputs, SurfingLessonCost-calculatorMetrics, SurfingLessonCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: SurfingLessonCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: SurfingLessonCost-calculatorInputs, metrics: SurfingLessonCost-calculatorMetrics): SurfingLessonCost-calculatorAnalysis {
