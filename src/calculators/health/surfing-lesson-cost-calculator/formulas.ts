import { surfing-lesson-cost-calculatorInputs, surfing-lesson-cost-calculatorMetrics, surfing-lesson-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: surfing-lesson-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: surfing-lesson-cost-calculatorInputs, metrics: surfing-lesson-cost-calculatorMetrics): surfing-lesson-cost-calculatorAnalysis {
