import { gas-cost-calculatorInputs, gas-cost-calculatorMetrics, gas-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: gas-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: gas-cost-calculatorInputs, metrics: gas-cost-calculatorMetrics): gas-cost-calculatorAnalysis {
