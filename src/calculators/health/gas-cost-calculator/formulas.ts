import { GasCostCalculatorinputs, GasCostCalculatormetrics, GasCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: GasCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: GasCostCalculatorinputs, metrics: GasCostCalculatormetrics): GasCostCalculatoranalysis {
