import { website-cost-calculatorInputs, website-cost-calculatorMetrics, website-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: website-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: website-cost-calculatorInputs, metrics: website-cost-calculatorMetrics): website-cost-calculatorAnalysis {
