import { WebsiteCostCalculatorinputs, WebsiteCostCalculatormetrics, WebsiteCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: WebsiteCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: WebsiteCostCalculatorinputs, metrics: WebsiteCostCalculatormetrics): WebsiteCostCalculatoranalysis {
