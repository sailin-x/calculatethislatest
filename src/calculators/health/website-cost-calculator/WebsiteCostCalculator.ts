...
import { WebsiteCostCalculatorInputs, WebsiteCostCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateWebsiteCostCalculatorInputs } from './validation';

export const WebsiteCostCalculator: Calculator = {
  id: 'WebsiteCostCalculator',
  title: 'Website Cost Calculator',
  category: 'health',
  subcategory: 'General',
  description: 'Calculate travel website costs',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
