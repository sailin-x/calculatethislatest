...
import { ZooCostCalculatorInputs, ZooCostCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateZooCostCalculatorInputs } from './validation';

export const ZooCostCalculator: Calculator = {
  id: 'zoo-cost-calculator',
  title: 'Zoo Cost Calculator',
  category: 'health',
  subcategory: 'General',
  description: 'Calculate zoo admission costs',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
