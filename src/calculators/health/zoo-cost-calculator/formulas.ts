import { ZooCostCalculatorinputs, ZooCostCalculatormetrics, ZooCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: ZooCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: ZooCostCalculatorinputs, metrics: ZooCostCalculatormetrics): ZooCostCalculatoranalysis {
