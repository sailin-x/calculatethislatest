import { zoo-cost-calculatorInputs, zoo-cost-calculatorMetrics, zoo-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: zoo-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: zoo-cost-calculatorInputs, metrics: zoo-cost-calculatorMetrics): zoo-cost-calculatorAnalysis {
