import { TourCostCalculatorinputs, TourCostCalculatormetrics, TourCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: TourCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: TourCostCalculatorinputs, metrics: TourCostCalculatormetrics): TourCostCalculatoranalysis {
