import { tour-cost-calculatorInputs, tour-cost-calculatorMetrics, tour-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: tour-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: tour-cost-calculatorInputs, metrics: tour-cost-calculatorMetrics): tour-cost-calculatorAnalysis {
