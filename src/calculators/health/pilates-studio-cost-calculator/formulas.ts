import { pilates-studio-cost-calculatorInputs, pilates-studio-cost-calculatorMetrics, pilates-studio-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: pilates-studio-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: pilates-studio-cost-calculatorInputs, metrics: pilates-studio-cost-calculatorMetrics): pilates-studio-cost-calculatorAnalysis {
