import { PilatesStudioCost-calculatorInputs, PilatesStudioCost-calculatorMetrics, PilatesStudioCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: PilatesStudioCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: PilatesStudioCost-calculatorInputs, metrics: PilatesStudioCost-calculatorMetrics): PilatesStudioCost-calculatorAnalysis {
