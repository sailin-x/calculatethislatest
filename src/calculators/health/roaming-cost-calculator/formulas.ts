import { roaming-cost-calculatorInputs, roaming-cost-calculatorMetrics, roaming-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: roaming-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: roaming-cost-calculatorInputs, metrics: roaming-cost-calculatorMetrics): roaming-cost-calculatorAnalysis {
