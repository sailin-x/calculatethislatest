import { RoamingCostCalculatorinputs, RoamingCostCalculatormetrics, RoamingCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: RoamingCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: RoamingCostCalculatorinputs, metrics: RoamingCostCalculatormetrics): RoamingCostCalculatoranalysis {
