import { HomeHealthAgencyProfitabilityCalculatorInputs } from './types';

export function validateHomeHealthAgencyProfitabilityCalculatorInputs(inputs: HomeHealthAgencyProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateHomeHealthAgencyProfitabilityCalculatorBusinessRules(inputs: HomeHealthAgencyProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
