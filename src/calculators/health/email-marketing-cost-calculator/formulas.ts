import { EmailMarketingCost-calculatorInputs, EmailMarketingCost-calculatorMetrics, EmailMarketingCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: EmailMarketingCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: EmailMarketingCost-calculatorInputs, metrics: EmailMarketingCost-calculatorMetrics): EmailMarketingCost-calculatorAnalysis {
