import { email-marketing-cost-calculatorInputs, email-marketing-cost-calculatorMetrics, email-marketing-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: email-marketing-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: email-marketing-cost-calculatorInputs, metrics: email-marketing-cost-calculatorMetrics): email-marketing-cost-calculatorAnalysis {
