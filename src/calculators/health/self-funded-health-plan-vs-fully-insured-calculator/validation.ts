import { SelffundedHealthPlanVsFullyinsuredCalculatorInputs } from './types';

export function validateSelffundedHealthPlanVsFullyinsuredCalculatorInputs(inputs: SelffundedHealthPlanVsFullyinsuredCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateSelffundedHealthPlanVsFullyinsuredCalculatorBusinessRules(inputs: SelffundedHealthPlanVsFullyinsuredCalculatorInputs): Array<{ field: string; message: string }> {
