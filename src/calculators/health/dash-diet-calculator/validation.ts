import { DashDietCalculatorInputs } from './types';

export function validateDashDietCalculatorInputs(inputs: DashDietCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDashDietCalculatorBusinessRules(inputs: DashDietCalculatorInputs): Array<{ field: string; message: string }> {
