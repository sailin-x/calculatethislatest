export interface DashDietCalculatorInputs {
...
export interface DashDietCalculatorOutputs {
...
export interface DashDietCalculatorMetrics {
...
export interface DashDietCalculatorAnalysis {
