...
import { MedicalExpenseTaxDeductionCalculatorInputs, MedicalExpenseTaxDeductionCalculatorOutputs } from './types';
...
export const MedicalExpenseTaxDeductionCalculator: Calculator = {
  ...
  category: 'health',
  subcategory: 'General',
  description: 'Calculate medical expense tax deductions',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
