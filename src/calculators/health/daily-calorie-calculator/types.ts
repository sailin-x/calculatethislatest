export interface DailyCalorieCalculatorInputs {
...
export interface DailyCalorieCalculatorOutputs {
...
export interface DailyCalorieCalculatorMetrics {
...
export interface DailyCalorieCalculatorAnalysis {
