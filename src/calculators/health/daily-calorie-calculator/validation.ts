import { DailyCalorieCalculatorInputs } from './types';

export function validateDailyCalorieCalculatorInputs(inputs: DailyCalorieCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDailyCalorieCalculatorBusinessRules(inputs: DailyCalorieCalculatorInputs): Array<{ field: string; message: string }> {
