import { sleep-calculatorInputs, sleep-calculatorMetrics, sleep-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: sleep-calculatorInputs): number {
...
export function generateAnalysis(inputs: sleep-calculatorInputs, metrics: sleep-calculatorMetrics): sleep-calculatorAnalysis {
