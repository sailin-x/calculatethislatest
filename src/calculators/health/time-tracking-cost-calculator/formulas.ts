import { TimeTrackingCost-calculatorInputs, TimeTrackingCost-calculatorMetrics, TimeTrackingCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: TimeTrackingCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: TimeTrackingCost-calculatorInputs, metrics: TimeTrackingCost-calculatorMetrics): TimeTrackingCost-calculatorAnalysis {
