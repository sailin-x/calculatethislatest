import { time-tracking-cost-calculatorInputs, time-tracking-cost-calculatorMetrics, time-tracking-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: time-tracking-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: time-tracking-cost-calculatorInputs, metrics: time-tracking-cost-calculatorMetrics): time-tracking-cost-calculatorAnalysis {
