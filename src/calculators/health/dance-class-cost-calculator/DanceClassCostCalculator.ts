...
import { DanceClassCostCalculatorInputs, DanceClassCostCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateDanceClassCostCalculatorInputs } from './validation';

export const DanceClassCostCalculator: Calculator = {
  id: 'dance-class-cost-calculator',
  title: 'Dance Class Cost Calculator',
  category: 'health',
  subcategory: 'General',
  description: 'Calculate dance class costs',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
