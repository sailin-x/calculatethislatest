import { DanceClassCost-calculatorInputs, DanceClassCost-calculatorMetrics, DanceClassCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: DanceClassCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: DanceClassCost-calculatorInputs, metrics: DanceClassCost-calculatorMetrics): DanceClassCost-calculatorAnalysis {
