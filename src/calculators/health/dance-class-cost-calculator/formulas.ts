import { dance-class-cost-calculatorInputs, dance-class-cost-calculatorMetrics, dance-class-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: dance-class-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: dance-class-cost-calculatorInputs, metrics: dance-class-cost-calculatorMetrics): dance-class-cost-calculatorAnalysis {
