import { AddictionRehabCalculatorinputs, AddictionRehabCalculatormetrics, AddictionRehabCalculatoranalysis } from './types';
...
export function calculateResult(inputs: AddictionRehabCalculatorinputs): number {
...
export function generateAnalysis(inputs: AddictionRehabCalculatorinputs, metrics: AddictionRehabCalculatormetrics): AddictionRehabCalculatoranalysis {
