import { SouvenirCostCalculatorinputs, SouvenirCostCalculatormetrics, SouvenirCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: SouvenirCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: SouvenirCostCalculatorinputs, metrics: SouvenirCostCalculatormetrics): SouvenirCostCalculatoranalysis {
