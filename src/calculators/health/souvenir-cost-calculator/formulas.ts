import { souvenir-cost-calculatorInputs, souvenir-cost-calculatorMetrics, souvenir-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: souvenir-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: souvenir-cost-calculatorInputs, metrics: souvenir-cost-calculatorMetrics): souvenir-cost-calculatorAnalysis {
