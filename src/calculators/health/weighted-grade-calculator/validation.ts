import { WeightedGradeCalculatorInputs } from './types';

export function validateWeightedGradeCalculatorInputs(inputs: WeightedGradeCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateWeightedGradeCalculatorBusinessRules(inputs: WeightedGradeCalculatorInputs): Array<{ field: string; message: string }> {
