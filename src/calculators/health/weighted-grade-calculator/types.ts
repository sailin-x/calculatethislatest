export interface WeightedGradeCalculatorInputs {
...
export interface WeightedGradeCalculatorOutputs {
...
export interface WeightedGradeCalculatorMetrics {
...
export interface WeightedGradeCalculatorAnalysis {
