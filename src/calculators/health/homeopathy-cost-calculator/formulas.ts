import { HomeopathyCostCalculatorinputs, HomeopathyCostCalculatormetrics, HomeopathyCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: HomeopathyCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: HomeopathyCostCalculatorinputs, metrics: HomeopathyCostCalculatormetrics): HomeopathyCostCalculatoranalysis {
