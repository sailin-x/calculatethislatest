import { homeopathy-cost-calculatorInputs, homeopathy-cost-calculatorMetrics, homeopathy-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: homeopathy-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: homeopathy-cost-calculatorInputs, metrics: homeopathy-cost-calculatorMetrics): homeopathy-cost-calculatorAnalysis {
