import { food-cost-calculatorInputs, food-cost-calculatorMetrics, food-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: food-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: food-cost-calculatorInputs, metrics: food-cost-calculatorMetrics): food-cost-calculatorAnalysis {
