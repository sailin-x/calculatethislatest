import { FoodCostCalculatorinputs, FoodCostCalculatormetrics, FoodCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FoodCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: FoodCostCalculatorinputs, metrics: FoodCostCalculatormetrics): FoodCostCalculatoranalysis {
