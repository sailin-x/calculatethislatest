import { TreeTrimmingCost-calculatorInputs, TreeTrimmingCost-calculatorMetrics, TreeTrimmingCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: TreeTrimmingCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: TreeTrimmingCost-calculatorInputs, metrics: TreeTrimmingCost-calculatorMetrics): TreeTrimmingCost-calculatorAnalysis {
