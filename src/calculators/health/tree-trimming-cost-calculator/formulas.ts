import { tree-trimming-cost-calculatorInputs, tree-trimming-cost-calculatorMetrics, tree-trimming-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: tree-trimming-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: tree-trimming-cost-calculatorInputs, metrics: tree-trimming-cost-calculatorMetrics): tree-trimming-cost-calculatorAnalysis {
