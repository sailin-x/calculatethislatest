import { hardiness-calculatorInputs, hardiness-calculatorMetrics, hardiness-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: hardiness-calculatorInputs): number {
...
export function generateAnalysis(inputs: hardiness-calculatorInputs, metrics: hardiness-calculatorMetrics): hardiness-calculatorAnalysis {
