import { ActivityCostCalculatorinputs, ActivityCostCalculatormetrics, ActivityCostCalculatoranalysis } from './types';
...
export function calculateResult(inputs: ActivityCostCalculatorinputs): number {
...
export function generateAnalysis(inputs: ActivityCostCalculatorinputs, metrics: ActivityCostCalculatormetrics): ActivityCostCalculatoranalysis {
