import { activity-cost-calculatorInputs, activity-cost-calculatorMetrics, activity-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: activity-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: activity-cost-calculatorInputs, metrics: activity-cost-calculatorMetrics): activity-cost-calculatorAnalysis {
