...
import { ActivityCostCalculatorInputs, ActivityCostCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateActivityCostCalculatorInputs } from './validation';

export const ActivityCostCalculator: Calculator = {
  id: 'activity-cost-calculator',
  title: 'Activity Cost Calculator',
  category: 'health',
  subcategory: 'General',
  description: 'Calculate travel activity costs',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
