...
import { MedicalBillNegotiationCalculatorInputs, MedicalBillNegotiationCalculatorOutputs } from './types';
...
export const MedicalBillNegotiationCalculator: Calculator = {
  ...
  category: 'health',
  subcategory: 'General',
  description: 'Calculate medical bill negotiation savings',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
