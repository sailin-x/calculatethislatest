import { medical-bill-negotiation-calculatorInputs, medical-bill-negotiation-calculatorMetrics, medical-bill-negotiation-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: medical-bill-negotiation-calculatorInputs): number {
...
export function generateAnalysis(inputs: medical-bill-negotiation-calculatorInputs, metrics: medical-bill-negotiation-calculatorMetrics): medical-bill-negotiation-calculatorAnalysis {
