import { MedicalBillNegotiation-calculatorInputs, MedicalBillNegotiation-calculatorMetrics, MedicalBillNegotiation-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: MedicalBillNegotiation-calculatorInputs): number {
...
export function generateAnalysis(inputs: MedicalBillNegotiation-calculatorInputs, metrics: MedicalBillNegotiation-calculatorMetrics): MedicalBillNegotiation-calculatorAnalysis {
