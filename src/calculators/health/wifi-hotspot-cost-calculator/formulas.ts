import { wifi-hotspot-cost-calculatorInputs, wifi-hotspot-cost-calculatorMetrics, wifi-hotspot-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: wifi-hotspot-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: wifi-hotspot-cost-calculatorInputs, metrics: wifi-hotspot-cost-calculatorMetrics): wifi-hotspot-cost-calculatorAnalysis {
