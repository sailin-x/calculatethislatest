import { WeightLossCalculatorInputs } from './types';

export function validateWeightLossCalculatorInputs(inputs: WeightLossCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateWeightLossCalculatorBusinessRules(inputs: WeightLossCalculatorInputs): Array<{ field: string; message: string }> {
