export interface WeightLossCalculatorInputs {
...
export interface WeightLossCalculatorOutputs {
...
export interface WeightLossCalculatorMetrics {
...
export interface WeightLossCalculatorAnalysis {
