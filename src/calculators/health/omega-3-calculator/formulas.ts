import { omega-3-calculatorInputs, omega-3-calculatorMetrics, omega-3-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: omega-3-calculatorInputs): number {
...
export function generateAnalysis(inputs: omega-3-calculatorInputs, metrics: omega-3-calculatorMetrics): omega-3-calculatorAnalysis {
