import { VisionInsuranceCost-calculatorInputs, VisionInsuranceCost-calculatorMetrics, VisionInsuranceCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: VisionInsuranceCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: VisionInsuranceCost-calculatorInputs, metrics: VisionInsuranceCost-calculatorMetrics): VisionInsuranceCost-calculatorAnalysis {
