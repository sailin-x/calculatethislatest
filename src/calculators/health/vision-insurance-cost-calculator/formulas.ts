import { vision-insurance-cost-calculatorInputs, vision-insurance-cost-calculatorMetrics, vision-insurance-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: vision-insurance-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: vision-insurance-cost-calculatorInputs, metrics: vision-insurance-cost-calculatorMetrics): vision-insurance-cost-calculatorAnalysis {
