import { vitamin-supplement-cost-calculatorInputs, vitamin-supplement-cost-calculatorMetrics, vitamin-supplement-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: vitamin-supplement-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: vitamin-supplement-cost-calculatorInputs, metrics: vitamin-supplement-cost-calculatorMetrics): vitamin-supplement-cost-calculatorAnalysis {
