import { VitaminSupplementCost-calculatorInputs, VitaminSupplementCost-calculatorMetrics, VitaminSupplementCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: VitaminSupplementCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: VitaminSupplementCost-calculatorInputs, metrics: VitaminSupplementCost-calculatorMetrics): VitaminSupplementCost-calculatorAnalysis {
