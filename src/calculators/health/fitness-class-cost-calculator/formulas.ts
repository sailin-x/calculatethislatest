import { FitnessClassCost-calculatorInputs, FitnessClassCost-calculatorMetrics, FitnessClassCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: FitnessClassCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: FitnessClassCost-calculatorInputs, metrics: FitnessClassCost-calculatorMetrics): FitnessClassCost-calculatorAnalysis {
