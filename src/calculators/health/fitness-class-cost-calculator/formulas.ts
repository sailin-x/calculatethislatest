import { fitness-class-cost-calculatorInputs, fitness-class-cost-calculatorMetrics, fitness-class-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fitness-class-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: fitness-class-cost-calculatorInputs, metrics: fitness-class-cost-calculatorMetrics): fitness-class-cost-calculatorAnalysis {
