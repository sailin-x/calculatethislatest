import { anti_aging_regenerative_medicine_cost_calculatorInputs, anti_aging_regenerative_medicine_cost_calculatorMetrics, anti_aging_regenerative_medicine_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: anti_aging_regenerative_medicine_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: anti_aging_regenerative_medicine_cost_calculatorInputs, metrics: anti_aging_regenerative_medicine_cost_calculatorMetrics): anti_aging_regenerative_medicine_cost_calculatorAnalysis {
