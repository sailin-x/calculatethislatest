import { payroll_calculatorInputs, payroll_calculatorMetrics, payroll_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: payroll_calculatorInputs): number {
...
export function generateAnalysis(inputs: payroll_calculatorInputs, metrics: payroll_calculatorMetrics): payroll_calculatorAnalysis {
