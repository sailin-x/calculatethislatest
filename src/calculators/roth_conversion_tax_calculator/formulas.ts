import { roth_conversion_tax_calculatorInputs, roth_conversion_tax_calculatorMetrics, roth_conversion_tax_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: roth_conversion_tax_calculatorInputs): number {
...
export function generateAnalysis(inputs: roth_conversion_tax_calculatorInputs, metrics: roth_conversion_tax_calculatorMetrics): roth_conversion_tax_calculatorAnalysis {
