import { roth_conversion_tax_calculatorInputs } from './types';

export function validateInputs(inputs: roth_conversion_tax_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
