import { contract_review_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: contract_review_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
