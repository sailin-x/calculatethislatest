import { contract_review_calculatorCalculatorInputs, contract_review_calculatorCalculatorMetrics, contract_review_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: contract_review_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: contract_review_calculatorCalculatorInputs, metrics: contract_review_calculatorCalculatorMetrics): contract_review_calculatorCalculatorAnalysis {
