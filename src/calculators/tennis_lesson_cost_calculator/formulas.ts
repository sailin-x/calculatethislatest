import { tennis_lesson_cost_calculatorInputs, tennis_lesson_cost_calculatorMetrics, tennis_lesson_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: tennis_lesson_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: tennis_lesson_cost_calculatorInputs, metrics: tennis_lesson_cost_calculatorMetrics): tennis_lesson_cost_calculatorAnalysis {
