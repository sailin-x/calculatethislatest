import { garden_calculatorCalculatorInputs, garden_calculatorCalculatorMetrics, garden_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: garden_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: garden_calculatorCalculatorInputs, metrics: garden_calculatorCalculatorMetrics): garden_calculatorCalculatorAnalysis {
