import { garden_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: garden_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
