import { retirement_calculatorCalculatorInputs, retirement_calculatorCalculatorMetrics, retirement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: retirement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: retirement_calculatorCalculatorInputs, metrics: retirement_calculatorCalculatorMetrics): retirement_calculatorCalculatorAnalysis {
