import { retirement_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: retirement_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
