import { employment_law_calculatorInputs, employment_law_calculatorMetrics, employment_law_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: employment_law_calculatorInputs): number {
...
export function generateAnalysis(inputs: employment_law_calculatorInputs, metrics: employment_law_calculatorMetrics): employment_law_calculatorAnalysis {
