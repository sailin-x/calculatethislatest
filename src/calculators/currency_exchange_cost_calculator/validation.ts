import { currency_exchange_cost_calculatorInputs } from './types';

export function validateInputs(inputs: currency_exchange_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
