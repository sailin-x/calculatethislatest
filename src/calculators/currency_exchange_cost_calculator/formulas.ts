import { currency_exchange_cost_calculatorInputs, currency_exchange_cost_calculatorMetrics, currency_exchange_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: currency_exchange_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: currency_exchange_cost_calculatorInputs, metrics: currency_exchange_cost_calculatorMetrics): currency_exchange_cost_calculatorAnalysis {
