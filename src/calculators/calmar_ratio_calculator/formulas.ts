import { calmar_ratio_calculatorInputs, calmar_ratio_calculatorMetrics, calmar_ratio_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: calmar_ratio_calculatorInputs): number {
...
export function generateAnalysis(inputs: calmar_ratio_calculatorInputs, metrics: calmar_ratio_calculatorMetrics): calmar_ratio_calculatorAnalysis {
