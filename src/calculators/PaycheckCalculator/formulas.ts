import { PaycheckCalculatorInputs, PaycheckCalculatorMetrics, PaycheckCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: PaycheckCalculatorInputs): number {
...
export function generateAnalysis(inputs: PaycheckCalculatorInputs, metrics: PaycheckCalculatorMetrics): PaycheckCalculatorAnalysis {
