import { dance_class_cost_calculatorInputs } from './types';

export function validateInputs(inputs: dance_class_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
