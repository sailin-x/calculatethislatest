import { dance_class_cost_calculatorInputs, dance_class_cost_calculatorMetrics, dance_class_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: dance_class_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: dance_class_cost_calculatorInputs, metrics: dance_class_cost_calculatorMetrics): dance_class_cost_calculatorAnalysis {
