import { financial_resilience_calculatorCalculatorInputs, financial_resilience_calculatorCalculatorMetrics, financial_resilience_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_resilience_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_resilience_calculatorCalculatorInputs, metrics: financial_resilience_calculatorCalculatorMetrics): financial_resilience_calculatorCalculatorAnalysis {
