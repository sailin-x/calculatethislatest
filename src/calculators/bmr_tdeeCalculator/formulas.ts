import { bmr_tdeeCalculatorInputs, bmr_tdeeCalculatorMetrics, bmr_tdeeCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: bmr_tdeeCalculatorInputs): number {
...
export function generateAnalysis(inputs: bmr_tdeeCalculatorInputs, metrics: bmr_tdeeCalculatorMetrics): bmr_tdeeCalculatorAnalysis {
