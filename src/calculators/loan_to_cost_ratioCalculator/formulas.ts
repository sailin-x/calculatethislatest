import { loan_to_cost_ratioCalculatorInputs, loan_to_cost_ratioCalculatorMetrics, loan_to_cost_ratioCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: loan_to_cost_ratioCalculatorInputs): number {
...
export function generateAnalysis(inputs: loan_to_cost_ratioCalculatorInputs, metrics: loan_to_cost_ratioCalculatorMetrics): loan_to_cost_ratioCalculatorAnalysis {
