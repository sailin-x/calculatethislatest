import { loan_to_cost_ratioCalculatorInputs } from './types';

export function validateInputs(inputs: loan_to_cost_ratioCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
