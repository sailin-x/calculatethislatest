import { crm_cost_calculatorInputs, crm_cost_calculatorMetrics, crm_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: crm_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: crm_cost_calculatorInputs, metrics: crm_cost_calculatorMetrics): crm_cost_calculatorAnalysis {
