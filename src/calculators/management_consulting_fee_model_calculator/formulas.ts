import { management_consulting_fee_model_calculatorInputs, management_consulting_fee_model_calculatorMetrics, management_consulting_fee_model_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: management_consulting_fee_model_calculatorInputs): number {
...
export function generateAnalysis(inputs: management_consulting_fee_model_calculatorInputs, metrics: management_consulting_fee_model_calculatorMetrics): management_consulting_fee_model_calculatorAnalysis {
