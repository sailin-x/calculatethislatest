import { nutrition_label_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: nutrition_label_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
