import { nutrition_label_calculatorCalculatorInputs, nutrition_label_calculatorCalculatorMetrics, nutrition_label_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: nutrition_label_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: nutrition_label_calculatorCalculatorInputs, metrics: nutrition_label_calculatorCalculatorMetrics): nutrition_label_calculatorCalculatorAnalysis {
