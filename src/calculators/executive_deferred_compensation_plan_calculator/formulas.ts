import { executive_deferred_compensation_plan_calculatorInputs, executive_deferred_compensation_plan_calculatorMetrics, executive_deferred_compensation_plan_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: executive_deferred_compensation_plan_calculatorInputs): number {
...
export function generateAnalysis(inputs: executive_deferred_compensation_plan_calculatorInputs, metrics: executive_deferred_compensation_plan_calculatorMetrics): executive_deferred_compensation_plan_calculatorAnalysis {
