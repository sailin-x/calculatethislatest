import { registerGenerationSkippingTransferGstTaxCalculatorInputs, registerGenerationSkippingTransferGstTaxCalculatorMetrics, registerGenerationSkippingTransferGstTaxCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerGenerationSkippingTransferGstTaxCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerGenerationSkippingTransferGstTaxCalculatorInputs, metrics: registerGenerationSkippingTransferGstTaxCalculatorMetrics): registerGenerationSkippingTransferGstTaxCalculatorAnalysis {
