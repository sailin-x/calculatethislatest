import { bill_of_materials_cost_calculatorCalculatorInputs, bill_of_materials_cost_calculatorCalculatorMetrics, bill_of_materials_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: bill_of_materials_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: bill_of_materials_cost_calculatorCalculatorInputs, metrics: bill_of_materials_cost_calculatorCalculatorMetrics): bill_of_materials_cost_calculatorCalculatorAnalysis {
