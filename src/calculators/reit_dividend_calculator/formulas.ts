import { reit_dividend_calculatorInputs, reit_dividend_calculatorMetrics, reit_dividend_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: reit_dividend_calculatorInputs): number {
...
export function generateAnalysis(inputs: reit_dividend_calculatorInputs, metrics: reit_dividend_calculatorMetrics): reit_dividend_calculatorAnalysis {
