import { supply_chain_bullwhip_effect_calculatorCalculatorInputs, supply_chain_bullwhip_effect_calculatorCalculatorMetrics, supply_chain_bullwhip_effect_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: supply_chain_bullwhip_effect_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: supply_chain_bullwhip_effect_calculatorCalculatorInputs, metrics: supply_chain_bullwhip_effect_calculatorCalculatorMetrics): supply_chain_bullwhip_effect_calculatorCalculatorAnalysis {
