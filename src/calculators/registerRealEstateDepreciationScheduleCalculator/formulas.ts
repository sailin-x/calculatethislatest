import { registerRealEstateDepreciationScheduleCalculatorInputs, registerRealEstateDepreciationScheduleCalculatorMetrics, registerRealEstateDepreciationScheduleCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerRealEstateDepreciationScheduleCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerRealEstateDepreciationScheduleCalculatorInputs, metrics: registerRealEstateDepreciationScheduleCalculatorMetrics): registerRealEstateDepreciationScheduleCalculatorAnalysis {
