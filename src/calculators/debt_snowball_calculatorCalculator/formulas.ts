import { debt_snowball_calculatorCalculatorInputs, debt_snowball_calculatorCalculatorMetrics, debt_snowball_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_snowball_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: debt_snowball_calculatorCalculatorInputs, metrics: debt_snowball_calculatorCalculatorMetrics): debt_snowball_calculatorCalculatorAnalysis {
