import { debt_snowball_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: debt_snowball_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
