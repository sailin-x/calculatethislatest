import { financial_efficiency_calculatorCalculatorInputs, financial_efficiency_calculatorCalculatorMetrics, financial_efficiency_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_efficiency_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_efficiency_calculatorCalculatorInputs, metrics: financial_efficiency_calculatorCalculatorMetrics): financial_efficiency_calculatorCalculatorAnalysis {
