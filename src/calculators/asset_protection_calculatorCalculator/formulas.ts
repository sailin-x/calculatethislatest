import { asset_protection_calculatorCalculatorInputs, asset_protection_calculatorCalculatorMetrics, asset_protection_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: asset_protection_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: asset_protection_calculatorCalculatorInputs, metrics: asset_protection_calculatorCalculatorMetrics): asset_protection_calculatorCalculatorAnalysis {
