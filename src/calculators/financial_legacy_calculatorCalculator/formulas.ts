import { financial_legacy_calculatorCalculatorInputs, financial_legacy_calculatorCalculatorMetrics, financial_legacy_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_legacy_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_legacy_calculatorCalculatorInputs, metrics: financial_legacy_calculatorCalculatorMetrics): financial_legacy_calculatorCalculatorAnalysis {
