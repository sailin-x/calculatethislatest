import { dental_implant_roi_calculatorCalculatorInputs, dental_implant_roi_calculatorCalculatorMetrics, dental_implant_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: dental_implant_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: dental_implant_roi_calculatorCalculatorInputs, metrics: dental_implant_roi_calculatorCalculatorMetrics): dental_implant_roi_calculatorCalculatorAnalysis {
