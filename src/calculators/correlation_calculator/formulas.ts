import { correlation_calculatorInputs, correlation_calculatorMetrics, correlation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: correlation_calculatorInputs): number {
...
export function generateAnalysis(inputs: correlation_calculatorInputs, metrics: correlation_calculatorMetrics): correlation_calculatorAnalysis {
