import { 1031_exchangeCalculatorInputs, 1031_exchangeCalculatorMetrics, 1031_exchangeCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: 1031_exchangeCalculatorInputs): number {
...
export function generateAnalysis(inputs: 1031_exchangeCalculatorInputs, metrics: 1031_exchangeCalculatorMetrics): 1031_exchangeCalculatorAnalysis {
