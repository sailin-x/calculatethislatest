import { ethereum_2_staking_calculatorCalculatorInputs, ethereum_2_staking_calculatorCalculatorMetrics, ethereum_2_staking_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: ethereum_2_staking_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: ethereum_2_staking_calculatorCalculatorInputs, metrics: ethereum_2_staking_calculatorCalculatorMetrics): ethereum_2_staking_calculatorCalculatorAnalysis {
