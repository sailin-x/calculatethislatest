import { ethereum_2_staking_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: ethereum_2_staking_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
