import { seo_cost_calculatorInputs, seo_cost_calculatorMetrics, seo_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: seo_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: seo_cost_calculatorInputs, metrics: seo_cost_calculatorMetrics): seo_cost_calculatorAnalysis {
