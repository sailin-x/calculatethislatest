import { loss_ratio_calculatorCalculatorInputs, loss_ratio_calculatorCalculatorMetrics, loss_ratio_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: loss_ratio_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: loss_ratio_calculatorCalculatorInputs, metrics: loss_ratio_calculatorCalculatorMetrics): loss_ratio_calculatorCalculatorAnalysis {
