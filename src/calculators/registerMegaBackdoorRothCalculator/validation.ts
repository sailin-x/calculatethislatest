import { registerMegaBackdoorRothCalculatorInputs } from './types';

export function validateInputs(inputs: registerMegaBackdoorRothCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
