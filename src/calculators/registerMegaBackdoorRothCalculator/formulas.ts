import { registerMegaBackdoorRothCalculatorInputs, registerMegaBackdoorRothCalculatorMetrics, registerMegaBackdoorRothCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerMegaBackdoorRothCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerMegaBackdoorRothCalculatorInputs, metrics: registerMegaBackdoorRothCalculatorMetrics): registerMegaBackdoorRothCalculatorAnalysis {
