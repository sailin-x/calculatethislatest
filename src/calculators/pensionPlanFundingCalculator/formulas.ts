import { pensionPlanFundingCalculatorInputs, pensionPlanFundingCalculatorMetrics, pensionPlanFundingCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: pensionPlanFundingCalculatorInputs): number {
...
export function generateAnalysis(inputs: pensionPlanFundingCalculatorInputs, metrics: pensionPlanFundingCalculatorMetrics): pensionPlanFundingCalculatorAnalysis {
