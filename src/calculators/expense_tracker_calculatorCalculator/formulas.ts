import { expense_tracker_calculatorCalculatorInputs, expense_tracker_calculatorCalculatorMetrics, expense_tracker_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: expense_tracker_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: expense_tracker_calculatorCalculatorInputs, metrics: expense_tracker_calculatorCalculatorMetrics): expense_tracker_calculatorCalculatorAnalysis {
