import { expense_tracker_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: expense_tracker_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
