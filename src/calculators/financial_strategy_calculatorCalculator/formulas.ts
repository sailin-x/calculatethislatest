import { financial_strategy_calculatorCalculatorInputs, financial_strategy_calculatorCalculatorMetrics, financial_strategy_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_strategy_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_strategy_calculatorCalculatorInputs, metrics: financial_strategy_calculatorCalculatorMetrics): financial_strategy_calculatorCalculatorAnalysis {
