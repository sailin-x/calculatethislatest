import { car_accident_pain_suffering_calculatorCalculatorInputs, car_accident_pain_suffering_calculatorCalculatorMetrics, car_accident_pain_suffering_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: car_accident_pain_suffering_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: car_accident_pain_suffering_calculatorCalculatorInputs, metrics: car_accident_pain_suffering_calculatorCalculatorMetrics): car_accident_pain_suffering_calculatorCalculatorAnalysis {
