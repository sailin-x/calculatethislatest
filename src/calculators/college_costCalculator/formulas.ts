import { college_costCalculatorInputs, college_costCalculatorMetrics, college_costCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: college_costCalculatorInputs): number {
...
export function generateAnalysis(inputs: college_costCalculatorInputs, metrics: college_costCalculatorMetrics): college_costCalculatorAnalysis {
