import { luggage_cost_calculatorCalculatorInputs, luggage_cost_calculatorCalculatorMetrics, luggage_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: luggage_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: luggage_cost_calculatorCalculatorInputs, metrics: luggage_cost_calculatorCalculatorMetrics): luggage_cost_calculatorCalculatorAnalysis {
