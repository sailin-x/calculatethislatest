import { composting_savings_calculatorInputs } from './types';

export function validateInputs(inputs: composting_savings_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
