import { composting_savings_calculatorInputs, composting_savings_calculatorMetrics, composting_savings_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: composting_savings_calculatorInputs): number {
...
export function generateAnalysis(inputs: composting_savings_calculatorInputs, metrics: composting_savings_calculatorMetrics): composting_savings_calculatorAnalysis {
