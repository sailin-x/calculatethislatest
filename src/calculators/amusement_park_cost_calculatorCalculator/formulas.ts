import { amusement_park_cost_calculatorCalculatorInputs, amusement_park_cost_calculatorCalculatorMetrics, amusement_park_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: amusement_park_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: amusement_park_cost_calculatorCalculatorInputs, metrics: amusement_park_cost_calculatorCalculatorMetrics): amusement_park_cost_calculatorCalculatorAnalysis {
