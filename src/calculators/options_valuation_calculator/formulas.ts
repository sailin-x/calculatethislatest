import { options_valuation_calculatorInputs, options_valuation_calculatorMetrics, options_valuation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: options_valuation_calculatorInputs): number {
...
export function generateAnalysis(inputs: options_valuation_calculatorInputs, metrics: options_valuation_calculatorMetrics): options_valuation_calculatorAnalysis {
