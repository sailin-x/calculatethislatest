import { cash_out_refinanceCalculatorInputs } from './types';

export function validateInputs(inputs: cash_out_refinanceCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
