import { cash_out_refinanceCalculatorInputs, cash_out_refinanceCalculatorMetrics, cash_out_refinanceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cash_out_refinanceCalculatorInputs): number {
...
export function generateAnalysis(inputs: cash_out_refinanceCalculatorInputs, metrics: cash_out_refinanceCalculatorMetrics): cash_out_refinanceCalculatorAnalysis {
