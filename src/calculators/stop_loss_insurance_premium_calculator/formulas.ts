import { stop_loss_insurance_premium_calculatorInputs, stop_loss_insurance_premium_calculatorMetrics, stop_loss_insurance_premium_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: stop_loss_insurance_premium_calculatorInputs): number {
...
export function generateAnalysis(inputs: stop_loss_insurance_premium_calculatorInputs, metrics: stop_loss_insurance_premium_calculatorMetrics): stop_loss_insurance_premium_calculatorAnalysis {
