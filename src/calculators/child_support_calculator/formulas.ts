import { child_support_calculatorInputs, child_support_calculatorMetrics, child_support_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: child_support_calculatorInputs): number {
...
export function generateAnalysis(inputs: child_support_calculatorInputs, metrics: child_support_calculatorMetrics): child_support_calculatorAnalysis {
