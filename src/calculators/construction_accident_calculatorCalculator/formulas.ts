import { construction_accident_calculatorCalculatorInputs, construction_accident_calculatorCalculatorMetrics, construction_accident_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: construction_accident_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: construction_accident_calculatorCalculatorInputs, metrics: construction_accident_calculatorCalculatorMetrics): construction_accident_calculatorCalculatorAnalysis {
