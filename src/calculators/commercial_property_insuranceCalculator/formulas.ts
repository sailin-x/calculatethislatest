import { commercial_property_insuranceCalculatorInputs, commercial_property_insuranceCalculatorMetrics, commercial_property_insuranceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: commercial_property_insuranceCalculatorInputs): number {
...
export function generateAnalysis(inputs: commercial_property_insuranceCalculatorInputs, metrics: commercial_property_insuranceCalculatorMetrics): commercial_property_insuranceCalculatorAnalysis {
