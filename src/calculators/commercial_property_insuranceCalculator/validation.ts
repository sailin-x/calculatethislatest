import { commercial_property_insuranceCalculatorInputs } from './types';

export function validateInputs(inputs: commercial_property_insuranceCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
