import { home_equity_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: home_equity_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
