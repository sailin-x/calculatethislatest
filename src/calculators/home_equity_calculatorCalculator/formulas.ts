import { home_equity_calculatorCalculatorInputs, home_equity_calculatorCalculatorMetrics, home_equity_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: home_equity_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: home_equity_calculatorCalculatorInputs, metrics: home_equity_calculatorCalculatorMetrics): home_equity_calculatorCalculatorAnalysis {
