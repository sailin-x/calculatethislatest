import { net_present_value_calculatorInputs, net_present_value_calculatorMetrics, net_present_value_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: net_present_value_calculatorInputs): number {
...
export function generateAnalysis(inputs: net_present_value_calculatorInputs, metrics: net_present_value_calculatorMetrics): net_present_value_calculatorAnalysis {
