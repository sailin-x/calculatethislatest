import { flood_insurance_calculatorInputs, flood_insurance_calculatorMetrics, flood_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: flood_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: flood_insurance_calculatorInputs, metrics: flood_insurance_calculatorMetrics): flood_insurance_calculatorAnalysis {
