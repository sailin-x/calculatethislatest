import { flood_insurance_calculatorInputs } from './types';

export function validateInputs(inputs: flood_insurance_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
