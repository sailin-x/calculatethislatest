import { real_estate_investmentCalculatorInputs } from './types';

export function validateInputs(inputs: real_estate_investmentCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
