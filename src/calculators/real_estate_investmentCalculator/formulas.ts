import { real_estate_investmentCalculatorInputs, real_estate_investmentCalculatorMetrics, real_estate_investmentCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: real_estate_investmentCalculatorInputs): number {
...
export function generateAnalysis(inputs: real_estate_investmentCalculatorInputs, metrics: real_estate_investmentCalculatorMetrics): real_estate_investmentCalculatorAnalysis {
