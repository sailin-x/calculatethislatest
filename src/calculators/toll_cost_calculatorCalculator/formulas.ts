import { toll_cost_calculatorCalculatorInputs, toll_cost_calculatorCalculatorMetrics, toll_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: toll_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: toll_cost_calculatorCalculatorInputs, metrics: toll_cost_calculatorCalculatorMetrics): toll_cost_calculatorCalculatorAnalysis {
