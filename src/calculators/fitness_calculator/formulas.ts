import { fitness_calculatorInputs, fitness_calculatorMetrics, fitness_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fitness_calculatorInputs): number {
...
export function generateAnalysis(inputs: fitness_calculatorInputs, metrics: fitness_calculatorMetrics): fitness_calculatorAnalysis {
