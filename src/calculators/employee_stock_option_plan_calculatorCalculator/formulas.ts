import { employee_stock_option_plan_calculatorCalculatorInputs, employee_stock_option_plan_calculatorCalculatorMetrics, employee_stock_option_plan_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: employee_stock_option_plan_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: employee_stock_option_plan_calculatorCalculatorInputs, metrics: employee_stock_option_plan_calculatorCalculatorMetrics): employee_stock_option_plan_calculatorCalculatorAnalysis {
