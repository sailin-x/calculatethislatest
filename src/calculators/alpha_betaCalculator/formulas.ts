import { alpha_betaCalculatorInputs, alpha_betaCalculatorMetrics, alpha_betaCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: alpha_betaCalculatorInputs): number {
...
export function generateAnalysis(inputs: alpha_betaCalculatorInputs, metrics: alpha_betaCalculatorMetrics): alpha_betaCalculatorAnalysis {
