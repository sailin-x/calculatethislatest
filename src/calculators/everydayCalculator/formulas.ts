import { everydayCalculatorInputs, everydayCalculatorMetrics, everydayCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: everydayCalculatorInputs): number {
...
export function generateAnalysis(inputs: everydayCalculatorInputs, metrics: everydayCalculatorMetrics): everydayCalculatorAnalysis {
