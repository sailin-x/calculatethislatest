import { time_tracking_cost_calculatorCalculatorInputs, time_tracking_cost_calculatorCalculatorMetrics, time_tracking_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: time_tracking_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: time_tracking_cost_calculatorCalculatorInputs, metrics: time_tracking_cost_calculatorCalculatorMetrics): time_tracking_cost_calculatorCalculatorAnalysis {
