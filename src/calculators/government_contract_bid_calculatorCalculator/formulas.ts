import { government_contract_bid_calculatorCalculatorInputs, government_contract_bid_calculatorCalculatorMetrics, government_contract_bid_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: government_contract_bid_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: government_contract_bid_calculatorCalculatorInputs, metrics: government_contract_bid_calculatorCalculatorMetrics): government_contract_bid_calculatorCalculatorAnalysis {
