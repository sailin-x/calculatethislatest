import { reverse_mortgage_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: reverse_mortgage_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
