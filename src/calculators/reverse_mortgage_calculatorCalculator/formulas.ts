import { reverse_mortgage_calculatorCalculatorInputs, reverse_mortgage_calculatorCalculatorMetrics, reverse_mortgage_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: reverse_mortgage_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: reverse_mortgage_calculatorCalculatorInputs, metrics: reverse_mortgage_calculatorCalculatorMetrics): reverse_mortgage_calculatorCalculatorAnalysis {
