import { nft_minting_cost_calculatorInputs, nft_minting_cost_calculatorMetrics, nft_minting_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: nft_minting_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: nft_minting_cost_calculatorInputs, metrics: nft_minting_cost_calculatorMetrics): nft_minting_cost_calculatorAnalysis {
