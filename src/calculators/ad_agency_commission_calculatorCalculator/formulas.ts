import { ad_agency_commission_calculatorCalculatorInputs, ad_agency_commission_calculatorCalculatorMetrics, ad_agency_commission_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: ad_agency_commission_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: ad_agency_commission_calculatorCalculatorInputs, metrics: ad_agency_commission_calculatorCalculatorMetrics): ad_agency_commission_calculatorCalculatorAnalysis {
