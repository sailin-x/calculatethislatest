import { ad_agency_commission_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: ad_agency_commission_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
