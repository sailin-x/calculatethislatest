import { total_cost_of_ownership_calculatorInputs } from './types';

export function validateInputs(inputs: total_cost_of_ownership_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
