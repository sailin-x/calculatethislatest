import { total_cost_of_ownership_calculatorInputs, total_cost_of_ownership_calculatorMetrics, total_cost_of_ownership_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: total_cost_of_ownership_calculatorInputs): number {
...
export function generateAnalysis(inputs: total_cost_of_ownership_calculatorInputs, metrics: total_cost_of_ownership_calculatorMetrics): total_cost_of_ownership_calculatorAnalysis {
