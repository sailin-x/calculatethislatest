import { home_improvement_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: home_improvement_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
