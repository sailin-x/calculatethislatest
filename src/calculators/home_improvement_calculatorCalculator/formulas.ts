import { home_improvement_calculatorCalculatorInputs, home_improvement_calculatorCalculatorMetrics, home_improvement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: home_improvement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: home_improvement_calculatorCalculatorInputs, metrics: home_improvement_calculatorCalculatorMetrics): home_improvement_calculatorCalculatorAnalysis {
