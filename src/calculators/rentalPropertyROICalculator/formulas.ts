import { rentalPropertyROICalculatorInputs, rentalPropertyROICalculatorMetrics, rentalPropertyROICalculatorAnalysis } from './types';
...
export function calculateResult(inputs: rentalPropertyROICalculatorInputs): number {
...
export function generateAnalysis(inputs: rentalPropertyROICalculatorInputs, metrics: rentalPropertyROICalculatorMetrics): rentalPropertyROICalculatorAnalysis {
