import { rentalPropertyROICalculatorInputs } from './types';

export function validateInputs(inputs: rentalPropertyROICalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
