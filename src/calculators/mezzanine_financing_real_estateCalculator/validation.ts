import { mezzanine_financing_real_estateCalculatorInputs } from './types';

export function validateInputs(inputs: mezzanine_financing_real_estateCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
