import { mezzanine_financing_real_estateCalculatorInputs, mezzanine_financing_real_estateCalculatorMetrics, mezzanine_financing_real_estateCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mezzanine_financing_real_estateCalculatorInputs): number {
...
export function generateAnalysis(inputs: mezzanine_financing_real_estateCalculatorInputs, metrics: mezzanine_financing_real_estateCalculatorMetrics): mezzanine_financing_real_estateCalculatorAnalysis {
