import { concert_ticket_cost_calculatorCalculatorInputs, concert_ticket_cost_calculatorCalculatorMetrics, concert_ticket_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: concert_ticket_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: concert_ticket_cost_calculatorCalculatorInputs, metrics: concert_ticket_cost_calculatorCalculatorMetrics): concert_ticket_cost_calculatorCalculatorAnalysis {
