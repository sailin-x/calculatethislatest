import { ethereum_2_0_staking_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: ethereum_2_0_staking_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
