import { calorie_cycling_calculatorInputs, calorie_cycling_calculatorMetrics, calorie_cycling_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: calorie_cycling_calculatorInputs): number {
...
export function generateAnalysis(inputs: calorie_cycling_calculatorInputs, metrics: calorie_cycling_calculatorMetrics): calorie_cycling_calculatorAnalysis {
