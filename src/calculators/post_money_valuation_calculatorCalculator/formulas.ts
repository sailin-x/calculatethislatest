import { post_money_valuation_calculatorCalculatorInputs, post_money_valuation_calculatorCalculatorMetrics, post_money_valuation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: post_money_valuation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: post_money_valuation_calculatorCalculatorInputs, metrics: post_money_valuation_calculatorCalculatorMetrics): post_money_valuation_calculatorCalculatorAnalysis {
