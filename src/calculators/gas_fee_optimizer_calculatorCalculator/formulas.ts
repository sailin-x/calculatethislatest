import { gas_fee_optimizer_calculatorCalculatorInputs, gas_fee_optimizer_calculatorCalculatorMetrics, gas_fee_optimizer_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: gas_fee_optimizer_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: gas_fee_optimizer_calculatorCalculatorInputs, metrics: gas_fee_optimizer_calculatorCalculatorMetrics): gas_fee_optimizer_calculatorCalculatorAnalysis {
