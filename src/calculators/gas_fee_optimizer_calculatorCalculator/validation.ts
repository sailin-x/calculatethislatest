import { gas_fee_optimizer_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: gas_fee_optimizer_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
