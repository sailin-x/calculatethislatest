import { contract_breach_calculatorCalculatorInputs, contract_breach_calculatorCalculatorMetrics, contract_breach_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: contract_breach_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: contract_breach_calculatorCalculatorInputs, metrics: contract_breach_calculatorCalculatorMetrics): contract_breach_calculatorCalculatorAnalysis {
