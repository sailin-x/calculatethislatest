import { contract_breach_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: contract_breach_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
