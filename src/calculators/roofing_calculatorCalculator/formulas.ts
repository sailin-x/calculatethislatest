import { roofing_calculatorCalculatorInputs, roofing_calculatorCalculatorMetrics, roofing_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: roofing_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: roofing_calculatorCalculatorInputs, metrics: roofing_calculatorCalculatorMetrics): roofing_calculatorCalculatorAnalysis {
