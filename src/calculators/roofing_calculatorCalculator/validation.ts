import { roofing_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: roofing_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
