import { herbal_medicine_cost_calculatorInputs, herbal_medicine_cost_calculatorMetrics, herbal_medicine_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: herbal_medicine_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: herbal_medicine_cost_calculatorInputs, metrics: herbal_medicine_cost_calculatorMetrics): herbal_medicine_cost_calculatorAnalysis {
