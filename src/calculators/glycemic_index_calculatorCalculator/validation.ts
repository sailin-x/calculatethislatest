import { glycemic_index_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: glycemic_index_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
