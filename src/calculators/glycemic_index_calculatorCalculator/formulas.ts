import { glycemic_index_calculatorCalculatorInputs, glycemic_index_calculatorCalculatorMetrics, glycemic_index_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: glycemic_index_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: glycemic_index_calculatorCalculatorInputs, metrics: glycemic_index_calculatorCalculatorMetrics): glycemic_index_calculatorCalculatorAnalysis {
