import { registerInvestmentCalculatorInputs, registerInvestmentCalculatorMetrics, registerInvestmentCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerInvestmentCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerInvestmentCalculatorInputs, metrics: registerInvestmentCalculatorMetrics): registerInvestmentCalculatorAnalysis {
