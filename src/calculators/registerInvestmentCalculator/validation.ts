import { registerInvestmentCalculatorInputs } from './types';

export function validateInputs(inputs: registerInvestmentCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
