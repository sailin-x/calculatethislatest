import { real_estate_crowdfundingCalculatorInputs } from './types';

export function validateInputs(inputs: real_estate_crowdfundingCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
