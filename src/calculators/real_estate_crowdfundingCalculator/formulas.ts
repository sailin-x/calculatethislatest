import { real_estate_crowdfundingCalculatorInputs, real_estate_crowdfundingCalculatorMetrics, real_estate_crowdfundingCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: real_estate_crowdfundingCalculatorInputs): number {
...
export function generateAnalysis(inputs: real_estate_crowdfundingCalculatorInputs, metrics: real_estate_crowdfundingCalculatorMetrics): real_estate_crowdfundingCalculatorAnalysis {
