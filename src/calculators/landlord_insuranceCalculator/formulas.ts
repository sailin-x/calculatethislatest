import { landlord_insuranceCalculatorInputs, landlord_insuranceCalculatorMetrics, landlord_insuranceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: landlord_insuranceCalculatorInputs): number {
...
export function generateAnalysis(inputs: landlord_insuranceCalculatorInputs, metrics: landlord_insuranceCalculatorMetrics): landlord_insuranceCalculatorAnalysis {
