import { landlord_insuranceCalculatorInputs } from './types';

export function validateInputs(inputs: landlord_insuranceCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
