import { cloud_migration_tco_calculatorInputs, cloud_migration_tco_calculatorMetrics, cloud_migration_tco_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cloud_migration_tco_calculatorInputs): number {
...
export function generateAnalysis(inputs: cloud_migration_tco_calculatorInputs, metrics: cloud_migration_tco_calculatorMetrics): cloud_migration_tco_calculatorAnalysis {
