import { reverse_mortgageCalculatorInputs } from './types';

export function validateInputs(inputs: reverse_mortgageCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
