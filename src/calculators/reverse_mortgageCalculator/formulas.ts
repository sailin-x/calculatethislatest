import { reverse_mortgageCalculatorInputs, reverse_mortgageCalculatorMetrics, reverse_mortgageCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: reverse_mortgageCalculatorInputs): number {
...
export function generateAnalysis(inputs: reverse_mortgageCalculatorInputs, metrics: reverse_mortgageCalculatorMetrics): reverse_mortgageCalculatorAnalysis {
