import { business_risk_assessment_calculatorCalculatorInputs, business_risk_assessment_calculatorCalculatorMetrics, business_risk_assessment_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_risk_assessment_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: business_risk_assessment_calculatorCalculatorInputs, metrics: business_risk_assessment_calculatorCalculatorMetrics): business_risk_assessment_calculatorCalculatorAnalysis {
