import { government_contract_bid_no_bid_decision_calculatorInputs, government_contract_bid_no_bid_decision_calculatorMetrics, government_contract_bid_no_bid_decision_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: government_contract_bid_no_bid_decision_calculatorInputs): number {
...
export function generateAnalysis(inputs: government_contract_bid_no_bid_decision_calculatorInputs, metrics: government_contract_bid_no_bid_decision_calculatorMetrics): government_contract_bid_no_bid_decision_calculatorAnalysis {
