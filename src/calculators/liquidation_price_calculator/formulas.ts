import { liquidation_price_calculatorInputs, liquidation_price_calculatorMetrics, liquidation_price_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: liquidation_price_calculatorInputs): number {
...
export function generateAnalysis(inputs: liquidation_price_calculatorInputs, metrics: liquidation_price_calculatorMetrics): liquidation_price_calculatorAnalysis {
