import { customer_segmentation_calculatorInputs } from './types';

export function validateInputs(inputs: customer_segmentation_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
