import { customer_segmentation_calculatorInputs, customer_segmentation_calculatorMetrics, customer_segmentation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: customer_segmentation_calculatorInputs): number {
...
export function generateAnalysis(inputs: customer_segmentation_calculatorInputs, metrics: customer_segmentation_calculatorMetrics): customer_segmentation_calculatorAnalysis {
