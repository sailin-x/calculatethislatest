import { economic_order_quantity_eoq_calculatorCalculatorInputs, economic_order_quantity_eoq_calculatorCalculatorMetrics, economic_order_quantity_eoq_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: economic_order_quantity_eoq_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: economic_order_quantity_eoq_calculatorCalculatorInputs, metrics: economic_order_quantity_eoq_calculatorCalculatorMetrics): economic_order_quantity_eoq_calculatorCalculatorAnalysis {
