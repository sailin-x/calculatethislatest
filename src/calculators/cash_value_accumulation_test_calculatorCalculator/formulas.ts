import { cash_value_accumulation_test_calculatorCalculatorInputs, cash_value_accumulation_test_calculatorCalculatorMetrics, cash_value_accumulation_test_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cash_value_accumulation_test_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cash_value_accumulation_test_calculatorCalculatorInputs, metrics: cash_value_accumulation_test_calculatorCalculatorMetrics): cash_value_accumulation_test_calculatorCalculatorAnalysis {
