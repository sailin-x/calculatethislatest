import { mold_remediation_cost_calculatorInputs } from './types';

export function validateInputs(inputs: mold_remediation_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
