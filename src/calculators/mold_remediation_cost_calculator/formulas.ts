import { mold_remediation_cost_calculatorInputs, mold_remediation_cost_calculatorMetrics, mold_remediation_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: mold_remediation_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: mold_remediation_cost_calculatorInputs, metrics: mold_remediation_cost_calculatorMetrics): mold_remediation_cost_calculatorAnalysis {
