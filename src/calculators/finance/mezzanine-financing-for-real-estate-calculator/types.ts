export interface MezzanineFinancingForRealEstateCalculatorInputs {
...
export interface MezzanineFinancingForRealEstateCalculatorOutputs {
...
export interface MezzanineFinancingForRealEstateCalculatorMetrics {
...
export interface MezzanineFinancingForRealEstateCalculatorAnalysis {
