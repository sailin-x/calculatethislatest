import { MezzanineFinancingForRealEstateCalculatorInputs } from './types';

export function validateMezzanineFinancingForRealEstateCalculatorInputs(inputs: MezzanineFinancingForRealEstateCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMezzanineFinancingForRealEstateCalculatorBusinessRules(inputs: MezzanineFinancingForRealEstateCalculatorInputs): Array<{ field: string; message: string }> {
