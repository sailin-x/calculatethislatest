import { 529-college-savings-planInputs, 529-college-savings-planMetrics, 529-college-savings-planAnalysis } from './types';
...
export function calculateResult(inputs: 529-college-savings-planInputs): number {
...
export function generateAnalysis(inputs: 529-college-savings-planInputs, metrics: 529-college-savings-planMetrics): 529-college-savings-planAnalysis {
