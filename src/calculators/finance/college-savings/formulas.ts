import { college-savingsInputs, college-savingsMetrics, college-savingsAnalysis } from './types';
...
export function calculateResult(inputs: college-savingsInputs): number {
...
export function generateAnalysis(inputs: college-savingsInputs, metrics: college-savingsMetrics): college-savingsAnalysis {
