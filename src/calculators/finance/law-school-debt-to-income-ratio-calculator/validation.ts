import { LawSchoolDebttoincomeRatioCalculatorInputs } from './types';

export function validateLawSchoolDebttoincomeRatioCalculatorInputs(inputs: LawSchoolDebttoincomeRatioCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateLawSchoolDebttoincomeRatioCalculatorBusinessRules(inputs: LawSchoolDebttoincomeRatioCalculatorInputs): Array<{ field: string; message: string }> {
