import { interest-calculatorInputs, interest-calculatorMetrics, interest-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: interest-calculatorInputs): number {
...
export function generateAnalysis(inputs: interest-calculatorInputs, metrics: interest-calculatorMetrics): interest-calculatorAnalysis {
