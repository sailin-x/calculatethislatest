...
export function validateUsdaLoanCalculatorInputs(inputs: UsdaLoanCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateUsdaLoanCalculatorBusinessRules(inputs: UsdaLoanCalculatorInputs): Array<{ field: string; message: string }> {
