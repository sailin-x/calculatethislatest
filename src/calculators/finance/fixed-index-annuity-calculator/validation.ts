import { FixedIndexAnnuityCalculatorInputs } from './types';

export function validateFixedIndexAnnuityCalculatorInputs(inputs: FixedIndexAnnuityCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateFixedIndexAnnuityCalculatorBusinessRules(inputs: FixedIndexAnnuityCalculatorInputs): Array<{ field: string; message: string }> {
