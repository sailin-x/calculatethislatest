import { CyberLiabilityInsuranceCalculatorInputs } from './types';

export function validateCyberLiabilityInsuranceCalculatorInputs(inputs: CyberLiabilityInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCyberLiabilityInsuranceCalculatorBusinessRules(inputs: CyberLiabilityInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
