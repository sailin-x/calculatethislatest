import { financial-advisory-calculatorInputs, financial-advisory-calculatorMetrics, financial-advisory-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-advisory-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-advisory-calculatorInputs, metrics: financial-advisory-calculatorMetrics): financial-advisory-calculatorAnalysis {
