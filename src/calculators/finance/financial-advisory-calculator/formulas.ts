import { FinancialAdvisoryCalculatorinputs, FinancialAdvisoryCalculatormetrics, FinancialAdvisoryCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialAdvisoryCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialAdvisoryCalculatorinputs, metrics: FinancialAdvisoryCalculatormetrics): FinancialAdvisoryCalculatoranalysis {
