export interface FinancialAdvisoryCalculatorInputs {
  ...
  // Financial Advisory Assessment
  financialAdvisoryAssessment: {
    // Advisory Components
    advisoryComponents: {
      component: string;
      score: number;
  ...
  advisoryComponents: {
    ...
    retirementAdvisory: {
      ...
      socialSecurityStrategy: 'early' | 'full_retirement' | 'delayed';
      pensionStrategy: string;
      withdrawalStrategy: 'systematic' | 'bucket' | 'dynamic' | 'annuity';
    ...
    estatePlanningAdvisory: {
      estateGoals: string[];
      estateStrategy: string;
      willPlanning: boolean;
  ...
  includeAdvisoryConsiderations: boolean;
  
  // Calculation Options
  calculationOptions: {
    includeAdvisoryAnalysis: boolean;
...
export interface FinancialAdvisoryCalculatorResults {
  // Core Financial Advisory Metrics
  financialAdvisoryScore: number;
  investmentAdvisoryScore: number;
  retirementAdvisoryScore: number;
  taxAdvisoryScore: number;
  estatePlanningAdvisoryScore: number;
  insuranceAdvisoryScore: number;
  debtAdvisoryScore: number;
  cashFlowAdvisoryScore: number;
  riskManagementAdvisoryScore: number;
  
  // Financial Advisory Analysis
  financialAdvisoryAnalysis: {
    financialAdvisoryScore: number;
    investmentAdvisoryScore: number;
    retirementAdvisoryScore: number;
    taxAdvisoryScore: number;
  ...
  // Advisory Assessment Analysis
  advisoryAssessmentAnalysis: {
    advisoryComponents: {
      component: string;
      score: number;
      weight: number;
  ...
  sensitivityAnalysis: {
    ...
    lowValue: number;
    highValue: number;
    lowAdvisoryScore: number;
    highAdvisoryScore: number;
    sensitivity: number;
  }[];
  
  // Monte Carlo Results
  monteCarloResults: {
    meanAdvisoryScore: number;
    medianAdvisoryScore: number;
  ...
  financialAdvisoryPlanningAnalysis: {
    optimizationOpportunities: {
      category: string;
      opportunity: string;
      potentialImprovement: number;
  ...
  // Financial Advisory Score
  financialAdvisoryScore: {
    overallScore: number;
    componentScores: {
      personal: number;
      financial: number;
