import { LongtermCareInsuranceCalculatorInputs } from './types';

export function validateLongtermCareInsuranceCalculatorInputs(inputs: LongtermCareInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateLongtermCareInsuranceCalculatorBusinessRules(inputs: LongtermCareInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
