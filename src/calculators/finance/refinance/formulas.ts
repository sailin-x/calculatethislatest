import { refinanceInputs, refinanceMetrics, refinanceAnalysis } from './types';
...
export function calculateResult(inputs: refinanceInputs): number {
...
export function generateAnalysis(inputs: refinanceInputs, metrics: refinanceMetrics): refinanceAnalysis {
