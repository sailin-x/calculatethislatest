import { blockchain-gas-fee-calculatorInputs, blockchain-gas-fee-calculatorMetrics, blockchain-gas-fee-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: blockchain-gas-fee-calculatorInputs): number {
...
export function generateAnalysis(inputs: blockchain-gas-fee-calculatorInputs, metrics: blockchain-gas-fee-calculatorMetrics): blockchain-gas-fee-calculatorAnalysis {
