import { BlockchainGasFee-calculatorInputs, BlockchainGasFee-calculatorMetrics, BlockchainGasFee-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: BlockchainGasFee-calculatorInputs): number {
...
export function generateAnalysis(inputs: BlockchainGasFee-calculatorInputs, metrics: BlockchainGasFee-calculatorMetrics): BlockchainGasFee-calculatorAnalysis {
