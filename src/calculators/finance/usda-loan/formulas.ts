import { usda-loanInputs, usda-loanMetrics, usda-loanAnalysis } from './types';
...
export function calculateResult(inputs: usda-loanInputs): number {
...
export function generateAnalysis(inputs: usda-loanInputs, metrics: usda-loanMetrics): usda-loanAnalysis {
