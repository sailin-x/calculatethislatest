export interface FinancialSuccessCalculatorInputs {
  ...
  successComponents: {
    ...
    wealthSuccess: {
      ...
      realEstateSuccess: boolean;
      businessSuccess: boolean;
      retirementSuccess: boolean;
      estateSuccess: boolean;
      legacySuccess: boolean;
      generationalSuccess: boolean;
    };
    
    // Income Success
    incomeSuccess: {
      incomeGrowth: boolean;
      multipleIncome: boolean;
    ...
    financialFreedomSuccess: {
      debtFreedom: boolean;
      expenseFreedom: boolean;
      timeFreedom: boolean;
      locationFreedom: boolean;
      choiceFreedom: boolean;
      lifestyleFreedom: boolean;
      securityFreedom: boolean;
      opportunityFreedom: boolean;
      legacyFreedom: boolean;
    };
    ...
    personalSuccess: {
      ...
      experienceSuccess: boolean;
      confidenceSuccess: boolean;
      satisfactionSuccess: boolean;
      fulfillmentSuccess: boolean;
      happinessSuccess: boolean;
    };
    
    // Family Success
    familySuccess: {
      familySecurity: boolean;
      educationSuccess: boolean;
      healthSuccess: boolean;
      relationshipSuccess: boolean;
      communicationSuccess: boolean;
      unitySuccess: boolean;
      valuesSuccess: boolean;
      traditionsSuccess: boolean;
      futureSuccess: boolean;
    };
    
    // Community Success
    communitySuccess: {
      communityImpact: boolean;
      leadershipSuccess: boolean;
      serviceSuccess: boolean;
      contributionSuccess: boolean;
      influenceSuccess: boolean;
      reputationSuccess: boolean;
    ...
    professionalSuccess: {
      ...
      skillAdvancement: boolean;
      leadershipSuccess: boolean;
      recognitionSuccess: boolean;
      influenceSuccess: boolean;
      networkSuccess: boolean;
      innovationSuccess: boolean;
      impactSuccess: boolean;
      legacySuccess: boolean;
    };
  };
  ...
  successStrategy: {
    ...
    goalAchievementStrategy: {
      strategy: string;
      description: string;
      achievementMethods: string[];
      achievementFrequency: string;
      achievementMetrics: string[];
    };
    
    // Continuous Success Strategy
    continuousSuccessStrategy: {
      strategy: string;
      description: string;
      successMethods: string[];
      successFrequency: string;
  ...
  includeSuccessConsiderations: boolean;
  
  // Calculation Options
  calculationOptions: {
    includeSuccessAnalysis: boolean;
...
export interface FinancialSuccessCalculatorResults {
  // Core Financial Success Metrics
  financialSuccessScore: number;
  wealthSuccessScore: number;
  incomeSuccessScore: number;
  financialFreedomSuccessScore: number;
  investmentSuccessScore: number;
  businessSuccessScore: number;
  personalSuccessScore: number;
  familySuccessScore: number;
  communitySuccessScore: number;
  professionalSuccessScore: number;
  
  // Financial Success Analysis
  financialSuccessAnalysis: {
    financialSuccessScore: number;
    wealthSuccessScore: number;
    incomeSuccessScore: number;
    financialFreedomSuccessScore: number;
  ...
  // Success Assessment Analysis
  successAssessmentAnalysis: {
    successComponents: {
      component: string;
      score: number;
      weight: number;
  ...
  successOptimizationAnalysis: {
    optimizationOpportunities: {
      category: string;
      opportunity: string;
      potentialSuccess: number;
  ...
  sensitivityAnalysis: {
    ...
    lowValue: number;
    highValue: number;
    lowSuccessScore: number;
    highSuccessScore: number;
    sensitivity: number;
  }[];
  ...
  // Financial Success Planning Analysis
  financialSuccessPlanningAnalysis: {
    optimizationOpportunities: {
      category: string;
      opportunity: string;
      potentialSuccess: number;
  ...
  financialSuccessScore: {
    overallScore: number;
    componentScores: {
      personal: number;
      financial: number;
      wealthSuccess: number;
      incomeSuccess: number;
      financialFreedomSuccess: number;
      investmentSuccess: number;
      businessSuccess: number;
      personalSuccess: number;
      familySuccess: number;
      communitySuccess: number;
      professionalSuccess: number;
    };
