import { financial-success-calculatorInputs, financial-success-calculatorMetrics, financial-success-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-success-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-success-calculatorInputs, metrics: financial-success-calculatorMetrics): financial-success-calculatorAnalysis {
