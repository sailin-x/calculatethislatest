import { FinancialSuccessCalculatorinputs, FinancialSuccessCalculatormetrics, FinancialSuccessCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialSuccessCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialSuccessCalculatorinputs, metrics: FinancialSuccessCalculatormetrics): FinancialSuccessCalculatoranalysis {
