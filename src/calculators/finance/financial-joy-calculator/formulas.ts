import { FinancialJoyCalculatorinputs, FinancialJoyCalculatormetrics, FinancialJoyCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialJoyCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialJoyCalculatorinputs, metrics: FinancialJoyCalculatormetrics): FinancialJoyCalculatoranalysis {
