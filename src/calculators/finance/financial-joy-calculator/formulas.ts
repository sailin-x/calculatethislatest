import { financial-joy-calculatorInputs, financial-joy-calculatorMetrics, financial-joy-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-joy-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-joy-calculatorInputs, metrics: financial-joy-calculatorMetrics): financial-joy-calculatorAnalysis {
