import { DefinedBenefitPlanCalculatorInputs } from './types';

export function validateDefinedBenefitPlanCalculatorInputs(inputs: DefinedBenefitPlanCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDefinedBenefitPlanCalculatorBusinessRules(inputs: DefinedBenefitPlanCalculatorInputs): Array<{ field: string; message: string }> {
