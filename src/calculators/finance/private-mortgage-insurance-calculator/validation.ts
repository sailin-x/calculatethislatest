import { PrivateMortgageInsuranceCalculatorInputs } from './types';

export function validatePrivateMortgageInsuranceCalculatorInputs(inputs: PrivateMortgageInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePrivateMortgageInsuranceCalculatorBusinessRules(inputs: PrivateMortgageInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
