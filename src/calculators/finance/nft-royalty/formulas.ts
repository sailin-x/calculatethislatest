import { nft-royaltyInputs, nft-royaltyMetrics, nft-royaltyAnalysis } from './types';
...
export function calculateResult(inputs: nft-royaltyInputs): number {
...
export function generateAnalysis(inputs: nft-royaltyInputs, metrics: nft-royaltyMetrics): nft-royaltyAnalysis {
