import { DisabilityInsuranceNeedsCalculatorInputs } from './types';

export function validateDisabilityInsuranceNeedsCalculatorInputs(inputs: DisabilityInsuranceNeedsCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDisabilityInsuranceNeedsCalculatorBusinessRules(inputs: DisabilityInsuranceNeedsCalculatorInputs): Array<{ field: string; message: string }> {
