import { financial-goal-calculatorInputs, financial-goal-calculatorMetrics, financial-goal-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-goal-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-goal-calculatorInputs, metrics: financial-goal-calculatorMetrics): financial-goal-calculatorAnalysis {
