import { FinancialGoalCalculatorinputs, FinancialGoalCalculatormetrics, FinancialGoalCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialGoalCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialGoalCalculatorinputs, metrics: FinancialGoalCalculatormetrics): FinancialGoalCalculatoranalysis {
