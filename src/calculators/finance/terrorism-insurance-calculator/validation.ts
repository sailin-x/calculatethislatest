import { TerrorismInsuranceCalculatorInputs } from './types';

export function validateTerrorismInsuranceCalculatorInputs(inputs: TerrorismInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTerrorismInsuranceCalculatorBusinessRules(inputs: TerrorismInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
