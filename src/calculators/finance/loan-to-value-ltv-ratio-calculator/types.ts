export interface LoantovalueLtvRatioCalculatorInputs {
...
export interface LoantovalueLtvRatioCalculatorOutputs {
...
export interface LoantovalueLtvRatioCalculatorMetrics {
...
export interface LoantovalueLtvRatioCalculatorAnalysis {
