import { LoantovalueLtvRatioCalculatorInputs } from './types';

export function validateLoantovalueLtvRatioCalculatorInputs(inputs: LoantovalueLtvRatioCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateLoantovalueLtvRatioCalculatorBusinessRules(inputs: LoantovalueLtvRatioCalculatorInputs): Array<{ field: string; message: string }> {
