import { RealEstateWaterfallModelCalculatorInputs } from './types';

export function validateRealEstateWaterfallModelCalculatorInputs(inputs: RealEstateWaterfallModelCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateRealEstateWaterfallModelCalculatorBusinessRules(inputs: RealEstateWaterfallModelCalculatorInputs): Array<{ field: string; message: string }> {
