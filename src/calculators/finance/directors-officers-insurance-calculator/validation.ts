import { DirectorsOfficersInsuranceCalculatorInputs } from './types';

export function validateDirectorsOfficersInsuranceCalculatorInputs(inputs: DirectorsOfficersInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDirectorsOfficersInsuranceCalculatorBusinessRules(inputs: DirectorsOfficersInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
