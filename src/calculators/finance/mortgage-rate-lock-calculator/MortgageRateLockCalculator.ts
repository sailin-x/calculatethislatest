...
import { MortgageRateLockCalculatorInputs, MortgageRateLockCalculatorOutputs } from './types';
import {
...
import { validateMortgageRateLockCalculatorInputs, validateMortgageRateLockCalculatorBusinessRules } from './validation';

export const MortgageRateLockCalculatorCalculator: Calculator: Calculator = {
  id: 'mortgage-rate-lock-calculator-calculator',
  title: 'Mortgage Rate Lock Calculator Calculator',
