...
export function validateMortgageRateLockCalculatorInputs(inputs: MortgageRateLockCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMortgageRateLockCalculatorBusinessRules(inputs: MortgageRateLockCalculatorInputs): Array<{ field: string; message: string }> {
