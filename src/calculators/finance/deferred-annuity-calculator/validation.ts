import { DeferredAnnuityCalculatorInputs } from './types';

export function validateDeferredAnnuityCalculatorInputs(inputs: DeferredAnnuityCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDeferredAnnuityCalculatorBusinessRules(inputs: DeferredAnnuityCalculatorInputs): Array<{ field: string; message: string }> {
