import { budget-planner-calculatorInputs, budget-planner-calculatorMetrics, budget-planner-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: budget-planner-calculatorInputs): number {
...
export function generateAnalysis(inputs: budget-planner-calculatorInputs, metrics: budget-planner-calculatorMetrics): budget-planner-calculatorAnalysis {
