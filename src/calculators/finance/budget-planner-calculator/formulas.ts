import { BudgetPlannerCalculatorinputs, BudgetPlannerCalculatormetrics, BudgetPlannerCalculatoranalysis } from './types';
...
export function calculateResult(inputs: BudgetPlannerCalculatorinputs): number {
...
export function generateAnalysis(inputs: BudgetPlannerCalculatorinputs, metrics: BudgetPlannerCalculatormetrics): BudgetPlannerCalculatoranalysis {
