import { financial-coaching-calculatorInputs, financial-coaching-calculatorMetrics, financial-coaching-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-coaching-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-coaching-calculatorInputs, metrics: financial-coaching-calculatorMetrics): financial-coaching-calculatorAnalysis {
