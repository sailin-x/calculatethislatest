import { FinancialCoachingCalculatorinputs, FinancialCoachingCalculatormetrics, FinancialCoachingCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialCoachingCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialCoachingCalculatorinputs, metrics: FinancialCoachingCalculatormetrics): FinancialCoachingCalculatoranalysis {
