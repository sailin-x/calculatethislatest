...
import { IrrevocableLifeInsuranceTrustIlitValueCalculatorInputs, IrrevocableLifeInsuranceTrustIlitValueCalculatorOutputs } from './types';
import {
...
export const IrrevocableLifeInsuranceTrustIlitValueCalculator: Calculator = {
  ...
  description: 'Calculate ILIT value and tax benefits.',
  usageInstructions: [
