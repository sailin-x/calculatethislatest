import { homeowners-insuranceInputs, homeowners-insuranceMetrics, homeowners-insuranceAnalysis } from './types';
...
export function calculateResult(inputs: homeowners-insuranceInputs): number {
...
export function generateAnalysis(inputs: homeowners-insuranceInputs, metrics: homeowners-insuranceMetrics): homeowners-insuranceAnalysis {
