...
export function calculateHomeownersInsurance(inputs: CalculatorInputs): CalculatorOutputs {
  ...
  return {
    ...
    coverageAdequacy,
    policyGrade,
    homeownersInsuranceAnalysis: 'Comprehensive homeowners insurance analysis completed'
  };
}

export function generateHomeownersInsuranceAnalysis(inputs: CalculatorInputs, outputs: CalculatorOutputs): string {
  return `# Homeowners Insurance Analysis
