...
import { TaxLossHarvestingCalculatorInputs, TaxLossHarvestingCalculatorOutputs } from './types';
import {
...
export const TaxLossHarvestingCalculator: Calculator = {
  ...
  description: 'Calculate tax-loss harvesting strategies to reduce capital gains tax.',
  usageInstructions: [
