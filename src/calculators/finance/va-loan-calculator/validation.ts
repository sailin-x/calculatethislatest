import { VaLoanCalculatorInputs } from './types';

export function validateVaLoanCalculatorInputs(inputs: VaLoanCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateVaLoanCalculatorBusinessRules(inputs: VaLoanCalculatorInputs): Array<{ field: string; message: string }> {
