export interface VaLoanCalculatorInputs {
...
export interface VaLoanCalculatorOutputs {
...
export interface VaLoanCalculatorMetrics {
...
export interface VaLoanCalculatorAnalysis {
