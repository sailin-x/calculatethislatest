import { flood-insuranceInputs, flood-insuranceMetrics, flood-insuranceAnalysis } from './types';
...
export function calculateResult(inputs: flood-insuranceInputs): number {
...
export function generateAnalysis(inputs: flood-insuranceInputs, metrics: flood-insuranceMetrics): flood-insuranceAnalysis {
