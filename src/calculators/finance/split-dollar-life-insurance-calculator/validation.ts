import { SplitDollarLifeInsuranceCalculatorInputs } from './types';

export function validateSplitDollarLifeInsuranceCalculatorInputs(inputs: SplitDollarLifeInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateSplitDollarLifeInsuranceCalculatorBusinessRules(inputs: SplitDollarLifeInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
