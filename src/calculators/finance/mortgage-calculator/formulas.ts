import { mortgage-calculatorInputs, mortgage-calculatorMetrics, mortgage-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgage-calculatorInputs): number {
...
export function generateAnalysis(inputs: mortgage-calculatorInputs, metrics: mortgage-calculatorMetrics): mortgage-calculatorAnalysis {
