...
export const cost_of_poor_quality_copq_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Cost of Poor Quality (COPQ) Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Cost of Poor Quality (COPQ) Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Cost of Poor Quality (COPQ) Calculator calculation',
