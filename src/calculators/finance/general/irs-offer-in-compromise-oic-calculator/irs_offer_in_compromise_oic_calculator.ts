...
export const irs_offer_in_compromise_oic_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate IRS Offer in Compromise (OIC) Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your IRS Offer in Compromise (OIC) Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic IRS Offer in Compromise (OIC) Calculator calculation',
