...
export const MassTortSettlement-calculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Mass Tort Settlement Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Mass Tort Settlement Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Mass Tort Settlement Calculator calculation',
