...
export const NumberTheoryCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Number Theory Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Number Theory Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Number Theory Calculator calculation',
