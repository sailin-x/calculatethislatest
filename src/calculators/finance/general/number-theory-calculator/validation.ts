import { number_theory_calculatorInputs } from './types';
...
export function validatenumber_theory_calculatorInputs(inputs: number_theory_calculatorInputs): ValidationResult[] {
...
export function validatenumber_theory_calculatorBusinessRules(inputs: number_theory_calculatorInputs): ValidationResult[] {
