import { baking-calculatorInputs, baking-calculatorMetrics, baking-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: baking-calculatorInputs): number {
...
export function generateAnalysis(inputs: baking-calculatorInputs, metrics: baking-calculatorMetrics): baking-calculatorAnalysis {
