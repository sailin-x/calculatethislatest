import { LongTermCare-insurance-calculatorInputs, LongTermCare-insurance-calculatorMetrics, LongTermCare-insurance-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: LongTermCare-insurance-calculatorInputs): number {
...
export function generateAnalysis(inputs: LongTermCare-insurance-calculatorInputs, metrics: LongTermCare-insurance-calculatorMetrics): LongTermCare-insurance-calculatorAnalysis {
