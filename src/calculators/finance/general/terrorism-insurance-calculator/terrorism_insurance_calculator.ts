...
export const TerrorismInsuranceCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Terrorism Insurance Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Terrorism Insurance Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Terrorism Insurance Calculator calculation',
