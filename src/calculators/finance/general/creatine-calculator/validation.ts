import { creatine_calculatorInputs } from './types';
...
export function validatecreatine_calculatorInputs(inputs: creatine_calculatorInputs): ValidationResult[] {
...
export function validatecreatine_calculatorBusinessRules(inputs: creatine_calculatorInputs): ValidationResult[] {
