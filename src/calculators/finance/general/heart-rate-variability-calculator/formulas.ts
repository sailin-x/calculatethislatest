import { HeartRateVariability-calculatorInputs, HeartRateVariability-calculatorMetrics, HeartRateVariability-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: HeartRateVariability-calculatorInputs): number {
...
export function generateAnalysis(inputs: HeartRateVariability-calculatorInputs, metrics: HeartRateVariability-calculatorMetrics): HeartRateVariability-calculatorAnalysis {
