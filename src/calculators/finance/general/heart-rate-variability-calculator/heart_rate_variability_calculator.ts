...
export const heart_rate_variability_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Heart Rate Variability Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Heart Rate Variability Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Heart Rate Variability Calculator calculation',
