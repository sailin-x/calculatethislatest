...
export const employee_turnover_cost_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Employee Turnover Cost Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Employee Turnover Cost Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Employee Turnover Cost Calculator calculation',
