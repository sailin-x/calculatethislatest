...
export const buy_sell_agreement_insurance_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Buy-Sell Agreement Insurance Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Buy-Sell Agreement Insurance Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Buy-Sell Agreement Insurance Calculator calculation',
