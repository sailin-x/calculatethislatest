...
export const salary_benchmarking_pay_equity_gap_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Salary Benchmarking & Pay Equity Gap Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Salary Benchmarking & Pay Equity Gap Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Salary Benchmarking & Pay Equity Gap Calculator calculation',
