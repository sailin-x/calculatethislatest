import { SalaryBenchmarkingPay-EquityGapCalculatorinputs, SalaryBenchmarkingPay-EquityGapCalculatormetrics, SalaryBenchmarkingPay-EquityGapCalculatoranalysis } from './types';
...
export function calculateResult(inputs: SalaryBenchmarkingPay-EquityGapCalculatorinputs): number {
...
export function generateAnalysis(inputs: SalaryBenchmarkingPay-EquityGapCalculatorinputs, metrics: SalaryBenchmarkingPay-EquityGapCalculatormetrics): SalaryBenchmarkingPay-EquityGapCalculatoranalysis {
