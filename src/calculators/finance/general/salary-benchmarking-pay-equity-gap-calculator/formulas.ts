import { salary-benchmarking-pay-equity-gap-calculatorInputs, salary-benchmarking-pay-equity-gap-calculatorMetrics, salary-benchmarking-pay-equity-gap-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: salary-benchmarking-pay-equity-gap-calculatorInputs): number {
...
export function generateAnalysis(inputs: salary-benchmarking-pay-equity-gap-calculatorInputs, metrics: salary-benchmarking-pay-equity-gap-calculatorMetrics): salary-benchmarking-pay-equity-gap-calculatorAnalysis {
