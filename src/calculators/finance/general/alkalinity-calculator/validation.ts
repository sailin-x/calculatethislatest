import { alkalinity_calculatorInputs } from './types';
...
export function validatealkalinity_calculatorInputs(inputs: alkalinity_calculatorInputs): ValidationResult[] {
...
export function validatealkalinity_calculatorBusinessRules(inputs: alkalinity_calculatorInputs): ValidationResult[] {
