...
export const alkalinity-calculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Alkalinity Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Alkalinity Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Alkalinity Calculator calculation',
