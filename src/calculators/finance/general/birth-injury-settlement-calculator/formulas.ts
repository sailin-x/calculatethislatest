import { birth-injury-settlement-calculatorInputs, birth-injury-settlement-calculatorMetrics, birth-injury-settlement-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: birth-injury-settlement-calculatorInputs): number {
...
export function generateAnalysis(inputs: birth-injury-settlement-calculatorInputs, metrics: birth-injury-settlement-calculatorMetrics): birth-injury-settlement-calculatorAnalysis {
