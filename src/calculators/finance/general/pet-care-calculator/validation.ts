import { pet_care_calculatorInputs } from './types';
...
export function validatepet_care_calculatorInputs(inputs: pet_care_calculatorInputs): ValidationResult[] {
...
export function validatepet_care_calculatorBusinessRules(inputs: pet_care_calculatorInputs): ValidationResult[] {
