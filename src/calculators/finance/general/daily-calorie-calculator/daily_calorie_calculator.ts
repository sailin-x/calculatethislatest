...
export const DailyCalorieCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Daily Calorie Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Daily Calorie Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Daily Calorie Calculator calculation',
