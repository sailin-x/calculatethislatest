import { daily_calorie_calculatorInputs } from './types';
...
export function validatedaily_calorie_calculatorInputs(inputs: daily_calorie_calculatorInputs): ValidationResult[] {
...
export function validatedaily_calorie_calculatorBusinessRules(inputs: daily_calorie_calculatorInputs): ValidationResult[] {
