import { RoundupSettlementCalculatorinputs, RoundupSettlementCalculatormetrics, RoundupSettlementCalculatoranalysis } from './types';
...
export function calculateResult(inputs: RoundupSettlementCalculatorinputs): number {
...
export function generateAnalysis(inputs: RoundupSettlementCalculatorinputs, metrics: RoundupSettlementCalculatormetrics): RoundupSettlementCalculatoranalysis {
