import { data_governance_roi_calculatorInputs } from './types';
...
export function validatedata_governance_roi_calculatorInputs(inputs: data_governance_roi_calculatorInputs): ValidationResult[] {
...
export function validatedata_governance_roi_calculatorBusinessRules(inputs: data_governance_roi_calculatorInputs): ValidationResult[] {
