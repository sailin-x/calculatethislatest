import { blood_alcohol_calculatorInputs } from './types';
...
export function validateblood_alcohol_calculatorInputs(inputs: blood_alcohol_calculatorInputs): ValidationResult[] {
...
export function validateblood_alcohol_calculatorBusinessRules(inputs: blood_alcohol_calculatorInputs): ValidationResult[] {
