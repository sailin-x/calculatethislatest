...
export const DogBiteSettlement-calculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Dog Bite Settlement Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Dog Bite Settlement Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Dog Bite Settlement Calculator calculation',
