import { dog_bite_settlement_calculatorInputs } from './types';
...
export function validatedog_bite_settlement_calculatorInputs(inputs: dog_bite_settlement_calculatorInputs): ValidationResult[] {
...
export function validatedog_bite_settlement_calculatorBusinessRules(inputs: dog_bite_settlement_calculatorInputs): ValidationResult[] {
