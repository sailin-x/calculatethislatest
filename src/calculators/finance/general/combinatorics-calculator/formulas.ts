import { combinatorics-calculatorInputs, combinatorics-calculatorMetrics, combinatorics-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: combinatorics-calculatorInputs): number {
...
export function generateAnalysis(inputs: combinatorics-calculatorInputs, metrics: combinatorics-calculatorMetrics): combinatorics-calculatorAnalysis {
