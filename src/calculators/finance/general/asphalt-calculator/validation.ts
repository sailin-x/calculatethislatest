import { asphalt_calculatorInputs } from './types';
...
export function validateasphalt_calculatorInputs(inputs: asphalt_calculatorInputs): ValidationResult[] {
...
export function validateasphalt_calculatorBusinessRules(inputs: asphalt_calculatorInputs): ValidationResult[] {
