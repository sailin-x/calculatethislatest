...
export const cholesterol-calculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Cholesterol Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Cholesterol Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Cholesterol Calculator calculation',
