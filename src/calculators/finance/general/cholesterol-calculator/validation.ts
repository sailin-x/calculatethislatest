import { cholesterol_calculatorInputs } from './types';
...
export function validatecholesterol_calculatorInputs(inputs: cholesterol_calculatorInputs): ValidationResult[] {
...
export function validatecholesterol_calculatorBusinessRules(inputs: cholesterol_calculatorInputs): ValidationResult[] {
