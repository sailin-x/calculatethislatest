import { food_combining_calculatorInputs } from './types';
...
export function validatefood_combining_calculatorInputs(inputs: food_combining_calculatorInputs): ValidationResult[] {
...
export function validatefood_combining_calculatorBusinessRules(inputs: food_combining_calculatorInputs): ValidationResult[] {
