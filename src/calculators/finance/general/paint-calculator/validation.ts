import { paint_calculatorInputs } from './types';
...
export function validatepaint_calculatorInputs(inputs: paint_calculatorInputs): ValidationResult[] {
...
export function validatepaint_calculatorBusinessRules(inputs: paint_calculatorInputs): ValidationResult[] {
