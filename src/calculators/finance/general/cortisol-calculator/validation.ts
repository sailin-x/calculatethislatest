import { cortisol_calculatorInputs } from './types';
...
export function validatecortisol_calculatorInputs(inputs: cortisol_calculatorInputs): ValidationResult[] {
...
export function validatecortisol_calculatorBusinessRules(inputs: cortisol_calculatorInputs): ValidationResult[] {
