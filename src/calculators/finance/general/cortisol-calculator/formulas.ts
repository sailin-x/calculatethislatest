import { cortisol-calculatorInputs, cortisol-calculatorMetrics, cortisol-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cortisol-calculatorInputs): number {
...
export function generateAnalysis(inputs: cortisol-calculatorInputs, metrics: cortisol-calculatorMetrics): cortisol-calculatorAnalysis {
