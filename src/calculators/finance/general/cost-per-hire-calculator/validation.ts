import { cost_per_hire_calculatorInputs } from './types';
...
export function validatecost_per_hire_calculatorInputs(inputs: cost_per_hire_calculatorInputs): ValidationResult[] {
...
export function validatecost_per_hire_calculatorBusinessRules(inputs: cost_per_hire_calculatorInputs): ValidationResult[] {
