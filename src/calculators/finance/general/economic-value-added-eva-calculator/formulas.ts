import { EconomicValueAdded-eva-calculatorInputs, EconomicValueAdded-eva-calculatorMetrics, EconomicValueAdded-eva-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: EconomicValueAdded-eva-calculatorInputs): number {
...
export function generateAnalysis(inputs: EconomicValueAdded-eva-calculatorInputs, metrics: EconomicValueAdded-eva-calculatorMetrics): EconomicValueAdded-eva-calculatorAnalysis {
