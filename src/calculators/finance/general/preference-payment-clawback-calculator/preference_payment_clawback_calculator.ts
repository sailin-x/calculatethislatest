...
export const PreferencePaymentClawback-calculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Preference Payment Clawback Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Preference Payment Clawback Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Preference Payment Clawback Calculator calculation',
