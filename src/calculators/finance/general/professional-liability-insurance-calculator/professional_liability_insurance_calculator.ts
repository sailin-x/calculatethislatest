...
export const ProfessionalLiabilityInsurance-calculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Professional Liability Insurance Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Professional Liability Insurance Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Professional Liability Insurance Calculator calculation',
