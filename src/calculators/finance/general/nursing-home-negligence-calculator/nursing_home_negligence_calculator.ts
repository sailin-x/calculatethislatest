...
export const nursing_home_negligence_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Nursing Home Negligence Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Nursing Home Negligence Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Nursing Home Negligence Calculator calculation',
