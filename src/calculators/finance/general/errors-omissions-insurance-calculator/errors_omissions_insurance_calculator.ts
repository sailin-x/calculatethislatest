...
export const ErrorsOmissionsInsurance-calculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Errors & Omissions Insurance Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Errors & Omissions Insurance Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Errors & Omissions Insurance Calculator calculation',
