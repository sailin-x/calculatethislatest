import { roofing-calculatorInputs, roofing-calculatorMetrics, roofing-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: roofing-calculatorInputs): number {
...
export function generateAnalysis(inputs: roofing-calculatorInputs, metrics: roofing-calculatorMetrics): roofing-calculatorAnalysis {
