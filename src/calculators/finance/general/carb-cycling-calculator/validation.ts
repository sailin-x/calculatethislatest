import { carb_cycling_calculatorInputs } from './types';
...
export function validatecarb_cycling_calculatorInputs(inputs: carb_cycling_calculatorInputs): ValidationResult[] {
...
export function validatecarb_cycling_calculatorBusinessRules(inputs: carb_cycling_calculatorInputs): ValidationResult[] {
