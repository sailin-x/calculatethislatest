...
export const carb_cycling_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Carb Cycling Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Carb Cycling Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Carb Cycling Calculator calculation',
