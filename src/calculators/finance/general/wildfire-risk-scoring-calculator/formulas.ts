import { WildfireRiskScoring-calculatorInputs, WildfireRiskScoring-calculatorMetrics, WildfireRiskScoring-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: WildfireRiskScoring-calculatorInputs): number {
...
export function generateAnalysis(inputs: WildfireRiskScoring-calculatorInputs, metrics: WildfireRiskScoring-calculatorMetrics): WildfireRiskScoring-calculatorAnalysis {
