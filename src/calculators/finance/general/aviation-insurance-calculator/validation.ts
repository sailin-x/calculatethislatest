import { aviation_insurance_calculatorInputs } from './types';
...
export function validateaviation_insurance_calculatorInputs(inputs: aviation_insurance_calculatorInputs): ValidationResult[] {
...
export function validateaviation_insurance_calculatorBusinessRules(inputs: aviation_insurance_calculatorInputs): ValidationResult[] {
