...
export const dui_accident_settlement_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate DUI Accident Settlement Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your DUI Accident Settlement Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic DUI Accident Settlement Calculator calculation',
