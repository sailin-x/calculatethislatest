import { blood_sugar_calculatorInputs } from './types';
...
export function validateblood_sugar_calculatorInputs(inputs: blood_sugar_calculatorInputs): ValidationResult[] {
...
export function validateblood_sugar_calculatorBusinessRules(inputs: blood_sugar_calculatorInputs): ValidationResult[] {
