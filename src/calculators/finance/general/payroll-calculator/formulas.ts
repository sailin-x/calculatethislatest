import { payroll-calculatorInputs, payroll-calculatorMetrics, payroll-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: payroll-calculatorInputs): number {
...
export function generateAnalysis(inputs: payroll-calculatorInputs, metrics: payroll-calculatorMetrics): payroll-calculatorAnalysis {
