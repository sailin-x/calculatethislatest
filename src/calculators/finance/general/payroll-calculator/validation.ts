import { payroll_calculatorInputs } from './types';
...
export function validatepayroll_calculatorInputs(inputs: payroll_calculatorInputs): ValidationResult[] {
...
export function validatepayroll_calculatorBusinessRules(inputs: payroll_calculatorInputs): ValidationResult[] {
