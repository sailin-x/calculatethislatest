...
export const garden_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Garden Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Garden Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Garden Calculator calculation',
