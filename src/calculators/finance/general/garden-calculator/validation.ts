import { garden_calculatorInputs } from './types';
...
export function validategarden_calculatorInputs(inputs: garden_calculatorInputs): ValidationResult[] {
...
export function validategarden_calculatorBusinessRules(inputs: garden_calculatorInputs): ValidationResult[] {
