import { garden-calculatorInputs, garden-calculatorMetrics, garden-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: garden-calculatorInputs): number {
...
export function generateAnalysis(inputs: garden-calculatorInputs, metrics: garden-calculatorMetrics): garden-calculatorAnalysis {
