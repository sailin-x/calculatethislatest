import { average_order_value_calculatorInputs } from './types';
...
export function validateaverage_order_value_calculatorInputs(inputs: average_order_value_calculatorInputs): ValidationResult[] {
...
export function validateaverage_order_value_calculatorBusinessRules(inputs: average_order_value_calculatorInputs): ValidationResult[] {
