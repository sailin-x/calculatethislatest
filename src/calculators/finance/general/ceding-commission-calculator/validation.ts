import { ceding_commission_calculatorInputs } from './types';
...
export function validateceding_commission_calculatorInputs(inputs: ceding_commission_calculatorInputs): ValidationResult[] {
...
export function validateceding_commission_calculatorBusinessRules(inputs: ceding_commission_calculatorInputs): ValidationResult[] {
