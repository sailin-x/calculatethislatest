import { patent_valuation_calculatorInputs } from './types';
...
export function validatepatent_valuation_calculatorInputs(inputs: patent_valuation_calculatorInputs): ValidationResult[] {
...
export function validatepatent_valuation_calculatorBusinessRules(inputs: patent_valuation_calculatorInputs): ValidationResult[] {
