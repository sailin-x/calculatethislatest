import { glycemic-index-calculatorInputs, glycemic-index-calculatorMetrics, glycemic-index-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: glycemic-index-calculatorInputs): number {
...
export function generateAnalysis(inputs: glycemic-index-calculatorInputs, metrics: glycemic-index-calculatorMetrics): glycemic-index-calculatorAnalysis {
