import { GlycemicIndexCalculatorinputs, GlycemicIndexCalculatormetrics, GlycemicIndexCalculatoranalysis } from './types';
...
export function calculateResult(inputs: GlycemicIndexCalculatorinputs): number {
...
export function generateAnalysis(inputs: GlycemicIndexCalculatorinputs, metrics: GlycemicIndexCalculatormetrics): GlycemicIndexCalculatoranalysis {
