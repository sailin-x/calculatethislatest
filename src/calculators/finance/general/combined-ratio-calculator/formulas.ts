import { combined-ratio-calculatorInputs, combined-ratio-calculatorMetrics, combined-ratio-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: combined-ratio-calculatorInputs): number {
...
export function generateAnalysis(inputs: combined-ratio-calculatorInputs, metrics: combined-ratio-calculatorMetrics): combined-ratio-calculatorAnalysis {
