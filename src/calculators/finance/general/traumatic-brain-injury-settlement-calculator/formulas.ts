import { TraumaticBrainInjury-settlement-calculatorInputs, TraumaticBrainInjury-settlement-calculatorMetrics, TraumaticBrainInjury-settlement-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: TraumaticBrainInjury-settlement-calculatorInputs): number {
...
export function generateAnalysis(inputs: TraumaticBrainInjury-settlement-calculatorInputs, metrics: TraumaticBrainInjury-settlement-calculatorMetrics): TraumaticBrainInjury-settlement-calculatorAnalysis {
