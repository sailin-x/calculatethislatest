import { MergerModelCalculatorinputs, MergerModelCalculatormetrics, MergerModelCalculatoranalysis } from './types';
...
export function calculateResult(inputs: MergerModelCalculatorinputs): number {
...
export function generateAnalysis(inputs: MergerModelCalculatorinputs, metrics: MergerModelCalculatormetrics): MergerModelCalculatoranalysis {
