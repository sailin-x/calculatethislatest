...
export const DirectorsOfficersInsurance-calculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Directors & Officers Insurance Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Directors & Officers Insurance Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Directors & Officers Insurance Calculator calculation',
