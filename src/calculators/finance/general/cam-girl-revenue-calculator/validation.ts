import { cam_girl_revenue_calculatorInputs } from './types';
...
export function validatecam_girl_revenue_calculatorInputs(inputs: cam_girl_revenue_calculatorInputs): ValidationResult[] {
...
export function validatecam_girl_revenue_calculatorBusinessRules(inputs: cam_girl_revenue_calculatorInputs): ValidationResult[] {
