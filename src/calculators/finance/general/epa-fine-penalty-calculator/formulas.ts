import { EpaFinePenalty-calculatorInputs, EpaFinePenalty-calculatorMetrics, EpaFinePenalty-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: EpaFinePenalty-calculatorInputs): number {
...
export function generateAnalysis(inputs: EpaFinePenalty-calculatorInputs, metrics: EpaFinePenalty-calculatorMetrics): EpaFinePenalty-calculatorAnalysis {
