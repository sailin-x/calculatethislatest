import { epa_fine_penalty_calculatorInputs } from './types';
...
export function validateepa_fine_penalty_calculatorInputs(inputs: epa_fine_penalty_calculatorInputs): ValidationResult[] {
...
export function validateepa_fine_penalty_calculatorBusinessRules(inputs: epa_fine_penalty_calculatorInputs): ValidationResult[] {
