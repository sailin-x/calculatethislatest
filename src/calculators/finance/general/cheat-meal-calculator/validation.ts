import { cheat_meal_calculatorInputs } from './types';
...
export function validatecheat_meal_calculatorInputs(inputs: cheat_meal_calculatorInputs): ValidationResult[] {
...
export function validatecheat_meal_calculatorBusinessRules(inputs: cheat_meal_calculatorInputs): ValidationResult[] {
