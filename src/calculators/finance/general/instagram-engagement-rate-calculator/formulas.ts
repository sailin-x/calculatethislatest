import { InstagramEngagementRate-calculatorInputs, InstagramEngagementRate-calculatorMetrics, InstagramEngagementRate-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: InstagramEngagementRate-calculatorInputs): number {
...
export function generateAnalysis(inputs: InstagramEngagementRate-calculatorInputs, metrics: InstagramEngagementRate-calculatorMetrics): InstagramEngagementRate-calculatorAnalysis {
