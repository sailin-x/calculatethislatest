import { instagram-engagement-rate-calculatorInputs, instagram-engagement-rate-calculatorMetrics, instagram-engagement-rate-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: instagram-engagement-rate-calculatorInputs): number {
...
export function generateAnalysis(inputs: instagram-engagement-rate-calculatorInputs, metrics: instagram-engagement-rate-calculatorMetrics): instagram-engagement-rate-calculatorAnalysis {
