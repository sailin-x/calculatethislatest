import { marine_insurance_calculatorInputs } from './types';
...
export function validatemarine_insurance_calculatorInputs(inputs: marine_insurance_calculatorInputs): ValidationResult[] {
...
export function validatemarine_insurance_calculatorBusinessRules(inputs: marine_insurance_calculatorInputs): ValidationResult[] {
