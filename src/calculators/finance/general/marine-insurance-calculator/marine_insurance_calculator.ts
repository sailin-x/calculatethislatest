...
export const marine_insurance_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Marine Insurance Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Marine Insurance Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Marine Insurance Calculator calculation',
