...
export const fitness_age_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Fitness Age Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Fitness Age Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Fitness Age Calculator calculation',
