import { fitness_age_calculatorInputs } from './types';
...
export function validatefitness_age_calculatorInputs(inputs: fitness_age_calculatorInputs): ValidationResult[] {
...
export function validatefitness_age_calculatorBusinessRules(inputs: fitness_age_calculatorInputs): ValidationResult[] {
