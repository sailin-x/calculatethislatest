...
export const film_distribution_waterfall_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Film Distribution Waterfall Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Film Distribution Waterfall Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Film Distribution Waterfall Calculator calculation',
