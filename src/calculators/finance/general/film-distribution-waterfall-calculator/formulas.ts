import { FilmDistributionWaterfall-calculatorInputs, FilmDistributionWaterfall-calculatorMetrics, FilmDistributionWaterfall-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: FilmDistributionWaterfall-calculatorInputs): number {
...
export function generateAnalysis(inputs: FilmDistributionWaterfall-calculatorInputs, metrics: FilmDistributionWaterfall-calculatorMetrics): FilmDistributionWaterfall-calculatorAnalysis {
