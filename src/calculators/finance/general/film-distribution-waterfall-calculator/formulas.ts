import { film-distribution-waterfall-calculatorInputs, film-distribution-waterfall-calculatorMetrics, film-distribution-waterfall-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: film-distribution-waterfall-calculatorInputs): number {
...
export function generateAnalysis(inputs: film-distribution-waterfall-calculatorInputs, metrics: film-distribution-waterfall-calculatorMetrics): film-distribution-waterfall-calculatorAnalysis {
