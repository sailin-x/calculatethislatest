import { catastrophe_bond_pricing_modelInputs } from './types';
...
export function validatecatastrophe_bond_pricing_modelInputs(inputs: catastrophe_bond_pricing_modelInputs): ValidationResult[] {
...
export function validatecatastrophe_bond_pricing_modelBusinessRules(inputs: catastrophe_bond_pricing_modelInputs): ValidationResult[] {
