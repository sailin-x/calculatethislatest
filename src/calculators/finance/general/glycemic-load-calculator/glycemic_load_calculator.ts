...
export const glycemic_load_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Glycemic Load Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Glycemic Load Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Glycemic Load Calculator calculation',
