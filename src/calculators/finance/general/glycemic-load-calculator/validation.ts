import { glycemic_load_calculatorInputs } from './types';
...
export function validateglycemic_load_calculatorInputs(inputs: glycemic_load_calculatorInputs): ValidationResult[] {
...
export function validateglycemic_load_calculatorBusinessRules(inputs: glycemic_load_calculatorInputs): ValidationResult[] {
