import { insulation_calculatorInputs } from './types';
...
export function validateinsulation_calculatorInputs(inputs: insulation_calculatorInputs): ValidationResult[] {
...
export function validateinsulation_calculatorBusinessRules(inputs: insulation_calculatorInputs): ValidationResult[] {
