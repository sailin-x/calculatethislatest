import { insulation-calculatorInputs, insulation-calculatorMetrics, insulation-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: insulation-calculatorInputs): number {
...
export function generateAnalysis(inputs: insulation-calculatorInputs, metrics: insulation-calculatorMetrics): insulation-calculatorAnalysis {
