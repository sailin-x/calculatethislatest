import { catastrophic_injury_calculatorInputs } from './types';
...
export function validatecatastrophic_injury_calculatorInputs(inputs: catastrophic_injury_calculatorInputs): ValidationResult[] {
...
export function validatecatastrophic_injury_calculatorBusinessRules(inputs: catastrophic_injury_calculatorInputs): ValidationResult[] {
