import { MedicalDeviceLiability-calculatorInputs, MedicalDeviceLiability-calculatorMetrics, MedicalDeviceLiability-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: MedicalDeviceLiability-calculatorInputs): number {
...
export function generateAnalysis(inputs: MedicalDeviceLiability-calculatorInputs, metrics: MedicalDeviceLiability-calculatorMetrics): MedicalDeviceLiability-calculatorAnalysis {
