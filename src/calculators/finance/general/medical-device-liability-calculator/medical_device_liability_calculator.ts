...
export const medical_device_liability_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Medical Device Liability Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Medical Device Liability Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Medical Device Liability Calculator calculation',
