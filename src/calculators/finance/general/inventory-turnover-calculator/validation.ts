import { inventory_turnover_calculatorInputs } from './types';
...
export function validateinventory_turnover_calculatorInputs(inputs: inventory_turnover_calculatorInputs): ValidationResult[] {
...
export function validateinventory_turnover_calculatorBusinessRules(inputs: inventory_turnover_calculatorInputs): ValidationResult[] {
