import { policy_lapse_rate_calculatorInputs } from './types';
...
export function validatepolicy_lapse_rate_calculatorInputs(inputs: policy_lapse_rate_calculatorInputs): ValidationResult[] {
...
export function validatepolicy_lapse_rate_calculatorBusinessRules(inputs: policy_lapse_rate_calculatorInputs): ValidationResult[] {
