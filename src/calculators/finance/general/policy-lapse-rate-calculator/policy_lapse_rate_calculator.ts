...
export const PolicyLapseRate-calculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Policy Lapse Rate Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Policy Lapse Rate Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Policy Lapse Rate Calculator calculation',
