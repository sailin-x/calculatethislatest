...
export const media_mix_modeling_mmm_roi_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Media Mix Modeling (MMM) ROI Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Media Mix Modeling (MMM) ROI Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Media Mix Modeling (MMM) ROI Calculator calculation',
