import { e_discovery_cost_calculatorInputs } from './types';
...
export function validatee_discovery_cost_calculatorInputs(inputs: e_discovery_cost_calculatorInputs): ValidationResult[] {
...
export function validatee_discovery_cost_calculatorBusinessRules(inputs: e_discovery_cost_calculatorInputs): ValidationResult[] {
