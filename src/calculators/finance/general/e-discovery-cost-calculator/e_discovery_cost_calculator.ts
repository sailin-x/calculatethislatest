...
export const EDiscoveryCost-calculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate E-Discovery Cost Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your E-Discovery Cost Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic E-Discovery Cost Calculator calculation',
