import { body_recomposition_calculatorInputs } from './types';
...
export function validatebody_recomposition_calculatorInputs(inputs: body_recomposition_calculatorInputs): ValidationResult[] {
...
export function validatebody_recomposition_calculatorBusinessRules(inputs: body_recomposition_calculatorInputs): ValidationResult[] {
