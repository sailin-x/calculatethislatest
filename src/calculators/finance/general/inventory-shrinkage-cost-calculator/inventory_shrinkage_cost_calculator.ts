...
export const InventoryShrinkageCost-calculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Inventory Shrinkage Cost Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Inventory Shrinkage Cost Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Inventory Shrinkage Cost Calculator calculation',
