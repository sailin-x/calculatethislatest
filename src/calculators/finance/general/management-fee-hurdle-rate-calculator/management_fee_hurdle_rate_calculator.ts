...
export const management_fee_hurdle_rate_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Management Fee & Hurdle Rate Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Management Fee & Hurdle Rate Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Management Fee & Hurdle Rate Calculator calculation',
