...
export const SlipAndFall-settlement-calculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Slip and Fall Settlement Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Slip and Fall Settlement Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Slip and Fall Settlement Calculator calculation',
