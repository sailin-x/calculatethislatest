import { heart_rate_zone_calculatorInputs } from './types';
...
export function validateheart_rate_zone_calculatorInputs(inputs: heart_rate_zone_calculatorInputs): ValidationResult[] {
...
export function validateheart_rate_zone_calculatorBusinessRules(inputs: heart_rate_zone_calculatorInputs): ValidationResult[] {
