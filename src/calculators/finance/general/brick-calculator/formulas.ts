import { brick-calculatorInputs, brick-calculatorMetrics, brick-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: brick-calculatorInputs): number {
...
export function generateAnalysis(inputs: brick-calculatorInputs, metrics: brick-calculatorMetrics): brick-calculatorAnalysis {
