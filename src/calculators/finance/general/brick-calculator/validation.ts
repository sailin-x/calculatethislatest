import { brick_calculatorInputs } from './types';
...
export function validatebrick_calculatorInputs(inputs: brick_calculatorInputs): ValidationResult[] {
...
export function validatebrick_calculatorBusinessRules(inputs: brick_calculatorInputs): ValidationResult[] {
