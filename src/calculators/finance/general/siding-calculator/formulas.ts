import { siding-calculatorInputs, siding-calculatorMetrics, siding-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: siding-calculatorInputs): number {
...
export function generateAnalysis(inputs: siding-calculatorInputs, metrics: siding-calculatorMetrics): siding-calculatorAnalysis {
