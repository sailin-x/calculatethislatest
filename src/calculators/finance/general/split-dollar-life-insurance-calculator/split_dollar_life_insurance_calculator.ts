...
export const SplitDollarLife-insurance-calculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Split Dollar Life Insurance Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Split Dollar Life Insurance Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Split Dollar Life Insurance Calculator calculation',
