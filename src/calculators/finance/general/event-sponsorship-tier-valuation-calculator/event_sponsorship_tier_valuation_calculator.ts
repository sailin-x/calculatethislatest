...
export const EventSponsorshipTier-valuation-calculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Event Sponsorship Tier Valuation Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Event Sponsorship Tier Valuation Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Event Sponsorship Tier Valuation Calculator calculation',
