import { CopyrightInfringementDamages-calculatorInputs, CopyrightInfringementDamages-calculatorMetrics, CopyrightInfringementDamages-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: CopyrightInfringementDamages-calculatorInputs): number {
...
export function generateAnalysis(inputs: CopyrightInfringementDamages-calculatorInputs, metrics: CopyrightInfringementDamages-calculatorMetrics): CopyrightInfringementDamages-calculatorAnalysis {
