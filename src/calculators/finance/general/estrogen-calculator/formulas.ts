import { estrogen-calculatorInputs, estrogen-calculatorMetrics, estrogen-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: estrogen-calculatorInputs): number {
...
export function generateAnalysis(inputs: estrogen-calculatorInputs, metrics: estrogen-calculatorMetrics): estrogen-calculatorAnalysis {
