import { distressed_debt_calculatorInputs } from './types';
...
export function validatedistressed_debt_calculatorInputs(inputs: distressed_debt_calculatorInputs): ValidationResult[] {
...
export function validatedistressed_debt_calculatorBusinessRules(inputs: distressed_debt_calculatorInputs): ValidationResult[] {
