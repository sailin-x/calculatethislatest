...
export const dental_implant_roi_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Dental Implant ROI Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Dental Implant ROI Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Dental Implant ROI Calculator calculation',
