...
export const premises_liability_settlement_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Premises Liability Settlement Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Premises Liability Settlement Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Premises Liability Settlement Calculator calculation',
