...
export const cosmetic_surgery_cost_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Cosmetic Surgery Cost Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Cosmetic Surgery Cost Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Cosmetic Surgery Cost Calculator calculation',
