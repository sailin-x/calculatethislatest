import { term_vs_whole_life_calculatorInputs } from './types';
...
export function validateterm_vs_whole_life_calculatorInputs(inputs: term_vs_whole_life_calculatorInputs): ValidationResult[] {
...
export function validateterm_vs_whole_life_calculatorBusinessRules(inputs: term_vs_whole_life_calculatorInputs): ValidationResult[] {
