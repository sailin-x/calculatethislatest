...
export const disability_insurance_needs_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Disability Insurance Needs Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Disability Insurance Needs Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Disability Insurance Needs Calculator calculation',
