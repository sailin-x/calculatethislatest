import { growth_hormone_calculatorInputs } from './types';
...
export function validategrowth_hormone_calculatorInputs(inputs: growth_hormone_calculatorInputs): ValidationResult[] {
...
export function validategrowth_hormone_calculatorBusinessRules(inputs: growth_hormone_calculatorInputs): ValidationResult[] {
