import { VeterinaryMalpracticeCalculatorinputs, VeterinaryMalpracticeCalculatormetrics, VeterinaryMalpracticeCalculatoranalysis } from './types';
...
export function calculateResult(inputs: VeterinaryMalpracticeCalculatorinputs): number {
...
export function generateAnalysis(inputs: VeterinaryMalpracticeCalculatorinputs, metrics: VeterinaryMalpracticeCalculatormetrics): VeterinaryMalpracticeCalculatoranalysis {
