import { biological_age_calculatorInputs } from './types';
...
export function validatebiological_age_calculatorInputs(inputs: biological_age_calculatorInputs): ValidationResult[] {
...
export function validatebiological_age_calculatorBusinessRules(inputs: biological_age_calculatorInputs): ValidationResult[] {
