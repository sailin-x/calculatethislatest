...
export const DrugRoyaltyRate-calculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Drug Royalty Rate Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Drug Royalty Rate Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Drug Royalty Rate Calculator calculation',
