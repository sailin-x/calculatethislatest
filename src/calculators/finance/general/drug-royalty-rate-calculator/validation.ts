import { drug_royalty_rate_calculatorInputs } from './types';
...
export function validatedrug_royalty_rate_calculatorInputs(inputs: drug_royalty_rate_calculatorInputs): ValidationResult[] {
...
export function validatedrug_royalty_rate_calculatorBusinessRules(inputs: drug_royalty_rate_calculatorInputs): ValidationResult[] {
