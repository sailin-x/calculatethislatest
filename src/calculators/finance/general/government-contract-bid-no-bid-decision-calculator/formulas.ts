import { GovernmentContractBid-NoBidDecision-calculatorInputs, GovernmentContractBid-NoBidDecision-calculatorMetrics, GovernmentContractBid-NoBidDecision-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: GovernmentContractBid-NoBidDecision-calculatorInputs): number {
...
export function generateAnalysis(inputs: GovernmentContractBid-NoBidDecision-calculatorInputs, metrics: GovernmentContractBid-NoBidDecision-calculatorMetrics): GovernmentContractBid-NoBidDecision-calculatorAnalysis {
