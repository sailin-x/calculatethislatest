import { startup_valuation_calculatorInputs } from './types';
...
export function validatestartup_valuation_calculatorInputs(inputs: startup_valuation_calculatorInputs): ValidationResult[] {
...
export function validatestartup_valuation_calculatorBusinessRules(inputs: startup_valuation_calculatorInputs): ValidationResult[] {
