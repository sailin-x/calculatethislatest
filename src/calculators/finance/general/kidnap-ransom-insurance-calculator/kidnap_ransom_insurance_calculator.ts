...
export const kidnap_ransom_insurance_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Kidnap & Ransom Insurance Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Kidnap & Ransom Insurance Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Kidnap & Ransom Insurance Calculator calculation',
