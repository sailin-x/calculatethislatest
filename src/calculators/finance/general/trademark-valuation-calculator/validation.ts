import { trademark_valuation_calculatorInputs } from './types';
...
export function validatetrademark_valuation_calculatorInputs(inputs: trademark_valuation_calculatorInputs): ValidationResult[] {
...
export function validatetrademark_valuation_calculatorBusinessRules(inputs: trademark_valuation_calculatorInputs): ValidationResult[] {
