import { graph_theory_calculatorInputs } from './types';
...
export function validategraph_theory_calculatorInputs(inputs: graph_theory_calculatorInputs): ValidationResult[] {
...
export function validategraph_theory_calculatorBusinessRules(inputs: graph_theory_calculatorInputs): ValidationResult[] {
