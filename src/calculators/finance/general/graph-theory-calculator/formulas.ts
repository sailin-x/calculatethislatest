import { graph-theory-calculatorInputs, graph-theory-calculatorMetrics, graph-theory-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: graph-theory-calculatorInputs): number {
...
export function generateAnalysis(inputs: graph-theory-calculatorInputs, metrics: graph-theory-calculatorMetrics): graph-theory-calculatorAnalysis {
