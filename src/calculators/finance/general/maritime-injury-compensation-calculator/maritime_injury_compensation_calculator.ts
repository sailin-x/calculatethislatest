...
export const maritime_injury_compensation_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Maritime Injury Compensation Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Maritime Injury Compensation Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Maritime Injury Compensation Calculator calculation',
