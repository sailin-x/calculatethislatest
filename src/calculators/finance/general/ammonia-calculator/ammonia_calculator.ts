...
export const ammonia_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Ammonia Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Ammonia Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Ammonia Calculator calculation',
