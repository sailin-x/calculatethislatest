import { ammonia_calculatorInputs } from './types';
...
export function validateammonia_calculatorInputs(inputs: ammonia_calculatorInputs): ValidationResult[] {
...
export function validateammonia_calculatorBusinessRules(inputs: ammonia_calculatorInputs): ValidationResult[] {
