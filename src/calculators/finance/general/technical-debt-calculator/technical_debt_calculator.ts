...
export const technical_debt_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Technical Debt Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Technical Debt Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Technical Debt Calculator calculation',
