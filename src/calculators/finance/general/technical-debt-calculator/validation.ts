import { technical_debt_calculatorInputs } from './types';
...
export function validatetechnical_debt_calculatorInputs(inputs: technical_debt_calculatorInputs): ValidationResult[] {
...
export function validatetechnical_debt_calculatorBusinessRules(inputs: technical_debt_calculatorInputs): ValidationResult[] {
