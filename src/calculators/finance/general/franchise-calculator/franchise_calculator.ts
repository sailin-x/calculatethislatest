...
export const franchise_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Franchise Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Franchise Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Franchise Calculator calculation',
