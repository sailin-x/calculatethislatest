import { franchise-calculatorInputs, franchise-calculatorMetrics, franchise-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: franchise-calculatorInputs): number {
...
export function generateAnalysis(inputs: franchise-calculatorInputs, metrics: franchise-calculatorMetrics): franchise-calculatorAnalysis {
