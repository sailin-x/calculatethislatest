import { AdReachAnd-frequency-calculatorInputs, AdReachAnd-frequency-calculatorMetrics, AdReachAnd-frequency-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: AdReachAnd-frequency-calculatorInputs): number {
...
export function generateAnalysis(inputs: AdReachAnd-frequency-calculatorInputs, metrics: AdReachAnd-frequency-calculatorMetrics): AdReachAnd-frequency-calculatorAnalysis {
