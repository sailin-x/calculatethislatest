...
export const aviation_accident_compensation_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Aviation Accident Compensation Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Aviation Accident Compensation Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Aviation Accident Compensation Calculator calculation',
