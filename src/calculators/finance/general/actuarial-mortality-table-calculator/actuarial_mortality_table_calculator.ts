...
export const actuarial_mortality_table_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Actuarial Mortality Table Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Actuarial Mortality Table Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Actuarial Mortality Table Calculator calculation',
