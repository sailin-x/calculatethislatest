import { pharmaceutical-liability-calculatorInputs, pharmaceutical-liability-calculatorMetrics, pharmaceutical-liability-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: pharmaceutical-liability-calculatorInputs): number {
...
export function generateAnalysis(inputs: pharmaceutical-liability-calculatorInputs, metrics: pharmaceutical-liability-calculatorMetrics): pharmaceutical-liability-calculatorAnalysis {
