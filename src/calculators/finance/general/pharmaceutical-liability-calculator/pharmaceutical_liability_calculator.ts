...
export const pharmaceutical_liability_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Pharmaceutical Liability Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Pharmaceutical Liability Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Pharmaceutical Liability Calculator calculation',
