import { drywall_calculatorInputs } from './types';
...
export function validatedrywall_calculatorInputs(inputs: drywall_calculatorInputs): ValidationResult[] {
...
export function validatedrywall_calculatorBusinessRules(inputs: drywall_calculatorInputs): ValidationResult[] {
