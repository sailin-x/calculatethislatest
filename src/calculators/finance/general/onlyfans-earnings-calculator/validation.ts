import { onlyfans_earnings_calculatorInputs } from './types';
...
export function validateonlyfans_earnings_calculatorInputs(inputs: onlyfans_earnings_calculatorInputs): ValidationResult[] {
...
export function validateonlyfans_earnings_calculatorBusinessRules(inputs: onlyfans_earnings_calculatorInputs): ValidationResult[] {
