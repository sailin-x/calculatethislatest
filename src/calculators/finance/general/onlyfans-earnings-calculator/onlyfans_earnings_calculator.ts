...
export const onlyfans_earnings_calculatorCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate OnlyFans Earnings Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your OnlyFans Earnings Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic OnlyFans Earnings Calculator calculation',
