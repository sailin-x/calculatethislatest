...
export const hardness-calculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Hardness Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Hardness Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Hardness Calculator calculation',
