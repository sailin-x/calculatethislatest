import { hardness_calculatorInputs } from './types';
...
export function validatehardness_calculatorInputs(inputs: hardness_calculatorInputs): ValidationResult[] {
...
export function validatehardness_calculatorBusinessRules(inputs: hardness_calculatorInputs): ValidationResult[] {
