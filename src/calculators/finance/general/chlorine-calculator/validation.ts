import { chlorine_calculatorInputs } from './types';
...
export function validatechlorine_calculatorInputs(inputs: chlorine_calculatorInputs): ValidationResult[] {
...
export function validatechlorine_calculatorBusinessRules(inputs: chlorine_calculatorInputs): ValidationResult[] {
