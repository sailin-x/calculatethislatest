...
export const AminoAcidCalculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Amino Acid Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Amino Acid Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Amino Acid Calculator calculation',
