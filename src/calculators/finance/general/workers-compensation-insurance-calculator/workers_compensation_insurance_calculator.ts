...
export const WorkersCompensationInsurance-calculator: Calculator = {
  ...
  category: 'finance',
  subcategory: 'general',
  description: 'Calculate Workers' Compensation Insurance Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Workers' Compensation Insurance Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Workers' Compensation Insurance Calculator calculation',
