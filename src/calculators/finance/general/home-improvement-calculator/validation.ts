import { home_improvement_calculatorInputs } from './types';
...
export function validatehome_improvement_calculatorInputs(inputs: home_improvement_calculatorInputs): ValidationResult[] {
...
export function validatehome_improvement_calculatorBusinessRules(inputs: home_improvement_calculatorInputs): ValidationResult[] {
