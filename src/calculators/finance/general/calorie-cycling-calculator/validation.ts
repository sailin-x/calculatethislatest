import { calorie_cycling_calculatorInputs } from './types';
...
export function validatecalorie_cycling_calculatorInputs(inputs: calorie_cycling_calculatorInputs): ValidationResult[] {
...
export function validatecalorie_cycling_calculatorBusinessRules(inputs: calorie_cycling_calculatorInputs): ValidationResult[] {
