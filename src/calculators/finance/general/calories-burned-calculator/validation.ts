import { calories_burned_calculatorInputs } from './types';
...
export function validatecalories_burned_calculatorInputs(inputs: calories_burned_calculatorInputs): ValidationResult[] {
...
export function validatecalories_burned_calculatorBusinessRules(inputs: calories_burned_calculatorInputs): ValidationResult[] {
