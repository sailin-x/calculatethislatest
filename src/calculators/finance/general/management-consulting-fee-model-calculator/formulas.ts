import { ManagementConsultingFee-model-calculatorInputs, ManagementConsultingFee-model-calculatorMetrics, ManagementConsultingFee-model-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ManagementConsultingFee-model-calculatorInputs): number {
...
export function generateAnalysis(inputs: ManagementConsultingFee-model-calculatorInputs, metrics: ManagementConsultingFee-model-calculatorMetrics): ManagementConsultingFee-model-calculatorAnalysis {
