import { FinancialSecurityCalculatorinputs, FinancialSecurityCalculatormetrics, FinancialSecurityCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialSecurityCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialSecurityCalculatorinputs, metrics: FinancialSecurityCalculatormetrics): FinancialSecurityCalculatoranalysis {
