import { financial-security-calculatorInputs, financial-security-calculatorMetrics, financial-security-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-security-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-security-calculatorInputs, metrics: financial-security-calculatorMetrics): financial-security-calculatorAnalysis {
