...
export function validateMaxLtvRatio(value: any): { isValid: boolean; message?: string } {
...
export function validateAppraisalType(value: any): { isValid: boolean; message?: string } {
...
export function validateTitleIssues(value: any): { isValid: boolean; message?: string } {
...
export function validateInsuranceRequired(value: any): { isValid: boolean; message?: string } {
