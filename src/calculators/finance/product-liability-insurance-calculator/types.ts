export interface ProductLiabilityInsuranceInputs {
  // Business information
  businessType: 'Manufacturer' | 'Distributor' | 'Retailer' | 'Importer' | 'Service Provider' | 'Other';
  industry: string;
  ...
  // Product information
  productType: 'Consumer Goods' | 'Industrial Equipment' | 'Medical Devices' | 'Food Products' | 'Chemicals' | 'Electronics' | 'Automotive' | 'Other';
  productComplexity: 'Simple' | 'Moderate' | 'Complex' | 'Highly Complex';
  productRiskLevel: 'Low' | 'Medium' | 'High' | 'Very High';
  ...
  // Coverage details
  coverageType: 'Claims-Made' | 'Occurrence' | 'Run-off Coverage';
  ...
  productStandards: boolean;
  recallRequirements: boolean;
  ...
  productSafetyStandards: boolean;
  labelingRequirements: boolean;
  ...
  businessSatisfaction: 'High' | 'Medium' | 'Low';
  ...
  consumerExpectations: string;
  regulatoryPressure: string;

  // Technological factors
  qualityControlSystems: boolean;
  productTesting: boolean;
  traceabilitySystems: boolean;
  ...
  productLiabilityUnderstanding: 'Expert' | 'Knowledgeable' | 'Basic' | 'Novice';
...
export interface ProductLiabilityInsuranceOutputs {
  // Premium analysis
  ...
  businessOwnerSatisfaction: number;
  ...
  // Educational content
  productLiabilityEducation: string[];
  insuranceEducation: string[];
  riskManagementEducation: string[];
  businessManagementEducation: string[];
  ...
  businessOwnerEngagement: number;
  ...
  businessPortfolioProtection: number;
