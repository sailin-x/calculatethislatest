import { ProductLiabilityInsuranceCalculatorInputs } from './types';

export function validateProductLiabilityInsuranceCalculatorInputs(inputs: ProductLiabilityInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateProductLiabilityInsuranceCalculatorBusinessRules(inputs: ProductLiabilityInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
