...
import { PensionPlanFundingCalculatorInputs, PensionPlanFundingCalculatorOutputs } from './types';
import {
...
export const PensionPlanFundingCalculator: Calculator = {
  ...
  description: 'Calculate pension plan funding requirements and contributions.',
  usageInstructions: [
