import { DefiLiquidityPool-calculatorInputs, DefiLiquidityPool-calculatorMetrics, DefiLiquidityPool-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: DefiLiquidityPool-calculatorInputs): number {
...
export function generateAnalysis(inputs: DefiLiquidityPool-calculatorInputs, metrics: DefiLiquidityPool-calculatorMetrics): DefiLiquidityPool-calculatorAnalysis {
