import { CoverdellEsaCalculatorInputs } from './types';

export function validateCoverdellEsaCalculatorInputs(inputs: CoverdellEsaCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCoverdellEsaCalculatorBusinessRules(inputs: CoverdellEsaCalculatorInputs): Array<{ field: string; message: string }> {
