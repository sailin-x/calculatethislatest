import { WorkersCompensationInsuranceCalculatorInputs } from './types';

export function validateWorkersCompensationInsuranceCalculatorInputs(inputs: WorkersCompensationInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateWorkersCompensationInsuranceCalculatorBusinessRules(inputs: WorkersCompensationInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
