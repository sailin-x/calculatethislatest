...
export function validateMortgageQualificationCalculatorInputs(inputs: MortgageQualificationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMortgageQualificationCalculatorBusinessRules(inputs: MortgageQualificationCalculatorInputs): Array<{ field: string; message: string }> {
