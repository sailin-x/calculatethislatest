export interface KidnapRansomInsuranceCalculatorInputs {
...
export interface KidnapRansomInsuranceCalculatorOutputs {
...
export interface KidnapRansomInsuranceCalculatorMetrics {
...
export interface KidnapRansomInsuranceCalculatorAnalysis {
