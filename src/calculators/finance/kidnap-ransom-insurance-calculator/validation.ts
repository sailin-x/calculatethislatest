import { KidnapRansomInsuranceCalculatorInputs } from './types';

export function validateKidnapRansomInsuranceCalculatorInputs(inputs: KidnapRansomInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateKidnapRansomInsuranceCalculatorBusinessRules(inputs: KidnapRansomInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
