import { real-estate-crowdfundingInputs, real-estate-crowdfundingMetrics, real-estate-crowdfundingAnalysis } from './types';
...
export function calculateResult(inputs: real-estate-crowdfundingInputs): number {
...
export function generateAnalysis(inputs: real-estate-crowdfundingInputs, metrics: real-estate-crowdfundingMetrics): real-estate-crowdfundingAnalysis {
