import { RealEstateCrowdfundinginputs, RealEstateCrowdfundingmetrics, RealEstateCrowdfundinganalysis } from './types';
...
export function calculateResult(inputs: RealEstateCrowdfundinginputs): number {
...
export function generateAnalysis(inputs: RealEstateCrowdfundinginputs, metrics: RealEstateCrowdfundingmetrics): RealEstateCrowdfundinganalysis {
