import { GeneralLiabilityInsuranceCalculatorInputs } from './types';

export function validateGeneralLiabilityInsuranceCalculatorInputs(inputs: GeneralLiabilityInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateGeneralLiabilityInsuranceCalculatorBusinessRules(inputs: GeneralLiabilityInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
