export interface LoanToCostLtcRatioCalculatorInputs {
...
export interface LoanToCostLtcRatioCalculatorOutputs {
...
export interface LoanToCostLtcRatioCalculatorMetrics {
...
export interface LoanToCostLtcRatioCalculatorAnalysis {
