import { LoanToCostLtcRatioCalculatorInputs } from './types';

export function validateLoanToCostLtcRatioCalculatorInputs(inputs: LoanToCostLtcRatioCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateLoanToCostLtcRatioCalculatorBusinessRules(inputs: LoanToCostLtcRatioCalculatorInputs): Array<{ field: string; message: string }> {
