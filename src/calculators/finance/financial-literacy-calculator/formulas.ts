import { FinancialLiteracyCalculatorinputs, FinancialLiteracyCalculatormetrics, FinancialLiteracyCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialLiteracyCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialLiteracyCalculatorinputs, metrics: FinancialLiteracyCalculatormetrics): FinancialLiteracyCalculatoranalysis {
