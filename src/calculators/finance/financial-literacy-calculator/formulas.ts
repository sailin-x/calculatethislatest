import { financial-literacy-calculatorInputs, financial-literacy-calculatorMetrics, financial-literacy-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-literacy-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-literacy-calculatorInputs, metrics: financial-literacy-calculatorMetrics): financial-literacy-calculatorAnalysis {
