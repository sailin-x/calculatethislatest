import { windstorm-insuranceInputs, windstorm-insuranceMetrics, windstorm-insuranceAnalysis } from './types';
...
export function calculateResult(inputs: windstorm-insuranceInputs): number {
...
export function generateAnalysis(inputs: windstorm-insuranceInputs, metrics: windstorm-insuranceMetrics): windstorm-insuranceAnalysis {
