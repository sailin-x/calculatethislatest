import { CommercialPropertyInsuranceinputs, CommercialPropertyInsurancemetrics, CommercialPropertyInsuranceanalysis } from './types';
...
export function calculateResult(inputs: CommercialPropertyInsuranceinputs): number {
...
export function generateAnalysis(inputs: CommercialPropertyInsuranceinputs, metrics: CommercialPropertyInsurancemetrics): CommercialPropertyInsuranceanalysis {
