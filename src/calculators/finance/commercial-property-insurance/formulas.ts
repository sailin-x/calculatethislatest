import { commercial-property-insuranceInputs, commercial-property-insuranceMetrics, commercial-property-insuranceAnalysis } from './types';
...
export function calculateResult(inputs: commercial-property-insuranceInputs): number {
...
export function generateAnalysis(inputs: commercial-property-insuranceInputs, metrics: commercial-property-insuranceMetrics): commercial-property-insuranceAnalysis {
