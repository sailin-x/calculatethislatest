import { WindstormInsuranceCalculatorInputs } from './types';

export function validateWindstormInsuranceCalculatorInputs(inputs: WindstormInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateWindstormInsuranceCalculatorBusinessRules(inputs: WindstormInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
