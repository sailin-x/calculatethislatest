import { mortgageInputs, mortgageMetrics, mortgageAnalysis } from './types';
...
export function calculateResult(inputs: mortgageInputs): number {
...
export function generateAnalysis(inputs: mortgageInputs, metrics: mortgageMetrics): mortgageAnalysis {
