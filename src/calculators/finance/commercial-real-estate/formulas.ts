import { CommercialRealEstateinputs, CommercialRealEstatemetrics, CommercialRealEstateanalysis } from './types';
...
export function calculateResult(inputs: CommercialRealEstateinputs): number {
...
export function generateAnalysis(inputs: CommercialRealEstateinputs, metrics: CommercialRealEstatemetrics): CommercialRealEstateanalysis {
