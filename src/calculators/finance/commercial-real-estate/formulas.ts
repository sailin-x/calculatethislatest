import { commercial-real-estateInputs, commercial-real-estateMetrics, commercial-real-estateAnalysis } from './types';
...
export function calculateResult(inputs: commercial-real-estateInputs): number {
...
export function generateAnalysis(inputs: commercial-real-estateInputs, metrics: commercial-real-estateMetrics): commercial-real-estateAnalysis {
