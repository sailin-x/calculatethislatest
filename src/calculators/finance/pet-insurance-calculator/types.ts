export interface PetInsuranceCalculatorInputs {
...
export interface PetInsuranceCalculatorOutputs {
...
export interface PetInsuranceCalculatorMetrics {
...
export interface PetInsuranceCalculatorAnalysis {
