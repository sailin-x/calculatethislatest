import { PetInsuranceCalculatorInputs } from './types';

export function validatePetInsuranceCalculatorInputs(inputs: PetInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePetInsuranceCalculatorBusinessRules(inputs: PetInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
