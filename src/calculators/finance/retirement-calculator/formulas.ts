import { retirement-calculatorInputs, retirement-calculatorMetrics, retirement-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: retirement-calculatorInputs): number {
...
export function generateAnalysis(inputs: retirement-calculatorInputs, metrics: retirement-calculatorMetrics): retirement-calculatorAnalysis {
