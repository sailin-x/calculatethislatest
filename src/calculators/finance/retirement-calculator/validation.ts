import { RetirementCalculatorInputs } from './types';

export function validateRetirementCalculatorInputs(inputs: RetirementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateRetirementCalculatorBusinessRules(inputs: RetirementCalculatorInputs): Array<{ field: string; message: string }> {
