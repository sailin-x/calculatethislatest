import { MortgageEquityCalculatorInputs } from './types';

export function validateMortgageEquityCalculatorInputs(inputs: MortgageEquityCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMortgageEquityCalculatorBusinessRules(inputs: MortgageEquityCalculatorInputs): Array<{ field: string; message: string }> {
