...
export function validateMortgageVsRentCalculatorInputs(inputs: MortgageVsRentCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMortgageVsRentCalculatorBusinessRules(inputs: MortgageVsRentCalculatorInputs): Array<{ field: string; message: string }> {
