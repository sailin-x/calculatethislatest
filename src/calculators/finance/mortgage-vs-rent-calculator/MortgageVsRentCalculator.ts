...
import { MortgageVsRentCalculatorInputs, MortgageVsRentCalculatorOutputs } from './types';
import {
...
import { validateMortgageVsRentCalculatorInputs, validateMortgageVsRentCalculatorBusinessRules } from './validation';

export const MortgageVsRentCalculatorCalculator: Calculator: Calculator = {
  id: 'mortgage-vs-rent-calculator-calculator',
  title: 'Mortgage vs. Rent Calculator Calculator',
