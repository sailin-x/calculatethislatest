...
import { NetOperatingIncomeNoiCalculatorInputs, NetOperatingIncomeNoiCalculatorOutputs } from './types';
import {
...
import { validateNetOperatingIncomeNoiCalculatorInputs, validateNetOperatingIncomeNoiCalculatorBusinessRules } from './validation';

export const NetOperatingIncomeNoiCalculatorCalculator: Calculator: Calculator = {
  id: 'net-operating-income-noi-calculator-calculator',
  title: 'Net Operating Income (NOI) Calculator Calculator',
