import { NetOperatingIncomeNoiCalculatorInputs } from './types';

export function validateNetOperatingIncomeNoiCalculatorInputs(inputs: NetOperatingIncomeNoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateNetOperatingIncomeNoiCalculatorBusinessRules(inputs: NetOperatingIncomeNoiCalculatorInputs): Array<{ field: string; message: string }> {
