export interface NetOperatingIncomeNoiCalculatorInputs {
...
export interface NetOperatingIncomeNoiCalculatorOutputs {
...
export interface NetOperatingIncomeNoiCalculatorMetrics {
...
export interface NetOperatingIncomeNoiCalculatorAnalysis {
