import { ArmVsFixedinputs, ArmVsFixedmetrics, ArmVsFixedanalysis } from './types';
...
export function calculateResult(inputs: ArmVsFixedinputs): number {
...
export function generateAnalysis(inputs: ArmVsFixedinputs, metrics: ArmVsFixedmetrics): ArmVsFixedanalysis {
