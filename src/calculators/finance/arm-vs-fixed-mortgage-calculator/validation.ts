import { ArmVsFixedMortgageCalculatorInputs } from './types';

export function validateArmVsFixedMortgageCalculatorInputs(inputs: ArmVsFixedMortgageCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateArmVsFixedMortgageCalculatorBusinessRules(inputs: ArmVsFixedMortgageCalculatorInputs): Array<{ field: string; message: string }> {
