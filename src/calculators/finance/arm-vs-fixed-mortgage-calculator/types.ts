export interface ArmVsFixedMortgageCalculatorInputs {
...
export interface ArmVsFixedMortgageCalculatorOutputs {
...
export interface ArmVsFixedMortgageCalculatorMetrics {
...
export interface ArmVsFixedMortgageCalculatorAnalysis {
