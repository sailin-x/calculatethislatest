import { cap-rateInputs, cap-rateMetrics, cap-rateAnalysis } from './types';
...
export function calculateResult(inputs: cap-rateInputs): number {
...
export function generateAnalysis(inputs: cap-rateInputs, metrics: cap-rateMetrics): cap-rateAnalysis {
