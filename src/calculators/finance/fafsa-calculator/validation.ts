import { FafsaCalculatorInputs } from './types';

export function validateFafsaCalculatorInputs(inputs: FafsaCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateFafsaCalculatorBusinessRules(inputs: FafsaCalculatorInputs): Array<{ field: string; message: string }> {
