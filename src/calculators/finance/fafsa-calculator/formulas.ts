import { fafsa-calculatorInputs, fafsa-calculatorMetrics, fafsa-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fafsa-calculatorInputs): number {
...
export function generateAnalysis(inputs: fafsa-calculatorInputs, metrics: fafsa-calculatorMetrics): fafsa-calculatorAnalysis {
