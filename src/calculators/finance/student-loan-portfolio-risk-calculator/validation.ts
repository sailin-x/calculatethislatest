import { StudentLoanPortfolioRiskCalculatorInputs } from './types';

export function validateStudentLoanPortfolioRiskCalculatorInputs(inputs: StudentLoanPortfolioRiskCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateStudentLoanPortfolioRiskCalculatorBusinessRules(inputs: StudentLoanPortfolioRiskCalculatorInputs): Array<{ field: string; message: string }> {
