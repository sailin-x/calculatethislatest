export interface StudentLoanPortfolioRiskCalculatorInputs {
...
export interface StudentLoanPortfolioRiskCalculatorOutputs {
...
export interface StudentLoanPortfolioRiskCalculatorMetrics {
...
export interface StudentLoanPortfolioRiskCalculatorAnalysis {
