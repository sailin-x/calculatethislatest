import { AlphaCalculatorInputs } from './types';

export function validateAlphaCalculatorInputs(inputs: AlphaCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAlphaCalculatorBusinessRules(inputs: AlphaCalculatorInputs): Array<{ field: string; message: string }> {
