import { 401kInputs, 401kMetrics, 401kAnalysis } from './types';
...
export function calculateResult(inputs: 401kInputs): number {
...
export function generateAnalysis(inputs: 401kInputs, metrics: 401kMetrics): 401kAnalysis {
