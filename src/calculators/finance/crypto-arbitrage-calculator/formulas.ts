import { CryptoArbitrageCalculatorinputs, CryptoArbitrageCalculatormetrics, CryptoArbitrageCalculatoranalysis } from './types';
...
export function calculateResult(inputs: CryptoArbitrageCalculatorinputs): number {
...
export function generateAnalysis(inputs: CryptoArbitrageCalculatorinputs, metrics: CryptoArbitrageCalculatormetrics): CryptoArbitrageCalculatoranalysis {
