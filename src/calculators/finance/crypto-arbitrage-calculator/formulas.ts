import { crypto-arbitrage-calculatorInputs, crypto-arbitrage-calculatorMetrics, crypto-arbitrage-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: crypto-arbitrage-calculatorInputs): number {
...
export function generateAnalysis(inputs: crypto-arbitrage-calculatorInputs, metrics: crypto-arbitrage-calculatorMetrics): crypto-arbitrage-calculatorAnalysis {
