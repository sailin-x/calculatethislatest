import { student-loanInputs, student-loanMetrics, student-loanAnalysis } from './types';
...
export function calculateResult(inputs: student-loanInputs): number {
...
export function generateAnalysis(inputs: student-loanInputs, metrics: student-loanMetrics): student-loanAnalysis {
