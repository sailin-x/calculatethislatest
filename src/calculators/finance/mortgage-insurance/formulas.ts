import { mortgage-insuranceInputs, mortgage-insuranceMetrics, mortgage-insuranceAnalysis } from './types';
...
export function calculateResult(inputs: mortgage-insuranceInputs): number {
...
export function generateAnalysis(inputs: mortgage-insuranceInputs, metrics: mortgage-insuranceMetrics): mortgage-insuranceAnalysis {
