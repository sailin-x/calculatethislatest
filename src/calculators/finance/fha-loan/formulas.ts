import { fha-loanInputs, fha-loanMetrics, fha-loanAnalysis } from './types';
...
export function calculateResult(inputs: fha-loanInputs): number {
...
export function generateAnalysis(inputs: fha-loanInputs, metrics: fha-loanMetrics): fha-loanAnalysis {
