...
import { TrustFundDistributionCalculatorInputs, TrustFundDistributionCalculatorOutputs } from './types';
import {
...
export const TrustFundDistributionCalculator: Calculator = {
  ...
  description: 'Calculate trust fund distribution strategies.',
  usageInstructions: [
