import { trust-fund-distribution-calculatorInputs, trust-fund-distribution-calculatorMetrics, trust-fund-distribution-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: trust-fund-distribution-calculatorInputs): number {
...
export function generateAnalysis(inputs: trust-fund-distribution-calculatorInputs, metrics: trust-fund-distribution-calculatorMetrics): trust-fund-distribution-calculatorAnalysis {
