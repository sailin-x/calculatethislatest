export interface ProfitabilityIndexInputs {
  // Project Information
  projectInfo: {
    projectName: string;
  ...
  // Calculation Method
  calculationMethod: 'traditional_pi' | 'modified_pi' | 'adjusted_pi' | 'real_pi' | 'nominal_pi';
...
export interface ProfitabilityIndexResults {
  // Core PI Metrics
  profitabilityIndex: number;
  modifiedProfitabilityIndex: number;
  ...
  piAnalysis: {
    profitabilityIndex: number;
    modifiedProfitabilityIndex: number;
    adjustedProfitabilityIndex: number;
    realProfitabilityIndex: number;
    nominalProfitabilityIndex: number;
    piBreakdown: {
      component: string;
      value: number;
      percentage: number;
