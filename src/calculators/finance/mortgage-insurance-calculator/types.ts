export interface MortgageInsuranceCalculatorInputs {
...
export interface MortgageInsuranceCalculatorOutputs {
...
export interface MortgageInsuranceCalculatorMetrics {
...
export interface MortgageInsuranceCalculatorAnalysis {
