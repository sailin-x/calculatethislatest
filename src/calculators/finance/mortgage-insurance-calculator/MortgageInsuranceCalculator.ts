...
import { MortgageInsuranceCalculatorInputs, MortgageInsuranceCalculatorOutputs } from './types';
import {
...
import { validateMortgageInsuranceCalculatorInputs, validateMortgageInsuranceCalculatorBusinessRules } from './validation';

export const MortgageInsuranceCalculatorCalculator: Calculator: Calculator = {
  id: 'mortgage-insurance-calculator-calculator',
  title: 'Mortgage Insurance Calculator Calculator',
