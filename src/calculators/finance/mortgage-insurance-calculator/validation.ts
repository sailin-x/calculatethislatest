import { MortgageInsuranceCalculatorInputs } from './types';

export function validateMortgageInsuranceCalculatorInputs(inputs: MortgageInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMortgageInsuranceCalculatorBusinessRules(inputs: MortgageInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
