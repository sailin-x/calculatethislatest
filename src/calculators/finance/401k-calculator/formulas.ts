import { 401k-calculatorInputs, 401k-calculatorMetrics, 401k-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: 401k-calculatorInputs): number {
...
export function generateAnalysis(inputs: 401k-calculatorInputs, metrics: 401k-calculatorMetrics): 401k-calculatorAnalysis {
