import { 403bPlanCalculatorInputs } from './types';

export function validate403bPlanCalculatorInputs(inputs: 403bPlanCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validate403bPlanCalculatorBusinessRules(inputs: 403bPlanCalculatorInputs): Array<{ field: string; message: string }> {
