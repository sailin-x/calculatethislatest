export interface MedicalMalpracticeInsuranceCalculatorInputs {
...
export interface MedicalMalpracticeInsuranceCalculatorOutputs {
...
export interface MedicalMalpracticeInsuranceCalculatorMetrics {
...
export interface MedicalMalpracticeInsuranceCalculatorAnalysis {
