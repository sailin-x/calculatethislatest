import { MedicalMalpracticeInsuranceCalculatorInputs } from './types';

export function validateMedicalMalpracticeInsuranceCalculatorInputs(inputs: MedicalMalpracticeInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMedicalMalpracticeInsuranceCalculatorBusinessRules(inputs: MedicalMalpracticeInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
