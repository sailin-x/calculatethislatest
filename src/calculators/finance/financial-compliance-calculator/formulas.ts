import { FinancialComplianceCalculatorinputs, FinancialComplianceCalculatormetrics, FinancialComplianceCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialComplianceCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialComplianceCalculatorinputs, metrics: FinancialComplianceCalculatormetrics): FinancialComplianceCalculatoranalysis {
