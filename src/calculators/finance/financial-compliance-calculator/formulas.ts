import { financial-compliance-calculatorInputs, financial-compliance-calculatorMetrics, financial-compliance-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-compliance-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-compliance-calculatorInputs, metrics: financial-compliance-calculatorMetrics): financial-compliance-calculatorAnalysis {
