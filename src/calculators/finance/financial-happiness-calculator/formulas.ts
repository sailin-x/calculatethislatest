import { financial-happiness-calculatorInputs, financial-happiness-calculatorMetrics, financial-happiness-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-happiness-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-happiness-calculatorInputs, metrics: financial-happiness-calculatorMetrics): financial-happiness-calculatorAnalysis {
