import { current-ratio-calculatorInputs, current-ratio-calculatorMetrics, current-ratio-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: current-ratio-calculatorInputs): number {
...
export function generateAnalysis(inputs: current-ratio-calculatorInputs, metrics: current-ratio-calculatorMetrics): current-ratio-calculatorAnalysis {
