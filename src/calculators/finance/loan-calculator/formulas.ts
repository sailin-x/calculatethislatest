import { loan-calculatorInputs, loan-calculatorMetrics, loan-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: loan-calculatorInputs): number {
...
export function generateAnalysis(inputs: loan-calculatorInputs, metrics: loan-calculatorMetrics): loan-calculatorAnalysis {
