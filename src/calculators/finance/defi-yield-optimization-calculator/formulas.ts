import { defi-yield-optimization-calculatorInputs, defi-yield-optimization-calculatorMetrics, defi-yield-optimization-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: defi-yield-optimization-calculatorInputs): number {
...
export function generateAnalysis(inputs: defi-yield-optimization-calculatorInputs, metrics: defi-yield-optimization-calculatorMetrics): defi-yield-optimization-calculatorAnalysis {
