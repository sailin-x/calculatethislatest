...
import { FinancialSustainabilityCalculatorInputs, FinancialSustainabilityCalculatorOutputs } from './types';
import {
...
export const FinancialSustainabilityCalculator: Calculator = {
  ...
  description: 'Calculate financial sustainability metrics.',
  usageInstructions: [
