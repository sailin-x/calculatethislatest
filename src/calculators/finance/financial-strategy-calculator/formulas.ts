import { FinancialStrategyCalculatorinputs, FinancialStrategyCalculatormetrics, FinancialStrategyCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialStrategyCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialStrategyCalculatorinputs, metrics: FinancialStrategyCalculatormetrics): FinancialStrategyCalculatoranalysis {
