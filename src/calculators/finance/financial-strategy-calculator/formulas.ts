import { financial-strategy-calculatorInputs, financial-strategy-calculatorMetrics, financial-strategy-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-strategy-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-strategy-calculatorInputs, metrics: financial-strategy-calculatorMetrics): financial-strategy-calculatorAnalysis {
