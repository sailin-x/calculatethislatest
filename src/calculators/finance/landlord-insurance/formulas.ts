import { landlord-insuranceInputs, landlord-insuranceMetrics, landlord-insuranceAnalysis } from './types';
...
export function calculateResult(inputs: landlord-insuranceInputs): number {
...
export function generateAnalysis(inputs: landlord-insuranceInputs, metrics: landlord-insuranceMetrics): landlord-insuranceAnalysis {
