import { title-insuranceInputs, title-insuranceMetrics, title-insuranceAnalysis } from './types';
...
export function calculateResult(inputs: title-insuranceInputs): number {
...
export function generateAnalysis(inputs: title-insuranceInputs, metrics: title-insuranceMetrics): title-insuranceAnalysis {
