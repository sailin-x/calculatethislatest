import { leverage-ratio-calculatorInputs, leverage-ratio-calculatorMetrics, leverage-ratio-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: leverage-ratio-calculatorInputs): number {
...
export function generateAnalysis(inputs: leverage-ratio-calculatorInputs, metrics: leverage-ratio-calculatorMetrics): leverage-ratio-calculatorAnalysis {
