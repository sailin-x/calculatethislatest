import { liquidity-mining-calculatorInputs, liquidity-mining-calculatorMetrics, liquidity-mining-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: liquidity-mining-calculatorInputs): number {
...
export function generateAnalysis(inputs: liquidity-mining-calculatorInputs, metrics: liquidity-mining-calculatorMetrics): liquidity-mining-calculatorAnalysis {
