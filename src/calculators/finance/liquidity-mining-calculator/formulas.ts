import { LiquidityMiningCalculatorinputs, LiquidityMiningCalculatormetrics, LiquidityMiningCalculatoranalysis } from './types';
...
export function calculateResult(inputs: LiquidityMiningCalculatorinputs): number {
...
export function generateAnalysis(inputs: LiquidityMiningCalculatorinputs, metrics: LiquidityMiningCalculatormetrics): LiquidityMiningCalculatoranalysis {
