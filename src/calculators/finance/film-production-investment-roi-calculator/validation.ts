import { FilmProductionInvestmentRoiCalculatorInputs } from './types';

export function validateFilmProductionInvestmentRoiCalculatorInputs(inputs: FilmProductionInvestmentRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateFilmProductionInvestmentRoiCalculatorBusinessRules(inputs: FilmProductionInvestmentRoiCalculatorInputs): Array<{ field: string; message: string }> {
