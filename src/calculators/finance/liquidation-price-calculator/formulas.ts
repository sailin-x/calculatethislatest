import { LiquidationPriceCalculatorinputs, LiquidationPriceCalculatormetrics, LiquidationPriceCalculatoranalysis } from './types';
...
export function calculateResult(inputs: LiquidationPriceCalculatorinputs): number {
...
export function generateAnalysis(inputs: LiquidationPriceCalculatorinputs, metrics: LiquidationPriceCalculatormetrics): LiquidationPriceCalculatoranalysis {
