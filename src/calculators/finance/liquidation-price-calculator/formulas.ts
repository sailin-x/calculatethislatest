import { liquidation-price-calculatorInputs, liquidation-price-calculatorMetrics, liquidation-price-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: liquidation-price-calculatorInputs): number {
...
export function generateAnalysis(inputs: liquidation-price-calculatorInputs, metrics: liquidation-price-calculatorMetrics): liquidation-price-calculatorAnalysis {
