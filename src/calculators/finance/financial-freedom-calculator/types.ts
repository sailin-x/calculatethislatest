export interface FinancialFreedomCalculatorInputs {
  ...
  freedomComponents: {
    ...
    financialFreedom: {
      ...
      assetFreedom: boolean;
      expenseFreedom: boolean;
      debtFreedom: boolean;
      savingsFreedom: boolean;
      investmentFreedom: boolean;
      retirementFreedom: boolean;
      lifestyleFreedom: boolean;
      timeFreedom: boolean;
    };
    
    // Choice Freedom
    choiceFreedom: {
      careerChoices: boolean;
      lifestyleChoices: boolean;
      locationChoices: boolean;
      timeChoices: boolean;
      spendingChoices: boolean;
      investmentChoices: boolean;
      riskChoices: boolean;
      goalChoices: boolean;
      futureChoices: boolean;
    };
    ...
    timeFreedom: {
      ...
      creativeTime: boolean;
      volunteerTime: boolean;
      restTime: boolean;
    };
    ...
    locationFreedom: {
      ...
      livingLocation: boolean;
      travelLocation: boolean;
      businessLocation: boolean;
      investmentLocation: boolean;
      retirementLocation: boolean;
      familyLocation: boolean;
      healthLocation: boolean;
      educationLocation: boolean;
    };
    
    // Lifestyle Freedom
    lifestyleFreedom: {
      spendingLifestyle: boolean;
      workingLifestyle: boolean;
      livingLifestyle: boolean;
      healthLifestyle: boolean;
      socialLifestyle: boolean;
      culturalLifestyle: boolean;
      educationalLifestyle: boolean;
      recreationalLifestyle: boolean;
      spiritualLifestyle: boolean;
    };
    ...
    opportunityFreedom: {
      ...
      socialOpportunities: boolean;
      creativeOpportunities: boolean;
      philanthropicOpportunities: boolean;
      legacyOpportunities: boolean;
    };
    ...
    securityFreedom: {
      ...
      familySecurity: boolean;
      assetSecurity: boolean;
      incomeSecurity: boolean;
      retirementSecurity: boolean;
      insuranceSecurity: boolean;
      legalSecurity: boolean;
      emotionalSecurity: boolean;
    };
    
    // Legacy Freedom
    legacyFreedom: {
      familyLegacy: boolean;
      wealthLegacy: boolean;
      knowledgeLegacy: boolean;
      philanthropicLegacy: boolean;
      businessLegacy: boolean;
      socialLegacy: boolean;
      environmentalLegacy: boolean;
      culturalLegacy: boolean;
      spiritualLegacy: boolean;
    };
  };
  ...
  includeFreedomConsiderations: boolean;
  
  // Calculation Options
  calculationOptions: {
    includeFreedomAnalysis: boolean;
...
export interface FinancialFreedomCalculatorResults {
  // Core Financial Freedom Metrics
  financialFreedomScore: number;
  financialFreedomComponentScore: number;
  choiceFreedomScore: number;
  timeFreedomScore: number;
  locationFreedomScore: number;
  lifestyleFreedomScore: number;
  riskFreedomScore: number;
  opportunityFreedomScore: number;
  securityFreedomScore: number;
  legacyFreedomScore: number;
  
  // Financial Freedom Analysis
  financialFreedomAnalysis: {
    financialFreedomScore: number;
    financialFreedomComponentScore: number;
    choiceFreedomScore: number;
    timeFreedomScore: number;
  ...
  // Freedom Assessment Analysis
  freedomAssessmentAnalysis: {
    freedomComponents: {
      component: string;
      score: number;
      weight: number;
  ...
  // Freedom Optimization Analysis
  freedomOptimizationAnalysis: {
  ...
  sensitivityAnalysis: {
    ...
    lowValue: number;
    highValue: number;
    lowFreedomScore: number;
    highFreedomScore: number;
    sensitivity: number;
  }[];
  
  // Monte Carlo Results
  monteCarloResults: {
    meanFreedomScore: number;
    medianFreedomScore: number;
  ...
  // Financial Freedom Planning Analysis
  financialFreedomPlanningAnalysis: {
    optimizationOpportunities: {
      category: string;
      opportunity: string;
      potentialImprovement: number;
  ...
  financialFreedomScore: {
    ...
    componentScores: {
      personal: number;
      financial: number;
      financialFreedomComponent: number;
      choiceFreedom: number;
      timeFreedom: number;
      locationFreedom: number;
      lifestyleFreedom: number;
      riskFreedom: number;
      opportunityFreedom: number;
      securityFreedom: number;
      legacyFreedom: number;
    };
