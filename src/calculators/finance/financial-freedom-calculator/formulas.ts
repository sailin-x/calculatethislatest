import { financial-freedom-calculatorInputs, financial-freedom-calculatorMetrics, financial-freedom-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-freedom-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-freedom-calculatorInputs, metrics: financial-freedom-calculatorMetrics): financial-freedom-calculatorAnalysis {
