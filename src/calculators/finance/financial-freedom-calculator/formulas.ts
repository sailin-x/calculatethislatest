import { FinancialFreedomCalculatorinputs, FinancialFreedomCalculatormetrics, FinancialFreedomCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialFreedomCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialFreedomCalculatorinputs, metrics: FinancialFreedomCalculatormetrics): FinancialFreedomCalculatoranalysis {
