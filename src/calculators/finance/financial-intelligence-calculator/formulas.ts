import { FinancialIntelligenceCalculatorinputs, FinancialIntelligenceCalculatormetrics, FinancialIntelligenceCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialIntelligenceCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialIntelligenceCalculatorinputs, metrics: FinancialIntelligenceCalculatormetrics): FinancialIntelligenceCalculatoranalysis {
