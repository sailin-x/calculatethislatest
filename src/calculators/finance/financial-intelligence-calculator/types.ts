export interface FinancialIntelligenceCalculatorInputs {
  ...
  financialIntelligenceAssessment: {
  ...
  intelligenceComponents: {
    ...
    decisionMaking: {
      ...
      tacticalDecisions: boolean;
      operationalDecisions: boolean;
      riskDecisions: boolean;
      investmentDecisions: boolean;
      debtDecisions: boolean;
      taxDecisions: boolean;
      insuranceDecisions: boolean;
      retirementDecisions: boolean;
    };
    
    // Problem Solving
    problemSolving: {
      financialProblems: boolean;
      investmentProblems: boolean;
      debtProblems: boolean;
      taxProblems: boolean;
      insuranceProblems: boolean;
      retirementProblems: boolean;
      estateProblems: boolean;
      riskProblems: boolean;
      marketProblems: boolean;
    };
    
    // Critical Thinking
    criticalThinking: {
      financialThinking: boolean;
      investmentThinking: boolean;
      debtThinking: boolean;
      taxThinking: boolean;
      insuranceThinking: boolean;
      retirementThinking: boolean;
      estateThinking: boolean;
      riskThinking: boolean;
      marketThinking: boolean;
    };
    
    // Learning Ability
    learningAbility: {
      financialLearning: boolean;
      investmentLearning: boolean;
      debtLearning: boolean;
      taxLearning: boolean;
      insuranceLearning: boolean;
      retirementLearning: boolean;
      estateLearning: boolean;
      riskLearning: boolean;
      marketLearning: boolean;
    };
    
    // Adaptability
    adaptability: {
      marketAdaptability: boolean;
      economicAdaptability: boolean;
      regulatoryAdaptability: boolean;
      technologicalAdaptability: boolean;
      strategyAdaptability: boolean;
      approachAdaptability: boolean;
      methodAdaptability: boolean;
      toolAdaptability: boolean;
      processAdaptability: boolean;
    };
    
    // Innovation
    innovation: {
      strategyInnovation: boolean;
      approachInnovation: boolean;
      methodInnovation: boolean;
      toolInnovation: boolean;
      technologyInnovation: boolean;
      processInnovation: boolean;
      solutionInnovation: boolean;
      opportunityInnovation: boolean;
      growthInnovation: boolean;
    };
  };
  ...
  includeIntelligenceRisk: boolean;
  ...
  includeIntelligenceConsiderations: boolean;
  
  // Calculation Options
  calculationOptions: {
    includeIntelligenceAnalysis: boolean;
...
export interface FinancialIntelligenceCalculatorResults {
  // Core Financial Intelligence Metrics
  financialIntelligenceScore: number;
  financialKnowledgeScore: number;
  financialSkillsScore: number;
  ...
  intelligenceAssessmentAnalysis: {
    intelligenceComponents: {
      component: string;
      score: number;
      weight: number;
  ...
  sensitivityAnalysis: {
    ...
    lowValue: number;
    highValue: number;
    lowIntelligenceScore: number;
    highIntelligenceScore: number;
    sensitivity: number;
  }[];
  
  // Monte Carlo Results
  monteCarloResults: {
    meanIntelligenceScore: number;
    medianIntelligenceScore: number;
  ...
  // Financial Intelligence Planning Analysis
  financialIntelligencePlanningAnalysis: {
    optimizationOpportunities: {
      category: string;
      opportunity: string;
      potentialImprovement: number;
  ...
  comparisonAnalysis: {
    ...
    benchmarkComparison: {
      benchmark: string;
      benchmarkIntelligence: number;
      planIntelligence: number;
