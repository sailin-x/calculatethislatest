import { MortgageClosingCostCalculatorInputs } from './types';

export function validateMortgageClosingCostCalculatorInputs(inputs: MortgageClosingCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMortgageClosingCostCalculatorBusinessRules(inputs: MortgageClosingCostCalculatorInputs): Array<{ field: string; message: string }> {
