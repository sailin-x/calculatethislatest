import { net-operating-incomeInputs, net-operating-incomeMetrics, net-operating-incomeAnalysis } from './types';
...
export function calculateResult(inputs: net-operating-incomeInputs): number {
...
export function generateAnalysis(inputs: net-operating-incomeInputs, metrics: net-operating-incomeMetrics): net-operating-incomeAnalysis {
