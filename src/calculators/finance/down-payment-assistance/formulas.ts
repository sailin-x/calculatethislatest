import { down-payment-assistanceInputs, down-payment-assistanceMetrics, down-payment-assistanceAnalysis } from './types';
...
export function calculateResult(inputs: down-payment-assistanceInputs): number {
...
export function generateAnalysis(inputs: down-payment-assistanceInputs, metrics: down-payment-assistanceMetrics): down-payment-assistanceAnalysis {
