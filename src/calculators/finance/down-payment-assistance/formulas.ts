import { DownPaymentAssistanceinputs, DownPaymentAssistancemetrics, DownPaymentAssistanceanalysis } from './types';
...
export function calculateResult(inputs: DownPaymentAssistanceinputs): number {
...
export function generateAnalysis(inputs: DownPaymentAssistanceinputs, metrics: DownPaymentAssistancemetrics): DownPaymentAssistanceanalysis {
