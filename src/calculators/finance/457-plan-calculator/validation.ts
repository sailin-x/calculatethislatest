import { 457PlanCalculatorInputs } from './types';

export function validate457PlanCalculatorInputs(inputs: 457PlanCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validate457PlanCalculatorBusinessRules(inputs: 457PlanCalculatorInputs): Array<{ field: string; message: string }> {
