import { biweekly-mortgageInputs, biweekly-mortgageMetrics, biweekly-mortgageAnalysis } from './types';
...
export function calculateResult(inputs: biweekly-mortgageInputs): number {
...
export function generateAnalysis(inputs: biweekly-mortgageInputs, metrics: biweekly-mortgageMetrics): biweekly-mortgageAnalysis {
