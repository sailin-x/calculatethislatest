import { NetPresentValue-calculatorInputs, NetPresentValue-calculatorMetrics, NetPresentValue-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: NetPresentValue-calculatorInputs): number {
...
export function generateAnalysis(inputs: NetPresentValue-calculatorInputs, metrics: NetPresentValue-calculatorMetrics): NetPresentValue-calculatorAnalysis {
