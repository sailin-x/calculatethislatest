...
import { UgmaUtmaCustodialAccountCalculatorInputs, UgmaUtmaCustodialAccountCalculatorOutputs } from './types';
import {
...
export const UgmaUtmaCustodialAccountCalculator: Calculator = {
  ...
  description: 'Calculate UGMA/UTMA custodial account growth and tax implications.',
  usageInstructions: [
