...
import { CarriedInterestWaterfallModelCalculatorInputs, CarriedInterestWaterfallModelCalculatorOutputs } from './types';
import {
...
export const CarriedInterestWaterfallModelCalculator: Calculator = {
  ...
  description: 'Calculate carried interest distributions in private equity.',
  usageInstructions: [
