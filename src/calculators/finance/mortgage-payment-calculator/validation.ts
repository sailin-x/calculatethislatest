import { MortgagePaymentCalculatorInputs } from './types';

export function validateMortgagePaymentCalculatorInputs(inputs: MortgagePaymentCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMortgagePaymentCalculatorBusinessRules(inputs: MortgagePaymentCalculatorInputs): Array<{ field: string; message: string }> {
