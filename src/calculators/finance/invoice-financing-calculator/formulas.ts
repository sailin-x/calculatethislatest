import { InvoiceFinancingCalculatorinputs, InvoiceFinancingCalculatormetrics, InvoiceFinancingCalculatoranalysis } from './types';
...
export function calculateResult(inputs: InvoiceFinancingCalculatorinputs): number {
...
export function generateAnalysis(inputs: InvoiceFinancingCalculatorinputs, metrics: InvoiceFinancingCalculatormetrics): InvoiceFinancingCalculatoranalysis {
