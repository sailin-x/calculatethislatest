import { invoice-financing-calculatorInputs, invoice-financing-calculatorMetrics, invoice-financing-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: invoice-financing-calculatorInputs): number {
...
export function generateAnalysis(inputs: invoice-financing-calculatorInputs, metrics: invoice-financing-calculatorMetrics): invoice-financing-calculatorAnalysis {
