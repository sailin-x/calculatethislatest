import { EstatePlanningCalculatorinputs, EstatePlanningCalculatormetrics, EstatePlanningCalculatoranalysis } from './types';
...
export function calculateResult(inputs: EstatePlanningCalculatorinputs): number {
...
export function generateAnalysis(inputs: EstatePlanningCalculatorinputs, metrics: EstatePlanningCalculatormetrics): EstatePlanningCalculatoranalysis {
