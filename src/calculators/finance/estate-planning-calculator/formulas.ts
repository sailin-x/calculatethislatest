import { estate-planning-calculatorInputs, estate-planning-calculatorMetrics, estate-planning-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: estate-planning-calculatorInputs): number {
...
export function generateAnalysis(inputs: estate-planning-calculatorInputs, metrics: estate-planning-calculatorMetrics): estate-planning-calculatorAnalysis {
