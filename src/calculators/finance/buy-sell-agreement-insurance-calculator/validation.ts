import { BuysellAgreementInsuranceCalculatorInputs } from './types';

export function validateBuysellAgreementInsuranceCalculatorInputs(inputs: BuysellAgreementInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBuysellAgreementInsuranceCalculatorBusinessRules(inputs: BuysellAgreementInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
