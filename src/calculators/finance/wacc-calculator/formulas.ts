import { wacc-calculatorInputs, wacc-calculatorMetrics, wacc-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: wacc-calculatorInputs): number {
...
export function generateAnalysis(inputs: wacc-calculatorInputs, metrics: wacc-calculatorMetrics): wacc-calculatorAnalysis {
