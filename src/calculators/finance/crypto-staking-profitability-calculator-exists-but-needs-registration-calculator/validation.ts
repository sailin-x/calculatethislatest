...
export function validateCryptoStakingProfitabilityCalculatorExistsButNeedsRegistrationCalculatorInputs(inputs: CryptoStakingProfitabilityCalculatorExistsButNeedsRegistrationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCryptoStakingProfitabilityCalculatorExistsButNeedsRegistrationCalculatorBusinessRules(inputs: CryptoStakingProfitabilityCalculatorExistsButNeedsRegistrationCalculatorInputs): Array<{ field: string; message: string }> {
