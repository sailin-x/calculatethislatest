import { FinancialRiskCalculatorinputs, FinancialRiskCalculatormetrics, FinancialRiskCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialRiskCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialRiskCalculatorinputs, metrics: FinancialRiskCalculatormetrics): FinancialRiskCalculatoranalysis {
