import { financial-risk-calculatorInputs, financial-risk-calculatorMetrics, financial-risk-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-risk-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-risk-calculatorInputs, metrics: financial-risk-calculatorMetrics): financial-risk-calculatorAnalysis {
