...
import { FinancialRiskCalculatorInputs, FinancialRiskCalculatorOutputs } from './types';
import {
...
export const FinancialRiskCalculator: Calculator = {
  id: 'FinancialRiskCalculator',
