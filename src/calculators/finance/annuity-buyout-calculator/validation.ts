...
export function validateAnnuityBuyoutCalculatorInputs(inputs: AnnuityBuyoutCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAnnuityBuyoutCalculatorBusinessRules(inputs: AnnuityBuyoutCalculatorInputs): Array<{ field: string; message: string }> {
