import { college-costInputs, college-costMetrics, college-costAnalysis } from './types';
...
export function calculateResult(inputs: college-costInputs): number {
...
export function generateAnalysis(inputs: college-costInputs, metrics: college-costMetrics): college-costAnalysis {
