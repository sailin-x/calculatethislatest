import { correlation-calculatorInputs, correlation-calculatorMetrics, correlation-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: correlation-calculatorInputs): number {
...
export function generateAnalysis(inputs: correlation-calculatorInputs, metrics: correlation-calculatorMetrics): correlation-calculatorAnalysis {
