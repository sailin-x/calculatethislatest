import { vineyard-profitabilityInputs, vineyard-profitabilityMetrics, vineyard-profitabilityAnalysis } from './types';
...
export function calculateResult(inputs: vineyard-profitabilityInputs): number {
...
export function generateAnalysis(inputs: vineyard-profitabilityInputs, metrics: vineyard-profitabilityMetrics): vineyard-profitabilityAnalysis {
