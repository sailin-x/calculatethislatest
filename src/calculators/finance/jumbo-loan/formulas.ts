import { jumbo-loanInputs, jumbo-loanMetrics, jumbo-loanAnalysis } from './types';
...
export function calculateResult(inputs: jumbo-loanInputs): number {
...
export function generateAnalysis(inputs: jumbo-loanInputs, metrics: jumbo-loanMetrics): jumbo-loanAnalysis {
