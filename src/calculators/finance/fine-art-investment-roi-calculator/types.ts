export interface FineArtInvestmentRoiCalculatorInputs {
...
export interface FineArtInvestmentRoiCalculatorOutputs {
...
export interface FineArtInvestmentRoiCalculatorMetrics {
...
export interface FineArtInvestmentRoiCalculatorAnalysis {
