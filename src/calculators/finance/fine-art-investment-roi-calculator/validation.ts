import { FineArtInvestmentRoiCalculatorInputs } from './types';

export function validateFineArtInvestmentRoiCalculatorInputs(inputs: FineArtInvestmentRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateFineArtInvestmentRoiCalculatorBusinessRules(inputs: FineArtInvestmentRoiCalculatorInputs): Array<{ field: string; message: string }> {
