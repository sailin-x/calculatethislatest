import { accretion-dilutionInputs, accretion-dilutionMetrics, accretion-dilutionAnalysis } from './types';
...
export function calculateResult(inputs: accretion-dilutionInputs): number {
...
export function generateAnalysis(inputs: accretion-dilutionInputs, metrics: accretion-dilutionMetrics): accretion-dilutionAnalysis {
