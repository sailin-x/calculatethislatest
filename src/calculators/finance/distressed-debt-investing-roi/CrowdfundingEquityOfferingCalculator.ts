...
import { distressed_debt_investing_roiCalculatorInputs, distressed_debt_investing_roiCalculatorOutputs } from './types';
import {
...
import { validatedistressed_debt_investing_roiCalculatorInputs, validatedistressed_debt_investing_roiCalculatorBusinessRules } from './validation';

export const distressed_debt_investing_roiCalculatorCalculator: Calculator = {
  id: 'DistressedDebtInvestingROICalculator',
  title: 'Distressed Debt Investing ROI Calculator',
  category: 'finance',
