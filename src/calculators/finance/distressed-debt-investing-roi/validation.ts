import { distressed_debt_investing_roiCalculatorInputs } from './types';

export function validatedistressed_debt_investing_roiCalculatorInputs(inputs: distressed_debt_investing_roiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatedistressed_debt_investing_roiCalculatorBusinessRules(inputs: distressed_debt_investing_roiCalculatorInputs): Array<{ field: string; message: string }> {
