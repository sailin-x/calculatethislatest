import { MortgagePointsCalculatorInputs } from './types';

export function validateMortgagePointsCalculatorInputs(inputs: MortgagePointsCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMortgagePointsCalculatorBusinessRules(inputs: MortgagePointsCalculatorInputs): Array<{ field: string; message: string }> {
