...
import { MortgagePointsCalculatorInputs, MortgagePointsCalculatorOutputs } from './types';
import {
...
import { validateMortgagePointsCalculatorInputs, validateMortgagePointsCalculatorBusinessRules } from './validation';

export const MortgagePointsCalculatorCalculator: Calculator: Calculator = {
  id: 'mortgage-points-calculator-calculator',
  title: 'Mortgage Points Calculator Calculator',
