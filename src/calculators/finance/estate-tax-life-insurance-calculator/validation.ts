import { EstateTaxLifeInsuranceCalculatorInputs } from './types';

export function validateEstateTaxLifeInsuranceCalculatorInputs(inputs: EstateTaxLifeInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateEstateTaxLifeInsuranceCalculatorBusinessRules(inputs: EstateTaxLifeInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
