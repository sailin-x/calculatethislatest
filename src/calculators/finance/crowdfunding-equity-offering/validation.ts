...
export function validateCrowdfundingEquityOfferingInputs(inputs: CrowdfundingEquityOfferingInputs): Array<{ field: string; message: string }> {
...
export function validateCrowdfundingEquityOfferingBusinessRules(inputs: CrowdfundingEquityOfferingInputs): Array<{ field: string; message: string }> {
