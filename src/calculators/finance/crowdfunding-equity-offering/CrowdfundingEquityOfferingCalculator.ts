...
import { CrowdfundingEquityOfferingInputs, CrowdfundingEquityOfferingOutputs } from './types';
import {
...
import { validateCrowdfundingEquityOfferingInputs, validateCrowdfundingEquityOfferingBusinessRules } from './validation';

export const CrowdfundingEquityOfferingCalculator: Calculator = {
  id: 'CrowdfundingEquityOfferingCalculator',
  title: 'Crowdfunding Equity Offering Calculator',
  category: 'finance',
