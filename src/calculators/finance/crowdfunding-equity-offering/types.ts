export interface CrowdfundingEquityOfferingInputs {
...
export interface CrowdfundingEquityOfferingOutputs {
...
export interface CrowdfundingEquityOfferingMetrics {
  result: number;
}

export interface CrowdfundingEquityOfferingAnalysis {
