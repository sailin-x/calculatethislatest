import { coverdell-esaInputs, coverdell-esaMetrics, coverdell-esaAnalysis } from './types';
...
export function calculateResult(inputs: coverdell-esaInputs): number {
...
export function generateAnalysis(inputs: coverdell-esaInputs, metrics: coverdell-esaMetrics): coverdell-esaAnalysis {
