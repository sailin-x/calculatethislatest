export interface KeyPersonInsuranceCalculatorInputs {
...
export interface KeyPersonInsuranceCalculatorOutputs {
...
export interface KeyPersonInsuranceCalculatorMetrics {
...
export interface KeyPersonInsuranceCalculatorAnalysis {
