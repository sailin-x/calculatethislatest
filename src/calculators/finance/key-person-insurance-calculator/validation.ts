import { KeyPersonInsuranceCalculatorInputs } from './types';

export function validateKeyPersonInsuranceCalculatorInputs(inputs: KeyPersonInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateKeyPersonInsuranceCalculatorBusinessRules(inputs: KeyPersonInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
