import { amortizationInputs, amortizationMetrics, amortizationAnalysis } from './types';
...
export function calculateResult(inputs: amortizationInputs): number {
...
export function generateAnalysis(inputs: amortizationInputs, metrics: amortizationMetrics): amortizationAnalysis {
