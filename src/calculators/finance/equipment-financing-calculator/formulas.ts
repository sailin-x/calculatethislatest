import { equipment-financing-calculatorInputs, equipment-financing-calculatorMetrics, equipment-financing-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: equipment-financing-calculatorInputs): number {
...
export function generateAnalysis(inputs: equipment-financing-calculatorInputs, metrics: equipment-financing-calculatorMetrics): equipment-financing-calculatorAnalysis {
