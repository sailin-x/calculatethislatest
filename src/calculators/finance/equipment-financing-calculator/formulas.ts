import { EquipmentFinancingCalculatorinputs, EquipmentFinancingCalculatormetrics, EquipmentFinancingCalculatoranalysis } from './types';
...
export function calculateResult(inputs: EquipmentFinancingCalculatorinputs): number {
...
export function generateAnalysis(inputs: EquipmentFinancingCalculatorinputs, metrics: EquipmentFinancingCalculatormetrics): EquipmentFinancingCalculatoranalysis {
