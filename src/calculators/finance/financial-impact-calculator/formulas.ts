import { FinancialImpactCalculatorinputs, FinancialImpactCalculatormetrics, FinancialImpactCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialImpactCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialImpactCalculatorinputs, metrics: FinancialImpactCalculatormetrics): FinancialImpactCalculatoranalysis {
