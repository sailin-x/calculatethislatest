import { financial-impact-calculatorInputs, financial-impact-calculatorMetrics, financial-impact-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-impact-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-impact-calculatorInputs, metrics: financial-impact-calculatorMetrics): financial-impact-calculatorAnalysis {
