import { va-loanInputs, va-loanMetrics, va-loanAnalysis } from './types';
...
export function calculateResult(inputs: va-loanInputs): number {
...
export function generateAnalysis(inputs: va-loanInputs, metrics: va-loanMetrics): va-loanAnalysis {
