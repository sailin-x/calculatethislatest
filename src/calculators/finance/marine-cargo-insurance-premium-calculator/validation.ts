import { MarineCargoInsurancePremiumCalculatorInputs } from './types';

export function validateMarineCargoInsurancePremiumCalculatorInputs(inputs: MarineCargoInsurancePremiumCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMarineCargoInsurancePremiumCalculatorBusinessRules(inputs: MarineCargoInsurancePremiumCalculatorInputs): Array<{ field: string; message: string }> {
