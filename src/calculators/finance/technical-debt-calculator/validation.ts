import { TechnicalDebtCalculatorInputs } from './types';

export function validateTechnicalDebtCalculatorInputs(inputs: TechnicalDebtCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTechnicalDebtCalculatorBusinessRules(inputs: TechnicalDebtCalculatorInputs): Array<{ field: string; message: string }> {
