export interface TechnicalDebtCalculatorInputs {
...
export interface TechnicalDebtCalculatorOutputs {
...
export interface TechnicalDebtCalculatorMetrics {
...
export interface TechnicalDebtCalculatorAnalysis {
