import { mortgage-pointsInputs, mortgage-pointsMetrics, mortgage-pointsAnalysis } from './types';
...
export function calculateResult(inputs: mortgage-pointsInputs): number {
...
export function generateAnalysis(inputs: mortgage-pointsInputs, metrics: mortgage-pointsMetrics): mortgage-pointsAnalysis {
