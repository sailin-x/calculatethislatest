import { CompoundInterestCalculatorinputs, CompoundInterestCalculatormetrics, CompoundInterestCalculatoranalysis } from './types';
...
export function calculateResult(inputs: CompoundInterestCalculatorinputs): number {
...
export function generateAnalysis(inputs: CompoundInterestCalculatorinputs, metrics: CompoundInterestCalculatormetrics): CompoundInterestCalculatoranalysis {
