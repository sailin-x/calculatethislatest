import { compound-interest-calculatorInputs, compound-interest-calculatorMetrics, compound-interest-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: compound-interest-calculatorInputs): number {
...
export function generateAnalysis(inputs: compound-interest-calculatorInputs, metrics: compound-interest-calculatorMetrics): compound-interest-calculatorAnalysis {
