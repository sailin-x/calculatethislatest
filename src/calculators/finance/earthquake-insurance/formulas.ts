import { earthquake-insuranceInputs, earthquake-insuranceMetrics, earthquake-insuranceAnalysis } from './types';
...
export function calculateResult(inputs: earthquake-insuranceInputs): number {
...
export function generateAnalysis(inputs: earthquake-insuranceInputs, metrics: earthquake-insuranceMetrics): earthquake-insuranceAnalysis {
