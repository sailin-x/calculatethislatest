import { financial-transformation-calculatorInputs, financial-transformation-calculatorMetrics, financial-transformation-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-transformation-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-transformation-calculatorInputs, metrics: financial-transformation-calculatorMetrics): financial-transformation-calculatorAnalysis {
