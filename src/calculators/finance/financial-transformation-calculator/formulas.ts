import { FinancialTransformationCalculatorinputs, FinancialTransformationCalculatormetrics, FinancialTransformationCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialTransformationCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialTransformationCalculatorinputs, metrics: FinancialTransformationCalculatormetrics): FinancialTransformationCalculatoranalysis {
