...
import { RequiredBeginningDateRbdForRmdsCalculatorInputs, RequiredBeginningDateRbdForRmdsCalculatorOutputs } from './types';
import {
...
export const RequiredBeginningDateRbdForRmdsCalculator: Calculator = {
  ...
  description: 'Calculate required beginning date for required minimum distributions.',
  usageInstructions: [
