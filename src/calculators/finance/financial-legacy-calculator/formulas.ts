import { financial-legacy-calculatorInputs, financial-legacy-calculatorMetrics, financial-legacy-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-legacy-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-legacy-calculatorInputs, metrics: financial-legacy-calculatorMetrics): financial-legacy-calculatorAnalysis {
