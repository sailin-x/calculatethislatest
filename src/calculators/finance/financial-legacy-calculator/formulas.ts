import { FinancialLegacyCalculatorinputs, FinancialLegacyCalculatormetrics, FinancialLegacyCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialLegacyCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialLegacyCalculatorinputs, metrics: FinancialLegacyCalculatormetrics): FinancialLegacyCalculatoranalysis {
