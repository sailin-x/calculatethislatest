export interface ShitcoinInvestmentCalculatorInputs {
...
export interface ShitcoinInvestmentCalculatorOutputs {
...
export interface ShitcoinInvestmentCalculatorMetrics {
...
export interface ShitcoinInvestmentCalculatorAnalysis {
