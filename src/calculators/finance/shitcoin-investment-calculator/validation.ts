...
export function validateShitcoinInvestmentCalculatorInputs(inputs: ShitcoinInvestmentCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateShitcoinInvestmentCalculatorBusinessRules(inputs: ShitcoinInvestmentCalculatorInputs): Array<{ field: string; message: string }> {
