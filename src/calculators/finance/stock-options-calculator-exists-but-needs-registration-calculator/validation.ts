...
export function validateStockOptionsCalculatorExistsButNeedsRegistrationCalculatorInputs(inputs: StockOptionsCalculatorExistsButNeedsRegistrationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateStockOptionsCalculatorExistsButNeedsRegistrationCalculatorBusinessRules(inputs: StockOptionsCalculatorExistsButNeedsRegistrationCalculatorInputs): Array<{ field: string; message: string }> {
