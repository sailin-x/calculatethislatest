import { crypto-portfolio-rebalancing-calculatorInputs, crypto-portfolio-rebalancing-calculatorMetrics, crypto-portfolio-rebalancing-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: crypto-portfolio-rebalancing-calculatorInputs): number {
...
export function generateAnalysis(inputs: crypto-portfolio-rebalancing-calculatorInputs, metrics: crypto-portfolio-rebalancing-calculatorMetrics): crypto-portfolio-rebalancing-calculatorAnalysis {
