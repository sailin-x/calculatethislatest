import { FinancialPerformanceCalculatorinputs, FinancialPerformanceCalculatormetrics, FinancialPerformanceCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialPerformanceCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialPerformanceCalculatorinputs, metrics: FinancialPerformanceCalculatormetrics): FinancialPerformanceCalculatoranalysis {
