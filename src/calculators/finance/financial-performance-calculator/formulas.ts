import { financial-performance-calculatorInputs, financial-performance-calculatorMetrics, financial-performance-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-performance-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-performance-calculatorInputs, metrics: financial-performance-calculatorMetrics): financial-performance-calculatorAnalysis {
