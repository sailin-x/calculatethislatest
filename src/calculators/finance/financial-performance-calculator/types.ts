export interface FinancialPerformanceCalculatorInputs {
  ...
  performanceComponents: {
    ...
    returnPerformance: {
      ...
      riskAdjustedReturn: boolean;
      excessReturn: boolean;
      relativeReturn: boolean;
      absoluteReturn: boolean;
      timeWeightedReturn: boolean;
      moneyWeightedReturn: boolean;
      geometricReturn: boolean;
    };
    
    // Risk Performance
    riskPerformance: {
      volatility: boolean;
      downsideDeviation: boolean;
      valueAtRisk: boolean;
    ...
    efficiencyPerformance: {
      ...
      allocationEfficiency: boolean;
      rebalancingEfficiency: boolean;
      tradingEfficiency: boolean;
      liquidityEfficiency: boolean;
      diversificationEfficiency: boolean;
      optimizationEfficiency: boolean;
    };
    ...
    liquidityPerformance: {
      ...
      liquidityStability: boolean;
      liquidityAccess: boolean;
    };
  ...
  includePerformanceRisk: boolean;
...
export interface FinancialPerformanceCalculatorResults {
  // Core Financial Performance Metrics
  financialPerformanceScore: number;
  returnPerformanceScore: number;
  riskPerformanceScore: number;
  efficiencyPerformanceScore: number;
  growthPerformanceScore: number;
  incomePerformanceScore: number;
  cashFlowPerformanceScore: number;
  liquidityPerformanceScore: number;
  solvencyPerformanceScore: number;
  ...
  // Financial Performance Planning Analysis
  financialPerformancePlanningAnalysis: {
    optimizationOpportunities: {
      category: string;
      opportunity: string;
      potentialImprovement: number;
  ...
  financialPerformanceScore: {
    ...
    componentScores: {
      ...
      efficiencyPerformance: number;
      growthPerformance: number;
      incomePerformance: number;
      cashFlowPerformance: number;
      liquidityPerformance: number;
      solvencyPerformance: number;
    };
