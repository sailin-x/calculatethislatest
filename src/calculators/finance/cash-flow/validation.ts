...
/**
 * Validate cash flow calculator inputs
 */
export function validateCashFlowInputs(inputs: Record<string, any>): ValidationResult {
  const errors: string[] = [];
  ...
  if (inputs.propertyValue < 50000) {
    ...
    errors.push('Property value cannot exceed $10 million');
  }
...
/**
 * Validate cash flow reasonableness
 */
export function validateCashFlowReasonableness(
