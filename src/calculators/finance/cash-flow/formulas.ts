import { cash-flowInputs, cash-flowMetrics, cash-flowAnalysis } from './types';
...
export function calculateResult(inputs: cash-flowInputs): number {
...
export function generateAnalysis(inputs: cash-flowInputs, metrics: cash-flowMetrics): cash-flowAnalysis {
