import { opportunity-zone-investment-roi-calculatorInputs, opportunity-zone-investment-roi-calculatorMetrics, opportunity-zone-investment-roi-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: opportunity-zone-investment-roi-calculatorInputs): number {
...
export function generateAnalysis(inputs: opportunity-zone-investment-roi-calculatorInputs, metrics: opportunity-zone-investment-roi-calculatorMetrics): opportunity-zone-investment-roi-calculatorAnalysis {
