...
export function validateOpportunityZoneInvestmentRoiCalculatorInputs(inputs: OpportunityZoneInvestmentRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateOpportunityZoneInvestmentRoiCalculatorBusinessRules(inputs: OpportunityZoneInvestmentRoiCalculatorInputs): Array<{ field: string; message: string }> {
