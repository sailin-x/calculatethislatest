export interface OpportunityZoneInvestmentRoiCalculatorInputs {
...
export interface OpportunityZoneInvestmentRoiCalculatorOutputs {
...
export interface OpportunityZoneInvestmentRoiCalculatorMetrics {
...
export interface OpportunityZoneInvestmentRoiCalculatorAnalysis {
