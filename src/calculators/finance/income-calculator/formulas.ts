import { income-calculatorInputs, income-calculatorMetrics, income-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: income-calculatorInputs): number {
...
export function generateAnalysis(inputs: income-calculatorInputs, metrics: income-calculatorMetrics): income-calculatorAnalysis {
