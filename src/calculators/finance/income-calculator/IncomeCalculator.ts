...
import { IncomeCalculatorInputs, IncomeCalculatorOutputs } from './types';
import {
...
import { validateIncomeCalculatorInputs } from './validation';
...
export const IncomeCalculator: Calculator = {
  ...
  description: 'Calculate various income types and taxes',
  usageInstructions: [
