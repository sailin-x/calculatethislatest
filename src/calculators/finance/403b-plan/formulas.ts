import { 403b-planInputs, 403b-planMetrics, 403b-planAnalysis } from './types';
...
export function calculateResult(inputs: 403b-planInputs): number {
...
export function generateAnalysis(inputs: 403b-planInputs, metrics: 403b-planMetrics): 403b-planAnalysis {
