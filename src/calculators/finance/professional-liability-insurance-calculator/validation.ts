import { ProfessionalLiabilityInsuranceCalculatorInputs } from './types';

export function validateProfessionalLiabilityInsuranceCalculatorInputs(inputs: ProfessionalLiabilityInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateProfessionalLiabilityInsuranceCalculatorBusinessRules(inputs: ProfessionalLiabilityInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
