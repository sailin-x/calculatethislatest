import { 457-planInputs, 457-planMetrics, 457-planAnalysis } from './types';
...
export function calculateResult(inputs: 457-planInputs): number {
...
export function generateAnalysis(inputs: 457-planInputs, metrics: 457-planMetrics): 457-planAnalysis {
