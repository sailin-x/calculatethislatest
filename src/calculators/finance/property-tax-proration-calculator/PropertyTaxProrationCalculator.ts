...
import { PropertyTaxProrationCalculatorInputs, PropertyTaxProrationCalculatorOutputs } from './types';
import {
...
import { validatePropertyTaxProrationCalculatorInputs, validatePropertyTaxProrationCalculatorBusinessRules } from './validation';

export const PropertyTaxProrationCalculatorCalculator: Calculator: Calculator = {
  id: 'property-tax-proration-calculator-calculator',
  title: 'Property Tax Proration Calculator Calculator',
