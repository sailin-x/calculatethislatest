import { renters-insuranceInputs, renters-insuranceMetrics, renters-insuranceAnalysis } from './types';
...
export function calculateResult(inputs: renters-insuranceInputs): number {
...
export function generateAnalysis(inputs: renters-insuranceInputs, metrics: renters-insuranceMetrics): renters-insuranceAnalysis {
