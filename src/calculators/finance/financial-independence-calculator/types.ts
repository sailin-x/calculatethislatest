export interface FinancialIndependenceCalculatorInputs {
  ...
  independenceComponents: {
    ...
    passiveIncomeIndependence: {
      investmentIncome: boolean;
      rentalIncome: boolean;
      businessIncome: boolean;
      dividendIncome: boolean;
      interestIncome: boolean;
      royaltyIncome: boolean;
      passiveIncomeDiversification: boolean;
      passiveIncomeGrowth: boolean;
      passiveIncomeProjection: boolean;
    };
    
    // Asset Independence
    assetIndependence: {
      totalAssetIndependence: boolean;
      investmentAssetIndependence: boolean;
      realEstateAssetIndependence: boolean;
      businessAssetIndependence: boolean;
      retirementAssetIndependence: boolean;
      cashAssetIndependence: boolean;
      assetDiversification: boolean;
      assetProjection: boolean;
      assetOptimization: boolean;
    };
    
    // Expense Independence
    expenseIndependence: {
      totalExpenseIndependence: boolean;
      essentialExpenseIndependence: boolean;
      discretionaryExpenseIndependence: boolean;
    ...
    // Debt Independence
    debtIndependence: {
      totalDebtIndependence: boolean;
      mortgageDebtIndependence: boolean;
      consumerDebtIndependence: boolean;
      studentLoanIndependence: boolean;
      businessDebtIndependence: boolean;
    ...
    lifestyleIndependence: {
      lifestyleExpenses: boolean;
      lifestyleChoices: boolean;
      lifestyleFlexibility: boolean;
      lifestyleSustainability: boolean;
      lifestyleProjection: boolean;
      lifestyleOptimization: boolean;
      lifestyleMonitoring: boolean;
      lifestylePlanning: boolean;
      lifestyleSecurity: boolean;
    };
    ...
    timeIndependence: {
      ...
      timeProjection: boolean;
      timeOptimization: boolean;
      timeMonitoring: boolean;
      timePlanning: boolean;
      timeSecurity: boolean;
    };
  };
  ...
  includeIndependenceRisk: boolean;
  ...
  includeIndependenceConsiderations: boolean;
  
  // Calculation Options
  calculationOptions: {
    includeIndependenceAnalysis: boolean;
...
export interface FinancialIndependenceCalculatorResults {
  // Core Financial Independence Metrics
  financialIndependenceScore: number;
  passiveIncomeIndependenceScore: number;
  assetIndependenceScore: number;
  expenseIndependenceScore: number;
  debtIndependenceScore: number;
  savingsIndependenceScore: number;
  investmentIndependenceScore: number;
  retirementIndependenceScore: number;
  lifestyleIndependenceScore: number;
  timeIndependenceScore: number;
  ...
  independenceAssessmentAnalysis: {
    independenceComponents: {
      component: string;
      score: number;
      weight: number;
  ...
  // Independence Optimization Analysis
  independenceOptimizationAnalysis: {
  ...
  sensitivityAnalysis: {
    ...
    lowValue: number;
    highValue: number;
    lowIndependenceScore: number;
    highIndependenceScore: number;
    sensitivity: number;
  }[];
  ...
  monteCarloResults: {
    ...
    medianIndependenceScore: number;
  ...
  // Financial Independence Planning Analysis
  financialIndependencePlanningAnalysis: {
    optimizationOpportunities: {
      category: string;
      opportunity: string;
      potentialImprovement: number;
  ...
  comparisonAnalysis: {
    ...
    benchmarkComparison: {
      benchmark: string;
      benchmarkIndependence: number;
      planIndependence: number;
  ...
  financialIndependenceScore: {
    ...
    componentScores: {
      personal: number;
      financial: number;
      passiveIncomeIndependence: number;
      assetIndependence: number;
      expenseIndependence: number;
      debtIndependence: number;
      savingsIndependence: number;
      investmentIndependence: number;
      retirementIndependence: number;
      lifestyleIndependence: number;
      timeIndependence: number;
    };
