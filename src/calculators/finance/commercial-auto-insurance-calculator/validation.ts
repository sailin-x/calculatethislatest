import { CommercialAutoInsuranceCalculatorInputs } from './types';

export function validateCommercialAutoInsuranceCalculatorInputs(inputs: CommercialAutoInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCommercialAutoInsuranceCalculatorBusinessRules(inputs: CommercialAutoInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
