import { TradeCreditInsuranceRoiCalculatorInputs } from './types';

export function validateTradeCreditInsuranceRoiCalculatorInputs(inputs: TradeCreditInsuranceRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTradeCreditInsuranceRoiCalculatorBusinessRules(inputs: TradeCreditInsuranceRoiCalculatorInputs): Array<{ field: string; message: string }> {
