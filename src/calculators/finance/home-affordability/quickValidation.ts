...
export function validateDownPaymentPercent(value: any): { isValid: boolean; message?: string } {
...
export function validateAnnualPropertyTaxes(value: any): { isValid: boolean; message?: string } {
...
export function validateAnnualHomeownersInsurance(value: any): { isValid: boolean; message?: string } {
...
export function validateMonthlyHoaFees(value: any): { isValid: boolean; message?: string } {
...
export function validateMonthlyUtilities(value: any): { isValid: boolean; message?: string } {
...
export function validateMonthlyMaintenance(value: any): { isValid: boolean; message?: string } {
...
export function validateFrontEndDTI(value: any): { isValid: boolean; message?: string } {
...
export function validateBackEndDTI(value: any): { isValid: boolean; message?: string } {
...
export function validateClosingCostsPercent(value: any): { isValid: boolean; message?: string } {
...
export function validateIncomeGrowthRate(value: any): { isValid: boolean; message?: string } {
...
export function validateHomeAppreciationRate(value: any): { isValid: boolean; message?: string } {
