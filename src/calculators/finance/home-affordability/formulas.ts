import { home-affordabilityInputs, home-affordabilityMetrics, home-affordabilityAnalysis } from './types';
...
export function calculateResult(inputs: home-affordabilityInputs): number {
...
export function generateAnalysis(inputs: home-affordabilityInputs, metrics: home-affordabilityMetrics): home-affordabilityAnalysis {
