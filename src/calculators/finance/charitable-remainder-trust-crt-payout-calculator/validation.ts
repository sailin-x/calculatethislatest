import { CharitableRemainderTrustCrtPayoutCalculatorInputs } from './types';

export function validateCharitableRemainderTrustCrtPayoutCalculatorInputs(inputs: CharitableRemainderTrustCrtPayoutCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCharitableRemainderTrustCrtPayoutCalculatorBusinessRules(inputs: CharitableRemainderTrustCrtPayoutCalculatorInputs): Array<{ field: string; message: string }> {
