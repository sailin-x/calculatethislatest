import { mortgage-qualificationInputs, mortgage-qualificationMetrics, mortgage-qualificationAnalysis } from './types';
...
export function calculateResult(inputs: mortgage-qualificationInputs): number {
...
export function generateAnalysis(inputs: mortgage-qualificationInputs, metrics: mortgage-qualificationMetrics): mortgage-qualificationAnalysis {
