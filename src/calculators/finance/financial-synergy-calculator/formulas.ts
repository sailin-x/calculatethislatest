import { FinancialSynergyCalculatorinputs, FinancialSynergyCalculatormetrics, FinancialSynergyCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialSynergyCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialSynergyCalculatorinputs, metrics: FinancialSynergyCalculatormetrics): FinancialSynergyCalculatoranalysis {
