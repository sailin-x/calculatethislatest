import { financial-synergy-calculatorInputs, financial-synergy-calculatorMetrics, financial-synergy-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-synergy-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-synergy-calculatorInputs, metrics: financial-synergy-calculatorMetrics): financial-synergy-calculatorAnalysis {
