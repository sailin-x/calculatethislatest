import { restricted-stock-unit-rsu-vs-stock-option-calculatorInputs, restricted-stock-unit-rsu-vs-stock-option-calculatorMetrics, restricted-stock-unit-rsu-vs-stock-option-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: restricted-stock-unit-rsu-vs-stock-option-calculatorInputs): number {
...
export function generateAnalysis(inputs: restricted-stock-unit-rsu-vs-stock-option-calculatorInputs, metrics: restricted-stock-unit-rsu-vs-stock-option-calculatorMetrics): restricted-stock-unit-rsu-vs-stock-option-calculatorAnalysis {
