...
export function validateRetirementPlanningCalculatorInputs(inputs: RetirementPlanningCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateRetirementPlanningCalculatorBusinessRules(inputs: RetirementPlanningCalculatorInputs): Array<{ field: string; message: string }> {
