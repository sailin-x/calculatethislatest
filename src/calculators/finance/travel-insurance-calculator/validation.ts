import { TravelInsuranceCalculatorInputs } from './types';

export function validateTravelInsuranceCalculatorInputs(inputs: TravelInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTravelInsuranceCalculatorBusinessRules(inputs: TravelInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
