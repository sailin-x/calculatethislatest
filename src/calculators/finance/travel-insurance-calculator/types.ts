export interface TravelInsuranceCalculatorInputs {
...
export interface TravelInsuranceCalculatorOutputs {
...
export interface TravelInsuranceCalculatorMetrics {
...
export interface TravelInsuranceCalculatorAnalysis {
