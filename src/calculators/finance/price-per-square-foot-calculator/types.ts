export interface PricePerSquareFootCalculatorInputs {
...
export interface PricePerSquareFootCalculatorOutputs {
...
export interface PricePerSquareFootCalculatorMetrics {
...
export interface PricePerSquareFootCalculatorAnalysis {
