...
import { PricePerSquareFootCalculatorInputs, PricePerSquareFootCalculatorOutputs } from './types';
import {
...
import { validatePricePerSquareFootCalculatorInputs, validatePricePerSquareFootCalculatorBusinessRules } from './validation';

export const PricePerSquareFootCalculatorCalculator: Calculator: Calculator = {
  id: 'price-per-square-foot-calculator-calculator',
  title: 'Price Per Square Foot Calculator Calculator',
