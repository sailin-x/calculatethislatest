import { PricePerSquareFootCalculatorInputs } from './types';

export function validatePricePerSquareFootCalculatorInputs(inputs: PricePerSquareFootCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePricePerSquareFootCalculatorBusinessRules(inputs: PricePerSquareFootCalculatorInputs): Array<{ field: string; message: string }> {
