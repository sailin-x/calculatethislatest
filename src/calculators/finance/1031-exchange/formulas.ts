import { 1031-exchangeInputs, 1031-exchangeMetrics, 1031-exchangeAnalysis } from './types';
...
export function calculateResult(inputs: 1031-exchangeInputs): number {
...
export function generateAnalysis(inputs: 1031-exchangeInputs, metrics: 1031-exchangeMetrics): 1031-exchangeAnalysis {
