import { reverse-mortgageInputs, reverse-mortgageMetrics, reverse-mortgageAnalysis } from './types';
...
export function calculateResult(inputs: reverse-mortgageInputs): number {
...
export function generateAnalysis(inputs: reverse-mortgageInputs, metrics: reverse-mortgageMetrics): reverse-mortgageAnalysis {
