import { arm-mortgageInputs, arm-mortgageMetrics, arm-mortgageAnalysis } from './types';
...
export function calculateResult(inputs: arm-mortgageInputs): number {
...
export function generateAnalysis(inputs: arm-mortgageInputs, metrics: arm-mortgageMetrics): arm-mortgageAnalysis {
