import { brrrr-strategyInputs, brrrr-strategyMetrics, brrrr-strategyAnalysis } from './types';
...
export function calculateResult(inputs: brrrr-strategyInputs): number {
...
export function generateAnalysis(inputs: brrrr-strategyInputs, metrics: brrrr-strategyMetrics): brrrr-strategyAnalysis {
