import { MortgageLifeCalculatorInputs } from './types';

export function validateMortgageLifeCalculatorInputs(inputs: MortgageLifeCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMortgageLifeCalculatorBusinessRules(inputs: MortgageLifeCalculatorInputs): Array<{ field: string; message: string }> {
