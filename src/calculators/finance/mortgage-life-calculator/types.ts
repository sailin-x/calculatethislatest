export interface MortgageLifeCalculatorInputs {
...
export interface MortgageLifeCalculatorOutputs {
...
export interface MortgageLifeCalculatorMetrics {
...
export interface MortgageLifeCalculatorAnalysis {
