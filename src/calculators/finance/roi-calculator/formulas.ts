import { roi-calculatorInputs, roi-calculatorMetrics, roi-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: roi-calculatorInputs): number {
...
export function generateAnalysis(inputs: roi-calculatorInputs, metrics: roi-calculatorMetrics): roi-calculatorAnalysis {
