import { PeerToPeer-lending-calculatorInputs, PeerToPeer-lending-calculatorMetrics, PeerToPeer-lending-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: PeerToPeer-lending-calculatorInputs): number {
...
export function generateAnalysis(inputs: PeerToPeer-lending-calculatorInputs, metrics: PeerToPeer-lending-calculatorMetrics): PeerToPeer-lending-calculatorAnalysis {
