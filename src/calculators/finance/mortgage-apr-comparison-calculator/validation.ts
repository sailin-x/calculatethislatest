import { MortgageAprComparisonCalculatorInputs } from './types';

export function validateMortgageAprComparisonCalculatorInputs(inputs: MortgageAprComparisonCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMortgageAprComparisonCalculatorBusinessRules(inputs: MortgageAprComparisonCalculatorInputs): Array<{ field: string; message: string }> {
