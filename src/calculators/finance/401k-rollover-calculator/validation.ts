import { 401kRolloverCalculatorInputs } from './types';

export function validate401kRolloverCalculatorInputs(inputs: 401kRolloverCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validate401kRolloverCalculatorBusinessRules(inputs: 401kRolloverCalculatorInputs): Array<{ field: string; message: string }> {
