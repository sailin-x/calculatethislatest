import { KeyPersonLifeInsuranceCalculatorInputs } from './types';

export function validateKeyPersonLifeInsuranceCalculatorInputs(inputs: KeyPersonLifeInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateKeyPersonLifeInsuranceCalculatorBusinessRules(inputs: KeyPersonLifeInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
