import { ImpermanentLossCalculatorinputs, ImpermanentLossCalculatormetrics, ImpermanentLossCalculatoranalysis } from './types';
...
export function calculateResult(inputs: ImpermanentLossCalculatorinputs): number {
...
export function generateAnalysis(inputs: ImpermanentLossCalculatorinputs, metrics: ImpermanentLossCalculatormetrics): ImpermanentLossCalculatoranalysis {
