import { AdjustablerateMortgageArmCalculatorInputs } from './types';

export function validateAdjustablerateMortgageArmCalculatorInputs(inputs: AdjustablerateMortgageArmCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAdjustablerateMortgageArmCalculatorBusinessRules(inputs: AdjustablerateMortgageArmCalculatorInputs): Array<{ field: string; message: string }> {
