...
import { CorporateTaxShieldCalculatorInputs, CorporateTaxShieldCalculatorOutputs } from './types';
import {
...
export const CorporateTaxShieldCalculator: Calculator = {
  ...
  description: 'Calculate tax shields from corporate debt and depreciation.',
  usageInstructions: [
