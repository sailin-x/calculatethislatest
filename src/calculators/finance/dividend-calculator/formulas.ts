import { dividend-calculatorInputs, dividend-calculatorMetrics, dividend-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: dividend-calculatorInputs): number {
...
export function generateAnalysis(inputs: dividend-calculatorInputs, metrics: dividend-calculatorMetrics): dividend-calculatorAnalysis {
