import { arm-vs-fixedInputs, arm-vs-fixedMetrics, arm-vs-fixedAnalysis } from './types';
...
export function calculateResult(inputs: arm-vs-fixedInputs): number {
...
export function generateAnalysis(inputs: arm-vs-fixedInputs, metrics: arm-vs-fixedMetrics): arm-vs-fixedAnalysis {
