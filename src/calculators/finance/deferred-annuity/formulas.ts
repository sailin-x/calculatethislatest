import { deferred-annuityInputs, deferred-annuityMetrics, deferred-annuityAnalysis } from './types';
...
export function calculateResult(inputs: deferred-annuityInputs): number {
...
export function generateAnalysis(inputs: deferred-annuityInputs, metrics: deferred-annuityMetrics): deferred-annuityAnalysis {
