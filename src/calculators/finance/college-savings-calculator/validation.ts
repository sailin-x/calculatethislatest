import { CollegeSavingsCalculatorInputs } from './types';

export function validateCollegeSavingsCalculatorInputs(inputs: CollegeSavingsCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCollegeSavingsCalculatorBusinessRules(inputs: CollegeSavingsCalculatorInputs): Array<{ field: string; message: string }> {
