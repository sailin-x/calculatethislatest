import { alphaInputs, alphaMetrics, alphaAnalysis } from './types';
...
export function calculateResult(inputs: alphaInputs): number {
...
export function generateAnalysis(inputs: alphaInputs, metrics: alphaMetrics): alphaAnalysis {
