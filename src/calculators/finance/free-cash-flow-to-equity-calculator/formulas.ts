import { FreeCashFlow-ToEquityCalculatorinputs, FreeCashFlow-ToEquityCalculatormetrics, FreeCashFlow-ToEquityCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FreeCashFlow-ToEquityCalculatorinputs): number {
...
export function generateAnalysis(inputs: FreeCashFlow-ToEquityCalculatorinputs, metrics: FreeCashFlow-ToEquityCalculatormetrics): FreeCashFlow-ToEquityCalculatoranalysis {
