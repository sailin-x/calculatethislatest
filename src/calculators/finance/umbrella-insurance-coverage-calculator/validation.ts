import { UmbrellaInsuranceCoverageCalculatorInputs } from './types';

export function validateUmbrellaInsuranceCoverageCalculatorInputs(inputs: UmbrellaInsuranceCoverageCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateUmbrellaInsuranceCoverageCalculatorBusinessRules(inputs: UmbrellaInsuranceCoverageCalculatorInputs): Array<{ field: string; message: string }> {
