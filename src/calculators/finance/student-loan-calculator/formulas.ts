import { StudentLoanCalculatorinputs, StudentLoanCalculatormetrics, StudentLoanCalculatoranalysis } from './types';
...
export function calculateResult(inputs: StudentLoanCalculatorinputs): number {
...
export function generateAnalysis(inputs: StudentLoanCalculatorinputs, metrics: StudentLoanCalculatormetrics): StudentLoanCalculatoranalysis {
