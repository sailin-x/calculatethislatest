import { student-loan-calculatorInputs, student-loan-calculatorMetrics, student-loan-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: student-loan-calculatorInputs): number {
...
export function generateAnalysis(inputs: student-loan-calculatorInputs, metrics: student-loan-calculatorMetrics): student-loan-calculatorAnalysis {
