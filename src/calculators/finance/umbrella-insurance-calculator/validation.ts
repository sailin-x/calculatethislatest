import { UmbrellaInsuranceCalculatorInputs } from './types';

export function validateUmbrellaInsuranceCalculatorInputs(inputs: UmbrellaInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateUmbrellaInsuranceCalculatorBusinessRules(inputs: UmbrellaInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
