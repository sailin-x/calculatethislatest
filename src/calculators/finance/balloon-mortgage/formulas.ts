import { balloon-mortgageInputs, balloon-mortgageMetrics, balloon-mortgageAnalysis } from './types';
...
export function calculateResult(inputs: balloon-mortgageInputs): number {
...
export function generateAnalysis(inputs: balloon-mortgageInputs, metrics: balloon-mortgageMetrics): balloon-mortgageAnalysis {
