...
import { VentureDebtVsEquityFinancingCalculatorInputs, VentureDebtVsEquityFinancingCalculatorOutputs } from './types';
import {
...
export const VentureDebtVsEquityFinancingCalculator: Calculator = {
  ...
  title: 'Venture Debt vs. Equity Financing Calculator',
  category: 'finance',
  subcategory: 'Financial Planning',
  description: 'Calculate venture debt vs. equity financing.',
  usageInstructions: [
