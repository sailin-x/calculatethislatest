import { convertible-bond-calculatorInputs, convertible-bond-calculatorMetrics, convertible-bond-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: convertible-bond-calculatorInputs): number {
...
export function generateAnalysis(inputs: convertible-bond-calculatorInputs, metrics: convertible-bond-calculatorMetrics): convertible-bond-calculatorAnalysis {
