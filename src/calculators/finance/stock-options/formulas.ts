import { stock-optionsInputs, stock-optionsMetrics, stock-optionsAnalysis } from './types';
...
export function calculateResult(inputs: stock-optionsInputs): number {
...
export function generateAnalysis(inputs: stock-optionsInputs, metrics: stock-optionsMetrics): stock-optionsAnalysis {
