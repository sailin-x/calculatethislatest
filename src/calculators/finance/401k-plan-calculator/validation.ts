import { 401kPlanCalculatorInputs } from './types';

export function validate401kPlanCalculatorInputs(inputs: 401kPlanCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validate401kPlanCalculatorBusinessRules(inputs: 401kPlanCalculatorInputs): Array<{ field: string; message: string }> {
