import { r-squared-calculatorInputs, r-squared-calculatorMetrics, r-squared-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: r-squared-calculatorInputs): number {
...
export function generateAnalysis(inputs: r-squared-calculatorInputs, metrics: r-squared-calculatorMetrics): r-squared-calculatorAnalysis {
