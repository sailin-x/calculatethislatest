import { mortgage-payoffInputs, mortgage-payoffMetrics, mortgage-payoffAnalysis } from './types';
...
export function calculateResult(inputs: mortgage-payoffInputs): number {
...
export function generateAnalysis(inputs: mortgage-payoffInputs, metrics: mortgage-payoffMetrics): mortgage-payoffAnalysis {
