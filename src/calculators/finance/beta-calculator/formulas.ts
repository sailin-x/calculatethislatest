import { beta-calculatorInputs, beta-calculatorMetrics, beta-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: beta-calculatorInputs): number {
...
export function generateAnalysis(inputs: beta-calculatorInputs, metrics: beta-calculatorMetrics): beta-calculatorAnalysis {
