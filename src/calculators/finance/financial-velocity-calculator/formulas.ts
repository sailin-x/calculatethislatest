import { FinancialVelocityCalculatorinputs, FinancialVelocityCalculatormetrics, FinancialVelocityCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialVelocityCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialVelocityCalculatorinputs, metrics: FinancialVelocityCalculatormetrics): FinancialVelocityCalculatoranalysis {
