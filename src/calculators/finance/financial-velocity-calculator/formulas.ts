import { financial-velocity-calculatorInputs, financial-velocity-calculatorMetrics, financial-velocity-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-velocity-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-velocity-calculatorInputs, metrics: financial-velocity-calculatorMetrics): financial-velocity-calculatorAnalysis {
