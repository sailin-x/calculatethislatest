import { FinancialAnalysisCalculatorinputs, FinancialAnalysisCalculatormetrics, FinancialAnalysisCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialAnalysisCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialAnalysisCalculatorinputs, metrics: FinancialAnalysisCalculatormetrics): FinancialAnalysisCalculatoranalysis {
