import { financial-analysis-calculatorInputs, financial-analysis-calculatorMetrics, financial-analysis-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-analysis-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-analysis-calculatorInputs, metrics: financial-analysis-calculatorMetrics): financial-analysis-calculatorAnalysis {
