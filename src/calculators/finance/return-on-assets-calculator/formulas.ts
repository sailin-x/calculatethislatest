import { return-on-assets-calculatorInputs, return-on-assets-calculatorMetrics, return-on-assets-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: return-on-assets-calculatorInputs): number {
...
export function generateAnalysis(inputs: return-on-assets-calculatorInputs, metrics: return-on-assets-calculatorMetrics): return-on-assets-calculatorAnalysis {
