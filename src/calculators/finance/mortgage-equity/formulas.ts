import { mortgage-equityInputs, mortgage-equityMetrics, mortgage-equityAnalysis } from './types';
...
export function calculateResult(inputs: mortgage-equityInputs): number {
...
export function generateAnalysis(inputs: mortgage-equityInputs, metrics: mortgage-equityMetrics): mortgage-equityAnalysis {
