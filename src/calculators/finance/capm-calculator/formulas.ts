import { capm-calculatorInputs, capm-calculatorMetrics, capm-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: capm-calculatorInputs): number {
...
export function generateAnalysis(inputs: capm-calculatorInputs, metrics: capm-calculatorMetrics): capm-calculatorAnalysis {
