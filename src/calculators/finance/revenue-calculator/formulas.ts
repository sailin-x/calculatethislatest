import { revenue-calculatorInputs, revenue-calculatorMetrics, revenue-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: revenue-calculatorInputs): number {
...
export function generateAnalysis(inputs: revenue-calculatorInputs, metrics: revenue-calculatorMetrics): revenue-calculatorAnalysis {
