import { FundLevelIrr-calculatorInputs, FundLevelIrr-calculatorMetrics, FundLevelIrr-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: FundLevelIrr-calculatorInputs): number {
...
export function generateAnalysis(inputs: FundLevelIrr-calculatorInputs, metrics: FundLevelIrr-calculatorMetrics): FundLevelIrr-calculatorAnalysis {
