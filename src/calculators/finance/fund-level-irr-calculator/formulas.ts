import { fund-level-irr-calculatorInputs, fund-level-irr-calculatorMetrics, fund-level-irr-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fund-level-irr-calculatorInputs): number {
...
export function generateAnalysis(inputs: fund-level-irr-calculatorInputs, metrics: fund-level-irr-calculatorMetrics): fund-level-irr-calculatorAnalysis {
