import { escrow-analysisInputs, escrow-analysisMetrics, escrow-analysisAnalysis } from './types';
...
export function calculateResult(inputs: escrow-analysisInputs): number {
...
export function generateAnalysis(inputs: escrow-analysisInputs, metrics: escrow-analysisMetrics): escrow-analysisAnalysis {
