import { AccretiondilutionMaModelInputs } from './types';

export function validateAccretiondilutionMaModelInputs(inputs: AccretiondilutionMaModelInputs): Array<{ field: string; message: string }> {
...
export function validateAccretiondilutionMaModelBusinessRules(inputs: AccretiondilutionMaModelInputs): Array<{ field: string; message: string }> {
