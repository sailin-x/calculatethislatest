import { bond-convexity-calculatorInputs, bond-convexity-calculatorMetrics, bond-convexity-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: bond-convexity-calculatorInputs): number {
...
export function generateAnalysis(inputs: bond-convexity-calculatorInputs, metrics: bond-convexity-calculatorMetrics): bond-convexity-calculatorAnalysis {
