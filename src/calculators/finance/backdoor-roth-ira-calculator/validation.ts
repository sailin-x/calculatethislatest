import { BackdoorRothIraCalculatorInputs } from './types';

export function validateBackdoorRothIraCalculatorInputs(inputs: BackdoorRothIraCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBackdoorRothIraCalculatorBusinessRules(inputs: BackdoorRothIraCalculatorInputs): Array<{ field: string; message: string }> {
