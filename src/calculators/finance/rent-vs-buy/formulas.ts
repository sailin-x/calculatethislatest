import { RentVsBuyinputs, RentVsBuymetrics, RentVsBuyanalysis } from './types';
...
export function calculateResult(inputs: RentVsBuyinputs): number {
...
export function generateAnalysis(inputs: RentVsBuyinputs, metrics: RentVsBuymetrics): RentVsBuyanalysis {
