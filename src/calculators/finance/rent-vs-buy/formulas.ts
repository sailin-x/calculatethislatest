import { rent-vs-buyInputs, rent-vs-buyMetrics, rent-vs-buyAnalysis } from './types';
...
export function calculateResult(inputs: rent-vs-buyInputs): number {
...
export function generateAnalysis(inputs: rent-vs-buyInputs, metrics: rent-vs-buyMetrics): rent-vs-buyAnalysis {
