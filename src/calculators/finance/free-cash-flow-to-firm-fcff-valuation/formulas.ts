import { FreeCashFlow-ToFirmFcff-valuationInputs, FreeCashFlow-ToFirmFcff-valuationMetrics, FreeCashFlow-ToFirmFcff-valuationAnalysis } from './types';
...
export function calculateResult(inputs: FreeCashFlow-ToFirmFcff-valuationInputs): number {
...
export function generateAnalysis(inputs: FreeCashFlow-ToFirmFcff-valuationInputs, metrics: FreeCashFlow-ToFirmFcff-valuationMetrics): FreeCashFlow-ToFirmFcff-valuationAnalysis {
