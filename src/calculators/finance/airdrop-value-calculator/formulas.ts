import { AirdropValueCalculatorinputs, AirdropValueCalculatormetrics, AirdropValueCalculatoranalysis } from './types';
...
export function calculateResult(inputs: AirdropValueCalculatorinputs): number {
...
export function generateAnalysis(inputs: AirdropValueCalculatorinputs, metrics: AirdropValueCalculatormetrics): AirdropValueCalculatoranalysis {
