import { LifeInsuranceNeedsCalculatorInputs } from './types';

export function validateLifeInsuranceNeedsCalculatorInputs(inputs: LifeInsuranceNeedsCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateLifeInsuranceNeedsCalculatorBusinessRules(inputs: LifeInsuranceNeedsCalculatorInputs): Array<{ field: string; message: string }> {
