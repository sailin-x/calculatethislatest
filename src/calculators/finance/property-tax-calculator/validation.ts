import { PropertyTaxCalculatorInputs } from './types';

export function validatePropertyTaxCalculatorInputs(inputs: PropertyTaxCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePropertyTaxCalculatorBusinessRules(inputs: PropertyTaxCalculatorInputs): Array<{ field: string; message: string }> {
