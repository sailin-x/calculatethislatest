export interface PropertyTaxCalculatorInputs {
...
export interface PropertyTaxCalculatorOutputs {
...
export interface PropertyTaxCalculatorMetrics {
...
export interface PropertyTaxCalculatorAnalysis {
