...
import { PropertyTaxCalculatorInputs, PropertyTaxCalculatorOutputs } from './types';
import {
...
import { validatePropertyTaxCalculatorInputs, validatePropertyTaxCalculatorBusinessRules } from './validation';

export const PropertyTaxCalculatorCalculator: Calculator: Calculator = {
  id: 'property-tax-calculator-calculator',
  title: 'Property Tax Calculator Calculator',
