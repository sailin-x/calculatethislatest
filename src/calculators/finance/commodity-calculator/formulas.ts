import { commodity-calculatorInputs, commodity-calculatorMetrics, commodity-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: commodity-calculatorInputs): number {
...
export function generateAnalysis(inputs: commodity-calculatorInputs, metrics: commodity-calculatorMetrics): commodity-calculatorAnalysis {
