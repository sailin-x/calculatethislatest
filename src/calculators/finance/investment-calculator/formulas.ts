import { investment-calculatorInputs, investment-calculatorMetrics, investment-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: investment-calculatorInputs): number {
...
export function generateAnalysis(inputs: investment-calculatorInputs, metrics: investment-calculatorMetrics): investment-calculatorAnalysis {
