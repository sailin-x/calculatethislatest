...
export function validateRealEstateInvestmentCalculatorExistsButNeedsRegistrationCalculatorInputs(inputs: RealEstateInvestmentCalculatorExistsButNeedsRegistrationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateRealEstateInvestmentCalculatorExistsButNeedsRegistrationCalculatorBusinessRules(inputs: RealEstateInvestmentCalculatorExistsButNeedsRegistrationCalculatorInputs): Array<{ field: string; message: string }> {
