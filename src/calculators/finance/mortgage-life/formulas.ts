import { mortgage-lifeInputs, mortgage-lifeMetrics, mortgage-lifeAnalysis } from './types';
...
export function calculateResult(inputs: mortgage-lifeInputs): number {
...
export function generateAnalysis(inputs: mortgage-lifeInputs, metrics: mortgage-lifeMetrics): mortgage-lifeAnalysis {
