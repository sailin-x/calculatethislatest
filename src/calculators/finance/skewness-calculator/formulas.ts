import { skewness-calculatorInputs, skewness-calculatorMetrics, skewness-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: skewness-calculatorInputs): number {
...
export function generateAnalysis(inputs: skewness-calculatorInputs, metrics: skewness-calculatorMetrics): skewness-calculatorAnalysis {
