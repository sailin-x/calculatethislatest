import { life-insurance-calculatorInputs, life-insurance-calculatorMetrics, life-insurance-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: life-insurance-calculatorInputs): number {
...
export function generateAnalysis(inputs: life-insurance-calculatorInputs, metrics: life-insurance-calculatorMetrics): life-insurance-calculatorAnalysis {
