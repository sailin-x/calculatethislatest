import { LifeInsuranceCalculatorinputs, LifeInsuranceCalculatormetrics, LifeInsuranceCalculatoranalysis } from './types';
...
export function calculateResult(inputs: LifeInsuranceCalculatorinputs): number {
...
export function generateAnalysis(inputs: LifeInsuranceCalculatorinputs, metrics: LifeInsuranceCalculatormetrics): LifeInsuranceCalculatoranalysis {
