import { BadFaithInsuranceClaimCalculatorInputs } from './types';

export function validateBadFaithInsuranceClaimCalculatorInputs(inputs: BadFaithInsuranceClaimCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBadFaithInsuranceClaimCalculatorBusinessRules(inputs: BadFaithInsuranceClaimCalculatorInputs): Array<{ field: string; message: string }> {
