export interface BadFaithInsuranceClaimCalculatorInputs {
...
export interface BadFaithInsuranceClaimCalculatorOutputs {
...
export interface BadFaithInsuranceClaimCalculatorMetrics {
...
export interface BadFaithInsuranceClaimCalculatorAnalysis {
