import { MarineInsuranceCalculatorInputs } from './types';

export function validateMarineInsuranceCalculatorInputs(inputs: MarineInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMarineInsuranceCalculatorBusinessRules(inputs: MarineInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
