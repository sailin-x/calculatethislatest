export interface MarineInsuranceCalculatorInputs {
...
export interface MarineInsuranceCalculatorOutputs {
...
export interface MarineInsuranceCalculatorMetrics {
...
export interface MarineInsuranceCalculatorAnalysis {
