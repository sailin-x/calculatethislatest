import { personal-loan-calculatorInputs, personal-loan-calculatorMetrics, personal-loan-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: personal-loan-calculatorInputs): number {
...
export function generateAnalysis(inputs: personal-loan-calculatorInputs, metrics: personal-loan-calculatorMetrics): personal-loan-calculatorAnalysis {
