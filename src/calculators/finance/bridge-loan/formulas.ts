import { bridge-loanInputs, bridge-loanMetrics, bridge-loanAnalysis } from './types';
...
export function calculateResult(inputs: bridge-loanInputs): number {
...
export function generateAnalysis(inputs: bridge-loanInputs, metrics: bridge-loanMetrics): bridge-loanAnalysis {
