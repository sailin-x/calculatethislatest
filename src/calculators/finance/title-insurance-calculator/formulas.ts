import { title-insurance-calculatorInputs, title-insurance-calculatorMetrics, title-insurance-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: title-insurance-calculatorInputs): number {
...
export function generateAnalysis(inputs: title-insurance-calculatorInputs, metrics: title-insurance-calculatorMetrics): title-insurance-calculatorAnalysis {
