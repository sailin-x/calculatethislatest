import { hotel-feasibilityInputs, hotel-feasibilityMetrics, hotel-feasibilityAnalysis } from './types';
...
export function calculateResult(inputs: hotel-feasibilityInputs): number {
...
export function generateAnalysis(inputs: hotel-feasibilityInputs, metrics: hotel-feasibilityMetrics): hotel-feasibilityAnalysis {
