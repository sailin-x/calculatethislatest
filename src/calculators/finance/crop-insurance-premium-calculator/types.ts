export interface CropInsurancePremiumCalculatorInputs {
...
export interface CropInsurancePremiumCalculatorOutputs {
...
export interface CropInsurancePremiumCalculatorMetrics {
...
export interface CropInsurancePremiumCalculatorAnalysis {
