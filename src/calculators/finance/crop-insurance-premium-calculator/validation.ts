import { CropInsurancePremiumCalculatorInputs } from './types';

export function validateCropInsurancePremiumCalculatorInputs(inputs: CropInsurancePremiumCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCropInsurancePremiumCalculatorBusinessRules(inputs: CropInsurancePremiumCalculatorInputs): Array<{ field: string; message: string }> {
