import { TermVsUniversalLifeInsuranceCalculatorInputs } from './types';

export function validateTermVsUniversalLifeInsuranceCalculatorInputs(inputs: TermVsUniversalLifeInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTermVsUniversalLifeInsuranceCalculatorBusinessRules(inputs: TermVsUniversalLifeInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
