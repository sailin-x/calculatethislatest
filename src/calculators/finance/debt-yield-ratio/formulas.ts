import { debt-yield-ratioInputs, debt-yield-ratioMetrics, debt-yield-ratioAnalysis } from './types';
...
export function calculateResult(inputs: debt-yield-ratioInputs): number {
...
export function generateAnalysis(inputs: debt-yield-ratioInputs, metrics: debt-yield-ratioMetrics): debt-yield-ratioAnalysis {
