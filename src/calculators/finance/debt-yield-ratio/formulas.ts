import { DebtYieldRatioinputs, DebtYieldRatiometrics, DebtYieldRatioanalysis } from './types';
...
export function calculateResult(inputs: DebtYieldRatioinputs): number {
...
export function generateAnalysis(inputs: DebtYieldRatioinputs, metrics: DebtYieldRatiometrics): DebtYieldRatioanalysis {
