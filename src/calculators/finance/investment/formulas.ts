import { investmentInputs, investmentMetrics, investmentAnalysis } from './types';
...
export function calculateResult(inputs: investmentInputs): number {
...
export function generateAnalysis(inputs: investmentInputs, metrics: investmentMetrics): investmentAnalysis {
