import { LiabilityInsuranceCalculatorInputs } from './types';

export function validateLiabilityInsuranceCalculatorInputs(inputs: LiabilityInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateLiabilityInsuranceCalculatorBusinessRules(inputs: LiabilityInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
