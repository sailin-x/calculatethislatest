import { PreferencePaymentClawbackCalculatorInputs } from './types';

export function validatePreferencePaymentClawbackCalculatorInputs(inputs: PreferencePaymentClawbackCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePreferencePaymentClawbackCalculatorBusinessRules(inputs: PreferencePaymentClawbackCalculatorInputs): Array<{ field: string; message: string }> {
