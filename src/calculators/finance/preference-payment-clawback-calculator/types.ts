export interface PreferencePaymentClawbackCalculatorInputs {
...
export interface PreferencePaymentClawbackCalculatorOutputs {
...
export interface PreferencePaymentClawbackCalculatorMetrics {
...
export interface PreferencePaymentClawbackCalculatorAnalysis {
