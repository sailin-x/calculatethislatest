export interface CryptoTaxHarvestingCalculatorInputs {
...
export interface CryptoTaxHarvestingCalculatorOutputs {
...
export interface CryptoTaxHarvestingCalculatorMetrics {
...
export interface CryptoTaxHarvestingCalculatorAnalysis {
