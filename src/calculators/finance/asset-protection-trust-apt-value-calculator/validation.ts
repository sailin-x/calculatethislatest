import { AssetProtectionTrustAptValueCalculatorInputs } from './types';

export function validateAssetProtectionTrustAptValueCalculatorInputs(inputs: AssetProtectionTrustAptValueCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAssetProtectionTrustAptValueCalculatorBusinessRules(inputs: AssetProtectionTrustAptValueCalculatorInputs): Array<{ field: string; message: string }> {
