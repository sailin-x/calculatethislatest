import { kurtosis-calculatorInputs, kurtosis-calculatorMetrics, kurtosis-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: kurtosis-calculatorInputs): number {
...
export function generateAnalysis(inputs: kurtosis-calculatorInputs, metrics: kurtosis-calculatorMetrics): kurtosis-calculatorAnalysis {
