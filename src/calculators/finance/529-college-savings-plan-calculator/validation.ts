import { 529CollegeSavingsPlanCalculatorInputs } from './types';

export function validate529CollegeSavingsPlanCalculatorInputs(inputs: 529CollegeSavingsPlanCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validate529CollegeSavingsPlanCalculatorBusinessRules(inputs: 529CollegeSavingsPlanCalculatorInputs): Array<{ field: string; message: string }> {
