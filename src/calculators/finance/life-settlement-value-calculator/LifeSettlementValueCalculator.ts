...
import { LifeSettlementValueCalculatorInputs, LifeSettlementValueCalculatorOutputs } from './types';
import {
...
export const LifeSettlementValueCalculator: Calculator = {
  ...
  description: 'Calculate life settlement value for life insurance policies.',
  usageInstructions: [
