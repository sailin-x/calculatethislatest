...
export function validateDynastyTrustGrowthEstimatorInputs(inputs: DynastyTrustGrowthEstimatorInputs): Array<{ field: string; message: string }> {
...
export function validateDynastyTrustGrowthEstimatorBusinessRules(inputs: DynastyTrustGrowthEstimatorInputs): Array<{ field: string; message: string }> {
