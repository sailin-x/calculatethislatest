import { 401k-company-match-roiInputs, 401k-company-match-roiMetrics, 401k-company-match-roiAnalysis } from './types';
...
export function calculateResult(inputs: 401k-company-match-roiInputs): number {
...
export function generateAnalysis(inputs: 401k-company-match-roiInputs, metrics: 401k-company-match-roiMetrics): 401k-company-match-roiAnalysis {
