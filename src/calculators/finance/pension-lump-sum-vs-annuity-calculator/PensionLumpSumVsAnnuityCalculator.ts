...
import { PensionLumpSumVsAnnuityCalculatorInputs, PensionLumpSumVsAnnuityCalculatorOutputs } from './types';
import {
...
export const PensionLumpSumVsAnnuityCalculator: Calculator = {
  ...
  description: 'Compare pension lump sum vs. annuity payment options.',
  usageInstructions: [
