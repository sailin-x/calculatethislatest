import { RealEstateCrowdfundingCalculatorInputs } from './types';

export function validateRealEstateCrowdfundingCalculatorInputs(inputs: RealEstateCrowdfundingCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateRealEstateCrowdfundingCalculatorBusinessRules(inputs: RealEstateCrowdfundingCalculatorInputs): Array<{ field: string; message: string }> {
