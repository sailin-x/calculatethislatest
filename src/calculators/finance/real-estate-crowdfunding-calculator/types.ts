export interface RealEstateCrowdfundingCalculatorInputs {
...
export interface RealEstateCrowdfundingCalculatorOutputs {
...
export interface RealEstateCrowdfundingCalculatorMetrics {
...
export interface RealEstateCrowdfundingCalculatorAnalysis {
