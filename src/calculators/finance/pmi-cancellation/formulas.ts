import { pmi-cancellationInputs, pmi-cancellationMetrics, pmi-cancellationAnalysis } from './types';
...
export function calculateResult(inputs: pmi-cancellationInputs): number {
...
export function generateAnalysis(inputs: pmi-cancellationInputs, metrics: pmi-cancellationMetrics): pmi-cancellationAnalysis {
