import { taxInputs, taxMetrics, taxAnalysis } from './types';
...
export function calculateResult(inputs: taxInputs): number {
...
export function generateAnalysis(inputs: taxInputs, metrics: taxMetrics): taxAnalysis {
