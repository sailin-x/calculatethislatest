import { alpha-betaInputs, alpha-betaMetrics, alpha-betaAnalysis } from './types';
...
export function calculateResult(inputs: alpha-betaInputs): number {
...
export function generateAnalysis(inputs: alpha-betaInputs, metrics: alpha-betaMetrics): alpha-betaAnalysis {
