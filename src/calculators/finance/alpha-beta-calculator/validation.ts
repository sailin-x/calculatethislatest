import { AlphaBetaCalculatorInputs } from './types';

export function validateAlphaBetaCalculatorInputs(inputs: AlphaBetaCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAlphaBetaCalculatorBusinessRules(inputs: AlphaBetaCalculatorInputs): Array<{ field: string; message: string }> {
