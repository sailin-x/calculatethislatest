export interface AlphaBetaCalculatorInputs {
...
export interface AlphaBetaCalculatorOutputs {
...
export interface AlphaBetaCalculatorMetrics {
...
export interface AlphaBetaCalculatorAnalysis {
