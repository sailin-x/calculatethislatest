import { DisabilityInsuranceCalculatorInputs } from './types';

export function validateDisabilityInsuranceCalculatorInputs(inputs: DisabilityInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDisabilityInsuranceCalculatorBusinessRules(inputs: DisabilityInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
