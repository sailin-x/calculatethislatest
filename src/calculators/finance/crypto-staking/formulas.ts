import { crypto-stakingInputs, crypto-stakingMetrics, crypto-stakingAnalysis } from './types';
...
export function calculateResult(inputs: crypto-stakingInputs): number {
...
export function generateAnalysis(inputs: crypto-stakingInputs, metrics: crypto-stakingMetrics): crypto-stakingAnalysis {
