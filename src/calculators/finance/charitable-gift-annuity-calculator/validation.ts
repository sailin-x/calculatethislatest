import { CharitableGiftAnnuityCalculatorInputs } from './types';

export function validateCharitableGiftAnnuityCalculatorInputs(inputs: CharitableGiftAnnuityCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCharitableGiftAnnuityCalculatorBusinessRules(inputs: CharitableGiftAnnuityCalculatorInputs): Array<{ field: string; message: string }> {
