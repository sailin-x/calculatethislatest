export interface CharitableGiftAnnuityCalculatorInputs {
...
export interface CharitableGiftAnnuityCalculatorOutputs {
...
export interface CharitableGiftAnnuityCalculatorMetrics {
...
export interface CharitableGiftAnnuityCalculatorAnalysis {
