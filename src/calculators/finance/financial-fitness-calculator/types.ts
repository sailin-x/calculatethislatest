export interface FinancialFitnessCalculatorInputs {
  ...
  fitnessComponents: {
    ...
    // Estate Planning Fitness
    estatePlanningFitness: {
      hasWill: boolean;
      hasTrust: boolean;
  ...
  includeFitnessConsiderations: boolean;
  
  // Calculation Options
  calculationOptions: {
    includeFitnessAnalysis: boolean;
...
export interface FinancialFitnessCalculatorResults {
  // Core Financial Fitness Metrics
  financialFitnessScore: number;
  budgetingFitnessScore: number;
  savingFitnessScore: number;
  debtFitnessScore: number;
  investmentFitnessScore: number;
  insuranceFitnessScore: number;
  taxFitnessScore: number;
  retirementFitnessScore: number;
  estatePlanningFitnessScore: number;
  
  // Financial Fitness Analysis
  financialFitnessAnalysis: {
    financialFitnessScore: number;
    budgetingFitnessScore: number;
    savingFitnessScore: number;
    debtFitnessScore: number;
  ...
  // Fitness Optimization Analysis
  fitnessOptimizationAnalysis: {
  ...
  sensitivityAnalysis: {
    ...
    lowValue: number;
    highValue: number;
    lowFitnessScore: number;
    highFitnessScore: number;
    sensitivity: number;
  }[];
  
  // Monte Carlo Results
  monteCarloResults: {
    meanFitnessScore: number;
    medianFitnessScore: number;
  ...
  // Financial Fitness Planning Analysis
  financialFitnessPlanningAnalysis: {
    optimizationOpportunities: {
      category: string;
      opportunity: string;
      potentialImprovement: number;
