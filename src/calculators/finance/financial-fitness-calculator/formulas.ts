import { financial-fitness-calculatorInputs, financial-fitness-calculatorMetrics, financial-fitness-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-fitness-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-fitness-calculatorInputs, metrics: financial-fitness-calculatorMetrics): financial-fitness-calculatorAnalysis {
