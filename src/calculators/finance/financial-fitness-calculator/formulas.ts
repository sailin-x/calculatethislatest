import { FinancialFitnessCalculatorinputs, FinancialFitnessCalculatormetrics, FinancialFitnessCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialFitnessCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialFitnessCalculatorinputs, metrics: FinancialFitnessCalculatormetrics): FinancialFitnessCalculatoranalysis {
