import { angel-investmentInputs, angel-investmentMetrics, angel-investmentAnalysis } from './types';
...
export function calculateResult(inputs: angel-investmentInputs): number {
...
export function generateAnalysis(inputs: angel-investmentInputs, metrics: angel-investmentMetrics): angel-investmentAnalysis {
