...
import { day_tradingCalculatorInputs, day_tradingCalculatorOutputs } from './types';
import {
...
import { validateday_tradingCalculatorInputs, validateday_tradingCalculatorBusinessRules } from './validation';

export const day_tradingCalculatorCalculator: Calculator = {
