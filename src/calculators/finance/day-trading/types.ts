export interface day_tradingCalculatorInputs {
...
export interface day_tradingCalculatorOutputs {
...
export interface day_tradingCalculatorMetrics {
  result: number;
}

export interface day_tradingCalculatorAnalysis {
