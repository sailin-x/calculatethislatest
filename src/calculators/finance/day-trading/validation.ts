import { day_tradingCalculatorInputs } from './types';

export function validateday_tradingCalculatorInputs(inputs: day_tradingCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateday_tradingCalculatorBusinessRules(inputs: day_tradingCalculatorInputs): Array<{ field: string; message: string }> {
