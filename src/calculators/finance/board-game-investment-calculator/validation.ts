import { BoardGameInvestmentCalculatorInputs } from './types';

export function validateBoardGameInvestmentCalculatorInputs(inputs: BoardGameInvestmentCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBoardGameInvestmentCalculatorBusinessRules(inputs: BoardGameInvestmentCalculatorInputs): Array<{ field: string; message: string }> {
