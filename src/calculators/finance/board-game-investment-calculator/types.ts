export interface BoardGameInvestmentCalculatorInputs {
...
export interface BoardGameInvestmentCalculatorOutputs {
...
export interface BoardGameInvestmentCalculatorMetrics {
...
export interface BoardGameInvestmentCalculatorAnalysis {
