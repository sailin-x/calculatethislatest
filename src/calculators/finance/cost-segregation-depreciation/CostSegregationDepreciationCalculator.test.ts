...
describe('Cost Segregation Depreciation Calculator', () => {
  describe('Calculator Structure', () => {
    it('should have correct basic properties', () => {
      expect(CostSegregationDepreciationCalculator.id).toBe('cost-segregation-depreciation-calculator');
  ...
  describe('Validation', () => {
    ...
    it('should reject invalid dates', () => {
      const invalidInputs = { ...validInputs, renovationDate: '2022-12-31' };
      const result = validateCostSegregationInputs(invalidInputs);
      expect(result.isValid).toBe(false);
