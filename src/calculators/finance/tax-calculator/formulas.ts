import { tax-calculatorInputs, tax-calculatorMetrics, tax-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: tax-calculatorInputs): number {
...
export function generateAnalysis(inputs: tax-calculatorInputs, metrics: tax-calculatorMetrics): tax-calculatorAnalysis {
