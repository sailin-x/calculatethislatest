import { 401k-planInputs, 401k-planMetrics, 401k-planAnalysis } from './types';
...
export function calculateResult(inputs: 401k-planInputs): number {
...
export function generateAnalysis(inputs: 401k-planInputs, metrics: 401k-planMetrics): 401k-planAnalysis {
