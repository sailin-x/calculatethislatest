...
export const FourZeroOneKPlanCalculator: Calculator = {
  ...
  inputs: {
    ...
    planFees: {
      name: 'Plan Administrative Fees',
      type: 'number',
      unit: '%',
      description: 'Annual administrative fees charged by the plan',
      placeholder: '0.5',
      min: 0,
      max: 5,
      step: 0.1,
    ...
    investmentFees: {
      name: 'Investment Fund Fees',
      type: 'number',
      unit: '%',
      description: 'Average expense ratio of your investment funds',
      placeholder: '0.8',
      min: 0,
      max: 3,
      step: 0.1,
    ...
    investmentReturn: {
      ...
      type: 'number',
      unit: '%',
      description: 'Expected annual return on 401(k) investments (before fees)',
      placeholder: '7',
      min: 1,
      max: 15,
      step: 0.5,
    ...
    planType: {
      name: 'Plan Type',
      type: 'select',
      description: 'Type of 401(k) plan',
      options: [
        { value: 'traditional', label: 'Traditional 401(k)' },
        { value: 'roth', label: 'Roth 401(k)' },
        { value: 'both', label: 'Both Traditional and Roth' }
      ],
      required: true
    },
    rothPercentage: {
      ...
      type: 'number',
      unit: '%',
      description: 'Percentage of contributions going to Roth 401(k)',
      placeholder: '0',
      min: 0,
      max: 100,
      step: 1,
    ...
    loanBalance: {
      name: '401(k) Loan Balance',
      type: 'number',
      unit: '$',
      description: 'Current outstanding 401(k) loan balance',
      placeholder: '0',
      min: 0,
      max: 1000000,
      step: 1000,
    ...
    investmentAllocation: {
      ...
      type: 'select',
      description: 'Your current investment allocation strategy',
      options: [
    ...
    rebalanceFrequency: {
      ...
      type: 'select',
      description: 'How often you rebalance your portfolio',
      options: [
  ...
  outputs: [
    ...
    },
    {
      ...
      type: 'number',
      unit: '$',
      description: 'Total fees paid over your career'
    },
    {
      id: 'total401kBalance',
    ...
    },
    {
      ...
      type: 'number',
      unit: '/100',
      description: 'Assessment of fee efficiency'
    },
    {
      id: 'projectedValue',
    ...
    {
      id: 'feeImpact',
      name: 'Fee Impact on Balance',
      type: 'number',
      unit: '$',
      description: 'Amount lost to fees over your career'
    },
    {
      id: 'rothBalance',
      ...
      type: 'number',
      unit: '$',
      description: 'Projected Roth 401(k) balance at retirement'
    },
    {
      ...
      type: 'number',
      unit: '$',
      description: 'Projected Traditional 401(k) balance at retirement'
    },
    {
      ...
      type: 'number',
      unit: '$/year',
      description: 'Annual tax-free income from Roth 401(k)'
    },
    {
      ...
      type: 'number',
      unit: '$',
      description: 'Impact of loan repayment on retirement balance'
    },
    {
      id: 'hardshipImpact',
      ...
      type: 'number',
      unit: '$',
      description: 'Impact of hardship withdrawals on retirement balance'
    },
    {
      id: 'rebalanceBenefit',
