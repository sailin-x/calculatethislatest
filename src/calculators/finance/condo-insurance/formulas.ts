import { condo-insuranceInputs, condo-insuranceMetrics, condo-insuranceAnalysis } from './types';
...
export function calculateResult(inputs: condo-insuranceInputs): number {
...
export function generateAnalysis(inputs: condo-insuranceInputs, metrics: condo-insuranceMetrics): condo-insuranceAnalysis {
