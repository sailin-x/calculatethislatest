import { PoliticalRiskInsuranceCalculatorInputs } from './types';

export function validatePoliticalRiskInsuranceCalculatorInputs(inputs: PoliticalRiskInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePoliticalRiskInsuranceCalculatorBusinessRules(inputs: PoliticalRiskInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
