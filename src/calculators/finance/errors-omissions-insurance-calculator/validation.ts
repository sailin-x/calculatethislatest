import { ErrorsOmissionsInsuranceCalculatorInputs } from './types';

export function validateErrorsOmissionsInsuranceCalculatorInputs(inputs: ErrorsOmissionsInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateErrorsOmissionsInsuranceCalculatorBusinessRules(inputs: ErrorsOmissionsInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
