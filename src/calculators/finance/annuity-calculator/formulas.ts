import { annuity-calculatorInputs, annuity-calculatorMetrics, annuity-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: annuity-calculatorInputs): number {
...
export function generateAnalysis(inputs: annuity-calculatorInputs, metrics: annuity-calculatorMetrics): annuity-calculatorAnalysis {
