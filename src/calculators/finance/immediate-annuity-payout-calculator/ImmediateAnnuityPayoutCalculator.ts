...
import { ImmediateAnnuityPayoutCalculatorInputs, ImmediateAnnuityPayoutCalculatorOutputs } from './types';
import {
...
export const ImmediateAnnuityPayoutCalculator: Calculator = {
  ...
  description: 'Calculate immediate annuity payout options and rates.',
  usageInstructions: [
