import { CollegeCostCalculatorInputs } from './types';

export function validateCollegeCostCalculatorInputs(inputs: CollegeCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCollegeCostCalculatorBusinessRules(inputs: CollegeCostCalculatorInputs): Array<{ field: string; message: string }> {
