import { timberland-investmentInputs, timberland-investmentMetrics, timberland-investmentAnalysis } from './types';
...
export function calculateResult(inputs: timberland-investmentInputs): number {
...
export function generateAnalysis(inputs: timberland-investmentInputs, metrics: timberland-investmentMetrics): timberland-investmentAnalysis {
