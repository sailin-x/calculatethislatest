import { financial-growth-calculatorInputs, financial-growth-calculatorMetrics, financial-growth-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-growth-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-growth-calculatorInputs, metrics: financial-growth-calculatorMetrics): financial-growth-calculatorAnalysis {
