import { FinancialGrowthCalculatorinputs, FinancialGrowthCalculatormetrics, FinancialGrowthCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialGrowthCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialGrowthCalculatorinputs, metrics: FinancialGrowthCalculatormetrics): FinancialGrowthCalculatoranalysis {
