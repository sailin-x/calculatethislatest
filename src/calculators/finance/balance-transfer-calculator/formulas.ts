import { balance-transfer-calculatorInputs, balance-transfer-calculatorMetrics, balance-transfer-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: balance-transfer-calculatorInputs): number {
...
export function generateAnalysis(inputs: balance-transfer-calculatorInputs, metrics: balance-transfer-calculatorMetrics): balance-transfer-calculatorAnalysis {
