import { BalanceTransferCalculatorinputs, BalanceTransferCalculatormetrics, BalanceTransferCalculatoranalysis } from './types';
...
export function calculateResult(inputs: BalanceTransferCalculatorinputs): number {
...
export function generateAnalysis(inputs: BalanceTransferCalculatorinputs, metrics: BalanceTransferCalculatormetrics): BalanceTransferCalculatoranalysis {
