import { defined-benefit-planInputs, defined-benefit-planMetrics, defined-benefit-planAnalysis } from './types';
...
export function calculateResult(inputs: defined-benefit-planInputs): number {
...
export function generateAnalysis(inputs: defined-benefit-planInputs, metrics: defined-benefit-planMetrics): defined-benefit-planAnalysis {
