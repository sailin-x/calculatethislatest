import { DefinedBenefitPlaninputs, DefinedBenefitPlanmetrics, DefinedBenefitPlananalysis } from './types';
...
export function calculateResult(inputs: DefinedBenefitPlaninputs): number {
...
export function generateAnalysis(inputs: DefinedBenefitPlaninputs, metrics: DefinedBenefitPlanmetrics): DefinedBenefitPlananalysis {
