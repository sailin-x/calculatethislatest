...
import { distressed_debtCalculatorInputs, distressed_debtCalculatorOutputs } from './types';
import {
...
import { validatedistressed_debtCalculatorInputs, validatedistressed_debtCalculatorBusinessRules } from './validation';

export const distressed_debtCalculatorCalculator: Calculator = {
  id: 'DistressedDebtCalculator',
  title: 'Distressed Debt Calculator',
  category: 'finance',
