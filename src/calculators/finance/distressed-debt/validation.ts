import { distressed_debtCalculatorInputs } from './types';

export function validatedistressed_debtCalculatorInputs(inputs: distressed_debtCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatedistressed_debtCalculatorBusinessRules(inputs: distressed_debtCalculatorInputs): Array<{ field: string; message: string }> {
