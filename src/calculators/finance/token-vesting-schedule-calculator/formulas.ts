import { TokenVestingSchedule-calculatorInputs, TokenVestingSchedule-calculatorMetrics, TokenVestingSchedule-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: TokenVestingSchedule-calculatorInputs): number {
...
export function generateAnalysis(inputs: TokenVestingSchedule-calculatorInputs, metrics: TokenVestingSchedule-calculatorMetrics): TokenVestingSchedule-calculatorAnalysis {
