import { hoa-feeInputs, hoa-feeMetrics, hoa-feeAnalysis } from './types';
...
export function calculateResult(inputs: hoa-feeInputs): number {
...
export function generateAnalysis(inputs: hoa-feeInputs, metrics: hoa-feeMetrics): hoa-feeAnalysis {
