import { capital-gains-calculatorInputs, capital-gains-calculatorMetrics, capital-gains-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: capital-gains-calculatorInputs): number {
...
export function generateAnalysis(inputs: capital-gains-calculatorInputs, metrics: capital-gains-calculatorMetrics): capital-gains-calculatorAnalysis {
