import { financial-optimization-calculatorInputs, financial-optimization-calculatorMetrics, financial-optimization-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial-optimization-calculatorInputs): number {
...
export function generateAnalysis(inputs: financial-optimization-calculatorInputs, metrics: financial-optimization-calculatorMetrics): financial-optimization-calculatorAnalysis {
