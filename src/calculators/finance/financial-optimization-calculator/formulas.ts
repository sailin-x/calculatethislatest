import { FinancialOptimizationCalculatorinputs, FinancialOptimizationCalculatormetrics, FinancialOptimizationCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialOptimizationCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialOptimizationCalculatorinputs, metrics: FinancialOptimizationCalculatormetrics): FinancialOptimizationCalculatoranalysis {
