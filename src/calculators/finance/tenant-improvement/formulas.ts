import { tenant-improvementInputs, tenant-improvementMetrics, tenant-improvementAnalysis } from './types';
...
export function calculateResult(inputs: tenant-improvementInputs): number {
...
export function generateAnalysis(inputs: tenant-improvementInputs, metrics: tenant-improvementMetrics): tenant-improvementAnalysis {
