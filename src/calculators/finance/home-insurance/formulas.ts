import { home-insuranceInputs, home-insuranceMetrics, home-insuranceAnalysis } from './types';
...
export function calculateResult(inputs: home-insuranceInputs): number {
...
export function generateAnalysis(inputs: home-insuranceInputs, metrics: home-insuranceMetrics): home-insuranceAnalysis {
