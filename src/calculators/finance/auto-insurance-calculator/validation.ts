import { AutoInsuranceCalculatorInputs } from './types';

export function validateAutoInsuranceCalculatorInputs(inputs: AutoInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAutoInsuranceCalculatorBusinessRules(inputs: AutoInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
