export interface AngelInvestmentCalculatorInputs {
...
export interface AngelInvestmentCalculatorOutputs {
...
export interface AngelInvestmentCalculatorMetrics {
...
export interface AngelInvestmentCalculatorAnalysis {
