import { AngelInvestmentCalculatorInputs } from './types';

export function validateAngelInvestmentCalculatorInputs(inputs: AngelInvestmentCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAngelInvestmentCalculatorBusinessRules(inputs: AngelInvestmentCalculatorInputs): Array<{ field: string; message: string }> {
