import { 401kCompanyMatchRoiCalculatorInputs } from './types';

export function validate401kCompanyMatchRoiCalculatorInputs(inputs: 401kCompanyMatchRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validate401kCompanyMatchRoiCalculatorBusinessRules(inputs: 401kCompanyMatchRoiCalculatorInputs): Array<{ field: string; message: string }> {
