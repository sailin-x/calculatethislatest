...
import { validatePropertyTaxAppealSavingsCalculatorInputs, validatePropertyTaxAppealSavingsCalculatorBusinessRules } from './validation';

export const PropertyTaxAppealSavingsCalculatorCalculator: Calculator: Calculator = {
  id: 'property-tax-appeal-savings-calculator-calculator',
