export interface PropertyTaxAppealSavingsCalculatorInputs {
...
export interface PropertyTaxAppealSavingsCalculatorOutputs {
...
export interface PropertyTaxAppealSavingsCalculatorMetrics {
...
export interface PropertyTaxAppealSavingsCalculatorAnalysis {
