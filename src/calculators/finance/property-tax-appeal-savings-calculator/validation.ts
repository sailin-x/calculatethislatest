...
export function validatePropertyTaxAppealSavingsCalculatorInputs(inputs: PropertyTaxAppealSavingsCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePropertyTaxAppealSavingsCalculatorBusinessRules(inputs: PropertyTaxAppealSavingsCalculatorInputs): Array<{ field: string; message: string }> {
