...
export function validateLeaseTerm(value: any): { isValid: boolean; message?: string } {
...
export function validateRentEscalation(value: any): { isValid: boolean; message?: string } {
...
export function validateDiscountRate(value: any): { isValid: boolean; message?: string } {
...
export function validateReversionaryValue(value: any): { isValid: boolean; message?: string } {
...
export function validateLeaseType(value: any): { isValid: boolean; message?: string } {
...
export function validateTenantCredit(value: any): { isValid: boolean; message?: string } {
  if (value) {
...
export function validatePaymentFrequency(value: any): { isValid: boolean; message?: string } {
  if (value) {
...
export function validateCollectionLoss(value: any): { isValid: boolean; message?: string } {
...
export function validateLeaseStartDate(value: any): { isValid: boolean; message?: string } {
  if (value) {
