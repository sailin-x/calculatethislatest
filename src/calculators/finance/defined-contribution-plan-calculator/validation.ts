import { DefinedContributionPlanCalculatorInputs } from './types';

export function validateDefinedContributionPlanCalculatorInputs(inputs: DefinedContributionPlanCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDefinedContributionPlanCalculatorBusinessRules(inputs: DefinedContributionPlanCalculatorInputs): Array<{ field: string; message: string }> {
