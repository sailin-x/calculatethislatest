import { AviationInsuranceCalculatorInputs } from './types';

export function validateAviationInsuranceCalculatorInputs(inputs: AviationInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAviationInsuranceCalculatorBusinessRules(inputs: AviationInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
