import { reit-calculatorInputs, reit-calculatorMetrics, reit-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: reit-calculatorInputs): number {
...
export function generateAnalysis(inputs: reit-calculatorInputs, metrics: reit-calculatorMetrics): reit-calculatorAnalysis {
