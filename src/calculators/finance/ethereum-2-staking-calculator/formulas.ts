import { ethereum-2-staking-calculatorInputs, ethereum-2-staking-calculatorMetrics, ethereum-2-staking-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ethereum-2-staking-calculatorInputs): number {
...
export function generateAnalysis(inputs: ethereum-2-staking-calculatorInputs, metrics: ethereum-2-staking-calculatorMetrics): ethereum-2-staking-calculatorAnalysis {
