...
export const Ethereum2StakingCalculator: Calculator = {
  id: 'ethereum-2-staking-calculator',
  title: 'Ethereum 2 Staking Calculator',
  category: 'finance',
  subcategory: 'Financial Planning',
  description: 'Calculate Ethereum staking rewards',
  usageInstructions: [
