import { 401k-rolloverInputs, 401k-rolloverMetrics, 401k-rolloverAnalysis } from './types';
...
export function calculateResult(inputs: 401k-rolloverInputs): number {
...
export function generateAnalysis(inputs: 401k-rolloverInputs, metrics: 401k-rolloverMetrics): 401k-rolloverAnalysis {
