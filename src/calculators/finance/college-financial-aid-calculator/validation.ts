import { CollegeFinancialAidCalculatorInputs } from './types';

export function validateCollegeFinancialAidCalculatorInputs(inputs: CollegeFinancialAidCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCollegeFinancialAidCalculatorBusinessRules(inputs: CollegeFinancialAidCalculatorInputs): Array<{ field: string; message: string }> {
