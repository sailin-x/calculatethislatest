import { rental-yieldInputs, rental-yieldMetrics, rental-yieldAnalysis } from './types';
...
export function calculateResult(inputs: rental-yieldInputs): number {
...
export function generateAnalysis(inputs: rental-yieldInputs, metrics: rental-yieldMetrics): rental-yieldAnalysis {
