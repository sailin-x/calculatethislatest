import { refinance-calculatorInputs, refinance-calculatorMetrics, refinance-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: refinance-calculatorInputs): number {
...
export function generateAnalysis(inputs: refinance-calculatorInputs, metrics: refinance-calculatorMetrics): refinance-calculatorAnalysis {
