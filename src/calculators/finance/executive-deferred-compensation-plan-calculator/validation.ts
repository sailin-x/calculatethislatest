import { ExecutiveDeferredCompensationPlanCalculatorInputs } from './types';

export function validateExecutiveDeferredCompensationPlanCalculatorInputs(inputs: ExecutiveDeferredCompensationPlanCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateExecutiveDeferredCompensationPlanCalculatorBusinessRules(inputs: ExecutiveDeferredCompensationPlanCalculatorInputs): Array<{ field: string; message: string }> {
