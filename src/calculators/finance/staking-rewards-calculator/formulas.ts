import { StakingRewardsCalculatorinputs, StakingRewardsCalculatormetrics, StakingRewardsCalculatoranalysis } from './types';
...
export function calculateResult(inputs: StakingRewardsCalculatorinputs): number {
...
export function generateAnalysis(inputs: StakingRewardsCalculatorinputs, metrics: StakingRewardsCalculatormetrics): StakingRewardsCalculatoranalysis {
