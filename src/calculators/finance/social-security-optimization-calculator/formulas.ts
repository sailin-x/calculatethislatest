import { social-security-optimization-calculatorInputs, social-security-optimization-calculatorMetrics, social-security-optimization-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: social-security-optimization-calculatorInputs): number {
...
export function generateAnalysis(inputs: social-security-optimization-calculatorInputs, metrics: social-security-optimization-calculatorMetrics): social-security-optimization-calculatorAnalysis {
