...
import { SocialSecurityOptimizationCalculatorInputs, SocialSecurityOptimizationCalculatorOutputs } from './types';
import {
...
export const SocialSecurityOptimizationCalculator: Calculator = {
  ...
  description: 'Optimize Social Security benefits claiming strategy.',
  usageInstructions: [
