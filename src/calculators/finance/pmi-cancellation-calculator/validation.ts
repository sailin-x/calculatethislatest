import { PmiCancellationCalculatorInputs } from './types';

export function validatePmiCancellationCalculatorInputs(inputs: PmiCancellationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePmiCancellationCalculatorBusinessRules(inputs: PmiCancellationCalculatorInputs): Array<{ field: string; message: string }> {
