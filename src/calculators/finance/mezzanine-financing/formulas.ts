import { mezzanine-financingInputs, mezzanine-financingMetrics, mezzanine-financingAnalysis } from './types';
...
export function calculateResult(inputs: mezzanine-financingInputs): number {
...
export function generateAnalysis(inputs: mezzanine-financingInputs, metrics: mezzanine-financingMetrics): mezzanine-financingAnalysis {
