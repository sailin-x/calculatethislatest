import { AngelInvestmentDilutionCalculatorInputs } from './types';

export function validateAngelInvestmentDilutionCalculatorInputs(inputs: AngelInvestmentDilutionCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAngelInvestmentDilutionCalculatorBusinessRules(inputs: AngelInvestmentDilutionCalculatorInputs): Array<{ field: string; message: string }> {
