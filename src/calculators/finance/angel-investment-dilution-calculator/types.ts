export interface AngelInvestmentDilutionCalculatorInputs {
...
export interface AngelInvestmentDilutionCalculatorOutputs {
...
export interface AngelInvestmentDilutionCalculatorMetrics {
...
export interface AngelInvestmentDilutionCalculatorAnalysis {
