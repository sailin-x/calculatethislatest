...
import { StructuredSettlementPayoutCalculatorInputs, StructuredSettlementPayoutCalculatorOutputs } from './types';
import {
...
export const StructuredSettlementPayoutCalculator: Calculator = {
  ...
  description: 'Calculate structured settlement payout options and present value.',
  usageInstructions: [
