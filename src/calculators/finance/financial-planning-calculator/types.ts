export interface FinancialPlanningCalculatorInputs {
  ...
  includePlanningConsiderations: boolean;
  
  // Calculation Options
  calculationOptions: {
    includePlanningAnalysis: boolean;
...
export interface FinancialPlanningCalculatorResults {
  // Core Financial Planning Metrics
  financialPlanningScore: number;
  cashFlowPlanningScore: number;
  budgetPlanningScore: number;
  debtPlanningScore: number;
  investmentPlanningScore: number;
  insurancePlanningScore: number;
  taxPlanningScore: number;
  retirementPlanningScore: number;
  ...
  sensitivityAnalysis: {
    ...
    lowValue: number;
    highValue: number;
    lowPlanningScore: number;
    highPlanningScore: number;
    sensitivity: number;
  }[];
  ...
  // Financial Planning Planning Analysis
  financialPlanningPlanningAnalysis: {
    optimizationOpportunities: {
      category: string;
      opportunity: string;
      potentialImprovement: number;
  ...
  financialPlanningScore: {
    overallScore: number;
    componentScores: {
      personal: number;
      financial: number;
      cashFlowPlanning: number;
