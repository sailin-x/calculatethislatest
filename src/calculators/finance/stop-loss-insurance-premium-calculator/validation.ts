import { StoplossInsurancePremiumCalculatorInputs } from './types';

export function validateStoplossInsurancePremiumCalculatorInputs(inputs: StoplossInsurancePremiumCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateStoplossInsurancePremiumCalculatorBusinessRules(inputs: StoplossInsurancePremiumCalculatorInputs): Array<{ field: string; message: string }> {
