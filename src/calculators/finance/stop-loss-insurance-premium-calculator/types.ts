export interface StoplossInsurancePremiumCalculatorInputs {
...
export interface StoplossInsurancePremiumCalculatorOutputs {
...
export interface StoplossInsurancePremiumCalculatorMetrics {
...
export interface StoplossInsurancePremiumCalculatorAnalysis {
