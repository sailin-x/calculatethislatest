import { FinancialEducationCalculatorinputs, FinancialEducationCalculatormetrics, FinancialEducationCalculatoranalysis } from './types';
...
export function calculateResult(inputs: FinancialEducationCalculatorinputs): number {
...
export function generateAnalysis(inputs: FinancialEducationCalculatorinputs, metrics: FinancialEducationCalculatormetrics): FinancialEducationCalculatoranalysis {
