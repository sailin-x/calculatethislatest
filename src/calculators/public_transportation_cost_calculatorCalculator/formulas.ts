import { public_transportation_cost_calculatorCalculatorInputs, public_transportation_cost_calculatorCalculatorMetrics, public_transportation_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: public_transportation_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: public_transportation_cost_calculatorCalculatorInputs, metrics: public_transportation_cost_calculatorCalculatorMetrics): public_transportation_cost_calculatorCalculatorAnalysis {
