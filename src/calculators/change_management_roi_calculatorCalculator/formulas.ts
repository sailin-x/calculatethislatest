import { change_management_roi_calculatorCalculatorInputs, change_management_roi_calculatorCalculatorMetrics, change_management_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: change_management_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: change_management_roi_calculatorCalculatorInputs, metrics: change_management_roi_calculatorCalculatorMetrics): change_management_roi_calculatorCalculatorAnalysis {
