import { reverse_mortgage_calculatorInputs } from './types';

export function validateInputs(inputs: reverse_mortgage_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
