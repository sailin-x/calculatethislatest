import { reverse_mortgage_calculatorInputs, reverse_mortgage_calculatorMetrics, reverse_mortgage_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: reverse_mortgage_calculatorInputs): number {
...
export function generateAnalysis(inputs: reverse_mortgage_calculatorInputs, metrics: reverse_mortgage_calculatorMetrics): reverse_mortgage_calculatorAnalysis {
