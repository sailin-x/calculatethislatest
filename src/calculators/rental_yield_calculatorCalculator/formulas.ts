import { rental_yield_calculatorCalculatorInputs, rental_yield_calculatorCalculatorMetrics, rental_yield_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: rental_yield_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: rental_yield_calculatorCalculatorInputs, metrics: rental_yield_calculatorCalculatorMetrics): rental_yield_calculatorCalculatorAnalysis {
