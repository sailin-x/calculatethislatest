import { rental_yield_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: rental_yield_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
