import { podcast_sponsorship_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: podcast_sponsorship_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
