import { podcast_sponsorship_calculatorCalculatorInputs, podcast_sponsorship_calculatorCalculatorMetrics, podcast_sponsorship_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: podcast_sponsorship_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: podcast_sponsorship_calculatorCalculatorInputs, metrics: podcast_sponsorship_calculatorCalculatorMetrics): podcast_sponsorship_calculatorCalculatorAnalysis {
