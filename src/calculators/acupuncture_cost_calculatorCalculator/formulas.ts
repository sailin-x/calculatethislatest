import { acupuncture_cost_calculatorCalculatorInputs, acupuncture_cost_calculatorCalculatorMetrics, acupuncture_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: acupuncture_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: acupuncture_cost_calculatorCalculatorInputs, metrics: acupuncture_cost_calculatorCalculatorMetrics): acupuncture_cost_calculatorCalculatorAnalysis {
