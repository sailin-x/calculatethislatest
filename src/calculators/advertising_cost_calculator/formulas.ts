import { advertising_cost_calculatorInputs, advertising_cost_calculatorMetrics, advertising_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: advertising_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: advertising_cost_calculatorInputs, metrics: advertising_cost_calculatorMetrics): advertising_cost_calculatorAnalysis {
