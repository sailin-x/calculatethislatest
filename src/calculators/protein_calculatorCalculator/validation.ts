import { protein_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: protein_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
