import { protein_calculatorCalculatorInputs, protein_calculatorCalculatorMetrics, protein_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: protein_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: protein_calculatorCalculatorInputs, metrics: protein_calculatorCalculatorMetrics): protein_calculatorCalculatorAnalysis {
