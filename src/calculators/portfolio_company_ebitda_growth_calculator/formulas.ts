import { portfolio_company_ebitda_growth_calculatorInputs, portfolio_company_ebitda_growth_calculatorMetrics, portfolio_company_ebitda_growth_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: portfolio_company_ebitda_growth_calculatorInputs): number {
...
export function generateAnalysis(inputs: portfolio_company_ebitda_growth_calculatorInputs, metrics: portfolio_company_ebitda_growth_calculatorMetrics): portfolio_company_ebitda_growth_calculatorAnalysis {
