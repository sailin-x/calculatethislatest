import { cohort_analysis_calculatorInputs } from './types';

export function validateInputs(inputs: cohort_analysis_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
