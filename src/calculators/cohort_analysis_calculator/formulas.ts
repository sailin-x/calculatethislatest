import { cohort_analysis_calculatorInputs, cohort_analysis_calculatorMetrics, cohort_analysis_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cohort_analysis_calculatorInputs): number {
...
export function generateAnalysis(inputs: cohort_analysis_calculatorInputs, metrics: cohort_analysis_calculatorMetrics): cohort_analysis_calculatorAnalysis {
