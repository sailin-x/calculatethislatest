import { blog_cost_calculatorInputs, blog_cost_calculatorMetrics, blog_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: blog_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: blog_cost_calculatorInputs, metrics: blog_cost_calculatorMetrics): blog_cost_calculatorAnalysis {
