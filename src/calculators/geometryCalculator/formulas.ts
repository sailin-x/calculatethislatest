import { geometryCalculatorInputs, geometryCalculatorMetrics, geometryCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: geometryCalculatorInputs): number {
...
export function generateAnalysis(inputs: geometryCalculatorInputs, metrics: geometryCalculatorMetrics): geometryCalculatorAnalysis {
