import { amino_acid_calculatorInputs, amino_acid_calculatorMetrics, amino_acid_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: amino_acid_calculatorInputs): number {
...
export function generateAnalysis(inputs: amino_acid_calculatorInputs, metrics: amino_acid_calculatorMetrics): amino_acid_calculatorAnalysis {
