import { registerAnnuityBuyoutCalculatorInputs, registerAnnuityBuyoutCalculatorMetrics, registerAnnuityBuyoutCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerAnnuityBuyoutCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerAnnuityBuyoutCalculatorInputs, metrics: registerAnnuityBuyoutCalculatorMetrics): registerAnnuityBuyoutCalculatorAnalysis {
