import { registerAnnuityBuyoutCalculatorInputs } from './types';

export function validateInputs(inputs: registerAnnuityBuyoutCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
