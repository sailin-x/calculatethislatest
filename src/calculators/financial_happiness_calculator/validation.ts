import { financial_happiness_calculatorInputs } from './types';

export function validateInputs(inputs: financial_happiness_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
