import { crypto_mining_profitability_calculatorInputs, crypto_mining_profitability_calculatorMetrics, crypto_mining_profitability_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: crypto_mining_profitability_calculatorInputs): number {
...
export function generateAnalysis(inputs: crypto_mining_profitability_calculatorInputs, metrics: crypto_mining_profitability_calculatorMetrics): crypto_mining_profitability_calculatorAnalysis {
