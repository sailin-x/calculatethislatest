import { mesothelioma_settlement_calculatorInputs, mesothelioma_settlement_calculatorMetrics, mesothelioma_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: mesothelioma_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: mesothelioma_settlement_calculatorInputs, metrics: mesothelioma_settlement_calculatorMetrics): mesothelioma_settlement_calculatorAnalysis {
