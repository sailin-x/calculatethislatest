import { pedestrian_accident_settlement_calculatorInputs, pedestrian_accident_settlement_calculatorMetrics, pedestrian_accident_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: pedestrian_accident_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: pedestrian_accident_settlement_calculatorInputs, metrics: pedestrian_accident_settlement_calculatorMetrics): pedestrian_accident_settlement_calculatorAnalysis {
