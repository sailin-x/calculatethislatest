import { meal_prep_calculatorInputs, meal_prep_calculatorMetrics, meal_prep_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: meal_prep_calculatorInputs): number {
...
export function generateAnalysis(inputs: meal_prep_calculatorInputs, metrics: meal_prep_calculatorMetrics): meal_prep_calculatorAnalysis {
