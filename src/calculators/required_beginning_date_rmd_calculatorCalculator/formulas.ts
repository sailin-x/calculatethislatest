import { required_beginning_date_rmd_calculatorCalculatorInputs, required_beginning_date_rmd_calculatorCalculatorMetrics, required_beginning_date_rmd_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: required_beginning_date_rmd_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: required_beginning_date_rmd_calculatorCalculatorInputs, metrics: required_beginning_date_rmd_calculatorCalculatorMetrics): required_beginning_date_rmd_calculatorCalculatorAnalysis {
