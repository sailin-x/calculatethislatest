import { registerImmediateAnnuityPayoutCalculatorInputs, registerImmediateAnnuityPayoutCalculatorMetrics, registerImmediateAnnuityPayoutCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerImmediateAnnuityPayoutCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerImmediateAnnuityPayoutCalculatorInputs, metrics: registerImmediateAnnuityPayoutCalculatorMetrics): registerImmediateAnnuityPayoutCalculatorAnalysis {
