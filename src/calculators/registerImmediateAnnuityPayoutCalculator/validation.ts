import { registerImmediateAnnuityPayoutCalculatorInputs } from './types';

export function validateInputs(inputs: registerImmediateAnnuityPayoutCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
