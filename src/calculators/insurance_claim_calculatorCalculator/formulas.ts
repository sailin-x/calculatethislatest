import { insurance_claim_calculatorCalculatorInputs, insurance_claim_calculatorCalculatorMetrics, insurance_claim_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: insurance_claim_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: insurance_claim_calculatorCalculatorInputs, metrics: insurance_claim_calculatorCalculatorMetrics): insurance_claim_calculatorCalculatorAnalysis {
