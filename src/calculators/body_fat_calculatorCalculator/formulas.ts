import { body_fat_calculatorCalculatorInputs, body_fat_calculatorCalculatorMetrics, body_fat_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: body_fat_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: body_fat_calculatorCalculatorInputs, metrics: body_fat_calculatorCalculatorMetrics): body_fat_calculatorCalculatorAnalysis {
