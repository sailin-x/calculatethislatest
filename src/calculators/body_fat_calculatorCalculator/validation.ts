import { body_fat_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: body_fat_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
