import { salary_benchmarking_calculatorInputs } from './types';

export function validateInputs(inputs: salary_benchmarking_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
