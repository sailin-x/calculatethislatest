import { salary_benchmarking_calculatorInputs, salary_benchmarking_calculatorMetrics, salary_benchmarking_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: salary_benchmarking_calculatorInputs): number {
...
export function generateAnalysis(inputs: salary_benchmarking_calculatorInputs, metrics: salary_benchmarking_calculatorMetrics): salary_benchmarking_calculatorAnalysis {
