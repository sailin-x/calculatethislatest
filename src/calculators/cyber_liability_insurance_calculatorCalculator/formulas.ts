import { cyber_liability_insurance_calculatorCalculatorInputs, cyber_liability_insurance_calculatorCalculatorMetrics, cyber_liability_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cyber_liability_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cyber_liability_insurance_calculatorCalculatorInputs, metrics: cyber_liability_insurance_calculatorCalculatorMetrics): cyber_liability_insurance_calculatorCalculatorAnalysis {
