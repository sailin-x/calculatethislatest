import { camping_cost_calculatorInputs, camping_cost_calculatorMetrics, camping_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: camping_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: camping_cost_calculatorInputs, metrics: camping_cost_calculatorMetrics): camping_cost_calculatorAnalysis {
