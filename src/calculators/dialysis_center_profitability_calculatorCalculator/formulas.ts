import { dialysis_center_profitability_calculatorCalculatorInputs, dialysis_center_profitability_calculatorCalculatorMetrics, dialysis_center_profitability_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: dialysis_center_profitability_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: dialysis_center_profitability_calculatorCalculatorInputs, metrics: dialysis_center_profitability_calculatorCalculatorMetrics): dialysis_center_profitability_calculatorCalculatorAnalysis {
