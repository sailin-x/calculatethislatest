import { sep_ira_calculatorInputs, sep_ira_calculatorMetrics, sep_ira_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: sep_ira_calculatorInputs): number {
...
export function generateAnalysis(inputs: sep_ira_calculatorInputs, metrics: sep_ira_calculatorMetrics): sep_ira_calculatorAnalysis {
