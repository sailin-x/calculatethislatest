import { data_governance_roi_calculatorCalculatorInputs, data_governance_roi_calculatorCalculatorMetrics, data_governance_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: data_governance_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: data_governance_roi_calculatorCalculatorInputs, metrics: data_governance_roi_calculatorCalculatorMetrics): data_governance_roi_calculatorCalculatorAnalysis {
