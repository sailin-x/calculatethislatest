import { ira_calculatorInputs, ira_calculatorMetrics, ira_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ira_calculatorInputs): number {
...
export function generateAnalysis(inputs: ira_calculatorInputs, metrics: ira_calculatorMetrics): ira_calculatorAnalysis {
