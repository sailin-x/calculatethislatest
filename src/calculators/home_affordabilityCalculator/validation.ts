import { home_affordabilityCalculatorInputs } from './types';

export function validateInputs(inputs: home_affordabilityCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
