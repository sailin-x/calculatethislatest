import { home_affordabilityCalculatorInputs, home_affordabilityCalculatorMetrics, home_affordabilityCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: home_affordabilityCalculatorInputs): number {
...
export function generateAnalysis(inputs: home_affordabilityCalculatorInputs, metrics: home_affordabilityCalculatorMetrics): home_affordabilityCalculatorAnalysis {
