import { creatine_calculatorCalculatorInputs, creatine_calculatorCalculatorMetrics, creatine_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: creatine_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: creatine_calculatorCalculatorInputs, metrics: creatine_calculatorCalculatorMetrics): creatine_calculatorCalculatorAnalysis {
