import { creatine_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: creatine_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
