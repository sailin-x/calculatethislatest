import { computer_science_calculatorInputs, computer_science_calculatorMetrics, computer_science_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: computer_science_calculatorInputs): number {
...
export function generateAnalysis(inputs: computer_science_calculatorInputs, metrics: computer_science_calculatorMetrics): computer_science_calculatorAnalysis {
