import { computer_science_calculatorInputs } from './types';

export function validateInputs(inputs: computer_science_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
