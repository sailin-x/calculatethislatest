import { roundup_settlement_calculatorCalculatorInputs, roundup_settlement_calculatorCalculatorMetrics, roundup_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: roundup_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: roundup_settlement_calculatorCalculatorInputs, metrics: roundup_settlement_calculatorCalculatorMetrics): roundup_settlement_calculatorCalculatorAnalysis {
