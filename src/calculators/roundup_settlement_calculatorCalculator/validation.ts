import { roundup_settlement_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: roundup_settlement_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
