import { instagram_influencer_rate_calculatorCalculatorInputs, instagram_influencer_rate_calculatorCalculatorMetrics, instagram_influencer_rate_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: instagram_influencer_rate_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: instagram_influencer_rate_calculatorCalculatorInputs, metrics: instagram_influencer_rate_calculatorCalculatorMetrics): instagram_influencer_rate_calculatorCalculatorAnalysis {
