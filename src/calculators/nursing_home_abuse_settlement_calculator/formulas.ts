import { nursing_home_abuse_settlement_calculatorInputs, nursing_home_abuse_settlement_calculatorMetrics, nursing_home_abuse_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: nursing_home_abuse_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: nursing_home_abuse_settlement_calculatorInputs, metrics: nursing_home_abuse_settlement_calculatorMetrics): nursing_home_abuse_settlement_calculatorAnalysis {
