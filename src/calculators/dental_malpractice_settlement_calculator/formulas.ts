import { dental_malpractice_settlement_calculatorInputs, dental_malpractice_settlement_calculatorMetrics, dental_malpractice_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: dental_malpractice_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: dental_malpractice_settlement_calculatorInputs, metrics: dental_malpractice_settlement_calculatorMetrics): dental_malpractice_settlement_calculatorAnalysis {
