import { tiktok_creator_fund_calculatorCalculatorInputs, tiktok_creator_fund_calculatorCalculatorMetrics, tiktok_creator_fund_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: tiktok_creator_fund_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: tiktok_creator_fund_calculatorCalculatorInputs, metrics: tiktok_creator_fund_calculatorCalculatorMetrics): tiktok_creator_fund_calculatorCalculatorAnalysis {
