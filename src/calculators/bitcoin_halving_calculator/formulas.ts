import { bitcoin_halving_calculatorInputs, bitcoin_halving_calculatorMetrics, bitcoin_halving_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: bitcoin_halving_calculatorInputs): number {
...
export function generateAnalysis(inputs: bitcoin_halving_calculatorInputs, metrics: bitcoin_halving_calculatorMetrics): bitcoin_halving_calculatorAnalysis {
