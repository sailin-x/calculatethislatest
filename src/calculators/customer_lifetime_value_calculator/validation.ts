import { customer_lifetime_value_calculatorInputs } from './types';

export function validateInputs(inputs: customer_lifetime_value_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
