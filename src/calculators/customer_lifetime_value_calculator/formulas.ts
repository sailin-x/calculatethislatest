import { customer_lifetime_value_calculatorInputs, customer_lifetime_value_calculatorMetrics, customer_lifetime_value_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: customer_lifetime_value_calculatorInputs): number {
...
export function generateAnalysis(inputs: customer_lifetime_value_calculatorInputs, metrics: customer_lifetime_value_calculatorMetrics): customer_lifetime_value_calculatorAnalysis {
