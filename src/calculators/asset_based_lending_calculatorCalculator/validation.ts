import { asset_based_lending_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: asset_based_lending_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
