import { asset_based_lending_calculatorCalculatorInputs, asset_based_lending_calculatorCalculatorMetrics, asset_based_lending_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: asset_based_lending_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: asset_based_lending_calculatorCalculatorInputs, metrics: asset_based_lending_calculatorCalculatorMetrics): asset_based_lending_calculatorCalculatorAnalysis {
