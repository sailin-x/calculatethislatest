import { aviation_insurance_calculatorInputs, aviation_insurance_calculatorMetrics, aviation_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: aviation_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: aviation_insurance_calculatorInputs, metrics: aviation_insurance_calculatorMetrics): aviation_insurance_calculatorAnalysis {
