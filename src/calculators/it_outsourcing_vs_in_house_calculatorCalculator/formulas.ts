import { it_outsourcing_vs_in_house_calculatorCalculatorInputs, it_outsourcing_vs_in_house_calculatorCalculatorMetrics, it_outsourcing_vs_in_house_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: it_outsourcing_vs_in_house_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: it_outsourcing_vs_in_house_calculatorCalculatorInputs, metrics: it_outsourcing_vs_in_house_calculatorCalculatorMetrics): it_outsourcing_vs_in_house_calculatorCalculatorAnalysis {
