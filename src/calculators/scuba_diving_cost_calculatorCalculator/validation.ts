import { scuba_diving_cost_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: scuba_diving_cost_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
