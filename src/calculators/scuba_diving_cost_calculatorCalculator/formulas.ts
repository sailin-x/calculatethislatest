import { scuba_diving_cost_calculatorCalculatorInputs, scuba_diving_cost_calculatorCalculatorMetrics, scuba_diving_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: scuba_diving_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: scuba_diving_cost_calculatorCalculatorInputs, metrics: scuba_diving_cost_calculatorCalculatorMetrics): scuba_diving_cost_calculatorCalculatorAnalysis {
