import { price_to_book_calculatorCalculatorInputs, price_to_book_calculatorCalculatorMetrics, price_to_book_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: price_to_book_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: price_to_book_calculatorCalculatorInputs, metrics: price_to_book_calculatorCalculatorMetrics): price_to_book_calculatorCalculatorAnalysis {
