import { price_to_book_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: price_to_book_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
