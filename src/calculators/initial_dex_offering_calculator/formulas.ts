import { initial_dex_offering_calculatorInputs, initial_dex_offering_calculatorMetrics, initial_dex_offering_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: initial_dex_offering_calculatorInputs): number {
...
export function generateAnalysis(inputs: initial_dex_offering_calculatorInputs, metrics: initial_dex_offering_calculatorMetrics): initial_dex_offering_calculatorAnalysis {
