import { student_loanCalculatorInputs, student_loanCalculatorMetrics, student_loanCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: student_loanCalculatorInputs): number {
...
export function generateAnalysis(inputs: student_loanCalculatorInputs, metrics: student_loanCalculatorMetrics): student_loanCalculatorAnalysis {
