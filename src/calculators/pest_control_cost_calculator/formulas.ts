import { pest_control_cost_calculatorInputs, pest_control_cost_calculatorMetrics, pest_control_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: pest_control_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: pest_control_cost_calculatorInputs, metrics: pest_control_cost_calculatorMetrics): pest_control_cost_calculatorAnalysis {
