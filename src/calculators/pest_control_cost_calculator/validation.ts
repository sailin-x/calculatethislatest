import { pest_control_cost_calculatorInputs } from './types';

export function validateInputs(inputs: pest_control_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
