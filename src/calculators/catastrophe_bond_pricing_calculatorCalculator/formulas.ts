import { catastrophe_bond_pricing_calculatorCalculatorInputs, catastrophe_bond_pricing_calculatorCalculatorMetrics, catastrophe_bond_pricing_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: catastrophe_bond_pricing_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: catastrophe_bond_pricing_calculatorCalculatorInputs, metrics: catastrophe_bond_pricing_calculatorCalculatorMetrics): catastrophe_bond_pricing_calculatorCalculatorAnalysis {
