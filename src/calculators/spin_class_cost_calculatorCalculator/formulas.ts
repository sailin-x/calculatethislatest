import { spin_class_cost_calculatorCalculatorInputs, spin_class_cost_calculatorCalculatorMetrics, spin_class_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: spin_class_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: spin_class_cost_calculatorCalculatorInputs, metrics: spin_class_cost_calculatorCalculatorMetrics): spin_class_cost_calculatorCalculatorAnalysis {
