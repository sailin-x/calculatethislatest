import { political_risk_insurance_calculatorCalculatorInputs, political_risk_insurance_calculatorCalculatorMetrics, political_risk_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: political_risk_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: political_risk_insurance_calculatorCalculatorInputs, metrics: political_risk_insurance_calculatorCalculatorMetrics): political_risk_insurance_calculatorCalculatorAnalysis {
