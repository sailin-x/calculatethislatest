import { private_equity_returns_calculatorCalculatorInputs, private_equity_returns_calculatorCalculatorMetrics, private_equity_returns_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: private_equity_returns_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: private_equity_returns_calculatorCalculatorInputs, metrics: private_equity_returns_calculatorCalculatorMetrics): private_equity_returns_calculatorCalculatorAnalysis {
