import { private_equity_returns_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: private_equity_returns_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
