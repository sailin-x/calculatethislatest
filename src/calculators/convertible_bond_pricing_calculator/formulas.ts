import { convertible_bond_pricing_calculatorInputs, convertible_bond_pricing_calculatorMetrics, convertible_bond_pricing_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: convertible_bond_pricing_calculatorInputs): number {
...
export function generateAnalysis(inputs: convertible_bond_pricing_calculatorInputs, metrics: convertible_bond_pricing_calculatorMetrics): convertible_bond_pricing_calculatorAnalysis {
