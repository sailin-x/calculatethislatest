import { title_insurance_calculatorCalculatorInputs, title_insurance_calculatorCalculatorMetrics, title_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: title_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: title_insurance_calculatorCalculatorInputs, metrics: title_insurance_calculatorCalculatorMetrics): title_insurance_calculatorCalculatorAnalysis {
