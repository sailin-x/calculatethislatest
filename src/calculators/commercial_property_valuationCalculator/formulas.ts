import { commercial_property_valuationCalculatorInputs, commercial_property_valuationCalculatorMetrics, commercial_property_valuationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: commercial_property_valuationCalculatorInputs): number {
...
export function generateAnalysis(inputs: commercial_property_valuationCalculatorInputs, metrics: commercial_property_valuationCalculatorMetrics): commercial_property_valuationCalculatorAnalysis {
