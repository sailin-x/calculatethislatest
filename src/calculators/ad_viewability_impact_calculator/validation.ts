import { ad_viewability_impact_calculatorInputs } from './types';

export function validateInputs(inputs: ad_viewability_impact_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
