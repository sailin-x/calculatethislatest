import { ad_viewability_impact_calculatorInputs, ad_viewability_impact_calculatorMetrics, ad_viewability_impact_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ad_viewability_impact_calculatorInputs): number {
...
export function generateAnalysis(inputs: ad_viewability_impact_calculatorInputs, metrics: ad_viewability_impact_calculatorMetrics): ad_viewability_impact_calculatorAnalysis {
