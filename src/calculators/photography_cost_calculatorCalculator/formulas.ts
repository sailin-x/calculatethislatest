import { photography_cost_calculatorCalculatorInputs, photography_cost_calculatorCalculatorMetrics, photography_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: photography_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: photography_cost_calculatorCalculatorInputs, metrics: photography_cost_calculatorCalculatorMetrics): photography_cost_calculatorCalculatorAnalysis {
