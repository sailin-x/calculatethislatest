import { life_settlement_value_calculatorInputs } from './types';

export function validateInputs(inputs: life_settlement_value_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
