import { life_settlement_value_calculatorInputs, life_settlement_value_calculatorMetrics, life_settlement_value_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: life_settlement_value_calculatorInputs): number {
...
export function generateAnalysis(inputs: life_settlement_value_calculatorInputs, metrics: life_settlement_value_calculatorMetrics): life_settlement_value_calculatorAnalysis {
