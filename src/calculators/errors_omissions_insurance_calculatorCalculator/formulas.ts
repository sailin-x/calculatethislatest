import { errors_omissions_insurance_calculatorCalculatorInputs, errors_omissions_insurance_calculatorCalculatorMetrics, errors_omissions_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: errors_omissions_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: errors_omissions_insurance_calculatorCalculatorInputs, metrics: errors_omissions_insurance_calculatorCalculatorMetrics): errors_omissions_insurance_calculatorCalculatorAnalysis {
