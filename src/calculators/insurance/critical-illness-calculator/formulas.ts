import { CriticalIllnessCalculatorinputs, CriticalIllnessCalculatormetrics, CriticalIllnessCalculatoranalysis } from './types';
...
export function calculateResult(inputs: CriticalIllnessCalculatorinputs): number {
...
export function generateAnalysis(inputs: CriticalIllnessCalculatorinputs, metrics: CriticalIllnessCalculatormetrics): CriticalIllnessCalculatoranalysis {
