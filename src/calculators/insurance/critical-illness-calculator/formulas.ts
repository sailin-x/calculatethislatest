import { critical-illness-calculatorInputs, critical-illness-calculatorMetrics, critical-illness-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: critical-illness-calculatorInputs): number {
...
export function generateAnalysis(inputs: critical-illness-calculatorInputs, metrics: critical-illness-calculatorMetrics): critical-illness-calculatorAnalysis {
