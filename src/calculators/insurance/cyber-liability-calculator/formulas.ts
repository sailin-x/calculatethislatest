import { CyberLiabilityCalculatorinputs, CyberLiabilityCalculatormetrics, CyberLiabilityCalculatoranalysis } from './types';
...
export function calculateResult(inputs: CyberLiabilityCalculatorinputs): number {
...
export function generateAnalysis(inputs: CyberLiabilityCalculatorinputs, metrics: CyberLiabilityCalculatormetrics): CyberLiabilityCalculatoranalysis {
