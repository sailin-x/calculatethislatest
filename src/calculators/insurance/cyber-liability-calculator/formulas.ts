import { cyber-liability-calculatorInputs, cyber-liability-calculatorMetrics, cyber-liability-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cyber-liability-calculatorInputs): number {
...
export function generateAnalysis(inputs: cyber-liability-calculatorInputs, metrics: cyber-liability-calculatorMetrics): cyber-liability-calculatorAnalysis {
