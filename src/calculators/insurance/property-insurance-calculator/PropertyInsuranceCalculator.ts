...
import { PropertyInsuranceCalculatorInputs, PropertyInsuranceCalculatorOutputs } from './types';
...
export const PropertyInsuranceCalculator: Calculator = {
  id: 'property-insurance-calculator',
