import { PoliticalRiskCalculatorinputs, PoliticalRiskCalculatormetrics, PoliticalRiskCalculatoranalysis } from './types';
...
export function calculateResult(inputs: PoliticalRiskCalculatorinputs): number {
...
export function generateAnalysis(inputs: PoliticalRiskCalculatorinputs, metrics: PoliticalRiskCalculatormetrics): PoliticalRiskCalculatoranalysis {
