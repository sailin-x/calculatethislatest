import { political-risk-calculatorInputs, political-risk-calculatorMetrics, political-risk-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: political-risk-calculatorInputs): number {
...
export function generateAnalysis(inputs: political-risk-calculatorInputs, metrics: political-risk-calculatorMetrics): political-risk-calculatorAnalysis {
