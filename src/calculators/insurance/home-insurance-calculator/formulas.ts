import { HomeInsuranceCalculatorinputs, HomeInsuranceCalculatormetrics, HomeInsuranceCalculatoranalysis } from './types';
...
export function calculateResult(inputs: HomeInsuranceCalculatorinputs): number {
...
export function generateAnalysis(inputs: HomeInsuranceCalculatorinputs, metrics: HomeInsuranceCalculatormetrics): HomeInsuranceCalculatoranalysis {
