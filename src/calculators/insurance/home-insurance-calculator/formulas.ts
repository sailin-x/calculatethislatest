import { home-insurance-calculatorInputs, home-insurance-calculatorMetrics, home-insurance-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: home-insurance-calculatorInputs): number {
...
export function generateAnalysis(inputs: home-insurance-calculatorInputs, metrics: home-insurance-calculatorMetrics): home-insurance-calculatorAnalysis {
