import { KeyPersonCalculatorinputs, KeyPersonCalculatormetrics, KeyPersonCalculatoranalysis } from './types';
...
export function calculateResult(inputs: KeyPersonCalculatorinputs): number {
...
export function generateAnalysis(inputs: KeyPersonCalculatorinputs, metrics: KeyPersonCalculatormetrics): KeyPersonCalculatoranalysis {
