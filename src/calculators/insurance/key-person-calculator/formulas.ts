import { key-person-calculatorInputs, key-person-calculatorMetrics, key-person-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: key-person-calculatorInputs): number {
...
export function generateAnalysis(inputs: key-person-calculatorInputs, metrics: key-person-calculatorMetrics): key-person-calculatorAnalysis {
