import { pressure_washing_cost_calculatorInputs } from './types';

export function validateInputs(inputs: pressure_washing_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
