import { pressure_washing_cost_calculatorInputs, pressure_washing_cost_calculatorMetrics, pressure_washing_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: pressure_washing_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: pressure_washing_cost_calculatorInputs, metrics: pressure_washing_cost_calculatorMetrics): pressure_washing_cost_calculatorAnalysis {
