import { profit_margin_calculatorInputs, profit_margin_calculatorMetrics, profit_margin_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: profit_margin_calculatorInputs): number {
...
export function generateAnalysis(inputs: profit_margin_calculatorInputs, metrics: profit_margin_calculatorMetrics): profit_margin_calculatorAnalysis {
