import { construction_accident_calculatorInputs } from './types';

export function validateInputs(inputs: construction_accident_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
