import { construction_accident_calculatorInputs, construction_accident_calculatorMetrics, construction_accident_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: construction_accident_calculatorInputs): number {
...
export function generateAnalysis(inputs: construction_accident_calculatorInputs, metrics: construction_accident_calculatorMetrics): construction_accident_calculatorAnalysis {
