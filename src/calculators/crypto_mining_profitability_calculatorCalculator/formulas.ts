import { crypto_mining_profitability_calculatorCalculatorInputs, crypto_mining_profitability_calculatorCalculatorMetrics, crypto_mining_profitability_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: crypto_mining_profitability_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: crypto_mining_profitability_calculatorCalculatorInputs, metrics: crypto_mining_profitability_calculatorCalculatorMetrics): crypto_mining_profitability_calculatorCalculatorAnalysis {
