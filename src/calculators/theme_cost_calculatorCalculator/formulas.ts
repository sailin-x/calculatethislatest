import { theme_cost_calculatorCalculatorInputs, theme_cost_calculatorCalculatorMetrics, theme_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: theme_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: theme_cost_calculatorCalculatorInputs, metrics: theme_cost_calculatorCalculatorMetrics): theme_cost_calculatorCalculatorAnalysis {
