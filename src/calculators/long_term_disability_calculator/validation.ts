import { long_term_disability_calculatorInputs } from './types';

export function validateInputs(inputs: long_term_disability_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
