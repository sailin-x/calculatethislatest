import { long_term_disability_calculatorInputs, long_term_disability_calculatorMetrics, long_term_disability_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: long_term_disability_calculatorInputs): number {
...
export function generateAnalysis(inputs: long_term_disability_calculatorInputs, metrics: long_term_disability_calculatorMetrics): long_term_disability_calculatorAnalysis {
