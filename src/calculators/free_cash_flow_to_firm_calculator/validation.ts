import { free_cash_flow_to_firm_calculatorInputs } from './types';

export function validateInputs(inputs: free_cash_flow_to_firm_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
