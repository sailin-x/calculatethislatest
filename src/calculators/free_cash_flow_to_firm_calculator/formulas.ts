import { free_cash_flow_to_firm_calculatorInputs, free_cash_flow_to_firm_calculatorMetrics, free_cash_flow_to_firm_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: free_cash_flow_to_firm_calculatorInputs): number {
...
export function generateAnalysis(inputs: free_cash_flow_to_firm_calculatorInputs, metrics: free_cash_flow_to_firm_calculatorMetrics): free_cash_flow_to_firm_calculatorAnalysis {
