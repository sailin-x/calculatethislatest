import { financial_education_calculatorCalculatorInputs, financial_education_calculatorCalculatorMetrics, financial_education_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_education_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_education_calculatorCalculatorInputs, metrics: financial_education_calculatorCalculatorMetrics): financial_education_calculatorCalculatorAnalysis {
