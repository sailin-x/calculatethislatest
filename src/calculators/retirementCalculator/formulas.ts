import { retirementCalculatorInputs, retirementCalculatorMetrics, retirementCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: retirementCalculatorInputs): number {
...
export function generateAnalysis(inputs: retirementCalculatorInputs, metrics: retirementCalculatorMetrics): retirementCalculatorAnalysis {
