import { tennis_lesson_cost_calculatorCalculatorInputs, tennis_lesson_cost_calculatorCalculatorMetrics, tennis_lesson_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: tennis_lesson_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: tennis_lesson_cost_calculatorCalculatorInputs, metrics: tennis_lesson_cost_calculatorCalculatorMetrics): tennis_lesson_cost_calculatorCalculatorAnalysis {
