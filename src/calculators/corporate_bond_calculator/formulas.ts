import { corporate_bond_calculatorInputs, corporate_bond_calculatorMetrics, corporate_bond_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: corporate_bond_calculatorInputs): number {
...
export function generateAnalysis(inputs: corporate_bond_calculatorInputs, metrics: corporate_bond_calculatorMetrics): corporate_bond_calculatorAnalysis {
