import { registerCostOfDebtCalculatorInputs, registerCostOfDebtCalculatorMetrics, registerCostOfDebtCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerCostOfDebtCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerCostOfDebtCalculatorInputs, metrics: registerCostOfDebtCalculatorMetrics): registerCostOfDebtCalculatorAnalysis {
