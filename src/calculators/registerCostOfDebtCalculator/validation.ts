import { registerCostOfDebtCalculatorInputs } from './types';

export function validateInputs(inputs: registerCostOfDebtCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
