import { medical_expense_tax_deduction_calculatorInputs } from './types';

export function validateInputs(inputs: medical_expense_tax_deduction_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
