import { medical_expense_tax_deduction_calculatorInputs, medical_expense_tax_deduction_calculatorMetrics, medical_expense_tax_deduction_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: medical_expense_tax_deduction_calculatorInputs): number {
...
export function generateAnalysis(inputs: medical_expense_tax_deduction_calculatorInputs, metrics: medical_expense_tax_deduction_calculatorMetrics): medical_expense_tax_deduction_calculatorAnalysis {
