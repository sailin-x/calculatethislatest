import { roaming_cost_calculatorInputs, roaming_cost_calculatorMetrics, roaming_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: roaming_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: roaming_cost_calculatorInputs, metrics: roaming_cost_calculatorMetrics): roaming_cost_calculatorAnalysis {
