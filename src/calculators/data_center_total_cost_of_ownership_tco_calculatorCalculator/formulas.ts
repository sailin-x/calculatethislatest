import { data_center_total_cost_of_ownership_tco_calculatorCalculatorInputs, data_center_total_cost_of_ownership_tco_calculatorCalculatorMetrics, data_center_total_cost_of_ownership_tco_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: data_center_total_cost_of_ownership_tco_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: data_center_total_cost_of_ownership_tco_calculatorCalculatorInputs, metrics: data_center_total_cost_of_ownership_tco_calculatorCalculatorMetrics): data_center_total_cost_of_ownership_tco_calculatorCalculatorAnalysis {
