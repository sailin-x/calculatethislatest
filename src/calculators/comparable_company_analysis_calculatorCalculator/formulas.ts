import { comparable_company_analysis_calculatorCalculatorInputs, comparable_company_analysis_calculatorCalculatorMetrics, comparable_company_analysis_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: comparable_company_analysis_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: comparable_company_analysis_calculatorCalculatorInputs, metrics: comparable_company_analysis_calculatorCalculatorMetrics): comparable_company_analysis_calculatorCalculatorAnalysis {
