import { project_management_cost_calculatorInputs, project_management_cost_calculatorMetrics, project_management_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: project_management_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: project_management_cost_calculatorInputs, metrics: project_management_cost_calculatorMetrics): project_management_cost_calculatorAnalysis {
