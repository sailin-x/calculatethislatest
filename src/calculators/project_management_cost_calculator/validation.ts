import { project_management_cost_calculatorInputs } from './types';

export function validateInputs(inputs: project_management_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
