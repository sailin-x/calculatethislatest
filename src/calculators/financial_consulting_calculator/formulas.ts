import { financial_consulting_calculatorInputs, financial_consulting_calculatorMetrics, financial_consulting_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_consulting_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_consulting_calculatorInputs, metrics: financial_consulting_calculatorMetrics): financial_consulting_calculatorAnalysis {
