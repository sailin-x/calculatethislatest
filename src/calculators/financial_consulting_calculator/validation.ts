import { financial_consulting_calculatorInputs } from './types';

export function validateInputs(inputs: financial_consulting_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
