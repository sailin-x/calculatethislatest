import { r_squared_calculatorCalculatorInputs, r_squared_calculatorCalculatorMetrics, r_squared_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: r_squared_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: r_squared_calculatorCalculatorInputs, metrics: r_squared_calculatorCalculatorMetrics): r_squared_calculatorCalculatorAnalysis {
