import { r_squared_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: r_squared_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
