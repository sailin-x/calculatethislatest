import { financial_success_calculatorCalculatorInputs, financial_success_calculatorCalculatorMetrics, financial_success_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_success_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_success_calculatorCalculatorInputs, metrics: financial_success_calculatorCalculatorMetrics): financial_success_calculatorCalculatorAnalysis {
