import { convertible_bond_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: convertible_bond_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
