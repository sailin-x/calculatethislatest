import { convertible_bond_calculatorCalculatorInputs, convertible_bond_calculatorCalculatorMetrics, convertible_bond_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: convertible_bond_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: convertible_bond_calculatorCalculatorInputs, metrics: convertible_bond_calculatorCalculatorMetrics): convertible_bond_calculatorCalculatorAnalysis {
