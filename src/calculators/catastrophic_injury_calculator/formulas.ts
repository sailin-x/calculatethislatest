import { catastrophic_injury_calculatorInputs, catastrophic_injury_calculatorMetrics, catastrophic_injury_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: catastrophic_injury_calculatorInputs): number {
...
export function generateAnalysis(inputs: catastrophic_injury_calculatorInputs, metrics: catastrophic_injury_calculatorMetrics): catastrophic_injury_calculatorAnalysis {
