import { annuity_calculatorCalculatorInputs, annuity_calculatorCalculatorMetrics, annuity_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: annuity_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: annuity_calculatorCalculatorInputs, metrics: annuity_calculatorCalculatorMetrics): annuity_calculatorCalculatorAnalysis {
