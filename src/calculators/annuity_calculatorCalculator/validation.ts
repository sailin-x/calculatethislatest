import { annuity_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: annuity_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
