import { public_private_partnership_roi_calculatorInputs, public_private_partnership_roi_calculatorMetrics, public_private_partnership_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: public_private_partnership_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: public_private_partnership_roi_calculatorInputs, metrics: public_private_partnership_roi_calculatorMetrics): public_private_partnership_roi_calculatorAnalysis {
