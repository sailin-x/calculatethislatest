import { public_private_partnership_roi_calculatorInputs } from './types';

export function validateInputs(inputs: public_private_partnership_roi_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
