import { inheritance_tax_estimatorCalculatorInputs } from './types';

export function validateInputs(inputs: inheritance_tax_estimatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
