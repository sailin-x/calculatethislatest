import { inheritance_tax_estimatorCalculatorInputs, inheritance_tax_estimatorCalculatorMetrics, inheritance_tax_estimatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: inheritance_tax_estimatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: inheritance_tax_estimatorCalculatorInputs, metrics: inheritance_tax_estimatorCalculatorMetrics): inheritance_tax_estimatorCalculatorAnalysis {
