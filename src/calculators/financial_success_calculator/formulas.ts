import { financial_success_calculatorInputs, financial_success_calculatorMetrics, financial_success_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_success_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_success_calculatorInputs, metrics: financial_success_calculatorMetrics): financial_success_calculatorAnalysis {
