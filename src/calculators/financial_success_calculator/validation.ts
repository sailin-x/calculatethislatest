import { financial_success_calculatorInputs } from './types';

export function validateInputs(inputs: financial_success_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
