import { industry_benchmarking_calculatorInputs, industry_benchmarking_calculatorMetrics, industry_benchmarking_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: industry_benchmarking_calculatorInputs): number {
...
export function generateAnalysis(inputs: industry_benchmarking_calculatorInputs, metrics: industry_benchmarking_calculatorMetrics): industry_benchmarking_calculatorAnalysis {
