import { industry_benchmarking_calculatorInputs } from './types';

export function validateInputs(inputs: industry_benchmarking_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
