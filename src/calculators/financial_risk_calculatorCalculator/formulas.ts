import { financial_risk_calculatorCalculatorInputs, financial_risk_calculatorCalculatorMetrics, financial_risk_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_risk_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_risk_calculatorCalculatorInputs, metrics: financial_risk_calculatorCalculatorMetrics): financial_risk_calculatorCalculatorAnalysis {
