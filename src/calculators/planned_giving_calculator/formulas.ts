import { planned_giving_calculatorInputs, planned_giving_calculatorMetrics, planned_giving_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: planned_giving_calculatorInputs): number {
...
export function generateAnalysis(inputs: planned_giving_calculatorInputs, metrics: planned_giving_calculatorMetrics): planned_giving_calculatorAnalysis {
