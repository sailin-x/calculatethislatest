import { bond_yield_calculatorCalculatorInputs, bond_yield_calculatorCalculatorMetrics, bond_yield_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: bond_yield_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: bond_yield_calculatorCalculatorInputs, metrics: bond_yield_calculatorCalculatorMetrics): bond_yield_calculatorCalculatorAnalysis {
