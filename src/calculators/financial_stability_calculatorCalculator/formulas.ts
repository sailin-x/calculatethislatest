import { financial_stability_calculatorCalculatorInputs, financial_stability_calculatorCalculatorMetrics, financial_stability_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_stability_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_stability_calculatorCalculatorInputs, metrics: financial_stability_calculatorCalculatorMetrics): financial_stability_calculatorCalculatorAnalysis {
