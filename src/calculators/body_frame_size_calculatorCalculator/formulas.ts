import { body_frame_size_calculatorCalculatorInputs, body_frame_size_calculatorCalculatorMetrics, body_frame_size_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: body_frame_size_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: body_frame_size_calculatorCalculatorInputs, metrics: body_frame_size_calculatorCalculatorMetrics): body_frame_size_calculatorCalculatorAnalysis {
