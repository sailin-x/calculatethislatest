import { body_frame_size_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: body_frame_size_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
