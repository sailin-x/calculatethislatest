import { guideline_premium_test_gpt_calculatorCalculatorInputs, guideline_premium_test_gpt_calculatorCalculatorMetrics, guideline_premium_test_gpt_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: guideline_premium_test_gpt_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: guideline_premium_test_gpt_calculatorCalculatorInputs, metrics: guideline_premium_test_gpt_calculatorCalculatorMetrics): guideline_premium_test_gpt_calculatorCalculatorAnalysis {
