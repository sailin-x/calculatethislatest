import { body_recomposition_calculatorCalculatorInputs, body_recomposition_calculatorCalculatorMetrics, body_recomposition_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: body_recomposition_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: body_recomposition_calculatorCalculatorInputs, metrics: body_recomposition_calculatorCalculatorMetrics): body_recomposition_calculatorCalculatorAnalysis {
