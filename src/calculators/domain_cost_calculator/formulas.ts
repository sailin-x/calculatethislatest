import { domain_cost_calculatorInputs, domain_cost_calculatorMetrics, domain_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: domain_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: domain_cost_calculatorInputs, metrics: domain_cost_calculatorMetrics): domain_cost_calculatorAnalysis {
