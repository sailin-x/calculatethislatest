import { clinical_trial_cost_estimatorCalculatorInputs, clinical_trial_cost_estimatorCalculatorMetrics, clinical_trial_cost_estimatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: clinical_trial_cost_estimatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: clinical_trial_cost_estimatorCalculatorInputs, metrics: clinical_trial_cost_estimatorCalculatorMetrics): clinical_trial_cost_estimatorCalculatorAnalysis {
