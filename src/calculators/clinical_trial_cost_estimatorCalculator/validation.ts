import { clinical_trial_cost_estimatorCalculatorInputs } from './types';

export function validateInputs(inputs: clinical_trial_cost_estimatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
