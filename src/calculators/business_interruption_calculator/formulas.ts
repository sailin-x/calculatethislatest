import { business_interruption_calculatorInputs, business_interruption_calculatorMetrics, business_interruption_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_interruption_calculatorInputs): number {
...
export function generateAnalysis(inputs: business_interruption_calculatorInputs, metrics: business_interruption_calculatorMetrics): business_interruption_calculatorAnalysis {
