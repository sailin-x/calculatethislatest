import { cooking_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: cooking_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
