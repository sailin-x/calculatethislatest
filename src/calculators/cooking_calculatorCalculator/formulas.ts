import { cooking_calculatorCalculatorInputs, cooking_calculatorCalculatorMetrics, cooking_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cooking_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cooking_calculatorCalculatorInputs, metrics: cooking_calculatorCalculatorMetrics): cooking_calculatorCalculatorAnalysis {
