import { defective_drug_settlement_calculatorInputs, defective_drug_settlement_calculatorMetrics, defective_drug_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: defective_drug_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: defective_drug_settlement_calculatorInputs, metrics: defective_drug_settlement_calculatorMetrics): defective_drug_settlement_calculatorAnalysis {
