import { onlyfans_earnings_calculatorInputs, onlyfans_earnings_calculatorMetrics, onlyfans_earnings_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: onlyfans_earnings_calculatorInputs): number {
...
export function generateAnalysis(inputs: onlyfans_earnings_calculatorInputs, metrics: onlyfans_earnings_calculatorMetrics): onlyfans_earnings_calculatorAnalysis {
