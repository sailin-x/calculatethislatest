import { kurtosis_calculatorInputs, kurtosis_calculatorMetrics, kurtosis_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: kurtosis_calculatorInputs): number {
...
export function generateAnalysis(inputs: kurtosis_calculatorInputs, metrics: kurtosis_calculatorMetrics): kurtosis_calculatorAnalysis {
