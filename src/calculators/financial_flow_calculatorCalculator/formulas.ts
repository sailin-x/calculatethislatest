import { financial_flow_calculatorCalculatorInputs, financial_flow_calculatorCalculatorMetrics, financial_flow_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_flow_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_flow_calculatorCalculatorInputs, metrics: financial_flow_calculatorCalculatorMetrics): financial_flow_calculatorCalculatorAnalysis {
