import { equity_valuation_calculatorInputs, equity_valuation_calculatorMetrics, equity_valuation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: equity_valuation_calculatorInputs): number {
...
export function generateAnalysis(inputs: equity_valuation_calculatorInputs, metrics: equity_valuation_calculatorMetrics): equity_valuation_calculatorAnalysis {
