import { fitness_age_calculatorCalculatorInputs, fitness_age_calculatorCalculatorMetrics, fitness_age_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fitness_age_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: fitness_age_calculatorCalculatorInputs, metrics: fitness_age_calculatorCalculatorMetrics): fitness_age_calculatorCalculatorAnalysis {
