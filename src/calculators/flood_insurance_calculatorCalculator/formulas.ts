import { flood_insurance_calculatorCalculatorInputs, flood_insurance_calculatorCalculatorMetrics, flood_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: flood_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: flood_insurance_calculatorCalculatorInputs, metrics: flood_insurance_calculatorCalculatorMetrics): flood_insurance_calculatorCalculatorAnalysis {
