import { alkalinity_calculatorInputs, alkalinity_calculatorMetrics, alkalinity_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: alkalinity_calculatorInputs): number {
...
export function generateAnalysis(inputs: alkalinity_calculatorInputs, metrics: alkalinity_calculatorMetrics): alkalinity_calculatorAnalysis {
