import { irrevocable_life_insurance_trust_ilit_value_calculatorInputs, irrevocable_life_insurance_trust_ilit_value_calculatorMetrics, irrevocable_life_insurance_trust_ilit_value_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: irrevocable_life_insurance_trust_ilit_value_calculatorInputs): number {
...
export function generateAnalysis(inputs: irrevocable_life_insurance_trust_ilit_value_calculatorInputs, metrics: irrevocable_life_insurance_trust_ilit_value_calculatorMetrics): irrevocable_life_insurance_trust_ilit_value_calculatorAnalysis {
