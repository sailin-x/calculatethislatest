import { antitrust_hhi_index_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: antitrust_hhi_index_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
