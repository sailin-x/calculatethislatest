import { antitrust_hhi_index_calculatorCalculatorInputs, antitrust_hhi_index_calculatorCalculatorMetrics, antitrust_hhi_index_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: antitrust_hhi_index_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: antitrust_hhi_index_calculatorCalculatorInputs, metrics: antitrust_hhi_index_calculatorCalculatorMetrics): antitrust_hhi_index_calculatorCalculatorAnalysis {
