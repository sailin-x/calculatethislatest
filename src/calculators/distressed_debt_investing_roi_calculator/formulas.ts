import { distressed_debt_investing_roi_calculatorInputs, distressed_debt_investing_roi_calculatorMetrics, distressed_debt_investing_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: distressed_debt_investing_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: distressed_debt_investing_roi_calculatorInputs, metrics: distressed_debt_investing_roi_calculatorMetrics): distressed_debt_investing_roi_calculatorAnalysis {
