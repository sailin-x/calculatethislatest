import { distressed_debt_calculatorCalculatorInputs, distressed_debt_calculatorCalculatorMetrics, distressed_debt_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: distressed_debt_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: distressed_debt_calculatorCalculatorInputs, metrics: distressed_debt_calculatorCalculatorMetrics): distressed_debt_calculatorCalculatorAnalysis {
