import { distressed_debt_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: distressed_debt_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
