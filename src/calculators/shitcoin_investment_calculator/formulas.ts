import { shitcoin_investment_calculatorInputs, shitcoin_investment_calculatorMetrics, shitcoin_investment_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: shitcoin_investment_calculatorInputs): number {
...
export function generateAnalysis(inputs: shitcoin_investment_calculatorInputs, metrics: shitcoin_investment_calculatorMetrics): shitcoin_investment_calculatorAnalysis {
