import { ammonia_calculatorInputs, ammonia_calculatorMetrics, ammonia_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ammonia_calculatorInputs): number {
...
export function generateAnalysis(inputs: ammonia_calculatorInputs, metrics: ammonia_calculatorMetrics): ammonia_calculatorAnalysis {
