import { pilates_studio_cost_calculatorCalculatorInputs, pilates_studio_cost_calculatorCalculatorMetrics, pilates_studio_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: pilates_studio_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: pilates_studio_cost_calculatorCalculatorInputs, metrics: pilates_studio_cost_calculatorCalculatorMetrics): pilates_studio_cost_calculatorCalculatorAnalysis {
