import { home_equity_loanCalculatorInputs, home_equity_loanCalculatorMetrics, home_equity_loanCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: home_equity_loanCalculatorInputs): number {
...
export function generateAnalysis(inputs: home_equity_loanCalculatorInputs, metrics: home_equity_loanCalculatorMetrics): home_equity_loanCalculatorAnalysis {
