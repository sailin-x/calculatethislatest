import { home_equity_loanCalculatorInputs } from './types';

export function validateInputs(inputs: home_equity_loanCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
