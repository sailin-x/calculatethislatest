import { disability_insurance_needs_calculatorInputs, disability_insurance_needs_calculatorMetrics, disability_insurance_needs_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: disability_insurance_needs_calculatorInputs): number {
...
export function generateAnalysis(inputs: disability_insurance_needs_calculatorInputs, metrics: disability_insurance_needs_calculatorMetrics): disability_insurance_needs_calculatorAnalysis {
