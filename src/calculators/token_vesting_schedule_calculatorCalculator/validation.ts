import { token_vesting_schedule_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: token_vesting_schedule_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
