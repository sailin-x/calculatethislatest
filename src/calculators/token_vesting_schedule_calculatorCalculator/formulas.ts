import { token_vesting_schedule_calculatorCalculatorInputs, token_vesting_schedule_calculatorCalculatorMetrics, token_vesting_schedule_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: token_vesting_schedule_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: token_vesting_schedule_calculatorCalculatorInputs, metrics: token_vesting_schedule_calculatorCalculatorMetrics): token_vesting_schedule_calculatorCalculatorAnalysis {
