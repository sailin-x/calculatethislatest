import { photography_cost_calculatorInputs } from './types';

export function validateInputs(inputs: photography_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
