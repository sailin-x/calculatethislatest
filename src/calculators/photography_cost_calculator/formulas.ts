import { photography_cost_calculatorInputs, photography_cost_calculatorMetrics, photography_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: photography_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: photography_cost_calculatorInputs, metrics: photography_cost_calculatorMetrics): photography_cost_calculatorAnalysis {
