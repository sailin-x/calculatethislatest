import { financial_synergy_calculatorInputs, financial_synergy_calculatorMetrics, financial_synergy_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_synergy_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_synergy_calculatorInputs, metrics: financial_synergy_calculatorMetrics): financial_synergy_calculatorAnalysis {
