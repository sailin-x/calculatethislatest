import { financial_synergy_calculatorInputs } from './types';

export function validateInputs(inputs: financial_synergy_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
