import { nft_minting_cost_calculatorCalculatorInputs, nft_minting_cost_calculatorCalculatorMetrics, nft_minting_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: nft_minting_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: nft_minting_cost_calculatorCalculatorInputs, metrics: nft_minting_cost_calculatorCalculatorMetrics): nft_minting_cost_calculatorCalculatorAnalysis {
