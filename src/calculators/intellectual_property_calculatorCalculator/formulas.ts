import { intellectual_property_calculatorCalculatorInputs, intellectual_property_calculatorCalculatorMetrics, intellectual_property_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: intellectual_property_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: intellectual_property_calculatorCalculatorInputs, metrics: intellectual_property_calculatorCalculatorMetrics): intellectual_property_calculatorCalculatorAnalysis {
