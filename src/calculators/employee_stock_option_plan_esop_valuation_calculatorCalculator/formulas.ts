import { employee_stock_option_plan_esop_valuation_calculatorCalculatorInputs, employee_stock_option_plan_esop_valuation_calculatorCalculatorMetrics, employee_stock_option_plan_esop_valuation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: employee_stock_option_plan_esop_valuation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: employee_stock_option_plan_esop_valuation_calculatorCalculatorInputs, metrics: employee_stock_option_plan_esop_valuation_calculatorCalculatorMetrics): employee_stock_option_plan_esop_valuation_calculatorCalculatorAnalysis {
