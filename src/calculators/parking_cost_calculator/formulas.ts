import { parking_cost_calculatorInputs, parking_cost_calculatorMetrics, parking_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: parking_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: parking_cost_calculatorInputs, metrics: parking_cost_calculatorMetrics): parking_cost_calculatorAnalysis {
