import { business_interruption_calculatorCalculatorInputs, business_interruption_calculatorCalculatorMetrics, business_interruption_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_interruption_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: business_interruption_calculatorCalculatorInputs, metrics: business_interruption_calculatorCalculatorMetrics): business_interruption_calculatorCalculatorAnalysis {
