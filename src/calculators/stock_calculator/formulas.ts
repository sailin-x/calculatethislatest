import { stock_calculatorInputs, stock_calculatorMetrics, stock_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: stock_calculatorInputs): number {
...
export function generateAnalysis(inputs: stock_calculatorInputs, metrics: stock_calculatorMetrics): stock_calculatorAnalysis {
