import { garden_yield_calculatorInputs, garden_yield_calculatorMetrics, garden_yield_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: garden_yield_calculatorInputs): number {
...
export function generateAnalysis(inputs: garden_yield_calculatorInputs, metrics: garden_yield_calculatorMetrics): garden_yield_calculatorAnalysis {
