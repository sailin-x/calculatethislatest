import { addiction_rehab_cost_financing_calculatorInputs, addiction_rehab_cost_financing_calculatorMetrics, addiction_rehab_cost_financing_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: addiction_rehab_cost_financing_calculatorInputs): number {
...
export function generateAnalysis(inputs: addiction_rehab_cost_financing_calculatorInputs, metrics: addiction_rehab_cost_financing_calculatorMetrics): addiction_rehab_cost_financing_calculatorAnalysis {
