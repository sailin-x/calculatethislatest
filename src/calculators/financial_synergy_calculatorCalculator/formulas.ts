import { financial_synergy_calculatorCalculatorInputs, financial_synergy_calculatorCalculatorMetrics, financial_synergy_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_synergy_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_synergy_calculatorCalculatorInputs, metrics: financial_synergy_calculatorCalculatorMetrics): financial_synergy_calculatorCalculatorAnalysis {
