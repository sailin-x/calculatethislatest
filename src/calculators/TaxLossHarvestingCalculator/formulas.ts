...
export function generateAnalysis(inputs: TaxLossHarvestingCalculatorInputs, metrics: TaxLossHarvestingCalculatorMetrics): TaxLossHarvestingCalculatorAnalysis {
