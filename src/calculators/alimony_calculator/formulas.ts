import { alimony_calculatorInputs, alimony_calculatorMetrics, alimony_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: alimony_calculatorInputs): number {
...
export function generateAnalysis(inputs: alimony_calculatorInputs, metrics: alimony_calculatorMetrics): alimony_calculatorAnalysis {
