import { complex_number_calculatorInputs, complex_number_calculatorMetrics, complex_number_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: complex_number_calculatorInputs): number {
...
export function generateAnalysis(inputs: complex_number_calculatorInputs, metrics: complex_number_calculatorMetrics): complex_number_calculatorAnalysis {
