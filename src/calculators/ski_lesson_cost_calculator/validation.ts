import { ski_lesson_cost_calculatorInputs } from './types';

export function validateInputs(inputs: ski_lesson_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
