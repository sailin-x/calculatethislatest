import { ski_lesson_cost_calculatorInputs, ski_lesson_cost_calculatorMetrics, ski_lesson_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ski_lesson_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: ski_lesson_cost_calculatorInputs, metrics: ski_lesson_cost_calculatorMetrics): ski_lesson_cost_calculatorAnalysis {
