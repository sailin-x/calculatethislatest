import { property_tax_appeal_savings_calculatorCalculatorInputs, property_tax_appeal_savings_calculatorCalculatorMetrics, property_tax_appeal_savings_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: property_tax_appeal_savings_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: property_tax_appeal_savings_calculatorCalculatorInputs, metrics: property_tax_appeal_savings_calculatorCalculatorMetrics): property_tax_appeal_savings_calculatorCalculatorAnalysis {
