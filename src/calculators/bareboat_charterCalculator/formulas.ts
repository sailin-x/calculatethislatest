import { bareboat_charterCalculatorInputs, bareboat_charterCalculatorMetrics, bareboat_charterCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: bareboat_charterCalculatorInputs): number {
...
export function generateAnalysis(inputs: bareboat_charterCalculatorInputs, metrics: bareboat_charterCalculatorMetrics): bareboat_charterCalculatorAnalysis {
