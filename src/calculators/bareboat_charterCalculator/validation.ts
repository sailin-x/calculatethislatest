import { bareboat_charterCalculatorInputs } from './types';

export function validateInputs(inputs: bareboat_charterCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
