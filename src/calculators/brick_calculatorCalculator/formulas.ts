import { brick_calculatorCalculatorInputs, brick_calculatorCalculatorMetrics, brick_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: brick_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: brick_calculatorCalculatorInputs, metrics: brick_calculatorCalculatorMetrics): brick_calculatorCalculatorAnalysis {
