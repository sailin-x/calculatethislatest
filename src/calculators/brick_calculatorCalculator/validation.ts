import { brick_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: brick_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
