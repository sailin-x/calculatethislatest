import { heavy_equipment_depreciation_calculatorInputs, heavy_equipment_depreciation_calculatorMetrics, heavy_equipment_depreciation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: heavy_equipment_depreciation_calculatorInputs): number {
...
export function generateAnalysis(inputs: heavy_equipment_depreciation_calculatorInputs, metrics: heavy_equipment_depreciation_calculatorMetrics): heavy_equipment_depreciation_calculatorAnalysis {
