import { stretch_ira_calculatorCalculatorInputs, stretch_ira_calculatorCalculatorMetrics, stretch_ira_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: stretch_ira_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: stretch_ira_calculatorCalculatorInputs, metrics: stretch_ira_calculatorCalculatorMetrics): stretch_ira_calculatorCalculatorAnalysis {
