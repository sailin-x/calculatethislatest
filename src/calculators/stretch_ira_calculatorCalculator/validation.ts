import { stretch_ira_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: stretch_ira_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
