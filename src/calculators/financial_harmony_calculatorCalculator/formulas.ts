import { financial_harmony_calculatorCalculatorInputs, financial_harmony_calculatorCalculatorMetrics, financial_harmony_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_harmony_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_harmony_calculatorCalculatorInputs, metrics: financial_harmony_calculatorCalculatorMetrics): financial_harmony_calculatorCalculatorAnalysis {
