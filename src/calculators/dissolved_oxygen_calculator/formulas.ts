import { dissolved_oxygen_calculatorInputs, dissolved_oxygen_calculatorMetrics, dissolved_oxygen_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: dissolved_oxygen_calculatorInputs): number {
...
export function generateAnalysis(inputs: dissolved_oxygen_calculatorInputs, metrics: dissolved_oxygen_calculatorMetrics): dissolved_oxygen_calculatorAnalysis {
