import { financial_gratitude_calculatorCalculatorInputs, financial_gratitude_calculatorCalculatorMetrics, financial_gratitude_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_gratitude_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_gratitude_calculatorCalculatorInputs, metrics: financial_gratitude_calculatorCalculatorMetrics): financial_gratitude_calculatorCalculatorAnalysis {
