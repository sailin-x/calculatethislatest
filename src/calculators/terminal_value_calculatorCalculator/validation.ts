import { terminal_value_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: terminal_value_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
