import { terminal_value_calculatorCalculatorInputs, terminal_value_calculatorCalculatorMetrics, terminal_value_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: terminal_value_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: terminal_value_calculatorCalculatorInputs, metrics: terminal_value_calculatorCalculatorMetrics): terminal_value_calculatorCalculatorAnalysis {
