import { registerCarPaymentCalculatorInputs } from './types';

export function validateInputs(inputs: registerCarPaymentCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
