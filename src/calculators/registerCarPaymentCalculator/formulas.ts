import { registerCarPaymentCalculatorInputs, registerCarPaymentCalculatorMetrics, registerCarPaymentCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerCarPaymentCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerCarPaymentCalculatorInputs, metrics: registerCarPaymentCalculatorMetrics): registerCarPaymentCalculatorAnalysis {
