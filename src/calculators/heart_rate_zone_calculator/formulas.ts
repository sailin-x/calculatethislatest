import { heart_rate_zone_calculatorInputs, heart_rate_zone_calculatorMetrics, heart_rate_zone_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: heart_rate_zone_calculatorInputs): number {
...
export function generateAnalysis(inputs: heart_rate_zone_calculatorInputs, metrics: heart_rate_zone_calculatorMetrics): heart_rate_zone_calculatorAnalysis {
