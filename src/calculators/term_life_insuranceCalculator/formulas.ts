import { term_life_insuranceCalculatorInputs, term_life_insuranceCalculatorMetrics, term_life_insuranceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: term_life_insuranceCalculatorInputs): number {
...
export function generateAnalysis(inputs: term_life_insuranceCalculatorInputs, metrics: term_life_insuranceCalculatorMetrics): term_life_insuranceCalculatorAnalysis {
