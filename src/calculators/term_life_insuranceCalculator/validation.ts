import { term_life_insuranceCalculatorInputs } from './types';

export function validateInputs(inputs: term_life_insuranceCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
