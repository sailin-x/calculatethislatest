import { hosting_cost_calculatorCalculatorInputs, hosting_cost_calculatorCalculatorMetrics, hosting_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hosting_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: hosting_cost_calculatorCalculatorInputs, metrics: hosting_cost_calculatorCalculatorMetrics): hosting_cost_calculatorCalculatorAnalysis {
