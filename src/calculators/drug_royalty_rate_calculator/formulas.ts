import { drug_royalty_rate_calculatorInputs, drug_royalty_rate_calculatorMetrics, drug_royalty_rate_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: drug_royalty_rate_calculatorInputs): number {
...
export function generateAnalysis(inputs: drug_royalty_rate_calculatorInputs, metrics: drug_royalty_rate_calculatorMetrics): drug_royalty_rate_calculatorAnalysis {
