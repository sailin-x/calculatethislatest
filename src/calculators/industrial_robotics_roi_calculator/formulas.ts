import { industrial_robotics_roi_calculatorInputs, industrial_robotics_roi_calculatorMetrics, industrial_robotics_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: industrial_robotics_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: industrial_robotics_roi_calculatorInputs, metrics: industrial_robotics_roi_calculatorMetrics): industrial_robotics_roi_calculatorAnalysis {
