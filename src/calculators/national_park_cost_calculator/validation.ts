import { national_park_cost_calculatorInputs } from './types';

export function validateInputs(inputs: national_park_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
