import { national_park_cost_calculatorInputs, national_park_cost_calculatorMetrics, national_park_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: national_park_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: national_park_cost_calculatorInputs, metrics: national_park_cost_calculatorMetrics): national_park_cost_calculatorAnalysis {
