import { blog_cost_calculatorCalculatorInputs, blog_cost_calculatorCalculatorMetrics, blog_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: blog_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: blog_cost_calculatorCalculatorInputs, metrics: blog_cost_calculatorCalculatorMetrics): blog_cost_calculatorCalculatorAnalysis {
