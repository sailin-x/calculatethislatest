import { financial_wisdom_calculatorInputs } from './types';

export function validateInputs(inputs: financial_wisdom_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
