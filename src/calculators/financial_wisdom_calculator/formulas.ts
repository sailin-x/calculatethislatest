import { financial_wisdom_calculatorInputs, financial_wisdom_calculatorMetrics, financial_wisdom_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_wisdom_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_wisdom_calculatorInputs, metrics: financial_wisdom_calculatorMetrics): financial_wisdom_calculatorAnalysis {
