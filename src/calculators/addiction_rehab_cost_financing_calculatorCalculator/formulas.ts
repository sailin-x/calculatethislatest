import { addiction_rehab_cost_financing_calculatorCalculatorInputs, addiction_rehab_cost_financing_calculatorCalculatorMetrics, addiction_rehab_cost_financing_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: addiction_rehab_cost_financing_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: addiction_rehab_cost_financing_calculatorCalculatorInputs, metrics: addiction_rehab_cost_financing_calculatorCalculatorMetrics): addiction_rehab_cost_financing_calculatorCalculatorAnalysis {
