import { enterprise_value_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: enterprise_value_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
