import { enterprise_value_calculatorCalculatorInputs, enterprise_value_calculatorCalculatorMetrics, enterprise_value_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: enterprise_value_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: enterprise_value_calculatorCalculatorInputs, metrics: enterprise_value_calculatorCalculatorMetrics): enterprise_value_calculatorCalculatorAnalysis {
