import { mold_remediation_cost_calculatorCalculatorInputs, mold_remediation_cost_calculatorCalculatorMetrics, mold_remediation_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mold_remediation_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: mold_remediation_cost_calculatorCalculatorInputs, metrics: mold_remediation_cost_calculatorCalculatorMetrics): mold_remediation_cost_calculatorCalculatorAnalysis {
