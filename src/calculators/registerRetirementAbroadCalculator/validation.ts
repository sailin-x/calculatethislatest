import { registerRetirementAbroadCalculatorInputs } from './types';

export function validateInputs(inputs: registerRetirementAbroadCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
