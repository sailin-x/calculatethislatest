import { registerRetirementAbroadCalculatorInputs, registerRetirementAbroadCalculatorMetrics, registerRetirementAbroadCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerRetirementAbroadCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerRetirementAbroadCalculatorInputs, metrics: registerRetirementAbroadCalculatorMetrics): registerRetirementAbroadCalculatorAnalysis {
