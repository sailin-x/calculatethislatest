import { cooking_conversion_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: cooking_conversion_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
