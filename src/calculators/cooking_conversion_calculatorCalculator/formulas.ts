import { cooking_conversion_calculatorCalculatorInputs, cooking_conversion_calculatorCalculatorMetrics, cooking_conversion_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cooking_conversion_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cooking_conversion_calculatorCalculatorInputs, metrics: cooking_conversion_calculatorCalculatorMetrics): cooking_conversion_calculatorCalculatorAnalysis {
