import { pmi_cancellationCalculatorInputs } from './types';

export function validateInputs(inputs: pmi_cancellationCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
