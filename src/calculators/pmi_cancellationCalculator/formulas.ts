import { pmi_cancellationCalculatorInputs, pmi_cancellationCalculatorMetrics, pmi_cancellationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: pmi_cancellationCalculatorInputs): number {
...
export function generateAnalysis(inputs: pmi_cancellationCalculatorInputs, metrics: pmi_cancellationCalculatorMetrics): pmi_cancellationCalculatorAnalysis {
