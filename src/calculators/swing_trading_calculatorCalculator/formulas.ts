import { swing_trading_calculatorCalculatorInputs, swing_trading_calculatorCalculatorMetrics, swing_trading_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: swing_trading_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: swing_trading_calculatorCalculatorInputs, metrics: swing_trading_calculatorCalculatorMetrics): swing_trading_calculatorCalculatorAnalysis {
