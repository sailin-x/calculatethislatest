import { swing_trading_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: swing_trading_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
