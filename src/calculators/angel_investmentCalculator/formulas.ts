import { angel_investmentCalculatorInputs, angel_investmentCalculatorMetrics, angel_investmentCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: angel_investmentCalculatorInputs): number {
...
export function generateAnalysis(inputs: angel_investmentCalculatorInputs, metrics: angel_investmentCalculatorMetrics): angel_investmentCalculatorAnalysis {
