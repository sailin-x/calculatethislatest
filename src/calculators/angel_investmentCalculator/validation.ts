import { angel_investmentCalculatorInputs } from './types';

export function validateInputs(inputs: angel_investmentCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
