import { lapse_rate_sensitivity_analysisCalculatorInputs, lapse_rate_sensitivity_analysisCalculatorMetrics, lapse_rate_sensitivity_analysisCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: lapse_rate_sensitivity_analysisCalculatorInputs): number {
...
export function generateAnalysis(inputs: lapse_rate_sensitivity_analysisCalculatorInputs, metrics: lapse_rate_sensitivity_analysisCalculatorMetrics): lapse_rate_sensitivity_analysisCalculatorAnalysis {
