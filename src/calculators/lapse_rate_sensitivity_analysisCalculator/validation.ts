import { lapse_rate_sensitivity_analysisCalculatorInputs } from './types';

export function validateInputs(inputs: lapse_rate_sensitivity_analysisCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
