import { bill_of_materials_calculatorInputs } from './types';

export function validateInputs(inputs: bill_of_materials_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
