import { bill_of_materials_calculatorInputs, bill_of_materials_calculatorMetrics, bill_of_materials_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: bill_of_materials_calculatorInputs): number {
...
export function generateAnalysis(inputs: bill_of_materials_calculatorInputs, metrics: bill_of_materials_calculatorMetrics): bill_of_materials_calculatorAnalysis {
