import { student_loan_repayment_calculatorCalculatorInputs, student_loan_repayment_calculatorCalculatorMetrics, student_loan_repayment_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: student_loan_repayment_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: student_loan_repayment_calculatorCalculatorInputs, metrics: student_loan_repayment_calculatorCalculatorMetrics): student_loan_repayment_calculatorCalculatorAnalysis {
