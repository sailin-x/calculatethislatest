import { business_insurance_calculatorInputs, business_insurance_calculatorMetrics, business_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: business_insurance_calculatorInputs, metrics: business_insurance_calculatorMetrics): business_insurance_calculatorAnalysis {
