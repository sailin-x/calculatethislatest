import { customer_lifetime_valueCalculatorInputs, customer_lifetime_valueCalculatorMetrics, customer_lifetime_valueCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: customer_lifetime_valueCalculatorInputs): number {
...
export function generateAnalysis(inputs: customer_lifetime_valueCalculatorInputs, metrics: customer_lifetime_valueCalculatorMetrics): customer_lifetime_valueCalculatorAnalysis {
