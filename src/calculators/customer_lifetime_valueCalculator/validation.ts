import { customer_lifetime_valueCalculatorInputs } from './types';

export function validateInputs(inputs: customer_lifetime_valueCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
