import { renters_insuranceCalculatorInputs, renters_insuranceCalculatorMetrics, renters_insuranceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: renters_insuranceCalculatorInputs): number {
...
export function generateAnalysis(inputs: renters_insuranceCalculatorInputs, metrics: renters_insuranceCalculatorMetrics): renters_insuranceCalculatorAnalysis {
