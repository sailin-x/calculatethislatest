import { renters_insuranceCalculatorInputs } from './types';

export function validateInputs(inputs: renters_insuranceCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
