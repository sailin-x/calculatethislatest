import { registerFAFSACalculatorInputs, registerFAFSACalculatorMetrics, registerFAFSACalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerFAFSACalculatorInputs): number {
...
export function generateAnalysis(inputs: registerFAFSACalculatorInputs, metrics: registerFAFSACalculatorMetrics): registerFAFSACalculatorAnalysis {
