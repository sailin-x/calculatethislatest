import { financial_stability_calculatorInputs, financial_stability_calculatorMetrics, financial_stability_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_stability_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_stability_calculatorInputs, metrics: financial_stability_calculatorMetrics): financial_stability_calculatorAnalysis {
