import { financial_stability_calculatorInputs } from './types';

export function validateInputs(inputs: financial_stability_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
