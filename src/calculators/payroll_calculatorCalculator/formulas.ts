import { payroll_calculatorCalculatorInputs, payroll_calculatorCalculatorMetrics, payroll_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: payroll_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: payroll_calculatorCalculatorInputs, metrics: payroll_calculatorCalculatorMetrics): payroll_calculatorCalculatorAnalysis {
