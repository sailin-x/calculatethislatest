import { patreon_subscription_calculatorInputs, patreon_subscription_calculatorMetrics, patreon_subscription_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: patreon_subscription_calculatorInputs): number {
...
export function generateAnalysis(inputs: patreon_subscription_calculatorInputs, metrics: patreon_subscription_calculatorMetrics): patreon_subscription_calculatorAnalysis {
