import { divorce_settlement_calculatorCalculatorInputs, divorce_settlement_calculatorCalculatorMetrics, divorce_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: divorce_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: divorce_settlement_calculatorCalculatorInputs, metrics: divorce_settlement_calculatorCalculatorMetrics): divorce_settlement_calculatorCalculatorAnalysis {
