import { bankruptcy_filing_calculatorInputs } from './types';

export function validateInputs(inputs: bankruptcy_filing_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
