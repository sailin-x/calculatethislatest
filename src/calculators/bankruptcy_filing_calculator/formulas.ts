import { bankruptcy_filing_calculatorInputs, bankruptcy_filing_calculatorMetrics, bankruptcy_filing_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: bankruptcy_filing_calculatorInputs): number {
...
export function generateAnalysis(inputs: bankruptcy_filing_calculatorInputs, metrics: bankruptcy_filing_calculatorMetrics): bankruptcy_filing_calculatorAnalysis {
