import { rv_rental_cost_calculatorCalculatorInputs, rv_rental_cost_calculatorCalculatorMetrics, rv_rental_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: rv_rental_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: rv_rental_cost_calculatorCalculatorInputs, metrics: rv_rental_cost_calculatorCalculatorMetrics): rv_rental_cost_calculatorCalculatorAnalysis {
