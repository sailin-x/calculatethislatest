import { maritime_injury_compensation_calculatorCalculatorInputs, maritime_injury_compensation_calculatorCalculatorMetrics, maritime_injury_compensation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: maritime_injury_compensation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: maritime_injury_compensation_calculatorCalculatorInputs, metrics: maritime_injury_compensation_calculatorCalculatorMetrics): maritime_injury_compensation_calculatorCalculatorAnalysis {
