import { interest_calculatorInputs, interest_calculatorMetrics, interest_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: interest_calculatorInputs): number {
...
export function generateAnalysis(inputs: interest_calculatorInputs, metrics: interest_calculatorMetrics): interest_calculatorAnalysis {
