import { capm_calculatorInputs, capm_calculatorMetrics, capm_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: capm_calculatorInputs): number {
...
export function generateAnalysis(inputs: capm_calculatorInputs, metrics: capm_calculatorMetrics): capm_calculatorAnalysis {
