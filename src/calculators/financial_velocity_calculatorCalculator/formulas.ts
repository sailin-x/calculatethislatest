import { financial_velocity_calculatorCalculatorInputs, financial_velocity_calculatorCalculatorMetrics, financial_velocity_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_velocity_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_velocity_calculatorCalculatorInputs, metrics: financial_velocity_calculatorCalculatorMetrics): financial_velocity_calculatorCalculatorAnalysis {
