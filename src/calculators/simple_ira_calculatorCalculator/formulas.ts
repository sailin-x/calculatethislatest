import { simple_ira_calculatorCalculatorInputs, simple_ira_calculatorCalculatorMetrics, simple_ira_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: simple_ira_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: simple_ira_calculatorCalculatorInputs, metrics: simple_ira_calculatorCalculatorMetrics): simple_ira_calculatorCalculatorAnalysis {
