import { simple_ira_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: simple_ira_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
