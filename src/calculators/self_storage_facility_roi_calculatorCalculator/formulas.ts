import { self_storage_facility_roi_calculatorCalculatorInputs, self_storage_facility_roi_calculatorCalculatorMetrics, self_storage_facility_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: self_storage_facility_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: self_storage_facility_roi_calculatorCalculatorInputs, metrics: self_storage_facility_roi_calculatorCalculatorMetrics): self_storage_facility_roi_calculatorCalculatorAnalysis {
