import { chlorine_calculatorInputs, chlorine_calculatorMetrics, chlorine_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: chlorine_calculatorInputs): number {
...
export function generateAnalysis(inputs: chlorine_calculatorInputs, metrics: chlorine_calculatorMetrics): chlorine_calculatorAnalysis {
