import { registerTimberlandInvestmentCalculatorInputs, registerTimberlandInvestmentCalculatorMetrics, registerTimberlandInvestmentCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerTimberlandInvestmentCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerTimberlandInvestmentCalculatorInputs, metrics: registerTimberlandInvestmentCalculatorMetrics): registerTimberlandInvestmentCalculatorAnalysis {
