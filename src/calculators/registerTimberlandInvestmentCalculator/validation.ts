import { registerTimberlandInvestmentCalculatorInputs } from './types';

export function validateInputs(inputs: registerTimberlandInvestmentCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
