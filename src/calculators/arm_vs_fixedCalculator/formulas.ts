import { arm_vs_fixedCalculatorInputs, arm_vs_fixedCalculatorMetrics, arm_vs_fixedCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: arm_vs_fixedCalculatorInputs): number {
...
export function generateAnalysis(inputs: arm_vs_fixedCalculatorInputs, metrics: arm_vs_fixedCalculatorMetrics): arm_vs_fixedCalculatorAnalysis {
