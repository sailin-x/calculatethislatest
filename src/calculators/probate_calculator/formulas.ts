import { probate_calculatorInputs, probate_calculatorMetrics, probate_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: probate_calculatorInputs): number {
...
export function generateAnalysis(inputs: probate_calculatorInputs, metrics: probate_calculatorMetrics): probate_calculatorAnalysis {
