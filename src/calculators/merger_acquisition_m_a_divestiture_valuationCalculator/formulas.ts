import { merger_acquisition_m_a_divestiture_valuationCalculatorInputs, merger_acquisition_m_a_divestiture_valuationCalculatorMetrics, merger_acquisition_m_a_divestiture_valuationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: merger_acquisition_m_a_divestiture_valuationCalculatorInputs): number {
...
export function generateAnalysis(inputs: merger_acquisition_m_a_divestiture_valuationCalculatorInputs, metrics: merger_acquisition_m_a_divestiture_valuationCalculatorMetrics): merger_acquisition_m_a_divestiture_valuationCalculatorAnalysis {
