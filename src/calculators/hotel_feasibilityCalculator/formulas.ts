import { hotel_feasibilityCalculatorInputs, hotel_feasibilityCalculatorMetrics, hotel_feasibilityCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hotel_feasibilityCalculatorInputs): number {
...
export function generateAnalysis(inputs: hotel_feasibilityCalculatorInputs, metrics: hotel_feasibilityCalculatorMetrics): hotel_feasibilityCalculatorAnalysis {
