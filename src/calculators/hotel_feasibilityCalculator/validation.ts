import { hotel_feasibilityCalculatorInputs } from './types';

export function validateInputs(inputs: hotel_feasibilityCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
