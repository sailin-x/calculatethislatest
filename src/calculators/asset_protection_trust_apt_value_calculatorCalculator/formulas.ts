import { asset_protection_trust_apt_value_calculatorCalculatorInputs, asset_protection_trust_apt_value_calculatorCalculatorMetrics, asset_protection_trust_apt_value_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: asset_protection_trust_apt_value_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: asset_protection_trust_apt_value_calculatorCalculatorInputs, metrics: asset_protection_trust_apt_value_calculatorCalculatorMetrics): asset_protection_trust_apt_value_calculatorCalculatorAnalysis {
