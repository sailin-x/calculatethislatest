import { chaturbate_token_calculatorInputs, chaturbate_token_calculatorMetrics, chaturbate_token_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: chaturbate_token_calculatorInputs): number {
...
export function generateAnalysis(inputs: chaturbate_token_calculatorInputs, metrics: chaturbate_token_calculatorMetrics): chaturbate_token_calculatorAnalysis {
