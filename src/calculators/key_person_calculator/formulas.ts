import { key_person_calculatorInputs, key_person_calculatorMetrics, key_person_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: key_person_calculatorInputs): number {
...
export function generateAnalysis(inputs: key_person_calculatorInputs, metrics: key_person_calculatorMetrics): key_person_calculatorAnalysis {
