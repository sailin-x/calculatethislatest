import { restricted_stock_unit_vs_stock_option_calculatorCalculatorInputs, restricted_stock_unit_vs_stock_option_calculatorCalculatorMetrics, restricted_stock_unit_vs_stock_option_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: restricted_stock_unit_vs_stock_option_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: restricted_stock_unit_vs_stock_option_calculatorCalculatorInputs, metrics: restricted_stock_unit_vs_stock_option_calculatorCalculatorMetrics): restricted_stock_unit_vs_stock_option_calculatorCalculatorAnalysis {
