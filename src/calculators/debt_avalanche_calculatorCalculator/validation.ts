import { debt_avalanche_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: debt_avalanche_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
