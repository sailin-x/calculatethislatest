import { debt_avalanche_calculatorCalculatorInputs, debt_avalanche_calculatorCalculatorMetrics, debt_avalanche_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_avalanche_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: debt_avalanche_calculatorCalculatorInputs, metrics: debt_avalanche_calculatorCalculatorMetrics): debt_avalanche_calculatorCalculatorAnalysis {
