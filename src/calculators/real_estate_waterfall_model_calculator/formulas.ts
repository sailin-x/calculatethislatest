import { real_estate_waterfall_model_calculatorInputs, real_estate_waterfall_model_calculatorMetrics, real_estate_waterfall_model_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: real_estate_waterfall_model_calculatorInputs): number {
...
export function generateAnalysis(inputs: real_estate_waterfall_model_calculatorInputs, metrics: real_estate_waterfall_model_calculatorMetrics): real_estate_waterfall_model_calculatorAnalysis {
