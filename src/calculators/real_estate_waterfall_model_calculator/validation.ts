import { real_estate_waterfall_model_calculatorInputs } from './types';

export function validateInputs(inputs: real_estate_waterfall_model_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
