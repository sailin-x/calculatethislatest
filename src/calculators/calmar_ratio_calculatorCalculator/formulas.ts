import { calmar_ratio_calculatorCalculatorInputs, calmar_ratio_calculatorCalculatorMetrics, calmar_ratio_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: calmar_ratio_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: calmar_ratio_calculatorCalculatorInputs, metrics: calmar_ratio_calculatorCalculatorMetrics): calmar_ratio_calculatorCalculatorAnalysis {
