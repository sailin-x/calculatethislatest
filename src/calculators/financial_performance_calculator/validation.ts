import { financial_performance_calculatorInputs } from './types';

export function validateInputs(inputs: financial_performance_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
