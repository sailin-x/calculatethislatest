import { financial_performance_calculatorInputs, financial_performance_calculatorMetrics, financial_performance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_performance_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_performance_calculatorInputs, metrics: financial_performance_calculatorMetrics): financial_performance_calculatorAnalysis {
