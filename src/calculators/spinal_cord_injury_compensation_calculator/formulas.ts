import { spinal_cord_injury_compensation_calculatorInputs, spinal_cord_injury_compensation_calculatorMetrics, spinal_cord_injury_compensation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: spinal_cord_injury_compensation_calculatorInputs): number {
...
export function generateAnalysis(inputs: spinal_cord_injury_compensation_calculatorInputs, metrics: spinal_cord_injury_compensation_calculatorMetrics): spinal_cord_injury_compensation_calculatorAnalysis {
