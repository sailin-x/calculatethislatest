import { registerRealEstateWaterfallModelCalculatorInputs, registerRealEstateWaterfallModelCalculatorMetrics, registerRealEstateWaterfallModelCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerRealEstateWaterfallModelCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerRealEstateWaterfallModelCalculatorInputs, metrics: registerRealEstateWaterfallModelCalculatorMetrics): registerRealEstateWaterfallModelCalculatorAnalysis {
