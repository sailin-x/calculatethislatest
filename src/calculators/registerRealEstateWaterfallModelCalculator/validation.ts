import { registerRealEstateWaterfallModelCalculatorInputs } from './types';

export function validateInputs(inputs: registerRealEstateWaterfallModelCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
