import { invoice_financing_calculatorInputs } from './types';

export function validateInputs(inputs: invoice_financing_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
