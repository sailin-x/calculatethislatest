import { invoice_financing_calculatorInputs, invoice_financing_calculatorMetrics, invoice_financing_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: invoice_financing_calculatorInputs): number {
...
export function generateAnalysis(inputs: invoice_financing_calculatorInputs, metrics: invoice_financing_calculatorMetrics): invoice_financing_calculatorAnalysis {
