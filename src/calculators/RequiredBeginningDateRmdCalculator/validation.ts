import { RequiredBeginningDateRmdCalculatorInputs } from './types';

export function validateInputs(inputs: RequiredBeginningDateRmdCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
