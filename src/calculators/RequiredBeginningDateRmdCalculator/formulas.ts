import { RequiredBeginningDateRmdCalculatorInputs, RequiredBeginningDateRmdCalculatorMetrics, RequiredBeginningDateRmdCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: RequiredBeginningDateRmdCalculatorInputs): number {
...
export function generateAnalysis(inputs: RequiredBeginningDateRmdCalculatorInputs, metrics: RequiredBeginningDateRmdCalculatorMetrics): RequiredBeginningDateRmdCalculatorAnalysis {
