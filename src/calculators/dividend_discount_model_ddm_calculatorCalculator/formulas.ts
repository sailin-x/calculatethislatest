import { dividend_discount_model_ddm_calculatorCalculatorInputs, dividend_discount_model_ddm_calculatorCalculatorMetrics, dividend_discount_model_ddm_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: dividend_discount_model_ddm_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: dividend_discount_model_ddm_calculatorCalculatorInputs, metrics: dividend_discount_model_ddm_calculatorCalculatorMetrics): dividend_discount_model_ddm_calculatorCalculatorAnalysis {
