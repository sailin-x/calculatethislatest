import { flexibleSpendingAccountCalculatorInputs, flexibleSpendingAccountCalculatorMetrics, flexibleSpendingAccountCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: flexibleSpendingAccountCalculatorInputs): number {
...
export function generateAnalysis(inputs: flexibleSpendingAccountCalculatorInputs, metrics: flexibleSpendingAccountCalculatorMetrics): flexibleSpendingAccountCalculatorAnalysis {
