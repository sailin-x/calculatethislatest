import { high_net_worth_divorce_asset_division_calculatorInputs, high_net_worth_divorce_asset_division_calculatorMetrics, high_net_worth_divorce_asset_division_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: high_net_worth_divorce_asset_division_calculatorInputs): number {
...
export function generateAnalysis(inputs: high_net_worth_divorce_asset_division_calculatorInputs, metrics: high_net_worth_divorce_asset_division_calculatorMetrics): high_net_worth_divorce_asset_division_calculatorAnalysis {
