import { crypto_tax_harvesting_calculatorInputs, crypto_tax_harvesting_calculatorMetrics, crypto_tax_harvesting_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: crypto_tax_harvesting_calculatorInputs): number {
...
export function generateAnalysis(inputs: crypto_tax_harvesting_calculatorInputs, metrics: crypto_tax_harvesting_calculatorMetrics): crypto_tax_harvesting_calculatorAnalysis {
