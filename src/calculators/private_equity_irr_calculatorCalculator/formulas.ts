import { private_equity_irr_calculatorCalculatorInputs, private_equity_irr_calculatorCalculatorMetrics, private_equity_irr_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: private_equity_irr_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: private_equity_irr_calculatorCalculatorInputs, metrics: private_equity_irr_calculatorCalculatorMetrics): private_equity_irr_calculatorCalculatorAnalysis {
