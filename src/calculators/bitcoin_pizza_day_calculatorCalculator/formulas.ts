import { bitcoin_pizza_day_calculatorCalculatorInputs, bitcoin_pizza_day_calculatorCalculatorMetrics, bitcoin_pizza_day_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: bitcoin_pizza_day_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: bitcoin_pizza_day_calculatorCalculatorInputs, metrics: bitcoin_pizza_day_calculatorCalculatorMetrics): bitcoin_pizza_day_calculatorCalculatorAnalysis {
