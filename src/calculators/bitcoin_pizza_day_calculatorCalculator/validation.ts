import { bitcoin_pizza_day_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: bitcoin_pizza_day_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
