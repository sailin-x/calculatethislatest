import { immigration_filing_calculatorInputs, immigration_filing_calculatorMetrics, immigration_filing_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: immigration_filing_calculatorInputs): number {
...
export function generateAnalysis(inputs: immigration_filing_calculatorInputs, metrics: immigration_filing_calculatorMetrics): immigration_filing_calculatorAnalysis {
