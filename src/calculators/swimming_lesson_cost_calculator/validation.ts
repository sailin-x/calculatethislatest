import { swimming_lesson_cost_calculatorInputs } from './types';

export function validateInputs(inputs: swimming_lesson_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
