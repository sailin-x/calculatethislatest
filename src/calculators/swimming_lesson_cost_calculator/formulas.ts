import { swimming_lesson_cost_calculatorInputs, swimming_lesson_cost_calculatorMetrics, swimming_lesson_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: swimming_lesson_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: swimming_lesson_cost_calculatorInputs, metrics: swimming_lesson_cost_calculatorMetrics): swimming_lesson_cost_calculatorAnalysis {
