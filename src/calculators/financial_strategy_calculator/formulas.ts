import { financial_strategy_calculatorInputs, financial_strategy_calculatorMetrics, financial_strategy_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_strategy_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_strategy_calculatorInputs, metrics: financial_strategy_calculatorMetrics): financial_strategy_calculatorAnalysis {
