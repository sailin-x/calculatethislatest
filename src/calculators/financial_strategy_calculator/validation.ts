import { financial_strategy_calculatorInputs } from './types';

export function validateInputs(inputs: financial_strategy_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
