import { stock_optionsCalculatorInputs, stock_optionsCalculatorMetrics, stock_optionsCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: stock_optionsCalculatorInputs): number {
...
export function generateAnalysis(inputs: stock_optionsCalculatorInputs, metrics: stock_optionsCalculatorMetrics): stock_optionsCalculatorAnalysis {
