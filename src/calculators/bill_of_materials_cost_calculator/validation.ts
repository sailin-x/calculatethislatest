import { bill_of_materials_cost_calculatorInputs } from './types';

export function validateInputs(inputs: bill_of_materials_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
