import { bill_of_materials_cost_calculatorInputs, bill_of_materials_cost_calculatorMetrics, bill_of_materials_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: bill_of_materials_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: bill_of_materials_cost_calculatorInputs, metrics: bill_of_materials_cost_calculatorMetrics): bill_of_materials_cost_calculatorAnalysis {
