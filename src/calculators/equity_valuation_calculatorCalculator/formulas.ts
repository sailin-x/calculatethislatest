import { equity_valuation_calculatorCalculatorInputs, equity_valuation_calculatorCalculatorMetrics, equity_valuation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: equity_valuation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: equity_valuation_calculatorCalculatorInputs, metrics: equity_valuation_calculatorCalculatorMetrics): equity_valuation_calculatorCalculatorAnalysis {
