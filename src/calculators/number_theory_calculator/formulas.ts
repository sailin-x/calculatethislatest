import { number_theory_calculatorInputs, number_theory_calculatorMetrics, number_theory_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: number_theory_calculatorInputs): number {
...
export function generateAnalysis(inputs: number_theory_calculatorInputs, metrics: number_theory_calculatorMetrics): number_theory_calculatorAnalysis {
