import { net_unrealized_appreciation_nua_tax_calculatorInputs, net_unrealized_appreciation_nua_tax_calculatorMetrics, net_unrealized_appreciation_nua_tax_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: net_unrealized_appreciation_nua_tax_calculatorInputs): number {
...
export function generateAnalysis(inputs: net_unrealized_appreciation_nua_tax_calculatorInputs, metrics: net_unrealized_appreciation_nua_tax_calculatorMetrics): net_unrealized_appreciation_nua_tax_calculatorAnalysis {
