import { defi_liquidity_pool_calculatorInputs, defi_liquidity_pool_calculatorMetrics, defi_liquidity_pool_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: defi_liquidity_pool_calculatorInputs): number {
...
export function generateAnalysis(inputs: defi_liquidity_pool_calculatorInputs, metrics: defi_liquidity_pool_calculatorMetrics): defi_liquidity_pool_calculatorAnalysis {
