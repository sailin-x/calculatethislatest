import { marketing_cost_calculatorCalculatorInputs, marketing_cost_calculatorCalculatorMetrics, marketing_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: marketing_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: marketing_cost_calculatorCalculatorInputs, metrics: marketing_cost_calculatorCalculatorMetrics): marketing_cost_calculatorCalculatorAnalysis {
