import { business_loan_calculatorCalculatorInputs, business_loan_calculatorCalculatorMetrics, business_loan_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_loan_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: business_loan_calculatorCalculatorInputs, metrics: business_loan_calculatorCalculatorMetrics): business_loan_calculatorCalculatorAnalysis {
