import { contract_review_calculatorInputs } from './types';

export function validateInputs(inputs: contract_review_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
