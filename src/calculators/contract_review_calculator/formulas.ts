import { contract_review_calculatorInputs, contract_review_calculatorMetrics, contract_review_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: contract_review_calculatorInputs): number {
...
export function generateAnalysis(inputs: contract_review_calculatorInputs, metrics: contract_review_calculatorMetrics): contract_review_calculatorAnalysis {
