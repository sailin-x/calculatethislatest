import { policy_lapse_rate_calculatorInputs, policy_lapse_rate_calculatorMetrics, policy_lapse_rate_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: policy_lapse_rate_calculatorInputs): number {
...
export function generateAnalysis(inputs: policy_lapse_rate_calculatorInputs, metrics: policy_lapse_rate_calculatorMetrics): policy_lapse_rate_calculatorAnalysis {
