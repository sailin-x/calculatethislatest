import { tax_calculatorCalculatorInputs, tax_calculatorCalculatorMetrics, tax_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: tax_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: tax_calculatorCalculatorInputs, metrics: tax_calculatorCalculatorMetrics): tax_calculatorCalculatorAnalysis {
