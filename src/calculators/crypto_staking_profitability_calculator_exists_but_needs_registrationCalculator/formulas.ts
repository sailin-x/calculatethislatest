import { crypto_staking_profitability_calculator_exists_but_needs_registrationCalculatorInputs, crypto_staking_profitability_calculator_exists_but_needs_registrationCalculatorMetrics, crypto_staking_profitability_calculator_exists_but_needs_registrationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: crypto_staking_profitability_calculator_exists_but_needs_registrationCalculatorInputs): number {
...
export function generateAnalysis(inputs: crypto_staking_profitability_calculator_exists_but_needs_registrationCalculatorInputs, metrics: crypto_staking_profitability_calculator_exists_but_needs_registrationCalculatorMetrics): crypto_staking_profitability_calculator_exists_but_needs_registrationCalculatorAnalysis {
