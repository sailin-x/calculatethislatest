import { litigation_finance_roi_calculatorInputs, litigation_finance_roi_calculatorMetrics, litigation_finance_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: litigation_finance_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: litigation_finance_roi_calculatorInputs, metrics: litigation_finance_roi_calculatorMetrics): litigation_finance_roi_calculatorAnalysis {
