import { financial_intelligence_calculatorCalculatorInputs, financial_intelligence_calculatorCalculatorMetrics, financial_intelligence_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_intelligence_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_intelligence_calculatorCalculatorInputs, metrics: financial_intelligence_calculatorCalculatorMetrics): financial_intelligence_calculatorCalculatorAnalysis {
