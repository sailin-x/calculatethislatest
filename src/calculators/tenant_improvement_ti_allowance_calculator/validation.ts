import { tenant_improvement_ti_allowance_calculatorInputs } from './types';

export function validateInputs(inputs: tenant_improvement_ti_allowance_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
