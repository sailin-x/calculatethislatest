import { tenant_improvement_ti_allowance_calculatorInputs, tenant_improvement_ti_allowance_calculatorMetrics, tenant_improvement_ti_allowance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: tenant_improvement_ti_allowance_calculatorInputs): number {
...
export function generateAnalysis(inputs: tenant_improvement_ti_allowance_calculatorInputs, metrics: tenant_improvement_ti_allowance_calculatorMetrics): tenant_improvement_ti_allowance_calculatorAnalysis {
