import { music_royalty_investment_calculatorInputs, music_royalty_investment_calculatorMetrics, music_royalty_investment_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: music_royalty_investment_calculatorInputs): number {
...
export function generateAnalysis(inputs: music_royalty_investment_calculatorInputs, metrics: music_royalty_investment_calculatorMetrics): music_royalty_investment_calculatorAnalysis {
