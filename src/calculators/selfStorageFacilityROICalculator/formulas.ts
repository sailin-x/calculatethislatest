import { selfStorageFacilityROICalculatorInputs, selfStorageFacilityROICalculatorMetrics, selfStorageFacilityROICalculatorAnalysis } from './types';
...
export function calculateResult(inputs: selfStorageFacilityROICalculatorInputs): number {
...
export function generateAnalysis(inputs: selfStorageFacilityROICalculatorInputs, metrics: selfStorageFacilityROICalculatorMetrics): selfStorageFacilityROICalculatorAnalysis {
