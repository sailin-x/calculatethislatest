import { selfStorageFacilityROICalculatorInputs } from './types';

export function validateInputs(inputs: selfStorageFacilityROICalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
