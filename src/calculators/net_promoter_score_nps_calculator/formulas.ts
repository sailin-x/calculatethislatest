import { net_promoter_score_nps_calculatorInputs, net_promoter_score_nps_calculatorMetrics, net_promoter_score_nps_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: net_promoter_score_nps_calculatorInputs): number {
...
export function generateAnalysis(inputs: net_promoter_score_nps_calculatorInputs, metrics: net_promoter_score_nps_calculatorMetrics): net_promoter_score_nps_calculatorAnalysis {
