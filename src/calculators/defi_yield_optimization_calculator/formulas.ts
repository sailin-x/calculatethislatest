import { defi_yield_optimization_calculatorInputs, defi_yield_optimization_calculatorMetrics, defi_yield_optimization_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: defi_yield_optimization_calculatorInputs): number {
...
export function generateAnalysis(inputs: defi_yield_optimization_calculatorInputs, metrics: defi_yield_optimization_calculatorMetrics): defi_yield_optimization_calculatorAnalysis {
