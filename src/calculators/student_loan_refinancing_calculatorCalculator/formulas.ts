import { student_loan_refinancing_calculatorCalculatorInputs, student_loan_refinancing_calculatorCalculatorMetrics, student_loan_refinancing_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: student_loan_refinancing_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: student_loan_refinancing_calculatorCalculatorInputs, metrics: student_loan_refinancing_calculatorCalculatorMetrics): student_loan_refinancing_calculatorCalculatorAnalysis {
