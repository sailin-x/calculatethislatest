import { mental_health_treatment_cost_calculatorInputs } from './types';

export function validateInputs(inputs: mental_health_treatment_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
