import { mental_health_treatment_cost_calculatorInputs, mental_health_treatment_cost_calculatorMetrics, mental_health_treatment_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: mental_health_treatment_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: mental_health_treatment_cost_calculatorInputs, metrics: mental_health_treatment_cost_calculatorMetrics): mental_health_treatment_cost_calculatorAnalysis {
