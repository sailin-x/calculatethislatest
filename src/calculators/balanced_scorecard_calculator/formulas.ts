import { balanced_scorecard_calculatorInputs, balanced_scorecard_calculatorMetrics, balanced_scorecard_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: balanced_scorecard_calculatorInputs): number {
...
export function generateAnalysis(inputs: balanced_scorecard_calculatorInputs, metrics: balanced_scorecard_calculatorMetrics): balanced_scorecard_calculatorAnalysis {
