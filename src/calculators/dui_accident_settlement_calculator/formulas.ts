import { dui_accident_settlement_calculatorInputs, dui_accident_settlement_calculatorMetrics, dui_accident_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: dui_accident_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: dui_accident_settlement_calculatorInputs, metrics: dui_accident_settlement_calculatorMetrics): dui_accident_settlement_calculatorAnalysis {
