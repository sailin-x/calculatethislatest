import { discord_server_monetization_calculatorInputs, discord_server_monetization_calculatorMetrics, discord_server_monetization_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: discord_server_monetization_calculatorInputs): number {
...
export function generateAnalysis(inputs: discord_server_monetization_calculatorInputs, metrics: discord_server_monetization_calculatorMetrics): discord_server_monetization_calculatorAnalysis {
