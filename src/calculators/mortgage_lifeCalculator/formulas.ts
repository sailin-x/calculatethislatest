import { mortgage_lifeCalculatorInputs, mortgage_lifeCalculatorMetrics, mortgage_lifeCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgage_lifeCalculatorInputs): number {
...
export function generateAnalysis(inputs: mortgage_lifeCalculatorInputs, metrics: mortgage_lifeCalculatorMetrics): mortgage_lifeCalculatorAnalysis {
