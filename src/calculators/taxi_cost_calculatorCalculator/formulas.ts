import { taxi_cost_calculatorCalculatorInputs, taxi_cost_calculatorCalculatorMetrics, taxi_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: taxi_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: taxi_cost_calculatorCalculatorInputs, metrics: taxi_cost_calculatorCalculatorMetrics): taxi_cost_calculatorCalculatorAnalysis {
