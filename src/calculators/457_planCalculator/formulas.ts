import { 457_planCalculatorInputs, 457_planCalculatorMetrics, 457_planCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: 457_planCalculatorInputs): number {
...
export function generateAnalysis(inputs: 457_planCalculatorInputs, metrics: 457_planCalculatorMetrics): 457_planCalculatorAnalysis {
