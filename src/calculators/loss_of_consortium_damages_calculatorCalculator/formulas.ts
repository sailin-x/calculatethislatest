import { loss_of_consortium_damages_calculatorCalculatorInputs, loss_of_consortium_damages_calculatorCalculatorMetrics, loss_of_consortium_damages_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: loss_of_consortium_damages_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: loss_of_consortium_damages_calculatorCalculatorInputs, metrics: loss_of_consortium_damages_calculatorCalculatorMetrics): loss_of_consortium_damages_calculatorCalculatorAnalysis {
