import { merger_arbitrage_spread_calculatorCalculatorInputs, merger_arbitrage_spread_calculatorCalculatorMetrics, merger_arbitrage_spread_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: merger_arbitrage_spread_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: merger_arbitrage_spread_calculatorCalculatorInputs, metrics: merger_arbitrage_spread_calculatorCalculatorMetrics): merger_arbitrage_spread_calculatorCalculatorAnalysis {
