import { registerBetaCalculatorInputs, registerBetaCalculatorMetrics, registerBetaCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerBetaCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerBetaCalculatorInputs, metrics: registerBetaCalculatorMetrics): registerBetaCalculatorAnalysis {
