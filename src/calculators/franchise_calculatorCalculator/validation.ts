import { franchise_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: franchise_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
