import { franchise_calculatorCalculatorInputs, franchise_calculatorCalculatorMetrics, franchise_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: franchise_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: franchise_calculatorCalculatorInputs, metrics: franchise_calculatorCalculatorMetrics): franchise_calculatorCalculatorAnalysis {
