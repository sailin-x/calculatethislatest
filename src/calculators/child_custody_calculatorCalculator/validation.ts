import { child_custody_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: child_custody_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
