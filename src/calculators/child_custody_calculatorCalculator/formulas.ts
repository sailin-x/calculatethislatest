import { child_custody_calculatorCalculatorInputs, child_custody_calculatorCalculatorMetrics, child_custody_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: child_custody_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: child_custody_calculatorCalculatorInputs, metrics: child_custody_calculatorCalculatorMetrics): child_custody_calculatorCalculatorAnalysis {
