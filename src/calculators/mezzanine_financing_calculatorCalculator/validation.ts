import { mezzanine_financing_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: mezzanine_financing_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
