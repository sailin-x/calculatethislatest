import { mezzanine_financing_calculatorCalculatorInputs, mezzanine_financing_calculatorCalculatorMetrics, mezzanine_financing_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mezzanine_financing_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: mezzanine_financing_calculatorCalculatorInputs, metrics: mezzanine_financing_calculatorCalculatorMetrics): mezzanine_financing_calculatorCalculatorAnalysis {
