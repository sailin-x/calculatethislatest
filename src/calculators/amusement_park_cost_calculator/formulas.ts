import { amusement_park_cost_calculatorInputs, amusement_park_cost_calculatorMetrics, amusement_park_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: amusement_park_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: amusement_park_cost_calculatorInputs, metrics: amusement_park_cost_calculatorMetrics): amusement_park_cost_calculatorAnalysis {
