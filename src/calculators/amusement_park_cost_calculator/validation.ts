import { amusement_park_cost_calculatorInputs } from './types';

export function validateInputs(inputs: amusement_park_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
