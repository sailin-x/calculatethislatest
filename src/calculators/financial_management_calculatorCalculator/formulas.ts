import { financial_management_calculatorCalculatorInputs, financial_management_calculatorCalculatorMetrics, financial_management_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_management_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_management_calculatorCalculatorInputs, metrics: financial_management_calculatorCalculatorMetrics): financial_management_calculatorCalculatorAnalysis {
