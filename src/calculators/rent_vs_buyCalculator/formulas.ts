import { rent_vs_buyCalculatorInputs, rent_vs_buyCalculatorMetrics, rent_vs_buyCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: rent_vs_buyCalculatorInputs): number {
...
export function generateAnalysis(inputs: rent_vs_buyCalculatorInputs, metrics: rent_vs_buyCalculatorMetrics): rent_vs_buyCalculatorAnalysis {
