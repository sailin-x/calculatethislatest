import { calorieCalculatorInputs, calorieCalculatorMetrics, calorieCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: calorieCalculatorInputs): number {
...
export function generateAnalysis(inputs: calorieCalculatorInputs, metrics: calorieCalculatorMetrics): calorieCalculatorAnalysis {
