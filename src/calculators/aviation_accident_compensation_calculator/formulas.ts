import { aviation_accident_compensation_calculatorInputs, aviation_accident_compensation_calculatorMetrics, aviation_accident_compensation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: aviation_accident_compensation_calculatorInputs): number {
...
export function generateAnalysis(inputs: aviation_accident_compensation_calculatorInputs, metrics: aviation_accident_compensation_calculatorMetrics): aviation_accident_compensation_calculatorAnalysis {
