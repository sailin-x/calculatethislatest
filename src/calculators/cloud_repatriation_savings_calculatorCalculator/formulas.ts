import { cloud_repatriation_savings_calculatorCalculatorInputs, cloud_repatriation_savings_calculatorCalculatorMetrics, cloud_repatriation_savings_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cloud_repatriation_savings_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cloud_repatriation_savings_calculatorCalculatorInputs, metrics: cloud_repatriation_savings_calculatorCalculatorMetrics): cloud_repatriation_savings_calculatorCalculatorAnalysis {
