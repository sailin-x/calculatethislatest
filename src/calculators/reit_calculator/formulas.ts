import { reit_calculatorInputs, reit_calculatorMetrics, reit_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: reit_calculatorInputs): number {
...
export function generateAnalysis(inputs: reit_calculatorInputs, metrics: reit_calculatorMetrics): reit_calculatorAnalysis {
