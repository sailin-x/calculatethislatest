import { financial_health_calculatorCalculatorInputs, financial_health_calculatorCalculatorMetrics, financial_health_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_health_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_health_calculatorCalculatorInputs, metrics: financial_health_calculatorCalculatorMetrics): financial_health_calculatorCalculatorAnalysis {
