import { brrrr_strategyCalculatorInputs, brrrr_strategyCalculatorMetrics, brrrr_strategyCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: brrrr_strategyCalculatorInputs): number {
...
export function generateAnalysis(inputs: brrrr_strategyCalculatorInputs, metrics: brrrr_strategyCalculatorMetrics): brrrr_strategyCalculatorAnalysis {
