import { timberland_investmentCalculatorInputs, timberland_investmentCalculatorMetrics, timberland_investmentCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: timberland_investmentCalculatorInputs): number {
...
export function generateAnalysis(inputs: timberland_investmentCalculatorInputs, metrics: timberland_investmentCalculatorMetrics): timberland_investmentCalculatorAnalysis {
