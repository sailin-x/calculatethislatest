import { timberland_investmentCalculatorInputs } from './types';

export function validateInputs(inputs: timberland_investmentCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
