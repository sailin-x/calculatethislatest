import { corporate_compliance_cost_benefit_calculatorInputs, corporate_compliance_cost_benefit_calculatorMetrics, corporate_compliance_cost_benefit_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: corporate_compliance_cost_benefit_calculatorInputs): number {
...
export function generateAnalysis(inputs: corporate_compliance_cost_benefit_calculatorInputs, metrics: corporate_compliance_cost_benefit_calculatorMetrics): corporate_compliance_cost_benefit_calculatorAnalysis {
