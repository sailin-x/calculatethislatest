import { personal_injury_multiplier_calculatorInputs, personal_injury_multiplier_calculatorMetrics, personal_injury_multiplier_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: personal_injury_multiplier_calculatorInputs): number {
...
export function generateAnalysis(inputs: personal_injury_multiplier_calculatorInputs, metrics: personal_injury_multiplier_calculatorMetrics): personal_injury_multiplier_calculatorAnalysis {
