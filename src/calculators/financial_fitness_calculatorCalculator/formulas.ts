import { financial_fitness_calculatorCalculatorInputs, financial_fitness_calculatorCalculatorMetrics, financial_fitness_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_fitness_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_fitness_calculatorCalculatorInputs, metrics: financial_fitness_calculatorCalculatorMetrics): financial_fitness_calculatorCalculatorAnalysis {
