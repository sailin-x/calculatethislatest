import { preventative_maintenance_savings_calculatorInputs, preventative_maintenance_savings_calculatorMetrics, preventative_maintenance_savings_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: preventative_maintenance_savings_calculatorInputs): number {
...
export function generateAnalysis(inputs: preventative_maintenance_savings_calculatorInputs, metrics: preventative_maintenance_savings_calculatorMetrics): preventative_maintenance_savings_calculatorAnalysis {
