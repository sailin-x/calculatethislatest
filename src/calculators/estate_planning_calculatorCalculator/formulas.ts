import { estate_planning_calculatorCalculatorInputs, estate_planning_calculatorCalculatorMetrics, estate_planning_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: estate_planning_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: estate_planning_calculatorCalculatorInputs, metrics: estate_planning_calculatorCalculatorMetrics): estate_planning_calculatorCalculatorAnalysis {
