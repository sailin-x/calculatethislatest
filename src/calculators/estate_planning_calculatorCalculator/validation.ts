import { estate_planning_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: estate_planning_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
