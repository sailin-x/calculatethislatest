import { jones_act_settlement_calculatorInputs, jones_act_settlement_calculatorMetrics, jones_act_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: jones_act_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: jones_act_settlement_calculatorInputs, metrics: jones_act_settlement_calculatorMetrics): jones_act_settlement_calculatorAnalysis {
