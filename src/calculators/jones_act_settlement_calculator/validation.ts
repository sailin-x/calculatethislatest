import { jones_act_settlement_calculatorInputs } from './types';

export function validateInputs(inputs: jones_act_settlement_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
