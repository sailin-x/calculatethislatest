import { financial_excellence_calculatorCalculatorInputs, financial_excellence_calculatorCalculatorMetrics, financial_excellence_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_excellence_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_excellence_calculatorCalculatorInputs, metrics: financial_excellence_calculatorCalculatorMetrics): financial_excellence_calculatorCalculatorAnalysis {
