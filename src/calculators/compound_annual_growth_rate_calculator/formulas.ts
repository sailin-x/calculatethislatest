import { compound_annual_growth_rate_calculatorInputs, compound_annual_growth_rate_calculatorMetrics, compound_annual_growth_rate_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: compound_annual_growth_rate_calculatorInputs): number {
...
export function generateAnalysis(inputs: compound_annual_growth_rate_calculatorInputs, metrics: compound_annual_growth_rate_calculatorMetrics): compound_annual_growth_rate_calculatorAnalysis {
