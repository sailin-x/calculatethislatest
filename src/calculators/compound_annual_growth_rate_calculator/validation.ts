import { compound_annual_growth_rate_calculatorInputs } from './types';

export function validateInputs(inputs: compound_annual_growth_rate_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
