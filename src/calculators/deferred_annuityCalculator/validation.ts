import { deferred_annuityCalculatorInputs } from './types';

export function validateInputs(inputs: deferred_annuityCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
