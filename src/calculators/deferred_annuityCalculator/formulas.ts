import { deferred_annuityCalculatorInputs, deferred_annuityCalculatorMetrics, deferred_annuityCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: deferred_annuityCalculatorInputs): number {
...
export function generateAnalysis(inputs: deferred_annuityCalculatorInputs, metrics: deferred_annuityCalculatorMetrics): deferred_annuityCalculatorAnalysis {
