import { fund_level_irr_tvpi_and_dpi_calculatorCalculatorInputs, fund_level_irr_tvpi_and_dpi_calculatorCalculatorMetrics, fund_level_irr_tvpi_and_dpi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fund_level_irr_tvpi_and_dpi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: fund_level_irr_tvpi_and_dpi_calculatorCalculatorInputs, metrics: fund_level_irr_tvpi_and_dpi_calculatorCalculatorMetrics): fund_level_irr_tvpi_and_dpi_calculatorCalculatorAnalysis {
