import { health_savings_account_hsa_calculatorInputs } from './types';

export function validateInputs(inputs: health_savings_account_hsa_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
