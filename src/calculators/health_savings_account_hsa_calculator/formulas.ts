import { health_savings_account_hsa_calculatorInputs, health_savings_account_hsa_calculatorMetrics, health_savings_account_hsa_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: health_savings_account_hsa_calculatorInputs): number {
...
export function generateAnalysis(inputs: health_savings_account_hsa_calculatorInputs, metrics: health_savings_account_hsa_calculatorMetrics): health_savings_account_hsa_calculatorAnalysis {
