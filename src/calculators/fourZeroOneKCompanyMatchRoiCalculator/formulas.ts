import { 401k_company_match_roiCalculatorInputs, 401k_company_match_roiCalculatorMetrics, 401k_company_match_roiCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: 401k_company_match_roiCalculatorInputs): number {
...
export function generateAnalysis(inputs: 401k_company_match_roiCalculatorInputs, metrics: 401k_company_match_roiCalculatorMetrics): 401k_company_match_roiCalculatorAnalysis {
