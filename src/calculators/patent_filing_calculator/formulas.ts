import { patent_filing_calculatorInputs, patent_filing_calculatorMetrics, patent_filing_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: patent_filing_calculatorInputs): number {
...
export function generateAnalysis(inputs: patent_filing_calculatorInputs, metrics: patent_filing_calculatorMetrics): patent_filing_calculatorAnalysis {
