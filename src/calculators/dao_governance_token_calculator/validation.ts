import { dao_governance_token_calculatorInputs } from './types';

export function validateInputs(inputs: dao_governance_token_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
