import { dao_governance_token_calculatorInputs, dao_governance_token_calculatorMetrics, dao_governance_token_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: dao_governance_token_calculatorInputs): number {
...
export function generateAnalysis(inputs: dao_governance_token_calculatorInputs, metrics: dao_governance_token_calculatorMetrics): dao_governance_token_calculatorAnalysis {
