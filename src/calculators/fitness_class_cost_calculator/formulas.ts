import { fitness_class_cost_calculatorInputs, fitness_class_cost_calculatorMetrics, fitness_class_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fitness_class_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: fitness_class_cost_calculatorInputs, metrics: fitness_class_cost_calculatorMetrics): fitness_class_cost_calculatorAnalysis {
