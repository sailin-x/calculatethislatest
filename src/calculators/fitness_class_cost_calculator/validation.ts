import { fitness_class_cost_calculatorInputs } from './types';

export function validateInputs(inputs: fitness_class_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
