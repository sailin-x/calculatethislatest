import { reit_dividend_calculatorCalculatorInputs, reit_dividend_calculatorCalculatorMetrics, reit_dividend_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: reit_dividend_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: reit_dividend_calculatorCalculatorInputs, metrics: reit_dividend_calculatorCalculatorMetrics): reit_dividend_calculatorCalculatorAnalysis {
