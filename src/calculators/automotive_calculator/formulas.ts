import { automotive_calculatorInputs, automotive_calculatorMetrics, automotive_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: automotive_calculatorInputs): number {
...
export function generateAnalysis(inputs: automotive_calculatorInputs, metrics: automotive_calculatorMetrics): automotive_calculatorAnalysis {
