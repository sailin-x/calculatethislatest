import { StructuredSettlementPayoutCalculatorInputs, StructuredSettlementPayoutCalculatorMetrics, StructuredSettlementPayoutCalculatorAnalysis } from './types';
...
export function generateAnalysis(inputs: StructuredSettlementPayoutCalculatorInputs, metrics: StructuredSettlementPayoutCalculatorMetrics): StructuredSettlementPayoutCalculatorAnalysis {
