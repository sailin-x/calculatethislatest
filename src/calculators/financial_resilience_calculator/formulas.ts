import { financial_resilience_calculatorInputs, financial_resilience_calculatorMetrics, financial_resilience_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_resilience_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_resilience_calculatorInputs, metrics: financial_resilience_calculatorMetrics): financial_resilience_calculatorAnalysis {
