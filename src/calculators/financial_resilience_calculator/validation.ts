import { financial_resilience_calculatorInputs } from './types';

export function validateInputs(inputs: financial_resilience_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
