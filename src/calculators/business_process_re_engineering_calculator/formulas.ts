import { business_process_re_engineering_calculatorInputs, business_process_re_engineering_calculatorMetrics, business_process_re_engineering_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_process_re_engineering_calculatorInputs): number {
...
export function generateAnalysis(inputs: business_process_re_engineering_calculatorInputs, metrics: business_process_re_engineering_calculatorMetrics): business_process_re_engineering_calculatorAnalysis {
