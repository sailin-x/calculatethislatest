import { business_process_re_engineering_calculatorInputs } from './types';

export function validateInputs(inputs: business_process_re_engineering_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
