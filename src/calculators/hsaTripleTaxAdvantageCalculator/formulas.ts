import { hsaTripleTaxAdvantageCalculatorInputs, hsaTripleTaxAdvantageCalculatorMetrics, hsaTripleTaxAdvantageCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hsaTripleTaxAdvantageCalculatorInputs): number {
...
export function generateAnalysis(inputs: hsaTripleTaxAdvantageCalculatorInputs, metrics: hsaTripleTaxAdvantageCalculatorMetrics): hsaTripleTaxAdvantageCalculatorAnalysis {
