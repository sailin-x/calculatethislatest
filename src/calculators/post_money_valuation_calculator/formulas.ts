import { post_money_valuation_calculatorInputs, post_money_valuation_calculatorMetrics, post_money_valuation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: post_money_valuation_calculatorInputs): number {
...
export function generateAnalysis(inputs: post_money_valuation_calculatorInputs, metrics: post_money_valuation_calculatorMetrics): post_money_valuation_calculatorAnalysis {
