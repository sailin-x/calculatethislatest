import { gap_insurance_calculatorInputs, gap_insurance_calculatorMetrics, gap_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: gap_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: gap_insurance_calculatorInputs, metrics: gap_insurance_calculatorMetrics): gap_insurance_calculatorAnalysis {
