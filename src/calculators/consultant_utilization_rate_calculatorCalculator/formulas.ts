import { consultant_utilization_rate_calculatorCalculatorInputs, consultant_utilization_rate_calculatorCalculatorMetrics, consultant_utilization_rate_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: consultant_utilization_rate_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: consultant_utilization_rate_calculatorCalculatorInputs, metrics: consultant_utilization_rate_calculatorCalculatorMetrics): consultant_utilization_rate_calculatorCalculatorAnalysis {
