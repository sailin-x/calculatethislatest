import { mezzanine_financing_calculatorInputs, mezzanine_financing_calculatorMetrics, mezzanine_financing_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: mezzanine_financing_calculatorInputs): number {
...
export function generateAnalysis(inputs: mezzanine_financing_calculatorInputs, metrics: mezzanine_financing_calculatorMetrics): mezzanine_financing_calculatorAnalysis {
