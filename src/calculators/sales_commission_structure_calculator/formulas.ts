import { sales_commission_structure_calculatorInputs, sales_commission_structure_calculatorMetrics, sales_commission_structure_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: sales_commission_structure_calculatorInputs): number {
...
export function generateAnalysis(inputs: sales_commission_structure_calculatorInputs, metrics: sales_commission_structure_calculatorMetrics): sales_commission_structure_calculatorAnalysis {
