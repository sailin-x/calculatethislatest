import { prenuptial_agreement_value_calculatorCalculatorInputs, prenuptial_agreement_value_calculatorCalculatorMetrics, prenuptial_agreement_value_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: prenuptial_agreement_value_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: prenuptial_agreement_value_calculatorCalculatorInputs, metrics: prenuptial_agreement_value_calculatorCalculatorMetrics): prenuptial_agreement_value_calculatorCalculatorAnalysis {
