import { management_consulting_fee_model_calculatorCalculatorInputs, management_consulting_fee_model_calculatorCalculatorMetrics, management_consulting_fee_model_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: management_consulting_fee_model_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: management_consulting_fee_model_calculatorCalculatorInputs, metrics: management_consulting_fee_model_calculatorCalculatorMetrics): management_consulting_fee_model_calculatorCalculatorAnalysis {
