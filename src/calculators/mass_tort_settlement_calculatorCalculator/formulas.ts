import { mass_tort_settlement_calculatorCalculatorInputs, mass_tort_settlement_calculatorCalculatorMetrics, mass_tort_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mass_tort_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: mass_tort_settlement_calculatorCalculatorInputs, metrics: mass_tort_settlement_calculatorCalculatorMetrics): mass_tort_settlement_calculatorCalculatorAnalysis {
