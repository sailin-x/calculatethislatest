import { dental_implant_roi_calculatorInputs, dental_implant_roi_calculatorMetrics, dental_implant_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: dental_implant_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: dental_implant_roi_calculatorInputs, metrics: dental_implant_roi_calculatorMetrics): dental_implant_roi_calculatorAnalysis {
