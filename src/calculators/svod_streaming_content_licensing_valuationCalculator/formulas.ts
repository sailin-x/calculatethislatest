import { svod_streaming_content_licensing_valuationCalculatorInputs, svod_streaming_content_licensing_valuationCalculatorMetrics, svod_streaming_content_licensing_valuationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: svod_streaming_content_licensing_valuationCalculatorInputs): number {
...
export function generateAnalysis(inputs: svod_streaming_content_licensing_valuationCalculatorInputs, metrics: svod_streaming_content_licensing_valuationCalculatorMetrics): svod_streaming_content_licensing_valuationCalculatorAnalysis {
