import { title_loan_calculatorInputs, title_loan_calculatorMetrics, title_loan_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: title_loan_calculatorInputs): number {
...
export function generateAnalysis(inputs: title_loan_calculatorInputs, metrics: title_loan_calculatorMetrics): title_loan_calculatorAnalysis {
