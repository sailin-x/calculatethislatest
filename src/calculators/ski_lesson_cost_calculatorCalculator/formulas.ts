import { ski_lesson_cost_calculatorCalculatorInputs, ski_lesson_cost_calculatorCalculatorMetrics, ski_lesson_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: ski_lesson_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: ski_lesson_cost_calculatorCalculatorInputs, metrics: ski_lesson_cost_calculatorCalculatorMetrics): ski_lesson_cost_calculatorCalculatorAnalysis {
