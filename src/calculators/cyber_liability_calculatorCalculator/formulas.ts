import { cyber_liability_calculatorCalculatorInputs, cyber_liability_calculatorCalculatorMetrics, cyber_liability_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cyber_liability_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cyber_liability_calculatorCalculatorInputs, metrics: cyber_liability_calculatorCalculatorMetrics): cyber_liability_calculatorCalculatorAnalysis {
