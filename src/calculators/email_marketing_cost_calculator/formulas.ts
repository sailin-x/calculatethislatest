import { email_marketing_cost_calculatorInputs, email_marketing_cost_calculatorMetrics, email_marketing_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: email_marketing_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: email_marketing_cost_calculatorInputs, metrics: email_marketing_cost_calculatorMetrics): email_marketing_cost_calculatorAnalysis {
