import { email_marketing_cost_calculatorInputs } from './types';

export function validateInputs(inputs: email_marketing_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
