import { kidnap_ransom_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: kidnap_ransom_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
