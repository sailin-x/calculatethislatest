import { kidnap_ransom_calculatorCalculatorInputs, kidnap_ransom_calculatorCalculatorMetrics, kidnap_ransom_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: kidnap_ransom_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: kidnap_ransom_calculatorCalculatorInputs, metrics: kidnap_ransom_calculatorCalculatorMetrics): kidnap_ransom_calculatorCalculatorAnalysis {
