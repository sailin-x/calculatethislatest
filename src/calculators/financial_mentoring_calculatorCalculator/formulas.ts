import { financial_mentoring_calculatorCalculatorInputs, financial_mentoring_calculatorCalculatorMetrics, financial_mentoring_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_mentoring_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_mentoring_calculatorCalculatorInputs, metrics: financial_mentoring_calculatorCalculatorMetrics): financial_mentoring_calculatorCalculatorAnalysis {
