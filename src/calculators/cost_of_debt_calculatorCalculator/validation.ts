import { cost_of_debt_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: cost_of_debt_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
