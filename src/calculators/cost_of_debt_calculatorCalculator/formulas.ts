import { cost_of_debt_calculatorCalculatorInputs, cost_of_debt_calculatorCalculatorMetrics, cost_of_debt_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cost_of_debt_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cost_of_debt_calculatorCalculatorInputs, metrics: cost_of_debt_calculatorCalculatorMetrics): cost_of_debt_calculatorCalculatorAnalysis {
