import { food_cost_calculatorInputs, food_cost_calculatorMetrics, food_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: food_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: food_cost_calculatorInputs, metrics: food_cost_calculatorMetrics): food_cost_calculatorAnalysis {
