import { calorie_deficit_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: calorie_deficit_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
