import { calorie_deficit_calculatorCalculatorInputs, calorie_deficit_calculatorCalculatorMetrics, calorie_deficit_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: calorie_deficit_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: calorie_deficit_calculatorCalculatorInputs, metrics: calorie_deficit_calculatorCalculatorMetrics): calorie_deficit_calculatorCalculatorAnalysis {
