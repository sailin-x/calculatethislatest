import { cost_segregation_depreciationCalculatorInputs, cost_segregation_depreciationCalculatorMetrics, cost_segregation_depreciationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cost_segregation_depreciationCalculatorInputs): number {
...
export function generateAnalysis(inputs: cost_segregation_depreciationCalculatorInputs, metrics: cost_segregation_depreciationCalculatorMetrics): cost_segregation_depreciationCalculatorAnalysis {
