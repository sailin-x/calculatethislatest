import { cost_segregation_depreciationCalculatorInputs } from './types';

export function validateInputs(inputs: cost_segregation_depreciationCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
