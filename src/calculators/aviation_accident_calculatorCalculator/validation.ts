import { aviation_accident_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: aviation_accident_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
