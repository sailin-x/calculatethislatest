import { aviation_accident_calculatorCalculatorInputs, aviation_accident_calculatorCalculatorMetrics, aviation_accident_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: aviation_accident_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: aviation_accident_calculatorCalculatorInputs, metrics: aviation_accident_calculatorCalculatorMetrics): aviation_accident_calculatorCalculatorAnalysis {
