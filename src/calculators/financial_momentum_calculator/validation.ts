import { financial_momentum_calculatorInputs } from './types';

export function validateInputs(inputs: financial_momentum_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
