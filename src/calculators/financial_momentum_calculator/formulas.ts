import { financial_momentum_calculatorInputs, financial_momentum_calculatorMetrics, financial_momentum_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_momentum_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_momentum_calculatorInputs, metrics: financial_momentum_calculatorMetrics): financial_momentum_calculatorAnalysis {
