import { growth_hormone_calculatorInputs, growth_hormone_calculatorMetrics, growth_hormone_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: growth_hormone_calculatorInputs): number {
...
export function generateAnalysis(inputs: growth_hormone_calculatorInputs, metrics: growth_hormone_calculatorMetrics): growth_hormone_calculatorAnalysis {
