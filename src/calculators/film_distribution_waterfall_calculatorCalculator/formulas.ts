import { film_distribution_waterfall_calculatorCalculatorInputs, film_distribution_waterfall_calculatorCalculatorMetrics, film_distribution_waterfall_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: film_distribution_waterfall_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: film_distribution_waterfall_calculatorCalculatorInputs, metrics: film_distribution_waterfall_calculatorCalculatorMetrics): film_distribution_waterfall_calculatorCalculatorAnalysis {
