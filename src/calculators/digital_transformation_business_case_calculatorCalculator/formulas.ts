import { digital_transformation_business_case_calculatorCalculatorInputs, digital_transformation_business_case_calculatorCalculatorMetrics, digital_transformation_business_case_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: digital_transformation_business_case_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: digital_transformation_business_case_calculatorCalculatorInputs, metrics: digital_transformation_business_case_calculatorCalculatorMetrics): digital_transformation_business_case_calculatorCalculatorAnalysis {
