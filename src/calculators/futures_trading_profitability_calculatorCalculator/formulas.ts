import { futures_trading_profitability_calculatorCalculatorInputs, futures_trading_profitability_calculatorCalculatorMetrics, futures_trading_profitability_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: futures_trading_profitability_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: futures_trading_profitability_calculatorCalculatorInputs, metrics: futures_trading_profitability_calculatorCalculatorMetrics): futures_trading_profitability_calculatorCalculatorAnalysis {
