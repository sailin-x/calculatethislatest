import { intermittent_fasting_calculatorInputs } from './types';

export function validateInputs(inputs: intermittent_fasting_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
