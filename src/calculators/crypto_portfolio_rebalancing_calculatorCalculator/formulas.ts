import { crypto_portfolio_rebalancing_calculatorCalculatorInputs, crypto_portfolio_rebalancing_calculatorCalculatorMetrics, crypto_portfolio_rebalancing_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: crypto_portfolio_rebalancing_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: crypto_portfolio_rebalancing_calculatorCalculatorInputs, metrics: crypto_portfolio_rebalancing_calculatorCalculatorMetrics): crypto_portfolio_rebalancing_calculatorCalculatorAnalysis {
