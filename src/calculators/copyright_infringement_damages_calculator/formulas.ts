import { copyright_infringement_damages_calculatorInputs, copyright_infringement_damages_calculatorMetrics, copyright_infringement_damages_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: copyright_infringement_damages_calculatorInputs): number {
...
export function generateAnalysis(inputs: copyright_infringement_damages_calculatorInputs, metrics: copyright_infringement_damages_calculatorMetrics): copyright_infringement_damages_calculatorAnalysis {
