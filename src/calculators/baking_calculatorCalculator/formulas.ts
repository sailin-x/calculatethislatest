import { baking_calculatorCalculatorInputs, baking_calculatorCalculatorMetrics, baking_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: baking_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: baking_calculatorCalculatorInputs, metrics: baking_calculatorCalculatorMetrics): baking_calculatorCalculatorAnalysis {
