import { baking_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: baking_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
