import { chemistry_calculatorCalculatorInputs, chemistry_calculatorCalculatorMetrics, chemistry_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: chemistry_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: chemistry_calculatorCalculatorInputs, metrics: chemistry_calculatorCalculatorMetrics): chemistry_calculatorCalculatorAnalysis {
