import { real_estate_depreciation_schedule_calculatorCalculatorInputs, real_estate_depreciation_schedule_calculatorCalculatorMetrics, real_estate_depreciation_schedule_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: real_estate_depreciation_schedule_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: real_estate_depreciation_schedule_calculatorCalculatorInputs, metrics: real_estate_depreciation_schedule_calculatorCalculatorMetrics): real_estate_depreciation_schedule_calculatorCalculatorAnalysis {
