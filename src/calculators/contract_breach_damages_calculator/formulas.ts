import { contract_breach_damages_calculatorInputs, contract_breach_damages_calculatorMetrics, contract_breach_damages_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: contract_breach_damages_calculatorInputs): number {
...
export function generateAnalysis(inputs: contract_breach_damages_calculatorInputs, metrics: contract_breach_damages_calculatorMetrics): contract_breach_damages_calculatorAnalysis {
