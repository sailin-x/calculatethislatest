import { realEstateTaxDeductionsCalculatorInputs, realEstateTaxDeductionsCalculatorMetrics, realEstateTaxDeductionsCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: realEstateTaxDeductionsCalculatorInputs): number {
...
export function generateAnalysis(inputs: realEstateTaxDeductionsCalculatorInputs, metrics: realEstateTaxDeductionsCalculatorMetrics): realEstateTaxDeductionsCalculatorAnalysis {
