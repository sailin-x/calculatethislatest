import { quick_ratio_calculatorCalculatorInputs, quick_ratio_calculatorCalculatorMetrics, quick_ratio_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: quick_ratio_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: quick_ratio_calculatorCalculatorInputs, metrics: quick_ratio_calculatorCalculatorMetrics): quick_ratio_calculatorCalculatorAnalysis {
