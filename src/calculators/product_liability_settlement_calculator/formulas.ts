import { product_liability_settlement_calculatorInputs, product_liability_settlement_calculatorMetrics, product_liability_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: product_liability_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: product_liability_settlement_calculatorInputs, metrics: product_liability_settlement_calculatorMetrics): product_liability_settlement_calculatorAnalysis {
