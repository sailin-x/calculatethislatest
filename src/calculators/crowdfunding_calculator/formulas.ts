import { crowdfunding_calculatorInputs, crowdfunding_calculatorMetrics, crowdfunding_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: crowdfunding_calculatorInputs): number {
...
export function generateAnalysis(inputs: crowdfunding_calculatorInputs, metrics: crowdfunding_calculatorMetrics): crowdfunding_calculatorAnalysis {
