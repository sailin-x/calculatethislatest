import { heart_rate_zone_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: heart_rate_zone_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
