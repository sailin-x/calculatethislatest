import { heart_rate_zone_calculatorCalculatorInputs, heart_rate_zone_calculatorCalculatorMetrics, heart_rate_zone_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: heart_rate_zone_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: heart_rate_zone_calculatorCalculatorInputs, metrics: heart_rate_zone_calculatorCalculatorMetrics): heart_rate_zone_calculatorCalculatorAnalysis {
