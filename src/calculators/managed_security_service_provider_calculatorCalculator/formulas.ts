import { managed_security_service_provider_calculatorCalculatorInputs, managed_security_service_provider_calculatorCalculatorMetrics, managed_security_service_provider_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: managed_security_service_provider_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: managed_security_service_provider_calculatorCalculatorInputs, metrics: managed_security_service_provider_calculatorCalculatorMetrics): managed_security_service_provider_calculatorCalculatorAnalysis {
