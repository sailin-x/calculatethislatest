import { biological_age_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: biological_age_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
