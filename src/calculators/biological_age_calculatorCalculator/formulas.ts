import { biological_age_calculatorCalculatorInputs, biological_age_calculatorCalculatorMetrics, biological_age_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: biological_age_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: biological_age_calculatorCalculatorInputs, metrics: biological_age_calculatorCalculatorMetrics): biological_age_calculatorCalculatorAnalysis {
