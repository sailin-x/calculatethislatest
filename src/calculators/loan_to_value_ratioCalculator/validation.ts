import { loan_to_value_ratioCalculatorInputs } from './types';

export function validateInputs(inputs: loan_to_value_ratioCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
