import { loan_to_value_ratioCalculatorInputs, loan_to_value_ratioCalculatorMetrics, loan_to_value_ratioCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: loan_to_value_ratioCalculatorInputs): number {
...
export function generateAnalysis(inputs: loan_to_value_ratioCalculatorInputs, metrics: loan_to_value_ratioCalculatorMetrics): loan_to_value_ratioCalculatorAnalysis {
