import { landed_cost_calculatorCalculatorInputs, landed_cost_calculatorCalculatorMetrics, landed_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: landed_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: landed_cost_calculatorCalculatorInputs, metrics: landed_cost_calculatorCalculatorMetrics): landed_cost_calculatorCalculatorAnalysis {
