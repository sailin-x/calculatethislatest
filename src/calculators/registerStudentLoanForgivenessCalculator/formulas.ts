import { registerStudentLoanForgivenessCalculatorInputs, registerStudentLoanForgivenessCalculatorMetrics, registerStudentLoanForgivenessCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerStudentLoanForgivenessCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerStudentLoanForgivenessCalculatorInputs, metrics: registerStudentLoanForgivenessCalculatorMetrics): registerStudentLoanForgivenessCalculatorAnalysis {
