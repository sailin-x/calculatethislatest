import { registerStudentLoanForgivenessCalculatorInputs } from './types';

export function validateInputs(inputs: registerStudentLoanForgivenessCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
