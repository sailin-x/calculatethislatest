import { tenant_improvement_ti_allowance_calculatorCalculatorInputs, tenant_improvement_ti_allowance_calculatorCalculatorMetrics, tenant_improvement_ti_allowance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: tenant_improvement_ti_allowance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: tenant_improvement_ti_allowance_calculatorCalculatorInputs, metrics: tenant_improvement_ti_allowance_calculatorCalculatorMetrics): tenant_improvement_ti_allowance_calculatorCalculatorAnalysis {
