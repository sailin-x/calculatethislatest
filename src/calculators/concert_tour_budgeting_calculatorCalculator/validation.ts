import { concert_tour_budgeting_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: concert_tour_budgeting_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
