import { concert_tour_budgeting_calculatorCalculatorInputs, concert_tour_budgeting_calculatorCalculatorMetrics, concert_tour_budgeting_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: concert_tour_budgeting_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: concert_tour_budgeting_calculatorCalculatorInputs, metrics: concert_tour_budgeting_calculatorCalculatorMetrics): concert_tour_budgeting_calculatorCalculatorAnalysis {
