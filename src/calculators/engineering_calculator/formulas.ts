import { engineering_calculatorInputs, engineering_calculatorMetrics, engineering_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: engineering_calculatorInputs): number {
...
export function generateAnalysis(inputs: engineering_calculatorInputs, metrics: engineering_calculatorMetrics): engineering_calculatorAnalysis {
