import { it_outsourcing_vs_in_house_calculatorInputs, it_outsourcing_vs_in_house_calculatorMetrics, it_outsourcing_vs_in_house_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: it_outsourcing_vs_in_house_calculatorInputs): number {
...
export function generateAnalysis(inputs: it_outsourcing_vs_in_house_calculatorInputs, metrics: it_outsourcing_vs_in_house_calculatorMetrics): it_outsourcing_vs_in_house_calculatorAnalysis {
