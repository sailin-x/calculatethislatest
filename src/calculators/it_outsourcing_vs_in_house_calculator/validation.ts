import { it_outsourcing_vs_in_house_calculatorInputs } from './types';

export function validateInputs(inputs: it_outsourcing_vs_in_house_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
