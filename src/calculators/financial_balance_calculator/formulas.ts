import { financial_balance_calculatorInputs, financial_balance_calculatorMetrics, financial_balance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_balance_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_balance_calculatorInputs, metrics: financial_balance_calculatorMetrics): financial_balance_calculatorAnalysis {
