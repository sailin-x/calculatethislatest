import { political_risk_insurance_calculatorInputs, political_risk_insurance_calculatorMetrics, political_risk_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: political_risk_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: political_risk_insurance_calculatorInputs, metrics: political_risk_insurance_calculatorMetrics): political_risk_insurance_calculatorAnalysis {
