import { medical_device_royalty_rate_calculatorCalculatorInputs, medical_device_royalty_rate_calculatorCalculatorMetrics, medical_device_royalty_rate_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: medical_device_royalty_rate_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: medical_device_royalty_rate_calculatorCalculatorInputs, metrics: medical_device_royalty_rate_calculatorCalculatorMetrics): medical_device_royalty_rate_calculatorCalculatorAnalysis {
