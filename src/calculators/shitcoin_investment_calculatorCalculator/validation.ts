import { shitcoin_investment_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: shitcoin_investment_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
