import { shitcoin_investment_calculatorCalculatorInputs, shitcoin_investment_calculatorCalculatorMetrics, shitcoin_investment_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: shitcoin_investment_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: shitcoin_investment_calculatorCalculatorInputs, metrics: shitcoin_investment_calculatorCalculatorMetrics): shitcoin_investment_calculatorCalculatorAnalysis {
