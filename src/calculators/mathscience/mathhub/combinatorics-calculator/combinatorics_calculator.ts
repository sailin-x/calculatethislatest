...
export const combinatorics_calculatorCalculator: Calculator = {
  ...
  subcategory: 'mathhub',
  description: 'Calculate Combinatorics Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Combinatorics Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Combinatorics Calculator calculation',
