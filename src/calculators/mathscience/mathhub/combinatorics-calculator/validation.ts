import { combinatorics_calculatorInputs } from './types';
...
export function validatecombinatorics_calculatorInputs(inputs: combinatorics_calculatorInputs): ValidationResult[] {
...
export function validatecombinatorics_calculatorBusinessRules(inputs: combinatorics_calculatorInputs): ValidationResult[] {
