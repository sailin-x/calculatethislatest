import { media_mix_modeling_mmm_roi_calculatorInputs, media_mix_modeling_mmm_roi_calculatorMetrics, media_mix_modeling_mmm_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: media_mix_modeling_mmm_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: media_mix_modeling_mmm_roi_calculatorInputs, metrics: media_mix_modeling_mmm_roi_calculatorMetrics): media_mix_modeling_mmm_roi_calculatorAnalysis {
