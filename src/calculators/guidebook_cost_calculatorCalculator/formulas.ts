import { guidebook_cost_calculatorCalculatorInputs, guidebook_cost_calculatorCalculatorMetrics, guidebook_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: guidebook_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: guidebook_cost_calculatorCalculatorInputs, metrics: guidebook_cost_calculatorCalculatorMetrics): guidebook_cost_calculatorCalculatorAnalysis {
