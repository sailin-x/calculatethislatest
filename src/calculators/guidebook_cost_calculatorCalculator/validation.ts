import { guidebook_cost_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: guidebook_cost_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
