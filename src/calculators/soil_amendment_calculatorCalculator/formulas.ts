import { soil_amendment_calculatorCalculatorInputs, soil_amendment_calculatorCalculatorMetrics, soil_amendment_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: soil_amendment_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: soil_amendment_calculatorCalculatorInputs, metrics: soil_amendment_calculatorCalculatorMetrics): soil_amendment_calculatorCalculatorAnalysis {
