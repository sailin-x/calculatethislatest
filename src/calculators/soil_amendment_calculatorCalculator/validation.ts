import { soil_amendment_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: soil_amendment_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
