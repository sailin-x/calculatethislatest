import { debt_snowball_calculatorInputs, debt_snowball_calculatorMetrics, debt_snowball_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_snowball_calculatorInputs): number {
...
export function generateAnalysis(inputs: debt_snowball_calculatorInputs, metrics: debt_snowball_calculatorMetrics): debt_snowball_calculatorAnalysis {
