import { kidnap_ransom_calculatorInputs, kidnap_ransom_calculatorMetrics, kidnap_ransom_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: kidnap_ransom_calculatorInputs): number {
...
export function generateAnalysis(inputs: kidnap_ransom_calculatorInputs, metrics: kidnap_ransom_calculatorMetrics): kidnap_ransom_calculatorAnalysis {
