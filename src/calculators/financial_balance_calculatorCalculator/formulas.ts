import { financial_balance_calculatorCalculatorInputs, financial_balance_calculatorCalculatorMetrics, financial_balance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_balance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_balance_calculatorCalculatorInputs, metrics: financial_balance_calculatorCalculatorMetrics): financial_balance_calculatorCalculatorAnalysis {
