import { gross_margin_calculatorInputs, gross_margin_calculatorMetrics, gross_margin_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: gross_margin_calculatorInputs): number {
...
export function generateAnalysis(inputs: gross_margin_calculatorInputs, metrics: gross_margin_calculatorMetrics): gross_margin_calculatorAnalysis {
