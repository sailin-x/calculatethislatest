import { net_unrealized_appreciation_nua_tax_calculatorCalculatorInputs, net_unrealized_appreciation_nua_tax_calculatorCalculatorMetrics, net_unrealized_appreciation_nua_tax_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: net_unrealized_appreciation_nua_tax_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: net_unrealized_appreciation_nua_tax_calculatorCalculatorInputs, metrics: net_unrealized_appreciation_nua_tax_calculatorCalculatorMetrics): net_unrealized_appreciation_nua_tax_calculatorCalculatorAnalysis {
