import { debt_consolidation_loan_calculatorInputs, debt_consolidation_loan_calculatorMetrics, debt_consolidation_loan_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_consolidation_loan_calculatorInputs): number {
...
export function generateAnalysis(inputs: debt_consolidation_loan_calculatorInputs, metrics: debt_consolidation_loan_calculatorMetrics): debt_consolidation_loan_calculatorAnalysis {
