import { enterprise_value_calculatorInputs, enterprise_value_calculatorMetrics, enterprise_value_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: enterprise_value_calculatorInputs): number {
...
export function generateAnalysis(inputs: enterprise_value_calculatorInputs, metrics: enterprise_value_calculatorMetrics): enterprise_value_calculatorAnalysis {
