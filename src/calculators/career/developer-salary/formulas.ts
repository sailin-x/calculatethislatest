import { developer-salaryInputs, developer-salaryMetrics, developer-salaryAnalysis } from './types';
...
export function calculateResult(inputs: developer-salaryInputs): number {
...
export function generateAnalysis(inputs: developer-salaryInputs, metrics: developer-salaryMetrics): developer-salaryAnalysis {
