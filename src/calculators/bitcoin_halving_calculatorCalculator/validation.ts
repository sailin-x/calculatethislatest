import { bitcoin_halving_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: bitcoin_halving_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
