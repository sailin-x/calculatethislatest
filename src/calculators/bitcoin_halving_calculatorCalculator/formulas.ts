import { bitcoin_halving_calculatorCalculatorInputs, bitcoin_halving_calculatorCalculatorMetrics, bitcoin_halving_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: bitcoin_halving_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: bitcoin_halving_calculatorCalculatorInputs, metrics: bitcoin_halving_calculatorCalculatorMetrics): bitcoin_halving_calculatorCalculatorAnalysis {
