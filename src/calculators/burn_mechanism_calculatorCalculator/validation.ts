import { burn_mechanism_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: burn_mechanism_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
