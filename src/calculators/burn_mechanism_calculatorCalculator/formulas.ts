import { burn_mechanism_calculatorCalculatorInputs, burn_mechanism_calculatorCalculatorMetrics, burn_mechanism_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: burn_mechanism_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: burn_mechanism_calculatorCalculatorInputs, metrics: burn_mechanism_calculatorCalculatorMetrics): burn_mechanism_calculatorCalculatorAnalysis {
