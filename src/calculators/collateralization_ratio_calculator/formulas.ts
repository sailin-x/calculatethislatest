import { collateralization_ratio_calculatorInputs, collateralization_ratio_calculatorMetrics, collateralization_ratio_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: collateralization_ratio_calculatorInputs): number {
...
export function generateAnalysis(inputs: collateralization_ratio_calculatorInputs, metrics: collateralization_ratio_calculatorMetrics): collateralization_ratio_calculatorAnalysis {
