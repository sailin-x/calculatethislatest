import { home_insuranceCalculatorInputs, home_insuranceCalculatorMetrics, home_insuranceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: home_insuranceCalculatorInputs): number {
...
export function generateAnalysis(inputs: home_insuranceCalculatorInputs, metrics: home_insuranceCalculatorMetrics): home_insuranceCalculatorAnalysis {
