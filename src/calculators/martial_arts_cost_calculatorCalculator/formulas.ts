import { martial_arts_cost_calculatorCalculatorInputs, martial_arts_cost_calculatorCalculatorMetrics, martial_arts_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: martial_arts_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: martial_arts_cost_calculatorCalculatorInputs, metrics: martial_arts_cost_calculatorCalculatorMetrics): martial_arts_cost_calculatorCalculatorAnalysis {
