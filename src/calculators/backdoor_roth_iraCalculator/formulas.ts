import { backdoor_roth_iraCalculatorInputs, backdoor_roth_iraCalculatorMetrics, backdoor_roth_iraCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: backdoor_roth_iraCalculatorInputs): number {
...
export function generateAnalysis(inputs: backdoor_roth_iraCalculatorInputs, metrics: backdoor_roth_iraCalculatorMetrics): backdoor_roth_iraCalculatorAnalysis {
