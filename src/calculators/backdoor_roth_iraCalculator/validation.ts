import { backdoor_roth_iraCalculatorInputs } from './types';

export function validateInputs(inputs: backdoor_roth_iraCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
