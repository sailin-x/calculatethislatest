import { timberland_investment_calculatorInputs } from './types';

export function validateInputs(inputs: timberland_investment_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
