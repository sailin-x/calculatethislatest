import { timberland_investment_calculatorInputs, timberland_investment_calculatorMetrics, timberland_investment_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: timberland_investment_calculatorInputs): number {
...
export function generateAnalysis(inputs: timberland_investment_calculatorInputs, metrics: timberland_investment_calculatorMetrics): timberland_investment_calculatorAnalysis {
