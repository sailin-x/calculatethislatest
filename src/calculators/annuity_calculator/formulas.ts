import { annuity_calculatorInputs, annuity_calculatorMetrics, annuity_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: annuity_calculatorInputs): number {
...
export function generateAnalysis(inputs: annuity_calculatorInputs, metrics: annuity_calculatorMetrics): annuity_calculatorAnalysis {
