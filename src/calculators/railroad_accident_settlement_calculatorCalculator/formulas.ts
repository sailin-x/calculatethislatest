import { railroad_accident_settlement_calculatorCalculatorInputs, railroad_accident_settlement_calculatorCalculatorMetrics, railroad_accident_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: railroad_accident_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: railroad_accident_settlement_calculatorCalculatorInputs, metrics: railroad_accident_settlement_calculatorCalculatorMetrics): railroad_accident_settlement_calculatorCalculatorAnalysis {
