import { financial_independence_calculatorInputs } from './types';

export function validateInputs(inputs: financial_independence_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
