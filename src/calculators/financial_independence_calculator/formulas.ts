import { financial_independence_calculatorInputs, financial_independence_calculatorMetrics, financial_independence_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_independence_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_independence_calculatorInputs, metrics: financial_independence_calculatorMetrics): financial_independence_calculatorAnalysis {
