import { merchant_cash_advance_calculatorInputs, merchant_cash_advance_calculatorMetrics, merchant_cash_advance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: merchant_cash_advance_calculatorInputs): number {
...
export function generateAnalysis(inputs: merchant_cash_advance_calculatorInputs, metrics: merchant_cash_advance_calculatorMetrics): merchant_cash_advance_calculatorAnalysis {
