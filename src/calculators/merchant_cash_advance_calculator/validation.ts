import { merchant_cash_advance_calculatorInputs } from './types';

export function validateInputs(inputs: merchant_cash_advance_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
