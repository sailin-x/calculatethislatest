import { blockchain_calculatorCalculatorInputs, blockchain_calculatorCalculatorMetrics, blockchain_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: blockchain_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: blockchain_calculatorCalculatorInputs, metrics: blockchain_calculatorCalculatorMetrics): blockchain_calculatorCalculatorAnalysis {
