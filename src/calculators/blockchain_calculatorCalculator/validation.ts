import { blockchain_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: blockchain_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
