import { recipe_scaling_calculatorCalculatorInputs, recipe_scaling_calculatorCalculatorMetrics, recipe_scaling_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: recipe_scaling_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: recipe_scaling_calculatorCalculatorInputs, metrics: recipe_scaling_calculatorCalculatorMetrics): recipe_scaling_calculatorCalculatorAnalysis {
