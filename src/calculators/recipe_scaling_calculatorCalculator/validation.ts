import { recipe_scaling_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: recipe_scaling_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
