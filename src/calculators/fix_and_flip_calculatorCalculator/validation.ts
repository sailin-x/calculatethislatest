import { fix_and_flip_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: fix_and_flip_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
