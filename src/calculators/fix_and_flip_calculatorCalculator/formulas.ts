import { fix_and_flip_calculatorCalculatorInputs, fix_and_flip_calculatorCalculatorMetrics, fix_and_flip_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fix_and_flip_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: fix_and_flip_calculatorCalculatorInputs, metrics: fix_and_flip_calculatorCalculatorMetrics): fix_and_flip_calculatorCalculatorAnalysis {
