import { cosmetic_surgery_cost_calculatorCalculatorInputs, cosmetic_surgery_cost_calculatorCalculatorMetrics, cosmetic_surgery_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cosmetic_surgery_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cosmetic_surgery_cost_calculatorCalculatorInputs, metrics: cosmetic_surgery_cost_calculatorCalculatorMetrics): cosmetic_surgery_cost_calculatorCalculatorAnalysis {
