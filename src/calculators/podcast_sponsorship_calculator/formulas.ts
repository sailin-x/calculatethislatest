import { podcast_sponsorship_calculatorInputs, podcast_sponsorship_calculatorMetrics, podcast_sponsorship_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: podcast_sponsorship_calculatorInputs): number {
...
export function generateAnalysis(inputs: podcast_sponsorship_calculatorInputs, metrics: podcast_sponsorship_calculatorMetrics): podcast_sponsorship_calculatorAnalysis {
