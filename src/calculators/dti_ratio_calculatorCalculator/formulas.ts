import { dti_ratio_calculatorCalculatorInputs, dti_ratio_calculatorCalculatorMetrics, dti_ratio_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: dti_ratio_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: dti_ratio_calculatorCalculatorInputs, metrics: dti_ratio_calculatorCalculatorMetrics): dti_ratio_calculatorCalculatorAnalysis {
