import { dti_ratio_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: dti_ratio_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
