import { camping_cost_calculatorCalculatorInputs, camping_cost_calculatorCalculatorMetrics, camping_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: camping_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: camping_cost_calculatorCalculatorInputs, metrics: camping_cost_calculatorCalculatorMetrics): camping_cost_calculatorCalculatorAnalysis {
