import { concrete_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: concrete_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
