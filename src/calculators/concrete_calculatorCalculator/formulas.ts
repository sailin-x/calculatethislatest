import { concrete_calculatorCalculatorInputs, concrete_calculatorCalculatorMetrics, concrete_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: concrete_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: concrete_calculatorCalculatorInputs, metrics: concrete_calculatorCalculatorMetrics): concrete_calculatorCalculatorAnalysis {
