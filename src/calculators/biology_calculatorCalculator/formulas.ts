import { biology_calculatorCalculatorInputs, biology_calculatorCalculatorMetrics, biology_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: biology_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: biology_calculatorCalculatorInputs, metrics: biology_calculatorCalculatorMetrics): biology_calculatorCalculatorAnalysis {
