import { biology_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: biology_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
