import { business_risk_assessment_calculatorInputs, business_risk_assessment_calculatorMetrics, business_risk_assessment_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_risk_assessment_calculatorInputs): number {
...
export function generateAnalysis(inputs: business_risk_assessment_calculatorInputs, metrics: business_risk_assessment_calculatorMetrics): business_risk_assessment_calculatorAnalysis {
