import { medical_device_liability_calculatorInputs, medical_device_liability_calculatorMetrics, medical_device_liability_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: medical_device_liability_calculatorInputs): number {
...
export function generateAnalysis(inputs: medical_device_liability_calculatorInputs, metrics: medical_device_liability_calculatorMetrics): medical_device_liability_calculatorAnalysis {
