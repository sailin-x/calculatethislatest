import { sponsorship_roi_calculatorInputs, sponsorship_roi_calculatorMetrics, sponsorship_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: sponsorship_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: sponsorship_roi_calculatorInputs, metrics: sponsorship_roi_calculatorMetrics): sponsorship_roi_calculatorAnalysis {
