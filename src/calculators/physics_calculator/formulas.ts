import { physics_calculatorInputs, physics_calculatorMetrics, physics_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: physics_calculatorInputs): number {
...
export function generateAnalysis(inputs: physics_calculatorInputs, metrics: physics_calculatorMetrics): physics_calculatorAnalysis {
