import { credit_card_payoff_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: credit_card_payoff_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
