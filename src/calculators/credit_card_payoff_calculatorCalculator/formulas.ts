import { credit_card_payoff_calculatorCalculatorInputs, credit_card_payoff_calculatorCalculatorMetrics, credit_card_payoff_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: credit_card_payoff_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: credit_card_payoff_calculatorCalculatorInputs, metrics: credit_card_payoff_calculatorCalculatorMetrics): credit_card_payoff_calculatorCalculatorAnalysis {
