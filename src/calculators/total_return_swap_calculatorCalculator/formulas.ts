import { total_return_swap_calculatorCalculatorInputs, total_return_swap_calculatorCalculatorMetrics, total_return_swap_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: total_return_swap_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: total_return_swap_calculatorCalculatorInputs, metrics: total_return_swap_calculatorCalculatorMetrics): total_return_swap_calculatorCalculatorAnalysis {
