import { total_return_swap_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: total_return_swap_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
