import { homeopathy_cost_calculatorInputs } from './types';

export function validateInputs(inputs: homeopathy_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
