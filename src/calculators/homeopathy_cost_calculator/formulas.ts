import { homeopathy_cost_calculatorInputs, homeopathy_cost_calculatorMetrics, homeopathy_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: homeopathy_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: homeopathy_cost_calculatorInputs, metrics: homeopathy_cost_calculatorMetrics): homeopathy_cost_calculatorAnalysis {
