import { epa_fine_penalty_calculatorInputs, epa_fine_penalty_calculatorMetrics, epa_fine_penalty_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: epa_fine_penalty_calculatorInputs): number {
...
export function generateAnalysis(inputs: epa_fine_penalty_calculatorInputs, metrics: epa_fine_penalty_calculatorMetrics): epa_fine_penalty_calculatorAnalysis {
