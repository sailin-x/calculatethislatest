import { internal_rate_of_return_calculatorCalculatorInputs, internal_rate_of_return_calculatorCalculatorMetrics, internal_rate_of_return_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: internal_rate_of_return_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: internal_rate_of_return_calculatorCalculatorInputs, metrics: internal_rate_of_return_calculatorCalculatorMetrics): internal_rate_of_return_calculatorCalculatorAnalysis {
