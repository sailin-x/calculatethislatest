import { day_trading_calculatorCalculatorInputs, day_trading_calculatorCalculatorMetrics, day_trading_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: day_trading_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: day_trading_calculatorCalculatorInputs, metrics: day_trading_calculatorCalculatorMetrics): day_trading_calculatorCalculatorAnalysis {
