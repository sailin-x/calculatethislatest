import { day_trading_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: day_trading_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
