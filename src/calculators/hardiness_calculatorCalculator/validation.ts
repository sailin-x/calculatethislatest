import { hardiness_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: hardiness_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
