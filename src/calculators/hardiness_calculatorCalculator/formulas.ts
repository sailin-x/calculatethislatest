import { hardiness_calculatorCalculatorInputs, hardiness_calculatorCalculatorMetrics, hardiness_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hardiness_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: hardiness_calculatorCalculatorInputs, metrics: hardiness_calculatorCalculatorMetrics): hardiness_calculatorCalculatorAnalysis {
