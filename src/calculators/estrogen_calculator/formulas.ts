import { estrogen_calculatorInputs, estrogen_calculatorMetrics, estrogen_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: estrogen_calculatorInputs): number {
...
export function generateAnalysis(inputs: estrogen_calculatorInputs, metrics: estrogen_calculatorMetrics): estrogen_calculatorAnalysis {
