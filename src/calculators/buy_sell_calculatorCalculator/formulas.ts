import { buy_sell_calculatorCalculatorInputs, buy_sell_calculatorCalculatorMetrics, buy_sell_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: buy_sell_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: buy_sell_calculatorCalculatorInputs, metrics: buy_sell_calculatorCalculatorMetrics): buy_sell_calculatorCalculatorAnalysis {
