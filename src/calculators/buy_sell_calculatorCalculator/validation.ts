import { buy_sell_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: buy_sell_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
