import { podcast_cost_calculatorInputs, podcast_cost_calculatorMetrics, podcast_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: podcast_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: podcast_cost_calculatorInputs, metrics: podcast_cost_calculatorMetrics): podcast_cost_calculatorAnalysis {
