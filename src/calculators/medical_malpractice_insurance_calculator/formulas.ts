import { medical_malpractice_insurance_calculatorInputs, medical_malpractice_insurance_calculatorMetrics, medical_malpractice_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: medical_malpractice_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: medical_malpractice_insurance_calculatorInputs, metrics: medical_malpractice_insurance_calculatorMetrics): medical_malpractice_insurance_calculatorAnalysis {
