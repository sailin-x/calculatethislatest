import { internal_rate_of_return_calculatorInputs, internal_rate_of_return_calculatorMetrics, internal_rate_of_return_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: internal_rate_of_return_calculatorInputs): number {
...
export function generateAnalysis(inputs: internal_rate_of_return_calculatorInputs, metrics: internal_rate_of_return_calculatorMetrics): internal_rate_of_return_calculatorAnalysis {
