import { mortgage_closing_costCalculatorInputs, mortgage_closing_costCalculatorMetrics, mortgage_closing_costCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgage_closing_costCalculatorInputs): number {
...
export function generateAnalysis(inputs: mortgage_closing_costCalculatorInputs, metrics: mortgage_closing_costCalculatorMetrics): mortgage_closing_costCalculatorAnalysis {
