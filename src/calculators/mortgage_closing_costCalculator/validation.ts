import { mortgage_closing_costCalculatorInputs } from './types';

export function validateInputs(inputs: mortgage_closing_costCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
