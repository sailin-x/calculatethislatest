import { financial_fulfillment_calculatorInputs, financial_fulfillment_calculatorMetrics, financial_fulfillment_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_fulfillment_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_fulfillment_calculatorInputs, metrics: financial_fulfillment_calculatorMetrics): financial_fulfillment_calculatorAnalysis {
