import { financial_fulfillment_calculatorInputs } from './types';

export function validateInputs(inputs: financial_fulfillment_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
