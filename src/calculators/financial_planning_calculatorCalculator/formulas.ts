import { financial_planning_calculatorCalculatorInputs, financial_planning_calculatorCalculatorMetrics, financial_planning_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_planning_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_planning_calculatorCalculatorInputs, metrics: financial_planning_calculatorCalculatorMetrics): financial_planning_calculatorCalculatorAnalysis {
