import { financial_planning_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: financial_planning_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
