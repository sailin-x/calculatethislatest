import { managed_security_service_provider_calculatorInputs, managed_security_service_provider_calculatorMetrics, managed_security_service_provider_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: managed_security_service_provider_calculatorInputs): number {
...
export function generateAnalysis(inputs: managed_security_service_provider_calculatorInputs, metrics: managed_security_service_provider_calculatorMetrics): managed_security_service_provider_calculatorAnalysis {
