import { registerTenantImprovementAllowanceCalculatorInputs, registerTenantImprovementAllowanceCalculatorMetrics, registerTenantImprovementAllowanceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerTenantImprovementAllowanceCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerTenantImprovementAllowanceCalculatorInputs, metrics: registerTenantImprovementAllowanceCalculatorMetrics): registerTenantImprovementAllowanceCalculatorAnalysis {
