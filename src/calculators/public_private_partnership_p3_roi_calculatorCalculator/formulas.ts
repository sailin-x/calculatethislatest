import { public_private_partnership_p3_roi_calculatorCalculatorInputs, public_private_partnership_p3_roi_calculatorCalculatorMetrics, public_private_partnership_p3_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: public_private_partnership_p3_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: public_private_partnership_p3_roi_calculatorCalculatorInputs, metrics: public_private_partnership_p3_roi_calculatorCalculatorMetrics): public_private_partnership_p3_roi_calculatorCalculatorAnalysis {
