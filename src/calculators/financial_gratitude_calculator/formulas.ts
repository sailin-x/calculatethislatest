import { financial_gratitude_calculatorInputs, financial_gratitude_calculatorMetrics, financial_gratitude_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_gratitude_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_gratitude_calculatorInputs, metrics: financial_gratitude_calculatorMetrics): financial_gratitude_calculatorAnalysis {
