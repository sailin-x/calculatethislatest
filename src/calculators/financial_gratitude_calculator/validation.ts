import { financial_gratitude_calculatorInputs } from './types';

export function validateInputs(inputs: financial_gratitude_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
