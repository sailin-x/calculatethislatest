import { ad_agency_commission_vs_fee_model_calculatorCalculatorInputs, ad_agency_commission_vs_fee_model_calculatorCalculatorMetrics, ad_agency_commission_vs_fee_model_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: ad_agency_commission_vs_fee_model_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: ad_agency_commission_vs_fee_model_calculatorCalculatorInputs, metrics: ad_agency_commission_vs_fee_model_calculatorCalculatorMetrics): ad_agency_commission_vs_fee_model_calculatorCalculatorAnalysis {
