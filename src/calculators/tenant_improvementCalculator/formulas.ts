import { tenant_improvementCalculatorInputs, tenant_improvementCalculatorMetrics, tenant_improvementCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: tenant_improvementCalculatorInputs): number {
...
export function generateAnalysis(inputs: tenant_improvementCalculatorInputs, metrics: tenant_improvementCalculatorMetrics): tenant_improvementCalculatorAnalysis {
