import { tenant_improvementCalculatorInputs } from './types';

export function validateInputs(inputs: tenant_improvementCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
