import { copyright_registration_calculatorInputs, copyright_registration_calculatorMetrics, copyright_registration_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: copyright_registration_calculatorInputs): number {
...
export function generateAnalysis(inputs: copyright_registration_calculatorInputs, metrics: copyright_registration_calculatorMetrics): copyright_registration_calculatorAnalysis {
