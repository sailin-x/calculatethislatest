import { copyright_registration_calculatorInputs } from './types';

export function validateInputs(inputs: copyright_registration_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
