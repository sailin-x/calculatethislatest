import { ransomware_downtime_cost_calculatorInputs, ransomware_downtime_cost_calculatorMetrics, ransomware_downtime_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ransomware_downtime_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: ransomware_downtime_cost_calculatorInputs, metrics: ransomware_downtime_cost_calculatorMetrics): ransomware_downtime_cost_calculatorAnalysis {
