import { Four01kCalculatorInputs, Four01kCalculatorMetrics, Four01kCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: Four01kCalculatorInputs): number {
...
export function generateAnalysis(inputs: Four01kCalculatorInputs, metrics: Four01kCalculatorMetrics): Four01kCalculatorAnalysis {
