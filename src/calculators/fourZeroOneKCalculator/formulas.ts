import { fourZeroOneKCalculatorInputs, fourZeroOneKCalculatorMetrics, fourZeroOneKCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fourZeroOneKCalculatorInputs): number {
...
export function generateAnalysis(inputs: fourZeroOneKCalculatorInputs, metrics: fourZeroOneKCalculatorMetrics): fourZeroOneKCalculatorAnalysis {
