import { industrial_warehouse_profitabilityCalculatorInputs, industrial_warehouse_profitabilityCalculatorMetrics, industrial_warehouse_profitabilityCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: industrial_warehouse_profitabilityCalculatorInputs): number {
...
export function generateAnalysis(inputs: industrial_warehouse_profitabilityCalculatorInputs, metrics: industrial_warehouse_profitabilityCalculatorMetrics): industrial_warehouse_profitabilityCalculatorAnalysis {
