import { financial_legacy_calculatorInputs, financial_legacy_calculatorMetrics, financial_legacy_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_legacy_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_legacy_calculatorInputs, metrics: financial_legacy_calculatorMetrics): financial_legacy_calculatorAnalysis {
