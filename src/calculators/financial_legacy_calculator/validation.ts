import { financial_legacy_calculatorInputs } from './types';

export function validateInputs(inputs: financial_legacy_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
