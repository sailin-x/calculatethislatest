import { engineering_calculatorCalculatorInputs, engineering_calculatorCalculatorMetrics, engineering_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: engineering_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: engineering_calculatorCalculatorInputs, metrics: engineering_calculatorCalculatorMetrics): engineering_calculatorCalculatorAnalysis {
