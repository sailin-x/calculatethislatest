import { engineering_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: engineering_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
