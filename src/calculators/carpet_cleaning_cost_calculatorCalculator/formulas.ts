import { carpet_cleaning_cost_calculatorCalculatorInputs, carpet_cleaning_cost_calculatorCalculatorMetrics, carpet_cleaning_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: carpet_cleaning_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: carpet_cleaning_cost_calculatorCalculatorInputs, metrics: carpet_cleaning_cost_calculatorCalculatorMetrics): carpet_cleaning_cost_calculatorCalculatorAnalysis {
