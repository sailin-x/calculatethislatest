import { DividendDiscountModelDdmCalculatorInputs } from './types';

export function validateDividendDiscountModelDdmCalculatorInputs(inputs: DividendDiscountModelDdmCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDividendDiscountModelDdmCalculatorBusinessRules(inputs: DividendDiscountModelDdmCalculatorInputs): Array<{ field: string; message: string }> {
