export interface DividendDiscountModelDdmCalculatorInputs {
...
export interface DividendDiscountModelDdmCalculatorOutputs {
...
export interface DividendDiscountModelDdmCalculatorMetrics {
...
export interface DividendDiscountModelDdmCalculatorAnalysis {
