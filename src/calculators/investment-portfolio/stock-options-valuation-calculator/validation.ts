...
export function validateStockOptionsValuationCalculatorInputs(inputs: StockOptionsValuationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateStockOptionsValuationCalculatorBusinessRules(inputs: StockOptionsValuationCalculatorInputs): Array<{ field: string; message: string }> {
