...
export function validateConvertibleBondPricingCalculatorInputs(inputs: ConvertibleBondPricingCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateConvertibleBondPricingCalculatorBusinessRules(inputs: ConvertibleBondPricingCalculatorInputs): Array<{ field: string; message: string }> {
