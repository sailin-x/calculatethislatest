export interface ConvertibleBondCalculatorInputs {
...
export interface ConvertibleBondCalculatorOutputs {
...
export interface ConvertibleBondCalculatorMetrics {
...
export interface ConvertibleBondCalculatorAnalysis {
