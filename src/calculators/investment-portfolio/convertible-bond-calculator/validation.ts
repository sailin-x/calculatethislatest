...
export function validateConvertibleBondCalculatorInputs(inputs: ConvertibleBondCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateConvertibleBondCalculatorBusinessRules(inputs: ConvertibleBondCalculatorInputs): Array<{ field: string; message: string }> {
