...
export function validateBondConvexityCalculatorInputs(inputs: BondConvexityCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBondConvexityCalculatorBusinessRules(inputs: BondConvexityCalculatorInputs): Array<{ field: string; message: string }> {
