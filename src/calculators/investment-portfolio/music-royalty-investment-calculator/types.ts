export interface MusicRoyaltyInvestmentCalculatorInputs {
...
export interface MusicRoyaltyInvestmentCalculatorOutputs {
...
export interface MusicRoyaltyInvestmentCalculatorMetrics {
...
export interface MusicRoyaltyInvestmentCalculatorAnalysis {
