...
export function validateMusicRoyaltyInvestmentCalculatorInputs(inputs: MusicRoyaltyInvestmentCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMusicRoyaltyInvestmentCalculatorBusinessRules(inputs: MusicRoyaltyInvestmentCalculatorInputs): Array<{ field: string; message: string }> {
