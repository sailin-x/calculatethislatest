import { DayTradingCalculatorInputs } from './types';

export function validateDayTradingCalculatorInputs(inputs: DayTradingCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDayTradingCalculatorBusinessRules(inputs: DayTradingCalculatorInputs): Array<{ field: string; message: string }> {
