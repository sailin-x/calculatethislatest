export interface CrowdfundingCalculatorInputs {
...
export interface CrowdfundingCalculatorOutputs {
...
export interface CrowdfundingCalculatorMetrics {
...
export interface CrowdfundingCalculatorAnalysis {
