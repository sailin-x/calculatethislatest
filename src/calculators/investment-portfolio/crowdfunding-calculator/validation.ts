import { CrowdfundingCalculatorInputs } from './types';

export function validateCrowdfundingCalculatorInputs(inputs: CrowdfundingCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCrowdfundingCalculatorBusinessRules(inputs: CrowdfundingCalculatorInputs): Array<{ field: string; message: string }> {
