import { DistressedDebtInvestingRoiCalculatorInputs } from './types';

export function validateDistressedDebtInvestingRoiCalculatorInputs(inputs: DistressedDebtInvestingRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDistressedDebtInvestingRoiCalculatorBusinessRules(inputs: DistressedDebtInvestingRoiCalculatorInputs): Array<{ field: string; message: string }> {
