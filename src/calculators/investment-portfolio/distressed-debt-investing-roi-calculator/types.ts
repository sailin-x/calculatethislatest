export interface DistressedDebtInvestingRoiCalculatorInputs {
...
export interface DistressedDebtInvestingRoiCalculatorOutputs {
...
export interface DistressedDebtInvestingRoiCalculatorMetrics {
...
export interface DistressedDebtInvestingRoiCalculatorAnalysis {
