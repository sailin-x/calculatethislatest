...
import { validateStockCalculatorInputs, validateStockCalculatorBusinessRules } from './validation';

export const StockCalculatorCalculator: Calculator: Calculator = {
  id: 'stock-calculator-calculator',
