...
export function validateStockCalculatorInputs(inputs: StockCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateStockCalculatorBusinessRules(inputs: StockCalculatorInputs): Array<{ field: string; message: string }> {
