export interface EconomicValueAddedEvaCalculatorInputs {
...
export interface EconomicValueAddedEvaCalculatorOutputs {
...
export interface EconomicValueAddedEvaCalculatorMetrics {
...
export interface EconomicValueAddedEvaCalculatorAnalysis {
