import { EconomicValueAddedEvaCalculatorInputs } from './types';

export function validateEconomicValueAddedEvaCalculatorInputs(inputs: EconomicValueAddedEvaCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateEconomicValueAddedEvaCalculatorBusinessRules(inputs: EconomicValueAddedEvaCalculatorInputs): Array<{ field: string; message: string }> {
