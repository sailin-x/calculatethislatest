import { InterestRateSwapCalculatorInputs } from './types';

export function validateInterestRateSwapCalculatorInputs(inputs: InterestRateSwapCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateInterestRateSwapCalculatorBusinessRules(inputs: InterestRateSwapCalculatorInputs): Array<{ field: string; message: string }> {
