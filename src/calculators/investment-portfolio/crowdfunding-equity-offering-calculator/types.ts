export interface CrowdfundingEquityOfferingCalculatorInputs {
...
export interface CrowdfundingEquityOfferingCalculatorOutputs {
...
export interface CrowdfundingEquityOfferingCalculatorMetrics {
...
export interface CrowdfundingEquityOfferingCalculatorAnalysis {
