import { CrowdfundingEquityOfferingCalculatorInputs } from './types';

export function validateCrowdfundingEquityOfferingCalculatorInputs(inputs: CrowdfundingEquityOfferingCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCrowdfundingEquityOfferingCalculatorBusinessRules(inputs: CrowdfundingEquityOfferingCalculatorInputs): Array<{ field: string; message: string }> {
