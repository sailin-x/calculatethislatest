...
export function validatePortfolioOptimizationCalculatorInputs(inputs: PortfolioOptimizationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePortfolioOptimizationCalculatorBusinessRules(inputs: PortfolioOptimizationCalculatorInputs): Array<{ field: string; message: string }> {
