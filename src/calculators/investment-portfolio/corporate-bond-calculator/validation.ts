...
export function validateCorporateBondCalculatorInputs(inputs: CorporateBondCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCorporateBondCalculatorBusinessRules(inputs: CorporateBondCalculatorInputs): Array<{ field: string; message: string }> {
