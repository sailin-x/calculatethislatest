...
export function validateAssetbasedLendingCalculatorInputs(inputs: AssetbasedLendingCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAssetbasedLendingCalculatorBusinessRules(inputs: AssetbasedLendingCalculatorInputs): Array<{ field: string; message: string }> {
