export interface StockBuybackRoiCalculatorInputs {
...
export interface StockBuybackRoiCalculatorOutputs {
...
export interface StockBuybackRoiCalculatorMetrics {
...
export interface StockBuybackRoiCalculatorAnalysis {
