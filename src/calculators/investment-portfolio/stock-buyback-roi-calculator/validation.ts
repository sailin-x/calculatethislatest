...
export function validateStockBuybackRoiCalculatorInputs(inputs: StockBuybackRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateStockBuybackRoiCalculatorBusinessRules(inputs: StockBuybackRoiCalculatorInputs): Array<{ field: string; message: string }> {
