export interface PortfolioCompanyEbitdaGrowthCalculatorInputs {
...
export interface PortfolioCompanyEbitdaGrowthCalculatorOutputs {
...
export interface PortfolioCompanyEbitdaGrowthCalculatorMetrics {
...
export interface PortfolioCompanyEbitdaGrowthCalculatorAnalysis {
