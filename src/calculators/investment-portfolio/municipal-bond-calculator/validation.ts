...
export function validateMunicipalBondCalculatorInputs(inputs: MunicipalBondCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMunicipalBondCalculatorBusinessRules(inputs: MunicipalBondCalculatorInputs): Array<{ field: string; message: string }> {
