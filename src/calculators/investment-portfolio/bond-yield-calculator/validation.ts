...
export function validateBondYieldCalculatorInputs(inputs: BondYieldCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBondYieldCalculatorBusinessRules(inputs: BondYieldCalculatorInputs): Array<{ field: string; message: string }> {
