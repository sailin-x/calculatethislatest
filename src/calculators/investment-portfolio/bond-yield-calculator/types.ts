export interface BondYieldCalculatorInputs {
...
export interface BondYieldCalculatorOutputs {
...
export interface BondYieldCalculatorMetrics {
...
export interface BondYieldCalculatorAnalysis {
