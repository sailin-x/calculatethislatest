import { DistressedDebtCalculatorInputs } from './types';

export function validateDistressedDebtCalculatorInputs(inputs: DistressedDebtCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDistressedDebtCalculatorBusinessRules(inputs: DistressedDebtCalculatorInputs): Array<{ field: string; message: string }> {
