import { geometry_calculatorInputs, geometry_calculatorMetrics, geometry_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: geometry_calculatorInputs): number {
...
export function generateAnalysis(inputs: geometry_calculatorInputs, metrics: geometry_calculatorMetrics): geometry_calculatorAnalysis {
