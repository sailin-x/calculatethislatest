import { farmland_investment_roiCalculatorInputs, farmland_investment_roiCalculatorMetrics, farmland_investment_roiCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: farmland_investment_roiCalculatorInputs): number {
...
export function generateAnalysis(inputs: farmland_investment_roiCalculatorInputs, metrics: farmland_investment_roiCalculatorMetrics): farmland_investment_roiCalculatorAnalysis {
