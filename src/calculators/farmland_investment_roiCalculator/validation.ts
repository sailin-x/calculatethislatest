import { farmland_investment_roiCalculatorInputs } from './types';

export function validateInputs(inputs: farmland_investment_roiCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
