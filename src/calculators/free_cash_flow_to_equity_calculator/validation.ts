import { free_cash_flow_to_equity_calculatorInputs } from './types';

export function validateInputs(inputs: free_cash_flow_to_equity_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
