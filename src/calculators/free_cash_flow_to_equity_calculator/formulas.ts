import { free_cash_flow_to_equity_calculatorInputs, free_cash_flow_to_equity_calculatorMetrics, free_cash_flow_to_equity_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: free_cash_flow_to_equity_calculatorInputs): number {
...
export function generateAnalysis(inputs: free_cash_flow_to_equity_calculatorInputs, metrics: free_cash_flow_to_equity_calculatorMetrics): free_cash_flow_to_equity_calculatorAnalysis {
