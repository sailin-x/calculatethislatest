import { patent_valuation_calculatorInputs, patent_valuation_calculatorMetrics, patent_valuation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: patent_valuation_calculatorInputs): number {
...
export function generateAnalysis(inputs: patent_valuation_calculatorInputs, metrics: patent_valuation_calculatorMetrics): patent_valuation_calculatorAnalysis {
