import { massage_therapy_cost_calculatorInputs, massage_therapy_cost_calculatorMetrics, massage_therapy_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: massage_therapy_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: massage_therapy_cost_calculatorInputs, metrics: massage_therapy_cost_calculatorMetrics): massage_therapy_cost_calculatorAnalysis {
