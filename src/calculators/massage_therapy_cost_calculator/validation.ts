import { massage_therapy_cost_calculatorInputs } from './types';

export function validateInputs(inputs: massage_therapy_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
