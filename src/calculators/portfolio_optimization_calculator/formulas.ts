import { portfolio_optimization_calculatorInputs, portfolio_optimization_calculatorMetrics, portfolio_optimization_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: portfolio_optimization_calculatorInputs): number {
...
export function generateAnalysis(inputs: portfolio_optimization_calculatorInputs, metrics: portfolio_optimization_calculatorMetrics): portfolio_optimization_calculatorAnalysis {
