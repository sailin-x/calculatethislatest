import { capital_structure_optimization_calculatorCalculatorInputs, capital_structure_optimization_calculatorCalculatorMetrics, capital_structure_optimization_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: capital_structure_optimization_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: capital_structure_optimization_calculatorCalculatorInputs, metrics: capital_structure_optimization_calculatorCalculatorMetrics): capital_structure_optimization_calculatorCalculatorAnalysis {
