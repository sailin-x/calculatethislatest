import { leverage_ratio_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: leverage_ratio_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
