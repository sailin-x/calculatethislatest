import { motorcycle_accident_compensation_calculatorCalculatorInputs, motorcycle_accident_compensation_calculatorCalculatorMetrics, motorcycle_accident_compensation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: motorcycle_accident_compensation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: motorcycle_accident_compensation_calculatorCalculatorInputs, metrics: motorcycle_accident_compensation_calculatorCalculatorMetrics): motorcycle_accident_compensation_calculatorCalculatorAnalysis {
