import { lawn_care_cost_calculatorInputs, lawn_care_cost_calculatorMetrics, lawn_care_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: lawn_care_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: lawn_care_cost_calculatorInputs, metrics: lawn_care_cost_calculatorMetrics): lawn_care_cost_calculatorAnalysis {
