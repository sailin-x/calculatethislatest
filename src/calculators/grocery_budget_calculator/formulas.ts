import { grocery_budget_calculatorInputs, grocery_budget_calculatorMetrics, grocery_budget_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: grocery_budget_calculatorInputs): number {
...
export function generateAnalysis(inputs: grocery_budget_calculatorInputs, metrics: grocery_budget_calculatorMetrics): grocery_budget_calculatorAnalysis {
