import { chapter_11_bankruptcy_plan_valuationCalculatorInputs, chapter_11_bankruptcy_plan_valuationCalculatorMetrics, chapter_11_bankruptcy_plan_valuationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: chapter_11_bankruptcy_plan_valuationCalculatorInputs): number {
...
export function generateAnalysis(inputs: chapter_11_bankruptcy_plan_valuationCalculatorInputs, metrics: chapter_11_bankruptcy_plan_valuationCalculatorMetrics): chapter_11_bankruptcy_plan_valuationCalculatorAnalysis {
