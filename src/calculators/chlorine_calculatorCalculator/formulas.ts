import { chlorine_calculatorCalculatorInputs, chlorine_calculatorCalculatorMetrics, chlorine_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: chlorine_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: chlorine_calculatorCalculatorInputs, metrics: chlorine_calculatorCalculatorMetrics): chlorine_calculatorCalculatorAnalysis {
