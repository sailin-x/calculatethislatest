import { chlorine_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: chlorine_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
