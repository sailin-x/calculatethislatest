import { CryptoStakingProfitabilityCalculatorExistsButNeedsRegistrationInputs } from './types';

export function validateCryptoStakingProfitabilityCalculatorExistsButNeedsRegistrationInputs(inputs: CryptoStakingProfitabilityCalculatorExistsButNeedsRegistrationInputs): Array<{ field: string; message: string }> {
...
export function validateCryptoStakingProfitabilityCalculatorExistsButNeedsRegistrationBusinessRules(inputs: CryptoStakingProfitabilityCalculatorExistsButNeedsRegistrationInputs): Array<{ field: string; message: string }> {
