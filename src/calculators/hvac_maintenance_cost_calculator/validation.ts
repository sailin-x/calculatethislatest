import { hvac_maintenance_cost_calculatorInputs } from './types';

export function validateInputs(inputs: hvac_maintenance_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
