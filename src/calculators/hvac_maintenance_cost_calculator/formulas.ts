import { hvac_maintenance_cost_calculatorInputs, hvac_maintenance_cost_calculatorMetrics, hvac_maintenance_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: hvac_maintenance_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: hvac_maintenance_cost_calculatorInputs, metrics: hvac_maintenance_cost_calculatorMetrics): hvac_maintenance_cost_calculatorAnalysis {
