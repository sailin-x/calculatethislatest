import { financial_optimization_calculatorCalculatorInputs, financial_optimization_calculatorCalculatorMetrics, financial_optimization_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_optimization_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_optimization_calculatorCalculatorInputs, metrics: financial_optimization_calculatorCalculatorMetrics): financial_optimization_calculatorCalculatorAnalysis {
