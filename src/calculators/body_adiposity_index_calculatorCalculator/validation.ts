import { body_adiposity_index_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: body_adiposity_index_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
