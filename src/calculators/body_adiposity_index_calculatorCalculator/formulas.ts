import { body_adiposity_index_calculatorCalculatorInputs, body_adiposity_index_calculatorCalculatorMetrics, body_adiposity_index_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: body_adiposity_index_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: body_adiposity_index_calculatorCalculatorInputs, metrics: body_adiposity_index_calculatorCalculatorMetrics): body_adiposity_index_calculatorCalculatorAnalysis {
