import { homeopathy_cost_calculatorCalculatorInputs, homeopathy_cost_calculatorCalculatorMetrics, homeopathy_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: homeopathy_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: homeopathy_cost_calculatorCalculatorInputs, metrics: homeopathy_cost_calculatorCalculatorMetrics): homeopathy_cost_calculatorCalculatorAnalysis {
