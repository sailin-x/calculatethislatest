...
export const HomeImprovementCalculator: Calculator = {
  ...
  description: 'Calculate Home Improvement Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Home Improvement Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Home Improvement Calculator calculation',
