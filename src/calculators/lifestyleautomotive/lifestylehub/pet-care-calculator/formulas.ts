import { pet-care-calculatorInputs, pet-care-calculatorMetrics, pet-care-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: pet-care-calculatorInputs): number {
...
export function generateAnalysis(inputs: pet-care-calculatorInputs, metrics: pet-care-calculatorMetrics): pet-care-calculatorAnalysis {
