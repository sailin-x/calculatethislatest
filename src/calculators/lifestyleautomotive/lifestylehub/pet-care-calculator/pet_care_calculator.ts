...
export const pet_care_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Pet Care Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Pet Care Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Pet Care Calculator calculation',
