...
export const travel-calculator: Calculator = {
  ...
  description: 'Calculate Travel Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Travel Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Travel Calculator calculation',
