import { travel_calculatorInputs } from './types';
...
export function validatetravel_calculatorInputs(inputs: travel_calculatorInputs): ValidationResult[] {
...
export function validatetravel_calculatorBusinessRules(inputs: travel_calculatorInputs): ValidationResult[] {
