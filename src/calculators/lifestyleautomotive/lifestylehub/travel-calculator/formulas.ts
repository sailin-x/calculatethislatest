import { travel-calculatorInputs, travel-calculatorMetrics, travel-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: travel-calculatorInputs): number {
...
export function generateAnalysis(inputs: travel-calculatorInputs, metrics: travel-calculatorMetrics): travel-calculatorAnalysis {
