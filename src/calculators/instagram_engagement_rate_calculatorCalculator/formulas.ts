import { instagram_engagement_rate_calculatorCalculatorInputs, instagram_engagement_rate_calculatorCalculatorMetrics, instagram_engagement_rate_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: instagram_engagement_rate_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: instagram_engagement_rate_calculatorCalculatorInputs, metrics: instagram_engagement_rate_calculatorCalculatorMetrics): instagram_engagement_rate_calculatorCalculatorAnalysis {
