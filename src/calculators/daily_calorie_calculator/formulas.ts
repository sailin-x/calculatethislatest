import { daily_calorie_calculatorInputs, daily_calorie_calculatorMetrics, daily_calorie_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: daily_calorie_calculatorInputs): number {
...
export function generateAnalysis(inputs: daily_calorie_calculatorInputs, metrics: daily_calorie_calculatorMetrics): daily_calorie_calculatorAnalysis {
