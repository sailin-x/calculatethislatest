import { film_distribution_waterfall_calculatorInputs, film_distribution_waterfall_calculatorMetrics, film_distribution_waterfall_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: film_distribution_waterfall_calculatorInputs): number {
...
export function generateAnalysis(inputs: film_distribution_waterfall_calculatorInputs, metrics: film_distribution_waterfall_calculatorMetrics): film_distribution_waterfall_calculatorAnalysis {
