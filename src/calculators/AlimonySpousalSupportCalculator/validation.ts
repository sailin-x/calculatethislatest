import { AlimonySpousalSupportCalculatorInputs } from './types';

export function validateInputs(inputs: AlimonySpousalSupportCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
