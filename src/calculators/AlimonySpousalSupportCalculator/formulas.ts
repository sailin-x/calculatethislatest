import { AlimonySpousalSupportCalculatorInputs, AlimonySpousalSupportCalculatorMetrics, AlimonySpousalSupportCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: AlimonySpousalSupportCalculatorInputs): number {
...
export function generateAnalysis(inputs: AlimonySpousalSupportCalculatorInputs, metrics: AlimonySpousalSupportCalculatorMetrics): AlimonySpousalSupportCalculatorAnalysis {
