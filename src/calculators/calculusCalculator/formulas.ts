import { calculusCalculatorInputs, calculusCalculatorMetrics, calculusCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: calculusCalculatorInputs): number {
...
export function generateAnalysis(inputs: calculusCalculatorInputs, metrics: calculusCalculatorMetrics): calculusCalculatorAnalysis {
