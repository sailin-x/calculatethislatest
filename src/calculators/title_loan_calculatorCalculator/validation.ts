import { title_loan_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: title_loan_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
