import { title_loan_calculatorCalculatorInputs, title_loan_calculatorCalculatorMetrics, title_loan_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: title_loan_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: title_loan_calculatorCalculatorInputs, metrics: title_loan_calculatorCalculatorMetrics): title_loan_calculatorCalculatorAnalysis {
