import { registerCreditDefaultSwapCalculatorInputs, registerCreditDefaultSwapCalculatorMetrics, registerCreditDefaultSwapCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerCreditDefaultSwapCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerCreditDefaultSwapCalculatorInputs, metrics: registerCreditDefaultSwapCalculatorMetrics): registerCreditDefaultSwapCalculatorAnalysis {
