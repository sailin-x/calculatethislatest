import { registerCreditDefaultSwapCalculatorInputs } from './types';

export function validateInputs(inputs: registerCreditDefaultSwapCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
