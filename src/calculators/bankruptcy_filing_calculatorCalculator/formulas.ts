import { bankruptcy_filing_calculatorCalculatorInputs, bankruptcy_filing_calculatorCalculatorMetrics, bankruptcy_filing_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: bankruptcy_filing_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: bankruptcy_filing_calculatorCalculatorInputs, metrics: bankruptcy_filing_calculatorCalculatorMetrics): bankruptcy_filing_calculatorCalculatorAnalysis {
