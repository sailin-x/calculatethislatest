import { bankruptcy_filing_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: bankruptcy_filing_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
