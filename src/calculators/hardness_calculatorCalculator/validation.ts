import { hardness_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: hardness_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
