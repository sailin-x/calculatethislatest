import { hardness_calculatorCalculatorInputs, hardness_calculatorCalculatorMetrics, hardness_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hardness_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: hardness_calculatorCalculatorInputs, metrics: hardness_calculatorCalculatorMetrics): hardness_calculatorCalculatorAnalysis {
