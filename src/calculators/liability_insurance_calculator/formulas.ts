import { liability_insurance_calculatorInputs, liability_insurance_calculatorMetrics, liability_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: liability_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: liability_insurance_calculatorInputs, metrics: liability_insurance_calculatorMetrics): liability_insurance_calculatorAnalysis {
