import { salary_benchmarking_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: salary_benchmarking_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
