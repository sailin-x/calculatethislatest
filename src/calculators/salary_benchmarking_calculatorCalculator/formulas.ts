import { salary_benchmarking_calculatorCalculatorInputs, salary_benchmarking_calculatorCalculatorMetrics, salary_benchmarking_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: salary_benchmarking_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: salary_benchmarking_calculatorCalculatorInputs, metrics: salary_benchmarking_calculatorCalculatorMetrics): salary_benchmarking_calculatorCalculatorAnalysis {
