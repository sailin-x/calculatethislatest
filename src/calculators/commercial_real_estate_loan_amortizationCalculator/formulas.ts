import { commercial_real_estate_loan_amortizationCalculatorInputs, commercial_real_estate_loan_amortizationCalculatorMetrics, commercial_real_estate_loan_amortizationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: commercial_real_estate_loan_amortizationCalculatorInputs): number {
...
export function generateAnalysis(inputs: commercial_real_estate_loan_amortizationCalculatorInputs, metrics: commercial_real_estate_loan_amortizationCalculatorMetrics): commercial_real_estate_loan_amortizationCalculatorAnalysis {
