import { electrical_repair_cost_calculatorCalculatorInputs, electrical_repair_cost_calculatorCalculatorMetrics, electrical_repair_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: electrical_repair_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: electrical_repair_cost_calculatorCalculatorInputs, metrics: electrical_repair_cost_calculatorCalculatorMetrics): electrical_repair_cost_calculatorCalculatorAnalysis {
