import { cash_flowCalculatorInputs, cash_flowCalculatorMetrics, cash_flowCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cash_flowCalculatorInputs): number {
...
export function generateAnalysis(inputs: cash_flowCalculatorInputs, metrics: cash_flowCalculatorMetrics): cash_flowCalculatorAnalysis {
