import { hedge_fund_fee_calculatorInputs, hedge_fund_fee_calculatorMetrics, hedge_fund_fee_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: hedge_fund_fee_calculatorInputs): number {
...
export function generateAnalysis(inputs: hedge_fund_fee_calculatorInputs, metrics: hedge_fund_fee_calculatorMetrics): hedge_fund_fee_calculatorAnalysis {
