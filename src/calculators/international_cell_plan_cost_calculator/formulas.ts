import { international_cell_plan_cost_calculatorInputs, international_cell_plan_cost_calculatorMetrics, international_cell_plan_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: international_cell_plan_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: international_cell_plan_cost_calculatorInputs, metrics: international_cell_plan_cost_calculatorMetrics): international_cell_plan_cost_calculatorAnalysis {
