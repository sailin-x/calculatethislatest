import { international_cell_plan_cost_calculatorInputs } from './types';

export function validateInputs(inputs: international_cell_plan_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
