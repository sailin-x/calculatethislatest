import { shopping_cart_abandonment_calculatorCalculatorInputs, shopping_cart_abandonment_calculatorCalculatorMetrics, shopping_cart_abandonment_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: shopping_cart_abandonment_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: shopping_cart_abandonment_calculatorCalculatorInputs, metrics: shopping_cart_abandonment_calculatorCalculatorMetrics): shopping_cart_abandonment_calculatorCalculatorAnalysis {
