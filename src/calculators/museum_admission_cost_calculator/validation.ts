import { museum_admission_cost_calculatorInputs } from './types';

export function validateInputs(inputs: museum_admission_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
