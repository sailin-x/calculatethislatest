import { museum_admission_cost_calculatorInputs, museum_admission_cost_calculatorMetrics, museum_admission_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: museum_admission_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: museum_admission_cost_calculatorInputs, metrics: museum_admission_cost_calculatorMetrics): museum_admission_cost_calculatorAnalysis {
