import { music_festival_profit_calculatorInputs, music_festival_profit_calculatorMetrics, music_festival_profit_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: music_festival_profit_calculatorInputs): number {
...
export function generateAnalysis(inputs: music_festival_profit_calculatorInputs, metrics: music_festival_profit_calculatorMetrics): music_festival_profit_calculatorAnalysis {
