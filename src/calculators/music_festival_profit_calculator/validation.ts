import { music_festival_profit_calculatorInputs } from './types';

export function validateInputs(inputs: music_festival_profit_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
