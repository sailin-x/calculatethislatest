import { flood_risk_zonal_pricing_calculatorCalculatorInputs, flood_risk_zonal_pricing_calculatorCalculatorMetrics, flood_risk_zonal_pricing_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: flood_risk_zonal_pricing_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: flood_risk_zonal_pricing_calculatorCalculatorInputs, metrics: flood_risk_zonal_pricing_calculatorCalculatorMetrics): flood_risk_zonal_pricing_calculatorCalculatorAnalysis {
