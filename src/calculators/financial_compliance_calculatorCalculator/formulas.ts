import { financial_compliance_calculatorCalculatorInputs, financial_compliance_calculatorCalculatorMetrics, financial_compliance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_compliance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_compliance_calculatorCalculatorInputs, metrics: financial_compliance_calculatorCalculatorMetrics): financial_compliance_calculatorCalculatorAnalysis {
