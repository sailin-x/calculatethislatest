import { environmental_remediation_calculatorInputs, environmental_remediation_calculatorMetrics, environmental_remediation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: environmental_remediation_calculatorInputs): number {
...
export function generateAnalysis(inputs: environmental_remediation_calculatorInputs, metrics: environmental_remediation_calculatorMetrics): environmental_remediation_calculatorAnalysis {
