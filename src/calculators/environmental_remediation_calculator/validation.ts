import { environmental_remediation_calculatorInputs } from './types';

export function validateInputs(inputs: environmental_remediation_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
