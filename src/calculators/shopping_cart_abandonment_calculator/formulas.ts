import { shopping_cart_abandonment_calculatorInputs, shopping_cart_abandonment_calculatorMetrics, shopping_cart_abandonment_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: shopping_cart_abandonment_calculatorInputs): number {
...
export function generateAnalysis(inputs: shopping_cart_abandonment_calculatorInputs, metrics: shopping_cart_abandonment_calculatorMetrics): shopping_cart_abandonment_calculatorAnalysis {
