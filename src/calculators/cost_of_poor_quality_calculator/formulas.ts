import { cost_of_poor_quality_calculatorInputs, cost_of_poor_quality_calculatorMetrics, cost_of_poor_quality_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cost_of_poor_quality_calculatorInputs): number {
...
export function generateAnalysis(inputs: cost_of_poor_quality_calculatorInputs, metrics: cost_of_poor_quality_calculatorMetrics): cost_of_poor_quality_calculatorAnalysis {
