import { cost_of_poor_quality_calculatorInputs } from './types';

export function validateInputs(inputs: cost_of_poor_quality_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
