import { surety_bond_premium_calculatorInputs, surety_bond_premium_calculatorMetrics, surety_bond_premium_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: surety_bond_premium_calculatorInputs): number {
...
export function generateAnalysis(inputs: surety_bond_premium_calculatorInputs, metrics: surety_bond_premium_calculatorMetrics): surety_bond_premium_calculatorAnalysis {
