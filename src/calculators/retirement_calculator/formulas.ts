import { retirement_calculatorInputs, retirement_calculatorMetrics, retirement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: retirement_calculatorInputs): number {
...
export function generateAnalysis(inputs: retirement_calculatorInputs, metrics: retirement_calculatorMetrics): retirement_calculatorAnalysis {
