import { forex_calculatorInputs, forex_calculatorMetrics, forex_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: forex_calculatorInputs): number {
...
export function generateAnalysis(inputs: forex_calculatorInputs, metrics: forex_calculatorMetrics): forex_calculatorAnalysis {
