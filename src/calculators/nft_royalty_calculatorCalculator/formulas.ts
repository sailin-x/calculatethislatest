import { nft_royalty_calculatorCalculatorInputs, nft_royalty_calculatorCalculatorMetrics, nft_royalty_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: nft_royalty_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: nft_royalty_calculatorCalculatorInputs, metrics: nft_royalty_calculatorCalculatorMetrics): nft_royalty_calculatorCalculatorAnalysis {
