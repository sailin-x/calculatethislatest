import { nft_royalty_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: nft_royalty_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
