import { debt_payoff_calculatorInputs, debt_payoff_calculatorMetrics, debt_payoff_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_payoff_calculatorInputs): number {
...
export function generateAnalysis(inputs: debt_payoff_calculatorInputs, metrics: debt_payoff_calculatorMetrics): debt_payoff_calculatorAnalysis {
