import { capital_gains_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: capital_gains_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
