import { capital_gains_calculatorCalculatorInputs, capital_gains_calculatorCalculatorMetrics, capital_gains_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: capital_gains_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: capital_gains_calculatorCalculatorInputs, metrics: capital_gains_calculatorCalculatorMetrics): capital_gains_calculatorCalculatorAnalysis {
