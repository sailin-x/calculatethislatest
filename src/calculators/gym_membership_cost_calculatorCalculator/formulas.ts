import { gym_membership_cost_calculatorCalculatorInputs, gym_membership_cost_calculatorCalculatorMetrics, gym_membership_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: gym_membership_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: gym_membership_cost_calculatorCalculatorInputs, metrics: gym_membership_cost_calculatorCalculatorMetrics): gym_membership_cost_calculatorCalculatorAnalysis {
