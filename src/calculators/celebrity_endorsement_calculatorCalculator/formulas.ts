import { celebrity_endorsement_calculatorCalculatorInputs, celebrity_endorsement_calculatorCalculatorMetrics, celebrity_endorsement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: celebrity_endorsement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: celebrity_endorsement_calculatorCalculatorInputs, metrics: celebrity_endorsement_calculatorCalculatorMetrics): celebrity_endorsement_calculatorCalculatorAnalysis {
