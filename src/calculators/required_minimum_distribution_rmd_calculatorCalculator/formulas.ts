import { required_minimum_distribution_rmd_calculatorCalculatorInputs, required_minimum_distribution_rmd_calculatorCalculatorMetrics, required_minimum_distribution_rmd_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: required_minimum_distribution_rmd_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: required_minimum_distribution_rmd_calculatorCalculatorInputs, metrics: required_minimum_distribution_rmd_calculatorCalculatorMetrics): required_minimum_distribution_rmd_calculatorCalculatorAnalysis {
