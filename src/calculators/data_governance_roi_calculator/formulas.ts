import { data_governance_roi_calculatorInputs, data_governance_roi_calculatorMetrics, data_governance_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: data_governance_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: data_governance_roi_calculatorInputs, metrics: data_governance_roi_calculatorMetrics): data_governance_roi_calculatorAnalysis {
