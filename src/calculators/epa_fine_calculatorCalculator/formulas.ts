import { epa_fine_calculatorCalculatorInputs, epa_fine_calculatorCalculatorMetrics, epa_fine_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: epa_fine_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: epa_fine_calculatorCalculatorInputs, metrics: epa_fine_calculatorCalculatorMetrics): epa_fine_calculatorCalculatorAnalysis {
