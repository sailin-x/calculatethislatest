import { epa_fine_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: epa_fine_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
