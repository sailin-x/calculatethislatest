import { marketing_cost_calculatorInputs, marketing_cost_calculatorMetrics, marketing_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: marketing_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: marketing_cost_calculatorInputs, metrics: marketing_cost_calculatorMetrics): marketing_cost_calculatorAnalysis {
