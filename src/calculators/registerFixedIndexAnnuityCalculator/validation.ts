import { registerFixedIndexAnnuityCalculatorInputs } from './types';

export function validateInputs(inputs: registerFixedIndexAnnuityCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
