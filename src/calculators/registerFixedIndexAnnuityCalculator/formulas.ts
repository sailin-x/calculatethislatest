import { registerFixedIndexAnnuityCalculatorInputs, registerFixedIndexAnnuityCalculatorMetrics, registerFixedIndexAnnuityCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerFixedIndexAnnuityCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerFixedIndexAnnuityCalculatorInputs, metrics: registerFixedIndexAnnuityCalculatorMetrics): registerFixedIndexAnnuityCalculatorAnalysis {
