import { bond_yield_calculatorInputs, bond_yield_calculatorMetrics, bond_yield_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: bond_yield_calculatorInputs): number {
...
export function generateAnalysis(inputs: bond_yield_calculatorInputs, metrics: bond_yield_calculatorMetrics): bond_yield_calculatorAnalysis {
