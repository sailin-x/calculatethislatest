import { employment_practices_liability_calculatorInputs, employment_practices_liability_calculatorMetrics, employment_practices_liability_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: employment_practices_liability_calculatorInputs): number {
...
export function generateAnalysis(inputs: employment_practices_liability_calculatorInputs, metrics: employment_practices_liability_calculatorMetrics): employment_practices_liability_calculatorAnalysis {
