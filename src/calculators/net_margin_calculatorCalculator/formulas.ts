import { net_margin_calculatorCalculatorInputs, net_margin_calculatorCalculatorMetrics, net_margin_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: net_margin_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: net_margin_calculatorCalculatorInputs, metrics: net_margin_calculatorCalculatorMetrics): net_margin_calculatorCalculatorAnalysis {
