import { net_margin_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: net_margin_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
