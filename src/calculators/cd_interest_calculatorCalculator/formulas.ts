import { cd_interest_calculatorCalculatorInputs, cd_interest_calculatorCalculatorMetrics, cd_interest_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cd_interest_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cd_interest_calculatorCalculatorInputs, metrics: cd_interest_calculatorCalculatorMetrics): cd_interest_calculatorCalculatorAnalysis {
