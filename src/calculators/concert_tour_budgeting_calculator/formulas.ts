import { concert_tour_budgeting_calculatorInputs, concert_tour_budgeting_calculatorMetrics, concert_tour_budgeting_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: concert_tour_budgeting_calculatorInputs): number {
...
export function generateAnalysis(inputs: concert_tour_budgeting_calculatorInputs, metrics: concert_tour_budgeting_calculatorMetrics): concert_tour_budgeting_calculatorAnalysis {
