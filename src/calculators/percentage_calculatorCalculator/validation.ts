import { percentage_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: percentage_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
