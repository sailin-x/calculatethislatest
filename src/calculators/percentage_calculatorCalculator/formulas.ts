import { percentage_calculatorCalculatorInputs, percentage_calculatorCalculatorMetrics, percentage_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: percentage_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: percentage_calculatorCalculatorInputs, metrics: percentage_calculatorCalculatorMetrics): percentage_calculatorCalculatorAnalysis {
