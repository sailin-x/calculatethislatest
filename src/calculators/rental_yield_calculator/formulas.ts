import { rental_yield_calculatorInputs, rental_yield_calculatorMetrics, rental_yield_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: rental_yield_calculatorInputs): number {
...
export function generateAnalysis(inputs: rental_yield_calculatorInputs, metrics: rental_yield_calculatorMetrics): rental_yield_calculatorAnalysis {
