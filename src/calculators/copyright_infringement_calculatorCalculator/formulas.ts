import { copyright_infringement_calculatorCalculatorInputs, copyright_infringement_calculatorCalculatorMetrics, copyright_infringement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: copyright_infringement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: copyright_infringement_calculatorCalculatorInputs, metrics: copyright_infringement_calculatorCalculatorMetrics): copyright_infringement_calculatorCalculatorAnalysis {
