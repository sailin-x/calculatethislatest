import { 529_college_savings_planCalculatorInputs } from './types';

export function validateInputs(inputs: 529_college_savings_planCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
