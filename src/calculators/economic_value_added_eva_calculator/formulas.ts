import { economic_value_added_eva_calculatorInputs, economic_value_added_eva_calculatorMetrics, economic_value_added_eva_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: economic_value_added_eva_calculatorInputs): number {
...
export function generateAnalysis(inputs: economic_value_added_eva_calculatorInputs, metrics: economic_value_added_eva_calculatorMetrics): economic_value_added_eva_calculatorAnalysis {
