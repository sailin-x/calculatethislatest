import { defined_benefit_planCalculatorInputs, defined_benefit_planCalculatorMetrics, defined_benefit_planCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: defined_benefit_planCalculatorInputs): number {
...
export function generateAnalysis(inputs: defined_benefit_planCalculatorInputs, metrics: defined_benefit_planCalculatorMetrics): defined_benefit_planCalculatorAnalysis {
