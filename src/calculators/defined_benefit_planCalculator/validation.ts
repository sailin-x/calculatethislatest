import { defined_benefit_planCalculatorInputs } from './types';

export function validateInputs(inputs: defined_benefit_planCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
