import { merchant_cash_advance_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: merchant_cash_advance_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
