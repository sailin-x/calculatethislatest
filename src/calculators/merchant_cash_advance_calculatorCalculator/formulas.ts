import { merchant_cash_advance_calculatorCalculatorInputs, merchant_cash_advance_calculatorCalculatorMetrics, merchant_cash_advance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: merchant_cash_advance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: merchant_cash_advance_calculatorCalculatorInputs, metrics: merchant_cash_advance_calculatorCalculatorMetrics): merchant_cash_advance_calculatorCalculatorAnalysis {
