import { hotel_feasibility_adrCalculatorInputs } from './types';

export function validateInputs(inputs: hotel_feasibility_adrCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
