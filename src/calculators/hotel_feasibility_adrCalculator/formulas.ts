import { hotel_feasibility_adrCalculatorInputs, hotel_feasibility_adrCalculatorMetrics, hotel_feasibility_adrCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hotel_feasibility_adrCalculatorInputs): number {
...
export function generateAnalysis(inputs: hotel_feasibility_adrCalculatorInputs, metrics: hotel_feasibility_adrCalculatorMetrics): hotel_feasibility_adrCalculatorAnalysis {
