import { business_formation_calculatorInputs, business_formation_calculatorMetrics, business_formation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_formation_calculatorInputs): number {
...
export function generateAnalysis(inputs: business_formation_calculatorInputs, metrics: business_formation_calculatorMetrics): business_formation_calculatorAnalysis {
