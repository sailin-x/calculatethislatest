import { business_formation_calculatorInputs } from './types';

export function validateInputs(inputs: business_formation_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
