import { comparable_company_analysis_calculatorInputs, comparable_company_analysis_calculatorMetrics, comparable_company_analysis_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: comparable_company_analysis_calculatorInputs): number {
...
export function generateAnalysis(inputs: comparable_company_analysis_calculatorInputs, metrics: comparable_company_analysis_calculatorMetrics): comparable_company_analysis_calculatorAnalysis {
