import { income_based_repayment_calculatorCalculatorInputs, income_based_repayment_calculatorCalculatorMetrics, income_based_repayment_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: income_based_repayment_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: income_based_repayment_calculatorCalculatorInputs, metrics: income_based_repayment_calculatorCalculatorMetrics): income_based_repayment_calculatorCalculatorAnalysis {
