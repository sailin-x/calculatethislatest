import { income_based_repayment_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: income_based_repayment_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
