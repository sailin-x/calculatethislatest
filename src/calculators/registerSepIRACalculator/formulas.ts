import { registerSepIRACalculatorInputs, registerSepIRACalculatorMetrics, registerSepIRACalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerSepIRACalculatorInputs): number {
...
export function generateAnalysis(inputs: registerSepIRACalculatorInputs, metrics: registerSepIRACalculatorMetrics): registerSepIRACalculatorAnalysis {
