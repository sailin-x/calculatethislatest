import { balance_transfer_calculatorCalculatorInputs, balance_transfer_calculatorCalculatorMetrics, balance_transfer_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: balance_transfer_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: balance_transfer_calculatorCalculatorInputs, metrics: balance_transfer_calculatorCalculatorMetrics): balance_transfer_calculatorCalculatorAnalysis {
