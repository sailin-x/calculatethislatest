import { balance_transfer_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: balance_transfer_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
