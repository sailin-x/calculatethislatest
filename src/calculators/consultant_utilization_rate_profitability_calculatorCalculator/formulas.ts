import { consultant_utilization_rate_profitability_calculatorCalculatorInputs, consultant_utilization_rate_profitability_calculatorCalculatorMetrics, consultant_utilization_rate_profitability_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: consultant_utilization_rate_profitability_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: consultant_utilization_rate_profitability_calculatorCalculatorInputs, metrics: consultant_utilization_rate_profitability_calculatorCalculatorMetrics): consultant_utilization_rate_profitability_calculatorCalculatorAnalysis {
