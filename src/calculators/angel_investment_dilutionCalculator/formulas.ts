import { angel_investment_dilutionCalculatorInputs, angel_investment_dilutionCalculatorMetrics, angel_investment_dilutionCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: angel_investment_dilutionCalculatorInputs): number {
...
export function generateAnalysis(inputs: angel_investment_dilutionCalculatorInputs, metrics: angel_investment_dilutionCalculatorMetrics): angel_investment_dilutionCalculatorAnalysis {
