import { angel_investment_dilutionCalculatorInputs } from './types';

export function validateInputs(inputs: angel_investment_dilutionCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
