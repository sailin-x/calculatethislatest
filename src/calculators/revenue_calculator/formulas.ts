import { revenue_calculatorInputs, revenue_calculatorMetrics, revenue_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: revenue_calculatorInputs): number {
...
export function generateAnalysis(inputs: revenue_calculatorInputs, metrics: revenue_calculatorMetrics): revenue_calculatorAnalysis {
