import { debt_consolidation_calculatorInputs } from './types';

export function validateInputs(inputs: debt_consolidation_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
