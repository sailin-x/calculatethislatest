import { debt_consolidation_calculatorInputs, debt_consolidation_calculatorMetrics, debt_consolidation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_consolidation_calculatorInputs): number {
...
export function generateAnalysis(inputs: debt_consolidation_calculatorInputs, metrics: debt_consolidation_calculatorMetrics): debt_consolidation_calculatorAnalysis {
