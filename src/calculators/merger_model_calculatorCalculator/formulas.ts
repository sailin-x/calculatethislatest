import { merger_model_calculatorCalculatorInputs, merger_model_calculatorCalculatorMetrics, merger_model_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: merger_model_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: merger_model_calculatorCalculatorInputs, metrics: merger_model_calculatorCalculatorMetrics): merger_model_calculatorCalculatorAnalysis {
