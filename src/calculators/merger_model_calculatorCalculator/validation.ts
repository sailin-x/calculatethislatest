import { merger_model_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: merger_model_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
