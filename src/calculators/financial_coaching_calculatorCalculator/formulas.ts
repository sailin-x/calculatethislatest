import { financial_coaching_calculatorCalculatorInputs, financial_coaching_calculatorCalculatorMetrics, financial_coaching_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_coaching_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_coaching_calculatorCalculatorInputs, metrics: financial_coaching_calculatorCalculatorMetrics): financial_coaching_calculatorCalculatorAnalysis {
