import { financial_coaching_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: financial_coaching_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
