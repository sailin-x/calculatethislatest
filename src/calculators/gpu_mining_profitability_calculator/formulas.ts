import { gpu_mining_profitability_calculatorInputs, gpu_mining_profitability_calculatorMetrics, gpu_mining_profitability_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: gpu_mining_profitability_calculatorInputs): number {
...
export function generateAnalysis(inputs: gpu_mining_profitability_calculatorInputs, metrics: gpu_mining_profitability_calculatorMetrics): gpu_mining_profitability_calculatorAnalysis {
