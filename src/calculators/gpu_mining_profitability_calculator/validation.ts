import { gpu_mining_profitability_calculatorInputs } from './types';

export function validateInputs(inputs: gpu_mining_profitability_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
