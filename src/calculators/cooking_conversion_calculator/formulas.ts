import { cooking_conversion_calculatorInputs, cooking_conversion_calculatorMetrics, cooking_conversion_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cooking_conversion_calculatorInputs): number {
...
export function generateAnalysis(inputs: cooking_conversion_calculatorInputs, metrics: cooking_conversion_calculatorMetrics): cooking_conversion_calculatorAnalysis {
