import { cooking_conversion_calculatorInputs } from './types';

export function validateInputs(inputs: cooking_conversion_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
