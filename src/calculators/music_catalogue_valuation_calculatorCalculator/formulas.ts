import { music_catalogue_valuation_calculatorCalculatorInputs, music_catalogue_valuation_calculatorCalculatorMetrics, music_catalogue_valuation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: music_catalogue_valuation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: music_catalogue_valuation_calculatorCalculatorInputs, metrics: music_catalogue_valuation_calculatorCalculatorMetrics): music_catalogue_valuation_calculatorCalculatorAnalysis {
