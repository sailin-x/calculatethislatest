import { executiveDeferredCompensationCalculatorInputs, executiveDeferredCompensationCalculatorMetrics, executiveDeferredCompensationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: executiveDeferredCompensationCalculatorInputs): number {
...
export function generateAnalysis(inputs: executiveDeferredCompensationCalculatorInputs, metrics: executiveDeferredCompensationCalculatorMetrics): executiveDeferredCompensationCalculatorAnalysis {
