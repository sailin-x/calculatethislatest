import { executiveDeferredCompensationCalculatorInputs } from './types';

export function validateInputs(inputs: executiveDeferredCompensationCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
