import { economic_order_quantity_eoq_calculatorInputs, economic_order_quantity_eoq_calculatorMetrics, economic_order_quantity_eoq_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: economic_order_quantity_eoq_calculatorInputs): number {
...
export function generateAnalysis(inputs: economic_order_quantity_eoq_calculatorInputs, metrics: economic_order_quantity_eoq_calculatorMetrics): economic_order_quantity_eoq_calculatorAnalysis {
