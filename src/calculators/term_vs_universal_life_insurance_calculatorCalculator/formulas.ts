import { term_vs_universal_life_insurance_calculatorCalculatorInputs, term_vs_universal_life_insurance_calculatorCalculatorMetrics, term_vs_universal_life_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: term_vs_universal_life_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: term_vs_universal_life_insurance_calculatorCalculatorInputs, metrics: term_vs_universal_life_insurance_calculatorCalculatorMetrics): term_vs_universal_life_insurance_calculatorCalculatorAnalysis {
