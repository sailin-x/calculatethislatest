import { request_for_proposal_rfp_scoring_calculatorInputs, request_for_proposal_rfp_scoring_calculatorMetrics, request_for_proposal_rfp_scoring_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: request_for_proposal_rfp_scoring_calculatorInputs): number {
...
export function generateAnalysis(inputs: request_for_proposal_rfp_scoring_calculatorInputs, metrics: request_for_proposal_rfp_scoring_calculatorMetrics): request_for_proposal_rfp_scoring_calculatorAnalysis {
