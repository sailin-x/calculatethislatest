import { prescription_cost_calculatorCalculatorInputs, prescription_cost_calculatorCalculatorMetrics, prescription_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: prescription_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: prescription_cost_calculatorCalculatorInputs, metrics: prescription_cost_calculatorCalculatorMetrics): prescription_cost_calculatorCalculatorAnalysis {
