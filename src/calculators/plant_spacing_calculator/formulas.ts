import { plant_spacing_calculatorInputs, plant_spacing_calculatorMetrics, plant_spacing_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: plant_spacing_calculatorInputs): number {
...
export function generateAnalysis(inputs: plant_spacing_calculatorInputs, metrics: plant_spacing_calculatorMetrics): plant_spacing_calculatorAnalysis {
