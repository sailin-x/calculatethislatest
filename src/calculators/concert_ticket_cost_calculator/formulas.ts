import { concert_ticket_cost_calculatorInputs, concert_ticket_cost_calculatorMetrics, concert_ticket_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: concert_ticket_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: concert_ticket_cost_calculatorInputs, metrics: concert_ticket_cost_calculatorMetrics): concert_ticket_cost_calculatorAnalysis {
