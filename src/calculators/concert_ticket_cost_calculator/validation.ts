import { concert_ticket_cost_calculatorInputs } from './types';

export function validateInputs(inputs: concert_ticket_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
