import { estate_tax_life_insurance_calculatorInputs, estate_tax_life_insurance_calculatorMetrics, estate_tax_life_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: estate_tax_life_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: estate_tax_life_insurance_calculatorInputs, metrics: estate_tax_life_insurance_calculatorMetrics): estate_tax_life_insurance_calculatorAnalysis {
