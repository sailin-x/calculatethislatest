import { auto_insurance_calculatorCalculatorInputs, auto_insurance_calculatorCalculatorMetrics, auto_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: auto_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: auto_insurance_calculatorCalculatorInputs, metrics: auto_insurance_calculatorCalculatorMetrics): auto_insurance_calculatorCalculatorAnalysis {
