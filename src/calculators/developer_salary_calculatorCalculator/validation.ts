import { developer_salary_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: developer_salary_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
