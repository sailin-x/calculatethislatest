import { developer_salary_calculatorCalculatorInputs, developer_salary_calculatorCalculatorMetrics, developer_salary_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: developer_salary_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: developer_salary_calculatorCalculatorInputs, metrics: developer_salary_calculatorCalculatorMetrics): developer_salary_calculatorCalculatorAnalysis {
