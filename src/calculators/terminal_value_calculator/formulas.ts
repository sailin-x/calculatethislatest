import { terminal_value_calculatorInputs, terminal_value_calculatorMetrics, terminal_value_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: terminal_value_calculatorInputs): number {
...
export function generateAnalysis(inputs: terminal_value_calculatorInputs, metrics: terminal_value_calculatorMetrics): terminal_value_calculatorAnalysis {
