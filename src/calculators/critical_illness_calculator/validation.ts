import { critical_illness_calculatorInputs } from './types';

export function validateInputs(inputs: critical_illness_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
