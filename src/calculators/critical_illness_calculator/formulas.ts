import { critical_illness_calculatorInputs, critical_illness_calculatorMetrics, critical_illness_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: critical_illness_calculatorInputs): number {
...
export function generateAnalysis(inputs: critical_illness_calculatorInputs, metrics: critical_illness_calculatorMetrics): critical_illness_calculatorAnalysis {
