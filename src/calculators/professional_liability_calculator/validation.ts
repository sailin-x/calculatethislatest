import { professional_liability_calculatorInputs } from './types';

export function validateInputs(inputs: professional_liability_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
