import { professional_liability_calculatorInputs, professional_liability_calculatorMetrics, professional_liability_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: professional_liability_calculatorInputs): number {
...
export function generateAnalysis(inputs: professional_liability_calculatorInputs, metrics: professional_liability_calculatorMetrics): professional_liability_calculatorAnalysis {
