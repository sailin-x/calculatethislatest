import { buy_sell_calculatorInputs, buy_sell_calculatorMetrics, buy_sell_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: buy_sell_calculatorInputs): number {
...
export function generateAnalysis(inputs: buy_sell_calculatorInputs, metrics: buy_sell_calculatorMetrics): buy_sell_calculatorAnalysis {
