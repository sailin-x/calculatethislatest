import { registerStructuredSettlementPayoutCalculatorInputs, registerStructuredSettlementPayoutCalculatorMetrics, registerStructuredSettlementPayoutCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerStructuredSettlementPayoutCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerStructuredSettlementPayoutCalculatorInputs, metrics: registerStructuredSettlementPayoutCalculatorMetrics): registerStructuredSettlementPayoutCalculatorAnalysis {
