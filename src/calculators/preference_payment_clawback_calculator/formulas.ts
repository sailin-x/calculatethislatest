import { preference_payment_clawback_calculatorInputs, preference_payment_clawback_calculatorMetrics, preference_payment_clawback_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: preference_payment_clawback_calculatorInputs): number {
...
export function generateAnalysis(inputs: preference_payment_clawback_calculatorInputs, metrics: preference_payment_clawback_calculatorMetrics): preference_payment_clawback_calculatorAnalysis {
