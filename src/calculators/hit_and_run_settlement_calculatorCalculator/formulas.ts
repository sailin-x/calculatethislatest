import { hit_and_run_settlement_calculatorCalculatorInputs, hit_and_run_settlement_calculatorCalculatorMetrics, hit_and_run_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hit_and_run_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: hit_and_run_settlement_calculatorCalculatorInputs, metrics: hit_and_run_settlement_calculatorCalculatorMetrics): hit_and_run_settlement_calculatorCalculatorAnalysis {
