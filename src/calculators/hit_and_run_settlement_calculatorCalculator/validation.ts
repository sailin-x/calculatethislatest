import { hit_and_run_settlement_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: hit_and_run_settlement_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
