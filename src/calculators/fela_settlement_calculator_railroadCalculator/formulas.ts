import { fela_settlement_calculator_railroadCalculatorInputs, fela_settlement_calculator_railroadCalculatorMetrics, fela_settlement_calculator_railroadCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fela_settlement_calculator_railroadCalculatorInputs): number {
...
export function generateAnalysis(inputs: fela_settlement_calculator_railroadCalculatorInputs, metrics: fela_settlement_calculator_railroadCalculatorMetrics): fela_settlement_calculator_railroadCalculatorAnalysis {
