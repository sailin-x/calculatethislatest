import { pension_lump_sum_vs_annuity_calculatorInputs, pension_lump_sum_vs_annuity_calculatorMetrics, pension_lump_sum_vs_annuity_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: pension_lump_sum_vs_annuity_calculatorInputs): number {
...
export function generateAnalysis(inputs: pension_lump_sum_vs_annuity_calculatorInputs, metrics: pension_lump_sum_vs_annuity_calculatorMetrics): pension_lump_sum_vs_annuity_calculatorAnalysis {
