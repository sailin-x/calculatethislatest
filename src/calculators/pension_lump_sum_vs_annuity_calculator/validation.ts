import { pension_lump_sum_vs_annuity_calculatorInputs } from './types';

export function validateInputs(inputs: pension_lump_sum_vs_annuity_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
