import { financial_growth_calculatorCalculatorInputs, financial_growth_calculatorCalculatorMetrics, financial_growth_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_growth_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_growth_calculatorCalculatorInputs, metrics: financial_growth_calculatorCalculatorMetrics): financial_growth_calculatorCalculatorAnalysis {
