import { payback_period_calculatorInputs, payback_period_calculatorMetrics, payback_period_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: payback_period_calculatorInputs): number {
...
export function generateAnalysis(inputs: payback_period_calculatorInputs, metrics: payback_period_calculatorMetrics): payback_period_calculatorAnalysis {
