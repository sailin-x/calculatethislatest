import { economic_value_added_eva_calculatorCalculatorInputs, economic_value_added_eva_calculatorCalculatorMetrics, economic_value_added_eva_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: economic_value_added_eva_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: economic_value_added_eva_calculatorCalculatorInputs, metrics: economic_value_added_eva_calculatorCalculatorMetrics): economic_value_added_eva_calculatorCalculatorAnalysis {
