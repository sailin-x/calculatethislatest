import { student_loan_repayment_calculatorInputs, student_loan_repayment_calculatorMetrics, student_loan_repayment_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: student_loan_repayment_calculatorInputs): number {
...
export function generateAnalysis(inputs: student_loan_repayment_calculatorInputs, metrics: student_loan_repayment_calculatorMetrics): student_loan_repayment_calculatorAnalysis {
