import { catastrophe_bond_pricing_modelCalculatorInputs } from './types';

export function validateInputs(inputs: catastrophe_bond_pricing_modelCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
