import { catastrophe_bond_pricing_modelCalculatorInputs, catastrophe_bond_pricing_modelCalculatorMetrics, catastrophe_bond_pricing_modelCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: catastrophe_bond_pricing_modelCalculatorInputs): number {
...
export function generateAnalysis(inputs: catastrophe_bond_pricing_modelCalculatorInputs, metrics: catastrophe_bond_pricing_modelCalculatorMetrics): catastrophe_bond_pricing_modelCalculatorAnalysis {
