import { bond_convexity_calculatorCalculatorInputs, bond_convexity_calculatorCalculatorMetrics, bond_convexity_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: bond_convexity_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: bond_convexity_calculatorCalculatorInputs, metrics: bond_convexity_calculatorCalculatorMetrics): bond_convexity_calculatorCalculatorAnalysis {
