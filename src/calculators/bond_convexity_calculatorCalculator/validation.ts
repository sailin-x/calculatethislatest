import { bond_convexity_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: bond_convexity_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
