import { estate_tax_life_insurance_calculatorCalculatorInputs, estate_tax_life_insurance_calculatorCalculatorMetrics, estate_tax_life_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: estate_tax_life_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: estate_tax_life_insurance_calculatorCalculatorInputs, metrics: estate_tax_life_insurance_calculatorCalculatorMetrics): estate_tax_life_insurance_calculatorCalculatorAnalysis {
