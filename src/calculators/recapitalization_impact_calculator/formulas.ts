import { recapitalization_impact_calculatorInputs, recapitalization_impact_calculatorMetrics, recapitalization_impact_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: recapitalization_impact_calculatorInputs): number {
...
export function generateAnalysis(inputs: recapitalization_impact_calculatorInputs, metrics: recapitalization_impact_calculatorMetrics): recapitalization_impact_calculatorAnalysis {
