import { hotel_cost_calculatorInputs, hotel_cost_calculatorMetrics, hotel_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: hotel_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: hotel_cost_calculatorInputs, metrics: hotel_cost_calculatorMetrics): hotel_cost_calculatorAnalysis {
