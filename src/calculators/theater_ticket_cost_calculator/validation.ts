import { theater_ticket_cost_calculatorInputs } from './types';

export function validateInputs(inputs: theater_ticket_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
