import { theater_ticket_cost_calculatorInputs, theater_ticket_cost_calculatorMetrics, theater_ticket_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: theater_ticket_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: theater_ticket_cost_calculatorInputs, metrics: theater_ticket_cost_calculatorMetrics): theater_ticket_cost_calculatorAnalysis {
