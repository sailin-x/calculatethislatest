import { cryptocurrency_investment_calculatorInputs, cryptocurrency_investment_calculatorMetrics, cryptocurrency_investment_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cryptocurrency_investment_calculatorInputs): number {
...
export function generateAnalysis(inputs: cryptocurrency_investment_calculatorInputs, metrics: cryptocurrency_investment_calculatorMetrics): cryptocurrency_investment_calculatorAnalysis {
