import { buy_sell_agreement_insurance_calculatorInputs, buy_sell_agreement_insurance_calculatorMetrics, buy_sell_agreement_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: buy_sell_agreement_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: buy_sell_agreement_insurance_calculatorInputs, metrics: buy_sell_agreement_insurance_calculatorMetrics): buy_sell_agreement_insurance_calculatorAnalysis {
