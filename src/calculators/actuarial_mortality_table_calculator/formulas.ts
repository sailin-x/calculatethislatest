import { actuarial_mortality_table_calculatorInputs, actuarial_mortality_table_calculatorMetrics, actuarial_mortality_table_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: actuarial_mortality_table_calculatorInputs): number {
...
export function generateAnalysis(inputs: actuarial_mortality_table_calculatorInputs, metrics: actuarial_mortality_table_calculatorMetrics): actuarial_mortality_table_calculatorAnalysis {
