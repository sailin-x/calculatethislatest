import { black_litterman_calculatorInputs, black_litterman_calculatorMetrics, black_litterman_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: black_litterman_calculatorInputs): number {
...
export function generateAnalysis(inputs: black_litterman_calculatorInputs, metrics: black_litterman_calculatorMetrics): black_litterman_calculatorAnalysis {
