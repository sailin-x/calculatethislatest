import { revenue_calculatorCalculatorInputs, revenue_calculatorCalculatorMetrics, revenue_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: revenue_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: revenue_calculatorCalculatorInputs, metrics: revenue_calculatorCalculatorMetrics): revenue_calculatorCalculatorAnalysis {
