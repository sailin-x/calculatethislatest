import { revenue_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: revenue_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
