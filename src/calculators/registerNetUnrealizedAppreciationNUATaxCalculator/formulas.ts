import { registerNetUnrealizedAppreciationNUATaxCalculatorInputs, registerNetUnrealizedAppreciationNUATaxCalculatorMetrics, registerNetUnrealizedAppreciationNUATaxCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerNetUnrealizedAppreciationNUATaxCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerNetUnrealizedAppreciationNUATaxCalculatorInputs, metrics: registerNetUnrealizedAppreciationNUATaxCalculatorMetrics): registerNetUnrealizedAppreciationNUATaxCalculatorAnalysis {
