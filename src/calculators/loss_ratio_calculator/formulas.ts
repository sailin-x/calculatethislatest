import { loss_ratio_calculatorInputs, loss_ratio_calculatorMetrics, loss_ratio_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: loss_ratio_calculatorInputs): number {
...
export function generateAnalysis(inputs: loss_ratio_calculatorInputs, metrics: loss_ratio_calculatorMetrics): loss_ratio_calculatorAnalysis {
