import { financial_achievement_calculatorCalculatorInputs, financial_achievement_calculatorCalculatorMetrics, financial_achievement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_achievement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_achievement_calculatorCalculatorInputs, metrics: financial_achievement_calculatorCalculatorMetrics): financial_achievement_calculatorCalculatorAnalysis {
