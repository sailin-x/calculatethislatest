import { prenuptial_agreement_value_calculatorInputs, prenuptial_agreement_value_calculatorMetrics, prenuptial_agreement_value_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: prenuptial_agreement_value_calculatorInputs): number {
...
export function generateAnalysis(inputs: prenuptial_agreement_value_calculatorInputs, metrics: prenuptial_agreement_value_calculatorMetrics): prenuptial_agreement_value_calculatorAnalysis {
