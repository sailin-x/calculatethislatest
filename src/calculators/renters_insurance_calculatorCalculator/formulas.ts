import { renters_insurance_calculatorCalculatorInputs, renters_insurance_calculatorCalculatorMetrics, renters_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: renters_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: renters_insurance_calculatorCalculatorInputs, metrics: renters_insurance_calculatorCalculatorMetrics): renters_insurance_calculatorCalculatorAnalysis {
