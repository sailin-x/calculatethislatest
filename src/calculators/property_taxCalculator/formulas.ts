import { property_taxCalculatorInputs, property_taxCalculatorMetrics, property_taxCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: property_taxCalculatorInputs): number {
...
export function generateAnalysis(inputs: property_taxCalculatorInputs, metrics: property_taxCalculatorMetrics): property_taxCalculatorAnalysis {
