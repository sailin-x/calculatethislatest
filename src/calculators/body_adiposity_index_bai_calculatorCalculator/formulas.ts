import { body_adiposity_index_bai_calculatorCalculatorInputs, body_adiposity_index_bai_calculatorCalculatorMetrics, body_adiposity_index_bai_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: body_adiposity_index_bai_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: body_adiposity_index_bai_calculatorCalculatorInputs, metrics: body_adiposity_index_bai_calculatorCalculatorMetrics): body_adiposity_index_bai_calculatorCalculatorAnalysis {
