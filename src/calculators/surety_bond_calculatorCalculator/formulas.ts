import { surety_bond_calculatorCalculatorInputs, surety_bond_calculatorCalculatorMetrics, surety_bond_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: surety_bond_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: surety_bond_calculatorCalculatorInputs, metrics: surety_bond_calculatorCalculatorMetrics): surety_bond_calculatorCalculatorAnalysis {
