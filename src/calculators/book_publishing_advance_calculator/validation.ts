import { book_publishing_advance_calculatorInputs } from './types';

export function validateInputs(inputs: book_publishing_advance_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
