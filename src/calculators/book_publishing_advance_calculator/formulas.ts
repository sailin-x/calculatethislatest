import { book_publishing_advance_calculatorInputs, book_publishing_advance_calculatorMetrics, book_publishing_advance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: book_publishing_advance_calculatorInputs): number {
...
export function generateAnalysis(inputs: book_publishing_advance_calculatorInputs, metrics: book_publishing_advance_calculatorMetrics): book_publishing_advance_calculatorAnalysis {
