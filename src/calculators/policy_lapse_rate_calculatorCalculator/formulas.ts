import { policy_lapse_rate_calculatorCalculatorInputs, policy_lapse_rate_calculatorCalculatorMetrics, policy_lapse_rate_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: policy_lapse_rate_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: policy_lapse_rate_calculatorCalculatorInputs, metrics: policy_lapse_rate_calculatorCalculatorMetrics): policy_lapse_rate_calculatorCalculatorAnalysis {
