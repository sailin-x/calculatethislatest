import { policy_lapse_rate_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: policy_lapse_rate_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
