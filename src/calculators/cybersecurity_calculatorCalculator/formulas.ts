import { cybersecurity_calculatorCalculatorInputs, cybersecurity_calculatorCalculatorMetrics, cybersecurity_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cybersecurity_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cybersecurity_calculatorCalculatorInputs, metrics: cybersecurity_calculatorCalculatorMetrics): cybersecurity_calculatorCalculatorAnalysis {
