import { cybersecurity_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: cybersecurity_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
