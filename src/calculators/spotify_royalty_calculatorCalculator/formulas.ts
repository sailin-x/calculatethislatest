import { spotify_royalty_calculatorCalculatorInputs, spotify_royalty_calculatorCalculatorMetrics, spotify_royalty_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: spotify_royalty_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: spotify_royalty_calculatorCalculatorInputs, metrics: spotify_royalty_calculatorCalculatorMetrics): spotify_royalty_calculatorCalculatorAnalysis {
