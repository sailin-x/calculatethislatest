import { spotify_royalty_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: spotify_royalty_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
