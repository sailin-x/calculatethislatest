import { sortino_ratio_calculatorInputs, sortino_ratio_calculatorMetrics, sortino_ratio_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: sortino_ratio_calculatorInputs): number {
...
export function generateAnalysis(inputs: sortino_ratio_calculatorInputs, metrics: sortino_ratio_calculatorMetrics): sortino_ratio_calculatorAnalysis {
