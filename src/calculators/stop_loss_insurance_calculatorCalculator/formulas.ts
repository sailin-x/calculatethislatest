import { stop_loss_insurance_calculatorCalculatorInputs, stop_loss_insurance_calculatorCalculatorMetrics, stop_loss_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: stop_loss_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: stop_loss_insurance_calculatorCalculatorInputs, metrics: stop_loss_insurance_calculatorCalculatorMetrics): stop_loss_insurance_calculatorCalculatorAnalysis {
