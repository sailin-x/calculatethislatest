import { pet_insurance_calculatorInputs, pet_insurance_calculatorMetrics, pet_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: pet_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: pet_insurance_calculatorInputs, metrics: pet_insurance_calculatorMetrics): pet_insurance_calculatorAnalysis {
