import { key_person_insurance_calculatorCalculatorInputs, key_person_insurance_calculatorCalculatorMetrics, key_person_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: key_person_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: key_person_insurance_calculatorCalculatorInputs, metrics: key_person_insurance_calculatorCalculatorMetrics): key_person_insurance_calculatorCalculatorAnalysis {
