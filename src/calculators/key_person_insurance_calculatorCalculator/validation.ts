import { key_person_insurance_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: key_person_insurance_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
