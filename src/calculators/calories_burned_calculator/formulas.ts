import { calories_burned_calculatorInputs, calories_burned_calculatorMetrics, calories_burned_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: calories_burned_calculatorInputs): number {
...
export function generateAnalysis(inputs: calories_burned_calculatorInputs, metrics: calories_burned_calculatorMetrics): calories_burned_calculatorAnalysis {
