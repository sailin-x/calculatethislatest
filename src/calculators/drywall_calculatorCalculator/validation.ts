import { drywall_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: drywall_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
