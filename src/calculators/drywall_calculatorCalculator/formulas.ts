import { drywall_calculatorCalculatorInputs, drywall_calculatorCalculatorMetrics, drywall_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: drywall_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: drywall_calculatorCalculatorInputs, metrics: drywall_calculatorCalculatorMetrics): drywall_calculatorCalculatorAnalysis {
