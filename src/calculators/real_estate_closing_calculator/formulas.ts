import { real_estate_closing_calculatorInputs, real_estate_closing_calculatorMetrics, real_estate_closing_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: real_estate_closing_calculatorInputs): number {
...
export function generateAnalysis(inputs: real_estate_closing_calculatorInputs, metrics: real_estate_closing_calculatorMetrics): real_estate_closing_calculatorAnalysis {
