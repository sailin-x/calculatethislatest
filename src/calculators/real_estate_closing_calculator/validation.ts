import { real_estate_closing_calculatorInputs } from './types';

export function validateInputs(inputs: real_estate_closing_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
