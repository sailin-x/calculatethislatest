import { siding_calculatorInputs, siding_calculatorMetrics, siding_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: siding_calculatorInputs): number {
...
export function generateAnalysis(inputs: siding_calculatorInputs, metrics: siding_calculatorMetrics): siding_calculatorAnalysis {
