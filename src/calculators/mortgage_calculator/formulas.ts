import { mortgage_calculatorInputs, mortgage_calculatorMetrics, mortgage_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgage_calculatorInputs): number {
...
export function generateAnalysis(inputs: mortgage_calculatorInputs, metrics: mortgage_calculatorMetrics): mortgage_calculatorAnalysis {
