import { average_order_value_calculatorInputs, average_order_value_calculatorMetrics, average_order_value_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: average_order_value_calculatorInputs): number {
...
export function generateAnalysis(inputs: average_order_value_calculatorInputs, metrics: average_order_value_calculatorMetrics): average_order_value_calculatorAnalysis {
