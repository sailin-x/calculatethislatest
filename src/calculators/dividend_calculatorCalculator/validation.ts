import { dividend_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: dividend_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
