import { dividend_calculatorCalculatorInputs, dividend_calculatorCalculatorMetrics, dividend_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: dividend_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: dividend_calculatorCalculatorInputs, metrics: dividend_calculatorCalculatorMetrics): dividend_calculatorCalculatorAnalysis {
