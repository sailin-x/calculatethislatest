import { mortgage_pointsCalculatorInputs, mortgage_pointsCalculatorMetrics, mortgage_pointsCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgage_pointsCalculatorInputs): number {
...
export function generateAnalysis(inputs: mortgage_pointsCalculatorInputs, metrics: mortgage_pointsCalculatorMetrics): mortgage_pointsCalculatorAnalysis {
