import { financial_growth_calculatorInputs } from './types';

export function validateInputs(inputs: financial_growth_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
