import { financial_growth_calculatorInputs, financial_growth_calculatorMetrics, financial_growth_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_growth_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_growth_calculatorInputs, metrics: financial_growth_calculatorMetrics): financial_growth_calculatorAnalysis {
