import { maximum_drawdown_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: maximum_drawdown_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
