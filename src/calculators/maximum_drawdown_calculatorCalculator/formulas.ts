import { maximum_drawdown_calculatorCalculatorInputs, maximum_drawdown_calculatorCalculatorMetrics, maximum_drawdown_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: maximum_drawdown_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: maximum_drawdown_calculatorCalculatorInputs, metrics: maximum_drawdown_calculatorCalculatorMetrics): maximum_drawdown_calculatorCalculatorAnalysis {
