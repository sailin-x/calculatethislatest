import { executive_deferred_compensation_plan_calculatorCalculatorInputs, executive_deferred_compensation_plan_calculatorCalculatorMetrics, executive_deferred_compensation_plan_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: executive_deferred_compensation_plan_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: executive_deferred_compensation_plan_calculatorCalculatorInputs, metrics: executive_deferred_compensation_plan_calculatorCalculatorMetrics): executive_deferred_compensation_plan_calculatorCalculatorAnalysis {
