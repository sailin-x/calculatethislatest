import { immigration_filing_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: immigration_filing_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
