import { immigration_filing_calculatorCalculatorInputs, immigration_filing_calculatorCalculatorMetrics, immigration_filing_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: immigration_filing_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: immigration_filing_calculatorCalculatorInputs, metrics: immigration_filing_calculatorCalculatorMetrics): immigration_filing_calculatorCalculatorAnalysis {
