import { nutrition_label_calculatorInputs, nutrition_label_calculatorMetrics, nutrition_label_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: nutrition_label_calculatorInputs): number {
...
export function generateAnalysis(inputs: nutrition_label_calculatorInputs, metrics: nutrition_label_calculatorMetrics): nutrition_label_calculatorAnalysis {
