import { nutrition_label_calculatorInputs } from './types';

export function validateInputs(inputs: nutrition_label_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
