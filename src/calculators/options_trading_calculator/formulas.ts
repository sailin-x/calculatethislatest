import { options_trading_calculatorInputs, options_trading_calculatorMetrics, options_trading_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: options_trading_calculatorInputs): number {
...
export function generateAnalysis(inputs: options_trading_calculatorInputs, metrics: options_trading_calculatorMetrics): options_trading_calculatorAnalysis {
