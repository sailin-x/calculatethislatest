import { commodity_calculatorInputs, commodity_calculatorMetrics, commodity_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: commodity_calculatorInputs): number {
...
export function generateAnalysis(inputs: commodity_calculatorInputs, metrics: commodity_calculatorMetrics): commodity_calculatorAnalysis {
