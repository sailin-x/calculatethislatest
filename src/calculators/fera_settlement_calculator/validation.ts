import { fera_settlement_calculatorInputs } from './types';

export function validateInputs(inputs: fera_settlement_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
