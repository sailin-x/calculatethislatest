import { fera_settlement_calculatorInputs, fera_settlement_calculatorMetrics, fera_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fera_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: fera_settlement_calculatorInputs, metrics: fera_settlement_calculatorMetrics): fera_settlement_calculatorAnalysis {
