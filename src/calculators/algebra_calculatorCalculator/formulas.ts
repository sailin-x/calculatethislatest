import { algebra_calculatorCalculatorInputs, algebra_calculatorCalculatorMetrics, algebra_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: algebra_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: algebra_calculatorCalculatorInputs, metrics: algebra_calculatorCalculatorMetrics): algebra_calculatorCalculatorAnalysis {
