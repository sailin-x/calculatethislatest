import { algebra_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: algebra_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
