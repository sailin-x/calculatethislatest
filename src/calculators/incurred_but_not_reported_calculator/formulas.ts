import { incurred_but_not_reported_calculatorInputs, incurred_but_not_reported_calculatorMetrics, incurred_but_not_reported_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: incurred_but_not_reported_calculatorInputs): number {
...
export function generateAnalysis(inputs: incurred_but_not_reported_calculatorInputs, metrics: incurred_but_not_reported_calculatorMetrics): incurred_but_not_reported_calculatorAnalysis {
