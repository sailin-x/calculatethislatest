import { incurred_but_not_reported_calculatorInputs } from './types';

export function validateInputs(inputs: incurred_but_not_reported_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
