import { everyday_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: everyday_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
