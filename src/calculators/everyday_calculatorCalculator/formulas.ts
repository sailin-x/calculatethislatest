import { everyday_calculatorCalculatorInputs, everyday_calculatorCalculatorMetrics, everyday_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: everyday_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: everyday_calculatorCalculatorInputs, metrics: everyday_calculatorCalculatorMetrics): everyday_calculatorCalculatorAnalysis {
