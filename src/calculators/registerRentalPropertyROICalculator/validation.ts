import { registerRentalPropertyROICalculatorInputs } from './types';

export function validateInputs(inputs: registerRentalPropertyROICalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
