import { registerRentalPropertyROICalculatorInputs, registerRentalPropertyROICalculatorMetrics, registerRentalPropertyROICalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerRentalPropertyROICalculatorInputs): number {
...
export function generateAnalysis(inputs: registerRentalPropertyROICalculatorInputs, metrics: registerRentalPropertyROICalculatorMetrics): registerRentalPropertyROICalculatorAnalysis {
