import { birth_injury_malpractice_calculatorCalculatorInputs, birth_injury_malpractice_calculatorCalculatorMetrics, birth_injury_malpractice_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: birth_injury_malpractice_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: birth_injury_malpractice_calculatorCalculatorInputs, metrics: birth_injury_malpractice_calculatorCalculatorMetrics): birth_injury_malpractice_calculatorCalculatorAnalysis {
