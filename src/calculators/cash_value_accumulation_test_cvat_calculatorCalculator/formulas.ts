import { cash_value_accumulation_test_cvat_calculatorCalculatorInputs, cash_value_accumulation_test_cvat_calculatorCalculatorMetrics, cash_value_accumulation_test_cvat_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cash_value_accumulation_test_cvat_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cash_value_accumulation_test_cvat_calculatorCalculatorInputs, metrics: cash_value_accumulation_test_cvat_calculatorCalculatorMetrics): cash_value_accumulation_test_cvat_calculatorCalculatorAnalysis {
