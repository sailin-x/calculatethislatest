import { fitness_age_calculatorInputs, fitness_age_calculatorMetrics, fitness_age_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fitness_age_calculatorInputs): number {
...
export function generateAnalysis(inputs: fitness_age_calculatorInputs, metrics: fitness_age_calculatorMetrics): fitness_age_calculatorAnalysis {
