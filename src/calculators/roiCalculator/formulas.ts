import { roiCalculatorInputs, roiCalculatorMetrics, roiCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: roiCalculatorInputs): number {
...
export function generateAnalysis(inputs: roiCalculatorInputs, metrics: roiCalculatorMetrics): roiCalculatorAnalysis {
