import { savings_goal_calculatorInputs, savings_goal_calculatorMetrics, savings_goal_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: savings_goal_calculatorInputs): number {
...
export function generateAnalysis(inputs: savings_goal_calculatorInputs, metrics: savings_goal_calculatorMetrics): savings_goal_calculatorAnalysis {
