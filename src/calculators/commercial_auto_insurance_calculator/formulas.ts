import { commercial_auto_insurance_calculatorInputs, commercial_auto_insurance_calculatorMetrics, commercial_auto_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: commercial_auto_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: commercial_auto_insurance_calculatorInputs, metrics: commercial_auto_insurance_calculatorMetrics): commercial_auto_insurance_calculatorAnalysis {
