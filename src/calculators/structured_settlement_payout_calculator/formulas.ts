import { structured_settlement_payout_calculatorInputs, structured_settlement_payout_calculatorMetrics, structured_settlement_payout_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: structured_settlement_payout_calculatorInputs): number {
...
export function generateAnalysis(inputs: structured_settlement_payout_calculatorInputs, metrics: structured_settlement_payout_calculatorMetrics): structured_settlement_payout_calculatorAnalysis {
