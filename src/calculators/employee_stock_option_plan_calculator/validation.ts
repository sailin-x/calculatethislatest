import { employee_stock_option_plan_calculatorInputs } from './types';

export function validateInputs(inputs: employee_stock_option_plan_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
