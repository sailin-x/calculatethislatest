import { employee_stock_option_plan_calculatorInputs, employee_stock_option_plan_calculatorMetrics, employee_stock_option_plan_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: employee_stock_option_plan_calculatorInputs): number {
...
export function generateAnalysis(inputs: employee_stock_option_plan_calculatorInputs, metrics: employee_stock_option_plan_calculatorMetrics): employee_stock_option_plan_calculatorAnalysis {
