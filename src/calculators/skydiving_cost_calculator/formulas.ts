import { skydiving_cost_calculatorInputs, skydiving_cost_calculatorMetrics, skydiving_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: skydiving_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: skydiving_cost_calculatorInputs, metrics: skydiving_cost_calculatorMetrics): skydiving_cost_calculatorAnalysis {
