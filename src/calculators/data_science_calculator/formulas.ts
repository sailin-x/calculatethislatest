import { data_science_calculatorInputs, data_science_calculatorMetrics, data_science_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: data_science_calculatorInputs): number {
...
export function generateAnalysis(inputs: data_science_calculatorInputs, metrics: data_science_calculatorMetrics): data_science_calculatorAnalysis {
