import { real_estate_syndication_calculatorInputs } from './types';

export function validateInputs(inputs: real_estate_syndication_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
