import { real_estate_syndication_calculatorInputs, real_estate_syndication_calculatorMetrics, real_estate_syndication_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: real_estate_syndication_calculatorInputs): number {
...
export function generateAnalysis(inputs: real_estate_syndication_calculatorInputs, metrics: real_estate_syndication_calculatorMetrics): real_estate_syndication_calculatorAnalysis {
