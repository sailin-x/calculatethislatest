import { car_rental_cost_calculatorInputs } from './types';

export function validateInputs(inputs: car_rental_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
