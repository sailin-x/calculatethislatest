import { car_rental_cost_calculatorInputs, car_rental_cost_calculatorMetrics, car_rental_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: car_rental_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: car_rental_cost_calculatorInputs, metrics: car_rental_cost_calculatorMetrics): car_rental_cost_calculatorAnalysis {
