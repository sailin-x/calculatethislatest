import { celebrity_endorsement_deal_valuationCalculatorInputs, celebrity_endorsement_deal_valuationCalculatorMetrics, celebrity_endorsement_deal_valuationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: celebrity_endorsement_deal_valuationCalculatorInputs): number {
...
export function generateAnalysis(inputs: celebrity_endorsement_deal_valuationCalculatorInputs, metrics: celebrity_endorsement_deal_valuationCalculatorMetrics): celebrity_endorsement_deal_valuationCalculatorAnalysis {
