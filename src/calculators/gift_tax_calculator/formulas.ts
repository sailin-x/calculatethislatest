import { gift_tax_calculatorInputs, gift_tax_calculatorMetrics, gift_tax_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: gift_tax_calculatorInputs): number {
...
export function generateAnalysis(inputs: gift_tax_calculatorInputs, metrics: gift_tax_calculatorMetrics): gift_tax_calculatorAnalysis {
