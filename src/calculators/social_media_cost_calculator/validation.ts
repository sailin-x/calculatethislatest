import { social_media_cost_calculatorInputs } from './types';

export function validateInputs(inputs: social_media_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
