import { social_media_cost_calculatorInputs, social_media_cost_calculatorMetrics, social_media_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: social_media_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: social_media_cost_calculatorInputs, metrics: social_media_cost_calculatorMetrics): social_media_cost_calculatorAnalysis {
