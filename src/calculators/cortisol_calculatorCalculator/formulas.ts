import { cortisol_calculatorCalculatorInputs, cortisol_calculatorCalculatorMetrics, cortisol_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cortisol_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cortisol_calculatorCalculatorInputs, metrics: cortisol_calculatorCalculatorMetrics): cortisol_calculatorCalculatorAnalysis {
