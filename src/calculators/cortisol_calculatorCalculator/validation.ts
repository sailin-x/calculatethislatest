import { cortisol_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: cortisol_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
