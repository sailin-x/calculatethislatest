import { machine_learning_calculatorInputs, machine_learning_calculatorMetrics, machine_learning_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: machine_learning_calculatorInputs): number {
...
export function generateAnalysis(inputs: machine_learning_calculatorInputs, metrics: machine_learning_calculatorMetrics): machine_learning_calculatorAnalysis {
