import { machine_learning_calculatorInputs } from './types';

export function validateInputs(inputs: machine_learning_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
