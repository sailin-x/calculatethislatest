import { cybersecurity_calculatorInputs, cybersecurity_calculatorMetrics, cybersecurity_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cybersecurity_calculatorInputs): number {
...
export function generateAnalysis(inputs: cybersecurity_calculatorInputs, metrics: cybersecurity_calculatorMetrics): cybersecurity_calculatorAnalysis {
