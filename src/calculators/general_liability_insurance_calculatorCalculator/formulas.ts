import { general_liability_insurance_calculatorCalculatorInputs, general_liability_insurance_calculatorCalculatorMetrics, general_liability_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: general_liability_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: general_liability_insurance_calculatorCalculatorInputs, metrics: general_liability_insurance_calculatorCalculatorMetrics): general_liability_insurance_calculatorCalculatorAnalysis {
