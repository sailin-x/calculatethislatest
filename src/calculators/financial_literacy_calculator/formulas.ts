import { financial_literacy_calculatorInputs, financial_literacy_calculatorMetrics, financial_literacy_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_literacy_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_literacy_calculatorInputs, metrics: financial_literacy_calculatorMetrics): financial_literacy_calculatorAnalysis {
