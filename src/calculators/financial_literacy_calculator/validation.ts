import { financial_literacy_calculatorInputs } from './types';

export function validateInputs(inputs: financial_literacy_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
