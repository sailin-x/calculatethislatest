import { startup_valuation_calculatorCalculatorInputs, startup_valuation_calculatorCalculatorMetrics, startup_valuation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: startup_valuation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: startup_valuation_calculatorCalculatorInputs, metrics: startup_valuation_calculatorCalculatorMetrics): startup_valuation_calculatorCalculatorAnalysis {
