import { student_loan_calculatorInputs, student_loan_calculatorMetrics, student_loan_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: student_loan_calculatorInputs): number {
...
export function generateAnalysis(inputs: student_loan_calculatorInputs, metrics: student_loan_calculatorMetrics): student_loan_calculatorAnalysis {
