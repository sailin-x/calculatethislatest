import { self_funded_health_plan_calculatorCalculatorInputs, self_funded_health_plan_calculatorCalculatorMetrics, self_funded_health_plan_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: self_funded_health_plan_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: self_funded_health_plan_calculatorCalculatorInputs, metrics: self_funded_health_plan_calculatorCalculatorMetrics): self_funded_health_plan_calculatorCalculatorAnalysis {
