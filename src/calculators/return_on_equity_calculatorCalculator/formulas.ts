import { return_on_equity_calculatorCalculatorInputs, return_on_equity_calculatorCalculatorMetrics, return_on_equity_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: return_on_equity_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: return_on_equity_calculatorCalculatorInputs, metrics: return_on_equity_calculatorCalculatorMetrics): return_on_equity_calculatorCalculatorAnalysis {
