import { return_on_equity_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: return_on_equity_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
