import { restaurant_tip_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: restaurant_tip_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
