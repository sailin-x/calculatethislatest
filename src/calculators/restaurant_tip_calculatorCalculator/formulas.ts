import { restaurant_tip_calculatorCalculatorInputs, restaurant_tip_calculatorCalculatorMetrics, restaurant_tip_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: restaurant_tip_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: restaurant_tip_calculatorCalculatorInputs, metrics: restaurant_tip_calculatorCalculatorMetrics): restaurant_tip_calculatorCalculatorAnalysis {
