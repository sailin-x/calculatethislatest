import { mortgage_vs_rentCalculatorInputs, mortgage_vs_rentCalculatorMetrics, mortgage_vs_rentCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgage_vs_rentCalculatorInputs): number {
...
export function generateAnalysis(inputs: mortgage_vs_rentCalculatorInputs, metrics: mortgage_vs_rentCalculatorMetrics): mortgage_vs_rentCalculatorAnalysis {
