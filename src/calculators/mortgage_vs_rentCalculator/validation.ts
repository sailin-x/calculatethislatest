import { mortgage_vs_rentCalculatorInputs } from './types';

export function validateInputs(inputs: mortgage_vs_rentCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
