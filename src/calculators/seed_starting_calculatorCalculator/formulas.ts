import { seed_starting_calculatorCalculatorInputs, seed_starting_calculatorCalculatorMetrics, seed_starting_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: seed_starting_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: seed_starting_calculatorCalculatorInputs, metrics: seed_starting_calculatorCalculatorMetrics): seed_starting_calculatorCalculatorAnalysis {
