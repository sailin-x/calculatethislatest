import { saas_metricsCalculatorInputs, saas_metricsCalculatorMetrics, saas_metricsCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: saas_metricsCalculatorInputs): number {
...
export function generateAnalysis(inputs: saas_metricsCalculatorInputs, metrics: saas_metricsCalculatorMetrics): saas_metricsCalculatorAnalysis {
