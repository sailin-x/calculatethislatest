import { influencer_marketing_earned_media_value_emv_calculatorInputs, influencer_marketing_earned_media_value_emv_calculatorMetrics, influencer_marketing_earned_media_value_emv_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: influencer_marketing_earned_media_value_emv_calculatorInputs): number {
...
export function generateAnalysis(inputs: influencer_marketing_earned_media_value_emv_calculatorInputs, metrics: influencer_marketing_earned_media_value_emv_calculatorMetrics): influencer_marketing_earned_media_value_emv_calculatorAnalysis {
