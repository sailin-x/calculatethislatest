import { calculus_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: calculus_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
