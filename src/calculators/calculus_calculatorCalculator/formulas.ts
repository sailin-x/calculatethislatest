import { calculus_calculatorCalculatorInputs, calculus_calculatorCalculatorMetrics, calculus_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: calculus_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: calculus_calculatorCalculatorInputs, metrics: calculus_calculatorCalculatorMetrics): calculus_calculatorCalculatorAnalysis {
