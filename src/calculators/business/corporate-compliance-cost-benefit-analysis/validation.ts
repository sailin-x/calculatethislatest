import { CorporateComplianceCostbenefitAnalysisInputs } from './types';

export function validateCorporateComplianceCostbenefitAnalysisInputs(inputs: CorporateComplianceCostbenefitAnalysisInputs): Array<{ field: string; message: string }> {
...
export function validateCorporateComplianceCostbenefitAnalysisBusinessRules(inputs: CorporateComplianceCostbenefitAnalysisInputs): Array<{ field: string; message: string }> {
