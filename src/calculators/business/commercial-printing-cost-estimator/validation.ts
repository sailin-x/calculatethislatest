import { CommercialPrintingCostEstimatorInputs } from './types';

export function validateCommercialPrintingCostEstimatorInputs(inputs: CommercialPrintingCostEstimatorInputs): Array<{ field: string; message: string }> {
...
export function validateCommercialPrintingCostEstimatorBusinessRules(inputs: CommercialPrintingCostEstimatorInputs): Array<{ field: string; message: string }> {
