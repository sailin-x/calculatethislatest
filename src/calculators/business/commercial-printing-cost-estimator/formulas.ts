import { CommercialPrintingCost-estimatorInputs, CommercialPrintingCost-estimatorMetrics, CommercialPrintingCost-estimatorAnalysis } from './types';
...
export function calculateResult(inputs: CommercialPrintingCost-estimatorInputs): number {
...
export function generateAnalysis(inputs: CommercialPrintingCost-estimatorInputs, metrics: CommercialPrintingCost-estimatorMetrics): CommercialPrintingCost-estimatorAnalysis {
