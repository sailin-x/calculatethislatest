import { FuelCostTripCalculatorInputs } from './types';

export function validateFuelCostTripCalculatorInputs(inputs: FuelCostTripCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateFuelCostTripCalculatorBusinessRules(inputs: FuelCostTripCalculatorInputs): Array<{ field: string; message: string }> {
