export interface FuelCostTripCalculatorInputs {
...
export interface FuelCostTripCalculatorOutputs {
...
export interface FuelCostTripCalculatorMetrics {
...
export interface FuelCostTripCalculatorAnalysis {
