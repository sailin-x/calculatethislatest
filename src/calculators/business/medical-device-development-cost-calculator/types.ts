export interface MedicalDeviceDevelopmentCostCalculatorInputs {
...
export interface MedicalDeviceDevelopmentCostCalculatorOutputs {
...
export interface MedicalDeviceDevelopmentCostCalculatorMetrics {
...
export interface MedicalDeviceDevelopmentCostCalculatorAnalysis {
