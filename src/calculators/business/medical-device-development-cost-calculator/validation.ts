import { MedicalDeviceDevelopmentCostCalculatorInputs } from './types';

export function validateMedicalDeviceDevelopmentCostCalculatorInputs(inputs: MedicalDeviceDevelopmentCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMedicalDeviceDevelopmentCostCalculatorBusinessRules(inputs: MedicalDeviceDevelopmentCostCalculatorInputs): Array<{ field: string; message: string }> {
