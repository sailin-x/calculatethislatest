export interface PrecisionAgricultureRoiCalculatorInputs {
...
export interface PrecisionAgricultureRoiCalculatorOutputs {
...
export interface PrecisionAgricultureRoiCalculatorMetrics {
...
export interface PrecisionAgricultureRoiCalculatorAnalysis {
