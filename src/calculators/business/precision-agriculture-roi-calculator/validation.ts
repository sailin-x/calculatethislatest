import { PrecisionAgricultureRoiCalculatorInputs } from './types';

export function validatePrecisionAgricultureRoiCalculatorInputs(inputs: PrecisionAgricultureRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePrecisionAgricultureRoiCalculatorBusinessRules(inputs: PrecisionAgricultureRoiCalculatorInputs): Array<{ field: string; message: string }> {
