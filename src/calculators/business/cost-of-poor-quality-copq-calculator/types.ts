export interface CostOfPoorQualityCopqCalculatorInputs {
...
export interface CostOfPoorQualityCopqCalculatorOutputs {
...
export interface CostOfPoorQualityCopqCalculatorMetrics {
...
export interface CostOfPoorQualityCopqCalculatorAnalysis {
