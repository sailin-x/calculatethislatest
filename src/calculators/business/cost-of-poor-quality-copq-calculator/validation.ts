import { CostOfPoorQualityCopqCalculatorInputs } from './types';

export function validateCostOfPoorQualityCopqCalculatorInputs(inputs: CostOfPoorQualityCopqCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCostOfPoorQualityCopqCalculatorBusinessRules(inputs: CostOfPoorQualityCopqCalculatorInputs): Array<{ field: string; message: string }> {
