...
import { CorporateComplianceCostBenefitCalculatorInputs, CorporateComplianceCostBenefitCalculatorOutputs } from './types';
import {
...
export const CorporateComplianceCostBenefitCalculator: Calculator = {
  ...
  description: 'Calculate compliance cost benefits',
  usageInstructions: [
