import { OffshoreDecommissioningCostEstimatorInputs } from './types';

export function validateOffshoreDecommissioningCostEstimatorInputs(inputs: OffshoreDecommissioningCostEstimatorInputs): Array<{ field: string; message: string }> {
...
export function validateOffshoreDecommissioningCostEstimatorBusinessRules(inputs: OffshoreDecommissioningCostEstimatorInputs): Array<{ field: string; message: string }> {
