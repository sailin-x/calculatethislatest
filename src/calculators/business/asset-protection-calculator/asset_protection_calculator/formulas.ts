import { asset_protection_calculatorInputs, asset_protection_calculatorMetrics, asset_protection_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: asset_protection_calculatorInputs): number {
...
export function generateAnalysis(inputs: asset_protection_calculatorInputs, metrics: asset_protection_calculatorMetrics): asset_protection_calculatorAnalysis {
