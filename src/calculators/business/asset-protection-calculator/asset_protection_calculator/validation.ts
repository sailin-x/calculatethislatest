import { asset_protection_calculatorInputs } from './types';

export function validateInputs(inputs: asset_protection_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
