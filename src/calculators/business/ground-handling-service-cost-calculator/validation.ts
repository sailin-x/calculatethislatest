import { GroundHandlingServiceCostCalculatorInputs } from './types';

export function validateGroundHandlingServiceCostCalculatorInputs(inputs: GroundHandlingServiceCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateGroundHandlingServiceCostCalculatorBusinessRules(inputs: GroundHandlingServiceCostCalculatorInputs): Array<{ field: string; message: string }> {
