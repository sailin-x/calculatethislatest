export interface CropYieldProfitabilityCalculatorInputs {
...
export interface CropYieldProfitabilityCalculatorOutputs {
...
export interface CropYieldProfitabilityCalculatorMetrics {
...
export interface CropYieldProfitabilityCalculatorAnalysis {
