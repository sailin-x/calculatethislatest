import { CropYieldProfitability-calculatorInputs, CropYieldProfitability-calculatorMetrics, CropYieldProfitability-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: CropYieldProfitability-calculatorInputs): number {
...
export function generateAnalysis(inputs: CropYieldProfitability-calculatorInputs, metrics: CropYieldProfitability-calculatorMetrics): CropYieldProfitability-calculatorAnalysis {
