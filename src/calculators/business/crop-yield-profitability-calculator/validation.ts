import { CropYieldProfitabilityCalculatorInputs } from './types';

export function validateCropYieldProfitabilityCalculatorInputs(inputs: CropYieldProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCropYieldProfitabilityCalculatorBusinessRules(inputs: CropYieldProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
