import { AdViewabilityImpactOnRoiCalculatorInputs } from './types';

export function validateAdViewabilityImpactOnRoiCalculatorInputs(inputs: AdViewabilityImpactOnRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAdViewabilityImpactOnRoiCalculatorBusinessRules(inputs: AdViewabilityImpactOnRoiCalculatorInputs): Array<{ field: string; message: string }> {
