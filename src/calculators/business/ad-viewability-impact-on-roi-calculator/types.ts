export interface AdViewabilityImpactOnRoiCalculatorInputs {
...
export interface AdViewabilityImpactOnRoiCalculatorOutputs {
...
export interface AdViewabilityImpactOnRoiCalculatorMetrics {
...
export interface AdViewabilityImpactOnRoiCalculatorAnalysis {
