import { FranchiseRoiCalculatorInputs } from './types';

export function validateFranchiseRoiCalculatorInputs(inputs: FranchiseRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateFranchiseRoiCalculatorBusinessRules(inputs: FranchiseRoiCalculatorInputs): Array<{ field: string; message: string }> {
