export interface FranchiseRoiCalculatorInputs {
...
export interface FranchiseRoiCalculatorOutputs {
...
export interface FranchiseRoiCalculatorMetrics {
...
export interface FranchiseRoiCalculatorAnalysis {
