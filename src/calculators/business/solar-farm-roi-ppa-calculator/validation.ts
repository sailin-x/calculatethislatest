import { SolarFarmRoiPpaCalculatorInputs } from './types';

export function validateSolarFarmRoiPpaCalculatorInputs(inputs: SolarFarmRoiPpaCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateSolarFarmRoiPpaCalculatorBusinessRules(inputs: SolarFarmRoiPpaCalculatorInputs): Array<{ field: string; message: string }> {
