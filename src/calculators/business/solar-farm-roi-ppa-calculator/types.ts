export interface SolarFarmRoiPpaCalculatorInputs {
...
export interface SolarFarmRoiPpaCalculatorOutputs {
...
export interface SolarFarmRoiPpaCalculatorMetrics {
...
export interface SolarFarmRoiPpaCalculatorAnalysis {
