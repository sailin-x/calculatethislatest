export interface StartupValuationCalculatorInputs {
...
export interface StartupValuationCalculatorOutputs {
...
export interface StartupValuationCalculatorMetrics {
...
export interface StartupValuationCalculatorAnalysis {
