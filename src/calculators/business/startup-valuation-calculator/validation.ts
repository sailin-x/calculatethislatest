import { StartupValuationCalculatorInputs } from './types';

export function validateStartupValuationCalculatorInputs(inputs: StartupValuationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateStartupValuationCalculatorBusinessRules(inputs: StartupValuationCalculatorInputs): Array<{ field: string; message: string }> {
