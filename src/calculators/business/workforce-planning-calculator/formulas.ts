import { workforce-planning-calculatorInputs, workforce-planning-calculatorMetrics, workforce-planning-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: workforce-planning-calculatorInputs): number {
...
export function generateAnalysis(inputs: workforce-planning-calculatorInputs, metrics: workforce-planning-calculatorMetrics): workforce-planning-calculatorAnalysis {
