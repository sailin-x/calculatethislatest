import { WorkforcePlanningCalculatorinputs, WorkforcePlanningCalculatormetrics, WorkforcePlanningCalculatoranalysis } from './types';
...
export function calculateResult(inputs: WorkforcePlanningCalculatorinputs): number {
...
export function generateAnalysis(inputs: WorkforcePlanningCalculatorinputs, metrics: WorkforcePlanningCalculatormetrics): WorkforcePlanningCalculatoranalysis {
