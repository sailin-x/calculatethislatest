...
import { AiopsImplementationSavingsCalculatorInputs, AiopsImplementationSavingsCalculatorOutputs } from './types';
import {
...
export const AiopsImplementationSavingsCalculator: Calculator = {
  ...
  description: 'Calculate AI operations cost savings',
  usageInstructions: [
