import { aiops_implementation_savings_calculatorInputs, aiops_implementation_savings_calculatorMetrics, aiops_implementation_savings_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: aiops_implementation_savings_calculatorInputs): number {
...
export function generateAnalysis(inputs: aiops_implementation_savings_calculatorInputs, metrics: aiops_implementation_savings_calculatorMetrics): aiops_implementation_savings_calculatorAnalysis {
