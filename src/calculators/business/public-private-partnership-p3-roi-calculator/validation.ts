import { PublicprivatePartnershipP3RoiCalculatorInputs } from './types';

export function validatePublicprivatePartnershipP3RoiCalculatorInputs(inputs: PublicprivatePartnershipP3RoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePublicprivatePartnershipP3RoiCalculatorBusinessRules(inputs: PublicprivatePartnershipP3RoiCalculatorInputs): Array<{ field: string; message: string }> {
