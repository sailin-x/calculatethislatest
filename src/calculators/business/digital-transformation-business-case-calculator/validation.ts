import { DigitalTransformationBusinessCaseCalculatorInputs } from './types';

export function validateDigitalTransformationBusinessCaseCalculatorInputs(inputs: DigitalTransformationBusinessCaseCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDigitalTransformationBusinessCaseCalculatorBusinessRules(inputs: DigitalTransformationBusinessCaseCalculatorInputs): Array<{ field: string; message: string }> {
