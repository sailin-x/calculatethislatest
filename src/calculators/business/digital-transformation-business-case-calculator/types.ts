export interface DigitalTransformationBusinessCaseCalculatorInputs {
...
export interface DigitalTransformationBusinessCaseCalculatorOutputs {
...
export interface DigitalTransformationBusinessCaseCalculatorMetrics {
...
export interface DigitalTransformationBusinessCaseCalculatorAnalysis {
