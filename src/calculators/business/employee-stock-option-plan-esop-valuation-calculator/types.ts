export interface EmployeeStockOptionPlanEsopValuationCalculatorInputs {
...
export interface EmployeeStockOptionPlanEsopValuationCalculatorOutputs {
...
export interface EmployeeStockOptionPlanEsopValuationCalculatorMetrics {
...
export interface EmployeeStockOptionPlanEsopValuationCalculatorAnalysis {
