...
export function validateEmployeeStockOptionPlanEsopValuationCalculatorInputs(inputs: EmployeeStockOptionPlanEsopValuationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateEmployeeStockOptionPlanEsopValuationCalculatorBusinessRules(inputs: EmployeeStockOptionPlanEsopValuationCalculatorInputs): Array<{ field: string; message: string }> {
