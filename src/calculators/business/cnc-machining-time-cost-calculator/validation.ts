import { CncMachiningTimeCostCalculatorInputs } from './types';

export function validateCncMachiningTimeCostCalculatorInputs(inputs: CncMachiningTimeCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCncMachiningTimeCostCalculatorBusinessRules(inputs: CncMachiningTimeCostCalculatorInputs): Array<{ field: string; message: string }> {
