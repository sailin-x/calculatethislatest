export interface CncMachiningTimeCostCalculatorInputs {
...
export interface CncMachiningTimeCostCalculatorOutputs {
...
export interface CncMachiningTimeCostCalculatorMetrics {
...
export interface CncMachiningTimeCostCalculatorAnalysis {
