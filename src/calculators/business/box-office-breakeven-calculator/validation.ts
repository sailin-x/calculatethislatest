import { BoxOfficeBreakevenCalculatorInputs } from './types';

export function validateBoxOfficeBreakevenCalculatorInputs(inputs: BoxOfficeBreakevenCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBoxOfficeBreakevenCalculatorBusinessRules(inputs: BoxOfficeBreakevenCalculatorInputs): Array<{ field: string; message: string }> {
