export interface BoxOfficeBreakevenCalculatorInputs {
...
export interface BoxOfficeBreakevenCalculatorOutputs {
...
export interface BoxOfficeBreakevenCalculatorMetrics {
...
export interface BoxOfficeBreakevenCalculatorAnalysis {
