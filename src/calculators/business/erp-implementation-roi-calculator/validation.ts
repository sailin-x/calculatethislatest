import { ErpImplementationRoiCalculatorInputs } from './types';

export function validateErpImplementationRoiCalculatorInputs(inputs: ErpImplementationRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateErpImplementationRoiCalculatorBusinessRules(inputs: ErpImplementationRoiCalculatorInputs): Array<{ field: string; message: string }> {
