export interface ErpImplementationRoiCalculatorInputs {
...
export interface ErpImplementationRoiCalculatorOutputs {
...
export interface ErpImplementationRoiCalculatorMetrics {
...
export interface ErpImplementationRoiCalculatorAnalysis {
