import { FlightCrewScheduling-cost-calculatorInputs, FlightCrewScheduling-cost-calculatorMetrics, FlightCrewScheduling-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: FlightCrewScheduling-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: FlightCrewScheduling-cost-calculatorInputs, metrics: FlightCrewScheduling-cost-calculatorMetrics): FlightCrewScheduling-cost-calculatorAnalysis {
