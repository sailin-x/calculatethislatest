import { flight-crew-scheduling-cost-calculatorInputs, flight-crew-scheduling-cost-calculatorMetrics, flight-crew-scheduling-cost-calculatorAnalysis } from './types';

// Flight Crew Scheduling Cost Calculator - Business calculations
...
export function calculateResult(inputs: flight-crew-scheduling-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: flight-crew-scheduling-cost-calculatorInputs, metrics: flight-crew-scheduling-cost-calculatorMetrics): flight-crew-scheduling-cost-calculatorAnalysis {
