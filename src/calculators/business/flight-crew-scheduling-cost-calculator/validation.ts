import { FlightCrewSchedulingCostCalculatorInputs } from './types';

export function validateFlightCrewSchedulingCostCalculatorInputs(inputs: FlightCrewSchedulingCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateFlightCrewSchedulingCostCalculatorBusinessRules(inputs: FlightCrewSchedulingCostCalculatorInputs): Array<{ field: string; message: string }> {
