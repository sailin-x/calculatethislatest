export interface TripleNetNnnLeaseRoiCalculatorInputs {
...
export interface TripleNetNnnLeaseRoiCalculatorOutputs {
...
export interface TripleNetNnnLeaseRoiCalculatorMetrics {
...
export interface TripleNetNnnLeaseRoiCalculatorAnalysis {
