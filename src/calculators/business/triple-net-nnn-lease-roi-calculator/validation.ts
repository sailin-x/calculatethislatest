import { TripleNetNnnLeaseRoiCalculatorInputs } from './types';

export function validateTripleNetNnnLeaseRoiCalculatorInputs(inputs: TripleNetNnnLeaseRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTripleNetNnnLeaseRoiCalculatorBusinessRules(inputs: TripleNetNnnLeaseRoiCalculatorInputs): Array<{ field: string; message: string }> {
