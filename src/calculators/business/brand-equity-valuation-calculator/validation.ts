import { BrandEquityValuationCalculatorInputs } from './types';

export function validateBrandEquityValuationCalculatorInputs(inputs: BrandEquityValuationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBrandEquityValuationCalculatorBusinessRules(inputs: BrandEquityValuationCalculatorInputs): Array<{ field: string; message: string }> {
