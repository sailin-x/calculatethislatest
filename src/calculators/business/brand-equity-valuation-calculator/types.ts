export interface BrandEquityValuationCalculatorInputs {
...
export interface BrandEquityValuationCalculatorOutputs {
...
export interface BrandEquityValuationCalculatorMetrics {
...
export interface BrandEquityValuationCalculatorAnalysis {
