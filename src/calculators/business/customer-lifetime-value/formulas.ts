import { customer-lifetime-valueInputs, customer-lifetime-valueMetrics, customer-lifetime-valueAnalysis } from './types';
...
export function calculateResult(inputs: customer-lifetime-valueInputs): number {
...
export function generateAnalysis(inputs: customer-lifetime-valueInputs, metrics: customer-lifetime-valueMetrics): customer-lifetime-valueAnalysis {
