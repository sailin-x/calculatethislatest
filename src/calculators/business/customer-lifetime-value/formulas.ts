import { CustomerLifetimeValueinputs, CustomerLifetimeValuemetrics, CustomerLifetimeValueanalysis } from './types';
...
export function calculateResult(inputs: CustomerLifetimeValueinputs): number {
...
export function generateAnalysis(inputs: CustomerLifetimeValueinputs, metrics: CustomerLifetimeValuemetrics): CustomerLifetimeValueanalysis {
