...
export function validateBusinessProcessReengineeringBprSavingsCalculatorInputs(inputs: BusinessProcessReengineeringBprSavingsCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBusinessProcessReengineeringBprSavingsCalculatorBusinessRules(inputs: BusinessProcessReengineeringBprSavingsCalculatorInputs): Array<{ field: string; message: string }> {
