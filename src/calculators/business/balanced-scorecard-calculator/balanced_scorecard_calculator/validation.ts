import { balanced_scorecard_calculatorInputs } from './types';

export function validateInputs(inputs: balanced_scorecard_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
