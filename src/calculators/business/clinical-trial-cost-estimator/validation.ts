import { ClinicalTrialCostEstimatorInputs } from './types';

export function validateClinicalTrialCostEstimatorInputs(inputs: ClinicalTrialCostEstimatorInputs): Array<{ field: string; message: string }> {
...
export function validateClinicalTrialCostEstimatorBusinessRules(inputs: ClinicalTrialCostEstimatorInputs): Array<{ field: string; message: string }> {
