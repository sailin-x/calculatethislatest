import { ItOutsourcingVsInhouseCostbenefitAnalysisInputs } from './types';

export function validateItOutsourcingVsInhouseCostbenefitAnalysisInputs(inputs: ItOutsourcingVsInhouseCostbenefitAnalysisInputs): Array<{ field: string; message: string }> {
...
export function validateItOutsourcingVsInhouseCostbenefitAnalysisBusinessRules(inputs: ItOutsourcingVsInhouseCostbenefitAnalysisInputs): Array<{ field: string; message: string }> {
