...
export const ItOutsourcingVsInHouseCostBenefitAnalysis: Calculator = {
  id: 'it-outsourcing-vs-in-house-cost-benefit-analysis',
  title: 'IT Outsourcing vs. In-House Cost-Benefit Analysis',
  category: 'business',
  subcategory: 'Financial Planning',
  description: 'Compare IT outsourcing costs',
  usageInstructions: [
