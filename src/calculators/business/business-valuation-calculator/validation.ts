...
export function validateBusinessValuationCalculatorInputs(inputs: BusinessValuationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBusinessValuationCalculatorBusinessRules(inputs: BusinessValuationCalculatorInputs): Array<{ field: string; message: string }> {
