import { CostPerHireCalculatorInputs } from './types';

export function validateCostPerHireCalculatorInputs(inputs: CostPerHireCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCostPerHireCalculatorBusinessRules(inputs: CostPerHireCalculatorInputs): Array<{ field: string; message: string }> {
