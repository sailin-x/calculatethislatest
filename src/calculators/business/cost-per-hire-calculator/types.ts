export interface CostPerHireCalculatorInputs {
...
export interface CostPerHireCalculatorOutputs {
...
export interface CostPerHireCalculatorMetrics {
...
export interface CostPerHireCalculatorAnalysis {
