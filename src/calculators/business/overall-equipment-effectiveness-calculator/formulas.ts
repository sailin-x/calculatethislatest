import { overall-equipment-effectiveness-calculatorInputs, overall-equipment-effectiveness-calculatorMetrics, overall-equipment-effectiveness-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: overall-equipment-effectiveness-calculatorInputs): number {
...
export function generateAnalysis(inputs: overall-equipment-effectiveness-calculatorInputs, metrics: overall-equipment-effectiveness-calculatorMetrics): overall-equipment-effectiveness-calculatorAnalysis {
