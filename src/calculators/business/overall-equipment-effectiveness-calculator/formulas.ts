import { OverallEquipmentEffectiveness-calculatorInputs, OverallEquipmentEffectiveness-calculatorMetrics, OverallEquipmentEffectiveness-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: OverallEquipmentEffectiveness-calculatorInputs): number {
...
export function generateAnalysis(inputs: OverallEquipmentEffectiveness-calculatorInputs, metrics: OverallEquipmentEffectiveness-calculatorMetrics): OverallEquipmentEffectiveness-calculatorAnalysis {
