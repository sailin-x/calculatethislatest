import { FacultyCostbenefitAnalysisInputs } from './types';

export function validateFacultyCostbenefitAnalysisInputs(inputs: FacultyCostbenefitAnalysisInputs): Array<{ field: string; message: string }> {
...
export function validateFacultyCostbenefitAnalysisBusinessRules(inputs: FacultyCostbenefitAnalysisInputs): Array<{ field: string; message: string }> {
