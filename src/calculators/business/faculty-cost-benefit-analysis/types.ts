export interface FacultyCostbenefitAnalysisInputs {
...
export interface FacultyCostbenefitAnalysisOutputs {
...
export interface FacultyCostbenefitAnalysisMetrics {
...
export interface FacultyCostbenefitAnalysisAnalysis {
