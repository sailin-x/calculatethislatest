import { FacultyCostBenefit-analysisInputs, FacultyCostBenefit-analysisMetrics, FacultyCostBenefit-analysisAnalysis } from './types';
...
export function calculateResult(inputs: FacultyCostBenefit-analysisInputs): number {
...
export function generateAnalysis(inputs: FacultyCostBenefit-analysisInputs, metrics: FacultyCostBenefit-analysisMetrics): FacultyCostBenefit-analysisAnalysis {
