import { BudgetOptimizationCalculatorinputs, BudgetOptimizationCalculatormetrics, BudgetOptimizationCalculatoranalysis } from './types';
...
export function calculateResult(inputs: BudgetOptimizationCalculatorinputs): number {
...
export function generateAnalysis(inputs: BudgetOptimizationCalculatorinputs, metrics: BudgetOptimizationCalculatormetrics): BudgetOptimizationCalculatoranalysis {
