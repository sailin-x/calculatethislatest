import { budget-optimization-calculatorInputs, budget-optimization-calculatorMetrics, budget-optimization-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: budget-optimization-calculatorInputs): number {
...
export function generateAnalysis(inputs: budget-optimization-calculatorInputs, metrics: budget-optimization-calculatorMetrics): budget-optimization-calculatorAnalysis {
