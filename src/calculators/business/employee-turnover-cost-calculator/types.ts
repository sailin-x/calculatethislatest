export interface EmployeeTurnoverCostCalculatorInputs {
...
export interface EmployeeTurnoverCostCalculatorOutputs {
...
export interface EmployeeTurnoverCostCalculatorMetrics {
...
export interface EmployeeTurnoverCostCalculatorAnalysis {
