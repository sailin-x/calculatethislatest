import { EmployeeTurnoverCostCalculatorInputs } from './types';

export function validateEmployeeTurnoverCostCalculatorInputs(inputs: EmployeeTurnoverCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateEmployeeTurnoverCostCalculatorBusinessRules(inputs: EmployeeTurnoverCostCalculatorInputs): Array<{ field: string; message: string }> {
