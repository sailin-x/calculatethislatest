import { InventoryShrinkageCostCalculatorInputs } from './types';

export function validateInventoryShrinkageCostCalculatorInputs(inputs: InventoryShrinkageCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateInventoryShrinkageCostCalculatorBusinessRules(inputs: InventoryShrinkageCostCalculatorInputs): Array<{ field: string; message: string }> {
