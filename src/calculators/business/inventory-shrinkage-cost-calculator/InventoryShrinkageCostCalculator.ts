...
import { InventoryShrinkageCostCalculatorInputs, InventoryShrinkageCostCalculatorOutputs } from './types';
import {
...
import { validateInventoryShrinkageCostCalculatorInputs, validateInventoryShrinkageCostCalculatorBusinessRules } from './validation';

export const InventoryShrinkageCostCalculatorCalculator: Calculator: Calculator = {
  id: 'inventory-shrinkage-cost-calculator-calculator',
