export interface InventoryShrinkageCostCalculatorInputs {
...
export interface InventoryShrinkageCostCalculatorOutputs {
...
export interface InventoryShrinkageCostCalculatorMetrics {
...
export interface InventoryShrinkageCostCalculatorAnalysis {
