import { BusinessRiskAssessmentCalculatorInputs } from './types';

export function validateBusinessRiskAssessmentCalculatorInputs(inputs: BusinessRiskAssessmentCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBusinessRiskAssessmentCalculatorBusinessRules(inputs: BusinessRiskAssessmentCalculatorInputs): Array<{ field: string; message: string }> {
