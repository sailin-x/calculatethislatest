import { TotalCostOf-ownership-calculatorInputs, TotalCostOf-ownership-calculatorMetrics, TotalCostOf-ownership-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: TotalCostOf-ownership-calculatorInputs): number {
...
export function generateAnalysis(inputs: TotalCostOf-ownership-calculatorInputs, metrics: TotalCostOf-ownership-calculatorMetrics): TotalCostOf-ownership-calculatorAnalysis {
