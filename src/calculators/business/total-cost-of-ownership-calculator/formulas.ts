import { total-cost-of-ownership-calculatorInputs, total-cost-of-ownership-calculatorMetrics, total-cost-of-ownership-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: total-cost-of-ownership-calculatorInputs): number {
...
export function generateAnalysis(inputs: total-cost-of-ownership-calculatorInputs, metrics: total-cost-of-ownership-calculatorMetrics): total-cost-of-ownership-calculatorAnalysis {
