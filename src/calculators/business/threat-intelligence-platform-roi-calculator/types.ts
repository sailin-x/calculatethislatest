export interface ThreatIntelligencePlatformRoiCalculatorInputs {
...
export interface ThreatIntelligencePlatformRoiCalculatorOutputs {
...
export interface ThreatIntelligencePlatformRoiCalculatorMetrics {
...
export interface ThreatIntelligencePlatformRoiCalculatorAnalysis {
