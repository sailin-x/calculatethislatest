import { ThreatIntelligencePlatformRoiCalculatorInputs } from './types';

export function validateThreatIntelligencePlatformRoiCalculatorInputs(inputs: ThreatIntelligencePlatformRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateThreatIntelligencePlatformRoiCalculatorBusinessRules(inputs: ThreatIntelligencePlatformRoiCalculatorInputs): Array<{ field: string; message: string }> {
