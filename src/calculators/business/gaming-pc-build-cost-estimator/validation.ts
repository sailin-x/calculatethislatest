import { GamingPcBuildCostEstimatorInputs } from './types';

export function validateGamingPcBuildCostEstimatorInputs(inputs: GamingPcBuildCostEstimatorInputs): Array<{ field: string; message: string }> {
...
export function validateGamingPcBuildCostEstimatorBusinessRules(inputs: GamingPcBuildCostEstimatorInputs): Array<{ field: string; message: string }> {
