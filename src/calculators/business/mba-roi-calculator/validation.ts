import { MbaRoiCalculatorInputs } from './types';

export function validateMbaRoiCalculatorInputs(inputs: MbaRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMbaRoiCalculatorBusinessRules(inputs: MbaRoiCalculatorInputs): Array<{ field: string; message: string }> {
