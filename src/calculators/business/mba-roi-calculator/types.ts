export interface MbaRoiCalculatorInputs {
...
export interface MbaRoiCalculatorOutputs {
...
export interface MbaRoiCalculatorMetrics {
...
export interface MbaRoiCalculatorAnalysis {
