import { BillOfMaterialsBomCostCalculatorInputs } from './types';

export function validateBillOfMaterialsBomCostCalculatorInputs(inputs: BillOfMaterialsBomCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBillOfMaterialsBomCostCalculatorBusinessRules(inputs: BillOfMaterialsBomCostCalculatorInputs): Array<{ field: string; message: string }> {
