export interface JewelryValuationCalculatorInputs {
...
export interface JewelryValuationCalculatorOutputs {
...
export interface JewelryValuationCalculatorMetrics {
...
export interface JewelryValuationCalculatorAnalysis {
