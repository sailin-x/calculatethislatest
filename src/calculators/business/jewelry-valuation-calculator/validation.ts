import { JewelryValuationCalculatorInputs } from './types';

export function validateJewelryValuationCalculatorInputs(inputs: JewelryValuationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateJewelryValuationCalculatorBusinessRules(inputs: JewelryValuationCalculatorInputs): Array<{ field: string; message: string }> {
