import { DialysisCenterProfitabilityCalculatorInputs } from './types';

export function validateDialysisCenterProfitabilityCalculatorInputs(inputs: DialysisCenterProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDialysisCenterProfitabilityCalculatorBusinessRules(inputs: DialysisCenterProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
