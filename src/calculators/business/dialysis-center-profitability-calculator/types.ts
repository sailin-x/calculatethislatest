export interface DialysisCenterProfitabilityCalculatorInputs {
...
export interface DialysisCenterProfitabilityCalculatorOutputs {
...
export interface DialysisCenterProfitabilityCalculatorMetrics {
...
export interface DialysisCenterProfitabilityCalculatorAnalysis {
