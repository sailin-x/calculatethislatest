export interface RansomwareDowntimeCostCalculatorInputs {
...
export interface RansomwareDowntimeCostCalculatorOutputs {
...
export interface RansomwareDowntimeCostCalculatorMetrics {
...
export interface RansomwareDowntimeCostCalculatorAnalysis {
