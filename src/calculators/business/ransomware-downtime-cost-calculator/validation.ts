import { RansomwareDowntimeCostCalculatorInputs } from './types';

export function validateRansomwareDowntimeCostCalculatorInputs(inputs: RansomwareDowntimeCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateRansomwareDowntimeCostCalculatorBusinessRules(inputs: RansomwareDowntimeCostCalculatorInputs): Array<{ field: string; message: string }> {
