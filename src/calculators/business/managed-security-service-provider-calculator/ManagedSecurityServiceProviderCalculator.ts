...
import { ManagedSecurityServiceProviderCalculatorInputs, ManagedSecurityServiceProviderCalculatorOutputs } from './types';
import {
...
export const ManagedSecurityServiceProviderCalculator: Calculator = {
  ...
  description: 'Compare MSSP vs in-house security',
  usageInstructions: [
