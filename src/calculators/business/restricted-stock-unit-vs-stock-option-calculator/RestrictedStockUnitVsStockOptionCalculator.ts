...
import { RestrictedStockUnitVsStockOptionCalculatorInputs, RestrictedStockUnitVsStockOptionCalculatorOutputs } from './types';
import {
...
export const RestrictedStockUnitVsStockOptionCalculator: Calculator = {
  ...
  description: 'Compare RSU vs options',
  usageInstructions: [
