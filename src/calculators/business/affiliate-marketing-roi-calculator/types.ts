export interface AffiliateMarketingRoiCalculatorInputs {
...
export interface AffiliateMarketingRoiCalculatorOutputs {
...
export interface AffiliateMarketingRoiCalculatorMetrics {
...
export interface AffiliateMarketingRoiCalculatorAnalysis {
