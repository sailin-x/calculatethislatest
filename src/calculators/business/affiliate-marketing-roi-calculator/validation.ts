import { AffiliateMarketingRoiCalculatorInputs } from './types';

export function validateAffiliateMarketingRoiCalculatorInputs(inputs: AffiliateMarketingRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAffiliateMarketingRoiCalculatorBusinessRules(inputs: AffiliateMarketingRoiCalculatorInputs): Array<{ field: string; message: string }> {
