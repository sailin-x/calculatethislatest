import { MusicFestivalProfitLossPlCalculatorInputs } from './types';

export function validateMusicFestivalProfitLossPlCalculatorInputs(inputs: MusicFestivalProfitLossPlCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMusicFestivalProfitLossPlCalculatorBusinessRules(inputs: MusicFestivalProfitLossPlCalculatorInputs): Array<{ field: string; message: string }> {
