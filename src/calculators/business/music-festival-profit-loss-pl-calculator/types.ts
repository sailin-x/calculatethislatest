export interface MusicFestivalProfitLossPlCalculatorInputs {
...
export interface MusicFestivalProfitLossPlCalculatorOutputs {
...
export interface MusicFestivalProfitLossPlCalculatorMetrics {
...
export interface MusicFestivalProfitLossPlCalculatorAnalysis {
