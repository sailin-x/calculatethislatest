import { churn-rateInputs, churn-rateMetrics, churn-rateAnalysis } from './types';
...
export function calculateResult(inputs: churn-rateInputs): number {
...
export function generateAnalysis(inputs: churn-rateInputs, metrics: churn-rateMetrics): churn-rateAnalysis {
