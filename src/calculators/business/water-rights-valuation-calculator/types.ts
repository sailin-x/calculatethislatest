export interface WaterRightsValuationCalculatorInputs {
...
export interface WaterRightsValuationCalculatorOutputs {
...
export interface WaterRightsValuationCalculatorMetrics {
...
export interface WaterRightsValuationCalculatorAnalysis {
