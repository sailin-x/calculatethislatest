import { WaterRightsValuationCalculatorInputs } from './types';

export function validateWaterRightsValuationCalculatorInputs(inputs: WaterRightsValuationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateWaterRightsValuationCalculatorBusinessRules(inputs: WaterRightsValuationCalculatorInputs): Array<{ field: string; message: string }> {
