import { RevenueCycleManagementRcmRoiCalculatorInputs } from './types';

export function validateRevenueCycleManagementRcmRoiCalculatorInputs(inputs: RevenueCycleManagementRcmRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateRevenueCycleManagementRcmRoiCalculatorBusinessRules(inputs: RevenueCycleManagementRcmRoiCalculatorInputs): Array<{ field: string; message: string }> {
