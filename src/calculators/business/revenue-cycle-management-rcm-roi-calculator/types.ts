export interface RevenueCycleManagementRcmRoiCalculatorInputs {
...
export interface RevenueCycleManagementRcmRoiCalculatorOutputs {
...
export interface RevenueCycleManagementRcmRoiCalculatorMetrics {
...
export interface RevenueCycleManagementRcmRoiCalculatorAnalysis {
