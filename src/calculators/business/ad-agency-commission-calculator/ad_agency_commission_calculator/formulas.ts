import { ad_agency_commission_calculatorInputs, ad_agency_commission_calculatorMetrics, ad_agency_commission_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ad_agency_commission_calculatorInputs): number {
...
export function generateAnalysis(inputs: ad_agency_commission_calculatorInputs, metrics: ad_agency_commission_calculatorMetrics): ad_agency_commission_calculatorAnalysis {
