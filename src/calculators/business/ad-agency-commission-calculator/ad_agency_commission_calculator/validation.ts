import { ad_agency_commission_calculatorInputs } from './types';

export function validateInputs(inputs: ad_agency_commission_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
