import { AdAgencyCommission-calculatorInputs, AdAgencyCommission-calculatorMetrics, AdAgencyCommission-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: AdAgencyCommission-calculatorInputs): number {
...
export function generateAnalysis(inputs: AdAgencyCommission-calculatorInputs, metrics: AdAgencyCommission-calculatorMetrics): AdAgencyCommission-calculatorAnalysis {
