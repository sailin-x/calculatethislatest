import { IndustrialRoboticsRoiCalculatorInputs } from './types';

export function validateIndustrialRoboticsRoiCalculatorInputs(inputs: IndustrialRoboticsRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateIndustrialRoboticsRoiCalculatorBusinessRules(inputs: IndustrialRoboticsRoiCalculatorInputs): Array<{ field: string; message: string }> {
