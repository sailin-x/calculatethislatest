import { IvfInVitroFertilizationCostCalculatorInputs } from './types';

export function validateIvfInVitroFertilizationCostCalculatorInputs(inputs: IvfInVitroFertilizationCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateIvfInVitroFertilizationCostCalculatorBusinessRules(inputs: IvfInVitroFertilizationCostCalculatorInputs): Array<{ field: string; message: string }> {
