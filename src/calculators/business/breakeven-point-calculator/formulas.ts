import { breakeven-point-calculatorInputs, breakeven-point-calculatorMetrics, breakeven-point-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: breakeven-point-calculatorInputs): number {
...
export function generateAnalysis(inputs: breakeven-point-calculatorInputs, metrics: breakeven-point-calculatorMetrics): breakeven-point-calculatorAnalysis {
