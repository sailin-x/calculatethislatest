import { BreakevenPointCalculatorinputs, BreakevenPointCalculatormetrics, BreakevenPointCalculatoranalysis } from './types';
...
export function calculateResult(inputs: BreakevenPointCalculatorinputs): number {
...
export function generateAnalysis(inputs: BreakevenPointCalculatorinputs, metrics: BreakevenPointCalculatormetrics): BreakevenPointCalculatoranalysis {
