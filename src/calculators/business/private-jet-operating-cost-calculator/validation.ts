import { PrivateJetOperatingCostCalculatorInputs } from './types';

export function validatePrivateJetOperatingCostCalculatorInputs(inputs: PrivateJetOperatingCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePrivateJetOperatingCostCalculatorBusinessRules(inputs: PrivateJetOperatingCostCalculatorInputs): Array<{ field: string; message: string }> {
