import { PrivateJetOperating-cost-calculatorInputs, PrivateJetOperating-cost-calculatorMetrics, PrivateJetOperating-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: PrivateJetOperating-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: PrivateJetOperating-cost-calculatorInputs, metrics: PrivateJetOperating-cost-calculatorMetrics): PrivateJetOperating-cost-calculatorAnalysis {
