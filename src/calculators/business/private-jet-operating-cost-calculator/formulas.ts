import { private-jet-operating-cost-calculatorInputs, private-jet-operating-cost-calculatorMetrics, private-jet-operating-cost-calculatorAnalysis } from './types';

// Private Jet Operating Cost Calculator - Business calculations
...
export function calculateResult(inputs: private-jet-operating-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: private-jet-operating-cost-calculatorInputs, metrics: private-jet-operating-cost-calculatorMetrics): private-jet-operating-cost-calculatorAnalysis {
