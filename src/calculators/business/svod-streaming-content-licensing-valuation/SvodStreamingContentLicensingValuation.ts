...
import { SvodStreamingContentLicensingValuationInputs, SvodStreamingContentLicensingValuationOutputs } from './types';
import {
...
import { validateSvodStreamingContentLicensingValuationInputs } from './validation';

export const SvodStreamingContentLicensingValuation: Calculator = {
  id: 'svod-streaming-content-licensing-valuation',
  title: 'SVOD (Streaming) Content Licensing Valuation',
  category: 'business',
  subcategory: 'Financial Planning',
  description: 'Calculate SVOD licensing',
  usageInstructions: [
