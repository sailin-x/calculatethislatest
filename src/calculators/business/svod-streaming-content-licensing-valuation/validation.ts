import { SvodStreamingContentLicensingValuationInputs } from './types';

export function validateSvodStreamingContentLicensingValuationInputs(inputs: SvodStreamingContentLicensingValuationInputs): Array<{ field: string; message: string }> {
...
export function validateSvodStreamingContentLicensingValuationBusinessRules(inputs: SvodStreamingContentLicensingValuationInputs): Array<{ field: string; message: string }> {
