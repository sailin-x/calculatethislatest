import { api_monetization_calculatorInputs, api_monetization_calculatorMetrics, api_monetization_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: api_monetization_calculatorInputs): number {
...
export function generateAnalysis(inputs: api_monetization_calculatorInputs, metrics: api_monetization_calculatorMetrics): api_monetization_calculatorAnalysis {
