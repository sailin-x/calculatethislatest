export interface OffshoreWindFarmInstallationCostCalculatorInputs {
...
export interface OffshoreWindFarmInstallationCostCalculatorOutputs {
...
export interface OffshoreWindFarmInstallationCostCalculatorMetrics {
...
export interface OffshoreWindFarmInstallationCostCalculatorAnalysis {
