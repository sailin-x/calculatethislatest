import { OffshoreWindFarmInstallationCostCalculatorInputs } from './types';

export function validateOffshoreWindFarmInstallationCostCalculatorInputs(inputs: OffshoreWindFarmInstallationCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateOffshoreWindFarmInstallationCostCalculatorBusinessRules(inputs: OffshoreWindFarmInstallationCostCalculatorInputs): Array<{ field: string; message: string }> {
