import { CosmeticSurgeryCostCalculatorInputs } from './types';

export function validateCosmeticSurgeryCostCalculatorInputs(inputs: CosmeticSurgeryCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCosmeticSurgeryCostCalculatorBusinessRules(inputs: CosmeticSurgeryCostCalculatorInputs): Array<{ field: string; message: string }> {
