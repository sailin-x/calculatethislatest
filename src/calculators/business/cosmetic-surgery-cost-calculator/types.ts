export interface CosmeticSurgeryCostCalculatorInputs {
...
export interface CosmeticSurgeryCostCalculatorOutputs {
...
export interface CosmeticSurgeryCostCalculatorMetrics {
...
export interface CosmeticSurgeryCostCalculatorAnalysis {
