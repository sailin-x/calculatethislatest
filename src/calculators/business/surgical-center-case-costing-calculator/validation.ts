import { SurgicalCenterCaseCostingCalculatorInputs } from './types';

export function validateSurgicalCenterCaseCostingCalculatorInputs(inputs: SurgicalCenterCaseCostingCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateSurgicalCenterCaseCostingCalculatorBusinessRules(inputs: SurgicalCenterCaseCostingCalculatorInputs): Array<{ field: string; message: string }> {
