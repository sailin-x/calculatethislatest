...
export function validateBusinessLoanQualificationCalculatorInputs(inputs: BusinessLoanQualificationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBusinessLoanQualificationCalculatorBusinessRules(inputs: BusinessLoanQualificationCalculatorInputs): Array<{ field: string; message: string }> {
