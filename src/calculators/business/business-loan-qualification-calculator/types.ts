export interface BusinessLoanQualificationCalculatorInputs {
...
export interface BusinessLoanQualificationCalculatorOutputs {
...
export interface BusinessLoanQualificationCalculatorMetrics {
...
export interface BusinessLoanQualificationCalculatorAnalysis {
