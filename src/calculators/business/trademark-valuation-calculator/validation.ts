import { TrademarkValuationCalculatorInputs } from './types';

export function validateTrademarkValuationCalculatorInputs(inputs: TrademarkValuationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTrademarkValuationCalculatorBusinessRules(inputs: TrademarkValuationCalculatorInputs): Array<{ field: string; message: string }> {
