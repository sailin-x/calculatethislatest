export interface TrademarkValuationCalculatorInputs {
...
export interface TrademarkValuationCalculatorOutputs {
...
export interface TrademarkValuationCalculatorMetrics {
...
export interface TrademarkValuationCalculatorAnalysis {
