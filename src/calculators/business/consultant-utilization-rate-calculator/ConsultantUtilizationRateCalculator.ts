...
import { ConsultantUtilizationRateCalculatorInputs, ConsultantUtilizationRateCalculatorOutputs } from './types';
import {
...
export const ConsultantUtilizationRateCalculator: Calculator = {
  ...
  description: 'Calculate consultant utilization rates',
  usageInstructions: [
