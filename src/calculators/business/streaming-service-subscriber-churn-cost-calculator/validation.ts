import { StreamingServiceSubscriberChurnCostCalculatorInputs } from './types';

export function validateStreamingServiceSubscriberChurnCostCalculatorInputs(inputs: StreamingServiceSubscriberChurnCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateStreamingServiceSubscriberChurnCostCalculatorBusinessRules(inputs: StreamingServiceSubscriberChurnCostCalculatorInputs): Array<{ field: string; message: string }> {
