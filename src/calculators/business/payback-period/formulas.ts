import { payback-periodInputs, payback-periodMetrics, payback-periodAnalysis } from './types';
...
export function calculateResult(inputs: payback-periodInputs): number {
...
export function generateAnalysis(inputs: payback-periodInputs, metrics: payback-periodMetrics): payback-periodAnalysis {
