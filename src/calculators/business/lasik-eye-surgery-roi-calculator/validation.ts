import { LasikEyeSurgeryRoiCalculatorInputs } from './types';

export function validateLasikEyeSurgeryRoiCalculatorInputs(inputs: LasikEyeSurgeryRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateLasikEyeSurgeryRoiCalculatorBusinessRules(inputs: LasikEyeSurgeryRoiCalculatorInputs): Array<{ field: string; message: string }> {
