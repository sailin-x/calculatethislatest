export interface LasikEyeSurgeryRoiCalculatorInputs {
...
export interface LasikEyeSurgeryRoiCalculatorOutputs {
...
export interface LasikEyeSurgeryRoiCalculatorMetrics {
...
export interface LasikEyeSurgeryRoiCalculatorAnalysis {
