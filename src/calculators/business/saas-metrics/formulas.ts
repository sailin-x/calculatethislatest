import { saas-metricsInputs, saas-metricsMetrics, saas-metricsAnalysis } from './types';
...
export function calculateResult(inputs: saas-metricsInputs): number {
...
export function generateAnalysis(inputs: saas-metricsInputs, metrics: saas-metricsMetrics): saas-metricsAnalysis {
