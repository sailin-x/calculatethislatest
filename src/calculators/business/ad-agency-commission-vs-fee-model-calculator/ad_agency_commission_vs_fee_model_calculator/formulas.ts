import { ad_agency_commission_vs_fee_model_calculatorInputs, ad_agency_commission_vs_fee_model_calculatorMetrics, ad_agency_commission_vs_fee_model_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ad_agency_commission_vs_fee_model_calculatorInputs): number {
...
export function generateAnalysis(inputs: ad_agency_commission_vs_fee_model_calculatorInputs, metrics: ad_agency_commission_vs_fee_model_calculatorMetrics): ad_agency_commission_vs_fee_model_calculatorAnalysis {
