import { AttributionModelsCalculatorinputs, AttributionModelsCalculatormetrics, AttributionModelsCalculatoranalysis } from './types';
...
export function calculateResult(inputs: AttributionModelsCalculatorinputs): number {
...
export function generateAnalysis(inputs: AttributionModelsCalculatorinputs, metrics: AttributionModelsCalculatormetrics): AttributionModelsCalculatoranalysis {
