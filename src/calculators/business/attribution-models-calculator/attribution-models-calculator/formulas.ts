import { attribution-models-calculatorInputs, attribution-models-calculatorMetrics, attribution-models-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: attribution-models-calculatorInputs): number {
...
export function generateAnalysis(inputs: attribution-models-calculatorInputs, metrics: attribution-models-calculatorMetrics): attribution-models-calculatorAnalysis {
