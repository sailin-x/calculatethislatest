import { attribution_models_calculatorInputs, attribution_models_calculatorMetrics, attribution_models_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: attribution_models_calculatorInputs): number {
...
export function generateAnalysis(inputs: attribution_models_calculatorInputs, metrics: attribution_models_calculatorMetrics): attribution_models_calculatorAnalysis {
