import { attribution_models_calculatorInputs } from './types';

export function validateInputs(inputs: attribution_models_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
