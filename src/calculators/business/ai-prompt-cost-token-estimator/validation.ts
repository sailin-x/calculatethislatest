import { AiPromptCostTokenEstimatorInputs } from './types';

export function validateAiPromptCostTokenEstimatorInputs(inputs: AiPromptCostTokenEstimatorInputs): Array<{ field: string; message: string }> {
...
export function validateAiPromptCostTokenEstimatorBusinessRules(inputs: AiPromptCostTokenEstimatorInputs): Array<{ field: string; message: string }> {
