...
import { PublicPrivatePartnershipRoiCalculatorInputs, PublicPrivatePartnershipRoiCalculatorOutputs } from './types';
import {
...
export const PublicPrivatePartnershipRoiCalculator: Calculator = {
  ...
  description: 'Calculate PPP investment returns',
  usageInstructions: [
