import { BusinessInsuranceCalculatorInputs } from './types';

export function validateBusinessInsuranceCalculatorInputs(inputs: BusinessInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBusinessInsuranceCalculatorBusinessRules(inputs: BusinessInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
