import { PassengerLoadFactorBreakevenCalculatorInputs } from './types';

export function validatePassengerLoadFactorBreakevenCalculatorInputs(inputs: PassengerLoadFactorBreakevenCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePassengerLoadFactorBreakevenCalculatorBusinessRules(inputs: PassengerLoadFactorBreakevenCalculatorInputs): Array<{ field: string; message: string }> {
