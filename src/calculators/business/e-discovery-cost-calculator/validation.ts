import { EdiscoveryCostCalculatorInputs } from './types';

export function validateEdiscoveryCostCalculatorInputs(inputs: EdiscoveryCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateEdiscoveryCostCalculatorBusinessRules(inputs: EdiscoveryCostCalculatorInputs): Array<{ field: string; message: string }> {
