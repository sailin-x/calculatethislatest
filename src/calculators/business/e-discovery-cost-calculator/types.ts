export interface EdiscoveryCostCalculatorInputs {
...
export interface EdiscoveryCostCalculatorOutputs {
...
export interface EdiscoveryCostCalculatorMetrics {
...
export interface EdiscoveryCostCalculatorAnalysis {
