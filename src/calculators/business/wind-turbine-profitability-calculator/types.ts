export interface WindTurbineProfitabilityCalculatorInputs {
...
export interface WindTurbineProfitabilityCalculatorOutputs {
...
export interface WindTurbineProfitabilityCalculatorMetrics {
...
export interface WindTurbineProfitabilityCalculatorAnalysis {
