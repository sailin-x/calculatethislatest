import { WindTurbineProfitabilityCalculatorInputs } from './types';

export function validateWindTurbineProfitabilityCalculatorInputs(inputs: WindTurbineProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateWindTurbineProfitabilityCalculatorBusinessRules(inputs: WindTurbineProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
