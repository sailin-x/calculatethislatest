export interface PatentValuationCalculatorInputs {
...
export interface PatentValuationCalculatorOutputs {
...
export interface PatentValuationCalculatorMetrics {
...
export interface PatentValuationCalculatorAnalysis {
