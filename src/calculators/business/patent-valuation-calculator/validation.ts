import { PatentValuationCalculatorInputs } from './types';

export function validatePatentValuationCalculatorInputs(inputs: PatentValuationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePatentValuationCalculatorBusinessRules(inputs: PatentValuationCalculatorInputs): Array<{ field: string; message: string }> {
