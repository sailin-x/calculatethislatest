import { roiInputs, roiMetrics, roiAnalysis } from './types';
...
export function calculateResult(inputs: roiInputs): number {
...
export function generateAnalysis(inputs: roiInputs, metrics: roiMetrics): roiAnalysis {
