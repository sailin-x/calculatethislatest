import { ad-viewability-impact-calculatorInputs, ad-viewability-impact-calculatorMetrics, ad-viewability-impact-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ad-viewability-impact-calculatorInputs): number {
...
export function generateAnalysis(inputs: ad-viewability-impact-calculatorInputs, metrics: ad-viewability-impact-calculatorMetrics): ad-viewability-impact-calculatorAnalysis {
