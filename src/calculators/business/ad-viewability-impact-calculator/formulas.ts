import { AdViewabilityImpact-calculatorInputs, AdViewabilityImpact-calculatorMetrics, AdViewabilityImpact-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: AdViewabilityImpact-calculatorInputs): number {
...
export function generateAnalysis(inputs: AdViewabilityImpact-calculatorInputs, metrics: AdViewabilityImpact-calculatorMetrics): AdViewabilityImpact-calculatorAnalysis {
