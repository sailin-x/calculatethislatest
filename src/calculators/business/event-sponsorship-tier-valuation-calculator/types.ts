export interface EventSponsorshipTierValuationCalculatorInputs {
...
export interface EventSponsorshipTierValuationCalculatorOutputs {
...
export interface EventSponsorshipTierValuationCalculatorMetrics {
...
export interface EventSponsorshipTierValuationCalculatorAnalysis {
