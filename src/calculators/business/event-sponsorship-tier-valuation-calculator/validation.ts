import { EventSponsorshipTierValuationCalculatorInputs } from './types';

export function validateEventSponsorshipTierValuationCalculatorInputs(inputs: EventSponsorshipTierValuationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateEventSponsorshipTierValuationCalculatorBusinessRules(inputs: EventSponsorshipTierValuationCalculatorInputs): Array<{ field: string; message: string }> {
