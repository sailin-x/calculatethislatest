import { YachtOperatingCostDepreciationCalculatorInputs } from './types';

export function validateYachtOperatingCostDepreciationCalculatorInputs(inputs: YachtOperatingCostDepreciationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateYachtOperatingCostDepreciationCalculatorBusinessRules(inputs: YachtOperatingCostDepreciationCalculatorInputs): Array<{ field: string; message: string }> {
