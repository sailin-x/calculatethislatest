export interface SixSigmaCostSavingsCalculatorInputs {
...
export interface SixSigmaCostSavingsCalculatorOutputs {
...
export interface SixSigmaCostSavingsCalculatorMetrics {
...
export interface SixSigmaCostSavingsCalculatorAnalysis {
