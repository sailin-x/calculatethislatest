...
export function validateSixSigmaCostSavingsCalculatorInputs(inputs: SixSigmaCostSavingsCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateSixSigmaCostSavingsCalculatorBusinessRules(inputs: SixSigmaCostSavingsCalculatorInputs): Array<{ field: string; message: string }> {
