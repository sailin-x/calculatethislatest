...
import { validateSixSigmaCostSavingsCalculatorInputs, validateSixSigmaCostSavingsCalculatorBusinessRules } from './validation';

export const SixSigmaCostSavingsCalculatorCalculator: Calculator: Calculator = {
  id: 'six-sigma-cost-savings-calculator-calculator',
