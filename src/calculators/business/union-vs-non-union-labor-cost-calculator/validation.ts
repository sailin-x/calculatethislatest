import { UnionVsNonunionLaborCostCalculatorInputs } from './types';

export function validateUnionVsNonunionLaborCostCalculatorInputs(inputs: UnionVsNonunionLaborCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateUnionVsNonunionLaborCostCalculatorBusinessRules(inputs: UnionVsNonunionLaborCostCalculatorInputs): Array<{ field: string; message: string }> {
