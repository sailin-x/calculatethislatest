import { MarketingAttributionModelComparisonCalculatorInputs } from './types';

export function validateMarketingAttributionModelComparisonCalculatorInputs(inputs: MarketingAttributionModelComparisonCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMarketingAttributionModelComparisonCalculatorBusinessRules(inputs: MarketingAttributionModelComparisonCalculatorInputs): Array<{ field: string; message: string }> {
