import { ComicBookValuationCalculatorInputs } from './types';

export function validateComicBookValuationCalculatorInputs(inputs: ComicBookValuationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateComicBookValuationCalculatorBusinessRules(inputs: ComicBookValuationCalculatorInputs): Array<{ field: string; message: string }> {
