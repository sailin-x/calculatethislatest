import { ComicBookValuation-calculatorInputs, ComicBookValuation-calculatorMetrics, ComicBookValuation-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ComicBookValuation-calculatorInputs): number {
...
export function generateAnalysis(inputs: ComicBookValuation-calculatorInputs, metrics: ComicBookValuation-calculatorMetrics): ComicBookValuation-calculatorAnalysis {
