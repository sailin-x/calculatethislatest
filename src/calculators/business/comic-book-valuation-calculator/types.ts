export interface ComicBookValuationCalculatorInputs {
...
export interface ComicBookValuationCalculatorOutputs {
...
export interface ComicBookValuationCalculatorMetrics {
...
export interface ComicBookValuationCalculatorAnalysis {
