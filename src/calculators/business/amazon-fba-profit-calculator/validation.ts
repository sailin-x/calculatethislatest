import { AmazonFbaProfitCalculatorInputs } from './types';

export function validateAmazonFbaProfitCalculatorInputs(inputs: AmazonFbaProfitCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAmazonFbaProfitCalculatorBusinessRules(inputs: AmazonFbaProfitCalculatorInputs): Array<{ field: string; message: string }> {
