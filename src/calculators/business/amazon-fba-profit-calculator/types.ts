export interface AmazonFbaProfitCalculatorInputs {
...
export interface AmazonFbaProfitCalculatorOutputs {
...
export interface AmazonFbaProfitCalculatorMetrics {
...
export interface AmazonFbaProfitCalculatorAnalysis {
