import { paycheck-calculatorInputs, paycheck-calculatorMetrics, paycheck-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: paycheck-calculatorInputs): number {
...
export function generateAnalysis(inputs: paycheck-calculatorInputs, metrics: paycheck-calculatorMetrics): paycheck-calculatorAnalysis {
