import { business-valuationInputs, business-valuationMetrics, business-valuationAnalysis } from './types';
...
export function calculateResult(inputs: business-valuationInputs): number {
...
export function generateAnalysis(inputs: business-valuationInputs, metrics: business-valuationMetrics): business-valuationAnalysis {
