import { Iso9001CertificationRoiCalculatorInputs } from './types';

export function validateIso9001CertificationRoiCalculatorInputs(inputs: Iso9001CertificationRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateIso9001CertificationRoiCalculatorBusinessRules(inputs: Iso9001CertificationRoiCalculatorInputs): Array<{ field: string; message: string }> {
