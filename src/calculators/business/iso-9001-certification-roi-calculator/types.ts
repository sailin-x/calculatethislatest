export interface Iso9001CertificationRoiCalculatorInputs {
...
export interface Iso9001CertificationRoiCalculatorOutputs {
...
export interface Iso9001CertificationRoiCalculatorMetrics {
...
export interface Iso9001CertificationRoiCalculatorAnalysis {
