export interface ClassicCarValuationCalculatorInputs {
...
export interface ClassicCarValuationCalculatorOutputs {
...
export interface ClassicCarValuationCalculatorMetrics {
...
export interface ClassicCarValuationCalculatorAnalysis {
