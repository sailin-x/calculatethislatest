import { ClassicCarValuationCalculatorInputs } from './types';

export function validateClassicCarValuationCalculatorInputs(inputs: ClassicCarValuationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateClassicCarValuationCalculatorBusinessRules(inputs: ClassicCarValuationCalculatorInputs): Array<{ field: string; message: string }> {
