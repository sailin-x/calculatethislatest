import { VineyardProfitabilityCalculatorInputs } from './types';

export function validateVineyardProfitabilityCalculatorInputs(inputs: VineyardProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateVineyardProfitabilityCalculatorBusinessRules(inputs: VineyardProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
