export interface VineyardProfitabilityCalculatorInputs {
...
export interface VineyardProfitabilityCalculatorOutputs {
...
export interface VineyardProfitabilityCalculatorMetrics {
...
export interface VineyardProfitabilityCalculatorAnalysis {
