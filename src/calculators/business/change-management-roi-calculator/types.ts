export interface ChangeManagementRoiCalculatorInputs {
...
export interface ChangeManagementRoiCalculatorOutputs {
...
export interface ChangeManagementRoiCalculatorMetrics {
...
export interface ChangeManagementRoiCalculatorAnalysis {
