import { ChangeManagementRoiCalculatorInputs } from './types';

export function validateChangeManagementRoiCalculatorInputs(inputs: ChangeManagementRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateChangeManagementRoiCalculatorBusinessRules(inputs: ChangeManagementRoiCalculatorInputs): Array<{ field: string; message: string }> {
