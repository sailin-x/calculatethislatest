import { ConsultantUtilizationRateProfitabilityCalculatorInputs } from './types';

export function validateConsultantUtilizationRateProfitabilityCalculatorInputs(inputs: ConsultantUtilizationRateProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateConsultantUtilizationRateProfitabilityCalculatorBusinessRules(inputs: ConsultantUtilizationRateProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
