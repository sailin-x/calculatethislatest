export interface ConsultantUtilizationRateProfitabilityCalculatorInputs {
...
export interface ConsultantUtilizationRateProfitabilityCalculatorOutputs {
...
export interface ConsultantUtilizationRateProfitabilityCalculatorMetrics {
...
export interface ConsultantUtilizationRateProfitabilityCalculatorAnalysis {
