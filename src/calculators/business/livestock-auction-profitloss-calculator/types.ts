export interface LivestockAuctionProfitlossCalculatorInputs {
...
export interface LivestockAuctionProfitlossCalculatorOutputs {
...
export interface LivestockAuctionProfitlossCalculatorMetrics {
...
export interface LivestockAuctionProfitlossCalculatorAnalysis {
