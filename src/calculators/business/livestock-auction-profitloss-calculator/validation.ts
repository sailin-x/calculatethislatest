import { LivestockAuctionProfitlossCalculatorInputs } from './types';

export function validateLivestockAuctionProfitlossCalculatorInputs(inputs: LivestockAuctionProfitlossCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateLivestockAuctionProfitlossCalculatorBusinessRules(inputs: LivestockAuctionProfitlossCalculatorInputs): Array<{ field: string; message: string }> {
