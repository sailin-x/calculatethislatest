export interface ProfitMarginCalculatorInputs {
...
export interface ProfitMarginCalculatorOutputs {
...
export interface ProfitMarginCalculatorMetrics {
...
export interface ProfitMarginCalculatorAnalysis {
