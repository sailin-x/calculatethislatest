import { ProfitMarginCalculatorInputs } from './types';

export function validateProfitMarginCalculatorInputs(inputs: ProfitMarginCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateProfitMarginCalculatorBusinessRules(inputs: ProfitMarginCalculatorInputs): Array<{ field: string; message: string }> {
