export interface CustomerAcquisitionCostCacCalculatorInputs {
...
export interface CustomerAcquisitionCostCacCalculatorOutputs {
...
export interface CustomerAcquisitionCostCacCalculatorMetrics {
...
export interface CustomerAcquisitionCostCacCalculatorAnalysis {
