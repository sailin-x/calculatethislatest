import { CustomerAcquisitionCostCacCalculatorInputs } from './types';

export function validateCustomerAcquisitionCostCacCalculatorInputs(inputs: CustomerAcquisitionCostCacCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCustomerAcquisitionCostCacCalculatorBusinessRules(inputs: CustomerAcquisitionCostCacCalculatorInputs): Array<{ field: string; message: string }> {
