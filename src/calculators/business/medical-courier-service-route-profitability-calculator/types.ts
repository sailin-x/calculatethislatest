export interface MedicalCourierServiceRouteProfitabilityCalculatorInputs {
...
export interface MedicalCourierServiceRouteProfitabilityCalculatorOutputs {
...
export interface MedicalCourierServiceRouteProfitabilityCalculatorMetrics {
...
export interface MedicalCourierServiceRouteProfitabilityCalculatorAnalysis {
