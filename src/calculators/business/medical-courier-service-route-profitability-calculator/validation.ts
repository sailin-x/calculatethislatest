import { MedicalCourierServiceRouteProfitabilityCalculatorInputs } from './types';

export function validateMedicalCourierServiceRouteProfitabilityCalculatorInputs(inputs: MedicalCourierServiceRouteProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMedicalCourierServiceRouteProfitabilityCalculatorBusinessRules(inputs: MedicalCourierServiceRouteProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
