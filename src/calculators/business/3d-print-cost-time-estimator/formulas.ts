import { 3d-print-cost-time-estimatorInputs, 3d-print-cost-time-estimatorMetrics, 3d-print-cost-time-estimatorAnalysis } from './types';

// 3D Print Cost & Time Estimator - Business calculations
...
export function calculateResult(inputs: 3d-print-cost-time-estimatorInputs): number {
...
export function generateAnalysis(inputs: 3d-print-cost-time-estimatorInputs, metrics: 3d-print-cost-time-estimatorMetrics): 3d-print-cost-time-estimatorAnalysis {
