import { 3dPrintCostTimeEstimatorInputs } from './types';

export function validate3dPrintCostTimeEstimatorInputs(inputs: 3dPrintCostTimeEstimatorInputs): Array<{ field: string; message: string }> {
...
export function validate3dPrintCostTimeEstimatorBusinessRules(inputs: 3dPrintCostTimeEstimatorInputs): Array<{ field: string; message: string }> {
