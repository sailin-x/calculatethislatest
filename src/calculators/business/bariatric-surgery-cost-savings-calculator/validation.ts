...
export function validateBariatricSurgeryCostSavingsCalculatorInputs(inputs: BariatricSurgeryCostSavingsCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBariatricSurgeryCostSavingsCalculatorBusinessRules(inputs: BariatricSurgeryCostSavingsCalculatorInputs): Array<{ field: string; message: string }> {
