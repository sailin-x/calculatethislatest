import { TotalCostOfOwnershipTcoForCommercialFleetCalculatorInputs } from './types';

export function validateTotalCostOfOwnershipTcoForCommercialFleetCalculatorInputs(inputs: TotalCostOfOwnershipTcoForCommercialFleetCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTotalCostOfOwnershipTcoForCommercialFleetCalculatorBusinessRules(inputs: TotalCostOfOwnershipTcoForCommercialFleetCalculatorInputs): Array<{ field: string; message: string }> {
