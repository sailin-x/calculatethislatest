export interface InfluencerMarketingEarnedMediaValueEmvCalculatorInputs {
...
export interface InfluencerMarketingEarnedMediaValueEmvCalculatorOutputs {
...
export interface InfluencerMarketingEarnedMediaValueEmvCalculatorMetrics {
...
export interface InfluencerMarketingEarnedMediaValueEmvCalculatorAnalysis {
