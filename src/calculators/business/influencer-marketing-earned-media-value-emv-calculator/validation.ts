import { InfluencerMarketingEarnedMediaValueEmvCalculatorInputs } from './types';

export function validateInfluencerMarketingEarnedMediaValueEmvCalculatorInputs(inputs: InfluencerMarketingEarnedMediaValueEmvCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateInfluencerMarketingEarnedMediaValueEmvCalculatorBusinessRules(inputs: InfluencerMarketingEarnedMediaValueEmvCalculatorInputs): Array<{ field: string; message: string }> {
