import { soc-2-compliance-cost-calculatorInputs, soc-2-compliance-cost-calculatorMetrics, soc-2-compliance-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: soc-2-compliance-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: soc-2-compliance-cost-calculatorInputs, metrics: soc-2-compliance-cost-calculatorMetrics): soc-2-compliance-cost-calculatorAnalysis {
