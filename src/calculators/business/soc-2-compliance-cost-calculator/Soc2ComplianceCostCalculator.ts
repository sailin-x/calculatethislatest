...
export const Soc2ComplianceCostCalculator: Calculator = {
  id: 'soc-2-compliance-cost-calculator',
  title: 'SOC 2 Compliance Cost Calculator',
  category: 'business',
  subcategory: 'Financial Planning',
  description: 'Calculate SOC 2 compliance costs',
  usageInstructions: [
