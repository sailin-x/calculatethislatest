export interface MediaMixModelingMmmRoiCalculatorInputs {
...
export interface MediaMixModelingMmmRoiCalculatorOutputs {
...
export interface MediaMixModelingMmmRoiCalculatorMetrics {
...
export interface MediaMixModelingMmmRoiCalculatorAnalysis {
