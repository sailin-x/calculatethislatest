import { MediaMixModelingMmmRoiCalculatorInputs } from './types';

export function validateMediaMixModelingMmmRoiCalculatorInputs(inputs: MediaMixModelingMmmRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMediaMixModelingMmmRoiCalculatorBusinessRules(inputs: MediaMixModelingMmmRoiCalculatorInputs): Array<{ field: string; message: string }> {
