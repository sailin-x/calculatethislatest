import { BusinessInterruptionCalculatorInputs } from './types';

export function validateBusinessInterruptionCalculatorInputs(inputs: BusinessInterruptionCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBusinessInterruptionCalculatorBusinessRules(inputs: BusinessInterruptionCalculatorInputs): Array<{ field: string; message: string }> {
