export interface BusinessInterruptionCalculatorInputs {
...
export interface BusinessInterruptionCalculatorOutputs {
...
export interface BusinessInterruptionCalculatorMetrics {
...
export interface BusinessInterruptionCalculatorAnalysis {
