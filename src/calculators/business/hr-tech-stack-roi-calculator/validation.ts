import { HrTechStackRoiCalculatorInputs } from './types';

export function validateHrTechStackRoiCalculatorInputs(inputs: HrTechStackRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateHrTechStackRoiCalculatorBusinessRules(inputs: HrTechStackRoiCalculatorInputs): Array<{ field: string; message: string }> {
