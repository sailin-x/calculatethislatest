export interface HrTechStackRoiCalculatorInputs {
...
export interface HrTechStackRoiCalculatorOutputs {
...
export interface HrTechStackRoiCalculatorMetrics {
...
export interface HrTechStackRoiCalculatorAnalysis {
