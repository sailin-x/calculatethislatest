import { FilmSlateFinancingRoiCalculatorInputs } from './types';

export function validateFilmSlateFinancingRoiCalculatorInputs(inputs: FilmSlateFinancingRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateFilmSlateFinancingRoiCalculatorBusinessRules(inputs: FilmSlateFinancingRoiCalculatorInputs): Array<{ field: string; message: string }> {
