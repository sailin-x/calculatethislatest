...
export function validateCryptoMiningProfitabilityCalculatorInputs(inputs: CryptoMiningProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCryptoMiningProfitabilityCalculatorBusinessRules(inputs: CryptoMiningProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
