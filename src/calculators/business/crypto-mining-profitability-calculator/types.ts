export interface CryptoMiningProfitabilityCalculatorInputs {
...
export interface CryptoMiningProfitabilityCalculatorOutputs {
...
export interface CryptoMiningProfitabilityCalculatorMetrics {
...
export interface CryptoMiningProfitabilityCalculatorAnalysis {
