import { AirlineRouteProfitabilityCalculatorInputs } from './types';

export function validateAirlineRouteProfitabilityCalculatorInputs(inputs: AirlineRouteProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAirlineRouteProfitabilityCalculatorBusinessRules(inputs: AirlineRouteProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
