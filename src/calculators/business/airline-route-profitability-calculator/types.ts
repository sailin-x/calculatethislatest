export interface AirlineRouteProfitabilityCalculatorInputs {
...
export interface AirlineRouteProfitabilityCalculatorOutputs {
...
export interface AirlineRouteProfitabilityCalculatorMetrics {
...
export interface AirlineRouteProfitabilityCalculatorAnalysis {
