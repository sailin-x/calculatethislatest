import { OilWellProfitabilityCalculatorInputs } from './types';

export function validateOilWellProfitabilityCalculatorInputs(inputs: OilWellProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateOilWellProfitabilityCalculatorBusinessRules(inputs: OilWellProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
