export interface OilWellProfitabilityCalculatorInputs {
...
export interface OilWellProfitabilityCalculatorOutputs {
...
export interface OilWellProfitabilityCalculatorMetrics {
...
export interface OilWellProfitabilityCalculatorAnalysis {
