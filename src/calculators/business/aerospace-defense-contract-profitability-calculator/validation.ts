import { AerospaceDefenseContractProfitabilityCalculatorInputs } from './types';

export function validateAerospaceDefenseContractProfitabilityCalculatorInputs(inputs: AerospaceDefenseContractProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAerospaceDefenseContractProfitabilityCalculatorBusinessRules(inputs: AerospaceDefenseContractProfitabilityCalculatorInputs): Array<{ field: string; message: string }> {
