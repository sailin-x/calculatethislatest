import { FarmSuccessionPlanningValuationInputs } from './types';

export function validateFarmSuccessionPlanningValuationInputs(inputs: FarmSuccessionPlanningValuationInputs): Array<{ field: string; message: string }> {
...
export function validateFarmSuccessionPlanningValuationBusinessRules(inputs: FarmSuccessionPlanningValuationInputs): Array<{ field: string; message: string }> {
