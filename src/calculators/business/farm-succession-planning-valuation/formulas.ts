import { farm-succession-planning-valuationInputs, farm-succession-planning-valuationMetrics, farm-succession-planning-valuationAnalysis } from './types';

// Farm Succession Planning Valuation - Business calculations
...
export function calculateResult(inputs: farm-succession-planning-valuationInputs): number {
...
export function generateAnalysis(inputs: farm-succession-planning-valuationInputs, metrics: farm-succession-planning-valuationMetrics): farm-succession-planning-valuationAnalysis {
