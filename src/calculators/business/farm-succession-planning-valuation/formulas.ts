import { FarmSuccessionPlanning-valuationInputs, FarmSuccessionPlanning-valuationMetrics, FarmSuccessionPlanning-valuationAnalysis } from './types';
...
export function calculateResult(inputs: FarmSuccessionPlanning-valuationInputs): number {
...
export function generateAnalysis(inputs: FarmSuccessionPlanning-valuationInputs, metrics: FarmSuccessionPlanning-valuationMetrics): FarmSuccessionPlanning-valuationAnalysis {
