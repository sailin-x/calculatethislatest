import { SponsorshipRoiCalculatorInputs } from './types';

export function validateSponsorshipRoiCalculatorInputs(inputs: SponsorshipRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateSponsorshipRoiCalculatorBusinessRules(inputs: SponsorshipRoiCalculatorInputs): Array<{ field: string; message: string }> {
