export interface SponsorshipRoiCalculatorInputs {
...
export interface SponsorshipRoiCalculatorOutputs {
...
export interface SponsorshipRoiCalculatorMetrics {
...
export interface SponsorshipRoiCalculatorAnalysis {
