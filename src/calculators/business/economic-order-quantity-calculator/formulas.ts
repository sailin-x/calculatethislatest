import { EconomicOrderQuantity-calculatorInputs, EconomicOrderQuantity-calculatorMetrics, EconomicOrderQuantity-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: EconomicOrderQuantity-calculatorInputs): number {
...
export function generateAnalysis(inputs: EconomicOrderQuantity-calculatorInputs, metrics: EconomicOrderQuantity-calculatorMetrics): EconomicOrderQuantity-calculatorAnalysis {
