import { economic-order-quantity-calculatorInputs, economic-order-quantity-calculatorMetrics, economic-order-quantity-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: economic-order-quantity-calculatorInputs): number {
...
export function generateAnalysis(inputs: economic-order-quantity-calculatorInputs, metrics: economic-order-quantity-calculatorMetrics): economic-order-quantity-calculatorAnalysis {
