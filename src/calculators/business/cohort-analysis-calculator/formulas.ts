import { cohort-analysis-calculatorInputs, cohort-analysis-calculatorMetrics, cohort-analysis-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cohort-analysis-calculatorInputs): number {
...
export function generateAnalysis(inputs: cohort-analysis-calculatorInputs, metrics: cohort-analysis-calculatorMetrics): cohort-analysis-calculatorAnalysis {
