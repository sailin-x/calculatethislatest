import { CohortAnalysisCalculatorinputs, CohortAnalysisCalculatormetrics, CohortAnalysisCalculatoranalysis } from './types';
...
export function calculateResult(inputs: CohortAnalysisCalculatorinputs): number {
...
export function generateAnalysis(inputs: CohortAnalysisCalculatorinputs, metrics: CohortAnalysisCalculatormetrics): CohortAnalysisCalculatoranalysis {
