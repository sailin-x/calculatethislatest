export interface MusicCatalogueValuationCalculatorInputs {
...
export interface MusicCatalogueValuationCalculatorOutputs {
...
export interface MusicCatalogueValuationCalculatorMetrics {
...
export interface MusicCatalogueValuationCalculatorAnalysis {
