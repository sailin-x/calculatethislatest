import { MusicCatalogueValuationCalculatorInputs } from './types';

export function validateMusicCatalogueValuationCalculatorInputs(inputs: MusicCatalogueValuationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMusicCatalogueValuationCalculatorBusinessRules(inputs: MusicCatalogueValuationCalculatorInputs): Array<{ field: string; message: string }> {
