import { DentalImplantRoiCalculatorInputs } from './types';

export function validateDentalImplantRoiCalculatorInputs(inputs: DentalImplantRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDentalImplantRoiCalculatorBusinessRules(inputs: DentalImplantRoiCalculatorInputs): Array<{ field: string; message: string }> {
