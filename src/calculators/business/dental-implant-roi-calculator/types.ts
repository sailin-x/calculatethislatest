export interface DentalImplantRoiCalculatorInputs {
...
export interface DentalImplantRoiCalculatorOutputs {
...
export interface DentalImplantRoiCalculatorMetrics {
...
export interface DentalImplantRoiCalculatorAnalysis {
