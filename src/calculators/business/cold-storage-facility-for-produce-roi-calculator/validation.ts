import { ColdStorageFacilityForProduceRoiCalculatorInputs } from './types';

export function validateColdStorageFacilityForProduceRoiCalculatorInputs(inputs: ColdStorageFacilityForProduceRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateColdStorageFacilityForProduceRoiCalculatorBusinessRules(inputs: ColdStorageFacilityForProduceRoiCalculatorInputs): Array<{ field: string; message: string }> {
