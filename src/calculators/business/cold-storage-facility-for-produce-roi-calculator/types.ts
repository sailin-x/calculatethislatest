export interface ColdStorageFacilityForProduceRoiCalculatorInputs {
...
export interface ColdStorageFacilityForProduceRoiCalculatorOutputs {
...
export interface ColdStorageFacilityForProduceRoiCalculatorMetrics {
...
export interface ColdStorageFacilityForProduceRoiCalculatorAnalysis {
