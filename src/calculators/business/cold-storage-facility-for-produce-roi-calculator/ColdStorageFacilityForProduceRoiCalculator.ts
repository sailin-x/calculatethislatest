...
import { ColdStorageFacilityForProduceRoiCalculatorInputs, ColdStorageFacilityForProduceRoiCalculatorOutputs } from './types';
import {
...
import { validateColdStorageFacilityForProduceRoiCalculatorInputs, validateColdStorageFacilityForProduceRoiCalculatorBusinessRules } from './validation';

export const ColdStorageFacilityForProduceRoiCalculatorCalculator: Calculator: Calculator = {
  id: 'cold-storage-facility-for-produce-roi-calculator-calculator',
  title: 'Cold Storage Facility for Produce ROI Calculator Calculator',
