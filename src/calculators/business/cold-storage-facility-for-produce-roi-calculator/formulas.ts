import { ColdStorageFacility-ForProduceRoi-calculatorInputs, ColdStorageFacility-ForProduceRoi-calculatorMetrics, ColdStorageFacility-ForProduceRoi-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ColdStorageFacility-ForProduceRoi-calculatorInputs): number {
...
export function generateAnalysis(inputs: ColdStorageFacility-ForProduceRoi-calculatorInputs, metrics: ColdStorageFacility-ForProduceRoi-calculatorMetrics): ColdStorageFacility-ForProduceRoi-calculatorAnalysis {
