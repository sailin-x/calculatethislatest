import { cold-storage-facility-for-produce-roi-calculatorInputs, cold-storage-facility-for-produce-roi-calculatorMetrics, cold-storage-facility-for-produce-roi-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cold-storage-facility-for-produce-roi-calculatorInputs): number {
...
export function generateAnalysis(inputs: cold-storage-facility-for-produce-roi-calculatorInputs, metrics: cold-storage-facility-for-produce-roi-calculatorMetrics): cold-storage-facility-for-produce-roi-calculatorAnalysis {
