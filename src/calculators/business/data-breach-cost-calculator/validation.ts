import { DataBreachCostCalculatorInputs } from './types';

export function validateDataBreachCostCalculatorInputs(inputs: DataBreachCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDataBreachCostCalculatorBusinessRules(inputs: DataBreachCostCalculatorInputs): Array<{ field: string; message: string }> {
