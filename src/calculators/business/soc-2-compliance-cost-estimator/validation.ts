import { Soc2ComplianceCostEstimatorInputs } from './types';

export function validateSoc2ComplianceCostEstimatorInputs(inputs: Soc2ComplianceCostEstimatorInputs): Array<{ field: string; message: string }> {
...
export function validateSoc2ComplianceCostEstimatorBusinessRules(inputs: Soc2ComplianceCostEstimatorInputs): Array<{ field: string; message: string }> {
