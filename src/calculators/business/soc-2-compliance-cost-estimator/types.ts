export interface Soc2ComplianceCostEstimatorInputs {
...
export interface Soc2ComplianceCostEstimatorOutputs {
...
export interface Soc2ComplianceCostEstimatorMetrics {
...
export interface Soc2ComplianceCostEstimatorAnalysis {
