...
import { Soc2ComplianceCostEstimatorInputs, Soc2ComplianceCostEstimatorOutputs } from './types';
import {
...
import { validateSoc2ComplianceCostEstimatorInputs, validateSoc2ComplianceCostEstimatorBusinessRules } from './validation';

export const Soc2ComplianceCostEstimatorCalculator: Calculator: Calculator = {
  id: 'soc-2-compliance-cost-estimator-calculator',
