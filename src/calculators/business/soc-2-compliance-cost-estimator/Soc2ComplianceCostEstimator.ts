...
import { validateSoc2ComplianceCostEstimatorInputs } from './validation';

export const Soc2ComplianceCostEstimator: Calculator = {
  id: 'soc-2-compliance-cost-estimator',
  title: 'SOC 2 Compliance Cost Estimator',
  category: 'business',
  subcategory: 'Financial Planning',
  description: 'Estimate SOC 2 costs',
  usageInstructions: [
