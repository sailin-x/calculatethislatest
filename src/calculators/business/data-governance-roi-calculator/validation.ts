import { DataGovernanceRoiCalculatorInputs } from './types';

export function validateDataGovernanceRoiCalculatorInputs(inputs: DataGovernanceRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDataGovernanceRoiCalculatorBusinessRules(inputs: DataGovernanceRoiCalculatorInputs): Array<{ field: string; message: string }> {
