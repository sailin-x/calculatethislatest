import { DredgingProjectCost-calculatorInputs, DredgingProjectCost-calculatorMetrics, DredgingProjectCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: DredgingProjectCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: DredgingProjectCost-calculatorInputs, metrics: DredgingProjectCost-calculatorMetrics): DredgingProjectCost-calculatorAnalysis {
