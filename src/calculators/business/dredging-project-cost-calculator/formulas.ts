import { dredging-project-cost-calculatorInputs, dredging-project-cost-calculatorMetrics, dredging-project-cost-calculatorAnalysis } from './types';

// Dredging Project Cost Calculator - Business calculations
...
export function calculateResult(inputs: dredging-project-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: dredging-project-cost-calculatorInputs, metrics: dredging-project-cost-calculatorMetrics): dredging-project-cost-calculatorAnalysis {
