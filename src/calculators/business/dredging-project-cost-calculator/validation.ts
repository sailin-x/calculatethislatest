import { DredgingProjectCostCalculatorInputs } from './types';

export function validateDredgingProjectCostCalculatorInputs(inputs: DredgingProjectCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDredgingProjectCostCalculatorBusinessRules(inputs: DredgingProjectCostCalculatorInputs): Array<{ field: string; message: string }> {
