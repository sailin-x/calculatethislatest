import { ad_reach_frequency_calculatorInputs } from './types';

export function validateInputs(inputs: ad_reach_frequency_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
