import { ad_reach_frequency_calculatorInputs, ad_reach_frequency_calculatorMetrics, ad_reach_frequency_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ad_reach_frequency_calculatorInputs): number {
...
export function generateAnalysis(inputs: ad_reach_frequency_calculatorInputs, metrics: ad_reach_frequency_calculatorMetrics): ad_reach_frequency_calculatorAnalysis {
