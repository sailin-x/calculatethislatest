import { AdReachFrequency-calculatorInputs, AdReachFrequency-calculatorMetrics, AdReachFrequency-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: AdReachFrequency-calculatorInputs): number {
...
export function generateAnalysis(inputs: AdReachFrequency-calculatorInputs, metrics: AdReachFrequency-calculatorMetrics): AdReachFrequency-calculatorAnalysis {
