import { MedicalPracticeValuationCalculatorInputs } from './types';

export function validateMedicalPracticeValuationCalculatorInputs(inputs: MedicalPracticeValuationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMedicalPracticeValuationCalculatorBusinessRules(inputs: MedicalPracticeValuationCalculatorInputs): Array<{ field: string; message: string }> {
