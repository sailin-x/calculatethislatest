export interface MedicalPracticeValuationCalculatorInputs {
...
export interface MedicalPracticeValuationCalculatorOutputs {
...
export interface MedicalPracticeValuationCalculatorMetrics {
...
export interface MedicalPracticeValuationCalculatorAnalysis {
