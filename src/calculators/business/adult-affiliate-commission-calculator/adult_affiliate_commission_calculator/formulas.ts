import { adult_affiliate_commission_calculatorInputs, adult_affiliate_commission_calculatorMetrics, adult_affiliate_commission_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: adult_affiliate_commission_calculatorInputs): number {
...
export function generateAnalysis(inputs: adult_affiliate_commission_calculatorInputs, metrics: adult_affiliate_commission_calculatorMetrics): adult_affiliate_commission_calculatorAnalysis {
