import { InjectionMoldingCostEstimatorInputs } from './types';

export function validateInjectionMoldingCostEstimatorInputs(inputs: InjectionMoldingCostEstimatorInputs): Array<{ field: string; message: string }> {
...
export function validateInjectionMoldingCostEstimatorBusinessRules(inputs: InjectionMoldingCostEstimatorInputs): Array<{ field: string; message: string }> {
