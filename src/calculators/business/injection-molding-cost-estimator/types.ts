export interface InjectionMoldingCostEstimatorInputs {
...
export interface InjectionMoldingCostEstimatorOutputs {
...
export interface InjectionMoldingCostEstimatorMetrics {
...
export interface InjectionMoldingCostEstimatorAnalysis {
