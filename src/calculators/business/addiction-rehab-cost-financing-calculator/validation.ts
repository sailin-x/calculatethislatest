import { AddictionRehabCostFinancingCalculatorInputs } from './types';

export function validateAddictionRehabCostFinancingCalculatorInputs(inputs: AddictionRehabCostFinancingCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAddictionRehabCostFinancingCalculatorBusinessRules(inputs: AddictionRehabCostFinancingCalculatorInputs): Array<{ field: string; message: string }> {
