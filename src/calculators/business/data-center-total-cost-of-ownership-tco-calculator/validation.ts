import { DataCenterTotalCostOfOwnershipTcoCalculatorInputs } from './types';

export function validateDataCenterTotalCostOfOwnershipTcoCalculatorInputs(inputs: DataCenterTotalCostOfOwnershipTcoCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDataCenterTotalCostOfOwnershipTcoCalculatorBusinessRules(inputs: DataCenterTotalCostOfOwnershipTcoCalculatorInputs): Array<{ field: string; message: string }> {
