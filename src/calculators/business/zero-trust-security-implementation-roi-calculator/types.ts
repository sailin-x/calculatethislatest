export interface ZerotrustSecurityImplementationRoiCalculatorInputs {
...
export interface ZerotrustSecurityImplementationRoiCalculatorOutputs {
...
export interface ZerotrustSecurityImplementationRoiCalculatorMetrics {
...
export interface ZerotrustSecurityImplementationRoiCalculatorAnalysis {
