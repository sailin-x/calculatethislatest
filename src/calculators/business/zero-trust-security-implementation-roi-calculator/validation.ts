import { ZerotrustSecurityImplementationRoiCalculatorInputs } from './types';

export function validateZerotrustSecurityImplementationRoiCalculatorInputs(inputs: ZerotrustSecurityImplementationRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateZerotrustSecurityImplementationRoiCalculatorBusinessRules(inputs: ZerotrustSecurityImplementationRoiCalculatorInputs): Array<{ field: string; message: string }> {
