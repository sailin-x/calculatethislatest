export interface TextileManufacturingCostperyardCalculatorInputs {
...
export interface TextileManufacturingCostperyardCalculatorOutputs {
...
export interface TextileManufacturingCostperyardCalculatorMetrics {
...
export interface TextileManufacturingCostperyardCalculatorAnalysis {
