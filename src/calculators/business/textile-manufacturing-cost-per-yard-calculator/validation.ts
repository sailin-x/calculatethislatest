import { TextileManufacturingCostperyardCalculatorInputs } from './types';

export function validateTextileManufacturingCostperyardCalculatorInputs(inputs: TextileManufacturingCostperyardCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTextileManufacturingCostperyardCalculatorBusinessRules(inputs: TextileManufacturingCostperyardCalculatorInputs): Array<{ field: string; message: string }> {
