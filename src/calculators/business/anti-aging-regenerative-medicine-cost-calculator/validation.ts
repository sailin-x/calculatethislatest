import { AntiagingRegenerativeMedicineCostCalculatorInputs } from './types';

export function validateAntiagingRegenerativeMedicineCostCalculatorInputs(inputs: AntiagingRegenerativeMedicineCostCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAntiagingRegenerativeMedicineCostCalculatorBusinessRules(inputs: AntiagingRegenerativeMedicineCostCalculatorInputs): Array<{ field: string; message: string }> {
