import { customer-segmentation-calculatorInputs, customer-segmentation-calculatorMetrics, customer-segmentation-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: customer-segmentation-calculatorInputs): number {
...
export function generateAnalysis(inputs: customer-segmentation-calculatorInputs, metrics: customer-segmentation-calculatorMetrics): customer-segmentation-calculatorAnalysis {
