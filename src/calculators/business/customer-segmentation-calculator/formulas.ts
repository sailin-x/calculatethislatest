import { CustomerSegmentationCalculatorinputs, CustomerSegmentationCalculatormetrics, CustomerSegmentationCalculatoranalysis } from './types';
...
export function calculateResult(inputs: CustomerSegmentationCalculatorinputs): number {
...
export function generateAnalysis(inputs: CustomerSegmentationCalculatorinputs, metrics: CustomerSegmentationCalculatormetrics): CustomerSegmentationCalculatoranalysis {
