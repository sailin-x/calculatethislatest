...
import { CelebrityEndorsementDealValuationInputs, CelebrityEndorsementDealValuationOutputs } from './types';
import {
...
import { validateCelebrityEndorsementDealValuationInputs } from './validation';

export const CelebrityEndorsementDealValuation: Calculator = {
  id: 'celebrity-endorsement-deal-valuation',
  title: 'Celebrity Endorsement Deal Valuation',
  category: 'business',
  subcategory: 'Financial Planning',
  description: 'Calculate celebrity endorsement value',
  usageInstructions: [
