import { CelebrityEndorsementDealValuationInputs } from './types';

export function validateCelebrityEndorsementDealValuationInputs(inputs: CelebrityEndorsementDealValuationInputs): Array<{ field: string; message: string }> {
...
export function validateCelebrityEndorsementDealValuationBusinessRules(inputs: CelebrityEndorsementDealValuationInputs): Array<{ field: string; message: string }> {
