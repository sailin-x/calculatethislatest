import { EmployeeStockOption-plan-calculatorInputs, EmployeeStockOption-plan-calculatorMetrics, EmployeeStockOption-plan-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: EmployeeStockOption-plan-calculatorInputs): number {
...
export function generateAnalysis(inputs: EmployeeStockOption-plan-calculatorInputs, metrics: EmployeeStockOption-plan-calculatorMetrics): EmployeeStockOption-plan-calculatorAnalysis {
