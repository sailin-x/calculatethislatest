import { employee-stock-option-plan-calculatorInputs, employee-stock-option-plan-calculatorMetrics, employee-stock-option-plan-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: employee-stock-option-plan-calculatorInputs): number {
...
export function generateAnalysis(inputs: employee-stock-option-plan-calculatorInputs, metrics: employee-stock-option-plan-calculatorMetrics): employee-stock-option-plan-calculatorAnalysis {
