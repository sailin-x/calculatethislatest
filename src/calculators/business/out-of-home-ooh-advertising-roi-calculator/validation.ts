import { OutofhomeOohAdvertisingRoiCalculatorInputs } from './types';

export function validateOutofhomeOohAdvertisingRoiCalculatorInputs(inputs: OutofhomeOohAdvertisingRoiCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateOutofhomeOohAdvertisingRoiCalculatorBusinessRules(inputs: OutofhomeOohAdvertisingRoiCalculatorInputs): Array<{ field: string; message: string }> {
