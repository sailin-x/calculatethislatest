import { irrigation_calculatorCalculatorInputs, irrigation_calculatorCalculatorMetrics, irrigation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: irrigation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: irrigation_calculatorCalculatorInputs, metrics: irrigation_calculatorCalculatorMetrics): irrigation_calculatorCalculatorAnalysis {
