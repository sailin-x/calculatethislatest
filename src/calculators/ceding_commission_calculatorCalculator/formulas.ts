import { ceding_commission_calculatorCalculatorInputs, ceding_commission_calculatorCalculatorMetrics, ceding_commission_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: ceding_commission_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: ceding_commission_calculatorCalculatorInputs, metrics: ceding_commission_calculatorCalculatorMetrics): ceding_commission_calculatorCalculatorAnalysis {
