import { ceding_commission_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: ceding_commission_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
