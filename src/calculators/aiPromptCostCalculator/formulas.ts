import { aiPromptCostCalculatorInputs, aiPromptCostCalculatorMetrics, aiPromptCostCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: aiPromptCostCalculatorInputs): number {
...
export function generateAnalysis(inputs: aiPromptCostCalculatorInputs, metrics: aiPromptCostCalculatorMetrics): aiPromptCostCalculatorAnalysis {
