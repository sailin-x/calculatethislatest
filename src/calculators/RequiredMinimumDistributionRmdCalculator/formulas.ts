import { RequiredMinimumDistributionRmdCalculatorInputs, RequiredMinimumDistributionRmdCalculatorMetrics, RequiredMinimumDistributionRmdCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: RequiredMinimumDistributionRmdCalculatorInputs): number {
...
export function generateAnalysis(inputs: RequiredMinimumDistributionRmdCalculatorInputs, metrics: RequiredMinimumDistributionRmdCalculatorMetrics): RequiredMinimumDistributionRmdCalculatorAnalysis {
