import { estateTaxLiabilityCalculatorInputs, estateTaxLiabilityCalculatorMetrics, estateTaxLiabilityCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: estateTaxLiabilityCalculatorInputs): number {
...
export function generateAnalysis(inputs: estateTaxLiabilityCalculatorInputs, metrics: estateTaxLiabilityCalculatorMetrics): estateTaxLiabilityCalculatorAnalysis {
