import { hedge_fund_fee_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: hedge_fund_fee_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
