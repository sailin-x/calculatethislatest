import { hedge_fund_fee_calculatorCalculatorInputs, hedge_fund_fee_calculatorCalculatorMetrics, hedge_fund_fee_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hedge_fund_fee_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: hedge_fund_fee_calculatorCalculatorInputs, metrics: hedge_fund_fee_calculatorCalculatorMetrics): hedge_fund_fee_calculatorCalculatorAnalysis {
