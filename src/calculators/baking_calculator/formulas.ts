import { baking_calculatorInputs, baking_calculatorMetrics, baking_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: baking_calculatorInputs): number {
...
export function generateAnalysis(inputs: baking_calculatorInputs, metrics: baking_calculatorMetrics): baking_calculatorAnalysis {
