import { catastrophic_injury_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: catastrophic_injury_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
