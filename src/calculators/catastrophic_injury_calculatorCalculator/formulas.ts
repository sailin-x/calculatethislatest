import { catastrophic_injury_calculatorCalculatorInputs, catastrophic_injury_calculatorCalculatorMetrics, catastrophic_injury_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: catastrophic_injury_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: catastrophic_injury_calculatorCalculatorInputs, metrics: catastrophic_injury_calculatorCalculatorMetrics): catastrophic_injury_calculatorCalculatorAnalysis {
