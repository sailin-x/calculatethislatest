import { critical_illness_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: critical_illness_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
