import { critical_illness_calculatorCalculatorInputs, critical_illness_calculatorCalculatorMetrics, critical_illness_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: critical_illness_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: critical_illness_calculatorCalculatorInputs, metrics: critical_illness_calculatorCalculatorMetrics): critical_illness_calculatorCalculatorAnalysis {
