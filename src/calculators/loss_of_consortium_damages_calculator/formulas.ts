import { loss_of_consortium_damages_calculatorInputs, loss_of_consortium_damages_calculatorMetrics, loss_of_consortium_damages_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: loss_of_consortium_damages_calculatorInputs): number {
...
export function generateAnalysis(inputs: loss_of_consortium_damages_calculatorInputs, metrics: loss_of_consortium_damages_calculatorMetrics): loss_of_consortium_damages_calculatorAnalysis {
