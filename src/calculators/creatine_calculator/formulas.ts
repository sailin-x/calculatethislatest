import { creatine_calculatorInputs, creatine_calculatorMetrics, creatine_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: creatine_calculatorInputs): number {
...
export function generateAnalysis(inputs: creatine_calculatorInputs, metrics: creatine_calculatorMetrics): creatine_calculatorAnalysis {
