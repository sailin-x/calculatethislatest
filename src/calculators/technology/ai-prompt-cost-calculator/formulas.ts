import { ai-prompt-cost-calculatorInputs, ai-prompt-cost-calculatorMetrics, ai-prompt-cost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ai-prompt-cost-calculatorInputs): number {
...
export function generateAnalysis(inputs: ai-prompt-cost-calculatorInputs, metrics: ai-prompt-cost-calculatorMetrics): ai-prompt-cost-calculatorAnalysis {
