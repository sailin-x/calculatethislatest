import { AiPromptCost-calculatorInputs, AiPromptCost-calculatorMetrics, AiPromptCost-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: AiPromptCost-calculatorInputs): number {
...
export function generateAnalysis(inputs: AiPromptCost-calculatorInputs, metrics: AiPromptCost-calculatorMetrics): AiPromptCost-calculatorAnalysis {
