import { irs_offer_in_compromise_oic_calculatorInputs, irs_offer_in_compromise_oic_calculatorMetrics, irs_offer_in_compromise_oic_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: irs_offer_in_compromise_oic_calculatorInputs): number {
...
export function generateAnalysis(inputs: irs_offer_in_compromise_oic_calculatorInputs, metrics: irs_offer_in_compromise_oic_calculatorMetrics): irs_offer_in_compromise_oic_calculatorAnalysis {
