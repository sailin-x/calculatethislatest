import { burn_injury_settlement_calculatorInputs, burn_injury_settlement_calculatorMetrics, burn_injury_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: burn_injury_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: burn_injury_settlement_calculatorInputs, metrics: burn_injury_settlement_calculatorMetrics): burn_injury_settlement_calculatorAnalysis {
