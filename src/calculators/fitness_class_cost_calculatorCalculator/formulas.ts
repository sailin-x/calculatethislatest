import { fitness_class_cost_calculatorCalculatorInputs, fitness_class_cost_calculatorCalculatorMetrics, fitness_class_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fitness_class_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: fitness_class_cost_calculatorCalculatorInputs, metrics: fitness_class_cost_calculatorCalculatorMetrics): fitness_class_cost_calculatorCalculatorAnalysis {
