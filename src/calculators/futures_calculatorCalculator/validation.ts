import { futures_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: futures_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
