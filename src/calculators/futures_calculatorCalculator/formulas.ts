import { futures_calculatorCalculatorInputs, futures_calculatorCalculatorMetrics, futures_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: futures_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: futures_calculatorCalculatorInputs, metrics: futures_calculatorCalculatorMetrics): futures_calculatorCalculatorAnalysis {
