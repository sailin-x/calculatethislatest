import { rental_property_roi_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: rental_property_roi_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
