import { rental_property_roi_calculatorCalculatorInputs, rental_property_roi_calculatorCalculatorMetrics, rental_property_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: rental_property_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: rental_property_roi_calculatorCalculatorInputs, metrics: rental_property_roi_calculatorCalculatorMetrics): rental_property_roi_calculatorCalculatorAnalysis {
