import { recipe_scaling_calculatorInputs, recipe_scaling_calculatorMetrics, recipe_scaling_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: recipe_scaling_calculatorInputs): number {
...
export function generateAnalysis(inputs: recipe_scaling_calculatorInputs, metrics: recipe_scaling_calculatorMetrics): recipe_scaling_calculatorAnalysis {
