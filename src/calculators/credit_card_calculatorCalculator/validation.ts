import { credit_card_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: credit_card_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
