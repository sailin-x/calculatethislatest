import { credit_card_calculatorCalculatorInputs, credit_card_calculatorCalculatorMetrics, credit_card_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: credit_card_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: credit_card_calculatorCalculatorInputs, metrics: credit_card_calculatorCalculatorMetrics): credit_card_calculatorCalculatorAnalysis {
