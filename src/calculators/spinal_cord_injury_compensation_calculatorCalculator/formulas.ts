import { spinal_cord_injury_compensation_calculatorCalculatorInputs, spinal_cord_injury_compensation_calculatorCalculatorMetrics, spinal_cord_injury_compensation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: spinal_cord_injury_compensation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: spinal_cord_injury_compensation_calculatorCalculatorInputs, metrics: spinal_cord_injury_compensation_calculatorCalculatorMetrics): spinal_cord_injury_compensation_calculatorCalculatorAnalysis {
