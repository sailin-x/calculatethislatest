import { professional_liability_insurance_calculatorInputs, professional_liability_insurance_calculatorMetrics, professional_liability_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: professional_liability_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: professional_liability_insurance_calculatorInputs, metrics: professional_liability_insurance_calculatorMetrics): professional_liability_insurance_calculatorAnalysis {
