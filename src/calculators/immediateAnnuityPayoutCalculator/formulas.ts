import { immediateAnnuityPayoutCalculatorInputs, immediateAnnuityPayoutCalculatorMetrics, immediateAnnuityPayoutCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: immediateAnnuityPayoutCalculatorInputs): number {
...
export function generateAnalysis(inputs: immediateAnnuityPayoutCalculatorInputs, metrics: immediateAnnuityPayoutCalculatorMetrics): immediateAnnuityPayoutCalculatorAnalysis {
