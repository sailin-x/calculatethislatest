import { slip_and_fall_settlement_calculatorCalculatorInputs, slip_and_fall_settlement_calculatorCalculatorMetrics, slip_and_fall_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: slip_and_fall_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: slip_and_fall_settlement_calculatorCalculatorInputs, metrics: slip_and_fall_settlement_calculatorCalculatorMetrics): slip_and_fall_settlement_calculatorCalculatorAnalysis {
