import { food_cost_calculatorCalculatorInputs, food_cost_calculatorCalculatorMetrics, food_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: food_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: food_cost_calculatorCalculatorInputs, metrics: food_cost_calculatorCalculatorMetrics): food_cost_calculatorCalculatorAnalysis {
