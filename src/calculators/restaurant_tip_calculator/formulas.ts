import { restaurant_tip_calculatorInputs, restaurant_tip_calculatorMetrics, restaurant_tip_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: restaurant_tip_calculatorInputs): number {
...
export function generateAnalysis(inputs: restaurant_tip_calculatorInputs, metrics: restaurant_tip_calculatorMetrics): restaurant_tip_calculatorAnalysis {
