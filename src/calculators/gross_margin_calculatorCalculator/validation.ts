import { gross_margin_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: gross_margin_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
