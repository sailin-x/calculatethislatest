import { gross_margin_calculatorCalculatorInputs, gross_margin_calculatorCalculatorMetrics, gross_margin_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: gross_margin_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: gross_margin_calculatorCalculatorInputs, metrics: gross_margin_calculatorCalculatorMetrics): gross_margin_calculatorCalculatorAnalysis {
