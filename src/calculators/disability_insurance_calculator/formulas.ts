import { disability_insurance_calculatorInputs, disability_insurance_calculatorMetrics, disability_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: disability_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: disability_insurance_calculatorInputs, metrics: disability_insurance_calculatorMetrics): disability_insurance_calculatorAnalysis {
