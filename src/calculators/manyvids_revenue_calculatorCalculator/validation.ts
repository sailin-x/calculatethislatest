import { manyvids_revenue_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: manyvids_revenue_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
