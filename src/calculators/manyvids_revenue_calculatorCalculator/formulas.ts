import { manyvids_revenue_calculatorCalculatorInputs, manyvids_revenue_calculatorCalculatorMetrics, manyvids_revenue_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: manyvids_revenue_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: manyvids_revenue_calculatorCalculatorInputs, metrics: manyvids_revenue_calculatorCalculatorMetrics): manyvids_revenue_calculatorCalculatorAnalysis {
