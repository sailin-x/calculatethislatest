import { request_for_proposal_scoring_calculatorInputs } from './types';

export function validateInputs(inputs: request_for_proposal_scoring_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
