import { roth_ira_calculatorInputs, roth_ira_calculatorMetrics, roth_ira_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: roth_ira_calculatorInputs): number {
...
export function generateAnalysis(inputs: roth_ira_calculatorInputs, metrics: roth_ira_calculatorMetrics): roth_ira_calculatorAnalysis {
