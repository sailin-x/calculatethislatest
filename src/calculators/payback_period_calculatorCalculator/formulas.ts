import { payback_period_calculatorCalculatorInputs, payback_period_calculatorCalculatorMetrics, payback_period_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: payback_period_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: payback_period_calculatorCalculatorInputs, metrics: payback_period_calculatorCalculatorMetrics): payback_period_calculatorCalculatorAnalysis {
