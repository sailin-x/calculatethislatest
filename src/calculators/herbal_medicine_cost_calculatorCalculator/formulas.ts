import { herbal_medicine_cost_calculatorCalculatorInputs, herbal_medicine_cost_calculatorCalculatorMetrics, herbal_medicine_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: herbal_medicine_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: herbal_medicine_cost_calculatorCalculatorInputs, metrics: herbal_medicine_cost_calculatorCalculatorMetrics): herbal_medicine_cost_calculatorCalculatorAnalysis {
