import { gift_tax_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: gift_tax_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
