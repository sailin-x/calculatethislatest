import { gift_tax_calculatorCalculatorInputs, gift_tax_calculatorCalculatorMetrics, gift_tax_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: gift_tax_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: gift_tax_calculatorCalculatorInputs, metrics: gift_tax_calculatorCalculatorMetrics): gift_tax_calculatorCalculatorAnalysis {
