import { beta_calculatorInputs, beta_calculatorMetrics, beta_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: beta_calculatorInputs): number {
...
export function generateAnalysis(inputs: beta_calculatorInputs, metrics: beta_calculatorMetrics): beta_calculatorAnalysis {
