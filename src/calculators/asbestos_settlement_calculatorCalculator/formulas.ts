import { asbestos_settlement_calculatorCalculatorInputs, asbestos_settlement_calculatorCalculatorMetrics, asbestos_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: asbestos_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: asbestos_settlement_calculatorCalculatorInputs, metrics: asbestos_settlement_calculatorCalculatorMetrics): asbestos_settlement_calculatorCalculatorAnalysis {
