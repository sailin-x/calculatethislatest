import { registerAutoLoanCalculatorInputs } from './types';

export function validateInputs(inputs: registerAutoLoanCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
