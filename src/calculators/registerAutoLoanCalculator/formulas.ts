import { registerAutoLoanCalculatorInputs, registerAutoLoanCalculatorMetrics, registerAutoLoanCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerAutoLoanCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerAutoLoanCalculatorInputs, metrics: registerAutoLoanCalculatorMetrics): registerAutoLoanCalculatorAnalysis {
