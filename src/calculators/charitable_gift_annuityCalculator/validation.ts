import { charitable_gift_annuityCalculatorInputs } from './types';

export function validateInputs(inputs: charitable_gift_annuityCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
