import { charitable_gift_annuityCalculatorInputs, charitable_gift_annuityCalculatorMetrics, charitable_gift_annuityCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: charitable_gift_annuityCalculatorInputs): number {
...
export function generateAnalysis(inputs: charitable_gift_annuityCalculatorInputs, metrics: charitable_gift_annuityCalculatorMetrics): charitable_gift_annuityCalculatorAnalysis {
