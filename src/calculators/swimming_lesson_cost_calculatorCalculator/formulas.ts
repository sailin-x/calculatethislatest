import { swimming_lesson_cost_calculatorCalculatorInputs, swimming_lesson_cost_calculatorCalculatorMetrics, swimming_lesson_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: swimming_lesson_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: swimming_lesson_cost_calculatorCalculatorInputs, metrics: swimming_lesson_cost_calculatorCalculatorMetrics): swimming_lesson_cost_calculatorCalculatorAnalysis {
