import { student_loan_refinancing_calculatorInputs, student_loan_refinancing_calculatorMetrics, student_loan_refinancing_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: student_loan_refinancing_calculatorInputs): number {
...
export function generateAnalysis(inputs: student_loan_refinancing_calculatorInputs, metrics: student_loan_refinancing_calculatorMetrics): student_loan_refinancing_calculatorAnalysis {
