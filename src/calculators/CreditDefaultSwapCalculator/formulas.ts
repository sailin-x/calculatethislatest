...
export function generateAnalysis(inputs: CreditDefaultSwapCalculatorInputs, metrics: CreditDefaultSwapCalculatorMetrics): CreditDefaultSwapCalculatorAnalysis {
