import { merger_arbitrage_spread_calculatorInputs, merger_arbitrage_spread_calculatorMetrics, merger_arbitrage_spread_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: merger_arbitrage_spread_calculatorInputs): number {
...
export function generateAnalysis(inputs: merger_arbitrage_spread_calculatorInputs, metrics: merger_arbitrage_spread_calculatorMetrics): merger_arbitrage_spread_calculatorAnalysis {
