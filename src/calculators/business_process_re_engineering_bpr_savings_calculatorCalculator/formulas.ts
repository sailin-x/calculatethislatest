import { business_process_re_engineering_bpr_savings_calculatorCalculatorInputs, business_process_re_engineering_bpr_savings_calculatorCalculatorMetrics, business_process_re_engineering_bpr_savings_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_process_re_engineering_bpr_savings_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: business_process_re_engineering_bpr_savings_calculatorCalculatorInputs, metrics: business_process_re_engineering_bpr_savings_calculatorCalculatorMetrics): business_process_re_engineering_bpr_savings_calculatorCalculatorAnalysis {
