import { siding_repair_cost_calculatorInputs, siding_repair_cost_calculatorMetrics, siding_repair_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: siding_repair_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: siding_repair_cost_calculatorInputs, metrics: siding_repair_cost_calculatorMetrics): siding_repair_cost_calculatorAnalysis {
