import { seo_cost_calculatorCalculatorInputs, seo_cost_calculatorCalculatorMetrics, seo_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: seo_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: seo_cost_calculatorCalculatorInputs, metrics: seo_cost_calculatorCalculatorMetrics): seo_cost_calculatorCalculatorAnalysis {
