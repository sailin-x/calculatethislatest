import { term_vs_whole_life_calculatorCalculatorInputs, term_vs_whole_life_calculatorCalculatorMetrics, term_vs_whole_life_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: term_vs_whole_life_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: term_vs_whole_life_calculatorCalculatorInputs, metrics: term_vs_whole_life_calculatorCalculatorMetrics): term_vs_whole_life_calculatorCalculatorAnalysis {
