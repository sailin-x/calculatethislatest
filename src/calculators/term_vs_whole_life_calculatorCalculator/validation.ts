import { term_vs_whole_life_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: term_vs_whole_life_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
