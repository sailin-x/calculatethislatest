import { medical_bill_negotiation_calculatorInputs, medical_bill_negotiation_calculatorMetrics, medical_bill_negotiation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: medical_bill_negotiation_calculatorInputs): number {
...
export function generateAnalysis(inputs: medical_bill_negotiation_calculatorInputs, metrics: medical_bill_negotiation_calculatorMetrics): medical_bill_negotiation_calculatorAnalysis {
