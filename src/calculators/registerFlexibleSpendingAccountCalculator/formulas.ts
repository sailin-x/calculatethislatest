import { registerFlexibleSpendingAccountCalculatorInputs, registerFlexibleSpendingAccountCalculatorMetrics, registerFlexibleSpendingAccountCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerFlexibleSpendingAccountCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerFlexibleSpendingAccountCalculatorInputs, metrics: registerFlexibleSpendingAccountCalculatorMetrics): registerFlexibleSpendingAccountCalculatorAnalysis {
