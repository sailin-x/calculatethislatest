import { registerFlexibleSpendingAccountCalculatorInputs } from './types';

export function validateInputs(inputs: registerFlexibleSpendingAccountCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
