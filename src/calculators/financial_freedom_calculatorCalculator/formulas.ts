import { financial_freedom_calculatorCalculatorInputs, financial_freedom_calculatorCalculatorMetrics, financial_freedom_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_freedom_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_freedom_calculatorCalculatorInputs, metrics: financial_freedom_calculatorCalculatorMetrics): financial_freedom_calculatorCalculatorAnalysis {
