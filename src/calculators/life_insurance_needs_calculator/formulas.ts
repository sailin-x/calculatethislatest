import { life_insurance_needs_calculatorInputs, life_insurance_needs_calculatorMetrics, life_insurance_needs_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: life_insurance_needs_calculatorInputs): number {
...
export function generateAnalysis(inputs: life_insurance_needs_calculatorInputs, metrics: life_insurance_needs_calculatorMetrics): life_insurance_needs_calculatorAnalysis {
