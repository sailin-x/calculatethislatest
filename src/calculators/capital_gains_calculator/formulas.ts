import { capital_gains_calculatorInputs, capital_gains_calculatorMetrics, capital_gains_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: capital_gains_calculatorInputs): number {
...
export function generateAnalysis(inputs: capital_gains_calculatorInputs, metrics: capital_gains_calculatorMetrics): capital_gains_calculatorAnalysis {
