import { medical_expense_tax_deduction_calculatorCalculatorInputs, medical_expense_tax_deduction_calculatorCalculatorMetrics, medical_expense_tax_deduction_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: medical_expense_tax_deduction_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: medical_expense_tax_deduction_calculatorCalculatorInputs, metrics: medical_expense_tax_deduction_calculatorCalculatorMetrics): medical_expense_tax_deduction_calculatorCalculatorAnalysis {
