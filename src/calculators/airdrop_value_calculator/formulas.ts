import { airdrop_value_calculatorInputs, airdrop_value_calculatorMetrics, airdrop_value_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: airdrop_value_calculatorInputs): number {
...
export function generateAnalysis(inputs: airdrop_value_calculatorInputs, metrics: airdrop_value_calculatorMetrics): airdrop_value_calculatorAnalysis {
