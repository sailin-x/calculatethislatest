import { college_financial_aidCalculatorInputs } from './types';

export function validateInputs(inputs: college_financial_aidCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
