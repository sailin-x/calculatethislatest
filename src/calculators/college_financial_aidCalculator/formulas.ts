import { college_financial_aidCalculatorInputs, college_financial_aidCalculatorMetrics, college_financial_aidCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: college_financial_aidCalculatorInputs): number {
...
export function generateAnalysis(inputs: college_financial_aidCalculatorInputs, metrics: college_financial_aidCalculatorMetrics): college_financial_aidCalculatorAnalysis {
