import { business_insurance_calculatorCalculatorInputs, business_insurance_calculatorCalculatorMetrics, business_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: business_insurance_calculatorCalculatorInputs, metrics: business_insurance_calculatorCalculatorMetrics): business_insurance_calculatorCalculatorAnalysis {
