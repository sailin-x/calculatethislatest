import { average_order_value_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: average_order_value_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
