import { average_order_value_calculatorCalculatorInputs, average_order_value_calculatorCalculatorMetrics, average_order_value_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: average_order_value_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: average_order_value_calculatorCalculatorInputs, metrics: average_order_value_calculatorCalculatorMetrics): average_order_value_calculatorCalculatorAnalysis {
