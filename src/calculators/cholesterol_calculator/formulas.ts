import { cholesterol_calculatorInputs, cholesterol_calculatorMetrics, cholesterol_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cholesterol_calculatorInputs): number {
...
export function generateAnalysis(inputs: cholesterol_calculatorInputs, metrics: cholesterol_calculatorMetrics): cholesterol_calculatorAnalysis {
