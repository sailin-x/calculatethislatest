import { equipment_financing_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: equipment_financing_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
