import { equipment_financing_calculatorCalculatorInputs, equipment_financing_calculatorCalculatorMetrics, equipment_financing_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: equipment_financing_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: equipment_financing_calculatorCalculatorInputs, metrics: equipment_financing_calculatorCalculatorMetrics): equipment_financing_calculatorCalculatorAnalysis {
