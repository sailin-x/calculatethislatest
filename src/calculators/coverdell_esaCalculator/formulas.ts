import { coverdell_esaCalculatorInputs, coverdell_esaCalculatorMetrics, coverdell_esaCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: coverdell_esaCalculatorInputs): number {
...
export function generateAnalysis(inputs: coverdell_esaCalculatorInputs, metrics: coverdell_esaCalculatorMetrics): coverdell_esaCalculatorAnalysis {
