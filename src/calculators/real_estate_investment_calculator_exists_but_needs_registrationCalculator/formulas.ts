import { real_estate_investment_calculator_exists_but_needs_registrationCalculatorInputs, real_estate_investment_calculator_exists_but_needs_registrationCalculatorMetrics, real_estate_investment_calculator_exists_but_needs_registrationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: real_estate_investment_calculator_exists_but_needs_registrationCalculatorInputs): number {
...
export function generateAnalysis(inputs: real_estate_investment_calculator_exists_but_needs_registrationCalculatorInputs, metrics: real_estate_investment_calculator_exists_but_needs_registrationCalculatorMetrics): real_estate_investment_calculator_exists_but_needs_registrationCalculatorAnalysis {
