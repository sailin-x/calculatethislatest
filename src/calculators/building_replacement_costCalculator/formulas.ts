import { building_replacement_costCalculatorInputs, building_replacement_costCalculatorMetrics, building_replacement_costCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: building_replacement_costCalculatorInputs): number {
...
export function generateAnalysis(inputs: building_replacement_costCalculatorInputs, metrics: building_replacement_costCalculatorMetrics): building_replacement_costCalculatorAnalysis {
