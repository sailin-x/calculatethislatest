import { building_replacement_costCalculatorInputs } from './types';

export function validateInputs(inputs: building_replacement_costCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
