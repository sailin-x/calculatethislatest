import { seed_starting_calculatorInputs, seed_starting_calculatorMetrics, seed_starting_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: seed_starting_calculatorInputs): number {
...
export function generateAnalysis(inputs: seed_starting_calculatorInputs, metrics: seed_starting_calculatorMetrics): seed_starting_calculatorAnalysis {
