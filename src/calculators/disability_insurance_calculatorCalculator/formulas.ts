import { disability_insurance_calculatorCalculatorInputs, disability_insurance_calculatorCalculatorMetrics, disability_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: disability_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: disability_insurance_calculatorCalculatorInputs, metrics: disability_insurance_calculatorCalculatorMetrics): disability_insurance_calculatorCalculatorAnalysis {
