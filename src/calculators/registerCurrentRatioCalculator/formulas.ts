import { registerCurrentRatioCalculatorInputs, registerCurrentRatioCalculatorMetrics, registerCurrentRatioCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerCurrentRatioCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerCurrentRatioCalculatorInputs, metrics: registerCurrentRatioCalculatorMetrics): registerCurrentRatioCalculatorAnalysis {
