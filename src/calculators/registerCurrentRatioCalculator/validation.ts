import { registerCurrentRatioCalculatorInputs } from './types';

export function validateInputs(inputs: registerCurrentRatioCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
