import { nft_royalty_calculatorInputs, nft_royalty_calculatorMetrics, nft_royalty_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: nft_royalty_calculatorInputs): number {
...
export function generateAnalysis(inputs: nft_royalty_calculatorInputs, metrics: nft_royalty_calculatorMetrics): nft_royalty_calculatorAnalysis {
