import { siding_calculatorCalculatorInputs, siding_calculatorCalculatorMetrics, siding_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: siding_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: siding_calculatorCalculatorInputs, metrics: siding_calculatorCalculatorMetrics): siding_calculatorCalculatorAnalysis {
