import { siding_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: siding_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
