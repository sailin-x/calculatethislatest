import { nft_royaltyCalculatorInputs, nft_royaltyCalculatorMetrics, nft_royaltyCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: nft_royaltyCalculatorInputs): number {
...
export function generateAnalysis(inputs: nft_royaltyCalculatorInputs, metrics: nft_royaltyCalculatorMetrics): nft_royaltyCalculatorAnalysis {
