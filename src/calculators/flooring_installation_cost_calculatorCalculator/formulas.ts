import { flooring_installation_cost_calculatorCalculatorInputs, flooring_installation_cost_calculatorCalculatorMetrics, flooring_installation_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: flooring_installation_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: flooring_installation_cost_calculatorCalculatorInputs, metrics: flooring_installation_cost_calculatorCalculatorMetrics): flooring_installation_cost_calculatorCalculatorAnalysis {
