import { grantor_retained_annuity_trust_grat_calculatorInputs, grantor_retained_annuity_trust_grat_calculatorMetrics, grantor_retained_annuity_trust_grat_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: grantor_retained_annuity_trust_grat_calculatorInputs): number {
...
export function generateAnalysis(inputs: grantor_retained_annuity_trust_grat_calculatorInputs, metrics: grantor_retained_annuity_trust_grat_calculatorMetrics): grantor_retained_annuity_trust_grat_calculatorAnalysis {
