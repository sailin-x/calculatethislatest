import { construction_accident_claims_calculatorInputs, construction_accident_claims_calculatorMetrics, construction_accident_claims_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: construction_accident_claims_calculatorInputs): number {
...
export function generateAnalysis(inputs: construction_accident_claims_calculatorInputs, metrics: construction_accident_claims_calculatorMetrics): construction_accident_claims_calculatorAnalysis {
