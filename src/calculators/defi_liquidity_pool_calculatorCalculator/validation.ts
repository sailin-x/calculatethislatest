import { defi_liquidity_pool_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: defi_liquidity_pool_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
