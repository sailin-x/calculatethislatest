import { defi_liquidity_pool_calculatorCalculatorInputs, defi_liquidity_pool_calculatorCalculatorMetrics, defi_liquidity_pool_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: defi_liquidity_pool_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: defi_liquidity_pool_calculatorCalculatorInputs, metrics: defi_liquidity_pool_calculatorCalculatorMetrics): defi_liquidity_pool_calculatorCalculatorAnalysis {
