import { dogecoin_mining_calculatorCalculatorInputs, dogecoin_mining_calculatorCalculatorMetrics, dogecoin_mining_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: dogecoin_mining_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: dogecoin_mining_calculatorCalculatorInputs, metrics: dogecoin_mining_calculatorCalculatorMetrics): dogecoin_mining_calculatorCalculatorAnalysis {
