import { dogecoin_mining_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: dogecoin_mining_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
