import { biology_calculatorInputs, biology_calculatorMetrics, biology_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: biology_calculatorInputs): number {
...
export function generateAnalysis(inputs: biology_calculatorInputs, metrics: biology_calculatorMetrics): biology_calculatorAnalysis {
