import { escrow_analysisCalculatorInputs, escrow_analysisCalculatorMetrics, escrow_analysisCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: escrow_analysisCalculatorInputs): number {
...
export function generateAnalysis(inputs: escrow_analysisCalculatorInputs, metrics: escrow_analysisCalculatorMetrics): escrow_analysisCalculatorAnalysis {
