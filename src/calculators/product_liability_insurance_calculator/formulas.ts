import { product_liability_insurance_calculatorInputs, product_liability_insurance_calculatorMetrics, product_liability_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: product_liability_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: product_liability_insurance_calculatorInputs, metrics: product_liability_insurance_calculatorMetrics): product_liability_insurance_calculatorAnalysis {
