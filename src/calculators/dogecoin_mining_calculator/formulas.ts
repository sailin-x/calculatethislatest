import { dogecoin_mining_calculatorInputs, dogecoin_mining_calculatorMetrics, dogecoin_mining_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: dogecoin_mining_calculatorInputs): number {
...
export function generateAnalysis(inputs: dogecoin_mining_calculatorInputs, metrics: dogecoin_mining_calculatorMetrics): dogecoin_mining_calculatorAnalysis {
