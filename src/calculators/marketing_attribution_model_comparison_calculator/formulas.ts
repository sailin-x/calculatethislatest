import { marketing_attribution_model_comparison_calculatorInputs, marketing_attribution_model_comparison_calculatorMetrics, marketing_attribution_model_comparison_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: marketing_attribution_model_comparison_calculatorInputs): number {
...
export function generateAnalysis(inputs: marketing_attribution_model_comparison_calculatorInputs, metrics: marketing_attribution_model_comparison_calculatorMetrics): marketing_attribution_model_comparison_calculatorAnalysis {
