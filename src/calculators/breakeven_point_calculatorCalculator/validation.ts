import { breakeven_point_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: breakeven_point_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
