import { breakeven_point_calculatorCalculatorInputs, breakeven_point_calculatorCalculatorMetrics, breakeven_point_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: breakeven_point_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: breakeven_point_calculatorCalculatorInputs, metrics: breakeven_point_calculatorCalculatorMetrics): breakeven_point_calculatorCalculatorAnalysis {
