import { class_action_settlement_calculatorInputs, class_action_settlement_calculatorMetrics, class_action_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: class_action_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: class_action_settlement_calculatorInputs, metrics: class_action_settlement_calculatorMetrics): class_action_settlement_calculatorAnalysis {
