import { life_insurance_calculatorCalculatorInputs, life_insurance_calculatorCalculatorMetrics, life_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: life_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: life_insurance_calculatorCalculatorInputs, metrics: life_insurance_calculatorCalculatorMetrics): life_insurance_calculatorCalculatorAnalysis {
