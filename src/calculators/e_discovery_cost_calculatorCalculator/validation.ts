import { e_discovery_cost_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: e_discovery_cost_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
