import { e_discovery_cost_calculatorCalculatorInputs, e_discovery_cost_calculatorCalculatorMetrics, e_discovery_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: e_discovery_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: e_discovery_cost_calculatorCalculatorInputs, metrics: e_discovery_cost_calculatorCalculatorMetrics): e_discovery_cost_calculatorCalculatorAnalysis {
