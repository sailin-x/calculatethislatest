import { real_estate_investment_calculatorInputs, real_estate_investment_calculatorMetrics, real_estate_investment_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: real_estate_investment_calculatorInputs): number {
...
export function generateAnalysis(inputs: real_estate_investment_calculatorInputs, metrics: real_estate_investment_calculatorMetrics): real_estate_investment_calculatorAnalysis {
