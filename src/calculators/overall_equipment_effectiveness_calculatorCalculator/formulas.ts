import { overall_equipment_effectiveness_calculatorCalculatorInputs, overall_equipment_effectiveness_calculatorCalculatorMetrics, overall_equipment_effectiveness_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: overall_equipment_effectiveness_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: overall_equipment_effectiveness_calculatorCalculatorInputs, metrics: overall_equipment_effectiveness_calculatorCalculatorMetrics): overall_equipment_effectiveness_calculatorCalculatorAnalysis {
