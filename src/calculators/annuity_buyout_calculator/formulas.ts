import { annuity_buyout_calculatorInputs, annuity_buyout_calculatorMetrics, annuity_buyout_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: annuity_buyout_calculatorInputs): number {
...
export function generateAnalysis(inputs: annuity_buyout_calculatorInputs, metrics: annuity_buyout_calculatorMetrics): annuity_buyout_calculatorAnalysis {
