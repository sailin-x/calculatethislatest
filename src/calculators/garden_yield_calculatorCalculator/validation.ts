import { garden_yield_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: garden_yield_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
