import { garden_yield_calculatorCalculatorInputs, garden_yield_calculatorCalculatorMetrics, garden_yield_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: garden_yield_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: garden_yield_calculatorCalculatorInputs, metrics: garden_yield_calculatorCalculatorMetrics): garden_yield_calculatorCalculatorAnalysis {
