import { museum_admission_cost_calculatorCalculatorInputs, museum_admission_cost_calculatorCalculatorMetrics, museum_admission_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: museum_admission_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: museum_admission_cost_calculatorCalculatorInputs, metrics: museum_admission_cost_calculatorCalculatorMetrics): museum_admission_cost_calculatorCalculatorAnalysis {
