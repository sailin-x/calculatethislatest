import { customer_segmentation_rfm_model_calculatorCalculatorInputs, customer_segmentation_rfm_model_calculatorCalculatorMetrics, customer_segmentation_rfm_model_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: customer_segmentation_rfm_model_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: customer_segmentation_rfm_model_calculatorCalculatorInputs, metrics: customer_segmentation_rfm_model_calculatorCalculatorMetrics): customer_segmentation_rfm_model_calculatorCalculatorAnalysis {
