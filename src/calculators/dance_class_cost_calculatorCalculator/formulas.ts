import { dance_class_cost_calculatorCalculatorInputs, dance_class_cost_calculatorCalculatorMetrics, dance_class_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: dance_class_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: dance_class_cost_calculatorCalculatorInputs, metrics: dance_class_cost_calculatorCalculatorMetrics): dance_class_cost_calculatorCalculatorAnalysis {
