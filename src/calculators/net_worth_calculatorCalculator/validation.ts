import { net_worth_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: net_worth_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
