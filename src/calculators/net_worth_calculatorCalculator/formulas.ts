import { net_worth_calculatorCalculatorInputs, net_worth_calculatorCalculatorMetrics, net_worth_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: net_worth_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: net_worth_calculatorCalculatorInputs, metrics: net_worth_calculatorCalculatorMetrics): net_worth_calculatorCalculatorAnalysis {
