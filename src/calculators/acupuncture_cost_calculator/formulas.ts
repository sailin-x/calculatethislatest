import { acupuncture_cost_calculatorInputs, acupuncture_cost_calculatorMetrics, acupuncture_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: acupuncture_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: acupuncture_cost_calculatorInputs, metrics: acupuncture_cost_calculatorMetrics): acupuncture_cost_calculatorAnalysis {
