import { scientific_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: scientific_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
