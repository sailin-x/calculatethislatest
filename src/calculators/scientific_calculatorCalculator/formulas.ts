import { scientific_calculatorCalculatorInputs, scientific_calculatorCalculatorMetrics, scientific_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: scientific_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: scientific_calculatorCalculatorInputs, metrics: scientific_calculatorCalculatorMetrics): scientific_calculatorCalculatorAnalysis {
