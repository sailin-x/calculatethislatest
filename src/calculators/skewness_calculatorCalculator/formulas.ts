import { skewness_calculatorCalculatorInputs, skewness_calculatorCalculatorMetrics, skewness_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: skewness_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: skewness_calculatorCalculatorInputs, metrics: skewness_calculatorCalculatorMetrics): skewness_calculatorCalculatorAnalysis {
