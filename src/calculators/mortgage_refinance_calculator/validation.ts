import { mortgage_refinance_calculatorInputs } from './types';

export function validateInputs(inputs: mortgage_refinance_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
