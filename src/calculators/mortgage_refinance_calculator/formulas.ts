import { mortgage_refinance_calculatorInputs, mortgage_refinance_calculatorMetrics, mortgage_refinance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgage_refinance_calculatorInputs): number {
...
export function generateAnalysis(inputs: mortgage_refinance_calculatorInputs, metrics: mortgage_refinance_calculatorMetrics): mortgage_refinance_calculatorAnalysis {
