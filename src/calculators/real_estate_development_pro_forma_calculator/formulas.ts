import { real_estate_development_pro_forma_calculatorInputs, real_estate_development_pro_forma_calculatorMetrics, real_estate_development_pro_forma_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: real_estate_development_pro_forma_calculatorInputs): number {
...
export function generateAnalysis(inputs: real_estate_development_pro_forma_calculatorInputs, metrics: real_estate_development_pro_forma_calculatorMetrics): real_estate_development_pro_forma_calculatorAnalysis {
