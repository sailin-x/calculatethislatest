import { general_liability_insurance_calculatorInputs, general_liability_insurance_calculatorMetrics, general_liability_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: general_liability_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: general_liability_insurance_calculatorInputs, metrics: general_liability_insurance_calculatorMetrics): general_liability_insurance_calculatorAnalysis {
