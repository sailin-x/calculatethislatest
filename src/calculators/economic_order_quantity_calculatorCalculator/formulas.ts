import { economic_order_quantity_calculatorCalculatorInputs, economic_order_quantity_calculatorCalculatorMetrics, economic_order_quantity_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: economic_order_quantity_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: economic_order_quantity_calculatorCalculatorInputs, metrics: economic_order_quantity_calculatorCalculatorMetrics): economic_order_quantity_calculatorCalculatorAnalysis {
