import { marine_cargo_insurance_calculatorInputs } from './types';

export function validateInputs(inputs: marine_cargo_insurance_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
