import { marine_cargo_insurance_calculatorInputs, marine_cargo_insurance_calculatorMetrics, marine_cargo_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: marine_cargo_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: marine_cargo_insurance_calculatorInputs, metrics: marine_cargo_insurance_calculatorMetrics): marine_cargo_insurance_calculatorAnalysis {
