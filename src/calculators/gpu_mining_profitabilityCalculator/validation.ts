import { gpu_mining_profitabilityCalculatorInputs } from './types';

export function validateInputs(inputs: gpu_mining_profitabilityCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
