import { gpu_mining_profitabilityCalculatorInputs, gpu_mining_profitabilityCalculatorMetrics, gpu_mining_profitabilityCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: gpu_mining_profitabilityCalculatorInputs): number {
...
export function generateAnalysis(inputs: gpu_mining_profitabilityCalculatorInputs, metrics: gpu_mining_profitabilityCalculatorMetrics): gpu_mining_profitabilityCalculatorAnalysis {
