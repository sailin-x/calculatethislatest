import { scientificCalculatorInputs, scientificCalculatorMetrics, scientificCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: scientificCalculatorInputs): number {
...
export function generateAnalysis(inputs: scientificCalculatorInputs, metrics: scientificCalculatorMetrics): scientificCalculatorAnalysis {
