import { registerDebtConsolidationCalculatorInputs, registerDebtConsolidationCalculatorMetrics, registerDebtConsolidationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerDebtConsolidationCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerDebtConsolidationCalculatorInputs, metrics: registerDebtConsolidationCalculatorMetrics): registerDebtConsolidationCalculatorAnalysis {
