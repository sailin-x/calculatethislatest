import { registerDebtConsolidationCalculatorInputs } from './types';

export function validateInputs(inputs: registerDebtConsolidationCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
