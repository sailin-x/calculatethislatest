import { music_festival_profit_loss_p_l_calculatorCalculatorInputs, music_festival_profit_loss_p_l_calculatorCalculatorMetrics, music_festival_profit_loss_p_l_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: music_festival_profit_loss_p_l_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: music_festival_profit_loss_p_l_calculatorCalculatorInputs, metrics: music_festival_profit_loss_p_l_calculatorCalculatorMetrics): music_festival_profit_loss_p_l_calculatorCalculatorAnalysis {
