import { basal_metabolic_rate_bmr_calculatorCalculatorInputs, basal_metabolic_rate_bmr_calculatorCalculatorMetrics, basal_metabolic_rate_bmr_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: basal_metabolic_rate_bmr_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: basal_metabolic_rate_bmr_calculatorCalculatorInputs, metrics: basal_metabolic_rate_bmr_calculatorCalculatorMetrics): basal_metabolic_rate_bmr_calculatorCalculatorAnalysis {
