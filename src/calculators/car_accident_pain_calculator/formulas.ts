import { car_accident_pain_calculatorInputs, car_accident_pain_calculatorMetrics, car_accident_pain_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: car_accident_pain_calculatorInputs): number {
...
export function generateAnalysis(inputs: car_accident_pain_calculatorInputs, metrics: car_accident_pain_calculatorMetrics): car_accident_pain_calculatorAnalysis {
