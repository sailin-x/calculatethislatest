import { car_accident_pain_calculatorInputs } from './types';

export function validateInputs(inputs: car_accident_pain_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
