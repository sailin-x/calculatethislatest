import { generation_skipping_transfer_gst_tax_calculatorInputs, generation_skipping_transfer_gst_tax_calculatorMetrics, generation_skipping_transfer_gst_tax_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: generation_skipping_transfer_gst_tax_calculatorInputs): number {
...
export function generateAnalysis(inputs: generation_skipping_transfer_gst_tax_calculatorInputs, metrics: generation_skipping_transfer_gst_tax_calculatorMetrics): generation_skipping_transfer_gst_tax_calculatorAnalysis {
