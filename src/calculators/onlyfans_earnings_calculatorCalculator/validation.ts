import { onlyfans_earnings_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: onlyfans_earnings_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
