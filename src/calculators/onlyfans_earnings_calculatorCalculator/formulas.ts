import { onlyfans_earnings_calculatorCalculatorInputs, onlyfans_earnings_calculatorCalculatorMetrics, onlyfans_earnings_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: onlyfans_earnings_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: onlyfans_earnings_calculatorCalculatorInputs, metrics: onlyfans_earnings_calculatorCalculatorMetrics): onlyfans_earnings_calculatorCalculatorAnalysis {
