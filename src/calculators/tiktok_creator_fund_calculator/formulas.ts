import { tiktok_creator_fund_calculatorInputs, tiktok_creator_fund_calculatorMetrics, tiktok_creator_fund_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: tiktok_creator_fund_calculatorInputs): number {
...
export function generateAnalysis(inputs: tiktok_creator_fund_calculatorInputs, metrics: tiktok_creator_fund_calculatorMetrics): tiktok_creator_fund_calculatorAnalysis {
