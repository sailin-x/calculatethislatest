import { fix_and_flipCalculatorInputs, fix_and_flipCalculatorMetrics, fix_and_flipCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fix_and_flipCalculatorInputs): number {
...
export function generateAnalysis(inputs: fix_and_flipCalculatorInputs, metrics: fix_and_flipCalculatorMetrics): fix_and_flipCalculatorAnalysis {
