import { api_monetization_calculatorInputs } from './types';

export function validateInputs(inputs: api_monetization_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
