import { media_mix_modeling_calculatorCalculatorInputs, media_mix_modeling_calculatorCalculatorMetrics, media_mix_modeling_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: media_mix_modeling_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: media_mix_modeling_calculatorCalculatorInputs, metrics: media_mix_modeling_calculatorCalculatorMetrics): media_mix_modeling_calculatorCalculatorAnalysis {
