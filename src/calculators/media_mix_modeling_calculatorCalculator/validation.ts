import { media_mix_modeling_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: media_mix_modeling_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
