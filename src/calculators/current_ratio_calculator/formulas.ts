import { current_ratio_calculatorInputs, current_ratio_calculatorMetrics, current_ratio_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: current_ratio_calculatorInputs): number {
...
export function generateAnalysis(inputs: current_ratio_calculatorInputs, metrics: current_ratio_calculatorMetrics): current_ratio_calculatorAnalysis {
