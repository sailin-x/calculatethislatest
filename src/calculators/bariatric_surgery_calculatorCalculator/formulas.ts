import { bariatric_surgery_calculatorCalculatorInputs, bariatric_surgery_calculatorCalculatorMetrics, bariatric_surgery_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: bariatric_surgery_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: bariatric_surgery_calculatorCalculatorInputs, metrics: bariatric_surgery_calculatorCalculatorMetrics): bariatric_surgery_calculatorCalculatorAnalysis {
