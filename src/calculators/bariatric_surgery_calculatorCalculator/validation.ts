import { bariatric_surgery_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: bariatric_surgery_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
