import { insulation_calculatorInputs, insulation_calculatorMetrics, insulation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: insulation_calculatorInputs): number {
...
export function generateAnalysis(inputs: insulation_calculatorInputs, metrics: insulation_calculatorMetrics): insulation_calculatorAnalysis {
