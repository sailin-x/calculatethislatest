import { peer_to_peer_lending_calculatorInputs, peer_to_peer_lending_calculatorMetrics, peer_to_peer_lending_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: peer_to_peer_lending_calculatorInputs): number {
...
export function generateAnalysis(inputs: peer_to_peer_lending_calculatorInputs, metrics: peer_to_peer_lending_calculatorMetrics): peer_to_peer_lending_calculatorAnalysis {
