import { bariatric_surgery_calculatorInputs, bariatric_surgery_calculatorMetrics, bariatric_surgery_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: bariatric_surgery_calculatorInputs): number {
...
export function generateAnalysis(inputs: bariatric_surgery_calculatorInputs, metrics: bariatric_surgery_calculatorMetrics): bariatric_surgery_calculatorAnalysis {
