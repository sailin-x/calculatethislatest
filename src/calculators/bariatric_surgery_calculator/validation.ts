import { bariatric_surgery_calculatorInputs } from './types';

export function validateInputs(inputs: bariatric_surgery_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
