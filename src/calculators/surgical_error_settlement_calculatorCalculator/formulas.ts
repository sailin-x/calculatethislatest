import { surgical_error_settlement_calculatorCalculatorInputs, surgical_error_settlement_calculatorCalculatorMetrics, surgical_error_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: surgical_error_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: surgical_error_settlement_calculatorCalculatorInputs, metrics: surgical_error_settlement_calculatorCalculatorMetrics): surgical_error_settlement_calculatorCalculatorAnalysis {
