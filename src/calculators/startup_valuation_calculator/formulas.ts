import { startup_valuation_calculatorInputs, startup_valuation_calculatorMetrics, startup_valuation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: startup_valuation_calculatorInputs): number {
...
export function generateAnalysis(inputs: startup_valuation_calculatorInputs, metrics: startup_valuation_calculatorMetrics): startup_valuation_calculatorAnalysis {
