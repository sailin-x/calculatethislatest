import { structured_settlement_payout_calculatorCalculatorInputs, structured_settlement_payout_calculatorCalculatorMetrics, structured_settlement_payout_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: structured_settlement_payout_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: structured_settlement_payout_calculatorCalculatorInputs, metrics: structured_settlement_payout_calculatorCalculatorMetrics): structured_settlement_payout_calculatorCalculatorAnalysis {
