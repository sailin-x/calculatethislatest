import { fixed_index_annuity_calculatorInputs } from './types';

export function validateInputs(inputs: fixed_index_annuity_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
