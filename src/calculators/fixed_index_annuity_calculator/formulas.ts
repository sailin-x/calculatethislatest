import { fixed_index_annuity_calculatorInputs, fixed_index_annuity_calculatorMetrics, fixed_index_annuity_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fixed_index_annuity_calculatorInputs): number {
...
export function generateAnalysis(inputs: fixed_index_annuity_calculatorInputs, metrics: fixed_index_annuity_calculatorMetrics): fixed_index_annuity_calculatorAnalysis {
