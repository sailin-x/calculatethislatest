import { fraction_calculatorCalculatorInputs, fraction_calculatorCalculatorMetrics, fraction_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fraction_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: fraction_calculatorCalculatorInputs, metrics: fraction_calculatorCalculatorMetrics): fraction_calculatorCalculatorAnalysis {
