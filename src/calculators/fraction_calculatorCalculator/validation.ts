import { fraction_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: fraction_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
