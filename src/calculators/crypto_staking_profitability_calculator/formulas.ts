import { crypto_staking_profitability_calculatorInputs, crypto_staking_profitability_calculatorMetrics, crypto_staking_profitability_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: crypto_staking_profitability_calculatorInputs): number {
...
export function generateAnalysis(inputs: crypto_staking_profitability_calculatorInputs, metrics: crypto_staking_profitability_calculatorMetrics): crypto_staking_profitability_calculatorAnalysis {
