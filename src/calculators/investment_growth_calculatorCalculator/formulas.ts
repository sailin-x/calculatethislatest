import { investment_growth_calculatorCalculatorInputs, investment_growth_calculatorCalculatorMetrics, investment_growth_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: investment_growth_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: investment_growth_calculatorCalculatorInputs, metrics: investment_growth_calculatorCalculatorMetrics): investment_growth_calculatorCalculatorAnalysis {
