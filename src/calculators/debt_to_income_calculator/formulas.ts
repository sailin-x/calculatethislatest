import { debt_to_income_calculatorInputs, debt_to_income_calculatorMetrics, debt_to_income_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_to_income_calculatorInputs): number {
...
export function generateAnalysis(inputs: debt_to_income_calculatorInputs, metrics: debt_to_income_calculatorMetrics): debt_to_income_calculatorAnalysis {
