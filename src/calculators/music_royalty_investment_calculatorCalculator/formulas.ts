import { music_royalty_investment_calculatorCalculatorInputs, music_royalty_investment_calculatorCalculatorMetrics, music_royalty_investment_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: music_royalty_investment_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: music_royalty_investment_calculatorCalculatorInputs, metrics: music_royalty_investment_calculatorCalculatorMetrics): music_royalty_investment_calculatorCalculatorAnalysis {
