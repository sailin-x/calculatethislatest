import { marine_cargo_insurance_premium_calculatorCalculatorInputs, marine_cargo_insurance_premium_calculatorCalculatorMetrics, marine_cargo_insurance_premium_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: marine_cargo_insurance_premium_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: marine_cargo_insurance_premium_calculatorCalculatorInputs, metrics: marine_cargo_insurance_premium_calculatorCalculatorMetrics): marine_cargo_insurance_premium_calculatorCalculatorAnalysis {
