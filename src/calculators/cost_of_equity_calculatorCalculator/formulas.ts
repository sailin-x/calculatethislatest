import { cost_of_equity_calculatorCalculatorInputs, cost_of_equity_calculatorCalculatorMetrics, cost_of_equity_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cost_of_equity_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cost_of_equity_calculatorCalculatorInputs, metrics: cost_of_equity_calculatorCalculatorMetrics): cost_of_equity_calculatorCalculatorAnalysis {
