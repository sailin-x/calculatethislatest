import { cost_of_equity_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: cost_of_equity_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
