import { netUnrealizedAppreciationNUATaxCalculatorInputs, netUnrealizedAppreciationNUATaxCalculatorMetrics, netUnrealizedAppreciationNUATaxCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: netUnrealizedAppreciationNUATaxCalculatorInputs): number {
...
export function generateAnalysis(inputs: netUnrealizedAppreciationNUATaxCalculatorInputs, metrics: netUnrealizedAppreciationNUATaxCalculatorMetrics): netUnrealizedAppreciationNUATaxCalculatorAnalysis {
