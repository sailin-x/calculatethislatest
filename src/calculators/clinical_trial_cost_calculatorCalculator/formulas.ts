import { clinical_trial_cost_calculatorCalculatorInputs, clinical_trial_cost_calculatorCalculatorMetrics, clinical_trial_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: clinical_trial_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: clinical_trial_cost_calculatorCalculatorInputs, metrics: clinical_trial_cost_calculatorCalculatorMetrics): clinical_trial_cost_calculatorCalculatorAnalysis {
