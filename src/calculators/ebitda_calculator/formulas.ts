import { ebitda_calculatorInputs, ebitda_calculatorMetrics, ebitda_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ebitda_calculatorInputs): number {
...
export function generateAnalysis(inputs: ebitda_calculatorInputs, metrics: ebitda_calculatorMetrics): ebitda_calculatorAnalysis {
