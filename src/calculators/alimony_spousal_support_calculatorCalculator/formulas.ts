import { alimony_spousal_support_calculatorCalculatorInputs, alimony_spousal_support_calculatorCalculatorMetrics, alimony_spousal_support_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: alimony_spousal_support_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: alimony_spousal_support_calculatorCalculatorInputs, metrics: alimony_spousal_support_calculatorCalculatorMetrics): alimony_spousal_support_calculatorCalculatorAnalysis {
