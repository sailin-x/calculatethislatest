import { financial_risk_calculatorInputs, financial_risk_calculatorMetrics, financial_risk_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_risk_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_risk_calculatorInputs, metrics: financial_risk_calculatorMetrics): financial_risk_calculatorAnalysis {
