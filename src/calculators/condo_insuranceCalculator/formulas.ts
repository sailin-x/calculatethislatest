import { condo_insuranceCalculatorInputs, condo_insuranceCalculatorMetrics, condo_insuranceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: condo_insuranceCalculatorInputs): number {
...
export function generateAnalysis(inputs: condo_insuranceCalculatorInputs, metrics: condo_insuranceCalculatorMetrics): condo_insuranceCalculatorAnalysis {
