import { credit_card_calculatorInputs, credit_card_calculatorMetrics, credit_card_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: credit_card_calculatorInputs): number {
...
export function generateAnalysis(inputs: credit_card_calculatorInputs, metrics: credit_card_calculatorMetrics): credit_card_calculatorAnalysis {
