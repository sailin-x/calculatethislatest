import { pest_control_cost_calculatorCalculatorInputs, pest_control_cost_calculatorCalculatorMetrics, pest_control_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: pest_control_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: pest_control_cost_calculatorCalculatorInputs, metrics: pest_control_cost_calculatorCalculatorMetrics): pest_control_cost_calculatorCalculatorAnalysis {
