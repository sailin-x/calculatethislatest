import { debt_payoff_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: debt_payoff_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
