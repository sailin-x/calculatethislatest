import { debt_payoff_calculatorCalculatorInputs, debt_payoff_calculatorCalculatorMetrics, debt_payoff_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_payoff_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: debt_payoff_calculatorCalculatorInputs, metrics: debt_payoff_calculatorCalculatorMetrics): debt_payoff_calculatorCalculatorAnalysis {
