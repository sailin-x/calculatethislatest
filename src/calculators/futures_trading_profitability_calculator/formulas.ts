import { futures_trading_profitability_calculatorInputs, futures_trading_profitability_calculatorMetrics, futures_trading_profitability_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: futures_trading_profitability_calculatorInputs): number {
...
export function generateAnalysis(inputs: futures_trading_profitability_calculatorInputs, metrics: futures_trading_profitability_calculatorMetrics): futures_trading_profitability_calculatorAnalysis {
