import { employment_practices_calculatorCalculatorInputs, employment_practices_calculatorCalculatorMetrics, employment_practices_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: employment_practices_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: employment_practices_calculatorCalculatorInputs, metrics: employment_practices_calculatorCalculatorMetrics): employment_practices_calculatorCalculatorAnalysis {
