import { employment_practices_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: employment_practices_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
