import { iso_9001_certification_roi_calculatorCalculatorInputs, iso_9001_certification_roi_calculatorCalculatorMetrics, iso_9001_certification_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: iso_9001_certification_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: iso_9001_certification_roi_calculatorCalculatorInputs, metrics: iso_9001_certification_roi_calculatorCalculatorMetrics): iso_9001_certification_roi_calculatorCalculatorAnalysis {
