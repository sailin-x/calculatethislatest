import { hsa_triple_tax_advantage_calculatorInputs, hsa_triple_tax_advantage_calculatorMetrics, hsa_triple_tax_advantage_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: hsa_triple_tax_advantage_calculatorInputs): number {
...
export function generateAnalysis(inputs: hsa_triple_tax_advantage_calculatorInputs, metrics: hsa_triple_tax_advantage_calculatorMetrics): hsa_triple_tax_advantage_calculatorAnalysis {
