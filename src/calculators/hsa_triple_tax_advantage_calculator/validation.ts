import { hsa_triple_tax_advantage_calculatorInputs } from './types';

export function validateInputs(inputs: hsa_triple_tax_advantage_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
