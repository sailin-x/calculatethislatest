import { preference_payment_clawback_calculatorCalculatorInputs, preference_payment_clawback_calculatorCalculatorMetrics, preference_payment_clawback_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: preference_payment_clawback_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: preference_payment_clawback_calculatorCalculatorInputs, metrics: preference_payment_clawback_calculatorCalculatorMetrics): preference_payment_clawback_calculatorCalculatorAnalysis {
