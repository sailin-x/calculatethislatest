import { nft_royalty_revenue_calculatorCalculatorInputs, nft_royalty_revenue_calculatorCalculatorMetrics, nft_royalty_revenue_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: nft_royalty_revenue_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: nft_royalty_revenue_calculatorCalculatorInputs, metrics: nft_royalty_revenue_calculatorCalculatorMetrics): nft_royalty_revenue_calculatorCalculatorAnalysis {
