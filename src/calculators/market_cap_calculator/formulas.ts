import { market_cap_calculatorInputs, market_cap_calculatorMetrics, market_cap_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: market_cap_calculatorInputs): number {
...
export function generateAnalysis(inputs: market_cap_calculatorInputs, metrics: market_cap_calculatorMetrics): market_cap_calculatorAnalysis {
