import { budget_optimization_calculatorCalculatorInputs, budget_optimization_calculatorCalculatorMetrics, budget_optimization_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: budget_optimization_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: budget_optimization_calculatorCalculatorInputs, metrics: budget_optimization_calculatorCalculatorMetrics): budget_optimization_calculatorCalculatorAnalysis {
