import { budget_optimization_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: budget_optimization_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
