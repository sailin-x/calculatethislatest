import { operating_margin_calculatorCalculatorInputs, operating_margin_calculatorCalculatorMetrics, operating_margin_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: operating_margin_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: operating_margin_calculatorCalculatorInputs, metrics: operating_margin_calculatorCalculatorMetrics): operating_margin_calculatorCalculatorAnalysis {
