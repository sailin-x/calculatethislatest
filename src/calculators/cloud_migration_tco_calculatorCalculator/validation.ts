import { cloud_migration_tco_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: cloud_migration_tco_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
