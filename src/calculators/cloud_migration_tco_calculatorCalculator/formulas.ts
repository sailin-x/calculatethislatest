import { cloud_migration_tco_calculatorCalculatorInputs, cloud_migration_tco_calculatorCalculatorMetrics, cloud_migration_tco_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cloud_migration_tco_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cloud_migration_tco_calculatorCalculatorInputs, metrics: cloud_migration_tco_calculatorCalculatorMetrics): cloud_migration_tco_calculatorCalculatorAnalysis {
