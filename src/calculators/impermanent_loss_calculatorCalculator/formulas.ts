import { impermanent_loss_calculatorCalculatorInputs, impermanent_loss_calculatorCalculatorMetrics, impermanent_loss_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: impermanent_loss_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: impermanent_loss_calculatorCalculatorInputs, metrics: impermanent_loss_calculatorCalculatorMetrics): impermanent_loss_calculatorCalculatorAnalysis {
