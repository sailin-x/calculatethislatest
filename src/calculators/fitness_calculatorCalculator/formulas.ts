import { fitness_calculatorCalculatorInputs, fitness_calculatorCalculatorMetrics, fitness_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fitness_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: fitness_calculatorCalculatorInputs, metrics: fitness_calculatorCalculatorMetrics): fitness_calculatorCalculatorAnalysis {
