import { earthquake_insurance_calculatorInputs, earthquake_insurance_calculatorMetrics, earthquake_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: earthquake_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: earthquake_insurance_calculatorInputs, metrics: earthquake_insurance_calculatorMetrics): earthquake_insurance_calculatorAnalysis {
