import { earthquake_insurance_calculatorInputs } from './types';

export function validateInputs(inputs: earthquake_insurance_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
