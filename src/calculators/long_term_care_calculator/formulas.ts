import { long_term_care_calculatorInputs, long_term_care_calculatorMetrics, long_term_care_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: long_term_care_calculatorInputs): number {
...
export function generateAnalysis(inputs: long_term_care_calculatorInputs, metrics: long_term_care_calculatorMetrics): long_term_care_calculatorAnalysis {
