import { crossfit_gym_cost_calculatorInputs, crossfit_gym_cost_calculatorMetrics, crossfit_gym_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: crossfit_gym_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: crossfit_gym_cost_calculatorInputs, metrics: crossfit_gym_cost_calculatorMetrics): crossfit_gym_cost_calculatorAnalysis {
