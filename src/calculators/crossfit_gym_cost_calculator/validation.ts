import { crossfit_gym_cost_calculatorInputs } from './types';

export function validateInputs(inputs: crossfit_gym_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
