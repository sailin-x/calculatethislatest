import { glycemic_load_calculatorInputs, glycemic_load_calculatorMetrics, glycemic_load_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: glycemic_load_calculatorInputs): number {
...
export function generateAnalysis(inputs: glycemic_load_calculatorInputs, metrics: glycemic_load_calculatorMetrics): glycemic_load_calculatorAnalysis {
