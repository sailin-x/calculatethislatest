import { product_liability_insurance_calculatorCalculatorInputs, product_liability_insurance_calculatorCalculatorMetrics, product_liability_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: product_liability_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: product_liability_insurance_calculatorCalculatorInputs, metrics: product_liability_insurance_calculatorCalculatorMetrics): product_liability_insurance_calculatorCalculatorAnalysis {
