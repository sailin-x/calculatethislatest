import { blood_alcohol_calculatorCalculatorInputs, blood_alcohol_calculatorCalculatorMetrics, blood_alcohol_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: blood_alcohol_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: blood_alcohol_calculatorCalculatorInputs, metrics: blood_alcohol_calculatorCalculatorMetrics): blood_alcohol_calculatorCalculatorAnalysis {
