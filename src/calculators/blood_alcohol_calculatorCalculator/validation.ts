import { blood_alcohol_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: blood_alcohol_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
