import { blood_pressure_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: blood_pressure_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
