import { blood_pressure_calculatorCalculatorInputs, blood_pressure_calculatorCalculatorMetrics, blood_pressure_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: blood_pressure_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: blood_pressure_calculatorCalculatorInputs, metrics: blood_pressure_calculatorCalculatorMetrics): blood_pressure_calculatorCalculatorAnalysis {
