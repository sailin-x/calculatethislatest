import { guideline_premium_test_gpt_calculatorInputs, guideline_premium_test_gpt_calculatorMetrics, guideline_premium_test_gpt_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: guideline_premium_test_gpt_calculatorInputs): number {
...
export function generateAnalysis(inputs: guideline_premium_test_gpt_calculatorInputs, metrics: guideline_premium_test_gpt_calculatorMetrics): guideline_premium_test_gpt_calculatorAnalysis {
