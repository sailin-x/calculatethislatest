import { project_management_cost_calculatorCalculatorInputs, project_management_cost_calculatorCalculatorMetrics, project_management_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: project_management_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: project_management_cost_calculatorCalculatorInputs, metrics: project_management_cost_calculatorCalculatorMetrics): project_management_cost_calculatorCalculatorAnalysis {
