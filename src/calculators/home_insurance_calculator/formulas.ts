import { home_insurance_calculatorInputs, home_insurance_calculatorMetrics, home_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: home_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: home_insurance_calculatorInputs, metrics: home_insurance_calculatorMetrics): home_insurance_calculatorAnalysis {
