import { intellectual_property_licensing_calculatorInputs } from './types';

export function validateInputs(inputs: intellectual_property_licensing_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
