import { intellectual_property_licensing_calculatorInputs, intellectual_property_licensing_calculatorMetrics, intellectual_property_licensing_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: intellectual_property_licensing_calculatorInputs): number {
...
export function generateAnalysis(inputs: intellectual_property_licensing_calculatorInputs, metrics: intellectual_property_licensing_calculatorMetrics): intellectual_property_licensing_calculatorAnalysis {
