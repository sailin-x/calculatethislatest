import { sleep_calculatorInputs, sleep_calculatorMetrics, sleep_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: sleep_calculatorInputs): number {
...
export function generateAnalysis(inputs: sleep_calculatorInputs, metrics: sleep_calculatorMetrics): sleep_calculatorAnalysis {
