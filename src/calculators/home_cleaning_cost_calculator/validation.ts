import { home_cleaning_cost_calculatorInputs } from './types';

export function validateInputs(inputs: home_cleaning_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
