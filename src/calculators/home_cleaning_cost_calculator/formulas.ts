import { home_cleaning_cost_calculatorInputs, home_cleaning_cost_calculatorMetrics, home_cleaning_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: home_cleaning_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: home_cleaning_cost_calculatorInputs, metrics: home_cleaning_cost_calculatorMetrics): home_cleaning_cost_calculatorAnalysis {
