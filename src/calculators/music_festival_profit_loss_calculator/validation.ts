import { music_festival_profit_loss_calculatorInputs } from './types';

export function validateInputs(inputs: music_festival_profit_loss_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
