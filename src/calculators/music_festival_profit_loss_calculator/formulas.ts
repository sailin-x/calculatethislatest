import { music_festival_profit_loss_calculatorInputs, music_festival_profit_loss_calculatorMetrics, music_festival_profit_loss_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: music_festival_profit_loss_calculatorInputs): number {
...
export function generateAnalysis(inputs: music_festival_profit_loss_calculatorInputs, metrics: music_festival_profit_loss_calculatorMetrics): music_festival_profit_loss_calculatorAnalysis {
