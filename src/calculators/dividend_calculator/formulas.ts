import { dividend_calculatorInputs, dividend_calculatorMetrics, dividend_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: dividend_calculatorInputs): number {
...
export function generateAnalysis(inputs: dividend_calculatorInputs, metrics: dividend_calculatorMetrics): dividend_calculatorAnalysis {
