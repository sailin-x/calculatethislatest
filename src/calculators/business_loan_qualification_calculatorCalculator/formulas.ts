import { business_loan_qualification_calculatorCalculatorInputs, business_loan_qualification_calculatorCalculatorMetrics, business_loan_qualification_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_loan_qualification_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: business_loan_qualification_calculatorCalculatorInputs, metrics: business_loan_qualification_calculatorCalculatorMetrics): business_loan_qualification_calculatorCalculatorAnalysis {
