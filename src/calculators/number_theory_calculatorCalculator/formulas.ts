import { number_theory_calculatorCalculatorInputs, number_theory_calculatorCalculatorMetrics, number_theory_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: number_theory_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: number_theory_calculatorCalculatorInputs, metrics: number_theory_calculatorCalculatorMetrics): number_theory_calculatorCalculatorAnalysis {
