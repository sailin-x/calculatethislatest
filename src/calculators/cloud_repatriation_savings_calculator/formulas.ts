import { cloud_repatriation_savings_calculatorInputs, cloud_repatriation_savings_calculatorMetrics, cloud_repatriation_savings_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cloud_repatriation_savings_calculatorInputs): number {
...
export function generateAnalysis(inputs: cloud_repatriation_savings_calculatorInputs, metrics: cloud_repatriation_savings_calculatorMetrics): cloud_repatriation_savings_calculatorAnalysis {
