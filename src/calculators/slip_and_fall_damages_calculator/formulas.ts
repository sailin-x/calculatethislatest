import { slip_and_fall_damages_calculatorInputs, slip_and_fall_damages_calculatorMetrics, slip_and_fall_damages_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: slip_and_fall_damages_calculatorInputs): number {
...
export function generateAnalysis(inputs: slip_and_fall_damages_calculatorInputs, metrics: slip_and_fall_damages_calculatorMetrics): slip_and_fall_damages_calculatorAnalysis {
