...
export const drywall_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Drywall Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Drywall Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Drywall Calculator calculation',
