import { drywall-calculatorInputs, drywall-calculatorMetrics, drywall-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: drywall-calculatorInputs): number {
...
export function generateAnalysis(inputs: drywall-calculatorInputs, metrics: drywall-calculatorMetrics): drywall-calculatorAnalysis {
