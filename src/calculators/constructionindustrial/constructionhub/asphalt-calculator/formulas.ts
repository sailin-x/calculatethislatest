import { asphalt-calculatorInputs, asphalt-calculatorMetrics, asphalt-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: asphalt-calculatorInputs): number {
...
export function generateAnalysis(inputs: asphalt-calculatorInputs, metrics: asphalt-calculatorMetrics): asphalt-calculatorAnalysis {
