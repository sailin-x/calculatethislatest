import { paint-calculatorInputs, paint-calculatorMetrics, paint-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: paint-calculatorInputs): number {
...
export function generateAnalysis(inputs: paint-calculatorInputs, metrics: paint-calculatorMetrics): paint-calculatorAnalysis {
