import { roofing_calculatorInputs } from './types';
...
export function validateroofing_calculatorInputs(inputs: roofing_calculatorInputs): ValidationResult[] {
...
export function validateroofing_calculatorBusinessRules(inputs: roofing_calculatorInputs): ValidationResult[] {
