...
export const roofing_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Roofing Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Roofing Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Roofing Calculator calculation',
