import { siding_calculatorInputs } from './types';
...
export function validatesiding_calculatorInputs(inputs: siding_calculatorInputs): ValidationResult[] {
...
export function validatesiding_calculatorBusinessRules(inputs: siding_calculatorInputs): ValidationResult[] {
