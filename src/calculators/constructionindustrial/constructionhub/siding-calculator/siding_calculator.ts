...
export const siding_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Siding Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Siding Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Siding Calculator calculation',
