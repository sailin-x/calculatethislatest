import { tile-calculatorInputs, tile-calculatorMetrics, tile-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: tile-calculatorInputs): number {
...
export function generateAnalysis(inputs: tile-calculatorInputs, metrics: tile-calculatorMetrics): tile-calculatorAnalysis {
