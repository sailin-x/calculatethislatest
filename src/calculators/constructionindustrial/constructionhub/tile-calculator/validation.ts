import { tile_calculatorInputs } from './types';
...
export function validatetile_calculatorInputs(inputs: tile_calculatorInputs): ValidationResult[] {
...
export function validatetile_calculatorBusinessRules(inputs: tile_calculatorInputs): ValidationResult[] {
