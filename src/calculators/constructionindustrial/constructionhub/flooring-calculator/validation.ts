import { flooring_calculatorInputs } from './types';
...
export function validateflooring_calculatorInputs(inputs: flooring_calculatorInputs): ValidationResult[] {
...
export function validateflooring_calculatorBusinessRules(inputs: flooring_calculatorInputs): ValidationResult[] {
