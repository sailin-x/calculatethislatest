import { flooring-calculatorInputs, flooring-calculatorMetrics, flooring-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: flooring-calculatorInputs): number {
...
export function generateAnalysis(inputs: flooring-calculatorInputs, metrics: flooring-calculatorMetrics): flooring-calculatorAnalysis {
