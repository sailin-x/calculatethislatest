...
export const insulation_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Insulation Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Insulation Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Insulation Calculator calculation',
