import { naturopathic_medicine_cost_calculatorInputs, naturopathic_medicine_cost_calculatorMetrics, naturopathic_medicine_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: naturopathic_medicine_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: naturopathic_medicine_cost_calculatorInputs, metrics: naturopathic_medicine_cost_calculatorMetrics): naturopathic_medicine_cost_calculatorAnalysis {
