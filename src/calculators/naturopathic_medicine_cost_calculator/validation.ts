import { naturopathic_medicine_cost_calculatorInputs } from './types';

export function validateInputs(inputs: naturopathic_medicine_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
