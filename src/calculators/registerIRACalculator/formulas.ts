import { registerIRACalculatorInputs, registerIRACalculatorMetrics, registerIRACalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerIRACalculatorInputs): number {
...
export function generateAnalysis(inputs: registerIRACalculatorInputs, metrics: registerIRACalculatorMetrics): registerIRACalculatorAnalysis {
