import { hr_tech_stack_roi_calculatorInputs } from './types';
...
export function validatehr_tech_stack_roi_calculatorInputs(inputs: hr_tech_stack_roi_calculatorInputs): ValidationResult[] {
...
export function validatehr_tech_stack_roi_calculatorBusinessRules(inputs: hr_tech_stack_roi_calculatorInputs): ValidationResult[] {
