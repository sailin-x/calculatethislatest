...
export const employee_stock_option_plan_esop_valuation_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Employee Stock Option Plan (ESOP) Valuation Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Employee Stock Option Plan (ESOP) Valuation Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Employee Stock Option Plan (ESOP) Valuation Calculator calculation',
