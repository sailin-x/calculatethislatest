import { sum_of_parts_calculatorInputs } from './types';
...
export function validatesum_of_parts_calculatorInputs(inputs: sum_of_parts_calculatorInputs): ValidationResult[] {
...
export function validatesum_of_parts_calculatorBusinessRules(inputs: sum_of_parts_calculatorInputs): ValidationResult[] {
