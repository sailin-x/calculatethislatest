...
export const SumOfParts-calculator: Calculator = {
  ...
  description: 'Calculate Sum of Parts Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Sum of Parts Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Sum of Parts Calculator calculation',
