import { management-fee-hurdle-rate-calculatorInputs, management-fee-hurdle-rate-calculatorMetrics, management-fee-hurdle-rate-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: management-fee-hurdle-rate-calculatorInputs): number {
...
export function generateAnalysis(inputs: management-fee-hurdle-rate-calculatorInputs, metrics: management-fee-hurdle-rate-calculatorMetrics): management-fee-hurdle-rate-calculatorAnalysis {
