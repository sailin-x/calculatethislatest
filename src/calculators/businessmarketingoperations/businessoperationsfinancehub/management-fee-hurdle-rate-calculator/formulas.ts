import { ManagementFeeHurdle-rate-calculatorInputs, ManagementFeeHurdle-rate-calculatorMetrics, ManagementFeeHurdle-rate-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ManagementFeeHurdle-rate-calculatorInputs): number {
...
export function generateAnalysis(inputs: ManagementFeeHurdle-rate-calculatorInputs, metrics: ManagementFeeHurdle-rate-calculatorMetrics): ManagementFeeHurdle-rate-calculatorAnalysis {
