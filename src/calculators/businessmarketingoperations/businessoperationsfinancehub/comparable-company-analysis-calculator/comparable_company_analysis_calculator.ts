...
export const comparable_company_analysis_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Comparable Company Analysis Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Comparable Company Analysis Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Comparable Company Analysis Calculator calculation',
