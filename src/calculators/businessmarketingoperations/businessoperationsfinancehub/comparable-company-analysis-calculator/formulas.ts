import { ComparableCompanyAnalysis-calculatorInputs, ComparableCompanyAnalysis-calculatorMetrics, ComparableCompanyAnalysis-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ComparableCompanyAnalysis-calculatorInputs): number {
...
export function generateAnalysis(inputs: ComparableCompanyAnalysis-calculatorInputs, metrics: ComparableCompanyAnalysis-calculatorMetrics): ComparableCompanyAnalysis-calculatorAnalysis {
