import { comparable-company-analysis-calculatorInputs, comparable-company-analysis-calculatorMetrics, comparable-company-analysis-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: comparable-company-analysis-calculatorInputs): number {
...
export function generateAnalysis(inputs: comparable-company-analysis-calculatorInputs, metrics: comparable-company-analysis-calculatorMetrics): comparable-company-analysis-calculatorAnalysis {
