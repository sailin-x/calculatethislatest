...
export const BusinessLoanQualification-calculator: Calculator = {
  ...
  description: 'Calculate Business Loan Qualification Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Business Loan Qualification Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Business Loan Qualification Calculator calculation',
