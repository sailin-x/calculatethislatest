...
export const landed_cost_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Landed Cost Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Landed Cost Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Landed Cost Calculator calculation',
