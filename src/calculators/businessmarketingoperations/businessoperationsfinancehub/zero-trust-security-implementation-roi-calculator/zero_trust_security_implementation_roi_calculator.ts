...
export const zero_trust_security_implementation_roi_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Zero-Trust Security Implementation ROI Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Zero-Trust Security Implementation ROI Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Zero-Trust Security Implementation ROI Calculator calculation',
