import { cloud-repatriation-savings-calculatorInputs, cloud-repatriation-savings-calculatorMetrics, cloud-repatriation-savings-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cloud-repatriation-savings-calculatorInputs): number {
...
export function generateAnalysis(inputs: cloud-repatriation-savings-calculatorInputs, metrics: cloud-repatriation-savings-calculatorMetrics): cloud-repatriation-savings-calculatorAnalysis {
