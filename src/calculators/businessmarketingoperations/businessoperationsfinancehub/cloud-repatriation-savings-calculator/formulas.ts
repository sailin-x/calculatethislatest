import { CloudRepatriationSavings-calculatorInputs, CloudRepatriationSavings-calculatorMetrics, CloudRepatriationSavings-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: CloudRepatriationSavings-calculatorInputs): number {
...
export function generateAnalysis(inputs: CloudRepatriationSavings-calculatorInputs, metrics: CloudRepatriationSavings-calculatorMetrics): CloudRepatriationSavings-calculatorAnalysis {
