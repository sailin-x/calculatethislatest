...
export const BusinessInterruptionCalculator: Calculator = {
  ...
  description: 'Calculate Business Interruption Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Business Interruption Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Business Interruption Calculator calculation',
