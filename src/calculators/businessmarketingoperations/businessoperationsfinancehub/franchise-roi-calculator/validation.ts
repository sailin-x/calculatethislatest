import { franchise_roi_calculatorInputs } from './types';
...
export function validatefranchise_roi_calculatorInputs(inputs: franchise_roi_calculatorInputs): ValidationResult[] {
...
export function validatefranchise_roi_calculatorBusinessRules(inputs: franchise_roi_calculatorInputs): ValidationResult[] {
