...
export const six_sigma_cost_savings_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Six Sigma Cost Savings Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Six Sigma Cost Savings Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Six Sigma Cost Savings Calculator calculation',
