import { merger_model_calculatorInputs } from './types';
...
export function validatemerger_model_calculatorInputs(inputs: merger_model_calculatorInputs): ValidationResult[] {
...
export function validatemerger_model_calculatorBusinessRules(inputs: merger_model_calculatorInputs): ValidationResult[] {
