import { merger-model-calculatorInputs, merger-model-calculatorMetrics, merger-model-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: merger-model-calculatorInputs): number {
...
export function generateAnalysis(inputs: merger-model-calculatorInputs, metrics: merger-model-calculatorMetrics): merger-model-calculatorAnalysis {
