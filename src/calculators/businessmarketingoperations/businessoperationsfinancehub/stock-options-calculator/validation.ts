import { stock_options_calculatorInputs } from './types';
...
export function validatestock_options_calculatorInputs(inputs: stock_options_calculatorInputs): ValidationResult[] {
...
export function validatestock_options_calculatorBusinessRules(inputs: stock_options_calculatorInputs): ValidationResult[] {
