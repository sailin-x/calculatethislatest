import { management-consulting-fee-model-calculatorInputs, management-consulting-fee-model-calculatorMetrics, management-consulting-fee-model-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: management-consulting-fee-model-calculatorInputs): number {
...
export function generateAnalysis(inputs: management-consulting-fee-model-calculatorInputs, metrics: management-consulting-fee-model-calculatorMetrics): management-consulting-fee-model-calculatorAnalysis {
