import { government-contract-bid-no-bid-decision-calculatorInputs, government-contract-bid-no-bid-decision-calculatorMetrics, government-contract-bid-no-bid-decision-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: government-contract-bid-no-bid-decision-calculatorInputs): number {
...
export function generateAnalysis(inputs: government-contract-bid-no-bid-decision-calculatorInputs, metrics: government-contract-bid-no-bid-decision-calculatorMetrics): government-contract-bid-no-bid-decision-calculatorAnalysis {
