import { data_breach_cost_calculatorInputs } from './types';
...
export function validatedata_breach_cost_calculatorInputs(inputs: data_breach_cost_calculatorInputs): ValidationResult[] {
...
export function validatedata_breach_cost_calculatorBusinessRules(inputs: data_breach_cost_calculatorInputs): ValidationResult[] {
