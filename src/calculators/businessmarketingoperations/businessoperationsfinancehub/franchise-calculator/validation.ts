import { franchise_calculatorInputs } from './types';
...
export function validatefranchise_calculatorInputs(inputs: franchise_calculatorInputs): ValidationResult[] {
...
export function validatefranchise_calculatorBusinessRules(inputs: franchise_calculatorInputs): ValidationResult[] {
