...
export const startup_valuation_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Startup Valuation Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Startup Valuation Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Startup Valuation Calculator calculation',
