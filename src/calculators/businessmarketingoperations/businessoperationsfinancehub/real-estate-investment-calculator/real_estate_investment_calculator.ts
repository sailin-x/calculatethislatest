...
export const RealEstateInvestment-calculator: Calculator = {
  ...
  description: 'Calculate **Real Estate Investment Calculator** metrics with professional accuracy.',
  usageInstructions: [
    'Enter your **Real Estate Investment Calculator** parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic **Real Estate Investment Calculator** calculation',
