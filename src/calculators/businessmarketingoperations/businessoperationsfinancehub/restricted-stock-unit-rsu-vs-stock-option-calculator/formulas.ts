import { RestrictedStockUnit-RsuVsStock-option-calculatorInputs, RestrictedStockUnit-RsuVsStock-option-calculatorMetrics, RestrictedStockUnit-RsuVsStock-option-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: RestrictedStockUnit-RsuVsStock-option-calculatorInputs): number {
...
export function generateAnalysis(inputs: RestrictedStockUnit-RsuVsStock-option-calculatorInputs, metrics: RestrictedStockUnit-RsuVsStock-option-calculatorMetrics): RestrictedStockUnit-RsuVsStock-option-calculatorAnalysis {
