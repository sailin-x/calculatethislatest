import { profit_margin_calculatorInputs } from './types';
...
export function validateprofit_margin_calculatorInputs(inputs: profit_margin_calculatorInputs): ValidationResult[] {
...
export function validateprofit_margin_calculatorBusinessRules(inputs: profit_margin_calculatorInputs): ValidationResult[] {
