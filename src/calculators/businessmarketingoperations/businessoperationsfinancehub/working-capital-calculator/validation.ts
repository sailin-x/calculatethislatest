import { working_capital_calculatorInputs } from './types';
...
export function validateworking_capital_calculatorInputs(inputs: working_capital_calculatorInputs): ValidationResult[] {
...
export function validateworking_capital_calculatorBusinessRules(inputs: working_capital_calculatorInputs): ValidationResult[] {
