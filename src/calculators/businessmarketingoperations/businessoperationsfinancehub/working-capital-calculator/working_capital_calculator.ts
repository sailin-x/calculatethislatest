...
export const WorkingCapitalCalculator: Calculator = {
  ...
  description: 'Calculate Working Capital Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Working Capital Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Working Capital Calculator calculation',
