import { cloud_migration_tco_calculatorInputs } from './types';
...
export function validatecloud_migration_tco_calculatorInputs(inputs: cloud_migration_tco_calculatorInputs): ValidationResult[] {
...
export function validatecloud_migration_tco_calculatorBusinessRules(inputs: cloud_migration_tco_calculatorInputs): ValidationResult[] {
