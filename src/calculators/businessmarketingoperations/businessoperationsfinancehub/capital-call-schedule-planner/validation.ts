import { capital_call_schedule_plannerInputs } from './types';
...
export function validatecapital_call_schedule_plannerInputs(inputs: capital_call_schedule_plannerInputs): ValidationResult[] {
...
export function validatecapital_call_schedule_plannerBusinessRules(inputs: capital_call_schedule_plannerInputs): ValidationResult[] {
