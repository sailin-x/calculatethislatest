...
export const ErpImplementationRoi-calculator: Calculator = {
  ...
  description: 'Calculate ERP Implementation ROI Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your ERP Implementation ROI Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic ERP Implementation ROI Calculator calculation',
