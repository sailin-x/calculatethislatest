...
export const ThreatIntelligencePlatform-roi-calculator: Calculator = {
  ...
  description: 'Calculate Threat Intelligence Platform ROI Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Threat Intelligence Platform ROI Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Threat Intelligence Platform ROI Calculator calculation',
