...
export const UnionVsNon-UnionLaborCost-calculator: Calculator = {
  ...
  description: 'Calculate Union vs. Non-Union Labor Cost Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Union vs. Non-Union Labor Cost Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Union vs. Non-Union Labor Cost Calculator calculation',
