import { inventory-turnover-calculatorInputs, inventory-turnover-calculatorMetrics, inventory-turnover-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: inventory-turnover-calculatorInputs): number {
...
export function generateAnalysis(inputs: inventory-turnover-calculatorInputs, metrics: inventory-turnover-calculatorMetrics): inventory-turnover-calculatorAnalysis {
