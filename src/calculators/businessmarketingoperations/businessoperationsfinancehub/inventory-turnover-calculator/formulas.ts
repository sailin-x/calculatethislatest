import { InventoryTurnoverCalculatorinputs, InventoryTurnoverCalculatormetrics, InventoryTurnoverCalculatoranalysis } from './types';
...
export function calculateResult(inputs: InventoryTurnoverCalculatorinputs): number {
...
export function generateAnalysis(inputs: InventoryTurnoverCalculatorinputs, metrics: InventoryTurnoverCalculatormetrics): InventoryTurnoverCalculatoranalysis {
