import { youtube_ad_revenue_calculatorInputs } from './types';
...
export function validateyoutube_ad_revenue_calculatorInputs(inputs: youtube_ad_revenue_calculatorInputs): ValidationResult[] {
...
export function validateyoutube_ad_revenue_calculatorBusinessRules(inputs: youtube_ad_revenue_calculatorInputs): ValidationResult[] {
