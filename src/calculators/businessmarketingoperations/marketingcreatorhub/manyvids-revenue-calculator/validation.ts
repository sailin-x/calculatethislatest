import { manyvids_revenue_calculatorInputs } from './types';
...
export function validatemanyvids_revenue_calculatorInputs(inputs: manyvids_revenue_calculatorInputs): ValidationResult[] {
...
export function validatemanyvids_revenue_calculatorBusinessRules(inputs: manyvids_revenue_calculatorInputs): ValidationResult[] {
