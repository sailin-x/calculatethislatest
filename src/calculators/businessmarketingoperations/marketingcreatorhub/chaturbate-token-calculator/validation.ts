import { chaturbate_token_calculatorInputs } from './types';
...
export function validatechaturbate_token_calculatorInputs(inputs: chaturbate_token_calculatorInputs): ValidationResult[] {
...
export function validatechaturbate_token_calculatorBusinessRules(inputs: chaturbate_token_calculatorInputs): ValidationResult[] {
