import { podcast_sponsorship_calculatorInputs } from './types';
...
export function validatepodcast_sponsorship_calculatorInputs(inputs: podcast_sponsorship_calculatorInputs): ValidationResult[] {
...
export function validatepodcast_sponsorship_calculatorBusinessRules(inputs: podcast_sponsorship_calculatorInputs): ValidationResult[] {
