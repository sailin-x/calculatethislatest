...
export const InstagramEngagementRate-calculator: Calculator = {
  ...
  description: 'Calculate Instagram Engagement Rate Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Instagram Engagement Rate Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Instagram Engagement Rate Calculator calculation',
