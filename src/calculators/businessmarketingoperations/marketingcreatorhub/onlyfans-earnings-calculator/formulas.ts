import { OnlyfansEarningsCalculatorinputs, OnlyfansEarningsCalculatormetrics, OnlyfansEarningsCalculatoranalysis } from './types';
...
export function calculateResult(inputs: OnlyfansEarningsCalculatorinputs): number {
...
export function generateAnalysis(inputs: OnlyfansEarningsCalculatorinputs, metrics: OnlyfansEarningsCalculatormetrics): OnlyfansEarningsCalculatoranalysis {
