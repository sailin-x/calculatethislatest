import { AverageOrderValue-calculatorInputs, AverageOrderValue-calculatorMetrics, AverageOrderValue-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: AverageOrderValue-calculatorInputs): number {
...
export function generateAnalysis(inputs: AverageOrderValue-calculatorInputs, metrics: AverageOrderValue-calculatorMetrics): AverageOrderValue-calculatorAnalysis {
