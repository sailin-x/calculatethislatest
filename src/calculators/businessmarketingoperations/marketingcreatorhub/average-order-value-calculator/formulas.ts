import { average-order-value-calculatorInputs, average-order-value-calculatorMetrics, average-order-value-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: average-order-value-calculatorInputs): number {
...
export function generateAnalysis(inputs: average-order-value-calculatorInputs, metrics: average-order-value-calculatorMetrics): average-order-value-calculatorAnalysis {
