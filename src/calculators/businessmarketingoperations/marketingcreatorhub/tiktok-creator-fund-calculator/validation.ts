import { tiktok_creator_fund_calculatorInputs } from './types';
...
export function validatetiktok_creator_fund_calculatorInputs(inputs: tiktok_creator_fund_calculatorInputs): ValidationResult[] {
...
export function validatetiktok_creator_fund_calculatorBusinessRules(inputs: tiktok_creator_fund_calculatorInputs): ValidationResult[] {
