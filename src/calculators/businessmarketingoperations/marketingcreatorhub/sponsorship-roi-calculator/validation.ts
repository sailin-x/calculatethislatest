import { sponsorship_roi_calculatorInputs } from './types';
...
export function validatesponsorship_roi_calculatorInputs(inputs: sponsorship_roi_calculatorInputs): ValidationResult[] {
...
export function validatesponsorship_roi_calculatorBusinessRules(inputs: sponsorship_roi_calculatorInputs): ValidationResult[] {
