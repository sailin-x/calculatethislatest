import { api-monetization-revenue-calculatorInputs, api-monetization-revenue-calculatorMetrics, api-monetization-revenue-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: api-monetization-revenue-calculatorInputs): number {
...
export function generateAnalysis(inputs: api-monetization-revenue-calculatorInputs, metrics: api-monetization-revenue-calculatorMetrics): api-monetization-revenue-calculatorAnalysis {
