import { ApiMonetizationRevenue-calculatorInputs, ApiMonetizationRevenue-calculatorMetrics, ApiMonetizationRevenue-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ApiMonetizationRevenue-calculatorInputs): number {
...
export function generateAnalysis(inputs: ApiMonetizationRevenue-calculatorInputs, metrics: ApiMonetizationRevenue-calculatorMetrics): ApiMonetizationRevenue-calculatorAnalysis {
