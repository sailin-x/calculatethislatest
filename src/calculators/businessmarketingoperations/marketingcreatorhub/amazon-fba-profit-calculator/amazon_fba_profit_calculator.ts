...
export const amazon_fba_profit_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Amazon FBA Profit Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Amazon FBA Profit Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Amazon FBA Profit Calculator calculation',
