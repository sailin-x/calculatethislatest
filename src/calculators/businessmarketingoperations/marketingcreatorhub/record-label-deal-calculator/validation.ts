import { record_label_deal_calculatorInputs } from './types';
...
export function validaterecord_label_deal_calculatorInputs(inputs: record_label_deal_calculatorInputs): ValidationResult[] {
...
export function validaterecord_label_deal_calculatorBusinessRules(inputs: record_label_deal_calculatorInputs): ValidationResult[] {
