...
export const RecordLabelDeal-calculator: Calculator = {
  ...
  description: 'Calculate Record Label Deal Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Record Label Deal Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Record Label Deal Calculator calculation',
