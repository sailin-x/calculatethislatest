...
export const SpotifyRoyaltyCalculator: Calculator = {
  ...
  description: 'Calculate Spotify Royalty Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Spotify Royalty Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Spotify Royalty Calculator calculation',
