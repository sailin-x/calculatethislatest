import { spotify_royalty_calculatorInputs } from './types';
...
export function validatespotify_royalty_calculatorInputs(inputs: spotify_royalty_calculatorInputs): ValidationResult[] {
...
export function validatespotify_royalty_calculatorBusinessRules(inputs: spotify_royalty_calculatorInputs): ValidationResult[] {
