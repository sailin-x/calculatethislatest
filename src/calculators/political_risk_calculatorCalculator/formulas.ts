import { political_risk_calculatorCalculatorInputs, political_risk_calculatorCalculatorMetrics, political_risk_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: political_risk_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: political_risk_calculatorCalculatorInputs, metrics: political_risk_calculatorCalculatorMetrics): political_risk_calculatorCalculatorAnalysis {
