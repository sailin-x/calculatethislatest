import { rideshare_cost_calculatorCalculatorInputs, rideshare_cost_calculatorCalculatorMetrics, rideshare_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: rideshare_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: rideshare_cost_calculatorCalculatorInputs, metrics: rideshare_cost_calculatorCalculatorMetrics): rideshare_cost_calculatorCalculatorAnalysis {
