import { taxCalculatorInputs, taxCalculatorMetrics, taxCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: taxCalculatorInputs): number {
...
export function generateAnalysis(inputs: taxCalculatorInputs, metrics: taxCalculatorMetrics): taxCalculatorAnalysis {
