import { management_fee_hurdle_rate_calculatorInputs, management_fee_hurdle_rate_calculatorMetrics, management_fee_hurdle_rate_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: management_fee_hurdle_rate_calculatorInputs): number {
...
export function generateAnalysis(inputs: management_fee_hurdle_rate_calculatorInputs, metrics: management_fee_hurdle_rate_calculatorMetrics): management_fee_hurdle_rate_calculatorAnalysis {
