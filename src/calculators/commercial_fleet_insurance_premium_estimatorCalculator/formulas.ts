import { commercial_fleet_insurance_premium_estimatorCalculatorInputs, commercial_fleet_insurance_premium_estimatorCalculatorMetrics, commercial_fleet_insurance_premium_estimatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: commercial_fleet_insurance_premium_estimatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: commercial_fleet_insurance_premium_estimatorCalculatorInputs, metrics: commercial_fleet_insurance_premium_estimatorCalculatorMetrics): commercial_fleet_insurance_premium_estimatorCalculatorAnalysis {
