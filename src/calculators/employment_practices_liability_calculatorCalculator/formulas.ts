import { employment_practices_liability_calculatorCalculatorInputs, employment_practices_liability_calculatorCalculatorMetrics, employment_practices_liability_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: employment_practices_liability_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: employment_practices_liability_calculatorCalculatorInputs, metrics: employment_practices_liability_calculatorCalculatorMetrics): employment_practices_liability_calculatorCalculatorAnalysis {
