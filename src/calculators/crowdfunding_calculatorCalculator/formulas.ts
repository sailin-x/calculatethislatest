import { crowdfunding_calculatorCalculatorInputs, crowdfunding_calculatorCalculatorMetrics, crowdfunding_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: crowdfunding_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: crowdfunding_calculatorCalculatorInputs, metrics: crowdfunding_calculatorCalculatorMetrics): crowdfunding_calculatorCalculatorAnalysis {
