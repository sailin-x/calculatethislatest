import { cooking_calculatorInputs, cooking_calculatorMetrics, cooking_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cooking_calculatorInputs): number {
...
export function generateAnalysis(inputs: cooking_calculatorInputs, metrics: cooking_calculatorMetrics): cooking_calculatorAnalysis {
