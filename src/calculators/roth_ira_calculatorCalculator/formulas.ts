import { roth_ira_calculatorCalculatorInputs, roth_ira_calculatorCalculatorMetrics, roth_ira_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: roth_ira_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: roth_ira_calculatorCalculatorInputs, metrics: roth_ira_calculatorCalculatorMetrics): roth_ira_calculatorCalculatorAnalysis {
