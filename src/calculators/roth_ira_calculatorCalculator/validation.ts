import { roth_ira_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: roth_ira_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
