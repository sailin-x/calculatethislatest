import { pilates_studio_cost_calculatorInputs, pilates_studio_cost_calculatorMetrics, pilates_studio_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: pilates_studio_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: pilates_studio_cost_calculatorInputs, metrics: pilates_studio_cost_calculatorMetrics): pilates_studio_cost_calculatorAnalysis {
