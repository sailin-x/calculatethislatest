import { pilates_studio_cost_calculatorInputs } from './types';

export function validateInputs(inputs: pilates_studio_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
