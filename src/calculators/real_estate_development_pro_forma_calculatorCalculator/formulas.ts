import { real_estate_development_pro_forma_calculatorCalculatorInputs, real_estate_development_pro_forma_calculatorCalculatorMetrics, real_estate_development_pro_forma_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: real_estate_development_pro_forma_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: real_estate_development_pro_forma_calculatorCalculatorInputs, metrics: real_estate_development_pro_forma_calculatorCalculatorMetrics): real_estate_development_pro_forma_calculatorCalculatorAnalysis {
