import { legal_malpractice_insurance_calculatorCalculatorInputs, legal_malpractice_insurance_calculatorCalculatorMetrics, legal_malpractice_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: legal_malpractice_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: legal_malpractice_insurance_calculatorCalculatorInputs, metrics: legal_malpractice_insurance_calculatorCalculatorMetrics): legal_malpractice_insurance_calculatorCalculatorAnalysis {
