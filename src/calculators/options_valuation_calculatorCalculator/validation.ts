import { options_valuation_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: options_valuation_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
