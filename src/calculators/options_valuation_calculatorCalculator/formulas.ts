import { options_valuation_calculatorCalculatorInputs, options_valuation_calculatorCalculatorMetrics, options_valuation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: options_valuation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: options_valuation_calculatorCalculatorInputs, metrics: options_valuation_calculatorCalculatorMetrics): options_valuation_calculatorCalculatorAnalysis {
