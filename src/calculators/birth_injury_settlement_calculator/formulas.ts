import { birth_injury_settlement_calculatorInputs, birth_injury_settlement_calculatorMetrics, birth_injury_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: birth_injury_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: birth_injury_settlement_calculatorInputs, metrics: birth_injury_settlement_calculatorMetrics): birth_injury_settlement_calculatorAnalysis {
