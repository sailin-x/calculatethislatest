import { refinanceCalculatorInputs, refinanceCalculatorMetrics, refinanceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: refinanceCalculatorInputs): number {
...
export function generateAnalysis(inputs: refinanceCalculatorInputs, metrics: refinanceCalculatorMetrics): refinanceCalculatorAnalysis {
