import { hobbiesCalculatorInputs, hobbiesCalculatorMetrics, hobbiesCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hobbiesCalculatorInputs): number {
...
export function generateAnalysis(inputs: hobbiesCalculatorInputs, metrics: hobbiesCalculatorMetrics): hobbiesCalculatorAnalysis {
