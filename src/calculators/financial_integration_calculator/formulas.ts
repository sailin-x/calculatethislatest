import { financial_integration_calculatorInputs, financial_integration_calculatorMetrics, financial_integration_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_integration_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_integration_calculatorInputs, metrics: financial_integration_calculatorMetrics): financial_integration_calculatorAnalysis {
