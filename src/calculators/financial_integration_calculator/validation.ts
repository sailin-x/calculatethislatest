import { financial_integration_calculatorInputs } from './types';

export function validateInputs(inputs: financial_integration_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
