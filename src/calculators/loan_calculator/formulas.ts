import { loan_calculatorInputs, loan_calculatorMetrics, loan_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: loan_calculatorInputs): number {
...
export function generateAnalysis(inputs: loan_calculatorInputs, metrics: loan_calculatorMetrics): loan_calculatorAnalysis {
