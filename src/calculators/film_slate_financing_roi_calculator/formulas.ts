import { film_slate_financing_roi_calculatorInputs, film_slate_financing_roi_calculatorMetrics, film_slate_financing_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: film_slate_financing_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: film_slate_financing_roi_calculatorInputs, metrics: film_slate_financing_roi_calculatorMetrics): film_slate_financing_roi_calculatorAnalysis {
