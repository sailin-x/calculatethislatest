import { luggage_cost_calculatorInputs, luggage_cost_calculatorMetrics, luggage_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: luggage_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: luggage_cost_calculatorInputs, metrics: luggage_cost_calculatorMetrics): luggage_cost_calculatorAnalysis {
