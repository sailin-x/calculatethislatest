import { dynasty_trust_growth_estimatorCalculatorInputs } from './types';

export function validateInputs(inputs: dynasty_trust_growth_estimatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
