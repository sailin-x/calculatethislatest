import { dynasty_trust_growth_estimatorCalculatorInputs, dynasty_trust_growth_estimatorCalculatorMetrics, dynasty_trust_growth_estimatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: dynasty_trust_growth_estimatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: dynasty_trust_growth_estimatorCalculatorInputs, metrics: dynasty_trust_growth_estimatorCalculatorMetrics): dynasty_trust_growth_estimatorCalculatorAnalysis {
