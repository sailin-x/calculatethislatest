import { return_on_assets_calculatorCalculatorInputs, return_on_assets_calculatorCalculatorMetrics, return_on_assets_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: return_on_assets_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: return_on_assets_calculatorCalculatorInputs, metrics: return_on_assets_calculatorCalculatorMetrics): return_on_assets_calculatorCalculatorAnalysis {
