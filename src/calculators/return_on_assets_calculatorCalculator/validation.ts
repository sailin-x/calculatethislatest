import { return_on_assets_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: return_on_assets_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
