import { dissolved_oxygen_calculatorCalculatorInputs, dissolved_oxygen_calculatorCalculatorMetrics, dissolved_oxygen_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: dissolved_oxygen_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: dissolved_oxygen_calculatorCalculatorInputs, metrics: dissolved_oxygen_calculatorCalculatorMetrics): dissolved_oxygen_calculatorCalculatorAnalysis {
