import { dissolved_oxygen_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: dissolved_oxygen_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
