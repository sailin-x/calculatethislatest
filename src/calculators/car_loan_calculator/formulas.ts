import { car_loan_calculatorInputs, car_loan_calculatorMetrics, car_loan_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: car_loan_calculatorInputs): number {
...
export function generateAnalysis(inputs: car_loan_calculatorInputs, metrics: car_loan_calculatorMetrics): car_loan_calculatorAnalysis {
