import { CatastrophicInjuryCalculatorInputs } from './types';

export function validateCatastrophicInjuryCalculatorInputs(inputs: CatastrophicInjuryCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCatastrophicInjuryCalculatorBusinessRules(inputs: CatastrophicInjuryCalculatorInputs): Array<{ field: string; message: string }> {
