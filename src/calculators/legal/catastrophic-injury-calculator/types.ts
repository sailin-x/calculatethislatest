export interface CatastrophicInjuryCalculatorInputs {
...
export interface CatastrophicInjuryCalculatorOutputs {
...
export interface CatastrophicInjuryCalculatorMetrics {
...
export interface CatastrophicInjuryCalculatorAnalysis {
