export interface PedestrianAccidentSettlementCalculatorInputs {
...
export interface PedestrianAccidentSettlementCalculatorOutputs {
...
export interface PedestrianAccidentSettlementCalculatorMetrics {
...
export interface PedestrianAccidentSettlementCalculatorAnalysis {
