import { PedestrianAccidentSettlementCalculatorInputs } from './types';

export function validatePedestrianAccidentSettlementCalculatorInputs(inputs: PedestrianAccidentSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePedestrianAccidentSettlementCalculatorBusinessRules(inputs: PedestrianAccidentSettlementCalculatorInputs): Array<{ field: string; message: string }> {
