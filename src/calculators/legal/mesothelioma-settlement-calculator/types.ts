export interface MesotheliomaSettlementCalculatorInputs {
...
export interface MesotheliomaSettlementCalculatorOutputs {
...
export interface MesotheliomaSettlementCalculatorMetrics {
...
export interface MesotheliomaSettlementCalculatorAnalysis {
