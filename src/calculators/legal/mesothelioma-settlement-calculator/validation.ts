import { MesotheliomaSettlementCalculatorInputs } from './types';

export function validateMesotheliomaSettlementCalculatorInputs(inputs: MesotheliomaSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMesotheliomaSettlementCalculatorBusinessRules(inputs: MesotheliomaSettlementCalculatorInputs): Array<{ field: string; message: string }> {
