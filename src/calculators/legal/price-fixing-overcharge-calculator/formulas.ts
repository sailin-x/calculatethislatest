import { PriceFixingOvercharge-calculatorInputs, PriceFixingOvercharge-calculatorMetrics, PriceFixingOvercharge-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: PriceFixingOvercharge-calculatorInputs): number {
...
export function generateAnalysis(inputs: PriceFixingOvercharge-calculatorInputs, metrics: PriceFixingOvercharge-calculatorMetrics): PriceFixingOvercharge-calculatorAnalysis {
