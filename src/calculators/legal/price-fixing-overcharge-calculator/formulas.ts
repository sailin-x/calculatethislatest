import { price-fixing-overcharge-calculatorInputs, price-fixing-overcharge-calculatorMetrics, price-fixing-overcharge-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: price-fixing-overcharge-calculatorInputs): number {
...
export function generateAnalysis(inputs: price-fixing-overcharge-calculatorInputs, metrics: price-fixing-overcharge-calculatorMetrics): price-fixing-overcharge-calculatorAnalysis {
