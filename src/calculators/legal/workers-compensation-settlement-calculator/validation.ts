import { WorkersCompensationSettlementCalculatorInputs } from './types';

export function validateWorkersCompensationSettlementCalculatorInputs(inputs: WorkersCompensationSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateWorkersCompensationSettlementCalculatorBusinessRules(inputs: WorkersCompensationSettlementCalculatorInputs): Array<{ field: string; message: string }> {
