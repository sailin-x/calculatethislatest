export interface WorkersCompensationSettlementCalculatorInputs {
...
export interface WorkersCompensationSettlementCalculatorOutputs {
...
export interface WorkersCompensationSettlementCalculatorMetrics {
...
export interface WorkersCompensationSettlementCalculatorAnalysis {
