...
import { IntellectualPropertyLicensingCalculatorInputs, IntellectualPropertyLicensingCalculatorOutputs } from './types';
import {
...
export const IntellectualPropertyLicensingCalculator: Calculator = {
  ...
  description: 'Calculate IP licensing royalties',
  usageInstructions: [
