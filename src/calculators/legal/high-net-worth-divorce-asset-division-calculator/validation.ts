import { HighnetworthDivorceAssetDivisionCalculatorInputs } from './types';

export function validateHighnetworthDivorceAssetDivisionCalculatorInputs(inputs: HighnetworthDivorceAssetDivisionCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateHighnetworthDivorceAssetDivisionCalculatorBusinessRules(inputs: HighnetworthDivorceAssetDivisionCalculatorInputs): Array<{ field: string; message: string }> {
