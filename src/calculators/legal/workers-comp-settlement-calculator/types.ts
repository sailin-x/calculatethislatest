export interface WorkersCompSettlementCalculatorInputs {
...
export interface WorkersCompSettlementCalculatorOutputs {
...
export interface WorkersCompSettlementCalculatorMetrics {
...
export interface WorkersCompSettlementCalculatorAnalysis {
