import { WorkersCompSettlementCalculatorInputs } from './types';

export function validateWorkersCompSettlementCalculatorInputs(inputs: WorkersCompSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateWorkersCompSettlementCalculatorBusinessRules(inputs: WorkersCompSettlementCalculatorInputs): Array<{ field: string; message: string }> {
