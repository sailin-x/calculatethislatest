import { DefectiveDrugSettlementCalculatorInputs } from './types';

export function validateDefectiveDrugSettlementCalculatorInputs(inputs: DefectiveDrugSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDefectiveDrugSettlementCalculatorBusinessRules(inputs: DefectiveDrugSettlementCalculatorInputs): Array<{ field: string; message: string }> {
