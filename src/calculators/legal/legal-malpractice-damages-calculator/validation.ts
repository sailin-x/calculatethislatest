import { LegalMalpracticeDamagesCalculatorInputs } from './types';

export function validateLegalMalpracticeDamagesCalculatorInputs(inputs: LegalMalpracticeDamagesCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateLegalMalpracticeDamagesCalculatorBusinessRules(inputs: LegalMalpracticeDamagesCalculatorInputs): Array<{ field: string; message: string }> {
