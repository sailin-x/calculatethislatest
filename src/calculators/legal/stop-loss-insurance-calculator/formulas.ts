import { StopLossInsurance-calculatorInputs, StopLossInsurance-calculatorMetrics, StopLossInsurance-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: StopLossInsurance-calculatorInputs): number {
...
export function generateAnalysis(inputs: StopLossInsurance-calculatorInputs, metrics: StopLossInsurance-calculatorMetrics): StopLossInsurance-calculatorAnalysis {
