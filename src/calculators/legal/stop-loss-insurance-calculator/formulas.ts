import { stop-loss-insurance-calculatorInputs, stop-loss-insurance-calculatorMetrics, stop-loss-insurance-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: stop-loss-insurance-calculatorInputs): number {
...
export function generateAnalysis(inputs: stop-loss-insurance-calculatorInputs, metrics: stop-loss-insurance-calculatorMetrics): stop-loss-insurance-calculatorAnalysis {
