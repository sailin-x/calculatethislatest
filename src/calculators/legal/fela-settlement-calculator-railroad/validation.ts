import { FelaSettlementCalculatorRailroadInputs } from './types';

export function validateFelaSettlementCalculatorRailroadInputs(inputs: FelaSettlementCalculatorRailroadInputs): Array<{ field: string; message: string }> {
...
export function validateFelaSettlementCalculatorRailroadBusinessRules(inputs: FelaSettlementCalculatorRailroadInputs): Array<{ field: string; message: string }> {
