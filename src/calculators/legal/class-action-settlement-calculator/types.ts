export interface ClassActionSettlementCalculatorInputs {
...
export interface ClassActionSettlementCalculatorOutputs {
...
export interface ClassActionSettlementCalculatorMetrics {
...
export interface ClassActionSettlementCalculatorAnalysis {
