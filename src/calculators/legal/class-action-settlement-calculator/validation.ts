import { ClassActionSettlementCalculatorInputs } from './types';

export function validateClassActionSettlementCalculatorInputs(inputs: ClassActionSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateClassActionSettlementCalculatorBusinessRules(inputs: ClassActionSettlementCalculatorInputs): Array<{ field: string; message: string }> {
