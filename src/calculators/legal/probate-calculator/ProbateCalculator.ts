...
import { ProbateCalculatorInputs, ProbateCalculatorOutputs } from './types';
import {
...
import { validateProbateCalculatorInputs } from './validation';

export const ProbateCalculator: Calculator = {
  id: 'probate-calculator',
  title: 'Probate Calculator',
  category: 'legal',
  subcategory: 'Settlement Analysis',
  description: 'Calculate probate costs and timelines',
  usageInstructions: [
