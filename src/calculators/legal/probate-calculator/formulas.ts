import { probate-calculatorInputs, probate-calculatorMetrics, probate-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: probate-calculatorInputs): number {
...
export function generateAnalysis(inputs: probate-calculatorInputs, metrics: probate-calculatorMetrics): probate-calculatorAnalysis {
