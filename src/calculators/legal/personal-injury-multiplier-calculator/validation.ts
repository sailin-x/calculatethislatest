import { PersonalInjuryMultiplierCalculatorInputs } from './types';

export function validatePersonalInjuryMultiplierCalculatorInputs(inputs: PersonalInjuryMultiplierCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePersonalInjuryMultiplierCalculatorBusinessRules(inputs: PersonalInjuryMultiplierCalculatorInputs): Array<{ field: string; message: string }> {
