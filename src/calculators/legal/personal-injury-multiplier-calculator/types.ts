export interface PersonalInjuryMultiplierCalculatorInputs {
...
export interface PersonalInjuryMultiplierCalculatorOutputs {
...
export interface PersonalInjuryMultiplierCalculatorMetrics {
...
export interface PersonalInjuryMultiplierCalculatorAnalysis {
