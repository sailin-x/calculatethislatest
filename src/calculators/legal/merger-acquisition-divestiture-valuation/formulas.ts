import { MergerAcquisitionDivestiture-valuationInputs, MergerAcquisitionDivestiture-valuationMetrics, MergerAcquisitionDivestiture-valuationAnalysis } from './types';
...
export function calculateResult(inputs: MergerAcquisitionDivestiture-valuationInputs): number {
...
export function generateAnalysis(inputs: MergerAcquisitionDivestiture-valuationInputs, metrics: MergerAcquisitionDivestiture-valuationMetrics): MergerAcquisitionDivestiture-valuationAnalysis {
