import { merger-acquisition-divestiture-valuationInputs, merger-acquisition-divestiture-valuationMetrics, merger-acquisition-divestiture-valuationAnalysis } from './types';
...
export function calculateResult(inputs: merger-acquisition-divestiture-valuationInputs): number {
...
export function generateAnalysis(inputs: merger-acquisition-divestiture-valuationInputs, metrics: merger-acquisition-divestiture-valuationMetrics): merger-acquisition-divestiture-valuationAnalysis {
