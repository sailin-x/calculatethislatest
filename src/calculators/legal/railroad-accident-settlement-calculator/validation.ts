import { RailroadAccidentSettlementCalculatorInputs } from './types';

export function validateRailroadAccidentSettlementCalculatorInputs(inputs: RailroadAccidentSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateRailroadAccidentSettlementCalculatorBusinessRules(inputs: RailroadAccidentSettlementCalculatorInputs): Array<{ field: string; message: string }> {
