export interface RailroadAccidentSettlementCalculatorInputs {
...
export interface RailroadAccidentSettlementCalculatorOutputs {
...
export interface RailroadAccidentSettlementCalculatorMetrics {
...
export interface RailroadAccidentSettlementCalculatorAnalysis {
