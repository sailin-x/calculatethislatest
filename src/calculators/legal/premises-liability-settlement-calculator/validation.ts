import { PremisesLiabilitySettlementCalculatorInputs } from './types';

export function validatePremisesLiabilitySettlementCalculatorInputs(inputs: PremisesLiabilitySettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePremisesLiabilitySettlementCalculatorBusinessRules(inputs: PremisesLiabilitySettlementCalculatorInputs): Array<{ field: string; message: string }> {
