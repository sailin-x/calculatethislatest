export interface SpinalCordInjuryCompensationCalculatorInputs {
...
export interface SpinalCordInjuryCompensationCalculatorOutputs {
...
export interface SpinalCordInjuryCompensationCalculatorMetrics {
...
export interface SpinalCordInjuryCompensationCalculatorAnalysis {
