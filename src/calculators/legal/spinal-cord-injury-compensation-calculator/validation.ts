import { SpinalCordInjuryCompensationCalculatorInputs } from './types';

export function validateSpinalCordInjuryCompensationCalculatorInputs(inputs: SpinalCordInjuryCompensationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateSpinalCordInjuryCompensationCalculatorBusinessRules(inputs: SpinalCordInjuryCompensationCalculatorInputs): Array<{ field: string; message: string }> {
