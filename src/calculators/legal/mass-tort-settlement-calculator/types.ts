export interface MassTortSettlementCalculatorInputs {
...
export interface MassTortSettlementCalculatorOutputs {
...
export interface MassTortSettlementCalculatorMetrics {
...
export interface MassTortSettlementCalculatorAnalysis {
