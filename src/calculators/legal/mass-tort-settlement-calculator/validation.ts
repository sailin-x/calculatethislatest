import { MassTortSettlementCalculatorInputs } from './types';

export function validateMassTortSettlementCalculatorInputs(inputs: MassTortSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMassTortSettlementCalculatorBusinessRules(inputs: MassTortSettlementCalculatorInputs): Array<{ field: string; message: string }> {
