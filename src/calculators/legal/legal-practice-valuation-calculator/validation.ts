import { LegalPracticeValuationCalculatorInputs } from './types';

export function validateLegalPracticeValuationCalculatorInputs(inputs: LegalPracticeValuationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateLegalPracticeValuationCalculatorBusinessRules(inputs: LegalPracticeValuationCalculatorInputs): Array<{ field: string; message: string }> {
