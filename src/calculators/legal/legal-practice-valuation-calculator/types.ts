export interface LegalPracticeValuationCalculatorInputs {
...
export interface LegalPracticeValuationCalculatorOutputs {
...
export interface LegalPracticeValuationCalculatorMetrics {
...
export interface LegalPracticeValuationCalculatorAnalysis {
