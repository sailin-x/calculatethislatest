export interface JonesActSettlementCalculatorMaritimeInputs {
...
export interface JonesActSettlementCalculatorMaritimeOutputs {
...
export interface JonesActSettlementCalculatorMaritimeMetrics {
...
export interface JonesActSettlementCalculatorMaritimeAnalysis {
