import { JonesActSettlementCalculatorMaritimeInputs } from './types';

export function validateJonesActSettlementCalculatorMaritimeInputs(inputs: JonesActSettlementCalculatorMaritimeInputs): Array<{ field: string; message: string }> {
...
export function validateJonesActSettlementCalculatorMaritimeBusinessRules(inputs: JonesActSettlementCalculatorMaritimeInputs): Array<{ field: string; message: string }> {
