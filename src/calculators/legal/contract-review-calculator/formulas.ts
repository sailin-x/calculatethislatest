import { ContractReviewCalculatorinputs, ContractReviewCalculatormetrics, ContractReviewCalculatoranalysis } from './types';
...
export function calculateResult(inputs: ContractReviewCalculatorinputs): number {
...
export function generateAnalysis(inputs: ContractReviewCalculatorinputs, metrics: ContractReviewCalculatormetrics): ContractReviewCalculatoranalysis {
