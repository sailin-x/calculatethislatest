import { contract-review-calculatorInputs, contract-review-calculatorMetrics, contract-review-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: contract-review-calculatorInputs): number {
...
export function generateAnalysis(inputs: contract-review-calculatorInputs, metrics: contract-review-calculatorMetrics): contract-review-calculatorAnalysis {
