import { CopyrightInfringementCalculatorinputs, CopyrightInfringementCalculatormetrics, CopyrightInfringementCalculatoranalysis } from './types';
...
export function calculateResult(inputs: CopyrightInfringementCalculatorinputs): number {
...
export function generateAnalysis(inputs: CopyrightInfringementCalculatorinputs, metrics: CopyrightInfringementCalculatormetrics): CopyrightInfringementCalculatoranalysis {
