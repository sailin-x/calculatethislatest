import { alimony-calculatorInputs, alimony-calculatorMetrics, alimony-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: alimony-calculatorInputs): number {
...
export function generateAnalysis(inputs: alimony-calculatorInputs, metrics: alimony-calculatorMetrics): alimony-calculatorAnalysis {
