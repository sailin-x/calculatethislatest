import { BirthInjuryMalpracticeCalculatorInputs } from './types';

export function validateBirthInjuryMalpracticeCalculatorInputs(inputs: BirthInjuryMalpracticeCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBirthInjuryMalpracticeCalculatorBusinessRules(inputs: BirthInjuryMalpracticeCalculatorInputs): Array<{ field: string; message: string }> {
