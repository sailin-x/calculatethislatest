export interface BirthInjuryMalpracticeCalculatorInputs {
...
export interface BirthInjuryMalpracticeCalculatorOutputs {
...
export interface BirthInjuryMalpracticeCalculatorMetrics {
...
export interface BirthInjuryMalpracticeCalculatorAnalysis {
