import { QuiTamReward-calculatorInputs, QuiTamReward-calculatorMetrics, QuiTamReward-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: QuiTamReward-calculatorInputs): number {
...
export function generateAnalysis(inputs: QuiTamReward-calculatorInputs, metrics: QuiTamReward-calculatorMetrics): QuiTamReward-calculatorAnalysis {
