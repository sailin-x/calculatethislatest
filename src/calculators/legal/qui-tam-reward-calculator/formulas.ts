import { qui-tam-reward-calculatorInputs, qui-tam-reward-calculatorMetrics, qui-tam-reward-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: qui-tam-reward-calculatorInputs): number {
...
export function generateAnalysis(inputs: qui-tam-reward-calculatorInputs, metrics: qui-tam-reward-calculatorMetrics): qui-tam-reward-calculatorAnalysis {
