import { OpioidSettlementCalculatorInputs } from './types';

export function validateOpioidSettlementCalculatorInputs(inputs: OpioidSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateOpioidSettlementCalculatorBusinessRules(inputs: OpioidSettlementCalculatorInputs): Array<{ field: string; message: string }> {
