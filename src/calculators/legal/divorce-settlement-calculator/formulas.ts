import { DivorceSettlementCalculatorinputs, DivorceSettlementCalculatormetrics, DivorceSettlementCalculatoranalysis } from './types';
...
export function calculateResult(inputs: DivorceSettlementCalculatorinputs): number {
...
export function generateAnalysis(inputs: DivorceSettlementCalculatorinputs, metrics: DivorceSettlementCalculatormetrics): DivorceSettlementCalculatoranalysis {
