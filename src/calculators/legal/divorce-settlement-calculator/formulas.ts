import { divorce-settlement-calculatorInputs, divorce-settlement-calculatorMetrics, divorce-settlement-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: divorce-settlement-calculatorInputs): number {
...
export function generateAnalysis(inputs: divorce-settlement-calculatorInputs, metrics: divorce-settlement-calculatorMetrics): divorce-settlement-calculatorAnalysis {
