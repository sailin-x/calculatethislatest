import { JonesActSettlement-calculatorInputs, JonesActSettlement-calculatorMetrics, JonesActSettlement-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: JonesActSettlement-calculatorInputs): number {
...
export function generateAnalysis(inputs: JonesActSettlement-calculatorInputs, metrics: JonesActSettlement-calculatorMetrics): JonesActSettlement-calculatorAnalysis {
