import { jones-act-settlement-calculatorInputs, jones-act-settlement-calculatorMetrics, jones-act-settlement-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: jones-act-settlement-calculatorInputs): number {
...
export function generateAnalysis(inputs: jones-act-settlement-calculatorInputs, metrics: jones-act-settlement-calculatorMetrics): jones-act-settlement-calculatorAnalysis {
