...
import { JonesActSettlementCalculatorInputs, JonesActSettlementCalculatorOutputs } from './types';
import {
...
export const JonesActSettlementCalculator: Calculator = {
  ...
  description: 'Calculate Jones Act settlement amounts for maritime workers.',
  usageInstructions: [
