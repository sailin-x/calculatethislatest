import { ProductLiabilitySettlementCalculatorInputs } from './types';

export function validateProductLiabilitySettlementCalculatorInputs(inputs: ProductLiabilitySettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateProductLiabilitySettlementCalculatorBusinessRules(inputs: ProductLiabilitySettlementCalculatorInputs): Array<{ field: string; message: string }> {
