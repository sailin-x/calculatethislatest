export interface TraumaticBrainInjurySettlementCalculatorInputs {
...
export interface TraumaticBrainInjurySettlementCalculatorOutputs {
...
export interface TraumaticBrainInjurySettlementCalculatorMetrics {
...
export interface TraumaticBrainInjurySettlementCalculatorAnalysis {
