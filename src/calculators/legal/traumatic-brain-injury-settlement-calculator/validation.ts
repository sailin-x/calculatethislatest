import { TraumaticBrainInjurySettlementCalculatorInputs } from './types';

export function validateTraumaticBrainInjurySettlementCalculatorInputs(inputs: TraumaticBrainInjurySettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTraumaticBrainInjurySettlementCalculatorBusinessRules(inputs: TraumaticBrainInjurySettlementCalculatorInputs): Array<{ field: string; message: string }> {
