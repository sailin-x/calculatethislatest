...
import { validateChapter11BankruptcyPlanValuationInputs } from './validation';

export const Chapter11BankruptcyPlanValuation: Calculator = {
  id: 'chapter-11-bankruptcy-plan-valuation',
  title: 'Chapter 11 Bankruptcy Plan Valuation',
  category: 'legal',
  subcategory: 'Settlement Analysis',
  description: 'Calculate Chapter 11 bankruptcy plan valuation.',
  usageInstructions: [
