import { SurgicalErrorSettlementCalculatorInputs } from './types';

export function validateSurgicalErrorSettlementCalculatorInputs(inputs: SurgicalErrorSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateSurgicalErrorSettlementCalculatorBusinessRules(inputs: SurgicalErrorSettlementCalculatorInputs): Array<{ field: string; message: string }> {
