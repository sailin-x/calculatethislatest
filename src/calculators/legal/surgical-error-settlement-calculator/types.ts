export interface SurgicalErrorSettlementCalculatorInputs {
...
export interface SurgicalErrorSettlementCalculatorOutputs {
...
export interface SurgicalErrorSettlementCalculatorMetrics {
...
export interface SurgicalErrorSettlementCalculatorAnalysis {
