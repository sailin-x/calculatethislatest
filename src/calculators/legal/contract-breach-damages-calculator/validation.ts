import { ContractBreachDamagesCalculatorInputs } from './types';

export function validateContractBreachDamagesCalculatorInputs(inputs: ContractBreachDamagesCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateContractBreachDamagesCalculatorBusinessRules(inputs: ContractBreachDamagesCalculatorInputs): Array<{ field: string; message: string }> {
