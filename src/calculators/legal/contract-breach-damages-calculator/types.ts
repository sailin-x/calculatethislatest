export interface ContractBreachDamagesCalculatorInputs {
...
export interface ContractBreachDamagesCalculatorOutputs {
...
export interface ContractBreachDamagesCalculatorMetrics {
...
export interface ContractBreachDamagesCalculatorAnalysis {
