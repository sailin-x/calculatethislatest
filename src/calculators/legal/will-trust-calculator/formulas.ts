import { will-trust-calculatorInputs, will-trust-calculatorMetrics, will-trust-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: will-trust-calculatorInputs): number {
...
export function generateAnalysis(inputs: will-trust-calculatorInputs, metrics: will-trust-calculatorMetrics): will-trust-calculatorAnalysis {
