import { WillTrustCalculatorinputs, WillTrustCalculatormetrics, WillTrustCalculatoranalysis } from './types';
...
export function calculateResult(inputs: WillTrustCalculatorinputs): number {
...
export function generateAnalysis(inputs: WillTrustCalculatorinputs, metrics: WillTrustCalculatormetrics): WillTrustCalculatoranalysis {
