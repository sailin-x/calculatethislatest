import { HitAndRunSettlementCalculatorInputs } from './types';

export function validateHitAndRunSettlementCalculatorInputs(inputs: HitAndRunSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateHitAndRunSettlementCalculatorBusinessRules(inputs: HitAndRunSettlementCalculatorInputs): Array<{ field: string; message: string }> {
