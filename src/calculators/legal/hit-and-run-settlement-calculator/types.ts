export interface HitAndRunSettlementCalculatorInputs {
...
export interface HitAndRunSettlementCalculatorOutputs {
...
export interface HitAndRunSettlementCalculatorMetrics {
...
export interface HitAndRunSettlementCalculatorAnalysis {
