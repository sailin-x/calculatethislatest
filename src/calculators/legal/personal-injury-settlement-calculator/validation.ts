import { PersonalInjurySettlementCalculatorInputs } from './types';

export function validatePersonalInjurySettlementCalculatorInputs(inputs: PersonalInjurySettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePersonalInjurySettlementCalculatorBusinessRules(inputs: PersonalInjurySettlementCalculatorInputs): Array<{ field: string; message: string }> {
