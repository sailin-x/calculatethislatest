export interface PersonalInjurySettlementCalculatorInputs {
...
export interface PersonalInjurySettlementCalculatorOutputs {
...
export interface PersonalInjurySettlementCalculatorMetrics {
...
export interface PersonalInjurySettlementCalculatorAnalysis {
