export interface MedicalMalpracticeSettlementCalculatorInputs {
...
export interface MedicalMalpracticeSettlementCalculatorOutputs {
...
export interface MedicalMalpracticeSettlementCalculatorMetrics {
...
export interface MedicalMalpracticeSettlementCalculatorAnalysis {
