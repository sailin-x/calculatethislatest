import { MedicalMalpracticeSettlementCalculatorInputs } from './types';

export function validateMedicalMalpracticeSettlementCalculatorInputs(inputs: MedicalMalpracticeSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMedicalMalpracticeSettlementCalculatorBusinessRules(inputs: MedicalMalpracticeSettlementCalculatorInputs): Array<{ field: string; message: string }> {
