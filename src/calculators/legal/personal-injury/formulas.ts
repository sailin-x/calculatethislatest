import { personal-injuryInputs, personal-injuryMetrics, personal-injuryAnalysis } from './types';
...
export function calculateResult(inputs: personal-injuryInputs): number {
...
export function generateAnalysis(inputs: personal-injuryInputs, metrics: personal-injuryMetrics): personal-injuryAnalysis {
