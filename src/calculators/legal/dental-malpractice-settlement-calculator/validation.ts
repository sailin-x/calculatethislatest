import { DentalMalpracticeSettlementCalculatorInputs } from './types';

export function validateDentalMalpracticeSettlementCalculatorInputs(inputs: DentalMalpracticeSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDentalMalpracticeSettlementCalculatorBusinessRules(inputs: DentalMalpracticeSettlementCalculatorInputs): Array<{ field: string; message: string }> {
