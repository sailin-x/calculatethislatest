export interface DentalMalpracticeSettlementCalculatorInputs {
...
export interface DentalMalpracticeSettlementCalculatorOutputs {
...
export interface DentalMalpracticeSettlementCalculatorMetrics {
...
export interface DentalMalpracticeSettlementCalculatorAnalysis {
