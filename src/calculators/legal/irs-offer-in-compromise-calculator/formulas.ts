import { irs-offer-in-compromise-calculatorInputs, irs-offer-in-compromise-calculatorMetrics, irs-offer-in-compromise-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: irs-offer-in-compromise-calculatorInputs): number {
...
export function generateAnalysis(inputs: irs-offer-in-compromise-calculatorInputs, metrics: irs-offer-in-compromise-calculatorMetrics): irs-offer-in-compromise-calculatorAnalysis {
