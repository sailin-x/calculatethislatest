import { IrsOfferIn-compromise-calculatorInputs, IrsOfferIn-compromise-calculatorMetrics, IrsOfferIn-compromise-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: IrsOfferIn-compromise-calculatorInputs): number {
...
export function generateAnalysis(inputs: IrsOfferIn-compromise-calculatorInputs, metrics: IrsOfferIn-compromise-calculatorMetrics): IrsOfferIn-compromise-calculatorAnalysis {
