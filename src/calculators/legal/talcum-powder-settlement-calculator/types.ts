export interface TalcumPowderSettlementCalculatorInputs {
...
export interface TalcumPowderSettlementCalculatorOutputs {
...
export interface TalcumPowderSettlementCalculatorMetrics {
...
export interface TalcumPowderSettlementCalculatorAnalysis {
