import { TalcumPowderSettlementCalculatorInputs } from './types';

export function validateTalcumPowderSettlementCalculatorInputs(inputs: TalcumPowderSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTalcumPowderSettlementCalculatorBusinessRules(inputs: TalcumPowderSettlementCalculatorInputs): Array<{ field: string; message: string }> {
