import { child-custody-calculatorInputs, child-custody-calculatorMetrics, child-custody-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: child-custody-calculatorInputs): number {
...
export function generateAnalysis(inputs: child-custody-calculatorInputs, metrics: child-custody-calculatorMetrics): child-custody-calculatorAnalysis {
