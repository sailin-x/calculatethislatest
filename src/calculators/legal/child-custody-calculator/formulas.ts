import { ChildCustodyCalculatorinputs, ChildCustodyCalculatormetrics, ChildCustodyCalculatoranalysis } from './types';
...
export function calculateResult(inputs: ChildCustodyCalculatorinputs): number {
...
export function generateAnalysis(inputs: ChildCustodyCalculatorinputs, metrics: ChildCustodyCalculatormetrics): ChildCustodyCalculatoranalysis {
