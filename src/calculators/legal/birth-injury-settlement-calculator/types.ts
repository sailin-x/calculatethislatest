export interface BirthInjurySettlementCalculatorInputs {
...
export interface BirthInjurySettlementCalculatorOutputs {
...
export interface BirthInjurySettlementCalculatorMetrics {
...
export interface BirthInjurySettlementCalculatorAnalysis {
