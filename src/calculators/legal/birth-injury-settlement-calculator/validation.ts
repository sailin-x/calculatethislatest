import { BirthInjurySettlementCalculatorInputs } from './types';

export function validateBirthInjurySettlementCalculatorInputs(inputs: BirthInjurySettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBirthInjurySettlementCalculatorBusinessRules(inputs: BirthInjurySettlementCalculatorInputs): Array<{ field: string; message: string }> {
