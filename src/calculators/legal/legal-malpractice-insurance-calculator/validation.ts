import { LegalMalpracticeInsuranceCalculatorInputs } from './types';

export function validateLegalMalpracticeInsuranceCalculatorInputs(inputs: LegalMalpracticeInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateLegalMalpracticeInsuranceCalculatorBusinessRules(inputs: LegalMalpracticeInsuranceCalculatorInputs): Array<{ field: string; message: string }> {
