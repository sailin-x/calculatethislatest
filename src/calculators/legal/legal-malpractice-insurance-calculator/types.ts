export interface LegalMalpracticeInsuranceCalculatorInputs {
...
export interface LegalMalpracticeInsuranceCalculatorOutputs {
...
export interface LegalMalpracticeInsuranceCalculatorMetrics {
...
export interface LegalMalpracticeInsuranceCalculatorAnalysis {
