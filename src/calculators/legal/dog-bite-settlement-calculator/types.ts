export interface DogBiteSettlementCalculatorInputs {
...
export interface DogBiteSettlementCalculatorOutputs {
...
export interface DogBiteSettlementCalculatorMetrics {
...
export interface DogBiteSettlementCalculatorAnalysis {
