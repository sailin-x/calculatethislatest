import { DogBiteSettlementCalculatorInputs } from './types';

export function validateDogBiteSettlementCalculatorInputs(inputs: DogBiteSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDogBiteSettlementCalculatorBusinessRules(inputs: DogBiteSettlementCalculatorInputs): Array<{ field: string; message: string }> {
