export interface MaritimeInjuryCompensationCalculatorInputs {
...
export interface MaritimeInjuryCompensationCalculatorOutputs {
...
export interface MaritimeInjuryCompensationCalculatorMetrics {
...
export interface MaritimeInjuryCompensationCalculatorAnalysis {
