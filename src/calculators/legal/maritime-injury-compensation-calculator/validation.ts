import { MaritimeInjuryCompensationCalculatorInputs } from './types';

export function validateMaritimeInjuryCompensationCalculatorInputs(inputs: MaritimeInjuryCompensationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateMaritimeInjuryCompensationCalculatorBusinessRules(inputs: MaritimeInjuryCompensationCalculatorInputs): Array<{ field: string; message: string }> {
