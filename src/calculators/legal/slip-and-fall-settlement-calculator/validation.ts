import { SlipAndFallSettlementCalculatorInputs } from './types';

export function validateSlipAndFallSettlementCalculatorInputs(inputs: SlipAndFallSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateSlipAndFallSettlementCalculatorBusinessRules(inputs: SlipAndFallSettlementCalculatorInputs): Array<{ field: string; message: string }> {
