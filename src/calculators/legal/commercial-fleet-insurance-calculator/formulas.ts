import { CommercialFleetInsurance-calculatorInputs, CommercialFleetInsurance-calculatorMetrics, CommercialFleetInsurance-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: CommercialFleetInsurance-calculatorInputs): number {
...
export function generateAnalysis(inputs: CommercialFleetInsurance-calculatorInputs, metrics: CommercialFleetInsurance-calculatorMetrics): CommercialFleetInsurance-calculatorAnalysis {
