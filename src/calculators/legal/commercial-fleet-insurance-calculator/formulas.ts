import { commercial-fleet-insurance-calculatorInputs, commercial-fleet-insurance-calculatorMetrics, commercial-fleet-insurance-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: commercial-fleet-insurance-calculatorInputs): number {
...
export function generateAnalysis(inputs: commercial-fleet-insurance-calculatorInputs, metrics: commercial-fleet-insurance-calculatorMetrics): commercial-fleet-insurance-calculatorAnalysis {
