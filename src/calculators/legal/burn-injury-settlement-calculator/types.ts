export interface BurnInjurySettlementCalculatorInputs {
...
export interface BurnInjurySettlementCalculatorOutputs {
...
export interface BurnInjurySettlementCalculatorMetrics {
...
export interface BurnInjurySettlementCalculatorAnalysis {
