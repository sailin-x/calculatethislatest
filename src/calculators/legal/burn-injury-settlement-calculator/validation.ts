import { BurnInjurySettlementCalculatorInputs } from './types';

export function validateBurnInjurySettlementCalculatorInputs(inputs: BurnInjurySettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateBurnInjurySettlementCalculatorBusinessRules(inputs: BurnInjurySettlementCalculatorInputs): Array<{ field: string; message: string }> {
