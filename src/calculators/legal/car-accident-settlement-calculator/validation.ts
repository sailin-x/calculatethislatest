import { CarAccidentSettlementCalculatorInputs } from './types';

export function validateCarAccidentSettlementCalculatorInputs(inputs: CarAccidentSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCarAccidentSettlementCalculatorBusinessRules(inputs: CarAccidentSettlementCalculatorInputs): Array<{ field: string; message: string }> {
