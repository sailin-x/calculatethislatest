export interface CarAccidentSettlementCalculatorInputs {
...
export interface CarAccidentSettlementCalculatorOutputs {
...
export interface CarAccidentSettlementCalculatorMetrics {
...
export interface CarAccidentSettlementCalculatorAnalysis {
