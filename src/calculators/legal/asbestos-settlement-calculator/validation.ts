import { AsbestosSettlementCalculatorInputs } from './types';

export function validateAsbestosSettlementCalculatorInputs(inputs: AsbestosSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAsbestosSettlementCalculatorBusinessRules(inputs: AsbestosSettlementCalculatorInputs): Array<{ field: string; message: string }> {
