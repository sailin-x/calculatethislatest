import { PremiumDeficiencyReserve-calculatorInputs, PremiumDeficiencyReserve-calculatorMetrics, PremiumDeficiencyReserve-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: PremiumDeficiencyReserve-calculatorInputs): number {
...
export function generateAnalysis(inputs: PremiumDeficiencyReserve-calculatorInputs, metrics: PremiumDeficiencyReserve-calculatorMetrics): PremiumDeficiencyReserve-calculatorAnalysis {
