import { premium-deficiency-reserve-calculatorInputs, premium-deficiency-reserve-calculatorMetrics, premium-deficiency-reserve-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: premium-deficiency-reserve-calculatorInputs): number {
...
export function generateAnalysis(inputs: premium-deficiency-reserve-calculatorInputs, metrics: premium-deficiency-reserve-calculatorMetrics): premium-deficiency-reserve-calculatorAnalysis {
