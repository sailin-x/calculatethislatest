import { RoundupSettlementCalculatorInputs } from './types';

export function validateRoundupSettlementCalculatorInputs(inputs: RoundupSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateRoundupSettlementCalculatorBusinessRules(inputs: RoundupSettlementCalculatorInputs): Array<{ field: string; message: string }> {
