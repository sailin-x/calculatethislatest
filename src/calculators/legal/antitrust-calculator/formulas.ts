import { antitrust-calculatorInputs, antitrust-calculatorMetrics, antitrust-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: antitrust-calculatorInputs): number {
...
export function generateAnalysis(inputs: antitrust-calculatorInputs, metrics: antitrust-calculatorMetrics): antitrust-calculatorAnalysis {
