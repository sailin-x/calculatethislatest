...
import { EnvironmentalRemediationCalculatorInputs, EnvironmentalRemediationCalculatorOutputs } from './types';
import {
...
export const EnvironmentalRemediationCalculator: Calculator = {
  ...
  description: 'Calculate environmental remediation costs',
  usageInstructions: [
