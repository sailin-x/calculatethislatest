export interface NursingHomeAbuseSettlementCalculatorInputs {
...
export interface NursingHomeAbuseSettlementCalculatorOutputs {
...
export interface NursingHomeAbuseSettlementCalculatorMetrics {
...
export interface NursingHomeAbuseSettlementCalculatorAnalysis {
