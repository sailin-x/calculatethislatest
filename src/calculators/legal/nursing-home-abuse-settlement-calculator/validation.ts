import { NursingHomeAbuseSettlementCalculatorInputs } from './types';

export function validateNursingHomeAbuseSettlementCalculatorInputs(inputs: NursingHomeAbuseSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateNursingHomeAbuseSettlementCalculatorBusinessRules(inputs: NursingHomeAbuseSettlementCalculatorInputs): Array<{ field: string; message: string }> {
