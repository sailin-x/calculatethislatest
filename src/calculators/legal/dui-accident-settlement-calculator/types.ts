export interface DuiAccidentSettlementCalculatorInputs {
...
export interface DuiAccidentSettlementCalculatorOutputs {
...
export interface DuiAccidentSettlementCalculatorMetrics {
...
export interface DuiAccidentSettlementCalculatorAnalysis {
