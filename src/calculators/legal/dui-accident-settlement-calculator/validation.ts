import { DuiAccidentSettlementCalculatorInputs } from './types';

export function validateDuiAccidentSettlementCalculatorInputs(inputs: DuiAccidentSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDuiAccidentSettlementCalculatorBusinessRules(inputs: DuiAccidentSettlementCalculatorInputs): Array<{ field: string; message: string }> {
