export interface HospitalNegligenceSettlementCalculatorInputs {
...
export interface HospitalNegligenceSettlementCalculatorOutputs {
...
export interface HospitalNegligenceSettlementCalculatorMetrics {
...
export interface HospitalNegligenceSettlementCalculatorAnalysis {
