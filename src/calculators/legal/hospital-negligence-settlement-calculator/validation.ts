import { HospitalNegligenceSettlementCalculatorInputs } from './types';

export function validateHospitalNegligenceSettlementCalculatorInputs(inputs: HospitalNegligenceSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateHospitalNegligenceSettlementCalculatorBusinessRules(inputs: HospitalNegligenceSettlementCalculatorInputs): Array<{ field: string; message: string }> {
