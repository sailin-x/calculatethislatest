...
import { Chapter11BankruptcyCalculatorInputs, Chapter11BankruptcyCalculatorOutputs } from './types';
import {
...
import { validateChapter11BankruptcyCalculatorInputs } from './validation';

export const Chapter11BankruptcyCalculator: Calculator = {
  id: 'chapter-11-bankruptcy-calculator',
  title: 'Chapter 11 Bankruptcy Calculator',
  category: 'legal',
  subcategory: 'Settlement Analysis',
  description: 'Calculate Chapter 11 reorganization',
  usageInstructions: [
