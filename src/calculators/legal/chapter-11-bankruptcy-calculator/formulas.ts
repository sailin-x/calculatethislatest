import { chapter-11-bankruptcy-calculatorInputs, chapter-11-bankruptcy-calculatorMetrics, chapter-11-bankruptcy-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: chapter-11-bankruptcy-calculatorInputs): number {
...
export function generateAnalysis(inputs: chapter-11-bankruptcy-calculatorInputs, metrics: chapter-11-bankruptcy-calculatorMetrics): chapter-11-bankruptcy-calculatorAnalysis {
