import { aviation-accident-calculatorInputs, aviation-accident-calculatorMetrics, aviation-accident-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: aviation-accident-calculatorInputs): number {
...
export function generateAnalysis(inputs: aviation-accident-calculatorInputs, metrics: aviation-accident-calculatorMetrics): aviation-accident-calculatorAnalysis {
