import { AviationAccidentCalculatorinputs, AviationAccidentCalculatormetrics, AviationAccidentCalculatoranalysis } from './types';
...
export function calculateResult(inputs: AviationAccidentCalculatorinputs): number {
...
export function generateAnalysis(inputs: AviationAccidentCalculatorinputs, metrics: AviationAccidentCalculatormetrics): AviationAccidentCalculatoranalysis {
