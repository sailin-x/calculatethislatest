import { GovernmentContractBidnobidDecisionCalculatorInputs } from './types';

export function validateGovernmentContractBidnobidDecisionCalculatorInputs(inputs: GovernmentContractBidnobidDecisionCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateGovernmentContractBidnobidDecisionCalculatorBusinessRules(inputs: GovernmentContractBidnobidDecisionCalculatorInputs): Array<{ field: string; message: string }> {
