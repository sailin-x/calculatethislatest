export interface GovernmentContractBidnobidDecisionCalculatorInputs {
...
export interface GovernmentContractBidnobidDecisionCalculatorOutputs {
...
export interface GovernmentContractBidnobidDecisionCalculatorMetrics {
...
export interface GovernmentContractBidnobidDecisionCalculatorAnalysis {
