export interface TruckAccidentSettlementCalculatorInputs {
...
export interface TruckAccidentSettlementCalculatorOutputs {
...
export interface TruckAccidentSettlementCalculatorMetrics {
...
export interface TruckAccidentSettlementCalculatorAnalysis {
