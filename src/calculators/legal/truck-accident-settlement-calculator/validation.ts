import { TruckAccidentSettlementCalculatorInputs } from './types';

export function validateTruckAccidentSettlementCalculatorInputs(inputs: TruckAccidentSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTruckAccidentSettlementCalculatorBusinessRules(inputs: TruckAccidentSettlementCalculatorInputs): Array<{ field: string; message: string }> {
