export interface WrongfulDeathSettlementCalculatorInputs {
...
export interface WrongfulDeathSettlementCalculatorOutputs {
...
export interface WrongfulDeathSettlementCalculatorMetrics {
...
export interface WrongfulDeathSettlementCalculatorAnalysis {
