import { WrongfulDeathSettlementCalculatorInputs } from './types';

export function validateWrongfulDeathSettlementCalculatorInputs(inputs: WrongfulDeathSettlementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateWrongfulDeathSettlementCalculatorBusinessRules(inputs: WrongfulDeathSettlementCalculatorInputs): Array<{ field: string; message: string }> {
