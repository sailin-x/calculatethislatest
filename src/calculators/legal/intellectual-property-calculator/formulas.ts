import { intellectual-property-calculatorInputs, intellectual-property-calculatorMetrics, intellectual-property-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: intellectual-property-calculatorInputs): number {
...
export function generateAnalysis(inputs: intellectual-property-calculatorInputs, metrics: intellectual-property-calculatorMetrics): intellectual-property-calculatorAnalysis {
