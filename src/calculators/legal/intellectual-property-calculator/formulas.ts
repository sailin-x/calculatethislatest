import { IntellectualPropertyCalculatorinputs, IntellectualPropertyCalculatormetrics, IntellectualPropertyCalculatoranalysis } from './types';
...
export function calculateResult(inputs: IntellectualPropertyCalculatorinputs): number {
...
export function generateAnalysis(inputs: IntellectualPropertyCalculatorinputs, metrics: IntellectualPropertyCalculatormetrics): IntellectualPropertyCalculatoranalysis {
