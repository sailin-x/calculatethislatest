import { keto_calculatorInputs, keto_calculatorMetrics, keto_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: keto_calculatorInputs): number {
...
export function generateAnalysis(inputs: keto_calculatorInputs, metrics: keto_calculatorMetrics): keto_calculatorAnalysis {
