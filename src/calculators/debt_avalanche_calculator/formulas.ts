import { debt_avalanche_calculatorInputs, debt_avalanche_calculatorMetrics, debt_avalanche_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_avalanche_calculatorInputs): number {
...
export function generateAnalysis(inputs: debt_avalanche_calculatorInputs, metrics: debt_avalanche_calculatorMetrics): debt_avalanche_calculatorAnalysis {
