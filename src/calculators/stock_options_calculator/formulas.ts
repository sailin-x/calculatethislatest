import { stock_options_calculatorInputs, stock_options_calculatorMetrics, stock_options_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: stock_options_calculatorInputs): number {
...
export function generateAnalysis(inputs: stock_options_calculatorInputs, metrics: stock_options_calculatorMetrics): stock_options_calculatorAnalysis {
