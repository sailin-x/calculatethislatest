import { pet_insurance_calculatorCalculatorInputs, pet_insurance_calculatorCalculatorMetrics, pet_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: pet_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: pet_insurance_calculatorCalculatorInputs, metrics: pet_insurance_calculatorCalculatorMetrics): pet_insurance_calculatorCalculatorAnalysis {
