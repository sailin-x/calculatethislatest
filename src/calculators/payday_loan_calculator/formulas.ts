import { payday_loan_calculatorInputs, payday_loan_calculatorMetrics, payday_loan_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: payday_loan_calculatorInputs): number {
...
export function generateAnalysis(inputs: payday_loan_calculatorInputs, metrics: payday_loan_calculatorMetrics): payday_loan_calculatorAnalysis {
