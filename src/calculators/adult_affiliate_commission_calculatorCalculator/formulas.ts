import { adult_affiliate_commission_calculatorCalculatorInputs, adult_affiliate_commission_calculatorCalculatorMetrics, adult_affiliate_commission_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: adult_affiliate_commission_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: adult_affiliate_commission_calculatorCalculatorInputs, metrics: adult_affiliate_commission_calculatorCalculatorMetrics): adult_affiliate_commission_calculatorCalculatorAnalysis {
