import { professional_liability_insurance_calculatorCalculatorInputs, professional_liability_insurance_calculatorCalculatorMetrics, professional_liability_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: professional_liability_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: professional_liability_insurance_calculatorCalculatorInputs, metrics: professional_liability_insurance_calculatorCalculatorMetrics): professional_liability_insurance_calculatorCalculatorAnalysis {
