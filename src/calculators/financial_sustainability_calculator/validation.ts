import { financial_sustainability_calculatorInputs } from './types';

export function validateInputs(inputs: financial_sustainability_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
