import { financial_sustainability_calculatorInputs, financial_sustainability_calculatorMetrics, financial_sustainability_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_sustainability_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_sustainability_calculatorInputs, metrics: financial_sustainability_calculatorMetrics): financial_sustainability_calculatorAnalysis {
