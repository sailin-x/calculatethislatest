import { simple_ira_calculatorInputs, simple_ira_calculatorMetrics, simple_ira_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: simple_ira_calculatorInputs): number {
...
export function generateAnalysis(inputs: simple_ira_calculatorInputs, metrics: simple_ira_calculatorMetrics): simple_ira_calculatorAnalysis {
