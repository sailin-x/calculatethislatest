import { mortgage_rate_lockCalculatorInputs } from './types';

export function validateInputs(inputs: mortgage_rate_lockCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
