import { mortgage_rate_lockCalculatorInputs, mortgage_rate_lockCalculatorMetrics, mortgage_rate_lockCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgage_rate_lockCalculatorInputs): number {
...
export function generateAnalysis(inputs: mortgage_rate_lockCalculatorInputs, metrics: mortgage_rate_lockCalculatorMetrics): mortgage_rate_lockCalculatorAnalysis {
