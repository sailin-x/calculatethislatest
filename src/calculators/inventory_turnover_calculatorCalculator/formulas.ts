import { inventory_turnover_calculatorCalculatorInputs, inventory_turnover_calculatorCalculatorMetrics, inventory_turnover_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: inventory_turnover_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: inventory_turnover_calculatorCalculatorInputs, metrics: inventory_turnover_calculatorCalculatorMetrics): inventory_turnover_calculatorCalculatorAnalysis {
