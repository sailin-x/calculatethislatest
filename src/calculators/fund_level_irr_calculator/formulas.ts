import { fund_level_irr_calculatorInputs, fund_level_irr_calculatorMetrics, fund_level_irr_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fund_level_irr_calculatorInputs): number {
...
export function generateAnalysis(inputs: fund_level_irr_calculatorInputs, metrics: fund_level_irr_calculatorMetrics): fund_level_irr_calculatorAnalysis {
