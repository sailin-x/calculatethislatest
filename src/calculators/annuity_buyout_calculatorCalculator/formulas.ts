import { annuity_buyout_calculatorCalculatorInputs, annuity_buyout_calculatorCalculatorMetrics, annuity_buyout_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: annuity_buyout_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: annuity_buyout_calculatorCalculatorInputs, metrics: annuity_buyout_calculatorCalculatorMetrics): annuity_buyout_calculatorCalculatorAnalysis {
