import { annuity_buyout_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: annuity_buyout_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
