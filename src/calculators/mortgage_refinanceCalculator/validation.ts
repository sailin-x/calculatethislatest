import { mortgage_refinanceCalculatorInputs } from './types';

export function validateInputs(inputs: mortgage_refinanceCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
