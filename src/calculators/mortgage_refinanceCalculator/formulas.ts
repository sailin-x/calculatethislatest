import { mortgage_refinanceCalculatorInputs, mortgage_refinanceCalculatorMetrics, mortgage_refinanceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgage_refinanceCalculatorInputs): number {
...
export function generateAnalysis(inputs: mortgage_refinanceCalculatorInputs, metrics: mortgage_refinanceCalculatorMetrics): mortgage_refinanceCalculatorAnalysis {
