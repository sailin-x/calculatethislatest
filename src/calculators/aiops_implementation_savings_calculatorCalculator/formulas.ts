import { aiops_implementation_savings_calculatorCalculatorInputs, aiops_implementation_savings_calculatorCalculatorMetrics, aiops_implementation_savings_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: aiops_implementation_savings_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: aiops_implementation_savings_calculatorCalculatorInputs, metrics: aiops_implementation_savings_calculatorCalculatorMetrics): aiops_implementation_savings_calculatorCalculatorAnalysis {
