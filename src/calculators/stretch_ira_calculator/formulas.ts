import { stretch_ira_calculatorInputs, stretch_ira_calculatorMetrics, stretch_ira_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: stretch_ira_calculatorInputs): number {
...
export function generateAnalysis(inputs: stretch_ira_calculatorInputs, metrics: stretch_ira_calculatorMetrics): stretch_ira_calculatorAnalysis {
