import { personal_loan_calculatorCalculatorInputs, personal_loan_calculatorCalculatorMetrics, personal_loan_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: personal_loan_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: personal_loan_calculatorCalculatorInputs, metrics: personal_loan_calculatorCalculatorMetrics): personal_loan_calculatorCalculatorAnalysis {
