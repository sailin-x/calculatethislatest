import { complex_number_calculatorCalculatorInputs, complex_number_calculatorCalculatorMetrics, complex_number_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: complex_number_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: complex_number_calculatorCalculatorInputs, metrics: complex_number_calculatorCalculatorMetrics): complex_number_calculatorCalculatorAnalysis {
