import { registerSimpleIRACalculatorInputs, registerSimpleIRACalculatorMetrics, registerSimpleIRACalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerSimpleIRACalculatorInputs): number {
...
export function generateAnalysis(inputs: registerSimpleIRACalculatorInputs, metrics: registerSimpleIRACalculatorMetrics): registerSimpleIRACalculatorAnalysis {
