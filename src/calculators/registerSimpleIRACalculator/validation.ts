import { registerSimpleIRACalculatorInputs } from './types';

export function validateInputs(inputs: registerSimpleIRACalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
