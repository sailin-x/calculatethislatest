import { car_loan_calculatorCalculatorInputs, car_loan_calculatorCalculatorMetrics, car_loan_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: car_loan_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: car_loan_calculatorCalculatorInputs, metrics: car_loan_calculatorCalculatorMetrics): car_loan_calculatorCalculatorAnalysis {
