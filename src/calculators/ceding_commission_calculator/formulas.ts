import { ceding_commission_calculatorInputs, ceding_commission_calculatorMetrics, ceding_commission_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ceding_commission_calculatorInputs): number {
...
export function generateAnalysis(inputs: ceding_commission_calculatorInputs, metrics: ceding_commission_calculatorMetrics): ceding_commission_calculatorAnalysis {
