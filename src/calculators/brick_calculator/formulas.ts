import { brick_calculatorInputs, brick_calculatorMetrics, brick_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: brick_calculatorInputs): number {
...
export function generateAnalysis(inputs: brick_calculatorInputs, metrics: brick_calculatorMetrics): brick_calculatorAnalysis {
