import { leverage_ratio_calculatorInputs, leverage_ratio_calculatorMetrics, leverage_ratio_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: leverage_ratio_calculatorInputs): number {
...
export function generateAnalysis(inputs: leverage_ratio_calculatorInputs, metrics: leverage_ratio_calculatorMetrics): leverage_ratio_calculatorAnalysis {
