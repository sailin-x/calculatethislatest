import { life_settlement_value_calculatorCalculatorInputs, life_settlement_value_calculatorCalculatorMetrics, life_settlement_value_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: life_settlement_value_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: life_settlement_value_calculatorCalculatorInputs, metrics: life_settlement_value_calculatorCalculatorMetrics): life_settlement_value_calculatorCalculatorAnalysis {
