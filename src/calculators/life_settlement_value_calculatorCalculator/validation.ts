import { life_settlement_value_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: life_settlement_value_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
