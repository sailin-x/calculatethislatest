import { aviation_insurance_calculatorCalculatorInputs, aviation_insurance_calculatorCalculatorMetrics, aviation_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: aviation_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: aviation_insurance_calculatorCalculatorInputs, metrics: aviation_insurance_calculatorCalculatorMetrics): aviation_insurance_calculatorCalculatorAnalysis {
