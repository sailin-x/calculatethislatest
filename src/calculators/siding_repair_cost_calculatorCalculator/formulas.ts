import { siding_repair_cost_calculatorCalculatorInputs, siding_repair_cost_calculatorCalculatorMetrics, siding_repair_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: siding_repair_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: siding_repair_cost_calculatorCalculatorInputs, metrics: siding_repair_cost_calculatorCalculatorMetrics): siding_repair_cost_calculatorCalculatorAnalysis {
