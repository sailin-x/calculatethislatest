import { environmental_remediation_calculatorCalculatorInputs, environmental_remediation_calculatorCalculatorMetrics, environmental_remediation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: environmental_remediation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: environmental_remediation_calculatorCalculatorInputs, metrics: environmental_remediation_calculatorCalculatorMetrics): environmental_remediation_calculatorCalculatorAnalysis {
