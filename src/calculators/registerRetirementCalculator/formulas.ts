import { registerRetirementCalculatorInputs, registerRetirementCalculatorMetrics, registerRetirementCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerRetirementCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerRetirementCalculatorInputs, metrics: registerRetirementCalculatorMetrics): registerRetirementCalculatorAnalysis {
