import { registerRetirementCalculatorInputs } from './types';

export function validateInputs(inputs: registerRetirementCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
