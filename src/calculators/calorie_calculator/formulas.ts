import { calorie_calculatorInputs, calorie_calculatorMetrics, calorie_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: calorie_calculatorInputs): number {
...
export function generateAnalysis(inputs: calorie_calculatorInputs, metrics: calorie_calculatorMetrics): calorie_calculatorAnalysis {
