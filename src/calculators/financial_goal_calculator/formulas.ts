import { financial_goal_calculatorInputs, financial_goal_calculatorMetrics, financial_goal_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_goal_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_goal_calculatorInputs, metrics: financial_goal_calculatorMetrics): financial_goal_calculatorAnalysis {
