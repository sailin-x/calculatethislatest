import { birth_injury_settlement_calculatorCalculatorInputs, birth_injury_settlement_calculatorCalculatorMetrics, birth_injury_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: birth_injury_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: birth_injury_settlement_calculatorCalculatorInputs, metrics: birth_injury_settlement_calculatorCalculatorMetrics): birth_injury_settlement_calculatorCalculatorAnalysis {
