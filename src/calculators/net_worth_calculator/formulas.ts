import { net_worth_calculatorInputs, net_worth_calculatorMetrics, net_worth_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: net_worth_calculatorInputs): number {
...
export function generateAnalysis(inputs: net_worth_calculatorInputs, metrics: net_worth_calculatorMetrics): net_worth_calculatorAnalysis {
