import { food_waste_calculatorInputs, food_waste_calculatorMetrics, food_waste_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: food_waste_calculatorInputs): number {
...
export function generateAnalysis(inputs: food_waste_calculatorInputs, metrics: food_waste_calculatorMetrics): food_waste_calculatorAnalysis {
