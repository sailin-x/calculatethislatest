import { dti_ratio_calculatorInputs, dti_ratio_calculatorMetrics, dti_ratio_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: dti_ratio_calculatorInputs): number {
...
export function generateAnalysis(inputs: dti_ratio_calculatorInputs, metrics: dti_ratio_calculatorMetrics): dti_ratio_calculatorAnalysis {
