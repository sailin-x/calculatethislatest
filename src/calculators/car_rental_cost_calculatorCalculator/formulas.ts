import { car_rental_cost_calculatorCalculatorInputs, car_rental_cost_calculatorCalculatorMetrics, car_rental_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: car_rental_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: car_rental_cost_calculatorCalculatorInputs, metrics: car_rental_cost_calculatorCalculatorMetrics): car_rental_cost_calculatorCalculatorAnalysis {
