import { property_tax_appeal_savings_calculatorInputs, property_tax_appeal_savings_calculatorMetrics, property_tax_appeal_savings_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: property_tax_appeal_savings_calculatorInputs): number {
...
export function generateAnalysis(inputs: property_tax_appeal_savings_calculatorInputs, metrics: property_tax_appeal_savings_calculatorMetrics): property_tax_appeal_savings_calculatorAnalysis {
