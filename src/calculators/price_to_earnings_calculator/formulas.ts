import { price_to_earnings_calculatorInputs, price_to_earnings_calculatorMetrics, price_to_earnings_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: price_to_earnings_calculatorInputs): number {
...
export function generateAnalysis(inputs: price_to_earnings_calculatorInputs, metrics: price_to_earnings_calculatorMetrics): price_to_earnings_calculatorAnalysis {
