import { data_center_tco_calculatorCalculatorInputs, data_center_tco_calculatorCalculatorMetrics, data_center_tco_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: data_center_tco_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: data_center_tco_calculatorCalculatorInputs, metrics: data_center_tco_calculatorCalculatorMetrics): data_center_tco_calculatorCalculatorAnalysis {
