import { offshore_accident_lawyer_fee_calculatorCalculatorInputs, offshore_accident_lawyer_fee_calculatorCalculatorMetrics, offshore_accident_lawyer_fee_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: offshore_accident_lawyer_fee_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: offshore_accident_lawyer_fee_calculatorCalculatorInputs, metrics: offshore_accident_lawyer_fee_calculatorCalculatorMetrics): offshore_accident_lawyer_fee_calculatorCalculatorAnalysis {
