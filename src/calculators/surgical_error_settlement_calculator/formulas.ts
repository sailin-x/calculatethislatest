import { surgical_error_settlement_calculatorInputs, surgical_error_settlement_calculatorMetrics, surgical_error_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: surgical_error_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: surgical_error_settlement_calculatorInputs, metrics: surgical_error_settlement_calculatorMetrics): surgical_error_settlement_calculatorAnalysis {
