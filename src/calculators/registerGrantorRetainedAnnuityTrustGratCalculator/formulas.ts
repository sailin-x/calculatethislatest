import { registerGrantorRetainedAnnuityTrustGratCalculatorInputs, registerGrantorRetainedAnnuityTrustGratCalculatorMetrics, registerGrantorRetainedAnnuityTrustGratCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerGrantorRetainedAnnuityTrustGratCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerGrantorRetainedAnnuityTrustGratCalculatorInputs, metrics: registerGrantorRetainedAnnuityTrustGratCalculatorMetrics): registerGrantorRetainedAnnuityTrustGratCalculatorAnalysis {
