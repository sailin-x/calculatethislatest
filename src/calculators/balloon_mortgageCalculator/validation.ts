import { balloon_mortgageCalculatorInputs } from './types';

export function validateInputs(inputs: balloon_mortgageCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
