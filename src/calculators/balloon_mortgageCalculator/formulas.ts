import { balloon_mortgageCalculatorInputs, balloon_mortgageCalculatorMetrics, balloon_mortgageCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: balloon_mortgageCalculatorInputs): number {
...
export function generateAnalysis(inputs: balloon_mortgageCalculatorInputs, metrics: balloon_mortgageCalculatorMetrics): balloon_mortgageCalculatorAnalysis {
