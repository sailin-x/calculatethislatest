import { six_sigma_cost_savings_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: six_sigma_cost_savings_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
