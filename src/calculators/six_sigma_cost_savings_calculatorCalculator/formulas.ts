import { six_sigma_cost_savings_calculatorCalculatorInputs, six_sigma_cost_savings_calculatorCalculatorMetrics, six_sigma_cost_savings_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: six_sigma_cost_savings_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: six_sigma_cost_savings_calculatorCalculatorInputs, metrics: six_sigma_cost_savings_calculatorCalculatorMetrics): six_sigma_cost_savings_calculatorCalculatorAnalysis {
