import { car_payment_calculatorCalculatorInputs, car_payment_calculatorCalculatorMetrics, car_payment_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: car_payment_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: car_payment_calculatorCalculatorInputs, metrics: car_payment_calculatorCalculatorMetrics): car_payment_calculatorCalculatorAnalysis {
