import { registerRealEstateDevelopmentProFormaCalculatorInputs, registerRealEstateDevelopmentProFormaCalculatorMetrics, registerRealEstateDevelopmentProFormaCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerRealEstateDevelopmentProFormaCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerRealEstateDevelopmentProFormaCalculatorInputs, metrics: registerRealEstateDevelopmentProFormaCalculatorMetrics): registerRealEstateDevelopmentProFormaCalculatorAnalysis {
