import { contract_breach_calculatorInputs } from './types';

export function validateInputs(inputs: contract_breach_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
