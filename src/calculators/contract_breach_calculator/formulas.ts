import { contract_breach_calculatorInputs, contract_breach_calculatorMetrics, contract_breach_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: contract_breach_calculatorInputs): number {
...
export function generateAnalysis(inputs: contract_breach_calculatorInputs, metrics: contract_breach_calculatorMetrics): contract_breach_calculatorAnalysis {
