import { aquarium_cost_calculatorInputs, aquarium_cost_calculatorMetrics, aquarium_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: aquarium_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: aquarium_cost_calculatorInputs, metrics: aquarium_cost_calculatorMetrics): aquarium_cost_calculatorAnalysis {
