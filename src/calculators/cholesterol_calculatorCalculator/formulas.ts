import { cholesterol_calculatorCalculatorInputs, cholesterol_calculatorCalculatorMetrics, cholesterol_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cholesterol_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cholesterol_calculatorCalculatorInputs, metrics: cholesterol_calculatorCalculatorMetrics): cholesterol_calculatorCalculatorAnalysis {
