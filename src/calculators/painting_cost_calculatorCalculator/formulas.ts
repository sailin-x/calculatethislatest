import { painting_cost_calculatorCalculatorInputs, painting_cost_calculatorCalculatorMetrics, painting_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: painting_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: painting_cost_calculatorCalculatorInputs, metrics: painting_cost_calculatorCalculatorMetrics): painting_cost_calculatorCalculatorAnalysis {
