import { flooring_installation_cost_calculatorInputs } from './types';

export function validateInputs(inputs: flooring_installation_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
