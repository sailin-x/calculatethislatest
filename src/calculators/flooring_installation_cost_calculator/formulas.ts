import { flooring_installation_cost_calculatorInputs, flooring_installation_cost_calculatorMetrics, flooring_installation_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: flooring_installation_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: flooring_installation_cost_calculatorInputs, metrics: flooring_installation_cost_calculatorMetrics): flooring_installation_cost_calculatorAnalysis {
