import { dash_diet_calculatorCalculatorInputs, dash_diet_calculatorCalculatorMetrics, dash_diet_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: dash_diet_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: dash_diet_calculatorCalculatorInputs, metrics: dash_diet_calculatorCalculatorMetrics): dash_diet_calculatorCalculatorAnalysis {
