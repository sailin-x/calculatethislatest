import { dash_diet_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: dash_diet_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
