import { terrorism_insurance_calculatorCalculatorInputs, terrorism_insurance_calculatorCalculatorMetrics, terrorism_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: terrorism_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: terrorism_insurance_calculatorCalculatorInputs, metrics: terrorism_insurance_calculatorCalculatorMetrics): terrorism_insurance_calculatorCalculatorAnalysis {
