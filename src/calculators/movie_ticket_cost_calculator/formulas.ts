import { movie_ticket_cost_calculatorInputs, movie_ticket_cost_calculatorMetrics, movie_ticket_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: movie_ticket_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: movie_ticket_cost_calculatorInputs, metrics: movie_ticket_cost_calculatorMetrics): movie_ticket_cost_calculatorAnalysis {
