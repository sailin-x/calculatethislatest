import { ground_lease_valuationCalculatorInputs, ground_lease_valuationCalculatorMetrics, ground_lease_valuationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: ground_lease_valuationCalculatorInputs): number {
...
export function generateAnalysis(inputs: ground_lease_valuationCalculatorInputs, metrics: ground_lease_valuationCalculatorMetrics): ground_lease_valuationCalculatorAnalysis {
