import { ground_lease_valuationCalculatorInputs } from './types';

export function validateInputs(inputs: ground_lease_valuationCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
