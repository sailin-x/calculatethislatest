import { gas_cost_calculatorCalculatorInputs, gas_cost_calculatorCalculatorMetrics, gas_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: gas_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: gas_cost_calculatorCalculatorInputs, metrics: gas_cost_calculatorCalculatorMetrics): gas_cost_calculatorCalculatorAnalysis {
