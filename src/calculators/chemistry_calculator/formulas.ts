import { chemistry_calculatorInputs, chemistry_calculatorMetrics, chemistry_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: chemistry_calculatorInputs): number {
...
export function generateAnalysis(inputs: chemistry_calculatorInputs, metrics: chemistry_calculatorMetrics): chemistry_calculatorAnalysis {
