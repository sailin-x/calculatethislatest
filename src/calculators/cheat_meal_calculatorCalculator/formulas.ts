import { cheat_meal_calculatorCalculatorInputs, cheat_meal_calculatorCalculatorMetrics, cheat_meal_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cheat_meal_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cheat_meal_calculatorCalculatorInputs, metrics: cheat_meal_calculatorCalculatorMetrics): cheat_meal_calculatorCalculatorAnalysis {
