import { roundup_settlement_calculatorInputs, roundup_settlement_calculatorMetrics, roundup_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: roundup_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: roundup_settlement_calculatorInputs, metrics: roundup_settlement_calculatorMetrics): roundup_settlement_calculatorAnalysis {
