import { registerRealEstateTaxDeductionsCalculatorInputs, registerRealEstateTaxDeductionsCalculatorMetrics, registerRealEstateTaxDeductionsCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerRealEstateTaxDeductionsCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerRealEstateTaxDeductionsCalculatorInputs, metrics: registerRealEstateTaxDeductionsCalculatorMetrics): registerRealEstateTaxDeductionsCalculatorAnalysis {
