import { registerRealEstateTaxDeductionsCalculatorInputs } from './types';

export function validateInputs(inputs: registerRealEstateTaxDeductionsCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
