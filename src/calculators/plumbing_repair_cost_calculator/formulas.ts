import { plumbing_repair_cost_calculatorInputs, plumbing_repair_cost_calculatorMetrics, plumbing_repair_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: plumbing_repair_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: plumbing_repair_cost_calculatorInputs, metrics: plumbing_repair_cost_calculatorMetrics): plumbing_repair_cost_calculatorAnalysis {
