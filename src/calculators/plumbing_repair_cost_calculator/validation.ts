import { plumbing_repair_cost_calculatorInputs } from './types';

export function validateInputs(inputs: plumbing_repair_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
