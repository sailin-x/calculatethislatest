...
export function validateStretchIraCalculatorInputs(inputs: StretchIraCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateStretchIraCalculatorBusinessRules(inputs: StretchIraCalculatorInputs): Array<{ field: string; message: string }> {
