import { RequiredMinimumDistribution(rmd)CalculatorInputs } from './types';

export function validateRequiredMinimumDistribution(rmd)CalculatorInputs(inputs: RequiredMinimumDistribution(rmd)CalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateRequiredMinimumDistribution(rmd)CalculatorBusinessRules(inputs: RequiredMinimumDistribution(rmd)CalculatorInputs): Array<{ field: string; message: string }> {
