...
import { validateSimpleIraCalculatorInputs, validateSimpleIraCalculatorBusinessRules } from './validation';

export const SimpleIraCalculatorCalculator: Calculator: Calculator = {
  id: 'simple-ira-calculator-calculator',
