...
export function validateSimpleIraCalculatorInputs(inputs: SimpleIraCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateSimpleIraCalculatorBusinessRules(inputs: SimpleIraCalculatorInputs): Array<{ field: string; message: string }> {
