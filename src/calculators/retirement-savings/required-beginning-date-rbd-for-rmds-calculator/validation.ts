import { RequiredBeginningDate(rbd)ForRmdsCalculatorInputs } from './types';

export function validateRequiredBeginningDate(rbd)ForRmdsCalculatorInputs(inputs: RequiredBeginningDate(rbd)ForRmdsCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateRequiredBeginningDate(rbd)ForRmdsCalculatorBusinessRules(inputs: RequiredBeginningDate(rbd)ForRmdsCalculatorInputs): Array<{ field: string; message: string }> {
