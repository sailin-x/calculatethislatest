...
export function validateSepIraCalculatorInputs(inputs: SepIraCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateSepIraCalculatorBusinessRules(inputs: SepIraCalculatorInputs): Array<{ field: string; message: string }> {
