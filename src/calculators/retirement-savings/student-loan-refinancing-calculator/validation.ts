...
export function validateStudentLoanRefinancingCalculatorInputs(inputs: StudentLoanRefinancingCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateStudentLoanRefinancingCalculatorBusinessRules(inputs: StudentLoanRefinancingCalculatorInputs): Array<{ field: string; message: string }> {
