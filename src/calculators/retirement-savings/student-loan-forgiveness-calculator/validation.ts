import { StudentLoanForgivenessCalculatorInputs } from './types';

export function validateStudentLoanForgivenessCalculatorInputs(inputs: StudentLoanForgivenessCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateStudentLoanForgivenessCalculatorBusinessRules(inputs: StudentLoanForgivenessCalculatorInputs): Array<{ field: string; message: string }> {
