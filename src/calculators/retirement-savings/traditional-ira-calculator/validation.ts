...
export function validateTraditionalIraCalculatorInputs(inputs: TraditionalIraCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTraditionalIraCalculatorBusinessRules(inputs: TraditionalIraCalculatorInputs): Array<{ field: string; message: string }> {
