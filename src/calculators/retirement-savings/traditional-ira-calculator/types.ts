export interface TraditionalIraCalculatorInputs {
...
export interface TraditionalIraCalculatorOutputs {
...
export interface TraditionalIraCalculatorMetrics {
...
export interface TraditionalIraCalculatorAnalysis {
