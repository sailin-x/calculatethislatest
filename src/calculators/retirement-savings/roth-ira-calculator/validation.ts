...
export function validateRothIraCalculatorInputs(inputs: RothIraCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateRothIraCalculatorBusinessRules(inputs: RothIraCalculatorInputs): Array<{ field: string; message: string }> {
