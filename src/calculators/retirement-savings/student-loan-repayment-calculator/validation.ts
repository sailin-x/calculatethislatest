...
export function validateStudentLoanRepaymentCalculatorInputs(inputs: StudentLoanRepaymentCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateStudentLoanRepaymentCalculatorBusinessRules(inputs: StudentLoanRepaymentCalculatorInputs): Array<{ field: string; message: string }> {
