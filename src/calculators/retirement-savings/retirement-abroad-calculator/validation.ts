import { RetirementAbroadCalculatorInputs } from './types';

export function validateRetirementAbroadCalculatorInputs(inputs: RetirementAbroadCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateRetirementAbroadCalculatorBusinessRules(inputs: RetirementAbroadCalculatorInputs): Array<{ field: string; message: string }> {
