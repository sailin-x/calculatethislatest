import { offshore_accident_lawyer_fee_calculatorInputs, offshore_accident_lawyer_fee_calculatorMetrics, offshore_accident_lawyer_fee_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: offshore_accident_lawyer_fee_calculatorInputs): number {
...
export function generateAnalysis(inputs: offshore_accident_lawyer_fee_calculatorInputs, metrics: offshore_accident_lawyer_fee_calculatorMetrics): offshore_accident_lawyer_fee_calculatorAnalysis {
