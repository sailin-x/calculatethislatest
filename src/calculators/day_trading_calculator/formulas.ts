import { day_trading_calculatorInputs, day_trading_calculatorMetrics, day_trading_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: day_trading_calculatorInputs): number {
...
export function generateAnalysis(inputs: day_trading_calculatorInputs, metrics: day_trading_calculatorMetrics): day_trading_calculatorAnalysis {
