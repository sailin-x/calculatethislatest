import { cryptocurrency_investment_calculatorCalculatorInputs, cryptocurrency_investment_calculatorCalculatorMetrics, cryptocurrency_investment_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cryptocurrency_investment_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cryptocurrency_investment_calculatorCalculatorInputs, metrics: cryptocurrency_investment_calculatorCalculatorMetrics): cryptocurrency_investment_calculatorCalculatorAnalysis {
