import { e_discovery_cost_calculatorInputs, e_discovery_cost_calculatorMetrics, e_discovery_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: e_discovery_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: e_discovery_cost_calculatorInputs, metrics: e_discovery_cost_calculatorMetrics): e_discovery_cost_calculatorAnalysis {
