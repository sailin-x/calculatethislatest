import { surety_bond_premium_calculatorCalculatorInputs, surety_bond_premium_calculatorCalculatorMetrics, surety_bond_premium_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: surety_bond_premium_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: surety_bond_premium_calculatorCalculatorInputs, metrics: surety_bond_premium_calculatorCalculatorMetrics): surety_bond_premium_calculatorCalculatorAnalysis {
