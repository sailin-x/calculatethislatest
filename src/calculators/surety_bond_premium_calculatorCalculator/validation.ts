import { surety_bond_premium_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: surety_bond_premium_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
