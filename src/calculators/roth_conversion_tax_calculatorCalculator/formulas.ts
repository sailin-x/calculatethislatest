import { roth_conversion_tax_calculatorCalculatorInputs, roth_conversion_tax_calculatorCalculatorMetrics, roth_conversion_tax_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: roth_conversion_tax_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: roth_conversion_tax_calculatorCalculatorInputs, metrics: roth_conversion_tax_calculatorCalculatorMetrics): roth_conversion_tax_calculatorCalculatorAnalysis {
