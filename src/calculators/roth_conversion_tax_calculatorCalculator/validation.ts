import { roth_conversion_tax_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: roth_conversion_tax_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
