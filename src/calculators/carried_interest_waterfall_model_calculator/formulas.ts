import { carried_interest_waterfall_model_calculatorInputs, carried_interest_waterfall_model_calculatorMetrics, carried_interest_waterfall_model_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: carried_interest_waterfall_model_calculatorInputs): number {
...
export function generateAnalysis(inputs: carried_interest_waterfall_model_calculatorInputs, metrics: carried_interest_waterfall_model_calculatorMetrics): carried_interest_waterfall_model_calculatorAnalysis {
