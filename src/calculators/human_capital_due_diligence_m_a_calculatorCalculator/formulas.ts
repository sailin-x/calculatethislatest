import { human_capital_due_diligence_m_a_calculatorCalculatorInputs, human_capital_due_diligence_m_a_calculatorCalculatorMetrics, human_capital_due_diligence_m_a_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: human_capital_due_diligence_m_a_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: human_capital_due_diligence_m_a_calculatorCalculatorInputs, metrics: human_capital_due_diligence_m_a_calculatorCalculatorMetrics): human_capital_due_diligence_m_a_calculatorCalculatorAnalysis {
