import { tile_calculatorInputs, tile_calculatorMetrics, tile_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: tile_calculatorInputs): number {
...
export function generateAnalysis(inputs: tile_calculatorInputs, metrics: tile_calculatorMetrics): tile_calculatorAnalysis {
