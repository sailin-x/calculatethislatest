import { premises_liability_settlement_calculatorInputs, premises_liability_settlement_calculatorMetrics, premises_liability_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: premises_liability_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: premises_liability_settlement_calculatorInputs, metrics: premises_liability_settlement_calculatorMetrics): premises_liability_settlement_calculatorAnalysis {
