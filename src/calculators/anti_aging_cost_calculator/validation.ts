import { anti_aging_cost_calculatorInputs } from './types';

export function validateInputs(inputs: anti_aging_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
