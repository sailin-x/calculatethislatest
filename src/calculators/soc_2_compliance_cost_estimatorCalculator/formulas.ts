import { soc_2_compliance_cost_estimatorCalculatorInputs, soc_2_compliance_cost_estimatorCalculatorMetrics, soc_2_compliance_cost_estimatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: soc_2_compliance_cost_estimatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: soc_2_compliance_cost_estimatorCalculatorInputs, metrics: soc_2_compliance_cost_estimatorCalculatorMetrics): soc_2_compliance_cost_estimatorCalculatorAnalysis {
