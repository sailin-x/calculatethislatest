import { soc_2_compliance_cost_estimatorCalculatorInputs } from './types';

export function validateInputs(inputs: soc_2_compliance_cost_estimatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
