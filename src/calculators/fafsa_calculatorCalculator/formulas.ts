import { fafsa_calculatorCalculatorInputs, fafsa_calculatorCalculatorMetrics, fafsa_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fafsa_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: fafsa_calculatorCalculatorInputs, metrics: fafsa_calculatorCalculatorMetrics): fafsa_calculatorCalculatorAnalysis {
