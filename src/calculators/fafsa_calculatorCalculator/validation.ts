import { fafsa_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: fafsa_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
