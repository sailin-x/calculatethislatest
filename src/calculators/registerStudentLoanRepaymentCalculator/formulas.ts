import { registerStudentLoanRepaymentCalculatorInputs, registerStudentLoanRepaymentCalculatorMetrics, registerStudentLoanRepaymentCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerStudentLoanRepaymentCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerStudentLoanRepaymentCalculatorInputs, metrics: registerStudentLoanRepaymentCalculatorMetrics): registerStudentLoanRepaymentCalculatorAnalysis {
