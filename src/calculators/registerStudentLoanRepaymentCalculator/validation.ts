import { registerStudentLoanRepaymentCalculatorInputs } from './types';

export function validateInputs(inputs: registerStudentLoanRepaymentCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
