import { chaturbate_token_calculatorCalculatorInputs, chaturbate_token_calculatorCalculatorMetrics, chaturbate_token_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: chaturbate_token_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: chaturbate_token_calculatorCalculatorInputs, metrics: chaturbate_token_calculatorCalculatorMetrics): chaturbate_token_calculatorCalculatorAnalysis {
