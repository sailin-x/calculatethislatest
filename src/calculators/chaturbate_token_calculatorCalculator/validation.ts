import { chaturbate_token_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: chaturbate_token_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
