import { employee_stock_option_plan_esop_valuation_calculatorInputs, employee_stock_option_plan_esop_valuation_calculatorMetrics, employee_stock_option_plan_esop_valuation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: employee_stock_option_plan_esop_valuation_calculatorInputs): number {
...
export function generateAnalysis(inputs: employee_stock_option_plan_esop_valuation_calculatorInputs, metrics: employee_stock_option_plan_esop_valuation_calculatorMetrics): employee_stock_option_plan_esop_valuation_calculatorAnalysis {
