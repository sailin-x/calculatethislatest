import { rothConversionTaxCalculatorInputs, rothConversionTaxCalculatorMetrics, rothConversionTaxCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: rothConversionTaxCalculatorInputs): number {
...
export function generateAnalysis(inputs: rothConversionTaxCalculatorInputs, metrics: rothConversionTaxCalculatorMetrics): rothConversionTaxCalculatorAnalysis {
