import { medical_malpractice_damages_calculatorCalculatorInputs, medical_malpractice_damages_calculatorCalculatorMetrics, medical_malpractice_damages_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: medical_malpractice_damages_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: medical_malpractice_damages_calculatorCalculatorInputs, metrics: medical_malpractice_damages_calculatorCalculatorMetrics): medical_malpractice_damages_calculatorCalculatorAnalysis {
