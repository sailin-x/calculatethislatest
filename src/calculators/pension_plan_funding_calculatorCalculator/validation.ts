import { pension_plan_funding_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: pension_plan_funding_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
