import { pension_plan_funding_calculatorCalculatorInputs, pension_plan_funding_calculatorCalculatorMetrics, pension_plan_funding_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: pension_plan_funding_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: pension_plan_funding_calculatorCalculatorInputs, metrics: pension_plan_funding_calculatorCalculatorMetrics): pension_plan_funding_calculatorCalculatorAnalysis {
