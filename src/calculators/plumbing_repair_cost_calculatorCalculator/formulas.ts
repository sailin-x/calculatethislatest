import { plumbing_repair_cost_calculatorCalculatorInputs, plumbing_repair_cost_calculatorCalculatorMetrics, plumbing_repair_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: plumbing_repair_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: plumbing_repair_cost_calculatorCalculatorInputs, metrics: plumbing_repair_cost_calculatorCalculatorMetrics): plumbing_repair_cost_calculatorCalculatorAnalysis {
