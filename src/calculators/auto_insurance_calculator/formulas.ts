import { auto_insurance_calculatorInputs, auto_insurance_calculatorMetrics, auto_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: auto_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: auto_insurance_calculatorInputs, metrics: auto_insurance_calculatorMetrics): auto_insurance_calculatorAnalysis {
