import { analytics_cost_calculatorCalculatorInputs, analytics_cost_calculatorCalculatorMetrics, analytics_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: analytics_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: analytics_cost_calculatorCalculatorInputs, metrics: analytics_cost_calculatorCalculatorMetrics): analytics_cost_calculatorCalculatorAnalysis {
