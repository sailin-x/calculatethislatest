import { matrixCalculatorInputs, matrixCalculatorMetrics, matrixCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: matrixCalculatorInputs): number {
...
export function generateAnalysis(inputs: matrixCalculatorInputs, metrics: matrixCalculatorMetrics): matrixCalculatorAnalysis {
