import { debt_to_equity_calculatorCalculatorInputs, debt_to_equity_calculatorCalculatorMetrics, debt_to_equity_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_to_equity_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: debt_to_equity_calculatorCalculatorInputs, metrics: debt_to_equity_calculatorCalculatorMetrics): debt_to_equity_calculatorCalculatorAnalysis {
