import { debt_to_equity_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: debt_to_equity_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
