import { hr_tech_stack_roi_calculatorInputs, hr_tech_stack_roi_calculatorMetrics, hr_tech_stack_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: hr_tech_stack_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: hr_tech_stack_roi_calculatorInputs, metrics: hr_tech_stack_roi_calculatorMetrics): hr_tech_stack_roi_calculatorAnalysis {
