import { naturopathic_medicine_cost_calculatorCalculatorInputs, naturopathic_medicine_cost_calculatorCalculatorMetrics, naturopathic_medicine_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: naturopathic_medicine_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: naturopathic_medicine_cost_calculatorCalculatorInputs, metrics: naturopathic_medicine_cost_calculatorCalculatorMetrics): naturopathic_medicine_cost_calculatorCalculatorAnalysis {
