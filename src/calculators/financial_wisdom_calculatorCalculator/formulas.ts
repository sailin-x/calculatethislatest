import { financial_wisdom_calculatorCalculatorInputs, financial_wisdom_calculatorCalculatorMetrics, financial_wisdom_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_wisdom_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_wisdom_calculatorCalculatorInputs, metrics: financial_wisdom_calculatorCalculatorMetrics): financial_wisdom_calculatorCalculatorAnalysis {
