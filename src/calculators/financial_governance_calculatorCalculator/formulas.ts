import { financial_governance_calculatorCalculatorInputs, financial_governance_calculatorCalculatorMetrics, financial_governance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_governance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_governance_calculatorCalculatorInputs, metrics: financial_governance_calculatorCalculatorMetrics): financial_governance_calculatorCalculatorAnalysis {
