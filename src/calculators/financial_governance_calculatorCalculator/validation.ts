import { financial_governance_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: financial_governance_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
