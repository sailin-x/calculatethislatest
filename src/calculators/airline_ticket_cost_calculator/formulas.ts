import { airline_ticket_cost_calculatorInputs, airline_ticket_cost_calculatorMetrics, airline_ticket_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: airline_ticket_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: airline_ticket_cost_calculatorInputs, metrics: airline_ticket_cost_calculatorMetrics): airline_ticket_cost_calculatorAnalysis {
