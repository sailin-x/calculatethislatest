import { health_savings_account_hsa_calculatorCalculatorInputs, health_savings_account_hsa_calculatorCalculatorMetrics, health_savings_account_hsa_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: health_savings_account_hsa_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: health_savings_account_hsa_calculatorCalculatorInputs, metrics: health_savings_account_hsa_calculatorCalculatorMetrics): health_savings_account_hsa_calculatorCalculatorAnalysis {
