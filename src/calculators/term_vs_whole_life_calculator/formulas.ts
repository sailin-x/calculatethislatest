import { term_vs_whole_life_calculatorInputs, term_vs_whole_life_calculatorMetrics, term_vs_whole_life_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: term_vs_whole_life_calculatorInputs): number {
...
export function generateAnalysis(inputs: term_vs_whole_life_calculatorInputs, metrics: term_vs_whole_life_calculatorMetrics): term_vs_whole_life_calculatorAnalysis {
