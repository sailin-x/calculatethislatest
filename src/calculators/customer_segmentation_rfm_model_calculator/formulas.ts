import { customer_segmentation_rfm_model_calculatorInputs, customer_segmentation_rfm_model_calculatorMetrics, customer_segmentation_rfm_model_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: customer_segmentation_rfm_model_calculatorInputs): number {
...
export function generateAnalysis(inputs: customer_segmentation_rfm_model_calculatorInputs, metrics: customer_segmentation_rfm_model_calculatorMetrics): customer_segmentation_rfm_model_calculatorAnalysis {
