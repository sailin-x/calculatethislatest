import { real_estate_syndication_calculatorCalculatorInputs, real_estate_syndication_calculatorCalculatorMetrics, real_estate_syndication_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: real_estate_syndication_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: real_estate_syndication_calculatorCalculatorInputs, metrics: real_estate_syndication_calculatorCalculatorMetrics): real_estate_syndication_calculatorCalculatorAnalysis {
