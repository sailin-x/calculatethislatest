import { pool_maintenance_cost_calculatorCalculatorInputs, pool_maintenance_cost_calculatorCalculatorMetrics, pool_maintenance_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: pool_maintenance_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: pool_maintenance_cost_calculatorCalculatorInputs, metrics: pool_maintenance_cost_calculatorCalculatorMetrics): pool_maintenance_cost_calculatorCalculatorAnalysis {
