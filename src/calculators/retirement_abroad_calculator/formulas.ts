import { retirement_abroad_calculatorInputs, retirement_abroad_calculatorMetrics, retirement_abroad_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: retirement_abroad_calculatorInputs): number {
...
export function generateAnalysis(inputs: retirement_abroad_calculatorInputs, metrics: retirement_abroad_calculatorMetrics): retirement_abroad_calculatorAnalysis {
