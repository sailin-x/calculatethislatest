import { free_cash_flow_to_equity_calculatorCalculatorInputs, free_cash_flow_to_equity_calculatorCalculatorMetrics, free_cash_flow_to_equity_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: free_cash_flow_to_equity_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: free_cash_flow_to_equity_calculatorCalculatorInputs, metrics: free_cash_flow_to_equity_calculatorCalculatorMetrics): free_cash_flow_to_equity_calculatorCalculatorAnalysis {
