import { souvenir_cost_calculatorInputs, souvenir_cost_calculatorMetrics, souvenir_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: souvenir_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: souvenir_cost_calculatorInputs, metrics: souvenir_cost_calculatorMetrics): souvenir_cost_calculatorAnalysis {
