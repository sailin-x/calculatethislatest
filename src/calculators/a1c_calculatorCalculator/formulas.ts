import { a1c_calculatorCalculatorInputs, a1c_calculatorCalculatorMetrics, a1c_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: a1c_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: a1c_calculatorCalculatorInputs, metrics: a1c_calculatorCalculatorMetrics): a1c_calculatorCalculatorAnalysis {
