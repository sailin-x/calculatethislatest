import { gym_membership_cost_calculatorInputs } from './types';

export function validateInputs(inputs: gym_membership_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
