import { gym_membership_cost_calculatorInputs, gym_membership_cost_calculatorMetrics, gym_membership_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: gym_membership_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: gym_membership_cost_calculatorInputs, metrics: gym_membership_cost_calculatorMetrics): gym_membership_cost_calculatorAnalysis {
