import { dialysis_center_profitability_calculatorInputs, dialysis_center_profitability_calculatorMetrics, dialysis_center_profitability_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: dialysis_center_profitability_calculatorInputs): number {
...
export function generateAnalysis(inputs: dialysis_center_profitability_calculatorInputs, metrics: dialysis_center_profitability_calculatorMetrics): dialysis_center_profitability_calculatorAnalysis {
