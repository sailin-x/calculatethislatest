import { property_insurance_calculatorInputs, property_insurance_calculatorMetrics, property_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: property_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: property_insurance_calculatorInputs, metrics: property_insurance_calculatorMetrics): property_insurance_calculatorAnalysis {
