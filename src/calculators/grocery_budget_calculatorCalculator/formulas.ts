import { grocery_budget_calculatorCalculatorInputs, grocery_budget_calculatorCalculatorMetrics, grocery_budget_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: grocery_budget_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: grocery_budget_calculatorCalculatorInputs, metrics: grocery_budget_calculatorCalculatorMetrics): grocery_budget_calculatorCalculatorAnalysis {
