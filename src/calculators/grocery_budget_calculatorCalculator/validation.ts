import { grocery_budget_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: grocery_budget_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
