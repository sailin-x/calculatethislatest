import { registerRentalYieldCalculatorInputs } from './types';

export function validateInputs(inputs: registerRentalYieldCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
