import { registerRentalYieldCalculatorInputs, registerRentalYieldCalculatorMetrics, registerRentalYieldCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerRentalYieldCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerRentalYieldCalculatorInputs, metrics: registerRentalYieldCalculatorMetrics): registerRentalYieldCalculatorAnalysis {
