import { terrorism_insurance_calculatorInputs, terrorism_insurance_calculatorMetrics, terrorism_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: terrorism_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: terrorism_insurance_calculatorInputs, metrics: terrorism_insurance_calculatorMetrics): terrorism_insurance_calculatorAnalysis {
