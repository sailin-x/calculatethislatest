import { cost_per_hire_calculatorInputs, cost_per_hire_calculatorMetrics, cost_per_hire_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cost_per_hire_calculatorInputs): number {
...
export function generateAnalysis(inputs: cost_per_hire_calculatorInputs, metrics: cost_per_hire_calculatorMetrics): cost_per_hire_calculatorAnalysis {
