import { defi_yield_optimization_calculatorCalculatorInputs, defi_yield_optimization_calculatorCalculatorMetrics, defi_yield_optimization_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: defi_yield_optimization_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: defi_yield_optimization_calculatorCalculatorInputs, metrics: defi_yield_optimization_calculatorCalculatorMetrics): defi_yield_optimization_calculatorCalculatorAnalysis {
