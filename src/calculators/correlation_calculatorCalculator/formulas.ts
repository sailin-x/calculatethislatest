import { correlation_calculatorCalculatorInputs, correlation_calculatorCalculatorMetrics, correlation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: correlation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: correlation_calculatorCalculatorInputs, metrics: correlation_calculatorCalculatorMetrics): correlation_calculatorCalculatorAnalysis {
