import { self_funded_health_plan_vs_fully_insured_calculatorCalculatorInputs, self_funded_health_plan_vs_fully_insured_calculatorCalculatorMetrics, self_funded_health_plan_vs_fully_insured_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: self_funded_health_plan_vs_fully_insured_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: self_funded_health_plan_vs_fully_insured_calculatorCalculatorInputs, metrics: self_funded_health_plan_vs_fully_insured_calculatorCalculatorMetrics): self_funded_health_plan_vs_fully_insured_calculatorCalculatorAnalysis {
