import { municipal_bond_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: municipal_bond_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
