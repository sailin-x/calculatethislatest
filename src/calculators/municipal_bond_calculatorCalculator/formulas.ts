import { municipal_bond_calculatorCalculatorInputs, municipal_bond_calculatorCalculatorMetrics, municipal_bond_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: municipal_bond_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: municipal_bond_calculatorCalculatorInputs, metrics: municipal_bond_calculatorCalculatorMetrics): municipal_bond_calculatorCalculatorAnalysis {
