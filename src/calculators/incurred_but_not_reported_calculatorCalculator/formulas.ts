import { incurred_but_not_reported_calculatorCalculatorInputs, incurred_but_not_reported_calculatorCalculatorMetrics, incurred_but_not_reported_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: incurred_but_not_reported_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: incurred_but_not_reported_calculatorCalculatorInputs, metrics: incurred_but_not_reported_calculatorCalculatorMetrics): incurred_but_not_reported_calculatorCalculatorAnalysis {
