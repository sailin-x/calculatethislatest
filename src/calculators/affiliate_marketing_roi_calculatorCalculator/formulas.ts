import { affiliate_marketing_roi_calculatorCalculatorInputs, affiliate_marketing_roi_calculatorCalculatorMetrics, affiliate_marketing_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: affiliate_marketing_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: affiliate_marketing_roi_calculatorCalculatorInputs, metrics: affiliate_marketing_roi_calculatorCalculatorMetrics): affiliate_marketing_roi_calculatorCalculatorAnalysis {
