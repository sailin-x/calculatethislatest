import { split_dollar_life_insurance_calculatorCalculatorInputs, split_dollar_life_insurance_calculatorCalculatorMetrics, split_dollar_life_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: split_dollar_life_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: split_dollar_life_insurance_calculatorCalculatorInputs, metrics: split_dollar_life_insurance_calculatorCalculatorMetrics): split_dollar_life_insurance_calculatorCalculatorAnalysis {
