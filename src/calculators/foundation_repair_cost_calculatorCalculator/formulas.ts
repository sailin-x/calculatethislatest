import { foundation_repair_cost_calculatorCalculatorInputs, foundation_repair_cost_calculatorCalculatorMetrics, foundation_repair_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: foundation_repair_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: foundation_repair_cost_calculatorCalculatorInputs, metrics: foundation_repair_cost_calculatorCalculatorMetrics): foundation_repair_cost_calculatorCalculatorAnalysis {
