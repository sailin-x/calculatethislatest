import { motorcycle_accident_compensation_calculatorInputs, motorcycle_accident_compensation_calculatorMetrics, motorcycle_accident_compensation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: motorcycle_accident_compensation_calculatorInputs): number {
...
export function generateAnalysis(inputs: motorcycle_accident_compensation_calculatorInputs, metrics: motorcycle_accident_compensation_calculatorMetrics): motorcycle_accident_compensation_calculatorAnalysis {
