import { networking_calculatorInputs, networking_calculatorMetrics, networking_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: networking_calculatorInputs): number {
...
export function generateAnalysis(inputs: networking_calculatorInputs, metrics: networking_calculatorMetrics): networking_calculatorAnalysis {
