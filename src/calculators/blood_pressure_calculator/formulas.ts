import { blood_pressure_calculatorInputs, blood_pressure_calculatorMetrics, blood_pressure_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: blood_pressure_calculatorInputs): number {
...
export function generateAnalysis(inputs: blood_pressure_calculatorInputs, metrics: blood_pressure_calculatorMetrics): blood_pressure_calculatorAnalysis {
