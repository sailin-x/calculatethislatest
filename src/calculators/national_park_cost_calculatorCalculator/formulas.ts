import { national_park_cost_calculatorCalculatorInputs, national_park_cost_calculatorCalculatorMetrics, national_park_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: national_park_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: national_park_cost_calculatorCalculatorInputs, metrics: national_park_cost_calculatorCalculatorMetrics): national_park_cost_calculatorCalculatorAnalysis {
