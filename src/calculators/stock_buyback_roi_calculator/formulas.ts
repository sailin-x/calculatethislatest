import { stock_buyback_roi_calculatorInputs, stock_buyback_roi_calculatorMetrics, stock_buyback_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: stock_buyback_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: stock_buyback_roi_calculatorInputs, metrics: stock_buyback_roi_calculatorMetrics): stock_buyback_roi_calculatorAnalysis {
