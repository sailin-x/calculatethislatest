import { book_publishing_advance_calculatorCalculatorInputs, book_publishing_advance_calculatorCalculatorMetrics, book_publishing_advance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: book_publishing_advance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: book_publishing_advance_calculatorCalculatorInputs, metrics: book_publishing_advance_calculatorCalculatorMetrics): book_publishing_advance_calculatorCalculatorAnalysis {
