import { sharpe_ratio_calculatorInputs, sharpe_ratio_calculatorMetrics, sharpe_ratio_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: sharpe_ratio_calculatorInputs): number {
...
export function generateAnalysis(inputs: sharpe_ratio_calculatorInputs, metrics: sharpe_ratio_calculatorMetrics): sharpe_ratio_calculatorAnalysis {
