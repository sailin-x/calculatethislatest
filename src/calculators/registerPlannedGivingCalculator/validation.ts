import { registerPlannedGivingCalculatorInputs } from './types';

export function validateInputs(inputs: registerPlannedGivingCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
