import { registerPlannedGivingCalculatorInputs, registerPlannedGivingCalculatorMetrics, registerPlannedGivingCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerPlannedGivingCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerPlannedGivingCalculatorInputs, metrics: registerPlannedGivingCalculatorMetrics): registerPlannedGivingCalculatorAnalysis {
