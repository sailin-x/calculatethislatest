import { asphalt_calculatorCalculatorInputs, asphalt_calculatorCalculatorMetrics, asphalt_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: asphalt_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: asphalt_calculatorCalculatorInputs, metrics: asphalt_calculatorCalculatorMetrics): asphalt_calculatorCalculatorAnalysis {
