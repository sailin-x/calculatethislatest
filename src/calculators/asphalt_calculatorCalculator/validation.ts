import { asphalt_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: asphalt_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
