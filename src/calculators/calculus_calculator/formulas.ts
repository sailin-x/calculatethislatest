import { calculus_calculatorInputs, calculus_calculatorMetrics, calculus_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: calculus_calculatorInputs): number {
...
export function generateAnalysis(inputs: calculus_calculatorInputs, metrics: calculus_calculatorMetrics): calculus_calculatorAnalysis {
