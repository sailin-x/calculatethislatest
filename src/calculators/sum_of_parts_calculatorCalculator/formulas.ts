import { sum_of_parts_calculatorCalculatorInputs, sum_of_parts_calculatorCalculatorMetrics, sum_of_parts_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: sum_of_parts_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: sum_of_parts_calculatorCalculatorInputs, metrics: sum_of_parts_calculatorCalculatorMetrics): sum_of_parts_calculatorCalculatorAnalysis {
