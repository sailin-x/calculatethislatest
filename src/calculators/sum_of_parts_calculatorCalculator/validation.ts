import { sum_of_parts_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: sum_of_parts_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
