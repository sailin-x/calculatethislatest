import { accident_insurance_calculatorInputs, accident_insurance_calculatorMetrics, accident_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: accident_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: accident_insurance_calculatorInputs, metrics: accident_insurance_calculatorMetrics): accident_insurance_calculatorAnalysis {
