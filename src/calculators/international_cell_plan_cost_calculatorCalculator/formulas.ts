import { international_cell_plan_cost_calculatorCalculatorInputs, international_cell_plan_cost_calculatorCalculatorMetrics, international_cell_plan_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: international_cell_plan_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: international_cell_plan_cost_calculatorCalculatorInputs, metrics: international_cell_plan_cost_calculatorCalculatorMetrics): international_cell_plan_cost_calculatorCalculatorAnalysis {
