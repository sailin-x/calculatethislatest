import { bad_faith_insurance_calculatorCalculatorInputs, bad_faith_insurance_calculatorCalculatorMetrics, bad_faith_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: bad_faith_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: bad_faith_insurance_calculatorCalculatorInputs, metrics: bad_faith_insurance_calculatorCalculatorMetrics): bad_faith_insurance_calculatorCalculatorAnalysis {
