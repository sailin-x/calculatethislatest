import { statistics_calculatorCalculatorInputs, statistics_calculatorCalculatorMetrics, statistics_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: statistics_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: statistics_calculatorCalculatorInputs, metrics: statistics_calculatorCalculatorMetrics): statistics_calculatorCalculatorAnalysis {
