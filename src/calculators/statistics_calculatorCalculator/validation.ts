import { statistics_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: statistics_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
