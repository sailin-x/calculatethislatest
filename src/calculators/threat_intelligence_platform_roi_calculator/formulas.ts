import { threat_intelligence_platform_roi_calculatorInputs, threat_intelligence_platform_roi_calculatorMetrics, threat_intelligence_platform_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: threat_intelligence_platform_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: threat_intelligence_platform_roi_calculatorInputs, metrics: threat_intelligence_platform_roi_calculatorMetrics): threat_intelligence_platform_roi_calculatorAnalysis {
