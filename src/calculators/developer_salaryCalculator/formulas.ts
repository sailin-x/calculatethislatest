import { developer_salaryCalculatorInputs, developer_salaryCalculatorMetrics, developer_salaryCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: developer_salaryCalculatorInputs): number {
...
export function generateAnalysis(inputs: developer_salaryCalculatorInputs, metrics: developer_salaryCalculatorMetrics): developer_salaryCalculatorAnalysis {
