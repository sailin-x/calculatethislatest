import { developer_salaryCalculatorInputs } from './types';

export function validateInputs(inputs: developer_salaryCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
