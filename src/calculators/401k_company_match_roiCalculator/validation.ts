import { 401k_company_match_roiCalculatorInputs } from './types';

export function validateInputs(inputs: 401k_company_match_roiCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
