import { api_monetization_revenue_calculatorInputs, api_monetization_revenue_calculatorMetrics, api_monetization_revenue_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: api_monetization_revenue_calculatorInputs): number {
...
export function generateAnalysis(inputs: api_monetization_revenue_calculatorInputs, metrics: api_monetization_revenue_calculatorMetrics): api_monetization_revenue_calculatorAnalysis {
