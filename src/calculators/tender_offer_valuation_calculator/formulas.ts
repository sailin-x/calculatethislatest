import { tender_offer_valuation_calculatorInputs, tender_offer_valuation_calculatorMetrics, tender_offer_valuation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: tender_offer_valuation_calculatorInputs): number {
...
export function generateAnalysis(inputs: tender_offer_valuation_calculatorInputs, metrics: tender_offer_valuation_calculatorMetrics): tender_offer_valuation_calculatorAnalysis {
