import { health_savings_account_contribution_calculatorCalculatorInputs, health_savings_account_contribution_calculatorCalculatorMetrics, health_savings_account_contribution_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: health_savings_account_contribution_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: health_savings_account_contribution_calculatorCalculatorInputs, metrics: health_savings_account_contribution_calculatorCalculatorMetrics): health_savings_account_contribution_calculatorCalculatorAnalysis {
