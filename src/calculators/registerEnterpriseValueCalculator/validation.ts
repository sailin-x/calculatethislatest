import { registerEnterpriseValueCalculatorInputs } from './types';

export function validateInputs(inputs: registerEnterpriseValueCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
