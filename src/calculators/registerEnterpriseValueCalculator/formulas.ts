import { registerEnterpriseValueCalculatorInputs, registerEnterpriseValueCalculatorMetrics, registerEnterpriseValueCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerEnterpriseValueCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerEnterpriseValueCalculatorInputs, metrics: registerEnterpriseValueCalculatorMetrics): registerEnterpriseValueCalculatorAnalysis {
