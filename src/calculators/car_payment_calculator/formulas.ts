import { car_payment_calculatorInputs, car_payment_calculatorMetrics, car_payment_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: car_payment_calculatorInputs): number {
...
export function generateAnalysis(inputs: car_payment_calculatorInputs, metrics: car_payment_calculatorMetrics): car_payment_calculatorAnalysis {
