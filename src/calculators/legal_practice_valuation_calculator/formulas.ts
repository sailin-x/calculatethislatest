import { legal_practice_valuation_calculatorInputs, legal_practice_valuation_calculatorMetrics, legal_practice_valuation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: legal_practice_valuation_calculatorInputs): number {
...
export function generateAnalysis(inputs: legal_practice_valuation_calculatorInputs, metrics: legal_practice_valuation_calculatorMetrics): legal_practice_valuation_calculatorAnalysis {
