import { class_action_settlement_calculatorCalculatorInputs, class_action_settlement_calculatorCalculatorMetrics, class_action_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: class_action_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: class_action_settlement_calculatorCalculatorInputs, metrics: class_action_settlement_calculatorCalculatorMetrics): class_action_settlement_calculatorCalculatorAnalysis {
