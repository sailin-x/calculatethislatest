import { merger_model_calculatorInputs, merger_model_calculatorMetrics, merger_model_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: merger_model_calculatorInputs): number {
...
export function generateAnalysis(inputs: merger_model_calculatorInputs, metrics: merger_model_calculatorMetrics): merger_model_calculatorAnalysis {
