import { martial_arts_cost_calculatorInputs, martial_arts_cost_calculatorMetrics, martial_arts_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: martial_arts_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: martial_arts_cost_calculatorInputs, metrics: martial_arts_cost_calculatorMetrics): martial_arts_cost_calculatorAnalysis {
