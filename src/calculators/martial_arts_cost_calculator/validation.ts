import { martial_arts_cost_calculatorInputs } from './types';

export function validateInputs(inputs: martial_arts_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
