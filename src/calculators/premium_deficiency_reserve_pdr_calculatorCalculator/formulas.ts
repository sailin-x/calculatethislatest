import { premium_deficiency_reserve_pdr_calculatorCalculatorInputs, premium_deficiency_reserve_pdr_calculatorCalculatorMetrics, premium_deficiency_reserve_pdr_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: premium_deficiency_reserve_pdr_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: premium_deficiency_reserve_pdr_calculatorCalculatorInputs, metrics: premium_deficiency_reserve_pdr_calculatorCalculatorMetrics): premium_deficiency_reserve_pdr_calculatorCalculatorAnalysis {
