import { generationSkippingTransferGstTaxCalculatorInputs, generationSkippingTransferGstTaxCalculatorMetrics, generationSkippingTransferGstTaxCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: generationSkippingTransferGstTaxCalculatorInputs): number {
...
export function generateAnalysis(inputs: generationSkippingTransferGstTaxCalculatorInputs, metrics: generationSkippingTransferGstTaxCalculatorMetrics): generationSkippingTransferGstTaxCalculatorAnalysis {
