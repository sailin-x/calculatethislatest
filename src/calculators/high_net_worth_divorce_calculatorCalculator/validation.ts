import { high_net_worth_divorce_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: high_net_worth_divorce_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
