import { high_net_worth_divorce_calculatorCalculatorInputs, high_net_worth_divorce_calculatorCalculatorMetrics, high_net_worth_divorce_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: high_net_worth_divorce_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: high_net_worth_divorce_calculatorCalculatorInputs, metrics: high_net_worth_divorce_calculatorCalculatorMetrics): high_net_worth_divorce_calculatorCalculatorAnalysis {
