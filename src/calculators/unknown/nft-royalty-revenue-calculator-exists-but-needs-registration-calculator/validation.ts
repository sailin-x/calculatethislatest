...
export function validateNftRoyaltyRevenueCalculatorExistsButNeedsRegistrationCalculatorInputs(inputs: NftRoyaltyRevenueCalculatorExistsButNeedsRegistrationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateNftRoyaltyRevenueCalculatorExistsButNeedsRegistrationCalculatorBusinessRules(inputs: NftRoyaltyRevenueCalculatorExistsButNeedsRegistrationCalculatorInputs): Array<{ field: string; message: string }> {
