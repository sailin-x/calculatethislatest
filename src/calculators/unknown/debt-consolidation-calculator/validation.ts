import { DebtConsolidationCalculatorInputs } from './types';

export function validateDebtConsolidationCalculatorInputs(inputs: DebtConsolidationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDebtConsolidationCalculatorBusinessRules(inputs: DebtConsolidationCalculatorInputs): Array<{ field: string; message: string }> {
