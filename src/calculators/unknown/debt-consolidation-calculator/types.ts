export interface DebtConsolidationCalculatorInputs {
...
export interface DebtConsolidationCalculatorOutputs {
...
export interface DebtConsolidationCalculatorMetrics {
...
export interface DebtConsolidationCalculatorAnalysis {
