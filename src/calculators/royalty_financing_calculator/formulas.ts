import { royalty_financing_calculatorInputs, royalty_financing_calculatorMetrics, royalty_financing_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: royalty_financing_calculatorInputs): number {
...
export function generateAnalysis(inputs: royalty_financing_calculatorInputs, metrics: royalty_financing_calculatorMetrics): royalty_financing_calculatorAnalysis {
