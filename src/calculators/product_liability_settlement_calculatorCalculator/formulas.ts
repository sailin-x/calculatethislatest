import { product_liability_settlement_calculatorCalculatorInputs, product_liability_settlement_calculatorCalculatorMetrics, product_liability_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: product_liability_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: product_liability_settlement_calculatorCalculatorInputs, metrics: product_liability_settlement_calculatorCalculatorMetrics): product_liability_settlement_calculatorCalculatorAnalysis {
