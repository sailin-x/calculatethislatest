import { talcum_powder_settlement_calculatorCalculatorInputs, talcum_powder_settlement_calculatorCalculatorMetrics, talcum_powder_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: talcum_powder_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: talcum_powder_settlement_calculatorCalculatorInputs, metrics: talcum_powder_settlement_calculatorCalculatorMetrics): talcum_powder_settlement_calculatorCalculatorAnalysis {
