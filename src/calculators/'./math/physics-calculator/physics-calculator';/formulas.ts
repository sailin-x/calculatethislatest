import { physics-calculator';Inputs, physics-calculator';Metrics, physics-calculator';Analysis } from './types';
...
export function calculateResult(inputs: physics-calculator';Inputs): number {
...
export function generateAnalysis(inputs: physics-calculator';Inputs, metrics: physics-calculator';Metrics): physics-calculator';Analysis {
