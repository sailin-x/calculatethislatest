import { './math/physics-calculator/physics-calculator';Inputs } from './types';

export function validateInputs(inputs: './math/physics-calculator/physics-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
