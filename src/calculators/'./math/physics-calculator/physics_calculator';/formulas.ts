import { physics_calculator';Inputs, physics_calculator';Metrics, physics_calculator';Analysis } from './types';
...
export function calculateResult(inputs: physics_calculator';Inputs): number {
...
export function generateAnalysis(inputs: physics_calculator';Inputs, metrics: physics_calculator';Metrics): physics_calculator';Analysis {
