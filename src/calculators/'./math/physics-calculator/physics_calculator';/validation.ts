import { './math/physics-calculator/physics_calculator';Inputs } from './types';

export function validateInputs(inputs: './math/physics-calculator/physics_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
