import { networking_calculator';Inputs, networking_calculator';Metrics, networking_calculator';Analysis } from './types';
...
export function calculateResult(inputs: networking_calculator';Inputs): number {
...
export function generateAnalysis(inputs: networking_calculator';Inputs, metrics: networking_calculator';Metrics): networking_calculator';Analysis {
