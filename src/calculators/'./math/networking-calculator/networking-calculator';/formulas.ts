import { networking-calculator';Inputs, networking-calculator';Metrics, networking-calculator';Analysis } from './types';
...
export function calculateResult(inputs: networking-calculator';Inputs): number {
...
export function generateAnalysis(inputs: networking-calculator';Inputs, metrics: networking-calculator';Metrics): networking-calculator';Analysis {
