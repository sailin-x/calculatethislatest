import { combinatorics_calculator';Inputs, combinatorics_calculator';Metrics, combinatorics_calculator';Analysis } from './types';
...
export function calculateResult(inputs: combinatorics_calculator';Inputs): number {
...
export function generateAnalysis(inputs: combinatorics_calculator';Inputs, metrics: combinatorics_calculator';Metrics): combinatorics_calculator';Analysis {
