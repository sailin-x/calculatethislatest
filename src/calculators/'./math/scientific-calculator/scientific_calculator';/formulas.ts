import { scientific_calculator';Inputs, scientific_calculator';Metrics, scientific_calculator';Analysis } from './types';
...
export function calculateResult(inputs: scientific_calculator';Inputs): number {
...
export function generateAnalysis(inputs: scientific_calculator';Inputs, metrics: scientific_calculator';Metrics): scientific_calculator';Analysis {
