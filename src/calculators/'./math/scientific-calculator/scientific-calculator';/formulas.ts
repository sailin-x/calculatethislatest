import { scientific-calculator';Inputs, scientific-calculator';Metrics, scientific-calculator';Analysis } from './types';
...
export function calculateResult(inputs: scientific-calculator';Inputs): number {
...
export function generateAnalysis(inputs: scientific-calculator';Inputs, metrics: scientific-calculator';Metrics): scientific-calculator';Analysis {
