import { cybersecurity-calculator';Inputs, cybersecurity-calculator';Metrics, cybersecurity-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cybersecurity-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cybersecurity-calculator';Inputs, metrics: cybersecurity-calculator';Metrics): cybersecurity-calculator';Analysis {
