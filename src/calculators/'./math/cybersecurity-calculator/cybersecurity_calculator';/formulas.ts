import { cybersecurity_calculator';Inputs, cybersecurity_calculator';Metrics, cybersecurity_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cybersecurity_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cybersecurity_calculator';Inputs, metrics: cybersecurity_calculator';Metrics): cybersecurity_calculator';Analysis {
