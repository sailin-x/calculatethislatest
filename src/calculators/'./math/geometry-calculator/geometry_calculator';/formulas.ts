import { geometry_calculator';Inputs, geometry_calculator';Metrics, geometry_calculator';Analysis } from './types';
...
export function calculateResult(inputs: geometry_calculator';Inputs): number {
...
export function generateAnalysis(inputs: geometry_calculator';Inputs, metrics: geometry_calculator';Metrics): geometry_calculator';Analysis {
