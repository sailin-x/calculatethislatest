import { geometry-calculator';Inputs, geometry-calculator';Metrics, geometry-calculator';Analysis } from './types';
...
export function calculateResult(inputs: geometry-calculator';Inputs): number {
...
export function generateAnalysis(inputs: geometry-calculator';Inputs, metrics: geometry-calculator';Metrics): geometry-calculator';Analysis {
