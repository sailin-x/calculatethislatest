import { scientific';Inputs, scientific';Metrics, scientific';Analysis } from './types';
...
export function calculateResult(inputs: scientific';Inputs): number {
...
export function generateAnalysis(inputs: scientific';Inputs, metrics: scientific';Metrics): scientific';Analysis {
