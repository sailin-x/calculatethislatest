import { clinical_trial_cost_calculator';Inputs, clinical_trial_cost_calculator';Metrics, clinical_trial_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: clinical_trial_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: clinical_trial_cost_calculator';Inputs, metrics: clinical_trial_cost_calculator';Metrics): clinical_trial_cost_calculator';Analysis {
