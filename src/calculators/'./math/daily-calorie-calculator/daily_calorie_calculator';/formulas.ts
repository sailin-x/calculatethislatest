import { daily_calorie_calculator';Inputs, daily_calorie_calculator';Metrics, daily_calorie_calculator';Analysis } from './types';
...
export function calculateResult(inputs: daily_calorie_calculator';Inputs): number {
...
export function generateAnalysis(inputs: daily_calorie_calculator';Inputs, metrics: daily_calorie_calculator';Metrics): daily_calorie_calculator';Analysis {
