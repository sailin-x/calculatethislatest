import { matrix';Inputs, matrix';Metrics, matrix';Analysis } from './types';
...
export function calculateResult(inputs: matrix';Inputs): number {
...
export function generateAnalysis(inputs: matrix';Inputs, metrics: matrix';Metrics): matrix';Analysis {
