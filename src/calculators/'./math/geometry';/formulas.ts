import { geometry';Inputs, geometry';Metrics, geometry';Analysis } from './types';
...
export function calculateResult(inputs: geometry';Inputs): number {
...
export function generateAnalysis(inputs: geometry';Inputs, metrics: geometry';Metrics): geometry';Analysis {
