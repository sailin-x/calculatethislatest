import { complex_number_calculator';Inputs, complex_number_calculator';Metrics, complex_number_calculator';Analysis } from './types';
...
export function calculateResult(inputs: complex_number_calculator';Inputs): number {
...
export function generateAnalysis(inputs: complex_number_calculator';Inputs, metrics: complex_number_calculator';Metrics): complex_number_calculator';Analysis {
