import { complex-number-calculator';Inputs, complex-number-calculator';Metrics, complex-number-calculator';Analysis } from './types';
...
export function calculateResult(inputs: complex-number-calculator';Inputs): number {
...
export function generateAnalysis(inputs: complex-number-calculator';Inputs, metrics: complex-number-calculator';Metrics): complex-number-calculator';Analysis {
