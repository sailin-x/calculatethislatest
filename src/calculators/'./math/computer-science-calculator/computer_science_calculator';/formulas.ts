import { computer_science_calculator';Inputs, computer_science_calculator';Metrics, computer_science_calculator';Analysis } from './types';
...
export function calculateResult(inputs: computer_science_calculator';Inputs): number {
...
export function generateAnalysis(inputs: computer_science_calculator';Inputs, metrics: computer_science_calculator';Metrics): computer_science_calculator';Analysis {
