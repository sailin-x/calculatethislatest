import { cheat_meal_calculator';Inputs, cheat_meal_calculator';Metrics, cheat_meal_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cheat_meal_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cheat_meal_calculator';Inputs, metrics: cheat_meal_calculator';Metrics): cheat_meal_calculator';Analysis {
