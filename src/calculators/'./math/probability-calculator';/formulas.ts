import { probability-calculator';Inputs, probability-calculator';Metrics, probability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: probability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: probability-calculator';Inputs, metrics: probability-calculator';Metrics): probability-calculator';Analysis {
