import { './math/probability-calculator';Inputs } from './types';

export function validateInputs(inputs: './math/probability-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
