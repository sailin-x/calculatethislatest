import { './math/biology-calculator/biology-calculator';Inputs } from './types';

export function validateInputs(inputs: './math/biology-calculator/biology-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
