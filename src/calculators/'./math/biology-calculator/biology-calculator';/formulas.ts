import { biology-calculator';Inputs, biology-calculator';Metrics, biology-calculator';Analysis } from './types';
...
export function calculateResult(inputs: biology-calculator';Inputs): number {
...
export function generateAnalysis(inputs: biology-calculator';Inputs, metrics: biology-calculator';Metrics): biology-calculator';Analysis {
