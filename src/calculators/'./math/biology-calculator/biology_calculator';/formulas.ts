import { biology_calculator';Inputs, biology_calculator';Metrics, biology_calculator';Analysis } from './types';
...
export function calculateResult(inputs: biology_calculator';Inputs): number {
...
export function generateAnalysis(inputs: biology_calculator';Inputs, metrics: biology_calculator';Metrics): biology_calculator';Analysis {
