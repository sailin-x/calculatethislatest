import { './math/biology-calculator/biology_calculator';Inputs } from './types';

export function validateInputs(inputs: './math/biology-calculator/biology_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
