import { complex_numbers';Inputs, complex_numbers';Metrics, complex_numbers';Analysis } from './types';
...
export function calculateResult(inputs: complex_numbers';Inputs): number {
...
export function generateAnalysis(inputs: complex_numbers';Inputs, metrics: complex_numbers';Metrics): complex_numbers';Analysis {
