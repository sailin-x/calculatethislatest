import { './math/complex-numbers/complex_numbers';Inputs } from './types';

export function validateInputs(inputs: './math/complex-numbers/complex_numbers';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
