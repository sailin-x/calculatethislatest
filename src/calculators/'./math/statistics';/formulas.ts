import { statistics';Inputs, statistics';Metrics, statistics';Analysis } from './types';
...
export function calculateResult(inputs: statistics';Inputs): number {
...
export function generateAnalysis(inputs: statistics';Inputs, metrics: statistics';Metrics): statistics';Analysis {
