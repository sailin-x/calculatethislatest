import { database_calculator';Inputs, database_calculator';Metrics, database_calculator';Analysis } from './types';
...
export function calculateResult(inputs: database_calculator';Inputs): number {
...
export function generateAnalysis(inputs: database_calculator';Inputs, metrics: database_calculator';Metrics): database_calculator';Analysis {
