import { database-calculator';Inputs, database-calculator';Metrics, database-calculator';Analysis } from './types';
...
export function calculateResult(inputs: database-calculator';Inputs): number {
...
export function generateAnalysis(inputs: database-calculator';Inputs, metrics: database-calculator';Metrics): database-calculator';Analysis {
