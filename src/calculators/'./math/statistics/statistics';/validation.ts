import { './math/statistics/statistics';Inputs } from './types';

export function validateInputs(inputs: './math/statistics/statistics';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
