import { engineering_calculator';Inputs, engineering_calculator';Metrics, engineering_calculator';Analysis } from './types';
...
export function calculateResult(inputs: engineering_calculator';Inputs): number {
...
export function generateAnalysis(inputs: engineering_calculator';Inputs, metrics: engineering_calculator';Metrics): engineering_calculator';Analysis {
