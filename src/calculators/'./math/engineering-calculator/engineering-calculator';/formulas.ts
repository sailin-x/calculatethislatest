import { engineering-calculator';Inputs, engineering-calculator';Metrics, engineering-calculator';Analysis } from './types';
...
export function calculateResult(inputs: engineering-calculator';Inputs): number {
...
export function generateAnalysis(inputs: engineering-calculator';Inputs, metrics: engineering-calculator';Metrics): engineering-calculator';Analysis {
