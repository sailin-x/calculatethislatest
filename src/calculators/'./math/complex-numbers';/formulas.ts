import { complex-numbers';Inputs, complex-numbers';Metrics, complex-numbers';Analysis } from './types';
...
export function calculateResult(inputs: complex-numbers';Inputs): number {
...
export function generateAnalysis(inputs: complex-numbers';Inputs, metrics: complex-numbers';Metrics): complex-numbers';Analysis {
