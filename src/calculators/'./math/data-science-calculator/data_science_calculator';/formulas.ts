import { data_science_calculator';Inputs, data_science_calculator';Metrics, data_science_calculator';Analysis } from './types';
...
export function calculateResult(inputs: data_science_calculator';Inputs): number {
...
export function generateAnalysis(inputs: data_science_calculator';Inputs, metrics: data_science_calculator';Metrics): data_science_calculator';Analysis {
