import { calculus';Inputs, calculus';Metrics, calculus';Analysis } from './types';
...
export function calculateResult(inputs: calculus';Inputs): number {
...
export function generateAnalysis(inputs: calculus';Inputs, metrics: calculus';Metrics): calculus';Analysis {
