import { chemistry-calculator';Inputs, chemistry-calculator';Metrics, chemistry-calculator';Analysis } from './types';
...
export function calculateResult(inputs: chemistry-calculator';Inputs): number {
...
export function generateAnalysis(inputs: chemistry-calculator';Inputs, metrics: chemistry-calculator';Metrics): chemistry-calculator';Analysis {
