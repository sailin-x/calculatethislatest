import { chemistry_calculator';Inputs, chemistry_calculator';Metrics, chemistry_calculator';Analysis } from './types';
...
export function calculateResult(inputs: chemistry_calculator';Inputs): number {
...
export function generateAnalysis(inputs: chemistry_calculator';Inputs, metrics: chemistry_calculator';Metrics): chemistry_calculator';Analysis {
