import { machine_learning_calculator';Inputs, machine_learning_calculator';Metrics, machine_learning_calculator';Analysis } from './types';
...
export function calculateResult(inputs: machine_learning_calculator';Inputs): number {
...
export function generateAnalysis(inputs: machine_learning_calculator';Inputs, metrics: machine_learning_calculator';Metrics): machine_learning_calculator';Analysis {
