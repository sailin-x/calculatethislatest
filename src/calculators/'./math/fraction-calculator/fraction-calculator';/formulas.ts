import { fraction-calculator';Inputs, fraction-calculator';Metrics, fraction-calculator';Analysis } from './types';
...
export function calculateResult(inputs: fraction-calculator';Inputs): number {
...
export function generateAnalysis(inputs: fraction-calculator';Inputs, metrics: fraction-calculator';Metrics): fraction-calculator';Analysis {
