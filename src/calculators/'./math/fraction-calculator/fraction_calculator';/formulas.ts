import { fraction_calculator';Inputs, fraction_calculator';Metrics, fraction_calculator';Analysis } from './types';
...
export function calculateResult(inputs: fraction_calculator';Inputs): number {
...
export function generateAnalysis(inputs: fraction_calculator';Inputs, metrics: fraction_calculator';Metrics): fraction_calculator';Analysis {
