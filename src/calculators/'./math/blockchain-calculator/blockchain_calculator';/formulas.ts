import { blockchain_calculator';Inputs, blockchain_calculator';Metrics, blockchain_calculator';Analysis } from './types';
...
export function calculateResult(inputs: blockchain_calculator';Inputs): number {
...
export function generateAnalysis(inputs: blockchain_calculator';Inputs, metrics: blockchain_calculator';Metrics): blockchain_calculator';Analysis {
