import { blockchain-calculator';Inputs, blockchain-calculator';Metrics, blockchain-calculator';Analysis } from './types';
...
export function calculateResult(inputs: blockchain-calculator';Inputs): number {
...
export function generateAnalysis(inputs: blockchain-calculator';Inputs, metrics: blockchain-calculator';Metrics): blockchain-calculator';Analysis {
