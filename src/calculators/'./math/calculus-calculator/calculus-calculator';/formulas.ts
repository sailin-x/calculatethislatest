import { calculus-calculator';Inputs, calculus-calculator';Metrics, calculus-calculator';Analysis } from './types';
...
export function calculateResult(inputs: calculus-calculator';Inputs): number {
...
export function generateAnalysis(inputs: calculus-calculator';Inputs, metrics: calculus-calculator';Metrics): calculus-calculator';Analysis {
