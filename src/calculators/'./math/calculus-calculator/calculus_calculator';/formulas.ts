import { calculus_calculator';Inputs, calculus_calculator';Metrics, calculus_calculator';Analysis } from './types';
...
export function calculateResult(inputs: calculus_calculator';Inputs): number {
...
export function generateAnalysis(inputs: calculus_calculator';Inputs, metrics: calculus_calculator';Metrics): calculus_calculator';Analysis {
