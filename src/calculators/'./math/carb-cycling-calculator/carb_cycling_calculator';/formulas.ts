import { carb_cycling_calculator';Inputs, carb_cycling_calculator';Metrics, carb_cycling_calculator';Analysis } from './types';
...
export function calculateResult(inputs: carb_cycling_calculator';Inputs): number {
...
export function generateAnalysis(inputs: carb_cycling_calculator';Inputs, metrics: carb_cycling_calculator';Metrics): carb_cycling_calculator';Analysis {
