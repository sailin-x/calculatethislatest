import { algebra';Inputs, algebra';Metrics, algebra';Analysis } from './types';
...
export function calculateResult(inputs: algebra';Inputs): number {
...
export function generateAnalysis(inputs: algebra';Inputs, metrics: algebra';Metrics): algebra';Analysis {
