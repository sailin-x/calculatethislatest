import { './math/matrix-calculator/matrix-calculator';Inputs } from './types';

export function validateInputs(inputs: './math/matrix-calculator/matrix-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
