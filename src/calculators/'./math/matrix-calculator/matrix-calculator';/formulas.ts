import { matrix-calculator';Inputs, matrix-calculator';Metrics, matrix-calculator';Analysis } from './types';
...
export function calculateResult(inputs: matrix-calculator';Inputs): number {
...
export function generateAnalysis(inputs: matrix-calculator';Inputs, metrics: matrix-calculator';Metrics): matrix-calculator';Analysis {
