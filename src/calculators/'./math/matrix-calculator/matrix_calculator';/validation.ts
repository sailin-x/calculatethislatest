import { './math/matrix-calculator/matrix_calculator';Inputs } from './types';

export function validateInputs(inputs: './math/matrix-calculator/matrix_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
