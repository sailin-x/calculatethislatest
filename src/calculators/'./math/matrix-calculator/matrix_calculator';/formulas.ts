import { matrix_calculator';Inputs, matrix_calculator';Metrics, matrix_calculator';Analysis } from './types';
...
export function calculateResult(inputs: matrix_calculator';Inputs): number {
...
export function generateAnalysis(inputs: matrix_calculator';Inputs, metrics: matrix_calculator';Metrics): matrix_calculator';Analysis {
