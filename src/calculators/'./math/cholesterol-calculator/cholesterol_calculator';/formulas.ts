import { cholesterol_calculator';Inputs, cholesterol_calculator';Metrics, cholesterol_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cholesterol_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cholesterol_calculator';Inputs, metrics: cholesterol_calculator';Metrics): cholesterol_calculator';Analysis {
