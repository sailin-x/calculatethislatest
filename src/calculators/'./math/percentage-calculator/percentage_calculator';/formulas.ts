import { percentage_calculator';Inputs, percentage_calculator';Metrics, percentage_calculator';Analysis } from './types';
...
export function calculateResult(inputs: percentage_calculator';Inputs): number {
...
export function generateAnalysis(inputs: percentage_calculator';Inputs, metrics: percentage_calculator';Metrics): percentage_calculator';Analysis {
