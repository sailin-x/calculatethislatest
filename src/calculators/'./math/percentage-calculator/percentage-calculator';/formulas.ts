import { percentage-calculator';Inputs, percentage-calculator';Metrics, percentage-calculator';Analysis } from './types';
...
export function calculateResult(inputs: percentage-calculator';Inputs): number {
...
export function generateAnalysis(inputs: percentage-calculator';Inputs, metrics: percentage-calculator';Metrics): percentage-calculator';Analysis {
