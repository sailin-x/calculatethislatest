import { statistics_calculator';Inputs, statistics_calculator';Metrics, statistics_calculator';Analysis } from './types';
...
export function calculateResult(inputs: statistics_calculator';Inputs): number {
...
export function generateAnalysis(inputs: statistics_calculator';Inputs, metrics: statistics_calculator';Metrics): statistics_calculator';Analysis {
