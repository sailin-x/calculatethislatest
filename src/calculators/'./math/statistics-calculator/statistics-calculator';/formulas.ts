import { statistics-calculator';Inputs, statistics-calculator';Metrics, statistics-calculator';Analysis } from './types';
...
export function calculateResult(inputs: statistics-calculator';Inputs): number {
...
export function generateAnalysis(inputs: statistics-calculator';Inputs, metrics: statistics-calculator';Metrics): statistics-calculator';Analysis {
