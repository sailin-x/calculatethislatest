import { fitness_age_calculator';Inputs, fitness_age_calculator';Metrics, fitness_age_calculator';Analysis } from './types';
...
export function calculateResult(inputs: fitness_age_calculator';Inputs): number {
...
export function generateAnalysis(inputs: fitness_age_calculator';Inputs, metrics: fitness_age_calculator';Metrics): fitness_age_calculator';Analysis {
