import { cryptography_calculator';Inputs, cryptography_calculator';Metrics, cryptography_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cryptography_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cryptography_calculator';Inputs, metrics: cryptography_calculator';Metrics): cryptography_calculator';Analysis {
