import { cryptography-calculator';Inputs, cryptography-calculator';Metrics, cryptography-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cryptography-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cryptography-calculator';Inputs, metrics: cryptography-calculator';Metrics): cryptography-calculator';Analysis {
