import { glycemic_load_calculator';Inputs, glycemic_load_calculator';Metrics, glycemic_load_calculator';Analysis } from './types';
...
export function calculateResult(inputs: glycemic_load_calculator';Inputs): number {
...
export function generateAnalysis(inputs: glycemic_load_calculator';Inputs, metrics: glycemic_load_calculator';Metrics): glycemic_load_calculator';Analysis {
