import { dissolved_oxygen_calculator';Inputs, dissolved_oxygen_calculator';Metrics, dissolved_oxygen_calculator';Analysis } from './types';
...
export function calculateResult(inputs: dissolved_oxygen_calculator';Inputs): number {
...
export function generateAnalysis(inputs: dissolved_oxygen_calculator';Inputs, metrics: dissolved_oxygen_calculator';Metrics): dissolved_oxygen_calculator';Analysis {
