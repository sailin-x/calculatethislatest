import { algebra-calculator';Inputs, algebra-calculator';Metrics, algebra-calculator';Analysis } from './types';
...
export function calculateResult(inputs: algebra-calculator';Inputs): number {
...
export function generateAnalysis(inputs: algebra-calculator';Inputs, metrics: algebra-calculator';Metrics): algebra-calculator';Analysis {
