import { './math/algebra-calculator/algebra-calculator';Inputs } from './types';

export function validateInputs(inputs: './math/algebra-calculator/algebra-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
