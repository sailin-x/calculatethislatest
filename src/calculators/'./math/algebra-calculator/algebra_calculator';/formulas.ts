import { algebra_calculator';Inputs, algebra_calculator';Metrics, algebra_calculator';Analysis } from './types';
...
export function calculateResult(inputs: algebra_calculator';Inputs): number {
...
export function generateAnalysis(inputs: algebra_calculator';Inputs, metrics: algebra_calculator';Metrics): algebra_calculator';Analysis {
