import { './math/algebra-calculator/algebra_calculator';Inputs } from './types';

export function validateInputs(inputs: './math/algebra-calculator/algebra_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
