import { probability_calculator';Inputs, probability_calculator';Metrics, probability_calculator';Analysis } from './types';
...
export function calculateResult(inputs: probability_calculator';Inputs): number {
...
export function generateAnalysis(inputs: probability_calculator';Inputs, metrics: probability_calculator';Metrics): probability_calculator';Analysis {
