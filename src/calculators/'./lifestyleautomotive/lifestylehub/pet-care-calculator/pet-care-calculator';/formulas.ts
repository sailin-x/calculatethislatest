import { pet-care-calculator';Inputs, pet-care-calculator';Metrics, pet-care-calculator';Analysis } from './types';
...
export function calculateResult(inputs: pet-care-calculator';Inputs): number {
...
export function generateAnalysis(inputs: pet-care-calculator';Inputs, metrics: pet-care-calculator';Metrics): pet-care-calculator';Analysis {
