import { cortisol_calculator';Inputs, cortisol_calculator';Metrics, cortisol_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cortisol_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cortisol_calculator';Inputs, metrics: cortisol_calculator';Metrics): cortisol_calculator';Analysis {
