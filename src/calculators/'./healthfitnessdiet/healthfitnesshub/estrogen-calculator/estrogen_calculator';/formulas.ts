import { estrogen_calculator';Inputs, estrogen_calculator';Metrics, estrogen_calculator';Analysis } from './types';
...
export function calculateResult(inputs: estrogen_calculator';Inputs): number {
...
export function generateAnalysis(inputs: estrogen_calculator';Inputs, metrics: estrogen_calculator';Metrics): estrogen_calculator';Analysis {
