import { calories-burned-calculator';Inputs, calories-burned-calculator';Metrics, calories-burned-calculator';Analysis } from './types';
...
export function calculateResult(inputs: calories-burned-calculator';Inputs): number {
...
export function generateAnalysis(inputs: calories-burned-calculator';Inputs, metrics: calories-burned-calculator';Metrics): calories-burned-calculator';Analysis {
