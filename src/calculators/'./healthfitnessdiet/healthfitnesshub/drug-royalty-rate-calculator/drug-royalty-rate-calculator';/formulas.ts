import { drug-royalty-rate-calculator';Inputs, drug-royalty-rate-calculator';Metrics, drug-royalty-rate-calculator';Analysis } from './types';
...
export function calculateResult(inputs: drug-royalty-rate-calculator';Inputs): number {
...
export function generateAnalysis(inputs: drug-royalty-rate-calculator';Inputs, metrics: drug-royalty-rate-calculator';Metrics): drug-royalty-rate-calculator';Analysis {
