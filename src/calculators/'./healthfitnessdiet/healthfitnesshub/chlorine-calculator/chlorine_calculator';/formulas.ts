import { chlorine_calculator';Inputs, chlorine_calculator';Metrics, chlorine_calculator';Analysis } from './types';
...
export function calculateResult(inputs: chlorine_calculator';Inputs): number {
...
export function generateAnalysis(inputs: chlorine_calculator';Inputs, metrics: chlorine_calculator';Metrics): chlorine_calculator';Analysis {
