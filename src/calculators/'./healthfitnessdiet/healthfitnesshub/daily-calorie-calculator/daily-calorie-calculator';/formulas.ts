import { daily-calorie-calculator';Inputs, daily-calorie-calculator';Metrics, daily-calorie-calculator';Analysis } from './types';
...
export function calculateResult(inputs: daily-calorie-calculator';Inputs): number {
...
export function generateAnalysis(inputs: daily-calorie-calculator';Inputs, metrics: daily-calorie-calculator';Metrics): daily-calorie-calculator';Analysis {
