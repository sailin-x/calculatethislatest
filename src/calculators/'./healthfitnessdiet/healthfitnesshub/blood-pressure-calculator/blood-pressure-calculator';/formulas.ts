import { blood-pressure-calculator';Inputs, blood-pressure-calculator';Metrics, blood-pressure-calculator';Analysis } from './types';
...
export function calculateResult(inputs: blood-pressure-calculator';Inputs): number {
...
export function generateAnalysis(inputs: blood-pressure-calculator';Inputs, metrics: blood-pressure-calculator';Metrics): blood-pressure-calculator';Analysis {
