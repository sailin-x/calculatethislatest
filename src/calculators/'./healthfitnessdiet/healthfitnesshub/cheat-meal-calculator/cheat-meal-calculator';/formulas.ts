import { cheat-meal-calculator';Inputs, cheat-meal-calculator';Metrics, cheat-meal-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cheat-meal-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cheat-meal-calculator';Inputs, metrics: cheat-meal-calculator';Metrics): cheat-meal-calculator';Analysis {
