import { growth-hormone-calculator';Inputs, growth-hormone-calculator';Metrics, growth-hormone-calculator';Analysis } from './types';
...
export function calculateResult(inputs: growth-hormone-calculator';Inputs): number {
...
export function generateAnalysis(inputs: growth-hormone-calculator';Inputs, metrics: growth-hormone-calculator';Metrics): growth-hormone-calculator';Analysis {
