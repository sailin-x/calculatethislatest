import { hardness_calculator';Inputs, hardness_calculator';Metrics, hardness_calculator';Analysis } from './types';
...
export function calculateResult(inputs: hardness_calculator';Inputs): number {
...
export function generateAnalysis(inputs: hardness_calculator';Inputs, metrics: hardness_calculator';Metrics): hardness_calculator';Analysis {
