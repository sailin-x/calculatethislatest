import { hardness-calculator';Inputs, hardness-calculator';Metrics, hardness-calculator';Analysis } from './types';
...
export function calculateResult(inputs: hardness-calculator';Inputs): number {
...
export function generateAnalysis(inputs: hardness-calculator';Inputs, metrics: hardness-calculator';Metrics): hardness-calculator';Analysis {
