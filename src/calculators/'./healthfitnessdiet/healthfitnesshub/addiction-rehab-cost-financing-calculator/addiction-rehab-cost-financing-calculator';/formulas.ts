import { addiction-rehab-cost-financing-calculator';Inputs, addiction-rehab-cost-financing-calculator';Metrics, addiction-rehab-cost-financing-calculator';Analysis } from './types';
...
export function calculateResult(inputs: addiction-rehab-cost-financing-calculator';Inputs): number {
...
export function generateAnalysis(inputs: addiction-rehab-cost-financing-calculator';Inputs, metrics: addiction-rehab-cost-financing-calculator';Metrics): addiction-rehab-cost-financing-calculator';Analysis {
