import { addiction_rehab_cost_financing_calculator';Inputs, addiction_rehab_cost_financing_calculator';Metrics, addiction_rehab_cost_financing_calculator';Analysis } from './types';
...
export function calculateResult(inputs: addiction_rehab_cost_financing_calculator';Inputs): number {
...
export function generateAnalysis(inputs: addiction_rehab_cost_financing_calculator';Inputs, metrics: addiction_rehab_cost_financing_calculator';Metrics): addiction_rehab_cost_financing_calculator';Analysis {
