import { alkalinity-calculator';Inputs, alkalinity-calculator';Metrics, alkalinity-calculator';Analysis } from './types';
...
export function calculateResult(inputs: alkalinity-calculator';Inputs): number {
...
export function generateAnalysis(inputs: alkalinity-calculator';Inputs, metrics: alkalinity-calculator';Metrics): alkalinity-calculator';Analysis {
