import { heart-rate-variability-calculator';Inputs, heart-rate-variability-calculator';Metrics, heart-rate-variability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: heart-rate-variability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: heart-rate-variability-calculator';Inputs, metrics: heart-rate-variability-calculator';Metrics): heart-rate-variability-calculator';Analysis {
