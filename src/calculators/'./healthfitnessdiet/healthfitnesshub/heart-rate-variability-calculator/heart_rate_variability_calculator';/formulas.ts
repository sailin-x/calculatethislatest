import { heart_rate_variability_calculator';Inputs, heart_rate_variability_calculator';Metrics, heart_rate_variability_calculator';Analysis } from './types';
...
export function calculateResult(inputs: heart_rate_variability_calculator';Inputs): number {
...
export function generateAnalysis(inputs: heart_rate_variability_calculator';Inputs, metrics: heart_rate_variability_calculator';Metrics): heart_rate_variability_calculator';Analysis {
