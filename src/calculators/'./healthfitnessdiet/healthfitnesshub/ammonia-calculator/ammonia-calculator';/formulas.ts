import { ammonia-calculator';Inputs, ammonia-calculator';Metrics, ammonia-calculator';Analysis } from './types';
...
export function calculateResult(inputs: ammonia-calculator';Inputs): number {
...
export function generateAnalysis(inputs: ammonia-calculator';Inputs, metrics: ammonia-calculator';Metrics): ammonia-calculator';Analysis {
