import { fitness-age-calculator';Inputs, fitness-age-calculator';Metrics, fitness-age-calculator';Analysis } from './types';
...
export function calculateResult(inputs: fitness-age-calculator';Inputs): number {
...
export function generateAnalysis(inputs: fitness-age-calculator';Inputs, metrics: fitness-age-calculator';Metrics): fitness-age-calculator';Analysis {
