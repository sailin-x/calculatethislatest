import { blood_alcohol_calculator';Inputs, blood_alcohol_calculator';Metrics, blood_alcohol_calculator';Analysis } from './types';
...
export function calculateResult(inputs: blood_alcohol_calculator';Inputs): number {
...
export function generateAnalysis(inputs: blood_alcohol_calculator';Inputs, metrics: blood_alcohol_calculator';Metrics): blood_alcohol_calculator';Analysis {
