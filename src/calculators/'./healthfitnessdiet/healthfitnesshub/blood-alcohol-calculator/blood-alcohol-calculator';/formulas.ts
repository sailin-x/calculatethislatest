import { blood-alcohol-calculator';Inputs, blood-alcohol-calculator';Metrics, blood-alcohol-calculator';Analysis } from './types';
...
export function calculateResult(inputs: blood-alcohol-calculator';Inputs): number {
...
export function generateAnalysis(inputs: blood-alcohol-calculator';Inputs, metrics: blood-alcohol-calculator';Metrics): blood-alcohol-calculator';Analysis {
