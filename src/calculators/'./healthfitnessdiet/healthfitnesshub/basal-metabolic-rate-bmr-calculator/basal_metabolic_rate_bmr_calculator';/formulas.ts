import { basal_metabolic_rate_bmr_calculator';Inputs, basal_metabolic_rate_bmr_calculator';Metrics, basal_metabolic_rate_bmr_calculator';Analysis } from './types';
...
export function calculateResult(inputs: basal_metabolic_rate_bmr_calculator';Inputs): number {
...
export function generateAnalysis(inputs: basal_metabolic_rate_bmr_calculator';Inputs, metrics: basal_metabolic_rate_bmr_calculator';Metrics): basal_metabolic_rate_bmr_calculator';Analysis {
