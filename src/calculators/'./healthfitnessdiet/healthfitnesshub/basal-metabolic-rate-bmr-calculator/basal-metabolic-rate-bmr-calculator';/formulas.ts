import { basal-metabolic-rate-bmr-calculator';Inputs, basal-metabolic-rate-bmr-calculator';Metrics, basal-metabolic-rate-bmr-calculator';Analysis } from './types';
...
export function calculateResult(inputs: basal-metabolic-rate-bmr-calculator';Inputs): number {
...
export function generateAnalysis(inputs: basal-metabolic-rate-bmr-calculator';Inputs, metrics: basal-metabolic-rate-bmr-calculator';Metrics): basal-metabolic-rate-bmr-calculator';Analysis {
