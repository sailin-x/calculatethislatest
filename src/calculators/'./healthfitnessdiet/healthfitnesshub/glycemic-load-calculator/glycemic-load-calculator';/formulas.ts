import { glycemic-load-calculator';Inputs, glycemic-load-calculator';Metrics, glycemic-load-calculator';Analysis } from './types';
...
export function calculateResult(inputs: glycemic-load-calculator';Inputs): number {
...
export function generateAnalysis(inputs: glycemic-load-calculator';Inputs, metrics: glycemic-load-calculator';Metrics): glycemic-load-calculator';Analysis {
