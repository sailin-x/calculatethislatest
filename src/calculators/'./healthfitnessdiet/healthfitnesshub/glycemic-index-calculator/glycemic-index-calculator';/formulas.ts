import { glycemic-index-calculator';Inputs, glycemic-index-calculator';Metrics, glycemic-index-calculator';Analysis } from './types';
...
export function calculateResult(inputs: glycemic-index-calculator';Inputs): number {
...
export function generateAnalysis(inputs: glycemic-index-calculator';Inputs, metrics: glycemic-index-calculator';Metrics): glycemic-index-calculator';Analysis {
