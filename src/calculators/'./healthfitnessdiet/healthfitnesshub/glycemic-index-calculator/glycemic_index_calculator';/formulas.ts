import { glycemic_index_calculator';Inputs, glycemic_index_calculator';Metrics, glycemic_index_calculator';Analysis } from './types';
...
export function calculateResult(inputs: glycemic_index_calculator';Inputs): number {
...
export function generateAnalysis(inputs: glycemic_index_calculator';Inputs, metrics: glycemic_index_calculator';Metrics): glycemic_index_calculator';Analysis {
