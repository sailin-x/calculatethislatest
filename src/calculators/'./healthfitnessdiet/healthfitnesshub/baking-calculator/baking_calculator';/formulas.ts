import { baking_calculator';Inputs, baking_calculator';Metrics, baking_calculator';Analysis } from './types';
...
export function calculateResult(inputs: baking_calculator';Inputs): number {
...
export function generateAnalysis(inputs: baking_calculator';Inputs, metrics: baking_calculator';Metrics): baking_calculator';Analysis {
