import { baking-calculator';Inputs, baking-calculator';Metrics, baking-calculator';Analysis } from './types';
...
export function calculateResult(inputs: baking-calculator';Inputs): number {
...
export function generateAnalysis(inputs: baking-calculator';Inputs, metrics: baking-calculator';Metrics): baking-calculator';Analysis {
