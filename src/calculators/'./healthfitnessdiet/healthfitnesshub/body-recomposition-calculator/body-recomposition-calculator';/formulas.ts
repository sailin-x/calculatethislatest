import { body-recomposition-calculator';Inputs, body-recomposition-calculator';Metrics, body-recomposition-calculator';Analysis } from './types';
...
export function calculateResult(inputs: body-recomposition-calculator';Inputs): number {
...
export function generateAnalysis(inputs: body-recomposition-calculator';Inputs, metrics: body-recomposition-calculator';Metrics): body-recomposition-calculator';Analysis {
