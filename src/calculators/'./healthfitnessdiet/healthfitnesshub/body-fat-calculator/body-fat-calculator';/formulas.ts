import { body-fat-calculator';Inputs, body-fat-calculator';Metrics, body-fat-calculator';Analysis } from './types';
...
export function calculateResult(inputs: body-fat-calculator';Inputs): number {
...
export function generateAnalysis(inputs: body-fat-calculator';Inputs, metrics: body-fat-calculator';Metrics): body-fat-calculator';Analysis {
