import { body_fat_calculator';Inputs, body_fat_calculator';Metrics, body_fat_calculator';Analysis } from './types';
...
export function calculateResult(inputs: body_fat_calculator';Inputs): number {
...
export function generateAnalysis(inputs: body_fat_calculator';Inputs, metrics: body_fat_calculator';Metrics): body_fat_calculator';Analysis {
