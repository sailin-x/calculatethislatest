import { dialysis-center-profitability-calculator';Inputs, dialysis-center-profitability-calculator';Metrics, dialysis-center-profitability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: dialysis-center-profitability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: dialysis-center-profitability-calculator';Inputs, metrics: dialysis-center-profitability-calculator';Metrics): dialysis-center-profitability-calculator';Analysis {
