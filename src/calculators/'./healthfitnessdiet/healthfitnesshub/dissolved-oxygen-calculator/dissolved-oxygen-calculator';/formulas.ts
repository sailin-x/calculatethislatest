import { dissolved-oxygen-calculator';Inputs, dissolved-oxygen-calculator';Metrics, dissolved-oxygen-calculator';Analysis } from './types';
...
export function calculateResult(inputs: dissolved-oxygen-calculator';Inputs): number {
...
export function generateAnalysis(inputs: dissolved-oxygen-calculator';Inputs, metrics: dissolved-oxygen-calculator';Metrics): dissolved-oxygen-calculator';Analysis {
