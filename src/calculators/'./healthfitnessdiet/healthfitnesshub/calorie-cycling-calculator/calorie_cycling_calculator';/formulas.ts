import { calorie_cycling_calculator';Inputs, calorie_cycling_calculator';Metrics, calorie_cycling_calculator';Analysis } from './types';
...
export function calculateResult(inputs: calorie_cycling_calculator';Inputs): number {
...
export function generateAnalysis(inputs: calorie_cycling_calculator';Inputs, metrics: calorie_cycling_calculator';Metrics): calorie_cycling_calculator';Analysis {
