import { anti-aging-regenerative-medicine-cost-calculator';Inputs, anti-aging-regenerative-medicine-cost-calculator';Metrics, anti-aging-regenerative-medicine-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: anti-aging-regenerative-medicine-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: anti-aging-regenerative-medicine-cost-calculator';Inputs, metrics: anti-aging-regenerative-medicine-cost-calculator';Metrics): anti-aging-regenerative-medicine-cost-calculator';Analysis {
