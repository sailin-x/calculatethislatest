import { dash_diet_calculator';Inputs, dash_diet_calculator';Metrics, dash_diet_calculator';Analysis } from './types';
...
export function calculateResult(inputs: dash_diet_calculator';Inputs): number {
...
export function generateAnalysis(inputs: dash_diet_calculator';Inputs, metrics: dash_diet_calculator';Metrics): dash_diet_calculator';Analysis {
