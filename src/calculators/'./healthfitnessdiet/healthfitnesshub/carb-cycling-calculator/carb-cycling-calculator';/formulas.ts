import { carb-cycling-calculator';Inputs, carb-cycling-calculator';Metrics, carb-cycling-calculator';Analysis } from './types';
...
export function calculateResult(inputs: carb-cycling-calculator';Inputs): number {
...
export function generateAnalysis(inputs: carb-cycling-calculator';Inputs, metrics: carb-cycling-calculator';Metrics): carb-cycling-calculator';Analysis {
