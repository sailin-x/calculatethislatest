import { heart_rate_zone_calculator';Inputs, heart_rate_zone_calculator';Metrics, heart_rate_zone_calculator';Analysis } from './types';
...
export function calculateResult(inputs: heart_rate_zone_calculator';Inputs): number {
...
export function generateAnalysis(inputs: heart_rate_zone_calculator';Inputs, metrics: heart_rate_zone_calculator';Metrics): heart_rate_zone_calculator';Analysis {
