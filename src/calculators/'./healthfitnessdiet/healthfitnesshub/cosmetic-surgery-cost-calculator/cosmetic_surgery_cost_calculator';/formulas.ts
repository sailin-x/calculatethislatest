import { cosmetic_surgery_cost_calculator';Inputs, cosmetic_surgery_cost_calculator';Metrics, cosmetic_surgery_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cosmetic_surgery_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cosmetic_surgery_cost_calculator';Inputs, metrics: cosmetic_surgery_cost_calculator';Metrics): cosmetic_surgery_cost_calculator';Analysis {
