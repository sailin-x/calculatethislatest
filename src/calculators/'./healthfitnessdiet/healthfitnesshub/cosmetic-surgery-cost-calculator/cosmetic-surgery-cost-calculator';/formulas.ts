import { cosmetic-surgery-cost-calculator';Inputs, cosmetic-surgery-cost-calculator';Metrics, cosmetic-surgery-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cosmetic-surgery-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cosmetic-surgery-cost-calculator';Inputs, metrics: cosmetic-surgery-cost-calculator';Metrics): cosmetic-surgery-cost-calculator';Analysis {
