import { biological-age-calculator';Inputs, biological-age-calculator';Metrics, biological-age-calculator';Analysis } from './types';
...
export function calculateResult(inputs: biological-age-calculator';Inputs): number {
...
export function generateAnalysis(inputs: biological-age-calculator';Inputs, metrics: biological-age-calculator';Metrics): biological-age-calculator';Analysis {
