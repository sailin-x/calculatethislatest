import { body_frame_size_calculator';Inputs, body_frame_size_calculator';Metrics, body_frame_size_calculator';Analysis } from './types';
...
export function calculateResult(inputs: body_frame_size_calculator';Inputs): number {
...
export function generateAnalysis(inputs: body_frame_size_calculator';Inputs, metrics: body_frame_size_calculator';Metrics): body_frame_size_calculator';Analysis {
