import { './technology/ai-prompt-cost';Inputs } from './types';

export function validateInputs(inputs: './technology/ai-prompt-cost';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
