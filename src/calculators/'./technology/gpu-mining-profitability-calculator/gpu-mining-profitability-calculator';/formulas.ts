import { gpu-mining-profitability-calculator';Inputs, gpu-mining-profitability-calculator';Metrics, gpu-mining-profitability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: gpu-mining-profitability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: gpu-mining-profitability-calculator';Inputs, metrics: gpu-mining-profitability-calculator';Metrics): gpu-mining-profitability-calculator';Analysis {
