import { ai-prompt-cost-calculator';Inputs, ai-prompt-cost-calculator';Metrics, ai-prompt-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: ai-prompt-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: ai-prompt-cost-calculator';Inputs, metrics: ai-prompt-cost-calculator';Metrics): ai-prompt-cost-calculator';Analysis {
