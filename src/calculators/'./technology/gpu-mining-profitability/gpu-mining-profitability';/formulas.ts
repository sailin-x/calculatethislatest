import { gpu-mining-profitability';Inputs, gpu-mining-profitability';Metrics, gpu-mining-profitability';Analysis } from './types';
...
export function calculateResult(inputs: gpu-mining-profitability';Inputs): number {
...
export function generateAnalysis(inputs: gpu-mining-profitability';Inputs, metrics: gpu-mining-profitability';Metrics): gpu-mining-profitability';Analysis {
