import { './technology/ai-prompt-cost/register';Inputs } from './types';

export function validateInputs(inputs: './technology/ai-prompt-cost/register';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
