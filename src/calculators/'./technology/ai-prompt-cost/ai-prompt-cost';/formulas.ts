import { ai-prompt-cost';Inputs, ai-prompt-cost';Metrics, ai-prompt-cost';Analysis } from './types';
...
export function calculateResult(inputs: ai-prompt-cost';Inputs): number {
...
export function generateAnalysis(inputs: ai-prompt-cost';Inputs, metrics: ai-prompt-cost';Metrics): ai-prompt-cost';Analysis {
