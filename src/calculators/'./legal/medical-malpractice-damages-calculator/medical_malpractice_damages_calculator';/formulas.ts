import { medical_malpractice_damages_calculator';Inputs, medical_malpractice_damages_calculator';Metrics, medical_malpractice_damages_calculator';Analysis } from './types';
...
export function calculateResult(inputs: medical_malpractice_damages_calculator';Inputs): number {
...
export function generateAnalysis(inputs: medical_malpractice_damages_calculator';Inputs, metrics: medical_malpractice_damages_calculator';Metrics): medical_malpractice_damages_calculator';Analysis {
