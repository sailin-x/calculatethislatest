import { mesothelioma_settlement_calculator';Inputs, mesothelioma_settlement_calculator';Metrics, mesothelioma_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: mesothelioma_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: mesothelioma_settlement_calculator';Inputs, metrics: mesothelioma_settlement_calculator';Metrics): mesothelioma_settlement_calculator';Analysis {
