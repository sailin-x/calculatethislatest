import { price_fixing_overcharge_calculator';Inputs, price_fixing_overcharge_calculator';Metrics, price_fixing_overcharge_calculator';Analysis } from './types';
...
export function calculateResult(inputs: price_fixing_overcharge_calculator';Inputs): number {
...
export function generateAnalysis(inputs: price_fixing_overcharge_calculator';Inputs, metrics: price_fixing_overcharge_calculator';Metrics): price_fixing_overcharge_calculator';Analysis {
