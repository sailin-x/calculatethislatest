import { price-fixing-overcharge-calculator';Inputs, price-fixing-overcharge-calculator';Metrics, price-fixing-overcharge-calculator';Analysis } from './types';
...
export function calculateResult(inputs: price-fixing-overcharge-calculator';Inputs): number {
...
export function generateAnalysis(inputs: price-fixing-overcharge-calculator';Inputs, metrics: price-fixing-overcharge-calculator';Metrics): price-fixing-overcharge-calculator';Analysis {
