import { copyright_infringement_damages_calculator';Inputs, copyright_infringement_damages_calculator';Metrics, copyright_infringement_damages_calculator';Analysis } from './types';
...
export function calculateResult(inputs: copyright_infringement_damages_calculator';Inputs): number {
...
export function generateAnalysis(inputs: copyright_infringement_damages_calculator';Inputs, metrics: copyright_infringement_damages_calculator';Metrics): copyright_infringement_damages_calculator';Analysis {
