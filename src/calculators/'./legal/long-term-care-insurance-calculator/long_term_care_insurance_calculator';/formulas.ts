import { long_term_care_insurance_calculator';Inputs, long_term_care_insurance_calculator';Metrics, long_term_care_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: long_term_care_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: long_term_care_insurance_calculator';Inputs, metrics: long_term_care_insurance_calculator';Metrics): long_term_care_insurance_calculator';Analysis {
