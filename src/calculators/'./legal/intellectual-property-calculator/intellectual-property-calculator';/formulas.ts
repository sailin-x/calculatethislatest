import { intellectual-property-calculator';Inputs, intellectual-property-calculator';Metrics, intellectual-property-calculator';Analysis } from './types';
...
export function calculateResult(inputs: intellectual-property-calculator';Inputs): number {
...
export function generateAnalysis(inputs: intellectual-property-calculator';Inputs, metrics: intellectual-property-calculator';Metrics): intellectual-property-calculator';Analysis {
