import { offshore_accident_lawyer_fee_calculator';Inputs, offshore_accident_lawyer_fee_calculator';Metrics, offshore_accident_lawyer_fee_calculator';Analysis } from './types';
...
export function calculateResult(inputs: offshore_accident_lawyer_fee_calculator';Inputs): number {
...
export function generateAnalysis(inputs: offshore_accident_lawyer_fee_calculator';Inputs, metrics: offshore_accident_lawyer_fee_calculator';Metrics): offshore_accident_lawyer_fee_calculator';Analysis {
