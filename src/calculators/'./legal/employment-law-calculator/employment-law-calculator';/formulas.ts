import { employment-law-calculator';Inputs, employment-law-calculator';Metrics, employment-law-calculator';Analysis } from './types';
...
export function calculateResult(inputs: employment-law-calculator';Inputs): number {
...
export function generateAnalysis(inputs: employment-law-calculator';Inputs, metrics: employment-law-calculator';Metrics): employment-law-calculator';Analysis {
