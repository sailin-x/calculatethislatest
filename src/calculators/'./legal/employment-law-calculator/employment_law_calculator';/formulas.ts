import { employment_law_calculator';Inputs, employment_law_calculator';Metrics, employment_law_calculator';Analysis } from './types';
...
export function calculateResult(inputs: employment_law_calculator';Inputs): number {
...
export function generateAnalysis(inputs: employment_law_calculator';Inputs, metrics: employment_law_calculator';Metrics): employment_law_calculator';Analysis {
