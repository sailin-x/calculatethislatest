import { qui-tam-reward-calculator';Inputs, qui-tam-reward-calculator';Metrics, qui-tam-reward-calculator';Analysis } from './types';
...
export function calculateResult(inputs: qui-tam-reward-calculator';Inputs): number {
...
export function generateAnalysis(inputs: qui-tam-reward-calculator';Inputs, metrics: qui-tam-reward-calculator';Metrics): qui-tam-reward-calculator';Analysis {
