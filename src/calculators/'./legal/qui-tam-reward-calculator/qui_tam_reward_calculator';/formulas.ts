import { qui_tam_reward_calculator';Inputs, qui_tam_reward_calculator';Metrics, qui_tam_reward_calculator';Analysis } from './types';
...
export function calculateResult(inputs: qui_tam_reward_calculator';Inputs): number {
...
export function generateAnalysis(inputs: qui_tam_reward_calculator';Inputs, metrics: qui_tam_reward_calculator';Metrics): qui_tam_reward_calculator';Analysis {
