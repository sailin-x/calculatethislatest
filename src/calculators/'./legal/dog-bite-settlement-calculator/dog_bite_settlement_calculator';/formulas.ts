import { dog_bite_settlement_calculator';Inputs, dog_bite_settlement_calculator';Metrics, dog_bite_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: dog_bite_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: dog_bite_settlement_calculator';Inputs, metrics: dog_bite_settlement_calculator';Metrics): dog_bite_settlement_calculator';Analysis {
