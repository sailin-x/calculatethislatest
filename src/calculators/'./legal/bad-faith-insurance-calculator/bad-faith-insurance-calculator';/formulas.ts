import { bad-faith-insurance-calculator';Inputs, bad-faith-insurance-calculator';Metrics, bad-faith-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: bad-faith-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: bad-faith-insurance-calculator';Inputs, metrics: bad-faith-insurance-calculator';Metrics): bad-faith-insurance-calculator';Analysis {
