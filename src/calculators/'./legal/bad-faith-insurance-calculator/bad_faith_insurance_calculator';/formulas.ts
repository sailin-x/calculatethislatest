import { bad_faith_insurance_calculator';Inputs, bad_faith_insurance_calculator';Metrics, bad_faith_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: bad_faith_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: bad_faith_insurance_calculator';Inputs, metrics: bad_faith_insurance_calculator';Metrics): bad_faith_insurance_calculator';Analysis {
