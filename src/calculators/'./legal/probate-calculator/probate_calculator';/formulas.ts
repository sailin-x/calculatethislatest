import { probate_calculator';Inputs, probate_calculator';Metrics, probate_calculator';Analysis } from './types';
...
export function calculateResult(inputs: probate_calculator';Inputs): number {
...
export function generateAnalysis(inputs: probate_calculator';Inputs, metrics: probate_calculator';Metrics): probate_calculator';Analysis {
