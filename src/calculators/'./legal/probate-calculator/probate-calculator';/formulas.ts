import { probate-calculator';Inputs, probate-calculator';Metrics, probate-calculator';Analysis } from './types';
...
export function calculateResult(inputs: probate-calculator';Inputs): number {
...
export function generateAnalysis(inputs: probate-calculator';Inputs, metrics: probate-calculator';Metrics): probate-calculator';Analysis {
