import { bankruptcy-filing-calculator';Inputs, bankruptcy-filing-calculator';Metrics, bankruptcy-filing-calculator';Analysis } from './types';
...
export function calculateResult(inputs: bankruptcy-filing-calculator';Inputs): number {
...
export function generateAnalysis(inputs: bankruptcy-filing-calculator';Inputs, metrics: bankruptcy-filing-calculator';Metrics): bankruptcy-filing-calculator';Analysis {
