import { bankruptcy_filing_calculator';Inputs, bankruptcy_filing_calculator';Metrics, bankruptcy_filing_calculator';Analysis } from './types';
...
export function calculateResult(inputs: bankruptcy_filing_calculator';Inputs): number {
...
export function generateAnalysis(inputs: bankruptcy_filing_calculator';Inputs, metrics: bankruptcy_filing_calculator';Metrics): bankruptcy_filing_calculator';Analysis {
