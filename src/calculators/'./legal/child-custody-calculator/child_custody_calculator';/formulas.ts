import { child_custody_calculator';Inputs, child_custody_calculator';Metrics, child_custody_calculator';Analysis } from './types';
...
export function calculateResult(inputs: child_custody_calculator';Inputs): number {
...
export function generateAnalysis(inputs: child_custody_calculator';Inputs, metrics: child_custody_calculator';Metrics): child_custody_calculator';Analysis {
