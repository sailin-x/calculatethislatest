import { child-custody-calculator';Inputs, child-custody-calculator';Metrics, child-custody-calculator';Analysis } from './types';
...
export function calculateResult(inputs: child-custody-calculator';Inputs): number {
...
export function generateAnalysis(inputs: child-custody-calculator';Inputs, metrics: child-custody-calculator';Metrics): child-custody-calculator';Analysis {
