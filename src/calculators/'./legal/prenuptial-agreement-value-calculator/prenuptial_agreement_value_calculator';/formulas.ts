import { prenuptial_agreement_value_calculator';Inputs, prenuptial_agreement_value_calculator';Metrics, prenuptial_agreement_value_calculator';Analysis } from './types';
...
export function calculateResult(inputs: prenuptial_agreement_value_calculator';Inputs): number {
...
export function generateAnalysis(inputs: prenuptial_agreement_value_calculator';Inputs, metrics: prenuptial_agreement_value_calculator';Metrics): prenuptial_agreement_value_calculator';Analysis {
