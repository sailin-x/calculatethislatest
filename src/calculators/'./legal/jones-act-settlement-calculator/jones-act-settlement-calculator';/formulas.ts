import { jones-act-settlement-calculator';Inputs, jones-act-settlement-calculator';Metrics, jones-act-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: jones-act-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: jones-act-settlement-calculator';Inputs, metrics: jones-act-settlement-calculator';Metrics): jones-act-settlement-calculator';Analysis {
