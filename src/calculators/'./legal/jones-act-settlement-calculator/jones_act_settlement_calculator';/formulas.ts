import { jones_act_settlement_calculator';Inputs, jones_act_settlement_calculator';Metrics, jones_act_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: jones_act_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: jones_act_settlement_calculator';Inputs, metrics: jones_act_settlement_calculator';Metrics): jones_act_settlement_calculator';Analysis {
