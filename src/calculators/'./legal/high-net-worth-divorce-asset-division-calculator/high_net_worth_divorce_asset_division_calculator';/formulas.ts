import { high_net_worth_divorce_asset_division_calculator';Inputs, high_net_worth_divorce_asset_division_calculator';Metrics, high_net_worth_divorce_asset_division_calculator';Analysis } from './types';
...
export function calculateResult(inputs: high_net_worth_divorce_asset_division_calculator';Inputs): number {
...
export function generateAnalysis(inputs: high_net_worth_divorce_asset_division_calculator';Inputs, metrics: high_net_worth_divorce_asset_division_calculator';Metrics): high_net_worth_divorce_asset_division_calculator';Analysis {
