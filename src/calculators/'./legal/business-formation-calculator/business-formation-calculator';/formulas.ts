import { business-formation-calculator';Inputs, business-formation-calculator';Metrics, business-formation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: business-formation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: business-formation-calculator';Inputs, metrics: business-formation-calculator';Metrics): business-formation-calculator';Analysis {
