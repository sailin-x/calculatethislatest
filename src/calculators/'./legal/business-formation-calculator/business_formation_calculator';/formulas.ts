import { business_formation_calculator';Inputs, business_formation_calculator';Metrics, business_formation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: business_formation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: business_formation_calculator';Inputs, metrics: business_formation_calculator';Metrics): business_formation_calculator';Analysis {
