import { catastrophe_bond_pricing_calculator';Inputs, catastrophe_bond_pricing_calculator';Metrics, catastrophe_bond_pricing_calculator';Analysis } from './types';
...
export function calculateResult(inputs: catastrophe_bond_pricing_calculator';Inputs): number {
...
export function generateAnalysis(inputs: catastrophe_bond_pricing_calculator';Inputs, metrics: catastrophe_bond_pricing_calculator';Metrics): catastrophe_bond_pricing_calculator';Analysis {
