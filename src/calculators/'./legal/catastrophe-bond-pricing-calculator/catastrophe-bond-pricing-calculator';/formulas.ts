import { catastrophe-bond-pricing-calculator';Inputs, catastrophe-bond-pricing-calculator';Metrics, catastrophe-bond-pricing-calculator';Analysis } from './types';
...
export function calculateResult(inputs: catastrophe-bond-pricing-calculator';Inputs): number {
...
export function generateAnalysis(inputs: catastrophe-bond-pricing-calculator';Inputs, metrics: catastrophe-bond-pricing-calculator';Metrics): catastrophe-bond-pricing-calculator';Analysis {
