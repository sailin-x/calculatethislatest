import { commercial-fleet-insurance-calculator';Inputs, commercial-fleet-insurance-calculator';Metrics, commercial-fleet-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: commercial-fleet-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: commercial-fleet-insurance-calculator';Inputs, metrics: commercial-fleet-insurance-calculator';Metrics): commercial-fleet-insurance-calculator';Analysis {
