import { commercial_fleet_insurance_calculator';Inputs, commercial_fleet_insurance_calculator';Metrics, commercial_fleet_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: commercial_fleet_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: commercial_fleet_insurance_calculator';Inputs, metrics: commercial_fleet_insurance_calculator';Metrics): commercial_fleet_insurance_calculator';Analysis {
