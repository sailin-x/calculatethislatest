import { life_insurance_needs_calculator';Inputs, life_insurance_needs_calculator';Metrics, life_insurance_needs_calculator';Analysis } from './types';
...
export function calculateResult(inputs: life_insurance_needs_calculator';Inputs): number {
...
export function generateAnalysis(inputs: life_insurance_needs_calculator';Inputs, metrics: life_insurance_needs_calculator';Metrics): life_insurance_needs_calculator';Analysis {
