import { high_net_worth_divorce_asset_division';Inputs, high_net_worth_divorce_asset_division';Metrics, high_net_worth_divorce_asset_division';Analysis } from './types';
...
export function calculateResult(inputs: high_net_worth_divorce_asset_division';Inputs): number {
...
export function generateAnalysis(inputs: high_net_worth_divorce_asset_division';Inputs, metrics: high_net_worth_divorce_asset_division';Metrics): high_net_worth_divorce_asset_division';Analysis {
