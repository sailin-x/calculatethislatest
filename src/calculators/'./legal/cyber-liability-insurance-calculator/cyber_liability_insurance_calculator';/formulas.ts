import { cyber_liability_insurance_calculator';Inputs, cyber_liability_insurance_calculator';Metrics, cyber_liability_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cyber_liability_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cyber_liability_insurance_calculator';Inputs, metrics: cyber_liability_insurance_calculator';Metrics): cyber_liability_insurance_calculator';Analysis {
