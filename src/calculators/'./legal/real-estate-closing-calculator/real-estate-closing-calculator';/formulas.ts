import { real-estate-closing-calculator';Inputs, real-estate-closing-calculator';Metrics, real-estate-closing-calculator';Analysis } from './types';
...
export function calculateResult(inputs: real-estate-closing-calculator';Inputs): number {
...
export function generateAnalysis(inputs: real-estate-closing-calculator';Inputs, metrics: real-estate-closing-calculator';Metrics): real-estate-closing-calculator';Analysis {
