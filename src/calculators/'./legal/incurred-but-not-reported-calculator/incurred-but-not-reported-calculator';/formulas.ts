import { incurred-but-not-reported-calculator';Inputs, incurred-but-not-reported-calculator';Metrics, incurred-but-not-reported-calculator';Analysis } from './types';
...
export function calculateResult(inputs: incurred-but-not-reported-calculator';Inputs): number {
...
export function generateAnalysis(inputs: incurred-but-not-reported-calculator';Inputs, metrics: incurred-but-not-reported-calculator';Metrics): incurred-but-not-reported-calculator';Analysis {
