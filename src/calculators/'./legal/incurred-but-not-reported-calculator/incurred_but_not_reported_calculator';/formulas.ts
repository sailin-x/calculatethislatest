import { incurred_but_not_reported_calculator';Inputs, incurred_but_not_reported_calculator';Metrics, incurred_but_not_reported_calculator';Analysis } from './types';
...
export function calculateResult(inputs: incurred_but_not_reported_calculator';Inputs): number {
...
export function generateAnalysis(inputs: incurred_but_not_reported_calculator';Inputs, metrics: incurred_but_not_reported_calculator';Metrics): incurred_but_not_reported_calculator';Analysis {
