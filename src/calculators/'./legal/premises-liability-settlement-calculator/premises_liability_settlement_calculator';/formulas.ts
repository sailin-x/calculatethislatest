import { premises_liability_settlement_calculator';Inputs, premises_liability_settlement_calculator';Metrics, premises_liability_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: premises_liability_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: premises_liability_settlement_calculator';Inputs, metrics: premises_liability_settlement_calculator';Metrics): premises_liability_settlement_calculator';Analysis {
