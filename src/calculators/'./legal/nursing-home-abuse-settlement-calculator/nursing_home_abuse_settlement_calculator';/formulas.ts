import { nursing_home_abuse_settlement_calculator';Inputs, nursing_home_abuse_settlement_calculator';Metrics, nursing_home_abuse_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: nursing_home_abuse_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: nursing_home_abuse_settlement_calculator';Inputs, metrics: nursing_home_abuse_settlement_calculator';Metrics): nursing_home_abuse_settlement_calculator';Analysis {
