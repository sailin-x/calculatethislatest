import { loss_ratio_calculator';Inputs, loss_ratio_calculator';Metrics, loss_ratio_calculator';Analysis } from './types';
...
export function calculateResult(inputs: loss_ratio_calculator';Inputs): number {
...
export function generateAnalysis(inputs: loss_ratio_calculator';Inputs, metrics: loss_ratio_calculator';Metrics): loss_ratio_calculator';Analysis {
