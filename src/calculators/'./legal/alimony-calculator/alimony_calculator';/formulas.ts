import { alimony_calculator';Inputs, alimony_calculator';Metrics, alimony_calculator';Analysis } from './types';
...
export function calculateResult(inputs: alimony_calculator';Inputs): number {
...
export function generateAnalysis(inputs: alimony_calculator';Inputs, metrics: alimony_calculator';Metrics): alimony_calculator';Analysis {
