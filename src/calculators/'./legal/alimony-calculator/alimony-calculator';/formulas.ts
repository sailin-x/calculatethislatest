import { alimony-calculator';Inputs, alimony-calculator';Metrics, alimony-calculator';Analysis } from './types';
...
export function calculateResult(inputs: alimony-calculator';Inputs): number {
...
export function generateAnalysis(inputs: alimony-calculator';Inputs, metrics: alimony-calculator';Metrics): alimony-calculator';Analysis {
