import { divorce-settlement-calculator';Inputs, divorce-settlement-calculator';Metrics, divorce-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: divorce-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: divorce-settlement-calculator';Inputs, metrics: divorce-settlement-calculator';Metrics): divorce-settlement-calculator';Analysis {
