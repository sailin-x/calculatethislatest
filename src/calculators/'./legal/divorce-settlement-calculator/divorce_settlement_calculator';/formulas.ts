import { divorce_settlement_calculator';Inputs, divorce_settlement_calculator';Metrics, divorce_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: divorce_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: divorce_settlement_calculator';Inputs, metrics: divorce_settlement_calculator';Metrics): divorce_settlement_calculator';Analysis {
