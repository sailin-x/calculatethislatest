import { premium_deficiency_reserve_calculator';Inputs, premium_deficiency_reserve_calculator';Metrics, premium_deficiency_reserve_calculator';Analysis } from './types';
...
export function calculateResult(inputs: premium_deficiency_reserve_calculator';Inputs): number {
...
export function generateAnalysis(inputs: premium_deficiency_reserve_calculator';Inputs, metrics: premium_deficiency_reserve_calculator';Metrics): premium_deficiency_reserve_calculator';Analysis {
