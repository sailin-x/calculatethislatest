import { premium-deficiency-reserve-calculator';Inputs, premium-deficiency-reserve-calculator';Metrics, premium-deficiency-reserve-calculator';Analysis } from './types';
...
export function calculateResult(inputs: premium-deficiency-reserve-calculator';Inputs): number {
...
export function generateAnalysis(inputs: premium-deficiency-reserve-calculator';Inputs, metrics: premium-deficiency-reserve-calculator';Metrics): premium-deficiency-reserve-calculator';Analysis {
