import { burn_injury_settlement_calculator';Inputs, burn_injury_settlement_calculator';Metrics, burn_injury_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: burn_injury_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: burn_injury_settlement_calculator';Inputs, metrics: burn_injury_settlement_calculator';Metrics): burn_injury_settlement_calculator';Analysis {
