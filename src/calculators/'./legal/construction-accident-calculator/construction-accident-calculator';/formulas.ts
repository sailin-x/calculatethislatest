import { construction-accident-calculator';Inputs, construction-accident-calculator';Metrics, construction-accident-calculator';Analysis } from './types';
...
export function calculateResult(inputs: construction-accident-calculator';Inputs): number {
...
export function generateAnalysis(inputs: construction-accident-calculator';Inputs, metrics: construction-accident-calculator';Metrics): construction-accident-calculator';Analysis {
