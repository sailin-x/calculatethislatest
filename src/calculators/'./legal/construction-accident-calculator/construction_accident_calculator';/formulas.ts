import { construction_accident_calculator';Inputs, construction_accident_calculator';Metrics, construction_accident_calculator';Analysis } from './types';
...
export function calculateResult(inputs: construction_accident_calculator';Inputs): number {
...
export function generateAnalysis(inputs: construction_accident_calculator';Inputs, metrics: construction_accident_calculator';Metrics): construction_accident_calculator';Analysis {
