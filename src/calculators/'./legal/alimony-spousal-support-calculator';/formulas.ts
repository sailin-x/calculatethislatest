import { alimony-spousal-support-calculator';Inputs, alimony-spousal-support-calculator';Metrics, alimony-spousal-support-calculator';Analysis } from './types';
...
export function calculateResult(inputs: alimony-spousal-support-calculator';Inputs): number {
...
export function generateAnalysis(inputs: alimony-spousal-support-calculator';Inputs, metrics: alimony-spousal-support-calculator';Metrics): alimony-spousal-support-calculator';Analysis {
