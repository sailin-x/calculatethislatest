import { './legal/alimony-spousal-support-calculator';Inputs } from './types';

export function validateInputs(inputs: './legal/alimony-spousal-support-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
