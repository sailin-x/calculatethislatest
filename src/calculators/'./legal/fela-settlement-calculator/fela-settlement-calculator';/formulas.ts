import { fela-settlement-calculator';Inputs, fela-settlement-calculator';Metrics, fela-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: fela-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: fela-settlement-calculator';Inputs, metrics: fela-settlement-calculator';Metrics): fela-settlement-calculator';Analysis {
