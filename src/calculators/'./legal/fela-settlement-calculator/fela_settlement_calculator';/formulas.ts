import { fela_settlement_calculator';Inputs, fela_settlement_calculator';Metrics, fela_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: fela_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: fela_settlement_calculator';Inputs, metrics: fela_settlement_calculator';Metrics): fela_settlement_calculator';Analysis {
