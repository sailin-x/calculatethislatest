import { self-funded-health-plan-calculator';Inputs, self-funded-health-plan-calculator';Metrics, self-funded-health-plan-calculator';Analysis } from './types';
...
export function calculateResult(inputs: self-funded-health-plan-calculator';Inputs): number {
...
export function generateAnalysis(inputs: self-funded-health-plan-calculator';Inputs, metrics: self-funded-health-plan-calculator';Metrics): self-funded-health-plan-calculator';Analysis {
