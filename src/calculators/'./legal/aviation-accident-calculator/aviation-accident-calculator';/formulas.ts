import { aviation-accident-calculator';Inputs, aviation-accident-calculator';Metrics, aviation-accident-calculator';Analysis } from './types';
...
export function calculateResult(inputs: aviation-accident-calculator';Inputs): number {
...
export function generateAnalysis(inputs: aviation-accident-calculator';Inputs, metrics: aviation-accident-calculator';Metrics): aviation-accident-calculator';Analysis {
