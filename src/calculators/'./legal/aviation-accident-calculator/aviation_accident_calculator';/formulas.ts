import { aviation_accident_calculator';Inputs, aviation_accident_calculator';Metrics, aviation_accident_calculator';Analysis } from './types';
...
export function calculateResult(inputs: aviation_accident_calculator';Inputs): number {
...
export function generateAnalysis(inputs: aviation_accident_calculator';Inputs, metrics: aviation_accident_calculator';Metrics): aviation_accident_calculator';Analysis {
