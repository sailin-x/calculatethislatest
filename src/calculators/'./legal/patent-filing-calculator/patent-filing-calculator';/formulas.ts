import { patent-filing-calculator';Inputs, patent-filing-calculator';Metrics, patent-filing-calculator';Analysis } from './types';
...
export function calculateResult(inputs: patent-filing-calculator';Inputs): number {
...
export function generateAnalysis(inputs: patent-filing-calculator';Inputs, metrics: patent-filing-calculator';Metrics): patent-filing-calculator';Analysis {
