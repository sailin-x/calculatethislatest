import { patent_filing_calculator';Inputs, patent_filing_calculator';Metrics, patent_filing_calculator';Analysis } from './types';
...
export function calculateResult(inputs: patent_filing_calculator';Inputs): number {
...
export function generateAnalysis(inputs: patent_filing_calculator';Inputs, metrics: patent_filing_calculator';Metrics): patent_filing_calculator';Analysis {
