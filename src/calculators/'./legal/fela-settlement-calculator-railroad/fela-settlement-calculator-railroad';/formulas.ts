import { fela-settlement-calculator-railroad';Inputs, fela-settlement-calculator-railroad';Metrics, fela-settlement-calculator-railroad';Analysis } from './types';
...
export function calculateResult(inputs: fela-settlement-calculator-railroad';Inputs): number {
...
export function generateAnalysis(inputs: fela-settlement-calculator-railroad';Inputs, metrics: fela-settlement-calculator-railroad';Metrics): fela-settlement-calculator-railroad';Analysis {
