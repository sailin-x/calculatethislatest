import { high_net_worth_divorce_calculator';Inputs, high_net_worth_divorce_calculator';Metrics, high_net_worth_divorce_calculator';Analysis } from './types';
...
export function calculateResult(inputs: high_net_worth_divorce_calculator';Inputs): number {
...
export function generateAnalysis(inputs: high_net_worth_divorce_calculator';Inputs, metrics: high_net_worth_divorce_calculator';Metrics): high_net_worth_divorce_calculator';Analysis {
