import { libel_slander_per_se_damages_estimator';Inputs, libel_slander_per_se_damages_estimator';Metrics, libel_slander_per_se_damages_estimator';Analysis } from './types';
...
export function calculateResult(inputs: libel_slander_per_se_damages_estimator';Inputs): number {
...
export function generateAnalysis(inputs: libel_slander_per_se_damages_estimator';Inputs, metrics: libel_slander_per_se_damages_estimator';Metrics): libel_slander_per_se_damages_estimator';Analysis {
