import { irs_offer_in_compromise_calculator';Inputs, irs_offer_in_compromise_calculator';Metrics, irs_offer_in_compromise_calculator';Analysis } from './types';
...
export function calculateResult(inputs: irs_offer_in_compromise_calculator';Inputs): number {
...
export function generateAnalysis(inputs: irs_offer_in_compromise_calculator';Inputs, metrics: irs_offer_in_compromise_calculator';Metrics): irs_offer_in_compromise_calculator';Analysis {
