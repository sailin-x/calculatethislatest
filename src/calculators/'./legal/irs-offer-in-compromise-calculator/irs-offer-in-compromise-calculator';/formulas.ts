import { irs-offer-in-compromise-calculator';Inputs, irs-offer-in-compromise-calculator';Metrics, irs-offer-in-compromise-calculator';Analysis } from './types';
...
export function calculateResult(inputs: irs-offer-in-compromise-calculator';Inputs): number {
...
export function generateAnalysis(inputs: irs-offer-in-compromise-calculator';Inputs, metrics: irs-offer-in-compromise-calculator';Metrics): irs-offer-in-compromise-calculator';Analysis {
