import { property_tax_appeal_savings_calculator';Inputs, property_tax_appeal_savings_calculator';Metrics, property_tax_appeal_savings_calculator';Analysis } from './types';
...
export function calculateResult(inputs: property_tax_appeal_savings_calculator';Inputs): number {
...
export function generateAnalysis(inputs: property_tax_appeal_savings_calculator';Inputs, metrics: property_tax_appeal_savings_calculator';Metrics): property_tax_appeal_savings_calculator';Analysis {
