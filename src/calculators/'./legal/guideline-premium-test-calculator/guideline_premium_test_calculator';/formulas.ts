import { guideline_premium_test_calculator';Inputs, guideline_premium_test_calculator';Metrics, guideline_premium_test_calculator';Analysis } from './types';
...
export function calculateResult(inputs: guideline_premium_test_calculator';Inputs): number {
...
export function generateAnalysis(inputs: guideline_premium_test_calculator';Inputs, metrics: guideline_premium_test_calculator';Metrics): guideline_premium_test_calculator';Analysis {
