import { legal_malpractice_insurance_calculator';Inputs, legal_malpractice_insurance_calculator';Metrics, legal_malpractice_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: legal_malpractice_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: legal_malpractice_insurance_calculator';Inputs, metrics: legal_malpractice_insurance_calculator';Metrics): legal_malpractice_insurance_calculator';Analysis {
