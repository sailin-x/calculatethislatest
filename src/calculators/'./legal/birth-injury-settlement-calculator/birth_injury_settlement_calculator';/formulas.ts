import { birth_injury_settlement_calculator';Inputs, birth_injury_settlement_calculator';Metrics, birth_injury_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: birth_injury_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: birth_injury_settlement_calculator';Inputs, metrics: birth_injury_settlement_calculator';Metrics): birth_injury_settlement_calculator';Analysis {
