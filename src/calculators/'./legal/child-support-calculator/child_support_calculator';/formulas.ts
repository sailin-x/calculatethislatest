import { child_support_calculator';Inputs, child_support_calculator';Metrics, child_support_calculator';Analysis } from './types';
...
export function calculateResult(inputs: child_support_calculator';Inputs): number {
...
export function generateAnalysis(inputs: child_support_calculator';Inputs, metrics: child_support_calculator';Metrics): child_support_calculator';Analysis {
