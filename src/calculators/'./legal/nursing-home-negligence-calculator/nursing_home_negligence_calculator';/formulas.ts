import { nursing_home_negligence_calculator';Inputs, nursing_home_negligence_calculator';Metrics, nursing_home_negligence_calculator';Analysis } from './types';
...
export function calculateResult(inputs: nursing_home_negligence_calculator';Inputs): number {
...
export function generateAnalysis(inputs: nursing_home_negligence_calculator';Inputs, metrics: nursing_home_negligence_calculator';Metrics): nursing_home_negligence_calculator';Analysis {
