import { disability_insurance_calculator';Inputs, disability_insurance_calculator';Metrics, disability_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: disability_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: disability_insurance_calculator';Inputs, metrics: disability_insurance_calculator';Metrics): disability_insurance_calculator';Analysis {
