import { cash_value_accumulation_test_calculator';Inputs, cash_value_accumulation_test_calculator';Metrics, cash_value_accumulation_test_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cash_value_accumulation_test_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cash_value_accumulation_test_calculator';Inputs, metrics: cash_value_accumulation_test_calculator';Metrics): cash_value_accumulation_test_calculator';Analysis {
