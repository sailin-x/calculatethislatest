import { cash-value-accumulation-test-calculator';Inputs, cash-value-accumulation-test-calculator';Metrics, cash-value-accumulation-test-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cash-value-accumulation-test-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cash-value-accumulation-test-calculator';Inputs, metrics: cash-value-accumulation-test-calculator';Metrics): cash-value-accumulation-test-calculator';Analysis {
