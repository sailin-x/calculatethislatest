import { './legal/child-support-calculator';Inputs } from './types';

export function validateInputs(inputs: './legal/child-support-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
