import { antitrust_calculator';Inputs, antitrust_calculator';Metrics, antitrust_calculator';Analysis } from './types';
...
export function calculateResult(inputs: antitrust_calculator';Inputs): number {
...
export function generateAnalysis(inputs: antitrust_calculator';Inputs, metrics: antitrust_calculator';Metrics): antitrust_calculator';Analysis {
