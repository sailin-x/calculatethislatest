import { antitrust-calculator';Inputs, antitrust-calculator';Metrics, antitrust-calculator';Analysis } from './types';
...
export function calculateResult(inputs: antitrust-calculator';Inputs): number {
...
export function generateAnalysis(inputs: antitrust-calculator';Inputs, metrics: antitrust-calculator';Metrics): antitrust-calculator';Analysis {
