import { immigration_filing_calculator';Inputs, immigration_filing_calculator';Metrics, immigration_filing_calculator';Analysis } from './types';
...
export function calculateResult(inputs: immigration_filing_calculator';Inputs): number {
...
export function generateAnalysis(inputs: immigration_filing_calculator';Inputs, metrics: immigration_filing_calculator';Metrics): immigration_filing_calculator';Analysis {
