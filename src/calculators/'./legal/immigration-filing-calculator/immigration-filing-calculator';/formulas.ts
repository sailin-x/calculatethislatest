import { immigration-filing-calculator';Inputs, immigration-filing-calculator';Metrics, immigration-filing-calculator';Analysis } from './types';
...
export function calculateResult(inputs: immigration-filing-calculator';Inputs): number {
...
export function generateAnalysis(inputs: immigration-filing-calculator';Inputs, metrics: immigration-filing-calculator';Metrics): immigration-filing-calculator';Analysis {
