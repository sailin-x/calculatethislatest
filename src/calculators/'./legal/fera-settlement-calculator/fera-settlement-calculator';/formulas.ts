import { fera-settlement-calculator';Inputs, fera-settlement-calculator';Metrics, fera-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: fera-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: fera-settlement-calculator';Inputs, metrics: fera-settlement-calculator';Metrics): fera-settlement-calculator';Analysis {
