import { fera_settlement_calculator';Inputs, fera_settlement_calculator';Metrics, fera_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: fera_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: fera_settlement_calculator';Inputs, metrics: fera_settlement_calculator';Metrics): fera_settlement_calculator';Analysis {
