import { personal-injury';Inputs, personal-injury';Metrics, personal-injury';Analysis } from './types';
...
export function calculateResult(inputs: personal-injury';Inputs): number {
...
export function generateAnalysis(inputs: personal-injury';Inputs, metrics: personal-injury';Metrics): personal-injury';Analysis {
