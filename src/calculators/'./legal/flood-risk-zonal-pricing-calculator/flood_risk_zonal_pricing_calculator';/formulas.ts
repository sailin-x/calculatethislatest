import { flood_risk_zonal_pricing_calculator';Inputs, flood_risk_zonal_pricing_calculator';Metrics, flood_risk_zonal_pricing_calculator';Analysis } from './types';
...
export function calculateResult(inputs: flood_risk_zonal_pricing_calculator';Inputs): number {
...
export function generateAnalysis(inputs: flood_risk_zonal_pricing_calculator';Inputs, metrics: flood_risk_zonal_pricing_calculator';Metrics): flood_risk_zonal_pricing_calculator';Analysis {
