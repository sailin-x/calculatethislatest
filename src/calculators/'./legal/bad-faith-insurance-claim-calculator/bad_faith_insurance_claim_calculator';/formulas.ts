import { bad_faith_insurance_claim_calculator';Inputs, bad_faith_insurance_claim_calculator';Metrics, bad_faith_insurance_claim_calculator';Analysis } from './types';
...
export function calculateResult(inputs: bad_faith_insurance_claim_calculator';Inputs): number {
...
export function generateAnalysis(inputs: bad_faith_insurance_claim_calculator';Inputs, metrics: bad_faith_insurance_claim_calculator';Metrics): bad_faith_insurance_claim_calculator';Analysis {
