import { long-term-disability-calculator';Inputs, long-term-disability-calculator';Metrics, long-term-disability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: long-term-disability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: long-term-disability-calculator';Inputs, metrics: long-term-disability-calculator';Metrics): long-term-disability-calculator';Analysis {
