import { long_term_disability_calculator';Inputs, long_term_disability_calculator';Metrics, long_term_disability_calculator';Analysis } from './types';
...
export function calculateResult(inputs: long_term_disability_calculator';Inputs): number {
...
export function generateAnalysis(inputs: long_term_disability_calculator';Inputs, metrics: long_term_disability_calculator';Metrics): long_term_disability_calculator';Analysis {
