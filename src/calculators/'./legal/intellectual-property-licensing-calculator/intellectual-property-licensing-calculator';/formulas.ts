import { intellectual-property-licensing-calculator';Inputs, intellectual-property-licensing-calculator';Metrics, intellectual-property-licensing-calculator';Analysis } from './types';
...
export function calculateResult(inputs: intellectual-property-licensing-calculator';Inputs): number {
...
export function generateAnalysis(inputs: intellectual-property-licensing-calculator';Inputs, metrics: intellectual-property-licensing-calculator';Metrics): intellectual-property-licensing-calculator';Analysis {
