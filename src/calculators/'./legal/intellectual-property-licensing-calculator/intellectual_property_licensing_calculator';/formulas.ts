import { intellectual_property_licensing_calculator';Inputs, intellectual_property_licensing_calculator';Metrics, intellectual_property_licensing_calculator';Analysis } from './types';
...
export function calculateResult(inputs: intellectual_property_licensing_calculator';Inputs): number {
...
export function generateAnalysis(inputs: intellectual_property_licensing_calculator';Inputs, metrics: intellectual_property_licensing_calculator';Metrics): intellectual_property_licensing_calculator';Analysis {
