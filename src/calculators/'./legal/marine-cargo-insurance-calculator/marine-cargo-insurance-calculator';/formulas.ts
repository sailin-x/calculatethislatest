import { marine-cargo-insurance-calculator';Inputs, marine-cargo-insurance-calculator';Metrics, marine-cargo-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: marine-cargo-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: marine-cargo-insurance-calculator';Inputs, metrics: marine-cargo-insurance-calculator';Metrics): marine-cargo-insurance-calculator';Analysis {
