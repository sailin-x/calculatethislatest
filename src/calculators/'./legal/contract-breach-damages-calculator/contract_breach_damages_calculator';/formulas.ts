import { contract_breach_damages_calculator';Inputs, contract_breach_damages_calculator';Metrics, contract_breach_damages_calculator';Analysis } from './types';
...
export function calculateResult(inputs: contract_breach_damages_calculator';Inputs): number {
...
export function generateAnalysis(inputs: contract_breach_damages_calculator';Inputs, metrics: contract_breach_damages_calculator';Metrics): contract_breach_damages_calculator';Analysis {
