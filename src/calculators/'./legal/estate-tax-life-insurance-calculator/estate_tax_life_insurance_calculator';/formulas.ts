import { estate_tax_life_insurance_calculator';Inputs, estate_tax_life_insurance_calculator';Metrics, estate_tax_life_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: estate_tax_life_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: estate_tax_life_insurance_calculator';Inputs, metrics: estate_tax_life_insurance_calculator';Metrics): estate_tax_life_insurance_calculator';Analysis {
