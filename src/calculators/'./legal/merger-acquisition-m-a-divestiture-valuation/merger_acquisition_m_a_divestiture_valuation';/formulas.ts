import { merger_acquisition_m_a_divestiture_valuation';Inputs, merger_acquisition_m_a_divestiture_valuation';Metrics, merger_acquisition_m_a_divestiture_valuation';Analysis } from './types';
...
export function calculateResult(inputs: merger_acquisition_m_a_divestiture_valuation';Inputs): number {
...
export function generateAnalysis(inputs: merger_acquisition_m_a_divestiture_valuation';Inputs, metrics: merger_acquisition_m_a_divestiture_valuation';Metrics): merger_acquisition_m_a_divestiture_valuation';Analysis {
