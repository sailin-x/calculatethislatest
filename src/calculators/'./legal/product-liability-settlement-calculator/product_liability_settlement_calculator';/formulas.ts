import { product_liability_settlement_calculator';Inputs, product_liability_settlement_calculator';Metrics, product_liability_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: product_liability_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: product_liability_settlement_calculator';Inputs, metrics: product_liability_settlement_calculator';Metrics): product_liability_settlement_calculator';Analysis {
