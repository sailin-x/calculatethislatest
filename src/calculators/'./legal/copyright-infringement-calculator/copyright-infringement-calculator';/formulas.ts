import { copyright-infringement-calculator';Inputs, copyright-infringement-calculator';Metrics, copyright-infringement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: copyright-infringement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: copyright-infringement-calculator';Inputs, metrics: copyright-infringement-calculator';Metrics): copyright-infringement-calculator';Analysis {
