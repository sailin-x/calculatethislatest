import { contract_review_calculator';Inputs, contract_review_calculator';Metrics, contract_review_calculator';Analysis } from './types';
...
export function calculateResult(inputs: contract_review_calculator';Inputs): number {
...
export function generateAnalysis(inputs: contract_review_calculator';Inputs, metrics: contract_review_calculator';Metrics): contract_review_calculator';Analysis {
