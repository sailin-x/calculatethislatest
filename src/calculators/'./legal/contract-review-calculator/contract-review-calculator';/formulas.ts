import { contract-review-calculator';Inputs, contract-review-calculator';Metrics, contract-review-calculator';Analysis } from './types';
...
export function calculateResult(inputs: contract-review-calculator';Inputs): number {
...
export function generateAnalysis(inputs: contract-review-calculator';Inputs, metrics: contract-review-calculator';Metrics): contract-review-calculator';Analysis {
