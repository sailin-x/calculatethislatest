import { surety_bond_calculator';Inputs, surety_bond_calculator';Metrics, surety_bond_calculator';Analysis } from './types';
...
export function calculateResult(inputs: surety_bond_calculator';Inputs): number {
...
export function generateAnalysis(inputs: surety_bond_calculator';Inputs, metrics: surety_bond_calculator';Metrics): surety_bond_calculator';Analysis {
