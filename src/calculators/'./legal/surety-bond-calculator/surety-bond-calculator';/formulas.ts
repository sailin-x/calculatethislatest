import { surety-bond-calculator';Inputs, surety-bond-calculator';Metrics, surety-bond-calculator';Analysis } from './types';
...
export function calculateResult(inputs: surety-bond-calculator';Inputs): number {
...
export function generateAnalysis(inputs: surety-bond-calculator';Inputs, metrics: surety-bond-calculator';Metrics): surety-bond-calculator';Analysis {
