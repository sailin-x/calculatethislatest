import { hit_and_run_settlement_calculator';Inputs, hit_and_run_settlement_calculator';Metrics, hit_and_run_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: hit_and_run_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: hit_and_run_settlement_calculator';Inputs, metrics: hit_and_run_settlement_calculator';Metrics): hit_and_run_settlement_calculator';Analysis {
