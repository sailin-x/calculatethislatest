import { stop-loss-insurance-calculator';Inputs, stop-loss-insurance-calculator';Metrics, stop-loss-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: stop-loss-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: stop-loss-insurance-calculator';Inputs, metrics: stop-loss-insurance-calculator';Metrics): stop-loss-insurance-calculator';Analysis {
