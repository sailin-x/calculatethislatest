import { stop_loss_insurance_calculator';Inputs, stop_loss_insurance_calculator';Metrics, stop_loss_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: stop_loss_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: stop_loss_insurance_calculator';Inputs, metrics: stop_loss_insurance_calculator';Metrics): stop_loss_insurance_calculator';Analysis {
