import { auto_insurance_calculator';Inputs, auto_insurance_calculator';Metrics, auto_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: auto_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: auto_insurance_calculator';Inputs, metrics: auto_insurance_calculator';Metrics): auto_insurance_calculator';Analysis {
