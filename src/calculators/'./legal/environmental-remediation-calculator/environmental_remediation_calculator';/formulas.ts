import { environmental_remediation_calculator';Inputs, environmental_remediation_calculator';Metrics, environmental_remediation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: environmental_remediation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: environmental_remediation_calculator';Inputs, metrics: environmental_remediation_calculator';Metrics): environmental_remediation_calculator';Analysis {
