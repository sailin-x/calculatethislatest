import { environmental-remediation-calculator';Inputs, environmental-remediation-calculator';Metrics, environmental-remediation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: environmental-remediation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: environmental-remediation-calculator';Inputs, metrics: environmental-remediation-calculator';Metrics): environmental-remediation-calculator';Analysis {
