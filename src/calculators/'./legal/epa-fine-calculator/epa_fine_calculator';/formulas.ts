import { epa_fine_calculator';Inputs, epa_fine_calculator';Metrics, epa_fine_calculator';Analysis } from './types';
...
export function calculateResult(inputs: epa_fine_calculator';Inputs): number {
...
export function generateAnalysis(inputs: epa_fine_calculator';Inputs, metrics: epa_fine_calculator';Metrics): epa_fine_calculator';Analysis {
