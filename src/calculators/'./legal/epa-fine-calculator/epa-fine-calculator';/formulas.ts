import { epa-fine-calculator';Inputs, epa-fine-calculator';Metrics, epa-fine-calculator';Analysis } from './types';
...
export function calculateResult(inputs: epa-fine-calculator';Inputs): number {
...
export function generateAnalysis(inputs: epa-fine-calculator';Inputs, metrics: epa-fine-calculator';Metrics): epa-fine-calculator';Analysis {
