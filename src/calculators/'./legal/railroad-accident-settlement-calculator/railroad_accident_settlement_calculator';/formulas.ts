import { railroad_accident_settlement_calculator';Inputs, railroad_accident_settlement_calculator';Metrics, railroad_accident_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: railroad_accident_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: railroad_accident_settlement_calculator';Inputs, metrics: railroad_accident_settlement_calculator';Metrics): railroad_accident_settlement_calculator';Analysis {
