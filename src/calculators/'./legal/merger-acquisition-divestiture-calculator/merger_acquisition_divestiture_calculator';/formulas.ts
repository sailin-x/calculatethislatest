import { merger_acquisition_divestiture_calculator';Inputs, merger_acquisition_divestiture_calculator';Metrics, merger_acquisition_divestiture_calculator';Analysis } from './types';
...
export function calculateResult(inputs: merger_acquisition_divestiture_calculator';Inputs): number {
...
export function generateAnalysis(inputs: merger_acquisition_divestiture_calculator';Inputs, metrics: merger_acquisition_divestiture_calculator';Metrics): merger_acquisition_divestiture_calculator';Analysis {
