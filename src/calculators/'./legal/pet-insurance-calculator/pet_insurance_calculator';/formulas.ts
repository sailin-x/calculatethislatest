import { pet_insurance_calculator';Inputs, pet_insurance_calculator';Metrics, pet_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: pet_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: pet_insurance_calculator';Inputs, metrics: pet_insurance_calculator';Metrics): pet_insurance_calculator';Analysis {
