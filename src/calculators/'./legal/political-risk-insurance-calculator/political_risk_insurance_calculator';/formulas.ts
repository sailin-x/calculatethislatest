import { political_risk_insurance_calculator';Inputs, political_risk_insurance_calculator';Metrics, political_risk_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: political_risk_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: political_risk_insurance_calculator';Inputs, metrics: political_risk_insurance_calculator';Metrics): political_risk_insurance_calculator';Analysis {
