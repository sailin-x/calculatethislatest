import { hospital_negligence_calculator';Inputs, hospital_negligence_calculator';Metrics, hospital_negligence_calculator';Analysis } from './types';
...
export function calculateResult(inputs: hospital_negligence_calculator';Inputs): number {
...
export function generateAnalysis(inputs: hospital_negligence_calculator';Inputs, metrics: hospital_negligence_calculator';Metrics): hospital_negligence_calculator';Analysis {
