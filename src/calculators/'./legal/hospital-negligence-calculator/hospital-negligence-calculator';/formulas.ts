import { hospital-negligence-calculator';Inputs, hospital-negligence-calculator';Metrics, hospital-negligence-calculator';Analysis } from './types';
...
export function calculateResult(inputs: hospital-negligence-calculator';Inputs): number {
...
export function generateAnalysis(inputs: hospital-negligence-calculator';Inputs, metrics: hospital-negligence-calculator';Metrics): hospital-negligence-calculator';Analysis {
