import { contract-breach-calculator';Inputs, contract-breach-calculator';Metrics, contract-breach-calculator';Analysis } from './types';
...
export function calculateResult(inputs: contract-breach-calculator';Inputs): number {
...
export function generateAnalysis(inputs: contract-breach-calculator';Inputs, metrics: contract-breach-calculator';Metrics): contract-breach-calculator';Analysis {
