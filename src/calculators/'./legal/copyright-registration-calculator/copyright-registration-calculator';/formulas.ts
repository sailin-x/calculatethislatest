import { copyright-registration-calculator';Inputs, copyright-registration-calculator';Metrics, copyright-registration-calculator';Analysis } from './types';
...
export function calculateResult(inputs: copyright-registration-calculator';Inputs): number {
...
export function generateAnalysis(inputs: copyright-registration-calculator';Inputs, metrics: copyright-registration-calculator';Metrics): copyright-registration-calculator';Analysis {
