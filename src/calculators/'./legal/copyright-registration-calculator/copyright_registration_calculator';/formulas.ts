import { copyright_registration_calculator';Inputs, copyright_registration_calculator';Metrics, copyright_registration_calculator';Analysis } from './types';
...
export function calculateResult(inputs: copyright_registration_calculator';Inputs): number {
...
export function generateAnalysis(inputs: copyright_registration_calculator';Inputs, metrics: copyright_registration_calculator';Metrics): copyright_registration_calculator';Analysis {
