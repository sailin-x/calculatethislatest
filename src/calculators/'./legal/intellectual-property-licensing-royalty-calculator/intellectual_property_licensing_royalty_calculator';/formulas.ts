import { intellectual_property_licensing_royalty_calculator';Inputs, intellectual_property_licensing_royalty_calculator';Metrics, intellectual_property_licensing_royalty_calculator';Analysis } from './types';
...
export function calculateResult(inputs: intellectual_property_licensing_royalty_calculator';Inputs): number {
...
export function generateAnalysis(inputs: intellectual_property_licensing_royalty_calculator';Inputs, metrics: intellectual_property_licensing_royalty_calculator';Metrics): intellectual_property_licensing_royalty_calculator';Analysis {
