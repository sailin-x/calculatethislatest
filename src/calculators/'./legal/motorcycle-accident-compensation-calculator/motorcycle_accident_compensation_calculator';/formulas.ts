import { motorcycle_accident_compensation_calculator';Inputs, motorcycle_accident_compensation_calculator';Metrics, motorcycle_accident_compensation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: motorcycle_accident_compensation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: motorcycle_accident_compensation_calculator';Inputs, metrics: motorcycle_accident_compensation_calculator';Metrics): motorcycle_accident_compensation_calculator';Analysis {
