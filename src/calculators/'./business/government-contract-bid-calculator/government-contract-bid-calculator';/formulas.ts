import { government-contract-bid-calculator';Inputs, government-contract-bid-calculator';Metrics, government-contract-bid-calculator';Analysis } from './types';
...
export function calculateResult(inputs: government-contract-bid-calculator';Inputs): number {
...
export function generateAnalysis(inputs: government-contract-bid-calculator';Inputs, metrics: government-contract-bid-calculator';Metrics): government-contract-bid-calculator';Analysis {
