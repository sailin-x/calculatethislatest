import { government_contract_bid_calculator';Inputs, government_contract_bid_calculator';Metrics, government_contract_bid_calculator';Analysis } from './types';
...
export function calculateResult(inputs: government_contract_bid_calculator';Inputs): number {
...
export function generateAnalysis(inputs: government_contract_bid_calculator';Inputs, metrics: government_contract_bid_calculator';Metrics): government_contract_bid_calculator';Analysis {
