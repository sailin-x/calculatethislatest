import { bill_of_materials_calculator';Inputs, bill_of_materials_calculator';Metrics, bill_of_materials_calculator';Analysis } from './types';
...
export function calculateResult(inputs: bill_of_materials_calculator';Inputs): number {
...
export function generateAnalysis(inputs: bill_of_materials_calculator';Inputs, metrics: bill_of_materials_calculator';Metrics): bill_of_materials_calculator';Analysis {
