import { net_promoter_score_nps_calculator';Inputs, net_promoter_score_nps_calculator';Metrics, net_promoter_score_nps_calculator';Analysis } from './types';
...
export function calculateResult(inputs: net_promoter_score_nps_calculator';Inputs): number {
...
export function generateAnalysis(inputs: net_promoter_score_nps_calculator';Inputs, metrics: net_promoter_score_nps_calculator';Metrics): net_promoter_score_nps_calculator';Analysis {
