import { soc-2-compliance-cost-estimator';Inputs, soc-2-compliance-cost-estimator';Metrics, soc-2-compliance-cost-estimator';Analysis } from './types';
...
export function calculateResult(inputs: soc-2-compliance-cost-estimator';Inputs): number {
...
export function generateAnalysis(inputs: soc-2-compliance-cost-estimator';Inputs, metrics: soc-2-compliance-cost-estimator';Metrics): soc-2-compliance-cost-estimator';Analysis {
