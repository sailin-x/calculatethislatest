import { roi';Inputs, roi';Metrics, roi';Analysis } from './types';
...
export function calculateResult(inputs: roi';Inputs): number {
...
export function generateAnalysis(inputs: roi';Inputs, metrics: roi';Metrics): roi';Analysis {
