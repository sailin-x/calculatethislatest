import { soc_2_compliance_cost_calculator';Inputs, soc_2_compliance_cost_calculator';Metrics, soc_2_compliance_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: soc_2_compliance_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: soc_2_compliance_cost_calculator';Inputs, metrics: soc_2_compliance_cost_calculator';Metrics): soc_2_compliance_cost_calculator';Analysis {
