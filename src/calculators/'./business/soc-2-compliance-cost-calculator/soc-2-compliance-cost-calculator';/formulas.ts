import { soc-2-compliance-cost-calculator';Inputs, soc-2-compliance-cost-calculator';Metrics, soc-2-compliance-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: soc-2-compliance-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: soc-2-compliance-cost-calculator';Inputs, metrics: soc-2-compliance-cost-calculator';Metrics): soc-2-compliance-cost-calculator';Analysis {
