import { customer_acquisition_cost_calculator';Inputs, customer_acquisition_cost_calculator';Metrics, customer_acquisition_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: customer_acquisition_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: customer_acquisition_cost_calculator';Inputs, metrics: customer_acquisition_cost_calculator';Metrics): customer_acquisition_cost_calculator';Analysis {
