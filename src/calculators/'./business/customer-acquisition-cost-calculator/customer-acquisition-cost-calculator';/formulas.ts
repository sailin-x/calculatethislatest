import { customer-acquisition-cost-calculator';Inputs, customer-acquisition-cost-calculator';Metrics, customer-acquisition-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: customer-acquisition-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: customer-acquisition-cost-calculator';Inputs, metrics: customer-acquisition-cost-calculator';Metrics): customer-acquisition-cost-calculator';Analysis {
