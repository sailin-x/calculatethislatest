import { music_catalogue_valuation_calculator';Inputs, music_catalogue_valuation_calculator';Metrics, music_catalogue_valuation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: music_catalogue_valuation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: music_catalogue_valuation_calculator';Inputs, metrics: music_catalogue_valuation_calculator';Metrics): music_catalogue_valuation_calculator';Analysis {
