import { customer_lifetime_value';Inputs, customer_lifetime_value';Metrics, customer_lifetime_value';Analysis } from './types';
...
export function calculateResult(inputs: customer_lifetime_value';Inputs): number {
...
export function generateAnalysis(inputs: customer_lifetime_value';Inputs, metrics: customer_lifetime_value';Metrics): customer_lifetime_value';Analysis {
