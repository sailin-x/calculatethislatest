import { customer-lifetime-value';Inputs, customer-lifetime-value';Metrics, customer-lifetime-value';Analysis } from './types';
...
export function calculateResult(inputs: customer-lifetime-value';Inputs): number {
...
export function generateAnalysis(inputs: customer-lifetime-value';Inputs, metrics: customer-lifetime-value';Metrics): customer-lifetime-value';Analysis {
