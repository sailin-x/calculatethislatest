import { api_monetization_revenue_calculator';Inputs, api_monetization_revenue_calculator';Metrics, api_monetization_revenue_calculator';Analysis } from './types';
...
export function calculateResult(inputs: api_monetization_revenue_calculator';Inputs): number {
...
export function generateAnalysis(inputs: api_monetization_revenue_calculator';Inputs, metrics: api_monetization_revenue_calculator';Metrics): api_monetization_revenue_calculator';Analysis {
