import { sponsorship_roi_calculator';Inputs, sponsorship_roi_calculator';Metrics, sponsorship_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: sponsorship_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: sponsorship_roi_calculator';Inputs, metrics: sponsorship_roi_calculator';Metrics): sponsorship_roi_calculator';Analysis {
