import { human-capital-due-diligence-calculator';Inputs, human-capital-due-diligence-calculator';Metrics, human-capital-due-diligence-calculator';Analysis } from './types';
...
export function calculateResult(inputs: human-capital-due-diligence-calculator';Inputs): number {
...
export function generateAnalysis(inputs: human-capital-due-diligence-calculator';Inputs, metrics: human-capital-due-diligence-calculator';Metrics): human-capital-due-diligence-calculator';Analysis {
