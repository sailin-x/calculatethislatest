import { data_governance_roi_calculator';Inputs, data_governance_roi_calculator';Metrics, data_governance_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: data_governance_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: data_governance_roi_calculator';Inputs, metrics: data_governance_roi_calculator';Metrics): data_governance_roi_calculator';Analysis {
