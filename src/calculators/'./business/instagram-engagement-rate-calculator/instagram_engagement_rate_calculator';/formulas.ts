import { instagram_engagement_rate_calculator';Inputs, instagram_engagement_rate_calculator';Metrics, instagram_engagement_rate_calculator';Analysis } from './types';
...
export function calculateResult(inputs: instagram_engagement_rate_calculator';Inputs): number {
...
export function generateAnalysis(inputs: instagram_engagement_rate_calculator';Inputs, metrics: instagram_engagement_rate_calculator';Metrics): instagram_engagement_rate_calculator';Analysis {
