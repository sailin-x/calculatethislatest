import { './business/marketing-roi-calculator';Inputs } from './types';

export function validateInputs(inputs: './business/marketing-roi-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
