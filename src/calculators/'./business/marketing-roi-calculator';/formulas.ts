import { marketing-roi-calculator';Inputs, marketing-roi-calculator';Metrics, marketing-roi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: marketing-roi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: marketing-roi-calculator';Inputs, metrics: marketing-roi-calculator';Metrics): marketing-roi-calculator';Analysis {
