import { startup_valuation_calculator';Inputs, startup_valuation_calculator';Metrics, startup_valuation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: startup_valuation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: startup_valuation_calculator';Inputs, metrics: startup_valuation_calculator';Metrics): startup_valuation_calculator';Analysis {
