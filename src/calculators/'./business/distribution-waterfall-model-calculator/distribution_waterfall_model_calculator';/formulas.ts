import { distribution_waterfall_model_calculator';Inputs, distribution_waterfall_model_calculator';Metrics, distribution_waterfall_model_calculator';Analysis } from './types';
...
export function calculateResult(inputs: distribution_waterfall_model_calculator';Inputs): number {
...
export function generateAnalysis(inputs: distribution_waterfall_model_calculator';Inputs, metrics: distribution_waterfall_model_calculator';Metrics): distribution_waterfall_model_calculator';Analysis {
