import { restricted-stock-unit-vs-stock-option-calculator';Inputs, restricted-stock-unit-vs-stock-option-calculator';Metrics, restricted-stock-unit-vs-stock-option-calculator';Analysis } from './types';
...
export function calculateResult(inputs: restricted-stock-unit-vs-stock-option-calculator';Inputs): number {
...
export function generateAnalysis(inputs: restricted-stock-unit-vs-stock-option-calculator';Inputs, metrics: restricted-stock-unit-vs-stock-option-calculator';Metrics): restricted-stock-unit-vs-stock-option-calculator';Analysis {
