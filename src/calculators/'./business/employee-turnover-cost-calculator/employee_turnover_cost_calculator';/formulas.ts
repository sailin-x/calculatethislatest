import { employee_turnover_cost_calculator';Inputs, employee_turnover_cost_calculator';Metrics, employee_turnover_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: employee_turnover_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: employee_turnover_cost_calculator';Inputs, metrics: employee_turnover_cost_calculator';Metrics): employee_turnover_cost_calculator';Analysis {
