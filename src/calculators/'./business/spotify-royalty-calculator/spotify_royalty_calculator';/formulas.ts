import { spotify_royalty_calculator';Inputs, spotify_royalty_calculator';Metrics, spotify_royalty_calculator';Analysis } from './types';
...
export function calculateResult(inputs: spotify_royalty_calculator';Inputs): number {
...
export function generateAnalysis(inputs: spotify_royalty_calculator';Inputs, metrics: spotify_royalty_calculator';Metrics): spotify_royalty_calculator';Analysis {
