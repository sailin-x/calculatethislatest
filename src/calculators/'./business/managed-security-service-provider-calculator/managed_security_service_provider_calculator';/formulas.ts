import { managed_security_service_provider_calculator';Inputs, managed_security_service_provider_calculator';Metrics, managed_security_service_provider_calculator';Analysis } from './types';
...
export function calculateResult(inputs: managed_security_service_provider_calculator';Inputs): number {
...
export function generateAnalysis(inputs: managed_security_service_provider_calculator';Inputs, metrics: managed_security_service_provider_calculator';Metrics): managed_security_service_provider_calculator';Analysis {
