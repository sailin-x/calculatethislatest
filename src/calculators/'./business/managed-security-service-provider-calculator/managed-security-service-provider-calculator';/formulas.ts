import { managed-security-service-provider-calculator';Inputs, managed-security-service-provider-calculator';Metrics, managed-security-service-provider-calculator';Analysis } from './types';
...
export function calculateResult(inputs: managed-security-service-provider-calculator';Inputs): number {
...
export function generateAnalysis(inputs: managed-security-service-provider-calculator';Inputs, metrics: managed-security-service-provider-calculator';Metrics): managed-security-service-provider-calculator';Analysis {
