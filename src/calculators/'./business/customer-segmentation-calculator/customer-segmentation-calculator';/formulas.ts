import { customer-segmentation-calculator';Inputs, customer-segmentation-calculator';Metrics, customer-segmentation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: customer-segmentation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: customer-segmentation-calculator';Inputs, metrics: customer-segmentation-calculator';Metrics): customer-segmentation-calculator';Analysis {
