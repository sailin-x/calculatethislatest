import { business_loan_qualification_calculator';Inputs, business_loan_qualification_calculator';Metrics, business_loan_qualification_calculator';Analysis } from './types';
...
export function calculateResult(inputs: business_loan_qualification_calculator';Inputs): number {
...
export function generateAnalysis(inputs: business_loan_qualification_calculator';Inputs, metrics: business_loan_qualification_calculator';Metrics): business_loan_qualification_calculator';Analysis {
