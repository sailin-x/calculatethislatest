import { marketing_roi_calculator';Inputs, marketing_roi_calculator';Metrics, marketing_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: marketing_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: marketing_roi_calculator';Inputs, metrics: marketing_roi_calculator';Metrics): marketing_roi_calculator';Analysis {
