import { './business/marketing-roi-calculator/register';Inputs } from './types';

export function validateInputs(inputs: './business/marketing-roi-calculator/register';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
