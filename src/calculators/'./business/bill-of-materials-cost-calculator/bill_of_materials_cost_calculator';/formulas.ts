import { bill_of_materials_cost_calculator';Inputs, bill_of_materials_cost_calculator';Metrics, bill_of_materials_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: bill_of_materials_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: bill_of_materials_cost_calculator';Inputs, metrics: bill_of_materials_cost_calculator';Metrics): bill_of_materials_cost_calculator';Analysis {
