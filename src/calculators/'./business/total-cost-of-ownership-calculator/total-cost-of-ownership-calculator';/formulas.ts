import { total-cost-of-ownership-calculator';Inputs, total-cost-of-ownership-calculator';Metrics, total-cost-of-ownership-calculator';Analysis } from './types';
...
export function calculateResult(inputs: total-cost-of-ownership-calculator';Inputs): number {
...
export function generateAnalysis(inputs: total-cost-of-ownership-calculator';Inputs, metrics: total-cost-of-ownership-calculator';Metrics): total-cost-of-ownership-calculator';Analysis {
