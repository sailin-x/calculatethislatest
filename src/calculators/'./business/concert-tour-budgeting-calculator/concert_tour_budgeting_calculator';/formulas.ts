import { concert_tour_budgeting_calculator';Inputs, concert_tour_budgeting_calculator';Metrics, concert_tour_budgeting_calculator';Analysis } from './types';
...
export function calculateResult(inputs: concert_tour_budgeting_calculator';Inputs): number {
...
export function generateAnalysis(inputs: concert_tour_budgeting_calculator';Inputs, metrics: concert_tour_budgeting_calculator';Metrics): concert_tour_budgeting_calculator';Analysis {
