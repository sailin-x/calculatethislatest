import { manyvids_revenue_calculator';Inputs, manyvids_revenue_calculator';Metrics, manyvids_revenue_calculator';Analysis } from './types';
...
export function calculateResult(inputs: manyvids_revenue_calculator';Inputs): number {
...
export function generateAnalysis(inputs: manyvids_revenue_calculator';Inputs, metrics: manyvids_revenue_calculator';Metrics): manyvids_revenue_calculator';Analysis {
