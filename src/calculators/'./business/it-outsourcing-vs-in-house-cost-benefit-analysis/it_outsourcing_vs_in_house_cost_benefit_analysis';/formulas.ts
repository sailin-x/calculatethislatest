import { it_outsourcing_vs_in_house_cost_benefit_analysis';Inputs, it_outsourcing_vs_in_house_cost_benefit_analysis';Metrics, it_outsourcing_vs_in_house_cost_benefit_analysis';Analysis } from './types';
...
export function calculateResult(inputs: it_outsourcing_vs_in_house_cost_benefit_analysis';Inputs): number {
...
export function generateAnalysis(inputs: it_outsourcing_vs_in_house_cost_benefit_analysis';Inputs, metrics: it_outsourcing_vs_in_house_cost_benefit_analysis';Metrics): it_outsourcing_vs_in_house_cost_benefit_analysis';Analysis {
