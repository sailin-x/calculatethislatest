import { it-outsourcing-vs-in-house-cost-benefit-analysis';Inputs, it-outsourcing-vs-in-house-cost-benefit-analysis';Metrics, it-outsourcing-vs-in-house-cost-benefit-analysis';Analysis } from './types';
...
export function calculateResult(inputs: it-outsourcing-vs-in-house-cost-benefit-analysis';Inputs): number {
...
export function generateAnalysis(inputs: it-outsourcing-vs-in-house-cost-benefit-analysis';Inputs, metrics: it-outsourcing-vs-in-house-cost-benefit-analysis';Metrics): it-outsourcing-vs-in-house-cost-benefit-analysis';Analysis {
