import { churn-rate-calculator';Inputs, churn-rate-calculator';Metrics, churn-rate-calculator';Analysis } from './types';
...
export function calculateResult(inputs: churn-rate-calculator';Inputs): number {
...
export function generateAnalysis(inputs: churn-rate-calculator';Inputs, metrics: churn-rate-calculator';Metrics): churn-rate-calculator';Analysis {
