import { churn_rate_calculator';Inputs, churn_rate_calculator';Metrics, churn_rate_calculator';Analysis } from './types';
...
export function calculateResult(inputs: churn_rate_calculator';Inputs): number {
...
export function generateAnalysis(inputs: churn_rate_calculator';Inputs, metrics: churn_rate_calculator';Metrics): churn_rate_calculator';Analysis {
