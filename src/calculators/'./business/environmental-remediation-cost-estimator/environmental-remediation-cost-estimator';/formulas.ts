import { environmental-remediation-cost-estimator';Inputs, environmental-remediation-cost-estimator';Metrics, environmental-remediation-cost-estimator';Analysis } from './types';
...
export function calculateResult(inputs: environmental-remediation-cost-estimator';Inputs): number {
...
export function generateAnalysis(inputs: environmental-remediation-cost-estimator';Inputs, metrics: environmental-remediation-cost-estimator';Metrics): environmental-remediation-cost-estimator';Analysis {
