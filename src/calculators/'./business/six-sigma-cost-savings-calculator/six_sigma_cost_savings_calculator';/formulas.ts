import { six_sigma_cost_savings_calculator';Inputs, six_sigma_cost_savings_calculator';Metrics, six_sigma_cost_savings_calculator';Analysis } from './types';
...
export function calculateResult(inputs: six_sigma_cost_savings_calculator';Inputs): number {
...
export function generateAnalysis(inputs: six_sigma_cost_savings_calculator';Inputs, metrics: six_sigma_cost_savings_calculator';Metrics): six_sigma_cost_savings_calculator';Analysis {
