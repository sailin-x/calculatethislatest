import { consultant-utilization-rate-calculator';Inputs, consultant-utilization-rate-calculator';Metrics, consultant-utilization-rate-calculator';Analysis } from './types';
...
export function calculateResult(inputs: consultant-utilization-rate-calculator';Inputs): number {
...
export function generateAnalysis(inputs: consultant-utilization-rate-calculator';Inputs, metrics: consultant-utilization-rate-calculator';Metrics): consultant-utilization-rate-calculator';Analysis {
