import { consultant_utilization_rate_calculator';Inputs, consultant_utilization_rate_calculator';Metrics, consultant_utilization_rate_calculator';Analysis } from './types';
...
export function calculateResult(inputs: consultant_utilization_rate_calculator';Inputs): number {
...
export function generateAnalysis(inputs: consultant_utilization_rate_calculator';Inputs, metrics: consultant_utilization_rate_calculator';Metrics): consultant_utilization_rate_calculator';Analysis {
