import { book_publishing_advance_calculator';Inputs, book_publishing_advance_calculator';Metrics, book_publishing_advance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: book_publishing_advance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: book_publishing_advance_calculator';Inputs, metrics: book_publishing_advance_calculator';Metrics): book_publishing_advance_calculator';Analysis {
