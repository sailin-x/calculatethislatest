import { book-publishing-advance-calculator';Inputs, book-publishing-advance-calculator';Metrics, book-publishing-advance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: book-publishing-advance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: book-publishing-advance-calculator';Inputs, metrics: book-publishing-advance-calculator';Metrics): book-publishing-advance-calculator';Analysis {
