import { attribution_models_calculator';Inputs, attribution_models_calculator';Metrics, attribution_models_calculator';Analysis } from './types';
...
export function calculateResult(inputs: attribution_models_calculator';Inputs): number {
...
export function generateAnalysis(inputs: attribution_models_calculator';Inputs, metrics: attribution_models_calculator';Metrics): attribution_models_calculator';Analysis {
