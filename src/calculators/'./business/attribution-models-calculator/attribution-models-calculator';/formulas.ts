import { attribution-models-calculator';Inputs, attribution-models-calculator';Metrics, attribution-models-calculator';Analysis } from './types';
...
export function calculateResult(inputs: attribution-models-calculator';Inputs): number {
...
export function generateAnalysis(inputs: attribution-models-calculator';Inputs, metrics: attribution-models-calculator';Metrics): attribution-models-calculator';Analysis {
