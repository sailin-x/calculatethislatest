import { ad_agency_commission_calculator';Inputs, ad_agency_commission_calculator';Metrics, ad_agency_commission_calculator';Analysis } from './types';
...
export function calculateResult(inputs: ad_agency_commission_calculator';Inputs): number {
...
export function generateAnalysis(inputs: ad_agency_commission_calculator';Inputs, metrics: ad_agency_commission_calculator';Metrics): ad_agency_commission_calculator';Analysis {
