import { discord_server_monetization_calculator';Inputs, discord_server_monetization_calculator';Metrics, discord_server_monetization_calculator';Analysis } from './types';
...
export function calculateResult(inputs: discord_server_monetization_calculator';Inputs): number {
...
export function generateAnalysis(inputs: discord_server_monetization_calculator';Inputs, metrics: discord_server_monetization_calculator';Metrics): discord_server_monetization_calculator';Analysis {
