import { customer_lifetime_value_calculator';Inputs, customer_lifetime_value_calculator';Metrics, customer_lifetime_value_calculator';Analysis } from './types';
...
export function calculateResult(inputs: customer_lifetime_value_calculator';Inputs): number {
...
export function generateAnalysis(inputs: customer_lifetime_value_calculator';Inputs, metrics: customer_lifetime_value_calculator';Metrics): customer_lifetime_value_calculator';Analysis {
