import { net-promoter-score-calculator';Inputs, net-promoter-score-calculator';Metrics, net-promoter-score-calculator';Analysis } from './types';
...
export function calculateResult(inputs: net-promoter-score-calculator';Inputs): number {
...
export function generateAnalysis(inputs: net-promoter-score-calculator';Inputs, metrics: net-promoter-score-calculator';Metrics): net-promoter-score-calculator';Analysis {
