import { celebrity_endorsement_calculator';Inputs, celebrity_endorsement_calculator';Metrics, celebrity_endorsement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: celebrity_endorsement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: celebrity_endorsement_calculator';Inputs, metrics: celebrity_endorsement_calculator';Metrics): celebrity_endorsement_calculator';Analysis {
