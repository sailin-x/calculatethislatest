import { celebrity-endorsement-calculator';Inputs, celebrity-endorsement-calculator';Metrics, celebrity-endorsement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: celebrity-endorsement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: celebrity-endorsement-calculator';Inputs, metrics: celebrity-endorsement-calculator';Metrics): celebrity-endorsement-calculator';Analysis {
