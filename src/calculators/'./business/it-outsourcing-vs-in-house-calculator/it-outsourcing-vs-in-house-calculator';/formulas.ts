import { it-outsourcing-vs-in-house-calculator';Inputs, it-outsourcing-vs-in-house-calculator';Metrics, it-outsourcing-vs-in-house-calculator';Analysis } from './types';
...
export function calculateResult(inputs: it-outsourcing-vs-in-house-calculator';Inputs): number {
...
export function generateAnalysis(inputs: it-outsourcing-vs-in-house-calculator';Inputs, metrics: it-outsourcing-vs-in-house-calculator';Metrics): it-outsourcing-vs-in-house-calculator';Analysis {
