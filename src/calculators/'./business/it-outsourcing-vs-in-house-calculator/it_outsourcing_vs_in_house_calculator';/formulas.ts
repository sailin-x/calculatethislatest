import { it_outsourcing_vs_in_house_calculator';Inputs, it_outsourcing_vs_in_house_calculator';Metrics, it_outsourcing_vs_in_house_calculator';Analysis } from './types';
...
export function calculateResult(inputs: it_outsourcing_vs_in_house_calculator';Inputs): number {
...
export function generateAnalysis(inputs: it_outsourcing_vs_in_house_calculator';Inputs, metrics: it_outsourcing_vs_in_house_calculator';Metrics): it_outsourcing_vs_in_house_calculator';Analysis {
