import { industry-benchmarking-calculator';Inputs, industry-benchmarking-calculator';Metrics, industry-benchmarking-calculator';Analysis } from './types';
...
export function calculateResult(inputs: industry-benchmarking-calculator';Inputs): number {
...
export function generateAnalysis(inputs: industry-benchmarking-calculator';Inputs, metrics: industry-benchmarking-calculator';Metrics): industry-benchmarking-calculator';Analysis {
