import { industry_benchmarking_calculator';Inputs, industry_benchmarking_calculator';Metrics, industry_benchmarking_calculator';Analysis } from './types';
...
export function calculateResult(inputs: industry_benchmarking_calculator';Inputs): number {
...
export function generateAnalysis(inputs: industry_benchmarking_calculator';Inputs, metrics: industry_benchmarking_calculator';Metrics): industry_benchmarking_calculator';Analysis {
