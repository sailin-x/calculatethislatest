import { music_festival_profit_loss_calculator';Inputs, music_festival_profit_loss_calculator';Metrics, music_festival_profit_loss_calculator';Analysis } from './types';
...
export function calculateResult(inputs: music_festival_profit_loss_calculator';Inputs): number {
...
export function generateAnalysis(inputs: music_festival_profit_loss_calculator';Inputs, metrics: music_festival_profit_loss_calculator';Metrics): music_festival_profit_loss_calculator';Analysis {
