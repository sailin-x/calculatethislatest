import { CustomerAcquisitionCostCalculator';Inputs, CustomerAcquisitionCostCalculator';Metrics, CustomerAcquisitionCostCalculator';Analysis } from './types';
...
export function calculateResult(inputs: CustomerAcquisitionCostCalculator';Inputs): number {
...
export function generateAnalysis(inputs: CustomerAcquisitionCostCalculator';Inputs, metrics: CustomerAcquisitionCostCalculator';Metrics): CustomerAcquisitionCostCalculator';Analysis {
