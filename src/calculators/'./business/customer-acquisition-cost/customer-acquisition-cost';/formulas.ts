import { customer-acquisition-cost';Inputs, customer-acquisition-cost';Metrics, customer-acquisition-cost';Analysis } from './types';
...
export function calculateResult(inputs: customer-acquisition-cost';Inputs): number {
...
export function generateAnalysis(inputs: customer-acquisition-cost';Inputs, metrics: customer-acquisition-cost';Metrics): customer-acquisition-cost';Analysis {
