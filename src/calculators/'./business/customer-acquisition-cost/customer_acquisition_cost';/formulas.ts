import { customer_acquisition_cost';Inputs, customer_acquisition_cost';Metrics, customer_acquisition_cost';Analysis } from './types';
...
export function calculateResult(inputs: customer_acquisition_cost';Inputs): number {
...
export function generateAnalysis(inputs: customer_acquisition_cost';Inputs, metrics: customer_acquisition_cost';Metrics): customer_acquisition_cost';Analysis {
