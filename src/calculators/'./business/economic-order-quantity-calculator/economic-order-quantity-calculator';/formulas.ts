import { economic-order-quantity-calculator';Inputs, economic-order-quantity-calculator';Metrics, economic-order-quantity-calculator';Analysis } from './types';
...
export function calculateResult(inputs: economic-order-quantity-calculator';Inputs): number {
...
export function generateAnalysis(inputs: economic-order-quantity-calculator';Inputs, metrics: economic-order-quantity-calculator';Metrics): economic-order-quantity-calculator';Analysis {
