import { budget_optimization_calculator';Inputs, budget_optimization_calculator';Metrics, budget_optimization_calculator';Analysis } from './types';
...
export function calculateResult(inputs: budget_optimization_calculator';Inputs): number {
...
export function generateAnalysis(inputs: budget_optimization_calculator';Inputs, metrics: budget_optimization_calculator';Metrics): budget_optimization_calculator';Analysis {
