import { budget-optimization-calculator';Inputs, budget-optimization-calculator';Metrics, budget-optimization-calculator';Analysis } from './types';
...
export function calculateResult(inputs: budget-optimization-calculator';Inputs): number {
...
export function generateAnalysis(inputs: budget-optimization-calculator';Inputs, metrics: budget-optimization-calculator';Metrics): budget-optimization-calculator';Analysis {
