import { break_even_analysis_calculator';Inputs, break_even_analysis_calculator';Metrics, break_even_analysis_calculator';Analysis } from './types';
...
export function calculateResult(inputs: break_even_analysis_calculator';Inputs): number {
...
export function generateAnalysis(inputs: break_even_analysis_calculator';Inputs, metrics: break_even_analysis_calculator';Metrics): break_even_analysis_calculator';Analysis {
