import { portfolio_company_ebitda_growth_calculator';Inputs, portfolio_company_ebitda_growth_calculator';Metrics, portfolio_company_ebitda_growth_calculator';Analysis } from './types';
...
export function calculateResult(inputs: portfolio_company_ebitda_growth_calculator';Inputs): number {
...
export function generateAnalysis(inputs: portfolio_company_ebitda_growth_calculator';Inputs, metrics: portfolio_company_ebitda_growth_calculator';Metrics): portfolio_company_ebitda_growth_calculator';Analysis {
