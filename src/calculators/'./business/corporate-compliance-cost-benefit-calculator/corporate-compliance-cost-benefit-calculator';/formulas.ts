import { corporate-compliance-cost-benefit-calculator';Inputs, corporate-compliance-cost-benefit-calculator';Metrics, corporate-compliance-cost-benefit-calculator';Analysis } from './types';
...
export function calculateResult(inputs: corporate-compliance-cost-benefit-calculator';Inputs): number {
...
export function generateAnalysis(inputs: corporate-compliance-cost-benefit-calculator';Inputs, metrics: corporate-compliance-cost-benefit-calculator';Metrics): corporate-compliance-cost-benefit-calculator';Analysis {
