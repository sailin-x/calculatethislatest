import { corporate_compliance_cost_benefit_calculator';Inputs, corporate_compliance_cost_benefit_calculator';Metrics, corporate_compliance_cost_benefit_calculator';Analysis } from './types';
...
export function calculateResult(inputs: corporate_compliance_cost_benefit_calculator';Inputs): number {
...
export function generateAnalysis(inputs: corporate_compliance_cost_benefit_calculator';Inputs, metrics: corporate_compliance_cost_benefit_calculator';Metrics): corporate_compliance_cost_benefit_calculator';Analysis {
