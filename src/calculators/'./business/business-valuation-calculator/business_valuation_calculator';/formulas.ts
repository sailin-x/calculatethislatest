import { business_valuation_calculator';Inputs, business_valuation_calculator';Metrics, business_valuation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: business_valuation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: business_valuation_calculator';Inputs, metrics: business_valuation_calculator';Metrics): business_valuation_calculator';Analysis {
