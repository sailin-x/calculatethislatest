import { developer-salary-calculator';Inputs, developer-salary-calculator';Metrics, developer-salary-calculator';Analysis } from './types';
...
export function calculateResult(inputs: developer-salary-calculator';Inputs): number {
...
export function generateAnalysis(inputs: developer-salary-calculator';Inputs, metrics: developer-salary-calculator';Metrics): developer-salary-calculator';Analysis {
