import { developer_salary_calculator';Inputs, developer_salary_calculator';Metrics, developer_salary_calculator';Analysis } from './types';
...
export function calculateResult(inputs: developer_salary_calculator';Inputs): number {
...
export function generateAnalysis(inputs: developer_salary_calculator';Inputs, metrics: developer_salary_calculator';Metrics): developer_salary_calculator';Analysis {
