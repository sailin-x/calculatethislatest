import { marketing_attribution_model_comparison_calculator';Inputs, marketing_attribution_model_comparison_calculator';Metrics, marketing_attribution_model_comparison_calculator';Analysis } from './types';
...
export function calculateResult(inputs: marketing_attribution_model_comparison_calculator';Inputs): number {
...
export function generateAnalysis(inputs: marketing_attribution_model_comparison_calculator';Inputs, metrics: marketing_attribution_model_comparison_calculator';Metrics): marketing_attribution_model_comparison_calculator';Analysis {
