import { ad_viewability_impact_on_roi_calculator';Inputs, ad_viewability_impact_on_roi_calculator';Metrics, ad_viewability_impact_on_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: ad_viewability_impact_on_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: ad_viewability_impact_on_roi_calculator';Inputs, metrics: ad_viewability_impact_on_roi_calculator';Metrics): ad_viewability_impact_on_roi_calculator';Analysis {
