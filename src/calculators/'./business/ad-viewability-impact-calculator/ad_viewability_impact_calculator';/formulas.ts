import { ad_viewability_impact_calculator';Inputs, ad_viewability_impact_calculator';Metrics, ad_viewability_impact_calculator';Analysis } from './types';
...
export function calculateResult(inputs: ad_viewability_impact_calculator';Inputs): number {
...
export function generateAnalysis(inputs: ad_viewability_impact_calculator';Inputs, metrics: ad_viewability_impact_calculator';Metrics): ad_viewability_impact_calculator';Analysis {
