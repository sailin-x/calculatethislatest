import { salary-benchmarking-calculator';Inputs, salary-benchmarking-calculator';Metrics, salary-benchmarking-calculator';Analysis } from './types';
...
export function calculateResult(inputs: salary-benchmarking-calculator';Inputs): number {
...
export function generateAnalysis(inputs: salary-benchmarking-calculator';Inputs, metrics: salary-benchmarking-calculator';Metrics): salary-benchmarking-calculator';Analysis {
