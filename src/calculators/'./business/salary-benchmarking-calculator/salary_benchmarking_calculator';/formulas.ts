import { salary_benchmarking_calculator';Inputs, salary_benchmarking_calculator';Metrics, salary_benchmarking_calculator';Analysis } from './types';
...
export function calculateResult(inputs: salary_benchmarking_calculator';Inputs): number {
...
export function generateAnalysis(inputs: salary_benchmarking_calculator';Inputs, metrics: salary_benchmarking_calculator';Metrics): salary_benchmarking_calculator';Analysis {
