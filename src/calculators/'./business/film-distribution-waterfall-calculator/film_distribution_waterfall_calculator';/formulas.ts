import { film_distribution_waterfall_calculator';Inputs, film_distribution_waterfall_calculator';Metrics, film_distribution_waterfall_calculator';Analysis } from './types';
...
export function calculateResult(inputs: film_distribution_waterfall_calculator';Inputs): number {
...
export function generateAnalysis(inputs: film_distribution_waterfall_calculator';Inputs, metrics: film_distribution_waterfall_calculator';Metrics): film_distribution_waterfall_calculator';Analysis {
