import { payback_period_calculator';Inputs, payback_period_calculator';Metrics, payback_period_calculator';Analysis } from './types';
...
export function calculateResult(inputs: payback_period_calculator';Inputs): number {
...
export function generateAnalysis(inputs: payback_period_calculator';Inputs, metrics: payback_period_calculator';Metrics): payback_period_calculator';Analysis {
