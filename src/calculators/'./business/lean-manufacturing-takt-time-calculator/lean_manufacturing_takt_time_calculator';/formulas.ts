import { lean_manufacturing_takt_time_calculator';Inputs, lean_manufacturing_takt_time_calculator';Metrics, lean_manufacturing_takt_time_calculator';Analysis } from './types';
...
export function calculateResult(inputs: lean_manufacturing_takt_time_calculator';Inputs): number {
...
export function generateAnalysis(inputs: lean_manufacturing_takt_time_calculator';Inputs, metrics: lean_manufacturing_takt_time_calculator';Metrics): lean_manufacturing_takt_time_calculator';Analysis {
