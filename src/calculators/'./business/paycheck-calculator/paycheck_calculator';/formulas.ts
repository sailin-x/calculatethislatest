import { paycheck_calculator';Inputs, paycheck_calculator';Metrics, paycheck_calculator';Analysis } from './types';
...
export function calculateResult(inputs: paycheck_calculator';Inputs): number {
...
export function generateAnalysis(inputs: paycheck_calculator';Inputs, metrics: paycheck_calculator';Metrics): paycheck_calculator';Analysis {
