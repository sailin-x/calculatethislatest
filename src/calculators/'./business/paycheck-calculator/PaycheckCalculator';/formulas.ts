import { PaycheckCalculator';Inputs, PaycheckCalculator';Metrics, PaycheckCalculator';Analysis } from './types';
...
export function calculateResult(inputs: PaycheckCalculator';Inputs): number {
...
export function generateAnalysis(inputs: PaycheckCalculator';Inputs, metrics: PaycheckCalculator';Metrics): PaycheckCalculator';Analysis {
