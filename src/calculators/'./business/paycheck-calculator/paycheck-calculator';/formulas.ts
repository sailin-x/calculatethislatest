import { paycheck-calculator';Inputs, paycheck-calculator';Metrics, paycheck-calculator';Analysis } from './types';
...
export function calculateResult(inputs: paycheck-calculator';Inputs): number {
...
export function generateAnalysis(inputs: paycheck-calculator';Inputs, metrics: paycheck-calculator';Metrics): paycheck-calculator';Analysis {
