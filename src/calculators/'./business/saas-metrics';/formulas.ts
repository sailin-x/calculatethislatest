import { saas-metrics';Inputs, saas-metrics';Metrics, saas-metrics';Analysis } from './types';
...
export function calculateResult(inputs: saas-metrics';Inputs): number {
...
export function generateAnalysis(inputs: saas-metrics';Inputs, metrics: saas-metrics';Metrics): saas-metrics';Analysis {
