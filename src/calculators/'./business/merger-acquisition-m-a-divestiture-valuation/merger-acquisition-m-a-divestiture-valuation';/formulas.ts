import { merger-acquisition-m-a-divestiture-valuation';Inputs, merger-acquisition-m-a-divestiture-valuation';Metrics, merger-acquisition-m-a-divestiture-valuation';Analysis } from './types';
...
export function calculateResult(inputs: merger-acquisition-m-a-divestiture-valuation';Inputs): number {
...
export function generateAnalysis(inputs: merger-acquisition-m-a-divestiture-valuation';Inputs, metrics: merger-acquisition-m-a-divestiture-valuation';Metrics): merger-acquisition-m-a-divestiture-valuation';Analysis {
