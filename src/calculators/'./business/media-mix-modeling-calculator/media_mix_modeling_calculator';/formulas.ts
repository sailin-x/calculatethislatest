import { media_mix_modeling_calculator';Inputs, media_mix_modeling_calculator';Metrics, media_mix_modeling_calculator';Analysis } from './types';
...
export function calculateResult(inputs: media_mix_modeling_calculator';Inputs): number {
...
export function generateAnalysis(inputs: media_mix_modeling_calculator';Inputs, metrics: media_mix_modeling_calculator';Metrics): media_mix_modeling_calculator';Analysis {
