import { media-mix-modeling-calculator';Inputs, media-mix-modeling-calculator';Metrics, media-mix-modeling-calculator';Analysis } from './types';
...
export function calculateResult(inputs: media-mix-modeling-calculator';Inputs): number {
...
export function generateAnalysis(inputs: media-mix-modeling-calculator';Inputs, metrics: media-mix-modeling-calculator';Metrics): media-mix-modeling-calculator';Analysis {
