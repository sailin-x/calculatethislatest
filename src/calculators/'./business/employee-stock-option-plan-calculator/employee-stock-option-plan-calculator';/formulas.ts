import { employee-stock-option-plan-calculator';Inputs, employee-stock-option-plan-calculator';Metrics, employee-stock-option-plan-calculator';Analysis } from './types';
...
export function calculateResult(inputs: employee-stock-option-plan-calculator';Inputs): number {
...
export function generateAnalysis(inputs: employee-stock-option-plan-calculator';Inputs, metrics: employee-stock-option-plan-calculator';Metrics): employee-stock-option-plan-calculator';Analysis {
