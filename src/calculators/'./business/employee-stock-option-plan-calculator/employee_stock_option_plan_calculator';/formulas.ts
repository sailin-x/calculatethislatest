import { employee_stock_option_plan_calculator';Inputs, employee_stock_option_plan_calculator';Metrics, employee_stock_option_plan_calculator';Analysis } from './types';
...
export function calculateResult(inputs: employee_stock_option_plan_calculator';Inputs): number {
...
export function generateAnalysis(inputs: employee_stock_option_plan_calculator';Inputs, metrics: employee_stock_option_plan_calculator';Metrics): employee_stock_option_plan_calculator';Analysis {
