import { corporate-compliance-cost-benefit-analysis';Inputs, corporate-compliance-cost-benefit-analysis';Metrics, corporate-compliance-cost-benefit-analysis';Analysis } from './types';
...
export function calculateResult(inputs: corporate-compliance-cost-benefit-analysis';Inputs): number {
...
export function generateAnalysis(inputs: corporate-compliance-cost-benefit-analysis';Inputs, metrics: corporate-compliance-cost-benefit-analysis';Metrics): corporate-compliance-cost-benefit-analysis';Analysis {
