import { ad_reach_and_frequency_calculator';Inputs, ad_reach_and_frequency_calculator';Metrics, ad_reach_and_frequency_calculator';Analysis } from './types';
...
export function calculateResult(inputs: ad_reach_and_frequency_calculator';Inputs): number {
...
export function generateAnalysis(inputs: ad_reach_and_frequency_calculator';Inputs, metrics: ad_reach_and_frequency_calculator';Metrics): ad_reach_and_frequency_calculator';Analysis {
