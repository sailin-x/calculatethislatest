import { total_cost_of_ownership_for_commercial_fleet_calculator';Inputs, total_cost_of_ownership_for_commercial_fleet_calculator';Metrics, total_cost_of_ownership_for_commercial_fleet_calculator';Analysis } from './types';
...
export function calculateResult(inputs: total_cost_of_ownership_for_commercial_fleet_calculator';Inputs): number {
...
export function generateAnalysis(inputs: total_cost_of_ownership_for_commercial_fleet_calculator';Inputs, metrics: total_cost_of_ownership_for_commercial_fleet_calculator';Metrics): total_cost_of_ownership_for_commercial_fleet_calculator';Analysis {
