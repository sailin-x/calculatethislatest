import { amazon_fba_profit_calculator';Inputs, amazon_fba_profit_calculator';Metrics, amazon_fba_profit_calculator';Analysis } from './types';
...
export function calculateResult(inputs: amazon_fba_profit_calculator';Inputs): number {
...
export function generateAnalysis(inputs: amazon_fba_profit_calculator';Inputs, metrics: amazon_fba_profit_calculator';Metrics): amazon_fba_profit_calculator';Analysis {
