import { './business/roi-calculator/roi_calculator';Inputs } from './types';

export function validateInputs(inputs: './business/roi-calculator/roi_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
