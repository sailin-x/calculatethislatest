import { roi_calculator';Inputs, roi_calculator';Metrics, roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: roi_calculator';Inputs, metrics: roi_calculator';Metrics): roi_calculator';Analysis {
