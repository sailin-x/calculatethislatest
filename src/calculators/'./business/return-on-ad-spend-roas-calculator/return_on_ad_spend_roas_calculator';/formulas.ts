import { return_on_ad_spend_roas_calculator';Inputs, return_on_ad_spend_roas_calculator';Metrics, return_on_ad_spend_roas_calculator';Analysis } from './types';
...
export function calculateResult(inputs: return_on_ad_spend_roas_calculator';Inputs): number {
...
export function generateAnalysis(inputs: return_on_ad_spend_roas_calculator';Inputs, metrics: return_on_ad_spend_roas_calculator';Metrics): return_on_ad_spend_roas_calculator';Analysis {
