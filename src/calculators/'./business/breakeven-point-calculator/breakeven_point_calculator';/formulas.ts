import { breakeven_point_calculator';Inputs, breakeven_point_calculator';Metrics, breakeven_point_calculator';Analysis } from './types';
...
export function calculateResult(inputs: breakeven_point_calculator';Inputs): number {
...
export function generateAnalysis(inputs: breakeven_point_calculator';Inputs, metrics: breakeven_point_calculator';Metrics): breakeven_point_calculator';Analysis {
