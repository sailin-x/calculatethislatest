import { breakeven-point-calculator';Inputs, breakeven-point-calculator';Metrics, breakeven-point-calculator';Analysis } from './types';
...
export function calculateResult(inputs: breakeven-point-calculator';Inputs): number {
...
export function generateAnalysis(inputs: breakeven-point-calculator';Inputs, metrics: breakeven-point-calculator';Metrics): breakeven-point-calculator';Analysis {
