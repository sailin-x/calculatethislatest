import { industrial_robotics_roi_calculator';Inputs, industrial_robotics_roi_calculator';Metrics, industrial_robotics_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: industrial_robotics_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: industrial_robotics_roi_calculator';Inputs, metrics: industrial_robotics_roi_calculator';Metrics): industrial_robotics_roi_calculator';Analysis {
