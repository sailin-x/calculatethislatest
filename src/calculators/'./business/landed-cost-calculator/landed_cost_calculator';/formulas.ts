import { landed_cost_calculator';Inputs, landed_cost_calculator';Metrics, landed_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: landed_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: landed_cost_calculator';Inputs, metrics: landed_cost_calculator';Metrics): landed_cost_calculator';Analysis {
