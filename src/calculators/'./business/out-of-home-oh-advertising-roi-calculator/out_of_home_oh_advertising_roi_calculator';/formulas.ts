import { out_of_home_oh_advertising_roi_calculator';Inputs, out_of_home_oh_advertising_roi_calculator';Metrics, out_of_home_oh_advertising_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: out_of_home_oh_advertising_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: out_of_home_oh_advertising_roi_calculator';Inputs, metrics: out_of_home_oh_advertising_roi_calculator';Metrics): out_of_home_oh_advertising_roi_calculator';Analysis {
