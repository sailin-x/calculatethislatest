import { merger_model_calculator';Inputs, merger_model_calculator';Metrics, merger_model_calculator';Analysis } from './types';
...
export function calculateResult(inputs: merger_model_calculator';Inputs): number {
...
export function generateAnalysis(inputs: merger_model_calculator';Inputs, metrics: merger_model_calculator';Metrics): merger_model_calculator';Analysis {
