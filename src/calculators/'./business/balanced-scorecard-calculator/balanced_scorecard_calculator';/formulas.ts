import { balanced_scorecard_calculator';Inputs, balanced_scorecard_calculator';Metrics, balanced_scorecard_calculator';Analysis } from './types';
...
export function calculateResult(inputs: balanced_scorecard_calculator';Inputs): number {
...
export function generateAnalysis(inputs: balanced_scorecard_calculator';Inputs, metrics: balanced_scorecard_calculator';Metrics): balanced_scorecard_calculator';Analysis {
