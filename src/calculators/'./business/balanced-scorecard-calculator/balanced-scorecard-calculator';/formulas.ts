import { balanced-scorecard-calculator';Inputs, balanced-scorecard-calculator';Metrics, balanced-scorecard-calculator';Analysis } from './types';
...
export function calculateResult(inputs: balanced-scorecard-calculator';Inputs): number {
...
export function generateAnalysis(inputs: balanced-scorecard-calculator';Inputs, metrics: balanced-scorecard-calculator';Metrics): balanced-scorecard-calculator';Analysis {
