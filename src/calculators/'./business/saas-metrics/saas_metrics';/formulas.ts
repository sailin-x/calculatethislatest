import { saas_metrics';Inputs, saas_metrics';Metrics, saas_metrics';Analysis } from './types';
...
export function calculateResult(inputs: saas_metrics';Inputs): number {
...
export function generateAnalysis(inputs: saas_metrics';Inputs, metrics: saas_metrics';Metrics): saas_metrics';Analysis {
