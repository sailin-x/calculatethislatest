import { './business/saas-metrics/saas-metrics';Inputs } from './types';

export function validateInputs(inputs: './business/saas-metrics/saas-metrics';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
