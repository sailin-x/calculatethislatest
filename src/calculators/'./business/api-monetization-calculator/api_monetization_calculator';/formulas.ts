import { api_monetization_calculator';Inputs, api_monetization_calculator';Metrics, api_monetization_calculator';Analysis } from './types';
...
export function calculateResult(inputs: api_monetization_calculator';Inputs): number {
...
export function generateAnalysis(inputs: api_monetization_calculator';Inputs, metrics: api_monetization_calculator';Metrics): api_monetization_calculator';Analysis {
