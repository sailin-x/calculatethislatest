import { request-for-proposal-scoring-calculator';Inputs, request-for-proposal-scoring-calculator';Metrics, request-for-proposal-scoring-calculator';Analysis } from './types';
...
export function calculateResult(inputs: request-for-proposal-scoring-calculator';Inputs): number {
...
export function generateAnalysis(inputs: request-for-proposal-scoring-calculator';Inputs, metrics: request-for-proposal-scoring-calculator';Metrics): request-for-proposal-scoring-calculator';Analysis {
