import { overall_equipment_effectiveness_calculator';Inputs, overall_equipment_effectiveness_calculator';Metrics, overall_equipment_effectiveness_calculator';Analysis } from './types';
...
export function calculateResult(inputs: overall_equipment_effectiveness_calculator';Inputs): number {
...
export function generateAnalysis(inputs: overall_equipment_effectiveness_calculator';Inputs, metrics: overall_equipment_effectiveness_calculator';Metrics): overall_equipment_effectiveness_calculator';Analysis {
