import { overall-equipment-effectiveness-calculator';Inputs, overall-equipment-effectiveness-calculator';Metrics, overall-equipment-effectiveness-calculator';Analysis } from './types';
...
export function calculateResult(inputs: overall-equipment-effectiveness-calculator';Inputs): number {
...
export function generateAnalysis(inputs: overall-equipment-effectiveness-calculator';Inputs, metrics: overall-equipment-effectiveness-calculator';Metrics): overall-equipment-effectiveness-calculator';Analysis {
