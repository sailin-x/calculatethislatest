import { cohort_analysis_calculator';Inputs, cohort_analysis_calculator';Metrics, cohort_analysis_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cohort_analysis_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cohort_analysis_calculator';Inputs, metrics: cohort_analysis_calculator';Metrics): cohort_analysis_calculator';Analysis {
