import { cohort-analysis-calculator';Inputs, cohort-analysis-calculator';Metrics, cohort-analysis-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cohort-analysis-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cohort-analysis-calculator';Inputs, metrics: cohort-analysis-calculator';Metrics): cohort-analysis-calculator';Analysis {
