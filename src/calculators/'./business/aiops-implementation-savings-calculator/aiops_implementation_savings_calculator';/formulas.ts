import { aiops_implementation_savings_calculator';Inputs, aiops_implementation_savings_calculator';Metrics, aiops_implementation_savings_calculator';Analysis } from './types';
...
export function calculateResult(inputs: aiops_implementation_savings_calculator';Inputs): number {
...
export function generateAnalysis(inputs: aiops_implementation_savings_calculator';Inputs, metrics: aiops_implementation_savings_calculator';Metrics): aiops_implementation_savings_calculator';Analysis {
