import { aiops-implementation-savings-calculator';Inputs, aiops-implementation-savings-calculator';Metrics, aiops-implementation-savings-calculator';Analysis } from './types';
...
export function calculateResult(inputs: aiops-implementation-savings-calculator';Inputs): number {
...
export function generateAnalysis(inputs: aiops-implementation-savings-calculator';Inputs, metrics: aiops-implementation-savings-calculator';Metrics): aiops-implementation-savings-calculator';Analysis {
