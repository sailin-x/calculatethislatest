import { business_process_re_engineering_calculator';Inputs, business_process_re_engineering_calculator';Metrics, business_process_re_engineering_calculator';Analysis } from './types';
...
export function calculateResult(inputs: business_process_re_engineering_calculator';Inputs): number {
...
export function generateAnalysis(inputs: business_process_re_engineering_calculator';Inputs, metrics: business_process_re_engineering_calculator';Metrics): business_process_re_engineering_calculator';Analysis {
