import { business-process-re-engineering-calculator';Inputs, business-process-re-engineering-calculator';Metrics, business-process-re-engineering-calculator';Analysis } from './types';
...
export function calculateResult(inputs: business-process-re-engineering-calculator';Inputs): number {
...
export function generateAnalysis(inputs: business-process-re-engineering-calculator';Inputs, metrics: business-process-re-engineering-calculator';Metrics): business-process-re-engineering-calculator';Analysis {
