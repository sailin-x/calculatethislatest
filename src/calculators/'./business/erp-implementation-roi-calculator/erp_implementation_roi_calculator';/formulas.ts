import { erp_implementation_roi_calculator';Inputs, erp_implementation_roi_calculator';Metrics, erp_implementation_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: erp_implementation_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: erp_implementation_roi_calculator';Inputs, metrics: erp_implementation_roi_calculator';Metrics): erp_implementation_roi_calculator';Analysis {
