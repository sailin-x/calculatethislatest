import { asset-protection-calculator';Inputs, asset-protection-calculator';Metrics, asset-protection-calculator';Analysis } from './types';
...
export function calculateResult(inputs: asset-protection-calculator';Inputs): number {
...
export function generateAnalysis(inputs: asset-protection-calculator';Inputs, metrics: asset-protection-calculator';Metrics): asset-protection-calculator';Analysis {
