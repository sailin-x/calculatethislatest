import { brand_equity_valuation_calculator';Inputs, brand_equity_valuation_calculator';Metrics, brand_equity_valuation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: brand_equity_valuation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: brand_equity_valuation_calculator';Inputs, metrics: brand_equity_valuation_calculator';Metrics): brand_equity_valuation_calculator';Analysis {
