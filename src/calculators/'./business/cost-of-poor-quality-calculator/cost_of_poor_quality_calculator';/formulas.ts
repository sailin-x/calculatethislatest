import { cost_of_poor_quality_calculator';Inputs, cost_of_poor_quality_calculator';Metrics, cost_of_poor_quality_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cost_of_poor_quality_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cost_of_poor_quality_calculator';Inputs, metrics: cost_of_poor_quality_calculator';Metrics): cost_of_poor_quality_calculator';Analysis {
