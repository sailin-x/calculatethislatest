import { everyday';Inputs, everyday';Metrics, everyday';Analysis } from './types';
...
export function calculateResult(inputs: everyday';Inputs): number {
...
export function generateAnalysis(inputs: everyday';Inputs, metrics: everyday';Metrics): everyday';Analysis {
