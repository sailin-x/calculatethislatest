import { garden_calculator';Inputs, garden_calculator';Metrics, garden_calculator';Analysis } from './types';
...
export function calculateResult(inputs: garden_calculator';Inputs): number {
...
export function generateAnalysis(inputs: garden_calculator';Inputs, metrics: garden_calculator';Metrics): garden_calculator';Analysis {
