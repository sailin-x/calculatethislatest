import { everyday-calculator';Inputs, everyday-calculator';Metrics, everyday-calculator';Analysis } from './types';
...
export function calculateResult(inputs: everyday-calculator';Inputs): number {
...
export function generateAnalysis(inputs: everyday-calculator';Inputs, metrics: everyday-calculator';Metrics): everyday-calculator';Analysis {
