import { everyday_calculator';Inputs, everyday_calculator';Metrics, everyday_calculator';Analysis } from './types';
...
export function calculateResult(inputs: everyday_calculator';Inputs): number {
...
export function generateAnalysis(inputs: everyday_calculator';Inputs, metrics: everyday_calculator';Metrics): everyday_calculator';Analysis {
