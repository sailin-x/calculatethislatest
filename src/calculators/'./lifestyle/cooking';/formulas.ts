import { cooking';Inputs, cooking';Metrics, cooking';Analysis } from './types';
...
export function calculateResult(inputs: cooking';Inputs): number {
...
export function generateAnalysis(inputs: cooking';Inputs, metrics: cooking';Metrics): cooking';Analysis {
