import { nft-royalty-revenue-calculator-exists-but-needs-registration';Inputs, nft-royalty-revenue-calculator-exists-but-needs-registration';Metrics, nft-royalty-revenue-calculator-exists-but-needs-registration';Analysis } from './types';
...
export function calculateResult(inputs: nft-royalty-revenue-calculator-exists-but-needs-registration';Inputs): number {
...
export function generateAnalysis(inputs: nft-royalty-revenue-calculator-exists-but-needs-registration';Inputs, metrics: nft-royalty-revenue-calculator-exists-but-needs-registration';Metrics): nft-royalty-revenue-calculator-exists-but-needs-registration';Analysis {
