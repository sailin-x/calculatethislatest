import { automotive';Inputs, automotive';Metrics, automotive';Analysis } from './types';
...
export function calculateResult(inputs: automotive';Inputs): number {
...
export function generateAnalysis(inputs: automotive';Inputs, metrics: automotive';Metrics): automotive';Analysis {
