import { automotive-calculator';Inputs, automotive-calculator';Metrics, automotive-calculator';Analysis } from './types';
...
export function calculateResult(inputs: automotive-calculator';Inputs): number {
...
export function generateAnalysis(inputs: automotive-calculator';Inputs, metrics: automotive-calculator';Metrics): automotive-calculator';Analysis {
