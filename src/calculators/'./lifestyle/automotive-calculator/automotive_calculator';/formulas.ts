import { automotive_calculator';Inputs, automotive_calculator';Metrics, automotive_calculator';Analysis } from './types';
...
export function calculateResult(inputs: automotive_calculator';Inputs): number {
...
export function generateAnalysis(inputs: automotive_calculator';Inputs, metrics: automotive_calculator';Metrics): automotive_calculator';Analysis {
