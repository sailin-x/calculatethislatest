import { hobbies_calculator';Inputs, hobbies_calculator';Metrics, hobbies_calculator';Analysis } from './types';
...
export function calculateResult(inputs: hobbies_calculator';Inputs): number {
...
export function generateAnalysis(inputs: hobbies_calculator';Inputs, metrics: hobbies_calculator';Metrics): hobbies_calculator';Analysis {
