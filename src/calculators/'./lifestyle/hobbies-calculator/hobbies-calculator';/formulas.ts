import { hobbies-calculator';Inputs, hobbies-calculator';Metrics, hobbies-calculator';Analysis } from './types';
...
export function calculateResult(inputs: hobbies-calculator';Inputs): number {
...
export function generateAnalysis(inputs: hobbies-calculator';Inputs, metrics: hobbies-calculator';Metrics): hobbies-calculator';Analysis {
