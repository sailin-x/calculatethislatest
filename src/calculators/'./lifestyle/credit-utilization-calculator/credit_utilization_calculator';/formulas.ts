import { credit_utilization_calculator';Inputs, credit_utilization_calculator';Metrics, credit_utilization_calculator';Analysis } from './types';
...
export function calculateResult(inputs: credit_utilization_calculator';Inputs): number {
...
export function generateAnalysis(inputs: credit_utilization_calculator';Inputs, metrics: credit_utilization_calculator';Metrics): credit_utilization_calculator';Analysis {
