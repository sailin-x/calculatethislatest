import { debt_consolidation_loan_calculator';Inputs, debt_consolidation_loan_calculator';Metrics, debt_consolidation_loan_calculator';Analysis } from './types';
...
export function calculateResult(inputs: debt_consolidation_loan_calculator';Inputs): number {
...
export function generateAnalysis(inputs: debt_consolidation_loan_calculator';Inputs, metrics: debt_consolidation_loan_calculator';Metrics): debt_consolidation_loan_calculator';Analysis {
