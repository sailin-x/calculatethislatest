import { libel-slander-per-se-damages-estimator';Inputs, libel-slander-per-se-damages-estimator';Metrics, libel-slander-per-se-damages-estimator';Analysis } from './types';
...
export function calculateResult(inputs: libel-slander-per-se-damages-estimator';Inputs): number {
...
export function generateAnalysis(inputs: libel-slander-per-se-damages-estimator';Inputs, metrics: libel-slander-per-se-damages-estimator';Metrics): libel-slander-per-se-damages-estimator';Analysis {
