import { cooking-calculator';Inputs, cooking-calculator';Metrics, cooking-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cooking-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cooking-calculator';Inputs, metrics: cooking-calculator';Metrics): cooking-calculator';Analysis {
