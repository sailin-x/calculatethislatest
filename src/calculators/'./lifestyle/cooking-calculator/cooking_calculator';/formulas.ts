import { cooking_calculator';Inputs, cooking_calculator';Metrics, cooking_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cooking_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cooking_calculator';Inputs, metrics: cooking_calculator';Metrics): cooking_calculator';Analysis {
