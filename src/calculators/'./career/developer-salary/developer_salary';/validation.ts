import { './career/developer-salary/developer_salary';Inputs } from './types';

export function validateInputs(inputs: './career/developer-salary/developer_salary';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
