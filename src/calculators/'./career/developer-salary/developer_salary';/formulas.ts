import { developer_salary';Inputs, developer_salary';Metrics, developer_salary';Analysis } from './types';
...
export function calculateResult(inputs: developer_salary';Inputs): number {
...
export function generateAnalysis(inputs: developer_salary';Inputs, metrics: developer_salary';Metrics): developer_salary';Analysis {
