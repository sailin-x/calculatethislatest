import { developer-salary';Inputs, developer-salary';Metrics, developer-salary';Analysis } from './types';
...
export function calculateResult(inputs: developer-salary';Inputs): number {
...
export function generateAnalysis(inputs: developer-salary';Inputs, metrics: developer-salary';Metrics): developer-salary';Analysis {
