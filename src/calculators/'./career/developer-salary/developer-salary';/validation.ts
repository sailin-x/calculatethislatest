import { './career/developer-salary/developer-salary';Inputs } from './types';

export function validateInputs(inputs: './career/developer-salary/developer-salary';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
