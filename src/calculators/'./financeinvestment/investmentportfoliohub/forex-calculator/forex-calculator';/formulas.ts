import { forex-calculator';Inputs, forex-calculator';Metrics, forex-calculator';Analysis } from './types';
...
export function calculateResult(inputs: forex-calculator';Inputs): number {
...
export function generateAnalysis(inputs: forex-calculator';Inputs, metrics: forex-calculator';Metrics): forex-calculator';Analysis {
