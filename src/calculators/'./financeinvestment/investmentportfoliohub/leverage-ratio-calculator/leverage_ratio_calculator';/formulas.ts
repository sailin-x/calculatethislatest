import { leverage_ratio_calculator';Inputs, leverage_ratio_calculator';Metrics, leverage_ratio_calculator';Analysis } from './types';
...
export function calculateResult(inputs: leverage_ratio_calculator';Inputs): number {
...
export function generateAnalysis(inputs: leverage_ratio_calculator';Inputs, metrics: leverage_ratio_calculator';Metrics): leverage_ratio_calculator';Analysis {
