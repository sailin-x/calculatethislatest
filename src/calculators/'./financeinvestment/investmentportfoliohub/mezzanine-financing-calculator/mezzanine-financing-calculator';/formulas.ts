import { mezzanine-financing-calculator';Inputs, mezzanine-financing-calculator';Metrics, mezzanine-financing-calculator';Analysis } from './types';
...
export function calculateResult(inputs: mezzanine-financing-calculator';Inputs): number {
...
export function generateAnalysis(inputs: mezzanine-financing-calculator';Inputs, metrics: mezzanine-financing-calculator';Metrics): mezzanine-financing-calculator';Analysis {
