import { capital-structure-optimization-calculator';Inputs, capital-structure-optimization-calculator';Metrics, capital-structure-optimization-calculator';Analysis } from './types';
...
export function calculateResult(inputs: capital-structure-optimization-calculator';Inputs): number {
...
export function generateAnalysis(inputs: capital-structure-optimization-calculator';Inputs, metrics: capital-structure-optimization-calculator';Metrics): capital-structure-optimization-calculator';Analysis {
