import { stock-buyback-roi-calculator';Inputs, stock-buyback-roi-calculator';Metrics, stock-buyback-roi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: stock-buyback-roi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: stock-buyback-roi-calculator';Inputs, metrics: stock-buyback-roi-calculator';Metrics): stock-buyback-roi-calculator';Analysis {
