import { options-trading-calculator';Inputs, options-trading-calculator';Metrics, options-trading-calculator';Analysis } from './types';
...
export function calculateResult(inputs: options-trading-calculator';Inputs): number {
...
export function generateAnalysis(inputs: options-trading-calculator';Inputs, metrics: options-trading-calculator';Metrics): options-trading-calculator';Analysis {
