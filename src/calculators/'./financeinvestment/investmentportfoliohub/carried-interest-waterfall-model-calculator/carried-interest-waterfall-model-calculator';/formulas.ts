import { carried-interest-waterfall-model-calculator';Inputs, carried-interest-waterfall-model-calculator';Metrics, carried-interest-waterfall-model-calculator';Analysis } from './types';
...
export function calculateResult(inputs: carried-interest-waterfall-model-calculator';Inputs): number {
...
export function generateAnalysis(inputs: carried-interest-waterfall-model-calculator';Inputs, metrics: carried-interest-waterfall-model-calculator';Metrics): carried-interest-waterfall-model-calculator';Analysis {
