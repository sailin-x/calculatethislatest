import { merger_arbitrage_spread_calculator';Inputs, merger_arbitrage_spread_calculator';Metrics, merger_arbitrage_spread_calculator';Analysis } from './types';
...
export function calculateResult(inputs: merger_arbitrage_spread_calculator';Inputs): number {
...
export function generateAnalysis(inputs: merger_arbitrage_spread_calculator';Inputs, metrics: merger_arbitrage_spread_calculator';Metrics): merger_arbitrage_spread_calculator';Analysis {
