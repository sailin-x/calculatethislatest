import { r-squared-calculator';Inputs, r-squared-calculator';Metrics, r-squared-calculator';Analysis } from './types';
...
export function calculateResult(inputs: r-squared-calculator';Inputs): number {
...
export function generateAnalysis(inputs: r-squared-calculator';Inputs, metrics: r-squared-calculator';Metrics): r-squared-calculator';Analysis {
