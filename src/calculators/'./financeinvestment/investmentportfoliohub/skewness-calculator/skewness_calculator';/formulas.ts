import { skewness_calculator';Inputs, skewness_calculator';Metrics, skewness_calculator';Analysis } from './types';
...
export function calculateResult(inputs: skewness_calculator';Inputs): number {
...
export function generateAnalysis(inputs: skewness_calculator';Inputs, metrics: skewness_calculator';Metrics): skewness_calculator';Analysis {
