import { interest-calculator';Inputs, interest-calculator';Metrics, interest-calculator';Analysis } from './types';
...
export function calculateResult(inputs: interest-calculator';Inputs): number {
...
export function generateAnalysis(inputs: interest-calculator';Inputs, metrics: interest-calculator';Metrics): interest-calculator';Analysis {
