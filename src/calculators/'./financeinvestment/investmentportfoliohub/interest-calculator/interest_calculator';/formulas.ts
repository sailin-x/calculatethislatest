import { interest_calculator';Inputs, interest_calculator';Metrics, interest_calculator';Analysis } from './types';
...
export function calculateResult(inputs: interest_calculator';Inputs): number {
...
export function generateAnalysis(inputs: interest_calculator';Inputs, metrics: interest_calculator';Metrics): interest_calculator';Analysis {
