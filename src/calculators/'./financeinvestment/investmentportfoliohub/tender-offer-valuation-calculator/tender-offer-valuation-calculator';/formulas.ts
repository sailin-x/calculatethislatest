import { tender-offer-valuation-calculator';Inputs, tender-offer-valuation-calculator';Metrics, tender-offer-valuation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: tender-offer-valuation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: tender-offer-valuation-calculator';Inputs, metrics: tender-offer-valuation-calculator';Metrics): tender-offer-valuation-calculator';Analysis {
