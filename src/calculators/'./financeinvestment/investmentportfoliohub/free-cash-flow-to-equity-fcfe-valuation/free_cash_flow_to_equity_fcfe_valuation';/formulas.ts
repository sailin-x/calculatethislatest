import { free_cash_flow_to_equity_fcfe_valuation';Inputs, free_cash_flow_to_equity_fcfe_valuation';Metrics, free_cash_flow_to_equity_fcfe_valuation';Analysis } from './types';
...
export function calculateResult(inputs: free_cash_flow_to_equity_fcfe_valuation';Inputs): number {
...
export function generateAnalysis(inputs: free_cash_flow_to_equity_fcfe_valuation';Inputs, metrics: free_cash_flow_to_equity_fcfe_valuation';Metrics): free_cash_flow_to_equity_fcfe_valuation';Analysis {
