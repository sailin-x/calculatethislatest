import { price-to-earnings-calculator';Inputs, price-to-earnings-calculator';Metrics, price-to-earnings-calculator';Analysis } from './types';
...
export function calculateResult(inputs: price-to-earnings-calculator';Inputs): number {
...
export function generateAnalysis(inputs: price-to-earnings-calculator';Inputs, metrics: price-to-earnings-calculator';Metrics): price-to-earnings-calculator';Analysis {
