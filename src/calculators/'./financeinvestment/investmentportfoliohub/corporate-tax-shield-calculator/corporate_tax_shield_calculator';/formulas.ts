import { corporate_tax_shield_calculator';Inputs, corporate_tax_shield_calculator';Metrics, corporate_tax_shield_calculator';Analysis } from './types';
...
export function calculateResult(inputs: corporate_tax_shield_calculator';Inputs): number {
...
export function generateAnalysis(inputs: corporate_tax_shield_calculator';Inputs, metrics: corporate_tax_shield_calculator';Metrics): corporate_tax_shield_calculator';Analysis {
