import { royalty-financing-calculator';Inputs, royalty-financing-calculator';Metrics, royalty-financing-calculator';Analysis } from './types';
...
export function calculateResult(inputs: royalty-financing-calculator';Inputs): number {
...
export function generateAnalysis(inputs: royalty-financing-calculator';Inputs, metrics: royalty-financing-calculator';Metrics): royalty-financing-calculator';Analysis {
