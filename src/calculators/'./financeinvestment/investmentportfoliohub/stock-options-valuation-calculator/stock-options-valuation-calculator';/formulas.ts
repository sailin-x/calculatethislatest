import { stock-options-valuation-calculator';Inputs, stock-options-valuation-calculator';Metrics, stock-options-valuation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: stock-options-valuation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: stock-options-valuation-calculator';Inputs, metrics: stock-options-valuation-calculator';Metrics): stock-options-valuation-calculator';Analysis {
