import { litigation-finance-roi-calculator';Inputs, litigation-finance-roi-calculator';Metrics, litigation-finance-roi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: litigation-finance-roi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: litigation-finance-roi-calculator';Inputs, metrics: litigation-finance-roi-calculator';Metrics): litigation-finance-roi-calculator';Analysis {
