import { litigation_finance_roi_calculator';Inputs, litigation_finance_roi_calculator';Metrics, litigation_finance_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: litigation_finance_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: litigation_finance_roi_calculator';Inputs, metrics: litigation_finance_roi_calculator';Metrics): litigation_finance_roi_calculator';Analysis {
