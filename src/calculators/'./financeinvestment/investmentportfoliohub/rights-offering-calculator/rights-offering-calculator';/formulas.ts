import { rights-offering-calculator';Inputs, rights-offering-calculator';Metrics, rights-offering-calculator';Analysis } from './types';
...
export function calculateResult(inputs: rights-offering-calculator';Inputs): number {
...
export function generateAnalysis(inputs: rights-offering-calculator';Inputs, metrics: rights-offering-calculator';Metrics): rights-offering-calculator';Analysis {
