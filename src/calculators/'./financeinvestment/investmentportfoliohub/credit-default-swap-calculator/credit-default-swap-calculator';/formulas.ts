import { credit-default-swap-calculator';Inputs, credit-default-swap-calculator';Metrics, credit-default-swap-calculator';Analysis } from './types';
...
export function calculateResult(inputs: credit-default-swap-calculator';Inputs): number {
...
export function generateAnalysis(inputs: credit-default-swap-calculator';Inputs, metrics: credit-default-swap-calculator';Metrics): credit-default-swap-calculator';Analysis {
