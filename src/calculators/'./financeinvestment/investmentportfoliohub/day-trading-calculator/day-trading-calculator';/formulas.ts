import { day-trading-calculator';Inputs, day-trading-calculator';Metrics, day-trading-calculator';Analysis } from './types';
...
export function calculateResult(inputs: day-trading-calculator';Inputs): number {
...
export function generateAnalysis(inputs: day-trading-calculator';Inputs, metrics: day-trading-calculator';Metrics): day-trading-calculator';Analysis {
