import { municipal-bond-calculator';Inputs, municipal-bond-calculator';Metrics, municipal-bond-calculator';Analysis } from './types';
...
export function calculateResult(inputs: municipal-bond-calculator';Inputs): number {
...
export function generateAnalysis(inputs: municipal-bond-calculator';Inputs, metrics: municipal-bond-calculator';Metrics): municipal-bond-calculator';Analysis {
