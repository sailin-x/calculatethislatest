import { recapitalization-impact-calculator';Inputs, recapitalization-impact-calculator';Metrics, recapitalization-impact-calculator';Analysis } from './types';
...
export function calculateResult(inputs: recapitalization-impact-calculator';Inputs): number {
...
export function generateAnalysis(inputs: recapitalization-impact-calculator';Inputs, metrics: recapitalization-impact-calculator';Metrics): recapitalization-impact-calculator';Analysis {
