import { dividend-discount-model-ddm-calculator';Inputs, dividend-discount-model-ddm-calculator';Metrics, dividend-discount-model-ddm-calculator';Analysis } from './types';
...
export function calculateResult(inputs: dividend-discount-model-ddm-calculator';Inputs): number {
...
export function generateAnalysis(inputs: dividend-discount-model-ddm-calculator';Inputs, metrics: dividend-discount-model-ddm-calculator';Metrics): dividend-discount-model-ddm-calculator';Analysis {
