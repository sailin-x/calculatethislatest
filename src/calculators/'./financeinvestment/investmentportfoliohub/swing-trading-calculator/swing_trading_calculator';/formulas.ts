import { swing_trading_calculator';Inputs, swing_trading_calculator';Metrics, swing_trading_calculator';Analysis } from './types';
...
export function calculateResult(inputs: swing_trading_calculator';Inputs): number {
...
export function generateAnalysis(inputs: swing_trading_calculator';Inputs, metrics: swing_trading_calculator';Metrics): swing_trading_calculator';Analysis {
