import { black-litterman-calculator';Inputs, black-litterman-calculator';Metrics, black-litterman-calculator';Analysis } from './types';
...
export function calculateResult(inputs: black-litterman-calculator';Inputs): number {
...
export function generateAnalysis(inputs: black-litterman-calculator';Inputs, metrics: black-litterman-calculator';Metrics): black-litterman-calculator';Analysis {
