import { commodity-calculator';Inputs, commodity-calculator';Metrics, commodity-calculator';Analysis } from './types';
...
export function calculateResult(inputs: commodity-calculator';Inputs): number {
...
export function generateAnalysis(inputs: commodity-calculator';Inputs, metrics: commodity-calculator';Metrics): commodity-calculator';Analysis {
