import { futures_calculator';Inputs, futures_calculator';Metrics, futures_calculator';Analysis } from './types';
...
export function calculateResult(inputs: futures_calculator';Inputs): number {
...
export function generateAnalysis(inputs: futures_calculator';Inputs, metrics: futures_calculator';Metrics): futures_calculator';Analysis {
