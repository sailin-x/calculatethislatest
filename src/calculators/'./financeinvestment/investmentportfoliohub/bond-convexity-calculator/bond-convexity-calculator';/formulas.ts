import { bond-convexity-calculator';Inputs, bond-convexity-calculator';Metrics, bond-convexity-calculator';Analysis } from './types';
...
export function calculateResult(inputs: bond-convexity-calculator';Inputs): number {
...
export function generateAnalysis(inputs: bond-convexity-calculator';Inputs, metrics: bond-convexity-calculator';Metrics): bond-convexity-calculator';Analysis {
