import { convertible-bond-calculator';Inputs, convertible-bond-calculator';Metrics, convertible-bond-calculator';Analysis } from './types';
...
export function calculateResult(inputs: convertible-bond-calculator';Inputs): number {
...
export function generateAnalysis(inputs: convertible-bond-calculator';Inputs, metrics: convertible-bond-calculator';Metrics): convertible-bond-calculator';Analysis {
