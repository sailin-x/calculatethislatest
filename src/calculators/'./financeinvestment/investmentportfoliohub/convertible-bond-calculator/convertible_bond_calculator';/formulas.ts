import { convertible_bond_calculator';Inputs, convertible_bond_calculator';Metrics, convertible_bond_calculator';Analysis } from './types';
...
export function calculateResult(inputs: convertible_bond_calculator';Inputs): number {
...
export function generateAnalysis(inputs: convertible_bond_calculator';Inputs, metrics: convertible_bond_calculator';Metrics): convertible_bond_calculator';Analysis {
