import { return_on_equity_calculator';Inputs, return_on_equity_calculator';Metrics, return_on_equity_calculator';Analysis } from './types';
...
export function calculateResult(inputs: return_on_equity_calculator';Inputs): number {
...
export function generateAnalysis(inputs: return_on_equity_calculator';Inputs, metrics: return_on_equity_calculator';Metrics): return_on_equity_calculator';Analysis {
