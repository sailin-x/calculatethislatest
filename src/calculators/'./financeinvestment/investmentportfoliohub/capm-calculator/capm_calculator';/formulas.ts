import { capm_calculator';Inputs, capm_calculator';Metrics, capm_calculator';Analysis } from './types';
...
export function calculateResult(inputs: capm_calculator';Inputs): number {
...
export function generateAnalysis(inputs: capm_calculator';Inputs, metrics: capm_calculator';Metrics): capm_calculator';Analysis {
