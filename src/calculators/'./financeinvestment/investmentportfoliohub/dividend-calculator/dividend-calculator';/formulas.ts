import { dividend-calculator';Inputs, dividend-calculator';Metrics, dividend-calculator';Analysis } from './types';
...
export function calculateResult(inputs: dividend-calculator';Inputs): number {
...
export function generateAnalysis(inputs: dividend-calculator';Inputs, metrics: dividend-calculator';Metrics): dividend-calculator';Analysis {
