import { net-margin-calculator';Inputs, net-margin-calculator';Metrics, net-margin-calculator';Analysis } from './types';
...
export function calculateResult(inputs: net-margin-calculator';Inputs): number {
...
export function generateAnalysis(inputs: net-margin-calculator';Inputs, metrics: net-margin-calculator';Metrics): net-margin-calculator';Analysis {
