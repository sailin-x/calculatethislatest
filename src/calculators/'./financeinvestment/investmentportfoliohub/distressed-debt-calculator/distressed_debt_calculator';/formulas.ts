import { distressed_debt_calculator';Inputs, distressed_debt_calculator';Metrics, distressed_debt_calculator';Analysis } from './types';
...
export function calculateResult(inputs: distressed_debt_calculator';Inputs): number {
...
export function generateAnalysis(inputs: distressed_debt_calculator';Inputs, metrics: distressed_debt_calculator';Metrics): distressed_debt_calculator';Analysis {
