import { distressed-debt-calculator';Inputs, distressed-debt-calculator';Metrics, distressed-debt-calculator';Analysis } from './types';
...
export function calculateResult(inputs: distressed-debt-calculator';Inputs): number {
...
export function generateAnalysis(inputs: distressed-debt-calculator';Inputs, metrics: distressed-debt-calculator';Metrics): distressed-debt-calculator';Analysis {
