import { cd_interest_calculator';Inputs, cd_interest_calculator';Metrics, cd_interest_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cd_interest_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cd_interest_calculator';Inputs, metrics: cd_interest_calculator';Metrics): cd_interest_calculator';Analysis {
