import { cd-interest-calculator';Inputs, cd-interest-calculator';Metrics, cd-interest-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cd-interest-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cd-interest-calculator';Inputs, metrics: cd-interest-calculator';Metrics): cd-interest-calculator';Analysis {
