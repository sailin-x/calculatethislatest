import { corporate-bond-calculator';Inputs, corporate-bond-calculator';Metrics, corporate-bond-calculator';Analysis } from './types';
...
export function calculateResult(inputs: corporate-bond-calculator';Inputs): number {
...
export function generateAnalysis(inputs: corporate-bond-calculator';Inputs, metrics: corporate-bond-calculator';Metrics): corporate-bond-calculator';Analysis {
