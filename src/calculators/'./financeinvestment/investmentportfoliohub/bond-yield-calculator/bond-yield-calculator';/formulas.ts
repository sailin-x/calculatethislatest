import { bond-yield-calculator';Inputs, bond-yield-calculator';Metrics, bond-yield-calculator';Analysis } from './types';
...
export function calculateResult(inputs: bond-yield-calculator';Inputs): number {
...
export function generateAnalysis(inputs: bond-yield-calculator';Inputs, metrics: bond-yield-calculator';Metrics): bond-yield-calculator';Analysis {
