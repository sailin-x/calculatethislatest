import { gross_margin_calculator';Inputs, gross_margin_calculator';Metrics, gross_margin_calculator';Analysis } from './types';
...
export function calculateResult(inputs: gross_margin_calculator';Inputs): number {
...
export function generateAnalysis(inputs: gross_margin_calculator';Inputs, metrics: gross_margin_calculator';Metrics): gross_margin_calculator';Analysis {
