import { reit_dividend_calculator';Inputs, reit_dividend_calculator';Metrics, reit_dividend_calculator';Analysis } from './types';
...
export function calculateResult(inputs: reit_dividend_calculator';Inputs): number {
...
export function generateAnalysis(inputs: reit_dividend_calculator';Inputs, metrics: reit_dividend_calculator';Metrics): reit_dividend_calculator';Analysis {
