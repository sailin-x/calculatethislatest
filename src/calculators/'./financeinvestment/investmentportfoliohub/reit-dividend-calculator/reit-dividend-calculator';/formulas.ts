import { reit-dividend-calculator';Inputs, reit-dividend-calculator';Metrics, reit-dividend-calculator';Analysis } from './types';
...
export function calculateResult(inputs: reit-dividend-calculator';Inputs): number {
...
export function generateAnalysis(inputs: reit-dividend-calculator';Inputs, metrics: reit-dividend-calculator';Metrics): reit-dividend-calculator';Analysis {
