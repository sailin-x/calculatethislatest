import { cost-of-debt-calculator';Inputs, cost-of-debt-calculator';Metrics, cost-of-debt-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cost-of-debt-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cost-of-debt-calculator';Inputs, metrics: cost-of-debt-calculator';Metrics): cost-of-debt-calculator';Analysis {
