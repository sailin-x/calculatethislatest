import { enterprise-value-calculator';Inputs, enterprise-value-calculator';Metrics, enterprise-value-calculator';Analysis } from './types';
...
export function calculateResult(inputs: enterprise-value-calculator';Inputs): number {
...
export function generateAnalysis(inputs: enterprise-value-calculator';Inputs, metrics: enterprise-value-calculator';Metrics): enterprise-value-calculator';Analysis {
