import { revenue_calculator';Inputs, revenue_calculator';Metrics, revenue_calculator';Analysis } from './types';
...
export function calculateResult(inputs: revenue_calculator';Inputs): number {
...
export function generateAnalysis(inputs: revenue_calculator';Inputs, metrics: revenue_calculator';Metrics): revenue_calculator';Analysis {
