import { revenue-calculator';Inputs, revenue-calculator';Metrics, revenue-calculator';Analysis } from './types';
...
export function calculateResult(inputs: revenue-calculator';Inputs): number {
...
export function generateAnalysis(inputs: revenue-calculator';Inputs, metrics: revenue-calculator';Metrics): revenue-calculator';Analysis {
