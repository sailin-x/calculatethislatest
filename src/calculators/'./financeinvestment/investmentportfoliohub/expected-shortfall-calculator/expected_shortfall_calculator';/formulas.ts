import { expected_shortfall_calculator';Inputs, expected_shortfall_calculator';Metrics, expected_shortfall_calculator';Analysis } from './types';
...
export function calculateResult(inputs: expected_shortfall_calculator';Inputs): number {
...
export function generateAnalysis(inputs: expected_shortfall_calculator';Inputs, metrics: expected_shortfall_calculator';Metrics): expected_shortfall_calculator';Analysis {
