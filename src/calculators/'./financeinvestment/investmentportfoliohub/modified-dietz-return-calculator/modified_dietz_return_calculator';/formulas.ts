import { modified_dietz_return_calculator';Inputs, modified_dietz_return_calculator';Metrics, modified_dietz_return_calculator';Analysis } from './types';
...
export function calculateResult(inputs: modified_dietz_return_calculator';Inputs): number {
...
export function generateAnalysis(inputs: modified_dietz_return_calculator';Inputs, metrics: modified_dietz_return_calculator';Metrics): modified_dietz_return_calculator';Analysis {
