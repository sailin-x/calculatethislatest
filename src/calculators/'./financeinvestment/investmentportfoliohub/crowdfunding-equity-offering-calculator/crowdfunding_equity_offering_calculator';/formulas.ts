import { crowdfunding_equity_offering_calculator';Inputs, crowdfunding_equity_offering_calculator';Metrics, crowdfunding_equity_offering_calculator';Analysis } from './types';
...
export function calculateResult(inputs: crowdfunding_equity_offering_calculator';Inputs): number {
...
export function generateAnalysis(inputs: crowdfunding_equity_offering_calculator';Inputs, metrics: crowdfunding_equity_offering_calculator';Metrics): crowdfunding_equity_offering_calculator';Analysis {
