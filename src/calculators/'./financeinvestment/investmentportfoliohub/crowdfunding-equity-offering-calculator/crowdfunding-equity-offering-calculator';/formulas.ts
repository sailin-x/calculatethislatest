import { crowdfunding-equity-offering-calculator';Inputs, crowdfunding-equity-offering-calculator';Metrics, crowdfunding-equity-offering-calculator';Analysis } from './types';
...
export function calculateResult(inputs: crowdfunding-equity-offering-calculator';Inputs): number {
...
export function generateAnalysis(inputs: crowdfunding-equity-offering-calculator';Inputs, metrics: crowdfunding-equity-offering-calculator';Metrics): crowdfunding-equity-offering-calculator';Analysis {
