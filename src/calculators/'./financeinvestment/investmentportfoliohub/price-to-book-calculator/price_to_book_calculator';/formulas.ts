import { price_to_book_calculator';Inputs, price_to_book_calculator';Metrics, price_to_book_calculator';Analysis } from './types';
...
export function calculateResult(inputs: price_to_book_calculator';Inputs): number {
...
export function generateAnalysis(inputs: price_to_book_calculator';Inputs, metrics: price_to_book_calculator';Metrics): price_to_book_calculator';Analysis {
