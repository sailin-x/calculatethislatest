import { terminal-value-calculator';Inputs, terminal-value-calculator';Metrics, terminal-value-calculator';Analysis } from './types';
...
export function calculateResult(inputs: terminal-value-calculator';Inputs): number {
...
export function generateAnalysis(inputs: terminal-value-calculator';Inputs, metrics: terminal-value-calculator';Metrics): terminal-value-calculator';Analysis {
