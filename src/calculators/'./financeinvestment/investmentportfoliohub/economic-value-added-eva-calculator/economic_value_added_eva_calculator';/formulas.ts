import { economic_value_added_eva_calculator';Inputs, economic_value_added_eva_calculator';Metrics, economic_value_added_eva_calculator';Analysis } from './types';
...
export function calculateResult(inputs: economic_value_added_eva_calculator';Inputs): number {
...
export function generateAnalysis(inputs: economic_value_added_eva_calculator';Inputs, metrics: economic_value_added_eva_calculator';Metrics): economic_value_added_eva_calculator';Analysis {
