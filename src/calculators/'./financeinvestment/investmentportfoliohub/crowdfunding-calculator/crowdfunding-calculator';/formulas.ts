import { crowdfunding-calculator';Inputs, crowdfunding-calculator';Metrics, crowdfunding-calculator';Analysis } from './types';
...
export function calculateResult(inputs: crowdfunding-calculator';Inputs): number {
...
export function generateAnalysis(inputs: crowdfunding-calculator';Inputs, metrics: crowdfunding-calculator';Metrics): crowdfunding-calculator';Analysis {
