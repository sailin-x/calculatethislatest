import { correlation-calculator';Inputs, correlation-calculator';Metrics, correlation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: correlation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: correlation-calculator';Inputs, metrics: correlation-calculator';Metrics): correlation-calculator';Analysis {
