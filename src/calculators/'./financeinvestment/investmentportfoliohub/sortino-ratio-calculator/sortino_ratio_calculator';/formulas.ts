import { sortino_ratio_calculator';Inputs, sortino_ratio_calculator';Metrics, sortino_ratio_calculator';Analysis } from './types';
...
export function calculateResult(inputs: sortino_ratio_calculator';Inputs): number {
...
export function generateAnalysis(inputs: sortino_ratio_calculator';Inputs, metrics: sortino_ratio_calculator';Metrics): sortino_ratio_calculator';Analysis {
