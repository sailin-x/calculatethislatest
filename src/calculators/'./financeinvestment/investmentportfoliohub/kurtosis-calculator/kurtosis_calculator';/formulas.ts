import { kurtosis_calculator';Inputs, kurtosis_calculator';Metrics, kurtosis_calculator';Analysis } from './types';
...
export function calculateResult(inputs: kurtosis_calculator';Inputs): number {
...
export function generateAnalysis(inputs: kurtosis_calculator';Inputs, metrics: kurtosis_calculator';Metrics): kurtosis_calculator';Analysis {
