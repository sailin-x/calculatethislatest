import { staking_rewards_calculator';Inputs, staking_rewards_calculator';Metrics, staking_rewards_calculator';Analysis } from './types';
...
export function calculateResult(inputs: staking_rewards_calculator';Inputs): number {
...
export function generateAnalysis(inputs: staking_rewards_calculator';Inputs, metrics: staking_rewards_calculator';Metrics): staking_rewards_calculator';Analysis {
