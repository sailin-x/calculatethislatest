import { crypto-arbitrage-calculator';Inputs, crypto-arbitrage-calculator';Metrics, crypto-arbitrage-calculator';Analysis } from './types';
...
export function calculateResult(inputs: crypto-arbitrage-calculator';Inputs): number {
...
export function generateAnalysis(inputs: crypto-arbitrage-calculator';Inputs, metrics: crypto-arbitrage-calculator';Metrics): crypto-arbitrage-calculator';Analysis {
