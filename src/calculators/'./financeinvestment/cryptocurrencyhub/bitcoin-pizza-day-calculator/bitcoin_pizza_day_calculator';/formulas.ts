import { bitcoin_pizza_day_calculator';Inputs, bitcoin_pizza_day_calculator';Metrics, bitcoin_pizza_day_calculator';Analysis } from './types';
...
export function calculateResult(inputs: bitcoin_pizza_day_calculator';Inputs): number {
...
export function generateAnalysis(inputs: bitcoin_pizza_day_calculator';Inputs, metrics: bitcoin_pizza_day_calculator';Metrics): bitcoin_pizza_day_calculator';Analysis {
