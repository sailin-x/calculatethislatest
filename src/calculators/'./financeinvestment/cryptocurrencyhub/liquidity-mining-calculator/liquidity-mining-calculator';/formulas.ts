import { liquidity-mining-calculator';Inputs, liquidity-mining-calculator';Metrics, liquidity-mining-calculator';Analysis } from './types';
...
export function calculateResult(inputs: liquidity-mining-calculator';Inputs): number {
...
export function generateAnalysis(inputs: liquidity-mining-calculator';Inputs, metrics: liquidity-mining-calculator';Metrics): liquidity-mining-calculator';Analysis {
