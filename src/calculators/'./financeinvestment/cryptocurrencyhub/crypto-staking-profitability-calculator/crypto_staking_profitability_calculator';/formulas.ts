import { crypto_staking_profitability_calculator';Inputs, crypto_staking_profitability_calculator';Metrics, crypto_staking_profitability_calculator';Analysis } from './types';
...
export function calculateResult(inputs: crypto_staking_profitability_calculator';Inputs): number {
...
export function generateAnalysis(inputs: crypto_staking_profitability_calculator';Inputs, metrics: crypto_staking_profitability_calculator';Metrics): crypto_staking_profitability_calculator';Analysis {
