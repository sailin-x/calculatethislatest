import { crypto-staking-profitability-calculator';Inputs, crypto-staking-profitability-calculator';Metrics, crypto-staking-profitability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: crypto-staking-profitability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: crypto-staking-profitability-calculator';Inputs, metrics: crypto-staking-profitability-calculator';Metrics): crypto-staking-profitability-calculator';Analysis {
