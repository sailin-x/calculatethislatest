import { masternode_roi_calculator';Inputs, masternode_roi_calculator';Metrics, masternode_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: masternode_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: masternode_roi_calculator';Inputs, metrics: masternode_roi_calculator';Metrics): masternode_roi_calculator';Analysis {
