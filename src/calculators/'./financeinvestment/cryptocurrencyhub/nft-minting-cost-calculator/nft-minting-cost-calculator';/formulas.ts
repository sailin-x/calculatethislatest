import { nft-minting-cost-calculator';Inputs, nft-minting-cost-calculator';Metrics, nft-minting-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: nft-minting-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: nft-minting-cost-calculator';Inputs, metrics: nft-minting-cost-calculator';Metrics): nft-minting-cost-calculator';Analysis {
