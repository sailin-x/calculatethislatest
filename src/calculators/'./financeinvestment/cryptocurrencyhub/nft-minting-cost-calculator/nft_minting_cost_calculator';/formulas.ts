import { nft_minting_cost_calculator';Inputs, nft_minting_cost_calculator';Metrics, nft_minting_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: nft_minting_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: nft_minting_cost_calculator';Inputs, metrics: nft_minting_cost_calculator';Metrics): nft_minting_cost_calculator';Analysis {
