import { nft-royalty-revenue-calculator';Inputs, nft-royalty-revenue-calculator';Metrics, nft-royalty-revenue-calculator';Analysis } from './types';
...
export function calculateResult(inputs: nft-royalty-revenue-calculator';Inputs): number {
...
export function generateAnalysis(inputs: nft-royalty-revenue-calculator';Inputs, metrics: nft-royalty-revenue-calculator';Metrics): nft-royalty-revenue-calculator';Analysis {
