import { dogecoin-mining-calculator';Inputs, dogecoin-mining-calculator';Metrics, dogecoin-mining-calculator';Analysis } from './types';
...
export function calculateResult(inputs: dogecoin-mining-calculator';Inputs): number {
...
export function generateAnalysis(inputs: dogecoin-mining-calculator';Inputs, metrics: dogecoin-mining-calculator';Metrics): dogecoin-mining-calculator';Analysis {
