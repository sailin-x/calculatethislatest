import { airdrop-value-calculator';Inputs, airdrop-value-calculator';Metrics, airdrop-value-calculator';Analysis } from './types';
...
export function calculateResult(inputs: airdrop-value-calculator';Inputs): number {
...
export function generateAnalysis(inputs: airdrop-value-calculator';Inputs, metrics: airdrop-value-calculator';Metrics): airdrop-value-calculator';Analysis {
