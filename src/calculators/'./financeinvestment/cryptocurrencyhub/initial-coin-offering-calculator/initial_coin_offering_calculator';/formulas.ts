import { initial_coin_offering_calculator';Inputs, initial_coin_offering_calculator';Metrics, initial_coin_offering_calculator';Analysis } from './types';
...
export function calculateResult(inputs: initial_coin_offering_calculator';Inputs): number {
...
export function generateAnalysis(inputs: initial_coin_offering_calculator';Inputs, metrics: initial_coin_offering_calculator';Metrics): initial_coin_offering_calculator';Analysis {
