import { defi_liquidity_pool_calculator';Inputs, defi_liquidity_pool_calculator';Metrics, defi_liquidity_pool_calculator';Analysis } from './types';
...
export function calculateResult(inputs: defi_liquidity_pool_calculator';Inputs): number {
...
export function generateAnalysis(inputs: defi_liquidity_pool_calculator';Inputs, metrics: defi_liquidity_pool_calculator';Metrics): defi_liquidity_pool_calculator';Analysis {
