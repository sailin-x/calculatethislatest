import { defi-liquidity-pool-calculator';Inputs, defi-liquidity-pool-calculator';Metrics, defi-liquidity-pool-calculator';Analysis } from './types';
...
export function calculateResult(inputs: defi-liquidity-pool-calculator';Inputs): number {
...
export function generateAnalysis(inputs: defi-liquidity-pool-calculator';Inputs, metrics: defi-liquidity-pool-calculator';Metrics): defi-liquidity-pool-calculator';Analysis {
