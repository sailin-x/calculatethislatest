import { gas_fee_optimizer_calculator';Inputs, gas_fee_optimizer_calculator';Metrics, gas_fee_optimizer_calculator';Analysis } from './types';
...
export function calculateResult(inputs: gas_fee_optimizer_calculator';Inputs): number {
...
export function generateAnalysis(inputs: gas_fee_optimizer_calculator';Inputs, metrics: gas_fee_optimizer_calculator';Metrics): gas_fee_optimizer_calculator';Analysis {
