import { crypto-tax-harvesting-calculator';Inputs, crypto-tax-harvesting-calculator';Metrics, crypto-tax-harvesting-calculator';Analysis } from './types';
...
export function calculateResult(inputs: crypto-tax-harvesting-calculator';Inputs): number {
...
export function generateAnalysis(inputs: crypto-tax-harvesting-calculator';Inputs, metrics: crypto-tax-harvesting-calculator';Metrics): crypto-tax-harvesting-calculator';Analysis {
