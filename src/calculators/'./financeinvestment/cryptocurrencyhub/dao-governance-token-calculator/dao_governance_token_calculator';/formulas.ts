import { dao_governance_token_calculator';Inputs, dao_governance_token_calculator';Metrics, dao_governance_token_calculator';Analysis } from './types';
...
export function calculateResult(inputs: dao_governance_token_calculator';Inputs): number {
...
export function generateAnalysis(inputs: dao_governance_token_calculator';Inputs, metrics: dao_governance_token_calculator';Metrics): dao_governance_token_calculator';Analysis {
