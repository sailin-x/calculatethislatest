import { shitcoin-investment-calculator';Inputs, shitcoin-investment-calculator';Metrics, shitcoin-investment-calculator';Analysis } from './types';
...
export function calculateResult(inputs: shitcoin-investment-calculator';Inputs): number {
...
export function generateAnalysis(inputs: shitcoin-investment-calculator';Inputs, metrics: shitcoin-investment-calculator';Metrics): shitcoin-investment-calculator';Analysis {
