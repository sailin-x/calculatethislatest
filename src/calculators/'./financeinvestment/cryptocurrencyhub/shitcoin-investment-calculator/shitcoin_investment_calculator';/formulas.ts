import { shitcoin_investment_calculator';Inputs, shitcoin_investment_calculator';Metrics, shitcoin_investment_calculator';Analysis } from './types';
...
export function calculateResult(inputs: shitcoin_investment_calculator';Inputs): number {
...
export function generateAnalysis(inputs: shitcoin_investment_calculator';Inputs, metrics: shitcoin_investment_calculator';Metrics): shitcoin_investment_calculator';Analysis {
