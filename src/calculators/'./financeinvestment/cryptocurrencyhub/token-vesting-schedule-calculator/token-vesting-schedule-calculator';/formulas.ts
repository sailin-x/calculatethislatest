import { token-vesting-schedule-calculator';Inputs, token-vesting-schedule-calculator';Metrics, token-vesting-schedule-calculator';Analysis } from './types';
...
export function calculateResult(inputs: token-vesting-schedule-calculator';Inputs): number {
...
export function generateAnalysis(inputs: token-vesting-schedule-calculator';Inputs, metrics: token-vesting-schedule-calculator';Metrics): token-vesting-schedule-calculator';Analysis {
