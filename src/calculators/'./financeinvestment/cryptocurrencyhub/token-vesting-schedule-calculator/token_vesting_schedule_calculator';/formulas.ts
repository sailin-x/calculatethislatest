import { token_vesting_schedule_calculator';Inputs, token_vesting_schedule_calculator';Metrics, token_vesting_schedule_calculator';Analysis } from './types';
...
export function calculateResult(inputs: token_vesting_schedule_calculator';Inputs): number {
...
export function generateAnalysis(inputs: token_vesting_schedule_calculator';Inputs, metrics: token_vesting_schedule_calculator';Metrics): token_vesting_schedule_calculator';Analysis {
