import { burn-mechanism-calculator';Inputs, burn-mechanism-calculator';Metrics, burn-mechanism-calculator';Analysis } from './types';
...
export function calculateResult(inputs: burn-mechanism-calculator';Inputs): number {
...
export function generateAnalysis(inputs: burn-mechanism-calculator';Inputs, metrics: burn-mechanism-calculator';Metrics): burn-mechanism-calculator';Analysis {
