import { burn_mechanism_calculator';Inputs, burn_mechanism_calculator';Metrics, burn_mechanism_calculator';Analysis } from './types';
...
export function calculateResult(inputs: burn_mechanism_calculator';Inputs): number {
...
export function generateAnalysis(inputs: burn_mechanism_calculator';Inputs, metrics: burn_mechanism_calculator';Metrics): burn_mechanism_calculator';Analysis {
