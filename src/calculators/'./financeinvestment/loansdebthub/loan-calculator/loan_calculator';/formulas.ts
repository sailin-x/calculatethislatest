import { loan_calculator';Inputs, loan_calculator';Metrics, loan_calculator';Analysis } from './types';
...
export function calculateResult(inputs: loan_calculator';Inputs): number {
...
export function generateAnalysis(inputs: loan_calculator';Inputs, metrics: loan_calculator';Metrics): loan_calculator';Analysis {
