import { income_based_repayment_calculator';Inputs, income_based_repayment_calculator';Metrics, income_based_repayment_calculator';Analysis } from './types';
...
export function calculateResult(inputs: income_based_repayment_calculator';Inputs): number {
...
export function generateAnalysis(inputs: income_based_repayment_calculator';Inputs, metrics: income_based_repayment_calculator';Metrics): income_based_repayment_calculator';Analysis {
