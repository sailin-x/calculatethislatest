import { current-ratio-calculator';Inputs, current-ratio-calculator';Metrics, current-ratio-calculator';Analysis } from './types';
...
export function calculateResult(inputs: current-ratio-calculator';Inputs): number {
...
export function generateAnalysis(inputs: current-ratio-calculator';Inputs, metrics: current-ratio-calculator';Metrics): current-ratio-calculator';Analysis {
