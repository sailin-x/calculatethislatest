import { current_ratio_calculator';Inputs, current_ratio_calculator';Metrics, current_ratio_calculator';Analysis } from './types';
...
export function calculateResult(inputs: current_ratio_calculator';Inputs): number {
...
export function generateAnalysis(inputs: current_ratio_calculator';Inputs, metrics: current_ratio_calculator';Metrics): current_ratio_calculator';Analysis {
