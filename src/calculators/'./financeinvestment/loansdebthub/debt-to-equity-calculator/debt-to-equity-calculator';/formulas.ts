import { debt-to-equity-calculator';Inputs, debt-to-equity-calculator';Metrics, debt-to-equity-calculator';Analysis } from './types';
...
export function calculateResult(inputs: debt-to-equity-calculator';Inputs): number {
...
export function generateAnalysis(inputs: debt-to-equity-calculator';Inputs, metrics: debt-to-equity-calculator';Metrics): debt-to-equity-calculator';Analysis {
