import { car-loan-calculator';Inputs, car-loan-calculator';Metrics, car-loan-calculator';Analysis } from './types';
...
export function calculateResult(inputs: car-loan-calculator';Inputs): number {
...
export function generateAnalysis(inputs: car-loan-calculator';Inputs, metrics: car-loan-calculator';Metrics): car-loan-calculator';Analysis {
