import { loan-comparison-calculator';Inputs, loan-comparison-calculator';Metrics, loan-comparison-calculator';Analysis } from './types';
...
export function calculateResult(inputs: loan-comparison-calculator';Inputs): number {
...
export function generateAnalysis(inputs: loan-comparison-calculator';Inputs, metrics: loan-comparison-calculator';Metrics): loan-comparison-calculator';Analysis {
