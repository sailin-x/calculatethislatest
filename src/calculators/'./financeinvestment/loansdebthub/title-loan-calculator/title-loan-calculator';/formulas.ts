import { title-loan-calculator';Inputs, title-loan-calculator';Metrics, title-loan-calculator';Analysis } from './types';
...
export function calculateResult(inputs: title-loan-calculator';Inputs): number {
...
export function generateAnalysis(inputs: title-loan-calculator';Inputs, metrics: title-loan-calculator';Metrics): title-loan-calculator';Analysis {
