import { credit-utilization-calculator';Inputs, credit-utilization-calculator';Metrics, credit-utilization-calculator';Analysis } from './types';
...
export function calculateResult(inputs: credit-utilization-calculator';Inputs): number {
...
export function generateAnalysis(inputs: credit-utilization-calculator';Inputs, metrics: credit-utilization-calculator';Metrics): credit-utilization-calculator';Analysis {
