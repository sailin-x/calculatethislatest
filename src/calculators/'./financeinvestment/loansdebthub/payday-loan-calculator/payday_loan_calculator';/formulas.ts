import { payday_loan_calculator';Inputs, payday_loan_calculator';Metrics, payday_loan_calculator';Analysis } from './types';
...
export function calculateResult(inputs: payday_loan_calculator';Inputs): number {
...
export function generateAnalysis(inputs: payday_loan_calculator';Inputs, metrics: payday_loan_calculator';Metrics): payday_loan_calculator';Analysis {
