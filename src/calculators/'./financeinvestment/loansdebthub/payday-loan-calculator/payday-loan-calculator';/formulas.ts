import { payday-loan-calculator';Inputs, payday-loan-calculator';Metrics, payday-loan-calculator';Analysis } from './types';
...
export function calculateResult(inputs: payday-loan-calculator';Inputs): number {
...
export function generateAnalysis(inputs: payday-loan-calculator';Inputs, metrics: payday-loan-calculator';Metrics): payday-loan-calculator';Analysis {
