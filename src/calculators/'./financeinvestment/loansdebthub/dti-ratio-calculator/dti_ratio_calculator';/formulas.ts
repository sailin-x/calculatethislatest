import { dti_ratio_calculator';Inputs, dti_ratio_calculator';Metrics, dti_ratio_calculator';Analysis } from './types';
...
export function calculateResult(inputs: dti_ratio_calculator';Inputs): number {
...
export function generateAnalysis(inputs: dti_ratio_calculator';Inputs, metrics: dti_ratio_calculator';Metrics): dti_ratio_calculator';Analysis {
