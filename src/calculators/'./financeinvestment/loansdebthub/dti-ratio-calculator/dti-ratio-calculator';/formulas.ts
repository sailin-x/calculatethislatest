import { dti-ratio-calculator';Inputs, dti-ratio-calculator';Metrics, dti-ratio-calculator';Analysis } from './types';
...
export function calculateResult(inputs: dti-ratio-calculator';Inputs): number {
...
export function generateAnalysis(inputs: dti-ratio-calculator';Inputs, metrics: dti-ratio-calculator';Metrics): dti-ratio-calculator';Analysis {
