import { student-loan-repayment-calculator';Inputs, student-loan-repayment-calculator';Metrics, student-loan-repayment-calculator';Analysis } from './types';
...
export function calculateResult(inputs: student-loan-repayment-calculator';Inputs): number {
...
export function generateAnalysis(inputs: student-loan-repayment-calculator';Inputs, metrics: student-loan-repayment-calculator';Metrics): student-loan-repayment-calculator';Analysis {
