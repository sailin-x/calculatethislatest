import { required_beginning_date_rbd_for_rmds_calculator';Inputs, required_beginning_date_rbd_for_rmds_calculator';Metrics, required_beginning_date_rbd_for_rmds_calculator';Analysis } from './types';
...
export function calculateResult(inputs: required_beginning_date_rbd_for_rmds_calculator';Inputs): number {
...
export function generateAnalysis(inputs: required_beginning_date_rbd_for_rmds_calculator';Inputs, metrics: required_beginning_date_rbd_for_rmds_calculator';Metrics): required_beginning_date_rbd_for_rmds_calculator';Analysis {
