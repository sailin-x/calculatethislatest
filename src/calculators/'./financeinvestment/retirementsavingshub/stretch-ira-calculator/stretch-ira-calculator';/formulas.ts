import { stretch-ira-calculator';Inputs, stretch-ira-calculator';Metrics, stretch-ira-calculator';Analysis } from './types';
...
export function calculateResult(inputs: stretch-ira-calculator';Inputs): number {
...
export function generateAnalysis(inputs: stretch-ira-calculator';Inputs, metrics: stretch-ira-calculator';Metrics): stretch-ira-calculator';Analysis {
