import { structured-settlement-payout-calculator';Inputs, structured-settlement-payout-calculator';Metrics, structured-settlement-payout-calculator';Analysis } from './types';
...
export function calculateResult(inputs: structured-settlement-payout-calculator';Inputs): number {
...
export function generateAnalysis(inputs: structured-settlement-payout-calculator';Inputs, metrics: structured-settlement-payout-calculator';Metrics): structured-settlement-payout-calculator';Analysis {
