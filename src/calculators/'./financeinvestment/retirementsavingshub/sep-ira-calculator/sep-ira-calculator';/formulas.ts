import { sep-ira-calculator';Inputs, sep-ira-calculator';Metrics, sep-ira-calculator';Analysis } from './types';
...
export function calculateResult(inputs: sep-ira-calculator';Inputs): number {
...
export function generateAnalysis(inputs: sep-ira-calculator';Inputs, metrics: sep-ira-calculator';Metrics): sep-ira-calculator';Analysis {
