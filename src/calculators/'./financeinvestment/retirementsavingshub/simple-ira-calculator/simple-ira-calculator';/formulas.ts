import { simple-ira-calculator';Inputs, simple-ira-calculator';Metrics, simple-ira-calculator';Analysis } from './types';
...
export function calculateResult(inputs: simple-ira-calculator';Inputs): number {
...
export function generateAnalysis(inputs: simple-ira-calculator';Inputs, metrics: simple-ira-calculator';Metrics): simple-ira-calculator';Analysis {
