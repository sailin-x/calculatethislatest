import { combinatorics-calculator';Inputs, combinatorics-calculator';Metrics, combinatorics-calculator';Analysis } from './types';
...
export function calculateResult(inputs: combinatorics-calculator';Inputs): number {
...
export function generateAnalysis(inputs: combinatorics-calculator';Inputs, metrics: combinatorics-calculator';Metrics): combinatorics-calculator';Analysis {
