import { graph-theory-calculator';Inputs, graph-theory-calculator';Metrics, graph-theory-calculator';Analysis } from './types';
...
export function calculateResult(inputs: graph-theory-calculator';Inputs): number {
...
export function generateAnalysis(inputs: graph-theory-calculator';Inputs, metrics: graph-theory-calculator';Metrics): graph-theory-calculator';Analysis {
