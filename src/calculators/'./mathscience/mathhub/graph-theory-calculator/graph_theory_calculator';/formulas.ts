import { graph_theory_calculator';Inputs, graph_theory_calculator';Metrics, graph_theory_calculator';Analysis } from './types';
...
export function calculateResult(inputs: graph_theory_calculator';Inputs): number {
...
export function generateAnalysis(inputs: graph_theory_calculator';Inputs, metrics: graph_theory_calculator';Metrics): graph_theory_calculator';Analysis {
