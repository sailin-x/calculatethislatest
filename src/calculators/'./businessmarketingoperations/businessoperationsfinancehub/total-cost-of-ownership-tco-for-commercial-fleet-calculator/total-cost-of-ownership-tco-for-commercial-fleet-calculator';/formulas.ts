import { total-cost-of-ownership-tco-for-commercial-fleet-calculator';Inputs, total-cost-of-ownership-tco-for-commercial-fleet-calculator';Metrics, total-cost-of-ownership-tco-for-commercial-fleet-calculator';Analysis } from './types';
...
export function calculateResult(inputs: total-cost-of-ownership-tco-for-commercial-fleet-calculator';Inputs): number {
...
export function generateAnalysis(inputs: total-cost-of-ownership-tco-for-commercial-fleet-calculator';Inputs, metrics: total-cost-of-ownership-tco-for-commercial-fleet-calculator';Metrics): total-cost-of-ownership-tco-for-commercial-fleet-calculator';Analysis {
