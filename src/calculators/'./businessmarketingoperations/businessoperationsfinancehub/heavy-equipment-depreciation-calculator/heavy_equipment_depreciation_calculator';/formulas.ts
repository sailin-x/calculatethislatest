import { heavy_equipment_depreciation_calculator';Inputs, heavy_equipment_depreciation_calculator';Metrics, heavy_equipment_depreciation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: heavy_equipment_depreciation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: heavy_equipment_depreciation_calculator';Inputs, metrics: heavy_equipment_depreciation_calculator';Metrics): heavy_equipment_depreciation_calculator';Analysis {
