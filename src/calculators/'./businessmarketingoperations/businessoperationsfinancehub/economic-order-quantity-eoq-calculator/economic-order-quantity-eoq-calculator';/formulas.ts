import { economic-order-quantity-eoq-calculator';Inputs, economic-order-quantity-eoq-calculator';Metrics, economic-order-quantity-eoq-calculator';Analysis } from './types';
...
export function calculateResult(inputs: economic-order-quantity-eoq-calculator';Inputs): number {
...
export function generateAnalysis(inputs: economic-order-quantity-eoq-calculator';Inputs, metrics: economic-order-quantity-eoq-calculator';Metrics): economic-order-quantity-eoq-calculator';Analysis {
