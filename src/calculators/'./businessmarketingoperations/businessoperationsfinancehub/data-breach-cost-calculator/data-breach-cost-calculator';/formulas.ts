import { data-breach-cost-calculator';Inputs, data-breach-cost-calculator';Metrics, data-breach-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: data-breach-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: data-breach-cost-calculator';Inputs, metrics: data-breach-cost-calculator';Metrics): data-breach-cost-calculator';Analysis {
