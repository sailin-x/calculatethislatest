import { management_consulting_fee_model_calculator';Inputs, management_consulting_fee_model_calculator';Metrics, management_consulting_fee_model_calculator';Analysis } from './types';
...
export function calculateResult(inputs: management_consulting_fee_model_calculator';Inputs): number {
...
export function generateAnalysis(inputs: management_consulting_fee_model_calculator';Inputs, metrics: management_consulting_fee_model_calculator';Metrics): management_consulting_fee_model_calculator';Analysis {
