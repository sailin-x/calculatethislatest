import { government-contract-bid-no-bid-decision-calculator';Inputs, government-contract-bid-no-bid-decision-calculator';Metrics, government-contract-bid-no-bid-decision-calculator';Analysis } from './types';
...
export function calculateResult(inputs: government-contract-bid-no-bid-decision-calculator';Inputs): number {
...
export function generateAnalysis(inputs: government-contract-bid-no-bid-decision-calculator';Inputs, metrics: government-contract-bid-no-bid-decision-calculator';Metrics): government-contract-bid-no-bid-decision-calculator';Analysis {
