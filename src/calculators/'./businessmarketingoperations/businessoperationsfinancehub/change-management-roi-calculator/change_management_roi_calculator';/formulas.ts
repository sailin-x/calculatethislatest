import { change_management_roi_calculator';Inputs, change_management_roi_calculator';Metrics, change_management_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: change_management_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: change_management_roi_calculator';Inputs, metrics: change_management_roi_calculator';Metrics): change_management_roi_calculator';Analysis {
