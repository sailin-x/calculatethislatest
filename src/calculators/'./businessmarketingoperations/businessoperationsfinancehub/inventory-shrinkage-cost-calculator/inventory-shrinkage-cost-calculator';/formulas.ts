import { inventory-shrinkage-cost-calculator';Inputs, inventory-shrinkage-cost-calculator';Metrics, inventory-shrinkage-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: inventory-shrinkage-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: inventory-shrinkage-cost-calculator';Inputs, metrics: inventory-shrinkage-cost-calculator';Metrics): inventory-shrinkage-cost-calculator';Analysis {
