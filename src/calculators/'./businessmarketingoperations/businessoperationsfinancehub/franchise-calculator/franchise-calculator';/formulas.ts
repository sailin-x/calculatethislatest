import { franchise-calculator';Inputs, franchise-calculator';Metrics, franchise-calculator';Analysis } from './types';
...
export function calculateResult(inputs: franchise-calculator';Inputs): number {
...
export function generateAnalysis(inputs: franchise-calculator';Inputs, metrics: franchise-calculator';Metrics): franchise-calculator';Analysis {
