import { ransomware-downtime-cost-calculator';Inputs, ransomware-downtime-cost-calculator';Metrics, ransomware-downtime-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: ransomware-downtime-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: ransomware-downtime-cost-calculator';Inputs, metrics: ransomware-downtime-cost-calculator';Metrics): ransomware-downtime-cost-calculator';Analysis {
