import { ransomware_downtime_cost_calculator';Inputs, ransomware_downtime_cost_calculator';Metrics, ransomware_downtime_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: ransomware_downtime_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: ransomware_downtime_cost_calculator';Inputs, metrics: ransomware_downtime_cost_calculator';Metrics): ransomware_downtime_cost_calculator';Analysis {
