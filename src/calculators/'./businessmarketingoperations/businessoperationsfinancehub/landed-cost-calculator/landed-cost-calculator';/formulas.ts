import { landed-cost-calculator';Inputs, landed-cost-calculator';Metrics, landed-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: landed-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: landed-cost-calculator';Inputs, metrics: landed-cost-calculator';Metrics): landed-cost-calculator';Analysis {
