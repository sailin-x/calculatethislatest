import { inventory-turnover-calculator';Inputs, inventory-turnover-calculator';Metrics, inventory-turnover-calculator';Analysis } from './types';
...
export function calculateResult(inputs: inventory-turnover-calculator';Inputs): number {
...
export function generateAnalysis(inputs: inventory-turnover-calculator';Inputs, metrics: inventory-turnover-calculator';Metrics): inventory-turnover-calculator';Analysis {
