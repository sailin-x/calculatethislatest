import { inventory_turnover_calculator';Inputs, inventory_turnover_calculator';Metrics, inventory_turnover_calculator';Analysis } from './types';
...
export function calculateResult(inputs: inventory_turnover_calculator';Inputs): number {
...
export function generateAnalysis(inputs: inventory_turnover_calculator';Inputs, metrics: inventory_turnover_calculator';Metrics): inventory_turnover_calculator';Analysis {
