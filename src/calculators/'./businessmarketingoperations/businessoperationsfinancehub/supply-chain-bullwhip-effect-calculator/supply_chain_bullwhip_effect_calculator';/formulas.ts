import { supply_chain_bullwhip_effect_calculator';Inputs, supply_chain_bullwhip_effect_calculator';Metrics, supply_chain_bullwhip_effect_calculator';Analysis } from './types';
...
export function calculateResult(inputs: supply_chain_bullwhip_effect_calculator';Inputs): number {
...
export function generateAnalysis(inputs: supply_chain_bullwhip_effect_calculator';Inputs, metrics: supply_chain_bullwhip_effect_calculator';Metrics): supply_chain_bullwhip_effect_calculator';Analysis {
