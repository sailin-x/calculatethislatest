import { sum_of_parts_calculator';Inputs, sum_of_parts_calculator';Metrics, sum_of_parts_calculator';Analysis } from './types';
...
export function calculateResult(inputs: sum_of_parts_calculator';Inputs): number {
...
export function generateAnalysis(inputs: sum_of_parts_calculator';Inputs, metrics: sum_of_parts_calculator';Metrics): sum_of_parts_calculator';Analysis {
