import { technical_debt_calculator';Inputs, technical_debt_calculator';Metrics, technical_debt_calculator';Analysis } from './types';
...
export function calculateResult(inputs: technical_debt_calculator';Inputs): number {
...
export function generateAnalysis(inputs: technical_debt_calculator';Inputs, metrics: technical_debt_calculator';Metrics): technical_debt_calculator';Analysis {
