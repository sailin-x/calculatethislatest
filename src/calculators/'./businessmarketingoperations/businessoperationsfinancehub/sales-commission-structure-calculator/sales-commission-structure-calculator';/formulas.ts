import { sales-commission-structure-calculator';Inputs, sales-commission-structure-calculator';Metrics, sales-commission-structure-calculator';Analysis } from './types';
...
export function calculateResult(inputs: sales-commission-structure-calculator';Inputs): number {
...
export function generateAnalysis(inputs: sales-commission-structure-calculator';Inputs, metrics: sales-commission-structure-calculator';Metrics): sales-commission-structure-calculator';Analysis {
