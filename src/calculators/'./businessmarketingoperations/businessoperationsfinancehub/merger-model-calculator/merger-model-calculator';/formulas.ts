import { merger-model-calculator';Inputs, merger-model-calculator';Metrics, merger-model-calculator';Analysis } from './types';
...
export function calculateResult(inputs: merger-model-calculator';Inputs): number {
...
export function generateAnalysis(inputs: merger-model-calculator';Inputs, metrics: merger-model-calculator';Metrics): merger-model-calculator';Analysis {
