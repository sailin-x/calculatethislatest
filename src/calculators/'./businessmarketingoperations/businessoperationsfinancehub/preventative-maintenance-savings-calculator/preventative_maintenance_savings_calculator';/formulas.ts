import { preventative_maintenance_savings_calculator';Inputs, preventative_maintenance_savings_calculator';Metrics, preventative_maintenance_savings_calculator';Analysis } from './types';
...
export function calculateResult(inputs: preventative_maintenance_savings_calculator';Inputs): number {
...
export function generateAnalysis(inputs: preventative_maintenance_savings_calculator';Inputs, metrics: preventative_maintenance_savings_calculator';Metrics): preventative_maintenance_savings_calculator';Analysis {
