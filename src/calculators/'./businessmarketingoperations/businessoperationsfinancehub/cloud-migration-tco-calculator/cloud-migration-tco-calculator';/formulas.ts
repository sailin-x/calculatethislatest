import { cloud-migration-tco-calculator';Inputs, cloud-migration-tco-calculator';Metrics, cloud-migration-tco-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cloud-migration-tco-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cloud-migration-tco-calculator';Inputs, metrics: cloud-migration-tco-calculator';Metrics): cloud-migration-tco-calculator';Analysis {
