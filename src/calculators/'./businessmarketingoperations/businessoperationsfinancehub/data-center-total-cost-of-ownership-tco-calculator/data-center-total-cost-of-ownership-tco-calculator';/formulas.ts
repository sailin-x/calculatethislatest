import { data-center-total-cost-of-ownership-tco-calculator';Inputs, data-center-total-cost-of-ownership-tco-calculator';Metrics, data-center-total-cost-of-ownership-tco-calculator';Analysis } from './types';
...
export function calculateResult(inputs: data-center-total-cost-of-ownership-tco-calculator';Inputs): number {
...
export function generateAnalysis(inputs: data-center-total-cost-of-ownership-tco-calculator';Inputs, metrics: data-center-total-cost-of-ownership-tco-calculator';Metrics): data-center-total-cost-of-ownership-tco-calculator';Analysis {
