import { business_interruption_calculator';Inputs, business_interruption_calculator';Metrics, business_interruption_calculator';Analysis } from './types';
...
export function calculateResult(inputs: business_interruption_calculator';Inputs): number {
...
export function generateAnalysis(inputs: business_interruption_calculator';Inputs, metrics: business_interruption_calculator';Metrics): business_interruption_calculator';Analysis {
