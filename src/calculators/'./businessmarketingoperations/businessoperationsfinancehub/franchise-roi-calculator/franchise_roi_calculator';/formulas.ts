import { franchise_roi_calculator';Inputs, franchise_roi_calculator';Metrics, franchise_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: franchise_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: franchise_roi_calculator';Inputs, metrics: franchise_roi_calculator';Metrics): franchise_roi_calculator';Analysis {
