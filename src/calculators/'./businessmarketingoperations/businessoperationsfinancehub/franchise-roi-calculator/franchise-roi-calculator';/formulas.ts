import { franchise-roi-calculator';Inputs, franchise-roi-calculator';Metrics, franchise-roi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: franchise-roi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: franchise-roi-calculator';Inputs, metrics: franchise-roi-calculator';Metrics): franchise-roi-calculator';Analysis {
