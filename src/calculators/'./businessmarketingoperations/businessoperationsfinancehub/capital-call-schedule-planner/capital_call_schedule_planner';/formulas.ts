import { capital_call_schedule_planner';Inputs, capital_call_schedule_planner';Metrics, capital_call_schedule_planner';Analysis } from './types';
...
export function calculateResult(inputs: capital_call_schedule_planner';Inputs): number {
...
export function generateAnalysis(inputs: capital_call_schedule_planner';Inputs, metrics: capital_call_schedule_planner';Metrics): capital_call_schedule_planner';Analysis {
