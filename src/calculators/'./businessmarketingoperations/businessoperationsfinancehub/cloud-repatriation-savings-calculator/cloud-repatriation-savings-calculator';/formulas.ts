import { cloud-repatriation-savings-calculator';Inputs, cloud-repatriation-savings-calculator';Metrics, cloud-repatriation-savings-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cloud-repatriation-savings-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cloud-repatriation-savings-calculator';Inputs, metrics: cloud-repatriation-savings-calculator';Metrics): cloud-repatriation-savings-calculator';Analysis {
