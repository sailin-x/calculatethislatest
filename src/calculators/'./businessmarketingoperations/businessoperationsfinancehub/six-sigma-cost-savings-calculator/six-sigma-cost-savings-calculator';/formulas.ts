import { six-sigma-cost-savings-calculator';Inputs, six-sigma-cost-savings-calculator';Metrics, six-sigma-cost-savings-calculator';Analysis } from './types';
...
export function calculateResult(inputs: six-sigma-cost-savings-calculator';Inputs): number {
...
export function generateAnalysis(inputs: six-sigma-cost-savings-calculator';Inputs, metrics: six-sigma-cost-savings-calculator';Metrics): six-sigma-cost-savings-calculator';Analysis {
