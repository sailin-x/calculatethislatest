import { digital_transformation_business_case_calculator';Inputs, digital_transformation_business_case_calculator';Metrics, digital_transformation_business_case_calculator';Analysis } from './types';
...
export function calculateResult(inputs: digital_transformation_business_case_calculator';Inputs): number {
...
export function generateAnalysis(inputs: digital_transformation_business_case_calculator';Inputs, metrics: digital_transformation_business_case_calculator';Metrics): digital_transformation_business_case_calculator';Analysis {
