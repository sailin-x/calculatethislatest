import { business-loan-qualification-calculator';Inputs, business-loan-qualification-calculator';Metrics, business-loan-qualification-calculator';Analysis } from './types';
...
export function calculateResult(inputs: business-loan-qualification-calculator';Inputs): number {
...
export function generateAnalysis(inputs: business-loan-qualification-calculator';Inputs, metrics: business-loan-qualification-calculator';Metrics): business-loan-qualification-calculator';Analysis {
