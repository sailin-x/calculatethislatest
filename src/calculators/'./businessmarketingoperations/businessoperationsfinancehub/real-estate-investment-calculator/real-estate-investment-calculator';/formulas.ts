import { real-estate-investment-calculator';Inputs, real-estate-investment-calculator';Metrics, real-estate-investment-calculator';Analysis } from './types';
...
export function calculateResult(inputs: real-estate-investment-calculator';Inputs): number {
...
export function generateAnalysis(inputs: real-estate-investment-calculator';Inputs, metrics: real-estate-investment-calculator';Metrics): real-estate-investment-calculator';Analysis {
