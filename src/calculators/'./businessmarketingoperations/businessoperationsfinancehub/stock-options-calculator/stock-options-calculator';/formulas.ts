import { stock-options-calculator';Inputs, stock-options-calculator';Metrics, stock-options-calculator';Analysis } from './types';
...
export function calculateResult(inputs: stock-options-calculator';Inputs): number {
...
export function generateAnalysis(inputs: stock-options-calculator';Inputs, metrics: stock-options-calculator';Metrics): stock-options-calculator';Analysis {
