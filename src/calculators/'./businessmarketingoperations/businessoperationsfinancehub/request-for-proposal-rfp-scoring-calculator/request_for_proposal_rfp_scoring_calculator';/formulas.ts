import { request_for_proposal_rfp_scoring_calculator';Inputs, request_for_proposal_rfp_scoring_calculator';Metrics, request_for_proposal_rfp_scoring_calculator';Analysis } from './types';
...
export function calculateResult(inputs: request_for_proposal_rfp_scoring_calculator';Inputs): number {
...
export function generateAnalysis(inputs: request_for_proposal_rfp_scoring_calculator';Inputs, metrics: request_for_proposal_rfp_scoring_calculator';Metrics): request_for_proposal_rfp_scoring_calculator';Analysis {
