import { request-for-proposal-rfp-scoring-calculator';Inputs, request-for-proposal-rfp-scoring-calculator';Metrics, request-for-proposal-rfp-scoring-calculator';Analysis } from './types';
...
export function calculateResult(inputs: request-for-proposal-rfp-scoring-calculator';Inputs): number {
...
export function generateAnalysis(inputs: request-for-proposal-rfp-scoring-calculator';Inputs, metrics: request-for-proposal-rfp-scoring-calculator';Metrics): request-for-proposal-rfp-scoring-calculator';Analysis {
