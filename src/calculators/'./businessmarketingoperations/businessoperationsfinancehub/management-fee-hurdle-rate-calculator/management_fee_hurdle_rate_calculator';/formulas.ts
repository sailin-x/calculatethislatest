import { management_fee_hurdle_rate_calculator';Inputs, management_fee_hurdle_rate_calculator';Metrics, management_fee_hurdle_rate_calculator';Analysis } from './types';
...
export function calculateResult(inputs: management_fee_hurdle_rate_calculator';Inputs): number {
...
export function generateAnalysis(inputs: management_fee_hurdle_rate_calculator';Inputs, metrics: management_fee_hurdle_rate_calculator';Metrics): management_fee_hurdle_rate_calculator';Analysis {
