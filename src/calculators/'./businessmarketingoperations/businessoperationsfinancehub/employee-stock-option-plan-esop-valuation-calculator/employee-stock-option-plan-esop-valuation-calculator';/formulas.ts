import { employee-stock-option-plan-esop-valuation-calculator';Inputs, employee-stock-option-plan-esop-valuation-calculator';Metrics, employee-stock-option-plan-esop-valuation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: employee-stock-option-plan-esop-valuation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: employee-stock-option-plan-esop-valuation-calculator';Inputs, metrics: employee-stock-option-plan-esop-valuation-calculator';Metrics): employee-stock-option-plan-esop-valuation-calculator';Analysis {
