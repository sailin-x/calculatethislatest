import { employee_stock_option_plan_esop_valuation_calculator';Inputs, employee_stock_option_plan_esop_valuation_calculator';Metrics, employee_stock_option_plan_esop_valuation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: employee_stock_option_plan_esop_valuation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: employee_stock_option_plan_esop_valuation_calculator';Inputs, metrics: employee_stock_option_plan_esop_valuation_calculator';Metrics): employee_stock_option_plan_esop_valuation_calculator';Analysis {
