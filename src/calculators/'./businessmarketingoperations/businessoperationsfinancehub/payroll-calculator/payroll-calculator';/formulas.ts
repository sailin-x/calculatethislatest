import { payroll-calculator';Inputs, payroll-calculator';Metrics, payroll-calculator';Analysis } from './types';
...
export function calculateResult(inputs: payroll-calculator';Inputs): number {
...
export function generateAnalysis(inputs: payroll-calculator';Inputs, metrics: payroll-calculator';Metrics): payroll-calculator';Analysis {
