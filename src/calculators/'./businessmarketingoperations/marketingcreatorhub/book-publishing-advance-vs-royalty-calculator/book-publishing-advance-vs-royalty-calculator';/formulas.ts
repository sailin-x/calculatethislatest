import { book-publishing-advance-vs-royalty-calculator';Inputs, book-publishing-advance-vs-royalty-calculator';Metrics, book-publishing-advance-vs-royalty-calculator';Analysis } from './types';
...
export function calculateResult(inputs: book-publishing-advance-vs-royalty-calculator';Inputs): number {
...
export function generateAnalysis(inputs: book-publishing-advance-vs-royalty-calculator';Inputs, metrics: book-publishing-advance-vs-royalty-calculator';Metrics): book-publishing-advance-vs-royalty-calculator';Analysis {
