import { patreon-subscription-calculator';Inputs, patreon-subscription-calculator';Metrics, patreon-subscription-calculator';Analysis } from './types';
...
export function calculateResult(inputs: patreon-subscription-calculator';Inputs): number {
...
export function generateAnalysis(inputs: patreon-subscription-calculator';Inputs, metrics: patreon-subscription-calculator';Metrics): patreon-subscription-calculator';Analysis {
