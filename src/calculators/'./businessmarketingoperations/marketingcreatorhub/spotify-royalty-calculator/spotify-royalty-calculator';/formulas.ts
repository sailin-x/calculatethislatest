import { spotify-royalty-calculator';Inputs, spotify-royalty-calculator';Metrics, spotify-royalty-calculator';Analysis } from './types';
...
export function calculateResult(inputs: spotify-royalty-calculator';Inputs): number {
...
export function generateAnalysis(inputs: spotify-royalty-calculator';Inputs, metrics: spotify-royalty-calculator';Metrics): spotify-royalty-calculator';Analysis {
