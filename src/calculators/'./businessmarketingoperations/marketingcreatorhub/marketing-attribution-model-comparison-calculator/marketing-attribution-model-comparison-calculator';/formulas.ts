import { marketing-attribution-model-comparison-calculator';Inputs, marketing-attribution-model-comparison-calculator';Metrics, marketing-attribution-model-comparison-calculator';Analysis } from './types';
...
export function calculateResult(inputs: marketing-attribution-model-comparison-calculator';Inputs): number {
...
export function generateAnalysis(inputs: marketing-attribution-model-comparison-calculator';Inputs, metrics: marketing-attribution-model-comparison-calculator';Metrics): marketing-attribution-model-comparison-calculator';Analysis {
