import { film_slate_financing_roi_calculator';Inputs, film_slate_financing_roi_calculator';Metrics, film_slate_financing_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: film_slate_financing_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: film_slate_financing_roi_calculator';Inputs, metrics: film_slate_financing_roi_calculator';Metrics): film_slate_financing_roi_calculator';Analysis {
