import { streaming-service-subscriber-churn-cost-calculator';Inputs, streaming-service-subscriber-churn-cost-calculator';Metrics, streaming-service-subscriber-churn-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: streaming-service-subscriber-churn-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: streaming-service-subscriber-churn-cost-calculator';Inputs, metrics: streaming-service-subscriber-churn-cost-calculator';Metrics): streaming-service-subscriber-churn-cost-calculator';Analysis {
