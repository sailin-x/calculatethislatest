import { streaming_service_subscriber_churn_cost_calculator';Inputs, streaming_service_subscriber_churn_cost_calculator';Metrics, streaming_service_subscriber_churn_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: streaming_service_subscriber_churn_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: streaming_service_subscriber_churn_cost_calculator';Inputs, metrics: streaming_service_subscriber_churn_cost_calculator';Metrics): streaming_service_subscriber_churn_cost_calculator';Analysis {
