import { event-sponsorship-tier-valuation-calculator';Inputs, event-sponsorship-tier-valuation-calculator';Metrics, event-sponsorship-tier-valuation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: event-sponsorship-tier-valuation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: event-sponsorship-tier-valuation-calculator';Inputs, metrics: event-sponsorship-tier-valuation-calculator';Metrics): event-sponsorship-tier-valuation-calculator';Analysis {
