import { ad-viewability-impact-on-roi-calculator';Inputs, ad-viewability-impact-on-roi-calculator';Metrics, ad-viewability-impact-on-roi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: ad-viewability-impact-on-roi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: ad-viewability-impact-on-roi-calculator';Inputs, metrics: ad-viewability-impact-on-roi-calculator';Metrics): ad-viewability-impact-on-roi-calculator';Analysis {
