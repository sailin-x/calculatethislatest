import { chaturbate-token-calculator';Inputs, chaturbate-token-calculator';Metrics, chaturbate-token-calculator';Analysis } from './types';
...
export function calculateResult(inputs: chaturbate-token-calculator';Inputs): number {
...
export function generateAnalysis(inputs: chaturbate-token-calculator';Inputs, metrics: chaturbate-token-calculator';Metrics): chaturbate-token-calculator';Analysis {
