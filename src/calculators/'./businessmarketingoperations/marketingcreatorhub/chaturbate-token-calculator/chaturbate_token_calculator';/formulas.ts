import { chaturbate_token_calculator';Inputs, chaturbate_token_calculator';Metrics, chaturbate_token_calculator';Analysis } from './types';
...
export function calculateResult(inputs: chaturbate_token_calculator';Inputs): number {
...
export function generateAnalysis(inputs: chaturbate_token_calculator';Inputs, metrics: chaturbate_token_calculator';Metrics): chaturbate_token_calculator';Analysis {
