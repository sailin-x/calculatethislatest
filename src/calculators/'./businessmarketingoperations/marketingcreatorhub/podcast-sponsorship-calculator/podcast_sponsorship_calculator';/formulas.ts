import { podcast_sponsorship_calculator';Inputs, podcast_sponsorship_calculator';Metrics, podcast_sponsorship_calculator';Analysis } from './types';
...
export function calculateResult(inputs: podcast_sponsorship_calculator';Inputs): number {
...
export function generateAnalysis(inputs: podcast_sponsorship_calculator';Inputs, metrics: podcast_sponsorship_calculator';Metrics): podcast_sponsorship_calculator';Analysis {
