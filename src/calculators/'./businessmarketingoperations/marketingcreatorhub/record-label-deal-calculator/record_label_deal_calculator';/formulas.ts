import { record_label_deal_calculator';Inputs, record_label_deal_calculator';Metrics, record_label_deal_calculator';Analysis } from './types';
...
export function calculateResult(inputs: record_label_deal_calculator';Inputs): number {
...
export function generateAnalysis(inputs: record_label_deal_calculator';Inputs, metrics: record_label_deal_calculator';Metrics): record_label_deal_calculator';Analysis {
