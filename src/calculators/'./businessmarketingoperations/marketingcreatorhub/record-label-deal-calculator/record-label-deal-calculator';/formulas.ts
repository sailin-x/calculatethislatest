import { record-label-deal-calculator';Inputs, record-label-deal-calculator';Metrics, record-label-deal-calculator';Analysis } from './types';
...
export function calculateResult(inputs: record-label-deal-calculator';Inputs): number {
...
export function generateAnalysis(inputs: record-label-deal-calculator';Inputs, metrics: record-label-deal-calculator';Metrics): record-label-deal-calculator';Analysis {
