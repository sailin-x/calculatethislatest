import { affiliate_marketing_roi_calculator';Inputs, affiliate_marketing_roi_calculator';Metrics, affiliate_marketing_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: affiliate_marketing_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: affiliate_marketing_roi_calculator';Inputs, metrics: affiliate_marketing_roi_calculator';Metrics): affiliate_marketing_roi_calculator';Analysis {
