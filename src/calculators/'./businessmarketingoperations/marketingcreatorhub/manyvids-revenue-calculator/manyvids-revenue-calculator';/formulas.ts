import { manyvids-revenue-calculator';Inputs, manyvids-revenue-calculator';Metrics, manyvids-revenue-calculator';Analysis } from './types';
...
export function calculateResult(inputs: manyvids-revenue-calculator';Inputs): number {
...
export function generateAnalysis(inputs: manyvids-revenue-calculator';Inputs, metrics: manyvids-revenue-calculator';Metrics): manyvids-revenue-calculator';Analysis {
