import { onlyfans-earnings-calculator';Inputs, onlyfans-earnings-calculator';Metrics, onlyfans-earnings-calculator';Analysis } from './types';
...
export function calculateResult(inputs: onlyfans-earnings-calculator';Inputs): number {
...
export function generateAnalysis(inputs: onlyfans-earnings-calculator';Inputs, metrics: onlyfans-earnings-calculator';Metrics): onlyfans-earnings-calculator';Analysis {
