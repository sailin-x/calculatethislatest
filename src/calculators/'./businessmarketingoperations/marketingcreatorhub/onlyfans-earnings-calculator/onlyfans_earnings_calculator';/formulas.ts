import { onlyfans_earnings_calculator';Inputs, onlyfans_earnings_calculator';Metrics, onlyfans_earnings_calculator';Analysis } from './types';
...
export function calculateResult(inputs: onlyfans_earnings_calculator';Inputs): number {
...
export function generateAnalysis(inputs: onlyfans_earnings_calculator';Inputs, metrics: onlyfans_earnings_calculator';Metrics): onlyfans_earnings_calculator';Analysis {
