import { discord-server-monetization-calculator';Inputs, discord-server-monetization-calculator';Metrics, discord-server-monetization-calculator';Analysis } from './types';
...
export function calculateResult(inputs: discord-server-monetization-calculator';Inputs): number {
...
export function generateAnalysis(inputs: discord-server-monetization-calculator';Inputs, metrics: discord-server-monetization-calculator';Metrics): discord-server-monetization-calculator';Analysis {
