import { film-distribution-waterfall-calculator';Inputs, film-distribution-waterfall-calculator';Metrics, film-distribution-waterfall-calculator';Analysis } from './types';
...
export function calculateResult(inputs: film-distribution-waterfall-calculator';Inputs): number {
...
export function generateAnalysis(inputs: film-distribution-waterfall-calculator';Inputs, metrics: film-distribution-waterfall-calculator';Metrics): film-distribution-waterfall-calculator';Analysis {
