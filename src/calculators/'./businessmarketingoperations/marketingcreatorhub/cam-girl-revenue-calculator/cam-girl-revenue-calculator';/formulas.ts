import { cam-girl-revenue-calculator';Inputs, cam-girl-revenue-calculator';Metrics, cam-girl-revenue-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cam-girl-revenue-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cam-girl-revenue-calculator';Inputs, metrics: cam-girl-revenue-calculator';Metrics): cam-girl-revenue-calculator';Analysis {
