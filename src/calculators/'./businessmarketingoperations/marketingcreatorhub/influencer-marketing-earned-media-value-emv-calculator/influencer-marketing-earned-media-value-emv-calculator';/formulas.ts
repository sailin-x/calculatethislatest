import { influencer-marketing-earned-media-value-emv-calculator';Inputs, influencer-marketing-earned-media-value-emv-calculator';Metrics, influencer-marketing-earned-media-value-emv-calculator';Analysis } from './types';
...
export function calculateResult(inputs: influencer-marketing-earned-media-value-emv-calculator';Inputs): number {
...
export function generateAnalysis(inputs: influencer-marketing-earned-media-value-emv-calculator';Inputs, metrics: influencer-marketing-earned-media-value-emv-calculator';Metrics): influencer-marketing-earned-media-value-emv-calculator';Analysis {
