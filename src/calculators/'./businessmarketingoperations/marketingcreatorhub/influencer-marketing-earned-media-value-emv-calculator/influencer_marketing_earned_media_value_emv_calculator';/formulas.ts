import { influencer_marketing_earned_media_value_emv_calculator';Inputs, influencer_marketing_earned_media_value_emv_calculator';Metrics, influencer_marketing_earned_media_value_emv_calculator';Analysis } from './types';
...
export function calculateResult(inputs: influencer_marketing_earned_media_value_emv_calculator';Inputs): number {
...
export function generateAnalysis(inputs: influencer_marketing_earned_media_value_emv_calculator';Inputs, metrics: influencer_marketing_earned_media_value_emv_calculator';Metrics): influencer_marketing_earned_media_value_emv_calculator';Analysis {
