import { instagram-engagement-rate-calculator';Inputs, instagram-engagement-rate-calculator';Metrics, instagram-engagement-rate-calculator';Analysis } from './types';
...
export function calculateResult(inputs: instagram-engagement-rate-calculator';Inputs): number {
...
export function generateAnalysis(inputs: instagram-engagement-rate-calculator';Inputs, metrics: instagram-engagement-rate-calculator';Metrics): instagram-engagement-rate-calculator';Analysis {
