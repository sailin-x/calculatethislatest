import { customer-segmentation-rfm-model-calculator';Inputs, customer-segmentation-rfm-model-calculator';Metrics, customer-segmentation-rfm-model-calculator';Analysis } from './types';
...
export function calculateResult(inputs: customer-segmentation-rfm-model-calculator';Inputs): number {
...
export function generateAnalysis(inputs: customer-segmentation-rfm-model-calculator';Inputs, metrics: customer-segmentation-rfm-model-calculator';Metrics): customer-segmentation-rfm-model-calculator';Analysis {
