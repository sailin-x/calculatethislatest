import { instagram_influencer_rate_calculator';Inputs, instagram_influencer_rate_calculator';Metrics, instagram_influencer_rate_calculator';Analysis } from './types';
...
export function calculateResult(inputs: instagram_influencer_rate_calculator';Inputs): number {
...
export function generateAnalysis(inputs: instagram_influencer_rate_calculator';Inputs, metrics: instagram_influencer_rate_calculator';Metrics): instagram_influencer_rate_calculator';Analysis {
