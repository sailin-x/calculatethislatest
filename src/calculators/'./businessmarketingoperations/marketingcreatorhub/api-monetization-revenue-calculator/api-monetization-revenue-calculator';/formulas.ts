import { api-monetization-revenue-calculator';Inputs, api-monetization-revenue-calculator';Metrics, api-monetization-revenue-calculator';Analysis } from './types';
...
export function calculateResult(inputs: api-monetization-revenue-calculator';Inputs): number {
...
export function generateAnalysis(inputs: api-monetization-revenue-calculator';Inputs, metrics: api-monetization-revenue-calculator';Metrics): api-monetization-revenue-calculator';Analysis {
