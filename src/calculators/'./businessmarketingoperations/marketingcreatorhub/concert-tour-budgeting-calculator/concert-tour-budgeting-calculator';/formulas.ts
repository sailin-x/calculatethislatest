import { concert-tour-budgeting-calculator';Inputs, concert-tour-budgeting-calculator';Metrics, concert-tour-budgeting-calculator';Analysis } from './types';
...
export function calculateResult(inputs: concert-tour-budgeting-calculator';Inputs): number {
...
export function generateAnalysis(inputs: concert-tour-budgeting-calculator';Inputs, metrics: concert-tour-budgeting-calculator';Metrics): concert-tour-budgeting-calculator';Analysis {
