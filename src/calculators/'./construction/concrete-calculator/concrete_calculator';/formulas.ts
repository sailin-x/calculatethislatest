import { concrete_calculator';Inputs, concrete_calculator';Metrics, concrete_calculator';Analysis } from './types';
...
export function calculateResult(inputs: concrete_calculator';Inputs): number {
...
export function generateAnalysis(inputs: concrete_calculator';Inputs, metrics: concrete_calculator';Metrics): concrete_calculator';Analysis {
