import { concrete-calculator';Inputs, concrete-calculator';Metrics, concrete-calculator';Analysis } from './types';
...
export function calculateResult(inputs: concrete-calculator';Inputs): number {
...
export function generateAnalysis(inputs: concrete-calculator';Inputs, metrics: concrete-calculator';Metrics): concrete-calculator';Analysis {
