import { './construction/concrete/concrete';Inputs } from './types';

export function validateInputs(inputs: './construction/concrete/concrete';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
