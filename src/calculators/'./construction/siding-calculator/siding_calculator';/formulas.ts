import { siding_calculator';Inputs, siding_calculator';Metrics, siding_calculator';Analysis } from './types';
...
export function calculateResult(inputs: siding_calculator';Inputs): number {
...
export function generateAnalysis(inputs: siding_calculator';Inputs, metrics: siding_calculator';Metrics): siding_calculator';Analysis {
