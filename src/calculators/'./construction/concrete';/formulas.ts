import { concrete';Inputs, concrete';Metrics, concrete';Analysis } from './types';
...
export function calculateResult(inputs: concrete';Inputs): number {
...
export function generateAnalysis(inputs: concrete';Inputs, metrics: concrete';Metrics): concrete';Analysis {
