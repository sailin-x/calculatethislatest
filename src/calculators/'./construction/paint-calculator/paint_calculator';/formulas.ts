import { paint_calculator';Inputs, paint_calculator';Metrics, paint_calculator';Analysis } from './types';
...
export function calculateResult(inputs: paint_calculator';Inputs): number {
...
export function generateAnalysis(inputs: paint_calculator';Inputs, metrics: paint_calculator';Metrics): paint_calculator';Analysis {
