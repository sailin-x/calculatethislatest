import { inventory_shrinkage_cost_calculator';Inputs, inventory_shrinkage_cost_calculator';Metrics, inventory_shrinkage_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: inventory_shrinkage_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: inventory_shrinkage_cost_calculator';Inputs, metrics: inventory_shrinkage_cost_calculator';Metrics): inventory_shrinkage_cost_calculator';Analysis {
