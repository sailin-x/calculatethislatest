import { drywall_calculator';Inputs, drywall_calculator';Metrics, drywall_calculator';Analysis } from './types';
...
export function calculateResult(inputs: drywall_calculator';Inputs): number {
...
export function generateAnalysis(inputs: drywall_calculator';Inputs, metrics: drywall_calculator';Metrics): drywall_calculator';Analysis {
