import { roofing_calculator';Inputs, roofing_calculator';Metrics, roofing_calculator';Analysis } from './types';
...
export function calculateResult(inputs: roofing_calculator';Inputs): number {
...
export function generateAnalysis(inputs: roofing_calculator';Inputs, metrics: roofing_calculator';Metrics): roofing_calculator';Analysis {
