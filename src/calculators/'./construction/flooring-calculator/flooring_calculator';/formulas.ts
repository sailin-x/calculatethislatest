import { flooring_calculator';Inputs, flooring_calculator';Metrics, flooring_calculator';Analysis } from './types';
...
export function calculateResult(inputs: flooring_calculator';Inputs): number {
...
export function generateAnalysis(inputs: flooring_calculator';Inputs, metrics: flooring_calculator';Metrics): flooring_calculator';Analysis {
