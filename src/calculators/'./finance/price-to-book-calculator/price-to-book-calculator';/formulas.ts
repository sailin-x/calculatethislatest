import { price-to-book-calculator';Inputs, price-to-book-calculator';Metrics, price-to-book-calculator';Analysis } from './types';
...
export function calculateResult(inputs: price-to-book-calculator';Inputs): number {
...
export function generateAnalysis(inputs: price-to-book-calculator';Inputs, metrics: price-to-book-calculator';Metrics): price-to-book-calculator';Analysis {
