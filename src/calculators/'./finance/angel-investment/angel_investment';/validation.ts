import { './finance/angel-investment/angel_investment';Inputs } from './types';

export function validateInputs(inputs: './finance/angel-investment/angel_investment';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
