import { angel_investment';Inputs, angel_investment';Metrics, angel_investment';Analysis } from './types';
...
export function calculateResult(inputs: angel_investment';Inputs): number {
...
export function generateAnalysis(inputs: angel_investment';Inputs, metrics: angel_investment';Metrics): angel_investment';Analysis {
