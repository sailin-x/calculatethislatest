import { angel-investment';Inputs, angel-investment';Metrics, angel-investment';Analysis } from './types';
...
export function calculateResult(inputs: angel-investment';Inputs): number {
...
export function generateAnalysis(inputs: angel-investment';Inputs, metrics: angel-investment';Metrics): angel-investment';Analysis {
