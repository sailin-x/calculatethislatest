import { './finance/angel-investment/angel-investment';Inputs } from './types';

export function validateInputs(inputs: './finance/angel-investment/angel-investment';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
