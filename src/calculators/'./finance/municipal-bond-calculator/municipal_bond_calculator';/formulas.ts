import { municipal_bond_calculator';Inputs, municipal_bond_calculator';Metrics, municipal_bond_calculator';Analysis } from './types';
...
export function calculateResult(inputs: municipal_bond_calculator';Inputs): number {
...
export function generateAnalysis(inputs: municipal_bond_calculator';Inputs, metrics: municipal_bond_calculator';Metrics): municipal_bond_calculator';Analysis {
