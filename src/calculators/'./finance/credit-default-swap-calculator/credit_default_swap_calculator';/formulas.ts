import { credit_default_swap_calculator';Inputs, credit_default_swap_calculator';Metrics, credit_default_swap_calculator';Analysis } from './types';
...
export function calculateResult(inputs: credit_default_swap_calculator';Inputs): number {
...
export function generateAnalysis(inputs: credit_default_swap_calculator';Inputs, metrics: credit_default_swap_calculator';Metrics): credit_default_swap_calculator';Analysis {
