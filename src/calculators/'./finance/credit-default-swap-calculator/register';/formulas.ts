import { register';Inputs, register';Metrics, register';Analysis } from './types';
...
export function calculateResult(inputs: register';Inputs): number {
...
export function generateAnalysis(inputs: register';Inputs, metrics: register';Metrics): register';Analysis {
