import { CreditDefaultSwapCalculator';Inputs, CreditDefaultSwapCalculator';Metrics, CreditDefaultSwapCalculator';Analysis } from './types';
...
export function calculateResult(inputs: CreditDefaultSwapCalculator';Inputs): number {
...
export function generateAnalysis(inputs: CreditDefaultSwapCalculator';Inputs, metrics: CreditDefaultSwapCalculator';Metrics): CreditDefaultSwapCalculator';Analysis {
