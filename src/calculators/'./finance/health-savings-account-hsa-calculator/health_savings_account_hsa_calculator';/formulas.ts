import { health_savings_account_hsa_calculator';Inputs, health_savings_account_hsa_calculator';Metrics, health_savings_account_hsa_calculator';Analysis } from './types';
...
export function calculateResult(inputs: health_savings_account_hsa_calculator';Inputs): number {
...
export function generateAnalysis(inputs: health_savings_account_hsa_calculator';Inputs, metrics: health_savings_account_hsa_calculator';Metrics): health_savings_account_hsa_calculator';Analysis {
