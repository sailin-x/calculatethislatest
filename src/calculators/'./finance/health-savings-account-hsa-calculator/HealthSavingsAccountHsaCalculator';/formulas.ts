import { HealthSavingsAccountHsaCalculator';Inputs, HealthSavingsAccountHsaCalculator';Metrics, HealthSavingsAccountHsaCalculator';Analysis } from './types';
...
export function calculateResult(inputs: HealthSavingsAccountHsaCalculator';Inputs): number {
...
export function generateAnalysis(inputs: HealthSavingsAccountHsaCalculator';Inputs, metrics: HealthSavingsAccountHsaCalculator';Metrics): HealthSavingsAccountHsaCalculator';Analysis {
