import { net-unrealized-appreciation-nua-tax-calculator';Inputs, net-unrealized-appreciation-nua-tax-calculator';Metrics, net-unrealized-appreciation-nua-tax-calculator';Analysis } from './types';
...
export function calculateResult(inputs: net-unrealized-appreciation-nua-tax-calculator';Inputs): number {
...
export function generateAnalysis(inputs: net-unrealized-appreciation-nua-tax-calculator';Inputs, metrics: net-unrealized-appreciation-nua-tax-calculator';Metrics): net-unrealized-appreciation-nua-tax-calculator';Analysis {
