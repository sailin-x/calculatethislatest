import { executive_deferred_compensation_plan_calculator';Inputs, executive_deferred_compensation_plan_calculator';Metrics, executive_deferred_compensation_plan_calculator';Analysis } from './types';
...
export function calculateResult(inputs: executive_deferred_compensation_plan_calculator';Inputs): number {
...
export function generateAnalysis(inputs: executive_deferred_compensation_plan_calculator';Inputs, metrics: executive_deferred_compensation_plan_calculator';Metrics): executive_deferred_compensation_plan_calculator';Analysis {
