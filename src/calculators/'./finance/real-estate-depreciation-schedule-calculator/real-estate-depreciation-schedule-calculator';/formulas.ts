import { real-estate-depreciation-schedule-calculator';Inputs, real-estate-depreciation-schedule-calculator';Metrics, real-estate-depreciation-schedule-calculator';Analysis } from './types';
...
export function calculateResult(inputs: real-estate-depreciation-schedule-calculator';Inputs): number {
...
export function generateAnalysis(inputs: real-estate-depreciation-schedule-calculator';Inputs, metrics: real-estate-depreciation-schedule-calculator';Metrics): real-estate-depreciation-schedule-calculator';Analysis {
