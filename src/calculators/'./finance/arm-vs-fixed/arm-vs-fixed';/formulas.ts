import { arm-vs-fixed';Inputs, arm-vs-fixed';Metrics, arm-vs-fixed';Analysis } from './types';
...
export function calculateResult(inputs: arm-vs-fixed';Inputs): number {
...
export function generateAnalysis(inputs: arm-vs-fixed';Inputs, metrics: arm-vs-fixed';Metrics): arm-vs-fixed';Analysis {
