import { './finance/arm-vs-fixed/arm-vs-fixed';Inputs } from './types';

export function validateInputs(inputs: './finance/arm-vs-fixed/arm-vs-fixed';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
