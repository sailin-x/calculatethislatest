import { arm_vs_fixed';Inputs, arm_vs_fixed';Metrics, arm_vs_fixed';Analysis } from './types';
...
export function calculateResult(inputs: arm_vs_fixed';Inputs): number {
...
export function generateAnalysis(inputs: arm_vs_fixed';Inputs, metrics: arm_vs_fixed';Metrics): arm_vs_fixed';Analysis {
