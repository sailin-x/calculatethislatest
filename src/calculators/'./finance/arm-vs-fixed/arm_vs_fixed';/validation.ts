import { './finance/arm-vs-fixed/arm_vs_fixed';Inputs } from './types';

export function validateInputs(inputs: './finance/arm-vs-fixed/arm_vs_fixed';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
