import { './finance/reit-calculator/reit-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/reit-calculator/reit-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
