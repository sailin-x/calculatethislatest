import { reit-calculator';Inputs, reit-calculator';Metrics, reit-calculator';Analysis } from './types';
...
export function calculateResult(inputs: reit-calculator';Inputs): number {
...
export function generateAnalysis(inputs: reit-calculator';Inputs, metrics: reit-calculator';Metrics): reit-calculator';Analysis {
