import { './finance/reit-calculator/reit_calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/reit-calculator/reit_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
