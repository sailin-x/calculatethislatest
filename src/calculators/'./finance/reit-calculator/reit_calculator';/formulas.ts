import { reit_calculator';Inputs, reit_calculator';Metrics, reit_calculator';Analysis } from './types';
...
export function calculateResult(inputs: reit_calculator';Inputs): number {
...
export function generateAnalysis(inputs: reit_calculator';Inputs, metrics: reit_calculator';Metrics): reit_calculator';Analysis {
