import { landlord_insurance';Inputs, landlord_insurance';Metrics, landlord_insurance';Analysis } from './types';
...
export function calculateResult(inputs: landlord_insurance';Inputs): number {
...
export function generateAnalysis(inputs: landlord_insurance';Inputs, metrics: landlord_insurance';Metrics): landlord_insurance';Analysis {
