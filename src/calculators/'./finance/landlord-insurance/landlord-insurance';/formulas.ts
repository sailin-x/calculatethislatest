import { landlord-insurance';Inputs, landlord-insurance';Metrics, landlord-insurance';Analysis } from './types';
...
export function calculateResult(inputs: landlord-insurance';Inputs): number {
...
export function generateAnalysis(inputs: landlord-insurance';Inputs, metrics: landlord-insurance';Metrics): landlord-insurance';Analysis {
