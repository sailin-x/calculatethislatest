import { './finance/estate-planning-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/estate-planning-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
