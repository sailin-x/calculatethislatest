import { market-cap-calculator';Inputs, market-cap-calculator';Metrics, market-cap-calculator';Analysis } from './types';
...
export function calculateResult(inputs: market-cap-calculator';Inputs): number {
...
export function generateAnalysis(inputs: market-cap-calculator';Inputs, metrics: market-cap-calculator';Metrics): market-cap-calculator';Analysis {
