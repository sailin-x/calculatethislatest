import { stock_options_valuation_calculator';Inputs, stock_options_valuation_calculator';Metrics, stock_options_valuation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: stock_options_valuation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: stock_options_valuation_calculator';Inputs, metrics: stock_options_valuation_calculator';Metrics): stock_options_valuation_calculator';Analysis {
