import { credit-card-calculator';Inputs, credit-card-calculator';Metrics, credit-card-calculator';Analysis } from './types';
...
export function calculateResult(inputs: credit-card-calculator';Inputs): number {
...
export function generateAnalysis(inputs: credit-card-calculator';Inputs, metrics: credit-card-calculator';Metrics): credit-card-calculator';Analysis {
