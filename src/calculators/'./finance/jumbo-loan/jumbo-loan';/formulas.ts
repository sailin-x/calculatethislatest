import { jumbo-loan';Inputs, jumbo-loan';Metrics, jumbo-loan';Analysis } from './types';
...
export function calculateResult(inputs: jumbo-loan';Inputs): number {
...
export function generateAnalysis(inputs: jumbo-loan';Inputs, metrics: jumbo-loan';Metrics): jumbo-loan';Analysis {
