import { jumbo_loan';Inputs, jumbo_loan';Metrics, jumbo_loan';Analysis } from './types';
...
export function calculateResult(inputs: jumbo_loan';Inputs): number {
...
export function generateAnalysis(inputs: jumbo_loan';Inputs, metrics: jumbo_loan';Metrics): jumbo_loan';Analysis {
