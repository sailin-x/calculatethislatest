import { title_insurance_calculator';Inputs, title_insurance_calculator';Metrics, title_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: title_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: title_insurance_calculator';Inputs, metrics: title_insurance_calculator';Metrics): title_insurance_calculator';Analysis {
