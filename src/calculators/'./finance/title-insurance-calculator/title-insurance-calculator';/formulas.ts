import { title-insurance-calculator';Inputs, title-insurance-calculator';Metrics, title-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: title-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: title-insurance-calculator';Inputs, metrics: title-insurance-calculator';Metrics): title-insurance-calculator';Analysis {
