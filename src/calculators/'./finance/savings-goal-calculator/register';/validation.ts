import { './finance/savings-goal-calculator/register';Inputs } from './types';

export function validateInputs(inputs: './finance/savings-goal-calculator/register';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
