import { savings_goal_calculator';Inputs, savings_goal_calculator';Metrics, savings_goal_calculator';Analysis } from './types';
...
export function calculateResult(inputs: savings_goal_calculator';Inputs): number {
...
export function generateAnalysis(inputs: savings_goal_calculator';Inputs, metrics: savings_goal_calculator';Metrics): savings_goal_calculator';Analysis {
