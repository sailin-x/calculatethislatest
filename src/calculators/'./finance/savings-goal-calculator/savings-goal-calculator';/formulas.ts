import { savings-goal-calculator';Inputs, savings-goal-calculator';Metrics, savings-goal-calculator';Analysis } from './types';
...
export function calculateResult(inputs: savings-goal-calculator';Inputs): number {
...
export function generateAnalysis(inputs: savings-goal-calculator';Inputs, metrics: savings-goal-calculator';Metrics): savings-goal-calculator';Analysis {
