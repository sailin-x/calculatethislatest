import { GenerationSkippingTransferGstTaxCalculator';Inputs, GenerationSkippingTransferGstTaxCalculator';Metrics, GenerationSkippingTransferGstTaxCalculator';Analysis } from './types';
...
export function calculateResult(inputs: GenerationSkippingTransferGstTaxCalculator';Inputs): number {
...
export function generateAnalysis(inputs: GenerationSkippingTransferGstTaxCalculator';Inputs, metrics: GenerationSkippingTransferGstTaxCalculator';Metrics): GenerationSkippingTransferGstTaxCalculator';Analysis {
