import { 529-college-savings-plan';Inputs, 529-college-savings-plan';Metrics, 529-college-savings-plan';Analysis } from './types';
...
export function calculateResult(inputs: 529-college-savings-plan';Inputs): number {
...
export function generateAnalysis(inputs: 529-college-savings-plan';Inputs, metrics: 529-college-savings-plan';Metrics): 529-college-savings-plan';Analysis {
