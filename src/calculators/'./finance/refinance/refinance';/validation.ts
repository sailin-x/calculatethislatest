import { './finance/refinance/refinance';Inputs } from './types';

export function validateInputs(inputs: './finance/refinance/refinance';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
