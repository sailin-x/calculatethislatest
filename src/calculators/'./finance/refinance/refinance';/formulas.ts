import { refinance';Inputs, refinance';Metrics, refinance';Analysis } from './types';
...
export function calculateResult(inputs: refinance';Inputs): number {
...
export function generateAnalysis(inputs: refinance';Inputs, metrics: refinance';Metrics): refinance';Analysis {
