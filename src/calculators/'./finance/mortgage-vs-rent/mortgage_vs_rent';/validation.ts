import { './finance/mortgage-vs-rent/mortgage_vs_rent';Inputs } from './types';

export function validateInputs(inputs: './finance/mortgage-vs-rent/mortgage_vs_rent';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
