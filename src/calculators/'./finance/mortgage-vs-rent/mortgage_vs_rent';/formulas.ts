import { mortgage_vs_rent';Inputs, mortgage_vs_rent';Metrics, mortgage_vs_rent';Analysis } from './types';
...
export function calculateResult(inputs: mortgage_vs_rent';Inputs): number {
...
export function generateAnalysis(inputs: mortgage_vs_rent';Inputs, metrics: mortgage_vs_rent';Metrics): mortgage_vs_rent';Analysis {
