import { './finance/mortgage-vs-rent/mortgage-vs-rent';Inputs } from './types';

export function validateInputs(inputs: './finance/mortgage-vs-rent/mortgage-vs-rent';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
