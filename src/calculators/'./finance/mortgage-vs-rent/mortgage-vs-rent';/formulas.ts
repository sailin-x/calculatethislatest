import { mortgage-vs-rent';Inputs, mortgage-vs-rent';Metrics, mortgage-vs-rent';Analysis } from './types';
...
export function calculateResult(inputs: mortgage-vs-rent';Inputs): number {
...
export function generateAnalysis(inputs: mortgage-vs-rent';Inputs, metrics: mortgage-vs-rent';Metrics): mortgage-vs-rent';Analysis {
