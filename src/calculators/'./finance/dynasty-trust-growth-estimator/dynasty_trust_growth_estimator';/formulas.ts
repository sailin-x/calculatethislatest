import { dynasty_trust_growth_estimator';Inputs, dynasty_trust_growth_estimator';Metrics, dynasty_trust_growth_estimator';Analysis } from './types';
...
export function calculateResult(inputs: dynasty_trust_growth_estimator';Inputs): number {
...
export function generateAnalysis(inputs: dynasty_trust_growth_estimator';Inputs, metrics: dynasty_trust_growth_estimator';Metrics): dynasty_trust_growth_estimator';Analysis {
