import { compound-annual-growth-rate-cagr-calculator';Inputs, compound-annual-growth-rate-cagr-calculator';Metrics, compound-annual-growth-rate-cagr-calculator';Analysis } from './types';
...
export function calculateResult(inputs: compound-annual-growth-rate-cagr-calculator';Inputs): number {
...
export function generateAnalysis(inputs: compound-annual-growth-rate-cagr-calculator';Inputs, metrics: compound-annual-growth-rate-cagr-calculator';Metrics): compound-annual-growth-rate-cagr-calculator';Analysis {
