import { budget-planner-calculator';Inputs, budget-planner-calculator';Metrics, budget-planner-calculator';Analysis } from './types';
...
export function calculateResult(inputs: budget-planner-calculator';Inputs): number {
...
export function generateAnalysis(inputs: budget-planner-calculator';Inputs, metrics: budget-planner-calculator';Metrics): budget-planner-calculator';Analysis {
