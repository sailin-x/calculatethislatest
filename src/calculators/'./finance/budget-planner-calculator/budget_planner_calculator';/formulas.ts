import { budget_planner_calculator';Inputs, budget_planner_calculator';Metrics, budget_planner_calculator';Analysis } from './types';
...
export function calculateResult(inputs: budget_planner_calculator';Inputs): number {
...
export function generateAnalysis(inputs: budget_planner_calculator';Inputs, metrics: budget_planner_calculator';Metrics): budget_planner_calculator';Analysis {
