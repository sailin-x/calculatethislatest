import { operating-margin-calculator';Inputs, operating-margin-calculator';Metrics, operating-margin-calculator';Analysis } from './types';
...
export function calculateResult(inputs: operating-margin-calculator';Inputs): number {
...
export function generateAnalysis(inputs: operating-margin-calculator';Inputs, metrics: operating-margin-calculator';Metrics): operating-margin-calculator';Analysis {
