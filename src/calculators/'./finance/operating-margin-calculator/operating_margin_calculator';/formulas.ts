import { operating_margin_calculator';Inputs, operating_margin_calculator';Metrics, operating_margin_calculator';Analysis } from './types';
...
export function calculateResult(inputs: operating_margin_calculator';Inputs): number {
...
export function generateAnalysis(inputs: operating_margin_calculator';Inputs, metrics: operating_margin_calculator';Metrics): operating_margin_calculator';Analysis {
