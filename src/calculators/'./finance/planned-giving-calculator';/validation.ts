import { './finance/planned-giving-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/planned-giving-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
