import { mega_backdoor_roth_calculator';Inputs, mega_backdoor_roth_calculator';Metrics, mega_backdoor_roth_calculator';Analysis } from './types';
...
export function calculateResult(inputs: mega_backdoor_roth_calculator';Inputs): number {
...
export function generateAnalysis(inputs: mega_backdoor_roth_calculator';Inputs, metrics: mega_backdoor_roth_calculator';Metrics): mega_backdoor_roth_calculator';Analysis {
