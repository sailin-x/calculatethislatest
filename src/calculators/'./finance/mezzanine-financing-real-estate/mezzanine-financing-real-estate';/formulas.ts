import { mezzanine-financing-real-estate';Inputs, mezzanine-financing-real-estate';Metrics, mezzanine-financing-real-estate';Analysis } from './types';
...
export function calculateResult(inputs: mezzanine-financing-real-estate';Inputs): number {
...
export function generateAnalysis(inputs: mezzanine-financing-real-estate';Inputs, metrics: mezzanine-financing-real-estate';Metrics): mezzanine-financing-real-estate';Analysis {
