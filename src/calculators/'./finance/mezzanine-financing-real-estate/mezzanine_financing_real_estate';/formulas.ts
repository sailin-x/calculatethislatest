import { mezzanine_financing_real_estate';Inputs, mezzanine_financing_real_estate';Metrics, mezzanine_financing_real_estate';Analysis } from './types';
...
export function calculateResult(inputs: mezzanine_financing_real_estate';Inputs): number {
...
export function generateAnalysis(inputs: mezzanine_financing_real_estate';Inputs, metrics: mezzanine_financing_real_estate';Metrics): mezzanine_financing_real_estate';Analysis {
