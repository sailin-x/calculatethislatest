import { mortgage_calculator';Inputs, mortgage_calculator';Metrics, mortgage_calculator';Analysis } from './types';
...
export function calculateResult(inputs: mortgage_calculator';Inputs): number {
...
export function generateAnalysis(inputs: mortgage_calculator';Inputs, metrics: mortgage_calculator';Metrics): mortgage_calculator';Analysis {
