import { ebitda-calculator';Inputs, ebitda-calculator';Metrics, ebitda-calculator';Analysis } from './types';
...
export function calculateResult(inputs: ebitda-calculator';Inputs): number {
...
export function generateAnalysis(inputs: ebitda-calculator';Inputs, metrics: ebitda-calculator';Metrics): ebitda-calculator';Analysis {
