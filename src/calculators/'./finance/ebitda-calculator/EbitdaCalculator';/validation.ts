import { './finance/ebitda-calculator/EbitdaCalculator';Inputs } from './types';

export function validateInputs(inputs: './finance/ebitda-calculator/EbitdaCalculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
