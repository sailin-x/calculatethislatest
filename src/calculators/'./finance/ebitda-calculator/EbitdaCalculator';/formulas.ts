import { EbitdaCalculator';Inputs, EbitdaCalculator';Metrics, EbitdaCalculator';Analysis } from './types';
...
export function calculateResult(inputs: EbitdaCalculator';Inputs): number {
...
export function generateAnalysis(inputs: EbitdaCalculator';Inputs, metrics: EbitdaCalculator';Metrics): EbitdaCalculator';Analysis {
