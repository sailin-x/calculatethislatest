import { ebitda_calculator';Inputs, ebitda_calculator';Metrics, ebitda_calculator';Analysis } from './types';
...
export function calculateResult(inputs: ebitda_calculator';Inputs): number {
...
export function generateAnalysis(inputs: ebitda_calculator';Inputs, metrics: ebitda_calculator';Metrics): ebitda_calculator';Analysis {
