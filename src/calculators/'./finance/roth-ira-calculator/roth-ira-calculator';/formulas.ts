import { roth-ira-calculator';Inputs, roth-ira-calculator';Metrics, roth-ira-calculator';Analysis } from './types';
...
export function calculateResult(inputs: roth-ira-calculator';Inputs): number {
...
export function generateAnalysis(inputs: roth-ira-calculator';Inputs, metrics: roth-ira-calculator';Metrics): roth-ira-calculator';Analysis {
