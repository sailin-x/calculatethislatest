import { executive-deferred-compensation-plan-calculator';Inputs, executive-deferred-compensation-plan-calculator';Metrics, executive-deferred-compensation-plan-calculator';Analysis } from './types';
...
export function calculateResult(inputs: executive-deferred-compensation-plan-calculator';Inputs): number {
...
export function generateAnalysis(inputs: executive-deferred-compensation-plan-calculator';Inputs, metrics: executive-deferred-compensation-plan-calculator';Metrics): executive-deferred-compensation-plan-calculator';Analysis {
