import { generation-skipping-transfer-tax-calculator';Inputs, generation-skipping-transfer-tax-calculator';Metrics, generation-skipping-transfer-tax-calculator';Analysis } from './types';
...
export function calculateResult(inputs: generation-skipping-transfer-tax-calculator';Inputs): number {
...
export function generateAnalysis(inputs: generation-skipping-transfer-tax-calculator';Inputs, metrics: generation-skipping-transfer-tax-calculator';Metrics): generation-skipping-transfer-tax-calculator';Analysis {
