import { generation_skipping_transfer_tax_calculator';Inputs, generation_skipping_transfer_tax_calculator';Metrics, generation_skipping_transfer_tax_calculator';Analysis } from './types';
...
export function calculateResult(inputs: generation_skipping_transfer_tax_calculator';Inputs): number {
...
export function generateAnalysis(inputs: generation_skipping_transfer_tax_calculator';Inputs, metrics: generation_skipping_transfer_tax_calculator';Metrics): generation_skipping_transfer_tax_calculator';Analysis {
