import { financial_governance_calculator';Inputs, financial_governance_calculator';Metrics, financial_governance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_governance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_governance_calculator';Inputs, metrics: financial_governance_calculator';Metrics): financial_governance_calculator';Analysis {
