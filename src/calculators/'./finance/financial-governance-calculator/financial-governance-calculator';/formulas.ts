import { financial-governance-calculator';Inputs, financial-governance-calculator';Metrics, financial-governance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-governance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-governance-calculator';Inputs, metrics: financial-governance-calculator';Metrics): financial-governance-calculator';Analysis {
