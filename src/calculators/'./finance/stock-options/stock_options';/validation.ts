import { './finance/stock-options/stock_options';Inputs } from './types';

export function validateInputs(inputs: './finance/stock-options/stock_options';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
