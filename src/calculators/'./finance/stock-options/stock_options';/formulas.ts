import { stock_options';Inputs, stock_options';Metrics, stock_options';Analysis } from './types';
...
export function calculateResult(inputs: stock_options';Inputs): number {
...
export function generateAnalysis(inputs: stock_options';Inputs, metrics: stock_options';Metrics): stock_options';Analysis {
