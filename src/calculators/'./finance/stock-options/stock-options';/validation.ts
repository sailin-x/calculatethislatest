import { './finance/stock-options/stock-options';Inputs } from './types';

export function validateInputs(inputs: './finance/stock-options/stock-options';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
