import { stock-options';Inputs, stock-options';Metrics, stock-options';Analysis } from './types';
...
export function calculateResult(inputs: stock-options';Inputs): number {
...
export function generateAnalysis(inputs: stock-options';Inputs, metrics: stock-options';Metrics): stock-options';Analysis {
