import { debt-consolidation-calculator';Inputs, debt-consolidation-calculator';Metrics, debt-consolidation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: debt-consolidation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: debt-consolidation-calculator';Inputs, metrics: debt-consolidation-calculator';Metrics): debt-consolidation-calculator';Analysis {
