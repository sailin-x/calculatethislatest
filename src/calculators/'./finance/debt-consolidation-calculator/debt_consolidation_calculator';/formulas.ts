import { debt_consolidation_calculator';Inputs, debt_consolidation_calculator';Metrics, debt_consolidation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: debt_consolidation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: debt_consolidation_calculator';Inputs, metrics: debt_consolidation_calculator';Metrics): debt_consolidation_calculator';Analysis {
