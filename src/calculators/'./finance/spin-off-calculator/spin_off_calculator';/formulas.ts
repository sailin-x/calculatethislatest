import { spin_off_calculator';Inputs, spin_off_calculator';Metrics, spin_off_calculator';Analysis } from './types';
...
export function calculateResult(inputs: spin_off_calculator';Inputs): number {
...
export function generateAnalysis(inputs: spin_off_calculator';Inputs, metrics: spin_off_calculator';Metrics): spin_off_calculator';Analysis {
