import { spin-off-calculator';Inputs, spin-off-calculator';Metrics, spin-off-calculator';Analysis } from './types';
...
export function calculateResult(inputs: spin-off-calculator';Inputs): number {
...
export function generateAnalysis(inputs: spin-off-calculator';Inputs, metrics: spin-off-calculator';Metrics): spin-off-calculator';Analysis {
