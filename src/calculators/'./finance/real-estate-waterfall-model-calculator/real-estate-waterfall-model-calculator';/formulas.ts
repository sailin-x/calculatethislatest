import { real-estate-waterfall-model-calculator';Inputs, real-estate-waterfall-model-calculator';Metrics, real-estate-waterfall-model-calculator';Analysis } from './types';
...
export function calculateResult(inputs: real-estate-waterfall-model-calculator';Inputs): number {
...
export function generateAnalysis(inputs: real-estate-waterfall-model-calculator';Inputs, metrics: real-estate-waterfall-model-calculator';Metrics): real-estate-waterfall-model-calculator';Analysis {
