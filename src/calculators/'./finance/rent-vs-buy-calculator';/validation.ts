import { './finance/rent-vs-buy-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/rent-vs-buy-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
