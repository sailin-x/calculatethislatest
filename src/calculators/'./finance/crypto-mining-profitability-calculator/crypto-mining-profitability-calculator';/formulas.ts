import { crypto-mining-profitability-calculator';Inputs, crypto-mining-profitability-calculator';Metrics, crypto-mining-profitability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: crypto-mining-profitability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: crypto-mining-profitability-calculator';Inputs, metrics: crypto-mining-profitability-calculator';Metrics): crypto-mining-profitability-calculator';Analysis {
