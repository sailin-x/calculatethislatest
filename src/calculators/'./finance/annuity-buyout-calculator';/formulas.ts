import { annuity-buyout-calculator';Inputs, annuity-buyout-calculator';Metrics, annuity-buyout-calculator';Analysis } from './types';
...
export function calculateResult(inputs: annuity-buyout-calculator';Inputs): number {
...
export function generateAnalysis(inputs: annuity-buyout-calculator';Inputs, metrics: annuity-buyout-calculator';Metrics): annuity-buyout-calculator';Analysis {
