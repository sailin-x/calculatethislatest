import { './finance/annuity-buyout-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/annuity-buyout-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
