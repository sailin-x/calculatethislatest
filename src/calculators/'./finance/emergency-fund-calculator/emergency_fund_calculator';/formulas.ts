import { emergency_fund_calculator';Inputs, emergency_fund_calculator';Metrics, emergency_fund_calculator';Analysis } from './types';
...
export function calculateResult(inputs: emergency_fund_calculator';Inputs): number {
...
export function generateAnalysis(inputs: emergency_fund_calculator';Inputs, metrics: emergency_fund_calculator';Metrics): emergency_fund_calculator';Analysis {
