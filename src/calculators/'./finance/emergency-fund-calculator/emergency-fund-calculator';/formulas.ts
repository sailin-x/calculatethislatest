import { emergency-fund-calculator';Inputs, emergency-fund-calculator';Metrics, emergency-fund-calculator';Analysis } from './types';
...
export function calculateResult(inputs: emergency-fund-calculator';Inputs): number {
...
export function generateAnalysis(inputs: emergency-fund-calculator';Inputs, metrics: emergency-fund-calculator';Metrics): emergency-fund-calculator';Analysis {
