import { ground-lease-valuation';Inputs, ground-lease-valuation';Metrics, ground-lease-valuation';Analysis } from './types';
...
export function calculateResult(inputs: ground-lease-valuation';Inputs): number {
...
export function generateAnalysis(inputs: ground-lease-valuation';Inputs, metrics: ground-lease-valuation';Metrics): ground-lease-valuation';Analysis {
