import { ground_lease_valuation';Inputs, ground_lease_valuation';Metrics, ground_lease_valuation';Analysis } from './types';
...
export function calculateResult(inputs: ground_lease_valuation';Inputs): number {
...
export function generateAnalysis(inputs: ground_lease_valuation';Inputs, metrics: ground_lease_valuation';Metrics): ground_lease_valuation';Analysis {
