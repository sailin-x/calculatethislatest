import { debt_avalanche_calculator';Inputs, debt_avalanche_calculator';Metrics, debt_avalanche_calculator';Analysis } from './types';
...
export function calculateResult(inputs: debt_avalanche_calculator';Inputs): number {
...
export function generateAnalysis(inputs: debt_avalanche_calculator';Inputs, metrics: debt_avalanche_calculator';Metrics): debt_avalanche_calculator';Analysis {
