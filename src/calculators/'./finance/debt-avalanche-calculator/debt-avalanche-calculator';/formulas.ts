import { debt-avalanche-calculator';Inputs, debt-avalanche-calculator';Metrics, debt-avalanche-calculator';Analysis } from './types';
...
export function calculateResult(inputs: debt-avalanche-calculator';Inputs): number {
...
export function generateAnalysis(inputs: debt-avalanche-calculator';Inputs, metrics: debt-avalanche-calculator';Metrics): debt-avalanche-calculator';Analysis {
