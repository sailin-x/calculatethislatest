import { DebtAvalancheCalculator';Inputs, DebtAvalancheCalculator';Metrics, DebtAvalancheCalculator';Analysis } from './types';
...
export function calculateResult(inputs: DebtAvalancheCalculator';Inputs): number {
...
export function generateAnalysis(inputs: DebtAvalancheCalculator';Inputs, metrics: DebtAvalancheCalculator';Metrics): DebtAvalancheCalculator';Analysis {
