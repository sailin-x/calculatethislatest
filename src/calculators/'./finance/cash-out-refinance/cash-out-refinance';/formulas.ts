import { cash-out-refinance';Inputs, cash-out-refinance';Metrics, cash-out-refinance';Analysis } from './types';
...
export function calculateResult(inputs: cash-out-refinance';Inputs): number {
...
export function generateAnalysis(inputs: cash-out-refinance';Inputs, metrics: cash-out-refinance';Metrics): cash-out-refinance';Analysis {
