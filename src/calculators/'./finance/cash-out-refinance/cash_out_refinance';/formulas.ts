import { cash_out_refinance';Inputs, cash_out_refinance';Metrics, cash_out_refinance';Analysis } from './types';
...
export function calculateResult(inputs: cash_out_refinance';Inputs): number {
...
export function generateAnalysis(inputs: cash_out_refinance';Inputs, metrics: cash_out_refinance';Metrics): cash_out_refinance';Analysis {
