import { title_insurance';Inputs, title_insurance';Metrics, title_insurance';Analysis } from './types';
...
export function calculateResult(inputs: title_insurance';Inputs): number {
...
export function generateAnalysis(inputs: title_insurance';Inputs, metrics: title_insurance';Metrics): title_insurance';Analysis {
