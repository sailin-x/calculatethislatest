import { './finance/title-insurance/title_insurance';Inputs } from './types';

export function validateInputs(inputs: './finance/title-insurance/title_insurance';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
