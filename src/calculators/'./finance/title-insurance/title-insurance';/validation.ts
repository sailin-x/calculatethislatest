import { './finance/title-insurance/title-insurance';Inputs } from './types';

export function validateInputs(inputs: './finance/title-insurance/title-insurance';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
