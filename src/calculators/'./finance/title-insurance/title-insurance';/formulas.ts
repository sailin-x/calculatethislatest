import { title-insurance';Inputs, title-insurance';Metrics, title-insurance';Analysis } from './types';
...
export function calculateResult(inputs: title-insurance';Inputs): number {
...
export function generateAnalysis(inputs: title-insurance';Inputs, metrics: title-insurance';Metrics): title-insurance';Analysis {
