import { './finance/mortgage-equity/mortgage-equity';Inputs } from './types';

export function validateInputs(inputs: './finance/mortgage-equity/mortgage-equity';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
