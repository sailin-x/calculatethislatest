import { mortgage-equity';Inputs, mortgage-equity';Metrics, mortgage-equity';Analysis } from './types';
...
export function calculateResult(inputs: mortgage-equity';Inputs): number {
...
export function generateAnalysis(inputs: mortgage-equity';Inputs, metrics: mortgage-equity';Metrics): mortgage-equity';Analysis {
