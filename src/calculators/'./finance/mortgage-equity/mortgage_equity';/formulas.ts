import { mortgage_equity';Inputs, mortgage_equity';Metrics, mortgage_equity';Analysis } from './types';
...
export function calculateResult(inputs: mortgage_equity';Inputs): number {
...
export function generateAnalysis(inputs: mortgage_equity';Inputs, metrics: mortgage_equity';Metrics): mortgage_equity';Analysis {
