import { './finance/mortgage-equity/mortgage_equity';Inputs } from './types';

export function validateInputs(inputs: './finance/mortgage-equity/mortgage_equity';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
