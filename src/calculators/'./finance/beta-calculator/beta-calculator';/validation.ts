import { './finance/beta-calculator/beta-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/beta-calculator/beta-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
