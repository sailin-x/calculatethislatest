import { beta-calculator';Inputs, beta-calculator';Metrics, beta-calculator';Analysis } from './types';
...
export function calculateResult(inputs: beta-calculator';Inputs): number {
...
export function generateAnalysis(inputs: beta-calculator';Inputs, metrics: beta-calculator';Metrics): beta-calculator';Analysis {
