import { './finance/beta-calculator/beta_calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/beta-calculator/beta_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
