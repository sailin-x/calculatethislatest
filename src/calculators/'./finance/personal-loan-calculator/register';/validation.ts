import { './finance/personal-loan-calculator/register';Inputs } from './types';

export function validateInputs(inputs: './finance/personal-loan-calculator/register';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
