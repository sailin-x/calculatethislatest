import { personal_loan_calculator';Inputs, personal_loan_calculator';Metrics, personal_loan_calculator';Analysis } from './types';
...
export function calculateResult(inputs: personal_loan_calculator';Inputs): number {
...
export function generateAnalysis(inputs: personal_loan_calculator';Inputs, metrics: personal_loan_calculator';Metrics): personal_loan_calculator';Analysis {
