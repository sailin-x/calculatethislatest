import { CreditUtilizationCalculator';Inputs, CreditUtilizationCalculator';Metrics, CreditUtilizationCalculator';Analysis } from './types';
...
export function calculateResult(inputs: CreditUtilizationCalculator';Inputs): number {
...
export function generateAnalysis(inputs: CreditUtilizationCalculator';Inputs, metrics: CreditUtilizationCalculator';Metrics): CreditUtilizationCalculator';Analysis {
