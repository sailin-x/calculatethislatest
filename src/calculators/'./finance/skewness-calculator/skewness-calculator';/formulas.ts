import { skewness-calculator';Inputs, skewness-calculator';Metrics, skewness-calculator';Analysis } from './types';
...
export function calculateResult(inputs: skewness-calculator';Inputs): number {
...
export function generateAnalysis(inputs: skewness-calculator';Inputs, metrics: skewness-calculator';Metrics): skewness-calculator';Analysis {
