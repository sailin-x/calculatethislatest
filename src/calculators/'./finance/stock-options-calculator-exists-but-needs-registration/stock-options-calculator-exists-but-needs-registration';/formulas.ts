import { stock-options-calculator-exists-but-needs-registration';Inputs, stock-options-calculator-exists-but-needs-registration';Metrics, stock-options-calculator-exists-but-needs-registration';Analysis } from './types';
...
export function calculateResult(inputs: stock-options-calculator-exists-but-needs-registration';Inputs): number {
...
export function generateAnalysis(inputs: stock-options-calculator-exists-but-needs-registration';Inputs, metrics: stock-options-calculator-exists-but-needs-registration';Metrics): stock-options-calculator-exists-but-needs-registration';Analysis {
