import { health-savings-account-hsa-calculator';Inputs, health-savings-account-hsa-calculator';Metrics, health-savings-account-hsa-calculator';Analysis } from './types';
...
export function calculateResult(inputs: health-savings-account-hsa-calculator';Inputs): number {
...
export function generateAnalysis(inputs: health-savings-account-hsa-calculator';Inputs, metrics: health-savings-account-hsa-calculator';Metrics): health-savings-account-hsa-calculator';Analysis {
