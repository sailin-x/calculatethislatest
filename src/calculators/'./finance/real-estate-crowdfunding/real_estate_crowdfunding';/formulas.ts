import { real_estate_crowdfunding';Inputs, real_estate_crowdfunding';Metrics, real_estate_crowdfunding';Analysis } from './types';
...
export function calculateResult(inputs: real_estate_crowdfunding';Inputs): number {
...
export function generateAnalysis(inputs: real_estate_crowdfunding';Inputs, metrics: real_estate_crowdfunding';Metrics): real_estate_crowdfunding';Analysis {
