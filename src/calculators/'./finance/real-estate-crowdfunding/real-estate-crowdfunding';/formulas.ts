import { real-estate-crowdfunding';Inputs, real-estate-crowdfunding';Metrics, real-estate-crowdfunding';Analysis } from './types';
...
export function calculateResult(inputs: real-estate-crowdfunding';Inputs): number {
...
export function generateAnalysis(inputs: real-estate-crowdfunding';Inputs, metrics: real-estate-crowdfunding';Metrics): real-estate-crowdfunding';Analysis {
