import { fafsa-calculator';Inputs, fafsa-calculator';Metrics, fafsa-calculator';Analysis } from './types';
...
export function calculateResult(inputs: fafsa-calculator';Inputs): number {
...
export function generateAnalysis(inputs: fafsa-calculator';Inputs, metrics: fafsa-calculator';Metrics): fafsa-calculator';Analysis {
