import { price_to_earnings_calculator';Inputs, price_to_earnings_calculator';Metrics, price_to_earnings_calculator';Analysis } from './types';
...
export function calculateResult(inputs: price_to_earnings_calculator';Inputs): number {
...
export function generateAnalysis(inputs: price_to_earnings_calculator';Inputs, metrics: price_to_earnings_calculator';Metrics): price_to_earnings_calculator';Analysis {
