import { blockchain-gas-fee-calculator';Inputs, blockchain-gas-fee-calculator';Metrics, blockchain-gas-fee-calculator';Analysis } from './types';
...
export function calculateResult(inputs: blockchain-gas-fee-calculator';Inputs): number {
...
export function generateAnalysis(inputs: blockchain-gas-fee-calculator';Inputs, metrics: blockchain-gas-fee-calculator';Metrics): blockchain-gas-fee-calculator';Analysis {
