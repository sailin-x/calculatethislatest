import { blockchain_gas_fee_calculator';Inputs, blockchain_gas_fee_calculator';Metrics, blockchain_gas_fee_calculator';Analysis } from './types';
...
export function calculateResult(inputs: blockchain_gas_fee_calculator';Inputs): number {
...
export function generateAnalysis(inputs: blockchain_gas_fee_calculator';Inputs, metrics: blockchain_gas_fee_calculator';Metrics): blockchain_gas_fee_calculator';Analysis {
