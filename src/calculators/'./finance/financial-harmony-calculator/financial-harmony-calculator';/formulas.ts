import { financial-harmony-calculator';Inputs, financial-harmony-calculator';Metrics, financial-harmony-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-harmony-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-harmony-calculator';Inputs, metrics: financial-harmony-calculator';Metrics): financial-harmony-calculator';Analysis {
