import { financial_harmony_calculator';Inputs, financial_harmony_calculator';Metrics, financial_harmony_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_harmony_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_harmony_calculator';Inputs, metrics: financial_harmony_calculator';Metrics): financial_harmony_calculator';Analysis {
