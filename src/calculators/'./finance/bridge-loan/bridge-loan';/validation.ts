import { './finance/bridge-loan/bridge-loan';Inputs } from './types';

export function validateInputs(inputs: './finance/bridge-loan/bridge-loan';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
