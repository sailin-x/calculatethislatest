import { bridge-loan';Inputs, bridge-loan';Metrics, bridge-loan';Analysis } from './types';
...
export function calculateResult(inputs: bridge-loan';Inputs): number {
...
export function generateAnalysis(inputs: bridge-loan';Inputs, metrics: bridge-loan';Metrics): bridge-loan';Analysis {
