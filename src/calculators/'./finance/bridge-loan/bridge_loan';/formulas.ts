import { bridge_loan';Inputs, bridge_loan';Metrics, bridge_loan';Analysis } from './types';
...
export function calculateResult(inputs: bridge_loan';Inputs): number {
...
export function generateAnalysis(inputs: bridge_loan';Inputs, metrics: bridge_loan';Metrics): bridge_loan';Analysis {
