import { './finance/bridge-loan/bridge_loan';Inputs } from './types';

export function validateInputs(inputs: './finance/bridge-loan/bridge_loan';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
