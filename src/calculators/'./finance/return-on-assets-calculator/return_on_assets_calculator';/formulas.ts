import { return_on_assets_calculator';Inputs, return_on_assets_calculator';Metrics, return_on_assets_calculator';Analysis } from './types';
...
export function calculateResult(inputs: return_on_assets_calculator';Inputs): number {
...
export function generateAnalysis(inputs: return_on_assets_calculator';Inputs, metrics: return_on_assets_calculator';Metrics): return_on_assets_calculator';Analysis {
