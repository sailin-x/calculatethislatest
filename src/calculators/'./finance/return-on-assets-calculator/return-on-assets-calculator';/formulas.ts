import { return-on-assets-calculator';Inputs, return-on-assets-calculator';Metrics, return-on-assets-calculator';Analysis } from './types';
...
export function calculateResult(inputs: return-on-assets-calculator';Inputs): number {
...
export function generateAnalysis(inputs: return-on-assets-calculator';Inputs, metrics: return-on-assets-calculator';Metrics): return-on-assets-calculator';Analysis {
