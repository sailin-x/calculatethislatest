import { amortization';Inputs, amortization';Metrics, amortization';Analysis } from './types';
...
export function calculateResult(inputs: amortization';Inputs): number {
...
export function generateAnalysis(inputs: amortization';Inputs, metrics: amortization';Metrics): amortization';Analysis {
