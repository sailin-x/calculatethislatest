import { './finance/amortization/amortization';Inputs } from './types';

export function validateInputs(inputs: './finance/amortization/amortization';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
