import { rental_yield';Inputs, rental_yield';Metrics, rental_yield';Analysis } from './types';
...
export function calculateResult(inputs: rental_yield';Inputs): number {
...
export function generateAnalysis(inputs: rental_yield';Inputs, metrics: rental_yield';Metrics): rental_yield';Analysis {
