import { './finance/rental-yield/rental_yield';Inputs } from './types';

export function validateInputs(inputs: './finance/rental-yield/rental_yield';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
