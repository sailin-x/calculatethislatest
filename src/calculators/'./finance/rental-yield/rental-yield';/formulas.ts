import { rental-yield';Inputs, rental-yield';Metrics, rental-yield';Analysis } from './types';
...
export function calculateResult(inputs: rental-yield';Inputs): number {
...
export function generateAnalysis(inputs: rental-yield';Inputs, metrics: rental-yield';Metrics): rental-yield';Analysis {
