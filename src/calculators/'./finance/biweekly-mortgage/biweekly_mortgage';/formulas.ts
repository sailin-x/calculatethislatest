import { biweekly_mortgage';Inputs, biweekly_mortgage';Metrics, biweekly_mortgage';Analysis } from './types';
...
export function calculateResult(inputs: biweekly_mortgage';Inputs): number {
...
export function generateAnalysis(inputs: biweekly_mortgage';Inputs, metrics: biweekly_mortgage';Metrics): biweekly_mortgage';Analysis {
