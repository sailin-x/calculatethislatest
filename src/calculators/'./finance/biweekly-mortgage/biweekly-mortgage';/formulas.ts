import { biweekly-mortgage';Inputs, biweekly-mortgage';Metrics, biweekly-mortgage';Analysis } from './types';
...
export function calculateResult(inputs: biweekly-mortgage';Inputs): number {
...
export function generateAnalysis(inputs: biweekly-mortgage';Inputs, metrics: biweekly-mortgage';Metrics): biweekly-mortgage';Analysis {
