import { CurrentRatioCalculator';Inputs, CurrentRatioCalculator';Metrics, CurrentRatioCalculator';Analysis } from './types';
...
export function calculateResult(inputs: CurrentRatioCalculator';Inputs): number {
...
export function generateAnalysis(inputs: CurrentRatioCalculator';Inputs, metrics: CurrentRatioCalculator';Metrics): CurrentRatioCalculator';Analysis {
