import { timberland_investment_calculator';Inputs, timberland_investment_calculator';Metrics, timberland_investment_calculator';Analysis } from './types';
...
export function calculateResult(inputs: timberland_investment_calculator';Inputs): number {
...
export function generateAnalysis(inputs: timberland_investment_calculator';Inputs, metrics: timberland_investment_calculator';Metrics): timberland_investment_calculator';Analysis {
