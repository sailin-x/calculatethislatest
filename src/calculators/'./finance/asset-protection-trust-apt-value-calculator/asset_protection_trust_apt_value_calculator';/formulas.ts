import { asset_protection_trust_apt_value_calculator';Inputs, asset_protection_trust_apt_value_calculator';Metrics, asset_protection_trust_apt_value_calculator';Analysis } from './types';
...
export function calculateResult(inputs: asset_protection_trust_apt_value_calculator';Inputs): number {
...
export function generateAnalysis(inputs: asset_protection_trust_apt_value_calculator';Inputs, metrics: asset_protection_trust_apt_value_calculator';Metrics): asset_protection_trust_apt_value_calculator';Analysis {
