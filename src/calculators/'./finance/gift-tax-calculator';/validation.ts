import { './finance/gift-tax-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/gift-tax-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
