import { mezzanine_financing';Inputs, mezzanine_financing';Metrics, mezzanine_financing';Analysis } from './types';
...
export function calculateResult(inputs: mezzanine_financing';Inputs): number {
...
export function generateAnalysis(inputs: mezzanine_financing';Inputs, metrics: mezzanine_financing';Metrics): mezzanine_financing';Analysis {
