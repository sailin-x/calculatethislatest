import { mezzanine-financing';Inputs, mezzanine-financing';Metrics, mezzanine-financing';Analysis } from './types';
...
export function calculateResult(inputs: mezzanine-financing';Inputs): number {
...
export function generateAnalysis(inputs: mezzanine-financing';Inputs, metrics: mezzanine-financing';Metrics): mezzanine-financing';Analysis {
