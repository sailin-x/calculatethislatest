import { price-per-square-foot';Inputs, price-per-square-foot';Metrics, price-per-square-foot';Analysis } from './types';
...
export function calculateResult(inputs: price-per-square-foot';Inputs): number {
...
export function generateAnalysis(inputs: price-per-square-foot';Inputs, metrics: price-per-square-foot';Metrics): price-per-square-foot';Analysis {
