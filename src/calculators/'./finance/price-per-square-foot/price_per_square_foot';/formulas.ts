import { price_per_square_foot';Inputs, price_per_square_foot';Metrics, price_per_square_foot';Analysis } from './types';
...
export function calculateResult(inputs: price_per_square_foot';Inputs): number {
...
export function generateAnalysis(inputs: price_per_square_foot';Inputs, metrics: price_per_square_foot';Metrics): price_per_square_foot';Analysis {
