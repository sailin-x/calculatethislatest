import { gross_rent_multiplier';Inputs, gross_rent_multiplier';Metrics, gross_rent_multiplier';Analysis } from './types';
...
export function calculateResult(inputs: gross_rent_multiplier';Inputs): number {
...
export function generateAnalysis(inputs: gross_rent_multiplier';Inputs, metrics: gross_rent_multiplier';Metrics): gross_rent_multiplier';Analysis {
