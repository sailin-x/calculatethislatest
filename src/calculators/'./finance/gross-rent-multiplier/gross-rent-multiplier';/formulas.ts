import { gross-rent-multiplier';Inputs, gross-rent-multiplier';Metrics, gross-rent-multiplier';Analysis } from './types';
...
export function calculateResult(inputs: gross-rent-multiplier';Inputs): number {
...
export function generateAnalysis(inputs: gross-rent-multiplier';Inputs, metrics: gross-rent-multiplier';Metrics): gross-rent-multiplier';Analysis {
