import { recapitalization_impact_calculator';Inputs, recapitalization_impact_calculator';Metrics, recapitalization_impact_calculator';Analysis } from './types';
...
export function calculateResult(inputs: recapitalization_impact_calculator';Inputs): number {
...
export function generateAnalysis(inputs: recapitalization_impact_calculator';Inputs, metrics: recapitalization_impact_calculator';Metrics): recapitalization_impact_calculator';Analysis {
