import { home_equity_loan';Inputs, home_equity_loan';Metrics, home_equity_loan';Analysis } from './types';
...
export function calculateResult(inputs: home_equity_loan';Inputs): number {
...
export function generateAnalysis(inputs: home_equity_loan';Inputs, metrics: home_equity_loan';Metrics): home_equity_loan';Analysis {
