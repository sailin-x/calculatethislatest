import { './finance/home-equity-loan/home_equity_loan';Inputs } from './types';

export function validateInputs(inputs: './finance/home-equity-loan/home_equity_loan';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
