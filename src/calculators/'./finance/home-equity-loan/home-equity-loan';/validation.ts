import { './finance/home-equity-loan/home-equity-loan';Inputs } from './types';

export function validateInputs(inputs: './finance/home-equity-loan/home-equity-loan';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
