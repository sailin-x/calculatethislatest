import { interest-only-mortgage';Inputs, interest-only-mortgage';Metrics, interest-only-mortgage';Analysis } from './types';
...
export function calculateResult(inputs: interest-only-mortgage';Inputs): number {
...
export function generateAnalysis(inputs: interest-only-mortgage';Inputs, metrics: interest-only-mortgage';Metrics): interest-only-mortgage';Analysis {
