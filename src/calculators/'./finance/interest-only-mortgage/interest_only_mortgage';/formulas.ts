import { interest_only_mortgage';Inputs, interest_only_mortgage';Metrics, interest_only_mortgage';Analysis } from './types';
...
export function calculateResult(inputs: interest_only_mortgage';Inputs): number {
...
export function generateAnalysis(inputs: interest_only_mortgage';Inputs, metrics: interest_only_mortgage';Metrics): interest_only_mortgage';Analysis {
