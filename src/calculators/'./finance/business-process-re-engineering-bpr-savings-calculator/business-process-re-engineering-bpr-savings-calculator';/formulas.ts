import { business-process-re-engineering-bpr-savings-calculator';Inputs, business-process-re-engineering-bpr-savings-calculator';Metrics, business-process-re-engineering-bpr-savings-calculator';Analysis } from './types';
...
export function calculateResult(inputs: business-process-re-engineering-bpr-savings-calculator';Inputs): number {
...
export function generateAnalysis(inputs: business-process-re-engineering-bpr-savings-calculator';Inputs, metrics: business-process-re-engineering-bpr-savings-calculator';Metrics): business-process-re-engineering-bpr-savings-calculator';Analysis {
