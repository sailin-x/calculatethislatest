import { financial-flow-calculator';Inputs, financial-flow-calculator';Metrics, financial-flow-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-flow-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-flow-calculator';Inputs, metrics: financial-flow-calculator';Metrics): financial-flow-calculator';Analysis {
