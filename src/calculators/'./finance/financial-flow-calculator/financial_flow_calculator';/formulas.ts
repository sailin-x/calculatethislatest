import { financial_flow_calculator';Inputs, financial_flow_calculator';Metrics, financial_flow_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_flow_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_flow_calculator';Inputs, metrics: financial_flow_calculator';Metrics): financial_flow_calculator';Analysis {
