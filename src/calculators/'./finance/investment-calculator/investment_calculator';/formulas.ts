import { investment_calculator';Inputs, investment_calculator';Metrics, investment_calculator';Analysis } from './types';
...
export function calculateResult(inputs: investment_calculator';Inputs): number {
...
export function generateAnalysis(inputs: investment_calculator';Inputs, metrics: investment_calculator';Metrics): investment_calculator';Analysis {
