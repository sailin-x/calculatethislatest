import { expected-shortfall-calculator';Inputs, expected-shortfall-calculator';Metrics, expected-shortfall-calculator';Analysis } from './types';
...
export function calculateResult(inputs: expected-shortfall-calculator';Inputs): number {
...
export function generateAnalysis(inputs: expected-shortfall-calculator';Inputs, metrics: expected-shortfall-calculator';Metrics): expected-shortfall-calculator';Analysis {
