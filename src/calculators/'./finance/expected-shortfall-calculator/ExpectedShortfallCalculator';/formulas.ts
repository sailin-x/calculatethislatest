import { ExpectedShortfallCalculator';Inputs, ExpectedShortfallCalculator';Metrics, ExpectedShortfallCalculator';Analysis } from './types';
...
export function calculateResult(inputs: ExpectedShortfallCalculator';Inputs): number {
...
export function generateAnalysis(inputs: ExpectedShortfallCalculator';Inputs, metrics: ExpectedShortfallCalculator';Metrics): ExpectedShortfallCalculator';Analysis {
