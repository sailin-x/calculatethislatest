import { immediate_annuity_payout_calculator';Inputs, immediate_annuity_payout_calculator';Metrics, immediate_annuity_payout_calculator';Analysis } from './types';
...
export function calculateResult(inputs: immediate_annuity_payout_calculator';Inputs): number {
...
export function generateAnalysis(inputs: immediate_annuity_payout_calculator';Inputs, metrics: immediate_annuity_payout_calculator';Metrics): immediate_annuity_payout_calculator';Analysis {
