import { staking-rewards-calculator';Inputs, staking-rewards-calculator';Metrics, staking-rewards-calculator';Analysis } from './types';
...
export function calculateResult(inputs: staking-rewards-calculator';Inputs): number {
...
export function generateAnalysis(inputs: staking-rewards-calculator';Inputs, metrics: staking-rewards-calculator';Metrics): staking-rewards-calculator';Analysis {
