import { commercial-real-estate';Inputs, commercial-real-estate';Metrics, commercial-real-estate';Analysis } from './types';
...
export function calculateResult(inputs: commercial-real-estate';Inputs): number {
...
export function generateAnalysis(inputs: commercial-real-estate';Inputs, metrics: commercial-real-estate';Metrics): commercial-real-estate';Analysis {
