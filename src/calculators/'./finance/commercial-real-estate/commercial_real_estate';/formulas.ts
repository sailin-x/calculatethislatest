import { commercial_real_estate';Inputs, commercial_real_estate';Metrics, commercial_real_estate';Analysis } from './types';
...
export function calculateResult(inputs: commercial_real_estate';Inputs): number {
...
export function generateAnalysis(inputs: commercial_real_estate';Inputs, metrics: commercial_real_estate';Metrics): commercial_real_estate';Analysis {
