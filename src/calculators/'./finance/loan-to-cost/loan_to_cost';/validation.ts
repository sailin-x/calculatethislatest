import { './finance/loan-to-cost/loan_to_cost';Inputs } from './types';

export function validateInputs(inputs: './finance/loan-to-cost/loan_to_cost';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
