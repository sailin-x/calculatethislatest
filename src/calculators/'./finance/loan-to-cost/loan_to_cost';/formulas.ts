import { loan_to_cost';Inputs, loan_to_cost';Metrics, loan_to_cost';Analysis } from './types';
...
export function calculateResult(inputs: loan_to_cost';Inputs): number {
...
export function generateAnalysis(inputs: loan_to_cost';Inputs, metrics: loan_to_cost';Metrics): loan_to_cost';Analysis {
