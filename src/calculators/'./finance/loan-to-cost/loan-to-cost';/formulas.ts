import { loan-to-cost';Inputs, loan-to-cost';Metrics, loan-to-cost';Analysis } from './types';
...
export function calculateResult(inputs: loan-to-cost';Inputs): number {
...
export function generateAnalysis(inputs: loan-to-cost';Inputs, metrics: loan-to-cost';Metrics): loan-to-cost';Analysis {
