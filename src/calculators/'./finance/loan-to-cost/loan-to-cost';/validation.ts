import { './finance/loan-to-cost/loan-to-cost';Inputs } from './types';

export function validateInputs(inputs: './finance/loan-to-cost/loan-to-cost';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
