import { free_cash_flow_to_firm_fcff_valuation';Inputs, free_cash_flow_to_firm_fcff_valuation';Metrics, free_cash_flow_to_firm_fcff_valuation';Analysis } from './types';
...
export function calculateResult(inputs: free_cash_flow_to_firm_fcff_valuation';Inputs): number {
...
export function generateAnalysis(inputs: free_cash_flow_to_firm_fcff_valuation';Inputs, metrics: free_cash_flow_to_firm_fcff_valuation';Metrics): free_cash_flow_to_firm_fcff_valuation';Analysis {
