import { commodities-futures-profitability-calculator';Inputs, commodities-futures-profitability-calculator';Metrics, commodities-futures-profitability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: commodities-futures-profitability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: commodities-futures-profitability-calculator';Inputs, metrics: commodities-futures-profitability-calculator';Metrics): commodities-futures-profitability-calculator';Analysis {
