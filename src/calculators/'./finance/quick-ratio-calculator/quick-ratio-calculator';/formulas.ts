import { quick-ratio-calculator';Inputs, quick-ratio-calculator';Metrics, quick-ratio-calculator';Analysis } from './types';
...
export function calculateResult(inputs: quick-ratio-calculator';Inputs): number {
...
export function generateAnalysis(inputs: quick-ratio-calculator';Inputs, metrics: quick-ratio-calculator';Metrics): quick-ratio-calculator';Analysis {
