import { './finance/balloon-mortgage/balloon-mortgage';Inputs } from './types';

export function validateInputs(inputs: './finance/balloon-mortgage/balloon-mortgage';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
