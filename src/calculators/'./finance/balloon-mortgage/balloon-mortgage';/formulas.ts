import { balloon-mortgage';Inputs, balloon-mortgage';Metrics, balloon-mortgage';Analysis } from './types';
...
export function calculateResult(inputs: balloon-mortgage';Inputs): number {
...
export function generateAnalysis(inputs: balloon-mortgage';Inputs, metrics: balloon-mortgage';Metrics): balloon-mortgage';Analysis {
