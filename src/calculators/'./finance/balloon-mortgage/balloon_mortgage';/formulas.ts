import { balloon_mortgage';Inputs, balloon_mortgage';Metrics, balloon_mortgage';Analysis } from './types';
...
export function calculateResult(inputs: balloon_mortgage';Inputs): number {
...
export function generateAnalysis(inputs: balloon_mortgage';Inputs, metrics: balloon_mortgage';Metrics): balloon_mortgage';Analysis {
