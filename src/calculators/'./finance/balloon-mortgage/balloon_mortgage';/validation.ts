import { './finance/balloon-mortgage/balloon_mortgage';Inputs } from './types';

export function validateInputs(inputs: './finance/balloon-mortgage/balloon_mortgage';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
