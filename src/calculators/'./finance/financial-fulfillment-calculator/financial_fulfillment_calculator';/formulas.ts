import { financial_fulfillment_calculator';Inputs, financial_fulfillment_calculator';Metrics, financial_fulfillment_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_fulfillment_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_fulfillment_calculator';Inputs, metrics: financial_fulfillment_calculator';Metrics): financial_fulfillment_calculator';Analysis {
