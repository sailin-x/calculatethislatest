import { financial-fulfillment-calculator';Inputs, financial-fulfillment-calculator';Metrics, financial-fulfillment-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-fulfillment-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-fulfillment-calculator';Inputs, metrics: financial-fulfillment-calculator';Metrics): financial-fulfillment-calculator';Analysis {
