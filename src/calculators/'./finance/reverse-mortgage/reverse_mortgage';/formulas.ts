import { reverse_mortgage';Inputs, reverse_mortgage';Metrics, reverse_mortgage';Analysis } from './types';
...
export function calculateResult(inputs: reverse_mortgage';Inputs): number {
...
export function generateAnalysis(inputs: reverse_mortgage';Inputs, metrics: reverse_mortgage';Metrics): reverse_mortgage';Analysis {
