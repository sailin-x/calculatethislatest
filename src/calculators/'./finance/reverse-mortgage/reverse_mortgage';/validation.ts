import { './finance/reverse-mortgage/reverse_mortgage';Inputs } from './types';

export function validateInputs(inputs: './finance/reverse-mortgage/reverse_mortgage';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
