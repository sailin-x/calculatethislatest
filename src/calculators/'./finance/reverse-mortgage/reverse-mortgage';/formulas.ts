import { reverse-mortgage';Inputs, reverse-mortgage';Metrics, reverse-mortgage';Analysis } from './types';
...
export function calculateResult(inputs: reverse-mortgage';Inputs): number {
...
export function generateAnalysis(inputs: reverse-mortgage';Inputs, metrics: reverse-mortgage';Metrics): reverse-mortgage';Analysis {
