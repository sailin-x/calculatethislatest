import { convertible-bond-pricing-calculator';Inputs, convertible-bond-pricing-calculator';Metrics, convertible-bond-pricing-calculator';Analysis } from './types';
...
export function calculateResult(inputs: convertible-bond-pricing-calculator';Inputs): number {
...
export function generateAnalysis(inputs: convertible-bond-pricing-calculator';Inputs, metrics: convertible-bond-pricing-calculator';Metrics): convertible-bond-pricing-calculator';Analysis {
