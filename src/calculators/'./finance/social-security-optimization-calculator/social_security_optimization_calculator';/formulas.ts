import { social_security_optimization_calculator';Inputs, social_security_optimization_calculator';Metrics, social_security_optimization_calculator';Analysis } from './types';
...
export function calculateResult(inputs: social_security_optimization_calculator';Inputs): number {
...
export function generateAnalysis(inputs: social_security_optimization_calculator';Inputs, metrics: social_security_optimization_calculator';Metrics): social_security_optimization_calculator';Analysis {
