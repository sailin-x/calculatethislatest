import { irrevocable-life-insurance-trust-ilit-value-calculator';Inputs, irrevocable-life-insurance-trust-ilit-value-calculator';Metrics, irrevocable-life-insurance-trust-ilit-value-calculator';Analysis } from './types';
...
export function calculateResult(inputs: irrevocable-life-insurance-trust-ilit-value-calculator';Inputs): number {
...
export function generateAnalysis(inputs: irrevocable-life-insurance-trust-ilit-value-calculator';Inputs, metrics: irrevocable-life-insurance-trust-ilit-value-calculator';Metrics): irrevocable-life-insurance-trust-ilit-value-calculator';Analysis {
