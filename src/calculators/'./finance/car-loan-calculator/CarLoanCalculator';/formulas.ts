import { CarLoanCalculator';Inputs, CarLoanCalculator';Metrics, CarLoanCalculator';Analysis } from './types';
...
export function calculateResult(inputs: CarLoanCalculator';Inputs): number {
...
export function generateAnalysis(inputs: CarLoanCalculator';Inputs, metrics: CarLoanCalculator';Metrics): CarLoanCalculator';Analysis {
