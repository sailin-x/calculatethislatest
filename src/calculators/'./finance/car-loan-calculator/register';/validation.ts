import { './finance/car-loan-calculator/register';Inputs } from './types';

export function validateInputs(inputs: './finance/car-loan-calculator/register';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
