import { return-on-equity-calculator';Inputs, return-on-equity-calculator';Metrics, return-on-equity-calculator';Analysis } from './types';
...
export function calculateResult(inputs: return-on-equity-calculator';Inputs): number {
...
export function generateAnalysis(inputs: return-on-equity-calculator';Inputs, metrics: return-on-equity-calculator';Metrics): return-on-equity-calculator';Analysis {
