import { 457-plan';Inputs, 457-plan';Metrics, 457-plan';Analysis } from './types';
...
export function calculateResult(inputs: 457-plan';Inputs): number {
...
export function generateAnalysis(inputs: 457-plan';Inputs, metrics: 457-plan';Metrics): 457-plan';Analysis {
