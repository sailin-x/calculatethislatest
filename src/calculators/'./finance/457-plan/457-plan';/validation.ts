import { './finance/457-plan/457-plan';Inputs } from './types';

export function validateInputs(inputs: './finance/457-plan/457-plan';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
