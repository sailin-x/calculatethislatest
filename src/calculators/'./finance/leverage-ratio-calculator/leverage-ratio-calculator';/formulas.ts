import { leverage-ratio-calculator';Inputs, leverage-ratio-calculator';Metrics, leverage-ratio-calculator';Analysis } from './types';
...
export function calculateResult(inputs: leverage-ratio-calculator';Inputs): number {
...
export function generateAnalysis(inputs: leverage-ratio-calculator';Inputs, metrics: leverage-ratio-calculator';Metrics): leverage-ratio-calculator';Analysis {
