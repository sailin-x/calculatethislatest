import { 401k_calculator';Inputs, 401k_calculator';Metrics, 401k_calculator';Analysis } from './types';
...
export function calculateResult(inputs: 401k_calculator';Inputs): number {
...
export function generateAnalysis(inputs: 401k_calculator';Inputs, metrics: 401k_calculator';Metrics): 401k_calculator';Analysis {
