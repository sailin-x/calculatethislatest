import { './finance/401k-calculator/401k-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/401k-calculator/401k-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
