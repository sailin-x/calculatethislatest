import { 401k-calculator';Inputs, 401k-calculator';Metrics, 401k-calculator';Analysis } from './types';
...
export function calculateResult(inputs: 401k-calculator';Inputs): number {
...
export function generateAnalysis(inputs: 401k-calculator';Inputs, metrics: 401k-calculator';Metrics): 401k-calculator';Analysis {
