import { financial-health-calculator';Inputs, financial-health-calculator';Metrics, financial-health-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-health-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-health-calculator';Inputs, metrics: financial-health-calculator';Metrics): financial-health-calculator';Analysis {
