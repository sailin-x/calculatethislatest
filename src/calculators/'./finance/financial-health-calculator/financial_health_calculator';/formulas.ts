import { financial_health_calculator';Inputs, financial_health_calculator';Metrics, financial_health_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_health_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_health_calculator';Inputs, metrics: financial_health_calculator';Metrics): financial_health_calculator';Analysis {
