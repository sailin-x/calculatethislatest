import { tender_offer_valuation_calculator';Inputs, tender_offer_valuation_calculator';Metrics, tender_offer_valuation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: tender_offer_valuation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: tender_offer_valuation_calculator';Inputs, metrics: tender_offer_valuation_calculator';Metrics): tender_offer_valuation_calculator';Analysis {
