import { './finance/fha-loan/fha_loan';Inputs } from './types';

export function validateInputs(inputs: './finance/fha-loan/fha_loan';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
