import { fha_loan';Inputs, fha_loan';Metrics, fha_loan';Analysis } from './types';
...
export function calculateResult(inputs: fha_loan';Inputs): number {
...
export function generateAnalysis(inputs: fha_loan';Inputs, metrics: fha_loan';Metrics): fha_loan';Analysis {
