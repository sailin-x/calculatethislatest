import { fha-loan';Inputs, fha-loan';Metrics, fha-loan';Analysis } from './types';
...
export function calculateResult(inputs: fha-loan';Inputs): number {
...
export function generateAnalysis(inputs: fha-loan';Inputs, metrics: fha-loan';Metrics): fha-loan';Analysis {
