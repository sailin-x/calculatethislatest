import { './finance/fha-loan/fha-loan';Inputs } from './types';

export function validateInputs(inputs: './finance/fha-loan/fha-loan';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
