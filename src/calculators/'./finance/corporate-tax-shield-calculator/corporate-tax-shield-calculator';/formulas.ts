import { corporate-tax-shield-calculator';Inputs, corporate-tax-shield-calculator';Metrics, corporate-tax-shield-calculator';Analysis } from './types';
...
export function calculateResult(inputs: corporate-tax-shield-calculator';Inputs): number {
...
export function generateAnalysis(inputs: corporate-tax-shield-calculator';Inputs, metrics: corporate-tax-shield-calculator';Metrics): corporate-tax-shield-calculator';Analysis {
