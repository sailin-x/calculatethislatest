import { futures-calculator';Inputs, futures-calculator';Metrics, futures-calculator';Analysis } from './types';
...
export function calculateResult(inputs: futures-calculator';Inputs): number {
...
export function generateAnalysis(inputs: futures-calculator';Inputs, metrics: futures-calculator';Metrics): futures-calculator';Analysis {
