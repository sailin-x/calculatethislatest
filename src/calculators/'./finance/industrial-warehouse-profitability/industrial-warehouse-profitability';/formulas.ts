import { industrial-warehouse-profitability';Inputs, industrial-warehouse-profitability';Metrics, industrial-warehouse-profitability';Analysis } from './types';
...
export function calculateResult(inputs: industrial-warehouse-profitability';Inputs): number {
...
export function generateAnalysis(inputs: industrial-warehouse-profitability';Inputs, metrics: industrial-warehouse-profitability';Metrics): industrial-warehouse-profitability';Analysis {
