import { './finance/tax-calculator/tax_calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/tax-calculator/tax_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
