import { tax_calculator';Inputs, tax_calculator';Metrics, tax_calculator';Analysis } from './types';
...
export function calculateResult(inputs: tax_calculator';Inputs): number {
...
export function generateAnalysis(inputs: tax_calculator';Inputs, metrics: tax_calculator';Metrics): tax_calculator';Analysis {
