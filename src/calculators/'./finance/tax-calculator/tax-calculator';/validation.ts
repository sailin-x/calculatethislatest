import { './finance/tax-calculator/tax-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/tax-calculator/tax-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
