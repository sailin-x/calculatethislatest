import { tax-calculator';Inputs, tax-calculator';Metrics, tax-calculator';Analysis } from './types';
...
export function calculateResult(inputs: tax-calculator';Inputs): number {
...
export function generateAnalysis(inputs: tax-calculator';Inputs, metrics: tax-calculator';Metrics): tax-calculator';Analysis {
