import { tenant-improvement';Inputs, tenant-improvement';Metrics, tenant-improvement';Analysis } from './types';
...
export function calculateResult(inputs: tenant-improvement';Inputs): number {
...
export function generateAnalysis(inputs: tenant-improvement';Inputs, metrics: tenant-improvement';Metrics): tenant-improvement';Analysis {
