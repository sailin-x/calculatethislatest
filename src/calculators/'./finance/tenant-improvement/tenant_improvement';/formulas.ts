import { tenant_improvement';Inputs, tenant_improvement';Metrics, tenant_improvement';Analysis } from './types';
...
export function calculateResult(inputs: tenant_improvement';Inputs): number {
...
export function generateAnalysis(inputs: tenant_improvement';Inputs, metrics: tenant_improvement';Metrics): tenant_improvement';Analysis {
