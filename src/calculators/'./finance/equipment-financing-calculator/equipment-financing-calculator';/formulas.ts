import { equipment-financing-calculator';Inputs, equipment-financing-calculator';Metrics, equipment-financing-calculator';Analysis } from './types';
...
export function calculateResult(inputs: equipment-financing-calculator';Inputs): number {
...
export function generateAnalysis(inputs: equipment-financing-calculator';Inputs, metrics: equipment-financing-calculator';Metrics): equipment-financing-calculator';Analysis {
