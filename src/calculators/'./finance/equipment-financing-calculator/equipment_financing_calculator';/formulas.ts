import { equipment_financing_calculator';Inputs, equipment_financing_calculator';Metrics, equipment_financing_calculator';Analysis } from './types';
...
export function calculateResult(inputs: equipment_financing_calculator';Inputs): number {
...
export function generateAnalysis(inputs: equipment_financing_calculator';Inputs, metrics: equipment_financing_calculator';Metrics): equipment_financing_calculator';Analysis {
