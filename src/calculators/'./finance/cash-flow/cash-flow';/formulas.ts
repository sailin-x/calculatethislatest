import { cash-flow';Inputs, cash-flow';Metrics, cash-flow';Analysis } from './types';
...
export function calculateResult(inputs: cash-flow';Inputs): number {
...
export function generateAnalysis(inputs: cash-flow';Inputs, metrics: cash-flow';Metrics): cash-flow';Analysis {
