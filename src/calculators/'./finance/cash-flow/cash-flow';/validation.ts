import { './finance/cash-flow/cash-flow';Inputs } from './types';

export function validateInputs(inputs: './finance/cash-flow/cash-flow';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
