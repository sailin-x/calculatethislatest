import { cash_flow';Inputs, cash_flow';Metrics, cash_flow';Analysis } from './types';
...
export function calculateResult(inputs: cash_flow';Inputs): number {
...
export function generateAnalysis(inputs: cash_flow';Inputs, metrics: cash_flow';Metrics): cash_flow';Analysis {
