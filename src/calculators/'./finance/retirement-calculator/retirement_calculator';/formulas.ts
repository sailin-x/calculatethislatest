import { retirement_calculator';Inputs, retirement_calculator';Metrics, retirement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: retirement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: retirement_calculator';Inputs, metrics: retirement_calculator';Metrics): retirement_calculator';Analysis {
