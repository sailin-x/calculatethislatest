import { retirement-calculator';Inputs, retirement-calculator';Metrics, retirement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: retirement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: retirement-calculator';Inputs, metrics: retirement-calculator';Metrics): retirement-calculator';Analysis {
