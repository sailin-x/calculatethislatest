import { hsa_triple_tax_advantage_calculator';Inputs, hsa_triple_tax_advantage_calculator';Metrics, hsa_triple_tax_advantage_calculator';Analysis } from './types';
...
export function calculateResult(inputs: hsa_triple_tax_advantage_calculator';Inputs): number {
...
export function generateAnalysis(inputs: hsa_triple_tax_advantage_calculator';Inputs, metrics: hsa_triple_tax_advantage_calculator';Metrics): hsa_triple_tax_advantage_calculator';Analysis {
