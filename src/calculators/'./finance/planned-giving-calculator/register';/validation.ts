import { './finance/planned-giving-calculator/register';Inputs } from './types';

export function validateInputs(inputs: './finance/planned-giving-calculator/register';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
