import { planned-giving-calculator';Inputs, planned-giving-calculator';Metrics, planned-giving-calculator';Analysis } from './types';
...
export function calculateResult(inputs: planned-giving-calculator';Inputs): number {
...
export function generateAnalysis(inputs: planned-giving-calculator';Inputs, metrics: planned-giving-calculator';Metrics): planned-giving-calculator';Analysis {
