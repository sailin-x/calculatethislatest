import { planned_giving_calculator';Inputs, planned_giving_calculator';Metrics, planned_giving_calculator';Analysis } from './types';
...
export function calculateResult(inputs: planned_giving_calculator';Inputs): number {
...
export function generateAnalysis(inputs: planned_giving_calculator';Inputs, metrics: planned_giving_calculator';Metrics): planned_giving_calculator';Analysis {
