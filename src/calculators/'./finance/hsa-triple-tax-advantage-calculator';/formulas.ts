import { hsa-triple-tax-advantage-calculator';Inputs, hsa-triple-tax-advantage-calculator';Metrics, hsa-triple-tax-advantage-calculator';Analysis } from './types';
...
export function calculateResult(inputs: hsa-triple-tax-advantage-calculator';Inputs): number {
...
export function generateAnalysis(inputs: hsa-triple-tax-advantage-calculator';Inputs, metrics: hsa-triple-tax-advantage-calculator';Metrics): hsa-triple-tax-advantage-calculator';Analysis {
