import { merger-arbitrage-spread-calculator';Inputs, merger-arbitrage-spread-calculator';Metrics, merger-arbitrage-spread-calculator';Analysis } from './types';
...
export function calculateResult(inputs: merger-arbitrage-spread-calculator';Inputs): number {
...
export function generateAnalysis(inputs: merger-arbitrage-spread-calculator';Inputs, metrics: merger-arbitrage-spread-calculator';Metrics): merger-arbitrage-spread-calculator';Analysis {
