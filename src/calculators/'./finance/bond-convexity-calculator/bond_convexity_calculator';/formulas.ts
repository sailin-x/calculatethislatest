import { bond_convexity_calculator';Inputs, bond_convexity_calculator';Metrics, bond_convexity_calculator';Analysis } from './types';
...
export function calculateResult(inputs: bond_convexity_calculator';Inputs): number {
...
export function generateAnalysis(inputs: bond_convexity_calculator';Inputs, metrics: bond_convexity_calculator';Metrics): bond_convexity_calculator';Analysis {
