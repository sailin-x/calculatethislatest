import { commercial-real-estate-cash-flow';Inputs, commercial-real-estate-cash-flow';Metrics, commercial-real-estate-cash-flow';Analysis } from './types';
...
export function calculateResult(inputs: commercial-real-estate-cash-flow';Inputs): number {
...
export function generateAnalysis(inputs: commercial-real-estate-cash-flow';Inputs, metrics: commercial-real-estate-cash-flow';Metrics): commercial-real-estate-cash-flow';Analysis {
