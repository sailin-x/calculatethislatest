import { commercial_real_estate_cash_flow';Inputs, commercial_real_estate_cash_flow';Metrics, commercial_real_estate_cash_flow';Analysis } from './types';
...
export function calculateResult(inputs: commercial_real_estate_cash_flow';Inputs): number {
...
export function generateAnalysis(inputs: commercial_real_estate_cash_flow';Inputs, metrics: commercial_real_estate_cash_flow';Metrics): commercial_real_estate_cash_flow';Analysis {
