import { free-cash-flow-to-equity-calculator';Inputs, free-cash-flow-to-equity-calculator';Metrics, free-cash-flow-to-equity-calculator';Analysis } from './types';
...
export function calculateResult(inputs: free-cash-flow-to-equity-calculator';Inputs): number {
...
export function generateAnalysis(inputs: free-cash-flow-to-equity-calculator';Inputs, metrics: free-cash-flow-to-equity-calculator';Metrics): free-cash-flow-to-equity-calculator';Analysis {
