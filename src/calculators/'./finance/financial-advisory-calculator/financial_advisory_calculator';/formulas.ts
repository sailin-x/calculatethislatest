import { financial_advisory_calculator';Inputs, financial_advisory_calculator';Metrics, financial_advisory_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_advisory_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_advisory_calculator';Inputs, metrics: financial_advisory_calculator';Metrics): financial_advisory_calculator';Analysis {
