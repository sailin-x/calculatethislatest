import { financial-advisory-calculator';Inputs, financial-advisory-calculator';Metrics, financial-advisory-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-advisory-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-advisory-calculator';Inputs, metrics: financial-advisory-calculator';Metrics): financial-advisory-calculator';Analysis {
