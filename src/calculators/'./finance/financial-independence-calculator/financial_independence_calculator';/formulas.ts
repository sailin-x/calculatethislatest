import { financial_independence_calculator';Inputs, financial_independence_calculator';Metrics, financial_independence_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_independence_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_independence_calculator';Inputs, metrics: financial_independence_calculator';Metrics): financial_independence_calculator';Analysis {
