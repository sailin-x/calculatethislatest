import { financial-independence-calculator';Inputs, financial-independence-calculator';Metrics, financial-independence-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-independence-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-independence-calculator';Inputs, metrics: financial-independence-calculator';Metrics): financial-independence-calculator';Analysis {
