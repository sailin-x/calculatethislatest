import { home_affordability';Inputs, home_affordability';Metrics, home_affordability';Analysis } from './types';
...
export function calculateResult(inputs: home_affordability';Inputs): number {
...
export function generateAnalysis(inputs: home_affordability';Inputs, metrics: home_affordability';Metrics): home_affordability';Analysis {
