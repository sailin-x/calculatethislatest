import { home-affordability';Inputs, home-affordability';Metrics, home-affordability';Analysis } from './types';
...
export function calculateResult(inputs: home-affordability';Inputs): number {
...
export function generateAnalysis(inputs: home-affordability';Inputs, metrics: home-affordability';Metrics): home-affordability';Analysis {
