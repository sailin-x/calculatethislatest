import { financial-strategy-calculator';Inputs, financial-strategy-calculator';Metrics, financial-strategy-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-strategy-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-strategy-calculator';Inputs, metrics: financial-strategy-calculator';Metrics): financial-strategy-calculator';Analysis {
