import { financial_strategy_calculator';Inputs, financial_strategy_calculator';Metrics, financial_strategy_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_strategy_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_strategy_calculator';Inputs, metrics: financial_strategy_calculator';Metrics): financial_strategy_calculator';Analysis {
