import { commercial_lease_buyout';Inputs, commercial_lease_buyout';Metrics, commercial_lease_buyout';Analysis } from './types';
...
export function calculateResult(inputs: commercial_lease_buyout';Inputs): number {
...
export function generateAnalysis(inputs: commercial_lease_buyout';Inputs, metrics: commercial_lease_buyout';Metrics): commercial_lease_buyout';Analysis {
