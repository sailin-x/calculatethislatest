import { commercial-lease-buyout';Inputs, commercial-lease-buyout';Metrics, commercial-lease-buyout';Analysis } from './types';
...
export function calculateResult(inputs: commercial-lease-buyout';Inputs): number {
...
export function generateAnalysis(inputs: commercial-lease-buyout';Inputs, metrics: commercial-lease-buyout';Metrics): commercial-lease-buyout';Analysis {
