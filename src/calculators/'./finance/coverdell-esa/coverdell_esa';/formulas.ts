import { coverdell_esa';Inputs, coverdell_esa';Metrics, coverdell_esa';Analysis } from './types';
...
export function calculateResult(inputs: coverdell_esa';Inputs): number {
...
export function generateAnalysis(inputs: coverdell_esa';Inputs, metrics: coverdell_esa';Metrics): coverdell_esa';Analysis {
