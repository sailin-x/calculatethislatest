import { './finance/coverdell-esa/coverdell_esa';Inputs } from './types';

export function validateInputs(inputs: './finance/coverdell-esa/coverdell_esa';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
