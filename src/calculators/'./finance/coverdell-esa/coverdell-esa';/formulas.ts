import { coverdell-esa';Inputs, coverdell-esa';Metrics, coverdell-esa';Analysis } from './types';
...
export function calculateResult(inputs: coverdell-esa';Inputs): number {
...
export function generateAnalysis(inputs: coverdell-esa';Inputs, metrics: coverdell-esa';Metrics): coverdell-esa';Analysis {
