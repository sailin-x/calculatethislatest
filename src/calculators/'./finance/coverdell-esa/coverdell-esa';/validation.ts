import { './finance/coverdell-esa/coverdell-esa';Inputs } from './types';

export function validateInputs(inputs: './finance/coverdell-esa/coverdell-esa';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
