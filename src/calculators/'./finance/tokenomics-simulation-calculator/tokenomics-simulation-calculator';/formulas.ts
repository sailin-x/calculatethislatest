import { tokenomics-simulation-calculator';Inputs, tokenomics-simulation-calculator';Metrics, tokenomics-simulation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: tokenomics-simulation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: tokenomics-simulation-calculator';Inputs, metrics: tokenomics-simulation-calculator';Metrics): tokenomics-simulation-calculator';Analysis {
