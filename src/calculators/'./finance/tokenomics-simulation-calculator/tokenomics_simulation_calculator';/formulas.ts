import { tokenomics_simulation_calculator';Inputs, tokenomics_simulation_calculator';Metrics, tokenomics_simulation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: tokenomics_simulation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: tokenomics_simulation_calculator';Inputs, metrics: tokenomics_simulation_calculator';Metrics): tokenomics_simulation_calculator';Analysis {
