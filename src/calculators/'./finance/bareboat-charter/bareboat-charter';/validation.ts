import { './finance/bareboat-charter/bareboat-charter';Inputs } from './types';

export function validateInputs(inputs: './finance/bareboat-charter/bareboat-charter';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
