import { bareboat-charter';Inputs, bareboat-charter';Metrics, bareboat-charter';Analysis } from './types';
...
export function calculateResult(inputs: bareboat-charter';Inputs): number {
...
export function generateAnalysis(inputs: bareboat-charter';Inputs, metrics: bareboat-charter';Metrics): bareboat-charter';Analysis {
