import { './finance/bareboat-charter/bareboat_charter';Inputs } from './types';

export function validateInputs(inputs: './finance/bareboat-charter/bareboat_charter';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
