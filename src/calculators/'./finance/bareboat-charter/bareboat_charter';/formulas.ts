import { bareboat_charter';Inputs, bareboat_charter';Metrics, bareboat_charter';Analysis } from './types';
...
export function calculateResult(inputs: bareboat_charter';Inputs): number {
...
export function generateAnalysis(inputs: bareboat_charter';Inputs, metrics: bareboat_charter';Metrics): bareboat_charter';Analysis {
