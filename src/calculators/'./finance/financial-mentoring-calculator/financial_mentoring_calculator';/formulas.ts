import { financial_mentoring_calculator';Inputs, financial_mentoring_calculator';Metrics, financial_mentoring_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_mentoring_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_mentoring_calculator';Inputs, metrics: financial_mentoring_calculator';Metrics): financial_mentoring_calculator';Analysis {
