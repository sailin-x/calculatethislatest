import { financial-mentoring-calculator';Inputs, financial-mentoring-calculator';Metrics, financial-mentoring-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-mentoring-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-mentoring-calculator';Inputs, metrics: financial-mentoring-calculator';Metrics): financial-mentoring-calculator';Analysis {
