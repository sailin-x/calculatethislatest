import { student_loan_calculator';Inputs, student_loan_calculator';Metrics, student_loan_calculator';Analysis } from './types';
...
export function calculateResult(inputs: student_loan_calculator';Inputs): number {
...
export function generateAnalysis(inputs: student_loan_calculator';Inputs, metrics: student_loan_calculator';Metrics): student_loan_calculator';Analysis {
