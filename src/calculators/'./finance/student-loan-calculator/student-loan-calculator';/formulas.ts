import { student-loan-calculator';Inputs, student-loan-calculator';Metrics, student-loan-calculator';Analysis } from './types';
...
export function calculateResult(inputs: student-loan-calculator';Inputs): number {
...
export function generateAnalysis(inputs: student-loan-calculator';Inputs, metrics: student-loan-calculator';Metrics): student-loan-calculator';Analysis {
