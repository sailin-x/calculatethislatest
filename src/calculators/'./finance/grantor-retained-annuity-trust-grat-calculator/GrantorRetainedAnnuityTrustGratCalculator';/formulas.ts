import { GrantorRetainedAnnuityTrustGratCalculator';Inputs, GrantorRetainedAnnuityTrustGratCalculator';Metrics, GrantorRetainedAnnuityTrustGratCalculator';Analysis } from './types';
...
export function calculateResult(inputs: GrantorRetainedAnnuityTrustGratCalculator';Inputs): number {
...
export function generateAnalysis(inputs: GrantorRetainedAnnuityTrustGratCalculator';Inputs, metrics: GrantorRetainedAnnuityTrustGratCalculator';Metrics): GrantorRetainedAnnuityTrustGratCalculator';Analysis {
