import { grantor_retained_annuity_trust_grat_calculator';Inputs, grantor_retained_annuity_trust_grat_calculator';Metrics, grantor_retained_annuity_trust_grat_calculator';Analysis } from './types';
...
export function calculateResult(inputs: grantor_retained_annuity_trust_grat_calculator';Inputs): number {
...
export function generateAnalysis(inputs: grantor_retained_annuity_trust_grat_calculator';Inputs, metrics: grantor_retained_annuity_trust_grat_calculator';Metrics): grantor_retained_annuity_trust_grat_calculator';Analysis {
