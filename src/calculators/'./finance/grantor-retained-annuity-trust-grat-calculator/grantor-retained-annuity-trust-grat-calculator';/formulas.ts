import { grantor-retained-annuity-trust-grat-calculator';Inputs, grantor-retained-annuity-trust-grat-calculator';Metrics, grantor-retained-annuity-trust-grat-calculator';Analysis } from './types';
...
export function calculateResult(inputs: grantor-retained-annuity-trust-grat-calculator';Inputs): number {
...
export function generateAnalysis(inputs: grantor-retained-annuity-trust-grat-calculator';Inputs, metrics: grantor-retained-annuity-trust-grat-calculator';Metrics): grantor-retained-annuity-trust-grat-calculator';Analysis {
