import { net_present_value_calculator';Inputs, net_present_value_calculator';Metrics, net_present_value_calculator';Analysis } from './types';
...
export function calculateResult(inputs: net_present_value_calculator';Inputs): number {
...
export function generateAnalysis(inputs: net_present_value_calculator';Inputs, metrics: net_present_value_calculator';Metrics): net_present_value_calculator';Analysis {
