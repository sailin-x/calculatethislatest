import { net-present-value-calculator';Inputs, net-present-value-calculator';Metrics, net-present-value-calculator';Analysis } from './types';
...
export function calculateResult(inputs: net-present-value-calculator';Inputs): number {
...
export function generateAnalysis(inputs: net-present-value-calculator';Inputs, metrics: net-present-value-calculator';Metrics): net-present-value-calculator';Analysis {
