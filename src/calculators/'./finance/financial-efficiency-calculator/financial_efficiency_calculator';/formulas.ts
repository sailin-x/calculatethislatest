import { financial_efficiency_calculator';Inputs, financial_efficiency_calculator';Metrics, financial_efficiency_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_efficiency_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_efficiency_calculator';Inputs, metrics: financial_efficiency_calculator';Metrics): financial_efficiency_calculator';Analysis {
