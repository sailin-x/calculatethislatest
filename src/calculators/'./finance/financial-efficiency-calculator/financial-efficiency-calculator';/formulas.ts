import { financial-efficiency-calculator';Inputs, financial-efficiency-calculator';Metrics, financial-efficiency-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-efficiency-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-efficiency-calculator';Inputs, metrics: financial-efficiency-calculator';Metrics): financial-efficiency-calculator';Analysis {
