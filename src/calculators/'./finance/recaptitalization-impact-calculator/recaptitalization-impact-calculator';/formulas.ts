import { recaptitalization-impact-calculator';Inputs, recaptitalization-impact-calculator';Metrics, recaptitalization-impact-calculator';Analysis } from './types';
...
export function calculateResult(inputs: recaptitalization-impact-calculator';Inputs): number {
...
export function generateAnalysis(inputs: recaptitalization-impact-calculator';Inputs, metrics: recaptitalization-impact-calculator';Metrics): recaptitalization-impact-calculator';Analysis {
