import { recaptitalization_impact_calculator';Inputs, recaptitalization_impact_calculator';Metrics, recaptitalization_impact_calculator';Analysis } from './types';
...
export function calculateResult(inputs: recaptitalization_impact_calculator';Inputs): number {
...
export function generateAnalysis(inputs: recaptitalization_impact_calculator';Inputs, metrics: recaptitalization_impact_calculator';Metrics): recaptitalization_impact_calculator';Analysis {
