import { './finance/hard-money-loan/hard-money-loan';Inputs } from './types';

export function validateInputs(inputs: './finance/hard-money-loan/hard-money-loan';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
