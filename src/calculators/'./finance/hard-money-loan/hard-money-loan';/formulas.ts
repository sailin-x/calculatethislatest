import { hard-money-loan';Inputs, hard-money-loan';Metrics, hard-money-loan';Analysis } from './types';
...
export function calculateResult(inputs: hard-money-loan';Inputs): number {
...
export function generateAnalysis(inputs: hard-money-loan';Inputs, metrics: hard-money-loan';Metrics): hard-money-loan';Analysis {
