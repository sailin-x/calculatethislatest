import { './finance/hard-money-loan/hard_money_loan';Inputs } from './types';

export function validateInputs(inputs: './finance/hard-money-loan/hard_money_loan';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
