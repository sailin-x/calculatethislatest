import { hard_money_loan';Inputs, hard_money_loan';Metrics, hard_money_loan';Analysis } from './types';
...
export function calculateResult(inputs: hard_money_loan';Inputs): number {
...
export function generateAnalysis(inputs: hard_money_loan';Inputs, metrics: hard_money_loan';Metrics): hard_money_loan';Analysis {
