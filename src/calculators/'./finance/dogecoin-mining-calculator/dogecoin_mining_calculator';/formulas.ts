import { dogecoin_mining_calculator';Inputs, dogecoin_mining_calculator';Metrics, dogecoin_mining_calculator';Analysis } from './types';
...
export function calculateResult(inputs: dogecoin_mining_calculator';Inputs): number {
...
export function generateAnalysis(inputs: dogecoin_mining_calculator';Inputs, metrics: dogecoin_mining_calculator';Metrics): dogecoin_mining_calculator';Analysis {
