import { net_margin_calculator';Inputs, net_margin_calculator';Metrics, net_margin_calculator';Analysis } from './types';
...
export function calculateResult(inputs: net_margin_calculator';Inputs): number {
...
export function generateAnalysis(inputs: net_margin_calculator';Inputs, metrics: net_margin_calculator';Metrics): net_margin_calculator';Analysis {
