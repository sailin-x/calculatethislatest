import { './finance/401k-plan/401k_plan';Inputs } from './types';

export function validateInputs(inputs: './finance/401k-plan/401k_plan';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
