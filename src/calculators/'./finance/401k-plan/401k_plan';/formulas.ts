import { 401k_plan';Inputs, 401k_plan';Metrics, 401k_plan';Analysis } from './types';
...
export function calculateResult(inputs: 401k_plan';Inputs): number {
...
export function generateAnalysis(inputs: 401k_plan';Inputs, metrics: 401k_plan';Metrics): 401k_plan';Analysis {
