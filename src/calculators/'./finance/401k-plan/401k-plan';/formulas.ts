import { 401k-plan';Inputs, 401k-plan';Metrics, 401k-plan';Analysis } from './types';
...
export function calculateResult(inputs: 401k-plan';Inputs): number {
...
export function generateAnalysis(inputs: 401k-plan';Inputs, metrics: 401k-plan';Metrics): 401k-plan';Analysis {
