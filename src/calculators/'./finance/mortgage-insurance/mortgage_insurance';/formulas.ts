import { mortgage_insurance';Inputs, mortgage_insurance';Metrics, mortgage_insurance';Analysis } from './types';
...
export function calculateResult(inputs: mortgage_insurance';Inputs): number {
...
export function generateAnalysis(inputs: mortgage_insurance';Inputs, metrics: mortgage_insurance';Metrics): mortgage_insurance';Analysis {
