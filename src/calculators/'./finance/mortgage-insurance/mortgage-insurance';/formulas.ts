import { mortgage-insurance';Inputs, mortgage-insurance';Metrics, mortgage-insurance';Analysis } from './types';
...
export function calculateResult(inputs: mortgage-insurance';Inputs): number {
...
export function generateAnalysis(inputs: mortgage-insurance';Inputs, metrics: mortgage-insurance';Metrics): mortgage-insurance';Analysis {
