import { investment_growth_calculator';Inputs, investment_growth_calculator';Metrics, investment_growth_calculator';Analysis } from './types';
...
export function calculateResult(inputs: investment_growth_calculator';Inputs): number {
...
export function generateAnalysis(inputs: investment_growth_calculator';Inputs, metrics: investment_growth_calculator';Metrics): investment_growth_calculator';Analysis {
