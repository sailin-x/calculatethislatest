import { investment-growth-calculator';Inputs, investment-growth-calculator';Metrics, investment-growth-calculator';Analysis } from './types';
...
export function calculateResult(inputs: investment-growth-calculator';Inputs): number {
...
export function generateAnalysis(inputs: investment-growth-calculator';Inputs, metrics: investment-growth-calculator';Metrics): investment-growth-calculator';Analysis {
