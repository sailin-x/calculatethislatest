import { commodity_calculator';Inputs, commodity_calculator';Metrics, commodity_calculator';Analysis } from './types';
...
export function calculateResult(inputs: commodity_calculator';Inputs): number {
...
export function generateAnalysis(inputs: commodity_calculator';Inputs, metrics: commodity_calculator';Metrics): commodity_calculator';Analysis {
