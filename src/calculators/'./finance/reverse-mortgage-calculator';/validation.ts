import { './finance/reverse-mortgage-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/reverse-mortgage-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
