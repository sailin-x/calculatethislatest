import { debt-snowball-calculator';Inputs, debt-snowball-calculator';Metrics, debt-snowball-calculator';Analysis } from './types';
...
export function calculateResult(inputs: debt-snowball-calculator';Inputs): number {
...
export function generateAnalysis(inputs: debt-snowball-calculator';Inputs, metrics: debt-snowball-calculator';Metrics): debt-snowball-calculator';Analysis {
