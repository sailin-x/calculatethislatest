import { DebtSnowballCalculator';Inputs, DebtSnowballCalculator';Metrics, DebtSnowballCalculator';Analysis } from './types';
...
export function calculateResult(inputs: DebtSnowballCalculator';Inputs): number {
...
export function generateAnalysis(inputs: DebtSnowballCalculator';Inputs, metrics: DebtSnowballCalculator';Metrics): DebtSnowballCalculator';Analysis {
