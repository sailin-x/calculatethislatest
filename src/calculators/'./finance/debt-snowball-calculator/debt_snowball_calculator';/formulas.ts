import { debt_snowball_calculator';Inputs, debt_snowball_calculator';Metrics, debt_snowball_calculator';Analysis } from './types';
...
export function calculateResult(inputs: debt_snowball_calculator';Inputs): number {
...
export function generateAnalysis(inputs: debt_snowball_calculator';Inputs, metrics: debt_snowball_calculator';Metrics): debt_snowball_calculator';Analysis {
