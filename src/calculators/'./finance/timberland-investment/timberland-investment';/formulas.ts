import { timberland-investment';Inputs, timberland-investment';Metrics, timberland-investment';Analysis } from './types';
...
export function calculateResult(inputs: timberland-investment';Inputs): number {
...
export function generateAnalysis(inputs: timberland-investment';Inputs, metrics: timberland-investment';Metrics): timberland-investment';Analysis {
