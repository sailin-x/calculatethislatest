import { timberland_investment';Inputs, timberland_investment';Metrics, timberland_investment';Analysis } from './types';
...
export function calculateResult(inputs: timberland_investment';Inputs): number {
...
export function generateAnalysis(inputs: timberland_investment';Inputs, metrics: timberland_investment';Metrics): timberland_investment';Analysis {
