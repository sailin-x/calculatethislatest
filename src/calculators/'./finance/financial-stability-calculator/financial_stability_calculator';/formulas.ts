import { financial_stability_calculator';Inputs, financial_stability_calculator';Metrics, financial_stability_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_stability_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_stability_calculator';Inputs, metrics: financial_stability_calculator';Metrics): financial_stability_calculator';Analysis {
