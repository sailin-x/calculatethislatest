import { financial-stability-calculator';Inputs, financial-stability-calculator';Metrics, financial-stability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-stability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-stability-calculator';Inputs, metrics: financial-stability-calculator';Metrics): financial-stability-calculator';Analysis {
