import { './finance/brrrr-strategy/brrrr_strategy';Inputs } from './types';

export function validateInputs(inputs: './finance/brrrr-strategy/brrrr_strategy';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
