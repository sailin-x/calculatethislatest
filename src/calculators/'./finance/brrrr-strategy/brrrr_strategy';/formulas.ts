import { brrrr_strategy';Inputs, brrrr_strategy';Metrics, brrrr_strategy';Analysis } from './types';
...
export function calculateResult(inputs: brrrr_strategy';Inputs): number {
...
export function generateAnalysis(inputs: brrrr_strategy';Inputs, metrics: brrrr_strategy';Metrics): brrrr_strategy';Analysis {
