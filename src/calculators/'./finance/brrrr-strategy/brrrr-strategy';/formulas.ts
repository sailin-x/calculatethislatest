import { brrrr-strategy';Inputs, brrrr-strategy';Metrics, brrrr-strategy';Analysis } from './types';
...
export function calculateResult(inputs: brrrr-strategy';Inputs): number {
...
export function generateAnalysis(inputs: brrrr-strategy';Inputs, metrics: brrrr-strategy';Metrics): brrrr-strategy';Analysis {
