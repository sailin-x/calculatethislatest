import { './finance/brrrr-strategy/brrrr-strategy';Inputs } from './types';

export function validateInputs(inputs: './finance/brrrr-strategy/brrrr-strategy';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
