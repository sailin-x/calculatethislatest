import { tax';Inputs, tax';Metrics, tax';Analysis } from './types';
...
export function calculateResult(inputs: tax';Inputs): number {
...
export function generateAnalysis(inputs: tax';Inputs, metrics: tax';Metrics): tax';Analysis {
