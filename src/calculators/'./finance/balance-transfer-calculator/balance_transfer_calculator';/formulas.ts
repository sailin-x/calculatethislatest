import { balance_transfer_calculator';Inputs, balance_transfer_calculator';Metrics, balance_transfer_calculator';Analysis } from './types';
...
export function calculateResult(inputs: balance_transfer_calculator';Inputs): number {
...
export function generateAnalysis(inputs: balance_transfer_calculator';Inputs, metrics: balance_transfer_calculator';Metrics): balance_transfer_calculator';Analysis {
