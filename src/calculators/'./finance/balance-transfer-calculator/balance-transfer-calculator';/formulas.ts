import { balance-transfer-calculator';Inputs, balance-transfer-calculator';Metrics, balance-transfer-calculator';Analysis } from './types';
...
export function calculateResult(inputs: balance-transfer-calculator';Inputs): number {
...
export function generateAnalysis(inputs: balance-transfer-calculator';Inputs, metrics: balance-transfer-calculator';Metrics): balance-transfer-calculator';Analysis {
