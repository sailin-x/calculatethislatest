import { net_unrealized_appreciation_nua_tax_calculator';Inputs, net_unrealized_appreciation_nua_tax_calculator';Metrics, net_unrealized_appreciation_nua_tax_calculator';Analysis } from './types';
...
export function calculateResult(inputs: net_unrealized_appreciation_nua_tax_calculator';Inputs): number {
...
export function generateAnalysis(inputs: net_unrealized_appreciation_nua_tax_calculator';Inputs, metrics: net_unrealized_appreciation_nua_tax_calculator';Metrics): net_unrealized_appreciation_nua_tax_calculator';Analysis {
