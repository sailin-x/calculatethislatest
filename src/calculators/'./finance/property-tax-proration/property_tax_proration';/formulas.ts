import { property_tax_proration';Inputs, property_tax_proration';Metrics, property_tax_proration';Analysis } from './types';
...
export function calculateResult(inputs: property_tax_proration';Inputs): number {
...
export function generateAnalysis(inputs: property_tax_proration';Inputs, metrics: property_tax_proration';Metrics): property_tax_proration';Analysis {
