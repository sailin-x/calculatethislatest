import { property-tax-proration';Inputs, property-tax-proration';Metrics, property-tax-proration';Analysis } from './types';
...
export function calculateResult(inputs: property-tax-proration';Inputs): number {
...
export function generateAnalysis(inputs: property-tax-proration';Inputs, metrics: property-tax-proration';Metrics): property-tax-proration';Analysis {
