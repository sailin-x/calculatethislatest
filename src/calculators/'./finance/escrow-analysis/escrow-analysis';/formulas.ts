import { escrow-analysis';Inputs, escrow-analysis';Metrics, escrow-analysis';Analysis } from './types';
...
export function calculateResult(inputs: escrow-analysis';Inputs): number {
...
export function generateAnalysis(inputs: escrow-analysis';Inputs, metrics: escrow-analysis';Metrics): escrow-analysis';Analysis {
