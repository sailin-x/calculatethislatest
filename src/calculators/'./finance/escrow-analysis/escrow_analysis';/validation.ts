import { './finance/escrow-analysis/escrow_analysis';Inputs } from './types';

export function validateInputs(inputs: './finance/escrow-analysis/escrow_analysis';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
