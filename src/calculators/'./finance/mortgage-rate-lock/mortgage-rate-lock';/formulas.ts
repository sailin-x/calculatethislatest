import { mortgage-rate-lock';Inputs, mortgage-rate-lock';Metrics, mortgage-rate-lock';Analysis } from './types';
...
export function calculateResult(inputs: mortgage-rate-lock';Inputs): number {
...
export function generateAnalysis(inputs: mortgage-rate-lock';Inputs, metrics: mortgage-rate-lock';Metrics): mortgage-rate-lock';Analysis {
