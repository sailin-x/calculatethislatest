import { mortgage_rate_lock';Inputs, mortgage_rate_lock';Metrics, mortgage_rate_lock';Analysis } from './types';
...
export function calculateResult(inputs: mortgage_rate_lock';Inputs): number {
...
export function generateAnalysis(inputs: mortgage_rate_lock';Inputs, metrics: mortgage_rate_lock';Metrics): mortgage_rate_lock';Analysis {
