import { accretion-dilution';Inputs, accretion-dilution';Metrics, accretion-dilution';Analysis } from './types';
...
export function calculateResult(inputs: accretion-dilution';Inputs): number {
...
export function generateAnalysis(inputs: accretion-dilution';Inputs, metrics: accretion-dilution';Metrics): accretion-dilution';Analysis {
