import { accretion_dilution';Inputs, accretion_dilution';Metrics, accretion_dilution';Analysis } from './types';
...
export function calculateResult(inputs: accretion_dilution';Inputs): number {
...
export function generateAnalysis(inputs: accretion_dilution';Inputs, metrics: accretion_dilution';Metrics): accretion_dilution';Analysis {
