import { real-estate-development-pro-forma-calculator';Inputs, real-estate-development-pro-forma-calculator';Metrics, real-estate-development-pro-forma-calculator';Analysis } from './types';
...
export function calculateResult(inputs: real-estate-development-pro-forma-calculator';Inputs): number {
...
export function generateAnalysis(inputs: real-estate-development-pro-forma-calculator';Inputs, metrics: real-estate-development-pro-forma-calculator';Metrics): real-estate-development-pro-forma-calculator';Analysis {
