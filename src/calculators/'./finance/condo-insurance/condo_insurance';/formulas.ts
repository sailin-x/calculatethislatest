import { condo_insurance';Inputs, condo_insurance';Metrics, condo_insurance';Analysis } from './types';
...
export function calculateResult(inputs: condo_insurance';Inputs): number {
...
export function generateAnalysis(inputs: condo_insurance';Inputs, metrics: condo_insurance';Metrics): condo_insurance';Analysis {
