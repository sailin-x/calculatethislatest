import { condo-insurance';Inputs, condo-insurance';Metrics, condo-insurance';Analysis } from './types';
...
export function calculateResult(inputs: condo-insurance';Inputs): number {
...
export function generateAnalysis(inputs: condo-insurance';Inputs, metrics: condo-insurance';Metrics): condo-insurance';Analysis {
