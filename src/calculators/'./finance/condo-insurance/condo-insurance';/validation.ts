import { './finance/condo-insurance/condo-insurance';Inputs } from './types';

export function validateInputs(inputs: './finance/condo-insurance/condo-insurance';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
