import { './finance/savings-goal-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/savings-goal-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
