import { title_loan_calculator';Inputs, title_loan_calculator';Metrics, title_loan_calculator';Analysis } from './types';
...
export function calculateResult(inputs: title_loan_calculator';Inputs): number {
...
export function generateAnalysis(inputs: title_loan_calculator';Inputs, metrics: title_loan_calculator';Metrics): title_loan_calculator';Analysis {
