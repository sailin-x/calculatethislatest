import { financial-impact-calculator';Inputs, financial-impact-calculator';Metrics, financial-impact-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-impact-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-impact-calculator';Inputs, metrics: financial-impact-calculator';Metrics): financial-impact-calculator';Analysis {
