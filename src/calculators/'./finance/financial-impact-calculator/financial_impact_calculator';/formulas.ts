import { financial_impact_calculator';Inputs, financial_impact_calculator';Metrics, financial_impact_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_impact_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_impact_calculator';Inputs, metrics: financial_impact_calculator';Metrics): financial_impact_calculator';Analysis {
