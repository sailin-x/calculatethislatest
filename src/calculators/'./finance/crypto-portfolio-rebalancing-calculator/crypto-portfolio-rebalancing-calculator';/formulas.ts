import { crypto-portfolio-rebalancing-calculator';Inputs, crypto-portfolio-rebalancing-calculator';Metrics, crypto-portfolio-rebalancing-calculator';Analysis } from './types';
...
export function calculateResult(inputs: crypto-portfolio-rebalancing-calculator';Inputs): number {
...
export function generateAnalysis(inputs: crypto-portfolio-rebalancing-calculator';Inputs, metrics: crypto-portfolio-rebalancing-calculator';Metrics): crypto-portfolio-rebalancing-calculator';Analysis {
