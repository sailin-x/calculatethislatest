import { crypto_portfolio_rebalancing_calculator';Inputs, crypto_portfolio_rebalancing_calculator';Metrics, crypto_portfolio_rebalancing_calculator';Analysis } from './types';
...
export function calculateResult(inputs: crypto_portfolio_rebalancing_calculator';Inputs): number {
...
export function generateAnalysis(inputs: crypto_portfolio_rebalancing_calculator';Inputs, metrics: crypto_portfolio_rebalancing_calculator';Metrics): crypto_portfolio_rebalancing_calculator';Analysis {
