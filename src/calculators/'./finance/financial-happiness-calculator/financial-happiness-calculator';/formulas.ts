import { financial-happiness-calculator';Inputs, financial-happiness-calculator';Metrics, financial-happiness-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-happiness-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-happiness-calculator';Inputs, metrics: financial-happiness-calculator';Metrics): financial-happiness-calculator';Analysis {
