import { capital_structure_optimization_calculator';Inputs, capital_structure_optimization_calculator';Metrics, capital_structure_optimization_calculator';Analysis } from './types';
...
export function calculateResult(inputs: capital_structure_optimization_calculator';Inputs): number {
...
export function generateAnalysis(inputs: capital_structure_optimization_calculator';Inputs, metrics: capital_structure_optimization_calculator';Metrics): capital_structure_optimization_calculator';Analysis {
