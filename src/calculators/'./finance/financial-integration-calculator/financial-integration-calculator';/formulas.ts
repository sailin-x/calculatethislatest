import { financial-integration-calculator';Inputs, financial-integration-calculator';Metrics, financial-integration-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-integration-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-integration-calculator';Inputs, metrics: financial-integration-calculator';Metrics): financial-integration-calculator';Analysis {
