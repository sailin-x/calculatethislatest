import { financial_integration_calculator';Inputs, financial_integration_calculator';Metrics, financial_integration_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_integration_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_integration_calculator';Inputs, metrics: financial_integration_calculator';Metrics): financial_integration_calculator';Analysis {
