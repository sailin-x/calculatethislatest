import { royalty_financing_calculator';Inputs, royalty_financing_calculator';Metrics, royalty_financing_calculator';Analysis } from './types';
...
export function calculateResult(inputs: royalty_financing_calculator';Inputs): number {
...
export function generateAnalysis(inputs: royalty_financing_calculator';Inputs, metrics: royalty_financing_calculator';Metrics): royalty_financing_calculator';Analysis {
