import { interest_rate_swap_calculator';Inputs, interest_rate_swap_calculator';Metrics, interest_rate_swap_calculator';Analysis } from './types';
...
export function calculateResult(inputs: interest_rate_swap_calculator';Inputs): number {
...
export function generateAnalysis(inputs: interest_rate_swap_calculator';Inputs, metrics: interest_rate_swap_calculator';Metrics): interest_rate_swap_calculator';Analysis {
