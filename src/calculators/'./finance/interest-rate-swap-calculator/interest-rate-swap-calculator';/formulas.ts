import { interest-rate-swap-calculator';Inputs, interest-rate-swap-calculator';Metrics, interest-rate-swap-calculator';Analysis } from './types';
...
export function calculateResult(inputs: interest-rate-swap-calculator';Inputs): number {
...
export function generateAnalysis(inputs: interest-rate-swap-calculator';Inputs, metrics: interest-rate-swap-calculator';Metrics): interest-rate-swap-calculator';Analysis {
