import { alpha-beta';Inputs, alpha-beta';Metrics, alpha-beta';Analysis } from './types';
...
export function calculateResult(inputs: alpha-beta';Inputs): number {
...
export function generateAnalysis(inputs: alpha-beta';Inputs, metrics: alpha-beta';Metrics): alpha-beta';Analysis {
