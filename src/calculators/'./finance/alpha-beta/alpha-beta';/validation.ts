import { './finance/alpha-beta/alpha-beta';Inputs } from './types';

export function validateInputs(inputs: './finance/alpha-beta/alpha-beta';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
