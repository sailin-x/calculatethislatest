import { alpha_beta';Inputs, alpha_beta';Metrics, alpha_beta';Analysis } from './types';
...
export function calculateResult(inputs: alpha_beta';Inputs): number {
...
export function generateAnalysis(inputs: alpha_beta';Inputs, metrics: alpha_beta';Metrics): alpha_beta';Analysis {
