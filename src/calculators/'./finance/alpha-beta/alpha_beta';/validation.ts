import { './finance/alpha-beta/alpha_beta';Inputs } from './types';

export function validateInputs(inputs: './finance/alpha-beta/alpha_beta';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
