import { college-cost';Inputs, college-cost';Metrics, college-cost';Analysis } from './types';
...
export function calculateResult(inputs: college-cost';Inputs): number {
...
export function generateAnalysis(inputs: college-cost';Inputs, metrics: college-cost';Metrics): college-cost';Analysis {
