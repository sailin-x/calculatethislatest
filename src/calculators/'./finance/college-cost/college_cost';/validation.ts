import { './finance/college-cost/college_cost';Inputs } from './types';

export function validateInputs(inputs: './finance/college-cost/college_cost';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
