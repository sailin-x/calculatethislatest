import { college_cost';Inputs, college_cost';Metrics, college_cost';Analysis } from './types';
...
export function calculateResult(inputs: college_cost';Inputs): number {
...
export function generateAnalysis(inputs: college_cost';Inputs, metrics: college_cost';Metrics): college_cost';Analysis {
