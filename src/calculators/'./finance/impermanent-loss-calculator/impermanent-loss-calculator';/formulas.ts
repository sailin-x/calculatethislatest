import { impermanent-loss-calculator';Inputs, impermanent-loss-calculator';Metrics, impermanent-loss-calculator';Analysis } from './types';
...
export function calculateResult(inputs: impermanent-loss-calculator';Inputs): number {
...
export function generateAnalysis(inputs: impermanent-loss-calculator';Inputs, metrics: impermanent-loss-calculator';Metrics): impermanent-loss-calculator';Analysis {
