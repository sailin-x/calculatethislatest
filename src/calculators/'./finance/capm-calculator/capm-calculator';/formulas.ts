import { capm-calculator';Inputs, capm-calculator';Metrics, capm-calculator';Analysis } from './types';
...
export function calculateResult(inputs: capm-calculator';Inputs): number {
...
export function generateAnalysis(inputs: capm-calculator';Inputs, metrics: capm-calculator';Metrics): capm-calculator';Analysis {
