import { './finance/capm-calculator/capm-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/capm-calculator/capm-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
