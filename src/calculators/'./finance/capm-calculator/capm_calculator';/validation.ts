import { './finance/capm-calculator/capm_calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/capm-calculator/capm_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
