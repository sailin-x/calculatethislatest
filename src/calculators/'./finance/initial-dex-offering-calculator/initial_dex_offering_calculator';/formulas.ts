import { initial_dex_offering_calculator';Inputs, initial_dex_offering_calculator';Metrics, initial_dex_offering_calculator';Analysis } from './types';
...
export function calculateResult(inputs: initial_dex_offering_calculator';Inputs): number {
...
export function generateAnalysis(inputs: initial_dex_offering_calculator';Inputs, metrics: initial_dex_offering_calculator';Metrics): initial_dex_offering_calculator';Analysis {
