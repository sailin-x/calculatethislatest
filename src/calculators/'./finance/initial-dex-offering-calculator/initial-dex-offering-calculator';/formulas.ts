import { initial-dex-offering-calculator';Inputs, initial-dex-offering-calculator';Metrics, initial-dex-offering-calculator';Analysis } from './types';
...
export function calculateResult(inputs: initial-dex-offering-calculator';Inputs): number {
...
export function generateAnalysis(inputs: initial-dex-offering-calculator';Inputs, metrics: initial-dex-offering-calculator';Metrics): initial-dex-offering-calculator';Analysis {
