import { mortgage';Inputs, mortgage';Metrics, mortgage';Analysis } from './types';
...
export function calculateResult(inputs: mortgage';Inputs): number {
...
export function generateAnalysis(inputs: mortgage';Inputs, metrics: mortgage';Metrics): mortgage';Analysis {
