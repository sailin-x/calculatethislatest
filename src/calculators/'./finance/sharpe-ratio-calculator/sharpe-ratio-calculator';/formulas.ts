import { sharpe-ratio-calculator';Inputs, sharpe-ratio-calculator';Metrics, sharpe-ratio-calculator';Analysis } from './types';
...
export function calculateResult(inputs: sharpe-ratio-calculator';Inputs): number {
...
export function generateAnalysis(inputs: sharpe-ratio-calculator';Inputs, metrics: sharpe-ratio-calculator';Metrics): sharpe-ratio-calculator';Analysis {
