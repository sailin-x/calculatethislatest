import { sharpe_ratio_calculator';Inputs, sharpe_ratio_calculator';Metrics, sharpe_ratio_calculator';Analysis } from './types';
...
export function calculateResult(inputs: sharpe_ratio_calculator';Inputs): number {
...
export function generateAnalysis(inputs: sharpe_ratio_calculator';Inputs, metrics: sharpe_ratio_calculator';Metrics): sharpe_ratio_calculator';Analysis {
