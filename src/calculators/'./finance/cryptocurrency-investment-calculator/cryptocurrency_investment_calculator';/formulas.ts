import { cryptocurrency_investment_calculator';Inputs, cryptocurrency_investment_calculator';Metrics, cryptocurrency_investment_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cryptocurrency_investment_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cryptocurrency_investment_calculator';Inputs, metrics: cryptocurrency_investment_calculator';Metrics): cryptocurrency_investment_calculator';Analysis {
