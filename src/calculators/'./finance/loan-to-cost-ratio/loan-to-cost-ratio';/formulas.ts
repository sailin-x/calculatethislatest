import { loan-to-cost-ratio';Inputs, loan-to-cost-ratio';Metrics, loan-to-cost-ratio';Analysis } from './types';
...
export function calculateResult(inputs: loan-to-cost-ratio';Inputs): number {
...
export function generateAnalysis(inputs: loan-to-cost-ratio';Inputs, metrics: loan-to-cost-ratio';Metrics): loan-to-cost-ratio';Analysis {
