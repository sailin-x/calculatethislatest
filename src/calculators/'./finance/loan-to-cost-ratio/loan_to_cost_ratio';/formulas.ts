import { loan_to_cost_ratio';Inputs, loan_to_cost_ratio';Metrics, loan_to_cost_ratio';Analysis } from './types';
...
export function calculateResult(inputs: loan_to_cost_ratio';Inputs): number {
...
export function generateAnalysis(inputs: loan_to_cost_ratio';Inputs, metrics: loan_to_cost_ratio';Metrics): loan_to_cost_ratio';Analysis {
