import { './finance/home-insurance/home-insurance';Inputs } from './types';

export function validateInputs(inputs: './finance/home-insurance/home-insurance';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
