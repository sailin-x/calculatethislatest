import { home-insurance';Inputs, home-insurance';Metrics, home-insurance';Analysis } from './types';
...
export function calculateResult(inputs: home-insurance';Inputs): number {
...
export function generateAnalysis(inputs: home-insurance';Inputs, metrics: home-insurance';Metrics): home-insurance';Analysis {
