import { './finance/home-insurance/home_insurance';Inputs } from './types';

export function validateInputs(inputs: './finance/home-insurance/home_insurance';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
