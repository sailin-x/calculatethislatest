import { home_insurance';Inputs, home_insurance';Metrics, home_insurance';Analysis } from './types';
...
export function calculateResult(inputs: home_insurance';Inputs): number {
...
export function generateAnalysis(inputs: home_insurance';Inputs, metrics: home_insurance';Metrics): home_insurance';Analysis {
