import { auto_loan_calculator';Inputs, auto_loan_calculator';Metrics, auto_loan_calculator';Analysis } from './types';
...
export function calculateResult(inputs: auto_loan_calculator';Inputs): number {
...
export function generateAnalysis(inputs: auto_loan_calculator';Inputs, metrics: auto_loan_calculator';Metrics): auto_loan_calculator';Analysis {
