import { EquityValuationCalculator';Inputs, EquityValuationCalculator';Metrics, EquityValuationCalculator';Analysis } from './types';
...
export function calculateResult(inputs: EquityValuationCalculator';Inputs): number {
...
export function generateAnalysis(inputs: EquityValuationCalculator';Inputs, metrics: EquityValuationCalculator';Metrics): EquityValuationCalculator';Analysis {
