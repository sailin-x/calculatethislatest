import { equity-valuation-calculator';Inputs, equity-valuation-calculator';Metrics, equity-valuation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: equity-valuation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: equity-valuation-calculator';Inputs, metrics: equity-valuation-calculator';Metrics): equity-valuation-calculator';Analysis {
