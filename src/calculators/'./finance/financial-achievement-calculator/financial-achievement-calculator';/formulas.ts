import { financial-achievement-calculator';Inputs, financial-achievement-calculator';Metrics, financial-achievement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-achievement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-achievement-calculator';Inputs, metrics: financial-achievement-calculator';Metrics): financial-achievement-calculator';Analysis {
