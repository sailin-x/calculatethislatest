import { financial_achievement_calculator';Inputs, financial_achievement_calculator';Metrics, financial_achievement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_achievement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_achievement_calculator';Inputs, metrics: financial_achievement_calculator';Metrics): financial_achievement_calculator';Analysis {
