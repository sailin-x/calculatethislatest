import { personal-loan-calculator';Inputs, personal-loan-calculator';Metrics, personal-loan-calculator';Analysis } from './types';
...
export function calculateResult(inputs: personal-loan-calculator';Inputs): number {
...
export function generateAnalysis(inputs: personal-loan-calculator';Inputs, metrics: personal-loan-calculator';Metrics): personal-loan-calculator';Analysis {
