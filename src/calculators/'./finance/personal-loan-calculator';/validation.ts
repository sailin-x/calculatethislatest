import { './finance/personal-loan-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/personal-loan-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
