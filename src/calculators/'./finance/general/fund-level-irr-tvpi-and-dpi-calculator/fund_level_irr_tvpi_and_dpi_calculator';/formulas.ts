import { fund_level_irr_tvpi_and_dpi_calculator';Inputs, fund_level_irr_tvpi_and_dpi_calculator';Metrics, fund_level_irr_tvpi_and_dpi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: fund_level_irr_tvpi_and_dpi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: fund_level_irr_tvpi_and_dpi_calculator';Inputs, metrics: fund_level_irr_tvpi_and_dpi_calculator';Metrics): fund_level_irr_tvpi_and_dpi_calculator';Analysis {
