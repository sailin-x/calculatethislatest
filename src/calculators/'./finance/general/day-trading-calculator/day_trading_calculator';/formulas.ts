import { day_trading_calculator';Inputs, day_trading_calculator';Metrics, day_trading_calculator';Analysis } from './types';
...
export function calculateResult(inputs: day_trading_calculator';Inputs): number {
...
export function generateAnalysis(inputs: day_trading_calculator';Inputs, metrics: day_trading_calculator';Metrics): day_trading_calculator';Analysis {
