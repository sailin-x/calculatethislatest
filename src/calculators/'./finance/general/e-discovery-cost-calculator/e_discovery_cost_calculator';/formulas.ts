import { e_discovery_cost_calculator';Inputs, e_discovery_cost_calculator';Metrics, e_discovery_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: e_discovery_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: e_discovery_cost_calculator';Inputs, metrics: e_discovery_cost_calculator';Metrics): e_discovery_cost_calculator';Analysis {
