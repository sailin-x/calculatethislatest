import { corporate_compliance_cost_benefit_analysis';Inputs, corporate_compliance_cost_benefit_analysis';Metrics, corporate_compliance_cost_benefit_analysis';Analysis } from './types';
...
export function calculateResult(inputs: corporate_compliance_cost_benefit_analysis';Inputs): number {
...
export function generateAnalysis(inputs: corporate_compliance_cost_benefit_analysis';Inputs, metrics: corporate_compliance_cost_benefit_analysis';Metrics): corporate_compliance_cost_benefit_analysis';Analysis {
