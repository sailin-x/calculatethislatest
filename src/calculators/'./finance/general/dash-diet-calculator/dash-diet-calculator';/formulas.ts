import { dash-diet-calculator';Inputs, dash-diet-calculator';Metrics, dash-diet-calculator';Analysis } from './types';
...
export function calculateResult(inputs: dash-diet-calculator';Inputs): number {
...
export function generateAnalysis(inputs: dash-diet-calculator';Inputs, metrics: dash-diet-calculator';Metrics): dash-diet-calculator';Analysis {
