import { pharmaceutical-liability-calculator';Inputs, pharmaceutical-liability-calculator';Metrics, pharmaceutical-liability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: pharmaceutical-liability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: pharmaceutical-liability-calculator';Inputs, metrics: pharmaceutical-liability-calculator';Metrics): pharmaceutical-liability-calculator';Analysis {
