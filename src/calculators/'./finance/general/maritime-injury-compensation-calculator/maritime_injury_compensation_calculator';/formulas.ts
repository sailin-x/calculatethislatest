import { maritime_injury_compensation_calculator';Inputs, maritime_injury_compensation_calculator';Metrics, maritime_injury_compensation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: maritime_injury_compensation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: maritime_injury_compensation_calculator';Inputs, metrics: maritime_injury_compensation_calculator';Metrics): maritime_injury_compensation_calculator';Analysis {
