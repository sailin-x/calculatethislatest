import { class_action_settlement_calculator';Inputs, class_action_settlement_calculator';Metrics, class_action_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: class_action_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: class_action_settlement_calculator';Inputs, metrics: class_action_settlement_calculator';Metrics): class_action_settlement_calculator';Analysis {
