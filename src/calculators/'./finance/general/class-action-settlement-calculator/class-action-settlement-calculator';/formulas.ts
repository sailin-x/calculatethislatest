import { class-action-settlement-calculator';Inputs, class-action-settlement-calculator';Metrics, class-action-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: class-action-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: class-action-settlement-calculator';Inputs, metrics: class-action-settlement-calculator';Metrics): class-action-settlement-calculator';Analysis {
