import { corporate_bond_calculator';Inputs, corporate_bond_calculator';Metrics, corporate_bond_calculator';Analysis } from './types';
...
export function calculateResult(inputs: corporate_bond_calculator';Inputs): number {
...
export function generateAnalysis(inputs: corporate_bond_calculator';Inputs, metrics: corporate_bond_calculator';Metrics): corporate_bond_calculator';Analysis {
