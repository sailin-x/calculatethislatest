import { music-festival-profit-loss-p-l-calculator';Inputs, music-festival-profit-loss-p-l-calculator';Metrics, music-festival-profit-loss-p-l-calculator';Analysis } from './types';
...
export function calculateResult(inputs: music-festival-profit-loss-p-l-calculator';Inputs): number {
...
export function generateAnalysis(inputs: music-festival-profit-loss-p-l-calculator';Inputs, metrics: music-festival-profit-loss-p-l-calculator';Metrics): music-festival-profit-loss-p-l-calculator';Analysis {
