import { lapse-rate-sensitivity-analysis';Inputs, lapse-rate-sensitivity-analysis';Metrics, lapse-rate-sensitivity-analysis';Analysis } from './types';
...
export function calculateResult(inputs: lapse-rate-sensitivity-analysis';Inputs): number {
...
export function generateAnalysis(inputs: lapse-rate-sensitivity-analysis';Inputs, metrics: lapse-rate-sensitivity-analysis';Metrics): lapse-rate-sensitivity-analysis';Analysis {
