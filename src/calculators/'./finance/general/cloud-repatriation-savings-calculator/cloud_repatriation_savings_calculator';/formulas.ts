import { cloud_repatriation_savings_calculator';Inputs, cloud_repatriation_savings_calculator';Metrics, cloud_repatriation_savings_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cloud_repatriation_savings_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cloud_repatriation_savings_calculator';Inputs, metrics: cloud_repatriation_savings_calculator';Metrics): cloud_repatriation_savings_calculator';Analysis {
