import { garden-calculator';Inputs, garden-calculator';Metrics, garden-calculator';Analysis } from './types';
...
export function calculateResult(inputs: garden-calculator';Inputs): number {
...
export function generateAnalysis(inputs: garden-calculator';Inputs, metrics: garden-calculator';Metrics): garden-calculator';Analysis {
