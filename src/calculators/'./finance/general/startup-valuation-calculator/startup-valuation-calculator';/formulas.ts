import { startup-valuation-calculator';Inputs, startup-valuation-calculator';Metrics, startup-valuation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: startup-valuation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: startup-valuation-calculator';Inputs, metrics: startup-valuation-calculator';Metrics): startup-valuation-calculator';Analysis {
