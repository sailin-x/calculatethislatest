import { insulation-calculator';Inputs, insulation-calculator';Metrics, insulation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: insulation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: insulation-calculator';Inputs, metrics: insulation-calculator';Metrics): insulation-calculator';Analysis {
