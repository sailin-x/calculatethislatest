import { insulation_calculator';Inputs, insulation_calculator';Metrics, insulation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: insulation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: insulation_calculator';Inputs, metrics: insulation_calculator';Metrics): insulation_calculator';Analysis {
