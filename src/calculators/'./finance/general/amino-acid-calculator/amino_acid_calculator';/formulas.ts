import { amino_acid_calculator';Inputs, amino_acid_calculator';Metrics, amino_acid_calculator';Analysis } from './types';
...
export function calculateResult(inputs: amino_acid_calculator';Inputs): number {
...
export function generateAnalysis(inputs: amino_acid_calculator';Inputs, metrics: amino_acid_calculator';Metrics): amino_acid_calculator';Analysis {
