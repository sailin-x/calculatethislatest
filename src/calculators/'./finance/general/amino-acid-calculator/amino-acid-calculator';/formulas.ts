import { amino-acid-calculator';Inputs, amino-acid-calculator';Metrics, amino-acid-calculator';Analysis } from './types';
...
export function calculateResult(inputs: amino-acid-calculator';Inputs): number {
...
export function generateAnalysis(inputs: amino-acid-calculator';Inputs, metrics: amino-acid-calculator';Metrics): amino-acid-calculator';Analysis {
