import { car-accident-settlement-calculator';Inputs, car-accident-settlement-calculator';Metrics, car-accident-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: car-accident-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: car-accident-settlement-calculator';Inputs, metrics: car-accident-settlement-calculator';Metrics): car-accident-settlement-calculator';Analysis {
