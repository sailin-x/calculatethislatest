import { cyber-liability-insurance-calculator';Inputs, cyber-liability-insurance-calculator';Metrics, cyber-liability-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cyber-liability-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cyber-liability-insurance-calculator';Inputs, metrics: cyber-liability-insurance-calculator';Metrics): cyber-liability-insurance-calculator';Analysis {
