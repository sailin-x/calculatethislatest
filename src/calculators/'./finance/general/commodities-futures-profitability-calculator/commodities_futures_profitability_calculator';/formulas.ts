import { commodities_futures_profitability_calculator';Inputs, commodities_futures_profitability_calculator';Metrics, commodities_futures_profitability_calculator';Analysis } from './types';
...
export function calculateResult(inputs: commodities_futures_profitability_calculator';Inputs): number {
...
export function generateAnalysis(inputs: commodities_futures_profitability_calculator';Inputs, metrics: commodities_futures_profitability_calculator';Metrics): commodities_futures_profitability_calculator';Analysis {
