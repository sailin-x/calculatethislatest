import { comparable_company_analysis_calculator';Inputs, comparable_company_analysis_calculator';Metrics, comparable_company_analysis_calculator';Analysis } from './types';
...
export function calculateResult(inputs: comparable_company_analysis_calculator';Inputs): number {
...
export function generateAnalysis(inputs: comparable_company_analysis_calculator';Inputs, metrics: comparable_company_analysis_calculator';Metrics): comparable_company_analysis_calculator';Analysis {
