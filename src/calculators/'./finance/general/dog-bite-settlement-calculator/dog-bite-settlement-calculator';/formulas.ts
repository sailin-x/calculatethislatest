import { dog-bite-settlement-calculator';Inputs, dog-bite-settlement-calculator';Metrics, dog-bite-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: dog-bite-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: dog-bite-settlement-calculator';Inputs, metrics: dog-bite-settlement-calculator';Metrics): dog-bite-settlement-calculator';Analysis {
