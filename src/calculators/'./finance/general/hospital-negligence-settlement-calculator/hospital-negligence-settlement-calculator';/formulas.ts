import { hospital-negligence-settlement-calculator';Inputs, hospital-negligence-settlement-calculator';Metrics, hospital-negligence-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: hospital-negligence-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: hospital-negligence-settlement-calculator';Inputs, metrics: hospital-negligence-settlement-calculator';Metrics): hospital-negligence-settlement-calculator';Analysis {
