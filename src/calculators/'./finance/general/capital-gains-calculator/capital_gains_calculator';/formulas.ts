import { capital_gains_calculator';Inputs, capital_gains_calculator';Metrics, capital_gains_calculator';Analysis } from './types';
...
export function calculateResult(inputs: capital_gains_calculator';Inputs): number {
...
export function generateAnalysis(inputs: capital_gains_calculator';Inputs, metrics: capital_gains_calculator';Metrics): capital_gains_calculator';Analysis {
