import { pet_care_calculator';Inputs, pet_care_calculator';Metrics, pet_care_calculator';Analysis } from './types';
...
export function calculateResult(inputs: pet_care_calculator';Inputs): number {
...
export function generateAnalysis(inputs: pet_care_calculator';Inputs, metrics: pet_care_calculator';Metrics): pet_care_calculator';Analysis {
