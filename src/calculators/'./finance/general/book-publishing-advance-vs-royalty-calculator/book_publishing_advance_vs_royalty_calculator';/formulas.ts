import { book_publishing_advance_vs_royalty_calculator';Inputs, book_publishing_advance_vs_royalty_calculator';Metrics, book_publishing_advance_vs_royalty_calculator';Analysis } from './types';
...
export function calculateResult(inputs: book_publishing_advance_vs_royalty_calculator';Inputs): number {
...
export function generateAnalysis(inputs: book_publishing_advance_vs_royalty_calculator';Inputs, metrics: book_publishing_advance_vs_royalty_calculator';Metrics): book_publishing_advance_vs_royalty_calculator';Analysis {
