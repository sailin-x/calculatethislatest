import { profit-margin-calculator';Inputs, profit-margin-calculator';Metrics, profit-margin-calculator';Analysis } from './types';
...
export function calculateResult(inputs: profit-margin-calculator';Inputs): number {
...
export function generateAnalysis(inputs: profit-margin-calculator';Inputs, metrics: profit-margin-calculator';Metrics): profit-margin-calculator';Analysis {
