import { profit_margin_calculator';Inputs, profit_margin_calculator';Metrics, profit_margin_calculator';Analysis } from './types';
...
export function calculateResult(inputs: profit_margin_calculator';Inputs): number {
...
export function generateAnalysis(inputs: profit_margin_calculator';Inputs, metrics: profit_margin_calculator';Metrics): profit_margin_calculator';Analysis {
