import { technical-debt-calculator';Inputs, technical-debt-calculator';Metrics, technical-debt-calculator';Analysis } from './types';
...
export function calculateResult(inputs: technical-debt-calculator';Inputs): number {
...
export function generateAnalysis(inputs: technical-debt-calculator';Inputs, metrics: technical-debt-calculator';Metrics): technical-debt-calculator';Analysis {
