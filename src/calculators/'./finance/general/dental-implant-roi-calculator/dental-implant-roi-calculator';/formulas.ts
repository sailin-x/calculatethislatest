import { dental-implant-roi-calculator';Inputs, dental-implant-roi-calculator';Metrics, dental-implant-roi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: dental-implant-roi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: dental-implant-roi-calculator';Inputs, metrics: dental-implant-roi-calculator';Metrics): dental-implant-roi-calculator';Analysis {
