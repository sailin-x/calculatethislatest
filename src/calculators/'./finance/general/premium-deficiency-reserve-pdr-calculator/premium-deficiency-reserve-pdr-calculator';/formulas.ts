import { premium-deficiency-reserve-pdr-calculator';Inputs, premium-deficiency-reserve-pdr-calculator';Metrics, premium-deficiency-reserve-pdr-calculator';Analysis } from './types';
...
export function calculateResult(inputs: premium-deficiency-reserve-pdr-calculator';Inputs): number {
...
export function generateAnalysis(inputs: premium-deficiency-reserve-pdr-calculator';Inputs, metrics: premium-deficiency-reserve-pdr-calculator';Metrics): premium-deficiency-reserve-pdr-calculator';Analysis {
