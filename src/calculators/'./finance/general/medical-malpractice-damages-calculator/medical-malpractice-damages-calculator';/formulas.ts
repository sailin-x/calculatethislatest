import { medical-malpractice-damages-calculator';Inputs, medical-malpractice-damages-calculator';Metrics, medical-malpractice-damages-calculator';Analysis } from './types';
...
export function calculateResult(inputs: medical-malpractice-damages-calculator';Inputs): number {
...
export function generateAnalysis(inputs: medical-malpractice-damages-calculator';Inputs, metrics: medical-malpractice-damages-calculator';Metrics): medical-malpractice-damages-calculator';Analysis {
