import { directors_officers_insurance_calculator';Inputs, directors_officers_insurance_calculator';Metrics, directors_officers_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: directors_officers_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: directors_officers_insurance_calculator';Inputs, metrics: directors_officers_insurance_calculator';Metrics): directors_officers_insurance_calculator';Analysis {
