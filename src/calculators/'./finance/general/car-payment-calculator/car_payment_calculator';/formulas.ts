import { car_payment_calculator';Inputs, car_payment_calculator';Metrics, car_payment_calculator';Analysis } from './types';
...
export function calculateResult(inputs: car_payment_calculator';Inputs): number {
...
export function generateAnalysis(inputs: car_payment_calculator';Inputs, metrics: car_payment_calculator';Metrics): car_payment_calculator';Analysis {
