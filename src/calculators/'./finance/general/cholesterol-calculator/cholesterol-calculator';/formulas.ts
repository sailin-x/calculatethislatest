import { cholesterol-calculator';Inputs, cholesterol-calculator';Metrics, cholesterol-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cholesterol-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cholesterol-calculator';Inputs, metrics: cholesterol-calculator';Metrics): cholesterol-calculator';Analysis {
