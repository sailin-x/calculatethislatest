import { spinal-cord-injury-compensation-calculator';Inputs, spinal-cord-injury-compensation-calculator';Metrics, spinal-cord-injury-compensation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: spinal-cord-injury-compensation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: spinal-cord-injury-compensation-calculator';Inputs, metrics: spinal-cord-injury-compensation-calculator';Metrics): spinal-cord-injury-compensation-calculator';Analysis {
