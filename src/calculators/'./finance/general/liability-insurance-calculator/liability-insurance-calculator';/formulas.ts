import { liability-insurance-calculator';Inputs, liability-insurance-calculator';Metrics, liability-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: liability-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: liability-insurance-calculator';Inputs, metrics: liability-insurance-calculator';Metrics): liability-insurance-calculator';Analysis {
