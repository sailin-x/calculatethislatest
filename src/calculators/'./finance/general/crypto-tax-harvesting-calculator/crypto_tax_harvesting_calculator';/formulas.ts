import { crypto_tax_harvesting_calculator';Inputs, crypto_tax_harvesting_calculator';Metrics, crypto_tax_harvesting_calculator';Analysis } from './types';
...
export function calculateResult(inputs: crypto_tax_harvesting_calculator';Inputs): number {
...
export function generateAnalysis(inputs: crypto_tax_harvesting_calculator';Inputs, metrics: crypto_tax_harvesting_calculator';Metrics): crypto_tax_harvesting_calculator';Analysis {
