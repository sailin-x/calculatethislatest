import { price_fixing_overcharge_estimator';Inputs, price_fixing_overcharge_estimator';Metrics, price_fixing_overcharge_estimator';Analysis } from './types';
...
export function calculateResult(inputs: price_fixing_overcharge_estimator';Inputs): number {
...
export function generateAnalysis(inputs: price_fixing_overcharge_estimator';Inputs, metrics: price_fixing_overcharge_estimator';Metrics): price_fixing_overcharge_estimator';Analysis {
