import { price-fixing-overcharge-estimator';Inputs, price-fixing-overcharge-estimator';Metrics, price-fixing-overcharge-estimator';Analysis } from './types';
...
export function calculateResult(inputs: price-fixing-overcharge-estimator';Inputs): number {
...
export function generateAnalysis(inputs: price-fixing-overcharge-estimator';Inputs, metrics: price-fixing-overcharge-estimator';Metrics): price-fixing-overcharge-estimator';Analysis {
