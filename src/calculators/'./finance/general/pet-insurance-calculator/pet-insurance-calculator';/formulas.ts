import { pet-insurance-calculator';Inputs, pet-insurance-calculator';Metrics, pet-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: pet-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: pet-insurance-calculator';Inputs, metrics: pet-insurance-calculator';Metrics): pet-insurance-calculator';Analysis {
