import { equity_valuation_calculator';Inputs, equity_valuation_calculator';Metrics, equity_valuation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: equity_valuation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: equity_valuation_calculator';Inputs, metrics: equity_valuation_calculator';Metrics): equity_valuation_calculator';Analysis {
