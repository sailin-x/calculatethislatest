import { carried_interest_waterfall_model_calculator';Inputs, carried_interest_waterfall_model_calculator';Metrics, carried_interest_waterfall_model_calculator';Analysis } from './types';
...
export function calculateResult(inputs: carried_interest_waterfall_model_calculator';Inputs): number {
...
export function generateAnalysis(inputs: carried_interest_waterfall_model_calculator';Inputs, metrics: carried_interest_waterfall_model_calculator';Metrics): carried_interest_waterfall_model_calculator';Analysis {
