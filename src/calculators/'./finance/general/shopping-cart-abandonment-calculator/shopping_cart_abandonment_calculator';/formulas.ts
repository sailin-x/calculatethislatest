import { shopping_cart_abandonment_calculator';Inputs, shopping_cart_abandonment_calculator';Metrics, shopping_cart_abandonment_calculator';Analysis } from './types';
...
export function calculateResult(inputs: shopping_cart_abandonment_calculator';Inputs): number {
...
export function generateAnalysis(inputs: shopping_cart_abandonment_calculator';Inputs, metrics: shopping_cart_abandonment_calculator';Metrics): shopping_cart_abandonment_calculator';Analysis {
