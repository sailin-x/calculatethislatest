import { private_equity_irr_calculator';Inputs, private_equity_irr_calculator';Metrics, private_equity_irr_calculator';Analysis } from './types';
...
export function calculateResult(inputs: private_equity_irr_calculator';Inputs): number {
...
export function generateAnalysis(inputs: private_equity_irr_calculator';Inputs, metrics: private_equity_irr_calculator';Metrics): private_equity_irr_calculator';Analysis {
