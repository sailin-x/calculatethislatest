import { tax_loss_harvesting_calculator';Inputs, tax_loss_harvesting_calculator';Metrics, tax_loss_harvesting_calculator';Analysis } from './types';
...
export function calculateResult(inputs: tax_loss_harvesting_calculator';Inputs): number {
...
export function generateAnalysis(inputs: tax_loss_harvesting_calculator';Inputs, metrics: tax_loss_harvesting_calculator';Metrics): tax_loss_harvesting_calculator';Analysis {
