import { body_recomposition_calculator';Inputs, body_recomposition_calculator';Metrics, body_recomposition_calculator';Analysis } from './types';
...
export function calculateResult(inputs: body_recomposition_calculator';Inputs): number {
...
export function generateAnalysis(inputs: body_recomposition_calculator';Inputs, metrics: body_recomposition_calculator';Metrics): body_recomposition_calculator';Analysis {
