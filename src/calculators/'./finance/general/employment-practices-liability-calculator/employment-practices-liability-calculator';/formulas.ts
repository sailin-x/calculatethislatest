import { employment-practices-liability-calculator';Inputs, employment-practices-liability-calculator';Metrics, employment-practices-liability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: employment-practices-liability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: employment-practices-liability-calculator';Inputs, metrics: employment-practices-liability-calculator';Metrics): employment-practices-liability-calculator';Analysis {
