import { asphalt-calculator';Inputs, asphalt-calculator';Metrics, asphalt-calculator';Analysis } from './types';
...
export function calculateResult(inputs: asphalt-calculator';Inputs): number {
...
export function generateAnalysis(inputs: asphalt-calculator';Inputs, metrics: asphalt-calculator';Metrics): asphalt-calculator';Analysis {
