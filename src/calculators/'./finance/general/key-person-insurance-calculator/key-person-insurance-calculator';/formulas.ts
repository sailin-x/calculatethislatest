import { key-person-insurance-calculator';Inputs, key-person-insurance-calculator';Metrics, key-person-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: key-person-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: key-person-insurance-calculator';Inputs, metrics: key-person-insurance-calculator';Metrics): key-person-insurance-calculator';Analysis {
