import { body-frame-size-calculator';Inputs, body-frame-size-calculator';Metrics, body-frame-size-calculator';Analysis } from './types';
...
export function calculateResult(inputs: body-frame-size-calculator';Inputs): number {
...
export function generateAnalysis(inputs: body-frame-size-calculator';Inputs, metrics: body-frame-size-calculator';Metrics): body-frame-size-calculator';Analysis {
