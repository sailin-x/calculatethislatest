import { film-slate-financing-roi-calculator';Inputs, film-slate-financing-roi-calculator';Metrics, film-slate-financing-roi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: film-slate-financing-roi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: film-slate-financing-roi-calculator';Inputs, metrics: film-slate-financing-roi-calculator';Metrics): film-slate-financing-roi-calculator';Analysis {
