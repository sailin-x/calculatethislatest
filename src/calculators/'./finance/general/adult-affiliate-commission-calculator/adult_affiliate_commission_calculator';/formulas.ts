import { adult_affiliate_commission_calculator';Inputs, adult_affiliate_commission_calculator';Metrics, adult_affiliate_commission_calculator';Analysis } from './types';
...
export function calculateResult(inputs: adult_affiliate_commission_calculator';Inputs): number {
...
export function generateAnalysis(inputs: adult_affiliate_commission_calculator';Inputs, metrics: adult_affiliate_commission_calculator';Metrics): adult_affiliate_commission_calculator';Analysis {
