import { free-cash-flow-to-firm-fcff-valuation';Inputs, free-cash-flow-to-firm-fcff-valuation';Metrics, free-cash-flow-to-firm-fcff-valuation';Analysis } from './types';
...
export function calculateResult(inputs: free-cash-flow-to-firm-fcff-valuation';Inputs): number {
...
export function generateAnalysis(inputs: free-cash-flow-to-firm-fcff-valuation';Inputs, metrics: free-cash-flow-to-firm-fcff-valuation';Metrics): free-cash-flow-to-firm-fcff-valuation';Analysis {
