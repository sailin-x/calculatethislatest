import { podcast-sponsorship-calculator';Inputs, podcast-sponsorship-calculator';Metrics, podcast-sponsorship-calculator';Analysis } from './types';
...
export function calculateResult(inputs: podcast-sponsorship-calculator';Inputs): number {
...
export function generateAnalysis(inputs: podcast-sponsorship-calculator';Inputs, metrics: podcast-sponsorship-calculator';Metrics): podcast-sponsorship-calculator';Analysis {
