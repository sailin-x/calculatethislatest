import { incurred_but_not_reported_ibnr_reserve_estimator';Inputs, incurred_but_not_reported_ibnr_reserve_estimator';Metrics, incurred_but_not_reported_ibnr_reserve_estimator';Analysis } from './types';
...
export function calculateResult(inputs: incurred_but_not_reported_ibnr_reserve_estimator';Inputs): number {
...
export function generateAnalysis(inputs: incurred_but_not_reported_ibnr_reserve_estimator';Inputs, metrics: incurred_but_not_reported_ibnr_reserve_estimator';Metrics): incurred_but_not_reported_ibnr_reserve_estimator';Analysis {
