import { business_risk_assessment_calculator';Inputs, business_risk_assessment_calculator';Metrics, business_risk_assessment_calculator';Analysis } from './types';
...
export function calculateResult(inputs: business_risk_assessment_calculator';Inputs): number {
...
export function generateAnalysis(inputs: business_risk_assessment_calculator';Inputs, metrics: business_risk_assessment_calculator';Metrics): business_risk_assessment_calculator';Analysis {
