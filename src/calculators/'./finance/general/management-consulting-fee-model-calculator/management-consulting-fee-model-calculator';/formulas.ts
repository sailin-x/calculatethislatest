import { management-consulting-fee-model-calculator';Inputs, management-consulting-fee-model-calculator';Metrics, management-consulting-fee-model-calculator';Analysis } from './types';
...
export function calculateResult(inputs: management-consulting-fee-model-calculator';Inputs): number {
...
export function generateAnalysis(inputs: management-consulting-fee-model-calculator';Inputs, metrics: management-consulting-fee-model-calculator';Metrics): management-consulting-fee-model-calculator';Analysis {
