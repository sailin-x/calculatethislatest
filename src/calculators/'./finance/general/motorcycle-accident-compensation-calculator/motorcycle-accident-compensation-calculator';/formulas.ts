import { motorcycle-accident-compensation-calculator';Inputs, motorcycle-accident-compensation-calculator';Metrics, motorcycle-accident-compensation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: motorcycle-accident-compensation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: motorcycle-accident-compensation-calculator';Inputs, metrics: motorcycle-accident-compensation-calculator';Metrics): motorcycle-accident-compensation-calculator';Analysis {
