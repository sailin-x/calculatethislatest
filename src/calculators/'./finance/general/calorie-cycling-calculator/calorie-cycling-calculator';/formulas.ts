import { calorie-cycling-calculator';Inputs, calorie-cycling-calculator';Metrics, calorie-cycling-calculator';Analysis } from './types';
...
export function calculateResult(inputs: calorie-cycling-calculator';Inputs): number {
...
export function generateAnalysis(inputs: calorie-cycling-calculator';Inputs, metrics: calorie-cycling-calculator';Metrics): calorie-cycling-calculator';Analysis {
