import { quick_ratio_calculator';Inputs, quick_ratio_calculator';Metrics, quick_ratio_calculator';Analysis } from './types';
...
export function calculateResult(inputs: quick_ratio_calculator';Inputs): number {
...
export function generateAnalysis(inputs: quick_ratio_calculator';Inputs, metrics: quick_ratio_calculator';Metrics): quick_ratio_calculator';Analysis {
