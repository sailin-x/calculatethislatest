import { expense-ratio-calculator';Inputs, expense-ratio-calculator';Metrics, expense-ratio-calculator';Analysis } from './types';
...
export function calculateResult(inputs: expense-ratio-calculator';Inputs): number {
...
export function generateAnalysis(inputs: expense-ratio-calculator';Inputs, metrics: expense-ratio-calculator';Metrics): expense-ratio-calculator';Analysis {
