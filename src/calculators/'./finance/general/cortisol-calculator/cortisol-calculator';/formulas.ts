import { cortisol-calculator';Inputs, cortisol-calculator';Metrics, cortisol-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cortisol-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cortisol-calculator';Inputs, metrics: cortisol-calculator';Metrics): cortisol-calculator';Analysis {
