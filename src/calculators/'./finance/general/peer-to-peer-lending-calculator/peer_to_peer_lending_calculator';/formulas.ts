import { peer_to_peer_lending_calculator';Inputs, peer_to_peer_lending_calculator';Metrics, peer_to_peer_lending_calculator';Analysis } from './types';
...
export function calculateResult(inputs: peer_to_peer_lending_calculator';Inputs): number {
...
export function generateAnalysis(inputs: peer_to_peer_lending_calculator';Inputs, metrics: peer_to_peer_lending_calculator';Metrics): peer_to_peer_lending_calculator';Analysis {
