import { instagram-influencer-rate-calculator';Inputs, instagram-influencer-rate-calculator';Metrics, instagram-influencer-rate-calculator';Analysis } from './types';
...
export function calculateResult(inputs: instagram-influencer-rate-calculator';Inputs): number {
...
export function generateAnalysis(inputs: instagram-influencer-rate-calculator';Inputs, metrics: instagram-influencer-rate-calculator';Metrics): instagram-influencer-rate-calculator';Analysis {
