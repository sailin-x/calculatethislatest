import { car_loan_calculator';Inputs, car_loan_calculator';Metrics, car_loan_calculator';Analysis } from './types';
...
export function calculateResult(inputs: car_loan_calculator';Inputs): number {
...
export function generateAnalysis(inputs: car_loan_calculator';Inputs, metrics: car_loan_calculator';Metrics): car_loan_calculator';Analysis {
