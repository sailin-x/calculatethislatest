import { information_ratio_calculator';Inputs, information_ratio_calculator';Metrics, information_ratio_calculator';Analysis } from './types';
...
export function calculateResult(inputs: information_ratio_calculator';Inputs): number {
...
export function generateAnalysis(inputs: information_ratio_calculator';Inputs, metrics: information_ratio_calculator';Metrics): information_ratio_calculator';Analysis {
