import { chlorine-calculator';Inputs, chlorine-calculator';Metrics, chlorine-calculator';Analysis } from './types';
...
export function calculateResult(inputs: chlorine-calculator';Inputs): number {
...
export function generateAnalysis(inputs: chlorine-calculator';Inputs, metrics: chlorine-calculator';Metrics): chlorine-calculator';Analysis {
