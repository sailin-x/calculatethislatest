import { r_squared_calculator';Inputs, r_squared_calculator';Metrics, r_squared_calculator';Analysis } from './types';
...
export function calculateResult(inputs: r_squared_calculator';Inputs): number {
...
export function generateAnalysis(inputs: r_squared_calculator';Inputs, metrics: r_squared_calculator';Metrics): r_squared_calculator';Analysis {
