import { cloud_migration_tco_calculator';Inputs, cloud_migration_tco_calculator';Metrics, cloud_migration_tco_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cloud_migration_tco_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cloud_migration_tco_calculator';Inputs, metrics: cloud_migration_tco_calculator';Metrics): cloud_migration_tco_calculator';Analysis {
