import { split-dollar-life-insurance-calculator';Inputs, split-dollar-life-insurance-calculator';Metrics, split-dollar-life-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: split-dollar-life-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: split-dollar-life-insurance-calculator';Inputs, metrics: split-dollar-life-insurance-calculator';Metrics): split-dollar-life-insurance-calculator';Analysis {
