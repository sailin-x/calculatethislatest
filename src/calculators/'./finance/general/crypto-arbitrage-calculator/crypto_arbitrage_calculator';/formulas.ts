import { crypto_arbitrage_calculator';Inputs, crypto_arbitrage_calculator';Metrics, crypto_arbitrage_calculator';Analysis } from './types';
...
export function calculateResult(inputs: crypto_arbitrage_calculator';Inputs): number {
...
export function generateAnalysis(inputs: crypto_arbitrage_calculator';Inputs, metrics: crypto_arbitrage_calculator';Metrics): crypto_arbitrage_calculator';Analysis {
