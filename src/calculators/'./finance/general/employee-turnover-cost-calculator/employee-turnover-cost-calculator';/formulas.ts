import { employee-turnover-cost-calculator';Inputs, employee-turnover-cost-calculator';Metrics, employee-turnover-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: employee-turnover-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: employee-turnover-cost-calculator';Inputs, metrics: employee-turnover-cost-calculator';Metrics): employee-turnover-cost-calculator';Analysis {
