import { public_private_partnership_p3_roi_calculator';Inputs, public_private_partnership_p3_roi_calculator';Metrics, public_private_partnership_p3_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: public_private_partnership_p3_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: public_private_partnership_p3_roi_calculator';Inputs, metrics: public_private_partnership_p3_roi_calculator';Metrics): public_private_partnership_p3_roi_calculator';Analysis {
