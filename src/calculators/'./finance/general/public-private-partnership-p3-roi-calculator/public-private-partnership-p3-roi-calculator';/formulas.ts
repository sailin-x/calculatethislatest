import { public-private-partnership-p3-roi-calculator';Inputs, public-private-partnership-p3-roi-calculator';Metrics, public-private-partnership-p3-roi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: public-private-partnership-p3-roi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: public-private-partnership-p3-roi-calculator';Inputs, metrics: public-private-partnership-p3-roi-calculator';Metrics): public-private-partnership-p3-roi-calculator';Analysis {
