import { preference-payment-clawback-calculator';Inputs, preference-payment-clawback-calculator';Metrics, preference-payment-clawback-calculator';Analysis } from './types';
...
export function calculateResult(inputs: preference-payment-clawback-calculator';Inputs): number {
...
export function generateAnalysis(inputs: preference-payment-clawback-calculator';Inputs, metrics: preference-payment-clawback-calculator';Metrics): preference-payment-clawback-calculator';Analysis {
