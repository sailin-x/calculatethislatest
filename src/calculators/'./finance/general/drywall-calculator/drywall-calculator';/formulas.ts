import { drywall-calculator';Inputs, drywall-calculator';Metrics, drywall-calculator';Analysis } from './types';
...
export function calculateResult(inputs: drywall-calculator';Inputs): number {
...
export function generateAnalysis(inputs: drywall-calculator';Inputs, metrics: drywall-calculator';Metrics): drywall-calculator';Analysis {
