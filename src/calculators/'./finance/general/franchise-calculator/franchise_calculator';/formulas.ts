import { franchise_calculator';Inputs, franchise_calculator';Metrics, franchise_calculator';Analysis } from './types';
...
export function calculateResult(inputs: franchise_calculator';Inputs): number {
...
export function generateAnalysis(inputs: franchise_calculator';Inputs, metrics: franchise_calculator';Metrics): franchise_calculator';Analysis {
