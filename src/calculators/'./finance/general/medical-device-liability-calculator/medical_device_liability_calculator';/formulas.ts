import { medical_device_liability_calculator';Inputs, medical_device_liability_calculator';Metrics, medical_device_liability_calculator';Analysis } from './types';
...
export function calculateResult(inputs: medical_device_liability_calculator';Inputs): number {
...
export function generateAnalysis(inputs: medical_device_liability_calculator';Inputs, metrics: medical_device_liability_calculator';Metrics): medical_device_liability_calculator';Analysis {
