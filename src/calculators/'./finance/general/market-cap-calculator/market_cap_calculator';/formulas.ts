import { market_cap_calculator';Inputs, market_cap_calculator';Metrics, market_cap_calculator';Analysis } from './types';
...
export function calculateResult(inputs: market_cap_calculator';Inputs): number {
...
export function generateAnalysis(inputs: market_cap_calculator';Inputs, metrics: market_cap_calculator';Metrics): market_cap_calculator';Analysis {
