import { calorie-deficit-calculator';Inputs, calorie-deficit-calculator';Metrics, calorie-deficit-calculator';Analysis } from './types';
...
export function calculateResult(inputs: calorie-deficit-calculator';Inputs): number {
...
export function generateAnalysis(inputs: calorie-deficit-calculator';Inputs, metrics: calorie-deficit-calculator';Metrics): calorie-deficit-calculator';Analysis {
