import { marine-insurance-calculator';Inputs, marine-insurance-calculator';Metrics, marine-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: marine-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: marine-insurance-calculator';Inputs, metrics: marine-insurance-calculator';Metrics): marine-insurance-calculator';Analysis {
