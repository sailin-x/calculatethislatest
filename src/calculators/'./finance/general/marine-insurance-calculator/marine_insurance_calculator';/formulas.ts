import { marine_insurance_calculator';Inputs, marine_insurance_calculator';Metrics, marine_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: marine_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: marine_insurance_calculator';Inputs, metrics: marine_insurance_calculator';Metrics): marine_insurance_calculator';Analysis {
