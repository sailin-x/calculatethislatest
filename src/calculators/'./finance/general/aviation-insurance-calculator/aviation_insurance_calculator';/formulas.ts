import { aviation_insurance_calculator';Inputs, aviation_insurance_calculator';Metrics, aviation_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: aviation_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: aviation_insurance_calculator';Inputs, metrics: aviation_insurance_calculator';Metrics): aviation_insurance_calculator';Analysis {
