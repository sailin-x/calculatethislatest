import { aviation-insurance-calculator';Inputs, aviation-insurance-calculator';Metrics, aviation-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: aviation-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: aviation-insurance-calculator';Inputs, metrics: aviation-insurance-calculator';Metrics): aviation-insurance-calculator';Analysis {
