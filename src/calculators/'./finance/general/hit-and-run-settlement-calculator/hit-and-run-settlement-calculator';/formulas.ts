import { hit-and-run-settlement-calculator';Inputs, hit-and-run-settlement-calculator';Metrics, hit-and-run-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: hit-and-run-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: hit-and-run-settlement-calculator';Inputs, metrics: hit-and-run-settlement-calculator';Metrics): hit-and-run-settlement-calculator';Analysis {
