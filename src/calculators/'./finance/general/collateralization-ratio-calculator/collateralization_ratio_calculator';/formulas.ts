import { collateralization_ratio_calculator';Inputs, collateralization_ratio_calculator';Metrics, collateralization_ratio_calculator';Analysis } from './types';
...
export function calculateResult(inputs: collateralization_ratio_calculator';Inputs): number {
...
export function generateAnalysis(inputs: collateralization_ratio_calculator';Inputs, metrics: collateralization_ratio_calculator';Metrics): collateralization_ratio_calculator';Analysis {
