import { health_insurance_calculator';Inputs, health_insurance_calculator';Metrics, health_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: health_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: health_insurance_calculator';Inputs, metrics: health_insurance_calculator';Metrics): health_insurance_calculator';Analysis {
