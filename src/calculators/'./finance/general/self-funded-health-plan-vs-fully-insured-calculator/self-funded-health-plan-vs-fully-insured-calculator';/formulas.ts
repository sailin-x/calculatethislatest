import { self-funded-health-plan-vs-fully-insured-calculator';Inputs, self-funded-health-plan-vs-fully-insured-calculator';Metrics, self-funded-health-plan-vs-fully-insured-calculator';Analysis } from './types';
...
export function calculateResult(inputs: self-funded-health-plan-vs-fully-insured-calculator';Inputs): number {
...
export function generateAnalysis(inputs: self-funded-health-plan-vs-fully-insured-calculator';Inputs, metrics: self-funded-health-plan-vs-fully-insured-calculator';Metrics): self-funded-health-plan-vs-fully-insured-calculator';Analysis {
