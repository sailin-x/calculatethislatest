import { cost-per-hire-calculator';Inputs, cost-per-hire-calculator';Metrics, cost-per-hire-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cost-per-hire-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cost-per-hire-calculator';Inputs, metrics: cost-per-hire-calculator';Metrics): cost-per-hire-calculator';Analysis {
