import { cost_per_hire_calculator';Inputs, cost_per_hire_calculator';Metrics, cost_per_hire_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cost_per_hire_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cost_per_hire_calculator';Inputs, metrics: cost_per_hire_calculator';Metrics): cost_per_hire_calculator';Analysis {
