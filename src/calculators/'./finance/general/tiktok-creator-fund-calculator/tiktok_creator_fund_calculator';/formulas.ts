import { tiktok_creator_fund_calculator';Inputs, tiktok_creator_fund_calculator';Metrics, tiktok_creator_fund_calculator';Analysis } from './types';
...
export function calculateResult(inputs: tiktok_creator_fund_calculator';Inputs): number {
...
export function generateAnalysis(inputs: tiktok_creator_fund_calculator';Inputs, metrics: tiktok_creator_fund_calculator';Metrics): tiktok_creator_fund_calculator';Analysis {
