import { tiktok-creator-fund-calculator';Inputs, tiktok-creator-fund-calculator';Metrics, tiktok-creator-fund-calculator';Analysis } from './types';
...
export function calculateResult(inputs: tiktok-creator-fund-calculator';Inputs): number {
...
export function generateAnalysis(inputs: tiktok-creator-fund-calculator';Inputs, metrics: tiktok-creator-fund-calculator';Metrics): tiktok-creator-fund-calculator';Analysis {
