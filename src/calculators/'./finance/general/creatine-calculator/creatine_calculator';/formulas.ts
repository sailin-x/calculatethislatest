import { creatine_calculator';Inputs, creatine_calculator';Metrics, creatine_calculator';Analysis } from './types';
...
export function calculateResult(inputs: creatine_calculator';Inputs): number {
...
export function generateAnalysis(inputs: creatine_calculator';Inputs, metrics: creatine_calculator';Metrics): creatine_calculator';Analysis {
