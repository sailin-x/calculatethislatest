import { creatine-calculator';Inputs, creatine-calculator';Metrics, creatine-calculator';Analysis } from './types';
...
export function calculateResult(inputs: creatine-calculator';Inputs): number {
...
export function generateAnalysis(inputs: creatine-calculator';Inputs, metrics: creatine-calculator';Metrics): creatine-calculator';Analysis {
