import { retirement_abroad_calculator';Inputs, retirement_abroad_calculator';Metrics, retirement_abroad_calculator';Analysis } from './types';
...
export function calculateResult(inputs: retirement_abroad_calculator';Inputs): number {
...
export function generateAnalysis(inputs: retirement_abroad_calculator';Inputs, metrics: retirement_abroad_calculator';Metrics): retirement_abroad_calculator';Analysis {
