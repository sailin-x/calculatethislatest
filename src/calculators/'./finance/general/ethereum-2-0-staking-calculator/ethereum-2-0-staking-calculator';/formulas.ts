import { ethereum-2-0-staking-calculator';Inputs, ethereum-2-0-staking-calculator';Metrics, ethereum-2-0-staking-calculator';Analysis } from './types';
...
export function calculateResult(inputs: ethereum-2-0-staking-calculator';Inputs): number {
...
export function generateAnalysis(inputs: ethereum-2-0-staking-calculator';Inputs, metrics: ethereum-2-0-staking-calculator';Metrics): ethereum-2-0-staking-calculator';Analysis {
