import { asbestos_settlement_calculator';Inputs, asbestos_settlement_calculator';Metrics, asbestos_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: asbestos_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: asbestos_settlement_calculator';Inputs, metrics: asbestos_settlement_calculator';Metrics): asbestos_settlement_calculator';Analysis {
