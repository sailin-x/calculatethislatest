import { product_liability_insurance_calculator';Inputs, product_liability_insurance_calculator';Metrics, product_liability_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: product_liability_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: product_liability_insurance_calculator';Inputs, metrics: product_liability_insurance_calculator';Metrics): product_liability_insurance_calculator';Analysis {
