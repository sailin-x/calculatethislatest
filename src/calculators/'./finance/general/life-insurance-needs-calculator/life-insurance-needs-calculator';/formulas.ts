import { life-insurance-needs-calculator';Inputs, life-insurance-needs-calculator';Metrics, life-insurance-needs-calculator';Analysis } from './types';
...
export function calculateResult(inputs: life-insurance-needs-calculator';Inputs): number {
...
export function generateAnalysis(inputs: life-insurance-needs-calculator';Inputs, metrics: life-insurance-needs-calculator';Metrics): life-insurance-needs-calculator';Analysis {
