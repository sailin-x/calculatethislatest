import { medical_malpractice_settlement_calculator';Inputs, medical_malpractice_settlement_calculator';Metrics, medical_malpractice_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: medical_malpractice_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: medical_malpractice_settlement_calculator';Inputs, metrics: medical_malpractice_settlement_calculator';Metrics): medical_malpractice_settlement_calculator';Analysis {
