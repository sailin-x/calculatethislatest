import { drug_royalty_rate_calculator';Inputs, drug_royalty_rate_calculator';Metrics, drug_royalty_rate_calculator';Analysis } from './types';
...
export function calculateResult(inputs: drug_royalty_rate_calculator';Inputs): number {
...
export function generateAnalysis(inputs: drug_royalty_rate_calculator';Inputs, metrics: drug_royalty_rate_calculator';Metrics): drug_royalty_rate_calculator';Analysis {
