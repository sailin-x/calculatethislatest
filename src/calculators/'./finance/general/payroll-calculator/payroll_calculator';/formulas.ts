import { payroll_calculator';Inputs, payroll_calculator';Metrics, payroll_calculator';Analysis } from './types';
...
export function calculateResult(inputs: payroll_calculator';Inputs): number {
...
export function generateAnalysis(inputs: payroll_calculator';Inputs, metrics: payroll_calculator';Metrics): payroll_calculator';Analysis {
