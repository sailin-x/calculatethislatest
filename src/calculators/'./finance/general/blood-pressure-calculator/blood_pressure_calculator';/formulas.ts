import { blood_pressure_calculator';Inputs, blood_pressure_calculator';Metrics, blood_pressure_calculator';Analysis } from './types';
...
export function calculateResult(inputs: blood_pressure_calculator';Inputs): number {
...
export function generateAnalysis(inputs: blood_pressure_calculator';Inputs, metrics: blood_pressure_calculator';Metrics): blood_pressure_calculator';Analysis {
