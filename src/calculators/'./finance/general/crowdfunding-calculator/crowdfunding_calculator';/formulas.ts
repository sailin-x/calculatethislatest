import { crowdfunding_calculator';Inputs, crowdfunding_calculator';Metrics, crowdfunding_calculator';Analysis } from './types';
...
export function calculateResult(inputs: crowdfunding_calculator';Inputs): number {
...
export function generateAnalysis(inputs: crowdfunding_calculator';Inputs, metrics: crowdfunding_calculator';Metrics): crowdfunding_calculator';Analysis {
