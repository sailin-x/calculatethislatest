import { dialysis_center_profitability_calculator';Inputs, dialysis_center_profitability_calculator';Metrics, dialysis_center_profitability_calculator';Analysis } from './types';
...
export function calculateResult(inputs: dialysis_center_profitability_calculator';Inputs): number {
...
export function generateAnalysis(inputs: dialysis_center_profitability_calculator';Inputs, metrics: dialysis_center_profitability_calculator';Metrics): dialysis_center_profitability_calculator';Analysis {
