import { enterprise_value_calculator';Inputs, enterprise_value_calculator';Metrics, enterprise_value_calculator';Analysis } from './types';
...
export function calculateResult(inputs: enterprise_value_calculator';Inputs): number {
...
export function generateAnalysis(inputs: enterprise_value_calculator';Inputs, metrics: enterprise_value_calculator';Metrics): enterprise_value_calculator';Analysis {
