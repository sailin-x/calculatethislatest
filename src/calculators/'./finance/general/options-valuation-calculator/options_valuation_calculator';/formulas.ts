import { options_valuation_calculator';Inputs, options_valuation_calculator';Metrics, options_valuation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: options_valuation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: options_valuation_calculator';Inputs, metrics: options_valuation_calculator';Metrics): options_valuation_calculator';Analysis {
