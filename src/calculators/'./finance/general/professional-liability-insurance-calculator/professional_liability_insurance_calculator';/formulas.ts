import { professional_liability_insurance_calculator';Inputs, professional_liability_insurance_calculator';Metrics, professional_liability_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: professional_liability_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: professional_liability_insurance_calculator';Inputs, metrics: professional_liability_insurance_calculator';Metrics): professional_liability_insurance_calculator';Analysis {
