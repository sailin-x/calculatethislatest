import { professional-liability-insurance-calculator';Inputs, professional-liability-insurance-calculator';Metrics, professional-liability-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: professional-liability-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: professional-liability-insurance-calculator';Inputs, metrics: professional-liability-insurance-calculator';Metrics): professional-liability-insurance-calculator';Analysis {
