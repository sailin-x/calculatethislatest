import { dental_malpractice_settlement_calculator';Inputs, dental_malpractice_settlement_calculator';Metrics, dental_malpractice_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: dental_malpractice_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: dental_malpractice_settlement_calculator';Inputs, metrics: dental_malpractice_settlement_calculator';Metrics): dental_malpractice_settlement_calculator';Analysis {
