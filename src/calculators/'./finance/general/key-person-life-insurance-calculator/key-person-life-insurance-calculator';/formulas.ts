import { key-person-life-insurance-calculator';Inputs, key-person-life-insurance-calculator';Metrics, key-person-life-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: key-person-life-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: key-person-life-insurance-calculator';Inputs, metrics: key-person-life-insurance-calculator';Metrics): key-person-life-insurance-calculator';Analysis {
