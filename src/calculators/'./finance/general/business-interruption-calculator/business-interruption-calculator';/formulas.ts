import { business-interruption-calculator';Inputs, business-interruption-calculator';Metrics, business-interruption-calculator';Analysis } from './types';
...
export function calculateResult(inputs: business-interruption-calculator';Inputs): number {
...
export function generateAnalysis(inputs: business-interruption-calculator';Inputs, metrics: business-interruption-calculator';Metrics): business-interruption-calculator';Analysis {
