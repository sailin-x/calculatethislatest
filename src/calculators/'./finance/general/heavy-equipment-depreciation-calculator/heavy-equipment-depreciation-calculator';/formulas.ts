import { heavy-equipment-depreciation-calculator';Inputs, heavy-equipment-depreciation-calculator';Metrics, heavy-equipment-depreciation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: heavy-equipment-depreciation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: heavy-equipment-depreciation-calculator';Inputs, metrics: heavy-equipment-depreciation-calculator';Metrics): heavy-equipment-depreciation-calculator';Analysis {
