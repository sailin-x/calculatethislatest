import { terrorism_insurance_calculator';Inputs, terrorism_insurance_calculator';Metrics, terrorism_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: terrorism_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: terrorism_insurance_calculator';Inputs, metrics: terrorism_insurance_calculator';Metrics): terrorism_insurance_calculator';Analysis {
