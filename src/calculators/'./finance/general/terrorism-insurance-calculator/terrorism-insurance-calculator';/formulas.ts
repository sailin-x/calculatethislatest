import { terrorism-insurance-calculator';Inputs, terrorism-insurance-calculator';Metrics, terrorism-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: terrorism-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: terrorism-insurance-calculator';Inputs, metrics: terrorism-insurance-calculator';Metrics): terrorism-insurance-calculator';Analysis {
