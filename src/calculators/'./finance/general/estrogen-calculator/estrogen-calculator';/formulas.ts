import { estrogen-calculator';Inputs, estrogen-calculator';Metrics, estrogen-calculator';Analysis } from './types';
...
export function calculateResult(inputs: estrogen-calculator';Inputs): number {
...
export function generateAnalysis(inputs: estrogen-calculator';Inputs, metrics: estrogen-calculator';Metrics): estrogen-calculator';Analysis {
