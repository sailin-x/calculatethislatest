import { change-management-roi-calculator';Inputs, change-management-roi-calculator';Metrics, change-management-roi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: change-management-roi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: change-management-roi-calculator';Inputs, metrics: change-management-roi-calculator';Metrics): change-management-roi-calculator';Analysis {
