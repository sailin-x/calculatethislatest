import { internal_rate_of_return_calculator';Inputs, internal_rate_of_return_calculator';Metrics, internal_rate_of_return_calculator';Analysis } from './types';
...
export function calculateResult(inputs: internal_rate_of_return_calculator';Inputs): number {
...
export function generateAnalysis(inputs: internal_rate_of_return_calculator';Inputs, metrics: internal_rate_of_return_calculator';Metrics): internal_rate_of_return_calculator';Analysis {
