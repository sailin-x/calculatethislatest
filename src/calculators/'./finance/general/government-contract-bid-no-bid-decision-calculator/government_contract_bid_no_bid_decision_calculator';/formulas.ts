import { government_contract_bid_no_bid_decision_calculator';Inputs, government_contract_bid_no_bid_decision_calculator';Metrics, government_contract_bid_no_bid_decision_calculator';Analysis } from './types';
...
export function calculateResult(inputs: government_contract_bid_no_bid_decision_calculator';Inputs): number {
...
export function generateAnalysis(inputs: government_contract_bid_no_bid_decision_calculator';Inputs, metrics: government_contract_bid_no_bid_decision_calculator';Metrics): government_contract_bid_no_bid_decision_calculator';Analysis {
