import { data_breach_cost_calculator';Inputs, data_breach_cost_calculator';Metrics, data_breach_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: data_breach_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: data_breach_cost_calculator';Inputs, metrics: data_breach_cost_calculator';Metrics): data_breach_cost_calculator';Analysis {
