import { kidnap-ransom-insurance-calculator';Inputs, kidnap-ransom-insurance-calculator';Metrics, kidnap-ransom-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: kidnap-ransom-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: kidnap-ransom-insurance-calculator';Inputs, metrics: kidnap-ransom-insurance-calculator';Metrics): kidnap-ransom-insurance-calculator';Analysis {
