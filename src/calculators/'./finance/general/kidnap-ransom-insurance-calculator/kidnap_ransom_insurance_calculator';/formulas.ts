import { kidnap_ransom_insurance_calculator';Inputs, kidnap_ransom_insurance_calculator';Metrics, kidnap_ransom_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: kidnap_ransom_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: kidnap_ransom_insurance_calculator';Inputs, metrics: kidnap_ransom_insurance_calculator';Metrics): kidnap_ransom_insurance_calculator';Analysis {
