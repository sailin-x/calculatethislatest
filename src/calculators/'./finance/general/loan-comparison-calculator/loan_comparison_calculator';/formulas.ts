import { loan_comparison_calculator';Inputs, loan_comparison_calculator';Metrics, loan_comparison_calculator';Analysis } from './types';
...
export function calculateResult(inputs: loan_comparison_calculator';Inputs): number {
...
export function generateAnalysis(inputs: loan_comparison_calculator';Inputs, metrics: loan_comparison_calculator';Metrics): loan_comparison_calculator';Analysis {
