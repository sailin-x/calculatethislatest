import { distribution-waterfall-model-calculator';Inputs, distribution-waterfall-model-calculator';Metrics, distribution-waterfall-model-calculator';Analysis } from './types';
...
export function calculateResult(inputs: distribution-waterfall-model-calculator';Inputs): number {
...
export function generateAnalysis(inputs: distribution-waterfall-model-calculator';Inputs, metrics: distribution-waterfall-model-calculator';Metrics): distribution-waterfall-model-calculator';Analysis {
