import { ceding-commission-calculator';Inputs, ceding-commission-calculator';Metrics, ceding-commission-calculator';Analysis } from './types';
...
export function calculateResult(inputs: ceding-commission-calculator';Inputs): number {
...
export function generateAnalysis(inputs: ceding-commission-calculator';Inputs, metrics: ceding-commission-calculator';Metrics): ceding-commission-calculator';Analysis {
