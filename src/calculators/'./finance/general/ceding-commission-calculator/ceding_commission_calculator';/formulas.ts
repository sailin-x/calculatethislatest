import { ceding_commission_calculator';Inputs, ceding_commission_calculator';Metrics, ceding_commission_calculator';Analysis } from './types';
...
export function calculateResult(inputs: ceding_commission_calculator';Inputs): number {
...
export function generateAnalysis(inputs: ceding_commission_calculator';Inputs, metrics: ceding_commission_calculator';Metrics): ceding_commission_calculator';Analysis {
