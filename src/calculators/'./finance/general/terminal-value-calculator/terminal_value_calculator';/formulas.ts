import { terminal_value_calculator';Inputs, terminal_value_calculator';Metrics, terminal_value_calculator';Analysis } from './types';
...
export function calculateResult(inputs: terminal_value_calculator';Inputs): number {
...
export function generateAnalysis(inputs: terminal_value_calculator';Inputs, metrics: terminal_value_calculator';Metrics): terminal_value_calculator';Analysis {
