import { cost_of_equity_calculator';Inputs, cost_of_equity_calculator';Metrics, cost_of_equity_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cost_of_equity_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cost_of_equity_calculator';Inputs, metrics: cost_of_equity_calculator';Metrics): cost_of_equity_calculator';Analysis {
