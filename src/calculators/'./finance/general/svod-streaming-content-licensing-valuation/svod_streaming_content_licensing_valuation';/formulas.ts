import { svod_streaming_content_licensing_valuation';Inputs, svod_streaming_content_licensing_valuation';Metrics, svod_streaming_content_licensing_valuation';Analysis } from './types';
...
export function calculateResult(inputs: svod_streaming_content_licensing_valuation';Inputs): number {
...
export function generateAnalysis(inputs: svod_streaming_content_licensing_valuation';Inputs, metrics: svod_streaming_content_licensing_valuation';Metrics): svod_streaming_content_licensing_valuation';Analysis {
