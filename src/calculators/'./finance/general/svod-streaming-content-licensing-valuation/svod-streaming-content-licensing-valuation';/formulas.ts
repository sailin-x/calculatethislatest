import { svod-streaming-content-licensing-valuation';Inputs, svod-streaming-content-licensing-valuation';Metrics, svod-streaming-content-licensing-valuation';Analysis } from './types';
...
export function calculateResult(inputs: svod-streaming-content-licensing-valuation';Inputs): number {
...
export function generateAnalysis(inputs: svod-streaming-content-licensing-valuation';Inputs, metrics: svod-streaming-content-licensing-valuation';Metrics): svod-streaming-content-licensing-valuation';Analysis {
