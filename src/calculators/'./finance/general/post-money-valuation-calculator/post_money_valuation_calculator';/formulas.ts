import { post_money_valuation_calculator';Inputs, post_money_valuation_calculator';Metrics, post_money_valuation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: post_money_valuation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: post_money_valuation_calculator';Inputs, metrics: post_money_valuation_calculator';Metrics): post_money_valuation_calculator';Analysis {
