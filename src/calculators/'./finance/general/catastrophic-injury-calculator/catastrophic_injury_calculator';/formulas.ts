import { catastrophic_injury_calculator';Inputs, catastrophic_injury_calculator';Metrics, catastrophic_injury_calculator';Analysis } from './types';
...
export function calculateResult(inputs: catastrophic_injury_calculator';Inputs): number {
...
export function generateAnalysis(inputs: catastrophic_injury_calculator';Inputs, metrics: catastrophic_injury_calculator';Metrics): catastrophic_injury_calculator';Analysis {
