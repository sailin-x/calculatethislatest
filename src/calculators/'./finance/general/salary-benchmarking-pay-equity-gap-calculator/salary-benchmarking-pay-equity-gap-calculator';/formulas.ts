import { salary-benchmarking-pay-equity-gap-calculator';Inputs, salary-benchmarking-pay-equity-gap-calculator';Metrics, salary-benchmarking-pay-equity-gap-calculator';Analysis } from './types';
...
export function calculateResult(inputs: salary-benchmarking-pay-equity-gap-calculator';Inputs): number {
...
export function generateAnalysis(inputs: salary-benchmarking-pay-equity-gap-calculator';Inputs, metrics: salary-benchmarking-pay-equity-gap-calculator';Metrics): salary-benchmarking-pay-equity-gap-calculator';Analysis {
