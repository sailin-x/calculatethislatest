import { soc_2_compliance_cost_estimator';Inputs, soc_2_compliance_cost_estimator';Metrics, soc_2_compliance_cost_estimator';Analysis } from './types';
...
export function calculateResult(inputs: soc_2_compliance_cost_estimator';Inputs): number {
...
export function generateAnalysis(inputs: soc_2_compliance_cost_estimator';Inputs, metrics: soc_2_compliance_cost_estimator';Metrics): soc_2_compliance_cost_estimator';Analysis {
