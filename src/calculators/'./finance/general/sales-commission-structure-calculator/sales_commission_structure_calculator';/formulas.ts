import { sales_commission_structure_calculator';Inputs, sales_commission_structure_calculator';Metrics, sales_commission_structure_calculator';Analysis } from './types';
...
export function calculateResult(inputs: sales_commission_structure_calculator';Inputs): number {
...
export function generateAnalysis(inputs: sales_commission_structure_calculator';Inputs, metrics: sales_commission_structure_calculator';Metrics): sales_commission_structure_calculator';Analysis {
