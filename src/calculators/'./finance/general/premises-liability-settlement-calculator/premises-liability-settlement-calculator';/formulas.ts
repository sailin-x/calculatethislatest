import { premises-liability-settlement-calculator';Inputs, premises-liability-settlement-calculator';Metrics, premises-liability-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: premises-liability-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: premises-liability-settlement-calculator';Inputs, metrics: premises-liability-settlement-calculator';Metrics): premises-liability-settlement-calculator';Analysis {
