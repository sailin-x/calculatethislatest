import { marine-cargo-insurance-premium-calculator';Inputs, marine-cargo-insurance-premium-calculator';Metrics, marine-cargo-insurance-premium-calculator';Analysis } from './types';
...
export function calculateResult(inputs: marine-cargo-insurance-premium-calculator';Inputs): number {
...
export function generateAnalysis(inputs: marine-cargo-insurance-premium-calculator';Inputs, metrics: marine-cargo-insurance-premium-calculator';Metrics): marine-cargo-insurance-premium-calculator';Analysis {
