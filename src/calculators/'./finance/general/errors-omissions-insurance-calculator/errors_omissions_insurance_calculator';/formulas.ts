import { errors_omissions_insurance_calculator';Inputs, errors_omissions_insurance_calculator';Metrics, errors_omissions_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: errors_omissions_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: errors_omissions_insurance_calculator';Inputs, metrics: errors_omissions_insurance_calculator';Metrics): errors_omissions_insurance_calculator';Analysis {
