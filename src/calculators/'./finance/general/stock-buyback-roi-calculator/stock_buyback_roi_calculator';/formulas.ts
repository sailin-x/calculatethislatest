import { stock_buyback_roi_calculator';Inputs, stock_buyback_roi_calculator';Metrics, stock_buyback_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: stock_buyback_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: stock_buyback_roi_calculator';Inputs, metrics: stock_buyback_roi_calculator';Metrics): stock_buyback_roi_calculator';Analysis {
