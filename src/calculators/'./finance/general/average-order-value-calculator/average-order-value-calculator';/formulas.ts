import { average-order-value-calculator';Inputs, average-order-value-calculator';Metrics, average-order-value-calculator';Analysis } from './types';
...
export function calculateResult(inputs: average-order-value-calculator';Inputs): number {
...
export function generateAnalysis(inputs: average-order-value-calculator';Inputs, metrics: average-order-value-calculator';Metrics): average-order-value-calculator';Analysis {
