import { average_order_value_calculator';Inputs, average_order_value_calculator';Metrics, average_order_value_calculator';Analysis } from './types';
...
export function calculateResult(inputs: average_order_value_calculator';Inputs): number {
...
export function generateAnalysis(inputs: average_order_value_calculator';Inputs, metrics: average_order_value_calculator';Metrics): average_order_value_calculator';Analysis {
