import { food-combining-calculator';Inputs, food-combining-calculator';Metrics, food-combining-calculator';Analysis } from './types';
...
export function calculateResult(inputs: food-combining-calculator';Inputs): number {
...
export function generateAnalysis(inputs: food-combining-calculator';Inputs, metrics: food-combining-calculator';Metrics): food-combining-calculator';Analysis {
