import { food_combining_calculator';Inputs, food_combining_calculator';Metrics, food_combining_calculator';Analysis } from './types';
...
export function calculateResult(inputs: food_combining_calculator';Inputs): number {
...
export function generateAnalysis(inputs: food_combining_calculator';Inputs, metrics: food_combining_calculator';Metrics): food_combining_calculator';Analysis {
