import { mezzanine_financing_calculator';Inputs, mezzanine_financing_calculator';Metrics, mezzanine_financing_calculator';Analysis } from './types';
...
export function calculateResult(inputs: mezzanine_financing_calculator';Inputs): number {
...
export function generateAnalysis(inputs: mezzanine_financing_calculator';Inputs, metrics: mezzanine_financing_calculator';Metrics): mezzanine_financing_calculator';Analysis {
