import { home_improvement_calculator';Inputs, home_improvement_calculator';Metrics, home_improvement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: home_improvement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: home_improvement_calculator';Inputs, metrics: home_improvement_calculator';Metrics): home_improvement_calculator';Analysis {
