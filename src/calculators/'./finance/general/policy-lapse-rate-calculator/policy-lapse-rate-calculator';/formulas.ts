import { policy-lapse-rate-calculator';Inputs, policy-lapse-rate-calculator';Metrics, policy-lapse-rate-calculator';Analysis } from './types';
...
export function calculateResult(inputs: policy-lapse-rate-calculator';Inputs): number {
...
export function generateAnalysis(inputs: policy-lapse-rate-calculator';Inputs, metrics: policy-lapse-rate-calculator';Metrics): policy-lapse-rate-calculator';Analysis {
