import { policy_lapse_rate_calculator';Inputs, policy_lapse_rate_calculator';Metrics, policy_lapse_rate_calculator';Analysis } from './types';
...
export function calculateResult(inputs: policy_lapse_rate_calculator';Inputs): number {
...
export function generateAnalysis(inputs: policy_lapse_rate_calculator';Inputs, metrics: policy_lapse_rate_calculator';Metrics): policy_lapse_rate_calculator';Analysis {
