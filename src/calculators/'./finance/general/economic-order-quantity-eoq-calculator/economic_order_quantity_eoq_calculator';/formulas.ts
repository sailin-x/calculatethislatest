import { economic_order_quantity_eoq_calculator';Inputs, economic_order_quantity_eoq_calculator';Metrics, economic_order_quantity_eoq_calculator';Analysis } from './types';
...
export function calculateResult(inputs: economic_order_quantity_eoq_calculator';Inputs): number {
...
export function generateAnalysis(inputs: economic_order_quantity_eoq_calculator';Inputs, metrics: economic_order_quantity_eoq_calculator';Metrics): economic_order_quantity_eoq_calculator';Analysis {
