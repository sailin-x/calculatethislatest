import { management-fee-hurdle-rate-calculator';Inputs, management-fee-hurdle-rate-calculator';Metrics, management-fee-hurdle-rate-calculator';Analysis } from './types';
...
export function calculateResult(inputs: management-fee-hurdle-rate-calculator';Inputs): number {
...
export function generateAnalysis(inputs: management-fee-hurdle-rate-calculator';Inputs, metrics: management-fee-hurdle-rate-calculator';Metrics): management-fee-hurdle-rate-calculator';Analysis {
