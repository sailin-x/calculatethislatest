import { beta_calculator';Inputs, beta_calculator';Metrics, beta_calculator';Analysis } from './types';
...
export function calculateResult(inputs: beta_calculator';Inputs): number {
...
export function generateAnalysis(inputs: beta_calculator';Inputs, metrics: beta_calculator';Metrics): beta_calculator';Analysis {
