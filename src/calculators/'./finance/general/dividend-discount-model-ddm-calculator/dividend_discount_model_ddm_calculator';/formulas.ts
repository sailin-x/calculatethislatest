import { dividend_discount_model_ddm_calculator';Inputs, dividend_discount_model_ddm_calculator';Metrics, dividend_discount_model_ddm_calculator';Analysis } from './types';
...
export function calculateResult(inputs: dividend_discount_model_ddm_calculator';Inputs): number {
...
export function generateAnalysis(inputs: dividend_discount_model_ddm_calculator';Inputs, metrics: dividend_discount_model_ddm_calculator';Metrics): dividend_discount_model_ddm_calculator';Analysis {
