import { overall-equipment-effectiveness-oee-calculator';Inputs, overall-equipment-effectiveness-oee-calculator';Metrics, overall-equipment-effectiveness-oee-calculator';Analysis } from './types';
...
export function calculateResult(inputs: overall-equipment-effectiveness-oee-calculator';Inputs): number {
...
export function generateAnalysis(inputs: overall-equipment-effectiveness-oee-calculator';Inputs, metrics: overall-equipment-effectiveness-oee-calculator';Metrics): overall-equipment-effectiveness-oee-calculator';Analysis {
