import { maximum_drawdown_calculator';Inputs, maximum_drawdown_calculator';Metrics, maximum_drawdown_calculator';Analysis } from './types';
...
export function calculateResult(inputs: maximum_drawdown_calculator';Inputs): number {
...
export function generateAnalysis(inputs: maximum_drawdown_calculator';Inputs, metrics: maximum_drawdown_calculator';Metrics): maximum_drawdown_calculator';Analysis {
