import { paint-calculator';Inputs, paint-calculator';Metrics, paint-calculator';Analysis } from './types';
...
export function calculateResult(inputs: paint-calculator';Inputs): number {
...
export function generateAnalysis(inputs: paint-calculator';Inputs, metrics: paint-calculator';Metrics): paint-calculator';Analysis {
