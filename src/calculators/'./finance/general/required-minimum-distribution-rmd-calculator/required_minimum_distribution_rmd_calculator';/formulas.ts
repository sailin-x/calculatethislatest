import { required_minimum_distribution_rmd_calculator';Inputs, required_minimum_distribution_rmd_calculator';Metrics, required_minimum_distribution_rmd_calculator';Analysis } from './types';
...
export function calculateResult(inputs: required_minimum_distribution_rmd_calculator';Inputs): number {
...
export function generateAnalysis(inputs: required_minimum_distribution_rmd_calculator';Inputs, metrics: required_minimum_distribution_rmd_calculator';Metrics): required_minimum_distribution_rmd_calculator';Analysis {
