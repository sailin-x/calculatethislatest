import { iso-9001-certification-roi-calculator';Inputs, iso-9001-certification-roi-calculator';Metrics, iso-9001-certification-roi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: iso-9001-certification-roi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: iso-9001-certification-roi-calculator';Inputs, metrics: iso-9001-certification-roi-calculator';Metrics): iso-9001-certification-roi-calculator';Analysis {
