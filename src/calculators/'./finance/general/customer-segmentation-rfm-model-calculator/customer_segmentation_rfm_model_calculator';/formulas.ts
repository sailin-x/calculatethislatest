import { customer_segmentation_rfm_model_calculator';Inputs, customer_segmentation_rfm_model_calculator';Metrics, customer_segmentation_rfm_model_calculator';Analysis } from './types';
...
export function calculateResult(inputs: customer_segmentation_rfm_model_calculator';Inputs): number {
...
export function generateAnalysis(inputs: customer_segmentation_rfm_model_calculator';Inputs, metrics: customer_segmentation_rfm_model_calculator';Metrics): customer_segmentation_rfm_model_calculator';Analysis {
