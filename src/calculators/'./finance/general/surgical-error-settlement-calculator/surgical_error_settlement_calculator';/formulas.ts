import { surgical_error_settlement_calculator';Inputs, surgical_error_settlement_calculator';Metrics, surgical_error_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: surgical_error_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: surgical_error_settlement_calculator';Inputs, metrics: surgical_error_settlement_calculator';Metrics): surgical_error_settlement_calculator';Analysis {
