import { non-compete-agreement-buyout-calculator';Inputs, non-compete-agreement-buyout-calculator';Metrics, non-compete-agreement-buyout-calculator';Analysis } from './types';
...
export function calculateResult(inputs: non-compete-agreement-buyout-calculator';Inputs): number {
...
export function generateAnalysis(inputs: non-compete-agreement-buyout-calculator';Inputs, metrics: non-compete-agreement-buyout-calculator';Metrics): non-compete-agreement-buyout-calculator';Analysis {
