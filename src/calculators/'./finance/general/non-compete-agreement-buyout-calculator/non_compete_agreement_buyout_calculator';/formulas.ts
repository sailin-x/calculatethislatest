import { non_compete_agreement_buyout_calculator';Inputs, non_compete_agreement_buyout_calculator';Metrics, non_compete_agreement_buyout_calculator';Analysis } from './types';
...
export function calculateResult(inputs: non_compete_agreement_buyout_calculator';Inputs): number {
...
export function generateAnalysis(inputs: non_compete_agreement_buyout_calculator';Inputs, metrics: non_compete_agreement_buyout_calculator';Metrics): non_compete_agreement_buyout_calculator';Analysis {
