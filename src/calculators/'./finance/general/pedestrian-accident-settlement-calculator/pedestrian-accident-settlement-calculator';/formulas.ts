import { pedestrian-accident-settlement-calculator';Inputs, pedestrian-accident-settlement-calculator';Metrics, pedestrian-accident-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: pedestrian-accident-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: pedestrian-accident-settlement-calculator';Inputs, metrics: pedestrian-accident-settlement-calculator';Metrics): pedestrian-accident-settlement-calculator';Analysis {
