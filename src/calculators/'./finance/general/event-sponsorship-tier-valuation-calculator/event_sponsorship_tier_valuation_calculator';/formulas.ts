import { event_sponsorship_tier_valuation_calculator';Inputs, event_sponsorship_tier_valuation_calculator';Metrics, event_sponsorship_tier_valuation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: event_sponsorship_tier_valuation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: event_sponsorship_tier_valuation_calculator';Inputs, metrics: event_sponsorship_tier_valuation_calculator';Metrics): event_sponsorship_tier_valuation_calculator';Analysis {
