import { construction-accident-claims-calculator';Inputs, construction-accident-claims-calculator';Metrics, construction-accident-claims-calculator';Analysis } from './types';
...
export function calculateResult(inputs: construction-accident-claims-calculator';Inputs): number {
...
export function generateAnalysis(inputs: construction-accident-claims-calculator';Inputs, metrics: construction-accident-claims-calculator';Metrics): construction-accident-claims-calculator';Analysis {
