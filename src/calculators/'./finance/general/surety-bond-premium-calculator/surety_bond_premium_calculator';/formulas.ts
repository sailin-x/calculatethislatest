import { surety_bond_premium_calculator';Inputs, surety_bond_premium_calculator';Metrics, surety_bond_premium_calculator';Analysis } from './types';
...
export function calculateResult(inputs: surety_bond_premium_calculator';Inputs): number {
...
export function generateAnalysis(inputs: surety_bond_premium_calculator';Inputs, metrics: surety_bond_premium_calculator';Metrics): surety_bond_premium_calculator';Analysis {
