import { bad-faith-insurance-claim-calculator';Inputs, bad-faith-insurance-claim-calculator';Metrics, bad-faith-insurance-claim-calculator';Analysis } from './types';
...
export function calculateResult(inputs: bad-faith-insurance-claim-calculator';Inputs): number {
...
export function generateAnalysis(inputs: bad-faith-insurance-claim-calculator';Inputs, metrics: bad-faith-insurance-claim-calculator';Metrics): bad-faith-insurance-claim-calculator';Analysis {
