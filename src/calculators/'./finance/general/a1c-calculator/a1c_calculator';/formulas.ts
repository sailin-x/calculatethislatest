import { a1c_calculator';Inputs, a1c_calculator';Metrics, a1c_calculator';Analysis } from './types';
...
export function calculateResult(inputs: a1c_calculator';Inputs): number {
...
export function generateAnalysis(inputs: a1c_calculator';Inputs, metrics: a1c_calculator';Metrics): a1c_calculator';Analysis {
