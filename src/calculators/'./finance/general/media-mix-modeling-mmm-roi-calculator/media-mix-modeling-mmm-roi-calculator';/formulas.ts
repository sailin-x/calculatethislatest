import { media-mix-modeling-mmm-roi-calculator';Inputs, media-mix-modeling-mmm-roi-calculator';Metrics, media-mix-modeling-mmm-roi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: media-mix-modeling-mmm-roi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: media-mix-modeling-mmm-roi-calculator';Inputs, metrics: media-mix-modeling-mmm-roi-calculator';Metrics): media-mix-modeling-mmm-roi-calculator';Analysis {
