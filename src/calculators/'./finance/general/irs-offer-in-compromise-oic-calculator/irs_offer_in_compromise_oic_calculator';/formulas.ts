import { irs_offer_in_compromise_oic_calculator';Inputs, irs_offer_in_compromise_oic_calculator';Metrics, irs_offer_in_compromise_oic_calculator';Analysis } from './types';
...
export function calculateResult(inputs: irs_offer_in_compromise_oic_calculator';Inputs): number {
...
export function generateAnalysis(inputs: irs_offer_in_compromise_oic_calculator';Inputs, metrics: irs_offer_in_compromise_oic_calculator';Metrics): irs_offer_in_compromise_oic_calculator';Analysis {
