import { irs-offer-in-compromise-oic-calculator';Inputs, irs-offer-in-compromise-oic-calculator';Metrics, irs-offer-in-compromise-oic-calculator';Analysis } from './types';
...
export function calculateResult(inputs: irs-offer-in-compromise-oic-calculator';Inputs): number {
...
export function generateAnalysis(inputs: irs-offer-in-compromise-oic-calculator';Inputs, metrics: irs-offer-in-compromise-oic-calculator';Metrics): irs-offer-in-compromise-oic-calculator';Analysis {
