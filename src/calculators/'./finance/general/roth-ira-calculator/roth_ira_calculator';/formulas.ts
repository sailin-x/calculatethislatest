import { roth_ira_calculator';Inputs, roth_ira_calculator';Metrics, roth_ira_calculator';Analysis } from './types';
...
export function calculateResult(inputs: roth_ira_calculator';Inputs): number {
...
export function generateAnalysis(inputs: roth_ira_calculator';Inputs, metrics: roth_ira_calculator';Metrics): roth_ira_calculator';Analysis {
