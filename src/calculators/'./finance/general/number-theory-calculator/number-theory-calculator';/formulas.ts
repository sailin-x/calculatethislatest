import { number-theory-calculator';Inputs, number-theory-calculator';Metrics, number-theory-calculator';Analysis } from './types';
...
export function calculateResult(inputs: number-theory-calculator';Inputs): number {
...
export function generateAnalysis(inputs: number-theory-calculator';Inputs, metrics: number-theory-calculator';Metrics): number-theory-calculator';Analysis {
