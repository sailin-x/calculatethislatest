import { number_theory_calculator';Inputs, number_theory_calculator';Metrics, number_theory_calculator';Analysis } from './types';
...
export function calculateResult(inputs: number_theory_calculator';Inputs): number {
...
export function generateAnalysis(inputs: number_theory_calculator';Inputs, metrics: number_theory_calculator';Metrics): number_theory_calculator';Analysis {
