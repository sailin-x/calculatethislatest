import { private_equity_returns_calculator';Inputs, private_equity_returns_calculator';Metrics, private_equity_returns_calculator';Analysis } from './types';
...
export function calculateResult(inputs: private_equity_returns_calculator';Inputs): number {
...
export function generateAnalysis(inputs: private_equity_returns_calculator';Inputs, metrics: private_equity_returns_calculator';Metrics): private_equity_returns_calculator';Analysis {
