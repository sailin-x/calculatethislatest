import { intellectual-property-licensing-royalty-calculator';Inputs, intellectual-property-licensing-royalty-calculator';Metrics, intellectual-property-licensing-royalty-calculator';Analysis } from './types';
...
export function calculateResult(inputs: intellectual-property-licensing-royalty-calculator';Inputs): number {
...
export function generateAnalysis(inputs: intellectual-property-licensing-royalty-calculator';Inputs, metrics: intellectual-property-licensing-royalty-calculator';Metrics): intellectual-property-licensing-royalty-calculator';Analysis {
