import { roofing-calculator';Inputs, roofing-calculator';Metrics, roofing-calculator';Analysis } from './types';
...
export function calculateResult(inputs: roofing-calculator';Inputs): number {
...
export function generateAnalysis(inputs: roofing-calculator';Inputs, metrics: roofing-calculator';Metrics): roofing-calculator';Analysis {
