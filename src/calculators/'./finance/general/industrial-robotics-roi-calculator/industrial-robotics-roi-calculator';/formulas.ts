import { industrial-robotics-roi-calculator';Inputs, industrial-robotics-roi-calculator';Metrics, industrial-robotics-roi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: industrial-robotics-roi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: industrial-robotics-roi-calculator';Inputs, metrics: industrial-robotics-roi-calculator';Metrics): industrial-robotics-roi-calculator';Analysis {
