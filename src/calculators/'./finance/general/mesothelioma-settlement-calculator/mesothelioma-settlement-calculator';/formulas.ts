import { mesothelioma-settlement-calculator';Inputs, mesothelioma-settlement-calculator';Metrics, mesothelioma-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: mesothelioma-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: mesothelioma-settlement-calculator';Inputs, metrics: mesothelioma-settlement-calculator';Metrics): mesothelioma-settlement-calculator';Analysis {
