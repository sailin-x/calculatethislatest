import { medical-malpractice-insurance-calculator';Inputs, medical-malpractice-insurance-calculator';Metrics, medical-malpractice-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: medical-malpractice-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: medical-malpractice-insurance-calculator';Inputs, metrics: medical-malpractice-insurance-calculator';Metrics): medical-malpractice-insurance-calculator';Analysis {
