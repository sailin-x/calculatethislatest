import { medical_malpractice_insurance_calculator';Inputs, medical_malpractice_insurance_calculator';Metrics, medical_malpractice_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: medical_malpractice_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: medical_malpractice_insurance_calculator';Inputs, metrics: medical_malpractice_insurance_calculator';Metrics): medical_malpractice_insurance_calculator';Analysis {
