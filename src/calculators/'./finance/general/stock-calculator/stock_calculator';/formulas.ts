import { stock_calculator';Inputs, stock_calculator';Metrics, stock_calculator';Analysis } from './types';
...
export function calculateResult(inputs: stock_calculator';Inputs): number {
...
export function generateAnalysis(inputs: stock_calculator';Inputs, metrics: stock_calculator';Metrics): stock_calculator';Analysis {
