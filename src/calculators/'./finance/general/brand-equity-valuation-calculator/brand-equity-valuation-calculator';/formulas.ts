import { brand-equity-valuation-calculator';Inputs, brand-equity-valuation-calculator';Metrics, brand-equity-valuation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: brand-equity-valuation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: brand-equity-valuation-calculator';Inputs, metrics: brand-equity-valuation-calculator';Metrics): brand-equity-valuation-calculator';Analysis {
