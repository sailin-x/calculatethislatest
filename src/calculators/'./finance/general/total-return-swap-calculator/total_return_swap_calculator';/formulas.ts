import { total_return_swap_calculator';Inputs, total_return_swap_calculator';Metrics, total_return_swap_calculator';Analysis } from './types';
...
export function calculateResult(inputs: total_return_swap_calculator';Inputs): number {
...
export function generateAnalysis(inputs: total_return_swap_calculator';Inputs, metrics: total_return_swap_calculator';Metrics): total_return_swap_calculator';Analysis {
