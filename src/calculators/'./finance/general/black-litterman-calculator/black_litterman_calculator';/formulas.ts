import { black_litterman_calculator';Inputs, black_litterman_calculator';Metrics, black_litterman_calculator';Analysis } from './types';
...
export function calculateResult(inputs: black_litterman_calculator';Inputs): number {
...
export function generateAnalysis(inputs: black_litterman_calculator';Inputs, metrics: black_litterman_calculator';Metrics): black_litterman_calculator';Analysis {
