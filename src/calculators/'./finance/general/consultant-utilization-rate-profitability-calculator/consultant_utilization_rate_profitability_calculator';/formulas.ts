import { consultant_utilization_rate_profitability_calculator';Inputs, consultant_utilization_rate_profitability_calculator';Metrics, consultant_utilization_rate_profitability_calculator';Analysis } from './types';
...
export function calculateResult(inputs: consultant_utilization_rate_profitability_calculator';Inputs): number {
...
export function generateAnalysis(inputs: consultant_utilization_rate_profitability_calculator';Inputs, metrics: consultant_utilization_rate_profitability_calculator';Metrics): consultant_utilization_rate_profitability_calculator';Analysis {
