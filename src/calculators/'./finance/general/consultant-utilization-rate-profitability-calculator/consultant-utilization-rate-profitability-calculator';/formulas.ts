import { consultant-utilization-rate-profitability-calculator';Inputs, consultant-utilization-rate-profitability-calculator';Metrics, consultant-utilization-rate-profitability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: consultant-utilization-rate-profitability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: consultant-utilization-rate-profitability-calculator';Inputs, metrics: consultant-utilization-rate-profitability-calculator';Metrics): consultant-utilization-rate-profitability-calculator';Analysis {
