import { data_center_total_cost_of_ownership_tco_calculator';Inputs, data_center_total_cost_of_ownership_tco_calculator';Metrics, data_center_total_cost_of_ownership_tco_calculator';Analysis } from './types';
...
export function calculateResult(inputs: data_center_total_cost_of_ownership_tco_calculator';Inputs): number {
...
export function generateAnalysis(inputs: data_center_total_cost_of_ownership_tco_calculator';Inputs, metrics: data_center_total_cost_of_ownership_tco_calculator';Metrics): data_center_total_cost_of_ownership_tco_calculator';Analysis {
