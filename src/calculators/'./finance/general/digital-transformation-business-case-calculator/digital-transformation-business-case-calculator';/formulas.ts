import { digital-transformation-business-case-calculator';Inputs, digital-transformation-business-case-calculator';Metrics, digital-transformation-business-case-calculator';Analysis } from './types';
...
export function calculateResult(inputs: digital-transformation-business-case-calculator';Inputs): number {
...
export function generateAnalysis(inputs: digital-transformation-business-case-calculator';Inputs, metrics: digital-transformation-business-case-calculator';Metrics): digital-transformation-business-case-calculator';Analysis {
