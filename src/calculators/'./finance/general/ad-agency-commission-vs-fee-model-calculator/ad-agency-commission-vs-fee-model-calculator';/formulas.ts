import { ad-agency-commission-vs-fee-model-calculator';Inputs, ad-agency-commission-vs-fee-model-calculator';Metrics, ad-agency-commission-vs-fee-model-calculator';Analysis } from './types';
...
export function calculateResult(inputs: ad-agency-commission-vs-fee-model-calculator';Inputs): number {
...
export function generateAnalysis(inputs: ad-agency-commission-vs-fee-model-calculator';Inputs, metrics: ad-agency-commission-vs-fee-model-calculator';Metrics): ad-agency-commission-vs-fee-model-calculator';Analysis {
