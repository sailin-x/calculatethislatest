import { ad_agency_commission_vs_fee_model_calculator';Inputs, ad_agency_commission_vs_fee_model_calculator';Metrics, ad_agency_commission_vs_fee_model_calculator';Analysis } from './types';
...
export function calculateResult(inputs: ad_agency_commission_vs_fee_model_calculator';Inputs): number {
...
export function generateAnalysis(inputs: ad_agency_commission_vs_fee_model_calculator';Inputs, metrics: ad_agency_commission_vs_fee_model_calculator';Metrics): ad_agency_commission_vs_fee_model_calculator';Analysis {
