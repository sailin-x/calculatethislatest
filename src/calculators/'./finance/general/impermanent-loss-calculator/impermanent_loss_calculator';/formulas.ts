import { impermanent_loss_calculator';Inputs, impermanent_loss_calculator';Metrics, impermanent_loss_calculator';Analysis } from './types';
...
export function calculateResult(inputs: impermanent_loss_calculator';Inputs): number {
...
export function generateAnalysis(inputs: impermanent_loss_calculator';Inputs, metrics: impermanent_loss_calculator';Metrics): impermanent_loss_calculator';Analysis {
