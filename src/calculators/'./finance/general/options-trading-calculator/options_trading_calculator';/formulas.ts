import { options_trading_calculator';Inputs, options_trading_calculator';Metrics, options_trading_calculator';Analysis } from './types';
...
export function calculateResult(inputs: options_trading_calculator';Inputs): number {
...
export function generateAnalysis(inputs: options_trading_calculator';Inputs, metrics: options_trading_calculator';Metrics): options_trading_calculator';Analysis {
