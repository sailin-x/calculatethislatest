import { heart-rate-zone-calculator';Inputs, heart-rate-zone-calculator';Metrics, heart-rate-zone-calculator';Analysis } from './types';
...
export function calculateResult(inputs: heart-rate-zone-calculator';Inputs): number {
...
export function generateAnalysis(inputs: heart-rate-zone-calculator';Inputs, metrics: heart-rate-zone-calculator';Metrics): heart-rate-zone-calculator';Analysis {
