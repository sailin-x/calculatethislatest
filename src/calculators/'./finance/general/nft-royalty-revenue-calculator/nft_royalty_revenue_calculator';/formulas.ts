import { nft_royalty_revenue_calculator';Inputs, nft_royalty_revenue_calculator';Metrics, nft_royalty_revenue_calculator';Analysis } from './types';
...
export function calculateResult(inputs: nft_royalty_revenue_calculator';Inputs): number {
...
export function generateAnalysis(inputs: nft_royalty_revenue_calculator';Inputs, metrics: nft_royalty_revenue_calculator';Metrics): nft_royalty_revenue_calculator';Analysis {
