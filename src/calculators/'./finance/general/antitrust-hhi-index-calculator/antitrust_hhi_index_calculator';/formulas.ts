import { antitrust_hhi_index_calculator';Inputs, antitrust_hhi_index_calculator';Metrics, antitrust_hhi_index_calculator';Analysis } from './types';
...
export function calculateResult(inputs: antitrust_hhi_index_calculator';Inputs): number {
...
export function generateAnalysis(inputs: antitrust_hhi_index_calculator';Inputs, metrics: antitrust_hhi_index_calculator';Metrics): antitrust_hhi_index_calculator';Analysis {
