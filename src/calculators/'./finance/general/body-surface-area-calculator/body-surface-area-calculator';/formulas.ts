import { body-surface-area-calculator';Inputs, body-surface-area-calculator';Metrics, body-surface-area-calculator';Analysis } from './types';
...
export function calculateResult(inputs: body-surface-area-calculator';Inputs): number {
...
export function generateAnalysis(inputs: body-surface-area-calculator';Inputs, metrics: body-surface-area-calculator';Metrics): body-surface-area-calculator';Analysis {
