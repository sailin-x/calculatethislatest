import { hr_tech_stack_roi_calculator';Inputs, hr_tech_stack_roi_calculator';Metrics, hr_tech_stack_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: hr_tech_stack_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: hr_tech_stack_roi_calculator';Inputs, metrics: hr_tech_stack_roi_calculator';Metrics): hr_tech_stack_roi_calculator';Analysis {
