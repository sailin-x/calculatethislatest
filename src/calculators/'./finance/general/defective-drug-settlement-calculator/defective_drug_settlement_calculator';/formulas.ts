import { defective_drug_settlement_calculator';Inputs, defective_drug_settlement_calculator';Metrics, defective_drug_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: defective_drug_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: defective_drug_settlement_calculator';Inputs, metrics: defective_drug_settlement_calculator';Metrics): defective_drug_settlement_calculator';Analysis {
