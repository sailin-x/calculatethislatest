import { human-capital-due-diligence-m-a-calculator';Inputs, human-capital-due-diligence-m-a-calculator';Metrics, human-capital-due-diligence-m-a-calculator';Analysis } from './types';
...
export function calculateResult(inputs: human-capital-due-diligence-m-a-calculator';Inputs): number {
...
export function generateAnalysis(inputs: human-capital-due-diligence-m-a-calculator';Inputs, metrics: human-capital-due-diligence-m-a-calculator';Metrics): human-capital-due-diligence-m-a-calculator';Analysis {
