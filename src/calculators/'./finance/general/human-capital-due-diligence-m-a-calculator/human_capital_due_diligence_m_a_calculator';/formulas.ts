import { human_capital_due_diligence_m_a_calculator';Inputs, human_capital_due_diligence_m_a_calculator';Metrics, human_capital_due_diligence_m_a_calculator';Analysis } from './types';
...
export function calculateResult(inputs: human_capital_due_diligence_m_a_calculator';Inputs): number {
...
export function generateAnalysis(inputs: human_capital_due_diligence_m_a_calculator';Inputs, metrics: human_capital_due_diligence_m_a_calculator';Metrics): human_capital_due_diligence_m_a_calculator';Analysis {
