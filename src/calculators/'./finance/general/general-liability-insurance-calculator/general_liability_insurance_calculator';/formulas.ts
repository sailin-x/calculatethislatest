import { general_liability_insurance_calculator';Inputs, general_liability_insurance_calculator';Metrics, general_liability_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: general_liability_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: general_liability_insurance_calculator';Inputs, metrics: general_liability_insurance_calculator';Metrics): general_liability_insurance_calculator';Analysis {
