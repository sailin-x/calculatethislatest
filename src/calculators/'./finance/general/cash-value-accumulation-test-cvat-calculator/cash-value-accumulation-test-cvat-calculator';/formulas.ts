import { cash-value-accumulation-test-cvat-calculator';Inputs, cash-value-accumulation-test-cvat-calculator';Metrics, cash-value-accumulation-test-cvat-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cash-value-accumulation-test-cvat-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cash-value-accumulation-test-cvat-calculator';Inputs, metrics: cash-value-accumulation-test-cvat-calculator';Metrics): cash-value-accumulation-test-cvat-calculator';Analysis {
