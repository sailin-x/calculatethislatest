import { crypto_mining_profitability_calculator';Inputs, crypto_mining_profitability_calculator';Metrics, crypto_mining_profitability_calculator';Analysis } from './types';
...
export function calculateResult(inputs: crypto_mining_profitability_calculator';Inputs): number {
...
export function generateAnalysis(inputs: crypto_mining_profitability_calculator';Inputs, metrics: crypto_mining_profitability_calculator';Metrics): crypto_mining_profitability_calculator';Analysis {
