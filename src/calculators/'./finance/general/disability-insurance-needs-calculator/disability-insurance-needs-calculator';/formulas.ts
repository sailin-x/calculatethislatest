import { disability-insurance-needs-calculator';Inputs, disability-insurance-needs-calculator';Metrics, disability-insurance-needs-calculator';Analysis } from './types';
...
export function calculateResult(inputs: disability-insurance-needs-calculator';Inputs): number {
...
export function generateAnalysis(inputs: disability-insurance-needs-calculator';Inputs, metrics: disability-insurance-needs-calculator';Metrics): disability-insurance-needs-calculator';Analysis {
