import { combined-ratio-calculator';Inputs, combined-ratio-calculator';Metrics, combined-ratio-calculator';Analysis } from './types';
...
export function calculateResult(inputs: combined-ratio-calculator';Inputs): number {
...
export function generateAnalysis(inputs: combined-ratio-calculator';Inputs, metrics: combined-ratio-calculator';Metrics): combined-ratio-calculator';Analysis {
