import { business_insurance_calculator';Inputs, business_insurance_calculator';Metrics, business_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: business_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: business_insurance_calculator';Inputs, metrics: business_insurance_calculator';Metrics): business_insurance_calculator';Analysis {
