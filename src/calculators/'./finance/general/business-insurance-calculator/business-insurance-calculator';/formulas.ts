import { business-insurance-calculator';Inputs, business-insurance-calculator';Metrics, business-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: business-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: business-insurance-calculator';Inputs, metrics: business-insurance-calculator';Metrics): business-insurance-calculator';Analysis {
