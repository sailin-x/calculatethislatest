import { affiliate-marketing-roi-calculator';Inputs, affiliate-marketing-roi-calculator';Metrics, affiliate-marketing-roi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: affiliate-marketing-roi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: affiliate-marketing-roi-calculator';Inputs, metrics: affiliate-marketing-roi-calculator';Metrics): affiliate-marketing-roi-calculator';Analysis {
