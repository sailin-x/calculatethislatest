import { net-promoter-score-nps-calculator';Inputs, net-promoter-score-nps-calculator';Metrics, net-promoter-score-nps-calculator';Analysis } from './types';
...
export function calculateResult(inputs: net-promoter-score-nps-calculator';Inputs): number {
...
export function generateAnalysis(inputs: net-promoter-score-nps-calculator';Inputs, metrics: net-promoter-score-nps-calculator';Metrics): net-promoter-score-nps-calculator';Analysis {
