import { lean-manufacturing-takt-time-calculator';Inputs, lean-manufacturing-takt-time-calculator';Metrics, lean-manufacturing-takt-time-calculator';Analysis } from './types';
...
export function calculateResult(inputs: lean-manufacturing-takt-time-calculator';Inputs): number {
...
export function generateAnalysis(inputs: lean-manufacturing-takt-time-calculator';Inputs, metrics: lean-manufacturing-takt-time-calculator';Metrics): lean-manufacturing-takt-time-calculator';Analysis {
