import { restricted_stock_unit_rsu_vs_stock_option_calculator';Inputs, restricted_stock_unit_rsu_vs_stock_option_calculator';Metrics, restricted_stock_unit_rsu_vs_stock_option_calculator';Analysis } from './types';
...
export function calculateResult(inputs: restricted_stock_unit_rsu_vs_stock_option_calculator';Inputs): number {
...
export function generateAnalysis(inputs: restricted_stock_unit_rsu_vs_stock_option_calculator';Inputs, metrics: restricted_stock_unit_rsu_vs_stock_option_calculator';Metrics): restricted_stock_unit_rsu_vs_stock_option_calculator';Analysis {
