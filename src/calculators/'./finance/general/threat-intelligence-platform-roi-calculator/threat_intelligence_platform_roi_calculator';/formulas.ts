import { threat_intelligence_platform_roi_calculator';Inputs, threat_intelligence_platform_roi_calculator';Metrics, threat_intelligence_platform_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: threat_intelligence_platform_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: threat_intelligence_platform_roi_calculator';Inputs, metrics: threat_intelligence_platform_roi_calculator';Metrics): threat_intelligence_platform_roi_calculator';Analysis {
