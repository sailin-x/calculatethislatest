import { threat-intelligence-platform-roi-calculator';Inputs, threat-intelligence-platform-roi-calculator';Metrics, threat-intelligence-platform-roi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: threat-intelligence-platform-roi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: threat-intelligence-platform-roi-calculator';Inputs, metrics: threat-intelligence-platform-roi-calculator';Metrics): threat-intelligence-platform-roi-calculator';Analysis {
