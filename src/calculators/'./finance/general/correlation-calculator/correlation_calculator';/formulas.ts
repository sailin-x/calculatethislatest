import { correlation_calculator';Inputs, correlation_calculator';Metrics, correlation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: correlation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: correlation_calculator';Inputs, metrics: correlation_calculator';Metrics): correlation_calculator';Analysis {
