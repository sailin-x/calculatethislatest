import { patreon_subscription_calculator';Inputs, patreon_subscription_calculator';Metrics, patreon_subscription_calculator';Analysis } from './types';
...
export function calculateResult(inputs: patreon_subscription_calculator';Inputs): number {
...
export function generateAnalysis(inputs: patreon_subscription_calculator';Inputs, metrics: patreon_subscription_calculator';Metrics): patreon_subscription_calculator';Analysis {
