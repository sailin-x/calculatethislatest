import { capital-call-schedule-planner';Inputs, capital-call-schedule-planner';Metrics, capital-call-schedule-planner';Analysis } from './types';
...
export function calculateResult(inputs: capital-call-schedule-planner';Inputs): number {
...
export function generateAnalysis(inputs: capital-call-schedule-planner';Inputs, metrics: capital-call-schedule-planner';Metrics): capital-call-schedule-planner';Analysis {
