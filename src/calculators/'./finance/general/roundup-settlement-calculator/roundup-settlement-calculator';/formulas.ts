import { roundup-settlement-calculator';Inputs, roundup-settlement-calculator';Metrics, roundup-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: roundup-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: roundup-settlement-calculator';Inputs, metrics: roundup-settlement-calculator';Metrics): roundup-settlement-calculator';Analysis {
