import { roundup_settlement_calculator';Inputs, roundup_settlement_calculator';Metrics, roundup_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: roundup_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: roundup_settlement_calculator';Inputs, metrics: roundup_settlement_calculator';Metrics): roundup_settlement_calculator';Analysis {
