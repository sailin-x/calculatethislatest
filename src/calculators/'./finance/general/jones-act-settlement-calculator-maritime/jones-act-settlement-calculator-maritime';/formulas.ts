import { jones-act-settlement-calculator-maritime';Inputs, jones-act-settlement-calculator-maritime';Metrics, jones-act-settlement-calculator-maritime';Analysis } from './types';
...
export function calculateResult(inputs: jones-act-settlement-calculator-maritime';Inputs): number {
...
export function generateAnalysis(inputs: jones-act-settlement-calculator-maritime';Inputs, metrics: jones-act-settlement-calculator-maritime';Metrics): jones-act-settlement-calculator-maritime';Analysis {
