import { jones_act_settlement_calculator_maritime';Inputs, jones_act_settlement_calculator_maritime';Metrics, jones_act_settlement_calculator_maritime';Analysis } from './types';
...
export function calculateResult(inputs: jones_act_settlement_calculator_maritime';Inputs): number {
...
export function generateAnalysis(inputs: jones_act_settlement_calculator_maritime';Inputs, metrics: jones_act_settlement_calculator_maritime';Metrics): jones_act_settlement_calculator_maritime';Analysis {
