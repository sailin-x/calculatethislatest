import { clinical-trial-cost-estimator';Inputs, clinical-trial-cost-estimator';Metrics, clinical-trial-cost-estimator';Analysis } from './types';
...
export function calculateResult(inputs: clinical-trial-cost-estimator';Inputs): number {
...
export function generateAnalysis(inputs: clinical-trial-cost-estimator';Inputs, metrics: clinical-trial-cost-estimator';Metrics): clinical-trial-cost-estimator';Analysis {
