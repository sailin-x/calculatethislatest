import { clinical_trial_cost_estimator';Inputs, clinical_trial_cost_estimator';Metrics, clinical_trial_cost_estimator';Analysis } from './types';
...
export function calculateResult(inputs: clinical_trial_cost_estimator';Inputs): number {
...
export function generateAnalysis(inputs: clinical_trial_cost_estimator';Inputs, metrics: clinical_trial_cost_estimator';Metrics): clinical_trial_cost_estimator';Analysis {
