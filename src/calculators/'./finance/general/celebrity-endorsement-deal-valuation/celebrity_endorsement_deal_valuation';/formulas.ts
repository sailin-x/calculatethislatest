import { celebrity_endorsement_deal_valuation';Inputs, celebrity_endorsement_deal_valuation';Metrics, celebrity_endorsement_deal_valuation';Analysis } from './types';
...
export function calculateResult(inputs: celebrity_endorsement_deal_valuation';Inputs): number {
...
export function generateAnalysis(inputs: celebrity_endorsement_deal_valuation';Inputs, metrics: celebrity_endorsement_deal_valuation';Metrics): celebrity_endorsement_deal_valuation';Analysis {
