import { financial_alignment_calculator';Inputs, financial_alignment_calculator';Metrics, financial_alignment_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_alignment_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_alignment_calculator';Inputs, metrics: financial_alignment_calculator';Metrics): financial_alignment_calculator';Analysis {
