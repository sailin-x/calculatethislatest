import { financial-alignment-calculator';Inputs, financial-alignment-calculator';Metrics, financial-alignment-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-alignment-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-alignment-calculator';Inputs, metrics: financial-alignment-calculator';Metrics): financial-alignment-calculator';Analysis {
