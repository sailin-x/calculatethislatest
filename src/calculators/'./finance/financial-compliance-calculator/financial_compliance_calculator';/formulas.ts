import { financial_compliance_calculator';Inputs, financial_compliance_calculator';Metrics, financial_compliance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_compliance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_compliance_calculator';Inputs, metrics: financial_compliance_calculator';Metrics): financial_compliance_calculator';Analysis {
