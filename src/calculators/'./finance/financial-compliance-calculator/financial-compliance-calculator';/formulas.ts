import { financial-compliance-calculator';Inputs, financial-compliance-calculator';Metrics, financial-compliance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-compliance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-compliance-calculator';Inputs, metrics: financial-compliance-calculator';Metrics): financial-compliance-calculator';Analysis {
