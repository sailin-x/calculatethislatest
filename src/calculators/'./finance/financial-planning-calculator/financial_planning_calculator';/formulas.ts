import { financial_planning_calculator';Inputs, financial_planning_calculator';Metrics, financial_planning_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_planning_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_planning_calculator';Inputs, metrics: financial_planning_calculator';Metrics): financial_planning_calculator';Analysis {
