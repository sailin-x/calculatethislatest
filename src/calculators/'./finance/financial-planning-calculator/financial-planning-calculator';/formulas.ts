import { financial-planning-calculator';Inputs, financial-planning-calculator';Metrics, financial-planning-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-planning-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-planning-calculator';Inputs, metrics: financial-planning-calculator';Metrics): financial-planning-calculator';Analysis {
