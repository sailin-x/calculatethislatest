import { free-cash-flow-to-firm-calculator';Inputs, free-cash-flow-to-firm-calculator';Metrics, free-cash-flow-to-firm-calculator';Analysis } from './types';
...
export function calculateResult(inputs: free-cash-flow-to-firm-calculator';Inputs): number {
...
export function generateAnalysis(inputs: free-cash-flow-to-firm-calculator';Inputs, metrics: free-cash-flow-to-firm-calculator';Metrics): free-cash-flow-to-firm-calculator';Analysis {
