import { free_cash_flow_to_firm_calculator';Inputs, free_cash_flow_to_firm_calculator';Metrics, free_cash_flow_to_firm_calculator';Analysis } from './types';
...
export function calculateResult(inputs: free_cash_flow_to_firm_calculator';Inputs): number {
...
export function generateAnalysis(inputs: free_cash_flow_to_firm_calculator';Inputs, metrics: free_cash_flow_to_firm_calculator';Metrics): free_cash_flow_to_firm_calculator';Analysis {
