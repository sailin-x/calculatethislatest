import { real-estate-tax-deductions-calculator';Inputs, real-estate-tax-deductions-calculator';Metrics, real-estate-tax-deductions-calculator';Analysis } from './types';
...
export function calculateResult(inputs: real-estate-tax-deductions-calculator';Inputs): number {
...
export function generateAnalysis(inputs: real-estate-tax-deductions-calculator';Inputs, metrics: real-estate-tax-deductions-calculator';Metrics): real-estate-tax-deductions-calculator';Analysis {
