import { generation-skipping-transfer-gst-tax-calculator';Inputs, generation-skipping-transfer-gst-tax-calculator';Metrics, generation-skipping-transfer-gst-tax-calculator';Analysis } from './types';
...
export function calculateResult(inputs: generation-skipping-transfer-gst-tax-calculator';Inputs): number {
...
export function generateAnalysis(inputs: generation-skipping-transfer-gst-tax-calculator';Inputs, metrics: generation-skipping-transfer-gst-tax-calculator';Metrics): generation-skipping-transfer-gst-tax-calculator';Analysis {
