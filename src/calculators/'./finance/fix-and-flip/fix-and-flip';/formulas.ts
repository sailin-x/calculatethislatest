import { fix-and-flip';Inputs, fix-and-flip';Metrics, fix-and-flip';Analysis } from './types';
...
export function calculateResult(inputs: fix-and-flip';Inputs): number {
...
export function generateAnalysis(inputs: fix-and-flip';Inputs, metrics: fix-and-flip';Metrics): fix-and-flip';Analysis {
