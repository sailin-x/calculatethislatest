import { './finance/fix-and-flip/fix-and-flip';Inputs } from './types';

export function validateInputs(inputs: './finance/fix-and-flip/fix-and-flip';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
