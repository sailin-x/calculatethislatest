import { fix_and_flip';Inputs, fix_and_flip';Metrics, fix_and_flip';Analysis } from './types';
...
export function calculateResult(inputs: fix_and_flip';Inputs): number {
...
export function generateAnalysis(inputs: fix_and_flip';Inputs, metrics: fix_and_flip';Metrics): fix_and_flip';Analysis {
