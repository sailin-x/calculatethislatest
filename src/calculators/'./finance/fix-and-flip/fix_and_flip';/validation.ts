import { './finance/fix-and-flip/fix_and_flip';Inputs } from './types';

export function validateInputs(inputs: './finance/fix-and-flip/fix_and_flip';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
