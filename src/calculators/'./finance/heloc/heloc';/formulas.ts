import { heloc';Inputs, heloc';Metrics, heloc';Analysis } from './types';
...
export function calculateResult(inputs: heloc';Inputs): number {
...
export function generateAnalysis(inputs: heloc';Inputs, metrics: heloc';Metrics): heloc';Analysis {
