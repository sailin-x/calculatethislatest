import { './finance/mortgage-refinance';Inputs } from './types';

export function validateInputs(inputs: './finance/mortgage-refinance';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
