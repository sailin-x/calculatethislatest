import { asset-protection-trust-apt-value-calculator';Inputs, asset-protection-trust-apt-value-calculator';Metrics, asset-protection-trust-apt-value-calculator';Analysis } from './types';
...
export function calculateResult(inputs: asset-protection-trust-apt-value-calculator';Inputs): number {
...
export function generateAnalysis(inputs: asset-protection-trust-apt-value-calculator';Inputs, metrics: asset-protection-trust-apt-value-calculator';Metrics): asset-protection-trust-apt-value-calculator';Analysis {
