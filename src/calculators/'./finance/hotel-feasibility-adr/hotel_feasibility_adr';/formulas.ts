import { hotel_feasibility_adr';Inputs, hotel_feasibility_adr';Metrics, hotel_feasibility_adr';Analysis } from './types';
...
export function calculateResult(inputs: hotel_feasibility_adr';Inputs): number {
...
export function generateAnalysis(inputs: hotel_feasibility_adr';Inputs, metrics: hotel_feasibility_adr';Metrics): hotel_feasibility_adr';Analysis {
