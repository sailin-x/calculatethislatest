import { hotel-feasibility-adr';Inputs, hotel-feasibility-adr';Metrics, hotel-feasibility-adr';Analysis } from './types';
...
export function calculateResult(inputs: hotel-feasibility-adr';Inputs): number {
...
export function generateAnalysis(inputs: hotel-feasibility-adr';Inputs, metrics: hotel-feasibility-adr';Metrics): hotel-feasibility-adr';Analysis {
