import { self-storage-facility-roi-calculator';Inputs, self-storage-facility-roi-calculator';Metrics, self-storage-facility-roi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: self-storage-facility-roi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: self-storage-facility-roi-calculator';Inputs, metrics: self-storage-facility-roi-calculator';Metrics): self-storage-facility-roi-calculator';Analysis {
