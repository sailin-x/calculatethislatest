import { mortgage-closing-cost';Inputs, mortgage-closing-cost';Metrics, mortgage-closing-cost';Analysis } from './types';
...
export function calculateResult(inputs: mortgage-closing-cost';Inputs): number {
...
export function generateAnalysis(inputs: mortgage-closing-cost';Inputs, metrics: mortgage-closing-cost';Metrics): mortgage-closing-cost';Analysis {
