import { mortgage_closing_cost';Inputs, mortgage_closing_cost';Metrics, mortgage_closing_cost';Analysis } from './types';
...
export function calculateResult(inputs: mortgage_closing_cost';Inputs): number {
...
export function generateAnalysis(inputs: mortgage_closing_cost';Inputs, metrics: mortgage_closing_cost';Metrics): mortgage_closing_cost';Analysis {
