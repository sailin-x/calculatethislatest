import { annuity_buyout_calculator';Inputs, annuity_buyout_calculator';Metrics, annuity_buyout_calculator';Analysis } from './types';
...
export function calculateResult(inputs: annuity_buyout_calculator';Inputs): number {
...
export function generateAnalysis(inputs: annuity_buyout_calculator';Inputs, metrics: annuity_buyout_calculator';Metrics): annuity_buyout_calculator';Analysis {
