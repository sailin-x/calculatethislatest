import { property-tax-proration-calculator';Inputs, property-tax-proration-calculator';Metrics, property-tax-proration-calculator';Analysis } from './types';
...
export function calculateResult(inputs: property-tax-proration-calculator';Inputs): number {
...
export function generateAnalysis(inputs: property-tax-proration-calculator';Inputs, metrics: property-tax-proration-calculator';Metrics): property-tax-proration-calculator';Analysis {
