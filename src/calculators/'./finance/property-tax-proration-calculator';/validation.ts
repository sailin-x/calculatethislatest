import { './finance/property-tax-proration-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/property-tax-proration-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
