import { hoa-fee';Inputs, hoa-fee';Metrics, hoa-fee';Analysis } from './types';
...
export function calculateResult(inputs: hoa-fee';Inputs): number {
...
export function generateAnalysis(inputs: hoa-fee';Inputs, metrics: hoa-fee';Metrics): hoa-fee';Analysis {
