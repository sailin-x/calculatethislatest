import { hoa_fee';Inputs, hoa_fee';Metrics, hoa_fee';Analysis } from './types';
...
export function calculateResult(inputs: hoa_fee';Inputs): number {
...
export function generateAnalysis(inputs: hoa_fee';Inputs, metrics: hoa_fee';Metrics): hoa_fee';Analysis {
