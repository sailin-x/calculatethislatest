import { financial-consulting-calculator';Inputs, financial-consulting-calculator';Metrics, financial-consulting-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-consulting-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-consulting-calculator';Inputs, metrics: financial-consulting-calculator';Metrics): financial-consulting-calculator';Analysis {
