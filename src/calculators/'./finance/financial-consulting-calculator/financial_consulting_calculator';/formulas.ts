import { financial_consulting_calculator';Inputs, financial_consulting_calculator';Metrics, financial_consulting_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_consulting_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_consulting_calculator';Inputs, metrics: financial_consulting_calculator';Metrics): financial_consulting_calculator';Analysis {
