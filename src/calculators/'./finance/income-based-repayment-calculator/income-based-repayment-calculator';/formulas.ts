import { income-based-repayment-calculator';Inputs, income-based-repayment-calculator';Metrics, income-based-repayment-calculator';Analysis } from './types';
...
export function calculateResult(inputs: income-based-repayment-calculator';Inputs): number {
...
export function generateAnalysis(inputs: income-based-repayment-calculator';Inputs, metrics: income-based-repayment-calculator';Metrics): income-based-repayment-calculator';Analysis {
