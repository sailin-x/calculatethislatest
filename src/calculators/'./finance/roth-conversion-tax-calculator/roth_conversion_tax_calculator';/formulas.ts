import { roth_conversion_tax_calculator';Inputs, roth_conversion_tax_calculator';Metrics, roth_conversion_tax_calculator';Analysis } from './types';
...
export function calculateResult(inputs: roth_conversion_tax_calculator';Inputs): number {
...
export function generateAnalysis(inputs: roth_conversion_tax_calculator';Inputs, metrics: roth_conversion_tax_calculator';Metrics): roth_conversion_tax_calculator';Analysis {
