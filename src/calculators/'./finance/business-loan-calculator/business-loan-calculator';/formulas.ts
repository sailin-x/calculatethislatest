import { business-loan-calculator';Inputs, business-loan-calculator';Metrics, business-loan-calculator';Analysis } from './types';
...
export function calculateResult(inputs: business-loan-calculator';Inputs): number {
...
export function generateAnalysis(inputs: business-loan-calculator';Inputs, metrics: business-loan-calculator';Metrics): business-loan-calculator';Analysis {
