import { business_loan_calculator';Inputs, business_loan_calculator';Metrics, business_loan_calculator';Analysis } from './types';
...
export function calculateResult(inputs: business_loan_calculator';Inputs): number {
...
export function generateAnalysis(inputs: business_loan_calculator';Inputs, metrics: business_loan_calculator';Metrics): business_loan_calculator';Analysis {
