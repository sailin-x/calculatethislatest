import { credit_card_payoff_calculator';Inputs, credit_card_payoff_calculator';Metrics, credit_card_payoff_calculator';Analysis } from './types';
...
export function calculateResult(inputs: credit_card_payoff_calculator';Inputs): number {
...
export function generateAnalysis(inputs: credit_card_payoff_calculator';Inputs, metrics: credit_card_payoff_calculator';Metrics): credit_card_payoff_calculator';Analysis {
