import { credit-card-payoff-calculator';Inputs, credit-card-payoff-calculator';Metrics, credit-card-payoff-calculator';Analysis } from './types';
...
export function calculateResult(inputs: credit-card-payoff-calculator';Inputs): number {
...
export function generateAnalysis(inputs: credit-card-payoff-calculator';Inputs, metrics: credit-card-payoff-calculator';Metrics): credit-card-payoff-calculator';Analysis {
