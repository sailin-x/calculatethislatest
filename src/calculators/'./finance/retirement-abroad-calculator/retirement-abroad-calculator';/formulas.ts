import { retirement-abroad-calculator';Inputs, retirement-abroad-calculator';Metrics, retirement-abroad-calculator';Analysis } from './types';
...
export function calculateResult(inputs: retirement-abroad-calculator';Inputs): number {
...
export function generateAnalysis(inputs: retirement-abroad-calculator';Inputs, metrics: retirement-abroad-calculator';Metrics): retirement-abroad-calculator';Analysis {
