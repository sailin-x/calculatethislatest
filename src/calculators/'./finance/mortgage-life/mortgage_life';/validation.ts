import { './finance/mortgage-life/mortgage_life';Inputs } from './types';

export function validateInputs(inputs: './finance/mortgage-life/mortgage_life';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
