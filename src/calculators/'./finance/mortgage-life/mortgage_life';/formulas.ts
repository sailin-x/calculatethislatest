import { mortgage_life';Inputs, mortgage_life';Metrics, mortgage_life';Analysis } from './types';
...
export function calculateResult(inputs: mortgage_life';Inputs): number {
...
export function generateAnalysis(inputs: mortgage_life';Inputs, metrics: mortgage_life';Metrics): mortgage_life';Analysis {
