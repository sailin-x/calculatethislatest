import { './finance/mortgage-life/mortgage-life';Inputs } from './types';

export function validateInputs(inputs: './finance/mortgage-life/mortgage-life';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
