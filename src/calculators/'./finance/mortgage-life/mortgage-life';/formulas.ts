import { mortgage-life';Inputs, mortgage-life';Metrics, mortgage-life';Analysis } from './types';
...
export function calculateResult(inputs: mortgage-life';Inputs): number {
...
export function generateAnalysis(inputs: mortgage-life';Inputs, metrics: mortgage-life';Metrics): mortgage-life';Analysis {
