import { rights_offering_calculator';Inputs, rights_offering_calculator';Metrics, rights_offering_calculator';Analysis } from './types';
...
export function calculateResult(inputs: rights_offering_calculator';Inputs): number {
...
export function generateAnalysis(inputs: rights_offering_calculator';Inputs, metrics: rights_offering_calculator';Metrics): rights_offering_calculator';Analysis {
