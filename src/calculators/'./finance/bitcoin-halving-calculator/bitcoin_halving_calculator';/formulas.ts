import { bitcoin_halving_calculator';Inputs, bitcoin_halving_calculator';Metrics, bitcoin_halving_calculator';Analysis } from './types';
...
export function calculateResult(inputs: bitcoin_halving_calculator';Inputs): number {
...
export function generateAnalysis(inputs: bitcoin_halving_calculator';Inputs, metrics: bitcoin_halving_calculator';Metrics): bitcoin_halving_calculator';Analysis {
