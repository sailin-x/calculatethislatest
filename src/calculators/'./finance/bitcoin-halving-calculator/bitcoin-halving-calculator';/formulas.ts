import { bitcoin-halving-calculator';Inputs, bitcoin-halving-calculator';Metrics, bitcoin-halving-calculator';Analysis } from './types';
...
export function calculateResult(inputs: bitcoin-halving-calculator';Inputs): number {
...
export function generateAnalysis(inputs: bitcoin-halving-calculator';Inputs, metrics: bitcoin-halving-calculator';Metrics): bitcoin-halving-calculator';Analysis {
