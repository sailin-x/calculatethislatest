import { tenant-improvement-ti-allowance-calculator';Inputs, tenant-improvement-ti-allowance-calculator';Metrics, tenant-improvement-ti-allowance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: tenant-improvement-ti-allowance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: tenant-improvement-ti-allowance-calculator';Inputs, metrics: tenant-improvement-ti-allowance-calculator';Metrics): tenant-improvement-ti-allowance-calculator';Analysis {
