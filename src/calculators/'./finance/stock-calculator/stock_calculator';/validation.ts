import { './finance/stock-calculator/stock_calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/stock-calculator/stock_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
