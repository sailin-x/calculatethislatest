import { './finance/stock-calculator/stock-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/stock-calculator/stock-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
