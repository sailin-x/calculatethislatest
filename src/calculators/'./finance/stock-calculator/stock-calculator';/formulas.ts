import { stock-calculator';Inputs, stock-calculator';Metrics, stock-calculator';Analysis } from './types';
...
export function calculateResult(inputs: stock-calculator';Inputs): number {
...
export function generateAnalysis(inputs: stock-calculator';Inputs, metrics: stock-calculator';Metrics): stock-calculator';Analysis {
