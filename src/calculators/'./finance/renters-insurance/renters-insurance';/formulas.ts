import { renters-insurance';Inputs, renters-insurance';Metrics, renters-insurance';Analysis } from './types';
...
export function calculateResult(inputs: renters-insurance';Inputs): number {
...
export function generateAnalysis(inputs: renters-insurance';Inputs, metrics: renters-insurance';Metrics): renters-insurance';Analysis {
