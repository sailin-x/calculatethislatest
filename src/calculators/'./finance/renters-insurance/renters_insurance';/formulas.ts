import { renters_insurance';Inputs, renters_insurance';Metrics, renters_insurance';Analysis } from './types';
...
export function calculateResult(inputs: renters_insurance';Inputs): number {
...
export function generateAnalysis(inputs: renters_insurance';Inputs, metrics: renters_insurance';Metrics): renters_insurance';Analysis {
