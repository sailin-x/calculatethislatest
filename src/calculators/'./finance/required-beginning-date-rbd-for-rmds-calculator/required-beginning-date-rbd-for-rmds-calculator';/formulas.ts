import { required-beginning-date-rbd-for-rmds-calculator';Inputs, required-beginning-date-rbd-for-rmds-calculator';Metrics, required-beginning-date-rbd-for-rmds-calculator';Analysis } from './types';
...
export function calculateResult(inputs: required-beginning-date-rbd-for-rmds-calculator';Inputs): number {
...
export function generateAnalysis(inputs: required-beginning-date-rbd-for-rmds-calculator';Inputs, metrics: required-beginning-date-rbd-for-rmds-calculator';Metrics): required-beginning-date-rbd-for-rmds-calculator';Analysis {
