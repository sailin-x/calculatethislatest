import { collateralization-ratio-calculator';Inputs, collateralization-ratio-calculator';Metrics, collateralization-ratio-calculator';Analysis } from './types';
...
export function calculateResult(inputs: collateralization-ratio-calculator';Inputs): number {
...
export function generateAnalysis(inputs: collateralization-ratio-calculator';Inputs, metrics: collateralization-ratio-calculator';Metrics): collateralization-ratio-calculator';Analysis {
