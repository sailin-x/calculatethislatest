import { './finance/rent-vs-buy/rent_vs_buy';Inputs } from './types';

export function validateInputs(inputs: './finance/rent-vs-buy/rent_vs_buy';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
