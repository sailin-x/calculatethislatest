import { rent_vs_buy';Inputs, rent_vs_buy';Metrics, rent_vs_buy';Analysis } from './types';
...
export function calculateResult(inputs: rent_vs_buy';Inputs): number {
...
export function generateAnalysis(inputs: rent_vs_buy';Inputs, metrics: rent_vs_buy';Metrics): rent_vs_buy';Analysis {
