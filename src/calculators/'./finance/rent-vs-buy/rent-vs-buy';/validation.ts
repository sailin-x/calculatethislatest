import { './finance/rent-vs-buy/rent-vs-buy';Inputs } from './types';

export function validateInputs(inputs: './finance/rent-vs-buy/rent-vs-buy';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
