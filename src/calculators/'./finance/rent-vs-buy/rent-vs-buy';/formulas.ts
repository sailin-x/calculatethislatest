import { rent-vs-buy';Inputs, rent-vs-buy';Metrics, rent-vs-buy';Analysis } from './types';
...
export function calculateResult(inputs: rent-vs-buy';Inputs): number {
...
export function generateAnalysis(inputs: rent-vs-buy';Inputs, metrics: rent-vs-buy';Metrics): rent-vs-buy';Analysis {
