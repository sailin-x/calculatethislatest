import { './finance/college-savings/college-savings';Inputs } from './types';

export function validateInputs(inputs: './finance/college-savings/college-savings';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
