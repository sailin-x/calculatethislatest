import { college-savings';Inputs, college-savings';Metrics, college-savings';Analysis } from './types';
...
export function calculateResult(inputs: college-savings';Inputs): number {
...
export function generateAnalysis(inputs: college-savings';Inputs, metrics: college-savings';Metrics): college-savings';Analysis {
