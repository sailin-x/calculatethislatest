import { college_savings';Inputs, college_savings';Metrics, college_savings';Analysis } from './types';
...
export function calculateResult(inputs: college_savings';Inputs): number {
...
export function generateAnalysis(inputs: college_savings';Inputs, metrics: college_savings';Metrics): college_savings';Analysis {
