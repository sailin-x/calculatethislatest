import { './finance/college-savings/college_savings';Inputs } from './types';

export function validateInputs(inputs: './finance/college-savings/college_savings';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
