import { construction-loan';Inputs, construction-loan';Metrics, construction-loan';Analysis } from './types';
...
export function calculateResult(inputs: construction-loan';Inputs): number {
...
export function generateAnalysis(inputs: construction-loan';Inputs, metrics: construction-loan';Metrics): construction-loan';Analysis {
