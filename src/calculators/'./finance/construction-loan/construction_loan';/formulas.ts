import { construction_loan';Inputs, construction_loan';Metrics, construction_loan';Analysis } from './types';
...
export function calculateResult(inputs: construction_loan';Inputs): number {
...
export function generateAnalysis(inputs: construction_loan';Inputs, metrics: construction_loan';Metrics): construction_loan';Analysis {
