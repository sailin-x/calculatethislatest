import { fixed_index_annuity_calculator';Inputs, fixed_index_annuity_calculator';Metrics, fixed_index_annuity_calculator';Analysis } from './types';
...
export function calculateResult(inputs: fixed_index_annuity_calculator';Inputs): number {
...
export function generateAnalysis(inputs: fixed_index_annuity_calculator';Inputs, metrics: fixed_index_annuity_calculator';Metrics): fixed_index_annuity_calculator';Analysis {
