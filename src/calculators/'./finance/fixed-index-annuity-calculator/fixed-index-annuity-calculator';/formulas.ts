import { fixed-index-annuity-calculator';Inputs, fixed-index-annuity-calculator';Metrics, fixed-index-annuity-calculator';Analysis } from './types';
...
export function calculateResult(inputs: fixed-index-annuity-calculator';Inputs): number {
...
export function generateAnalysis(inputs: fixed-index-annuity-calculator';Inputs, metrics: fixed-index-annuity-calculator';Metrics): fixed-index-annuity-calculator';Analysis {
