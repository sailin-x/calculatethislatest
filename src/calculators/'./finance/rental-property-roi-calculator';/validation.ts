import { './finance/rental-property-roi-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/rental-property-roi-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
