import { retirement-savings-calculator';Inputs, retirement-savings-calculator';Metrics, retirement-savings-calculator';Analysis } from './types';
...
export function calculateResult(inputs: retirement-savings-calculator';Inputs): number {
...
export function generateAnalysis(inputs: retirement-savings-calculator';Inputs, metrics: retirement-savings-calculator';Metrics): retirement-savings-calculator';Analysis {
