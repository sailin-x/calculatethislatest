import { retirement_savings_calculator';Inputs, retirement_savings_calculator';Metrics, retirement_savings_calculator';Analysis } from './types';
...
export function calculateResult(inputs: retirement_savings_calculator';Inputs): number {
...
export function generateAnalysis(inputs: retirement_savings_calculator';Inputs, metrics: retirement_savings_calculator';Metrics): retirement_savings_calculator';Analysis {
