import { GiftTaxCalculator';Inputs, GiftTaxCalculator';Metrics, GiftTaxCalculator';Analysis } from './types';
...
export function calculateResult(inputs: GiftTaxCalculator';Inputs): number {
...
export function generateAnalysis(inputs: GiftTaxCalculator';Inputs, metrics: GiftTaxCalculator';Metrics): GiftTaxCalculator';Analysis {
