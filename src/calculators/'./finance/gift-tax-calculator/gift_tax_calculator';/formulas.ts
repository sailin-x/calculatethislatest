import { gift_tax_calculator';Inputs, gift_tax_calculator';Metrics, gift_tax_calculator';Analysis } from './types';
...
export function calculateResult(inputs: gift_tax_calculator';Inputs): number {
...
export function generateAnalysis(inputs: gift_tax_calculator';Inputs, metrics: gift_tax_calculator';Metrics): gift_tax_calculator';Analysis {
