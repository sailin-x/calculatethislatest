import { gift-tax-calculator';Inputs, gift-tax-calculator';Metrics, gift-tax-calculator';Analysis } from './types';
...
export function calculateResult(inputs: gift-tax-calculator';Inputs): number {
...
export function generateAnalysis(inputs: gift-tax-calculator';Inputs, metrics: gift-tax-calculator';Metrics): gift-tax-calculator';Analysis {
