import { music_royalty_investment_calculator';Inputs, music_royalty_investment_calculator';Metrics, music_royalty_investment_calculator';Analysis } from './types';
...
export function calculateResult(inputs: music_royalty_investment_calculator';Inputs): number {
...
export function generateAnalysis(inputs: music_royalty_investment_calculator';Inputs, metrics: music_royalty_investment_calculator';Metrics): music_royalty_investment_calculator';Analysis {
