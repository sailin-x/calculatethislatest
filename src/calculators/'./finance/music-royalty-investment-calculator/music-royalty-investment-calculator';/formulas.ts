import { music-royalty-investment-calculator';Inputs, music-royalty-investment-calculator';Metrics, music-royalty-investment-calculator';Analysis } from './types';
...
export function calculateResult(inputs: music-royalty-investment-calculator';Inputs): number {
...
export function generateAnalysis(inputs: music-royalty-investment-calculator';Inputs, metrics: music-royalty-investment-calculator';Metrics): music-royalty-investment-calculator';Analysis {
