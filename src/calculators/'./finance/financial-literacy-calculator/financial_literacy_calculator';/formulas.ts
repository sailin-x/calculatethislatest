import { financial_literacy_calculator';Inputs, financial_literacy_calculator';Metrics, financial_literacy_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_literacy_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_literacy_calculator';Inputs, metrics: financial_literacy_calculator';Metrics): financial_literacy_calculator';Analysis {
