import { financial-literacy-calculator';Inputs, financial-literacy-calculator';Metrics, financial-literacy-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-literacy-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-literacy-calculator';Inputs, metrics: financial-literacy-calculator';Metrics): financial-literacy-calculator';Analysis {
