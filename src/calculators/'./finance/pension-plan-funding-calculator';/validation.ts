import { './finance/pension-plan-funding-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/pension-plan-funding-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
