import { './finance/student-loan/student_loan';Inputs } from './types';

export function validateInputs(inputs: './finance/student-loan/student_loan';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
