import { student_loan';Inputs, student_loan';Metrics, student_loan';Analysis } from './types';
...
export function calculateResult(inputs: student_loan';Inputs): number {
...
export function generateAnalysis(inputs: student_loan';Inputs, metrics: student_loan';Metrics): student_loan';Analysis {
