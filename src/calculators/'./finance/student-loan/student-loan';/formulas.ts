import { student-loan';Inputs, student-loan';Metrics, student-loan';Analysis } from './types';
...
export function calculateResult(inputs: student-loan';Inputs): number {
...
export function generateAnalysis(inputs: student-loan';Inputs, metrics: student-loan';Metrics): student-loan';Analysis {
