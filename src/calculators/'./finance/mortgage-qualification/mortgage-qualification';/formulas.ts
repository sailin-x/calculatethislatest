import { mortgage-qualification';Inputs, mortgage-qualification';Metrics, mortgage-qualification';Analysis } from './types';
...
export function calculateResult(inputs: mortgage-qualification';Inputs): number {
...
export function generateAnalysis(inputs: mortgage-qualification';Inputs, metrics: mortgage-qualification';Metrics): mortgage-qualification';Analysis {
