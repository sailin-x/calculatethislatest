import { mortgage_qualification';Inputs, mortgage_qualification';Metrics, mortgage_qualification';Analysis } from './types';
...
export function calculateResult(inputs: mortgage_qualification';Inputs): number {
...
export function generateAnalysis(inputs: mortgage_qualification';Inputs, metrics: mortgage_qualification';Metrics): mortgage_qualification';Analysis {
