import { home_equity_calculator';Inputs, home_equity_calculator';Metrics, home_equity_calculator';Analysis } from './types';
...
export function calculateResult(inputs: home_equity_calculator';Inputs): number {
...
export function generateAnalysis(inputs: home_equity_calculator';Inputs, metrics: home_equity_calculator';Metrics): home_equity_calculator';Analysis {
