import { total-return-swap-calculator';Inputs, total-return-swap-calculator';Metrics, total-return-swap-calculator';Analysis } from './types';
...
export function calculateResult(inputs: total-return-swap-calculator';Inputs): number {
...
export function generateAnalysis(inputs: total-return-swap-calculator';Inputs, metrics: total-return-swap-calculator';Metrics): total-return-swap-calculator';Analysis {
