import { student_loan_repayment_calculator';Inputs, student_loan_repayment_calculator';Metrics, student_loan_repayment_calculator';Analysis } from './types';
...
export function calculateResult(inputs: student_loan_repayment_calculator';Inputs): number {
...
export function generateAnalysis(inputs: student_loan_repayment_calculator';Inputs, metrics: student_loan_repayment_calculator';Metrics): student_loan_repayment_calculator';Analysis {
