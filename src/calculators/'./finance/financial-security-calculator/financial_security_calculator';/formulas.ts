import { financial_security_calculator';Inputs, financial_security_calculator';Metrics, financial_security_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_security_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_security_calculator';Inputs, metrics: financial_security_calculator';Metrics): financial_security_calculator';Analysis {
