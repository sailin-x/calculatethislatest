import { financial-security-calculator';Inputs, financial-security-calculator';Metrics, financial-security-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-security-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-security-calculator';Inputs, metrics: financial-security-calculator';Metrics): financial-security-calculator';Analysis {
