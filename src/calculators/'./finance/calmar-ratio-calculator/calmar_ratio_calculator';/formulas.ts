import { calmar_ratio_calculator';Inputs, calmar_ratio_calculator';Metrics, calmar_ratio_calculator';Analysis } from './types';
...
export function calculateResult(inputs: calmar_ratio_calculator';Inputs): number {
...
export function generateAnalysis(inputs: calmar_ratio_calculator';Inputs, metrics: calmar_ratio_calculator';Metrics): calmar_ratio_calculator';Analysis {
