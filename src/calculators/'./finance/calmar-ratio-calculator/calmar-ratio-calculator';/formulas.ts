import { calmar-ratio-calculator';Inputs, calmar-ratio-calculator';Metrics, calmar-ratio-calculator';Analysis } from './types';
...
export function calculateResult(inputs: calmar-ratio-calculator';Inputs): number {
...
export function generateAnalysis(inputs: calmar-ratio-calculator';Inputs, metrics: calmar-ratio-calculator';Metrics): calmar-ratio-calculator';Analysis {
