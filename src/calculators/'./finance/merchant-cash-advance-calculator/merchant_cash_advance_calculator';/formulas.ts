import { merchant_cash_advance_calculator';Inputs, merchant_cash_advance_calculator';Metrics, merchant_cash_advance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: merchant_cash_advance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: merchant_cash_advance_calculator';Inputs, metrics: merchant_cash_advance_calculator';Metrics): merchant_cash_advance_calculator';Analysis {
