import { merchant-cash-advance-calculator';Inputs, merchant-cash-advance-calculator';Metrics, merchant-cash-advance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: merchant-cash-advance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: merchant-cash-advance-calculator';Inputs, metrics: merchant-cash-advance-calculator';Metrics): merchant-cash-advance-calculator';Analysis {
