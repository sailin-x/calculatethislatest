import { immediate-annuity-payout-calculator';Inputs, immediate-annuity-payout-calculator';Metrics, immediate-annuity-payout-calculator';Analysis } from './types';
...
export function calculateResult(inputs: immediate-annuity-payout-calculator';Inputs): number {
...
export function generateAnalysis(inputs: immediate-annuity-payout-calculator';Inputs, metrics: immediate-annuity-payout-calculator';Metrics): immediate-annuity-payout-calculator';Analysis {
