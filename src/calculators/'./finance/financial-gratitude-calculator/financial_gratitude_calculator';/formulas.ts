import { financial_gratitude_calculator';Inputs, financial_gratitude_calculator';Metrics, financial_gratitude_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_gratitude_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_gratitude_calculator';Inputs, metrics: financial_gratitude_calculator';Metrics): financial_gratitude_calculator';Analysis {
