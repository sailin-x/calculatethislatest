import { financial-gratitude-calculator';Inputs, financial-gratitude-calculator';Metrics, financial-gratitude-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-gratitude-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-gratitude-calculator';Inputs, metrics: financial-gratitude-calculator';Metrics): financial-gratitude-calculator';Analysis {
