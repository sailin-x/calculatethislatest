import { './finance/renters-insurance-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/renters-insurance-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
