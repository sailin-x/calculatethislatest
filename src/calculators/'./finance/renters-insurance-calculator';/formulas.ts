import { renters-insurance-calculator';Inputs, renters-insurance-calculator';Metrics, renters-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: renters-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: renters-insurance-calculator';Inputs, metrics: renters-insurance-calculator';Metrics): renters-insurance-calculator';Analysis {
