import { life_settlement_value_calculator';Inputs, life_settlement_value_calculator';Metrics, life_settlement_value_calculator';Analysis } from './types';
...
export function calculateResult(inputs: life_settlement_value_calculator';Inputs): number {
...
export function generateAnalysis(inputs: life_settlement_value_calculator';Inputs, metrics: life_settlement_value_calculator';Metrics): life_settlement_value_calculator';Analysis {
