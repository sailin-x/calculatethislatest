import { homeowners_insurance';Inputs, homeowners_insurance';Metrics, homeowners_insurance';Analysis } from './types';
...
export function calculateResult(inputs: homeowners_insurance';Inputs): number {
...
export function generateAnalysis(inputs: homeowners_insurance';Inputs, metrics: homeowners_insurance';Metrics): homeowners_insurance';Analysis {
