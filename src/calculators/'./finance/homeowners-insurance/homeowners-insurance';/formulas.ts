import { homeowners-insurance';Inputs, homeowners-insurance';Metrics, homeowners-insurance';Analysis } from './types';
...
export function calculateResult(inputs: homeowners-insurance';Inputs): number {
...
export function generateAnalysis(inputs: homeowners-insurance';Inputs, metrics: homeowners-insurance';Metrics): homeowners-insurance';Analysis {
