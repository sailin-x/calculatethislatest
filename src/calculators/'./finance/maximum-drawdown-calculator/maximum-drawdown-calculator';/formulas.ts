import { maximum-drawdown-calculator';Inputs, maximum-drawdown-calculator';Metrics, maximum-drawdown-calculator';Analysis } from './types';
...
export function calculateResult(inputs: maximum-drawdown-calculator';Inputs): number {
...
export function generateAnalysis(inputs: maximum-drawdown-calculator';Inputs, metrics: maximum-drawdown-calculator';Metrics): maximum-drawdown-calculator';Analysis {
