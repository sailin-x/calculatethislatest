import { financial_coaching_calculator';Inputs, financial_coaching_calculator';Metrics, financial_coaching_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_coaching_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_coaching_calculator';Inputs, metrics: financial_coaching_calculator';Metrics): financial_coaching_calculator';Analysis {
