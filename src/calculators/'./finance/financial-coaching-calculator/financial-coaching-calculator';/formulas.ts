import { financial-coaching-calculator';Inputs, financial-coaching-calculator';Metrics, financial-coaching-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-coaching-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-coaching-calculator';Inputs, metrics: financial-coaching-calculator';Metrics): financial-coaching-calculator';Analysis {
