import { options-valuation-calculator';Inputs, options-valuation-calculator';Metrics, options-valuation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: options-valuation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: options-valuation-calculator';Inputs, metrics: options-valuation-calculator';Metrics): options-valuation-calculator';Analysis {
