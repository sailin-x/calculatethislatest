import { term_life_insurance';Inputs, term_life_insurance';Metrics, term_life_insurance';Analysis } from './types';
...
export function calculateResult(inputs: term_life_insurance';Inputs): number {
...
export function generateAnalysis(inputs: term_life_insurance';Inputs, metrics: term_life_insurance';Metrics): term_life_insurance';Analysis {
