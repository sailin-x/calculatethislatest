import { term-life-insurance';Inputs, term-life-insurance';Metrics, term-life-insurance';Analysis } from './types';
...
export function calculateResult(inputs: term-life-insurance';Inputs): number {
...
export function generateAnalysis(inputs: term-life-insurance';Inputs, metrics: term-life-insurance';Metrics): term-life-insurance';Analysis {
