import { './finance/deferred-annuity/deferred_annuity';Inputs } from './types';

export function validateInputs(inputs: './finance/deferred-annuity/deferred_annuity';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
