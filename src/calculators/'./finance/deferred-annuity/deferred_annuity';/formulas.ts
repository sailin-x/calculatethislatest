import { deferred_annuity';Inputs, deferred_annuity';Metrics, deferred_annuity';Analysis } from './types';
...
export function calculateResult(inputs: deferred_annuity';Inputs): number {
...
export function generateAnalysis(inputs: deferred_annuity';Inputs, metrics: deferred_annuity';Metrics): deferred_annuity';Analysis {
