import { deferred-annuity';Inputs, deferred-annuity';Metrics, deferred-annuity';Analysis } from './types';
...
export function calculateResult(inputs: deferred-annuity';Inputs): number {
...
export function generateAnalysis(inputs: deferred-annuity';Inputs, metrics: deferred-annuity';Metrics): deferred-annuity';Analysis {
