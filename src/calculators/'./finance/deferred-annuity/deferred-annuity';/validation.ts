import { './finance/deferred-annuity/deferred-annuity';Inputs } from './types';

export function validateInputs(inputs: './finance/deferred-annuity/deferred-annuity';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
