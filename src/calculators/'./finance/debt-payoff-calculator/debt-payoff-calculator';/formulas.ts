import { debt-payoff-calculator';Inputs, debt-payoff-calculator';Metrics, debt-payoff-calculator';Analysis } from './types';
...
export function calculateResult(inputs: debt-payoff-calculator';Inputs): number {
...
export function generateAnalysis(inputs: debt-payoff-calculator';Inputs, metrics: debt-payoff-calculator';Metrics): debt-payoff-calculator';Analysis {
