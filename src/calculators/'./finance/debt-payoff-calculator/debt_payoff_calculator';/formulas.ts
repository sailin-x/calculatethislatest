import { debt_payoff_calculator';Inputs, debt_payoff_calculator';Metrics, debt_payoff_calculator';Analysis } from './types';
...
export function calculateResult(inputs: debt_payoff_calculator';Inputs): number {
...
export function generateAnalysis(inputs: debt_payoff_calculator';Inputs, metrics: debt_payoff_calculator';Metrics): debt_payoff_calculator';Analysis {
