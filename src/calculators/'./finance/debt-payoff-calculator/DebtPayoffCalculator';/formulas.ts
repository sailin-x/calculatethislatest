import { DebtPayoffCalculator';Inputs, DebtPayoffCalculator';Metrics, DebtPayoffCalculator';Analysis } from './types';
...
export function calculateResult(inputs: DebtPayoffCalculator';Inputs): number {
...
export function generateAnalysis(inputs: DebtPayoffCalculator';Inputs, metrics: DebtPayoffCalculator';Metrics): DebtPayoffCalculator';Analysis {
