import { flexible-spending-account-calculator';Inputs, flexible-spending-account-calculator';Metrics, flexible-spending-account-calculator';Analysis } from './types';
...
export function calculateResult(inputs: flexible-spending-account-calculator';Inputs): number {
...
export function generateAnalysis(inputs: flexible-spending-account-calculator';Inputs, metrics: flexible-spending-account-calculator';Metrics): flexible-spending-account-calculator';Analysis {
