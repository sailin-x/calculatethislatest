import { angel-investment-dilution';Inputs, angel-investment-dilution';Metrics, angel-investment-dilution';Analysis } from './types';
...
export function calculateResult(inputs: angel-investment-dilution';Inputs): number {
...
export function generateAnalysis(inputs: angel-investment-dilution';Inputs, metrics: angel-investment-dilution';Metrics): angel-investment-dilution';Analysis {
