import { angel_investment_dilution';Inputs, angel_investment_dilution';Metrics, angel_investment_dilution';Analysis } from './types';
...
export function calculateResult(inputs: angel_investment_dilution';Inputs): number {
...
export function generateAnalysis(inputs: angel_investment_dilution';Inputs, metrics: angel_investment_dilution';Metrics): angel_investment_dilution';Analysis {
