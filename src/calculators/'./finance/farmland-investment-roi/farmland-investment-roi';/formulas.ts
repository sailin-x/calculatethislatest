import { farmland-investment-roi';Inputs, farmland-investment-roi';Metrics, farmland-investment-roi';Analysis } from './types';
...
export function calculateResult(inputs: farmland-investment-roi';Inputs): number {
...
export function generateAnalysis(inputs: farmland-investment-roi';Inputs, metrics: farmland-investment-roi';Metrics): farmland-investment-roi';Analysis {
