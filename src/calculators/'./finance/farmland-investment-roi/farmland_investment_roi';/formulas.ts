import { farmland_investment_roi';Inputs, farmland_investment_roi';Metrics, farmland_investment_roi';Analysis } from './types';
...
export function calculateResult(inputs: farmland_investment_roi';Inputs): number {
...
export function generateAnalysis(inputs: farmland_investment_roi';Inputs, metrics: farmland_investment_roi';Metrics): farmland_investment_roi';Analysis {
