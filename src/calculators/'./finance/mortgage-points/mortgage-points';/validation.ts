import { './finance/mortgage-points/mortgage-points';Inputs } from './types';

export function validateInputs(inputs: './finance/mortgage-points/mortgage-points';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
