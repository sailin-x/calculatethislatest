import { mortgage-points';Inputs, mortgage-points';Metrics, mortgage-points';Analysis } from './types';
...
export function calculateResult(inputs: mortgage-points';Inputs): number {
...
export function generateAnalysis(inputs: mortgage-points';Inputs, metrics: mortgage-points';Metrics): mortgage-points';Analysis {
