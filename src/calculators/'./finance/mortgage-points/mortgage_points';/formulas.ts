import { mortgage_points';Inputs, mortgage_points';Metrics, mortgage_points';Analysis } from './types';
...
export function calculateResult(inputs: mortgage_points';Inputs): number {
...
export function generateAnalysis(inputs: mortgage_points';Inputs, metrics: mortgage_points';Metrics): mortgage_points';Analysis {
