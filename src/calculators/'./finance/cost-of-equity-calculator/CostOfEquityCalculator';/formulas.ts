import { CostOfEquityCalculator';Inputs, CostOfEquityCalculator';Metrics, CostOfEquityCalculator';Analysis } from './types';
...
export function calculateResult(inputs: CostOfEquityCalculator';Inputs): number {
...
export function generateAnalysis(inputs: CostOfEquityCalculator';Inputs, metrics: CostOfEquityCalculator';Metrics): CostOfEquityCalculator';Analysis {
