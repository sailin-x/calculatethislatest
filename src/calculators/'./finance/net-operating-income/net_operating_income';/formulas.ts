import { net_operating_income';Inputs, net_operating_income';Metrics, net_operating_income';Analysis } from './types';
...
export function calculateResult(inputs: net_operating_income';Inputs): number {
...
export function generateAnalysis(inputs: net_operating_income';Inputs, metrics: net_operating_income';Metrics): net_operating_income';Analysis {
