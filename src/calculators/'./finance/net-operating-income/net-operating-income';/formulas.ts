import { net-operating-income';Inputs, net-operating-income';Metrics, net-operating-income';Analysis } from './types';
...
export function calculateResult(inputs: net-operating-income';Inputs): number {
...
export function generateAnalysis(inputs: net-operating-income';Inputs, metrics: net-operating-income';Metrics): net-operating-income';Analysis {
