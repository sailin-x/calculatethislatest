import { college_financial_aid';Inputs, college_financial_aid';Metrics, college_financial_aid';Analysis } from './types';
...
export function calculateResult(inputs: college_financial_aid';Inputs): number {
...
export function generateAnalysis(inputs: college_financial_aid';Inputs, metrics: college_financial_aid';Metrics): college_financial_aid';Analysis {
