import { college-financial-aid';Inputs, college-financial-aid';Metrics, college-financial-aid';Analysis } from './types';
...
export function calculateResult(inputs: college-financial-aid';Inputs): number {
...
export function generateAnalysis(inputs: college-financial-aid';Inputs, metrics: college-financial-aid';Metrics): college-financial-aid';Analysis {
