import { tax-loss-harvesting-calculator';Inputs, tax-loss-harvesting-calculator';Metrics, tax-loss-harvesting-calculator';Analysis } from './types';
...
export function calculateResult(inputs: tax-loss-harvesting-calculator';Inputs): number {
...
export function generateAnalysis(inputs: tax-loss-harvesting-calculator';Inputs, metrics: tax-loss-harvesting-calculator';Metrics): tax-loss-harvesting-calculator';Analysis {
