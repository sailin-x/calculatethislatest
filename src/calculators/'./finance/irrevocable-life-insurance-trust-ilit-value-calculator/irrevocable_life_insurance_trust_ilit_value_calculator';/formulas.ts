import { irrevocable_life_insurance_trust_ilit_value_calculator';Inputs, irrevocable_life_insurance_trust_ilit_value_calculator';Metrics, irrevocable_life_insurance_trust_ilit_value_calculator';Analysis } from './types';
...
export function calculateResult(inputs: irrevocable_life_insurance_trust_ilit_value_calculator';Inputs): number {
...
export function generateAnalysis(inputs: irrevocable_life_insurance_trust_ilit_value_calculator';Inputs, metrics: irrevocable_life_insurance_trust_ilit_value_calculator';Metrics): irrevocable_life_insurance_trust_ilit_value_calculator';Analysis {
