import { financial_management_calculator';Inputs, financial_management_calculator';Metrics, financial_management_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_management_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_management_calculator';Inputs, metrics: financial_management_calculator';Metrics): financial_management_calculator';Analysis {
