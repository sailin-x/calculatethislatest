import { financial-management-calculator';Inputs, financial-management-calculator';Metrics, financial-management-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-management-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-management-calculator';Inputs, metrics: financial-management-calculator';Metrics): financial-management-calculator';Analysis {
