import { peer-to-peer-lending-calculator';Inputs, peer-to-peer-lending-calculator';Metrics, peer-to-peer-lending-calculator';Analysis } from './types';
...
export function calculateResult(inputs: peer-to-peer-lending-calculator';Inputs): number {
...
export function generateAnalysis(inputs: peer-to-peer-lending-calculator';Inputs, metrics: peer-to-peer-lending-calculator';Metrics): peer-to-peer-lending-calculator';Analysis {
