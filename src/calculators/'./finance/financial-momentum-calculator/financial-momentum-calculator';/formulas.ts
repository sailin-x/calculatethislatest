import { financial-momentum-calculator';Inputs, financial-momentum-calculator';Metrics, financial-momentum-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-momentum-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-momentum-calculator';Inputs, metrics: financial-momentum-calculator';Metrics): financial-momentum-calculator';Analysis {
