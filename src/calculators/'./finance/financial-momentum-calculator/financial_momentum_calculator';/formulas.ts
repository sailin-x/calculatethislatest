import { financial_momentum_calculator';Inputs, financial_momentum_calculator';Metrics, financial_momentum_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_momentum_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_momentum_calculator';Inputs, metrics: financial_momentum_calculator';Metrics): financial_momentum_calculator';Analysis {
