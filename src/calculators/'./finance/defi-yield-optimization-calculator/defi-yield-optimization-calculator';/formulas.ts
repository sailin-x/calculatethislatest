import { defi-yield-optimization-calculator';Inputs, defi-yield-optimization-calculator';Metrics, defi-yield-optimization-calculator';Analysis } from './types';
...
export function calculateResult(inputs: defi-yield-optimization-calculator';Inputs): number {
...
export function generateAnalysis(inputs: defi-yield-optimization-calculator';Inputs, metrics: defi-yield-optimization-calculator';Metrics): defi-yield-optimization-calculator';Analysis {
