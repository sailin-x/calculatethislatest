import { defi_yield_optimization_calculator';Inputs, defi_yield_optimization_calculator';Metrics, defi_yield_optimization_calculator';Analysis } from './types';
...
export function calculateResult(inputs: defi_yield_optimization_calculator';Inputs): number {
...
export function generateAnalysis(inputs: defi_yield_optimization_calculator';Inputs, metrics: defi_yield_optimization_calculator';Metrics): defi_yield_optimization_calculator';Analysis {
