import { financial-goal-calculator';Inputs, financial-goal-calculator';Metrics, financial-goal-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-goal-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-goal-calculator';Inputs, metrics: financial-goal-calculator';Metrics): financial-goal-calculator';Analysis {
