import { financial_goal_calculator';Inputs, financial_goal_calculator';Metrics, financial_goal_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_goal_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_goal_calculator';Inputs, metrics: financial_goal_calculator';Metrics): financial_goal_calculator';Analysis {
