import { nft_royalty';Inputs, nft_royalty';Metrics, nft_royalty';Analysis } from './types';
...
export function calculateResult(inputs: nft_royalty';Inputs): number {
...
export function generateAnalysis(inputs: nft_royalty';Inputs, metrics: nft_royalty';Metrics): nft_royalty';Analysis {
