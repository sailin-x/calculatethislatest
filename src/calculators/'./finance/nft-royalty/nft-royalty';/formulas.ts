import { nft-royalty';Inputs, nft-royalty';Metrics, nft-royalty';Analysis } from './types';
...
export function calculateResult(inputs: nft-royalty';Inputs): number {
...
export function generateAnalysis(inputs: nft-royalty';Inputs, metrics: nft-royalty';Metrics): nft-royalty';Analysis {
