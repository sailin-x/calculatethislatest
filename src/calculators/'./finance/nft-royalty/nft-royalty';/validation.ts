import { './finance/nft-royalty/nft-royalty';Inputs } from './types';

export function validateInputs(inputs: './finance/nft-royalty/nft-royalty';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
