import { financial_education_calculator';Inputs, financial_education_calculator';Metrics, financial_education_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_education_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_education_calculator';Inputs, metrics: financial_education_calculator';Metrics): financial_education_calculator';Analysis {
