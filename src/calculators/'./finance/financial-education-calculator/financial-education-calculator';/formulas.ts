import { financial-education-calculator';Inputs, financial-education-calculator';Metrics, financial-education-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-education-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-education-calculator';Inputs, metrics: financial-education-calculator';Metrics): financial-education-calculator';Analysis {
