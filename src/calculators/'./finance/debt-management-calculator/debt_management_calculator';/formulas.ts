import { debt_management_calculator';Inputs, debt_management_calculator';Metrics, debt_management_calculator';Analysis } from './types';
...
export function calculateResult(inputs: debt_management_calculator';Inputs): number {
...
export function generateAnalysis(inputs: debt_management_calculator';Inputs, metrics: debt_management_calculator';Metrics): debt_management_calculator';Analysis {
