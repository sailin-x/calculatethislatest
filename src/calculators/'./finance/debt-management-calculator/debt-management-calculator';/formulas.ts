import { debt-management-calculator';Inputs, debt-management-calculator';Metrics, debt-management-calculator';Analysis } from './types';
...
export function calculateResult(inputs: debt-management-calculator';Inputs): number {
...
export function generateAnalysis(inputs: debt-management-calculator';Inputs, metrics: debt-management-calculator';Metrics): debt-management-calculator';Analysis {
