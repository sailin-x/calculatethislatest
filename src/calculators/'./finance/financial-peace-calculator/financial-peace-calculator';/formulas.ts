import { financial-peace-calculator';Inputs, financial-peace-calculator';Metrics, financial-peace-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-peace-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-peace-calculator';Inputs, metrics: financial-peace-calculator';Metrics): financial-peace-calculator';Analysis {
