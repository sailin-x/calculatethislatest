import { financial_peace_calculator';Inputs, financial_peace_calculator';Metrics, financial_peace_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_peace_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_peace_calculator';Inputs, metrics: financial_peace_calculator';Metrics): financial_peace_calculator';Analysis {
