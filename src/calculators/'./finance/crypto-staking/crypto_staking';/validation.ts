import { './finance/crypto-staking/crypto_staking';Inputs } from './types';

export function validateInputs(inputs: './finance/crypto-staking/crypto_staking';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
