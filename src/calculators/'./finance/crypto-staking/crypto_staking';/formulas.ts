import { crypto_staking';Inputs, crypto_staking';Metrics, crypto_staking';Analysis } from './types';
...
export function calculateResult(inputs: crypto_staking';Inputs): number {
...
export function generateAnalysis(inputs: crypto_staking';Inputs, metrics: crypto_staking';Metrics): crypto_staking';Analysis {
