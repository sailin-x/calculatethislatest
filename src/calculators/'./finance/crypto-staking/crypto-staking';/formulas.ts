import { crypto-staking';Inputs, crypto-staking';Metrics, crypto-staking';Analysis } from './types';
...
export function calculateResult(inputs: crypto-staking';Inputs): number {
...
export function generateAnalysis(inputs: crypto-staking';Inputs, metrics: crypto-staking';Metrics): crypto-staking';Analysis {
