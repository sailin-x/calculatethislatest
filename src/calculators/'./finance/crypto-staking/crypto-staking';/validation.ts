import { './finance/crypto-staking/crypto-staking';Inputs } from './types';

export function validateInputs(inputs: './finance/crypto-staking/crypto-staking';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
