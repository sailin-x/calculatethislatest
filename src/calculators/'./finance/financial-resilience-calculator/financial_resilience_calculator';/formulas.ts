import { financial_resilience_calculator';Inputs, financial_resilience_calculator';Metrics, financial_resilience_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_resilience_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_resilience_calculator';Inputs, metrics: financial_resilience_calculator';Metrics): financial_resilience_calculator';Analysis {
