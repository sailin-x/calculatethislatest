import { financial-resilience-calculator';Inputs, financial-resilience-calculator';Metrics, financial-resilience-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-resilience-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-resilience-calculator';Inputs, metrics: financial-resilience-calculator';Metrics): financial-resilience-calculator';Analysis {
