import { financial-optimization-calculator';Inputs, financial-optimization-calculator';Metrics, financial-optimization-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-optimization-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-optimization-calculator';Inputs, metrics: financial-optimization-calculator';Metrics): financial-optimization-calculator';Analysis {
