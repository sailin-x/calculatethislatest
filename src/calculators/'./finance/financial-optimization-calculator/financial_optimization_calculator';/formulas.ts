import { financial_optimization_calculator';Inputs, financial_optimization_calculator';Metrics, financial_optimization_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_optimization_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_optimization_calculator';Inputs, metrics: financial_optimization_calculator';Metrics): financial_optimization_calculator';Analysis {
