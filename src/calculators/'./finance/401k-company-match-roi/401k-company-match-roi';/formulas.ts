import { 401k-company-match-roi';Inputs, 401k-company-match-roi';Metrics, 401k-company-match-roi';Analysis } from './types';
...
export function calculateResult(inputs: 401k-company-match-roi';Inputs): number {
...
export function generateAnalysis(inputs: 401k-company-match-roi';Inputs, metrics: 401k-company-match-roi';Metrics): 401k-company-match-roi';Analysis {
