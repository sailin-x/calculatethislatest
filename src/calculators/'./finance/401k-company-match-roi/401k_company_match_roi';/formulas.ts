import { 401k_company_match_roi';Inputs, 401k_company_match_roi';Metrics, 401k_company_match_roi';Analysis } from './types';
...
export function calculateResult(inputs: 401k_company_match_roi';Inputs): number {
...
export function generateAnalysis(inputs: 401k_company_match_roi';Inputs, metrics: 401k_company_match_roi';Metrics): 401k_company_match_roi';Analysis {
