import { './finance/forex-calculator/forex-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/forex-calculator/forex-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
