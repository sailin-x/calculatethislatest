import { './finance/forex-calculator/forex_calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/forex-calculator/forex_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
