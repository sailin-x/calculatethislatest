import { forex_calculator';Inputs, forex_calculator';Metrics, forex_calculator';Analysis } from './types';
...
export function calculateResult(inputs: forex_calculator';Inputs): number {
...
export function generateAnalysis(inputs: forex_calculator';Inputs, metrics: forex_calculator';Metrics): forex_calculator';Analysis {
