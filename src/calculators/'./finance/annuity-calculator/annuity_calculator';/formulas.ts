import { annuity_calculator';Inputs, annuity_calculator';Metrics, annuity_calculator';Analysis } from './types';
...
export function calculateResult(inputs: annuity_calculator';Inputs): number {
...
export function generateAnalysis(inputs: annuity_calculator';Inputs, metrics: annuity_calculator';Metrics): annuity_calculator';Analysis {
