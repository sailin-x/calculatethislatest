import { annuity-calculator';Inputs, annuity-calculator';Metrics, annuity-calculator';Analysis } from './types';
...
export function calculateResult(inputs: annuity-calculator';Inputs): number {
...
export function generateAnalysis(inputs: annuity-calculator';Inputs, metrics: annuity-calculator';Metrics): annuity-calculator';Analysis {
