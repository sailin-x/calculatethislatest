import { fund-level-irr-calculator';Inputs, fund-level-irr-calculator';Metrics, fund-level-irr-calculator';Analysis } from './types';
...
export function calculateResult(inputs: fund-level-irr-calculator';Inputs): number {
...
export function generateAnalysis(inputs: fund-level-irr-calculator';Inputs, metrics: fund-level-irr-calculator';Metrics): fund-level-irr-calculator';Analysis {
