import { fund_level_irr_calculator';Inputs, fund_level_irr_calculator';Metrics, fund_level_irr_calculator';Analysis } from './types';
...
export function calculateResult(inputs: fund_level_irr_calculator';Inputs): number {
...
export function generateAnalysis(inputs: fund_level_irr_calculator';Inputs, metrics: fund_level_irr_calculator';Metrics): fund_level_irr_calculator';Analysis {
