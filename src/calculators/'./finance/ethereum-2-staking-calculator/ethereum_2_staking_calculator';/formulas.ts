import { ethereum_2_staking_calculator';Inputs, ethereum_2_staking_calculator';Metrics, ethereum_2_staking_calculator';Analysis } from './types';
...
export function calculateResult(inputs: ethereum_2_staking_calculator';Inputs): number {
...
export function generateAnalysis(inputs: ethereum_2_staking_calculator';Inputs, metrics: ethereum_2_staking_calculator';Metrics): ethereum_2_staking_calculator';Analysis {
