import { './finance/loan-calculator/loan-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/loan-calculator/loan-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
