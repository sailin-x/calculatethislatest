import { loan-calculator';Inputs, loan-calculator';Metrics, loan-calculator';Analysis } from './types';
...
export function calculateResult(inputs: loan-calculator';Inputs): number {
...
export function generateAnalysis(inputs: loan-calculator';Inputs, metrics: loan-calculator';Metrics): loan-calculator';Analysis {
