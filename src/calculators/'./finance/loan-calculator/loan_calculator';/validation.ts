import { './finance/loan-calculator/loan_calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/loan-calculator/loan_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
