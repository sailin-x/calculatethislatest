import { CorrelationCalculator';Inputs, CorrelationCalculator';Metrics, CorrelationCalculator';Analysis } from './types';
...
export function calculateResult(inputs: CorrelationCalculator';Inputs): number {
...
export function generateAnalysis(inputs: CorrelationCalculator';Inputs, metrics: CorrelationCalculator';Metrics): CorrelationCalculator';Analysis {
