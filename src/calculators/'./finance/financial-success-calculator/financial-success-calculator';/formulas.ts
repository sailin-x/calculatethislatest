import { financial-success-calculator';Inputs, financial-success-calculator';Metrics, financial-success-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-success-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-success-calculator';Inputs, metrics: financial-success-calculator';Metrics): financial-success-calculator';Analysis {
