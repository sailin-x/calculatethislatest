import { financial_success_calculator';Inputs, financial_success_calculator';Metrics, financial_success_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_success_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_success_calculator';Inputs, metrics: financial_success_calculator';Metrics): financial_success_calculator';Analysis {
