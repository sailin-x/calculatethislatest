import { './finance/timberland-investment-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/timberland-investment-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
