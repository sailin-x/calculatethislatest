import { timberland-investment-calculator';Inputs, timberland-investment-calculator';Metrics, timberland-investment-calculator';Analysis } from './types';
...
export function calculateResult(inputs: timberland-investment-calculator';Inputs): number {
...
export function generateAnalysis(inputs: timberland-investment-calculator';Inputs, metrics: timberland-investment-calculator';Metrics): timberland-investment-calculator';Analysis {
