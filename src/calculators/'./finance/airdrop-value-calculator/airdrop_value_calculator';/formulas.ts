import { airdrop_value_calculator';Inputs, airdrop_value_calculator';Metrics, airdrop_value_calculator';Analysis } from './types';
...
export function calculateResult(inputs: airdrop_value_calculator';Inputs): number {
...
export function generateAnalysis(inputs: airdrop_value_calculator';Inputs, metrics: airdrop_value_calculator';Metrics): airdrop_value_calculator';Analysis {
