import { './finance/retirement-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/retirement-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
