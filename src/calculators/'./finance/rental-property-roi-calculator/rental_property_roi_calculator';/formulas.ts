import { rental_property_roi_calculator';Inputs, rental_property_roi_calculator';Metrics, rental_property_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: rental_property_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: rental_property_roi_calculator';Inputs, metrics: rental_property_roi_calculator';Metrics): rental_property_roi_calculator';Analysis {
