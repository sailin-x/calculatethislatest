import { rental-property-roi-calculator';Inputs, rental-property-roi-calculator';Metrics, rental-property-roi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: rental-property-roi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: rental-property-roi-calculator';Inputs, metrics: rental-property-roi-calculator';Metrics): rental-property-roi-calculator';Analysis {
