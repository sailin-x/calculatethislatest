import { EnterpriseValueCalculator';Inputs, EnterpriseValueCalculator';Metrics, EnterpriseValueCalculator';Analysis } from './types';
...
export function calculateResult(inputs: EnterpriseValueCalculator';Inputs): number {
...
export function generateAnalysis(inputs: EnterpriseValueCalculator';Inputs, metrics: EnterpriseValueCalculator';Metrics): EnterpriseValueCalculator';Analysis {
