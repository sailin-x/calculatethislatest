import { './finance/real-estate-syndication-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/real-estate-syndication-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
