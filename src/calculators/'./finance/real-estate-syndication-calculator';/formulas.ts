import { real-estate-syndication-calculator';Inputs, real-estate-syndication-calculator';Metrics, real-estate-syndication-calculator';Analysis } from './types';
...
export function calculateResult(inputs: real-estate-syndication-calculator';Inputs): number {
...
export function generateAnalysis(inputs: real-estate-syndication-calculator';Inputs, metrics: real-estate-syndication-calculator';Metrics): real-estate-syndication-calculator';Analysis {
