import { rental_yield_calculator';Inputs, rental_yield_calculator';Metrics, rental_yield_calculator';Analysis } from './types';
...
export function calculateResult(inputs: rental_yield_calculator';Inputs): number {
...
export function generateAnalysis(inputs: rental_yield_calculator';Inputs, metrics: rental_yield_calculator';Metrics): rental_yield_calculator';Analysis {
