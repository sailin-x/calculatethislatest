import { net_worth_calculator';Inputs, net_worth_calculator';Metrics, net_worth_calculator';Analysis } from './types';
...
export function calculateResult(inputs: net_worth_calculator';Inputs): number {
...
export function generateAnalysis(inputs: net_worth_calculator';Inputs, metrics: net_worth_calculator';Metrics): net_worth_calculator';Analysis {
