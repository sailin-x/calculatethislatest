import { net-worth-calculator';Inputs, net-worth-calculator';Metrics, net-worth-calculator';Analysis } from './types';
...
export function calculateResult(inputs: net-worth-calculator';Inputs): number {
...
export function generateAnalysis(inputs: net-worth-calculator';Inputs, metrics: net-worth-calculator';Metrics): net-worth-calculator';Analysis {
