import { './finance/life-settlement-value-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/life-settlement-value-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
