import { financial-balance-calculator';Inputs, financial-balance-calculator';Metrics, financial-balance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-balance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-balance-calculator';Inputs, metrics: financial-balance-calculator';Metrics): financial-balance-calculator';Analysis {
