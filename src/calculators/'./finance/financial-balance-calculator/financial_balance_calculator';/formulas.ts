import { financial_balance_calculator';Inputs, financial_balance_calculator';Metrics, financial_balance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_balance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_balance_calculator';Inputs, metrics: financial_balance_calculator';Metrics): financial_balance_calculator';Analysis {
