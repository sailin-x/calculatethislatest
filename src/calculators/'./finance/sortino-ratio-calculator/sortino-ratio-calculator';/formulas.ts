import { sortino-ratio-calculator';Inputs, sortino-ratio-calculator';Metrics, sortino-ratio-calculator';Analysis } from './types';
...
export function calculateResult(inputs: sortino-ratio-calculator';Inputs): number {
...
export function generateAnalysis(inputs: sortino-ratio-calculator';Inputs, metrics: sortino-ratio-calculator';Metrics): sortino-ratio-calculator';Analysis {
