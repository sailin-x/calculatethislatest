import { financial_innovation_calculator';Inputs, financial_innovation_calculator';Metrics, financial_innovation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_innovation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_innovation_calculator';Inputs, metrics: financial_innovation_calculator';Metrics): financial_innovation_calculator';Analysis {
