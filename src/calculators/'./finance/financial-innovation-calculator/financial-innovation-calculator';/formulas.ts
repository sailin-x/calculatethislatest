import { financial-innovation-calculator';Inputs, financial-innovation-calculator';Metrics, financial-innovation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-innovation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-innovation-calculator';Inputs, metrics: financial-innovation-calculator';Metrics): financial-innovation-calculator';Analysis {
