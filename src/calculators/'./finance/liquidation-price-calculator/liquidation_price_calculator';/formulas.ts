import { liquidation_price_calculator';Inputs, liquidation_price_calculator';Metrics, liquidation_price_calculator';Analysis } from './types';
...
export function calculateResult(inputs: liquidation_price_calculator';Inputs): number {
...
export function generateAnalysis(inputs: liquidation_price_calculator';Inputs, metrics: liquidation_price_calculator';Metrics): liquidation_price_calculator';Analysis {
