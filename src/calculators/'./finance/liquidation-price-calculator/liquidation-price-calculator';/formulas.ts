import { liquidation-price-calculator';Inputs, liquidation-price-calculator';Metrics, liquidation-price-calculator';Analysis } from './types';
...
export function calculateResult(inputs: liquidation-price-calculator';Inputs): number {
...
export function generateAnalysis(inputs: liquidation-price-calculator';Inputs, metrics: liquidation-price-calculator';Metrics): liquidation-price-calculator';Analysis {
