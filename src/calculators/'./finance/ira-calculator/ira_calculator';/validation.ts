import { './finance/ira-calculator/ira_calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/ira-calculator/ira_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
