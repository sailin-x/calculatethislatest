import { ira_calculator';Inputs, ira_calculator';Metrics, ira_calculator';Analysis } from './types';
...
export function calculateResult(inputs: ira_calculator';Inputs): number {
...
export function generateAnalysis(inputs: ira_calculator';Inputs, metrics: ira_calculator';Metrics): ira_calculator';Analysis {
