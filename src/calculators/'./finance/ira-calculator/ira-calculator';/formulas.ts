import { ira-calculator';Inputs, ira-calculator';Metrics, ira-calculator';Analysis } from './types';
...
export function calculateResult(inputs: ira-calculator';Inputs): number {
...
export function generateAnalysis(inputs: ira-calculator';Inputs, metrics: ira-calculator';Metrics): ira-calculator';Analysis {
