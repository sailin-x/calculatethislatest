import { './finance/ira-calculator/ira-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/ira-calculator/ira-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
