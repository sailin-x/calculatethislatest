import { commercial_property_insurance';Inputs, commercial_property_insurance';Metrics, commercial_property_insurance';Analysis } from './types';
...
export function calculateResult(inputs: commercial_property_insurance';Inputs): number {
...
export function generateAnalysis(inputs: commercial_property_insurance';Inputs, metrics: commercial_property_insurance';Metrics): commercial_property_insurance';Analysis {
