import { commercial-property-insurance';Inputs, commercial-property-insurance';Metrics, commercial-property-insurance';Analysis } from './types';
...
export function calculateResult(inputs: commercial-property-insurance';Inputs): number {
...
export function generateAnalysis(inputs: commercial-property-insurance';Inputs, metrics: commercial-property-insurance';Metrics): commercial-property-insurance';Analysis {
