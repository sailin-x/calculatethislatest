import { './finance/property-tax/property-tax';Inputs } from './types';

export function validateInputs(inputs: './finance/property-tax/property-tax';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
