import { property-tax';Inputs, property-tax';Metrics, property-tax';Analysis } from './types';
...
export function calculateResult(inputs: property-tax';Inputs): number {
...
export function generateAnalysis(inputs: property-tax';Inputs, metrics: property-tax';Metrics): property-tax';Analysis {
