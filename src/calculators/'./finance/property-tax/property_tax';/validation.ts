import { './finance/property-tax/property_tax';Inputs } from './types';

export function validateInputs(inputs: './finance/property-tax/property_tax';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
