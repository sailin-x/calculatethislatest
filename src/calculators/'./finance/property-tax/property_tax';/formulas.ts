import { property_tax';Inputs, property_tax';Metrics, property_tax';Analysis } from './types';
...
export function calculateResult(inputs: property_tax';Inputs): number {
...
export function generateAnalysis(inputs: property_tax';Inputs, metrics: property_tax';Metrics): property_tax';Analysis {
