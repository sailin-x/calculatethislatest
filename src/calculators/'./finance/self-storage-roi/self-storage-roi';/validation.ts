import { './finance/self-storage-roi/self-storage-roi';Inputs } from './types';

export function validateInputs(inputs: './finance/self-storage-roi/self-storage-roi';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
