import { self-storage-roi';Inputs, self-storage-roi';Metrics, self-storage-roi';Analysis } from './types';
...
export function calculateResult(inputs: self-storage-roi';Inputs): number {
...
export function generateAnalysis(inputs: self-storage-roi';Inputs, metrics: self-storage-roi';Metrics): self-storage-roi';Analysis {
