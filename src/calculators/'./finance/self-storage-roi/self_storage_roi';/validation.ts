import { './finance/self-storage-roi/self_storage_roi';Inputs } from './types';

export function validateInputs(inputs: './finance/self-storage-roi/self_storage_roi';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
