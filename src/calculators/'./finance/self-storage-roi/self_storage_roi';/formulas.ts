import { self_storage_roi';Inputs, self_storage_roi';Metrics, self_storage_roi';Analysis } from './types';
...
export function calculateResult(inputs: self_storage_roi';Inputs): number {
...
export function generateAnalysis(inputs: self_storage_roi';Inputs, metrics: self_storage_roi';Metrics): self_storage_roi';Analysis {
