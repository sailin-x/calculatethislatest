import { rental-yield-calculator';Inputs, rental-yield-calculator';Metrics, rental-yield-calculator';Analysis } from './types';
...
export function calculateResult(inputs: rental-yield-calculator';Inputs): number {
...
export function generateAnalysis(inputs: rental-yield-calculator';Inputs, metrics: rental-yield-calculator';Metrics): rental-yield-calculator';Analysis {
