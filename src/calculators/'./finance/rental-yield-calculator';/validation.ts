import { './finance/rental-yield-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/rental-yield-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
