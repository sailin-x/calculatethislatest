import { './finance/fixed-index-annuity-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/fixed-index-annuity-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
