import { CorporateBondCalculator';Inputs, CorporateBondCalculator';Metrics, CorporateBondCalculator';Analysis } from './types';
...
export function calculateResult(inputs: CorporateBondCalculator';Inputs): number {
...
export function generateAnalysis(inputs: CorporateBondCalculator';Inputs, metrics: CorporateBondCalculator';Metrics): CorporateBondCalculator';Analysis {
