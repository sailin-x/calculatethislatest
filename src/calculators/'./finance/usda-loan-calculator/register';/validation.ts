import { './finance/usda-loan-calculator/register';Inputs } from './types';

export function validateInputs(inputs: './finance/usda-loan-calculator/register';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
