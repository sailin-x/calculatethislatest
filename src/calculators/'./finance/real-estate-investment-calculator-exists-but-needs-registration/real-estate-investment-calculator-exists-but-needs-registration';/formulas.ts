import { real-estate-investment-calculator-exists-but-needs-registration';Inputs, real-estate-investment-calculator-exists-but-needs-registration';Metrics, real-estate-investment-calculator-exists-but-needs-registration';Analysis } from './types';
...
export function calculateResult(inputs: real-estate-investment-calculator-exists-but-needs-registration';Inputs): number {
...
export function generateAnalysis(inputs: real-estate-investment-calculator-exists-but-needs-registration';Inputs, metrics: real-estate-investment-calculator-exists-but-needs-registration';Metrics): real-estate-investment-calculator-exists-but-needs-registration';Analysis {
