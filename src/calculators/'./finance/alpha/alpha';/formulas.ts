import { alpha';Inputs, alpha';Metrics, alpha';Analysis } from './types';
...
export function calculateResult(inputs: alpha';Inputs): number {
...
export function generateAnalysis(inputs: alpha';Inputs, metrics: alpha';Metrics): alpha';Analysis {
