import { compound_annual_growth_rate_calculator';Inputs, compound_annual_growth_rate_calculator';Metrics, compound_annual_growth_rate_calculator';Analysis } from './types';
...
export function calculateResult(inputs: compound_annual_growth_rate_calculator';Inputs): number {
...
export function generateAnalysis(inputs: compound_annual_growth_rate_calculator';Inputs, metrics: compound_annual_growth_rate_calculator';Metrics): compound_annual_growth_rate_calculator';Analysis {
