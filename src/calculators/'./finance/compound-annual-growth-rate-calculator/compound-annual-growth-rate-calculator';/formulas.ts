import { compound-annual-growth-rate-calculator';Inputs, compound-annual-growth-rate-calculator';Metrics, compound-annual-growth-rate-calculator';Analysis } from './types';
...
export function calculateResult(inputs: compound-annual-growth-rate-calculator';Inputs): number {
...
export function generateAnalysis(inputs: compound-annual-growth-rate-calculator';Inputs, metrics: compound-annual-growth-rate-calculator';Metrics): compound-annual-growth-rate-calculator';Analysis {
