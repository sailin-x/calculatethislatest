import { 401k-rollover';Inputs, 401k-rollover';Metrics, 401k-rollover';Analysis } from './types';
...
export function calculateResult(inputs: 401k-rollover';Inputs): number {
...
export function generateAnalysis(inputs: 401k-rollover';Inputs, metrics: 401k-rollover';Metrics): 401k-rollover';Analysis {
