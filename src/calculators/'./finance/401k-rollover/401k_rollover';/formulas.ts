import { 401k_rollover';Inputs, 401k_rollover';Metrics, 401k_rollover';Analysis } from './types';
...
export function calculateResult(inputs: 401k_rollover';Inputs): number {
...
export function generateAnalysis(inputs: 401k_rollover';Inputs, metrics: 401k_rollover';Metrics): 401k_rollover';Analysis {
