import { './finance/401k-rollover/401k_rollover';Inputs } from './types';

export function validateInputs(inputs: './finance/401k-rollover/401k_rollover';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
