import { liquidity_mining_calculator';Inputs, liquidity_mining_calculator';Metrics, liquidity_mining_calculator';Analysis } from './types';
...
export function calculateResult(inputs: liquidity_mining_calculator';Inputs): number {
...
export function generateAnalysis(inputs: liquidity_mining_calculator';Inputs, metrics: liquidity_mining_calculator';Metrics): liquidity_mining_calculator';Analysis {
