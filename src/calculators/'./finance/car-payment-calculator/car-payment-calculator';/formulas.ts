import { car-payment-calculator';Inputs, car-payment-calculator';Metrics, car-payment-calculator';Analysis } from './types';
...
export function calculateResult(inputs: car-payment-calculator';Inputs): number {
...
export function generateAnalysis(inputs: car-payment-calculator';Inputs, metrics: car-payment-calculator';Metrics): car-payment-calculator';Analysis {
