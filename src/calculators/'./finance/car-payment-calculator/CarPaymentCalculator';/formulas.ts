import { CarPaymentCalculator';Inputs, CarPaymentCalculator';Metrics, CarPaymentCalculator';Analysis } from './types';
...
export function calculateResult(inputs: CarPaymentCalculator';Inputs): number {
...
export function generateAnalysis(inputs: CarPaymentCalculator';Inputs, metrics: CarPaymentCalculator';Metrics): CarPaymentCalculator';Analysis {
