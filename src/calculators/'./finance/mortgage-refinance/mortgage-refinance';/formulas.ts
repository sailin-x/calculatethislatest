import { mortgage-refinance';Inputs, mortgage-refinance';Metrics, mortgage-refinance';Analysis } from './types';
...
export function calculateResult(inputs: mortgage-refinance';Inputs): number {
...
export function generateAnalysis(inputs: mortgage-refinance';Inputs, metrics: mortgage-refinance';Metrics): mortgage-refinance';Analysis {
