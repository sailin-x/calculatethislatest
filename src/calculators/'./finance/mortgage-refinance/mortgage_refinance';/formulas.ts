import { mortgage_refinance';Inputs, mortgage_refinance';Metrics, mortgage_refinance';Analysis } from './types';
...
export function calculateResult(inputs: mortgage_refinance';Inputs): number {
...
export function generateAnalysis(inputs: mortgage_refinance';Inputs, metrics: mortgage_refinance';Metrics): mortgage_refinance';Analysis {
