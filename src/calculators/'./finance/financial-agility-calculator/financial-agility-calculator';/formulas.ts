import { financial-agility-calculator';Inputs, financial-agility-calculator';Metrics, financial-agility-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-agility-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-agility-calculator';Inputs, metrics: financial-agility-calculator';Metrics): financial-agility-calculator';Analysis {
