import { financial_agility_calculator';Inputs, financial_agility_calculator';Metrics, financial_agility_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_agility_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_agility_calculator';Inputs, metrics: financial_agility_calculator';Metrics): financial_agility_calculator';Analysis {
