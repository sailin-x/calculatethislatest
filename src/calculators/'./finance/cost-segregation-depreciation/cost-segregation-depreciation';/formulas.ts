import { cost-segregation-depreciation';Inputs, cost-segregation-depreciation';Metrics, cost-segregation-depreciation';Analysis } from './types';
...
export function calculateResult(inputs: cost-segregation-depreciation';Inputs): number {
...
export function generateAnalysis(inputs: cost-segregation-depreciation';Inputs, metrics: cost-segregation-depreciation';Metrics): cost-segregation-depreciation';Analysis {
