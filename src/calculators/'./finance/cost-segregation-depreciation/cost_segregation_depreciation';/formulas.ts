import { cost_segregation_depreciation';Inputs, cost_segregation_depreciation';Metrics, cost_segregation_depreciation';Analysis } from './types';
...
export function calculateResult(inputs: cost_segregation_depreciation';Inputs): number {
...
export function generateAnalysis(inputs: cost_segregation_depreciation';Inputs, metrics: cost_segregation_depreciation';Metrics): cost_segregation_depreciation';Analysis {
