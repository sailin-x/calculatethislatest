import { './finance/title-insurance-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/title-insurance-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
