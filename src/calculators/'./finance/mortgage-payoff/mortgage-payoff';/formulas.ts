import { mortgage-payoff';Inputs, mortgage-payoff';Metrics, mortgage-payoff';Analysis } from './types';
...
export function calculateResult(inputs: mortgage-payoff';Inputs): number {
...
export function generateAnalysis(inputs: mortgage-payoff';Inputs, metrics: mortgage-payoff';Metrics): mortgage-payoff';Analysis {
