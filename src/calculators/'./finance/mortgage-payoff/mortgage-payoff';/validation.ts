import { './finance/mortgage-payoff/mortgage-payoff';Inputs } from './types';

export function validateInputs(inputs: './finance/mortgage-payoff/mortgage-payoff';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
