import { './finance/mortgage-payoff/mortgage_payoff';Inputs } from './types';

export function validateInputs(inputs: './finance/mortgage-payoff/mortgage_payoff';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
