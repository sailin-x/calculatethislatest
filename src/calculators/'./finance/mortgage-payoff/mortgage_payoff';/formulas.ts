import { mortgage_payoff';Inputs, mortgage_payoff';Metrics, mortgage_payoff';Analysis } from './types';
...
export function calculateResult(inputs: mortgage_payoff';Inputs): number {
...
export function generateAnalysis(inputs: mortgage_payoff';Inputs, metrics: mortgage_payoff';Metrics): mortgage_payoff';Analysis {
