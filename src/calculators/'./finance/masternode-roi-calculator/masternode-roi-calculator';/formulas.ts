import { masternode-roi-calculator';Inputs, masternode-roi-calculator';Metrics, masternode-roi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: masternode-roi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: masternode-roi-calculator';Inputs, metrics: masternode-roi-calculator';Metrics): masternode-roi-calculator';Analysis {
