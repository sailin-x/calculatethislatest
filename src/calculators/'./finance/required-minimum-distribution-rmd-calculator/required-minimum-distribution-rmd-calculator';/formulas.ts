import { required-minimum-distribution-rmd-calculator';Inputs, required-minimum-distribution-rmd-calculator';Metrics, required-minimum-distribution-rmd-calculator';Analysis } from './types';
...
export function calculateResult(inputs: required-minimum-distribution-rmd-calculator';Inputs): number {
...
export function generateAnalysis(inputs: required-minimum-distribution-rmd-calculator';Inputs, metrics: required-minimum-distribution-rmd-calculator';Metrics): required-minimum-distribution-rmd-calculator';Analysis {
