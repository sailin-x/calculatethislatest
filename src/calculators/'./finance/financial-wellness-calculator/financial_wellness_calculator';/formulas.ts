import { financial_wellness_calculator';Inputs, financial_wellness_calculator';Metrics, financial_wellness_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_wellness_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_wellness_calculator';Inputs, metrics: financial_wellness_calculator';Metrics): financial_wellness_calculator';Analysis {
