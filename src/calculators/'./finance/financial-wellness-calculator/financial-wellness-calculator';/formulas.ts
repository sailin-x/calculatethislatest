import { financial-wellness-calculator';Inputs, financial-wellness-calculator';Metrics, financial-wellness-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-wellness-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-wellness-calculator';Inputs, metrics: financial-wellness-calculator';Metrics): financial-wellness-calculator';Analysis {
