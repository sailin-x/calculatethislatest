import { expense-tracker-calculator';Inputs, expense-tracker-calculator';Metrics, expense-tracker-calculator';Analysis } from './types';
...
export function calculateResult(inputs: expense-tracker-calculator';Inputs): number {
...
export function generateAnalysis(inputs: expense-tracker-calculator';Inputs, metrics: expense-tracker-calculator';Metrics): expense-tracker-calculator';Analysis {
