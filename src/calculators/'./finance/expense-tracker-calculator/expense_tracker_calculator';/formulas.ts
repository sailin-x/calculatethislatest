import { expense_tracker_calculator';Inputs, expense_tracker_calculator';Metrics, expense_tracker_calculator';Analysis } from './types';
...
export function calculateResult(inputs: expense_tracker_calculator';Inputs): number {
...
export function generateAnalysis(inputs: expense_tracker_calculator';Inputs, metrics: expense_tracker_calculator';Metrics): expense_tracker_calculator';Analysis {
