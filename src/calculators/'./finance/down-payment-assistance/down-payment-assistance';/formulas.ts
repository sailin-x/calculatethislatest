import { down-payment-assistance';Inputs, down-payment-assistance';Metrics, down-payment-assistance';Analysis } from './types';
...
export function calculateResult(inputs: down-payment-assistance';Inputs): number {
...
export function generateAnalysis(inputs: down-payment-assistance';Inputs, metrics: down-payment-assistance';Metrics): down-payment-assistance';Analysis {
