import { down_payment_assistance';Inputs, down_payment_assistance';Metrics, down_payment_assistance';Analysis } from './types';
...
export function calculateResult(inputs: down_payment_assistance';Inputs): number {
...
export function generateAnalysis(inputs: down_payment_assistance';Inputs, metrics: down_payment_assistance';Metrics): down_payment_assistance';Analysis {
