import { './finance/pmi-cancellation/pmi_cancellation';Inputs } from './types';

export function validateInputs(inputs: './finance/pmi-cancellation/pmi_cancellation';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
