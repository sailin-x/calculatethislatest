import { pmi_cancellation';Inputs, pmi_cancellation';Metrics, pmi_cancellation';Analysis } from './types';
...
export function calculateResult(inputs: pmi_cancellation';Inputs): number {
...
export function generateAnalysis(inputs: pmi_cancellation';Inputs, metrics: pmi_cancellation';Metrics): pmi_cancellation';Analysis {
