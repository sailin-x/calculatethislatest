import { pmi-cancellation';Inputs, pmi-cancellation';Metrics, pmi-cancellation';Analysis } from './types';
...
export function calculateResult(inputs: pmi-cancellation';Inputs): number {
...
export function generateAnalysis(inputs: pmi-cancellation';Inputs, metrics: pmi-cancellation';Metrics): pmi-cancellation';Analysis {
