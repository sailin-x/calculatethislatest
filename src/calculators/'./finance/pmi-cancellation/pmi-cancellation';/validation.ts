import { './finance/pmi-cancellation/pmi-cancellation';Inputs } from './types';

export function validateInputs(inputs: './finance/pmi-cancellation/pmi-cancellation';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
