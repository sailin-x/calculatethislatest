import { commercial_real_estate_loan_amortization';Inputs, commercial_real_estate_loan_amortization';Metrics, commercial_real_estate_loan_amortization';Analysis } from './types';
...
export function calculateResult(inputs: commercial_real_estate_loan_amortization';Inputs): number {
...
export function generateAnalysis(inputs: commercial_real_estate_loan_amortization';Inputs, metrics: commercial_real_estate_loan_amortization';Metrics): commercial_real_estate_loan_amortization';Analysis {
