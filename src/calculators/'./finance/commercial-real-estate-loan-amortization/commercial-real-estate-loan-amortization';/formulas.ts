import { commercial-real-estate-loan-amortization';Inputs, commercial-real-estate-loan-amortization';Metrics, commercial-real-estate-loan-amortization';Analysis } from './types';
...
export function calculateResult(inputs: commercial-real-estate-loan-amortization';Inputs): number {
...
export function generateAnalysis(inputs: commercial-real-estate-loan-amortization';Inputs, metrics: commercial-real-estate-loan-amortization';Metrics): commercial-real-estate-loan-amortization';Analysis {
