import { 401k';Inputs, 401k';Metrics, 401k';Analysis } from './types';
...
export function calculateResult(inputs: 401k';Inputs): number {
...
export function generateAnalysis(inputs: 401k';Inputs, metrics: 401k';Metrics): 401k';Analysis {
