import { real_estate_syndication_calculator';Inputs, real_estate_syndication_calculator';Metrics, real_estate_syndication_calculator';Analysis } from './types';
...
export function calculateResult(inputs: real_estate_syndication_calculator';Inputs): number {
...
export function generateAnalysis(inputs: real_estate_syndication_calculator';Inputs, metrics: real_estate_syndication_calculator';Metrics): real_estate_syndication_calculator';Analysis {
