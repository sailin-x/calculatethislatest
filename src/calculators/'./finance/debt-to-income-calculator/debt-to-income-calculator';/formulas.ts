import { debt-to-income-calculator';Inputs, debt-to-income-calculator';Metrics, debt-to-income-calculator';Analysis } from './types';
...
export function calculateResult(inputs: debt-to-income-calculator';Inputs): number {
...
export function generateAnalysis(inputs: debt-to-income-calculator';Inputs, metrics: debt-to-income-calculator';Metrics): debt-to-income-calculator';Analysis {
