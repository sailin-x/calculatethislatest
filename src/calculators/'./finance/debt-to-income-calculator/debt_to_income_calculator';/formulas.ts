import { debt_to_income_calculator';Inputs, debt_to_income_calculator';Metrics, debt_to_income_calculator';Analysis } from './types';
...
export function calculateResult(inputs: debt_to_income_calculator';Inputs): number {
...
export function generateAnalysis(inputs: debt_to_income_calculator';Inputs, metrics: debt_to_income_calculator';Metrics): debt_to_income_calculator';Analysis {
