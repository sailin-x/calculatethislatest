import { DividendCalculator';Inputs, DividendCalculator';Metrics, DividendCalculator';Analysis } from './types';
...
export function calculateResult(inputs: DividendCalculator';Inputs): number {
...
export function generateAnalysis(inputs: DividendCalculator';Inputs, metrics: DividendCalculator';Metrics): DividendCalculator';Analysis {
