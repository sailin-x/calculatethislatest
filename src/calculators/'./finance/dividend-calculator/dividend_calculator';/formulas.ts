import { dividend_calculator';Inputs, dividend_calculator';Metrics, dividend_calculator';Analysis } from './types';
...
export function calculateResult(inputs: dividend_calculator';Inputs): number {
...
export function generateAnalysis(inputs: dividend_calculator';Inputs, metrics: dividend_calculator';Metrics): dividend_calculator';Analysis {
