import { financial-wisdom-calculator';Inputs, financial-wisdom-calculator';Metrics, financial-wisdom-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-wisdom-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-wisdom-calculator';Inputs, metrics: financial-wisdom-calculator';Metrics): financial-wisdom-calculator';Analysis {
