import { financial_wisdom_calculator';Inputs, financial_wisdom_calculator';Metrics, financial_wisdom_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_wisdom_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_wisdom_calculator';Inputs, metrics: financial_wisdom_calculator';Metrics): financial_wisdom_calculator';Analysis {
