import { financial_joy_calculator';Inputs, financial_joy_calculator';Metrics, financial_joy_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_joy_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_joy_calculator';Inputs, metrics: financial_joy_calculator';Metrics): financial_joy_calculator';Analysis {
