import { financial-joy-calculator';Inputs, financial-joy-calculator';Metrics, financial-joy-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-joy-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-joy-calculator';Inputs, metrics: financial-joy-calculator';Metrics): financial-joy-calculator';Analysis {
