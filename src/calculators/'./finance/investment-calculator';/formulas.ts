import { investment-calculator';Inputs, investment-calculator';Metrics, investment-calculator';Analysis } from './types';
...
export function calculateResult(inputs: investment-calculator';Inputs): number {
...
export function generateAnalysis(inputs: investment-calculator';Inputs, metrics: investment-calculator';Metrics): investment-calculator';Analysis {
