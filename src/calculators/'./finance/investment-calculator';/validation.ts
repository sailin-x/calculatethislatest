import { './finance/investment-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/investment-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
