import { DtiRatioCalculator';Inputs, DtiRatioCalculator';Metrics, DtiRatioCalculator';Analysis } from './types';
...
export function calculateResult(inputs: DtiRatioCalculator';Inputs): number {
...
export function generateAnalysis(inputs: DtiRatioCalculator';Inputs, metrics: DtiRatioCalculator';Metrics): DtiRatioCalculator';Analysis {
