import { self_storage_facility_roi_calculator';Inputs, self_storage_facility_roi_calculator';Metrics, self_storage_facility_roi_calculator';Analysis } from './types';
...
export function calculateResult(inputs: self_storage_facility_roi_calculator';Inputs): number {
...
export function generateAnalysis(inputs: self_storage_facility_roi_calculator';Inputs, metrics: self_storage_facility_roi_calculator';Metrics): self_storage_facility_roi_calculator';Analysis {
