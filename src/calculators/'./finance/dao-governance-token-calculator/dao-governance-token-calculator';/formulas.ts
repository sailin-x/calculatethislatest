import { dao-governance-token-calculator';Inputs, dao-governance-token-calculator';Metrics, dao-governance-token-calculator';Analysis } from './types';
...
export function calculateResult(inputs: dao-governance-token-calculator';Inputs): number {
...
export function generateAnalysis(inputs: dao-governance-token-calculator';Inputs, metrics: dao-governance-token-calculator';Metrics): dao-governance-token-calculator';Analysis {
