import { mortgage-apr-comparison';Inputs, mortgage-apr-comparison';Metrics, mortgage-apr-comparison';Analysis } from './types';
...
export function calculateResult(inputs: mortgage-apr-comparison';Inputs): number {
...
export function generateAnalysis(inputs: mortgage-apr-comparison';Inputs, metrics: mortgage-apr-comparison';Metrics): mortgage-apr-comparison';Analysis {
