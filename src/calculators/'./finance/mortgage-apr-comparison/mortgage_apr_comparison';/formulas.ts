import { mortgage_apr_comparison';Inputs, mortgage_apr_comparison';Metrics, mortgage_apr_comparison';Analysis } from './types';
...
export function calculateResult(inputs: mortgage_apr_comparison';Inputs): number {
...
export function generateAnalysis(inputs: mortgage_apr_comparison';Inputs, metrics: mortgage_apr_comparison';Metrics): mortgage_apr_comparison';Analysis {
