import { loan_to_value_ratio';Inputs, loan_to_value_ratio';Metrics, loan_to_value_ratio';Analysis } from './types';
...
export function calculateResult(inputs: loan_to_value_ratio';Inputs): number {
...
export function generateAnalysis(inputs: loan_to_value_ratio';Inputs, metrics: loan_to_value_ratio';Metrics): loan_to_value_ratio';Analysis {
