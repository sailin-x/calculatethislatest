import { loan-to-value-ratio';Inputs, loan-to-value-ratio';Metrics, loan-to-value-ratio';Analysis } from './types';
...
export function calculateResult(inputs: loan-to-value-ratio';Inputs): number {
...
export function generateAnalysis(inputs: loan-to-value-ratio';Inputs, metrics: loan-to-value-ratio';Metrics): loan-to-value-ratio';Analysis {
