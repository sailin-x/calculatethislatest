import { fafsa_calculator';Inputs, fafsa_calculator';Metrics, fafsa_calculator';Analysis } from './types';
...
export function calculateResult(inputs: fafsa_calculator';Inputs): number {
...
export function generateAnalysis(inputs: fafsa_calculator';Inputs, metrics: fafsa_calculator';Metrics): fafsa_calculator';Analysis {
