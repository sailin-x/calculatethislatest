import { './finance/fafsa-calculator/fafsa-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/fafsa-calculator/fafsa-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
