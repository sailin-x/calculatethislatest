import { financial-performance-calculator';Inputs, financial-performance-calculator';Metrics, financial-performance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-performance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-performance-calculator';Inputs, metrics: financial-performance-calculator';Metrics): financial-performance-calculator';Analysis {
