import { financial_performance_calculator';Inputs, financial_performance_calculator';Metrics, financial_performance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_performance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_performance_calculator';Inputs, metrics: financial_performance_calculator';Metrics): financial_performance_calculator';Analysis {
