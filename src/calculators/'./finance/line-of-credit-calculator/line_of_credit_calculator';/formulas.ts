import { line_of_credit_calculator';Inputs, line_of_credit_calculator';Metrics, line_of_credit_calculator';Analysis } from './types';
...
export function calculateResult(inputs: line_of_credit_calculator';Inputs): number {
...
export function generateAnalysis(inputs: line_of_credit_calculator';Inputs, metrics: line_of_credit_calculator';Metrics): line_of_credit_calculator';Analysis {
