import { bariatric-surgery-cost-savings-calculator';Inputs, bariatric-surgery-cost-savings-calculator';Metrics, bariatric-surgery-cost-savings-calculator';Analysis } from './types';
...
export function calculateResult(inputs: bariatric-surgery-cost-savings-calculator';Inputs): number {
...
export function generateAnalysis(inputs: bariatric-surgery-cost-savings-calculator';Inputs, metrics: bariatric-surgery-cost-savings-calculator';Metrics): bariatric-surgery-cost-savings-calculator';Analysis {
