import { financial-analysis-calculator';Inputs, financial-analysis-calculator';Metrics, financial-analysis-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-analysis-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-analysis-calculator';Inputs, metrics: financial-analysis-calculator';Metrics): financial-analysis-calculator';Analysis {
