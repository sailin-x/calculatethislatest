import { financial_analysis_calculator';Inputs, financial_analysis_calculator';Metrics, financial_analysis_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_analysis_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_analysis_calculator';Inputs, metrics: financial_analysis_calculator';Metrics): financial_analysis_calculator';Analysis {
