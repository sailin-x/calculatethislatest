import { financial-legacy-calculator';Inputs, financial-legacy-calculator';Metrics, financial-legacy-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-legacy-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-legacy-calculator';Inputs, metrics: financial-legacy-calculator';Metrics): financial-legacy-calculator';Analysis {
