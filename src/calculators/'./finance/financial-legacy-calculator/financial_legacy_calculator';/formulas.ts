import { financial_legacy_calculator';Inputs, financial_legacy_calculator';Metrics, financial_legacy_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_legacy_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_legacy_calculator';Inputs, metrics: financial_legacy_calculator';Metrics): financial_legacy_calculator';Analysis {
