import { CostOfDebtCalculator';Inputs, CostOfDebtCalculator';Metrics, CostOfDebtCalculator';Analysis } from './types';
...
export function calculateResult(inputs: CostOfDebtCalculator';Inputs): number {
...
export function generateAnalysis(inputs: CostOfDebtCalculator';Inputs, metrics: CostOfDebtCalculator';Metrics): CostOfDebtCalculator';Analysis {
