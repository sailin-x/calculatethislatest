import { defined_contribution_plan';Inputs, defined_contribution_plan';Metrics, defined_contribution_plan';Analysis } from './types';
...
export function calculateResult(inputs: defined_contribution_plan';Inputs): number {
...
export function generateAnalysis(inputs: defined_contribution_plan';Inputs, metrics: defined_contribution_plan';Metrics): defined_contribution_plan';Analysis {
