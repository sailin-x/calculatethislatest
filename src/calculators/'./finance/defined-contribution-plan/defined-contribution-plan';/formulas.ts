import { defined-contribution-plan';Inputs, defined-contribution-plan';Metrics, defined-contribution-plan';Analysis } from './types';
...
export function calculateResult(inputs: defined-contribution-plan';Inputs): number {
...
export function generateAnalysis(inputs: defined-contribution-plan';Inputs, metrics: defined-contribution-plan';Metrics): defined-contribution-plan';Analysis {
