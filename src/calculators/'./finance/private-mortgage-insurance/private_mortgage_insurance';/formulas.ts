import { private_mortgage_insurance';Inputs, private_mortgage_insurance';Metrics, private_mortgage_insurance';Analysis } from './types';
...
export function calculateResult(inputs: private_mortgage_insurance';Inputs): number {
...
export function generateAnalysis(inputs: private_mortgage_insurance';Inputs, metrics: private_mortgage_insurance';Metrics): private_mortgage_insurance';Analysis {
