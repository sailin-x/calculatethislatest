import { inheritance_tax_estimator';Inputs, inheritance_tax_estimator';Metrics, inheritance_tax_estimator';Analysis } from './types';
...
export function calculateResult(inputs: inheritance_tax_estimator';Inputs): number {
...
export function generateAnalysis(inputs: inheritance_tax_estimator';Inputs, metrics: inheritance_tax_estimator';Metrics): inheritance_tax_estimator';Analysis {
