import { inheritance-tax-estimator';Inputs, inheritance-tax-estimator';Metrics, inheritance-tax-estimator';Analysis } from './types';
...
export function calculateResult(inputs: inheritance-tax-estimator';Inputs): number {
...
export function generateAnalysis(inputs: inheritance-tax-estimator';Inputs, metrics: inheritance-tax-estimator';Metrics): inheritance-tax-estimator';Analysis {
