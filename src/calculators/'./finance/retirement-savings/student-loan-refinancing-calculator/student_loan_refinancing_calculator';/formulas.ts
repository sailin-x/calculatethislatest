import { student_loan_refinancing_calculator';Inputs, student_loan_refinancing_calculator';Metrics, student_loan_refinancing_calculator';Analysis } from './types';
...
export function calculateResult(inputs: student_loan_refinancing_calculator';Inputs): number {
...
export function generateAnalysis(inputs: student_loan_refinancing_calculator';Inputs, metrics: student_loan_refinancing_calculator';Metrics): student_loan_refinancing_calculator';Analysis {
