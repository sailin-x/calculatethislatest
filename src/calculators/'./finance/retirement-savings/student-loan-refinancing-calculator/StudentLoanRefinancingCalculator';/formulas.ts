import { StudentLoanRefinancingCalculator';Inputs, StudentLoanRefinancingCalculator';Metrics, StudentLoanRefinancingCalculator';Analysis } from './types';
...
export function calculateResult(inputs: StudentLoanRefinancingCalculator';Inputs): number {
...
export function generateAnalysis(inputs: StudentLoanRefinancingCalculator';Inputs, metrics: StudentLoanRefinancingCalculator';Metrics): StudentLoanRefinancingCalculator';Analysis {
