import { RequiredMinimumDistributionRmdCalculator';Inputs, RequiredMinimumDistributionRmdCalculator';Metrics, RequiredMinimumDistributionRmdCalculator';Analysis } from './types';
...
export function calculateResult(inputs: RequiredMinimumDistributionRmdCalculator';Inputs): number {
...
export function generateAnalysis(inputs: RequiredMinimumDistributionRmdCalculator';Inputs, metrics: RequiredMinimumDistributionRmdCalculator';Metrics): RequiredMinimumDistributionRmdCalculator';Analysis {
