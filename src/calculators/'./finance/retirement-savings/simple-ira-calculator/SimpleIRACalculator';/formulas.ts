import { SimpleIRACalculator';Inputs, SimpleIRACalculator';Metrics, SimpleIRACalculator';Analysis } from './types';
...
export function calculateResult(inputs: SimpleIRACalculator';Inputs): number {
...
export function generateAnalysis(inputs: SimpleIRACalculator';Inputs, metrics: SimpleIRACalculator';Metrics): SimpleIRACalculator';Analysis {
