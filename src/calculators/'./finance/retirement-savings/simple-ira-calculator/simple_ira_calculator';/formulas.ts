import { simple_ira_calculator';Inputs, simple_ira_calculator';Metrics, simple_ira_calculator';Analysis } from './types';
...
export function calculateResult(inputs: simple_ira_calculator';Inputs): number {
...
export function generateAnalysis(inputs: simple_ira_calculator';Inputs, metrics: simple_ira_calculator';Metrics): simple_ira_calculator';Analysis {
