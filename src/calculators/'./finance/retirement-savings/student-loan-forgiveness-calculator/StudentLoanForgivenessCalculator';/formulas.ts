import { StudentLoanForgivenessCalculator';Inputs, StudentLoanForgivenessCalculator';Metrics, StudentLoanForgivenessCalculator';Analysis } from './types';
...
export function calculateResult(inputs: StudentLoanForgivenessCalculator';Inputs): number {
...
export function generateAnalysis(inputs: StudentLoanForgivenessCalculator';Inputs, metrics: StudentLoanForgivenessCalculator';Metrics): StudentLoanForgivenessCalculator';Analysis {
