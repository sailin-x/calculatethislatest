import { SepIRACalculator';Inputs, SepIRACalculator';Metrics, SepIRACalculator';Analysis } from './types';
...
export function calculateResult(inputs: SepIRACalculator';Inputs): number {
...
export function generateAnalysis(inputs: SepIRACalculator';Inputs, metrics: SepIRACalculator';Metrics): SepIRACalculator';Analysis {
