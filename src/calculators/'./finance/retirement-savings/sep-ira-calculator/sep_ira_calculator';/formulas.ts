import { sep_ira_calculator';Inputs, sep_ira_calculator';Metrics, sep_ira_calculator';Analysis } from './types';
...
export function calculateResult(inputs: sep_ira_calculator';Inputs): number {
...
export function generateAnalysis(inputs: sep_ira_calculator';Inputs, metrics: sep_ira_calculator';Metrics): sep_ira_calculator';Analysis {
