import { StudentLoanRepaymentCalculator';Inputs, StudentLoanRepaymentCalculator';Metrics, StudentLoanRepaymentCalculator';Analysis } from './types';
...
export function calculateResult(inputs: StudentLoanRepaymentCalculator';Inputs): number {
...
export function generateAnalysis(inputs: StudentLoanRepaymentCalculator';Inputs, metrics: StudentLoanRepaymentCalculator';Metrics): StudentLoanRepaymentCalculator';Analysis {
