import { RequiredBeginningDateRmdCalculator';Inputs, RequiredBeginningDateRmdCalculator';Metrics, RequiredBeginningDateRmdCalculator';Analysis } from './types';
...
export function calculateResult(inputs: RequiredBeginningDateRmdCalculator';Inputs): number {
...
export function generateAnalysis(inputs: RequiredBeginningDateRmdCalculator';Inputs, metrics: RequiredBeginningDateRmdCalculator';Metrics): RequiredBeginningDateRmdCalculator';Analysis {
