import { TaxLossHarvestingCalculator';Inputs, TaxLossHarvestingCalculator';Metrics, TaxLossHarvestingCalculator';Analysis } from './types';
...
export function calculateResult(inputs: TaxLossHarvestingCalculator';Inputs): number {
...
export function generateAnalysis(inputs: TaxLossHarvestingCalculator';Inputs, metrics: TaxLossHarvestingCalculator';Metrics): TaxLossHarvestingCalculator';Analysis {
