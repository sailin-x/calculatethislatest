import { stretch_ira_calculator';Inputs, stretch_ira_calculator';Metrics, stretch_ira_calculator';Analysis } from './types';
...
export function calculateResult(inputs: stretch_ira_calculator';Inputs): number {
...
export function generateAnalysis(inputs: stretch_ira_calculator';Inputs, metrics: stretch_ira_calculator';Metrics): stretch_ira_calculator';Analysis {
