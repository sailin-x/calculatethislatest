import { StretchIRACalculator';Inputs, StretchIRACalculator';Metrics, StretchIRACalculator';Analysis } from './types';
...
export function calculateResult(inputs: StretchIRACalculator';Inputs): number {
...
export function generateAnalysis(inputs: StretchIRACalculator';Inputs, metrics: StretchIRACalculator';Metrics): StretchIRACalculator';Analysis {
