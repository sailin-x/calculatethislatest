import { StructuredSettlementPayoutCalculator';Inputs, StructuredSettlementPayoutCalculator';Metrics, StructuredSettlementPayoutCalculator';Analysis } from './types';
...
export function calculateResult(inputs: StructuredSettlementPayoutCalculator';Inputs): number {
...
export function generateAnalysis(inputs: StructuredSettlementPayoutCalculator';Inputs, metrics: StructuredSettlementPayoutCalculator';Metrics): StructuredSettlementPayoutCalculator';Analysis {
