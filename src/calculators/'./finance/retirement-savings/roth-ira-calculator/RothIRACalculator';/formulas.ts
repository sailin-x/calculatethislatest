import { RothIRACalculator';Inputs, RothIRACalculator';Metrics, RothIRACalculator';Analysis } from './types';
...
export function calculateResult(inputs: RothIRACalculator';Inputs): number {
...
export function generateAnalysis(inputs: RothIRACalculator';Inputs, metrics: RothIRACalculator';Metrics): RothIRACalculator';Analysis {
