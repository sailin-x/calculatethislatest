import { SocialSecurityOptimizationCalculator';Inputs, SocialSecurityOptimizationCalculator';Metrics, SocialSecurityOptimizationCalculator';Analysis } from './types';
...
export function calculateResult(inputs: SocialSecurityOptimizationCalculator';Inputs): number {
...
export function generateAnalysis(inputs: SocialSecurityOptimizationCalculator';Inputs, metrics: SocialSecurityOptimizationCalculator';Metrics): SocialSecurityOptimizationCalculator';Analysis {
