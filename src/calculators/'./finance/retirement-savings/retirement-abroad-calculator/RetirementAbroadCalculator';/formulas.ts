import { RetirementAbroadCalculator';Inputs, RetirementAbroadCalculator';Metrics, RetirementAbroadCalculator';Analysis } from './types';
...
export function calculateResult(inputs: RetirementAbroadCalculator';Inputs): number {
...
export function generateAnalysis(inputs: RetirementAbroadCalculator';Inputs, metrics: RetirementAbroadCalculator';Metrics): RetirementAbroadCalculator';Analysis {
