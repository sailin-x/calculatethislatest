import { rent_vs_buy_calculator';Inputs, rent_vs_buy_calculator';Metrics, rent_vs_buy_calculator';Analysis } from './types';
...
export function calculateResult(inputs: rent_vs_buy_calculator';Inputs): number {
...
export function generateAnalysis(inputs: rent_vs_buy_calculator';Inputs, metrics: rent_vs_buy_calculator';Metrics): rent_vs_buy_calculator';Analysis {
