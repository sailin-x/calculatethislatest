import { rent-vs-buy-calculator';Inputs, rent-vs-buy-calculator';Metrics, rent-vs-buy-calculator';Analysis } from './types';
...
export function calculateResult(inputs: rent-vs-buy-calculator';Inputs): number {
...
export function generateAnalysis(inputs: rent-vs-buy-calculator';Inputs, metrics: rent-vs-buy-calculator';Metrics): rent-vs-buy-calculator';Analysis {
