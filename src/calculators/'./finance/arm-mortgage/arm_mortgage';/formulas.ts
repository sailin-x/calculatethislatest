import { arm_mortgage';Inputs, arm_mortgage';Metrics, arm_mortgage';Analysis } from './types';
...
export function calculateResult(inputs: arm_mortgage';Inputs): number {
...
export function generateAnalysis(inputs: arm_mortgage';Inputs, metrics: arm_mortgage';Metrics): arm_mortgage';Analysis {
