import { './finance/arm-mortgage/arm_mortgage';Inputs } from './types';

export function validateInputs(inputs: './finance/arm-mortgage/arm_mortgage';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
