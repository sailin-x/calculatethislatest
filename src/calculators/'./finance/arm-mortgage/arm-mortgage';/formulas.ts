import { arm-mortgage';Inputs, arm-mortgage';Metrics, arm-mortgage';Analysis } from './types';
...
export function calculateResult(inputs: arm-mortgage';Inputs): number {
...
export function generateAnalysis(inputs: arm-mortgage';Inputs, metrics: arm-mortgage';Metrics): arm-mortgage';Analysis {
