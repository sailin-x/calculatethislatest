import { opportunity-zone-investment';Inputs, opportunity-zone-investment';Metrics, opportunity-zone-investment';Analysis } from './types';
...
export function calculateResult(inputs: opportunity-zone-investment';Inputs): number {
...
export function generateAnalysis(inputs: opportunity-zone-investment';Inputs, metrics: opportunity-zone-investment';Metrics): opportunity-zone-investment';Analysis {
