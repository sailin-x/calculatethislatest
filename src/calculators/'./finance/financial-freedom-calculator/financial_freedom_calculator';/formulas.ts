import { financial_freedom_calculator';Inputs, financial_freedom_calculator';Metrics, financial_freedom_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_freedom_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_freedom_calculator';Inputs, metrics: financial_freedom_calculator';Metrics): financial_freedom_calculator';Analysis {
