import { financial-freedom-calculator';Inputs, financial-freedom-calculator';Metrics, financial-freedom-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-freedom-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-freedom-calculator';Inputs, metrics: financial-freedom-calculator';Metrics): financial-freedom-calculator';Analysis {
