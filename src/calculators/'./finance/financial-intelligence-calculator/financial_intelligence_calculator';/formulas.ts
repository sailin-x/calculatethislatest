import { financial_intelligence_calculator';Inputs, financial_intelligence_calculator';Metrics, financial_intelligence_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_intelligence_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_intelligence_calculator';Inputs, metrics: financial_intelligence_calculator';Metrics): financial_intelligence_calculator';Analysis {
