import { property-tax-appeal-savings-calculator';Inputs, property-tax-appeal-savings-calculator';Metrics, property-tax-appeal-savings-calculator';Analysis } from './types';
...
export function calculateResult(inputs: property-tax-appeal-savings-calculator';Inputs): number {
...
export function generateAnalysis(inputs: property-tax-appeal-savings-calculator';Inputs, metrics: property-tax-appeal-savings-calculator';Metrics): property-tax-appeal-savings-calculator';Analysis {
