import { tenant_improvement_ti_allowance_calculator';Inputs, tenant_improvement_ti_allowance_calculator';Metrics, tenant_improvement_ti_allowance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: tenant_improvement_ti_allowance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: tenant_improvement_ti_allowance_calculator';Inputs, metrics: tenant_improvement_ti_allowance_calculator';Metrics): tenant_improvement_ti_allowance_calculator';Analysis {
