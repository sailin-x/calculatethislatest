import { financial-synergy-calculator';Inputs, financial-synergy-calculator';Metrics, financial-synergy-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-synergy-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-synergy-calculator';Inputs, metrics: financial-synergy-calculator';Metrics): financial-synergy-calculator';Analysis {
