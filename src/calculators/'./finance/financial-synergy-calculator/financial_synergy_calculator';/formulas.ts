import { financial_synergy_calculator';Inputs, financial_synergy_calculator';Metrics, financial_synergy_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_synergy_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_synergy_calculator';Inputs, metrics: financial_synergy_calculator';Metrics): financial_synergy_calculator';Analysis {
