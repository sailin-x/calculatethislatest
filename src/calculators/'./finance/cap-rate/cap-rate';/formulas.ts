import { cap-rate';Inputs, cap-rate';Metrics, cap-rate';Analysis } from './types';
...
export function calculateResult(inputs: cap-rate';Inputs): number {
...
export function generateAnalysis(inputs: cap-rate';Inputs, metrics: cap-rate';Metrics): cap-rate';Analysis {
