import { './finance/cap-rate/cap-rate';Inputs } from './types';

export function validateInputs(inputs: './finance/cap-rate/cap-rate';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
