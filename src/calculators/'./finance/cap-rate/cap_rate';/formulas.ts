import { cap_rate';Inputs, cap_rate';Metrics, cap_rate';Analysis } from './types';
...
export function calculateResult(inputs: cap_rate';Inputs): number {
...
export function generateAnalysis(inputs: cap_rate';Inputs, metrics: cap_rate';Metrics): cap_rate';Analysis {
