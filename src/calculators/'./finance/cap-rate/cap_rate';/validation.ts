import { './finance/cap-rate/cap_rate';Inputs } from './types';

export function validateInputs(inputs: './finance/cap-rate/cap_rate';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
