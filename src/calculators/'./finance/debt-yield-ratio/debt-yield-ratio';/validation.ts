import { './finance/debt-yield-ratio/debt-yield-ratio';Inputs } from './types';

export function validateInputs(inputs: './finance/debt-yield-ratio/debt-yield-ratio';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
