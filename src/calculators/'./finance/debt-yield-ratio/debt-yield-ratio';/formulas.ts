import { debt-yield-ratio';Inputs, debt-yield-ratio';Metrics, debt-yield-ratio';Analysis } from './types';
...
export function calculateResult(inputs: debt-yield-ratio';Inputs): number {
...
export function generateAnalysis(inputs: debt-yield-ratio';Inputs, metrics: debt-yield-ratio';Metrics): debt-yield-ratio';Analysis {
