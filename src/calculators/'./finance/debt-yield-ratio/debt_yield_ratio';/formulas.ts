import { debt_yield_ratio';Inputs, debt_yield_ratio';Metrics, debt_yield_ratio';Analysis } from './types';
...
export function calculateResult(inputs: debt_yield_ratio';Inputs): number {
...
export function generateAnalysis(inputs: debt_yield_ratio';Inputs, metrics: debt_yield_ratio';Metrics): debt_yield_ratio';Analysis {
