import { './finance/debt-yield-ratio/debt_yield_ratio';Inputs } from './types';

export function validateInputs(inputs: './finance/debt-yield-ratio/debt_yield_ratio';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
