import { pension-plan-funding-calculator';Inputs, pension-plan-funding-calculator';Metrics, pension-plan-funding-calculator';Analysis } from './types';
...
export function calculateResult(inputs: pension-plan-funding-calculator';Inputs): number {
...
export function generateAnalysis(inputs: pension-plan-funding-calculator';Inputs, metrics: pension-plan-funding-calculator';Metrics): pension-plan-funding-calculator';Analysis {
