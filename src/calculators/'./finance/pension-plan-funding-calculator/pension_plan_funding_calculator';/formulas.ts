import { pension_plan_funding_calculator';Inputs, pension_plan_funding_calculator';Metrics, pension_plan_funding_calculator';Analysis } from './types';
...
export function calculateResult(inputs: pension_plan_funding_calculator';Inputs): number {
...
export function generateAnalysis(inputs: pension_plan_funding_calculator';Inputs, metrics: pension_plan_funding_calculator';Metrics): pension_plan_funding_calculator';Analysis {
