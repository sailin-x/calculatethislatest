import { real-estate-investment';Inputs, real-estate-investment';Metrics, real-estate-investment';Analysis } from './types';
...
export function calculateResult(inputs: real-estate-investment';Inputs): number {
...
export function generateAnalysis(inputs: real-estate-investment';Inputs, metrics: real-estate-investment';Metrics): real-estate-investment';Analysis {
