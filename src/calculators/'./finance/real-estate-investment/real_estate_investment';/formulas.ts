import { real_estate_investment';Inputs, real_estate_investment';Metrics, real_estate_investment';Analysis } from './types';
...
export function calculateResult(inputs: real_estate_investment';Inputs): number {
...
export function generateAnalysis(inputs: real_estate_investment';Inputs, metrics: real_estate_investment';Metrics): real_estate_investment';Analysis {
