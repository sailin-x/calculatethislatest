import { reverse-mortgage-calculator';Inputs, reverse-mortgage-calculator';Metrics, reverse-mortgage-calculator';Analysis } from './types';
...
export function calculateResult(inputs: reverse-mortgage-calculator';Inputs): number {
...
export function generateAnalysis(inputs: reverse-mortgage-calculator';Inputs, metrics: reverse-mortgage-calculator';Metrics): reverse-mortgage-calculator';Analysis {
