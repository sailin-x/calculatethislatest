import { reverse_mortgage_calculator';Inputs, reverse_mortgage_calculator';Metrics, reverse_mortgage_calculator';Analysis } from './types';
...
export function calculateResult(inputs: reverse_mortgage_calculator';Inputs): number {
...
export function generateAnalysis(inputs: reverse_mortgage_calculator';Inputs, metrics: reverse_mortgage_calculator';Metrics): reverse_mortgage_calculator';Analysis {
