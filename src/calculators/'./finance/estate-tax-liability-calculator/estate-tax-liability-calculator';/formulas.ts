import { estate-tax-liability-calculator';Inputs, estate-tax-liability-calculator';Metrics, estate-tax-liability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: estate-tax-liability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: estate-tax-liability-calculator';Inputs, metrics: estate-tax-liability-calculator';Metrics): estate-tax-liability-calculator';Analysis {
