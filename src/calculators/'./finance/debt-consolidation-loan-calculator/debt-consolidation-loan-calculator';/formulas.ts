import { debt-consolidation-loan-calculator';Inputs, debt-consolidation-loan-calculator';Metrics, debt-consolidation-loan-calculator';Analysis } from './types';
...
export function calculateResult(inputs: debt-consolidation-loan-calculator';Inputs): number {
...
export function generateAnalysis(inputs: debt-consolidation-loan-calculator';Inputs, metrics: debt-consolidation-loan-calculator';Metrics): debt-consolidation-loan-calculator';Analysis {
