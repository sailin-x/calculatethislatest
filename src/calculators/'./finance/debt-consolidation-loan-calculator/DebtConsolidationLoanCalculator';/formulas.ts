import { DebtConsolidationLoanCalculator';Inputs, DebtConsolidationLoanCalculator';Metrics, DebtConsolidationLoanCalculator';Analysis } from './types';
...
export function calculateResult(inputs: DebtConsolidationLoanCalculator';Inputs): number {
...
export function generateAnalysis(inputs: DebtConsolidationLoanCalculator';Inputs, metrics: DebtConsolidationLoanCalculator';Metrics): DebtConsolidationLoanCalculator';Analysis {
