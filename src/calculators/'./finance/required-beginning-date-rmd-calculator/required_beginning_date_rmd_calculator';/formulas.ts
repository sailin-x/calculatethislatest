import { required_beginning_date_rmd_calculator';Inputs, required_beginning_date_rmd_calculator';Metrics, required_beginning_date_rmd_calculator';Analysis } from './types';
...
export function calculateResult(inputs: required_beginning_date_rmd_calculator';Inputs): number {
...
export function generateAnalysis(inputs: required_beginning_date_rmd_calculator';Inputs, metrics: required_beginning_date_rmd_calculator';Metrics): required_beginning_date_rmd_calculator';Analysis {
