import { required-beginning-date-rmd-calculator';Inputs, required-beginning-date-rmd-calculator';Metrics, required-beginning-date-rmd-calculator';Analysis } from './types';
...
export function calculateResult(inputs: required-beginning-date-rmd-calculator';Inputs): number {
...
export function generateAnalysis(inputs: required-beginning-date-rmd-calculator';Inputs, metrics: required-beginning-date-rmd-calculator';Metrics): required-beginning-date-rmd-calculator';Analysis {
