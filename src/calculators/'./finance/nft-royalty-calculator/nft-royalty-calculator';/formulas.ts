import { nft-royalty-calculator';Inputs, nft-royalty-calculator';Metrics, nft-royalty-calculator';Analysis } from './types';
...
export function calculateResult(inputs: nft-royalty-calculator';Inputs): number {
...
export function generateAnalysis(inputs: nft-royalty-calculator';Inputs, metrics: nft-royalty-calculator';Metrics): nft-royalty-calculator';Analysis {
