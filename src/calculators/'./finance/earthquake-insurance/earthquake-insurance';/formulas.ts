import { earthquake-insurance';Inputs, earthquake-insurance';Metrics, earthquake-insurance';Analysis } from './types';
...
export function calculateResult(inputs: earthquake-insurance';Inputs): number {
...
export function generateAnalysis(inputs: earthquake-insurance';Inputs, metrics: earthquake-insurance';Metrics): earthquake-insurance';Analysis {
