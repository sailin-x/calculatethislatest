import { earthquake_insurance';Inputs, earthquake_insurance';Metrics, earthquake_insurance';Analysis } from './types';
...
export function calculateResult(inputs: earthquake_insurance';Inputs): number {
...
export function generateAnalysis(inputs: earthquake_insurance';Inputs, metrics: earthquake_insurance';Metrics): earthquake_insurance';Analysis {
