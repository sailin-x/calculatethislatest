import { free-cash-flow-to-equity-fcfe-valuation';Inputs, free-cash-flow-to-equity-fcfe-valuation';Metrics, free-cash-flow-to-equity-fcfe-valuation';Analysis } from './types';
...
export function calculateResult(inputs: free-cash-flow-to-equity-fcfe-valuation';Inputs): number {
...
export function generateAnalysis(inputs: free-cash-flow-to-equity-fcfe-valuation';Inputs, metrics: free-cash-flow-to-equity-fcfe-valuation';Metrics): free-cash-flow-to-equity-fcfe-valuation';Analysis {
