import { './finance/mortgage-payment/mortgage_payment';Inputs } from './types';

export function validateInputs(inputs: './finance/mortgage-payment/mortgage_payment';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
