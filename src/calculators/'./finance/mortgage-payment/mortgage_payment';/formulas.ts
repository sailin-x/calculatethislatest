import { mortgage_payment';Inputs, mortgage_payment';Metrics, mortgage_payment';Analysis } from './types';
...
export function calculateResult(inputs: mortgage_payment';Inputs): number {
...
export function generateAnalysis(inputs: mortgage_payment';Inputs, metrics: mortgage_payment';Metrics): mortgage_payment';Analysis {
