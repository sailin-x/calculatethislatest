import { './finance/mortgage-payment/mortgage-payment';Inputs } from './types';

export function validateInputs(inputs: './finance/mortgage-payment/mortgage-payment';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
