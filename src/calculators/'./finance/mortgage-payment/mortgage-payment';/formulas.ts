import { mortgage-payment';Inputs, mortgage-payment';Metrics, mortgage-payment';Analysis } from './types';
...
export function calculateResult(inputs: mortgage-payment';Inputs): number {
...
export function generateAnalysis(inputs: mortgage-payment';Inputs, metrics: mortgage-payment';Metrics): mortgage-payment';Analysis {
