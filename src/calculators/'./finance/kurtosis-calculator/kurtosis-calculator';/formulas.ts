import { kurtosis-calculator';Inputs, kurtosis-calculator';Metrics, kurtosis-calculator';Analysis } from './types';
...
export function calculateResult(inputs: kurtosis-calculator';Inputs): number {
...
export function generateAnalysis(inputs: kurtosis-calculator';Inputs, metrics: kurtosis-calculator';Metrics): kurtosis-calculator';Analysis {
