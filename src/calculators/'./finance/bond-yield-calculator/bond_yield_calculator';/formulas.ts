import { bond_yield_calculator';Inputs, bond_yield_calculator';Metrics, bond_yield_calculator';Analysis } from './types';
...
export function calculateResult(inputs: bond_yield_calculator';Inputs): number {
...
export function generateAnalysis(inputs: bond_yield_calculator';Inputs, metrics: bond_yield_calculator';Metrics): bond_yield_calculator';Analysis {
