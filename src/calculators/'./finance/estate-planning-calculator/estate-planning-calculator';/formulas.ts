import { estate-planning-calculator';Inputs, estate-planning-calculator';Metrics, estate-planning-calculator';Analysis } from './types';
...
export function calculateResult(inputs: estate-planning-calculator';Inputs): number {
...
export function generateAnalysis(inputs: estate-planning-calculator';Inputs, metrics: estate-planning-calculator';Metrics): estate-planning-calculator';Analysis {
