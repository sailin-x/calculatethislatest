import { estate_planning_calculator';Inputs, estate_planning_calculator';Metrics, estate_planning_calculator';Analysis } from './types';
...
export function calculateResult(inputs: estate_planning_calculator';Inputs): number {
...
export function generateAnalysis(inputs: estate_planning_calculator';Inputs, metrics: estate_planning_calculator';Metrics): estate_planning_calculator';Analysis {
