import { 1031-exchange';Inputs, 1031-exchange';Metrics, 1031-exchange';Analysis } from './types';
...
export function calculateResult(inputs: 1031-exchange';Inputs): number {
...
export function generateAnalysis(inputs: 1031-exchange';Inputs, metrics: 1031-exchange';Metrics): 1031-exchange';Analysis {
