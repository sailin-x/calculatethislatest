import { './finance/1031-exchange/1031_exchange';Inputs } from './types';

export function validateInputs(inputs: './finance/1031-exchange/1031_exchange';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
