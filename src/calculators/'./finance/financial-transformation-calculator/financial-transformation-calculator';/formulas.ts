import { financial-transformation-calculator';Inputs, financial-transformation-calculator';Metrics, financial-transformation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-transformation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-transformation-calculator';Inputs, metrics: financial-transformation-calculator';Metrics): financial-transformation-calculator';Analysis {
