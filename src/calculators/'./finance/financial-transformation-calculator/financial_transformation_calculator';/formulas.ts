import { financial_transformation_calculator';Inputs, financial_transformation_calculator';Metrics, financial_transformation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_transformation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_transformation_calculator';Inputs, metrics: financial_transformation_calculator';Metrics): financial_transformation_calculator';Analysis {
