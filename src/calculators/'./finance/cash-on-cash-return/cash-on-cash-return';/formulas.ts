import { cash-on-cash-return';Inputs, cash-on-cash-return';Metrics, cash-on-cash-return';Analysis } from './types';
...
export function calculateResult(inputs: cash-on-cash-return';Inputs): number {
...
export function generateAnalysis(inputs: cash-on-cash-return';Inputs, metrics: cash-on-cash-return';Metrics): cash-on-cash-return';Analysis {
