import { cash_on_cash_return';Inputs, cash_on_cash_return';Metrics, cash_on_cash_return';Analysis } from './types';
...
export function calculateResult(inputs: cash_on_cash_return';Inputs): number {
...
export function generateAnalysis(inputs: cash_on_cash_return';Inputs, metrics: cash_on_cash_return';Metrics): cash_on_cash_return';Analysis {
