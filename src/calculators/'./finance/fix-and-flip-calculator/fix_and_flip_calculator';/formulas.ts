import { fix_and_flip_calculator';Inputs, fix_and_flip_calculator';Metrics, fix_and_flip_calculator';Analysis } from './types';
...
export function calculateResult(inputs: fix_and_flip_calculator';Inputs): number {
...
export function generateAnalysis(inputs: fix_and_flip_calculator';Inputs, metrics: fix_and_flip_calculator';Metrics): fix_and_flip_calculator';Analysis {
