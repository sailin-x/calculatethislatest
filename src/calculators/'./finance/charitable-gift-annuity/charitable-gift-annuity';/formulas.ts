import { charitable-gift-annuity';Inputs, charitable-gift-annuity';Metrics, charitable-gift-annuity';Analysis } from './types';
...
export function calculateResult(inputs: charitable-gift-annuity';Inputs): number {
...
export function generateAnalysis(inputs: charitable-gift-annuity';Inputs, metrics: charitable-gift-annuity';Metrics): charitable-gift-annuity';Analysis {
