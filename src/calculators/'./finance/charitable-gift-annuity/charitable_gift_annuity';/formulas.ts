import { charitable_gift_annuity';Inputs, charitable_gift_annuity';Metrics, charitable_gift_annuity';Analysis } from './types';
...
export function calculateResult(inputs: charitable_gift_annuity';Inputs): number {
...
export function generateAnalysis(inputs: charitable_gift_annuity';Inputs, metrics: charitable_gift_annuity';Metrics): charitable_gift_annuity';Analysis {
