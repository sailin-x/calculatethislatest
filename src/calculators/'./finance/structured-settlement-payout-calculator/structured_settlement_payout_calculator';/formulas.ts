import { structured_settlement_payout_calculator';Inputs, structured_settlement_payout_calculator';Metrics, structured_settlement_payout_calculator';Analysis } from './types';
...
export function calculateResult(inputs: structured_settlement_payout_calculator';Inputs): number {
...
export function generateAnalysis(inputs: structured_settlement_payout_calculator';Inputs, metrics: structured_settlement_payout_calculator';Metrics): structured_settlement_payout_calculator';Analysis {
