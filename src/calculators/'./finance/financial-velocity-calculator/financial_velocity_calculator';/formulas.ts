import { financial_velocity_calculator';Inputs, financial_velocity_calculator';Metrics, financial_velocity_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_velocity_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_velocity_calculator';Inputs, metrics: financial_velocity_calculator';Metrics): financial_velocity_calculator';Analysis {
