import { financial-velocity-calculator';Inputs, financial-velocity-calculator';Metrics, financial-velocity-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-velocity-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-velocity-calculator';Inputs, metrics: financial-velocity-calculator';Metrics): financial-velocity-calculator';Analysis {
