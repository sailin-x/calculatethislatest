import { mortgage-refinance-calculator';Inputs, mortgage-refinance-calculator';Metrics, mortgage-refinance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: mortgage-refinance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: mortgage-refinance-calculator';Inputs, metrics: mortgage-refinance-calculator';Metrics): mortgage-refinance-calculator';Analysis {
