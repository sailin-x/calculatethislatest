import { mortgage_refinance_calculator';Inputs, mortgage_refinance_calculator';Metrics, mortgage_refinance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: mortgage_refinance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: mortgage_refinance_calculator';Inputs, metrics: mortgage_refinance_calculator';Metrics): mortgage_refinance_calculator';Analysis {
