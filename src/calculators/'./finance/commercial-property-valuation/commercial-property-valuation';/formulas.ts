import { commercial-property-valuation';Inputs, commercial-property-valuation';Metrics, commercial-property-valuation';Analysis } from './types';
...
export function calculateResult(inputs: commercial-property-valuation';Inputs): number {
...
export function generateAnalysis(inputs: commercial-property-valuation';Inputs, metrics: commercial-property-valuation';Metrics): commercial-property-valuation';Analysis {
