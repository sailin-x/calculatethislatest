import { commercial_property_valuation';Inputs, commercial_property_valuation';Metrics, commercial_property_valuation';Analysis } from './types';
...
export function calculateResult(inputs: commercial_property_valuation';Inputs): number {
...
export function generateAnalysis(inputs: commercial_property_valuation';Inputs, metrics: commercial_property_valuation';Metrics): commercial_property_valuation';Analysis {
