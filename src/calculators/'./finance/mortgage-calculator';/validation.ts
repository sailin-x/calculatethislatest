import { './finance/mortgage-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/mortgage-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
