import { mortgage-calculator';Inputs, mortgage-calculator';Metrics, mortgage-calculator';Analysis } from './types';
...
export function calculateResult(inputs: mortgage-calculator';Inputs): number {
...
export function generateAnalysis(inputs: mortgage-calculator';Inputs, metrics: mortgage-calculator';Metrics): mortgage-calculator';Analysis {
