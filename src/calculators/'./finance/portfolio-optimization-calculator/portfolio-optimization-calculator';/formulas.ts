import { portfolio-optimization-calculator';Inputs, portfolio-optimization-calculator';Metrics, portfolio-optimization-calculator';Analysis } from './types';
...
export function calculateResult(inputs: portfolio-optimization-calculator';Inputs): number {
...
export function generateAnalysis(inputs: portfolio-optimization-calculator';Inputs, metrics: portfolio-optimization-calculator';Metrics): portfolio-optimization-calculator';Analysis {
