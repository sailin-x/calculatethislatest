import { portfolio_optimization_calculator';Inputs, portfolio_optimization_calculator';Metrics, portfolio_optimization_calculator';Analysis } from './types';
...
export function calculateResult(inputs: portfolio_optimization_calculator';Inputs): number {
...
export function generateAnalysis(inputs: portfolio_optimization_calculator';Inputs, metrics: portfolio_optimization_calculator';Metrics): portfolio_optimization_calculator';Analysis {
