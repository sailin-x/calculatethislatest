import { initial-coin-offering-calculator';Inputs, initial-coin-offering-calculator';Metrics, initial-coin-offering-calculator';Analysis } from './types';
...
export function calculateResult(inputs: initial-coin-offering-calculator';Inputs): number {
...
export function generateAnalysis(inputs: initial-coin-offering-calculator';Inputs, metrics: initial-coin-offering-calculator';Metrics): initial-coin-offering-calculator';Analysis {
