import { crypto-staking-profitability-calculator-exists-but-needs-registration';Inputs, crypto-staking-profitability-calculator-exists-but-needs-registration';Metrics, crypto-staking-profitability-calculator-exists-but-needs-registration';Analysis } from './types';
...
export function calculateResult(inputs: crypto-staking-profitability-calculator-exists-but-needs-registration';Inputs): number {
...
export function generateAnalysis(inputs: crypto-staking-profitability-calculator-exists-but-needs-registration';Inputs, metrics: crypto-staking-profitability-calculator-exists-but-needs-registration';Metrics): crypto-staking-profitability-calculator-exists-but-needs-registration';Analysis {
