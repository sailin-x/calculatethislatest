import { building-replacement-cost';Inputs, building-replacement-cost';Metrics, building-replacement-cost';Analysis } from './types';
...
export function calculateResult(inputs: building-replacement-cost';Inputs): number {
...
export function generateAnalysis(inputs: building-replacement-cost';Inputs, metrics: building-replacement-cost';Metrics): building-replacement-cost';Analysis {
