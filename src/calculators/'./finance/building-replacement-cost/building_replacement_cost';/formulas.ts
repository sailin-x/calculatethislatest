import { building_replacement_cost';Inputs, building_replacement_cost';Metrics, building_replacement_cost';Analysis } from './types';
...
export function calculateResult(inputs: building_replacement_cost';Inputs): number {
...
export function generateAnalysis(inputs: building_replacement_cost';Inputs, metrics: building_replacement_cost';Metrics): building_replacement_cost';Analysis {
