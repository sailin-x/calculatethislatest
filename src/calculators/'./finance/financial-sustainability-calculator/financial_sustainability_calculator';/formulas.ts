import { financial_sustainability_calculator';Inputs, financial_sustainability_calculator';Metrics, financial_sustainability_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_sustainability_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_sustainability_calculator';Inputs, metrics: financial_sustainability_calculator';Metrics): financial_sustainability_calculator';Analysis {
