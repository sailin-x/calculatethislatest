import { financial-sustainability-calculator';Inputs, financial-sustainability-calculator';Metrics, financial-sustainability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-sustainability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-sustainability-calculator';Inputs, metrics: financial-sustainability-calculator';Metrics): financial-sustainability-calculator';Analysis {
