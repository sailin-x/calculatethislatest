import { asset_based_lending_calculator';Inputs, asset_based_lending_calculator';Metrics, asset_based_lending_calculator';Analysis } from './types';
...
export function calculateResult(inputs: asset_based_lending_calculator';Inputs): number {
...
export function generateAnalysis(inputs: asset_based_lending_calculator';Inputs, metrics: asset_based_lending_calculator';Metrics): asset_based_lending_calculator';Analysis {
