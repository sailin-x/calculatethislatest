import { asset-based-lending-calculator';Inputs, asset-based-lending-calculator';Metrics, asset-based-lending-calculator';Analysis } from './types';
...
export function calculateResult(inputs: asset-based-lending-calculator';Inputs): number {
...
export function generateAnalysis(inputs: asset-based-lending-calculator';Inputs, metrics: asset-based-lending-calculator';Metrics): asset-based-lending-calculator';Analysis {
