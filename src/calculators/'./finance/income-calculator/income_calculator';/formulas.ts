import { income_calculator';Inputs, income_calculator';Metrics, income_calculator';Analysis } from './types';
...
export function calculateResult(inputs: income_calculator';Inputs): number {
...
export function generateAnalysis(inputs: income_calculator';Inputs, metrics: income_calculator';Metrics): income_calculator';Analysis {
