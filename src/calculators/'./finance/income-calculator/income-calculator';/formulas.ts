import { income-calculator';Inputs, income-calculator';Metrics, income-calculator';Analysis } from './types';
...
export function calculateResult(inputs: income-calculator';Inputs): number {
...
export function generateAnalysis(inputs: income-calculator';Inputs, metrics: income-calculator';Metrics): income-calculator';Analysis {
