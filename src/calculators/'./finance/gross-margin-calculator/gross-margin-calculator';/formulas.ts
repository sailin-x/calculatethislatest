import { gross-margin-calculator';Inputs, gross-margin-calculator';Metrics, gross-margin-calculator';Analysis } from './types';
...
export function calculateResult(inputs: gross-margin-calculator';Inputs): number {
...
export function generateAnalysis(inputs: gross-margin-calculator';Inputs, metrics: gross-margin-calculator';Metrics): gross-margin-calculator';Analysis {
