import { financial-mastery-calculator';Inputs, financial-mastery-calculator';Metrics, financial-mastery-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-mastery-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-mastery-calculator';Inputs, metrics: financial-mastery-calculator';Metrics): financial-mastery-calculator';Analysis {
