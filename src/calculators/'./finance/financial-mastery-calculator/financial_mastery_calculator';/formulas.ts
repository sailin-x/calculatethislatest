import { financial_mastery_calculator';Inputs, financial_mastery_calculator';Metrics, financial_mastery_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_mastery_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_mastery_calculator';Inputs, metrics: financial_mastery_calculator';Metrics): financial_mastery_calculator';Analysis {
