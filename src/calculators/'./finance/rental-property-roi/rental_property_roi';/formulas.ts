import { rental_property_roi';Inputs, rental_property_roi';Metrics, rental_property_roi';Analysis } from './types';
...
export function calculateResult(inputs: rental_property_roi';Inputs): number {
...
export function generateAnalysis(inputs: rental_property_roi';Inputs, metrics: rental_property_roi';Metrics): rental_property_roi';Analysis {
