import { rental-property-roi';Inputs, rental-property-roi';Metrics, rental-property-roi';Analysis } from './types';
...
export function calculateResult(inputs: rental-property-roi';Inputs): number {
...
export function generateAnalysis(inputs: rental-property-roi';Inputs, metrics: rental-property-roi';Metrics): rental-property-roi';Analysis {
