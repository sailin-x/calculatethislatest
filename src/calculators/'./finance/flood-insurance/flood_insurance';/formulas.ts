import { flood_insurance';Inputs, flood_insurance';Metrics, flood_insurance';Analysis } from './types';
...
export function calculateResult(inputs: flood_insurance';Inputs): number {
...
export function generateAnalysis(inputs: flood_insurance';Inputs, metrics: flood_insurance';Metrics): flood_insurance';Analysis {
