import { './finance/flood-insurance/flood_insurance';Inputs } from './types';

export function validateInputs(inputs: './finance/flood-insurance/flood_insurance';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
