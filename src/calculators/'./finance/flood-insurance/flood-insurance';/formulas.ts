import { flood-insurance';Inputs, flood-insurance';Metrics, flood-insurance';Analysis } from './types';
...
export function calculateResult(inputs: flood-insurance';Inputs): number {
...
export function generateAnalysis(inputs: flood-insurance';Inputs, metrics: flood-insurance';Metrics): flood-insurance';Analysis {
