import { './finance/flood-insurance/flood-insurance';Inputs } from './types';

export function validateInputs(inputs: './finance/flood-insurance/flood-insurance';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
