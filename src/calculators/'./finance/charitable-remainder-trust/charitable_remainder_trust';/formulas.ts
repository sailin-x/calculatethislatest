import { charitable_remainder_trust';Inputs, charitable_remainder_trust';Metrics, charitable_remainder_trust';Analysis } from './types';
...
export function calculateResult(inputs: charitable_remainder_trust';Inputs): number {
...
export function generateAnalysis(inputs: charitable_remainder_trust';Inputs, metrics: charitable_remainder_trust';Metrics): charitable_remainder_trust';Analysis {
