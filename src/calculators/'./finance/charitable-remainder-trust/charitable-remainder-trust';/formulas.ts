import { charitable-remainder-trust';Inputs, charitable-remainder-trust';Metrics, charitable-remainder-trust';Analysis } from './types';
...
export function calculateResult(inputs: charitable-remainder-trust';Inputs): number {
...
export function generateAnalysis(inputs: charitable-remainder-trust';Inputs, metrics: charitable-remainder-trust';Metrics): charitable-remainder-trust';Analysis {
