import { futures-trading-profitability-calculator';Inputs, futures-trading-profitability-calculator';Metrics, futures-trading-profitability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: futures-trading-profitability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: futures-trading-profitability-calculator';Inputs, metrics: futures-trading-profitability-calculator';Metrics): futures-trading-profitability-calculator';Analysis {
