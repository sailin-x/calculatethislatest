import { futures_trading_profitability_calculator';Inputs, futures_trading_profitability_calculator';Metrics, futures_trading_profitability_calculator';Analysis } from './types';
...
export function calculateResult(inputs: futures_trading_profitability_calculator';Inputs): number {
...
export function generateAnalysis(inputs: futures_trading_profitability_calculator';Inputs, metrics: futures_trading_profitability_calculator';Metrics): futures_trading_profitability_calculator';Analysis {
