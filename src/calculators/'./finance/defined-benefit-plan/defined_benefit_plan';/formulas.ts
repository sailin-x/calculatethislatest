import { defined_benefit_plan';Inputs, defined_benefit_plan';Metrics, defined_benefit_plan';Analysis } from './types';
...
export function calculateResult(inputs: defined_benefit_plan';Inputs): number {
...
export function generateAnalysis(inputs: defined_benefit_plan';Inputs, metrics: defined_benefit_plan';Metrics): defined_benefit_plan';Analysis {
