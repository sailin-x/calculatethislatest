import { defined-benefit-plan';Inputs, defined-benefit-plan';Metrics, defined-benefit-plan';Analysis } from './types';
...
export function calculateResult(inputs: defined-benefit-plan';Inputs): number {
...
export function generateAnalysis(inputs: defined-benefit-plan';Inputs, metrics: defined-benefit-plan';Metrics): defined-benefit-plan';Analysis {
