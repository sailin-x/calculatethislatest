import { pension_lump_sum_vs_annuity_calculator';Inputs, pension_lump_sum_vs_annuity_calculator';Metrics, pension_lump_sum_vs_annuity_calculator';Analysis } from './types';
...
export function calculateResult(inputs: pension_lump_sum_vs_annuity_calculator';Inputs): number {
...
export function generateAnalysis(inputs: pension_lump_sum_vs_annuity_calculator';Inputs, metrics: pension_lump_sum_vs_annuity_calculator';Metrics): pension_lump_sum_vs_annuity_calculator';Analysis {
