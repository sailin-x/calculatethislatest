import { pension-lump-sum-vs-annuity-calculator';Inputs, pension-lump-sum-vs-annuity-calculator';Metrics, pension-lump-sum-vs-annuity-calculator';Analysis } from './types';
...
export function calculateResult(inputs: pension-lump-sum-vs-annuity-calculator';Inputs): number {
...
export function generateAnalysis(inputs: pension-lump-sum-vs-annuity-calculator';Inputs, metrics: pension-lump-sum-vs-annuity-calculator';Metrics): pension-lump-sum-vs-annuity-calculator';Analysis {
