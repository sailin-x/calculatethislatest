import { conservation_easement_tax_benefit';Inputs, conservation_easement_tax_benefit';Metrics, conservation_easement_tax_benefit';Analysis } from './types';
...
export function calculateResult(inputs: conservation_easement_tax_benefit';Inputs): number {
...
export function generateAnalysis(inputs: conservation_easement_tax_benefit';Inputs, metrics: conservation_easement_tax_benefit';Metrics): conservation_easement_tax_benefit';Analysis {
