import { conservation-easement-tax-benefit';Inputs, conservation-easement-tax-benefit';Metrics, conservation-easement-tax-benefit';Analysis } from './types';
...
export function calculateResult(inputs: conservation-easement-tax-benefit';Inputs): number {
...
export function generateAnalysis(inputs: conservation-easement-tax-benefit';Inputs, metrics: conservation-easement-tax-benefit';Metrics): conservation-easement-tax-benefit';Analysis {
