import { hotel-feasibility';Inputs, hotel-feasibility';Metrics, hotel-feasibility';Analysis } from './types';
...
export function calculateResult(inputs: hotel-feasibility';Inputs): number {
...
export function generateAnalysis(inputs: hotel-feasibility';Inputs, metrics: hotel-feasibility';Metrics): hotel-feasibility';Analysis {
