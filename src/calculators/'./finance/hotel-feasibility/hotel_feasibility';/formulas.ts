import { hotel_feasibility';Inputs, hotel_feasibility';Metrics, hotel_feasibility';Analysis } from './types';
...
export function calculateResult(inputs: hotel_feasibility';Inputs): number {
...
export function generateAnalysis(inputs: hotel_feasibility';Inputs, metrics: hotel_feasibility';Metrics): hotel_feasibility';Analysis {
