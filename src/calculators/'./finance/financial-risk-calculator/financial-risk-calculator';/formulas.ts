import { financial-risk-calculator';Inputs, financial-risk-calculator';Metrics, financial-risk-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-risk-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-risk-calculator';Inputs, metrics: financial-risk-calculator';Metrics): financial-risk-calculator';Analysis {
