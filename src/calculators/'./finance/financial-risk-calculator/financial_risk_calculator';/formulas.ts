import { financial_risk_calculator';Inputs, financial_risk_calculator';Metrics, financial_risk_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_risk_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_risk_calculator';Inputs, metrics: financial_risk_calculator';Metrics): financial_risk_calculator';Analysis {
