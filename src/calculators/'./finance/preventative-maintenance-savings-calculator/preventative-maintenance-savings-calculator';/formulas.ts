import { preventative-maintenance-savings-calculator';Inputs, preventative-maintenance-savings-calculator';Metrics, preventative-maintenance-savings-calculator';Analysis } from './types';
...
export function calculateResult(inputs: preventative-maintenance-savings-calculator';Inputs): number {
...
export function generateAnalysis(inputs: preventative-maintenance-savings-calculator';Inputs, metrics: preventative-maintenance-savings-calculator';Metrics): preventative-maintenance-savings-calculator';Analysis {
