import { hedge-fund-fee-calculator';Inputs, hedge-fund-fee-calculator';Metrics, hedge-fund-fee-calculator';Analysis } from './types';
...
export function calculateResult(inputs: hedge-fund-fee-calculator';Inputs): number {
...
export function generateAnalysis(inputs: hedge-fund-fee-calculator';Inputs, metrics: hedge-fund-fee-calculator';Metrics): hedge-fund-fee-calculator';Analysis {
