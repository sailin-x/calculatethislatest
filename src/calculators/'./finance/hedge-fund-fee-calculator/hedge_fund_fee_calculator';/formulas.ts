import { hedge_fund_fee_calculator';Inputs, hedge_fund_fee_calculator';Metrics, hedge_fund_fee_calculator';Analysis } from './types';
...
export function calculateResult(inputs: hedge_fund_fee_calculator';Inputs): number {
...
export function generateAnalysis(inputs: hedge_fund_fee_calculator';Inputs, metrics: hedge_fund_fee_calculator';Metrics): hedge_fund_fee_calculator';Analysis {
