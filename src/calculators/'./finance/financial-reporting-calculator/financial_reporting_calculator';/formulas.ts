import { financial_reporting_calculator';Inputs, financial_reporting_calculator';Metrics, financial_reporting_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_reporting_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_reporting_calculator';Inputs, metrics: financial_reporting_calculator';Metrics): financial_reporting_calculator';Analysis {
