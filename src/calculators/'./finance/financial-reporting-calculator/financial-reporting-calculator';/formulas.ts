import { financial-reporting-calculator';Inputs, financial-reporting-calculator';Metrics, financial-reporting-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-reporting-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-reporting-calculator';Inputs, metrics: financial-reporting-calculator';Metrics): financial-reporting-calculator';Analysis {
