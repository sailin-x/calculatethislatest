import { financial-growth-calculator';Inputs, financial-growth-calculator';Metrics, financial-growth-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-growth-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-growth-calculator';Inputs, metrics: financial-growth-calculator';Metrics): financial-growth-calculator';Analysis {
