import { financial_growth_calculator';Inputs, financial_growth_calculator';Metrics, financial_growth_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_growth_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_growth_calculator';Inputs, metrics: financial_growth_calculator';Metrics): financial_growth_calculator';Analysis {
