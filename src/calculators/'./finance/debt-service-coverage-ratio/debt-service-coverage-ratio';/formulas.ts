import { debt-service-coverage-ratio';Inputs, debt-service-coverage-ratio';Metrics, debt-service-coverage-ratio';Analysis } from './types';
...
export function calculateResult(inputs: debt-service-coverage-ratio';Inputs): number {
...
export function generateAnalysis(inputs: debt-service-coverage-ratio';Inputs, metrics: debt-service-coverage-ratio';Metrics): debt-service-coverage-ratio';Analysis {
