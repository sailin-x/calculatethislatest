import { debt_service_coverage_ratio';Inputs, debt_service_coverage_ratio';Metrics, debt_service_coverage_ratio';Analysis } from './types';
...
export function calculateResult(inputs: debt_service_coverage_ratio';Inputs): number {
...
export function generateAnalysis(inputs: debt_service_coverage_ratio';Inputs, metrics: debt_service_coverage_ratio';Metrics): debt_service_coverage_ratio';Analysis {
