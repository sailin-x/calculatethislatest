import { capital-gains-calculator';Inputs, capital-gains-calculator';Metrics, capital-gains-calculator';Analysis } from './types';
...
export function calculateResult(inputs: capital-gains-calculator';Inputs): number {
...
export function generateAnalysis(inputs: capital-gains-calculator';Inputs, metrics: capital-gains-calculator';Metrics): capital-gains-calculator';Analysis {
