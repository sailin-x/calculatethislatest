import { roth-conversion-tax-calculator';Inputs, roth-conversion-tax-calculator';Metrics, roth-conversion-tax-calculator';Analysis } from './types';
...
export function calculateResult(inputs: roth-conversion-tax-calculator';Inputs): number {
...
export function generateAnalysis(inputs: roth-conversion-tax-calculator';Inputs, metrics: roth-conversion-tax-calculator';Metrics): roth-conversion-tax-calculator';Analysis {
