import { './finance/roth-conversion-tax-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/roth-conversion-tax-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
