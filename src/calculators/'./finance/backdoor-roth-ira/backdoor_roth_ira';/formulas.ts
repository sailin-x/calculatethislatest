import { backdoor_roth_ira';Inputs, backdoor_roth_ira';Metrics, backdoor_roth_ira';Analysis } from './types';
...
export function calculateResult(inputs: backdoor_roth_ira';Inputs): number {
...
export function generateAnalysis(inputs: backdoor_roth_ira';Inputs, metrics: backdoor_roth_ira';Metrics): backdoor_roth_ira';Analysis {
