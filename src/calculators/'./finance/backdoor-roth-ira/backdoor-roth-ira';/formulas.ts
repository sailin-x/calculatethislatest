import { backdoor-roth-ira';Inputs, backdoor-roth-ira';Metrics, backdoor-roth-ira';Analysis } from './types';
...
export function calculateResult(inputs: backdoor-roth-ira';Inputs): number {
...
export function generateAnalysis(inputs: backdoor-roth-ira';Inputs, metrics: backdoor-roth-ira';Metrics): backdoor-roth-ira';Analysis {
