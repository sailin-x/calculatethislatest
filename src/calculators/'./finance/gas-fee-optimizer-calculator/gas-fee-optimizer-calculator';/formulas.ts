import { gas-fee-optimizer-calculator';Inputs, gas-fee-optimizer-calculator';Metrics, gas-fee-optimizer-calculator';Analysis } from './types';
...
export function calculateResult(inputs: gas-fee-optimizer-calculator';Inputs): number {
...
export function generateAnalysis(inputs: gas-fee-optimizer-calculator';Inputs, metrics: gas-fee-optimizer-calculator';Metrics): gas-fee-optimizer-calculator';Analysis {
