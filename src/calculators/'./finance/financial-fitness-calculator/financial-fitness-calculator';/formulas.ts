import { financial-fitness-calculator';Inputs, financial-fitness-calculator';Metrics, financial-fitness-calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial-fitness-calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial-fitness-calculator';Inputs, metrics: financial-fitness-calculator';Metrics): financial-fitness-calculator';Analysis {
