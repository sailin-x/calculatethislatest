import { financial_fitness_calculator';Inputs, financial_fitness_calculator';Metrics, financial_fitness_calculator';Analysis } from './types';
...
export function calculateResult(inputs: financial_fitness_calculator';Inputs): number {
...
export function generateAnalysis(inputs: financial_fitness_calculator';Inputs, metrics: financial_fitness_calculator';Metrics): financial_fitness_calculator';Analysis {
