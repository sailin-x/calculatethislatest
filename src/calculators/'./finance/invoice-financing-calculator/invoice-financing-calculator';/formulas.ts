import { invoice-financing-calculator';Inputs, invoice-financing-calculator';Metrics, invoice-financing-calculator';Analysis } from './types';
...
export function calculateResult(inputs: invoice-financing-calculator';Inputs): number {
...
export function generateAnalysis(inputs: invoice-financing-calculator';Inputs, metrics: invoice-financing-calculator';Metrics): invoice-financing-calculator';Analysis {
