import { invoice_financing_calculator';Inputs, invoice_financing_calculator';Metrics, invoice_financing_calculator';Analysis } from './types';
...
export function calculateResult(inputs: invoice_financing_calculator';Inputs): number {
...
export function generateAnalysis(inputs: invoice_financing_calculator';Inputs, metrics: invoice_financing_calculator';Metrics): invoice_financing_calculator';Analysis {
