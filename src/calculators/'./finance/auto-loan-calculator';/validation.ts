import { './finance/auto-loan-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/auto-loan-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
