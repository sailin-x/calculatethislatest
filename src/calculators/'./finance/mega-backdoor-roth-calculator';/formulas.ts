import { mega-backdoor-roth-calculator';Inputs, mega-backdoor-roth-calculator';Metrics, mega-backdoor-roth-calculator';Analysis } from './types';
...
export function calculateResult(inputs: mega-backdoor-roth-calculator';Inputs): number {
...
export function generateAnalysis(inputs: mega-backdoor-roth-calculator';Inputs, metrics: mega-backdoor-roth-calculator';Metrics): mega-backdoor-roth-calculator';Analysis {
