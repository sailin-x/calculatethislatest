import { './finance/mega-backdoor-roth-calculator';Inputs } from './types';

export function validateInputs(inputs: './finance/mega-backdoor-roth-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
