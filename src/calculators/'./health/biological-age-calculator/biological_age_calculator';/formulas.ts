import { biological_age_calculator';Inputs, biological_age_calculator';Metrics, biological_age_calculator';Analysis } from './types';
...
export function calculateResult(inputs: biological_age_calculator';Inputs): number {
...
export function generateAnalysis(inputs: biological_age_calculator';Inputs, metrics: biological_age_calculator';Metrics): biological_age_calculator';Analysis {
