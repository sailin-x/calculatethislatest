import { fitness-class-cost-calculator';Inputs, fitness-class-cost-calculator';Metrics, fitness-class-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: fitness-class-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: fitness-class-cost-calculator';Inputs, metrics: fitness-class-cost-calculator';Metrics): fitness-class-cost-calculator';Analysis {
