import { fitness_class_cost_calculator';Inputs, fitness_class_cost_calculator';Metrics, fitness_class_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: fitness_class_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: fitness_class_cost_calculator';Inputs, metrics: fitness_class_cost_calculator';Metrics): fitness_class_cost_calculator';Analysis {
