import { './health/bmi-calculator/bmi-calculator';Inputs } from './types';

export function validateInputs(inputs: './health/bmi-calculator/bmi-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
