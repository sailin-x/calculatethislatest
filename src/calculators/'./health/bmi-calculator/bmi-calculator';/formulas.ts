import { bmi-calculator';Inputs, bmi-calculator';Metrics, bmi-calculator';Analysis } from './types';
...
export function calculateResult(inputs: bmi-calculator';Inputs): number {
...
export function generateAnalysis(inputs: bmi-calculator';Inputs, metrics: bmi-calculator';Metrics): bmi-calculator';Analysis {
