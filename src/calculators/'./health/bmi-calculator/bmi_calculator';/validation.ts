import { './health/bmi-calculator/bmi_calculator';Inputs } from './types';

export function validateInputs(inputs: './health/bmi-calculator/bmi_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
