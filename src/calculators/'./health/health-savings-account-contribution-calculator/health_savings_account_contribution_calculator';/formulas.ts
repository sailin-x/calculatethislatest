import { health_savings_account_contribution_calculator';Inputs, health_savings_account_contribution_calculator';Metrics, health_savings_account_contribution_calculator';Analysis } from './types';
...
export function calculateResult(inputs: health_savings_account_contribution_calculator';Inputs): number {
...
export function generateAnalysis(inputs: health_savings_account_contribution_calculator';Inputs, metrics: health_savings_account_contribution_calculator';Metrics): health_savings_account_contribution_calculator';Analysis {
