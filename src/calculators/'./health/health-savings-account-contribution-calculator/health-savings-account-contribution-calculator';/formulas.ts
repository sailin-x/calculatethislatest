import { health-savings-account-contribution-calculator';Inputs, health-savings-account-contribution-calculator';Metrics, health-savings-account-contribution-calculator';Analysis } from './types';
...
export function calculateResult(inputs: health-savings-account-contribution-calculator';Inputs): number {
...
export function generateAnalysis(inputs: health-savings-account-contribution-calculator';Inputs, metrics: health-savings-account-contribution-calculator';Metrics): health-savings-account-contribution-calculator';Analysis {
