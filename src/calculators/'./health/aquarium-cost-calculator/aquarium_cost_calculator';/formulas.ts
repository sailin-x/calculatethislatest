import { aquarium_cost_calculator';Inputs, aquarium_cost_calculator';Metrics, aquarium_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: aquarium_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: aquarium_cost_calculator';Inputs, metrics: aquarium_cost_calculator';Metrics): aquarium_cost_calculator';Analysis {
