import { aquarium-cost-calculator';Inputs, aquarium-cost-calculator';Metrics, aquarium-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: aquarium-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: aquarium-cost-calculator';Inputs, metrics: aquarium-cost-calculator';Metrics): aquarium-cost-calculator';Analysis {
