import { './health/a1c-calculator/a1c_calculator';Inputs } from './types';

export function validateInputs(inputs: './health/a1c-calculator/a1c_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
