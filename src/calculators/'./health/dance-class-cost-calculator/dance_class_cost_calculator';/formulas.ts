import { dance_class_cost_calculator';Inputs, dance_class_cost_calculator';Metrics, dance_class_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: dance_class_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: dance_class_cost_calculator';Inputs, metrics: dance_class_cost_calculator';Metrics): dance_class_cost_calculator';Analysis {
