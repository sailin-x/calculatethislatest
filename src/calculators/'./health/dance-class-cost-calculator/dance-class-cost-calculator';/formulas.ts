import { dance-class-cost-calculator';Inputs, dance-class-cost-calculator';Metrics, dance-class-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: dance-class-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: dance-class-cost-calculator';Inputs, metrics: dance-class-cost-calculator';Metrics): dance-class-cost-calculator';Analysis {
