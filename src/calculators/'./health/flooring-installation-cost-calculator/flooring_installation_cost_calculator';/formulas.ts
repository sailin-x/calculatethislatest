import { flooring_installation_cost_calculator';Inputs, flooring_installation_cost_calculator';Metrics, flooring_installation_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: flooring_installation_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: flooring_installation_cost_calculator';Inputs, metrics: flooring_installation_cost_calculator';Metrics): flooring_installation_cost_calculator';Analysis {
