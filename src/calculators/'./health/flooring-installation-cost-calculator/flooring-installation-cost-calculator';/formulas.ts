import { flooring-installation-cost-calculator';Inputs, flooring-installation-cost-calculator';Metrics, flooring-installation-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: flooring-installation-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: flooring-installation-cost-calculator';Inputs, metrics: flooring-installation-cost-calculator';Metrics): flooring-installation-cost-calculator';Analysis {
