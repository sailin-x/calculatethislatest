import { anti_aging_cost_calculator';Inputs, anti_aging_cost_calculator';Metrics, anti_aging_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: anti_aging_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: anti_aging_cost_calculator';Inputs, metrics: anti_aging_cost_calculator';Metrics): anti_aging_cost_calculator';Analysis {
