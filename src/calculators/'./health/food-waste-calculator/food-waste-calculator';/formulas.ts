import { food-waste-calculator';Inputs, food-waste-calculator';Metrics, food-waste-calculator';Analysis } from './types';
...
export function calculateResult(inputs: food-waste-calculator';Inputs): number {
...
export function generateAnalysis(inputs: food-waste-calculator';Inputs, metrics: food-waste-calculator';Metrics): food-waste-calculator';Analysis {
