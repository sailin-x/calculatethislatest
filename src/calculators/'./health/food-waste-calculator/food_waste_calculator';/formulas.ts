import { food_waste_calculator';Inputs, food_waste_calculator';Metrics, food_waste_calculator';Analysis } from './types';
...
export function calculateResult(inputs: food_waste_calculator';Inputs): number {
...
export function generateAnalysis(inputs: food_waste_calculator';Inputs, metrics: food_waste_calculator';Metrics): food_waste_calculator';Analysis {
