import { bmr-tdee';Inputs, bmr-tdee';Metrics, bmr-tdee';Analysis } from './types';
...
export function calculateResult(inputs: bmr-tdee';Inputs): number {
...
export function generateAnalysis(inputs: bmr-tdee';Inputs, metrics: bmr-tdee';Metrics): bmr-tdee';Analysis {
