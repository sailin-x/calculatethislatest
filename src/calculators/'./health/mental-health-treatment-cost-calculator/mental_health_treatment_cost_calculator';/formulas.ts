import { mental_health_treatment_cost_calculator';Inputs, mental_health_treatment_cost_calculator';Metrics, mental_health_treatment_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: mental_health_treatment_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: mental_health_treatment_cost_calculator';Inputs, metrics: mental_health_treatment_cost_calculator';Metrics): mental_health_treatment_cost_calculator';Analysis {
