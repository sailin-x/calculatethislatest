import { analytics-cost-calculator';Inputs, analytics-cost-calculator';Metrics, analytics-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: analytics-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: analytics-cost-calculator';Inputs, metrics: analytics-cost-calculator';Metrics): analytics-cost-calculator';Analysis {
