import { analytics_cost_calculator';Inputs, analytics_cost_calculator';Metrics, analytics_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: analytics_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: analytics_cost_calculator';Inputs, metrics: analytics_cost_calculator';Metrics): analytics_cost_calculator';Analysis {
