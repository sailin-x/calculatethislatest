import { painting-cost-calculator';Inputs, painting-cost-calculator';Metrics, painting-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: painting-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: painting-cost-calculator';Inputs, metrics: painting-cost-calculator';Metrics): painting-cost-calculator';Analysis {
