import { painting_cost_calculator';Inputs, painting_cost_calculator';Metrics, painting_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: painting_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: painting_cost_calculator';Inputs, metrics: painting_cost_calculator';Metrics): painting_cost_calculator';Analysis {
