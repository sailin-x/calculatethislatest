import { homeopathy-cost-calculator';Inputs, homeopathy-cost-calculator';Metrics, homeopathy-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: homeopathy-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: homeopathy-cost-calculator';Inputs, metrics: homeopathy-cost-calculator';Metrics): homeopathy-cost-calculator';Analysis {
