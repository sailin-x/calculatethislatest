import { homeopathy_cost_calculator';Inputs, homeopathy_cost_calculator';Metrics, homeopathy_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: homeopathy_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: homeopathy_cost_calculator';Inputs, metrics: homeopathy_cost_calculator';Metrics): homeopathy_cost_calculator';Analysis {
