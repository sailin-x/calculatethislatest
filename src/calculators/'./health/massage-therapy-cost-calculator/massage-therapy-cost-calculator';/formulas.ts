import { massage-therapy-cost-calculator';Inputs, massage-therapy-cost-calculator';Metrics, massage-therapy-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: massage-therapy-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: massage-therapy-cost-calculator';Inputs, metrics: massage-therapy-cost-calculator';Metrics): massage-therapy-cost-calculator';Analysis {
