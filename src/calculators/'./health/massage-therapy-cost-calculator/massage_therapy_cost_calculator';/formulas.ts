import { massage_therapy_cost_calculator';Inputs, massage_therapy_cost_calculator';Metrics, massage_therapy_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: massage_therapy_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: massage_therapy_cost_calculator';Inputs, metrics: massage_therapy_cost_calculator';Metrics): massage_therapy_cost_calculator';Analysis {
