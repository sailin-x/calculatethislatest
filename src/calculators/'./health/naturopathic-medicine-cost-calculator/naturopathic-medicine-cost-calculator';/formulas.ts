import { naturopathic-medicine-cost-calculator';Inputs, naturopathic-medicine-cost-calculator';Metrics, naturopathic-medicine-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: naturopathic-medicine-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: naturopathic-medicine-cost-calculator';Inputs, metrics: naturopathic-medicine-cost-calculator';Metrics): naturopathic-medicine-cost-calculator';Analysis {
