import { naturopathic_medicine_cost_calculator';Inputs, naturopathic_medicine_cost_calculator';Metrics, naturopathic_medicine_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: naturopathic_medicine_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: naturopathic_medicine_cost_calculator';Inputs, metrics: naturopathic_medicine_cost_calculator';Metrics): naturopathic_medicine_cost_calculator';Analysis {
