import { insurance-claim-calculator';Inputs, insurance-claim-calculator';Metrics, insurance-claim-calculator';Analysis } from './types';
...
export function calculateResult(inputs: insurance-claim-calculator';Inputs): number {
...
export function generateAnalysis(inputs: insurance-claim-calculator';Inputs, metrics: insurance-claim-calculator';Metrics): insurance-claim-calculator';Analysis {
