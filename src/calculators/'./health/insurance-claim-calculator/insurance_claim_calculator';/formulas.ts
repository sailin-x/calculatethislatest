import { insurance_claim_calculator';Inputs, insurance_claim_calculator';Metrics, insurance_claim_calculator';Analysis } from './types';
...
export function calculateResult(inputs: insurance_claim_calculator';Inputs): number {
...
export function generateAnalysis(inputs: insurance_claim_calculator';Inputs, metrics: insurance_claim_calculator';Metrics): insurance_claim_calculator';Analysis {
