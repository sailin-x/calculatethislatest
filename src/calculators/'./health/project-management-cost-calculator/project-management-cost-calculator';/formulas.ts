import { project-management-cost-calculator';Inputs, project-management-cost-calculator';Metrics, project-management-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: project-management-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: project-management-cost-calculator';Inputs, metrics: project-management-cost-calculator';Metrics): project-management-cost-calculator';Analysis {
