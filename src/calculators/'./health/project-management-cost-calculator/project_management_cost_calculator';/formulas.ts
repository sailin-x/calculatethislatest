import { project_management_cost_calculator';Inputs, project_management_cost_calculator';Metrics, project_management_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: project_management_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: project_management_cost_calculator';Inputs, metrics: project_management_cost_calculator';Metrics): project_management_cost_calculator';Analysis {
