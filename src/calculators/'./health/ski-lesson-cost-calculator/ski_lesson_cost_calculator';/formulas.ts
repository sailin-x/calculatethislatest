import { ski_lesson_cost_calculator';Inputs, ski_lesson_cost_calculator';Metrics, ski_lesson_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: ski_lesson_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: ski_lesson_cost_calculator';Inputs, metrics: ski_lesson_cost_calculator';Metrics): ski_lesson_cost_calculator';Analysis {
