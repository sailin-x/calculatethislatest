import { ski-lesson-cost-calculator';Inputs, ski-lesson-cost-calculator';Metrics, ski-lesson-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: ski-lesson-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: ski-lesson-cost-calculator';Inputs, metrics: ski-lesson-cost-calculator';Metrics): ski-lesson-cost-calculator';Analysis {
