import { toll-cost-calculator';Inputs, toll-cost-calculator';Metrics, toll-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: toll-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: toll-cost-calculator';Inputs, metrics: toll-cost-calculator';Metrics): toll-cost-calculator';Analysis {
