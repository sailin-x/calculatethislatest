import { toll_cost_calculator';Inputs, toll_cost_calculator';Metrics, toll_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: toll_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: toll_cost_calculator';Inputs, metrics: toll_cost_calculator';Metrics): toll_cost_calculator';Analysis {
