import { surfing-lesson-cost-calculator';Inputs, surfing-lesson-cost-calculator';Metrics, surfing-lesson-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: surfing-lesson-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: surfing-lesson-cost-calculator';Inputs, metrics: surfing-lesson-cost-calculator';Metrics): surfing-lesson-cost-calculator';Analysis {
