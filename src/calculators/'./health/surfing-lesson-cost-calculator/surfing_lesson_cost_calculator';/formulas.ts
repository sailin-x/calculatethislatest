import { surfing_lesson_cost_calculator';Inputs, surfing_lesson_cost_calculator';Metrics, surfing_lesson_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: surfing_lesson_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: surfing_lesson_cost_calculator';Inputs, metrics: surfing_lesson_cost_calculator';Metrics): surfing_lesson_cost_calculator';Analysis {
