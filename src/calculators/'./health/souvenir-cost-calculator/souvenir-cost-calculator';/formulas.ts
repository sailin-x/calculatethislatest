import { souvenir-cost-calculator';Inputs, souvenir-cost-calculator';Metrics, souvenir-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: souvenir-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: souvenir-cost-calculator';Inputs, metrics: souvenir-cost-calculator';Metrics): souvenir-cost-calculator';Analysis {
