import { souvenir_cost_calculator';Inputs, souvenir_cost_calculator';Metrics, souvenir_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: souvenir_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: souvenir_cost_calculator';Inputs, metrics: souvenir_cost_calculator';Metrics): souvenir_cost_calculator';Analysis {
