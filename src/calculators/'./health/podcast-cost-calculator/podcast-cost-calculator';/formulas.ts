import { podcast-cost-calculator';Inputs, podcast-cost-calculator';Metrics, podcast-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: podcast-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: podcast-cost-calculator';Inputs, metrics: podcast-cost-calculator';Metrics): podcast-cost-calculator';Analysis {
