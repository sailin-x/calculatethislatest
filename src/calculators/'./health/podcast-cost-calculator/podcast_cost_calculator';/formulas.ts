import { podcast_cost_calculator';Inputs, podcast_cost_calculator';Metrics, podcast_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: podcast_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: podcast_cost_calculator';Inputs, metrics: podcast_cost_calculator';Metrics): podcast_cost_calculator';Analysis {
