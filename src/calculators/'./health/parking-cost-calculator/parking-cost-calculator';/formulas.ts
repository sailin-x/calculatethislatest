import { parking-cost-calculator';Inputs, parking-cost-calculator';Metrics, parking-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: parking-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: parking-cost-calculator';Inputs, metrics: parking-cost-calculator';Metrics): parking-cost-calculator';Analysis {
