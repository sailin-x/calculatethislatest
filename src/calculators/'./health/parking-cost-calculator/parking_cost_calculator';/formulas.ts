import { parking_cost_calculator';Inputs, parking_cost_calculator';Metrics, parking_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: parking_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: parking_cost_calculator';Inputs, metrics: parking_cost_calculator';Metrics): parking_cost_calculator';Analysis {
