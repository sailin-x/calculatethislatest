import { meal-prep-calculator';Inputs, meal-prep-calculator';Metrics, meal-prep-calculator';Analysis } from './types';
...
export function calculateResult(inputs: meal-prep-calculator';Inputs): number {
...
export function generateAnalysis(inputs: meal-prep-calculator';Inputs, metrics: meal-prep-calculator';Metrics): meal-prep-calculator';Analysis {
