import { meal_prep_calculator';Inputs, meal_prep_calculator';Metrics, meal_prep_calculator';Analysis } from './types';
...
export function calculateResult(inputs: meal_prep_calculator';Inputs): number {
...
export function generateAnalysis(inputs: meal_prep_calculator';Inputs, metrics: meal_prep_calculator';Metrics): meal_prep_calculator';Analysis {
