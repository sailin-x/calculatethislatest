import { tennis-lesson-cost-calculator';Inputs, tennis-lesson-cost-calculator';Metrics, tennis-lesson-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: tennis-lesson-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: tennis-lesson-cost-calculator';Inputs, metrics: tennis-lesson-cost-calculator';Metrics): tennis-lesson-cost-calculator';Analysis {
