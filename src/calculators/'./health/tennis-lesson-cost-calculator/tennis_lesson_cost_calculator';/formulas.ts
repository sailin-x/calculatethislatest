import { tennis_lesson_cost_calculator';Inputs, tennis_lesson_cost_calculator';Metrics, tennis_lesson_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: tennis_lesson_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: tennis_lesson_cost_calculator';Inputs, metrics: tennis_lesson_cost_calculator';Metrics): tennis_lesson_cost_calculator';Analysis {
