import { fertilizer_calculator';Inputs, fertilizer_calculator';Metrics, fertilizer_calculator';Analysis } from './types';
...
export function calculateResult(inputs: fertilizer_calculator';Inputs): number {
...
export function generateAnalysis(inputs: fertilizer_calculator';Inputs, metrics: fertilizer_calculator';Metrics): fertilizer_calculator';Analysis {
