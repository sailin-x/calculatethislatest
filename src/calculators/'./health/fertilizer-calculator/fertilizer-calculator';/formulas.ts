import { fertilizer-calculator';Inputs, fertilizer-calculator';Metrics, fertilizer-calculator';Analysis } from './types';
...
export function calculateResult(inputs: fertilizer-calculator';Inputs): number {
...
export function generateAnalysis(inputs: fertilizer-calculator';Inputs, metrics: fertilizer-calculator';Metrics): fertilizer-calculator';Analysis {
