import { './health/sleep-calculator/sleep_calculator';Inputs } from './types';

export function validateInputs(inputs: './health/sleep-calculator/sleep_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
