import { sleep_calculator';Inputs, sleep_calculator';Metrics, sleep_calculator';Analysis } from './types';
...
export function calculateResult(inputs: sleep_calculator';Inputs): number {
...
export function generateAnalysis(inputs: sleep_calculator';Inputs, metrics: sleep_calculator';Metrics): sleep_calculator';Analysis {
