import { './health/sleep-calculator/sleep-calculator';Inputs } from './types';

export function validateInputs(inputs: './health/sleep-calculator/sleep-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
