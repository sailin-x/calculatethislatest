import { sleep-calculator';Inputs, sleep-calculator';Metrics, sleep-calculator';Analysis } from './types';
...
export function calculateResult(inputs: sleep-calculator';Inputs): number {
...
export function generateAnalysis(inputs: sleep-calculator';Inputs, metrics: sleep-calculator';Metrics): sleep-calculator';Analysis {
