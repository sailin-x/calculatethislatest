import { electrical_repair_cost_calculator';Inputs, electrical_repair_cost_calculator';Metrics, electrical_repair_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: electrical_repair_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: electrical_repair_cost_calculator';Inputs, metrics: electrical_repair_cost_calculator';Metrics): electrical_repair_cost_calculator';Analysis {
