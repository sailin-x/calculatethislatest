import { pilates-studio-cost-calculator';Inputs, pilates-studio-cost-calculator';Metrics, pilates-studio-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: pilates-studio-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: pilates-studio-cost-calculator';Inputs, metrics: pilates-studio-cost-calculator';Metrics): pilates-studio-cost-calculator';Analysis {
