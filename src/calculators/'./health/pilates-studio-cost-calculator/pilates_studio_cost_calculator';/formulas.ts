import { pilates_studio_cost_calculator';Inputs, pilates_studio_cost_calculator';Metrics, pilates_studio_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: pilates_studio_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: pilates_studio_cost_calculator';Inputs, metrics: pilates_studio_cost_calculator';Metrics): pilates_studio_cost_calculator';Analysis {
