import { dental-insurance-cost-calculator';Inputs, dental-insurance-cost-calculator';Metrics, dental-insurance-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: dental-insurance-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: dental-insurance-cost-calculator';Inputs, metrics: dental-insurance-cost-calculator';Metrics): dental-insurance-cost-calculator';Analysis {
