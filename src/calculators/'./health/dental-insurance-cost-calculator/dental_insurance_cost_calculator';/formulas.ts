import { dental_insurance_cost_calculator';Inputs, dental_insurance_cost_calculator';Metrics, dental_insurance_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: dental_insurance_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: dental_insurance_cost_calculator';Inputs, metrics: dental_insurance_cost_calculator';Metrics): dental_insurance_cost_calculator';Analysis {
