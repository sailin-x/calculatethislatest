import { activity_cost_calculator';Inputs, activity_cost_calculator';Metrics, activity_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: activity_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: activity_cost_calculator';Inputs, metrics: activity_cost_calculator';Metrics): activity_cost_calculator';Analysis {
