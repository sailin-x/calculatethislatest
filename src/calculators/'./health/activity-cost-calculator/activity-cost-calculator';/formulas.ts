import { activity-cost-calculator';Inputs, activity-cost-calculator';Metrics, activity-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: activity-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: activity-cost-calculator';Inputs, metrics: activity-cost-calculator';Metrics): activity-cost-calculator';Analysis {
