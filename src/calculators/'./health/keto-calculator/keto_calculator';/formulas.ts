import { keto_calculator';Inputs, keto_calculator';Metrics, keto_calculator';Analysis } from './types';
...
export function calculateResult(inputs: keto_calculator';Inputs): number {
...
export function generateAnalysis(inputs: keto_calculator';Inputs, metrics: keto_calculator';Metrics): keto_calculator';Analysis {
