import { './health/keto-calculator/keto_calculator';Inputs } from './types';

export function validateInputs(inputs: './health/keto-calculator/keto_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
