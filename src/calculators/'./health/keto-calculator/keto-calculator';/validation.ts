import { './health/keto-calculator/keto-calculator';Inputs } from './types';

export function validateInputs(inputs: './health/keto-calculator/keto-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
