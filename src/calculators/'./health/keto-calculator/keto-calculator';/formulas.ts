import { keto-calculator';Inputs, keto-calculator';Metrics, keto-calculator';Analysis } from './types';
...
export function calculateResult(inputs: keto-calculator';Inputs): number {
...
export function generateAnalysis(inputs: keto-calculator';Inputs, metrics: keto-calculator';Metrics): keto-calculator';Analysis {
