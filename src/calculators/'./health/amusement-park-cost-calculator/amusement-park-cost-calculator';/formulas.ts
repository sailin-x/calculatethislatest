import { amusement-park-cost-calculator';Inputs, amusement-park-cost-calculator';Metrics, amusement-park-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: amusement-park-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: amusement-park-cost-calculator';Inputs, metrics: amusement-park-cost-calculator';Metrics): amusement-park-cost-calculator';Analysis {
