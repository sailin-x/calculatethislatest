import { amusement_park_cost_calculator';Inputs, amusement_park_cost_calculator';Metrics, amusement_park_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: amusement_park_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: amusement_park_cost_calculator';Inputs, metrics: amusement_park_cost_calculator';Metrics): amusement_park_cost_calculator';Analysis {
