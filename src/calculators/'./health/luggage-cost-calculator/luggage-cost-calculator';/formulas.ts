import { luggage-cost-calculator';Inputs, luggage-cost-calculator';Metrics, luggage-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: luggage-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: luggage-cost-calculator';Inputs, metrics: luggage-cost-calculator';Metrics): luggage-cost-calculator';Analysis {
