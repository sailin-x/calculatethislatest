import { luggage_cost_calculator';Inputs, luggage_cost_calculator';Metrics, luggage_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: luggage_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: luggage_cost_calculator';Inputs, metrics: luggage_cost_calculator';Metrics): luggage_cost_calculator';Analysis {
