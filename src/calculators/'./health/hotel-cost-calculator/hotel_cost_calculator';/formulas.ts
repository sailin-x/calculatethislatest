import { hotel_cost_calculator';Inputs, hotel_cost_calculator';Metrics, hotel_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: hotel_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: hotel_cost_calculator';Inputs, metrics: hotel_cost_calculator';Metrics): hotel_cost_calculator';Analysis {
