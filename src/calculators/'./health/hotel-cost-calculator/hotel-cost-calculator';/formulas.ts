import { hotel-cost-calculator';Inputs, hotel-cost-calculator';Metrics, hotel-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: hotel-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: hotel-cost-calculator';Inputs, metrics: hotel-cost-calculator';Metrics): hotel-cost-calculator';Analysis {
