import { rv-rental-cost-calculator';Inputs, rv-rental-cost-calculator';Metrics, rv-rental-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: rv-rental-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: rv-rental-cost-calculator';Inputs, metrics: rv-rental-cost-calculator';Metrics): rv-rental-cost-calculator';Analysis {
