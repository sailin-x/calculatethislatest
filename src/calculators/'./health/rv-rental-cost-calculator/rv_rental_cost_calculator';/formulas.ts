import { rv_rental_cost_calculator';Inputs, rv_rental_cost_calculator';Metrics, rv_rental_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: rv_rental_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: rv_rental_cost_calculator';Inputs, metrics: rv_rental_cost_calculator';Metrics): rv_rental_cost_calculator';Analysis {
