import { cooking_conversion_calculator';Inputs, cooking_conversion_calculator';Metrics, cooking_conversion_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cooking_conversion_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cooking_conversion_calculator';Inputs, metrics: cooking_conversion_calculator';Metrics): cooking_conversion_calculator';Analysis {
