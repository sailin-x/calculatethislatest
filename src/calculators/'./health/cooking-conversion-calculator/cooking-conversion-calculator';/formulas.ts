import { cooking-conversion-calculator';Inputs, cooking-conversion-calculator';Metrics, cooking-conversion-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cooking-conversion-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cooking-conversion-calculator';Inputs, metrics: cooking-conversion-calculator';Metrics): cooking-conversion-calculator';Analysis {
