import { food-cost-calculator';Inputs, food-cost-calculator';Metrics, food-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: food-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: food-cost-calculator';Inputs, metrics: food-cost-calculator';Metrics): food-cost-calculator';Analysis {
