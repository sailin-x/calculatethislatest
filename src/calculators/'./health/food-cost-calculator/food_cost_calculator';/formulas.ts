import { food_cost_calculator';Inputs, food_cost_calculator';Metrics, food_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: food_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: food_cost_calculator';Inputs, metrics: food_cost_calculator';Metrics): food_cost_calculator';Analysis {
