import { spin_class_cost_calculator';Inputs, spin_class_cost_calculator';Metrics, spin_class_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: spin_class_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: spin_class_cost_calculator';Inputs, metrics: spin_class_cost_calculator';Metrics): spin_class_cost_calculator';Analysis {
