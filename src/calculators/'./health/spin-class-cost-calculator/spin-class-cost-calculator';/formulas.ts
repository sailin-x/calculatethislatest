import { spin-class-cost-calculator';Inputs, spin-class-cost-calculator';Metrics, spin-class-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: spin-class-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: spin-class-cost-calculator';Inputs, metrics: spin-class-cost-calculator';Metrics): spin-class-cost-calculator';Analysis {
