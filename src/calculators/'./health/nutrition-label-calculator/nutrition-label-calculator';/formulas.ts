import { nutrition-label-calculator';Inputs, nutrition-label-calculator';Metrics, nutrition-label-calculator';Analysis } from './types';
...
export function calculateResult(inputs: nutrition-label-calculator';Inputs): number {
...
export function generateAnalysis(inputs: nutrition-label-calculator';Inputs, metrics: nutrition-label-calculator';Metrics): nutrition-label-calculator';Analysis {
