import { nutrition_label_calculator';Inputs, nutrition_label_calculator';Metrics, nutrition_label_calculator';Analysis } from './types';
...
export function calculateResult(inputs: nutrition_label_calculator';Inputs): number {
...
export function generateAnalysis(inputs: nutrition_label_calculator';Inputs, metrics: nutrition_label_calculator';Metrics): nutrition_label_calculator';Analysis {
