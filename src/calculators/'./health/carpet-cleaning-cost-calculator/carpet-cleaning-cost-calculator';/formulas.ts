import { carpet-cleaning-cost-calculator';Inputs, carpet-cleaning-cost-calculator';Metrics, carpet-cleaning-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: carpet-cleaning-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: carpet-cleaning-cost-calculator';Inputs, metrics: carpet-cleaning-cost-calculator';Metrics): carpet-cleaning-cost-calculator';Analysis {
