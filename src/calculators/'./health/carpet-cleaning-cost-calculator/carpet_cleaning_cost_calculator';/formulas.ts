import { carpet_cleaning_cost_calculator';Inputs, carpet_cleaning_cost_calculator';Metrics, carpet_cleaning_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: carpet_cleaning_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: carpet_cleaning_cost_calculator';Inputs, metrics: carpet_cleaning_cost_calculator';Metrics): carpet_cleaning_cost_calculator';Analysis {
