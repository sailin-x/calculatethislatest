import { rideshare-cost-calculator';Inputs, rideshare-cost-calculator';Metrics, rideshare-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: rideshare-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: rideshare-cost-calculator';Inputs, metrics: rideshare-cost-calculator';Metrics): rideshare-cost-calculator';Analysis {
