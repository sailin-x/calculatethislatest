import { rideshare_cost_calculator';Inputs, rideshare_cost_calculator';Metrics, rideshare_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: rideshare_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: rideshare_cost_calculator';Inputs, metrics: rideshare_cost_calculator';Metrics): rideshare_cost_calculator';Analysis {
