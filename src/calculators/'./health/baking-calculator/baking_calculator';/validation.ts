import { './health/baking-calculator/baking_calculator';Inputs } from './types';

export function validateInputs(inputs: './health/baking-calculator/baking_calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
