import { basal-metabolic-rate-calculator';Inputs, basal-metabolic-rate-calculator';Metrics, basal-metabolic-rate-calculator';Analysis } from './types';
...
export function calculateResult(inputs: basal-metabolic-rate-calculator';Inputs): number {
...
export function generateAnalysis(inputs: basal-metabolic-rate-calculator';Inputs, metrics: basal-metabolic-rate-calculator';Metrics): basal-metabolic-rate-calculator';Analysis {
