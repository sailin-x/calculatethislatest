import { airline-ticket-cost-calculator';Inputs, airline-ticket-cost-calculator';Metrics, airline-ticket-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: airline-ticket-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: airline-ticket-cost-calculator';Inputs, metrics: airline-ticket-cost-calculator';Metrics): airline-ticket-cost-calculator';Analysis {
