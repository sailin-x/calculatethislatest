import { airline_ticket_cost_calculator';Inputs, airline_ticket_cost_calculator';Metrics, airline_ticket_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: airline_ticket_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: airline_ticket_cost_calculator';Inputs, metrics: airline_ticket_cost_calculator';Metrics): airline_ticket_cost_calculator';Analysis {
