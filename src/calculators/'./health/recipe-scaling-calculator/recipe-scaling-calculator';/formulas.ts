import { recipe-scaling-calculator';Inputs, recipe-scaling-calculator';Metrics, recipe-scaling-calculator';Analysis } from './types';
...
export function calculateResult(inputs: recipe-scaling-calculator';Inputs): number {
...
export function generateAnalysis(inputs: recipe-scaling-calculator';Inputs, metrics: recipe-scaling-calculator';Metrics): recipe-scaling-calculator';Analysis {
