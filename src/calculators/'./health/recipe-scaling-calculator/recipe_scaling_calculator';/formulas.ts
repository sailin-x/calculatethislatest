import { recipe_scaling_calculator';Inputs, recipe_scaling_calculator';Metrics, recipe_scaling_calculator';Analysis } from './types';
...
export function calculateResult(inputs: recipe_scaling_calculator';Inputs): number {
...
export function generateAnalysis(inputs: recipe_scaling_calculator';Inputs, metrics: recipe_scaling_calculator';Metrics): recipe_scaling_calculator';Analysis {
