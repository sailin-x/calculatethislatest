import { storm_damage_repair_cost_calculator';Inputs, storm_damage_repair_cost_calculator';Metrics, storm_damage_repair_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: storm_damage_repair_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: storm_damage_repair_cost_calculator';Inputs, metrics: storm_damage_repair_cost_calculator';Metrics): storm_damage_repair_cost_calculator';Analysis {
