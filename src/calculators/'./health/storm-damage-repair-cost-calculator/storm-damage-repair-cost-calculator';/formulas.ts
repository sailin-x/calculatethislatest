import { storm-damage-repair-cost-calculator';Inputs, storm-damage-repair-cost-calculator';Metrics, storm-damage-repair-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: storm-damage-repair-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: storm-damage-repair-cost-calculator';Inputs, metrics: storm-damage-repair-cost-calculator';Metrics): storm-damage-repair-cost-calculator';Analysis {
