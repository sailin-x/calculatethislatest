import { gym-membership-cost-calculator';Inputs, gym-membership-cost-calculator';Metrics, gym-membership-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: gym-membership-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: gym-membership-cost-calculator';Inputs, metrics: gym-membership-cost-calculator';Metrics): gym-membership-cost-calculator';Analysis {
