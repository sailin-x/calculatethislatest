import { gym_membership_cost_calculator';Inputs, gym_membership_cost_calculator';Metrics, gym_membership_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: gym_membership_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: gym_membership_cost_calculator';Inputs, metrics: gym_membership_cost_calculator';Metrics): gym_membership_cost_calculator';Analysis {
