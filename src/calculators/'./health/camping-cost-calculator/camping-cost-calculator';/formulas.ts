import { camping-cost-calculator';Inputs, camping-cost-calculator';Metrics, camping-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: camping-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: camping-cost-calculator';Inputs, metrics: camping-cost-calculator';Metrics): camping-cost-calculator';Analysis {
