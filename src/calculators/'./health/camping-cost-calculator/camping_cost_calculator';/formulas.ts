import { camping_cost_calculator';Inputs, camping_cost_calculator';Metrics, camping_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: camping_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: camping_cost_calculator';Inputs, metrics: camping_cost_calculator';Metrics): camping_cost_calculator';Analysis {
