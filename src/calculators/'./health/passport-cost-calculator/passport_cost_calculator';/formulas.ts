import { passport_cost_calculator';Inputs, passport_cost_calculator';Metrics, passport_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: passport_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: passport_cost_calculator';Inputs, metrics: passport_cost_calculator';Metrics): passport_cost_calculator';Analysis {
