import { passport-cost-calculator';Inputs, passport-cost-calculator';Metrics, passport-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: passport-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: passport-cost-calculator';Inputs, metrics: passport-cost-calculator';Metrics): passport-cost-calculator';Analysis {
