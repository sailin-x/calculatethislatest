import { testosterone-calculator';Inputs, testosterone-calculator';Metrics, testosterone-calculator';Analysis } from './types';
...
export function calculateResult(inputs: testosterone-calculator';Inputs): number {
...
export function generateAnalysis(inputs: testosterone-calculator';Inputs, metrics: testosterone-calculator';Metrics): testosterone-calculator';Analysis {
