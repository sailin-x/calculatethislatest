import { body_surface_area_calculator';Inputs, body_surface_area_calculator';Metrics, body_surface_area_calculator';Analysis } from './types';
...
export function calculateResult(inputs: body_surface_area_calculator';Inputs): number {
...
export function generateAnalysis(inputs: body_surface_area_calculator';Inputs, metrics: body_surface_area_calculator';Metrics): body_surface_area_calculator';Analysis {
