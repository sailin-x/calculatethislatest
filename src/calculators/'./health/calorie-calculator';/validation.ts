import { './health/calorie-calculator';Inputs } from './types';

export function validateInputs(inputs: './health/calorie-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
