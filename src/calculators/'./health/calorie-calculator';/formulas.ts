import { calorie-calculator';Inputs, calorie-calculator';Metrics, calorie-calculator';Analysis } from './types';
...
export function calculateResult(inputs: calorie-calculator';Inputs): number {
...
export function generateAnalysis(inputs: calorie-calculator';Inputs, metrics: calorie-calculator';Metrics): calorie-calculator';Analysis {
