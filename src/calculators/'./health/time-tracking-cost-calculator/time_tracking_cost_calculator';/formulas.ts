import { time_tracking_cost_calculator';Inputs, time_tracking_cost_calculator';Metrics, time_tracking_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: time_tracking_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: time_tracking_cost_calculator';Inputs, metrics: time_tracking_cost_calculator';Metrics): time_tracking_cost_calculator';Analysis {
