import { time-tracking-cost-calculator';Inputs, time-tracking-cost-calculator';Metrics, time-tracking-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: time-tracking-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: time-tracking-cost-calculator';Inputs, metrics: time-tracking-cost-calculator';Metrics): time-tracking-cost-calculator';Analysis {
