import { barre-class-cost-calculator';Inputs, barre-class-cost-calculator';Metrics, barre-class-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: barre-class-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: barre-class-cost-calculator';Inputs, metrics: barre-class-cost-calculator';Metrics): barre-class-cost-calculator';Analysis {
