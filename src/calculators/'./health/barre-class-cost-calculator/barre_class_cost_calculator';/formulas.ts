import { barre_class_cost_calculator';Inputs, barre_class_cost_calculator';Metrics, barre_class_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: barre_class_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: barre_class_cost_calculator';Inputs, metrics: barre_class_cost_calculator';Metrics): barre_class_cost_calculator';Analysis {
