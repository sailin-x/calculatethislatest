import { social-media-cost-calculator';Inputs, social-media-cost-calculator';Metrics, social-media-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: social-media-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: social-media-cost-calculator';Inputs, metrics: social-media-cost-calculator';Metrics): social-media-cost-calculator';Analysis {
