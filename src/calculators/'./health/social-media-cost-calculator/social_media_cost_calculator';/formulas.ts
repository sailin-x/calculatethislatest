import { social_media_cost_calculator';Inputs, social_media_cost_calculator';Metrics, social_media_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: social_media_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: social_media_cost_calculator';Inputs, metrics: social_media_cost_calculator';Metrics): social_media_cost_calculator';Analysis {
