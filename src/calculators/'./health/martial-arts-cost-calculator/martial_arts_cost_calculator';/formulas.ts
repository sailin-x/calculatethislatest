import { martial_arts_cost_calculator';Inputs, martial_arts_cost_calculator';Metrics, martial_arts_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: martial_arts_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: martial_arts_cost_calculator';Inputs, metrics: martial_arts_cost_calculator';Metrics): martial_arts_cost_calculator';Analysis {
