import { martial-arts-cost-calculator';Inputs, martial-arts-cost-calculator';Metrics, martial-arts-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: martial-arts-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: martial-arts-cost-calculator';Inputs, metrics: martial-arts-cost-calculator';Metrics): martial-arts-cost-calculator';Analysis {
