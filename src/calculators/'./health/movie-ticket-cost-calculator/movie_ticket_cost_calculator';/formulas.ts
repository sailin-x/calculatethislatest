import { movie_ticket_cost_calculator';Inputs, movie_ticket_cost_calculator';Metrics, movie_ticket_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: movie_ticket_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: movie_ticket_cost_calculator';Inputs, metrics: movie_ticket_cost_calculator';Metrics): movie_ticket_cost_calculator';Analysis {
