import { movie-ticket-cost-calculator';Inputs, movie-ticket-cost-calculator';Metrics, movie-ticket-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: movie-ticket-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: movie-ticket-cost-calculator';Inputs, metrics: movie-ticket-cost-calculator';Metrics): movie-ticket-cost-calculator';Analysis {
