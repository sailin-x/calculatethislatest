import { calorie_calculator';Inputs, calorie_calculator';Metrics, calorie_calculator';Analysis } from './types';
...
export function calculateResult(inputs: calorie_calculator';Inputs): number {
...
export function generateAnalysis(inputs: calorie_calculator';Inputs, metrics: calorie_calculator';Metrics): calorie_calculator';Analysis {
