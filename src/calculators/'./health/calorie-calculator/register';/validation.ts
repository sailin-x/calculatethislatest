import { './health/calorie-calculator/register';Inputs } from './types';

export function validateInputs(inputs: './health/calorie-calculator/register';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
