import { herbal-medicine-cost-calculator';Inputs, herbal-medicine-cost-calculator';Metrics, herbal-medicine-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: herbal-medicine-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: herbal-medicine-cost-calculator';Inputs, metrics: herbal-medicine-cost-calculator';Metrics): herbal-medicine-cost-calculator';Analysis {
