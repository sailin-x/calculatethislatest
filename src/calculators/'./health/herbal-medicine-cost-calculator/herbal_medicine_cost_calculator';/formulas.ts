import { herbal_medicine_cost_calculator';Inputs, herbal_medicine_cost_calculator';Metrics, herbal_medicine_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: herbal_medicine_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: herbal_medicine_cost_calculator';Inputs, metrics: herbal_medicine_cost_calculator';Metrics): herbal_medicine_cost_calculator';Analysis {
