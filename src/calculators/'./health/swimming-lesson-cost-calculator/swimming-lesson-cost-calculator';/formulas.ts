import { swimming-lesson-cost-calculator';Inputs, swimming-lesson-cost-calculator';Metrics, swimming-lesson-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: swimming-lesson-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: swimming-lesson-cost-calculator';Inputs, metrics: swimming-lesson-cost-calculator';Metrics): swimming-lesson-cost-calculator';Analysis {
