import { swimming_lesson_cost_calculator';Inputs, swimming_lesson_cost_calculator';Metrics, swimming_lesson_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: swimming_lesson_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: swimming_lesson_cost_calculator';Inputs, metrics: swimming_lesson_cost_calculator';Metrics): swimming_lesson_cost_calculator';Analysis {
