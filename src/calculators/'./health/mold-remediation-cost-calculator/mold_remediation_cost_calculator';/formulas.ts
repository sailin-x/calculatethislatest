import { mold_remediation_cost_calculator';Inputs, mold_remediation_cost_calculator';Metrics, mold_remediation_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: mold_remediation_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: mold_remediation_cost_calculator';Inputs, metrics: mold_remediation_cost_calculator';Metrics): mold_remediation_cost_calculator';Analysis {
