import { mold-remediation-cost-calculator';Inputs, mold-remediation-cost-calculator';Metrics, mold-remediation-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: mold-remediation-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: mold-remediation-cost-calculator';Inputs, metrics: mold-remediation-cost-calculator';Metrics): mold-remediation-cost-calculator';Analysis {
