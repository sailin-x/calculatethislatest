import { international-cell-plan-cost-calculator';Inputs, international-cell-plan-cost-calculator';Metrics, international-cell-plan-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: international-cell-plan-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: international-cell-plan-cost-calculator';Inputs, metrics: international-cell-plan-cost-calculator';Metrics): international-cell-plan-cost-calculator';Analysis {
