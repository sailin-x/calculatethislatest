import { international_cell_plan_cost_calculator';Inputs, international_cell_plan_cost_calculator';Metrics, international_cell_plan_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: international_cell_plan_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: international_cell_plan_cost_calculator';Inputs, metrics: international_cell_plan_cost_calculator';Metrics): international_cell_plan_cost_calculator';Analysis {
