import { blog_cost_calculator';Inputs, blog_cost_calculator';Metrics, blog_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: blog_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: blog_cost_calculator';Inputs, metrics: blog_cost_calculator';Metrics): blog_cost_calculator';Analysis {
