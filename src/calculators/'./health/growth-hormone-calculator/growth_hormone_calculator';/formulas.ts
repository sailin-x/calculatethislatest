import { growth_hormone_calculator';Inputs, growth_hormone_calculator';Metrics, growth_hormone_calculator';Analysis } from './types';
...
export function calculateResult(inputs: growth_hormone_calculator';Inputs): number {
...
export function generateAnalysis(inputs: growth_hormone_calculator';Inputs, metrics: growth_hormone_calculator';Metrics): growth_hormone_calculator';Analysis {
