import { calories_burned_calculator';Inputs, calories_burned_calculator';Metrics, calories_burned_calculator';Analysis } from './types';
...
export function calculateResult(inputs: calories_burned_calculator';Inputs): number {
...
export function generateAnalysis(inputs: calories_burned_calculator';Inputs, metrics: calories_burned_calculator';Metrics): calories_burned_calculator';Analysis {
