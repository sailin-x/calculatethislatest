import { plugin_cost_calculator';Inputs, plugin_cost_calculator';Metrics, plugin_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: plugin_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: plugin_cost_calculator';Inputs, metrics: plugin_cost_calculator';Metrics): plugin_cost_calculator';Analysis {
