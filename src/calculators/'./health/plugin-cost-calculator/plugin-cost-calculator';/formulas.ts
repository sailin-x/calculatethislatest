import { plugin-cost-calculator';Inputs, plugin-cost-calculator';Metrics, plugin-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: plugin-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: plugin-cost-calculator';Inputs, metrics: plugin-cost-calculator';Metrics): plugin-cost-calculator';Analysis {
