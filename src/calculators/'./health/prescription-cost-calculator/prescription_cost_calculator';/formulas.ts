import { prescription_cost_calculator';Inputs, prescription_cost_calculator';Metrics, prescription_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: prescription_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: prescription_cost_calculator';Inputs, metrics: prescription_cost_calculator';Metrics): prescription_cost_calculator';Analysis {
