import { prescription-cost-calculator';Inputs, prescription-cost-calculator';Metrics, prescription-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: prescription-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: prescription-cost-calculator';Inputs, metrics: prescription-cost-calculator';Metrics): prescription-cost-calculator';Analysis {
