import { car-rental-cost-calculator';Inputs, car-rental-cost-calculator';Metrics, car-rental-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: car-rental-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: car-rental-cost-calculator';Inputs, metrics: car-rental-cost-calculator';Metrics): car-rental-cost-calculator';Analysis {
