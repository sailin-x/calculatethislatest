import { car_rental_cost_calculator';Inputs, car_rental_cost_calculator';Metrics, car_rental_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: car_rental_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: car_rental_cost_calculator';Inputs, metrics: car_rental_cost_calculator';Metrics): car_rental_cost_calculator';Analysis {
