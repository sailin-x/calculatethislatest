import { pressure_washing_cost_calculator';Inputs, pressure_washing_cost_calculator';Metrics, pressure_washing_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: pressure_washing_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: pressure_washing_cost_calculator';Inputs, metrics: pressure_washing_cost_calculator';Metrics): pressure_washing_cost_calculator';Analysis {
