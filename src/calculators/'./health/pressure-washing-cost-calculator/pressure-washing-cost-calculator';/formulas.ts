import { pressure-washing-cost-calculator';Inputs, pressure-washing-cost-calculator';Metrics, pressure-washing-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: pressure-washing-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: pressure-washing-cost-calculator';Inputs, metrics: pressure-washing-cost-calculator';Metrics): pressure-washing-cost-calculator';Analysis {
