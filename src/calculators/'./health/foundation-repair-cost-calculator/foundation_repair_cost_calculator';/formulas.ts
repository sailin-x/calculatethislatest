import { foundation_repair_cost_calculator';Inputs, foundation_repair_cost_calculator';Metrics, foundation_repair_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: foundation_repair_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: foundation_repair_cost_calculator';Inputs, metrics: foundation_repair_cost_calculator';Metrics): foundation_repair_cost_calculator';Analysis {
