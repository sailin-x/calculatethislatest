import { physical-therapy-cost-calculator';Inputs, physical-therapy-cost-calculator';Metrics, physical-therapy-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: physical-therapy-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: physical-therapy-cost-calculator';Inputs, metrics: physical-therapy-cost-calculator';Metrics): physical-therapy-cost-calculator';Analysis {
