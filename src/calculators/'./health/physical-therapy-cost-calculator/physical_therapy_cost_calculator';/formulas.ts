import { physical_therapy_cost_calculator';Inputs, physical_therapy_cost_calculator';Metrics, physical_therapy_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: physical_therapy_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: physical_therapy_cost_calculator';Inputs, metrics: physical_therapy_cost_calculator';Metrics): physical_therapy_cost_calculator';Analysis {
