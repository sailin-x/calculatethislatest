import { garden-yield-calculator';Inputs, garden-yield-calculator';Metrics, garden-yield-calculator';Analysis } from './types';
...
export function calculateResult(inputs: garden-yield-calculator';Inputs): number {
...
export function generateAnalysis(inputs: garden-yield-calculator';Inputs, metrics: garden-yield-calculator';Metrics): garden-yield-calculator';Analysis {
