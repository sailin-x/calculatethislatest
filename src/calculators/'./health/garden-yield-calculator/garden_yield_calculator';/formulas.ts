import { garden_yield_calculator';Inputs, garden_yield_calculator';Metrics, garden_yield_calculator';Analysis } from './types';
...
export function calculateResult(inputs: garden_yield_calculator';Inputs): number {
...
export function generateAnalysis(inputs: garden_yield_calculator';Inputs, metrics: garden_yield_calculator';Metrics): garden_yield_calculator';Analysis {
