import { seed-starting-calculator';Inputs, seed-starting-calculator';Metrics, seed-starting-calculator';Analysis } from './types';
...
export function calculateResult(inputs: seed-starting-calculator';Inputs): number {
...
export function generateAnalysis(inputs: seed-starting-calculator';Inputs, metrics: seed-starting-calculator';Metrics): seed-starting-calculator';Analysis {
