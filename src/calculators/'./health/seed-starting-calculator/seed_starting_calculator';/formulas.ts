import { seed_starting_calculator';Inputs, seed_starting_calculator';Metrics, seed_starting_calculator';Analysis } from './types';
...
export function calculateResult(inputs: seed_starting_calculator';Inputs): number {
...
export function generateAnalysis(inputs: seed_starting_calculator';Inputs, metrics: seed_starting_calculator';Metrics): seed_starting_calculator';Analysis {
