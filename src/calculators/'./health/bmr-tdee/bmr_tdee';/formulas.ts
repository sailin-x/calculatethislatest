import { bmr_tdee';Inputs, bmr_tdee';Metrics, bmr_tdee';Analysis } from './types';
...
export function calculateResult(inputs: bmr_tdee';Inputs): number {
...
export function generateAnalysis(inputs: bmr_tdee';Inputs, metrics: bmr_tdee';Metrics): bmr_tdee';Analysis {
