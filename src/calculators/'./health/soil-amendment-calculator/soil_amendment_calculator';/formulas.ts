import { soil_amendment_calculator';Inputs, soil_amendment_calculator';Metrics, soil_amendment_calculator';Analysis } from './types';
...
export function calculateResult(inputs: soil_amendment_calculator';Inputs): number {
...
export function generateAnalysis(inputs: soil_amendment_calculator';Inputs, metrics: soil_amendment_calculator';Metrics): soil_amendment_calculator';Analysis {
