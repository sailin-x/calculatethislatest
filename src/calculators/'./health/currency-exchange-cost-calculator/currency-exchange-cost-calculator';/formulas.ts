import { currency-exchange-cost-calculator';Inputs, currency-exchange-cost-calculator';Metrics, currency-exchange-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: currency-exchange-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: currency-exchange-cost-calculator';Inputs, metrics: currency-exchange-cost-calculator';Metrics): currency-exchange-cost-calculator';Analysis {
