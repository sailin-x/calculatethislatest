import { currency_exchange_cost_calculator';Inputs, currency_exchange_cost_calculator';Metrics, currency_exchange_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: currency_exchange_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: currency_exchange_cost_calculator';Inputs, metrics: currency_exchange_cost_calculator';Metrics): currency_exchange_cost_calculator';Analysis {
