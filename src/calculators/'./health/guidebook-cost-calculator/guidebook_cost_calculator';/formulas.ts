import { guidebook_cost_calculator';Inputs, guidebook_cost_calculator';Metrics, guidebook_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: guidebook_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: guidebook_cost_calculator';Inputs, metrics: guidebook_cost_calculator';Metrics): guidebook_cost_calculator';Analysis {
