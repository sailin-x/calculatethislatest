import { guidebook-cost-calculator';Inputs, guidebook-cost-calculator';Metrics, guidebook-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: guidebook-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: guidebook-cost-calculator';Inputs, metrics: guidebook-cost-calculator';Metrics): guidebook-cost-calculator';Analysis {
