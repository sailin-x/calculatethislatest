import { hot_air_balloon_cost_calculator';Inputs, hot_air_balloon_cost_calculator';Metrics, hot_air_balloon_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: hot_air_balloon_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: hot_air_balloon_cost_calculator';Inputs, metrics: hot_air_balloon_cost_calculator';Metrics): hot_air_balloon_cost_calculator';Analysis {
