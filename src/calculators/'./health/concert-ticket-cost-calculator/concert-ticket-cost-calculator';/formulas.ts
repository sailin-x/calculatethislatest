import { concert-ticket-cost-calculator';Inputs, concert-ticket-cost-calculator';Metrics, concert-ticket-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: concert-ticket-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: concert-ticket-cost-calculator';Inputs, metrics: concert-ticket-cost-calculator';Metrics): concert-ticket-cost-calculator';Analysis {
