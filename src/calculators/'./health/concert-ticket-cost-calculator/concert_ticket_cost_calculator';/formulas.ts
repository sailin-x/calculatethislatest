import { concert_ticket_cost_calculator';Inputs, concert_ticket_cost_calculator';Metrics, concert_ticket_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: concert_ticket_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: concert_ticket_cost_calculator';Inputs, metrics: concert_ticket_cost_calculator';Metrics): concert_ticket_cost_calculator';Analysis {
