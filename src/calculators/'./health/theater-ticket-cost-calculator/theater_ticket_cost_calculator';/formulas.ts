import { theater_ticket_cost_calculator';Inputs, theater_ticket_cost_calculator';Metrics, theater_ticket_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: theater_ticket_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: theater_ticket_cost_calculator';Inputs, metrics: theater_ticket_cost_calculator';Metrics): theater_ticket_cost_calculator';Analysis {
