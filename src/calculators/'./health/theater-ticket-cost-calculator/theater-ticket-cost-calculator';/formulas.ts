import { theater-ticket-cost-calculator';Inputs, theater-ticket-cost-calculator';Metrics, theater-ticket-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: theater-ticket-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: theater-ticket-cost-calculator';Inputs, metrics: theater-ticket-cost-calculator';Metrics): theater-ticket-cost-calculator';Analysis {
