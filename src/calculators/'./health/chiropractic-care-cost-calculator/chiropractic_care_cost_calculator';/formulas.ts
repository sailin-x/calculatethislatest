import { chiropractic_care_cost_calculator';Inputs, chiropractic_care_cost_calculator';Metrics, chiropractic_care_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: chiropractic_care_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: chiropractic_care_cost_calculator';Inputs, metrics: chiropractic_care_cost_calculator';Metrics): chiropractic_care_cost_calculator';Analysis {
