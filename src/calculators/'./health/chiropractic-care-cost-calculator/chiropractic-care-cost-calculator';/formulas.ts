import { chiropractic-care-cost-calculator';Inputs, chiropractic-care-cost-calculator';Metrics, chiropractic-care-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: chiropractic-care-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: chiropractic-care-cost-calculator';Inputs, metrics: chiropractic-care-cost-calculator';Metrics): chiropractic-care-cost-calculator';Analysis {
