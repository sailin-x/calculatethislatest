import { plant_spacing_calculator';Inputs, plant_spacing_calculator';Metrics, plant_spacing_calculator';Analysis } from './types';
...
export function calculateResult(inputs: plant_spacing_calculator';Inputs): number {
...
export function generateAnalysis(inputs: plant_spacing_calculator';Inputs, metrics: plant_spacing_calculator';Metrics): plant_spacing_calculator';Analysis {
