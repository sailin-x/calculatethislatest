import { plant-spacing-calculator';Inputs, plant-spacing-calculator';Metrics, plant-spacing-calculator';Analysis } from './types';
...
export function calculateResult(inputs: plant-spacing-calculator';Inputs): number {
...
export function generateAnalysis(inputs: plant-spacing-calculator';Inputs, metrics: plant-spacing-calculator';Metrics): plant-spacing-calculator';Analysis {
