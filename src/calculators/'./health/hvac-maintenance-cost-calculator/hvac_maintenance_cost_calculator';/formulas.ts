import { hvac_maintenance_cost_calculator';Inputs, hvac_maintenance_cost_calculator';Metrics, hvac_maintenance_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: hvac_maintenance_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: hvac_maintenance_cost_calculator';Inputs, metrics: hvac_maintenance_cost_calculator';Metrics): hvac_maintenance_cost_calculator';Analysis {
