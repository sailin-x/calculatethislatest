import { hvac-maintenance-cost-calculator';Inputs, hvac-maintenance-cost-calculator';Metrics, hvac-maintenance-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: hvac-maintenance-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: hvac-maintenance-cost-calculator';Inputs, metrics: hvac-maintenance-cost-calculator';Metrics): hvac-maintenance-cost-calculator';Analysis {
