import { personal-trainer-cost-calculator';Inputs, personal-trainer-cost-calculator';Metrics, personal-trainer-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: personal-trainer-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: personal-trainer-cost-calculator';Inputs, metrics: personal-trainer-cost-calculator';Metrics): personal-trainer-cost-calculator';Analysis {
