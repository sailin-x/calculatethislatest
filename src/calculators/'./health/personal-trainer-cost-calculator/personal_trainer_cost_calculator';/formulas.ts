import { personal_trainer_cost_calculator';Inputs, personal_trainer_cost_calculator';Metrics, personal_trainer_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: personal_trainer_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: personal_trainer_cost_calculator';Inputs, metrics: personal_trainer_cost_calculator';Metrics): personal_trainer_cost_calculator';Analysis {
