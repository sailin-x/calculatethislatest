import { acupuncture-cost-calculator';Inputs, acupuncture-cost-calculator';Metrics, acupuncture-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: acupuncture-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: acupuncture-cost-calculator';Inputs, metrics: acupuncture-cost-calculator';Metrics): acupuncture-cost-calculator';Analysis {
