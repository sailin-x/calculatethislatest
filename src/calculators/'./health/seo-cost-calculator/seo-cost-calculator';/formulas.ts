import { seo-cost-calculator';Inputs, seo-cost-calculator';Metrics, seo-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: seo-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: seo-cost-calculator';Inputs, metrics: seo-cost-calculator';Metrics): seo-cost-calculator';Analysis {
