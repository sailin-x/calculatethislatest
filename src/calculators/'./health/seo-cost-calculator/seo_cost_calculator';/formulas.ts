import { seo_cost_calculator';Inputs, seo_cost_calculator';Metrics, seo_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: seo_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: seo_cost_calculator';Inputs, metrics: seo_cost_calculator';Metrics): seo_cost_calculator';Analysis {
