import { fitness_calculator';Inputs, fitness_calculator';Metrics, fitness_calculator';Analysis } from './types';
...
export function calculateResult(inputs: fitness_calculator';Inputs): number {
...
export function generateAnalysis(inputs: fitness_calculator';Inputs, metrics: fitness_calculator';Metrics): fitness_calculator';Analysis {
