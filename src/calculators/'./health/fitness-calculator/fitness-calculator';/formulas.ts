import { fitness-calculator';Inputs, fitness-calculator';Metrics, fitness-calculator';Analysis } from './types';
...
export function calculateResult(inputs: fitness-calculator';Inputs): number {
...
export function generateAnalysis(inputs: fitness-calculator';Inputs, metrics: fitness-calculator';Metrics): fitness-calculator';Analysis {
