import { crm-cost-calculator';Inputs, crm-cost-calculator';Metrics, crm-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: crm-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: crm-cost-calculator';Inputs, metrics: crm-cost-calculator';Metrics): crm-cost-calculator';Analysis {
