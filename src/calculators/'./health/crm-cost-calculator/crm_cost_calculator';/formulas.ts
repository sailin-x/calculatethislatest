import { crm_cost_calculator';Inputs, crm_cost_calculator';Metrics, crm_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: crm_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: crm_cost_calculator';Inputs, metrics: crm_cost_calculator';Metrics): crm_cost_calculator';Analysis {
