import { domain-cost-calculator';Inputs, domain-cost-calculator';Metrics, domain-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: domain-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: domain-cost-calculator';Inputs, metrics: domain-cost-calculator';Metrics): domain-cost-calculator';Analysis {
