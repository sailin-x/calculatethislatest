import { domain_cost_calculator';Inputs, domain_cost_calculator';Metrics, domain_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: domain_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: domain_cost_calculator';Inputs, metrics: domain_cost_calculator';Metrics): domain_cost_calculator';Analysis {
