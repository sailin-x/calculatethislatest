import { macro-calculator';Inputs, macro-calculator';Metrics, macro-calculator';Analysis } from './types';
...
export function calculateResult(inputs: macro-calculator';Inputs): number {
...
export function generateAnalysis(inputs: macro-calculator';Inputs, metrics: macro-calculator';Metrics): macro-calculator';Analysis {
