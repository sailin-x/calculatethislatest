import { './health/macro-calculator/macro-calculator';Inputs } from './types';

export function validateInputs(inputs: './health/macro-calculator/macro-calculator';Inputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
