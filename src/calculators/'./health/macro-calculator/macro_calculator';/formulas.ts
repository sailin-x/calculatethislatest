import { macro_calculator';Inputs, macro_calculator';Metrics, macro_calculator';Analysis } from './types';
...
export function calculateResult(inputs: macro_calculator';Inputs): number {
...
export function generateAnalysis(inputs: macro_calculator';Inputs, metrics: macro_calculator';Metrics): macro_calculator';Analysis {
