import { grocery_budget_calculator';Inputs, grocery_budget_calculator';Metrics, grocery_budget_calculator';Analysis } from './types';
...
export function calculateResult(inputs: grocery_budget_calculator';Inputs): number {
...
export function generateAnalysis(inputs: grocery_budget_calculator';Inputs, metrics: grocery_budget_calculator';Metrics): grocery_budget_calculator';Analysis {
