import { grocery-budget-calculator';Inputs, grocery-budget-calculator';Metrics, grocery-budget-calculator';Analysis } from './types';
...
export function calculateResult(inputs: grocery-budget-calculator';Inputs): number {
...
export function generateAnalysis(inputs: grocery-budget-calculator';Inputs, metrics: grocery-budget-calculator';Metrics): grocery-budget-calculator';Analysis {
