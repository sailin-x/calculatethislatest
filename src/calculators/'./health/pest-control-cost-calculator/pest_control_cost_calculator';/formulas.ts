import { pest_control_cost_calculator';Inputs, pest_control_cost_calculator';Metrics, pest_control_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: pest_control_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: pest_control_cost_calculator';Inputs, metrics: pest_control_cost_calculator';Metrics): pest_control_cost_calculator';Analysis {
