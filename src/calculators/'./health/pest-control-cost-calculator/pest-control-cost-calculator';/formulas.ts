import { pest-control-cost-calculator';Inputs, pest-control-cost-calculator';Metrics, pest-control-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: pest-control-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: pest-control-cost-calculator';Inputs, metrics: pest-control-cost-calculator';Metrics): pest-control-cost-calculator';Analysis {
