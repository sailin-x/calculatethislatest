import { advertising-cost-calculator';Inputs, advertising-cost-calculator';Metrics, advertising-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: advertising-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: advertising-cost-calculator';Inputs, metrics: advertising-cost-calculator';Metrics): advertising-cost-calculator';Analysis {
