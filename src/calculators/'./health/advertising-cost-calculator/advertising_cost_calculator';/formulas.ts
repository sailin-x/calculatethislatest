import { advertising_cost_calculator';Inputs, advertising_cost_calculator';Metrics, advertising_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: advertising_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: advertising_cost_calculator';Inputs, metrics: advertising_cost_calculator';Metrics): advertising_cost_calculator';Analysis {
