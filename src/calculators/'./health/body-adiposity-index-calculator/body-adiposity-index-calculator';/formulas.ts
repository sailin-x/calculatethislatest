import { body-adiposity-index-calculator';Inputs, body-adiposity-index-calculator';Metrics, body-adiposity-index-calculator';Analysis } from './types';
...
export function calculateResult(inputs: body-adiposity-index-calculator';Inputs): number {
...
export function generateAnalysis(inputs: body-adiposity-index-calculator';Inputs, metrics: body-adiposity-index-calculator';Metrics): body-adiposity-index-calculator';Analysis {
