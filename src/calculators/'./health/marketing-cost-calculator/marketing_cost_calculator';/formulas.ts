import { marketing_cost_calculator';Inputs, marketing_cost_calculator';Metrics, marketing_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: marketing_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: marketing_cost_calculator';Inputs, metrics: marketing_cost_calculator';Metrics): marketing_cost_calculator';Analysis {
