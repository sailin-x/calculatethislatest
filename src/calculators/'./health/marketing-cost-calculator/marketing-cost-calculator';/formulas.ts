import { marketing-cost-calculator';Inputs, marketing-cost-calculator';Metrics, marketing-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: marketing-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: marketing-cost-calculator';Inputs, metrics: marketing-cost-calculator';Metrics): marketing-cost-calculator';Analysis {
