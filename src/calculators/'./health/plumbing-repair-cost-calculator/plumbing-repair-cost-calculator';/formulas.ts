import { plumbing-repair-cost-calculator';Inputs, plumbing-repair-cost-calculator';Metrics, plumbing-repair-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: plumbing-repair-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: plumbing-repair-cost-calculator';Inputs, metrics: plumbing-repair-cost-calculator';Metrics): plumbing-repair-cost-calculator';Analysis {
