import { plumbing_repair_cost_calculator';Inputs, plumbing_repair_cost_calculator';Metrics, plumbing_repair_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: plumbing_repair_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: plumbing_repair_cost_calculator';Inputs, metrics: plumbing_repair_cost_calculator';Metrics): plumbing_repair_cost_calculator';Analysis {
