import { hosting_cost_calculator';Inputs, hosting_cost_calculator';Metrics, hosting_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: hosting_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: hosting_cost_calculator';Inputs, metrics: hosting_cost_calculator';Metrics): hosting_cost_calculator';Analysis {
