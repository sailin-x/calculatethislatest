import { hosting-cost-calculator';Inputs, hosting-cost-calculator';Metrics, hosting-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: hosting-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: hosting-cost-calculator';Inputs, metrics: hosting-cost-calculator';Metrics): hosting-cost-calculator';Analysis {
