import { skydiving_cost_calculator';Inputs, skydiving_cost_calculator';Metrics, skydiving_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: skydiving_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: skydiving_cost_calculator';Inputs, metrics: skydiving_cost_calculator';Metrics): skydiving_cost_calculator';Analysis {
