import { skydiving-cost-calculator';Inputs, skydiving-cost-calculator';Metrics, skydiving-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: skydiving-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: skydiving-cost-calculator';Inputs, metrics: skydiving-cost-calculator';Metrics): skydiving-cost-calculator';Analysis {
