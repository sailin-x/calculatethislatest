import { medical_bill_negotiation_calculator';Inputs, medical_bill_negotiation_calculator';Metrics, medical_bill_negotiation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: medical_bill_negotiation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: medical_bill_negotiation_calculator';Inputs, metrics: medical_bill_negotiation_calculator';Metrics): medical_bill_negotiation_calculator';Analysis {
