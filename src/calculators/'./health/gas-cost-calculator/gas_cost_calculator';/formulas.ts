import { gas_cost_calculator';Inputs, gas_cost_calculator';Metrics, gas_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: gas_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: gas_cost_calculator';Inputs, metrics: gas_cost_calculator';Metrics): gas_cost_calculator';Analysis {
