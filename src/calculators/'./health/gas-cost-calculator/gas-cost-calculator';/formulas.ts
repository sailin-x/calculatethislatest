import { gas-cost-calculator';Inputs, gas-cost-calculator';Metrics, gas-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: gas-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: gas-cost-calculator';Inputs, metrics: gas-cost-calculator';Metrics): gas-cost-calculator';Analysis {
