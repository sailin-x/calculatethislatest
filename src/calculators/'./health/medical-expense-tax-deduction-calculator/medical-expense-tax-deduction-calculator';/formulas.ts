import { medical-expense-tax-deduction-calculator';Inputs, medical-expense-tax-deduction-calculator';Metrics, medical-expense-tax-deduction-calculator';Analysis } from './types';
...
export function calculateResult(inputs: medical-expense-tax-deduction-calculator';Inputs): number {
...
export function generateAnalysis(inputs: medical-expense-tax-deduction-calculator';Inputs, metrics: medical-expense-tax-deduction-calculator';Metrics): medical-expense-tax-deduction-calculator';Analysis {
