import { medical_expense_tax_deduction_calculator';Inputs, medical_expense_tax_deduction_calculator';Metrics, medical_expense_tax_deduction_calculator';Analysis } from './types';
...
export function calculateResult(inputs: medical_expense_tax_deduction_calculator';Inputs): number {
...
export function generateAnalysis(inputs: medical_expense_tax_deduction_calculator';Inputs, metrics: medical_expense_tax_deduction_calculator';Metrics): medical_expense_tax_deduction_calculator';Analysis {
