import { landscaping-cost-calculator';Inputs, landscaping-cost-calculator';Metrics, landscaping-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: landscaping-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: landscaping-cost-calculator';Inputs, metrics: landscaping-cost-calculator';Metrics): landscaping-cost-calculator';Analysis {
