import { landscaping_cost_calculator';Inputs, landscaping_cost_calculator';Metrics, landscaping_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: landscaping_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: landscaping_cost_calculator';Inputs, metrics: landscaping_cost_calculator';Metrics): landscaping_cost_calculator';Analysis {
