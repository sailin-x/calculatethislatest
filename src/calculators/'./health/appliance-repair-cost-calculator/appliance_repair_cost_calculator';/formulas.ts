import { appliance_repair_cost_calculator';Inputs, appliance_repair_cost_calculator';Metrics, appliance_repair_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: appliance_repair_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: appliance_repair_cost_calculator';Inputs, metrics: appliance_repair_cost_calculator';Metrics): appliance_repair_cost_calculator';Analysis {
