import { composting_savings_calculator';Inputs, composting_savings_calculator';Metrics, composting_savings_calculator';Analysis } from './types';
...
export function calculateResult(inputs: composting_savings_calculator';Inputs): number {
...
export function generateAnalysis(inputs: composting_savings_calculator';Inputs, metrics: composting_savings_calculator';Metrics): composting_savings_calculator';Analysis {
