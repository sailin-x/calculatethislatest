import { composting-savings-calculator';Inputs, composting-savings-calculator';Metrics, composting-savings-calculator';Analysis } from './types';
...
export function calculateResult(inputs: composting-savings-calculator';Inputs): number {
...
export function generateAnalysis(inputs: composting-savings-calculator';Inputs, metrics: composting-savings-calculator';Metrics): composting-savings-calculator';Analysis {
