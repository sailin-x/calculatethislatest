import { protein-calculator';Inputs, protein-calculator';Metrics, protein-calculator';Analysis } from './types';
...
export function calculateResult(inputs: protein-calculator';Inputs): number {
...
export function generateAnalysis(inputs: protein-calculator';Inputs, metrics: protein-calculator';Metrics): protein-calculator';Analysis {
