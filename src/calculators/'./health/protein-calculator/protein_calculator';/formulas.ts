import { protein_calculator';Inputs, protein_calculator';Metrics, protein_calculator';Analysis } from './types';
...
export function calculateResult(inputs: protein_calculator';Inputs): number {
...
export function generateAnalysis(inputs: protein_calculator';Inputs, metrics: protein_calculator';Metrics): protein_calculator';Analysis {
