import { home_cleaning_cost_calculator';Inputs, home_cleaning_cost_calculator';Metrics, home_cleaning_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: home_cleaning_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: home_cleaning_cost_calculator';Inputs, metrics: home_cleaning_cost_calculator';Metrics): home_cleaning_cost_calculator';Analysis {
