import { pool_maintenance_cost_calculator';Inputs, pool_maintenance_cost_calculator';Metrics, pool_maintenance_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: pool_maintenance_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: pool_maintenance_cost_calculator';Inputs, metrics: pool_maintenance_cost_calculator';Metrics): pool_maintenance_cost_calculator';Analysis {
