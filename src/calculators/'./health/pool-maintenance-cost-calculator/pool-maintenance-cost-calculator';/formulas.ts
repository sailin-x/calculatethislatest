import { pool-maintenance-cost-calculator';Inputs, pool-maintenance-cost-calculator';Metrics, pool-maintenance-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: pool-maintenance-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: pool-maintenance-cost-calculator';Inputs, metrics: pool-maintenance-cost-calculator';Metrics): pool-maintenance-cost-calculator';Analysis {
