import { medical_device_royalty_rate_calculator';Inputs, medical_device_royalty_rate_calculator';Metrics, medical_device_royalty_rate_calculator';Analysis } from './types';
...
export function calculateResult(inputs: medical_device_royalty_rate_calculator';Inputs): number {
...
export function generateAnalysis(inputs: medical_device_royalty_rate_calculator';Inputs, metrics: medical_device_royalty_rate_calculator';Metrics): medical_device_royalty_rate_calculator';Analysis {
