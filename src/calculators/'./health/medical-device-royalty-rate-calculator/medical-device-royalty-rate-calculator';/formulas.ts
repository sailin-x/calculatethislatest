import { medical-device-royalty-rate-calculator';Inputs, medical-device-royalty-rate-calculator';Metrics, medical-device-royalty-rate-calculator';Analysis } from './types';
...
export function calculateResult(inputs: medical-device-royalty-rate-calculator';Inputs): number {
...
export function generateAnalysis(inputs: medical-device-royalty-rate-calculator';Inputs, metrics: medical-device-royalty-rate-calculator';Metrics): medical-device-royalty-rate-calculator';Analysis {
