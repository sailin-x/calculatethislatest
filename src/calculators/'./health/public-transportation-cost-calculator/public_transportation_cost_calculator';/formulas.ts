import { public_transportation_cost_calculator';Inputs, public_transportation_cost_calculator';Metrics, public_transportation_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: public_transportation_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: public_transportation_cost_calculator';Inputs, metrics: public_transportation_cost_calculator';Metrics): public_transportation_cost_calculator';Analysis {
