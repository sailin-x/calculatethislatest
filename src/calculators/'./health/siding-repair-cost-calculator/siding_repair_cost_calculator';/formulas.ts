import { siding_repair_cost_calculator';Inputs, siding_repair_cost_calculator';Metrics, siding_repair_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: siding_repair_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: siding_repair_cost_calculator';Inputs, metrics: siding_repair_cost_calculator';Metrics): siding_repair_cost_calculator';Analysis {
