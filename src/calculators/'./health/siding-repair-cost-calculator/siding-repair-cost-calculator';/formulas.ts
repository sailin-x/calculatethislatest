import { siding-repair-cost-calculator';Inputs, siding-repair-cost-calculator';Metrics, siding-repair-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: siding-repair-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: siding-repair-cost-calculator';Inputs, metrics: siding-repair-cost-calculator';Metrics): siding-repair-cost-calculator';Analysis {
