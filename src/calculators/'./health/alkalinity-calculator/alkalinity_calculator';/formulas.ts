import { alkalinity_calculator';Inputs, alkalinity_calculator';Metrics, alkalinity_calculator';Analysis } from './types';
...
export function calculateResult(inputs: alkalinity_calculator';Inputs): number {
...
export function generateAnalysis(inputs: alkalinity_calculator';Inputs, metrics: alkalinity_calculator';Metrics): alkalinity_calculator';Analysis {
