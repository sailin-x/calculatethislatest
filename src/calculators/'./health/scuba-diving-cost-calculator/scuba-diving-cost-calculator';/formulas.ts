import { scuba-diving-cost-calculator';Inputs, scuba-diving-cost-calculator';Metrics, scuba-diving-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: scuba-diving-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: scuba-diving-cost-calculator';Inputs, metrics: scuba-diving-cost-calculator';Metrics): scuba-diving-cost-calculator';Analysis {
