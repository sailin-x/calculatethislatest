import { scuba_diving_cost_calculator';Inputs, scuba_diving_cost_calculator';Metrics, scuba_diving_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: scuba_diving_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: scuba_diving_cost_calculator';Inputs, metrics: scuba_diving_cost_calculator';Metrics): scuba_diving_cost_calculator';Analysis {
