import { calorie_deficit_calculator';Inputs, calorie_deficit_calculator';Metrics, calorie_deficit_calculator';Analysis } from './types';
...
export function calculateResult(inputs: calorie_deficit_calculator';Inputs): number {
...
export function generateAnalysis(inputs: calorie_deficit_calculator';Inputs, metrics: calorie_deficit_calculator';Metrics): calorie_deficit_calculator';Analysis {
