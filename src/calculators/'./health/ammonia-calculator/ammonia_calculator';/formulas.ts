import { ammonia_calculator';Inputs, ammonia_calculator';Metrics, ammonia_calculator';Analysis } from './types';
...
export function calculateResult(inputs: ammonia_calculator';Inputs): number {
...
export function generateAnalysis(inputs: ammonia_calculator';Inputs, metrics: ammonia_calculator';Metrics): ammonia_calculator';Analysis {
