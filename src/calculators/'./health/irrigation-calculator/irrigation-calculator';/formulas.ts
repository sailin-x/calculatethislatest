import { irrigation-calculator';Inputs, irrigation-calculator';Metrics, irrigation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: irrigation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: irrigation-calculator';Inputs, metrics: irrigation-calculator';Metrics): irrigation-calculator';Analysis {
