import { irrigation_calculator';Inputs, irrigation_calculator';Metrics, irrigation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: irrigation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: irrigation_calculator';Inputs, metrics: irrigation_calculator';Metrics): irrigation_calculator';Analysis {
