import { crossfit-gym-cost-calculator';Inputs, crossfit-gym-cost-calculator';Metrics, crossfit-gym-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: crossfit-gym-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: crossfit-gym-cost-calculator';Inputs, metrics: crossfit-gym-cost-calculator';Metrics): crossfit-gym-cost-calculator';Analysis {
