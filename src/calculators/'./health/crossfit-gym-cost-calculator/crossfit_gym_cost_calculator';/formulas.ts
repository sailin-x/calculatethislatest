import { crossfit_gym_cost_calculator';Inputs, crossfit_gym_cost_calculator';Metrics, crossfit_gym_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: crossfit_gym_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: crossfit_gym_cost_calculator';Inputs, metrics: crossfit_gym_cost_calculator';Metrics): crossfit_gym_cost_calculator';Analysis {
