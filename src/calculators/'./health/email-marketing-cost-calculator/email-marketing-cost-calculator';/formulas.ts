import { email-marketing-cost-calculator';Inputs, email-marketing-cost-calculator';Metrics, email-marketing-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: email-marketing-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: email-marketing-cost-calculator';Inputs, metrics: email-marketing-cost-calculator';Metrics): email-marketing-cost-calculator';Analysis {
