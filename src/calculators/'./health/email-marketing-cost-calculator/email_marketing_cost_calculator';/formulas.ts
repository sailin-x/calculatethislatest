import { email_marketing_cost_calculator';Inputs, email_marketing_cost_calculator';Metrics, email_marketing_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: email_marketing_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: email_marketing_cost_calculator';Inputs, metrics: email_marketing_cost_calculator';Metrics): email_marketing_cost_calculator';Analysis {
