import { taxi_cost_calculator';Inputs, taxi_cost_calculator';Metrics, taxi_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: taxi_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: taxi_cost_calculator';Inputs, metrics: taxi_cost_calculator';Metrics): taxi_cost_calculator';Analysis {
