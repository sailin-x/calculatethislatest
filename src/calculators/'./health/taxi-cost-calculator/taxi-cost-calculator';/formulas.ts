import { taxi-cost-calculator';Inputs, taxi-cost-calculator';Metrics, taxi-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: taxi-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: taxi-cost-calculator';Inputs, metrics: taxi-cost-calculator';Metrics): taxi-cost-calculator';Analysis {
