import { museum_admission_cost_calculator';Inputs, museum_admission_cost_calculator';Metrics, museum_admission_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: museum_admission_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: museum_admission_cost_calculator';Inputs, metrics: museum_admission_cost_calculator';Metrics): museum_admission_cost_calculator';Analysis {
