import { museum-admission-cost-calculator';Inputs, museum-admission-cost-calculator';Metrics, museum-admission-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: museum-admission-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: museum-admission-cost-calculator';Inputs, metrics: museum-admission-cost-calculator';Metrics): museum-admission-cost-calculator';Analysis {
