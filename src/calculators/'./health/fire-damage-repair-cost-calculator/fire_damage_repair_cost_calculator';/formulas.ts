import { fire_damage_repair_cost_calculator';Inputs, fire_damage_repair_cost_calculator';Metrics, fire_damage_repair_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: fire_damage_repair_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: fire_damage_repair_cost_calculator';Inputs, metrics: fire_damage_repair_cost_calculator';Metrics): fire_damage_repair_cost_calculator';Analysis {
