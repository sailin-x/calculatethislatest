import { fire-damage-repair-cost-calculator';Inputs, fire-damage-repair-cost-calculator';Metrics, fire-damage-repair-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: fire-damage-repair-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: fire-damage-repair-cost-calculator';Inputs, metrics: fire-damage-repair-cost-calculator';Metrics): fire-damage-repair-cost-calculator';Analysis {
