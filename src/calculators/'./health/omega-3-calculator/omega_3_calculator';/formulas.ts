import { omega_3_calculator';Inputs, omega_3_calculator';Metrics, omega_3_calculator';Analysis } from './types';
...
export function calculateResult(inputs: omega_3_calculator';Inputs): number {
...
export function generateAnalysis(inputs: omega_3_calculator';Inputs, metrics: omega_3_calculator';Metrics): omega_3_calculator';Analysis {
