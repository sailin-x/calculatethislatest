import { omega-3-calculator';Inputs, omega-3-calculator';Metrics, omega-3-calculator';Analysis } from './types';
...
export function calculateResult(inputs: omega-3-calculator';Inputs): number {
...
export function generateAnalysis(inputs: omega-3-calculator';Inputs, metrics: omega-3-calculator';Metrics): omega-3-calculator';Analysis {
