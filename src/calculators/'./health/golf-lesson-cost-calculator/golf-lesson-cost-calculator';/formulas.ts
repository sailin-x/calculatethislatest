import { golf-lesson-cost-calculator';Inputs, golf-lesson-cost-calculator';Metrics, golf-lesson-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: golf-lesson-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: golf-lesson-cost-calculator';Inputs, metrics: golf-lesson-cost-calculator';Metrics): golf-lesson-cost-calculator';Analysis {
