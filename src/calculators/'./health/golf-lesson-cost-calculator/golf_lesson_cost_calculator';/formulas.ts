import { golf_lesson_cost_calculator';Inputs, golf_lesson_cost_calculator';Metrics, golf_lesson_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: golf_lesson_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: golf_lesson_cost_calculator';Inputs, metrics: golf_lesson_cost_calculator';Metrics): golf_lesson_cost_calculator';Analysis {
