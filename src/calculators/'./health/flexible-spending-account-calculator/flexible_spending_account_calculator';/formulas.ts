import { flexible_spending_account_calculator';Inputs, flexible_spending_account_calculator';Metrics, flexible_spending_account_calculator';Analysis } from './types';
...
export function calculateResult(inputs: flexible_spending_account_calculator';Inputs): number {
...
export function generateAnalysis(inputs: flexible_spending_account_calculator';Inputs, metrics: flexible_spending_account_calculator';Metrics): flexible_spending_account_calculator';Analysis {
