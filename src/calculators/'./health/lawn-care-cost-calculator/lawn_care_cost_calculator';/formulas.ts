import { lawn_care_cost_calculator';Inputs, lawn_care_cost_calculator';Metrics, lawn_care_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: lawn_care_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: lawn_care_cost_calculator';Inputs, metrics: lawn_care_cost_calculator';Metrics): lawn_care_cost_calculator';Analysis {
