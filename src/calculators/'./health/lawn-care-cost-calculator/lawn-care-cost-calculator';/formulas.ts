import { lawn-care-cost-calculator';Inputs, lawn-care-cost-calculator';Metrics, lawn-care-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: lawn-care-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: lawn-care-cost-calculator';Inputs, metrics: lawn-care-cost-calculator';Metrics): lawn-care-cost-calculator';Analysis {
