import { restaurant-tip-calculator';Inputs, restaurant-tip-calculator';Metrics, restaurant-tip-calculator';Analysis } from './types';
...
export function calculateResult(inputs: restaurant-tip-calculator';Inputs): number {
...
export function generateAnalysis(inputs: restaurant-tip-calculator';Inputs, metrics: restaurant-tip-calculator';Metrics): restaurant-tip-calculator';Analysis {
