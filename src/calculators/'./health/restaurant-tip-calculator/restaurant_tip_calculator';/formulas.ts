import { restaurant_tip_calculator';Inputs, restaurant_tip_calculator';Metrics, restaurant_tip_calculator';Analysis } from './types';
...
export function calculateResult(inputs: restaurant_tip_calculator';Inputs): number {
...
export function generateAnalysis(inputs: restaurant_tip_calculator';Inputs, metrics: restaurant_tip_calculator';Metrics): restaurant_tip_calculator';Analysis {
