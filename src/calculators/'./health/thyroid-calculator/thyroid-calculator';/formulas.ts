import { thyroid-calculator';Inputs, thyroid-calculator';Metrics, thyroid-calculator';Analysis } from './types';
...
export function calculateResult(inputs: thyroid-calculator';Inputs): number {
...
export function generateAnalysis(inputs: thyroid-calculator';Inputs, metrics: thyroid-calculator';Metrics): thyroid-calculator';Analysis {
