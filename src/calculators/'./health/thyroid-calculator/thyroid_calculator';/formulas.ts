import { thyroid_calculator';Inputs, thyroid_calculator';Metrics, thyroid_calculator';Analysis } from './types';
...
export function calculateResult(inputs: thyroid_calculator';Inputs): number {
...
export function generateAnalysis(inputs: thyroid_calculator';Inputs, metrics: thyroid_calculator';Metrics): thyroid_calculator';Analysis {
