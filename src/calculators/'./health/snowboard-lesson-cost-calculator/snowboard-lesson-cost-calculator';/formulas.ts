import { snowboard-lesson-cost-calculator';Inputs, snowboard-lesson-cost-calculator';Metrics, snowboard-lesson-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: snowboard-lesson-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: snowboard-lesson-cost-calculator';Inputs, metrics: snowboard-lesson-cost-calculator';Metrics): snowboard-lesson-cost-calculator';Analysis {
