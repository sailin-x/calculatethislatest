import { snowboard_lesson_cost_calculator';Inputs, snowboard_lesson_cost_calculator';Metrics, snowboard_lesson_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: snowboard_lesson_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: snowboard_lesson_cost_calculator';Inputs, metrics: snowboard_lesson_cost_calculator';Metrics): snowboard_lesson_cost_calculator';Analysis {
