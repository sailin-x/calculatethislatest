import { body_adiposity_index_bai_calculator';Inputs, body_adiposity_index_bai_calculator';Metrics, body_adiposity_index_bai_calculator';Analysis } from './types';
...
export function calculateResult(inputs: body_adiposity_index_bai_calculator';Inputs): number {
...
export function generateAnalysis(inputs: body_adiposity_index_bai_calculator';Inputs, metrics: body_adiposity_index_bai_calculator';Metrics): body_adiposity_index_bai_calculator';Analysis {
