import { bariatric_surgery_calculator';Inputs, bariatric_surgery_calculator';Metrics, bariatric_surgery_calculator';Analysis } from './types';
...
export function calculateResult(inputs: bariatric_surgery_calculator';Inputs): number {
...
export function generateAnalysis(inputs: bariatric_surgery_calculator';Inputs, metrics: bariatric_surgery_calculator';Metrics): bariatric_surgery_calculator';Analysis {
