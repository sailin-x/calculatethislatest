import { bariatric-surgery-calculator';Inputs, bariatric-surgery-calculator';Metrics, bariatric-surgery-calculator';Analysis } from './types';
...
export function calculateResult(inputs: bariatric-surgery-calculator';Inputs): number {
...
export function generateAnalysis(inputs: bariatric-surgery-calculator';Inputs, metrics: bariatric-surgery-calculator';Metrics): bariatric-surgery-calculator';Analysis {
