import { roofing_repair_cost_calculator';Inputs, roofing_repair_cost_calculator';Metrics, roofing_repair_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: roofing_repair_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: roofing_repair_cost_calculator';Inputs, metrics: roofing_repair_cost_calculator';Metrics): roofing_repair_cost_calculator';Analysis {
