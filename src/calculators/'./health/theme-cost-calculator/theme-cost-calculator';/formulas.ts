import { theme-cost-calculator';Inputs, theme-cost-calculator';Metrics, theme-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: theme-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: theme-cost-calculator';Inputs, metrics: theme-cost-calculator';Metrics): theme-cost-calculator';Analysis {
