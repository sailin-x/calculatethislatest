import { theme_cost_calculator';Inputs, theme_cost_calculator';Metrics, theme_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: theme_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: theme_cost_calculator';Inputs, metrics: theme_cost_calculator';Metrics): theme_cost_calculator';Analysis {
