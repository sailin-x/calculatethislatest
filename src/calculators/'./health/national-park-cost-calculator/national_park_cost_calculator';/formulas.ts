import { national_park_cost_calculator';Inputs, national_park_cost_calculator';Metrics, national_park_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: national_park_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: national_park_cost_calculator';Inputs, metrics: national_park_cost_calculator';Metrics): national_park_cost_calculator';Analysis {
