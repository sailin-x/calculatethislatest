import { national-park-cost-calculator';Inputs, national-park-cost-calculator';Metrics, national-park-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: national-park-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: national-park-cost-calculator';Inputs, metrics: national-park-cost-calculator';Metrics): national-park-cost-calculator';Analysis {
