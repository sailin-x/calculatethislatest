import { intermittent-fasting-calculator';Inputs, intermittent-fasting-calculator';Metrics, intermittent-fasting-calculator';Analysis } from './types';
...
export function calculateResult(inputs: intermittent-fasting-calculator';Inputs): number {
...
export function generateAnalysis(inputs: intermittent-fasting-calculator';Inputs, metrics: intermittent-fasting-calculator';Metrics): intermittent-fasting-calculator';Analysis {
