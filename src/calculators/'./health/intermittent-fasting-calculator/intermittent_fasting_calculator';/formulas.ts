import { intermittent_fasting_calculator';Inputs, intermittent_fasting_calculator';Metrics, intermittent_fasting_calculator';Analysis } from './types';
...
export function calculateResult(inputs: intermittent_fasting_calculator';Inputs): number {
...
export function generateAnalysis(inputs: intermittent_fasting_calculator';Inputs, metrics: intermittent_fasting_calculator';Metrics): intermittent_fasting_calculator';Analysis {
