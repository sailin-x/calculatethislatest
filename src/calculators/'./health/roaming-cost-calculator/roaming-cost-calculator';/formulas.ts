import { roaming-cost-calculator';Inputs, roaming-cost-calculator';Metrics, roaming-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: roaming-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: roaming-cost-calculator';Inputs, metrics: roaming-cost-calculator';Metrics): roaming-cost-calculator';Analysis {
