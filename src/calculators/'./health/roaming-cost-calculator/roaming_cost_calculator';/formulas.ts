import { roaming_cost_calculator';Inputs, roaming_cost_calculator';Metrics, roaming_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: roaming_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: roaming_cost_calculator';Inputs, metrics: roaming_cost_calculator';Metrics): roaming_cost_calculator';Analysis {
