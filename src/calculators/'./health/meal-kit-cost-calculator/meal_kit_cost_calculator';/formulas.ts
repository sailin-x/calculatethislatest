import { meal_kit_cost_calculator';Inputs, meal_kit_cost_calculator';Metrics, meal_kit_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: meal_kit_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: meal_kit_cost_calculator';Inputs, metrics: meal_kit_cost_calculator';Metrics): meal_kit_cost_calculator';Analysis {
