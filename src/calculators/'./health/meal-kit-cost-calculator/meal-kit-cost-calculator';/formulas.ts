import { meal-kit-cost-calculator';Inputs, meal-kit-cost-calculator';Metrics, meal-kit-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: meal-kit-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: meal-kit-cost-calculator';Inputs, metrics: meal-kit-cost-calculator';Metrics): meal-kit-cost-calculator';Analysis {
