import { photography-cost-calculator';Inputs, photography-cost-calculator';Metrics, photography-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: photography-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: photography-cost-calculator';Inputs, metrics: photography-cost-calculator';Metrics): photography-cost-calculator';Analysis {
