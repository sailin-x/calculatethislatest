import { photography_cost_calculator';Inputs, photography_cost_calculator';Metrics, photography_cost_calculator';Analysis } from './types';
...
export function calculateResult(inputs: photography_cost_calculator';Inputs): number {
...
export function generateAnalysis(inputs: photography_cost_calculator';Inputs, metrics: photography_cost_calculator';Metrics): photography_cost_calculator';Analysis {
