import { hardiness_calculator';Inputs, hardiness_calculator';Metrics, hardiness_calculator';Analysis } from './types';
...
export function calculateResult(inputs: hardiness_calculator';Inputs): number {
...
export function generateAnalysis(inputs: hardiness_calculator';Inputs, metrics: hardiness_calculator';Metrics): hardiness_calculator';Analysis {
