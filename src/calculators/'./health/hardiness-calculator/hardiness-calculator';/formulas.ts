import { hardiness-calculator';Inputs, hardiness-calculator';Metrics, hardiness-calculator';Analysis } from './types';
...
export function calculateResult(inputs: hardiness-calculator';Inputs): number {
...
export function generateAnalysis(inputs: hardiness-calculator';Inputs, metrics: hardiness-calculator';Metrics): hardiness-calculator';Analysis {
