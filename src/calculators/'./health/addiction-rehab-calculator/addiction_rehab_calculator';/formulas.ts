import { addiction_rehab_calculator';Inputs, addiction_rehab_calculator';Metrics, addiction_rehab_calculator';Analysis } from './types';
...
export function calculateResult(inputs: addiction_rehab_calculator';Inputs): number {
...
export function generateAnalysis(inputs: addiction_rehab_calculator';Inputs, metrics: addiction_rehab_calculator';Metrics): addiction_rehab_calculator';Analysis {
