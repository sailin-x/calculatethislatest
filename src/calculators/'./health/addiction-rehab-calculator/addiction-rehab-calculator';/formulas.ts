import { addiction-rehab-calculator';Inputs, addiction-rehab-calculator';Metrics, addiction-rehab-calculator';Analysis } from './types';
...
export function calculateResult(inputs: addiction-rehab-calculator';Inputs): number {
...
export function generateAnalysis(inputs: addiction-rehab-calculator';Inputs, metrics: addiction-rehab-calculator';Metrics): addiction-rehab-calculator';Analysis {
