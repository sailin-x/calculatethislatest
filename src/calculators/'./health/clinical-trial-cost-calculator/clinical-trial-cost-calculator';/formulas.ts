import { clinical-trial-cost-calculator';Inputs, clinical-trial-cost-calculator';Metrics, clinical-trial-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: clinical-trial-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: clinical-trial-cost-calculator';Inputs, metrics: clinical-trial-cost-calculator';Metrics): clinical-trial-cost-calculator';Analysis {
