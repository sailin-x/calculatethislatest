import { term_vs_universal_life_insurance_calculator';Inputs, term_vs_universal_life_insurance_calculator';Metrics, term_vs_universal_life_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: term_vs_universal_life_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: term_vs_universal_life_insurance_calculator';Inputs, metrics: term_vs_universal_life_insurance_calculator';Metrics): term_vs_universal_life_insurance_calculator';Analysis {
