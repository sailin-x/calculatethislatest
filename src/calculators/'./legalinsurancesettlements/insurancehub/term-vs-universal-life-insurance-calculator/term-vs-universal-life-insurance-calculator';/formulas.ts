import { term-vs-universal-life-insurance-calculator';Inputs, term-vs-universal-life-insurance-calculator';Metrics, term-vs-universal-life-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: term-vs-universal-life-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: term-vs-universal-life-insurance-calculator';Inputs, metrics: term-vs-universal-life-insurance-calculator';Metrics): term-vs-universal-life-insurance-calculator';Analysis {
