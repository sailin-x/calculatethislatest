import { general-liability-insurance-calculator';Inputs, general-liability-insurance-calculator';Metrics, general-liability-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: general-liability-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: general-liability-insurance-calculator';Inputs, metrics: general-liability-insurance-calculator';Metrics): general-liability-insurance-calculator';Analysis {
