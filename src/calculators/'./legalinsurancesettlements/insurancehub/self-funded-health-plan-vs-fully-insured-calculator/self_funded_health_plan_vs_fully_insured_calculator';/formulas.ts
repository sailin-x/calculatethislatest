import { self_funded_health_plan_vs_fully_insured_calculator';Inputs, self_funded_health_plan_vs_fully_insured_calculator';Metrics, self_funded_health_plan_vs_fully_insured_calculator';Analysis } from './types';
...
export function calculateResult(inputs: self_funded_health_plan_vs_fully_insured_calculator';Inputs): number {
...
export function generateAnalysis(inputs: self_funded_health_plan_vs_fully_insured_calculator';Inputs, metrics: self_funded_health_plan_vs_fully_insured_calculator';Metrics): self_funded_health_plan_vs_fully_insured_calculator';Analysis {
