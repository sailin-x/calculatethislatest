import { surety-bond-premium-calculator';Inputs, surety-bond-premium-calculator';Metrics, surety-bond-premium-calculator';Analysis } from './types';
...
export function calculateResult(inputs: surety-bond-premium-calculator';Inputs): number {
...
export function generateAnalysis(inputs: surety-bond-premium-calculator';Inputs, metrics: surety-bond-premium-calculator';Metrics): surety-bond-premium-calculator';Analysis {
