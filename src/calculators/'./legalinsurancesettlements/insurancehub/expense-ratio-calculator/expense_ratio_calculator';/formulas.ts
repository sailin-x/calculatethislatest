import { expense_ratio_calculator';Inputs, expense_ratio_calculator';Metrics, expense_ratio_calculator';Analysis } from './types';
...
export function calculateResult(inputs: expense_ratio_calculator';Inputs): number {
...
export function generateAnalysis(inputs: expense_ratio_calculator';Inputs, metrics: expense_ratio_calculator';Metrics): expense_ratio_calculator';Analysis {
