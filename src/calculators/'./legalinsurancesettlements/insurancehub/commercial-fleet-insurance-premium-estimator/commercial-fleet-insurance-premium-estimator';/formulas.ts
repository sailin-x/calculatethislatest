import { commercial-fleet-insurance-premium-estimator';Inputs, commercial-fleet-insurance-premium-estimator';Metrics, commercial-fleet-insurance-premium-estimator';Analysis } from './types';
...
export function calculateResult(inputs: commercial-fleet-insurance-premium-estimator';Inputs): number {
...
export function generateAnalysis(inputs: commercial-fleet-insurance-premium-estimator';Inputs, metrics: commercial-fleet-insurance-premium-estimator';Metrics): commercial-fleet-insurance-premium-estimator';Analysis {
