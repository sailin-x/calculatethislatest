import { health-insurance-calculator';Inputs, health-insurance-calculator';Metrics, health-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: health-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: health-insurance-calculator';Inputs, metrics: health-insurance-calculator';Metrics): health-insurance-calculator';Analysis {
