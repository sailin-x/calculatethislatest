import { stop-loss-insurance-premium-calculator';Inputs, stop-loss-insurance-premium-calculator';Metrics, stop-loss-insurance-premium-calculator';Analysis } from './types';
...
export function calculateResult(inputs: stop-loss-insurance-premium-calculator';Inputs): number {
...
export function generateAnalysis(inputs: stop-loss-insurance-premium-calculator';Inputs, metrics: stop-loss-insurance-premium-calculator';Metrics): stop-loss-insurance-premium-calculator';Analysis {
