import { catastrophe_bond_pricing_model';Inputs, catastrophe_bond_pricing_model';Metrics, catastrophe_bond_pricing_model';Analysis } from './types';
...
export function calculateResult(inputs: catastrophe_bond_pricing_model';Inputs): number {
...
export function generateAnalysis(inputs: catastrophe_bond_pricing_model';Inputs, metrics: catastrophe_bond_pricing_model';Metrics): catastrophe_bond_pricing_model';Analysis {
