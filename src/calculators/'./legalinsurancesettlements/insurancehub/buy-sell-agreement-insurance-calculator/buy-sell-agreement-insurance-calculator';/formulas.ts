import { buy-sell-agreement-insurance-calculator';Inputs, buy-sell-agreement-insurance-calculator';Metrics, buy-sell-agreement-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: buy-sell-agreement-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: buy-sell-agreement-insurance-calculator';Inputs, metrics: buy-sell-agreement-insurance-calculator';Metrics): buy-sell-agreement-insurance-calculator';Analysis {
