import { split_dollar_life_insurance_calculator';Inputs, split_dollar_life_insurance_calculator';Metrics, split_dollar_life_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: split_dollar_life_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: split_dollar_life_insurance_calculator';Inputs, metrics: split_dollar_life_insurance_calculator';Metrics): split_dollar_life_insurance_calculator';Analysis {
