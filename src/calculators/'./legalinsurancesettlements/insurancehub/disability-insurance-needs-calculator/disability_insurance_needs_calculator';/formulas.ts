import { disability_insurance_needs_calculator';Inputs, disability_insurance_needs_calculator';Metrics, disability_insurance_needs_calculator';Analysis } from './types';
...
export function calculateResult(inputs: disability_insurance_needs_calculator';Inputs): number {
...
export function generateAnalysis(inputs: disability_insurance_needs_calculator';Inputs, metrics: disability_insurance_needs_calculator';Metrics): disability_insurance_needs_calculator';Analysis {
