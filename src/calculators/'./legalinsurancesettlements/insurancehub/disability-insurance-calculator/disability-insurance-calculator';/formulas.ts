import { disability-insurance-calculator';Inputs, disability-insurance-calculator';Metrics, disability-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: disability-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: disability-insurance-calculator';Inputs, metrics: disability-insurance-calculator';Metrics): disability-insurance-calculator';Analysis {
