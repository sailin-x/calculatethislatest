import { lapse_rate_sensitivity_analysis';Inputs, lapse_rate_sensitivity_analysis';Metrics, lapse_rate_sensitivity_analysis';Analysis } from './types';
...
export function calculateResult(inputs: lapse_rate_sensitivity_analysis';Inputs): number {
...
export function generateAnalysis(inputs: lapse_rate_sensitivity_analysis';Inputs, metrics: lapse_rate_sensitivity_analysis';Metrics): lapse_rate_sensitivity_analysis';Analysis {
