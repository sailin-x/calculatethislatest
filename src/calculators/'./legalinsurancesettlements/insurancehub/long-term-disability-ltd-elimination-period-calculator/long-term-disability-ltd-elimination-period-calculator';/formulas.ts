import { long-term-disability-ltd-elimination-period-calculator';Inputs, long-term-disability-ltd-elimination-period-calculator';Metrics, long-term-disability-ltd-elimination-period-calculator';Analysis } from './types';
...
export function calculateResult(inputs: long-term-disability-ltd-elimination-period-calculator';Inputs): number {
...
export function generateAnalysis(inputs: long-term-disability-ltd-elimination-period-calculator';Inputs, metrics: long-term-disability-ltd-elimination-period-calculator';Metrics): long-term-disability-ltd-elimination-period-calculator';Analysis {
