import { political-risk-insurance-calculator';Inputs, political-risk-insurance-calculator';Metrics, political-risk-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: political-risk-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: political-risk-insurance-calculator';Inputs, metrics: political-risk-insurance-calculator';Metrics): political-risk-insurance-calculator';Analysis {
