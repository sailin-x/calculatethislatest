import { directors-officers-insurance-calculator';Inputs, directors-officers-insurance-calculator';Metrics, directors-officers-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: directors-officers-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: directors-officers-insurance-calculator';Inputs, metrics: directors-officers-insurance-calculator';Metrics): directors-officers-insurance-calculator';Analysis {
