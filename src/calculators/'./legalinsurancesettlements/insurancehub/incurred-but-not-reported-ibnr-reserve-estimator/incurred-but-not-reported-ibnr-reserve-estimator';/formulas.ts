import { incurred-but-not-reported-ibnr-reserve-estimator';Inputs, incurred-but-not-reported-ibnr-reserve-estimator';Metrics, incurred-but-not-reported-ibnr-reserve-estimator';Analysis } from './types';
...
export function calculateResult(inputs: incurred-but-not-reported-ibnr-reserve-estimator';Inputs): number {
...
export function generateAnalysis(inputs: incurred-but-not-reported-ibnr-reserve-estimator';Inputs, metrics: incurred-but-not-reported-ibnr-reserve-estimator';Metrics): incurred-but-not-reported-ibnr-reserve-estimator';Analysis {
