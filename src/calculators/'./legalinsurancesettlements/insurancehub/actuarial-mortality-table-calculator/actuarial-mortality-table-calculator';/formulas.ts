import { actuarial-mortality-table-calculator';Inputs, actuarial-mortality-table-calculator';Metrics, actuarial-mortality-table-calculator';Analysis } from './types';
...
export function calculateResult(inputs: actuarial-mortality-table-calculator';Inputs): number {
...
export function generateAnalysis(inputs: actuarial-mortality-table-calculator';Inputs, metrics: actuarial-mortality-table-calculator';Metrics): actuarial-mortality-table-calculator';Analysis {
