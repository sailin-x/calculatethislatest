import { actuarial_mortality_table_calculator';Inputs, actuarial_mortality_table_calculator';Metrics, actuarial_mortality_table_calculator';Analysis } from './types';
...
export function calculateResult(inputs: actuarial_mortality_table_calculator';Inputs): number {
...
export function generateAnalysis(inputs: actuarial_mortality_table_calculator';Inputs, metrics: actuarial_mortality_table_calculator';Metrics): actuarial_mortality_table_calculator';Analysis {
