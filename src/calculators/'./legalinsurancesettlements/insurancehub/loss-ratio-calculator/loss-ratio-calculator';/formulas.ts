import { loss-ratio-calculator';Inputs, loss-ratio-calculator';Metrics, loss-ratio-calculator';Analysis } from './types';
...
export function calculateResult(inputs: loss-ratio-calculator';Inputs): number {
...
export function generateAnalysis(inputs: loss-ratio-calculator';Inputs, metrics: loss-ratio-calculator';Metrics): loss-ratio-calculator';Analysis {
