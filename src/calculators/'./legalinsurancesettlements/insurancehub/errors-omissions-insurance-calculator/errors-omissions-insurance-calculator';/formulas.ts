import { errors-omissions-insurance-calculator';Inputs, errors-omissions-insurance-calculator';Metrics, errors-omissions-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: errors-omissions-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: errors-omissions-insurance-calculator';Inputs, metrics: errors-omissions-insurance-calculator';Metrics): errors-omissions-insurance-calculator';Analysis {
