import { catastrophic-injury-calculator';Inputs, catastrophic-injury-calculator';Metrics, catastrophic-injury-calculator';Analysis } from './types';
...
export function calculateResult(inputs: catastrophic-injury-calculator';Inputs): number {
...
export function generateAnalysis(inputs: catastrophic-injury-calculator';Inputs, metrics: catastrophic-injury-calculator';Metrics): catastrophic-injury-calculator';Analysis {
