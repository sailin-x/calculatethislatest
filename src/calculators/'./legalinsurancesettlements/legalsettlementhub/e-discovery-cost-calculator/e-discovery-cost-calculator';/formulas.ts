import { e-discovery-cost-calculator';Inputs, e-discovery-cost-calculator';Metrics, e-discovery-cost-calculator';Analysis } from './types';
...
export function calculateResult(inputs: e-discovery-cost-calculator';Inputs): number {
...
export function generateAnalysis(inputs: e-discovery-cost-calculator';Inputs, metrics: e-discovery-cost-calculator';Metrics): e-discovery-cost-calculator';Analysis {
