import { dental-malpractice-settlement-calculator';Inputs, dental-malpractice-settlement-calculator';Metrics, dental-malpractice-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: dental-malpractice-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: dental-malpractice-settlement-calculator';Inputs, metrics: dental-malpractice-settlement-calculator';Metrics): dental-malpractice-settlement-calculator';Analysis {
