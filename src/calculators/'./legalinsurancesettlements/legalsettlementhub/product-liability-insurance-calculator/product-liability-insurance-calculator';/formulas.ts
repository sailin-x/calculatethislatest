import { product-liability-insurance-calculator';Inputs, product-liability-insurance-calculator';Metrics, product-liability-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: product-liability-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: product-liability-insurance-calculator';Inputs, metrics: product-liability-insurance-calculator';Metrics): product-liability-insurance-calculator';Analysis {
