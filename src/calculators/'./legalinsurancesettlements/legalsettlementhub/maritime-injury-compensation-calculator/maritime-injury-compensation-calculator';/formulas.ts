import { maritime-injury-compensation-calculator';Inputs, maritime-injury-compensation-calculator';Metrics, maritime-injury-compensation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: maritime-injury-compensation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: maritime-injury-compensation-calculator';Inputs, metrics: maritime-injury-compensation-calculator';Metrics): maritime-injury-compensation-calculator';Analysis {
