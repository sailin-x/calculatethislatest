import { epa-fine-penalty-calculator';Inputs, epa-fine-penalty-calculator';Metrics, epa-fine-penalty-calculator';Analysis } from './types';
...
export function calculateResult(inputs: epa-fine-penalty-calculator';Inputs): number {
...
export function generateAnalysis(inputs: epa-fine-penalty-calculator';Inputs, metrics: epa-fine-penalty-calculator';Metrics): epa-fine-penalty-calculator';Analysis {
