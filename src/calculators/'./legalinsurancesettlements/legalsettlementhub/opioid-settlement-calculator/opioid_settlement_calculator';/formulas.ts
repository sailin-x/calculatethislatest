import { opioid_settlement_calculator';Inputs, opioid_settlement_calculator';Metrics, opioid_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: opioid_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: opioid_settlement_calculator';Inputs, metrics: opioid_settlement_calculator';Metrics): opioid_settlement_calculator';Analysis {
