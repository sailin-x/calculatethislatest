import { opioid-settlement-calculator';Inputs, opioid-settlement-calculator';Metrics, opioid-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: opioid-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: opioid-settlement-calculator';Inputs, metrics: opioid-settlement-calculator';Metrics): opioid-settlement-calculator';Analysis {
