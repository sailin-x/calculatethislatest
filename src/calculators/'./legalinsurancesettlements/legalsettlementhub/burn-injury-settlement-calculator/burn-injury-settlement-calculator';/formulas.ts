import { burn-injury-settlement-calculator';Inputs, burn-injury-settlement-calculator';Metrics, burn-injury-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: burn-injury-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: burn-injury-settlement-calculator';Inputs, metrics: burn-injury-settlement-calculator';Metrics): burn-injury-settlement-calculator';Analysis {
