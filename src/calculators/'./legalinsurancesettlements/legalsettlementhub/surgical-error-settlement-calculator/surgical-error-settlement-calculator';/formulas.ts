import { surgical-error-settlement-calculator';Inputs, surgical-error-settlement-calculator';Metrics, surgical-error-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: surgical-error-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: surgical-error-settlement-calculator';Inputs, metrics: surgical-error-settlement-calculator';Metrics): surgical-error-settlement-calculator';Analysis {
