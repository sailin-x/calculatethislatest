import { legal_practice_valuation_calculator';Inputs, legal_practice_valuation_calculator';Metrics, legal_practice_valuation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: legal_practice_valuation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: legal_practice_valuation_calculator';Inputs, metrics: legal_practice_valuation_calculator';Metrics): legal_practice_valuation_calculator';Analysis {
