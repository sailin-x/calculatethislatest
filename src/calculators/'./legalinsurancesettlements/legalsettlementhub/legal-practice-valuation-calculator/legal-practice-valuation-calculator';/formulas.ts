import { legal-practice-valuation-calculator';Inputs, legal-practice-valuation-calculator';Metrics, legal-practice-valuation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: legal-practice-valuation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: legal-practice-valuation-calculator';Inputs, metrics: legal-practice-valuation-calculator';Metrics): legal-practice-valuation-calculator';Analysis {
