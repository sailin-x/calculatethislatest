import { talcum-powder-settlement-calculator';Inputs, talcum-powder-settlement-calculator';Metrics, talcum-powder-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: talcum-powder-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: talcum-powder-settlement-calculator';Inputs, metrics: talcum-powder-settlement-calculator';Metrics): talcum-powder-settlement-calculator';Analysis {
