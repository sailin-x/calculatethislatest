import { personal_injury_multiplier_calculator';Inputs, personal_injury_multiplier_calculator';Metrics, personal_injury_multiplier_calculator';Analysis } from './types';
...
export function calculateResult(inputs: personal_injury_multiplier_calculator';Inputs): number {
...
export function generateAnalysis(inputs: personal_injury_multiplier_calculator';Inputs, metrics: personal_injury_multiplier_calculator';Metrics): personal_injury_multiplier_calculator';Analysis {
