import { product-liability-settlement-calculator';Inputs, product-liability-settlement-calculator';Metrics, product-liability-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: product-liability-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: product-liability-settlement-calculator';Inputs, metrics: product-liability-settlement-calculator';Metrics): product-liability-settlement-calculator';Analysis {
