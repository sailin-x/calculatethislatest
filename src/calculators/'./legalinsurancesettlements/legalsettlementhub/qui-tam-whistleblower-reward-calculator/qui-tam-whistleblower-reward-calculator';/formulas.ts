import { qui-tam-whistleblower-reward-calculator';Inputs, qui-tam-whistleblower-reward-calculator';Metrics, qui-tam-whistleblower-reward-calculator';Analysis } from './types';
...
export function calculateResult(inputs: qui-tam-whistleblower-reward-calculator';Inputs): number {
...
export function generateAnalysis(inputs: qui-tam-whistleblower-reward-calculator';Inputs, metrics: qui-tam-whistleblower-reward-calculator';Metrics): qui-tam-whistleblower-reward-calculator';Analysis {
