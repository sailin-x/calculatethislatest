import { medical-malpractice-settlement-calculator';Inputs, medical-malpractice-settlement-calculator';Metrics, medical-malpractice-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: medical-malpractice-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: medical-malpractice-settlement-calculator';Inputs, metrics: medical-malpractice-settlement-calculator';Metrics): medical-malpractice-settlement-calculator';Analysis {
