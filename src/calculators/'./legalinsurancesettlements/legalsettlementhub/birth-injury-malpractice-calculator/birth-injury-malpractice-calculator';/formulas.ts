import { birth-injury-malpractice-calculator';Inputs, birth-injury-malpractice-calculator';Metrics, birth-injury-malpractice-calculator';Analysis } from './types';
...
export function calculateResult(inputs: birth-injury-malpractice-calculator';Inputs): number {
...
export function generateAnalysis(inputs: birth-injury-malpractice-calculator';Inputs, metrics: birth-injury-malpractice-calculator';Metrics): birth-injury-malpractice-calculator';Analysis {
