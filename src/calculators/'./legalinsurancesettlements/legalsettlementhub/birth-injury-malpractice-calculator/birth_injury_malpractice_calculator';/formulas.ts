import { birth_injury_malpractice_calculator';Inputs, birth_injury_malpractice_calculator';Metrics, birth_injury_malpractice_calculator';Analysis } from './types';
...
export function calculateResult(inputs: birth_injury_malpractice_calculator';Inputs): number {
...
export function generateAnalysis(inputs: birth_injury_malpractice_calculator';Inputs, metrics: birth_injury_malpractice_calculator';Metrics): birth_injury_malpractice_calculator';Analysis {
