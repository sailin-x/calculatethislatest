import { aviation-accident-compensation-calculator';Inputs, aviation-accident-compensation-calculator';Metrics, aviation-accident-compensation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: aviation-accident-compensation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: aviation-accident-compensation-calculator';Inputs, metrics: aviation-accident-compensation-calculator';Metrics): aviation-accident-compensation-calculator';Analysis {
