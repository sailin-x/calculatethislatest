import { spinal_cord_injury_compensation_calculator';Inputs, spinal_cord_injury_compensation_calculator';Metrics, spinal_cord_injury_compensation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: spinal_cord_injury_compensation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: spinal_cord_injury_compensation_calculator';Inputs, metrics: spinal_cord_injury_compensation_calculator';Metrics): spinal_cord_injury_compensation_calculator';Analysis {
