import { fela_settlement_calculator_railroad';Inputs, fela_settlement_calculator_railroad';Metrics, fela_settlement_calculator_railroad';Analysis } from './types';
...
export function calculateResult(inputs: fela_settlement_calculator_railroad';Inputs): number {
...
export function generateAnalysis(inputs: fela_settlement_calculator_railroad';Inputs, metrics: fela_settlement_calculator_railroad';Metrics): fela_settlement_calculator_railroad';Analysis {
