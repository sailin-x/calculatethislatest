import { patent_valuation_calculator';Inputs, patent_valuation_calculator';Metrics, patent_valuation_calculator';Analysis } from './types';
...
export function calculateResult(inputs: patent_valuation_calculator';Inputs): number {
...
export function generateAnalysis(inputs: patent_valuation_calculator';Inputs, metrics: patent_valuation_calculator';Metrics): patent_valuation_calculator';Analysis {
