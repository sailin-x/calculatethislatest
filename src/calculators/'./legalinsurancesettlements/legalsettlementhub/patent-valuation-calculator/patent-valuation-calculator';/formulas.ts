import { patent-valuation-calculator';Inputs, patent-valuation-calculator';Metrics, patent-valuation-calculator';Analysis } from './types';
...
export function calculateResult(inputs: patent-valuation-calculator';Inputs): number {
...
export function generateAnalysis(inputs: patent-valuation-calculator';Inputs, metrics: patent-valuation-calculator';Metrics): patent-valuation-calculator';Analysis {
