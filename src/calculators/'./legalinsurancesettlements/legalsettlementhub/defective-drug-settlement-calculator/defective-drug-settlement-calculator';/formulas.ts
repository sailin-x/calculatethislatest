import { defective-drug-settlement-calculator';Inputs, defective-drug-settlement-calculator';Metrics, defective-drug-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: defective-drug-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: defective-drug-settlement-calculator';Inputs, metrics: defective-drug-settlement-calculator';Metrics): defective-drug-settlement-calculator';Analysis {
