import { railroad-accident-settlement-calculator';Inputs, railroad-accident-settlement-calculator';Metrics, railroad-accident-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: railroad-accident-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: railroad-accident-settlement-calculator';Inputs, metrics: railroad-accident-settlement-calculator';Metrics): railroad-accident-settlement-calculator';Analysis {
