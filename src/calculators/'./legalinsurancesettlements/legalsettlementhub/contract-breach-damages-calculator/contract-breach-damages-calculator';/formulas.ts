import { contract-breach-damages-calculator';Inputs, contract-breach-damages-calculator';Metrics, contract-breach-damages-calculator';Analysis } from './types';
...
export function calculateResult(inputs: contract-breach-damages-calculator';Inputs): number {
...
export function generateAnalysis(inputs: contract-breach-damages-calculator';Inputs, metrics: contract-breach-damages-calculator';Metrics): contract-breach-damages-calculator';Analysis {
