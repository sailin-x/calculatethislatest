import { pedestrian_accident_settlement_calculator';Inputs, pedestrian_accident_settlement_calculator';Metrics, pedestrian_accident_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: pedestrian_accident_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: pedestrian_accident_settlement_calculator';Inputs, metrics: pedestrian_accident_settlement_calculator';Metrics): pedestrian_accident_settlement_calculator';Analysis {
