import { child-support-calculator';Inputs, child-support-calculator';Metrics, child-support-calculator';Analysis } from './types';
...
export function calculateResult(inputs: child-support-calculator';Inputs): number {
...
export function generateAnalysis(inputs: child-support-calculator';Inputs, metrics: child-support-calculator';Metrics): child-support-calculator';Analysis {
