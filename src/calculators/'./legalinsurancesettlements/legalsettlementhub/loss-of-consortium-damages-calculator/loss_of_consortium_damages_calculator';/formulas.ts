import { loss_of_consortium_damages_calculator';Inputs, loss_of_consortium_damages_calculator';Metrics, loss_of_consortium_damages_calculator';Analysis } from './types';
...
export function calculateResult(inputs: loss_of_consortium_damages_calculator';Inputs): number {
...
export function generateAnalysis(inputs: loss_of_consortium_damages_calculator';Inputs, metrics: loss_of_consortium_damages_calculator';Metrics): loss_of_consortium_damages_calculator';Analysis {
