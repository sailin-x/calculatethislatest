import { slip_and_fall_damages_calculator';Inputs, slip_and_fall_damages_calculator';Metrics, slip_and_fall_damages_calculator';Analysis } from './types';
...
export function calculateResult(inputs: slip_and_fall_damages_calculator';Inputs): number {
...
export function generateAnalysis(inputs: slip_and_fall_damages_calculator';Inputs, metrics: slip_and_fall_damages_calculator';Metrics): slip_and_fall_damages_calculator';Analysis {
