import { alimony_spousal_support_calculator';Inputs, alimony_spousal_support_calculator';Metrics, alimony_spousal_support_calculator';Analysis } from './types';
...
export function calculateResult(inputs: alimony_spousal_support_calculator';Inputs): number {
...
export function generateAnalysis(inputs: alimony_spousal_support_calculator';Inputs, metrics: alimony_spousal_support_calculator';Metrics): alimony_spousal_support_calculator';Analysis {
