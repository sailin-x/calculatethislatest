import { mass_tort_settlement_calculator';Inputs, mass_tort_settlement_calculator';Metrics, mass_tort_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: mass_tort_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: mass_tort_settlement_calculator';Inputs, metrics: mass_tort_settlement_calculator';Metrics): mass_tort_settlement_calculator';Analysis {
