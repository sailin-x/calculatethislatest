import { mass-tort-settlement-calculator';Inputs, mass-tort-settlement-calculator';Metrics, mass-tort-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: mass-tort-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: mass-tort-settlement-calculator';Inputs, metrics: mass-tort-settlement-calculator';Metrics): mass-tort-settlement-calculator';Analysis {
