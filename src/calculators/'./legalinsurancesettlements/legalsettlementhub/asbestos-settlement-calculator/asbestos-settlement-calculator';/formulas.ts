import { asbestos-settlement-calculator';Inputs, asbestos-settlement-calculator';Metrics, asbestos-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: asbestos-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: asbestos-settlement-calculator';Inputs, metrics: asbestos-settlement-calculator';Metrics): asbestos-settlement-calculator';Analysis {
