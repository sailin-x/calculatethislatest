import { legal-malpractice-insurance-calculator';Inputs, legal-malpractice-insurance-calculator';Metrics, legal-malpractice-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: legal-malpractice-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: legal-malpractice-insurance-calculator';Inputs, metrics: legal-malpractice-insurance-calculator';Metrics): legal-malpractice-insurance-calculator';Analysis {
