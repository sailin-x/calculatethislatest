import { pharmaceutical_liability_calculator';Inputs, pharmaceutical_liability_calculator';Metrics, pharmaceutical_liability_calculator';Analysis } from './types';
...
export function calculateResult(inputs: pharmaceutical_liability_calculator';Inputs): number {
...
export function generateAnalysis(inputs: pharmaceutical_liability_calculator';Inputs, metrics: pharmaceutical_liability_calculator';Metrics): pharmaceutical_liability_calculator';Analysis {
