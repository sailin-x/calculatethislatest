import { medical-device-liability-calculator';Inputs, medical-device-liability-calculator';Metrics, medical-device-liability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: medical-device-liability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: medical-device-liability-calculator';Inputs, metrics: medical-device-liability-calculator';Metrics): medical-device-liability-calculator';Analysis {
