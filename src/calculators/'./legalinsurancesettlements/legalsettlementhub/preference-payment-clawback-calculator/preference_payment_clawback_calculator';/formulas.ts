import { preference_payment_clawback_calculator';Inputs, preference_payment_clawback_calculator';Metrics, preference_payment_clawback_calculator';Analysis } from './types';
...
export function calculateResult(inputs: preference_payment_clawback_calculator';Inputs): number {
...
export function generateAnalysis(inputs: preference_payment_clawback_calculator';Inputs, metrics: preference_payment_clawback_calculator';Metrics): preference_payment_clawback_calculator';Analysis {
