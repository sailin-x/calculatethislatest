import { dui_accident_settlement_calculator';Inputs, dui_accident_settlement_calculator';Metrics, dui_accident_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: dui_accident_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: dui_accident_settlement_calculator';Inputs, metrics: dui_accident_settlement_calculator';Metrics): dui_accident_settlement_calculator';Analysis {
