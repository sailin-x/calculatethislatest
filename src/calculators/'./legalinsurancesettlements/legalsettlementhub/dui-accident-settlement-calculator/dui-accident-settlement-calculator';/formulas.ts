import { dui-accident-settlement-calculator';Inputs, dui-accident-settlement-calculator';Metrics, dui-accident-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: dui-accident-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: dui-accident-settlement-calculator';Inputs, metrics: dui-accident-settlement-calculator';Metrics): dui-accident-settlement-calculator';Analysis {
