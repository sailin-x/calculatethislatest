import { environmental_remediation_cost_estimator';Inputs, environmental_remediation_cost_estimator';Metrics, environmental_remediation_cost_estimator';Analysis } from './types';
...
export function calculateResult(inputs: environmental_remediation_cost_estimator';Inputs): number {
...
export function generateAnalysis(inputs: environmental_remediation_cost_estimator';Inputs, metrics: environmental_remediation_cost_estimator';Metrics): environmental_remediation_cost_estimator';Analysis {
