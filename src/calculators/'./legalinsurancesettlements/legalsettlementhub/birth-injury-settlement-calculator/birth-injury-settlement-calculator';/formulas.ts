import { birth-injury-settlement-calculator';Inputs, birth-injury-settlement-calculator';Metrics, birth-injury-settlement-calculator';Analysis } from './types';
...
export function calculateResult(inputs: birth-injury-settlement-calculator';Inputs): number {
...
export function generateAnalysis(inputs: birth-injury-settlement-calculator';Inputs, metrics: birth-injury-settlement-calculator';Metrics): birth-injury-settlement-calculator';Analysis {
