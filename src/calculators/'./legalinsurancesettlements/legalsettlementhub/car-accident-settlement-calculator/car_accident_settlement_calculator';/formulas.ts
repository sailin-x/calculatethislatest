import { car_accident_settlement_calculator';Inputs, car_accident_settlement_calculator';Metrics, car_accident_settlement_calculator';Analysis } from './types';
...
export function calculateResult(inputs: car_accident_settlement_calculator';Inputs): number {
...
export function generateAnalysis(inputs: car_accident_settlement_calculator';Inputs, metrics: car_accident_settlement_calculator';Metrics): car_accident_settlement_calculator';Analysis {
