import { life_insurance_calculator';Inputs, life_insurance_calculator';Metrics, life_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: life_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: life_insurance_calculator';Inputs, metrics: life_insurance_calculator';Metrics): life_insurance_calculator';Analysis {
