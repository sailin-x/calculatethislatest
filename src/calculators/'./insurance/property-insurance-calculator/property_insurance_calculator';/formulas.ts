import { property_insurance_calculator';Inputs, property_insurance_calculator';Metrics, property_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: property_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: property_insurance_calculator';Inputs, metrics: property_insurance_calculator';Metrics): property_insurance_calculator';Analysis {
