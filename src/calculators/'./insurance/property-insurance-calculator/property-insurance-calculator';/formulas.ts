import { property-insurance-calculator';Inputs, property-insurance-calculator';Metrics, property-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: property-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: property-insurance-calculator';Inputs, metrics: property-insurance-calculator';Metrics): property-insurance-calculator';Analysis {
