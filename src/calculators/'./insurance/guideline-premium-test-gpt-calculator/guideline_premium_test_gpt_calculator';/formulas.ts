import { guideline_premium_test_gpt_calculator';Inputs, guideline_premium_test_gpt_calculator';Metrics, guideline_premium_test_gpt_calculator';Analysis } from './types';
...
export function calculateResult(inputs: guideline_premium_test_gpt_calculator';Inputs): number {
...
export function generateAnalysis(inputs: guideline_premium_test_gpt_calculator';Inputs, metrics: guideline_premium_test_gpt_calculator';Metrics): guideline_premium_test_gpt_calculator';Analysis {
