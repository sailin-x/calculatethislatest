import { key-person-calculator';Inputs, key-person-calculator';Metrics, key-person-calculator';Analysis } from './types';
...
export function calculateResult(inputs: key-person-calculator';Inputs): number {
...
export function generateAnalysis(inputs: key-person-calculator';Inputs, metrics: key-person-calculator';Metrics): key-person-calculator';Analysis {
