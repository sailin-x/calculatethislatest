import { key_person_calculator';Inputs, key_person_calculator';Metrics, key_person_calculator';Analysis } from './types';
...
export function calculateResult(inputs: key_person_calculator';Inputs): number {
...
export function generateAnalysis(inputs: key_person_calculator';Inputs, metrics: key_person_calculator';Metrics): key_person_calculator';Analysis {
