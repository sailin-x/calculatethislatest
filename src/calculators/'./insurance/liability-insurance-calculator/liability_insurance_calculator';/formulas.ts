import { liability_insurance_calculator';Inputs, liability_insurance_calculator';Metrics, liability_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: liability_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: liability_insurance_calculator';Inputs, metrics: liability_insurance_calculator';Metrics): liability_insurance_calculator';Analysis {
