import { renters_insurance_calculator';Inputs, renters_insurance_calculator';Metrics, renters_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: renters_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: renters_insurance_calculator';Inputs, metrics: renters_insurance_calculator';Metrics): renters_insurance_calculator';Analysis {
