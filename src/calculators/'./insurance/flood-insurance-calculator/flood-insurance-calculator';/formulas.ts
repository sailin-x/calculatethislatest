import { flood-insurance-calculator';Inputs, flood-insurance-calculator';Metrics, flood-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: flood-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: flood-insurance-calculator';Inputs, metrics: flood-insurance-calculator';Metrics): flood-insurance-calculator';Analysis {
