import { flood_insurance_calculator';Inputs, flood_insurance_calculator';Metrics, flood_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: flood_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: flood_insurance_calculator';Inputs, metrics: flood_insurance_calculator';Metrics): flood_insurance_calculator';Analysis {
