import { term_vs_whole_life_calculator';Inputs, term_vs_whole_life_calculator';Metrics, term_vs_whole_life_calculator';Analysis } from './types';
...
export function calculateResult(inputs: term_vs_whole_life_calculator';Inputs): number {
...
export function generateAnalysis(inputs: term_vs_whole_life_calculator';Inputs, metrics: term_vs_whole_life_calculator';Metrics): term_vs_whole_life_calculator';Analysis {
