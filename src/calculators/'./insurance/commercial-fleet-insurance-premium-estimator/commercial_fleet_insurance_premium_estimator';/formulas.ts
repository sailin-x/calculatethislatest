import { commercial_fleet_insurance_premium_estimator';Inputs, commercial_fleet_insurance_premium_estimator';Metrics, commercial_fleet_insurance_premium_estimator';Analysis } from './types';
...
export function calculateResult(inputs: commercial_fleet_insurance_premium_estimator';Inputs): number {
...
export function generateAnalysis(inputs: commercial_fleet_insurance_premium_estimator';Inputs, metrics: commercial_fleet_insurance_premium_estimator';Metrics): commercial_fleet_insurance_premium_estimator';Analysis {
