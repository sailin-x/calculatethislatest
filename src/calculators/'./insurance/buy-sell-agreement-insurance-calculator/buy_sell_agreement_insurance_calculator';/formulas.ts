import { buy_sell_agreement_insurance_calculator';Inputs, buy_sell_agreement_insurance_calculator';Metrics, buy_sell_agreement_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: buy_sell_agreement_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: buy_sell_agreement_insurance_calculator';Inputs, metrics: buy_sell_agreement_insurance_calculator';Metrics): buy_sell_agreement_insurance_calculator';Analysis {
