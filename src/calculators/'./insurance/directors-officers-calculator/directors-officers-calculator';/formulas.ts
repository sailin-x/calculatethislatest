import { directors-officers-calculator';Inputs, directors-officers-calculator';Metrics, directors-officers-calculator';Analysis } from './types';
...
export function calculateResult(inputs: directors-officers-calculator';Inputs): number {
...
export function generateAnalysis(inputs: directors-officers-calculator';Inputs, metrics: directors-officers-calculator';Metrics): directors-officers-calculator';Analysis {
