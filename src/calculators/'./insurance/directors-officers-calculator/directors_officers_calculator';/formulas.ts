import { directors_officers_calculator';Inputs, directors_officers_calculator';Metrics, directors_officers_calculator';Analysis } from './types';
...
export function calculateResult(inputs: directors_officers_calculator';Inputs): number {
...
export function generateAnalysis(inputs: directors_officers_calculator';Inputs, metrics: directors_officers_calculator';Metrics): directors_officers_calculator';Analysis {
