import { accident_insurance_calculator';Inputs, accident_insurance_calculator';Metrics, accident_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: accident_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: accident_insurance_calculator';Inputs, metrics: accident_insurance_calculator';Metrics): accident_insurance_calculator';Analysis {
