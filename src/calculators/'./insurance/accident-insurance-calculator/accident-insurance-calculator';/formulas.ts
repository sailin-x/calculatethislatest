import { accident-insurance-calculator';Inputs, accident-insurance-calculator';Metrics, accident-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: accident-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: accident-insurance-calculator';Inputs, metrics: accident-insurance-calculator';Metrics): accident-insurance-calculator';Analysis {
