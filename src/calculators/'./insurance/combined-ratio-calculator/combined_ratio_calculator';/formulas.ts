import { combined_ratio_calculator';Inputs, combined_ratio_calculator';Metrics, combined_ratio_calculator';Analysis } from './types';
...
export function calculateResult(inputs: combined_ratio_calculator';Inputs): number {
...
export function generateAnalysis(inputs: combined_ratio_calculator';Inputs, metrics: combined_ratio_calculator';Metrics): combined_ratio_calculator';Analysis {
