import { buy_sell_calculator';Inputs, buy_sell_calculator';Metrics, buy_sell_calculator';Analysis } from './types';
...
export function calculateResult(inputs: buy_sell_calculator';Inputs): number {
...
export function generateAnalysis(inputs: buy_sell_calculator';Inputs, metrics: buy_sell_calculator';Metrics): buy_sell_calculator';Analysis {
