import { buy-sell-calculator';Inputs, buy-sell-calculator';Metrics, buy-sell-calculator';Analysis } from './types';
...
export function calculateResult(inputs: buy-sell-calculator';Inputs): number {
...
export function generateAnalysis(inputs: buy-sell-calculator';Inputs, metrics: buy-sell-calculator';Metrics): buy-sell-calculator';Analysis {
