import { employment-practices-calculator';Inputs, employment-practices-calculator';Metrics, employment-practices-calculator';Analysis } from './types';
...
export function calculateResult(inputs: employment-practices-calculator';Inputs): number {
...
export function generateAnalysis(inputs: employment-practices-calculator';Inputs, metrics: employment-practices-calculator';Metrics): employment-practices-calculator';Analysis {
