import { employment_practices_calculator';Inputs, employment_practices_calculator';Metrics, employment_practices_calculator';Analysis } from './types';
...
export function calculateResult(inputs: employment_practices_calculator';Inputs): number {
...
export function generateAnalysis(inputs: employment_practices_calculator';Inputs, metrics: employment_practices_calculator';Metrics): employment_practices_calculator';Analysis {
