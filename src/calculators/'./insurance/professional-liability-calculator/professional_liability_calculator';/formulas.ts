import { professional_liability_calculator';Inputs, professional_liability_calculator';Metrics, professional_liability_calculator';Analysis } from './types';
...
export function calculateResult(inputs: professional_liability_calculator';Inputs): number {
...
export function generateAnalysis(inputs: professional_liability_calculator';Inputs, metrics: professional_liability_calculator';Metrics): professional_liability_calculator';Analysis {
