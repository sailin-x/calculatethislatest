import { professional-liability-calculator';Inputs, professional-liability-calculator';Metrics, professional-liability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: professional-liability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: professional-liability-calculator';Inputs, metrics: professional-liability-calculator';Metrics): professional-liability-calculator';Analysis {
