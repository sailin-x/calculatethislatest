import { gap-insurance-calculator';Inputs, gap-insurance-calculator';Metrics, gap-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: gap-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: gap-insurance-calculator';Inputs, metrics: gap-insurance-calculator';Metrics): gap-insurance-calculator';Analysis {
