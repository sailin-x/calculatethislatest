import { gap_insurance_calculator';Inputs, gap_insurance_calculator';Metrics, gap_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: gap_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: gap_insurance_calculator';Inputs, metrics: gap_insurance_calculator';Metrics): gap_insurance_calculator';Analysis {
