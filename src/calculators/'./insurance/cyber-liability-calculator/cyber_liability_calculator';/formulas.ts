import { cyber_liability_calculator';Inputs, cyber_liability_calculator';Metrics, cyber_liability_calculator';Analysis } from './types';
...
export function calculateResult(inputs: cyber_liability_calculator';Inputs): number {
...
export function generateAnalysis(inputs: cyber_liability_calculator';Inputs, metrics: cyber_liability_calculator';Metrics): cyber_liability_calculator';Analysis {
