import { cyber-liability-calculator';Inputs, cyber-liability-calculator';Metrics, cyber-liability-calculator';Analysis } from './types';
...
export function calculateResult(inputs: cyber-liability-calculator';Inputs): number {
...
export function generateAnalysis(inputs: cyber-liability-calculator';Inputs, metrics: cyber-liability-calculator';Metrics): cyber-liability-calculator';Analysis {
