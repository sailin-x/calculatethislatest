import { critical-illness-calculator';Inputs, critical-illness-calculator';Metrics, critical-illness-calculator';Analysis } from './types';
...
export function calculateResult(inputs: critical-illness-calculator';Inputs): number {
...
export function generateAnalysis(inputs: critical-illness-calculator';Inputs, metrics: critical-illness-calculator';Metrics): critical-illness-calculator';Analysis {
