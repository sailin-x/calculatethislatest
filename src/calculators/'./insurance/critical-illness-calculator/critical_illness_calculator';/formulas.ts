import { critical_illness_calculator';Inputs, critical_illness_calculator';Metrics, critical_illness_calculator';Analysis } from './types';
...
export function calculateResult(inputs: critical_illness_calculator';Inputs): number {
...
export function generateAnalysis(inputs: critical_illness_calculator';Inputs, metrics: critical_illness_calculator';Metrics): critical_illness_calculator';Analysis {
