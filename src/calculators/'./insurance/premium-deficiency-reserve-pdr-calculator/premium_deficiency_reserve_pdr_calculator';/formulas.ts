import { premium_deficiency_reserve_pdr_calculator';Inputs, premium_deficiency_reserve_pdr_calculator';Metrics, premium_deficiency_reserve_pdr_calculator';Analysis } from './types';
...
export function calculateResult(inputs: premium_deficiency_reserve_pdr_calculator';Inputs): number {
...
export function generateAnalysis(inputs: premium_deficiency_reserve_pdr_calculator';Inputs, metrics: premium_deficiency_reserve_pdr_calculator';Metrics): premium_deficiency_reserve_pdr_calculator';Analysis {
