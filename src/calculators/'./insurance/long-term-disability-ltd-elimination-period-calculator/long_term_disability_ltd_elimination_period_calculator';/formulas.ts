import { long_term_disability_ltd_elimination_period_calculator';Inputs, long_term_disability_ltd_elimination_period_calculator';Metrics, long_term_disability_ltd_elimination_period_calculator';Analysis } from './types';
...
export function calculateResult(inputs: long_term_disability_ltd_elimination_period_calculator';Inputs): number {
...
export function generateAnalysis(inputs: long_term_disability_ltd_elimination_period_calculator';Inputs, metrics: long_term_disability_ltd_elimination_period_calculator';Metrics): long_term_disability_ltd_elimination_period_calculator';Analysis {
