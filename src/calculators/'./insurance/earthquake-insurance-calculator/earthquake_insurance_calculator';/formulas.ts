import { earthquake_insurance_calculator';Inputs, earthquake_insurance_calculator';Metrics, earthquake_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: earthquake_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: earthquake_insurance_calculator';Inputs, metrics: earthquake_insurance_calculator';Metrics): earthquake_insurance_calculator';Analysis {
