import { earthquake-insurance-calculator';Inputs, earthquake-insurance-calculator';Metrics, earthquake-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: earthquake-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: earthquake-insurance-calculator';Inputs, metrics: earthquake-insurance-calculator';Metrics): earthquake-insurance-calculator';Analysis {
