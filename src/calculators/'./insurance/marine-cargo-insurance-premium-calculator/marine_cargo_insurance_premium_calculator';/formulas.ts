import { marine_cargo_insurance_premium_calculator';Inputs, marine_cargo_insurance_premium_calculator';Metrics, marine_cargo_insurance_premium_calculator';Analysis } from './types';
...
export function calculateResult(inputs: marine_cargo_insurance_premium_calculator';Inputs): number {
...
export function generateAnalysis(inputs: marine_cargo_insurance_premium_calculator';Inputs, metrics: marine_cargo_insurance_premium_calculator';Metrics): marine_cargo_insurance_premium_calculator';Analysis {
