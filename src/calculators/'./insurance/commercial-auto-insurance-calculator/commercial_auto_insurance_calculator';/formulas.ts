import { commercial_auto_insurance_calculator';Inputs, commercial_auto_insurance_calculator';Metrics, commercial_auto_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: commercial_auto_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: commercial_auto_insurance_calculator';Inputs, metrics: commercial_auto_insurance_calculator';Metrics): commercial_auto_insurance_calculator';Analysis {
