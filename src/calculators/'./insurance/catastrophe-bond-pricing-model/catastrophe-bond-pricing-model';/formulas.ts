import { catastrophe-bond-pricing-model';Inputs, catastrophe-bond-pricing-model';Metrics, catastrophe-bond-pricing-model';Analysis } from './types';
...
export function calculateResult(inputs: catastrophe-bond-pricing-model';Inputs): number {
...
export function generateAnalysis(inputs: catastrophe-bond-pricing-model';Inputs, metrics: catastrophe-bond-pricing-model';Metrics): catastrophe-bond-pricing-model';Analysis {
