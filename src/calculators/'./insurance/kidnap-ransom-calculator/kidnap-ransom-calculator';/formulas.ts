import { kidnap-ransom-calculator';Inputs, kidnap-ransom-calculator';Metrics, kidnap-ransom-calculator';Analysis } from './types';
...
export function calculateResult(inputs: kidnap-ransom-calculator';Inputs): number {
...
export function generateAnalysis(inputs: kidnap-ransom-calculator';Inputs, metrics: kidnap-ransom-calculator';Metrics): kidnap-ransom-calculator';Analysis {
