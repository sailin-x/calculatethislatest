import { home_insurance_calculator';Inputs, home_insurance_calculator';Metrics, home_insurance_calculator';Analysis } from './types';
...
export function calculateResult(inputs: home_insurance_calculator';Inputs): number {
...
export function generateAnalysis(inputs: home_insurance_calculator';Inputs, metrics: home_insurance_calculator';Metrics): home_insurance_calculator';Analysis {
