import { home-insurance-calculator';Inputs, home-insurance-calculator';Metrics, home-insurance-calculator';Analysis } from './types';
...
export function calculateResult(inputs: home-insurance-calculator';Inputs): number {
...
export function generateAnalysis(inputs: home-insurance-calculator';Inputs, metrics: home-insurance-calculator';Metrics): home-insurance-calculator';Analysis {
