import { marine-cargo-calculator';Inputs, marine-cargo-calculator';Metrics, marine-cargo-calculator';Analysis } from './types';
...
export function calculateResult(inputs: marine-cargo-calculator';Inputs): number {
...
export function generateAnalysis(inputs: marine-cargo-calculator';Inputs, metrics: marine-cargo-calculator';Metrics): marine-cargo-calculator';Analysis {
