import { brick_calculator';Inputs, brick_calculator';Metrics, brick_calculator';Analysis } from './types';
...
export function calculateResult(inputs: brick_calculator';Inputs): number {
...
export function generateAnalysis(inputs: brick_calculator';Inputs, metrics: brick_calculator';Metrics): brick_calculator';Analysis {
