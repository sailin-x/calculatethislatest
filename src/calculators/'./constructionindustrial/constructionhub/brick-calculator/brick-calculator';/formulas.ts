import { brick-calculator';Inputs, brick-calculator';Metrics, brick-calculator';Analysis } from './types';
...
export function calculateResult(inputs: brick-calculator';Inputs): number {
...
export function generateAnalysis(inputs: brick-calculator';Inputs, metrics: brick-calculator';Metrics): brick-calculator';Analysis {
