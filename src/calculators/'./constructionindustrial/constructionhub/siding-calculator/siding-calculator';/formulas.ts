import { siding-calculator';Inputs, siding-calculator';Metrics, siding-calculator';Analysis } from './types';
...
export function calculateResult(inputs: siding-calculator';Inputs): number {
...
export function generateAnalysis(inputs: siding-calculator';Inputs, metrics: siding-calculator';Metrics): siding-calculator';Analysis {
