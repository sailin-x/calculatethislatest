import { asphalt_calculator';Inputs, asphalt_calculator';Metrics, asphalt_calculator';Analysis } from './types';
...
export function calculateResult(inputs: asphalt_calculator';Inputs): number {
...
export function generateAnalysis(inputs: asphalt_calculator';Inputs, metrics: asphalt_calculator';Metrics): asphalt_calculator';Analysis {
