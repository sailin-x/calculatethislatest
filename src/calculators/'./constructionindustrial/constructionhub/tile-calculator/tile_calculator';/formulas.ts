import { tile_calculator';Inputs, tile_calculator';Metrics, tile_calculator';Analysis } from './types';
...
export function calculateResult(inputs: tile_calculator';Inputs): number {
...
export function generateAnalysis(inputs: tile_calculator';Inputs, metrics: tile_calculator';Metrics): tile_calculator';Analysis {
