import { tile-calculator';Inputs, tile-calculator';Metrics, tile-calculator';Analysis } from './types';
...
export function calculateResult(inputs: tile-calculator';Inputs): number {
...
export function generateAnalysis(inputs: tile-calculator';Inputs, metrics: tile-calculator';Metrics): tile-calculator';Analysis {
