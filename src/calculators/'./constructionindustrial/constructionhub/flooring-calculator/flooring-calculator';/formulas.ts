import { flooring-calculator';Inputs, flooring-calculator';Metrics, flooring-calculator';Analysis } from './types';
...
export function calculateResult(inputs: flooring-calculator';Inputs): number {
...
export function generateAnalysis(inputs: flooring-calculator';Inputs, metrics: flooring-calculator';Metrics): flooring-calculator';Analysis {
