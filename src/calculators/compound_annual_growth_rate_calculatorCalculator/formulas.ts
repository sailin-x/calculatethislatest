import { compound_annual_growth_rate_calculatorCalculatorInputs, compound_annual_growth_rate_calculatorCalculatorMetrics, compound_annual_growth_rate_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: compound_annual_growth_rate_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: compound_annual_growth_rate_calculatorCalculatorInputs, metrics: compound_annual_growth_rate_calculatorCalculatorMetrics): compound_annual_growth_rate_calculatorCalculatorAnalysis {
