import { swing_trading_calculatorInputs, swing_trading_calculatorMetrics, swing_trading_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: swing_trading_calculatorInputs): number {
...
export function generateAnalysis(inputs: swing_trading_calculatorInputs, metrics: swing_trading_calculatorMetrics): swing_trading_calculatorAnalysis {
