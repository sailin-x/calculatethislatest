import { registerDebtPayoffCalculatorInputs, registerDebtPayoffCalculatorMetrics, registerDebtPayoffCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerDebtPayoffCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerDebtPayoffCalculatorInputs, metrics: registerDebtPayoffCalculatorMetrics): registerDebtPayoffCalculatorAnalysis {
