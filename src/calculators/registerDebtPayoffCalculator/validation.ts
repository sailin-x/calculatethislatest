import { registerDebtPayoffCalculatorInputs } from './types';

export function validateInputs(inputs: registerDebtPayoffCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
