import { landscaping_cost_calculatorInputs } from './types';

export function validateInputs(inputs: landscaping_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
