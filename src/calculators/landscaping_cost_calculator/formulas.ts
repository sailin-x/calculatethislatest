import { landscaping_cost_calculatorInputs, landscaping_cost_calculatorMetrics, landscaping_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: landscaping_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: landscaping_cost_calculatorInputs, metrics: landscaping_cost_calculatorMetrics): landscaping_cost_calculatorAnalysis {
