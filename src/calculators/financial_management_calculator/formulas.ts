import { financial_management_calculatorInputs, financial_management_calculatorMetrics, financial_management_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_management_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_management_calculatorInputs, metrics: financial_management_calculatorMetrics): financial_management_calculatorAnalysis {
