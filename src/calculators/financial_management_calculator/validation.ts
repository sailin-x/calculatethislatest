import { financial_management_calculatorInputs } from './types';

export function validateInputs(inputs: financial_management_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
