import { chiropractic_care_cost_calculatorCalculatorInputs, chiropractic_care_cost_calculatorCalculatorMetrics, chiropractic_care_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: chiropractic_care_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: chiropractic_care_cost_calculatorCalculatorInputs, metrics: chiropractic_care_cost_calculatorCalculatorMetrics): chiropractic_care_cost_calculatorCalculatorAnalysis {
