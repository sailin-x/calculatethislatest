import { rights_offering_calculatorInputs, rights_offering_calculatorMetrics, rights_offering_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: rights_offering_calculatorInputs): number {
...
export function generateAnalysis(inputs: rights_offering_calculatorInputs, metrics: rights_offering_calculatorMetrics): rights_offering_calculatorAnalysis {
