import { massage_therapy_cost_calculatorCalculatorInputs, massage_therapy_cost_calculatorCalculatorMetrics, massage_therapy_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: massage_therapy_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: massage_therapy_cost_calculatorCalculatorInputs, metrics: massage_therapy_cost_calculatorCalculatorMetrics): massage_therapy_cost_calculatorCalculatorAnalysis {
