import { credit_card_payoff_calculatorInputs, credit_card_payoff_calculatorMetrics, credit_card_payoff_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: credit_card_payoff_calculatorInputs): number {
...
export function generateAnalysis(inputs: credit_card_payoff_calculatorInputs, metrics: credit_card_payoff_calculatorMetrics): credit_card_payoff_calculatorAnalysis {
