import { credit_card_payoff_calculatorInputs } from './types';

export function validateInputs(inputs: credit_card_payoff_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
