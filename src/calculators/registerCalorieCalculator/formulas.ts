import { registerCalorieCalculatorInputs, registerCalorieCalculatorMetrics, registerCalorieCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerCalorieCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerCalorieCalculatorInputs, metrics: registerCalorieCalculatorMetrics): registerCalorieCalculatorAnalysis {
