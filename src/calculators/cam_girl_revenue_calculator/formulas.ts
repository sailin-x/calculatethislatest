import { cam_girl_revenue_calculatorInputs, cam_girl_revenue_calculatorMetrics, cam_girl_revenue_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cam_girl_revenue_calculatorInputs): number {
...
export function generateAnalysis(inputs: cam_girl_revenue_calculatorInputs, metrics: cam_girl_revenue_calculatorMetrics): cam_girl_revenue_calculatorAnalysis {
