import { body_adiposity_index_bai_calculatorInputs, body_adiposity_index_bai_calculatorMetrics, body_adiposity_index_bai_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: body_adiposity_index_bai_calculatorInputs): number {
...
export function generateAnalysis(inputs: body_adiposity_index_bai_calculatorInputs, metrics: body_adiposity_index_bai_calculatorMetrics): body_adiposity_index_bai_calculatorAnalysis {
