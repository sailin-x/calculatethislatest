import { sortino_ratio_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: sortino_ratio_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
