import { sortino_ratio_calculatorCalculatorInputs, sortino_ratio_calculatorCalculatorMetrics, sortino_ratio_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: sortino_ratio_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: sortino_ratio_calculatorCalculatorInputs, metrics: sortino_ratio_calculatorCalculatorMetrics): sortino_ratio_calculatorCalculatorAnalysis {
