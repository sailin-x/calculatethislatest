import { registerDtiRatioCalculatorInputs } from './types';

export function validateInputs(inputs: registerDtiRatioCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
