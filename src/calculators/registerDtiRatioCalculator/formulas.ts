import { registerDtiRatioCalculatorInputs, registerDtiRatioCalculatorMetrics, registerDtiRatioCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerDtiRatioCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerDtiRatioCalculatorInputs, metrics: registerDtiRatioCalculatorMetrics): registerDtiRatioCalculatorAnalysis {
