import { digital_transformation_business_case_calculatorInputs, digital_transformation_business_case_calculatorMetrics, digital_transformation_business_case_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: digital_transformation_business_case_calculatorInputs): number {
...
export function generateAnalysis(inputs: digital_transformation_business_case_calculatorInputs, metrics: digital_transformation_business_case_calculatorMetrics): digital_transformation_business_case_calculatorAnalysis {
