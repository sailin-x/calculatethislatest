import { term_vs_universal_life_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: term_vs_universal_life_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
