import { private_equity_returns_calculatorInputs, private_equity_returns_calculatorMetrics, private_equity_returns_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: private_equity_returns_calculatorInputs): number {
...
export function generateAnalysis(inputs: private_equity_returns_calculatorInputs, metrics: private_equity_returns_calculatorMetrics): private_equity_returns_calculatorAnalysis {
