import { scientific_calculatorInputs, scientific_calculatorMetrics, scientific_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: scientific_calculatorInputs): number {
...
export function generateAnalysis(inputs: scientific_calculatorInputs, metrics: scientific_calculatorMetrics): scientific_calculatorAnalysis {
