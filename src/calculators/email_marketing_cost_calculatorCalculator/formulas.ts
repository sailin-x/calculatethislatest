import { email_marketing_cost_calculatorCalculatorInputs, email_marketing_cost_calculatorCalculatorMetrics, email_marketing_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: email_marketing_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: email_marketing_cost_calculatorCalculatorInputs, metrics: email_marketing_cost_calculatorCalculatorMetrics): email_marketing_cost_calculatorCalculatorAnalysis {
