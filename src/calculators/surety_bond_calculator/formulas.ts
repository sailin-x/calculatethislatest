import { surety_bond_calculatorInputs, surety_bond_calculatorMetrics, surety_bond_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: surety_bond_calculatorInputs): number {
...
export function generateAnalysis(inputs: surety_bond_calculatorInputs, metrics: surety_bond_calculatorMetrics): surety_bond_calculatorAnalysis {
