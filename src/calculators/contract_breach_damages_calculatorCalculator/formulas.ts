import { contract_breach_damages_calculatorCalculatorInputs, contract_breach_damages_calculatorCalculatorMetrics, contract_breach_damages_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: contract_breach_damages_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: contract_breach_damages_calculatorCalculatorInputs, metrics: contract_breach_damages_calculatorCalculatorMetrics): contract_breach_damages_calculatorCalculatorAnalysis {
