import { spotify_royalty_calculatorInputs, spotify_royalty_calculatorMetrics, spotify_royalty_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: spotify_royalty_calculatorInputs): number {
...
export function generateAnalysis(inputs: spotify_royalty_calculatorInputs, metrics: spotify_royalty_calculatorMetrics): spotify_royalty_calculatorAnalysis {
