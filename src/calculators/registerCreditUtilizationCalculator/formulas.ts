import { registerCreditUtilizationCalculatorInputs, registerCreditUtilizationCalculatorMetrics, registerCreditUtilizationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerCreditUtilizationCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerCreditUtilizationCalculatorInputs, metrics: registerCreditUtilizationCalculatorMetrics): registerCreditUtilizationCalculatorAnalysis {
