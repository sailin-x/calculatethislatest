import { registerCreditUtilizationCalculatorInputs } from './types';

export function validateInputs(inputs: registerCreditUtilizationCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
