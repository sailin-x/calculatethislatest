import { event_sponsorship_tier_valuation_calculatorInputs, event_sponsorship_tier_valuation_calculatorMetrics, event_sponsorship_tier_valuation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: event_sponsorship_tier_valuation_calculatorInputs): number {
...
export function generateAnalysis(inputs: event_sponsorship_tier_valuation_calculatorInputs, metrics: event_sponsorship_tier_valuation_calculatorMetrics): event_sponsorship_tier_valuation_calculatorAnalysis {
