import { registerExpectedShortfallCalculatorInputs } from './types';

export function validateInputs(inputs: registerExpectedShortfallCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
