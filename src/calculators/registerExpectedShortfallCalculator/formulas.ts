import { registerExpectedShortfallCalculatorInputs, registerExpectedShortfallCalculatorMetrics, registerExpectedShortfallCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerExpectedShortfallCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerExpectedShortfallCalculatorInputs, metrics: registerExpectedShortfallCalculatorMetrics): registerExpectedShortfallCalculatorAnalysis {
