import { celebrity_endorsement_calculatorInputs, celebrity_endorsement_calculatorMetrics, celebrity_endorsement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: celebrity_endorsement_calculatorInputs): number {
...
export function generateAnalysis(inputs: celebrity_endorsement_calculatorInputs, metrics: celebrity_endorsement_calculatorMetrics): celebrity_endorsement_calculatorAnalysis {
