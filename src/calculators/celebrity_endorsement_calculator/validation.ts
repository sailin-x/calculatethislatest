import { celebrity_endorsement_calculatorInputs } from './types';

export function validateInputs(inputs: celebrity_endorsement_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
