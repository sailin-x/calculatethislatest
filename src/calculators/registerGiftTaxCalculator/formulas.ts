import { registerGiftTaxCalculatorInputs, registerGiftTaxCalculatorMetrics, registerGiftTaxCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerGiftTaxCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerGiftTaxCalculatorInputs, metrics: registerGiftTaxCalculatorMetrics): registerGiftTaxCalculatorAnalysis {
