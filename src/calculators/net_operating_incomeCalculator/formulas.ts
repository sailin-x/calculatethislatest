import { net_operating_incomeCalculatorInputs, net_operating_incomeCalculatorMetrics, net_operating_incomeCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: net_operating_incomeCalculatorInputs): number {
...
export function generateAnalysis(inputs: net_operating_incomeCalculatorInputs, metrics: net_operating_incomeCalculatorMetrics): net_operating_incomeCalculatorAnalysis {
