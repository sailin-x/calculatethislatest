import { net_operating_incomeCalculatorInputs } from './types';

export function validateInputs(inputs: net_operating_incomeCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
