import { networking_calculatorCalculatorInputs, networking_calculatorCalculatorMetrics, networking_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: networking_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: networking_calculatorCalculatorInputs, metrics: networking_calculatorCalculatorMetrics): networking_calculatorCalculatorAnalysis {
