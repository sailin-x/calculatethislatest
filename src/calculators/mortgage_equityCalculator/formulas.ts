import { mortgage_equityCalculatorInputs, mortgage_equityCalculatorMetrics, mortgage_equityCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgage_equityCalculatorInputs): number {
...
export function generateAnalysis(inputs: mortgage_equityCalculatorInputs, metrics: mortgage_equityCalculatorMetrics): mortgage_equityCalculatorAnalysis {
