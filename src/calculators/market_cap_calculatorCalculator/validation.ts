import { market_cap_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: market_cap_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
