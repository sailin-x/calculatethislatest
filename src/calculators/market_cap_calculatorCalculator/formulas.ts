import { market_cap_calculatorCalculatorInputs, market_cap_calculatorCalculatorMetrics, market_cap_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: market_cap_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: market_cap_calculatorCalculatorInputs, metrics: market_cap_calculatorCalculatorMetrics): market_cap_calculatorCalculatorAnalysis {
