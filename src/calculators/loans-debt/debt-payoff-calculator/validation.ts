import { DebtPayoffCalculatorInputs } from './types';

export function validateDebtPayoffCalculatorInputs(inputs: DebtPayoffCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDebtPayoffCalculatorBusinessRules(inputs: DebtPayoffCalculatorInputs): Array<{ field: string; message: string }> {
