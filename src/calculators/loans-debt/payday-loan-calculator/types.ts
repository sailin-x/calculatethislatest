export interface PaydayLoanCalculatorInputs {
...
export interface PaydayLoanCalculatorOutputs {
...
export interface PaydayLoanCalculatorMetrics {
...
export interface PaydayLoanCalculatorAnalysis {
