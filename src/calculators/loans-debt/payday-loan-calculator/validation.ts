...
export function validatePaydayLoanCalculatorInputs(inputs: PaydayLoanCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePaydayLoanCalculatorBusinessRules(inputs: PaydayLoanCalculatorInputs): Array<{ field: string; message: string }> {
