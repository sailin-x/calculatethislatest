...
export function validateLoanCalculatorInputs(inputs: LoanCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateLoanCalculatorBusinessRules(inputs: LoanCalculatorInputs): Array<{ field: string; message: string }> {
