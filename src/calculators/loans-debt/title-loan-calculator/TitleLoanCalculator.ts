...
import { validateTitleLoanCalculatorInputs, validateTitleLoanCalculatorBusinessRules } from './validation';

export const TitleLoanCalculatorCalculator: Calculator: Calculator = {
  id: 'title-loan-calculator-calculator',
