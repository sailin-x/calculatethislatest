...
export function validateTitleLoanCalculatorInputs(inputs: TitleLoanCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTitleLoanCalculatorBusinessRules(inputs: TitleLoanCalculatorInputs): Array<{ field: string; message: string }> {
