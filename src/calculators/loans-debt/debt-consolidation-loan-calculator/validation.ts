...
export function validateDebtConsolidationLoanCalculatorInputs(inputs: DebtConsolidationLoanCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateDebtConsolidationLoanCalculatorBusinessRules(inputs: DebtConsolidationLoanCalculatorInputs): Array<{ field: string; message: string }> {
