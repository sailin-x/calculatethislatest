...
export function validateLoanComparisonCalculatorInputs(inputs: LoanComparisonCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateLoanComparisonCalculatorBusinessRules(inputs: LoanComparisonCalculatorInputs): Array<{ field: string; message: string }> {
