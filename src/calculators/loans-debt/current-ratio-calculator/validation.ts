import { CurrentRatioCalculatorInputs } from './types';

export function validateCurrentRatioCalculatorInputs(inputs: CurrentRatioCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCurrentRatioCalculatorBusinessRules(inputs: CurrentRatioCalculatorInputs): Array<{ field: string; message: string }> {
