...
export function validateCarLoanCalculatorInputs(inputs: CarLoanCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCarLoanCalculatorBusinessRules(inputs: CarLoanCalculatorInputs): Array<{ field: string; message: string }> {
