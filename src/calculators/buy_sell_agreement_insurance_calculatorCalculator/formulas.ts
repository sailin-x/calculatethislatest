import { buy_sell_agreement_insurance_calculatorCalculatorInputs, buy_sell_agreement_insurance_calculatorCalculatorMetrics, buy_sell_agreement_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: buy_sell_agreement_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: buy_sell_agreement_insurance_calculatorCalculatorInputs, metrics: buy_sell_agreement_insurance_calculatorCalculatorMetrics): buy_sell_agreement_insurance_calculatorCalculatorAnalysis {
