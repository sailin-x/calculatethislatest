import { cost_of_poor_quality_calculatorCalculatorInputs, cost_of_poor_quality_calculatorCalculatorMetrics, cost_of_poor_quality_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cost_of_poor_quality_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cost_of_poor_quality_calculatorCalculatorInputs, metrics: cost_of_poor_quality_calculatorCalculatorMetrics): cost_of_poor_quality_calculatorCalculatorAnalysis {
