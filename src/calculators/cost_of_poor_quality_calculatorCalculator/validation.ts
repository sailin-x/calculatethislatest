import { cost_of_poor_quality_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: cost_of_poor_quality_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
