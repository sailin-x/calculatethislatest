import { keto_calculatorCalculatorInputs, keto_calculatorCalculatorMetrics, keto_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: keto_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: keto_calculatorCalculatorInputs, metrics: keto_calculatorCalculatorMetrics): keto_calculatorCalculatorAnalysis {
