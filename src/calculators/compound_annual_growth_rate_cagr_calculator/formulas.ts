import { compound_annual_growth_rate_cagr_calculatorInputs, compound_annual_growth_rate_cagr_calculatorMetrics, compound_annual_growth_rate_cagr_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: compound_annual_growth_rate_cagr_calculatorInputs): number {
...
export function generateAnalysis(inputs: compound_annual_growth_rate_cagr_calculatorInputs, metrics: compound_annual_growth_rate_cagr_calculatorMetrics): compound_annual_growth_rate_cagr_calculatorAnalysis {
