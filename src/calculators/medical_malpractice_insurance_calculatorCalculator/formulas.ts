import { medical_malpractice_insurance_calculatorCalculatorInputs, medical_malpractice_insurance_calculatorCalculatorMetrics, medical_malpractice_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: medical_malpractice_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: medical_malpractice_insurance_calculatorCalculatorInputs, metrics: medical_malpractice_insurance_calculatorCalculatorMetrics): medical_malpractice_insurance_calculatorCalculatorAnalysis {
