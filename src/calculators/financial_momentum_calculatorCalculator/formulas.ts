import { financial_momentum_calculatorCalculatorInputs, financial_momentum_calculatorCalculatorMetrics, financial_momentum_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_momentum_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_momentum_calculatorCalculatorInputs, metrics: financial_momentum_calculatorCalculatorMetrics): financial_momentum_calculatorCalculatorAnalysis {
