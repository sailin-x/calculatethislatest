import { pressure_washing_cost_calculatorCalculatorInputs, pressure_washing_cost_calculatorCalculatorMetrics, pressure_washing_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: pressure_washing_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: pressure_washing_cost_calculatorCalculatorInputs, metrics: pressure_washing_cost_calculatorCalculatorMetrics): pressure_washing_cost_calculatorCalculatorAnalysis {
