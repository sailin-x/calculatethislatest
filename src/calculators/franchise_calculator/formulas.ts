import { franchise_calculatorInputs, franchise_calculatorMetrics, franchise_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: franchise_calculatorInputs): number {
...
export function generateAnalysis(inputs: franchise_calculatorInputs, metrics: franchise_calculatorMetrics): franchise_calculatorAnalysis {
