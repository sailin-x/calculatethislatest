import { financial_intelligence_calculatorInputs, financial_intelligence_calculatorMetrics, financial_intelligence_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_intelligence_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_intelligence_calculatorInputs, metrics: financial_intelligence_calculatorMetrics): financial_intelligence_calculatorAnalysis {
