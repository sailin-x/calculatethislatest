import { financial_intelligence_calculatorInputs } from './types';

export function validateInputs(inputs: financial_intelligence_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
