import { life_insurance_needs_calculatorCalculatorInputs, life_insurance_needs_calculatorCalculatorMetrics, life_insurance_needs_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: life_insurance_needs_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: life_insurance_needs_calculatorCalculatorInputs, metrics: life_insurance_needs_calculatorCalculatorMetrics): life_insurance_needs_calculatorCalculatorAnalysis {
