import { life_insurance_needs_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: life_insurance_needs_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
