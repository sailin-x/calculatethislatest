import { skewness_calculatorInputs, skewness_calculatorMetrics, skewness_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: skewness_calculatorInputs): number {
...
export function generateAnalysis(inputs: skewness_calculatorInputs, metrics: skewness_calculatorMetrics): skewness_calculatorAnalysis {
