import { hobbies_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: hobbies_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
