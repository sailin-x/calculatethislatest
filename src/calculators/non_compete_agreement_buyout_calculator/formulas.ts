import { non_compete_agreement_buyout_calculatorInputs, non_compete_agreement_buyout_calculatorMetrics, non_compete_agreement_buyout_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: non_compete_agreement_buyout_calculatorInputs): number {
...
export function generateAnalysis(inputs: non_compete_agreement_buyout_calculatorInputs, metrics: non_compete_agreement_buyout_calculatorMetrics): non_compete_agreement_buyout_calculatorAnalysis {
