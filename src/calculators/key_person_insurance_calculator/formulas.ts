import { key_person_insurance_calculatorInputs, key_person_insurance_calculatorMetrics, key_person_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: key_person_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: key_person_insurance_calculatorInputs, metrics: key_person_insurance_calculatorMetrics): key_person_insurance_calculatorAnalysis {
