import { bariatric_surgery_cost_savings_calculatorInputs, bariatric_surgery_cost_savings_calculatorMetrics, bariatric_surgery_cost_savings_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: bariatric_surgery_cost_savings_calculatorInputs): number {
...
export function generateAnalysis(inputs: bariatric_surgery_cost_savings_calculatorInputs, metrics: bariatric_surgery_cost_savings_calculatorMetrics): bariatric_surgery_cost_savings_calculatorAnalysis {
