import { return_on_ad_spend_roas_calculatorInputs, return_on_ad_spend_roas_calculatorMetrics, return_on_ad_spend_roas_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: return_on_ad_spend_roas_calculatorInputs): number {
...
export function generateAnalysis(inputs: return_on_ad_spend_roas_calculatorInputs, metrics: return_on_ad_spend_roas_calculatorMetrics): return_on_ad_spend_roas_calculatorAnalysis {
