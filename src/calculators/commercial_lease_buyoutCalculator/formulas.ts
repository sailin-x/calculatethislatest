import { commercial_lease_buyoutCalculatorInputs, commercial_lease_buyoutCalculatorMetrics, commercial_lease_buyoutCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: commercial_lease_buyoutCalculatorInputs): number {
...
export function generateAnalysis(inputs: commercial_lease_buyoutCalculatorInputs, metrics: commercial_lease_buyoutCalculatorMetrics): commercial_lease_buyoutCalculatorAnalysis {
