import { commercial_lease_buyoutCalculatorInputs } from './types';

export function validateInputs(inputs: commercial_lease_buyoutCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
