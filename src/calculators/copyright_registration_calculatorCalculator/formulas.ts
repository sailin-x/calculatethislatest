import { copyright_registration_calculatorCalculatorInputs, copyright_registration_calculatorCalculatorMetrics, copyright_registration_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: copyright_registration_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: copyright_registration_calculatorCalculatorInputs, metrics: copyright_registration_calculatorCalculatorMetrics): copyright_registration_calculatorCalculatorAnalysis {
