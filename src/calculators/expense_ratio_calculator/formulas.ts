import { expense_ratio_calculatorInputs, expense_ratio_calculatorMetrics, expense_ratio_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: expense_ratio_calculatorInputs): number {
...
export function generateAnalysis(inputs: expense_ratio_calculatorInputs, metrics: expense_ratio_calculatorMetrics): expense_ratio_calculatorAnalysis {
