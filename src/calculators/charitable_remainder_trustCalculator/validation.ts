import { charitable_remainder_trustCalculatorInputs } from './types';

export function validateInputs(inputs: charitable_remainder_trustCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
