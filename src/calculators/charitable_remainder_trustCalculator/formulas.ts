import { charitable_remainder_trustCalculatorInputs, charitable_remainder_trustCalculatorMetrics, charitable_remainder_trustCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: charitable_remainder_trustCalculatorInputs): number {
...
export function generateAnalysis(inputs: charitable_remainder_trustCalculatorInputs, metrics: charitable_remainder_trustCalculatorMetrics): charitable_remainder_trustCalculatorAnalysis {
