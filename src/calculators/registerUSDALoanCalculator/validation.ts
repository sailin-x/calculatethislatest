import { registerUSDALoanCalculatorInputs } from './types';

export function validateInputs(inputs: registerUSDALoanCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
