import { registerUSDALoanCalculatorInputs, registerUSDALoanCalculatorMetrics, registerUSDALoanCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerUSDALoanCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerUSDALoanCalculatorInputs, metrics: registerUSDALoanCalculatorMetrics): registerUSDALoanCalculatorAnalysis {
