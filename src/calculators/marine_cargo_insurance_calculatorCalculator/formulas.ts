import { marine_cargo_insurance_calculatorCalculatorInputs, marine_cargo_insurance_calculatorCalculatorMetrics, marine_cargo_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: marine_cargo_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: marine_cargo_insurance_calculatorCalculatorInputs, metrics: marine_cargo_insurance_calculatorCalculatorMetrics): marine_cargo_insurance_calculatorCalculatorAnalysis {
