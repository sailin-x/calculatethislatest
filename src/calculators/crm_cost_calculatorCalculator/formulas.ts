import { crm_cost_calculatorCalculatorInputs, crm_cost_calculatorCalculatorMetrics, crm_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: crm_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: crm_cost_calculatorCalculatorInputs, metrics: crm_cost_calculatorCalculatorMetrics): crm_cost_calculatorCalculatorAnalysis {
