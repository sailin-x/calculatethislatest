import { financial_independence_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: financial_independence_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
