import { financial_independence_calculatorCalculatorInputs, financial_independence_calculatorCalculatorMetrics, financial_independence_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_independence_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_independence_calculatorCalculatorInputs, metrics: financial_independence_calculatorCalculatorMetrics): financial_independence_calculatorCalculatorAnalysis {
