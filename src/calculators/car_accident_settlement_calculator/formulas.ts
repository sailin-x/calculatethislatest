import { car_accident_settlement_calculatorInputs, car_accident_settlement_calculatorMetrics, car_accident_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: car_accident_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: car_accident_settlement_calculatorInputs, metrics: car_accident_settlement_calculatorMetrics): car_accident_settlement_calculatorAnalysis {
