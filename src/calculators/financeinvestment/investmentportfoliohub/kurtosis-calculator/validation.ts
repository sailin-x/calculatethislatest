import { kurtosis_calculatorInputs } from './types';
...
export function validatekurtosis_calculatorInputs(inputs: kurtosis_calculatorInputs): ValidationResult[] {
...
export function validatekurtosis_calculatorBusinessRules(inputs: kurtosis_calculatorInputs): ValidationResult[] {
