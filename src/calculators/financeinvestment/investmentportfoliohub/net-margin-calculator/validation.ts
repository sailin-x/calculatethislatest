import { net_margin_calculatorInputs } from './types';
...
export function validatenet_margin_calculatorInputs(inputs: net_margin_calculatorInputs): ValidationResult[] {
...
export function validatenet_margin_calculatorBusinessRules(inputs: net_margin_calculatorInputs): ValidationResult[] {
