import { net-margin-calculatorInputs, net-margin-calculatorMetrics, net-margin-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: net-margin-calculatorInputs): number {
...
export function generateAnalysis(inputs: net-margin-calculatorInputs, metrics: net-margin-calculatorMetrics): net-margin-calculatorAnalysis {
