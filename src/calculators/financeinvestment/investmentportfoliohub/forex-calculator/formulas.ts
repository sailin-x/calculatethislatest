import { forex-calculatorInputs, forex-calculatorMetrics, forex-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: forex-calculatorInputs): number {
...
export function generateAnalysis(inputs: forex-calculatorInputs, metrics: forex-calculatorMetrics): forex-calculatorAnalysis {
