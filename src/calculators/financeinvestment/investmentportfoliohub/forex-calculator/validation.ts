import { forex_calculatorInputs } from './types';
...
export function validateforex_calculatorInputs(inputs: forex_calculatorInputs): ValidationResult[] {
...
export function validateforex_calculatorBusinessRules(inputs: forex_calculatorInputs): ValidationResult[] {
