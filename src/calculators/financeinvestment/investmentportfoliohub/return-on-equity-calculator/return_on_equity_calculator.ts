...
export const ReturnOnEquity-calculator: Calculator = {
  ...
  description: 'Calculate Return on Equity Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Return on Equity Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Return on Equity Calculator calculation',
