...
export function validatereturn_on_equity_calculatorInputs(inputs: return_on_equity_calculatorInputs): ValidationResult[] {
...
export function validatereturn_on_equity_calculatorBusinessRules(inputs: return_on_equity_calculatorInputs): ValidationResult[] {
