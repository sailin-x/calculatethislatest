import { options_valuation_calculatorInputs } from './types';
...
export function validateoptions_valuation_calculatorInputs(inputs: options_valuation_calculatorInputs): ValidationResult[] {
...
export function validateoptions_valuation_calculatorBusinessRules(inputs: options_valuation_calculatorInputs): ValidationResult[] {
