import { cost_of_equity_calculatorInputs } from './types';
...
export function validatecost_of_equity_calculatorInputs(inputs: cost_of_equity_calculatorInputs): ValidationResult[] {
...
export function validatecost_of_equity_calculatorBusinessRules(inputs: cost_of_equity_calculatorInputs): ValidationResult[] {
