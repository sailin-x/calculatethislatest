import { peer-to-peer-lending-calculatorInputs, peer-to-peer-lending-calculatorMetrics, peer-to-peer-lending-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: peer-to-peer-lending-calculatorInputs): number {
...
export function generateAnalysis(inputs: peer-to-peer-lending-calculatorInputs, metrics: peer-to-peer-lending-calculatorMetrics): peer-to-peer-lending-calculatorAnalysis {
