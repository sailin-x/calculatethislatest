import { reit_dividend_calculatorInputs } from './types';
...
export function validatereit_dividend_calculatorInputs(inputs: reit_dividend_calculatorInputs): ValidationResult[] {
...
export function validatereit_dividend_calculatorBusinessRules(inputs: reit_dividend_calculatorInputs): ValidationResult[] {
