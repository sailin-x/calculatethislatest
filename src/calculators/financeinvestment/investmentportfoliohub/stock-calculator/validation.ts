import { stock_calculatorInputs } from './types';
...
export function validatestock_calculatorInputs(inputs: stock_calculatorInputs): ValidationResult[] {
...
export function validatestock_calculatorBusinessRules(inputs: stock_calculatorInputs): ValidationResult[] {
