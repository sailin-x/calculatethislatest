import { stock-calculatorInputs, stock-calculatorMetrics, stock-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: stock-calculatorInputs): number {
...
export function generateAnalysis(inputs: stock-calculatorInputs, metrics: stock-calculatorMetrics): stock-calculatorAnalysis {
