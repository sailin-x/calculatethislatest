import { ConvertibleBondPricing-calculatorInputs, ConvertibleBondPricing-calculatorMetrics, ConvertibleBondPricing-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ConvertibleBondPricing-calculatorInputs): number {
...
export function generateAnalysis(inputs: ConvertibleBondPricing-calculatorInputs, metrics: ConvertibleBondPricing-calculatorMetrics): ConvertibleBondPricing-calculatorAnalysis {
