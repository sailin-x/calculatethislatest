import { convertible-bond-pricing-calculatorInputs, convertible-bond-pricing-calculatorMetrics, convertible-bond-pricing-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: convertible-bond-pricing-calculatorInputs): number {
...
export function generateAnalysis(inputs: convertible-bond-pricing-calculatorInputs, metrics: convertible-bond-pricing-calculatorMetrics): convertible-bond-pricing-calculatorAnalysis {
