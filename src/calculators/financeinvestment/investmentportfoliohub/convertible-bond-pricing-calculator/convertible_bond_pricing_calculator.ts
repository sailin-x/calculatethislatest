...
export const convertible_bond_pricing_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Convertible Bond Pricing Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Convertible Bond Pricing Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Convertible Bond Pricing Calculator calculation',
