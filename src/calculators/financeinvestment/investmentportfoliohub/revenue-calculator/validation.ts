import { revenue_calculatorInputs } from './types';
...
export function validaterevenue_calculatorInputs(inputs: revenue_calculatorInputs): ValidationResult[] {
...
export function validaterevenue_calculatorBusinessRules(inputs: revenue_calculatorInputs): ValidationResult[] {
