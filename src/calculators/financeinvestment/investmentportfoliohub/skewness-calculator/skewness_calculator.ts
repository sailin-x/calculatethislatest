...
export const skewness_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Skewness Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Skewness Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Skewness Calculator calculation',
