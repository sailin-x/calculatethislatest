import { skewness_calculatorInputs } from './types';
...
export function validateskewness_calculatorInputs(inputs: skewness_calculatorInputs): ValidationResult[] {
...
export function validateskewness_calculatorBusinessRules(inputs: skewness_calculatorInputs): ValidationResult[] {
