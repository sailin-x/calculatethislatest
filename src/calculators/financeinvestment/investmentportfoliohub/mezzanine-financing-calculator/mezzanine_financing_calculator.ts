...
export const MezzanineFinancingCalculator: Calculator = {
  ...
  description: 'Calculate Mezzanine Financing Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Mezzanine Financing Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Mezzanine Financing Calculator calculation',
