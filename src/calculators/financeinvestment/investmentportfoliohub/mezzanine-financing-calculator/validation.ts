import { mezzanine_financing_calculatorInputs } from './types';
...
export function validatemezzanine_financing_calculatorInputs(inputs: mezzanine_financing_calculatorInputs): ValidationResult[] {
...
export function validatemezzanine_financing_calculatorBusinessRules(inputs: mezzanine_financing_calculatorInputs): ValidationResult[] {
