import { futures_calculatorInputs } from './types';
...
export function validatefutures_calculatorInputs(inputs: futures_calculatorInputs): ValidationResult[] {
...
export function validatefutures_calculatorBusinessRules(inputs: futures_calculatorInputs): ValidationResult[] {
