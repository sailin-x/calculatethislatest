import { futures-calculatorInputs, futures-calculatorMetrics, futures-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: futures-calculatorInputs): number {
...
export function generateAnalysis(inputs: futures-calculatorInputs, metrics: futures-calculatorMetrics): futures-calculatorAnalysis {
