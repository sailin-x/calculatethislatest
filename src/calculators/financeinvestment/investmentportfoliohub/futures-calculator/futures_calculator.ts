...
export const futures-calculator: Calculator = {
  ...
  description: 'Calculate Futures Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Futures Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Futures Calculator calculation',
