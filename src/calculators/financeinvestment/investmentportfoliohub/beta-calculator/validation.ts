import { beta_calculatorInputs } from './types';
...
export function validatebeta_calculatorInputs(inputs: beta_calculatorInputs): ValidationResult[] {
...
export function validatebeta_calculatorBusinessRules(inputs: beta_calculatorInputs): ValidationResult[] {
