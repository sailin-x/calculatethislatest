import { return_on_assets_calculatorInputs } from './types';
...
export function validatereturn_on_assets_calculatorInputs(inputs: return_on_assets_calculatorInputs): ValidationResult[] {
...
export function validatereturn_on_assets_calculatorBusinessRules(inputs: return_on_assets_calculatorInputs): ValidationResult[] {
