import { ReturnOnAssets-calculatorInputs, ReturnOnAssets-calculatorMetrics, ReturnOnAssets-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ReturnOnAssets-calculatorInputs): number {
...
export function generateAnalysis(inputs: ReturnOnAssets-calculatorInputs, metrics: ReturnOnAssets-calculatorMetrics): ReturnOnAssets-calculatorAnalysis {
