...
export const OptionsTradingCalculator: Calculator = {
  ...
  description: 'Calculate Options Trading Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Options Trading Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Options Trading Calculator calculation',
