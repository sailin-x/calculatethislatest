import { options_trading_calculatorInputs } from './types';
...
export function validateoptions_trading_calculatorInputs(inputs: options_trading_calculatorInputs): ValidationResult[] {
...
export function validateoptions_trading_calculatorBusinessRules(inputs: options_trading_calculatorInputs): ValidationResult[] {
