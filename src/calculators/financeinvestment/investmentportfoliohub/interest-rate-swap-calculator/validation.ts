import { interest_rate_swap_calculatorInputs } from './types';
...
export function validateinterest_rate_swap_calculatorInputs(inputs: interest_rate_swap_calculatorInputs): ValidationResult[] {
...
export function validateinterest_rate_swap_calculatorBusinessRules(inputs: interest_rate_swap_calculatorInputs): ValidationResult[] {
