...
export const interest_rate_swap_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Interest Rate Swap Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Interest Rate Swap Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Interest Rate Swap Calculator calculation',
