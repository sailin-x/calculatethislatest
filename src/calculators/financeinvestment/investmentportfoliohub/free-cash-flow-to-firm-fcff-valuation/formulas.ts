import { free-cash-flow-to-firm-fcff-valuationInputs, free-cash-flow-to-firm-fcff-valuationMetrics, free-cash-flow-to-firm-fcff-valuationAnalysis } from './types';
...
export function calculateResult(inputs: free-cash-flow-to-firm-fcff-valuationInputs): number {
...
export function generateAnalysis(inputs: free-cash-flow-to-firm-fcff-valuationInputs, metrics: free-cash-flow-to-firm-fcff-valuationMetrics): free-cash-flow-to-firm-fcff-valuationAnalysis {
