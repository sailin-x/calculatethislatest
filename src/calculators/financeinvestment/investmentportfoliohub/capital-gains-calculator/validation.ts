import { capital_gains_calculatorInputs } from './types';
...
export function validatecapital_gains_calculatorInputs(inputs: capital_gains_calculatorInputs): ValidationResult[] {
...
export function validatecapital_gains_calculatorBusinessRules(inputs: capital_gains_calculatorInputs): ValidationResult[] {
