import { variance-calculatorInputs, variance-calculatorMetrics, variance-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: variance-calculatorInputs): number {
...
export function generateAnalysis(inputs: variance-calculatorInputs, metrics: variance-calculatorMetrics): variance-calculatorAnalysis {
