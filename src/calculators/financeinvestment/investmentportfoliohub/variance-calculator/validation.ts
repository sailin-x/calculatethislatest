import { variance_calculatorInputs } from './types';
...
export function validatevariance_calculatorInputs(inputs: variance_calculatorInputs): ValidationResult[] {
...
export function validatevariance_calculatorBusinessRules(inputs: variance_calculatorInputs): ValidationResult[] {
