...
export const variance-calculator: Calculator = {
  ...
  description: 'Calculate Variance Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Variance Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Variance Calculator calculation',
