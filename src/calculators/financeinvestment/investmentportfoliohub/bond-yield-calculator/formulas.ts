import { bond-yield-calculatorInputs, bond-yield-calculatorMetrics, bond-yield-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: bond-yield-calculatorInputs): number {
...
export function generateAnalysis(inputs: bond-yield-calculatorInputs, metrics: bond-yield-calculatorMetrics): bond-yield-calculatorAnalysis {
