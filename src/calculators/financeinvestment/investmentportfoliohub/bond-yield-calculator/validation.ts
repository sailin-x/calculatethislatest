import { bond_yield_calculatorInputs } from './types';
...
export function validatebond_yield_calculatorInputs(inputs: bond_yield_calculatorInputs): ValidationResult[] {
...
export function validatebond_yield_calculatorBusinessRules(inputs: bond_yield_calculatorInputs): ValidationResult[] {
