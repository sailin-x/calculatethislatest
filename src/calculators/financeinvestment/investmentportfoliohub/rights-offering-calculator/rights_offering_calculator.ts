...
export const rights_offering_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Rights Offering Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Rights Offering Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Rights Offering Calculator calculation',
