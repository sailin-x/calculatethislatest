import { rights_offering_calculatorInputs } from './types';
...
export function validaterights_offering_calculatorInputs(inputs: rights_offering_calculatorInputs): ValidationResult[] {
...
export function validaterights_offering_calculatorBusinessRules(inputs: rights_offering_calculatorInputs): ValidationResult[] {
