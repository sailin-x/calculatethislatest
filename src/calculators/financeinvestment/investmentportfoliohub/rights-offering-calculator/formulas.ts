import { rights-offering-calculatorInputs, rights-offering-calculatorMetrics, rights-offering-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: rights-offering-calculatorInputs): number {
...
export function generateAnalysis(inputs: rights-offering-calculatorInputs, metrics: rights-offering-calculatorMetrics): rights-offering-calculatorAnalysis {
