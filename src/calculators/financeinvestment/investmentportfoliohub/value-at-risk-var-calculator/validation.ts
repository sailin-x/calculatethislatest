import { value_at_risk_var_calculatorInputs } from './types';
...
export function validatevalue_at_risk_var_calculatorInputs(inputs: value_at_risk_var_calculatorInputs): ValidationResult[] {
...
export function validatevalue_at_risk_var_calculatorBusinessRules(inputs: value_at_risk_var_calculatorInputs): ValidationResult[] {
