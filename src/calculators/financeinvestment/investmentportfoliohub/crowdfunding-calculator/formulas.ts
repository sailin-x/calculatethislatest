import { crowdfunding-calculatorInputs, crowdfunding-calculatorMetrics, crowdfunding-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: crowdfunding-calculatorInputs): number {
...
export function generateAnalysis(inputs: crowdfunding-calculatorInputs, metrics: crowdfunding-calculatorMetrics): crowdfunding-calculatorAnalysis {
