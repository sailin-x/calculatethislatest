import { crowdfunding_calculatorInputs } from './types';
...
export function validatecrowdfunding_calculatorInputs(inputs: crowdfunding_calculatorInputs): ValidationResult[] {
...
export function validatecrowdfunding_calculatorBusinessRules(inputs: crowdfunding_calculatorInputs): ValidationResult[] {
