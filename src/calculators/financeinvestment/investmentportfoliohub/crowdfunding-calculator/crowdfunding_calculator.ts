...
export const crowdfunding_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Crowdfunding Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Crowdfunding Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Crowdfunding Calculator calculation',
