import { TotalReturnSwap-calculatorInputs, TotalReturnSwap-calculatorMetrics, TotalReturnSwap-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: TotalReturnSwap-calculatorInputs): number {
...
export function generateAnalysis(inputs: TotalReturnSwap-calculatorInputs, metrics: TotalReturnSwap-calculatorMetrics): TotalReturnSwap-calculatorAnalysis {
