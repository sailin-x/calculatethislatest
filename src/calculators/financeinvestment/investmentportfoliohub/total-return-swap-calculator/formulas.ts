import { total-return-swap-calculatorInputs, total-return-swap-calculatorMetrics, total-return-swap-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: total-return-swap-calculatorInputs): number {
...
export function generateAnalysis(inputs: total-return-swap-calculatorInputs, metrics: total-return-swap-calculatorMetrics): total-return-swap-calculatorAnalysis {
