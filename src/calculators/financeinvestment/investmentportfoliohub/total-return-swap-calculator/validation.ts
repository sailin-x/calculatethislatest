import { total_return_swap_calculatorInputs } from './types';
...
export function validatetotal_return_swap_calculatorInputs(inputs: total_return_swap_calculatorInputs): ValidationResult[] {
...
export function validatetotal_return_swap_calculatorBusinessRules(inputs: total_return_swap_calculatorInputs): ValidationResult[] {
