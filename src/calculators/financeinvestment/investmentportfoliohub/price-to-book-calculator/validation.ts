...
export function validateprice_to_book_calculatorInputs(inputs: price_to_book_calculatorInputs): ValidationResult[] {
...
export function validateprice_to_book_calculatorBusinessRules(inputs: price_to_book_calculatorInputs): ValidationResult[] {
