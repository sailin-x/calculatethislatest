...
export const post_money_valuation_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Post-Money Valuation Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Post-Money Valuation Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Post-Money Valuation Calculator calculation',
