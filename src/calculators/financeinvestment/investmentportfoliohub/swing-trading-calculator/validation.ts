import { swing_trading_calculatorInputs } from './types';
...
export function validateswing_trading_calculatorInputs(inputs: swing_trading_calculatorInputs): ValidationResult[] {
...
export function validateswing_trading_calculatorBusinessRules(inputs: swing_trading_calculatorInputs): ValidationResult[] {
