...
export const SwingTradingCalculator: Calculator = {
  ...
  description: 'Calculate Swing Trading Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Swing Trading Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Swing Trading Calculator calculation',
