import { hedge_fund_fee_calculatorInputs } from './types';
...
export function validatehedge_fund_fee_calculatorInputs(inputs: hedge_fund_fee_calculatorInputs): ValidationResult[] {
...
export function validatehedge_fund_fee_calculatorBusinessRules(inputs: hedge_fund_fee_calculatorInputs): ValidationResult[] {
