import { interest_calculatorInputs } from './types';
...
export function validateinterest_calculatorInputs(inputs: interest_calculatorInputs): ValidationResult[] {
...
export function validateinterest_calculatorBusinessRules(inputs: interest_calculatorInputs): ValidationResult[] {
