import { bond_convexity_calculatorInputs } from './types';
...
export function validatebond_convexity_calculatorInputs(inputs: bond_convexity_calculatorInputs): ValidationResult[] {
...
export function validatebond_convexity_calculatorBusinessRules(inputs: bond_convexity_calculatorInputs): ValidationResult[] {
