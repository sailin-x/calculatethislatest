...
export const BondConvexityCalculator: Calculator = {
  ...
  description: 'Calculate Bond Convexity Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Bond Convexity Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Bond Convexity Calculator calculation',
