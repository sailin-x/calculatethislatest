import { treynor_ratio_calculatorInputs } from './types';
...
export function validatetreynor_ratio_calculatorInputs(inputs: treynor_ratio_calculatorInputs): ValidationResult[] {
...
export function validatetreynor_ratio_calculatorBusinessRules(inputs: treynor_ratio_calculatorInputs): ValidationResult[] {
