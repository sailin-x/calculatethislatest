import { day_trading_calculatorInputs } from './types';
...
export function validateday_trading_calculatorInputs(inputs: day_trading_calculatorInputs): ValidationResult[] {
...
export function validateday_trading_calculatorBusinessRules(inputs: day_trading_calculatorInputs): ValidationResult[] {
