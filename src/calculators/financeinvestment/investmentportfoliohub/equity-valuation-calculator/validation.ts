import { equity_valuation_calculatorInputs } from './types';
...
export function validateequity_valuation_calculatorInputs(inputs: equity_valuation_calculatorInputs): ValidationResult[] {
...
export function validateequity_valuation_calculatorBusinessRules(inputs: equity_valuation_calculatorInputs): ValidationResult[] {
