...
export const EquityValuationCalculator: Calculator = {
  ...
  description: 'Calculate Equity Valuation Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Equity Valuation Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Equity Valuation Calculator calculation',
