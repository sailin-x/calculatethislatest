...
export const information_ratio_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Information Ratio Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Information Ratio Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Information Ratio Calculator calculation',
