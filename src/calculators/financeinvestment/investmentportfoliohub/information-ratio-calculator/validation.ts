import { information_ratio_calculatorInputs } from './types';
...
export function validateinformation_ratio_calculatorInputs(inputs: information_ratio_calculatorInputs): ValidationResult[] {
...
export function validateinformation_ratio_calculatorBusinessRules(inputs: information_ratio_calculatorInputs): ValidationResult[] {
