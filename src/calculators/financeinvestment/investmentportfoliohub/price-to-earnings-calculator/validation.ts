import { price_to_earnings_calculatorInputs } from './types';
...
export function validateprice_to_earnings_calculatorInputs(inputs: price_to_earnings_calculatorInputs): ValidationResult[] {
...
export function validateprice_to_earnings_calculatorBusinessRules(inputs: price_to_earnings_calculatorInputs): ValidationResult[] {
