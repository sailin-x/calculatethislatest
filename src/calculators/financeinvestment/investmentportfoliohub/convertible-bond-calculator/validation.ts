import { convertible_bond_calculatorInputs } from './types';
...
export function validateconvertible_bond_calculatorInputs(inputs: convertible_bond_calculatorInputs): ValidationResult[] {
...
export function validateconvertible_bond_calculatorBusinessRules(inputs: convertible_bond_calculatorInputs): ValidationResult[] {
