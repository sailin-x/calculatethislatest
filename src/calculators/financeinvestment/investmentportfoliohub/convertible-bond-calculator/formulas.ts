import { ConvertibleBondCalculatorinputs, ConvertibleBondCalculatormetrics, ConvertibleBondCalculatoranalysis } from './types';
...
export function generateAnalysis(inputs: ConvertibleBondCalculatorinputs, metrics: ConvertibleBondCalculatormetrics): ConvertibleBondCalculatoranalysis {
