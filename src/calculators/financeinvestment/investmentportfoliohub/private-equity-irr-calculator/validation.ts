import { private_equity_irr_calculatorInputs } from './types';
...
export function validateprivate_equity_irr_calculatorInputs(inputs: private_equity_irr_calculatorInputs): ValidationResult[] {
...
export function validateprivate_equity_irr_calculatorBusinessRules(inputs: private_equity_irr_calculatorInputs): ValidationResult[] {
