...
export function validatereit_calculatorInputs(inputs: reit_calculatorInputs): ValidationResult[] {
...
export function validatereit_calculatorBusinessRules(inputs: reit_calculatorInputs): ValidationResult[] {
