import { quick_ratio_calculatorInputs } from './types';
...
export function validatequick_ratio_calculatorInputs(inputs: quick_ratio_calculatorInputs): ValidationResult[] {
...
export function validatequick_ratio_calculatorBusinessRules(inputs: quick_ratio_calculatorInputs): ValidationResult[] {
