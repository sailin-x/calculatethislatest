import { PrivateEquityReturns-calculatorInputs, PrivateEquityReturns-calculatorMetrics, PrivateEquityReturns-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: PrivateEquityReturns-calculatorInputs): number {
...
export function generateAnalysis(inputs: PrivateEquityReturns-calculatorInputs, metrics: PrivateEquityReturns-calculatorMetrics): PrivateEquityReturns-calculatorAnalysis {
