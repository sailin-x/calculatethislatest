import { sortino_ratio_calculatorInputs } from './types';
...
export function validatesortino_ratio_calculatorInputs(inputs: sortino_ratio_calculatorInputs): ValidationResult[] {
...
export function validatesortino_ratio_calculatorBusinessRules(inputs: sortino_ratio_calculatorInputs): ValidationResult[] {
