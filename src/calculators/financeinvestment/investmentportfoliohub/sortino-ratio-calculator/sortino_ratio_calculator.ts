...
export const sortino_ratio_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Sortino Ratio Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Sortino Ratio Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Sortino Ratio Calculator calculation',
