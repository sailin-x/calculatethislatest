import { corporate_bond_calculatorInputs } from './types';
...
export function validatecorporate_bond_calculatorInputs(inputs: corporate_bond_calculatorInputs): ValidationResult[] {
...
export function validatecorporate_bond_calculatorBusinessRules(inputs: corporate_bond_calculatorInputs): ValidationResult[] {
