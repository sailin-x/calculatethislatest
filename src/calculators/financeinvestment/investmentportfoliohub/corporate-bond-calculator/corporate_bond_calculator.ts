...
export const corporate_bond_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Corporate Bond Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Corporate Bond Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Corporate Bond Calculator calculation',
