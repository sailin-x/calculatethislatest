import { capm_calculatorInputs } from './types';
...
export function validatecapm_calculatorInputs(inputs: capm_calculatorInputs): ValidationResult[] {
...
export function validatecapm_calculatorBusinessRules(inputs: capm_calculatorInputs): ValidationResult[] {
