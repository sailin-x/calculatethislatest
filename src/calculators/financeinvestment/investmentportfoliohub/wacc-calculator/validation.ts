import { wacc_calculatorInputs } from './types';
...
export function validatewacc_calculatorInputs(inputs: wacc_calculatorInputs): ValidationResult[] {
...
export function validatewacc_calculatorBusinessRules(inputs: wacc_calculatorInputs): ValidationResult[] {
