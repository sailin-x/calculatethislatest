import { credit_default_swap_calculatorInputs } from './types';
...
export function validatecredit_default_swap_calculatorInputs(inputs: credit_default_swap_calculatorInputs): ValidationResult[] {
...
export function validatecredit_default_swap_calculatorBusinessRules(inputs: credit_default_swap_calculatorInputs): ValidationResult[] {
