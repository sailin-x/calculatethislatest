import { leverage_ratio_calculatorInputs } from './types';
...
export function validateleverage_ratio_calculatorInputs(inputs: leverage_ratio_calculatorInputs): ValidationResult[] {
...
export function validateleverage_ratio_calculatorBusinessRules(inputs: leverage_ratio_calculatorInputs): ValidationResult[] {
