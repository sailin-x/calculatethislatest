import { gross_margin_calculatorInputs } from './types';
...
export function validategross_margin_calculatorInputs(inputs: gross_margin_calculatorInputs): ValidationResult[] {
...
export function validategross_margin_calculatorBusinessRules(inputs: gross_margin_calculatorInputs): ValidationResult[] {
