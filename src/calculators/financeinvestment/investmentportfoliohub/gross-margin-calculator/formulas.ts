import { gross-margin-calculatorInputs, gross-margin-calculatorMetrics, gross-margin-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: gross-margin-calculatorInputs): number {
...
export function generateAnalysis(inputs: gross-margin-calculatorInputs, metrics: gross-margin-calculatorMetrics): gross-margin-calculatorAnalysis {
