...
export const warrant_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Warrant Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Warrant Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Warrant Calculator calculation',
