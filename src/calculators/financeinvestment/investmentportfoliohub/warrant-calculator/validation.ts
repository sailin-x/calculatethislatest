import { warrant_calculatorInputs } from './types';
...
export function validatewarrant_calculatorInputs(inputs: warrant_calculatorInputs): ValidationResult[] {
...
export function validatewarrant_calculatorBusinessRules(inputs: warrant_calculatorInputs): ValidationResult[] {
