import { warrant-calculatorInputs, warrant-calculatorMetrics, warrant-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: warrant-calculatorInputs): number {
...
export function generateAnalysis(inputs: warrant-calculatorInputs, metrics: warrant-calculatorMetrics): warrant-calculatorAnalysis {
