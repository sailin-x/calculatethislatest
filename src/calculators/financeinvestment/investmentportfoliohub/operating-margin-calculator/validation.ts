import { operating_margin_calculatorInputs } from './types';
...
export function validateoperating_margin_calculatorInputs(inputs: operating_margin_calculatorInputs): ValidationResult[] {
...
export function validateoperating_margin_calculatorBusinessRules(inputs: operating_margin_calculatorInputs): ValidationResult[] {
