...
export const operating_margin_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Operating Margin Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Operating Margin Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Operating Margin Calculator calculation',
