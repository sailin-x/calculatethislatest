import { cost_of_debt_calculatorInputs } from './types';
...
export function validatecost_of_debt_calculatorInputs(inputs: cost_of_debt_calculatorInputs): ValidationResult[] {
...
export function validatecost_of_debt_calculatorBusinessRules(inputs: cost_of_debt_calculatorInputs): ValidationResult[] {
