...
export const CostOfDebt-calculator: Calculator = {
  ...
  description: 'Calculate Cost of Debt Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Cost of Debt Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Cost of Debt Calculator calculation',
