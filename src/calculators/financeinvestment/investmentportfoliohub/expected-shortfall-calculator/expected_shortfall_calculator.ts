...
export const ExpectedShortfallCalculator: Calculator = {
  ...
  description: 'Calculate Expected Shortfall Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Expected Shortfall Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Expected Shortfall Calculator calculation',
