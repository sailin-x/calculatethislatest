import { expected_shortfall_calculatorInputs } from './types';
...
export function validateexpected_shortfall_calculatorInputs(inputs: expected_shortfall_calculatorInputs): ValidationResult[] {
...
export function validateexpected_shortfall_calculatorBusinessRules(inputs: expected_shortfall_calculatorInputs): ValidationResult[] {
