import { municipal_bond_calculatorInputs } from './types';
...
export function validatemunicipal_bond_calculatorInputs(inputs: municipal_bond_calculatorInputs): ValidationResult[] {
...
export function validatemunicipal_bond_calculatorBusinessRules(inputs: municipal_bond_calculatorInputs): ValidationResult[] {
