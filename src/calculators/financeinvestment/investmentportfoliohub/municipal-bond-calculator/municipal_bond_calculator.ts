...
export const municipal_bond_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Municipal Bond Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Municipal Bond Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Municipal Bond Calculator calculation',
