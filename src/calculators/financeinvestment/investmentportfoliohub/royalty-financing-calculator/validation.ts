import { royalty_financing_calculatorInputs } from './types';
...
export function validateroyalty_financing_calculatorInputs(inputs: royalty_financing_calculatorInputs): ValidationResult[] {
...
export function validateroyalty_financing_calculatorBusinessRules(inputs: royalty_financing_calculatorInputs): ValidationResult[] {
