import { stock_buyback_roi_calculatorInputs } from './types';
...
export function validatestock_buyback_roi_calculatorInputs(inputs: stock_buyback_roi_calculatorInputs): ValidationResult[] {
...
export function validatestock_buyback_roi_calculatorBusinessRules(inputs: stock_buyback_roi_calculatorInputs): ValidationResult[] {
