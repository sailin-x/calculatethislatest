...
export const StockBuybackRoi-calculator: Calculator = {
  ...
  description: 'Calculate Stock Buyback ROI Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Stock Buyback ROI Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Stock Buyback ROI Calculator calculation',
