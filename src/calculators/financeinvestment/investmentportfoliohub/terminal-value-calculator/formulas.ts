import { terminal-value-calculatorInputs, terminal-value-calculatorMetrics, terminal-value-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: terminal-value-calculatorInputs): number {
...
export function generateAnalysis(inputs: terminal-value-calculatorInputs, metrics: terminal-value-calculatorMetrics): terminal-value-calculatorAnalysis {
