import { terminal_value_calculatorInputs } from './types';
...
export function validateterminal_value_calculatorInputs(inputs: terminal_value_calculatorInputs): ValidationResult[] {
...
export function validateterminal_value_calculatorBusinessRules(inputs: terminal_value_calculatorInputs): ValidationResult[] {
