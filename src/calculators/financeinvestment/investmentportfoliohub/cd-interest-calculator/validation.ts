import { cd_interest_calculatorInputs } from './types';
...
export function validatecd_interest_calculatorInputs(inputs: cd_interest_calculatorInputs): ValidationResult[] {
...
export function validatecd_interest_calculatorBusinessRules(inputs: cd_interest_calculatorInputs): ValidationResult[] {
