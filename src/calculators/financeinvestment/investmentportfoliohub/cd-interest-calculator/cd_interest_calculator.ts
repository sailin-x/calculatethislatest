...
export const CdInterestCalculator: Calculator = {
  ...
  description: 'Calculate CD Interest Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your CD Interest Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic CD Interest Calculator calculation',
