...
export const SpinOffCalculator: Calculator = {
  ...
  description: 'Calculate Spin Off Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Spin Off Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Spin Off Calculator calculation',
