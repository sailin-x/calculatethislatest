import { spin_off_calculatorInputs } from './types';
...
export function validatespin_off_calculatorInputs(inputs: spin_off_calculatorInputs): ValidationResult[] {
...
export function validatespin_off_calculatorBusinessRules(inputs: spin_off_calculatorInputs): ValidationResult[] {
