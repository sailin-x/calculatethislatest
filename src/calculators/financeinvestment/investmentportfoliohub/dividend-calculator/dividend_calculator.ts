...
export const dividend-calculator: Calculator = {
  ...
  description: 'Calculate Dividend Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Dividend Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Dividend Calculator calculation',
