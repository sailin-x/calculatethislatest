import { dividend_calculatorInputs } from './types';
...
export function validatedividend_calculatorInputs(inputs: dividend_calculatorInputs): ValidationResult[] {
...
export function validatedividend_calculatorBusinessRules(inputs: dividend_calculatorInputs): ValidationResult[] {
