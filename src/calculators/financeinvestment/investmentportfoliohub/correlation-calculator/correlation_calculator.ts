...
export const correlation_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Correlation Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Correlation Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Correlation Calculator calculation',
