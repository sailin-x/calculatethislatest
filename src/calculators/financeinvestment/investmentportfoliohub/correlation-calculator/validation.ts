import { correlation_calculatorInputs } from './types';
...
export function validatecorrelation_calculatorInputs(inputs: correlation_calculatorInputs): ValidationResult[] {
...
export function validatecorrelation_calculatorBusinessRules(inputs: correlation_calculatorInputs): ValidationResult[] {
