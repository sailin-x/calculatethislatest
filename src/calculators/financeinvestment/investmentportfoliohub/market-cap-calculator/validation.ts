import { market_cap_calculatorInputs } from './types';
...
export function validatemarket_cap_calculatorInputs(inputs: market_cap_calculatorInputs): ValidationResult[] {
...
export function validatemarket_cap_calculatorBusinessRules(inputs: market_cap_calculatorInputs): ValidationResult[] {
