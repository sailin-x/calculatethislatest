...
export const commodity_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Commodity Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Commodity Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Commodity Calculator calculation',
