import { commodity_calculatorInputs } from './types';
...
export function validatecommodity_calculatorInputs(inputs: commodity_calculatorInputs): ValidationResult[] {
...
export function validatecommodity_calculatorBusinessRules(inputs: commodity_calculatorInputs): ValidationResult[] {
