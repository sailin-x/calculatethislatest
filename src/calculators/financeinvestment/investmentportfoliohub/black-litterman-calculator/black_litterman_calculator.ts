...
export const BlackLittermanCalculator: Calculator = {
  ...
  description: 'Calculate Black Litterman Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Black Litterman Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Black Litterman Calculator calculation',
