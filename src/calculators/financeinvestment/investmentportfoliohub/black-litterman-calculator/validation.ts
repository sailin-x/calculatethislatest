import { black_litterman_calculatorInputs } from './types';
...
export function validateblack_litterman_calculatorInputs(inputs: black_litterman_calculatorInputs): ValidationResult[] {
...
export function validateblack_litterman_calculatorBusinessRules(inputs: black_litterman_calculatorInputs): ValidationResult[] {
