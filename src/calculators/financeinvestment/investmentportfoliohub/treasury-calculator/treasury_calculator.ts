...
export const treasury_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Treasury Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Treasury Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Treasury Calculator calculation',
