import { treasury-calculatorInputs, treasury-calculatorMetrics, treasury-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: treasury-calculatorInputs): number {
...
export function generateAnalysis(inputs: treasury-calculatorInputs, metrics: treasury-calculatorMetrics): treasury-calculatorAnalysis {
