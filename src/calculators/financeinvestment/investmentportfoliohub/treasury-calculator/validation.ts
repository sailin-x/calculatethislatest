import { treasury_calculatorInputs } from './types';
...
export function validatetreasury_calculatorInputs(inputs: treasury_calculatorInputs): ValidationResult[] {
...
export function validatetreasury_calculatorBusinessRules(inputs: treasury_calculatorInputs): ValidationResult[] {
