...
export const ebitda_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate EBITDA Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your EBITDA Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic EBITDA Calculator calculation',
