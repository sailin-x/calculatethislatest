import { ebitda_calculatorInputs } from './types';
...
export function validateebitda_calculatorInputs(inputs: ebitda_calculatorInputs): ValidationResult[] {
...
export function validateebitda_calculatorBusinessRules(inputs: ebitda_calculatorInputs): ValidationResult[] {
