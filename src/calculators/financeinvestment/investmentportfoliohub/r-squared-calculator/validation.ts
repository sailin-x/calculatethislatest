import { r_squared_calculatorInputs } from './types';
...
export function validater_squared_calculatorInputs(inputs: r_squared_calculatorInputs): ValidationResult[] {
...
export function validater_squared_calculatorBusinessRules(inputs: r_squared_calculatorInputs): ValidationResult[] {
