...
export const RSquaredCalculator: Calculator = {
  ...
  description: 'Calculate R Squared Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your R Squared Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic R Squared Calculator calculation',
