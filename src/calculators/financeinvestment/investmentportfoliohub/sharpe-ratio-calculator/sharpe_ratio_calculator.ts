...
export const SharpeRatioCalculator: Calculator = {
  ...
  description: 'Calculate Sharpe Ratio Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Sharpe Ratio Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Sharpe Ratio Calculator calculation',
