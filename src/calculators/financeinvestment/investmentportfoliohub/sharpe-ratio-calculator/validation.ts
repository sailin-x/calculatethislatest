import { sharpe_ratio_calculatorInputs } from './types';
...
export function validatesharpe_ratio_calculatorInputs(inputs: sharpe_ratio_calculatorInputs): ValidationResult[] {
...
export function validatesharpe_ratio_calculatorBusinessRules(inputs: sharpe_ratio_calculatorInputs): ValidationResult[] {
