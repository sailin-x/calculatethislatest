import { sharpe-ratio-calculatorInputs, sharpe-ratio-calculatorMetrics, sharpe-ratio-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: sharpe-ratio-calculatorInputs): number {
...
export function generateAnalysis(inputs: sharpe-ratio-calculatorInputs, metrics: sharpe-ratio-calculatorMetrics): sharpe-ratio-calculatorAnalysis {
