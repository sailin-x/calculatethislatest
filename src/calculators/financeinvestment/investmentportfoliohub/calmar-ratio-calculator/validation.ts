import { calmar_ratio_calculatorInputs } from './types';
...
export function validatecalmar_ratio_calculatorInputs(inputs: calmar_ratio_calculatorInputs): ValidationResult[] {
...
export function validatecalmar_ratio_calculatorBusinessRules(inputs: calmar_ratio_calculatorInputs): ValidationResult[] {
