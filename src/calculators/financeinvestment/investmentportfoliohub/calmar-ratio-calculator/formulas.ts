import { calmar-ratio-calculatorInputs, calmar-ratio-calculatorMetrics, calmar-ratio-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: calmar-ratio-calculatorInputs): number {
...
export function generateAnalysis(inputs: calmar-ratio-calculatorInputs, metrics: calmar-ratio-calculatorMetrics): calmar-ratio-calculatorAnalysis {
