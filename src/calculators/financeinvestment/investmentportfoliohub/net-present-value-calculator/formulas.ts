import { net-present-value-calculatorInputs, net-present-value-calculatorMetrics, net-present-value-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: net-present-value-calculatorInputs): number {
...
export function generateAnalysis(inputs: net-present-value-calculatorInputs, metrics: net-present-value-calculatorMetrics): net-present-value-calculatorAnalysis {
