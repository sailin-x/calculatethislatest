import { net_present_value_calculatorInputs } from './types';
...
export function validatenet_present_value_calculatorInputs(inputs: net_present_value_calculatorInputs): ValidationResult[] {
...
export function validatenet_present_value_calculatorBusinessRules(inputs: net_present_value_calculatorInputs): ValidationResult[] {
