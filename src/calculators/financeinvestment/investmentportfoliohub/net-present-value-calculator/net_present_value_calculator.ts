...
export const net_present_value_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Net Present Value Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Net Present Value Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Net Present Value Calculator calculation',
