import { StockOptionsValuation-calculatorInputs, StockOptionsValuation-calculatorMetrics, StockOptionsValuation-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: StockOptionsValuation-calculatorInputs): number {
...
export function generateAnalysis(inputs: StockOptionsValuation-calculatorInputs, metrics: StockOptionsValuation-calculatorMetrics): StockOptionsValuation-calculatorAnalysis {
