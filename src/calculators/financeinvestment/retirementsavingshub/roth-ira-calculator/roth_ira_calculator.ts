...
export const roth_ira_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Roth IRA Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Roth IRA Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Roth IRA Calculator calculation',
