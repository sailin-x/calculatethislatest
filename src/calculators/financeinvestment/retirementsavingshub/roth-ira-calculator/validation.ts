import { roth_ira_calculatorInputs } from './types';
...
export function validateroth_ira_calculatorInputs(inputs: roth_ira_calculatorInputs): ValidationResult[] {
...
export function validateroth_ira_calculatorBusinessRules(inputs: roth_ira_calculatorInputs): ValidationResult[] {
