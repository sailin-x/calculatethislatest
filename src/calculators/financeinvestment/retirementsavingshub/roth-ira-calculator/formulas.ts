import { roth-ira-calculatorInputs, roth-ira-calculatorMetrics, roth-ira-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: roth-ira-calculatorInputs): number {
...
export function generateAnalysis(inputs: roth-ira-calculatorInputs, metrics: roth-ira-calculatorMetrics): roth-ira-calculatorAnalysis {
