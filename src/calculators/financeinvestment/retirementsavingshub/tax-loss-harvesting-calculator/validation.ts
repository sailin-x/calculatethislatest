import { tax_loss_harvesting_calculatorInputs } from './types';
...
export function validatetax_loss_harvesting_calculatorInputs(inputs: tax_loss_harvesting_calculatorInputs): ValidationResult[] {
...
export function validatetax_loss_harvesting_calculatorBusinessRules(inputs: tax_loss_harvesting_calculatorInputs): ValidationResult[] {
