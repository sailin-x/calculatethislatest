...
export const tax_loss_harvesting_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Tax-Loss Harvesting Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Tax-Loss Harvesting Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Tax-Loss Harvesting Calculator calculation',
