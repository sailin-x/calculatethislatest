import { sep_ira_calculatorInputs } from './types';
...
export function validatesep_ira_calculatorInputs(inputs: sep_ira_calculatorInputs): ValidationResult[] {
...
export function validatesep_ira_calculatorBusinessRules(inputs: sep_ira_calculatorInputs): ValidationResult[] {
