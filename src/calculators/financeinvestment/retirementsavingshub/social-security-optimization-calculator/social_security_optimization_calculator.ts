...
export const SocialSecurityOptimization-calculator: Calculator = {
  ...
  description: 'Calculate Social Security Optimization Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Social Security Optimization Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Social Security Optimization Calculator calculation',
