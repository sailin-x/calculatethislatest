import { SocialSecurityOptimization-calculatorInputs, SocialSecurityOptimization-calculatorMetrics, SocialSecurityOptimization-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: SocialSecurityOptimization-calculatorInputs): number {
...
export function generateAnalysis(inputs: SocialSecurityOptimization-calculatorInputs, metrics: SocialSecurityOptimization-calculatorMetrics): SocialSecurityOptimization-calculatorAnalysis {
