import { traditional-ira-calculatorInputs, traditional-ira-calculatorMetrics, traditional-ira-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: traditional-ira-calculatorInputs): number {
...
export function generateAnalysis(inputs: traditional-ira-calculatorInputs, metrics: traditional-ira-calculatorMetrics): traditional-ira-calculatorAnalysis {
