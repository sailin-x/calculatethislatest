import { traditional_ira_calculatorInputs } from './types';
...
export function validatetraditional_ira_calculatorInputs(inputs: traditional_ira_calculatorInputs): ValidationResult[] {
...
export function validatetraditional_ira_calculatorBusinessRules(inputs: traditional_ira_calculatorInputs): ValidationResult[] {
