import { retirement_abroad_calculatorInputs } from './types';
...
export function validateretirement_abroad_calculatorInputs(inputs: retirement_abroad_calculatorInputs): ValidationResult[] {
...
export function validateretirement_abroad_calculatorBusinessRules(inputs: retirement_abroad_calculatorInputs): ValidationResult[] {
