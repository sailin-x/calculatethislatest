import { TrustFundDistribution-calculatorInputs, TrustFundDistribution-calculatorMetrics, TrustFundDistribution-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: TrustFundDistribution-calculatorInputs): number {
...
export function generateAnalysis(inputs: TrustFundDistribution-calculatorInputs, metrics: TrustFundDistribution-calculatorMetrics): TrustFundDistribution-calculatorAnalysis {
