import { simple_ira_calculatorInputs } from './types';
...
export function validatesimple_ira_calculatorInputs(inputs: simple_ira_calculatorInputs): ValidationResult[] {
...
export function validatesimple_ira_calculatorBusinessRules(inputs: simple_ira_calculatorInputs): ValidationResult[] {
