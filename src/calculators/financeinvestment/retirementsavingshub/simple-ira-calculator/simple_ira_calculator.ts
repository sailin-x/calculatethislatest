...
export const simple_ira_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate SIMPLE IRA Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your SIMPLE IRA Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic SIMPLE IRA Calculator calculation',
