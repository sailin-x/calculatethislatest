...
export const PaydayLoanCalculator: Calculator = {
  ...
  description: 'Calculate Payday Loan Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Payday Loan Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Payday Loan Calculator calculation',
