import { payday_loan_calculatorInputs } from './types';
...
export function validatepayday_loan_calculatorInputs(inputs: payday_loan_calculatorInputs): ValidationResult[] {
...
export function validatepayday_loan_calculatorBusinessRules(inputs: payday_loan_calculatorInputs): ValidationResult[] {
