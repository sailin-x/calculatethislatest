import { loan_calculatorInputs } from './types';
...
export function validateloan_calculatorInputs(inputs: loan_calculatorInputs): ValidationResult[] {
...
export function validateloan_calculatorBusinessRules(inputs: loan_calculatorInputs): ValidationResult[] {
