import { title_loan_calculatorInputs } from './types';
...
export function validatetitle_loan_calculatorInputs(inputs: title_loan_calculatorInputs): ValidationResult[] {
...
export function validatetitle_loan_calculatorBusinessRules(inputs: title_loan_calculatorInputs): ValidationResult[] {
