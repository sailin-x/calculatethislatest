import { car_loan_calculatorInputs } from './types';
...
export function validatecar_loan_calculatorInputs(inputs: car_loan_calculatorInputs): ValidationResult[] {
...
export function validatecar_loan_calculatorBusinessRules(inputs: car_loan_calculatorInputs): ValidationResult[] {
