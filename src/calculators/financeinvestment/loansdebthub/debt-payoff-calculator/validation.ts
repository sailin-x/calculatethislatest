import { debt_payoff_calculatorInputs } from './types';
...
export function validatedebt_payoff_calculatorInputs(inputs: debt_payoff_calculatorInputs): ValidationResult[] {
...
export function validatedebt_payoff_calculatorBusinessRules(inputs: debt_payoff_calculatorInputs): ValidationResult[] {
