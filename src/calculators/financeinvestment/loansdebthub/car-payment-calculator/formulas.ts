import { car-payment-calculatorInputs, car-payment-calculatorMetrics, car-payment-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: car-payment-calculatorInputs): number {
...
export function generateAnalysis(inputs: car-payment-calculatorInputs, metrics: car-payment-calculatorMetrics): car-payment-calculatorAnalysis {
