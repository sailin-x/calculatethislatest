import { car_payment_calculatorInputs } from './types';
...
export function validatecar_payment_calculatorInputs(inputs: car_payment_calculatorInputs): ValidationResult[] {
...
export function validatecar_payment_calculatorBusinessRules(inputs: car_payment_calculatorInputs): ValidationResult[] {
