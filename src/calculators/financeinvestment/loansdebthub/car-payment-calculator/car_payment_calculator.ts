...
export const car_payment_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Car Payment Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Car Payment Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Car Payment Calculator calculation',
