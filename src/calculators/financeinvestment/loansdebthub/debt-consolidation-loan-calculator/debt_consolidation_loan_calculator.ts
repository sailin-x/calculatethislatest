...
export const DebtConsolidationLoan-calculator: Calculator = {
  ...
  description: 'Calculate Debt Consolidation Loan Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Debt Consolidation Loan Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Debt Consolidation Loan Calculator calculation',
