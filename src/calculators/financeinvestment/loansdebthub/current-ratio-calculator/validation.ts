import { current_ratio_calculatorInputs } from './types';
...
export function validatecurrent_ratio_calculatorInputs(inputs: current_ratio_calculatorInputs): ValidationResult[] {
...
export function validatecurrent_ratio_calculatorBusinessRules(inputs: current_ratio_calculatorInputs): ValidationResult[] {
