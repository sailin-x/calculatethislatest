...
export const CurrentRatioCalculator: Calculator = {
  ...
  description: 'Calculate Current Ratio Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Current Ratio Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Current Ratio Calculator calculation',
