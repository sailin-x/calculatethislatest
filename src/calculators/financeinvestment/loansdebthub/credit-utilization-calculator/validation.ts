import { credit_utilization_calculatorInputs } from './types';
...
export function validatecredit_utilization_calculatorInputs(inputs: credit_utilization_calculatorInputs): ValidationResult[] {
...
export function validatecredit_utilization_calculatorBusinessRules(inputs: credit_utilization_calculatorInputs): ValidationResult[] {
