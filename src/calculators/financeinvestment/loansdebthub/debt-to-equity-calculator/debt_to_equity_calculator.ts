...
export const debt_to_equity_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Debt to Equity Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Debt to Equity Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Debt to Equity Calculator calculation',
