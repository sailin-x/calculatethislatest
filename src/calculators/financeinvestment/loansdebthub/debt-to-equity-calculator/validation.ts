import { debt_to_equity_calculatorInputs } from './types';
...
export function validatedebt_to_equity_calculatorInputs(inputs: debt_to_equity_calculatorInputs): ValidationResult[] {
...
export function validatedebt_to_equity_calculatorBusinessRules(inputs: debt_to_equity_calculatorInputs): ValidationResult[] {
