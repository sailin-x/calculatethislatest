import { debt_snowball_calculatorInputs } from './types';
...
export function validatedebt_snowball_calculatorInputs(inputs: debt_snowball_calculatorInputs): ValidationResult[] {
...
export function validatedebt_snowball_calculatorBusinessRules(inputs: debt_snowball_calculatorInputs): ValidationResult[] {
