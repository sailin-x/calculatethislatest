...
export const debt_avalanche_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Debt Avalanche Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Debt Avalanche Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Debt Avalanche Calculator calculation',
