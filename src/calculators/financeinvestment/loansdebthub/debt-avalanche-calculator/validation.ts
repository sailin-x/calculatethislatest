import { debt_avalanche_calculatorInputs } from './types';
...
export function validatedebt_avalanche_calculatorInputs(inputs: debt_avalanche_calculatorInputs): ValidationResult[] {
...
export function validatedebt_avalanche_calculatorBusinessRules(inputs: debt_avalanche_calculatorInputs): ValidationResult[] {
