import { dti_ratio_calculatorInputs } from './types';
...
export function validatedti_ratio_calculatorInputs(inputs: dti_ratio_calculatorInputs): ValidationResult[] {
...
export function validatedti_ratio_calculatorBusinessRules(inputs: dti_ratio_calculatorInputs): ValidationResult[] {
