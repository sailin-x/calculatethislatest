...
export const DtiRatioCalculator: Calculator = {
  ...
  description: 'Calculate DTI Ratio Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your DTI Ratio Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic DTI Ratio Calculator calculation',
