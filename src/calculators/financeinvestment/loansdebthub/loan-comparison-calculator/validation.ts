import { loan_comparison_calculatorInputs } from './types';
...
export function validateloan_comparison_calculatorInputs(inputs: loan_comparison_calculatorInputs): ValidationResult[] {
...
export function validateloan_comparison_calculatorBusinessRules(inputs: loan_comparison_calculatorInputs): ValidationResult[] {
