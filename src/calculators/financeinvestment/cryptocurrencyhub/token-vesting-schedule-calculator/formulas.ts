import { token-vesting-schedule-calculatorInputs, token-vesting-schedule-calculatorMetrics, token-vesting-schedule-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: token-vesting-schedule-calculatorInputs): number {
...
export function generateAnalysis(inputs: token-vesting-schedule-calculatorInputs, metrics: token-vesting-schedule-calculatorMetrics): token-vesting-schedule-calculatorAnalysis {
