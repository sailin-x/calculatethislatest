...
export const AirdropValueCalculator: Calculator = {
  ...
  description: 'Calculate Airdrop Value Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Airdrop Value Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Airdrop Value Calculator calculation',
