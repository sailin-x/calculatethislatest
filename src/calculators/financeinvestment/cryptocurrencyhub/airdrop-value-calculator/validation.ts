import { airdrop_value_calculatorInputs } from './types';
...
export function validateairdrop_value_calculatorInputs(inputs: airdrop_value_calculatorInputs): ValidationResult[] {
...
export function validateairdrop_value_calculatorBusinessRules(inputs: airdrop_value_calculatorInputs): ValidationResult[] {
