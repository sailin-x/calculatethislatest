import { airdrop-value-calculatorInputs, airdrop-value-calculatorMetrics, airdrop-value-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: airdrop-value-calculatorInputs): number {
...
export function generateAnalysis(inputs: airdrop-value-calculatorInputs, metrics: airdrop-value-calculatorMetrics): airdrop-value-calculatorAnalysis {
