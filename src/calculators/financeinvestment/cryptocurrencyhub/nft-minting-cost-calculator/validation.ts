import { nft_minting_cost_calculatorInputs } from './types';
...
export function validatenft_minting_cost_calculatorInputs(inputs: nft_minting_cost_calculatorInputs): ValidationResult[] {
...
export function validatenft_minting_cost_calculatorBusinessRules(inputs: nft_minting_cost_calculatorInputs): ValidationResult[] {
