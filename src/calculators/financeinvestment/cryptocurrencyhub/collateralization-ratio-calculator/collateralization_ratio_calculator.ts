...
export const CollateralizationRatioCalculator: Calculator = {
  ...
  description: 'Calculate Collateralization Ratio Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Collateralization Ratio Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Collateralization Ratio Calculator calculation',
