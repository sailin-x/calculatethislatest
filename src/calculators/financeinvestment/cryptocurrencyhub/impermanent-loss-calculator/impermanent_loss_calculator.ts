...
export const ImpermanentLossCalculator: Calculator = {
  ...
  description: 'Calculate Impermanent Loss Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Impermanent Loss Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Impermanent Loss Calculator calculation',
