import { impermanent-loss-calculatorInputs, impermanent-loss-calculatorMetrics, impermanent-loss-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: impermanent-loss-calculatorInputs): number {
...
export function generateAnalysis(inputs: impermanent-loss-calculatorInputs, metrics: impermanent-loss-calculatorMetrics): impermanent-loss-calculatorAnalysis {
