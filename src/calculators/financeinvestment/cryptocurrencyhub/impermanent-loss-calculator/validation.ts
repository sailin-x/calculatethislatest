import { impermanent_loss_calculatorInputs } from './types';
...
export function validateimpermanent_loss_calculatorInputs(inputs: impermanent_loss_calculatorInputs): ValidationResult[] {
...
export function validateimpermanent_loss_calculatorBusinessRules(inputs: impermanent_loss_calculatorInputs): ValidationResult[] {
