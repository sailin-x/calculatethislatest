import { defi_liquidity_pool_calculatorInputs } from './types';
...
export function validatedefi_liquidity_pool_calculatorInputs(inputs: defi_liquidity_pool_calculatorInputs): ValidationResult[] {
...
export function validatedefi_liquidity_pool_calculatorBusinessRules(inputs: defi_liquidity_pool_calculatorInputs): ValidationResult[] {
