import { blockchain_gas_fee_calculatorInputs } from './types';
...
export function validateblockchain_gas_fee_calculatorInputs(inputs: blockchain_gas_fee_calculatorInputs): ValidationResult[] {
...
export function validateblockchain_gas_fee_calculatorBusinessRules(inputs: blockchain_gas_fee_calculatorInputs): ValidationResult[] {
