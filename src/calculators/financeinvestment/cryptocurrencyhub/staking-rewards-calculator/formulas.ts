import { staking-rewards-calculatorInputs, staking-rewards-calculatorMetrics, staking-rewards-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: staking-rewards-calculatorInputs): number {
...
export function generateAnalysis(inputs: staking-rewards-calculatorInputs, metrics: staking-rewards-calculatorMetrics): staking-rewards-calculatorAnalysis {
