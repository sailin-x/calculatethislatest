import { staking_rewards_calculatorInputs } from './types';
...
export function validatestaking_rewards_calculatorInputs(inputs: staking_rewards_calculatorInputs): ValidationResult[] {
...
export function validatestaking_rewards_calculatorBusinessRules(inputs: staking_rewards_calculatorInputs): ValidationResult[] {
