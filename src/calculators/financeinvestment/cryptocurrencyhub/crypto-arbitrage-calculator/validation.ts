import { crypto_arbitrage_calculatorInputs } from './types';
...
export function validatecrypto_arbitrage_calculatorInputs(inputs: crypto_arbitrage_calculatorInputs): ValidationResult[] {
...
export function validatecrypto_arbitrage_calculatorBusinessRules(inputs: crypto_arbitrage_calculatorInputs): ValidationResult[] {
