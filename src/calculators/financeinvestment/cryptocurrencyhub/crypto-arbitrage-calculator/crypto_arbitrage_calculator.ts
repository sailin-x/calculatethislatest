...
export const CryptoArbitrageCalculator: Calculator = {
  ...
  description: 'Calculate Crypto Arbitrage Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Crypto Arbitrage Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Crypto Arbitrage Calculator calculation',
