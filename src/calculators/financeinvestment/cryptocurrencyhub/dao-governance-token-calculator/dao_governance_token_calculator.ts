...
export const dao_governance_token_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate DAO Governance Token Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your DAO Governance Token Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic DAO Governance Token Calculator calculation',
