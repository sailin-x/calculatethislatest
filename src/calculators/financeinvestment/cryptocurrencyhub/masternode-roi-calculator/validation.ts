import { masternode_roi_calculatorInputs } from './types';
...
export function validatemasternode_roi_calculatorInputs(inputs: masternode_roi_calculatorInputs): ValidationResult[] {
...
export function validatemasternode_roi_calculatorBusinessRules(inputs: masternode_roi_calculatorInputs): ValidationResult[] {
