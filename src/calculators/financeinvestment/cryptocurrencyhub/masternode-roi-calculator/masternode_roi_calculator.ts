...
export const MasternodeRoiCalculator: Calculator = {
  ...
  description: 'Calculate Masternode ROI Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Masternode ROI Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Masternode ROI Calculator calculation',
