import { DefiYieldOptimization-calculatorInputs, DefiYieldOptimization-calculatorMetrics, DefiYieldOptimization-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: DefiYieldOptimization-calculatorInputs): number {
...
export function generateAnalysis(inputs: DefiYieldOptimization-calculatorInputs, metrics: DefiYieldOptimization-calculatorMetrics): DefiYieldOptimization-calculatorAnalysis {
