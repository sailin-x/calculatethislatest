...
export const yield_farming_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Yield Farming Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Yield Farming Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Yield Farming Calculator calculation',
