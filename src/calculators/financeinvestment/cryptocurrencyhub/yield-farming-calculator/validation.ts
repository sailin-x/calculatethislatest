import { yield_farming_calculatorInputs } from './types';
...
export function validateyield_farming_calculatorInputs(inputs: yield_farming_calculatorInputs): ValidationResult[] {
...
export function validateyield_farming_calculatorBusinessRules(inputs: yield_farming_calculatorInputs): ValidationResult[] {
