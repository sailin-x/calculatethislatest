import { YieldFarmingCalculatorinputs, YieldFarmingCalculatormetrics, YieldFarmingCalculatoranalysis } from './types';
...
export function calculateResult(inputs: YieldFarmingCalculatorinputs): number {
...
export function generateAnalysis(inputs: YieldFarmingCalculatorinputs, metrics: YieldFarmingCalculatormetrics): YieldFarmingCalculatoranalysis {
