import { yield-farming-calculatorInputs, yield-farming-calculatorMetrics, yield-farming-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: yield-farming-calculatorInputs): number {
...
export function generateAnalysis(inputs: yield-farming-calculatorInputs, metrics: yield-farming-calculatorMetrics): yield-farming-calculatorAnalysis {
