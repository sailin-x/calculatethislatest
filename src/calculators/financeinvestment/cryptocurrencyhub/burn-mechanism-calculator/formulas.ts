import { burn-mechanism-calculatorInputs, burn-mechanism-calculatorMetrics, burn-mechanism-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: burn-mechanism-calculatorInputs): number {
...
export function generateAnalysis(inputs: burn-mechanism-calculatorInputs, metrics: burn-mechanism-calculatorMetrics): burn-mechanism-calculatorAnalysis {
