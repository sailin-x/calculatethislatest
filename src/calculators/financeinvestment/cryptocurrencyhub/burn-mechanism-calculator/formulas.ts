import { BurnMechanismCalculatorinputs, BurnMechanismCalculatormetrics, BurnMechanismCalculatoranalysis } from './types';
...
export function calculateResult(inputs: BurnMechanismCalculatorinputs): number {
...
export function generateAnalysis(inputs: BurnMechanismCalculatorinputs, metrics: BurnMechanismCalculatormetrics): BurnMechanismCalculatoranalysis {
