import { burn_mechanism_calculatorInputs } from './types';
...
export function validateburn_mechanism_calculatorInputs(inputs: burn_mechanism_calculatorInputs): ValidationResult[] {
...
export function validateburn_mechanism_calculatorBusinessRules(inputs: burn_mechanism_calculatorInputs): ValidationResult[] {
