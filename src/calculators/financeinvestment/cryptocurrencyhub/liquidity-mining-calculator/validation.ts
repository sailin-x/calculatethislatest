import { liquidity_mining_calculatorInputs } from './types';
...
export function validateliquidity_mining_calculatorInputs(inputs: liquidity_mining_calculatorInputs): ValidationResult[] {
...
export function validateliquidity_mining_calculatorBusinessRules(inputs: liquidity_mining_calculatorInputs): ValidationResult[] {
