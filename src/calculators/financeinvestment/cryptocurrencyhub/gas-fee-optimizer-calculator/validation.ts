import { gas_fee_optimizer_calculatorInputs } from './types';
...
export function validategas_fee_optimizer_calculatorInputs(inputs: gas_fee_optimizer_calculatorInputs): ValidationResult[] {
...
export function validategas_fee_optimizer_calculatorBusinessRules(inputs: gas_fee_optimizer_calculatorInputs): ValidationResult[] {
