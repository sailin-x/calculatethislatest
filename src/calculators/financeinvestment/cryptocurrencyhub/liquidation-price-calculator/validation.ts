import { liquidation_price_calculatorInputs } from './types';
...
export function validateliquidation_price_calculatorInputs(inputs: liquidation_price_calculatorInputs): ValidationResult[] {
...
export function validateliquidation_price_calculatorBusinessRules(inputs: liquidation_price_calculatorInputs): ValidationResult[] {
