import { bitcoin_pizza_day_calculatorInputs } from './types';
...
export function validatebitcoin_pizza_day_calculatorInputs(inputs: bitcoin_pizza_day_calculatorInputs): ValidationResult[] {
...
export function validatebitcoin_pizza_day_calculatorBusinessRules(inputs: bitcoin_pizza_day_calculatorInputs): ValidationResult[] {
