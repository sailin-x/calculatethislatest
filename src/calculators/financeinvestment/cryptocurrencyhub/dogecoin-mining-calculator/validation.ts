import { dogecoin_mining_calculatorInputs } from './types';
...
export function validatedogecoin_mining_calculatorInputs(inputs: dogecoin_mining_calculatorInputs): ValidationResult[] {
...
export function validatedogecoin_mining_calculatorBusinessRules(inputs: dogecoin_mining_calculatorInputs): ValidationResult[] {
