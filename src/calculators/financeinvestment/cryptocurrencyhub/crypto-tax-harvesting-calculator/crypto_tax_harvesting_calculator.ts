...
export const CryptoTaxHarvesting-calculator: Calculator = {
  ...
  description: 'Calculate Crypto Tax Harvesting Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Crypto Tax Harvesting Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Crypto Tax Harvesting Calculator calculation',
