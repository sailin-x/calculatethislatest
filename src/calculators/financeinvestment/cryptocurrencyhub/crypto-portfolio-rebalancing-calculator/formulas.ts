import { CryptoPortfolioRebalancing-calculatorInputs, CryptoPortfolioRebalancing-calculatorMetrics, CryptoPortfolioRebalancing-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: CryptoPortfolioRebalancing-calculatorInputs): number {
...
export function generateAnalysis(inputs: CryptoPortfolioRebalancing-calculatorInputs, metrics: CryptoPortfolioRebalancing-calculatorMetrics): CryptoPortfolioRebalancing-calculatorAnalysis {
