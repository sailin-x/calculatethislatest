import { nft_royalty_calculatorInputs } from './types';
...
export function validatenft_royalty_calculatorInputs(inputs: nft_royalty_calculatorInputs): ValidationResult[] {
...
export function validatenft_royalty_calculatorBusinessRules(inputs: nft_royalty_calculatorInputs): ValidationResult[] {
