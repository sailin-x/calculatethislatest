import { bitcoin_halving_calculatorInputs } from './types';
...
export function validatebitcoin_halving_calculatorInputs(inputs: bitcoin_halving_calculatorInputs): ValidationResult[] {
...
export function validatebitcoin_halving_calculatorBusinessRules(inputs: bitcoin_halving_calculatorInputs): ValidationResult[] {
