import { required_beginning_date_rmd_calculatorInputs, required_beginning_date_rmd_calculatorMetrics, required_beginning_date_rmd_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: required_beginning_date_rmd_calculatorInputs): number {
...
export function generateAnalysis(inputs: required_beginning_date_rmd_calculatorInputs, metrics: required_beginning_date_rmd_calculatorMetrics): required_beginning_date_rmd_calculatorAnalysis {
