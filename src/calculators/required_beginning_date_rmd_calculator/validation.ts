import { required_beginning_date_rmd_calculatorInputs } from './types';

export function validateInputs(inputs: required_beginning_date_rmd_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
