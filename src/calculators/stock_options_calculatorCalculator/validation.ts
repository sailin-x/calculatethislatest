import { stock_options_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: stock_options_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
