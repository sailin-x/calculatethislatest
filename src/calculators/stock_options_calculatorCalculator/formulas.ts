import { stock_options_calculatorCalculatorInputs, stock_options_calculatorCalculatorMetrics, stock_options_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: stock_options_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: stock_options_calculatorCalculatorInputs, metrics: stock_options_calculatorCalculatorMetrics): stock_options_calculatorCalculatorAnalysis {
