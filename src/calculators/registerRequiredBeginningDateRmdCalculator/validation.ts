import { registerRequiredBeginningDateRmdCalculatorInputs } from './types';

export function validateInputs(inputs: registerRequiredBeginningDateRmdCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
