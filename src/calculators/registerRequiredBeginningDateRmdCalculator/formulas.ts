import { registerRequiredBeginningDateRmdCalculatorInputs, registerRequiredBeginningDateRmdCalculatorMetrics, registerRequiredBeginningDateRmdCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerRequiredBeginningDateRmdCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerRequiredBeginningDateRmdCalculatorInputs, metrics: registerRequiredBeginningDateRmdCalculatorMetrics): registerRequiredBeginningDateRmdCalculatorAnalysis {
