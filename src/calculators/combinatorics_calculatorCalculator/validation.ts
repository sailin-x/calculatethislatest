import { combinatorics_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: combinatorics_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
