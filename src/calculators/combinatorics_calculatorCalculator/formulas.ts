import { combinatorics_calculatorCalculatorInputs, combinatorics_calculatorCalculatorMetrics, combinatorics_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: combinatorics_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: combinatorics_calculatorCalculatorInputs, metrics: combinatorics_calculatorCalculatorMetrics): combinatorics_calculatorCalculatorAnalysis {
