import { medical_device_royalty_rate_calculatorInputs, medical_device_royalty_rate_calculatorMetrics, medical_device_royalty_rate_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: medical_device_royalty_rate_calculatorInputs): number {
...
export function generateAnalysis(inputs: medical_device_royalty_rate_calculatorInputs, metrics: medical_device_royalty_rate_calculatorMetrics): medical_device_royalty_rate_calculatorAnalysis {
