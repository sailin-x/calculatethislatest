import { medical_device_royalty_rate_calculatorInputs } from './types';

export function validateInputs(inputs: medical_device_royalty_rate_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
