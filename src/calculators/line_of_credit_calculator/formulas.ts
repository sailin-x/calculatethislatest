import { line_of_credit_calculatorInputs, line_of_credit_calculatorMetrics, line_of_credit_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: line_of_credit_calculatorInputs): number {
...
export function generateAnalysis(inputs: line_of_credit_calculatorInputs, metrics: line_of_credit_calculatorMetrics): line_of_credit_calculatorAnalysis {
