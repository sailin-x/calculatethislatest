import { health_savings_account_contribution_calculatorInputs, health_savings_account_contribution_calculatorMetrics, health_savings_account_contribution_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: health_savings_account_contribution_calculatorInputs): number {
...
export function generateAnalysis(inputs: health_savings_account_contribution_calculatorInputs, metrics: health_savings_account_contribution_calculatorMetrics): health_savings_account_contribution_calculatorAnalysis {
