import { futures_calculatorInputs, futures_calculatorMetrics, futures_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: futures_calculatorInputs): number {
...
export function generateAnalysis(inputs: futures_calculatorInputs, metrics: futures_calculatorMetrics): futures_calculatorAnalysis {
