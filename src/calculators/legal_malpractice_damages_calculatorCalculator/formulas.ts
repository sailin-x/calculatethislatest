import { legal_malpractice_damages_calculatorCalculatorInputs, legal_malpractice_damages_calculatorCalculatorMetrics, legal_malpractice_damages_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: legal_malpractice_damages_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: legal_malpractice_damages_calculatorCalculatorInputs, metrics: legal_malpractice_damages_calculatorCalculatorMetrics): legal_malpractice_damages_calculatorCalculatorAnalysis {
