import { initial_dex_offering_calculatorCalculatorInputs, initial_dex_offering_calculatorCalculatorMetrics, initial_dex_offering_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: initial_dex_offering_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: initial_dex_offering_calculatorCalculatorInputs, metrics: initial_dex_offering_calculatorCalculatorMetrics): initial_dex_offering_calculatorCalculatorAnalysis {
