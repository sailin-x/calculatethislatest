import { initial_dex_offering_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: initial_dex_offering_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
