import { credit_utilization_calculatorCalculatorInputs, credit_utilization_calculatorCalculatorMetrics, credit_utilization_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: credit_utilization_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: credit_utilization_calculatorCalculatorInputs, metrics: credit_utilization_calculatorCalculatorMetrics): credit_utilization_calculatorCalculatorAnalysis {
