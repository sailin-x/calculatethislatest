import { blood_alcohol_calculatorInputs, blood_alcohol_calculatorMetrics, blood_alcohol_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: blood_alcohol_calculatorInputs): number {
...
export function generateAnalysis(inputs: blood_alcohol_calculatorInputs, metrics: blood_alcohol_calculatorMetrics): blood_alcohol_calculatorAnalysis {
