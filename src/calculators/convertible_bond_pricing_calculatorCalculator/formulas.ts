import { convertible_bond_pricing_calculatorCalculatorInputs, convertible_bond_pricing_calculatorCalculatorMetrics, convertible_bond_pricing_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: convertible_bond_pricing_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: convertible_bond_pricing_calculatorCalculatorInputs, metrics: convertible_bond_pricing_calculatorCalculatorMetrics): convertible_bond_pricing_calculatorCalculatorAnalysis {
