import { interest_only_mortgageCalculatorInputs, interest_only_mortgageCalculatorMetrics, interest_only_mortgageCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: interest_only_mortgageCalculatorInputs): number {
...
export function generateAnalysis(inputs: interest_only_mortgageCalculatorInputs, metrics: interest_only_mortgageCalculatorMetrics): interest_only_mortgageCalculatorAnalysis {
