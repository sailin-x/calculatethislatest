import { interest_only_mortgageCalculatorInputs } from './types';

export function validateInputs(inputs: interest_only_mortgageCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
