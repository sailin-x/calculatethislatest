import { financial_education_calculatorInputs } from './types';

export function validateInputs(inputs: financial_education_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
