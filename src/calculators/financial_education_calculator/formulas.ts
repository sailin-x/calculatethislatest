import { financial_education_calculatorInputs, financial_education_calculatorMetrics, financial_education_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_education_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_education_calculatorInputs, metrics: financial_education_calculatorMetrics): financial_education_calculatorAnalysis {
