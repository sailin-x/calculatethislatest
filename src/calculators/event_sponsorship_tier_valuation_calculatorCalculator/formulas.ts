import { event_sponsorship_tier_valuation_calculatorCalculatorInputs, event_sponsorship_tier_valuation_calculatorCalculatorMetrics, event_sponsorship_tier_valuation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: event_sponsorship_tier_valuation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: event_sponsorship_tier_valuation_calculatorCalculatorInputs, metrics: event_sponsorship_tier_valuation_calculatorCalculatorMetrics): event_sponsorship_tier_valuation_calculatorCalculatorAnalysis {
