import { glycemic_index_calculatorInputs, glycemic_index_calculatorMetrics, glycemic_index_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: glycemic_index_calculatorInputs): number {
...
export function generateAnalysis(inputs: glycemic_index_calculatorInputs, metrics: glycemic_index_calculatorMetrics): glycemic_index_calculatorAnalysis {
