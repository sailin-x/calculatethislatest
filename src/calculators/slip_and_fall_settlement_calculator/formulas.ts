import { slip_and_fall_settlement_calculatorInputs, slip_and_fall_settlement_calculatorMetrics, slip_and_fall_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: slip_and_fall_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: slip_and_fall_settlement_calculatorInputs, metrics: slip_and_fall_settlement_calculatorMetrics): slip_and_fall_settlement_calculatorAnalysis {
