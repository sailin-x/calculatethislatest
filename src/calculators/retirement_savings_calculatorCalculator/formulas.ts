import { retirement_savings_calculatorCalculatorInputs, retirement_savings_calculatorCalculatorMetrics, retirement_savings_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: retirement_savings_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: retirement_savings_calculatorCalculatorInputs, metrics: retirement_savings_calculatorCalculatorMetrics): retirement_savings_calculatorCalculatorAnalysis {
