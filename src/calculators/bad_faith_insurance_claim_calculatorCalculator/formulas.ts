import { bad_faith_insurance_claim_calculatorCalculatorInputs, bad_faith_insurance_claim_calculatorCalculatorMetrics, bad_faith_insurance_claim_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: bad_faith_insurance_claim_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: bad_faith_insurance_claim_calculatorCalculatorInputs, metrics: bad_faith_insurance_claim_calculatorCalculatorMetrics): bad_faith_insurance_claim_calculatorCalculatorAnalysis {
