import { pharmaceutical_liability_calculatorInputs, pharmaceutical_liability_calculatorMetrics, pharmaceutical_liability_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: pharmaceutical_liability_calculatorInputs): number {
...
export function generateAnalysis(inputs: pharmaceutical_liability_calculatorInputs, metrics: pharmaceutical_liability_calculatorMetrics): pharmaceutical_liability_calculatorAnalysis {
