import { fund_level_irr_calculatorCalculatorInputs, fund_level_irr_calculatorCalculatorMetrics, fund_level_irr_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fund_level_irr_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: fund_level_irr_calculatorCalculatorInputs, metrics: fund_level_irr_calculatorCalculatorMetrics): fund_level_irr_calculatorCalculatorAnalysis {
