import { fund_level_irr_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: fund_level_irr_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
