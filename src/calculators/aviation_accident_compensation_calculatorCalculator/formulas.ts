import { aviation_accident_compensation_calculatorCalculatorInputs, aviation_accident_compensation_calculatorCalculatorMetrics, aviation_accident_compensation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: aviation_accident_compensation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: aviation_accident_compensation_calculatorCalculatorInputs, metrics: aviation_accident_compensation_calculatorCalculatorMetrics): aviation_accident_compensation_calculatorCalculatorAnalysis {
