import { reit_calculatorCalculatorInputs, reit_calculatorCalculatorMetrics, reit_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: reit_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: reit_calculatorCalculatorInputs, metrics: reit_calculatorCalculatorMetrics): reit_calculatorCalculatorAnalysis {
