import { flood_risk_zonal_pricing_calculatorInputs, flood_risk_zonal_pricing_calculatorMetrics, flood_risk_zonal_pricing_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: flood_risk_zonal_pricing_calculatorInputs): number {
...
export function generateAnalysis(inputs: flood_risk_zonal_pricing_calculatorInputs, metrics: flood_risk_zonal_pricing_calculatorMetrics): flood_risk_zonal_pricing_calculatorAnalysis {
