import { percentage_calculatorInputs, percentage_calculatorMetrics, percentage_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: percentage_calculatorInputs): number {
...
export function generateAnalysis(inputs: percentage_calculatorInputs, metrics: percentage_calculatorMetrics): percentage_calculatorAnalysis {
