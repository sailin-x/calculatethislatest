import { medical_malpractice_damages_calculatorInputs, medical_malpractice_damages_calculatorMetrics, medical_malpractice_damages_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: medical_malpractice_damages_calculatorInputs): number {
...
export function generateAnalysis(inputs: medical_malpractice_damages_calculatorInputs, metrics: medical_malpractice_damages_calculatorMetrics): medical_malpractice_damages_calculatorAnalysis {
