import { paint_calculatorCalculatorInputs, paint_calculatorCalculatorMetrics, paint_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: paint_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: paint_calculatorCalculatorInputs, metrics: paint_calculatorCalculatorMetrics): paint_calculatorCalculatorAnalysis {
