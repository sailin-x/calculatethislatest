import { registerPensionPlanFundingCalculatorInputs } from './types';

export function validateInputs(inputs: registerPensionPlanFundingCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
