import { registerPensionPlanFundingCalculatorInputs, registerPensionPlanFundingCalculatorMetrics, registerPensionPlanFundingCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerPensionPlanFundingCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerPensionPlanFundingCalculatorInputs, metrics: registerPensionPlanFundingCalculatorMetrics): registerPensionPlanFundingCalculatorAnalysis {
