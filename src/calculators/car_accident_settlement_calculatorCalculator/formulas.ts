import { car_accident_settlement_calculatorCalculatorInputs, car_accident_settlement_calculatorCalculatorMetrics, car_accident_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: car_accident_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: car_accident_settlement_calculatorCalculatorInputs, metrics: car_accident_settlement_calculatorCalculatorMetrics): car_accident_settlement_calculatorCalculatorAnalysis {
