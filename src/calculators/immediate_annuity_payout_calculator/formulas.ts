import { immediate_annuity_payout_calculatorInputs, immediate_annuity_payout_calculatorMetrics, immediate_annuity_payout_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: immediate_annuity_payout_calculatorInputs): number {
...
export function generateAnalysis(inputs: immediate_annuity_payout_calculatorInputs, metrics: immediate_annuity_payout_calculatorMetrics): immediate_annuity_payout_calculatorAnalysis {
