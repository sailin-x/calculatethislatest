import { immediate_annuity_payout_calculatorInputs } from './types';

export function validateInputs(inputs: immediate_annuity_payout_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
