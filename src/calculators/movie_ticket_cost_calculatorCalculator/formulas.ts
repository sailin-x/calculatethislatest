import { movie_ticket_cost_calculatorCalculatorInputs, movie_ticket_cost_calculatorCalculatorMetrics, movie_ticket_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: movie_ticket_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: movie_ticket_cost_calculatorCalculatorInputs, metrics: movie_ticket_cost_calculatorCalculatorMetrics): movie_ticket_cost_calculatorCalculatorAnalysis {
