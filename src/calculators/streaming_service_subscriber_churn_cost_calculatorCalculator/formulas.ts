import { streaming_service_subscriber_churn_cost_calculatorCalculatorInputs, streaming_service_subscriber_churn_cost_calculatorCalculatorMetrics, streaming_service_subscriber_churn_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: streaming_service_subscriber_churn_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: streaming_service_subscriber_churn_cost_calculatorCalculatorInputs, metrics: streaming_service_subscriber_churn_cost_calculatorCalculatorMetrics): streaming_service_subscriber_churn_cost_calculatorCalculatorAnalysis {
