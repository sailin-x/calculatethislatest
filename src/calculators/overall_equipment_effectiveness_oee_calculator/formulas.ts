import { overall_equipment_effectiveness_oee_calculatorInputs, overall_equipment_effectiveness_oee_calculatorMetrics, overall_equipment_effectiveness_oee_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: overall_equipment_effectiveness_oee_calculatorInputs): number {
...
export function generateAnalysis(inputs: overall_equipment_effectiveness_oee_calculatorInputs, metrics: overall_equipment_effectiveness_oee_calculatorMetrics): overall_equipment_effectiveness_oee_calculatorAnalysis {
