import { lean_manufacturing_takt_time_calculatorCalculatorInputs, lean_manufacturing_takt_time_calculatorCalculatorMetrics, lean_manufacturing_takt_time_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: lean_manufacturing_takt_time_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: lean_manufacturing_takt_time_calculatorCalculatorInputs, metrics: lean_manufacturing_takt_time_calculatorCalculatorMetrics): lean_manufacturing_takt_time_calculatorCalculatorAnalysis {
