import { savings_goal_calculatorCalculatorInputs, savings_goal_calculatorCalculatorMetrics, savings_goal_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: savings_goal_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: savings_goal_calculatorCalculatorInputs, metrics: savings_goal_calculatorCalculatorMetrics): savings_goal_calculatorCalculatorAnalysis {
