import { registerRequiredMinimumDistributionRmdCalculatorInputs, registerRequiredMinimumDistributionRmdCalculatorMetrics, registerRequiredMinimumDistributionRmdCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerRequiredMinimumDistributionRmdCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerRequiredMinimumDistributionRmdCalculatorInputs, metrics: registerRequiredMinimumDistributionRmdCalculatorMetrics): registerRequiredMinimumDistributionRmdCalculatorAnalysis {
