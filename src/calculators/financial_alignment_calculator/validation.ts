import { financial_alignment_calculatorInputs } from './types';

export function validateInputs(inputs: financial_alignment_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
