import { financial_alignment_calculatorInputs, financial_alignment_calculatorMetrics, financial_alignment_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_alignment_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_alignment_calculatorInputs, metrics: financial_alignment_calculatorMetrics): financial_alignment_calculatorAnalysis {
