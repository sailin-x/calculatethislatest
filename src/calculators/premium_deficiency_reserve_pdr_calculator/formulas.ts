import { premium_deficiency_reserve_pdr_calculatorInputs, premium_deficiency_reserve_pdr_calculatorMetrics, premium_deficiency_reserve_pdr_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: premium_deficiency_reserve_pdr_calculatorInputs): number {
...
export function generateAnalysis(inputs: premium_deficiency_reserve_pdr_calculatorInputs, metrics: premium_deficiency_reserve_pdr_calculatorMetrics): premium_deficiency_reserve_pdr_calculatorAnalysis {
