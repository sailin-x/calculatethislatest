import { combined_ratio_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: combined_ratio_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
