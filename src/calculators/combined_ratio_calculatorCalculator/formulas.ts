import { combined_ratio_calculatorCalculatorInputs, combined_ratio_calculatorCalculatorMetrics, combined_ratio_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: combined_ratio_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: combined_ratio_calculatorCalculatorInputs, metrics: combined_ratio_calculatorCalculatorMetrics): combined_ratio_calculatorCalculatorAnalysis {
