import { registerCreditCardPayoffCalculatorInputs } from './types';

export function validateInputs(inputs: registerCreditCardPayoffCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
