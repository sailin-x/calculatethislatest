import { registerCreditCardPayoffCalculatorInputs, registerCreditCardPayoffCalculatorMetrics, registerCreditCardPayoffCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerCreditCardPayoffCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerCreditCardPayoffCalculatorInputs, metrics: registerCreditCardPayoffCalculatorMetrics): registerCreditCardPayoffCalculatorAnalysis {
