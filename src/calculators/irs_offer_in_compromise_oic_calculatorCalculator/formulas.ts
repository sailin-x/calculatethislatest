import { irs_offer_in_compromise_oic_calculatorCalculatorInputs, irs_offer_in_compromise_oic_calculatorCalculatorMetrics, irs_offer_in_compromise_oic_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: irs_offer_in_compromise_oic_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: irs_offer_in_compromise_oic_calculatorCalculatorInputs, metrics: irs_offer_in_compromise_oic_calculatorCalculatorMetrics): irs_offer_in_compromise_oic_calculatorCalculatorAnalysis {
