import { basal_metabolic_rate_bmr_calculatorInputs, basal_metabolic_rate_bmr_calculatorMetrics, basal_metabolic_rate_bmr_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: basal_metabolic_rate_bmr_calculatorInputs): number {
...
export function generateAnalysis(inputs: basal_metabolic_rate_bmr_calculatorInputs, metrics: basal_metabolic_rate_bmr_calculatorMetrics): basal_metabolic_rate_bmr_calculatorAnalysis {
