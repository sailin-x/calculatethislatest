import { registerAlimonySpousalSupportCalculatorInputs, registerAlimonySpousalSupportCalculatorMetrics, registerAlimonySpousalSupportCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerAlimonySpousalSupportCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerAlimonySpousalSupportCalculatorInputs, metrics: registerAlimonySpousalSupportCalculatorMetrics): registerAlimonySpousalSupportCalculatorAnalysis {
