import { registerAlimonySpousalSupportCalculatorInputs } from './types';

export function validateInputs(inputs: registerAlimonySpousalSupportCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
