import { body_adiposity_index_calculatorInputs, body_adiposity_index_calculatorMetrics, body_adiposity_index_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: body_adiposity_index_calculatorInputs): number {
...
export function generateAnalysis(inputs: body_adiposity_index_calculatorInputs, metrics: body_adiposity_index_calculatorMetrics): body_adiposity_index_calculatorAnalysis {
