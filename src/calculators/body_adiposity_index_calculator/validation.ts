import { body_adiposity_index_calculatorInputs } from './types';

export function validateInputs(inputs: body_adiposity_index_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
