import { alimony_spousal_support_calculatorInputs, alimony_spousal_support_calculatorMetrics, alimony_spousal_support_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: alimony_spousal_support_calculatorInputs): number {
...
export function generateAnalysis(inputs: alimony_spousal_support_calculatorInputs, metrics: alimony_spousal_support_calculatorMetrics): alimony_spousal_support_calculatorAnalysis {
