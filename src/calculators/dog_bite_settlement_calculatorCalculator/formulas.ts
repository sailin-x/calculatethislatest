import { dog_bite_settlement_calculatorCalculatorInputs, dog_bite_settlement_calculatorCalculatorMetrics, dog_bite_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: dog_bite_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: dog_bite_settlement_calculatorCalculatorInputs, metrics: dog_bite_settlement_calculatorCalculatorMetrics): dog_bite_settlement_calculatorCalculatorAnalysis {
