import { dog_bite_settlement_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: dog_bite_settlement_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
