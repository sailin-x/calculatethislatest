import { term_vs_universal_life_calculatorInputs } from './types';

export function validateInputs(inputs: term_vs_universal_life_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
