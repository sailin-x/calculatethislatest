import { tax_loss_harvesting_calculatorInputs, tax_loss_harvesting_calculatorMetrics, tax_loss_harvesting_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: tax_loss_harvesting_calculatorInputs): number {
...
export function generateAnalysis(inputs: tax_loss_harvesting_calculatorInputs, metrics: tax_loss_harvesting_calculatorMetrics): tax_loss_harvesting_calculatorAnalysis {
