import { hospital_negligence_settlement_calculatorInputs, hospital_negligence_settlement_calculatorMetrics, hospital_negligence_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: hospital_negligence_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: hospital_negligence_settlement_calculatorInputs, metrics: hospital_negligence_settlement_calculatorMetrics): hospital_negligence_settlement_calculatorAnalysis {
