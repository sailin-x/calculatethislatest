import { financial_wellness_calculatorInputs, financial_wellness_calculatorMetrics, financial_wellness_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_wellness_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_wellness_calculatorInputs, metrics: financial_wellness_calculatorMetrics): financial_wellness_calculatorAnalysis {
