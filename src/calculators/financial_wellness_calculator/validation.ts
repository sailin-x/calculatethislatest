import { financial_wellness_calculatorInputs } from './types';

export function validateInputs(inputs: financial_wellness_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
