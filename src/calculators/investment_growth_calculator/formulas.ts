import { investment_growth_calculatorInputs, investment_growth_calculatorMetrics, investment_growth_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: investment_growth_calculatorInputs): number {
...
export function generateAnalysis(inputs: investment_growth_calculatorInputs, metrics: investment_growth_calculatorMetrics): investment_growth_calculatorAnalysis {
