import { investment_growth_calculatorInputs } from './types';

export function validateInputs(inputs: investment_growth_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
