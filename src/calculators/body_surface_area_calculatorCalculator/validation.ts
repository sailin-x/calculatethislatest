import { body_surface_area_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: body_surface_area_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
