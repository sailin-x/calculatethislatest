import { body_surface_area_calculatorCalculatorInputs, body_surface_area_calculatorCalculatorMetrics, body_surface_area_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: body_surface_area_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: body_surface_area_calculatorCalculatorInputs, metrics: body_surface_area_calculatorCalculatorMetrics): body_surface_area_calculatorCalculatorAnalysis {
