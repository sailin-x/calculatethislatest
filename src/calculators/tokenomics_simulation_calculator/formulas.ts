import { tokenomics_simulation_calculatorInputs, tokenomics_simulation_calculatorMetrics, tokenomics_simulation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: tokenomics_simulation_calculatorInputs): number {
...
export function generateAnalysis(inputs: tokenomics_simulation_calculatorInputs, metrics: tokenomics_simulation_calculatorMetrics): tokenomics_simulation_calculatorAnalysis {
