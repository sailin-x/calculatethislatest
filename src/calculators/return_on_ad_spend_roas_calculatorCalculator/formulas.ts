import { return_on_ad_spend_roas_calculatorCalculatorInputs, return_on_ad_spend_roas_calculatorCalculatorMetrics, return_on_ad_spend_roas_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: return_on_ad_spend_roas_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: return_on_ad_spend_roas_calculatorCalculatorInputs, metrics: return_on_ad_spend_roas_calculatorCalculatorMetrics): return_on_ad_spend_roas_calculatorCalculatorAnalysis {
