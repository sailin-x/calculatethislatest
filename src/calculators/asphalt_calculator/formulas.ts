import { asphalt_calculatorInputs, asphalt_calculatorMetrics, asphalt_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: asphalt_calculatorInputs): number {
...
export function generateAnalysis(inputs: asphalt_calculatorInputs, metrics: asphalt_calculatorMetrics): asphalt_calculatorAnalysis {
