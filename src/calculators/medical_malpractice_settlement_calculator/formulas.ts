import { medical_malpractice_settlement_calculatorInputs, medical_malpractice_settlement_calculatorMetrics, medical_malpractice_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: medical_malpractice_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: medical_malpractice_settlement_calculatorInputs, metrics: medical_malpractice_settlement_calculatorMetrics): medical_malpractice_settlement_calculatorAnalysis {
