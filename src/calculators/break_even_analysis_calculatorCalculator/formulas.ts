import { break_even_analysis_calculatorCalculatorInputs, break_even_analysis_calculatorCalculatorMetrics, break_even_analysis_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: break_even_analysis_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: break_even_analysis_calculatorCalculatorInputs, metrics: break_even_analysis_calculatorCalculatorMetrics): break_even_analysis_calculatorCalculatorAnalysis {
