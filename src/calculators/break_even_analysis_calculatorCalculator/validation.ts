import { break_even_analysis_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: break_even_analysis_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
