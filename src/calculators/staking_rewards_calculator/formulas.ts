import { staking_rewards_calculatorInputs, staking_rewards_calculatorMetrics, staking_rewards_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: staking_rewards_calculatorInputs): number {
...
export function generateAnalysis(inputs: staking_rewards_calculatorInputs, metrics: staking_rewards_calculatorMetrics): staking_rewards_calculatorAnalysis {
