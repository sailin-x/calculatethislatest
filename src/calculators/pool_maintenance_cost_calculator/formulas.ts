import { pool_maintenance_cost_calculatorInputs, pool_maintenance_cost_calculatorMetrics, pool_maintenance_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: pool_maintenance_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: pool_maintenance_cost_calculatorInputs, metrics: pool_maintenance_cost_calculatorMetrics): pool_maintenance_cost_calculatorAnalysis {
