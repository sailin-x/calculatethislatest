import { pool_maintenance_cost_calculatorInputs } from './types';

export function validateInputs(inputs: pool_maintenance_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
