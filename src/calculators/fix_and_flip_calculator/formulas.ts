import { fix_and_flip_calculatorInputs, fix_and_flip_calculatorMetrics, fix_and_flip_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fix_and_flip_calculatorInputs): number {
...
export function generateAnalysis(inputs: fix_and_flip_calculatorInputs, metrics: fix_and_flip_calculatorMetrics): fix_and_flip_calculatorAnalysis {
