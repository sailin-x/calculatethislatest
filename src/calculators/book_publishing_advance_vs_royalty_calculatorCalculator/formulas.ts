import { book_publishing_advance_vs_royalty_calculatorCalculatorInputs, book_publishing_advance_vs_royalty_calculatorCalculatorMetrics, book_publishing_advance_vs_royalty_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: book_publishing_advance_vs_royalty_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: book_publishing_advance_vs_royalty_calculatorCalculatorInputs, metrics: book_publishing_advance_vs_royalty_calculatorCalculatorMetrics): book_publishing_advance_vs_royalty_calculatorCalculatorAnalysis {
