import { personalInjuryCalculatorInputs, personalInjuryCalculatorMetrics, personalInjuryCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: personalInjuryCalculatorInputs): number {
...
export function generateAnalysis(inputs: personalInjuryCalculatorInputs, metrics: personalInjuryCalculatorMetrics): personalInjuryCalculatorAnalysis {
