import { spin_off_calculatorInputs, spin_off_calculatorMetrics, spin_off_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: spin_off_calculatorInputs): number {
...
export function generateAnalysis(inputs: spin_off_calculatorInputs, metrics: spin_off_calculatorMetrics): spin_off_calculatorAnalysis {
