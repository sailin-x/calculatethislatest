import { hardiness_calculatorInputs, hardiness_calculatorMetrics, hardiness_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: hardiness_calculatorInputs): number {
...
export function generateAnalysis(inputs: hardiness_calculatorInputs, metrics: hardiness_calculatorMetrics): hardiness_calculatorAnalysis {
