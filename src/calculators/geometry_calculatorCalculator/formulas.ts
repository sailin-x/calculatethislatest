import { geometry_calculatorCalculatorInputs, geometry_calculatorCalculatorMetrics, geometry_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: geometry_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: geometry_calculatorCalculatorInputs, metrics: geometry_calculatorCalculatorMetrics): geometry_calculatorCalculatorAnalysis {
