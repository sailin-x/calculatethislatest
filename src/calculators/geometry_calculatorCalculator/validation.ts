import { geometry_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: geometry_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
