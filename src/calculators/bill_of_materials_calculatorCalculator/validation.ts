import { bill_of_materials_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: bill_of_materials_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
