import { bill_of_materials_calculatorCalculatorInputs, bill_of_materials_calculatorCalculatorMetrics, bill_of_materials_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: bill_of_materials_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: bill_of_materials_calculatorCalculatorInputs, metrics: bill_of_materials_calculatorCalculatorMetrics): bill_of_materials_calculatorCalculatorAnalysis {
