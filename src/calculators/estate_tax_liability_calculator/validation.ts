import { estate_tax_liability_calculatorInputs } from './types';

export function validateInputs(inputs: estate_tax_liability_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
