import { estate_tax_liability_calculatorInputs, estate_tax_liability_calculatorMetrics, estate_tax_liability_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: estate_tax_liability_calculatorInputs): number {
...
export function generateAnalysis(inputs: estate_tax_liability_calculatorInputs, metrics: estate_tax_liability_calculatorMetrics): estate_tax_liability_calculatorAnalysis {
