import { probability_calculatorInputs, probability_calculatorMetrics, probability_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: probability_calculatorInputs): number {
...
export function generateAnalysis(inputs: probability_calculatorInputs, metrics: probability_calculatorMetrics): probability_calculatorAnalysis {
