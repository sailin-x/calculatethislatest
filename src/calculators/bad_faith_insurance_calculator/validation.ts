import { bad_faith_insurance_calculatorInputs } from './types';

export function validateInputs(inputs: bad_faith_insurance_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
