import { bad_faith_insurance_calculatorInputs, bad_faith_insurance_calculatorMetrics, bad_faith_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: bad_faith_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: bad_faith_insurance_calculatorInputs, metrics: bad_faith_insurance_calculatorMetrics): bad_faith_insurance_calculatorAnalysis {
