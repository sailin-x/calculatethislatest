import { overall_equipment_effectiveness_calculatorInputs, overall_equipment_effectiveness_calculatorMetrics, overall_equipment_effectiveness_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: overall_equipment_effectiveness_calculatorInputs): number {
...
export function generateAnalysis(inputs: overall_equipment_effectiveness_calculatorInputs, metrics: overall_equipment_effectiveness_calculatorMetrics): overall_equipment_effectiveness_calculatorAnalysis {
