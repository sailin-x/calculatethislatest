import { overall_equipment_effectiveness_calculatorInputs } from './types';

export function validateInputs(inputs: overall_equipment_effectiveness_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
