import { directors_officers_calculatorInputs, directors_officers_calculatorMetrics, directors_officers_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: directors_officers_calculatorInputs): number {
...
export function generateAnalysis(inputs: directors_officers_calculatorInputs, metrics: directors_officers_calculatorMetrics): directors_officers_calculatorAnalysis {
