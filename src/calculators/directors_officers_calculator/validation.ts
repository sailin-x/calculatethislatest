import { directors_officers_calculatorInputs } from './types';

export function validateInputs(inputs: directors_officers_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
