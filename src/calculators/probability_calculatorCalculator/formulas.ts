import { probability_calculatorCalculatorInputs, probability_calculatorCalculatorMetrics, probability_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: probability_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: probability_calculatorCalculatorInputs, metrics: probability_calculatorCalculatorMetrics): probability_calculatorCalculatorAnalysis {
