import { financial_harmony_calculatorInputs } from './types';

export function validateInputs(inputs: financial_harmony_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
