import { financial_harmony_calculatorInputs, financial_harmony_calculatorMetrics, financial_harmony_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_harmony_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_harmony_calculatorInputs, metrics: financial_harmony_calculatorMetrics): financial_harmony_calculatorAnalysis {
