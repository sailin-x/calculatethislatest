import { forex_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: forex_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
