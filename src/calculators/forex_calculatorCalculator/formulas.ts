import { forex_calculatorCalculatorInputs, forex_calculatorCalculatorMetrics, forex_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: forex_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: forex_calculatorCalculatorInputs, metrics: forex_calculatorCalculatorMetrics): forex_calculatorCalculatorAnalysis {
