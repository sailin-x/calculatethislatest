import { record_label_deal_calculatorCalculatorInputs, record_label_deal_calculatorCalculatorMetrics, record_label_deal_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: record_label_deal_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: record_label_deal_calculatorCalculatorInputs, metrics: record_label_deal_calculatorCalculatorMetrics): record_label_deal_calculatorCalculatorAnalysis {
