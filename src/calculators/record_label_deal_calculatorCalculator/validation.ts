import { record_label_deal_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: record_label_deal_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
