import { taxi_cost_calculatorInputs, taxi_cost_calculatorMetrics, taxi_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: taxi_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: taxi_cost_calculatorInputs, metrics: taxi_cost_calculatorMetrics): taxi_cost_calculatorAnalysis {
