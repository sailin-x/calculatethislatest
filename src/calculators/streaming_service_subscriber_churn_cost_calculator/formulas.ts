import { streaming_service_subscriber_churn_cost_calculatorInputs, streaming_service_subscriber_churn_cost_calculatorMetrics, streaming_service_subscriber_churn_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: streaming_service_subscriber_churn_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: streaming_service_subscriber_churn_cost_calculatorInputs, metrics: streaming_service_subscriber_churn_cost_calculatorMetrics): streaming_service_subscriber_churn_cost_calculatorAnalysis {
