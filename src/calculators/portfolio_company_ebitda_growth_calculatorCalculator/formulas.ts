import { portfolio_company_ebitda_growth_calculatorCalculatorInputs, portfolio_company_ebitda_growth_calculatorCalculatorMetrics, portfolio_company_ebitda_growth_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: portfolio_company_ebitda_growth_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: portfolio_company_ebitda_growth_calculatorCalculatorInputs, metrics: portfolio_company_ebitda_growth_calculatorCalculatorMetrics): portfolio_company_ebitda_growth_calculatorCalculatorAnalysis {
