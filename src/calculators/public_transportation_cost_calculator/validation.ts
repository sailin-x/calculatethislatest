import { public_transportation_cost_calculatorInputs } from './types';

export function validateInputs(inputs: public_transportation_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
