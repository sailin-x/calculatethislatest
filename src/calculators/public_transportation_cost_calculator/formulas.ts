import { public_transportation_cost_calculatorInputs, public_transportation_cost_calculatorMetrics, public_transportation_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: public_transportation_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: public_transportation_cost_calculatorInputs, metrics: public_transportation_cost_calculatorMetrics): public_transportation_cost_calculatorAnalysis {
