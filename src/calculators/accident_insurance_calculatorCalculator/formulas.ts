import { accident_insurance_calculatorCalculatorInputs, accident_insurance_calculatorCalculatorMetrics, accident_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: accident_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: accident_insurance_calculatorCalculatorInputs, metrics: accident_insurance_calculatorCalculatorMetrics): accident_insurance_calculatorCalculatorAnalysis {
