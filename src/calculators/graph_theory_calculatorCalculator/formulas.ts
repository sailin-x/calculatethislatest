import { graph_theory_calculatorCalculatorInputs, graph_theory_calculatorCalculatorMetrics, graph_theory_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: graph_theory_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: graph_theory_calculatorCalculatorInputs, metrics: graph_theory_calculatorCalculatorMetrics): graph_theory_calculatorCalculatorAnalysis {
