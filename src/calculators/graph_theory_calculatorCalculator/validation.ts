import { graph_theory_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: graph_theory_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
