import { loan_comparison_calculatorCalculatorInputs, loan_comparison_calculatorCalculatorMetrics, loan_comparison_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: loan_comparison_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: loan_comparison_calculatorCalculatorInputs, metrics: loan_comparison_calculatorCalculatorMetrics): loan_comparison_calculatorCalculatorAnalysis {
