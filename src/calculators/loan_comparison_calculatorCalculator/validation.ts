import { loan_comparison_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: loan_comparison_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
