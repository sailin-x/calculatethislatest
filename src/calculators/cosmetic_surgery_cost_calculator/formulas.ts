import { cosmetic_surgery_cost_calculatorInputs, cosmetic_surgery_cost_calculatorMetrics, cosmetic_surgery_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cosmetic_surgery_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: cosmetic_surgery_cost_calculatorInputs, metrics: cosmetic_surgery_cost_calculatorMetrics): cosmetic_surgery_cost_calculatorAnalysis {
