import { beta_calculatorCalculatorInputs, beta_calculatorCalculatorMetrics, beta_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: beta_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: beta_calculatorCalculatorInputs, metrics: beta_calculatorCalculatorMetrics): beta_calculatorCalculatorAnalysis {
