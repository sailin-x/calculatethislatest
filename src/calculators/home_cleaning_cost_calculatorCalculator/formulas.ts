import { home_cleaning_cost_calculatorCalculatorInputs, home_cleaning_cost_calculatorCalculatorMetrics, home_cleaning_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: home_cleaning_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: home_cleaning_cost_calculatorCalculatorInputs, metrics: home_cleaning_cost_calculatorCalculatorMetrics): home_cleaning_cost_calculatorCalculatorAnalysis {
