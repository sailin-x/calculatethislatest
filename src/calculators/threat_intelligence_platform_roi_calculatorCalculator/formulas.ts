import { threat_intelligence_platform_roi_calculatorCalculatorInputs, threat_intelligence_platform_roi_calculatorCalculatorMetrics, threat_intelligence_platform_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: threat_intelligence_platform_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: threat_intelligence_platform_roi_calculatorCalculatorInputs, metrics: threat_intelligence_platform_roi_calculatorCalculatorMetrics): threat_intelligence_platform_roi_calculatorCalculatorAnalysis {
