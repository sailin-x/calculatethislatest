import { fela_settlement_calculatorInputs, fela_settlement_calculatorMetrics, fela_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fela_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: fela_settlement_calculatorInputs, metrics: fela_settlement_calculatorMetrics): fela_settlement_calculatorAnalysis {
