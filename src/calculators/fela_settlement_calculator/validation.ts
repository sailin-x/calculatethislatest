import { fela_settlement_calculatorInputs } from './types';

export function validateInputs(inputs: fela_settlement_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
