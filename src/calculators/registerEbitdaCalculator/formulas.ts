import { registerEbitdaCalculatorInputs, registerEbitdaCalculatorMetrics, registerEbitdaCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerEbitdaCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerEbitdaCalculatorInputs, metrics: registerEbitdaCalculatorMetrics): registerEbitdaCalculatorAnalysis {
