import { annuityBuyoutCalculatorInputs, annuityBuyoutCalculatorMetrics, annuityBuyoutCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: annuityBuyoutCalculatorInputs): number {
...
export function generateAnalysis(inputs: annuityBuyoutCalculatorInputs, metrics: annuityBuyoutCalculatorMetrics): annuityBuyoutCalculatorAnalysis {
