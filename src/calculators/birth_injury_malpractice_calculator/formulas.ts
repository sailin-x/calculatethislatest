import { birth_injury_malpractice_calculatorInputs, birth_injury_malpractice_calculatorMetrics, birth_injury_malpractice_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: birth_injury_malpractice_calculatorInputs): number {
...
export function generateAnalysis(inputs: birth_injury_malpractice_calculatorInputs, metrics: birth_injury_malpractice_calculatorMetrics): birth_injury_malpractice_calculatorAnalysis {
