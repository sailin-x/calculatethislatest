import { dui_accident_settlement_calculatorCalculatorInputs, dui_accident_settlement_calculatorCalculatorMetrics, dui_accident_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: dui_accident_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: dui_accident_settlement_calculatorCalculatorInputs, metrics: dui_accident_settlement_calculatorCalculatorMetrics): dui_accident_settlement_calculatorCalculatorAnalysis {
