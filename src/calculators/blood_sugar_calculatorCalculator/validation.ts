import { blood_sugar_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: blood_sugar_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
