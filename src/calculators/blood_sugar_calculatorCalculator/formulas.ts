import { blood_sugar_calculatorCalculatorInputs, blood_sugar_calculatorCalculatorMetrics, blood_sugar_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: blood_sugar_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: blood_sugar_calculatorCalculatorInputs, metrics: blood_sugar_calculatorCalculatorMetrics): blood_sugar_calculatorCalculatorAnalysis {
