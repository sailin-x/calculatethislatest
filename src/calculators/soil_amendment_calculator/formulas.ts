import { soil_amendment_calculatorInputs, soil_amendment_calculatorMetrics, soil_amendment_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: soil_amendment_calculatorInputs): number {
...
export function generateAnalysis(inputs: soil_amendment_calculatorInputs, metrics: soil_amendment_calculatorMetrics): soil_amendment_calculatorAnalysis {
