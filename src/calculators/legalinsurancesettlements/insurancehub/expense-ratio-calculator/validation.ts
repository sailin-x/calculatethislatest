import { expense_ratio_calculatorInputs } from './types';
...
export function validateexpense_ratio_calculatorInputs(inputs: expense_ratio_calculatorInputs): ValidationResult[] {
...
export function validateexpense_ratio_calculatorBusinessRules(inputs: expense_ratio_calculatorInputs): ValidationResult[] {
