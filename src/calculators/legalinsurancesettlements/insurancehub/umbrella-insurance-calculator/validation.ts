import { umbrella_insurance_calculatorInputs } from './types';
...
export function validateumbrella_insurance_calculatorInputs(inputs: umbrella_insurance_calculatorInputs): ValidationResult[] {
...
export function validateumbrella_insurance_calculatorBusinessRules(inputs: umbrella_insurance_calculatorInputs): ValidationResult[] {
