import { loss_ratio_calculatorInputs } from './types';
...
export function validateloss_ratio_calculatorInputs(inputs: loss_ratio_calculatorInputs): ValidationResult[] {
...
export function validateloss_ratio_calculatorBusinessRules(inputs: loss_ratio_calculatorInputs): ValidationResult[] {
