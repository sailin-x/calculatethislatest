import { wildfire-risk-scoring-calculatorInputs, wildfire-risk-scoring-calculatorMetrics, wildfire-risk-scoring-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: wildfire-risk-scoring-calculatorInputs): number {
...
export function generateAnalysis(inputs: wildfire-risk-scoring-calculatorInputs, metrics: wildfire-risk-scoring-calculatorMetrics): wildfire-risk-scoring-calculatorAnalysis {
