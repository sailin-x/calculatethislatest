...
export const WildfireRiskScoring-calculator: Calculator = {
  ...
  description: 'Calculate Wildfire Risk Scoring Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Wildfire Risk Scoring Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Wildfire Risk Scoring Calculator calculation',
