import { actuarial-mortality-table-calculatorInputs, actuarial-mortality-table-calculatorMetrics, actuarial-mortality-table-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: actuarial-mortality-table-calculatorInputs): number {
...
export function generateAnalysis(inputs: actuarial-mortality-table-calculatorInputs, metrics: actuarial-mortality-table-calculatorMetrics): actuarial-mortality-table-calculatorAnalysis {
