import { ActuarialMortalityTable-calculatorInputs, ActuarialMortalityTable-calculatorMetrics, ActuarialMortalityTable-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ActuarialMortalityTable-calculatorInputs): number {
...
export function generateAnalysis(inputs: ActuarialMortalityTable-calculatorInputs, metrics: ActuarialMortalityTable-calculatorMetrics): ActuarialMortalityTable-calculatorAnalysis {
