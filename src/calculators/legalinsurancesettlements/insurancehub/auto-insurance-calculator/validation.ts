import { auto_insurance_calculatorInputs } from './types';
...
export function validateauto_insurance_calculatorInputs(inputs: auto_insurance_calculatorInputs): ValidationResult[] {
...
export function validateauto_insurance_calculatorBusinessRules(inputs: auto_insurance_calculatorInputs): ValidationResult[] {
