import { travel_insurance_calculatorInputs } from './types';
...
export function validatetravel_insurance_calculatorInputs(inputs: travel_insurance_calculatorInputs): ValidationResult[] {
...
export function validatetravel_insurance_calculatorBusinessRules(inputs: travel_insurance_calculatorInputs): ValidationResult[] {
