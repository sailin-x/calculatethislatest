...
export const marine_cargo_insurance_premium_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Marine Cargo Insurance Premium Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Marine Cargo Insurance Premium Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Marine Cargo Insurance Premium Calculator calculation',
