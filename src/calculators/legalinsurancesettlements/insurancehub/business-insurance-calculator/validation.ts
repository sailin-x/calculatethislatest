import { business_insurance_calculatorInputs } from './types';
...
export function validatebusiness_insurance_calculatorInputs(inputs: business_insurance_calculatorInputs): ValidationResult[] {
...
export function validatebusiness_insurance_calculatorBusinessRules(inputs: business_insurance_calculatorInputs): ValidationResult[] {
