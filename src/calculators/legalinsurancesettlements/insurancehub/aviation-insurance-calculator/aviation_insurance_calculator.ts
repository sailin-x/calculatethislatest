...
export const AviationInsuranceCalculator: Calculator = {
  ...
  description: 'Calculate Aviation Insurance Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Aviation Insurance Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Aviation Insurance Calculator calculation',
