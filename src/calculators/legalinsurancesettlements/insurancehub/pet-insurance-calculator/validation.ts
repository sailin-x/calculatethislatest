import { pet_insurance_calculatorInputs } from './types';
...
export function validatepet_insurance_calculatorInputs(inputs: pet_insurance_calculatorInputs): ValidationResult[] {
...
export function validatepet_insurance_calculatorBusinessRules(inputs: pet_insurance_calculatorInputs): ValidationResult[] {
