import { liability_insurance_calculatorInputs } from './types';
...
export function validateliability_insurance_calculatorInputs(inputs: liability_insurance_calculatorInputs): ValidationResult[] {
...
export function validateliability_insurance_calculatorBusinessRules(inputs: liability_insurance_calculatorInputs): ValidationResult[] {
