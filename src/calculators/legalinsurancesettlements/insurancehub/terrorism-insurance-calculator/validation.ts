import { terrorism_insurance_calculatorInputs } from './types';
...
export function validateterrorism_insurance_calculatorInputs(inputs: terrorism_insurance_calculatorInputs): ValidationResult[] {
...
export function validateterrorism_insurance_calculatorBusinessRules(inputs: terrorism_insurance_calculatorInputs): ValidationResult[] {
