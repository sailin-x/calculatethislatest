import { EmploymentPracticesLiability-calculatorInputs, EmploymentPracticesLiability-calculatorMetrics, EmploymentPracticesLiability-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: EmploymentPracticesLiability-calculatorInputs): number {
...
export function generateAnalysis(inputs: EmploymentPracticesLiability-calculatorInputs, metrics: EmploymentPracticesLiability-calculatorMetrics): EmploymentPracticesLiability-calculatorAnalysis {
