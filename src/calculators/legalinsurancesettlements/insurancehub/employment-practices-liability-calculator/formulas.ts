import { employment-practices-liability-calculatorInputs, employment-practices-liability-calculatorMetrics, employment-practices-liability-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: employment-practices-liability-calculatorInputs): number {
...
export function generateAnalysis(inputs: employment-practices-liability-calculatorInputs, metrics: employment-practices-liability-calculatorMetrics): employment-practices-liability-calculatorAnalysis {
