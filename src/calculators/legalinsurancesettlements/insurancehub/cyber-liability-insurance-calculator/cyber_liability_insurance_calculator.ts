...
export const CyberLiabilityInsurance-calculator: Calculator = {
  ...
  description: 'Calculate Cyber Liability Insurance Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Cyber Liability Insurance Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Cyber Liability Insurance Calculator calculation',
