...
export const GeneralLiabilityInsurance-calculator: Calculator = {
  ...
  description: 'Calculate General Liability Insurance Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your General Liability Insurance Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic General Liability Insurance Calculator calculation',
