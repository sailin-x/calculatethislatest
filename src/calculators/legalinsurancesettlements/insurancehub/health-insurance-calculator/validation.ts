import { health_insurance_calculatorInputs } from './types';
...
export function validatehealth_insurance_calculatorInputs(inputs: health_insurance_calculatorInputs): ValidationResult[] {
...
export function validatehealth_insurance_calculatorBusinessRules(inputs: health_insurance_calculatorInputs): ValidationResult[] {
