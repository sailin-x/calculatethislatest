import { surety_bond_premium_calculatorInputs } from './types';
...
export function validatesurety_bond_premium_calculatorInputs(inputs: surety_bond_premium_calculatorInputs): ValidationResult[] {
...
export function validatesurety_bond_premium_calculatorBusinessRules(inputs: surety_bond_premium_calculatorInputs): ValidationResult[] {
