import { CombinedRatioCalculatorinputs, CombinedRatioCalculatormetrics, CombinedRatioCalculatoranalysis } from './types';
...
export function calculateResult(inputs: CombinedRatioCalculatorinputs): number {
...
export function generateAnalysis(inputs: CombinedRatioCalculatorinputs, metrics: CombinedRatioCalculatormetrics): CombinedRatioCalculatoranalysis {
