...
export const CombinedRatioCalculator: Calculator = {
  ...
  description: 'Calculate Combined Ratio Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Combined Ratio Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Combined Ratio Calculator calculation',
