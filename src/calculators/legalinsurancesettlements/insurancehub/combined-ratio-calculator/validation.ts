import { combined_ratio_calculatorInputs } from './types';
...
export function validatecombined_ratio_calculatorInputs(inputs: combined_ratio_calculatorInputs): ValidationResult[] {
...
export function validatecombined_ratio_calculatorBusinessRules(inputs: combined_ratio_calculatorInputs): ValidationResult[] {
