...
export const car_accident_pain_suffering_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Car Accident Pain & Suffering Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Car Accident Pain & Suffering Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Car Accident Pain & Suffering Calculator calculation',
