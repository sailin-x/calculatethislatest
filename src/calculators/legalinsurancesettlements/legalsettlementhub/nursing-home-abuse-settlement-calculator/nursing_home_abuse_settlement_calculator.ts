...
export const nursing_home_abuse_settlement_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Nursing Home Abuse Settlement Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Nursing Home Abuse Settlement Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Nursing Home Abuse Settlement Calculator calculation',
