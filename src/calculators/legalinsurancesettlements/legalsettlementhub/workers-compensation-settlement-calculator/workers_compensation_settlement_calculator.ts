...
export const WorkersCompensationSettlement-calculator: Calculator = {
  ...
  description: 'Calculate Workers' Compensation Settlement Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Workers' Compensation Settlement Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Workers' Compensation Settlement Calculator calculation',
