import { roundup_settlement_calculatorInputs } from './types';
...
export function validateroundup_settlement_calculatorInputs(inputs: roundup_settlement_calculatorInputs): ValidationResult[] {
...
export function validateroundup_settlement_calculatorBusinessRules(inputs: roundup_settlement_calculatorInputs): ValidationResult[] {
