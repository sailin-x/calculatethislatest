import { medical-device-liability-calculatorInputs, medical-device-liability-calculatorMetrics, medical-device-liability-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: medical-device-liability-calculatorInputs): number {
...
export function generateAnalysis(inputs: medical-device-liability-calculatorInputs, metrics: medical-device-liability-calculatorMetrics): medical-device-liability-calculatorAnalysis {
