import { child_support_calculatorInputs } from './types';
...
export function validatechild_support_calculatorInputs(inputs: child_support_calculatorInputs): ValidationResult[] {
...
export function validatechild_support_calculatorBusinessRules(inputs: child_support_calculatorInputs): ValidationResult[] {
