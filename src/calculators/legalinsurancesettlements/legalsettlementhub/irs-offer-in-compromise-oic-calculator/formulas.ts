import { IrsOfferIn-CompromiseOicCalculatorinputs, IrsOfferIn-CompromiseOicCalculatormetrics, IrsOfferIn-CompromiseOicCalculatoranalysis } from './types';
...
export function calculateResult(inputs: IrsOfferIn-CompromiseOicCalculatorinputs): number {
...
export function generateAnalysis(inputs: IrsOfferIn-CompromiseOicCalculatorinputs, metrics: IrsOfferIn-CompromiseOicCalculatormetrics): IrsOfferIn-CompromiseOicCalculatoranalysis {
