import { irs-offer-in-compromise-oic-calculatorInputs, irs-offer-in-compromise-oic-calculatorMetrics, irs-offer-in-compromise-oic-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: irs-offer-in-compromise-oic-calculatorInputs): number {
...
export function generateAnalysis(inputs: irs-offer-in-compromise-oic-calculatorInputs, metrics: irs-offer-in-compromise-oic-calculatorMetrics): irs-offer-in-compromise-oic-calculatorAnalysis {
