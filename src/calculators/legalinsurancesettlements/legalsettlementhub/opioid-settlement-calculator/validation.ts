import { opioid_settlement_calculatorInputs } from './types';
...
export function validateopioid_settlement_calculatorInputs(inputs: opioid_settlement_calculatorInputs): ValidationResult[] {
...
export function validateopioid_settlement_calculatorBusinessRules(inputs: opioid_settlement_calculatorInputs): ValidationResult[] {
