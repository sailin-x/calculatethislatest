import { antitrust_hhi_index_calculatorInputs } from './types';
...
export function validateantitrust_hhi_index_calculatorInputs(inputs: antitrust_hhi_index_calculatorInputs): ValidationResult[] {
...
export function validateantitrust_hhi_index_calculatorBusinessRules(inputs: antitrust_hhi_index_calculatorInputs): ValidationResult[] {
