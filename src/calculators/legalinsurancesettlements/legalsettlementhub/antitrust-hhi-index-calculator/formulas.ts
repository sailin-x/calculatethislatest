import { AntitrustHhiIndex-calculatorInputs, AntitrustHhiIndex-calculatorMetrics, AntitrustHhiIndex-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: AntitrustHhiIndex-calculatorInputs): number {
...
export function generateAnalysis(inputs: AntitrustHhiIndex-calculatorInputs, metrics: AntitrustHhiIndex-calculatorMetrics): AntitrustHhiIndex-calculatorAnalysis {
