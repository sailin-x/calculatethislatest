import { antitrust-hhi-index-calculatorInputs, antitrust-hhi-index-calculatorMetrics, antitrust-hhi-index-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: antitrust-hhi-index-calculatorInputs): number {
...
export function generateAnalysis(inputs: antitrust-hhi-index-calculatorInputs, metrics: antitrust-hhi-index-calculatorMetrics): antitrust-hhi-index-calculatorAnalysis {
