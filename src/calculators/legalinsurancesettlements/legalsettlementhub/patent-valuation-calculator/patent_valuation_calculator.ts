...
export const PatentValuationCalculator: Calculator = {
  ...
  description: 'Calculate Patent Valuation Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Patent Valuation Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Patent Valuation Calculator calculation',
