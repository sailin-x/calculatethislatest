...
export const personal_injury_multiplier_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Personal Injury Multiplier Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Personal Injury Multiplier Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Personal Injury Multiplier Calculator calculation',
