import { PharmaceuticalLiabilityCalculatorinputs, PharmaceuticalLiabilityCalculatormetrics, PharmaceuticalLiabilityCalculatoranalysis } from './types';
...
export function calculateResult(inputs: PharmaceuticalLiabilityCalculatorinputs): number {
...
export function generateAnalysis(inputs: PharmaceuticalLiabilityCalculatorinputs, metrics: PharmaceuticalLiabilityCalculatormetrics): PharmaceuticalLiabilityCalculatoranalysis {
