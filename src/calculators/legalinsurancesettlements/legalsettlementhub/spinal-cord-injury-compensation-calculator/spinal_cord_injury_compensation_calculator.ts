...
export const SpinalCordInjury-compensation-calculator: Calculator = {
  ...
  description: 'Calculate Spinal Cord Injury Compensation Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Spinal Cord Injury Compensation Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Spinal Cord Injury Compensation Calculator calculation',
