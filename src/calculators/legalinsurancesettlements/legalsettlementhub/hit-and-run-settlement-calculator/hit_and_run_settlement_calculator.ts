...
export const HitAndRun-settlement-calculator: Calculator = {
  ...
  description: 'Calculate Hit and Run Settlement Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Hit and Run Settlement Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Hit and Run Settlement Calculator calculation',
