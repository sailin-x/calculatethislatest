import { veterinary-malpractice-calculatorInputs, veterinary-malpractice-calculatorMetrics, veterinary-malpractice-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: veterinary-malpractice-calculatorInputs): number {
...
export function generateAnalysis(inputs: veterinary-malpractice-calculatorInputs, metrics: veterinary-malpractice-calculatorMetrics): veterinary-malpractice-calculatorAnalysis {
