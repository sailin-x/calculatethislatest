...
export const VeterinaryMalpracticeCalculator: Calculator = {
  ...
  description: 'Calculate Veterinary Malpractice Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Veterinary Malpractice Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Veterinary Malpractice Calculator calculation',
