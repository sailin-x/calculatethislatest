import { asbestos_settlement_calculatorInputs } from './types';
...
export function validateasbestos_settlement_calculatorInputs(inputs: asbestos_settlement_calculatorInputs): ValidationResult[] {
...
export function validateasbestos_settlement_calculatorBusinessRules(inputs: asbestos_settlement_calculatorInputs): ValidationResult[] {
