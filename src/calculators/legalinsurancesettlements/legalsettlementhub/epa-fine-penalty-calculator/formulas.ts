import { epa-fine-penalty-calculatorInputs, epa-fine-penalty-calculatorMetrics, epa-fine-penalty-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: epa-fine-penalty-calculatorInputs): number {
...
export function generateAnalysis(inputs: epa-fine-penalty-calculatorInputs, metrics: epa-fine-penalty-calculatorMetrics): epa-fine-penalty-calculatorAnalysis {
