...
export const burn_injury_settlement_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Burn Injury Settlement Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Burn Injury Settlement Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Burn Injury Settlement Calculator calculation',
