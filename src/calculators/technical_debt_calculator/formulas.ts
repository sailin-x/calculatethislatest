import { technical_debt_calculatorInputs, technical_debt_calculatorMetrics, technical_debt_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: technical_debt_calculatorInputs): number {
...
export function generateAnalysis(inputs: technical_debt_calculatorInputs, metrics: technical_debt_calculatorMetrics): technical_debt_calculatorAnalysis {
