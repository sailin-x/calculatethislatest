import { intellectual_property_licensing_calculatorCalculatorInputs, intellectual_property_licensing_calculatorCalculatorMetrics, intellectual_property_licensing_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: intellectual_property_licensing_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: intellectual_property_licensing_calculatorCalculatorInputs, metrics: intellectual_property_licensing_calculatorCalculatorMetrics): intellectual_property_licensing_calculatorCalculatorAnalysis {
