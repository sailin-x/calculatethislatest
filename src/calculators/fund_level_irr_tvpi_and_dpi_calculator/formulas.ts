import { fund_level_irr_tvpi_and_dpi_calculatorInputs, fund_level_irr_tvpi_and_dpi_calculatorMetrics, fund_level_irr_tvpi_and_dpi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fund_level_irr_tvpi_and_dpi_calculatorInputs): number {
...
export function generateAnalysis(inputs: fund_level_irr_tvpi_and_dpi_calculatorInputs, metrics: fund_level_irr_tvpi_and_dpi_calculatorMetrics): fund_level_irr_tvpi_and_dpi_calculatorAnalysis {
