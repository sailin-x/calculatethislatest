import { income_based_repayment_calculatorInputs, income_based_repayment_calculatorMetrics, income_based_repayment_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: income_based_repayment_calculatorInputs): number {
...
export function generateAnalysis(inputs: income_based_repayment_calculatorInputs, metrics: income_based_repayment_calculatorMetrics): income_based_repayment_calculatorAnalysis {
