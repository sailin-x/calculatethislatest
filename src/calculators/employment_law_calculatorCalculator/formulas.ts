import { employment_law_calculatorCalculatorInputs, employment_law_calculatorCalculatorMetrics, employment_law_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: employment_law_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: employment_law_calculatorCalculatorInputs, metrics: employment_law_calculatorCalculatorMetrics): employment_law_calculatorCalculatorAnalysis {
