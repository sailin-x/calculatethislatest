import { employment_law_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: employment_law_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
