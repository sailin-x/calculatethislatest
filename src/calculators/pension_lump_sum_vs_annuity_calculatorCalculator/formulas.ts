import { pension_lump_sum_vs_annuity_calculatorCalculatorInputs, pension_lump_sum_vs_annuity_calculatorCalculatorMetrics, pension_lump_sum_vs_annuity_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: pension_lump_sum_vs_annuity_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: pension_lump_sum_vs_annuity_calculatorCalculatorInputs, metrics: pension_lump_sum_vs_annuity_calculatorCalculatorMetrics): pension_lump_sum_vs_annuity_calculatorCalculatorAnalysis {
