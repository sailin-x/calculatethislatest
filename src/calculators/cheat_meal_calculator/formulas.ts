import { cheat_meal_calculatorInputs, cheat_meal_calculatorMetrics, cheat_meal_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cheat_meal_calculatorInputs): number {
...
export function generateAnalysis(inputs: cheat_meal_calculatorInputs, metrics: cheat_meal_calculatorMetrics): cheat_meal_calculatorAnalysis {
