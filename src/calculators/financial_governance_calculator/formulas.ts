import { financial_governance_calculatorInputs, financial_governance_calculatorMetrics, financial_governance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_governance_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_governance_calculatorInputs, metrics: financial_governance_calculatorMetrics): financial_governance_calculatorAnalysis {
