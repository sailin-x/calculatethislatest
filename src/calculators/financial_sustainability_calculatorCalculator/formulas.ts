import { financial_sustainability_calculatorCalculatorInputs, financial_sustainability_calculatorCalculatorMetrics, financial_sustainability_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_sustainability_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_sustainability_calculatorCalculatorInputs, metrics: financial_sustainability_calculatorCalculatorMetrics): financial_sustainability_calculatorCalculatorAnalysis {
