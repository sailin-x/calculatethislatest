import { physical_therapy_cost_calculatorCalculatorInputs, physical_therapy_cost_calculatorCalculatorMetrics, physical_therapy_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: physical_therapy_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: physical_therapy_cost_calculatorCalculatorInputs, metrics: physical_therapy_cost_calculatorCalculatorMetrics): physical_therapy_cost_calculatorCalculatorAnalysis {
