import { rental_yieldCalculatorInputs, rental_yieldCalculatorMetrics, rental_yieldCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: rental_yieldCalculatorInputs): number {
...
export function generateAnalysis(inputs: rental_yieldCalculatorInputs, metrics: rental_yieldCalculatorMetrics): rental_yieldCalculatorAnalysis {
