import { profit_margin_calculatorCalculatorInputs, profit_margin_calculatorCalculatorMetrics, profit_margin_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: profit_margin_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: profit_margin_calculatorCalculatorInputs, metrics: profit_margin_calculatorCalculatorMetrics): profit_margin_calculatorCalculatorAnalysis {
