import { opioid_settlement_calculatorCalculatorInputs, opioid_settlement_calculatorCalculatorMetrics, opioid_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: opioid_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: opioid_settlement_calculatorCalculatorInputs, metrics: opioid_settlement_calculatorCalculatorMetrics): opioid_settlement_calculatorCalculatorAnalysis {
