import { planned_giving_calculatorCalculatorInputs, planned_giving_calculatorCalculatorMetrics, planned_giving_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: planned_giving_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: planned_giving_calculatorCalculatorInputs, metrics: planned_giving_calculatorCalculatorMetrics): planned_giving_calculatorCalculatorAnalysis {
