import { planned_giving_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: planned_giving_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
