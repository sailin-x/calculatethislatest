import { healthSavingsAccountHsaCalculatorInputs, healthSavingsAccountHsaCalculatorMetrics, healthSavingsAccountHsaCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: healthSavingsAccountHsaCalculatorInputs): number {
...
export function generateAnalysis(inputs: healthSavingsAccountHsaCalculatorInputs, metrics: healthSavingsAccountHsaCalculatorMetrics): healthSavingsAccountHsaCalculatorAnalysis {
