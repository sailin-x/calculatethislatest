import { information_ratio_calculatorInputs, information_ratio_calculatorMetrics, information_ratio_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: information_ratio_calculatorInputs): number {
...
export function generateAnalysis(inputs: information_ratio_calculatorInputs, metrics: information_ratio_calculatorMetrics): information_ratio_calculatorAnalysis {
