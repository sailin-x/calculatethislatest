import { errors_omissions_insurance_calculatorInputs, errors_omissions_insurance_calculatorMetrics, errors_omissions_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: errors_omissions_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: errors_omissions_insurance_calculatorInputs, metrics: errors_omissions_insurance_calculatorMetrics): errors_omissions_insurance_calculatorAnalysis {
