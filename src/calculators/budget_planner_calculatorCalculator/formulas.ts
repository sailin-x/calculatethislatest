import { budget_planner_calculatorCalculatorInputs, budget_planner_calculatorCalculatorMetrics, budget_planner_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: budget_planner_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: budget_planner_calculatorCalculatorInputs, metrics: budget_planner_calculatorCalculatorMetrics): budget_planner_calculatorCalculatorAnalysis {
