import { grantor_retained_annuity_trust_grat_calculatorCalculatorInputs, grantor_retained_annuity_trust_grat_calculatorCalculatorMetrics, grantor_retained_annuity_trust_grat_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: grantor_retained_annuity_trust_grat_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: grantor_retained_annuity_trust_grat_calculatorCalculatorInputs, metrics: grantor_retained_annuity_trust_grat_calculatorCalculatorMetrics): grantor_retained_annuity_trust_grat_calculatorCalculatorAnalysis {
