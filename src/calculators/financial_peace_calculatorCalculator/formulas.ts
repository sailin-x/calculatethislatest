import { financial_peace_calculatorCalculatorInputs, financial_peace_calculatorCalculatorMetrics, financial_peace_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_peace_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_peace_calculatorCalculatorInputs, metrics: financial_peace_calculatorCalculatorMetrics): financial_peace_calculatorCalculatorAnalysis {
