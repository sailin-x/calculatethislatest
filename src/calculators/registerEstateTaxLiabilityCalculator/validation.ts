import { registerEstateTaxLiabilityCalculatorInputs } from './types';

export function validateInputs(inputs: registerEstateTaxLiabilityCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
