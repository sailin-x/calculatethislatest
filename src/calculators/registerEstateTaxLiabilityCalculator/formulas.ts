import { registerEstateTaxLiabilityCalculatorInputs, registerEstateTaxLiabilityCalculatorMetrics, registerEstateTaxLiabilityCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerEstateTaxLiabilityCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerEstateTaxLiabilityCalculatorInputs, metrics: registerEstateTaxLiabilityCalculatorMetrics): registerEstateTaxLiabilityCalculatorAnalysis {
