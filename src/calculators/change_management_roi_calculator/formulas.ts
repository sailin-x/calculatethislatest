import { change_management_roi_calculatorInputs, change_management_roi_calculatorMetrics, change_management_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: change_management_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: change_management_roi_calculatorInputs, metrics: change_management_roi_calculatorMetrics): change_management_roi_calculatorAnalysis {
