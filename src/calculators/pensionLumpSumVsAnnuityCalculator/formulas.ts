import { pensionLumpSumVsAnnuityCalculatorInputs, pensionLumpSumVsAnnuityCalculatorMetrics, pensionLumpSumVsAnnuityCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: pensionLumpSumVsAnnuityCalculatorInputs): number {
...
export function generateAnalysis(inputs: pensionLumpSumVsAnnuityCalculatorInputs, metrics: pensionLumpSumVsAnnuityCalculatorMetrics): pensionLumpSumVsAnnuityCalculatorAnalysis {
