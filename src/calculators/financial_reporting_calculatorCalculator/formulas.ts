import { financial_reporting_calculatorCalculatorInputs, financial_reporting_calculatorCalculatorMetrics, financial_reporting_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_reporting_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_reporting_calculatorCalculatorInputs, metrics: financial_reporting_calculatorCalculatorMetrics): financial_reporting_calculatorCalculatorAnalysis {
