import { testosterone_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: testosterone_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
