import { guideline_premium_test_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: guideline_premium_test_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
