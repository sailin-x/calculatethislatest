import { guideline_premium_test_calculatorCalculatorInputs, guideline_premium_test_calculatorCalculatorMetrics, guideline_premium_test_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: guideline_premium_test_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: guideline_premium_test_calculatorCalculatorInputs, metrics: guideline_premium_test_calculatorCalculatorMetrics): guideline_premium_test_calculatorCalculatorAnalysis {
