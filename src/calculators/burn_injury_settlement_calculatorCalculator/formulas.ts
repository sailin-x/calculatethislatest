import { burn_injury_settlement_calculatorCalculatorInputs, burn_injury_settlement_calculatorCalculatorMetrics, burn_injury_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: burn_injury_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: burn_injury_settlement_calculatorCalculatorInputs, metrics: burn_injury_settlement_calculatorCalculatorMetrics): burn_injury_settlement_calculatorCalculatorAnalysis {
