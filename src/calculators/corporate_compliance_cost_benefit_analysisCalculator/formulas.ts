import { corporate_compliance_cost_benefit_analysisCalculatorInputs, corporate_compliance_cost_benefit_analysisCalculatorMetrics, corporate_compliance_cost_benefit_analysisCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: corporate_compliance_cost_benefit_analysisCalculatorInputs): number {
...
export function generateAnalysis(inputs: corporate_compliance_cost_benefit_analysisCalculatorInputs, metrics: corporate_compliance_cost_benefit_analysisCalculatorMetrics): corporate_compliance_cost_benefit_analysisCalculatorAnalysis {
