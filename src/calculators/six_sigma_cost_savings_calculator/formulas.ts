import { six_sigma_cost_savings_calculatorInputs, six_sigma_cost_savings_calculatorMetrics, six_sigma_cost_savings_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: six_sigma_cost_savings_calculatorInputs): number {
...
export function generateAnalysis(inputs: six_sigma_cost_savings_calculatorInputs, metrics: six_sigma_cost_savings_calculatorMetrics): six_sigma_cost_savings_calculatorAnalysis {
