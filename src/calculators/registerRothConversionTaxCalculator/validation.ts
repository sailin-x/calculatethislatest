import { registerRothConversionTaxCalculatorInputs } from './types';

export function validateInputs(inputs: registerRothConversionTaxCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
