import { registerRothConversionTaxCalculatorInputs, registerRothConversionTaxCalculatorMetrics, registerRothConversionTaxCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerRothConversionTaxCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerRothConversionTaxCalculatorInputs, metrics: registerRothConversionTaxCalculatorMetrics): registerRothConversionTaxCalculatorAnalysis {
