import { capital_structure_optimization_calculatorInputs, capital_structure_optimization_calculatorMetrics, capital_structure_optimization_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: capital_structure_optimization_calculatorInputs): number {
...
export function generateAnalysis(inputs: capital_structure_optimization_calculatorInputs, metrics: capital_structure_optimization_calculatorMetrics): capital_structure_optimization_calculatorAnalysis {
