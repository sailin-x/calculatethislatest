import { rv_rental_cost_calculatorInputs, rv_rental_cost_calculatorMetrics, rv_rental_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: rv_rental_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: rv_rental_cost_calculatorInputs, metrics: rv_rental_cost_calculatorMetrics): rv_rental_cost_calculatorAnalysis {
