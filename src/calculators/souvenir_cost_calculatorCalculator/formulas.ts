import { souvenir_cost_calculatorCalculatorInputs, souvenir_cost_calculatorCalculatorMetrics, souvenir_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: souvenir_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: souvenir_cost_calculatorCalculatorInputs, metrics: souvenir_cost_calculatorCalculatorMetrics): souvenir_cost_calculatorCalculatorAnalysis {
