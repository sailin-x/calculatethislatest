import { roofing_repair_cost_calculatorInputs } from './types';

export function validateInputs(inputs: roofing_repair_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
