import { roofing_repair_cost_calculatorInputs, roofing_repair_cost_calculatorMetrics, roofing_repair_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: roofing_repair_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: roofing_repair_cost_calculatorInputs, metrics: roofing_repair_cost_calculatorMetrics): roofing_repair_cost_calculatorAnalysis {
