import { registerCostOfEquityCalculatorInputs } from './types';

export function validateInputs(inputs: registerCostOfEquityCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
