import { registerCostOfEquityCalculatorInputs, registerCostOfEquityCalculatorMetrics, registerCostOfEquityCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerCostOfEquityCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerCostOfEquityCalculatorInputs, metrics: registerCostOfEquityCalculatorMetrics): registerCostOfEquityCalculatorAnalysis {
