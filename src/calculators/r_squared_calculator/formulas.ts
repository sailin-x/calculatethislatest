import { r_squared_calculatorInputs, r_squared_calculatorMetrics, r_squared_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: r_squared_calculatorInputs): number {
...
export function generateAnalysis(inputs: r_squared_calculatorInputs, metrics: r_squared_calculatorMetrics): r_squared_calculatorAnalysis {
