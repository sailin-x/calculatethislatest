import { railroad_accident_settlement_calculatorInputs, railroad_accident_settlement_calculatorMetrics, railroad_accident_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: railroad_accident_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: railroad_accident_settlement_calculatorInputs, metrics: railroad_accident_settlement_calculatorMetrics): railroad_accident_settlement_calculatorAnalysis {
