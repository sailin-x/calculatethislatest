import { corporate_tax_shield_calculatorInputs, corporate_tax_shield_calculatorMetrics, corporate_tax_shield_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: corporate_tax_shield_calculatorInputs): number {
...
export function generateAnalysis(inputs: corporate_tax_shield_calculatorInputs, metrics: corporate_tax_shield_calculatorMetrics): corporate_tax_shield_calculatorAnalysis {
