import { budget_planner_calculatorInputs, budget_planner_calculatorMetrics, budget_planner_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: budget_planner_calculatorInputs): number {
...
export function generateAnalysis(inputs: budget_planner_calculatorInputs, metrics: budget_planner_calculatorMetrics): budget_planner_calculatorAnalysis {
