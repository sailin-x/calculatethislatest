import { personal_trainer_cost_calculatorInputs } from './types';

export function validateInputs(inputs: personal_trainer_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
