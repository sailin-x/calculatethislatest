import { personal_trainer_cost_calculatorInputs, personal_trainer_cost_calculatorMetrics, personal_trainer_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: personal_trainer_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: personal_trainer_cost_calculatorInputs, metrics: personal_trainer_cost_calculatorMetrics): personal_trainer_cost_calculatorAnalysis {
