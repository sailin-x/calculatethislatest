import { distressed_debt_calculatorInputs, distressed_debt_calculatorMetrics, distressed_debt_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: distressed_debt_calculatorInputs): number {
...
export function generateAnalysis(inputs: distressed_debt_calculatorInputs, metrics: distressed_debt_calculatorMetrics): distressed_debt_calculatorAnalysis {
