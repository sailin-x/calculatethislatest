import { loan_to_costCalculatorInputs, loan_to_costCalculatorMetrics, loan_to_costCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: loan_to_costCalculatorInputs): number {
...
export function generateAnalysis(inputs: loan_to_costCalculatorInputs, metrics: loan_to_costCalculatorMetrics): loan_to_costCalculatorAnalysis {
