import { business_formation_calculatorCalculatorInputs, business_formation_calculatorCalculatorMetrics, business_formation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_formation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: business_formation_calculatorCalculatorInputs, metrics: business_formation_calculatorCalculatorMetrics): business_formation_calculatorCalculatorAnalysis {
