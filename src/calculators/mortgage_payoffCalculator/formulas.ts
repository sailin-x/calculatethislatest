import { mortgage_payoffCalculatorInputs, mortgage_payoffCalculatorMetrics, mortgage_payoffCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgage_payoffCalculatorInputs): number {
...
export function generateAnalysis(inputs: mortgage_payoffCalculatorInputs, metrics: mortgage_payoffCalculatorMetrics): mortgage_payoffCalculatorAnalysis {
