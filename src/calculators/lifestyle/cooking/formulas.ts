import { cookingInputs, cookingMetrics, cookingAnalysis } from './types';
...
export function calculateResult(inputs: cookingInputs): number {
...
export function generateAnalysis(inputs: cookingInputs, metrics: cookingMetrics): cookingAnalysis {
