import { TravelCalculatorInputs } from './types';

export function validateTravelCalculatorInputs(inputs: TravelCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTravelCalculatorBusinessRules(inputs: TravelCalculatorInputs): Array<{ field: string; message: string }> {
