import { hobbiesInputs, hobbiesMetrics, hobbiesAnalysis } from './types';
...
export function calculateResult(inputs: hobbiesInputs): number {
...
export function generateAnalysis(inputs: hobbiesInputs, metrics: hobbiesMetrics): hobbiesAnalysis {
