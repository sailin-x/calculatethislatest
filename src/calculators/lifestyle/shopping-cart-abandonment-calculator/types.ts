export interface ShoppingCartAbandonmentCalculatorInputs {
...
export interface ShoppingCartAbandonmentCalculatorOutputs {
...
export interface ShoppingCartAbandonmentCalculatorMetrics {
...
export interface ShoppingCartAbandonmentCalculatorAnalysis {
