import { ShoppingCartAbandonmentCalculatorInputs } from './types';

export function validateShoppingCartAbandonmentCalculatorInputs(inputs: ShoppingCartAbandonmentCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateShoppingCartAbandonmentCalculatorBusinessRules(inputs: ShoppingCartAbandonmentCalculatorInputs): Array<{ field: string; message: string }> {
