import { automotiveInputs, automotiveMetrics, automotiveAnalysis } from './types';
...
export function calculateResult(inputs: automotiveInputs): number {
...
export function generateAnalysis(inputs: automotiveInputs, metrics: automotiveMetrics): automotiveAnalysis {
