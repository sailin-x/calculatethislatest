export interface NursingHomeNegligenceCalculatorInputs {
...
export interface NursingHomeNegligenceCalculatorOutputs {
...
export interface NursingHomeNegligenceCalculatorMetrics {
...
export interface NursingHomeNegligenceCalculatorAnalysis {
