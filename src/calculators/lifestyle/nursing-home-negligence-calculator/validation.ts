import { NursingHomeNegligenceCalculatorInputs } from './types';

export function validateNursingHomeNegligenceCalculatorInputs(inputs: NursingHomeNegligenceCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateNursingHomeNegligenceCalculatorBusinessRules(inputs: NursingHomeNegligenceCalculatorInputs): Array<{ field: string; message: string }> {
