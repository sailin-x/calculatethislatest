import { PriceFixingOvercharge-estimatorInputs, PriceFixingOvercharge-estimatorMetrics, PriceFixingOvercharge-estimatorAnalysis } from './types';
...
export function calculateResult(inputs: PriceFixingOvercharge-estimatorInputs): number {
...
export function generateAnalysis(inputs: PriceFixingOvercharge-estimatorInputs, metrics: PriceFixingOvercharge-estimatorMetrics): PriceFixingOvercharge-estimatorAnalysis {
