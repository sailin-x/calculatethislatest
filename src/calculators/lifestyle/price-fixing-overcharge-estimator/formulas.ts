import { price-fixing-overcharge-estimatorInputs, price-fixing-overcharge-estimatorMetrics, price-fixing-overcharge-estimatorAnalysis } from './types';
...
export function calculateResult(inputs: price-fixing-overcharge-estimatorInputs): number {
...
export function generateAnalysis(inputs: price-fixing-overcharge-estimatorInputs, metrics: price-fixing-overcharge-estimatorMetrics): price-fixing-overcharge-estimatorAnalysis {
