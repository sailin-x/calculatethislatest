import { GardenCalculatorInputs } from './types';

export function validateGardenCalculatorInputs(inputs: GardenCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateGardenCalculatorBusinessRules(inputs: GardenCalculatorInputs): Array<{ field: string; message: string }> {
