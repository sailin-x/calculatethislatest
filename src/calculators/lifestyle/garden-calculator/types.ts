export interface GardenCalculatorInputs {
...
export interface GardenCalculatorOutputs {
...
export interface GardenCalculatorMetrics {
...
export interface GardenCalculatorAnalysis {
