import { TradingCardCalculatorInputs } from './types';

export function validateTradingCardCalculatorInputs(inputs: TradingCardCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateTradingCardCalculatorBusinessRules(inputs: TradingCardCalculatorInputs): Array<{ field: string; message: string }> {
