export interface TradingCardCalculatorInputs {
...
export interface TradingCardCalculatorOutputs {
...
export interface TradingCardCalculatorMetrics {
...
export interface TradingCardCalculatorAnalysis {
