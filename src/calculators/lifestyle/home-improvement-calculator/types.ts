export interface HomeImprovementCalculatorInputs {
...
export interface HomeImprovementCalculatorOutputs {
...
export interface HomeImprovementCalculatorMetrics {
...
export interface HomeImprovementCalculatorAnalysis {
