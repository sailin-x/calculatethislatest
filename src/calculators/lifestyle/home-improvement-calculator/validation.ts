import { HomeImprovementCalculatorInputs } from './types';

export function validateHomeImprovementCalculatorInputs(inputs: HomeImprovementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateHomeImprovementCalculatorBusinessRules(inputs: HomeImprovementCalculatorInputs): Array<{ field: string; message: string }> {
