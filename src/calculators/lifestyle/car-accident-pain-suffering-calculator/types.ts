export interface CarAccidentPainSufferingCalculatorInputs {
...
export interface CarAccidentPainSufferingCalculatorOutputs {
...
export interface CarAccidentPainSufferingCalculatorMetrics {
...
export interface CarAccidentPainSufferingCalculatorAnalysis {
