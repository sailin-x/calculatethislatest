import { CarAccidentPainSufferingCalculatorInputs } from './types';

export function validateCarAccidentPainSufferingCalculatorInputs(inputs: CarAccidentPainSufferingCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCarAccidentPainSufferingCalculatorBusinessRules(inputs: CarAccidentPainSufferingCalculatorInputs): Array<{ field: string; message: string }> {
