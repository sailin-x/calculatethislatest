import { hobbies-calculatorInputs, hobbies-calculatorMetrics, hobbies-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: hobbies-calculatorInputs): number {
...
export function generateAnalysis(inputs: hobbies-calculatorInputs, metrics: hobbies-calculatorMetrics): hobbies-calculatorAnalysis {
