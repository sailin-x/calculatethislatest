import { cooking-calculatorInputs, cooking-calculatorMetrics, cooking-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cooking-calculatorInputs): number {
...
export function generateAnalysis(inputs: cooking-calculatorInputs, metrics: cooking-calculatorMetrics): cooking-calculatorAnalysis {
