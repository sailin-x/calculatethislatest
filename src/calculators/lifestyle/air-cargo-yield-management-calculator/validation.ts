import { AirCargoYieldManagementCalculatorInputs } from './types';

export function validateAirCargoYieldManagementCalculatorInputs(inputs: AirCargoYieldManagementCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateAirCargoYieldManagementCalculatorBusinessRules(inputs: AirCargoYieldManagementCalculatorInputs): Array<{ field: string; message: string }> {
