export interface AirCargoYieldManagementCalculatorInputs {
...
export interface AirCargoYieldManagementCalculatorOutputs {
...
export interface AirCargoYieldManagementCalculatorMetrics {
...
export interface AirCargoYieldManagementCalculatorAnalysis {
