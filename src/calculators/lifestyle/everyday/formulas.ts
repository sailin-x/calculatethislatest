import { everydayInputs, everydayMetrics, everydayAnalysis } from './types';
...
export function calculateResult(inputs: everydayInputs): number {
...
export function generateAnalysis(inputs: everydayInputs, metrics: everydayMetrics): everydayAnalysis {
