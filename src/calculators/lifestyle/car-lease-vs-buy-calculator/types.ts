export interface CarLeaseVsBuyCalculatorInputs {
...
export interface CarLeaseVsBuyCalculatorOutputs {
...
export interface CarLeaseVsBuyCalculatorMetrics {
...
export interface CarLeaseVsBuyCalculatorAnalysis {
