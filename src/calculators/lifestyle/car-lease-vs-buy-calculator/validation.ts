import { CarLeaseVsBuyCalculatorInputs } from './types';

export function validateCarLeaseVsBuyCalculatorInputs(inputs: CarLeaseVsBuyCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCarLeaseVsBuyCalculatorBusinessRules(inputs: CarLeaseVsBuyCalculatorInputs): Array<{ field: string; message: string }> {
