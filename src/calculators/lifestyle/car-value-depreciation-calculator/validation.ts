import { CarValueDepreciationCalculatorInputs } from './types';

export function validateCarValueDepreciationCalculatorInputs(inputs: CarValueDepreciationCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCarValueDepreciationCalculatorBusinessRules(inputs: CarValueDepreciationCalculatorInputs): Array<{ field: string; message: string }> {
