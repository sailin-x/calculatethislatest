export interface CarValueDepreciationCalculatorInputs {
...
export interface CarValueDepreciationCalculatorOutputs {
...
export interface CarValueDepreciationCalculatorMetrics {
...
export interface CarValueDepreciationCalculatorAnalysis {
