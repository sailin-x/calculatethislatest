import { CarbCyclingCalculatorInputs } from './types';

export function validateCarbCyclingCalculatorInputs(inputs: CarbCyclingCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCarbCyclingCalculatorBusinessRules(inputs: CarbCyclingCalculatorInputs): Array<{ field: string; message: string }> {
