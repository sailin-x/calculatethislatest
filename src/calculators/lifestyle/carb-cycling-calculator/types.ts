export interface CarbCyclingCalculatorInputs {
...
export interface CarbCyclingCalculatorOutputs {
...
export interface CarbCyclingCalculatorMetrics {
...
export interface CarbCyclingCalculatorAnalysis {
