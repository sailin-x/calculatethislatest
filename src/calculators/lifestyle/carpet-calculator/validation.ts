import { CarpetCalculatorInputs } from './types';

export function validateCarpetCalculatorInputs(inputs: CarpetCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCarpetCalculatorBusinessRules(inputs: CarpetCalculatorInputs): Array<{ field: string; message: string }> {
