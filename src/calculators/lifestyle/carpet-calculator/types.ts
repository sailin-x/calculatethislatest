export interface CarpetCalculatorInputs {
...
export interface CarpetCalculatorOutputs {
...
export interface CarpetCalculatorMetrics {
...
export interface CarpetCalculatorAnalysis {
