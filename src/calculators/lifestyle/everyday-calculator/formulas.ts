import { everyday-calculatorInputs, everyday-calculatorMetrics, everyday-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: everyday-calculatorInputs): number {
...
export function generateAnalysis(inputs: everyday-calculatorInputs, metrics: everyday-calculatorMetrics): everyday-calculatorAnalysis {
