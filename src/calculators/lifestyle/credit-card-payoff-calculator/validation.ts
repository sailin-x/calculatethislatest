import { CreditCardPayoffCalculatorInputs } from './types';

export function validateCreditCardPayoffCalculatorInputs(inputs: CreditCardPayoffCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCreditCardPayoffCalculatorBusinessRules(inputs: CreditCardPayoffCalculatorInputs): Array<{ field: string; message: string }> {
