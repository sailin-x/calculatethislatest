import { PetCareCalculatorInputs } from './types';

export function validatePetCareCalculatorInputs(inputs: PetCareCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePetCareCalculatorBusinessRules(inputs: PetCareCalculatorInputs): Array<{ field: string; message: string }> {
