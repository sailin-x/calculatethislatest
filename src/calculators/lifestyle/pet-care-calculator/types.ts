export interface PetCareCalculatorInputs {
...
export interface PetCareCalculatorOutputs {
...
export interface PetCareCalculatorMetrics {
...
export interface PetCareCalculatorAnalysis {
