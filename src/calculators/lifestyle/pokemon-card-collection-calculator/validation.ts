import { PokemonCardCollectionCalculatorInputs } from './types';

export function validatePokemonCardCollectionCalculatorInputs(inputs: PokemonCardCollectionCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validatePokemonCardCollectionCalculatorBusinessRules(inputs: PokemonCardCollectionCalculatorInputs): Array<{ field: string; message: string }> {
