export interface PokemonCardCollectionCalculatorInputs {
...
export interface PokemonCardCollectionCalculatorOutputs {
...
export interface PokemonCardCollectionCalculatorMetrics {
...
export interface PokemonCardCollectionCalculatorAnalysis {
