import { ransomware_downtime_cost_calculatorCalculatorInputs, ransomware_downtime_cost_calculatorCalculatorMetrics, ransomware_downtime_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: ransomware_downtime_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: ransomware_downtime_cost_calculatorCalculatorInputs, metrics: ransomware_downtime_cost_calculatorCalculatorMetrics): ransomware_downtime_cost_calculatorCalculatorAnalysis {
