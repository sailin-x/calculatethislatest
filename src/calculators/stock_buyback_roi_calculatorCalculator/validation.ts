import { stock_buyback_roi_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: stock_buyback_roi_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
