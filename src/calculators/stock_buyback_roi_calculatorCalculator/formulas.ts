import { stock_buyback_roi_calculatorCalculatorInputs, stock_buyback_roi_calculatorCalculatorMetrics, stock_buyback_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: stock_buyback_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: stock_buyback_roi_calculatorCalculatorInputs, metrics: stock_buyback_roi_calculatorCalculatorMetrics): stock_buyback_roi_calculatorCalculatorAnalysis {
