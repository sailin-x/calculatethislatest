import { cost_of_poor_quality_copq_calculatorInputs, cost_of_poor_quality_copq_calculatorMetrics, cost_of_poor_quality_copq_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cost_of_poor_quality_copq_calculatorInputs): number {
...
export function generateAnalysis(inputs: cost_of_poor_quality_copq_calculatorInputs, metrics: cost_of_poor_quality_copq_calculatorMetrics): cost_of_poor_quality_copq_calculatorAnalysis {
