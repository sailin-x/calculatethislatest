import { media_mix_modeling_mmm_roi_calculatorCalculatorInputs, media_mix_modeling_mmm_roi_calculatorCalculatorMetrics, media_mix_modeling_mmm_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: media_mix_modeling_mmm_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: media_mix_modeling_mmm_roi_calculatorCalculatorInputs, metrics: media_mix_modeling_mmm_roi_calculatorCalculatorMetrics): media_mix_modeling_mmm_roi_calculatorCalculatorAnalysis {
