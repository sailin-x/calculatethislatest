import { bmrCalculatorInputs, bmrCalculatorMetrics, bmrCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: bmrCalculatorInputs): number {
...
export function generateAnalysis(inputs: bmrCalculatorInputs, metrics: bmrCalculatorMetrics): bmrCalculatorAnalysis {
