import { expected_shortfall_calculatorInputs, expected_shortfall_calculatorMetrics, expected_shortfall_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: expected_shortfall_calculatorInputs): number {
...
export function generateAnalysis(inputs: expected_shortfall_calculatorInputs, metrics: expected_shortfall_calculatorMetrics): expected_shortfall_calculatorAnalysis {
