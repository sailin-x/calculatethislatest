import { pension_plan_funding_calculatorInputs } from './types';

export function validateInputs(inputs: pension_plan_funding_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
