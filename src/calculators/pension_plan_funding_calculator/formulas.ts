import { pension_plan_funding_calculatorInputs, pension_plan_funding_calculatorMetrics, pension_plan_funding_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: pension_plan_funding_calculatorInputs): number {
...
export function generateAnalysis(inputs: pension_plan_funding_calculatorInputs, metrics: pension_plan_funding_calculatorMetrics): pension_plan_funding_calculatorAnalysis {
