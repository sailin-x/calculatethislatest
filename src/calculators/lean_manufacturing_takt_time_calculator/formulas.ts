import { lean_manufacturing_takt_time_calculatorInputs, lean_manufacturing_takt_time_calculatorMetrics, lean_manufacturing_takt_time_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: lean_manufacturing_takt_time_calculatorInputs): number {
...
export function generateAnalysis(inputs: lean_manufacturing_takt_time_calculatorInputs, metrics: lean_manufacturing_takt_time_calculatorMetrics): lean_manufacturing_takt_time_calculatorAnalysis {
