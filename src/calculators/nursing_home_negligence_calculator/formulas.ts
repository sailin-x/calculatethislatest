import { nursing_home_negligence_calculatorInputs, nursing_home_negligence_calculatorMetrics, nursing_home_negligence_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: nursing_home_negligence_calculatorInputs): number {
...
export function generateAnalysis(inputs: nursing_home_negligence_calculatorInputs, metrics: nursing_home_negligence_calculatorMetrics): nursing_home_negligence_calculatorAnalysis {
