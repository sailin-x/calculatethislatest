import { ai_prompt_cost_calculatorCalculatorInputs, ai_prompt_cost_calculatorCalculatorMetrics, ai_prompt_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: ai_prompt_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: ai_prompt_cost_calculatorCalculatorInputs, metrics: ai_prompt_cost_calculatorCalculatorMetrics): ai_prompt_cost_calculatorCalculatorAnalysis {
