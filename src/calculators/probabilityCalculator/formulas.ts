import { probabilityCalculatorInputs, probabilityCalculatorMetrics, probabilityCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: probabilityCalculatorInputs): number {
...
export function generateAnalysis(inputs: probabilityCalculatorInputs, metrics: probabilityCalculatorMetrics): probabilityCalculatorAnalysis {
