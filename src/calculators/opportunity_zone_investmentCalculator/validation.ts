import { opportunity_zone_investmentCalculatorInputs } from './types';

export function validateInputs(inputs: opportunity_zone_investmentCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
