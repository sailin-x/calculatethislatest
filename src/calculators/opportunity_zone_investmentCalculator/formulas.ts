import { opportunity_zone_investmentCalculatorInputs, opportunity_zone_investmentCalculatorMetrics, opportunity_zone_investmentCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: opportunity_zone_investmentCalculatorInputs): number {
...
export function generateAnalysis(inputs: opportunity_zone_investmentCalculatorInputs, metrics: opportunity_zone_investmentCalculatorMetrics): opportunity_zone_investmentCalculatorAnalysis {
