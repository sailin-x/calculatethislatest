import { options_trading_calculatorCalculatorInputs, options_trading_calculatorCalculatorMetrics, options_trading_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: options_trading_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: options_trading_calculatorCalculatorInputs, metrics: options_trading_calculatorCalculatorMetrics): options_trading_calculatorCalculatorAnalysis {
