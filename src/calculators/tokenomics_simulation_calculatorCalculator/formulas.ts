import { tokenomics_simulation_calculatorCalculatorInputs, tokenomics_simulation_calculatorCalculatorMetrics, tokenomics_simulation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: tokenomics_simulation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: tokenomics_simulation_calculatorCalculatorInputs, metrics: tokenomics_simulation_calculatorCalculatorMetrics): tokenomics_simulation_calculatorCalculatorAnalysis {
