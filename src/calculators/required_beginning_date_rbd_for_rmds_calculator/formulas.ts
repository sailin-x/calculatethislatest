import { required_beginning_date_rbd_for_rmds_calculatorInputs, required_beginning_date_rbd_for_rmds_calculatorMetrics, required_beginning_date_rbd_for_rmds_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: required_beginning_date_rbd_for_rmds_calculatorInputs): number {
...
export function generateAnalysis(inputs: required_beginning_date_rbd_for_rmds_calculatorInputs, metrics: required_beginning_date_rbd_for_rmds_calculatorMetrics): required_beginning_date_rbd_for_rmds_calculatorAnalysis {
