import { landed_cost_calculatorInputs, landed_cost_calculatorMetrics, landed_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: landed_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: landed_cost_calculatorInputs, metrics: landed_cost_calculatorMetrics): landed_cost_calculatorAnalysis {
