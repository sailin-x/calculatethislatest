import { hospital_negligence_calculatorCalculatorInputs, hospital_negligence_calculatorCalculatorMetrics, hospital_negligence_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hospital_negligence_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: hospital_negligence_calculatorCalculatorInputs, metrics: hospital_negligence_calculatorCalculatorMetrics): hospital_negligence_calculatorCalculatorAnalysis {
