import { hospital_negligence_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: hospital_negligence_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
