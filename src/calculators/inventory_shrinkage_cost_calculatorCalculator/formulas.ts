import { inventory_shrinkage_cost_calculatorCalculatorInputs, inventory_shrinkage_cost_calculatorCalculatorMetrics, inventory_shrinkage_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: inventory_shrinkage_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: inventory_shrinkage_cost_calculatorCalculatorInputs, metrics: inventory_shrinkage_cost_calculatorCalculatorMetrics): inventory_shrinkage_cost_calculatorCalculatorAnalysis {
