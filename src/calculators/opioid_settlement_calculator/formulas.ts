import { opioid_settlement_calculatorInputs, opioid_settlement_calculatorMetrics, opioid_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: opioid_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: opioid_settlement_calculatorInputs, metrics: opioid_settlement_calculatorMetrics): opioid_settlement_calculatorAnalysis {
