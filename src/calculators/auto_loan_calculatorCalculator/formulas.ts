import { auto_loan_calculatorCalculatorInputs, auto_loan_calculatorCalculatorMetrics, auto_loan_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: auto_loan_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: auto_loan_calculatorCalculatorInputs, metrics: auto_loan_calculatorCalculatorMetrics): auto_loan_calculatorCalculatorAnalysis {
