import { registerCorporateBondCalculatorInputs } from './types';

export function validateInputs(inputs: registerCorporateBondCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
