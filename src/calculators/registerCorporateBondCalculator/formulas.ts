import { registerCorporateBondCalculatorInputs, registerCorporateBondCalculatorMetrics, registerCorporateBondCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerCorporateBondCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerCorporateBondCalculatorInputs, metrics: registerCorporateBondCalculatorMetrics): registerCorporateBondCalculatorAnalysis {
