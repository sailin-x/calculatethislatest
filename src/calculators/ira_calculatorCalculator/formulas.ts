import { ira_calculatorCalculatorInputs, ira_calculatorCalculatorMetrics, ira_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: ira_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: ira_calculatorCalculatorInputs, metrics: ira_calculatorCalculatorMetrics): ira_calculatorCalculatorAnalysis {
