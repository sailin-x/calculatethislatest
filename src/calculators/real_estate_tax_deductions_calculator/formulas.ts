import { real_estate_tax_deductions_calculatorInputs, real_estate_tax_deductions_calculatorMetrics, real_estate_tax_deductions_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: real_estate_tax_deductions_calculatorInputs): number {
...
export function generateAnalysis(inputs: real_estate_tax_deductions_calculatorInputs, metrics: real_estate_tax_deductions_calculatorMetrics): real_estate_tax_deductions_calculatorAnalysis {
