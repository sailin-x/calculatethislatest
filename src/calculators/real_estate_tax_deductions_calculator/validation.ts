import { real_estate_tax_deductions_calculatorInputs } from './types';

export function validateInputs(inputs: real_estate_tax_deductions_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
