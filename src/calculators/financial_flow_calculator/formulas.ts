import { financial_flow_calculatorInputs, financial_flow_calculatorMetrics, financial_flow_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_flow_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_flow_calculatorInputs, metrics: financial_flow_calculatorMetrics): financial_flow_calculatorAnalysis {
