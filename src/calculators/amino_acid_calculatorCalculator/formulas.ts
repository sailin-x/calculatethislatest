import { amino_acid_calculatorCalculatorInputs, amino_acid_calculatorCalculatorMetrics, amino_acid_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: amino_acid_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: amino_acid_calculatorCalculatorInputs, metrics: amino_acid_calculatorCalculatorMetrics): amino_acid_calculatorCalculatorAnalysis {
