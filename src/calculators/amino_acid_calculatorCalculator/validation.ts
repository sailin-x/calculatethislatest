import { amino_acid_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: amino_acid_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
