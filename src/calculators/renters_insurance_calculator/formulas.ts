import { renters_insurance_calculatorInputs, renters_insurance_calculatorMetrics, renters_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: renters_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: renters_insurance_calculatorInputs, metrics: renters_insurance_calculatorMetrics): renters_insurance_calculatorAnalysis {
