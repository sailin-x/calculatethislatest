import { automotive_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: automotive_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
