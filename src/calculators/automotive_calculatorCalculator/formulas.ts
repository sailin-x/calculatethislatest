import { automotive_calculatorCalculatorInputs, automotive_calculatorCalculatorMetrics, automotive_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: automotive_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: automotive_calculatorCalculatorInputs, metrics: automotive_calculatorCalculatorMetrics): automotive_calculatorCalculatorAnalysis {
