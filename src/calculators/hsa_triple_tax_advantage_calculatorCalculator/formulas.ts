import { hsa_triple_tax_advantage_calculatorCalculatorInputs, hsa_triple_tax_advantage_calculatorCalculatorMetrics, hsa_triple_tax_advantage_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hsa_triple_tax_advantage_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: hsa_triple_tax_advantage_calculatorCalculatorInputs, metrics: hsa_triple_tax_advantage_calculatorCalculatorMetrics): hsa_triple_tax_advantage_calculatorCalculatorAnalysis {
