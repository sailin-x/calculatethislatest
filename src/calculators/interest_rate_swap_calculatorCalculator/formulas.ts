import { interest_rate_swap_calculatorCalculatorInputs, interest_rate_swap_calculatorCalculatorMetrics, interest_rate_swap_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: interest_rate_swap_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: interest_rate_swap_calculatorCalculatorInputs, metrics: interest_rate_swap_calculatorCalculatorMetrics): interest_rate_swap_calculatorCalculatorAnalysis {
