import { interest_rate_swap_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: interest_rate_swap_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
