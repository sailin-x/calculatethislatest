import { financial_security_calculatorCalculatorInputs, financial_security_calculatorCalculatorMetrics, financial_security_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_security_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_security_calculatorCalculatorInputs, metrics: financial_security_calculatorCalculatorMetrics): financial_security_calculatorCalculatorAnalysis {
