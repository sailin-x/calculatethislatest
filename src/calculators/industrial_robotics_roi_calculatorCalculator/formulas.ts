import { industrial_robotics_roi_calculatorCalculatorInputs, industrial_robotics_roi_calculatorCalculatorMetrics, industrial_robotics_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: industrial_robotics_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: industrial_robotics_roi_calculatorCalculatorInputs, metrics: industrial_robotics_roi_calculatorCalculatorMetrics): industrial_robotics_roi_calculatorCalculatorAnalysis {
