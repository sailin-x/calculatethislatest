import { mega_backdoor_roth_calculatorCalculatorInputs, mega_backdoor_roth_calculatorCalculatorMetrics, mega_backdoor_roth_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mega_backdoor_roth_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: mega_backdoor_roth_calculatorCalculatorInputs, metrics: mega_backdoor_roth_calculatorCalculatorMetrics): mega_backdoor_roth_calculatorCalculatorAnalysis {
