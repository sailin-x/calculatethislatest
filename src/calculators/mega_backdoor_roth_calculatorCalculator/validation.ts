import { mega_backdoor_roth_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: mega_backdoor_roth_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
