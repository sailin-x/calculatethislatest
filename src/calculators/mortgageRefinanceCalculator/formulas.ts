import { mortgageRefinanceCalculatorInputs, mortgageRefinanceCalculatorMetrics, mortgageRefinanceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgageRefinanceCalculatorInputs): number {
...
export function generateAnalysis(inputs: mortgageRefinanceCalculatorInputs, metrics: mortgageRefinanceCalculatorMetrics): mortgageRefinanceCalculatorAnalysis {
