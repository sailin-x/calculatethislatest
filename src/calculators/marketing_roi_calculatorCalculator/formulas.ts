import { marketing_roi_calculatorCalculatorInputs, marketing_roi_calculatorCalculatorMetrics, marketing_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: marketing_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: marketing_roi_calculatorCalculatorInputs, metrics: marketing_roi_calculatorCalculatorMetrics): marketing_roi_calculatorCalculatorAnalysis {
