import { instagram_engagement_rate_calculatorInputs, instagram_engagement_rate_calculatorMetrics, instagram_engagement_rate_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: instagram_engagement_rate_calculatorInputs): number {
...
export function generateAnalysis(inputs: instagram_engagement_rate_calculatorInputs, metrics: instagram_engagement_rate_calculatorMetrics): instagram_engagement_rate_calculatorAnalysis {
