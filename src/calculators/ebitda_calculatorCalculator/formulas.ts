import { ebitda_calculatorCalculatorInputs, ebitda_calculatorCalculatorMetrics, ebitda_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: ebitda_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: ebitda_calculatorCalculatorInputs, metrics: ebitda_calculatorCalculatorMetrics): ebitda_calculatorCalculatorAnalysis {
