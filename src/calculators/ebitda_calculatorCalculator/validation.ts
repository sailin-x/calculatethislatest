import { ebitda_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: ebitda_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
