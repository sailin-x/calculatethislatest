import { tax_loss_harvesting_calculatorCalculatorInputs, tax_loss_harvesting_calculatorCalculatorMetrics, tax_loss_harvesting_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: tax_loss_harvesting_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: tax_loss_harvesting_calculatorCalculatorInputs, metrics: tax_loss_harvesting_calculatorCalculatorMetrics): tax_loss_harvesting_calculatorCalculatorAnalysis {
