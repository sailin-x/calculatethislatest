import { tax_loss_harvesting_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: tax_loss_harvesting_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
