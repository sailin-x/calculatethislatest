import { surfing_lesson_cost_calculatorCalculatorInputs, surfing_lesson_cost_calculatorCalculatorMetrics, surfing_lesson_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: surfing_lesson_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: surfing_lesson_cost_calculatorCalculatorInputs, metrics: surfing_lesson_cost_calculatorCalculatorMetrics): surfing_lesson_cost_calculatorCalculatorAnalysis {
