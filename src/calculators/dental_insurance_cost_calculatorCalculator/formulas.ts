import { dental_insurance_cost_calculatorCalculatorInputs, dental_insurance_cost_calculatorCalculatorMetrics, dental_insurance_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: dental_insurance_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: dental_insurance_cost_calculatorCalculatorInputs, metrics: dental_insurance_cost_calculatorCalculatorMetrics): dental_insurance_cost_calculatorCalculatorAnalysis {
