import { emergency_fund_calculatorCalculatorInputs, emergency_fund_calculatorCalculatorMetrics, emergency_fund_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: emergency_fund_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: emergency_fund_calculatorCalculatorInputs, metrics: emergency_fund_calculatorCalculatorMetrics): emergency_fund_calculatorCalculatorAnalysis {
