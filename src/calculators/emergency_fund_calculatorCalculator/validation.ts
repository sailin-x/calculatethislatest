import { emergency_fund_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: emergency_fund_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
