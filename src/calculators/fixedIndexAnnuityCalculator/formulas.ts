import { fixedIndexAnnuityCalculatorInputs, fixedIndexAnnuityCalculatorMetrics, fixedIndexAnnuityCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fixedIndexAnnuityCalculatorInputs): number {
...
export function generateAnalysis(inputs: fixedIndexAnnuityCalculatorInputs, metrics: fixedIndexAnnuityCalculatorMetrics): fixedIndexAnnuityCalculatorAnalysis {
