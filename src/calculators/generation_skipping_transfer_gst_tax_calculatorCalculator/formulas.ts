import { generation_skipping_transfer_gst_tax_calculatorCalculatorInputs, generation_skipping_transfer_gst_tax_calculatorCalculatorMetrics, generation_skipping_transfer_gst_tax_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: generation_skipping_transfer_gst_tax_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: generation_skipping_transfer_gst_tax_calculatorCalculatorInputs, metrics: generation_skipping_transfer_gst_tax_calculatorCalculatorMetrics): generation_skipping_transfer_gst_tax_calculatorCalculatorAnalysis {
