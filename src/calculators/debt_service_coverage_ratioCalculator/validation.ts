import { debt_service_coverage_ratioCalculatorInputs } from './types';

export function validateInputs(inputs: debt_service_coverage_ratioCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
