import { debt_service_coverage_ratioCalculatorInputs, debt_service_coverage_ratioCalculatorMetrics, debt_service_coverage_ratioCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_service_coverage_ratioCalculatorInputs): number {
...
export function generateAnalysis(inputs: debt_service_coverage_ratioCalculatorInputs, metrics: debt_service_coverage_ratioCalculatorMetrics): debt_service_coverage_ratioCalculatorAnalysis {
