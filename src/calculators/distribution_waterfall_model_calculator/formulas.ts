import { distribution_waterfall_model_calculatorInputs, distribution_waterfall_model_calculatorMetrics, distribution_waterfall_model_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: distribution_waterfall_model_calculatorInputs): number {
...
export function generateAnalysis(inputs: distribution_waterfall_model_calculatorInputs, metrics: distribution_waterfall_model_calculatorMetrics): distribution_waterfall_model_calculatorAnalysis {
