import { paycheck_calculatorCalculatorInputs, paycheck_calculatorCalculatorMetrics, paycheck_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: paycheck_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: paycheck_calculatorCalculatorInputs, metrics: paycheck_calculatorCalculatorMetrics): paycheck_calculatorCalculatorAnalysis {
