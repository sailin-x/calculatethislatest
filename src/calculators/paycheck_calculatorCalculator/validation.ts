import { paycheck_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: paycheck_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
