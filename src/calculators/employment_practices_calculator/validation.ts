import { employment_practices_calculatorInputs } from './types';

export function validateInputs(inputs: employment_practices_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
