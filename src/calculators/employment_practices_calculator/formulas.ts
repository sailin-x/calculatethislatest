import { employment_practices_calculatorInputs, employment_practices_calculatorMetrics, employment_practices_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: employment_practices_calculatorInputs): number {
...
export function generateAnalysis(inputs: employment_practices_calculatorInputs, metrics: employment_practices_calculatorMetrics): employment_practices_calculatorAnalysis {
