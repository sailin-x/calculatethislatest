import { cap_rateCalculatorInputs, cap_rateCalculatorMetrics, cap_rateCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cap_rateCalculatorInputs): number {
...
export function generateAnalysis(inputs: cap_rateCalculatorInputs, metrics: cap_rateCalculatorMetrics): cap_rateCalculatorAnalysis {
