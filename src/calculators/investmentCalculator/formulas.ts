import { investmentCalculatorInputs, investmentCalculatorMetrics, investmentCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: investmentCalculatorInputs): number {
...
export function generateAnalysis(inputs: investmentCalculatorInputs, metrics: investmentCalculatorMetrics): investmentCalculatorAnalysis {
