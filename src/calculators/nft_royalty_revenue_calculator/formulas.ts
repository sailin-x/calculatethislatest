import { nft_royalty_revenue_calculatorInputs, nft_royalty_revenue_calculatorMetrics, nft_royalty_revenue_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: nft_royalty_revenue_calculatorInputs): number {
...
export function generateAnalysis(inputs: nft_royalty_revenue_calculatorInputs, metrics: nft_royalty_revenue_calculatorMetrics): nft_royalty_revenue_calculatorAnalysis {
