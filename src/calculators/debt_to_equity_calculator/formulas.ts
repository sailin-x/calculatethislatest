import { debt_to_equity_calculatorInputs, debt_to_equity_calculatorMetrics, debt_to_equity_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_to_equity_calculatorInputs): number {
...
export function generateAnalysis(inputs: debt_to_equity_calculatorInputs, metrics: debt_to_equity_calculatorMetrics): debt_to_equity_calculatorAnalysis {
