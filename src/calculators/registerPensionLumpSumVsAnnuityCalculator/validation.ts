import { registerPensionLumpSumVsAnnuityCalculatorInputs } from './types';

export function validateInputs(inputs: registerPensionLumpSumVsAnnuityCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
