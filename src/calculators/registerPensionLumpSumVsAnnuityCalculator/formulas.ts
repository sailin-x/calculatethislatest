import { registerPensionLumpSumVsAnnuityCalculatorInputs, registerPensionLumpSumVsAnnuityCalculatorMetrics, registerPensionLumpSumVsAnnuityCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerPensionLumpSumVsAnnuityCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerPensionLumpSumVsAnnuityCalculatorInputs, metrics: registerPensionLumpSumVsAnnuityCalculatorMetrics): registerPensionLumpSumVsAnnuityCalculatorAnalysis {
