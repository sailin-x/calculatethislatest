import { hospital_negligence_settlement_calculatorCalculatorInputs, hospital_negligence_settlement_calculatorCalculatorMetrics, hospital_negligence_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hospital_negligence_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: hospital_negligence_settlement_calculatorCalculatorInputs, metrics: hospital_negligence_settlement_calculatorCalculatorMetrics): hospital_negligence_settlement_calculatorCalculatorAnalysis {
