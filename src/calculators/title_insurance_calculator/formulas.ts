import { title_insurance_calculatorInputs, title_insurance_calculatorMetrics, title_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: title_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: title_insurance_calculatorInputs, metrics: title_insurance_calculatorMetrics): title_insurance_calculatorAnalysis {
