import { title_insurance_calculatorInputs } from './types';

export function validateInputs(inputs: title_insurance_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
