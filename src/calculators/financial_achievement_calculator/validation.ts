import { financial_achievement_calculatorInputs } from './types';

export function validateInputs(inputs: financial_achievement_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
