import { financial_achievement_calculatorInputs, financial_achievement_calculatorMetrics, financial_achievement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_achievement_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_achievement_calculatorInputs, metrics: financial_achievement_calculatorMetrics): financial_achievement_calculatorAnalysis {
