import { graph_theory_calculatorInputs, graph_theory_calculatorMetrics, graph_theory_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: graph_theory_calculatorInputs): number {
...
export function generateAnalysis(inputs: graph_theory_calculatorInputs, metrics: graph_theory_calculatorMetrics): graph_theory_calculatorAnalysis {
