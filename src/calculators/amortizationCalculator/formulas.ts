import { amortizationCalculatorInputs, amortizationCalculatorMetrics, amortizationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: amortizationCalculatorInputs): number {
...
export function generateAnalysis(inputs: amortizationCalculatorInputs, metrics: amortizationCalculatorMetrics): amortizationCalculatorAnalysis {
