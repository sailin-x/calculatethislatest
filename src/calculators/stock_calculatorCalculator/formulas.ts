import { stock_calculatorCalculatorInputs, stock_calculatorCalculatorMetrics, stock_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: stock_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: stock_calculatorCalculatorInputs, metrics: stock_calculatorCalculatorMetrics): stock_calculatorCalculatorAnalysis {
