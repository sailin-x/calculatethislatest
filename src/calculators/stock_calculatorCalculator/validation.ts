import { stock_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: stock_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
