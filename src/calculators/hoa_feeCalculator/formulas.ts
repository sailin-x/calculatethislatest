import { hoa_feeCalculatorInputs, hoa_feeCalculatorMetrics, hoa_feeCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: hoa_feeCalculatorInputs): number {
...
export function generateAnalysis(inputs: hoa_feeCalculatorInputs, metrics: hoa_feeCalculatorMetrics): hoa_feeCalculatorAnalysis {
