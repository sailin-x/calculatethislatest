import { kurtosis_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: kurtosis_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
