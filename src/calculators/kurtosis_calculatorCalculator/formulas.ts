import { kurtosis_calculatorCalculatorInputs, kurtosis_calculatorCalculatorMetrics, kurtosis_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: kurtosis_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: kurtosis_calculatorCalculatorInputs, metrics: kurtosis_calculatorCalculatorMetrics): kurtosis_calculatorCalculatorAnalysis {
