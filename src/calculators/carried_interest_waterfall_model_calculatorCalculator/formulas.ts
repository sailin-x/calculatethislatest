import { carried_interest_waterfall_model_calculatorCalculatorInputs, carried_interest_waterfall_model_calculatorCalculatorMetrics, carried_interest_waterfall_model_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: carried_interest_waterfall_model_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: carried_interest_waterfall_model_calculatorCalculatorInputs, metrics: carried_interest_waterfall_model_calculatorCalculatorMetrics): carried_interest_waterfall_model_calculatorCalculatorAnalysis {
