import { down_payment_assistanceCalculatorInputs, down_payment_assistanceCalculatorMetrics, down_payment_assistanceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: down_payment_assistanceCalculatorInputs): number {
...
export function generateAnalysis(inputs: down_payment_assistanceCalculatorInputs, metrics: down_payment_assistanceCalculatorMetrics): down_payment_assistanceCalculatorAnalysis {
