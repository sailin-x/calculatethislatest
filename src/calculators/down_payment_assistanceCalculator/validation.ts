import { down_payment_assistanceCalculatorInputs } from './types';

export function validateInputs(inputs: down_payment_assistanceCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
