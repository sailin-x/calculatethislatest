import { toll_cost_calculatorInputs, toll_cost_calculatorMetrics, toll_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: toll_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: toll_cost_calculatorInputs, metrics: toll_cost_calculatorMetrics): toll_cost_calculatorAnalysis {
