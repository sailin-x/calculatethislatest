import { mega_backdoor_roth_calculatorInputs } from './types';

export function validateInputs(inputs: mega_backdoor_roth_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
