import { mega_backdoor_roth_calculatorInputs, mega_backdoor_roth_calculatorMetrics, mega_backdoor_roth_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: mega_backdoor_roth_calculatorInputs): number {
...
export function generateAnalysis(inputs: mega_backdoor_roth_calculatorInputs, metrics: mega_backdoor_roth_calculatorMetrics): mega_backdoor_roth_calculatorAnalysis {
