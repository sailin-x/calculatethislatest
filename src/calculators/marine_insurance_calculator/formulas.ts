import { marine_insurance_calculatorInputs, marine_insurance_calculatorMetrics, marine_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: marine_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: marine_insurance_calculatorInputs, metrics: marine_insurance_calculatorMetrics): marine_insurance_calculatorAnalysis {
