import { life_insurance_calculatorInputs, life_insurance_calculatorMetrics, life_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: life_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: life_insurance_calculatorInputs, metrics: life_insurance_calculatorMetrics): life_insurance_calculatorAnalysis {
