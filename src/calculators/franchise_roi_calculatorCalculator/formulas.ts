import { franchise_roi_calculatorCalculatorInputs, franchise_roi_calculatorCalculatorMetrics, franchise_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: franchise_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: franchise_roi_calculatorCalculatorInputs, metrics: franchise_roi_calculatorCalculatorMetrics): franchise_roi_calculatorCalculatorAnalysis {
