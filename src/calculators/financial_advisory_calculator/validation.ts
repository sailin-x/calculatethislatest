import { financial_advisory_calculatorInputs } from './types';

export function validateInputs(inputs: financial_advisory_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
