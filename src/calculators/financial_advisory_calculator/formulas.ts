import { financial_advisory_calculatorInputs, financial_advisory_calculatorMetrics, financial_advisory_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_advisory_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_advisory_calculatorInputs, metrics: financial_advisory_calculatorMetrics): financial_advisory_calculatorAnalysis {
