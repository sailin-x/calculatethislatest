import { gas_fee_optimizer_calculatorInputs, gas_fee_optimizer_calculatorMetrics, gas_fee_optimizer_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: gas_fee_optimizer_calculatorInputs): number {
...
export function generateAnalysis(inputs: gas_fee_optimizer_calculatorInputs, metrics: gas_fee_optimizer_calculatorMetrics): gas_fee_optimizer_calculatorAnalysis {
