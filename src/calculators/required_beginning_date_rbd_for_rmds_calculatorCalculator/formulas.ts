import { required_beginning_date_rbd_for_rmds_calculatorCalculatorInputs, required_beginning_date_rbd_for_rmds_calculatorCalculatorMetrics, required_beginning_date_rbd_for_rmds_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: required_beginning_date_rbd_for_rmds_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: required_beginning_date_rbd_for_rmds_calculatorCalculatorInputs, metrics: required_beginning_date_rbd_for_rmds_calculatorCalculatorMetrics): required_beginning_date_rbd_for_rmds_calculatorCalculatorAnalysis {
