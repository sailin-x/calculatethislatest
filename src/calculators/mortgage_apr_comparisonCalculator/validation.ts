import { mortgage_apr_comparisonCalculatorInputs } from './types';

export function validateInputs(inputs: mortgage_apr_comparisonCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
