import { mortgage_apr_comparisonCalculatorInputs, mortgage_apr_comparisonCalculatorMetrics, mortgage_apr_comparisonCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgage_apr_comparisonCalculatorInputs): number {
...
export function generateAnalysis(inputs: mortgage_apr_comparisonCalculatorInputs, metrics: mortgage_apr_comparisonCalculatorMetrics): mortgage_apr_comparisonCalculatorAnalysis {
