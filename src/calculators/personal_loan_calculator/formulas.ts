import { personal_loan_calculatorInputs, personal_loan_calculatorMetrics, personal_loan_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: personal_loan_calculatorInputs): number {
...
export function generateAnalysis(inputs: personal_loan_calculatorInputs, metrics: personal_loan_calculatorMetrics): personal_loan_calculatorAnalysis {
