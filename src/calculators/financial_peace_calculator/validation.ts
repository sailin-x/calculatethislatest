import { financial_peace_calculatorInputs } from './types';

export function validateInputs(inputs: financial_peace_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
