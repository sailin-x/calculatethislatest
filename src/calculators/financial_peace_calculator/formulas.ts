import { financial_peace_calculatorInputs, financial_peace_calculatorMetrics, financial_peace_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_peace_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_peace_calculatorInputs, metrics: financial_peace_calculatorMetrics): financial_peace_calculatorAnalysis {
