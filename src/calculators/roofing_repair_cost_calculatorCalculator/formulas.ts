import { roofing_repair_cost_calculatorCalculatorInputs, roofing_repair_cost_calculatorCalculatorMetrics, roofing_repair_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: roofing_repair_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: roofing_repair_cost_calculatorCalculatorInputs, metrics: roofing_repair_cost_calculatorCalculatorMetrics): roofing_repair_cost_calculatorCalculatorAnalysis {
