import { directors_officers_insurance_calculatorInputs, directors_officers_insurance_calculatorMetrics, directors_officers_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: directors_officers_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: directors_officers_insurance_calculatorInputs, metrics: directors_officers_insurance_calculatorMetrics): directors_officers_insurance_calculatorAnalysis {
