import { chiropractic_care_cost_calculatorInputs, chiropractic_care_cost_calculatorMetrics, chiropractic_care_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: chiropractic_care_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: chiropractic_care_cost_calculatorInputs, metrics: chiropractic_care_cost_calculatorMetrics): chiropractic_care_cost_calculatorAnalysis {
