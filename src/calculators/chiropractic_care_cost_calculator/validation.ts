import { chiropractic_care_cost_calculatorInputs } from './types';

export function validateInputs(inputs: chiropractic_care_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
