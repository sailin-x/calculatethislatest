import { marine_insurance_calculatorCalculatorInputs, marine_insurance_calculatorCalculatorMetrics, marine_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: marine_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: marine_insurance_calculatorCalculatorInputs, metrics: marine_insurance_calculatorCalculatorMetrics): marine_insurance_calculatorCalculatorAnalysis {
