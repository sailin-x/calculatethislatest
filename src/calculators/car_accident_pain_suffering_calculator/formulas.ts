import { car_accident_pain_suffering_calculatorInputs, car_accident_pain_suffering_calculatorMetrics, car_accident_pain_suffering_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: car_accident_pain_suffering_calculatorInputs): number {
...
export function generateAnalysis(inputs: car_accident_pain_suffering_calculatorInputs, metrics: car_accident_pain_suffering_calculatorMetrics): car_accident_pain_suffering_calculatorAnalysis {
