import { dividend_discount_model_ddm_calculatorInputs, dividend_discount_model_ddm_calculatorMetrics, dividend_discount_model_ddm_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: dividend_discount_model_ddm_calculatorInputs): number {
...
export function generateAnalysis(inputs: dividend_discount_model_ddm_calculatorInputs, metrics: dividend_discount_model_ddm_calculatorMetrics): dividend_discount_model_ddm_calculatorAnalysis {
