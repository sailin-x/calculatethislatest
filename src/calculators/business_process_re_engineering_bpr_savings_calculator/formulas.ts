import { business_process_re_engineering_bpr_savings_calculatorInputs, business_process_re_engineering_bpr_savings_calculatorMetrics, business_process_re_engineering_bpr_savings_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_process_re_engineering_bpr_savings_calculatorInputs): number {
...
export function generateAnalysis(inputs: business_process_re_engineering_bpr_savings_calculatorInputs, metrics: business_process_re_engineering_bpr_savings_calculatorMetrics): business_process_re_engineering_bpr_savings_calculatorAnalysis {
