import { investment_calculatorCalculatorInputs, investment_calculatorCalculatorMetrics, investment_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: investment_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: investment_calculatorCalculatorInputs, metrics: investment_calculatorCalculatorMetrics): investment_calculatorCalculatorAnalysis {
