import { podcast_cost_calculatorCalculatorInputs, podcast_cost_calculatorCalculatorMetrics, podcast_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: podcast_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: podcast_cost_calculatorCalculatorInputs, metrics: podcast_cost_calculatorCalculatorMetrics): podcast_cost_calculatorCalculatorAnalysis {
