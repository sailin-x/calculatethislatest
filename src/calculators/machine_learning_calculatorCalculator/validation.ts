import { machine_learning_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: machine_learning_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
