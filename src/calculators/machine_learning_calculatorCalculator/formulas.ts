import { machine_learning_calculatorCalculatorInputs, machine_learning_calculatorCalculatorMetrics, machine_learning_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: machine_learning_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: machine_learning_calculatorCalculatorInputs, metrics: machine_learning_calculatorCalculatorMetrics): machine_learning_calculatorCalculatorAnalysis {
