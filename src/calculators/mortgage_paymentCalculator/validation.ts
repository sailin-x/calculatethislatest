import { mortgage_paymentCalculatorInputs } from './types';

export function validateInputs(inputs: mortgage_paymentCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
