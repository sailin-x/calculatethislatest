import { mortgage_paymentCalculatorInputs, mortgage_paymentCalculatorMetrics, mortgage_paymentCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgage_paymentCalculatorInputs): number {
...
export function generateAnalysis(inputs: mortgage_paymentCalculatorInputs, metrics: mortgage_paymentCalculatorMetrics): mortgage_paymentCalculatorAnalysis {
