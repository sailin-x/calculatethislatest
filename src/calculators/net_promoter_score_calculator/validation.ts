import { net_promoter_score_calculatorInputs } from './types';

export function validateInputs(inputs: net_promoter_score_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
