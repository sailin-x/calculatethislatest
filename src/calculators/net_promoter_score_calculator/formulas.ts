import { net_promoter_score_calculatorInputs, net_promoter_score_calculatorMetrics, net_promoter_score_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: net_promoter_score_calculatorInputs): number {
...
export function generateAnalysis(inputs: net_promoter_score_calculatorInputs, metrics: net_promoter_score_calculatorMetrics): net_promoter_score_calculatorAnalysis {
