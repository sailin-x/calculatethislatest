import { catastrophe_bond_pricing_calculatorInputs } from './types';

export function validateInputs(inputs: catastrophe_bond_pricing_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
