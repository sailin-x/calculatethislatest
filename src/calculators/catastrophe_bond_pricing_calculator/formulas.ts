import { catastrophe_bond_pricing_calculatorInputs, catastrophe_bond_pricing_calculatorMetrics, catastrophe_bond_pricing_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: catastrophe_bond_pricing_calculatorInputs): number {
...
export function generateAnalysis(inputs: catastrophe_bond_pricing_calculatorInputs, metrics: catastrophe_bond_pricing_calculatorMetrics): catastrophe_bond_pricing_calculatorAnalysis {
