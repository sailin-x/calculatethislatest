import { complex-numbersInputs, complex-numbersMetrics, complex-numbersAnalysis } from './types';
...
export function calculateResult(inputs: complex-numbersInputs): number {
...
export function generateAnalysis(inputs: complex-numbersInputs, metrics: complex-numbersMetrics): complex-numbersAnalysis {
