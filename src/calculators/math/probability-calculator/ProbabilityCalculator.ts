...
import { ProbabilityCalculatorInputs, ProbabilityCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateProbabilityCalculatorInputs } from './validation';
...
export const ProbabilityCalculator: Calculator = {
  ...
  category: 'math',
  subcategory: 'General',
  description: 'Calculate probabilities and distributions',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
