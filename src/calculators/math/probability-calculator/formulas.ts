import { probability-calculatorInputs, probability-calculatorMetrics, probability-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: probability-calculatorInputs): number {
...
export function generateAnalysis(inputs: probability-calculatorInputs, metrics: probability-calculatorMetrics): probability-calculatorAnalysis {
