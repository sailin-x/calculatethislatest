import { matrixInputs, matrixMetrics, matrixAnalysis } from './types';
...
export function calculateResult(inputs: matrixInputs): number {
...
export function generateAnalysis(inputs: matrixInputs, metrics: matrixMetrics): matrixAnalysis {
