...
import { PhysicsCalculatorInputs, PhysicsCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validatePhysicsCalculatorInputs } from './validation';

export const PhysicsCalculator: Calculator = {
  id: 'physics-calculator',
  title: 'Physics Calculator',
  category: 'math',
  subcategory: 'General',
  description: 'Calculate physics formulas',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
