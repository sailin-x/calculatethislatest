import { physics-calculatorInputs, physics-calculatorMetrics, physics-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: physics-calculatorInputs): number {
...
export function generateAnalysis(inputs: physics-calculatorInputs, metrics: physics-calculatorMetrics): physics-calculatorAnalysis {
