import { complex-number-calculatorInputs, complex-number-calculatorMetrics, complex-number-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: complex-number-calculatorInputs): number {
...
export function generateAnalysis(inputs: complex-number-calculatorInputs, metrics: complex-number-calculatorMetrics): complex-number-calculatorAnalysis {
