import { ComplexNumberCalculatorinputs, ComplexNumberCalculatormetrics, ComplexNumberCalculatoranalysis } from './types';
...
export function calculateResult(inputs: ComplexNumberCalculatorinputs): number {
...
export function generateAnalysis(inputs: ComplexNumberCalculatorinputs, metrics: ComplexNumberCalculatormetrics): ComplexNumberCalculatoranalysis {
