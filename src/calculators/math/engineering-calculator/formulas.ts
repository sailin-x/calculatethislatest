import { engineering-calculatorInputs, engineering-calculatorMetrics, engineering-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: engineering-calculatorInputs): number {
...
export function generateAnalysis(inputs: engineering-calculatorInputs, metrics: engineering-calculatorMetrics): engineering-calculatorAnalysis {
