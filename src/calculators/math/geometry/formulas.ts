import { geometryInputs, geometryMetrics, geometryAnalysis } from './types';
...
export function calculateResult(inputs: geometryInputs): number {
...
export function generateAnalysis(inputs: geometryInputs, metrics: geometryMetrics): geometryAnalysis {
