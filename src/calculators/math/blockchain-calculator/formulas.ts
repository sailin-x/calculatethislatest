import { blockchain-calculatorInputs, blockchain-calculatorMetrics, blockchain-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: blockchain-calculatorInputs): number {
...
export function generateAnalysis(inputs: blockchain-calculatorInputs, metrics: blockchain-calculatorMetrics): blockchain-calculatorAnalysis {
