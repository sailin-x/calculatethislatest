...
import { BlockchainCalculatorInputs, BlockchainCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateBlockchainCalculatorInputs } from './validation';

export const BlockchainCalculator: Calculator = {
  id: 'blockchain-calculator',
  title: 'Blockchain Calculator',
  category: 'math',
  subcategory: 'General',
  description: 'Calculate blockchain metrics',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
