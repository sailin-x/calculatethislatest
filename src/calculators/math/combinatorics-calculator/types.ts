export interface CombinatoricsCalculatorInputs {
...
export interface CombinatoricsCalculatorOutputs {
...
export interface CombinatoricsCalculatorMetrics {
...
export interface CombinatoricsCalculatorAnalysis {
