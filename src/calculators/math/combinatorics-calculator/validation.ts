import { CombinatoricsCalculatorInputs } from './types';

export function validateCombinatoricsCalculatorInputs(inputs: CombinatoricsCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCombinatoricsCalculatorBusinessRules(inputs: CombinatoricsCalculatorInputs): Array<{ field: string; message: string }> {
