import { unit-conversionInputs, unit-conversionMetrics, unit-conversionAnalysis } from './types';
...
export function calculateResult(inputs: unit-conversionInputs): number {
...
export function generateAnalysis(inputs: unit-conversionInputs, metrics: unit-conversionMetrics): unit-conversionAnalysis {
