import { algebraInputs, algebraMetrics, algebraAnalysis } from './types';
...
export function calculateResult(inputs: algebraInputs): number {
...
export function generateAnalysis(inputs: algebraInputs, metrics: algebraMetrics): algebraAnalysis {
