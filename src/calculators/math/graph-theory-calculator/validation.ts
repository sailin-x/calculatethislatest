import { GraphTheoryCalculatorInputs } from './types';

export function validateGraphTheoryCalculatorInputs(inputs: GraphTheoryCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateGraphTheoryCalculatorBusinessRules(inputs: GraphTheoryCalculatorInputs): Array<{ field: string; message: string }> {
