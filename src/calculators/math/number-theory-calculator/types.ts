export interface NumberTheoryCalculatorInputs {
...
export interface NumberTheoryCalculatorOutputs {
...
export interface NumberTheoryCalculatorMetrics {
...
export interface NumberTheoryCalculatorAnalysis {
