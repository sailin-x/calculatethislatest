import { NumberTheoryCalculatorInputs } from './types';

export function validateNumberTheoryCalculatorInputs(inputs: NumberTheoryCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateNumberTheoryCalculatorBusinessRules(inputs: NumberTheoryCalculatorInputs): Array<{ field: string; message: string }> {
