import { statisticsInputs, statisticsMetrics, statisticsAnalysis } from './types';
...
export function calculateResult(inputs: statisticsInputs): number {
...
export function generateAnalysis(inputs: statisticsInputs, metrics: statisticsMetrics): statisticsAnalysis {
