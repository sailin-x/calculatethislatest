import { scientific-calculatorInputs, scientific-calculatorMetrics, scientific-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: scientific-calculatorInputs): number {
...
export function generateAnalysis(inputs: scientific-calculatorInputs, metrics: scientific-calculatorMetrics): scientific-calculatorAnalysis {
