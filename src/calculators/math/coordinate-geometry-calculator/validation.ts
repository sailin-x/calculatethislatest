import { CoordinateGeometryCalculatorInputs } from './types';

export function validateCoordinateGeometryCalculatorInputs(inputs: CoordinateGeometryCalculatorInputs): Array<{ field: string; message: string }> {
...
export function validateCoordinateGeometryCalculatorBusinessRules(inputs: CoordinateGeometryCalculatorInputs): Array<{ field: string; message: string }> {
