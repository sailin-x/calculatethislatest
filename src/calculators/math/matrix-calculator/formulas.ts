import { matrix-calculatorInputs, matrix-calculatorMetrics, matrix-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: matrix-calculatorInputs): number {
...
export function generateAnalysis(inputs: matrix-calculatorInputs, metrics: matrix-calculatorMetrics): matrix-calculatorAnalysis {
