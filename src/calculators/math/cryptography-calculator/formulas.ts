import { cryptography-calculatorInputs, cryptography-calculatorMetrics, cryptography-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cryptography-calculatorInputs): number {
...
export function generateAnalysis(inputs: cryptography-calculatorInputs, metrics: cryptography-calculatorMetrics): cryptography-calculatorAnalysis {
