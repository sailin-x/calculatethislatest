...
import { CryptographyCalculatorInputs, CryptographyCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateCryptographyCalculatorInputs } from './validation';

export const CryptographyCalculator: Calculator = {
  id: 'cryptography-calculator',
  title: 'Cryptography Calculator',
  category: 'math',
  subcategory: 'General',
  description: 'Calculate cryptographic functions',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
