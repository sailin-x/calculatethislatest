import { cybersecurity-calculatorInputs, cybersecurity-calculatorMetrics, cybersecurity-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cybersecurity-calculatorInputs): number {
...
export function generateAnalysis(inputs: cybersecurity-calculatorInputs, metrics: cybersecurity-calculatorMetrics): cybersecurity-calculatorAnalysis {
