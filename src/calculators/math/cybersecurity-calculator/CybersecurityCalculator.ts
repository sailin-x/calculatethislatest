...
import { CybersecurityCalculatorInputs, CybersecurityCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateCybersecurityCalculatorInputs } from './validation';

export const CybersecurityCalculator: Calculator = {
  id: 'cybersecurity-calculator',
  title: 'Cybersecurity Calculator',
  category: 'math',
  subcategory: 'General',
  description: 'Calculate security metrics',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
