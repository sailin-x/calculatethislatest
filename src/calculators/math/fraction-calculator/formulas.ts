import { fraction-calculatorInputs, fraction-calculatorMetrics, fraction-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fraction-calculatorInputs): number {
...
export function generateAnalysis(inputs: fraction-calculatorInputs, metrics: fraction-calculatorMetrics): fraction-calculatorAnalysis {
