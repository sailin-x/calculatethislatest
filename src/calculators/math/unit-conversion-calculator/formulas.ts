import { unit-conversion-calculatorInputs, unit-conversion-calculatorMetrics, unit-conversion-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: unit-conversion-calculatorInputs): number {
...
export function generateAnalysis(inputs: unit-conversion-calculatorInputs, metrics: unit-conversion-calculatorMetrics): unit-conversion-calculatorAnalysis {
