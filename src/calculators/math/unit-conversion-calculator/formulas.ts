import { UnitConversionCalculatorinputs, UnitConversionCalculatormetrics, UnitConversionCalculatoranalysis } from './types';
...
export function calculateResult(inputs: UnitConversionCalculatorinputs): number {
...
export function generateAnalysis(inputs: UnitConversionCalculatorinputs, metrics: UnitConversionCalculatormetrics): UnitConversionCalculatoranalysis {
