import { biology-calculatorInputs, biology-calculatorMetrics, biology-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: biology-calculatorInputs): number {
...
export function generateAnalysis(inputs: biology-calculatorInputs, metrics: biology-calculatorMetrics): biology-calculatorAnalysis {
