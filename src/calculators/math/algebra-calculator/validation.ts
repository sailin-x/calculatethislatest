...
export function validateAlgebraCalculatorInputs(inputs: AlgebraCalculatorInputs): Array<{ field: string; message: string }> {
  const errors: Array<{ field: string; message: string }> = [];

  // Add specific validation based on calculator type
  const inputKeys = Object.keys(inputs) as Array<keyof AlgebraCalculatorInputs>;
...
export function validateAlgebraCalculatorBusinessRules(inputs: AlgebraCalculatorInputs): Array<{ field: string; message: string }> {
