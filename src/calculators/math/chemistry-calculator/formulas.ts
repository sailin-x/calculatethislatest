import { chemistry-calculatorInputs, chemistry-calculatorMetrics, chemistry-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: chemistry-calculatorInputs): number {
...
export function generateAnalysis(inputs: chemistry-calculatorInputs, metrics: chemistry-calculatorMetrics): chemistry-calculatorAnalysis {
