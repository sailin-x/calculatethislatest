...
import { ChemistryCalculatorInputs, ChemistryCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateChemistryCalculatorInputs } from './validation';

export const ChemistryCalculator: Calculator = {
  id: 'chemistry-calculator',
  title: 'Chemistry Calculator',
  category: 'math',
  subcategory: 'General',
  description: 'Calculate chemical formulas',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
