import { networking-calculatorInputs, networking-calculatorMetrics, networking-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: networking-calculatorInputs): number {
...
export function generateAnalysis(inputs: networking-calculatorInputs, metrics: networking-calculatorMetrics): networking-calculatorAnalysis {
