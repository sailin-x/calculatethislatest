import { database-calculatorInputs, database-calculatorMetrics, database-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: database-calculatorInputs): number {
...
export function generateAnalysis(inputs: database-calculatorInputs, metrics: database-calculatorMetrics): database-calculatorAnalysis {
