...
import { DatabaseCalculatorInputs, DatabaseCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateDatabaseCalculatorInputs } from './validation';

export const DatabaseCalculator: Calculator = {
  id: 'database-calculator',
  title: 'Database Calculator',
  category: 'math',
  subcategory: 'General',
  description: 'Calculate database performance',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
