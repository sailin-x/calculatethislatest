import { trigonometry-calculatorInputs, trigonometry-calculatorMetrics, trigonometry-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: trigonometry-calculatorInputs): number {
...
export function generateAnalysis(inputs: trigonometry-calculatorInputs, metrics: trigonometry-calculatorMetrics): trigonometry-calculatorAnalysis {
