import { scientificInputs, scientificMetrics, scientificAnalysis } from './types';
...
export function calculateResult(inputs: scientificInputs): number {
...
export function generateAnalysis(inputs: scientificInputs, metrics: scientificMetrics): scientificAnalysis {
