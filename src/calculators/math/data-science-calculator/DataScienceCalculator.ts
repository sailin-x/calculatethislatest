...
import { DataScienceCalculatorInputs, DataScienceCalculatorOutputs } from './types';
import { calculateResult, generateCalculation, generateAnalysis } from './formulas';
import { validateDataScienceCalculatorInputs } from './validation';

export const DataScienceCalculator: Calculator = {
  id: 'data-science-calculator',
  title: 'Data Science Calculator',
  category: 'math',
  subcategory: 'General',
  description: 'Calculate data science metrics',
  usageInstructions: [
    'Enter input value',
    'Specify multiplier',
