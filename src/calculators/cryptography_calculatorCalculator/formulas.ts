import { cryptography_calculatorCalculatorInputs, cryptography_calculatorCalculatorMetrics, cryptography_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cryptography_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: cryptography_calculatorCalculatorInputs, metrics: cryptography_calculatorCalculatorMetrics): cryptography_calculatorCalculatorAnalysis {
