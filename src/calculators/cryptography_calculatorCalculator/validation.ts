import { cryptography_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: cryptography_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
