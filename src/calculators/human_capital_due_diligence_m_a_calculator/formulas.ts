import { human_capital_due_diligence_m_a_calculatorInputs, human_capital_due_diligence_m_a_calculatorMetrics, human_capital_due_diligence_m_a_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: human_capital_due_diligence_m_a_calculatorInputs): number {
...
export function generateAnalysis(inputs: human_capital_due_diligence_m_a_calculatorInputs, metrics: human_capital_due_diligence_m_a_calculatorMetrics): human_capital_due_diligence_m_a_calculatorAnalysis {
