import { nursing_home_abuse_settlement_calculatorCalculatorInputs, nursing_home_abuse_settlement_calculatorCalculatorMetrics, nursing_home_abuse_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: nursing_home_abuse_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: nursing_home_abuse_settlement_calculatorCalculatorInputs, metrics: nursing_home_abuse_settlement_calculatorCalculatorMetrics): nursing_home_abuse_settlement_calculatorCalculatorAnalysis {
