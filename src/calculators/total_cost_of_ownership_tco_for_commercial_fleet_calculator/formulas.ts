import { total_cost_of_ownership_tco_for_commercial_fleet_calculatorInputs, total_cost_of_ownership_tco_for_commercial_fleet_calculatorMetrics, total_cost_of_ownership_tco_for_commercial_fleet_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: total_cost_of_ownership_tco_for_commercial_fleet_calculatorInputs): number {
...
export function generateAnalysis(inputs: total_cost_of_ownership_tco_for_commercial_fleet_calculatorInputs, metrics: total_cost_of_ownership_tco_for_commercial_fleet_calculatorMetrics): total_cost_of_ownership_tco_for_commercial_fleet_calculatorAnalysis {
