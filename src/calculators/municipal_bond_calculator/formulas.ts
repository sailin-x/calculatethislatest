import { municipal_bond_calculatorInputs, municipal_bond_calculatorMetrics, municipal_bond_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: municipal_bond_calculatorInputs): number {
...
export function generateAnalysis(inputs: municipal_bond_calculatorInputs, metrics: municipal_bond_calculatorMetrics): municipal_bond_calculatorAnalysis {
