import { rentVsBuyCalculatorInputs, rentVsBuyCalculatorMetrics, rentVsBuyCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: rentVsBuyCalculatorInputs): number {
...
export function generateAnalysis(inputs: rentVsBuyCalculatorInputs, metrics: rentVsBuyCalculatorMetrics): rentVsBuyCalculatorAnalysis {
