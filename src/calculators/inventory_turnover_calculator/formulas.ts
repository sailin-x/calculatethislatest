import { inventory_turnover_calculatorInputs, inventory_turnover_calculatorMetrics, inventory_turnover_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: inventory_turnover_calculatorInputs): number {
...
export function generateAnalysis(inputs: inventory_turnover_calculatorInputs, metrics: inventory_turnover_calculatorMetrics): inventory_turnover_calculatorAnalysis {
