import { high_net_worth_divorce_calculatorInputs } from './types';

export function validateInputs(inputs: high_net_worth_divorce_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
