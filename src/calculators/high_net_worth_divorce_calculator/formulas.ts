import { high_net_worth_divorce_calculatorInputs, high_net_worth_divorce_calculatorMetrics, high_net_worth_divorce_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: high_net_worth_divorce_calculatorInputs): number {
...
export function generateAnalysis(inputs: high_net_worth_divorce_calculatorInputs, metrics: high_net_worth_divorce_calculatorMetrics): high_net_worth_divorce_calculatorAnalysis {
