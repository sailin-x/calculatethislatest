import { roi_calculatorCalculatorInputs, roi_calculatorCalculatorMetrics, roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: roi_calculatorCalculatorInputs, metrics: roi_calculatorCalculatorMetrics): roi_calculatorCalculatorAnalysis {
