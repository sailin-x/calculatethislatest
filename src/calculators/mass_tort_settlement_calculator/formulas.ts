import { mass_tort_settlement_calculatorInputs, mass_tort_settlement_calculatorMetrics, mass_tort_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: mass_tort_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: mass_tort_settlement_calculatorInputs, metrics: mass_tort_settlement_calculatorMetrics): mass_tort_settlement_calculatorAnalysis {
