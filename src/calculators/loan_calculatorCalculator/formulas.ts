import { loan_calculatorCalculatorInputs, loan_calculatorCalculatorMetrics, loan_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: loan_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: loan_calculatorCalculatorInputs, metrics: loan_calculatorCalculatorMetrics): loan_calculatorCalculatorAnalysis {
