import { term_vs_universal_life_insurance_calculatorInputs, term_vs_universal_life_insurance_calculatorMetrics, term_vs_universal_life_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: term_vs_universal_life_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: term_vs_universal_life_insurance_calculatorInputs, metrics: term_vs_universal_life_insurance_calculatorMetrics): term_vs_universal_life_insurance_calculatorAnalysis {
