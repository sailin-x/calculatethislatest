import { qui_tam_reward_calculatorInputs, qui_tam_reward_calculatorMetrics, qui_tam_reward_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: qui_tam_reward_calculatorInputs): number {
...
export function generateAnalysis(inputs: qui_tam_reward_calculatorInputs, metrics: qui_tam_reward_calculatorMetrics): qui_tam_reward_calculatorAnalysis {
