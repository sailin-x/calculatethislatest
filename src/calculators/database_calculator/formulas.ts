import { database_calculatorInputs, database_calculatorMetrics, database_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: database_calculatorInputs): number {
...
export function generateAnalysis(inputs: database_calculatorInputs, metrics: database_calculatorMetrics): database_calculatorAnalysis {
