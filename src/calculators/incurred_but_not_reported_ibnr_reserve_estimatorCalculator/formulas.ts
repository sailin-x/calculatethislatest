import { incurred_but_not_reported_ibnr_reserve_estimatorCalculatorInputs, incurred_but_not_reported_ibnr_reserve_estimatorCalculatorMetrics, incurred_but_not_reported_ibnr_reserve_estimatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: incurred_but_not_reported_ibnr_reserve_estimatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: incurred_but_not_reported_ibnr_reserve_estimatorCalculatorInputs, metrics: incurred_but_not_reported_ibnr_reserve_estimatorCalculatorMetrics): incurred_but_not_reported_ibnr_reserve_estimatorCalculatorAnalysis {
