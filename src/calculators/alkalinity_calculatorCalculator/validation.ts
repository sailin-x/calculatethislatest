import { alkalinity_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: alkalinity_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
