import { alkalinity_calculatorCalculatorInputs, alkalinity_calculatorCalculatorMetrics, alkalinity_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: alkalinity_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: alkalinity_calculatorCalculatorInputs, metrics: alkalinity_calculatorCalculatorMetrics): alkalinity_calculatorCalculatorAnalysis {
