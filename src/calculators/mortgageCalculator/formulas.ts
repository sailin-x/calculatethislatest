import { mortgageCalculatorInputs, mortgageCalculatorMetrics, mortgageCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mortgageCalculatorInputs): number {
...
export function generateAnalysis(inputs: mortgageCalculatorInputs, metrics: mortgageCalculatorMetrics): mortgageCalculatorAnalysis {
