import { currency_exchange_cost_calculatorCalculatorInputs, currency_exchange_cost_calculatorCalculatorMetrics, currency_exchange_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: currency_exchange_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: currency_exchange_cost_calculatorCalculatorInputs, metrics: currency_exchange_cost_calculatorCalculatorMetrics): currency_exchange_cost_calculatorCalculatorAnalysis {
