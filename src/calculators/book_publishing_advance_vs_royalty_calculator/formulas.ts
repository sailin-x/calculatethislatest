import { book_publishing_advance_vs_royalty_calculatorInputs, book_publishing_advance_vs_royalty_calculatorMetrics, book_publishing_advance_vs_royalty_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: book_publishing_advance_vs_royalty_calculatorInputs): number {
...
export function generateAnalysis(inputs: book_publishing_advance_vs_royalty_calculatorInputs, metrics: book_publishing_advance_vs_royalty_calculatorMetrics): book_publishing_advance_vs_royalty_calculatorAnalysis {
