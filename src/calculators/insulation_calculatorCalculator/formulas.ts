import { insulation_calculatorCalculatorInputs, insulation_calculatorCalculatorMetrics, insulation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: insulation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: insulation_calculatorCalculatorInputs, metrics: insulation_calculatorCalculatorMetrics): insulation_calculatorCalculatorAnalysis {
