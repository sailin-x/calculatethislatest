import { breakeven_point_calculatorInputs, breakeven_point_calculatorMetrics, breakeven_point_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: breakeven_point_calculatorInputs): number {
...
export function generateAnalysis(inputs: breakeven_point_calculatorInputs, metrics: breakeven_point_calculatorMetrics): breakeven_point_calculatorAnalysis {
