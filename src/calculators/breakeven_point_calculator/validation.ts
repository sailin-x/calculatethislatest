import { breakeven_point_calculatorInputs } from './types';

export function validateInputs(inputs: breakeven_point_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
