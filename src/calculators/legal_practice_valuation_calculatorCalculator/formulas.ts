import { legal_practice_valuation_calculatorCalculatorInputs, legal_practice_valuation_calculatorCalculatorMetrics, legal_practice_valuation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: legal_practice_valuation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: legal_practice_valuation_calculatorCalculatorInputs, metrics: legal_practice_valuation_calculatorCalculatorMetrics): legal_practice_valuation_calculatorCalculatorAnalysis {
