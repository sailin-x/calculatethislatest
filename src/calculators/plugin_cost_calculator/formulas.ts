import { plugin_cost_calculatorInputs, plugin_cost_calculatorMetrics, plugin_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: plugin_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: plugin_cost_calculatorInputs, metrics: plugin_cost_calculatorMetrics): plugin_cost_calculatorAnalysis {
