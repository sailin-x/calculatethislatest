import { garden_calculatorInputs, garden_calculatorMetrics, garden_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: garden_calculatorInputs): number {
...
export function generateAnalysis(inputs: garden_calculatorInputs, metrics: garden_calculatorMetrics): garden_calculatorAnalysis {
