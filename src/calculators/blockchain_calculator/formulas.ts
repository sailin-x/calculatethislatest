import { blockchain_calculatorInputs, blockchain_calculatorMetrics, blockchain_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: blockchain_calculatorInputs): number {
...
export function generateAnalysis(inputs: blockchain_calculatorInputs, metrics: blockchain_calculatorMetrics): blockchain_calculatorAnalysis {
