import { cyber_liability_insurance_calculatorInputs, cyber_liability_insurance_calculatorMetrics, cyber_liability_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cyber_liability_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: cyber_liability_insurance_calculatorInputs, metrics: cyber_liability_insurance_calculatorMetrics): cyber_liability_insurance_calculatorAnalysis {
