import { tender_offer_valuation_calculatorCalculatorInputs, tender_offer_valuation_calculatorCalculatorMetrics, tender_offer_valuation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: tender_offer_valuation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: tender_offer_valuation_calculatorCalculatorInputs, metrics: tender_offer_valuation_calculatorCalculatorMetrics): tender_offer_valuation_calculatorCalculatorAnalysis {
