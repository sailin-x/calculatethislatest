import { tender_offer_valuation_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: tender_offer_valuation_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
