import { rights_offering_calculatorCalculatorInputs, rights_offering_calculatorCalculatorMetrics, rights_offering_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: rights_offering_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: rights_offering_calculatorCalculatorInputs, metrics: rights_offering_calculatorCalculatorMetrics): rights_offering_calculatorCalculatorAnalysis {
