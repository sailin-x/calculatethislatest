import { rights_offering_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: rights_offering_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
