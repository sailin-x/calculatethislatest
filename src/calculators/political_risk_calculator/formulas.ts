import { political_risk_calculatorInputs, political_risk_calculatorMetrics, political_risk_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: political_risk_calculatorInputs): number {
...
export function generateAnalysis(inputs: political_risk_calculatorInputs, metrics: political_risk_calculatorMetrics): political_risk_calculatorAnalysis {
