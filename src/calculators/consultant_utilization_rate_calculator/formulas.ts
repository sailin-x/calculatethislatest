import { consultant_utilization_rate_calculatorInputs, consultant_utilization_rate_calculatorMetrics, consultant_utilization_rate_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: consultant_utilization_rate_calculatorInputs): number {
...
export function generateAnalysis(inputs: consultant_utilization_rate_calculatorInputs, metrics: consultant_utilization_rate_calculatorMetrics): consultant_utilization_rate_calculatorAnalysis {
