import { consultant_utilization_rate_calculatorInputs } from './types';

export function validateInputs(inputs: consultant_utilization_rate_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
