import { premium_deficiency_reserve_calculatorInputs } from './types';

export function validateInputs(inputs: premium_deficiency_reserve_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
