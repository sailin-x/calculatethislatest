import { premium_deficiency_reserve_calculatorInputs, premium_deficiency_reserve_calculatorMetrics, premium_deficiency_reserve_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: premium_deficiency_reserve_calculatorInputs): number {
...
export function generateAnalysis(inputs: premium_deficiency_reserve_calculatorInputs, metrics: premium_deficiency_reserve_calculatorMetrics): premium_deficiency_reserve_calculatorAnalysis {
