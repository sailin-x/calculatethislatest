import { registerComprehensiveMortgageCalculatorInputs, registerComprehensiveMortgageCalculatorMetrics, registerComprehensiveMortgageCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerComprehensiveMortgageCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerComprehensiveMortgageCalculatorInputs, metrics: registerComprehensiveMortgageCalculatorMetrics): registerComprehensiveMortgageCalculatorAnalysis {
