import { registerComprehensiveMortgageCalculatorInputs } from './types';

export function validateInputs(inputs: registerComprehensiveMortgageCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
