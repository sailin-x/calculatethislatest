import { operating_margin_calculatorInputs, operating_margin_calculatorMetrics, operating_margin_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: operating_margin_calculatorInputs): number {
...
export function generateAnalysis(inputs: operating_margin_calculatorInputs, metrics: operating_margin_calculatorMetrics): operating_margin_calculatorAnalysis {
