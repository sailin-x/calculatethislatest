import { break_even_analysis_calculatorInputs, break_even_analysis_calculatorMetrics, break_even_analysis_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: break_even_analysis_calculatorInputs): number {
...
export function generateAnalysis(inputs: break_even_analysis_calculatorInputs, metrics: break_even_analysis_calculatorMetrics): break_even_analysis_calculatorAnalysis {
