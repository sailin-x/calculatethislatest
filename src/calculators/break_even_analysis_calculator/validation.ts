import { break_even_analysis_calculatorInputs } from './types';

export function validateInputs(inputs: break_even_analysis_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
