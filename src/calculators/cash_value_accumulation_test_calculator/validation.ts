import { cash_value_accumulation_test_calculatorInputs } from './types';

export function validateInputs(inputs: cash_value_accumulation_test_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
