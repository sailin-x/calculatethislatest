import { cash_value_accumulation_test_calculatorInputs, cash_value_accumulation_test_calculatorMetrics, cash_value_accumulation_test_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cash_value_accumulation_test_calculatorInputs): number {
...
export function generateAnalysis(inputs: cash_value_accumulation_test_calculatorInputs, metrics: cash_value_accumulation_test_calculatorMetrics): cash_value_accumulation_test_calculatorAnalysis {
