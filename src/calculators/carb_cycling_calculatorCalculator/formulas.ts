import { carb_cycling_calculatorCalculatorInputs, carb_cycling_calculatorCalculatorMetrics, carb_cycling_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: carb_cycling_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: carb_cycling_calculatorCalculatorInputs, metrics: carb_cycling_calculatorCalculatorMetrics): carb_cycling_calculatorCalculatorAnalysis {
