import { carb_cycling_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: carb_cycling_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
