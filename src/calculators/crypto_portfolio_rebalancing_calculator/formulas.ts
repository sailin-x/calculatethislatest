import { crypto_portfolio_rebalancing_calculatorInputs, crypto_portfolio_rebalancing_calculatorMetrics, crypto_portfolio_rebalancing_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: crypto_portfolio_rebalancing_calculatorInputs): number {
...
export function generateAnalysis(inputs: crypto_portfolio_rebalancing_calculatorInputs, metrics: crypto_portfolio_rebalancing_calculatorMetrics): crypto_portfolio_rebalancing_calculatorAnalysis {
