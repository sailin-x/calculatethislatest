import { professional_liability_calculatorCalculatorInputs, professional_liability_calculatorCalculatorMetrics, professional_liability_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: professional_liability_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: professional_liability_calculatorCalculatorInputs, metrics: professional_liability_calculatorCalculatorMetrics): professional_liability_calculatorCalculatorAnalysis {
