import { technical_debt_calculatorCalculatorInputs, technical_debt_calculatorCalculatorMetrics, technical_debt_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: technical_debt_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: technical_debt_calculatorCalculatorInputs, metrics: technical_debt_calculatorCalculatorMetrics): technical_debt_calculatorCalculatorAnalysis {
