import { technical_debt_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: technical_debt_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
