import { realEstateDepreciationScheduleCalculatorInputs, realEstateDepreciationScheduleCalculatorMetrics, realEstateDepreciationScheduleCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: realEstateDepreciationScheduleCalculatorInputs): number {
...
export function generateAnalysis(inputs: realEstateDepreciationScheduleCalculatorInputs, metrics: realEstateDepreciationScheduleCalculatorMetrics): realEstateDepreciationScheduleCalculatorAnalysis {
