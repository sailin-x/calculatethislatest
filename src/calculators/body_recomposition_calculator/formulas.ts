import { body_recomposition_calculatorInputs, body_recomposition_calculatorMetrics, body_recomposition_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: body_recomposition_calculatorInputs): number {
...
export function generateAnalysis(inputs: body_recomposition_calculatorInputs, metrics: body_recomposition_calculatorMetrics): body_recomposition_calculatorAnalysis {
