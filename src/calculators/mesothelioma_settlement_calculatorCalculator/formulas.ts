import { mesothelioma_settlement_calculatorCalculatorInputs, mesothelioma_settlement_calculatorCalculatorMetrics, mesothelioma_settlement_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mesothelioma_settlement_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: mesothelioma_settlement_calculatorCalculatorInputs, metrics: mesothelioma_settlement_calculatorCalculatorMetrics): mesothelioma_settlement_calculatorCalculatorAnalysis {
