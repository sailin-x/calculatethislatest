import { timberland_investment_calculatorCalculatorInputs, timberland_investment_calculatorCalculatorMetrics, timberland_investment_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: timberland_investment_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: timberland_investment_calculatorCalculatorInputs, metrics: timberland_investment_calculatorCalculatorMetrics): timberland_investment_calculatorCalculatorAnalysis {
