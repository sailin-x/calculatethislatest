import { modified_dietz_return_calculatorCalculatorInputs, modified_dietz_return_calculatorCalculatorMetrics, modified_dietz_return_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: modified_dietz_return_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: modified_dietz_return_calculatorCalculatorInputs, metrics: modified_dietz_return_calculatorCalculatorMetrics): modified_dietz_return_calculatorCalculatorAnalysis {
