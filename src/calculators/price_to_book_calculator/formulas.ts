import { price_to_book_calculatorInputs, price_to_book_calculatorMetrics, price_to_book_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: price_to_book_calculatorInputs): number {
...
export function generateAnalysis(inputs: price_to_book_calculatorInputs, metrics: price_to_book_calculatorMetrics): price_to_book_calculatorAnalysis {
