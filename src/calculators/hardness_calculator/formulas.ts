import { hardness_calculatorInputs, hardness_calculatorMetrics, hardness_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: hardness_calculatorInputs): number {
...
export function generateAnalysis(inputs: hardness_calculatorInputs, metrics: hardness_calculatorMetrics): hardness_calculatorAnalysis {
