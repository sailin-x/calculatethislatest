import { media_mix_modeling_calculatorInputs, media_mix_modeling_calculatorMetrics, media_mix_modeling_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: media_mix_modeling_calculatorInputs): number {
...
export function generateAnalysis(inputs: media_mix_modeling_calculatorInputs, metrics: media_mix_modeling_calculatorMetrics): media_mix_modeling_calculatorAnalysis {
