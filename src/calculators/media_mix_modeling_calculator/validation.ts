import { media_mix_modeling_calculatorInputs } from './types';

export function validateInputs(inputs: media_mix_modeling_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
