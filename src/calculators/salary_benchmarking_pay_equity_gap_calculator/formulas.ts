import { salary_benchmarking_pay_equity_gap_calculatorInputs, salary_benchmarking_pay_equity_gap_calculatorMetrics, salary_benchmarking_pay_equity_gap_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: salary_benchmarking_pay_equity_gap_calculatorInputs): number {
...
export function generateAnalysis(inputs: salary_benchmarking_pay_equity_gap_calculatorInputs, metrics: salary_benchmarking_pay_equity_gap_calculatorMetrics): salary_benchmarking_pay_equity_gap_calculatorAnalysis {
