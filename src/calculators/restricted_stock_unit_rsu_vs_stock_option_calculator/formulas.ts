import { restricted_stock_unit_rsu_vs_stock_option_calculatorInputs, restricted_stock_unit_rsu_vs_stock_option_calculatorMetrics, restricted_stock_unit_rsu_vs_stock_option_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: restricted_stock_unit_rsu_vs_stock_option_calculatorInputs): number {
...
export function generateAnalysis(inputs: restricted_stock_unit_rsu_vs_stock_option_calculatorInputs, metrics: restricted_stock_unit_rsu_vs_stock_option_calculatorMetrics): restricted_stock_unit_rsu_vs_stock_option_calculatorAnalysis {
