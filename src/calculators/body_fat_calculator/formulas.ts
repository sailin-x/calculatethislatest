import { body_fat_calculatorInputs, body_fat_calculatorMetrics, body_fat_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: body_fat_calculatorInputs): number {
...
export function generateAnalysis(inputs: body_fat_calculatorInputs, metrics: body_fat_calculatorMetrics): body_fat_calculatorAnalysis {
