import { financial_freedom_calculatorInputs, financial_freedom_calculatorMetrics, financial_freedom_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_freedom_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_freedom_calculatorInputs, metrics: financial_freedom_calculatorMetrics): financial_freedom_calculatorAnalysis {
