import { financial_freedom_calculatorInputs } from './types';

export function validateInputs(inputs: financial_freedom_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
