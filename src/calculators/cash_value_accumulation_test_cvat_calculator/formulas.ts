import { cash_value_accumulation_test_cvat_calculatorInputs, cash_value_accumulation_test_cvat_calculatorMetrics, cash_value_accumulation_test_cvat_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cash_value_accumulation_test_cvat_calculatorInputs): number {
...
export function generateAnalysis(inputs: cash_value_accumulation_test_cvat_calculatorInputs, metrics: cash_value_accumulation_test_cvat_calculatorMetrics): cash_value_accumulation_test_cvat_calculatorAnalysis {
