import { tile_calculatorCalculatorInputs, tile_calculatorCalculatorMetrics, tile_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: tile_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: tile_calculatorCalculatorInputs, metrics: tile_calculatorCalculatorMetrics): tile_calculatorCalculatorAnalysis {
