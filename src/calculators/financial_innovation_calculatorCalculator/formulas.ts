import { financial_innovation_calculatorCalculatorInputs, financial_innovation_calculatorCalculatorMetrics, financial_innovation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_innovation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_innovation_calculatorCalculatorInputs, metrics: financial_innovation_calculatorCalculatorMetrics): financial_innovation_calculatorCalculatorAnalysis {
