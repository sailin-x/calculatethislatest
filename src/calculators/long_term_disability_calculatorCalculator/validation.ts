import { long_term_disability_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: long_term_disability_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
