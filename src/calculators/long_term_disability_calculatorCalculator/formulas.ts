import { long_term_disability_calculatorCalculatorInputs, long_term_disability_calculatorCalculatorMetrics, long_term_disability_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: long_term_disability_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: long_term_disability_calculatorCalculatorInputs, metrics: long_term_disability_calculatorCalculatorMetrics): long_term_disability_calculatorCalculatorAnalysis {
