import { title_insuranceCalculatorInputs, title_insuranceCalculatorMetrics, title_insuranceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: title_insuranceCalculatorInputs): number {
...
export function generateAnalysis(inputs: title_insuranceCalculatorInputs, metrics: title_insuranceCalculatorMetrics): title_insuranceCalculatorAnalysis {
