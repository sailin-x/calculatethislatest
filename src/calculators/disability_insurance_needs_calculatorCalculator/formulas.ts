import { disability_insurance_needs_calculatorCalculatorInputs, disability_insurance_needs_calculatorCalculatorMetrics, disability_insurance_needs_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: disability_insurance_needs_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: disability_insurance_needs_calculatorCalculatorInputs, metrics: disability_insurance_needs_calculatorCalculatorMetrics): disability_insurance_needs_calculatorCalculatorAnalysis {
