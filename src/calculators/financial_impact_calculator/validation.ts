import { financial_impact_calculatorInputs } from './types';

export function validateInputs(inputs: financial_impact_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
