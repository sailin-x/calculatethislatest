import { financial_impact_calculatorInputs, financial_impact_calculatorMetrics, financial_impact_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_impact_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_impact_calculatorInputs, metrics: financial_impact_calculatorMetrics): financial_impact_calculatorAnalysis {
