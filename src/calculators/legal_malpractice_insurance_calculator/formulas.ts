import { legal_malpractice_insurance_calculatorInputs, legal_malpractice_insurance_calculatorMetrics, legal_malpractice_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: legal_malpractice_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: legal_malpractice_insurance_calculatorInputs, metrics: legal_malpractice_insurance_calculatorMetrics): legal_malpractice_insurance_calculatorAnalysis {
