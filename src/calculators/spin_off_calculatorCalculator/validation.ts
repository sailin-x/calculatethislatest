import { spin_off_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: spin_off_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
