import { spin_off_calculatorCalculatorInputs, spin_off_calculatorCalculatorMetrics, spin_off_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: spin_off_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: spin_off_calculatorCalculatorInputs, metrics: spin_off_calculatorCalculatorMetrics): spin_off_calculatorCalculatorAnalysis {
