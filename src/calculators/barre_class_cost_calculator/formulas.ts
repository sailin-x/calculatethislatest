import { barre_class_cost_calculatorInputs, barre_class_cost_calculatorMetrics, barre_class_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: barre_class_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: barre_class_cost_calculatorInputs, metrics: barre_class_cost_calculatorMetrics): barre_class_cost_calculatorAnalysis {
