import { bond_convexity_calculatorInputs, bond_convexity_calculatorMetrics, bond_convexity_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: bond_convexity_calculatorInputs): number {
...
export function generateAnalysis(inputs: bond_convexity_calculatorInputs, metrics: bond_convexity_calculatorMetrics): bond_convexity_calculatorAnalysis {
