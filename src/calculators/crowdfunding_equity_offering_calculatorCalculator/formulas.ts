import { crowdfunding_equity_offering_calculatorCalculatorInputs, crowdfunding_equity_offering_calculatorCalculatorMetrics, crowdfunding_equity_offering_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: crowdfunding_equity_offering_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: crowdfunding_equity_offering_calculatorCalculatorInputs, metrics: crowdfunding_equity_offering_calculatorCalculatorMetrics): crowdfunding_equity_offering_calculatorCalculatorAnalysis {
