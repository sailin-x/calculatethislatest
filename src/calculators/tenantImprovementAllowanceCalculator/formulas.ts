import { tenantImprovementAllowanceCalculatorInputs, tenantImprovementAllowanceCalculatorMetrics, tenantImprovementAllowanceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: tenantImprovementAllowanceCalculatorInputs): number {
...
export function generateAnalysis(inputs: tenantImprovementAllowanceCalculatorInputs, metrics: tenantImprovementAllowanceCalculatorMetrics): tenantImprovementAllowanceCalculatorAnalysis {
