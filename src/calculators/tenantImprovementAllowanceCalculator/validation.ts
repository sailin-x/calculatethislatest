import { tenantImprovementAllowanceCalculatorInputs } from './types';

export function validateInputs(inputs: tenantImprovementAllowanceCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
