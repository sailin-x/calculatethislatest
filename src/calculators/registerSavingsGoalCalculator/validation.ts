import { registerSavingsGoalCalculatorInputs } from './types';

export function validateInputs(inputs: registerSavingsGoalCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
