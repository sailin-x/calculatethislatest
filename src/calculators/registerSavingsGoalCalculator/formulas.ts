import { registerSavingsGoalCalculatorInputs, registerSavingsGoalCalculatorMetrics, registerSavingsGoalCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerSavingsGoalCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerSavingsGoalCalculatorInputs, metrics: registerSavingsGoalCalculatorMetrics): registerSavingsGoalCalculatorAnalysis {
