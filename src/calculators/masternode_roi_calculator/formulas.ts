import { masternode_roi_calculatorInputs, masternode_roi_calculatorMetrics, masternode_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: masternode_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: masternode_roi_calculatorInputs, metrics: masternode_roi_calculatorMetrics): masternode_roi_calculatorAnalysis {
