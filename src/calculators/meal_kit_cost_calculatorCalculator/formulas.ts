import { meal_kit_cost_calculatorCalculatorInputs, meal_kit_cost_calculatorCalculatorMetrics, meal_kit_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: meal_kit_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: meal_kit_cost_calculatorCalculatorInputs, metrics: meal_kit_cost_calculatorCalculatorMetrics): meal_kit_cost_calculatorCalculatorAnalysis {
