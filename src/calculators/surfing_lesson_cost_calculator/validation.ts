import { surfing_lesson_cost_calculatorInputs } from './types';

export function validateInputs(inputs: surfing_lesson_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
