import { surfing_lesson_cost_calculatorInputs, surfing_lesson_cost_calculatorMetrics, surfing_lesson_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: surfing_lesson_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: surfing_lesson_cost_calculatorInputs, metrics: surfing_lesson_cost_calculatorMetrics): surfing_lesson_cost_calculatorAnalysis {
