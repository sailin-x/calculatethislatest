import { registerMarketingROICalculatorInputs } from './types';

export function validateInputs(inputs: registerMarketingROICalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
