import { registerMarketingROICalculatorInputs, registerMarketingROICalculatorMetrics, registerMarketingROICalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerMarketingROICalculatorInputs): number {
...
export function generateAnalysis(inputs: registerMarketingROICalculatorInputs, metrics: registerMarketingROICalculatorMetrics): registerMarketingROICalculatorAnalysis {
