import { distribution_waterfall_model_calculatorCalculatorInputs, distribution_waterfall_model_calculatorCalculatorMetrics, distribution_waterfall_model_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: distribution_waterfall_model_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: distribution_waterfall_model_calculatorCalculatorInputs, metrics: distribution_waterfall_model_calculatorCalculatorMetrics): distribution_waterfall_model_calculatorCalculatorAnalysis {
