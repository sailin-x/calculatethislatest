import { loan_comparison_calculatorInputs, loan_comparison_calculatorMetrics, loan_comparison_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: loan_comparison_calculatorInputs): number {
...
export function generateAnalysis(inputs: loan_comparison_calculatorInputs, metrics: loan_comparison_calculatorMetrics): loan_comparison_calculatorAnalysis {
