import { mental_health_treatment_cost_calculatorCalculatorInputs, mental_health_treatment_cost_calculatorCalculatorMetrics, mental_health_treatment_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: mental_health_treatment_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: mental_health_treatment_cost_calculatorCalculatorInputs, metrics: mental_health_treatment_cost_calculatorCalculatorMetrics): mental_health_treatment_cost_calculatorCalculatorAnalysis {
