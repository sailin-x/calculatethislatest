import { computer_science_calculatorCalculatorInputs, computer_science_calculatorCalculatorMetrics, computer_science_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: computer_science_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: computer_science_calculatorCalculatorInputs, metrics: computer_science_calculatorCalculatorMetrics): computer_science_calculatorCalculatorAnalysis {
