import { painting_cost_calculatorInputs, painting_cost_calculatorMetrics, painting_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: painting_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: painting_cost_calculatorInputs, metrics: painting_cost_calculatorMetrics): painting_cost_calculatorAnalysis {
