import { snowboard_lesson_cost_calculatorCalculatorInputs, snowboard_lesson_cost_calculatorCalculatorMetrics, snowboard_lesson_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: snowboard_lesson_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: snowboard_lesson_cost_calculatorCalculatorInputs, metrics: snowboard_lesson_cost_calculatorCalculatorMetrics): snowboard_lesson_cost_calculatorCalculatorAnalysis {
