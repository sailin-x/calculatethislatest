import { recaptitalization_impact_calculatorInputs, recaptitalization_impact_calculatorMetrics, recaptitalization_impact_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: recaptitalization_impact_calculatorInputs): number {
...
export function generateAnalysis(inputs: recaptitalization_impact_calculatorInputs, metrics: recaptitalization_impact_calculatorMetrics): recaptitalization_impact_calculatorAnalysis {
