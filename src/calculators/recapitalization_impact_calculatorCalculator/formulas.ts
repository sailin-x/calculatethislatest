import { recapitalization_impact_calculatorCalculatorInputs, recapitalization_impact_calculatorCalculatorMetrics, recapitalization_impact_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: recapitalization_impact_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: recapitalization_impact_calculatorCalculatorInputs, metrics: recapitalization_impact_calculatorCalculatorMetrics): recapitalization_impact_calculatorCalculatorAnalysis {
