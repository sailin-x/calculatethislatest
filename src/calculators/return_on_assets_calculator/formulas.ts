import { return_on_assets_calculatorInputs, return_on_assets_calculatorMetrics, return_on_assets_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: return_on_assets_calculatorInputs): number {
...
export function generateAnalysis(inputs: return_on_assets_calculatorInputs, metrics: return_on_assets_calculatorMetrics): return_on_assets_calculatorAnalysis {
