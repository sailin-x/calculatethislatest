import { price_to_earnings_calculatorCalculatorInputs, price_to_earnings_calculatorCalculatorMetrics, price_to_earnings_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: price_to_earnings_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: price_to_earnings_calculatorCalculatorInputs, metrics: price_to_earnings_calculatorCalculatorMetrics): price_to_earnings_calculatorCalculatorAnalysis {
