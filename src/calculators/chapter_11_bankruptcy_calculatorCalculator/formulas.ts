import { chapter_11_bankruptcy_calculatorCalculatorInputs, chapter_11_bankruptcy_calculatorCalculatorMetrics, chapter_11_bankruptcy_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: chapter_11_bankruptcy_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: chapter_11_bankruptcy_calculatorCalculatorInputs, metrics: chapter_11_bankruptcy_calculatorCalculatorMetrics): chapter_11_bankruptcy_calculatorCalculatorAnalysis {
