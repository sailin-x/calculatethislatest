import { chapter_11_bankruptcy_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: chapter_11_bankruptcy_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
