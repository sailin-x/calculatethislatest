import { health_insurance_calculatorCalculatorInputs, health_insurance_calculatorCalculatorMetrics, health_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: health_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: health_insurance_calculatorCalculatorInputs, metrics: health_insurance_calculatorCalculatorMetrics): health_insurance_calculatorCalculatorAnalysis {
