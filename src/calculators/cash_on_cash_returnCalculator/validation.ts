import { cash_on_cash_returnCalculatorInputs } from './types';

export function validateInputs(inputs: cash_on_cash_returnCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
