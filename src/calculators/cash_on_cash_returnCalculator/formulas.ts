import { cash_on_cash_returnCalculatorInputs, cash_on_cash_returnCalculatorMetrics, cash_on_cash_returnCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: cash_on_cash_returnCalculatorInputs): number {
...
export function generateAnalysis(inputs: cash_on_cash_returnCalculatorInputs, metrics: cash_on_cash_returnCalculatorMetrics): cash_on_cash_returnCalculatorAnalysis {
