import { activity_cost_calculatorInputs, activity_cost_calculatorMetrics, activity_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: activity_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: activity_cost_calculatorInputs, metrics: activity_cost_calculatorMetrics): activity_cost_calculatorAnalysis {
