import { private_equity_irr_calculatorInputs, private_equity_irr_calculatorMetrics, private_equity_irr_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: private_equity_irr_calculatorInputs): number {
...
export function generateAnalysis(inputs: private_equity_irr_calculatorInputs, metrics: private_equity_irr_calculatorMetrics): private_equity_irr_calculatorAnalysis {
