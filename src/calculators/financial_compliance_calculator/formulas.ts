import { financial_compliance_calculatorInputs, financial_compliance_calculatorMetrics, financial_compliance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_compliance_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_compliance_calculatorInputs, metrics: financial_compliance_calculatorMetrics): financial_compliance_calculatorAnalysis {
