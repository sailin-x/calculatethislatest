import { financial_compliance_calculatorInputs } from './types';

export function validateInputs(inputs: financial_compliance_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
