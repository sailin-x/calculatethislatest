import { home_insurance_calculatorCalculatorInputs, home_insurance_calculatorCalculatorMetrics, home_insurance_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: home_insurance_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: home_insurance_calculatorCalculatorInputs, metrics: home_insurance_calculatorCalculatorMetrics): home_insurance_calculatorCalculatorAnalysis {
