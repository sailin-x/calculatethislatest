import { financial_efficiency_calculatorInputs } from './types';

export function validateInputs(inputs: financial_efficiency_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
