import { financial_efficiency_calculatorInputs, financial_efficiency_calculatorMetrics, financial_efficiency_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_efficiency_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_efficiency_calculatorInputs, metrics: financial_efficiency_calculatorMetrics): financial_efficiency_calculatorAnalysis {
