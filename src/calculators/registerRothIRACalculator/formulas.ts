import { registerRothIRACalculatorInputs, registerRothIRACalculatorMetrics, registerRothIRACalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerRothIRACalculatorInputs): number {
...
export function generateAnalysis(inputs: registerRothIRACalculatorInputs, metrics: registerRothIRACalculatorMetrics): registerRothIRACalculatorAnalysis {
