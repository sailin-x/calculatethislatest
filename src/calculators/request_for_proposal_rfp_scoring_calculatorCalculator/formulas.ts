import { request_for_proposal_rfp_scoring_calculatorCalculatorInputs, request_for_proposal_rfp_scoring_calculatorCalculatorMetrics, request_for_proposal_rfp_scoring_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: request_for_proposal_rfp_scoring_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: request_for_proposal_rfp_scoring_calculatorCalculatorInputs, metrics: request_for_proposal_rfp_scoring_calculatorCalculatorMetrics): request_for_proposal_rfp_scoring_calculatorCalculatorAnalysis {
