import { college_savingsCalculatorInputs, college_savingsCalculatorMetrics, college_savingsCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: college_savingsCalculatorInputs): number {
...
export function generateAnalysis(inputs: college_savingsCalculatorInputs, metrics: college_savingsCalculatorMetrics): college_savingsCalculatorAnalysis {
