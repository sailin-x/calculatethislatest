import { hit_and_run_settlement_calculatorInputs, hit_and_run_settlement_calculatorMetrics, hit_and_run_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: hit_and_run_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: hit_and_run_settlement_calculatorInputs, metrics: hit_and_run_settlement_calculatorMetrics): hit_and_run_settlement_calculatorAnalysis {
