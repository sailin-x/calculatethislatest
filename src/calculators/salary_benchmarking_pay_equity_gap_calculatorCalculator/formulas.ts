import { salary_benchmarking_pay_equity_gap_calculatorCalculatorInputs, salary_benchmarking_pay_equity_gap_calculatorCalculatorMetrics, salary_benchmarking_pay_equity_gap_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: salary_benchmarking_pay_equity_gap_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: salary_benchmarking_pay_equity_gap_calculatorCalculatorInputs, metrics: salary_benchmarking_pay_equity_gap_calculatorCalculatorMetrics): salary_benchmarking_pay_equity_gap_calculatorCalculatorAnalysis {
