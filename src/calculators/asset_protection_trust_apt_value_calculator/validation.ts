import { asset_protection_trust_apt_value_calculatorInputs } from './types';

export function validateInputs(inputs: asset_protection_trust_apt_value_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
