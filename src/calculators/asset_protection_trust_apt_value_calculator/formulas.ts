import { asset_protection_trust_apt_value_calculatorInputs, asset_protection_trust_apt_value_calculatorMetrics, asset_protection_trust_apt_value_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: asset_protection_trust_apt_value_calculatorInputs): number {
...
export function generateAnalysis(inputs: asset_protection_trust_apt_value_calculatorInputs, metrics: asset_protection_trust_apt_value_calculatorMetrics): asset_protection_trust_apt_value_calculatorAnalysis {
