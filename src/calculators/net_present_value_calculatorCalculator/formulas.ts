import { net_present_value_calculatorCalculatorInputs, net_present_value_calculatorCalculatorMetrics, net_present_value_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: net_present_value_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: net_present_value_calculatorCalculatorInputs, metrics: net_present_value_calculatorCalculatorMetrics): net_present_value_calculatorCalculatorAnalysis {
