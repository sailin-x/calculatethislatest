import { net_present_value_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: net_present_value_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
