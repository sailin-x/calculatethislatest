import { cyber_liability_calculatorInputs } from './types';

export function validateInputs(inputs: cyber_liability_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
