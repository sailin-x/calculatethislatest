import { cyber_liability_calculatorInputs, cyber_liability_calculatorMetrics, cyber_liability_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cyber_liability_calculatorInputs): number {
...
export function generateAnalysis(inputs: cyber_liability_calculatorInputs, metrics: cyber_liability_calculatorMetrics): cyber_liability_calculatorAnalysis {
