import { social_media_cost_calculatorCalculatorInputs, social_media_cost_calculatorCalculatorMetrics, social_media_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: social_media_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: social_media_cost_calculatorCalculatorInputs, metrics: social_media_cost_calculatorCalculatorMetrics): social_media_cost_calculatorCalculatorAnalysis {
