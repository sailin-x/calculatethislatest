import { epa_fine_calculatorInputs, epa_fine_calculatorMetrics, epa_fine_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: epa_fine_calculatorInputs): number {
...
export function generateAnalysis(inputs: epa_fine_calculatorInputs, metrics: epa_fine_calculatorMetrics): epa_fine_calculatorAnalysis {
