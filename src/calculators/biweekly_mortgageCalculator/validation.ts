import { biweekly_mortgageCalculatorInputs } from './types';

export function validateInputs(inputs: biweekly_mortgageCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
