import { biweekly_mortgageCalculatorInputs, biweekly_mortgageCalculatorMetrics, biweekly_mortgageCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: biweekly_mortgageCalculatorInputs): number {
...
export function generateAnalysis(inputs: biweekly_mortgageCalculatorInputs, metrics: biweekly_mortgageCalculatorMetrics): biweekly_mortgageCalculatorAnalysis {
