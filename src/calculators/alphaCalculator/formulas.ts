import { alphaCalculatorInputs, alphaCalculatorMetrics, alphaCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: alphaCalculatorInputs): number {
...
export function generateAnalysis(inputs: alphaCalculatorInputs, metrics: alphaCalculatorMetrics): alphaCalculatorAnalysis {
