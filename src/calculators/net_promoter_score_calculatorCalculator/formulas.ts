import { net_promoter_score_calculatorCalculatorInputs, net_promoter_score_calculatorCalculatorMetrics, net_promoter_score_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: net_promoter_score_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: net_promoter_score_calculatorCalculatorInputs, metrics: net_promoter_score_calculatorCalculatorMetrics): net_promoter_score_calculatorCalculatorAnalysis {
