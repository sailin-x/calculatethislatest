import { macro_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: macro_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
