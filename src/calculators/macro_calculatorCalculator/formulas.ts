import { macro_calculatorCalculatorInputs, macro_calculatorCalculatorMetrics, macro_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: macro_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: macro_calculatorCalculatorInputs, metrics: macro_calculatorCalculatorMetrics): macro_calculatorCalculatorAnalysis {
