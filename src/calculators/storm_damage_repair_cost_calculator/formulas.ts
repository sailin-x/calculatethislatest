import { storm_damage_repair_cost_calculatorInputs, storm_damage_repair_cost_calculatorMetrics, storm_damage_repair_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: storm_damage_repair_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: storm_damage_repair_cost_calculatorInputs, metrics: storm_damage_repair_cost_calculatorMetrics): storm_damage_repair_cost_calculatorAnalysis {
