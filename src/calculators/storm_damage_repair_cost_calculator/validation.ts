import { storm_damage_repair_cost_calculatorInputs } from './types';

export function validateInputs(inputs: storm_damage_repair_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
