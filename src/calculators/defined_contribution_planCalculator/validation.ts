import { defined_contribution_planCalculatorInputs } from './types';

export function validateInputs(inputs: defined_contribution_planCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
