import { defined_contribution_planCalculatorInputs, defined_contribution_planCalculatorMetrics, defined_contribution_planCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: defined_contribution_planCalculatorInputs): number {
...
export function generateAnalysis(inputs: defined_contribution_planCalculatorInputs, metrics: defined_contribution_planCalculatorMetrics): defined_contribution_planCalculatorAnalysis {
