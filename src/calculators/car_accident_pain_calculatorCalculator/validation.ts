import { car_accident_pain_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: car_accident_pain_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
