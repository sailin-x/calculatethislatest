import { car_accident_pain_calculatorCalculatorInputs, car_accident_pain_calculatorCalculatorMetrics, car_accident_pain_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: car_accident_pain_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: car_accident_pain_calculatorCalculatorInputs, metrics: car_accident_pain_calculatorCalculatorMetrics): car_accident_pain_calculatorCalculatorAnalysis {
