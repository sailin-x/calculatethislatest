import { registerRentersInsuranceCalculatorInputs, registerRentersInsuranceCalculatorMetrics, registerRentersInsuranceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerRentersInsuranceCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerRentersInsuranceCalculatorInputs, metrics: registerRentersInsuranceCalculatorMetrics): registerRentersInsuranceCalculatorAnalysis {
