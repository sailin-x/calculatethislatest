import { registerRentersInsuranceCalculatorInputs } from './types';

export function validateInputs(inputs: registerRentersInsuranceCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
