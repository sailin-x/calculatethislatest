import { soc_2_compliance_cost_calculatorCalculatorInputs, soc_2_compliance_cost_calculatorCalculatorMetrics, soc_2_compliance_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: soc_2_compliance_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: soc_2_compliance_cost_calculatorCalculatorInputs, metrics: soc_2_compliance_cost_calculatorCalculatorMetrics): soc_2_compliance_cost_calculatorCalculatorAnalysis {
