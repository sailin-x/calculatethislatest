import { prescription_cost_calculatorInputs, prescription_cost_calculatorMetrics, prescription_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: prescription_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: prescription_cost_calculatorInputs, metrics: prescription_cost_calculatorMetrics): prescription_cost_calculatorAnalysis {
