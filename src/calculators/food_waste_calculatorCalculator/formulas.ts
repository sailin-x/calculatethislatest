import { food_waste_calculatorCalculatorInputs, food_waste_calculatorCalculatorMetrics, food_waste_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: food_waste_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: food_waste_calculatorCalculatorInputs, metrics: food_waste_calculatorCalculatorMetrics): food_waste_calculatorCalculatorAnalysis {
