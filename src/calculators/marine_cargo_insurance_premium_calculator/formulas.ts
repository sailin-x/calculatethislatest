import { marine_cargo_insurance_premium_calculatorInputs, marine_cargo_insurance_premium_calculatorMetrics, marine_cargo_insurance_premium_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: marine_cargo_insurance_premium_calculatorInputs): number {
...
export function generateAnalysis(inputs: marine_cargo_insurance_premium_calculatorInputs, metrics: marine_cargo_insurance_premium_calculatorMetrics): marine_cargo_insurance_premium_calculatorAnalysis {
