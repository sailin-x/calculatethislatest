import { patreon_subscription_calculatorCalculatorInputs, patreon_subscription_calculatorCalculatorMetrics, patreon_subscription_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: patreon_subscription_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: patreon_subscription_calculatorCalculatorInputs, metrics: patreon_subscription_calculatorCalculatorMetrics): patreon_subscription_calculatorCalculatorAnalysis {
