import { debt_yield_ratioCalculatorInputs } from './types';

export function validateInputs(inputs: debt_yield_ratioCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
