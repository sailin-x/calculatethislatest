import { debt_yield_ratioCalculatorInputs, debt_yield_ratioCalculatorMetrics, debt_yield_ratioCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_yield_ratioCalculatorInputs): number {
...
export function generateAnalysis(inputs: debt_yield_ratioCalculatorInputs, metrics: debt_yield_ratioCalculatorMetrics): debt_yield_ratioCalculatorAnalysis {
