import { financial_planning_calculatorInputs } from './types';

export function validateInputs(inputs: financial_planning_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
