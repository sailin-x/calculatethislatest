import { financial_planning_calculatorInputs, financial_planning_calculatorMetrics, financial_planning_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_planning_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_planning_calculatorInputs, metrics: financial_planning_calculatorMetrics): financial_planning_calculatorAnalysis {
