import { heart_rate_variability_calculatorInputs, heart_rate_variability_calculatorMetrics, heart_rate_variability_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: heart_rate_variability_calculatorInputs): number {
...
export function generateAnalysis(inputs: heart_rate_variability_calculatorInputs, metrics: heart_rate_variability_calculatorMetrics): heart_rate_variability_calculatorAnalysis {
