import { franchise_roi_calculatorInputs, franchise_roi_calculatorMetrics, franchise_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: franchise_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: franchise_roi_calculatorInputs, metrics: franchise_roi_calculatorMetrics): franchise_roi_calculatorAnalysis {
