import { biological_age_calculatorInputs, biological_age_calculatorMetrics, biological_age_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: biological_age_calculatorInputs): number {
...
export function generateAnalysis(inputs: biological_age_calculatorInputs, metrics: biological_age_calculatorMetrics): biological_age_calculatorAnalysis {
