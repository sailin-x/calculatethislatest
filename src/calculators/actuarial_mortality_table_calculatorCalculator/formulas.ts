import { actuarial_mortality_table_calculatorCalculatorInputs, actuarial_mortality_table_calculatorCalculatorMetrics, actuarial_mortality_table_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: actuarial_mortality_table_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: actuarial_mortality_table_calculatorCalculatorInputs, metrics: actuarial_mortality_table_calculatorCalculatorMetrics): actuarial_mortality_table_calculatorCalculatorAnalysis {
