import { estate_planning_calculatorInputs, estate_planning_calculatorMetrics, estate_planning_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: estate_planning_calculatorInputs): number {
...
export function generateAnalysis(inputs: estate_planning_calculatorInputs, metrics: estate_planning_calculatorMetrics): estate_planning_calculatorAnalysis {
