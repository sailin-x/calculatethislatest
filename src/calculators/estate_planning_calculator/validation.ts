import { estate_planning_calculatorInputs } from './types';

export function validateInputs(inputs: estate_planning_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
