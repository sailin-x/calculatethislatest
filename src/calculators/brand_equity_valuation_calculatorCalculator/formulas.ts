import { brand_equity_valuation_calculatorCalculatorInputs, brand_equity_valuation_calculatorCalculatorMetrics, brand_equity_valuation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: brand_equity_valuation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: brand_equity_valuation_calculatorCalculatorInputs, metrics: brand_equity_valuation_calculatorCalculatorMetrics): brand_equity_valuation_calculatorCalculatorAnalysis {
