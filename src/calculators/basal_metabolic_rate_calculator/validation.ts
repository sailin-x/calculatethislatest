import { basal_metabolic_rate_calculatorInputs } from './types';

export function validateInputs(inputs: basal_metabolic_rate_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
