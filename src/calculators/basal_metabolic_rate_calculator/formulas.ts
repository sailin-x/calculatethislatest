import { basal_metabolic_rate_calculatorInputs, basal_metabolic_rate_calculatorMetrics, basal_metabolic_rate_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: basal_metabolic_rate_calculatorInputs): number {
...
export function generateAnalysis(inputs: basal_metabolic_rate_calculatorInputs, metrics: basal_metabolic_rate_calculatorMetrics): basal_metabolic_rate_calculatorAnalysis {
