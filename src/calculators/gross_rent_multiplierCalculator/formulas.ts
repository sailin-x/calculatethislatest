import { gross_rent_multiplierCalculatorInputs, gross_rent_multiplierCalculatorMetrics, gross_rent_multiplierCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: gross_rent_multiplierCalculatorInputs): number {
...
export function generateAnalysis(inputs: gross_rent_multiplierCalculatorInputs, metrics: gross_rent_multiplierCalculatorMetrics): gross_rent_multiplierCalculatorAnalysis {
