import { gross_rent_multiplierCalculatorInputs } from './types';

export function validateInputs(inputs: gross_rent_multiplierCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
