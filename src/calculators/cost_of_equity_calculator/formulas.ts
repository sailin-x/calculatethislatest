import { cost_of_equity_calculatorInputs, cost_of_equity_calculatorMetrics, cost_of_equity_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cost_of_equity_calculatorInputs): number {
...
export function generateAnalysis(inputs: cost_of_equity_calculatorInputs, metrics: cost_of_equity_calculatorMetrics): cost_of_equity_calculatorAnalysis {
