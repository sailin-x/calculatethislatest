import { registerCorrelationCalculatorInputs } from './types';

export function validateInputs(inputs: registerCorrelationCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
