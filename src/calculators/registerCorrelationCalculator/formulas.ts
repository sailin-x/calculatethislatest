import { registerCorrelationCalculatorInputs, registerCorrelationCalculatorMetrics, registerCorrelationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerCorrelationCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerCorrelationCalculatorInputs, metrics: registerCorrelationCalculatorMetrics): registerCorrelationCalculatorAnalysis {
