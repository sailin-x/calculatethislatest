import { crowdfunding_equity_offering_calculatorInputs, crowdfunding_equity_offering_calculatorMetrics, crowdfunding_equity_offering_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: crowdfunding_equity_offering_calculatorInputs): number {
...
export function generateAnalysis(inputs: crowdfunding_equity_offering_calculatorInputs, metrics: crowdfunding_equity_offering_calculatorMetrics): crowdfunding_equity_offering_calculatorAnalysis {
