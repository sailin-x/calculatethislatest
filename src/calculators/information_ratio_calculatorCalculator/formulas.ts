import { information_ratio_calculatorCalculatorInputs, information_ratio_calculatorCalculatorMetrics, information_ratio_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: information_ratio_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: information_ratio_calculatorCalculatorInputs, metrics: information_ratio_calculatorCalculatorMetrics): information_ratio_calculatorCalculatorAnalysis {
