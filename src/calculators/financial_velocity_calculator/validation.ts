import { financial_velocity_calculatorInputs } from './types';

export function validateInputs(inputs: financial_velocity_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
