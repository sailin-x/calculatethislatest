import { financial_velocity_calculatorInputs, financial_velocity_calculatorMetrics, financial_velocity_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_velocity_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_velocity_calculatorInputs, metrics: financial_velocity_calculatorMetrics): financial_velocity_calculatorAnalysis {
