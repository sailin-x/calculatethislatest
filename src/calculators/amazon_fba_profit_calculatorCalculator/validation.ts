import { amazon_fba_profit_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: amazon_fba_profit_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
