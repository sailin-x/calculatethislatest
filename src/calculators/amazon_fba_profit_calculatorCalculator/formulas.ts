import { amazon_fba_profit_calculatorCalculatorInputs, amazon_fba_profit_calculatorCalculatorMetrics, amazon_fba_profit_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: amazon_fba_profit_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: amazon_fba_profit_calculatorCalculatorInputs, metrics: amazon_fba_profit_calculatorCalculatorMetrics): amazon_fba_profit_calculatorCalculatorAnalysis {
