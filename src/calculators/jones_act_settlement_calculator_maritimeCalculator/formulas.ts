import { jones_act_settlement_calculator_maritimeCalculatorInputs, jones_act_settlement_calculator_maritimeCalculatorMetrics, jones_act_settlement_calculator_maritimeCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: jones_act_settlement_calculator_maritimeCalculatorInputs): number {
...
export function generateAnalysis(inputs: jones_act_settlement_calculator_maritimeCalculatorInputs, metrics: jones_act_settlement_calculator_maritimeCalculatorMetrics): jones_act_settlement_calculator_maritimeCalculatorAnalysis {
