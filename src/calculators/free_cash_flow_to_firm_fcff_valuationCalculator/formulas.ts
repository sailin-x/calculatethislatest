import { free_cash_flow_to_firm_fcff_valuationCalculatorInputs, free_cash_flow_to_firm_fcff_valuationCalculatorMetrics, free_cash_flow_to_firm_fcff_valuationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: free_cash_flow_to_firm_fcff_valuationCalculatorInputs): number {
...
export function generateAnalysis(inputs: free_cash_flow_to_firm_fcff_valuationCalculatorInputs, metrics: free_cash_flow_to_firm_fcff_valuationCalculatorMetrics): free_cash_flow_to_firm_fcff_valuationCalculatorAnalysis {
