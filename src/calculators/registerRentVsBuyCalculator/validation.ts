import { registerRentVsBuyCalculatorInputs } from './types';

export function validateInputs(inputs: registerRentVsBuyCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
