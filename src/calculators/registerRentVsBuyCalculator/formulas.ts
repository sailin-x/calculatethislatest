import { registerRentVsBuyCalculatorInputs, registerRentVsBuyCalculatorMetrics, registerRentVsBuyCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerRentVsBuyCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerRentVsBuyCalculatorInputs, metrics: registerRentVsBuyCalculatorMetrics): registerRentVsBuyCalculatorAnalysis {
