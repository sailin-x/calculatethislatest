import { glycemic_load_calculatorCalculatorInputs, glycemic_load_calculatorCalculatorMetrics, glycemic_load_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: glycemic_load_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: glycemic_load_calculatorCalculatorInputs, metrics: glycemic_load_calculatorCalculatorMetrics): glycemic_load_calculatorCalculatorAnalysis {
