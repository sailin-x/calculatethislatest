import { glycemic_load_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: glycemic_load_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
