import { self_funded_health_plan_calculatorInputs } from './types';

export function validateInputs(inputs: self_funded_health_plan_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
