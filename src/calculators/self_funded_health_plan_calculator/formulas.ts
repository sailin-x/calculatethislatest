import { self_funded_health_plan_calculatorInputs, self_funded_health_plan_calculatorMetrics, self_funded_health_plan_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: self_funded_health_plan_calculatorInputs): number {
...
export function generateAnalysis(inputs: self_funded_health_plan_calculatorInputs, metrics: self_funded_health_plan_calculatorMetrics): self_funded_health_plan_calculatorAnalysis {
