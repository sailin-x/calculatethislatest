import { child_support_calculatorCalculatorInputs, child_support_calculatorCalculatorMetrics, child_support_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: child_support_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: child_support_calculatorCalculatorInputs, metrics: child_support_calculatorCalculatorMetrics): child_support_calculatorCalculatorAnalysis {
