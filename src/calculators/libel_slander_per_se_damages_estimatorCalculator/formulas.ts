import { libel_slander_per_se_damages_estimatorCalculatorInputs, libel_slander_per_se_damages_estimatorCalculatorMetrics, libel_slander_per_se_damages_estimatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: libel_slander_per_se_damages_estimatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: libel_slander_per_se_damages_estimatorCalculatorInputs, metrics: libel_slander_per_se_damages_estimatorCalculatorMetrics): libel_slander_per_se_damages_estimatorCalculatorAnalysis {
