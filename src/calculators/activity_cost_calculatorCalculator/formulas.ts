import { activity_cost_calculatorCalculatorInputs, activity_cost_calculatorCalculatorMetrics, activity_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: activity_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: activity_cost_calculatorCalculatorInputs, metrics: activity_cost_calculatorCalculatorMetrics): activity_cost_calculatorCalculatorAnalysis {
