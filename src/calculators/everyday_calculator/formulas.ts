import { everyday_calculatorInputs, everyday_calculatorMetrics, everyday_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: everyday_calculatorInputs): number {
...
export function generateAnalysis(inputs: everyday_calculatorInputs, metrics: everyday_calculatorMetrics): everyday_calculatorAnalysis {
