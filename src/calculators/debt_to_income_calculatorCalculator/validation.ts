import { debt_to_income_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: debt_to_income_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
