import { debt_to_income_calculatorCalculatorInputs, debt_to_income_calculatorCalculatorMetrics, debt_to_income_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_to_income_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: debt_to_income_calculatorCalculatorInputs, metrics: debt_to_income_calculatorCalculatorMetrics): debt_to_income_calculatorCalculatorAnalysis {
