import { data_breach_cost_calculatorCalculatorInputs, data_breach_cost_calculatorCalculatorMetrics, data_breach_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: data_breach_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: data_breach_cost_calculatorCalculatorInputs, metrics: data_breach_cost_calculatorCalculatorMetrics): data_breach_cost_calculatorCalculatorAnalysis {
