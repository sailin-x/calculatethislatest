import { roofing_calculatorInputs, roofing_calculatorMetrics, roofing_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: roofing_calculatorInputs): number {
...
export function generateAnalysis(inputs: roofing_calculatorInputs, metrics: roofing_calculatorMetrics): roofing_calculatorAnalysis {
