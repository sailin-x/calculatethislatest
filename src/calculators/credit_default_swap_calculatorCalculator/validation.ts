import { credit_default_swap_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: credit_default_swap_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
