import { credit_default_swap_calculatorCalculatorInputs, credit_default_swap_calculatorCalculatorMetrics, credit_default_swap_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: credit_default_swap_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: credit_default_swap_calculatorCalculatorInputs, metrics: credit_default_swap_calculatorCalculatorMetrics): credit_default_swap_calculatorCalculatorAnalysis {
