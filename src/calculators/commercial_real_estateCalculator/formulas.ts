import { commercial_real_estateCalculatorInputs, commercial_real_estateCalculatorMetrics, commercial_real_estateCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: commercial_real_estateCalculatorInputs): number {
...
export function generateAnalysis(inputs: commercial_real_estateCalculatorInputs, metrics: commercial_real_estateCalculatorMetrics): commercial_real_estateCalculatorAnalysis {
