import { commercial_real_estateCalculatorInputs } from './types';

export function validateInputs(inputs: commercial_real_estateCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
