import { preventative_maintenance_savings_calculatorCalculatorInputs, preventative_maintenance_savings_calculatorCalculatorMetrics, preventative_maintenance_savings_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: preventative_maintenance_savings_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: preventative_maintenance_savings_calculatorCalculatorInputs, metrics: preventative_maintenance_savings_calculatorCalculatorMetrics): preventative_maintenance_savings_calculatorCalculatorAnalysis {
