import { financial_innovation_calculatorInputs } from './types';

export function validateInputs(inputs: financial_innovation_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
