import { financial_innovation_calculatorInputs, financial_innovation_calculatorMetrics, financial_innovation_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_innovation_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_innovation_calculatorInputs, metrics: financial_innovation_calculatorMetrics): financial_innovation_calculatorAnalysis {
