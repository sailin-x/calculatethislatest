import { algebraCalculatorInputs, algebraCalculatorMetrics, algebraCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: algebraCalculatorInputs): number {
...
export function generateAnalysis(inputs: algebraCalculatorInputs, metrics: algebraCalculatorMetrics): algebraCalculatorAnalysis {
