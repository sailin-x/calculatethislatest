import { environmental_remediation_cost_estimatorCalculatorInputs, environmental_remediation_cost_estimatorCalculatorMetrics, environmental_remediation_cost_estimatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: environmental_remediation_cost_estimatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: environmental_remediation_cost_estimatorCalculatorInputs, metrics: environmental_remediation_cost_estimatorCalculatorMetrics): environmental_remediation_cost_estimatorCalculatorAnalysis {
