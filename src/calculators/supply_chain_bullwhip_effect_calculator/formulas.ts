import { supply_chain_bullwhip_effect_calculatorInputs, supply_chain_bullwhip_effect_calculatorMetrics, supply_chain_bullwhip_effect_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: supply_chain_bullwhip_effect_calculatorInputs): number {
...
export function generateAnalysis(inputs: supply_chain_bullwhip_effect_calculatorInputs, metrics: supply_chain_bullwhip_effect_calculatorMetrics): supply_chain_bullwhip_effect_calculatorAnalysis {
