import { cryptography_calculatorInputs, cryptography_calculatorMetrics, cryptography_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cryptography_calculatorInputs): number {
...
export function generateAnalysis(inputs: cryptography_calculatorInputs, metrics: cryptography_calculatorMetrics): cryptography_calculatorAnalysis {
