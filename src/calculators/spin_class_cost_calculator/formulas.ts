import { spin_class_cost_calculatorInputs, spin_class_cost_calculatorMetrics, spin_class_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: spin_class_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: spin_class_cost_calculatorInputs, metrics: spin_class_cost_calculatorMetrics): spin_class_cost_calculatorAnalysis {
