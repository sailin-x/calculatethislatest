import { real_estate_tax_deductions_calculatorCalculatorInputs, real_estate_tax_deductions_calculatorCalculatorMetrics, real_estate_tax_deductions_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: real_estate_tax_deductions_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: real_estate_tax_deductions_calculatorCalculatorInputs, metrics: real_estate_tax_deductions_calculatorCalculatorMetrics): real_estate_tax_deductions_calculatorCalculatorAnalysis {
