import { financial_coaching_calculatorInputs, financial_coaching_calculatorMetrics, financial_coaching_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_coaching_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_coaching_calculatorInputs, metrics: financial_coaching_calculatorMetrics): financial_coaching_calculatorAnalysis {
