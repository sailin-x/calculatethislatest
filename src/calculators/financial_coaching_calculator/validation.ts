import { financial_coaching_calculatorInputs } from './types';

export function validateInputs(inputs: financial_coaching_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
