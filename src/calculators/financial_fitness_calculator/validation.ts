import { financial_fitness_calculatorInputs } from './types';

export function validateInputs(inputs: financial_fitness_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
