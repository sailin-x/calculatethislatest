import { financial_fitness_calculatorInputs, financial_fitness_calculatorMetrics, financial_fitness_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_fitness_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_fitness_calculatorInputs, metrics: financial_fitness_calculatorMetrics): financial_fitness_calculatorAnalysis {
