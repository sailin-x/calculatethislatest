import { net_promoter_score_nps_calculatorCalculatorInputs, net_promoter_score_nps_calculatorCalculatorMetrics, net_promoter_score_nps_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: net_promoter_score_nps_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: net_promoter_score_nps_calculatorCalculatorInputs, metrics: net_promoter_score_nps_calculatorCalculatorMetrics): net_promoter_score_nps_calculatorCalculatorAnalysis {
