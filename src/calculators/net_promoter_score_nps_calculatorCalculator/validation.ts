import { net_promoter_score_nps_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: net_promoter_score_nps_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
