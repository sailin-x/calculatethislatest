import { private_mortgage_insuranceCalculatorInputs, private_mortgage_insuranceCalculatorMetrics, private_mortgage_insuranceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: private_mortgage_insuranceCalculatorInputs): number {
...
export function generateAnalysis(inputs: private_mortgage_insuranceCalculatorInputs, metrics: private_mortgage_insuranceCalculatorMetrics): private_mortgage_insuranceCalculatorAnalysis {
