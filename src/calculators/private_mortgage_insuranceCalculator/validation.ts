import { private_mortgage_insuranceCalculatorInputs } from './types';

export function validateInputs(inputs: private_mortgage_insuranceCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
