import { rentersInsuranceCalculatorInputs } from './types';

export function validateInputs(inputs: rentersInsuranceCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
