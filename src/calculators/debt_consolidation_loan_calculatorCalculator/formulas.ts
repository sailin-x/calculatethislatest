import { debt_consolidation_loan_calculatorCalculatorInputs, debt_consolidation_loan_calculatorCalculatorMetrics, debt_consolidation_loan_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: debt_consolidation_loan_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: debt_consolidation_loan_calculatorCalculatorInputs, metrics: debt_consolidation_loan_calculatorCalculatorMetrics): debt_consolidation_loan_calculatorCalculatorAnalysis {
