import { automotiveCalculatorInputs, automotiveCalculatorMetrics, automotiveCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: automotiveCalculatorInputs): number {
...
export function generateAnalysis(inputs: automotiveCalculatorInputs, metrics: automotiveCalculatorMetrics): automotiveCalculatorAnalysis {
