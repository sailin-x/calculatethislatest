import { aquarium_cost_calculatorCalculatorInputs, aquarium_cost_calculatorCalculatorMetrics, aquarium_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: aquarium_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: aquarium_cost_calculatorCalculatorInputs, metrics: aquarium_cost_calculatorCalculatorMetrics): aquarium_cost_calculatorCalculatorAnalysis {
