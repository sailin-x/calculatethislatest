import { patent_valuation_calculatorCalculatorInputs, patent_valuation_calculatorCalculatorMetrics, patent_valuation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: patent_valuation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: patent_valuation_calculatorCalculatorInputs, metrics: patent_valuation_calculatorCalculatorMetrics): patent_valuation_calculatorCalculatorAnalysis {
