import { commercial_real_estate_cash_flowCalculatorInputs, commercial_real_estate_cash_flowCalculatorMetrics, commercial_real_estate_cash_flowCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: commercial_real_estate_cash_flowCalculatorInputs): number {
...
export function generateAnalysis(inputs: commercial_real_estate_cash_flowCalculatorInputs, metrics: commercial_real_estate_cash_flowCalculatorMetrics): commercial_real_estate_cash_flowCalculatorAnalysis {
