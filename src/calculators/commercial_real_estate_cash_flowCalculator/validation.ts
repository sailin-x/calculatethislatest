import { commercial_real_estate_cash_flowCalculatorInputs } from './types';

export function validateInputs(inputs: commercial_real_estate_cash_flowCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
