import { data_center_tco_calculatorInputs } from './types';

export function validateInputs(inputs: data_center_tco_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
