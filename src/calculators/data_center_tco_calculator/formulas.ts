import { data_center_tco_calculatorInputs, data_center_tco_calculatorMetrics, data_center_tco_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: data_center_tco_calculatorInputs): number {
...
export function generateAnalysis(inputs: data_center_tco_calculatorInputs, metrics: data_center_tco_calculatorMetrics): data_center_tco_calculatorAnalysis {
