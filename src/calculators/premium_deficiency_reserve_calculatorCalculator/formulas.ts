import { premium_deficiency_reserve_calculatorCalculatorInputs, premium_deficiency_reserve_calculatorCalculatorMetrics, premium_deficiency_reserve_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: premium_deficiency_reserve_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: premium_deficiency_reserve_calculatorCalculatorInputs, metrics: premium_deficiency_reserve_calculatorCalculatorMetrics): premium_deficiency_reserve_calculatorCalculatorAnalysis {
