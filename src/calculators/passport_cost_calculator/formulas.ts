import { passport_cost_calculatorInputs, passport_cost_calculatorMetrics, passport_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: passport_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: passport_cost_calculatorInputs, metrics: passport_cost_calculatorMetrics): passport_cost_calculatorAnalysis {
