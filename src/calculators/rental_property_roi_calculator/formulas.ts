import { rental_property_roi_calculatorInputs, rental_property_roi_calculatorMetrics, rental_property_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: rental_property_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: rental_property_roi_calculatorInputs, metrics: rental_property_roi_calculatorMetrics): rental_property_roi_calculatorAnalysis {
