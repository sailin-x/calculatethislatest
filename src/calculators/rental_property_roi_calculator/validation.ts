import { rental_property_roi_calculatorInputs } from './types';

export function validateInputs(inputs: rental_property_roi_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
