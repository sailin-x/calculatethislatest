import { bariatric_surgery_cost_savings_calculatorCalculatorInputs, bariatric_surgery_cost_savings_calculatorCalculatorMetrics, bariatric_surgery_cost_savings_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: bariatric_surgery_cost_savings_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: bariatric_surgery_cost_savings_calculatorCalculatorInputs, metrics: bariatric_surgery_cost_savings_calculatorCalculatorMetrics): bariatric_surgery_cost_savings_calculatorCalculatorAnalysis {
