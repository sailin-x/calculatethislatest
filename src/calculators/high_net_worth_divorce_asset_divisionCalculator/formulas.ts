import { high_net_worth_divorce_asset_divisionCalculatorInputs, high_net_worth_divorce_asset_divisionCalculatorMetrics, high_net_worth_divorce_asset_divisionCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: high_net_worth_divorce_asset_divisionCalculatorInputs): number {
...
export function generateAnalysis(inputs: high_net_worth_divorce_asset_divisionCalculatorInputs, metrics: high_net_worth_divorce_asset_divisionCalculatorMetrics): high_net_worth_divorce_asset_divisionCalculatorAnalysis {
