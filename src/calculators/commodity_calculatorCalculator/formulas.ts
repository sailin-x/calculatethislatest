import { commodity_calculatorCalculatorInputs, commodity_calculatorCalculatorMetrics, commodity_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: commodity_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: commodity_calculatorCalculatorInputs, metrics: commodity_calculatorCalculatorMetrics): commodity_calculatorCalculatorAnalysis {
