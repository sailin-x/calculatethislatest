import { commodity_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: commodity_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
