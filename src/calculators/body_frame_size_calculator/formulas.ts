import { body_frame_size_calculatorInputs, body_frame_size_calculatorMetrics, body_frame_size_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: body_frame_size_calculatorInputs): number {
...
export function generateAnalysis(inputs: body_frame_size_calculatorInputs, metrics: body_frame_size_calculatorMetrics): body_frame_size_calculatorAnalysis {
