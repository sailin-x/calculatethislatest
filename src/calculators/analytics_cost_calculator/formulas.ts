import { analytics_cost_calculatorInputs, analytics_cost_calculatorMetrics, analytics_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: analytics_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: analytics_cost_calculatorInputs, metrics: analytics_cost_calculatorMetrics): analytics_cost_calculatorAnalysis {
