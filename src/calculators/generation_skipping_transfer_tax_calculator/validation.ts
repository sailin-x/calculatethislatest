import { generation_skipping_transfer_tax_calculatorInputs } from './types';

export function validateInputs(inputs: generation_skipping_transfer_tax_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
