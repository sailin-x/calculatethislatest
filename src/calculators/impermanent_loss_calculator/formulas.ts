import { impermanent_loss_calculatorInputs, impermanent_loss_calculatorMetrics, impermanent_loss_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: impermanent_loss_calculatorInputs): number {
...
export function generateAnalysis(inputs: impermanent_loss_calculatorInputs, metrics: impermanent_loss_calculatorMetrics): impermanent_loss_calculatorAnalysis {
