import { financial_goal_calculatorCalculatorInputs, financial_goal_calculatorCalculatorMetrics, financial_goal_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_goal_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_goal_calculatorCalculatorInputs, metrics: financial_goal_calculatorCalculatorMetrics): financial_goal_calculatorCalculatorAnalysis {
