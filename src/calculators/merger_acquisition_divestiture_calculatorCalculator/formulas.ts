import { merger_acquisition_divestiture_calculatorCalculatorInputs, merger_acquisition_divestiture_calculatorCalculatorMetrics, merger_acquisition_divestiture_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: merger_acquisition_divestiture_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: merger_acquisition_divestiture_calculatorCalculatorInputs, metrics: merger_acquisition_divestiture_calculatorCalculatorMetrics): merger_acquisition_divestiture_calculatorCalculatorAnalysis {
