import { customer_segmentation_calculatorCalculatorInputs, customer_segmentation_calculatorCalculatorMetrics, customer_segmentation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: customer_segmentation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: customer_segmentation_calculatorCalculatorInputs, metrics: customer_segmentation_calculatorCalculatorMetrics): customer_segmentation_calculatorCalculatorAnalysis {
