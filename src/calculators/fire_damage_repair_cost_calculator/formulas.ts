import { fire_damage_repair_cost_calculatorInputs, fire_damage_repair_cost_calculatorMetrics, fire_damage_repair_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fire_damage_repair_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: fire_damage_repair_cost_calculatorInputs, metrics: fire_damage_repair_cost_calculatorMetrics): fire_damage_repair_cost_calculatorAnalysis {
