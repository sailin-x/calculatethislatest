import { fire_damage_repair_cost_calculatorInputs } from './types';

export function validateInputs(inputs: fire_damage_repair_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
