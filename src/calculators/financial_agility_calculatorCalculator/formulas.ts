import { financial_agility_calculatorCalculatorInputs, financial_agility_calculatorCalculatorMetrics, financial_agility_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_agility_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_agility_calculatorCalculatorInputs, metrics: financial_agility_calculatorCalculatorMetrics): financial_agility_calculatorCalculatorAnalysis {
