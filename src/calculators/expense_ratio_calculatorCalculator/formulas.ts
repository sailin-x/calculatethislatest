import { expense_ratio_calculatorCalculatorInputs, expense_ratio_calculatorCalculatorMetrics, expense_ratio_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: expense_ratio_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: expense_ratio_calculatorCalculatorInputs, metrics: expense_ratio_calculatorCalculatorMetrics): expense_ratio_calculatorCalculatorAnalysis {
