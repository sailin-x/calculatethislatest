import { crypto_tax_harvesting_calculatorCalculatorInputs, crypto_tax_harvesting_calculatorCalculatorMetrics, crypto_tax_harvesting_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: crypto_tax_harvesting_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: crypto_tax_harvesting_calculatorCalculatorInputs, metrics: crypto_tax_harvesting_calculatorCalculatorMetrics): crypto_tax_harvesting_calculatorCalculatorAnalysis {
