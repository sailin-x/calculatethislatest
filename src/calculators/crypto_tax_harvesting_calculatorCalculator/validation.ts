import { crypto_tax_harvesting_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: crypto_tax_harvesting_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
