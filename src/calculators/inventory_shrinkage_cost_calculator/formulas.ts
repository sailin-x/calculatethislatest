import { inventory_shrinkage_cost_calculatorInputs, inventory_shrinkage_cost_calculatorMetrics, inventory_shrinkage_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: inventory_shrinkage_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: inventory_shrinkage_cost_calculatorInputs, metrics: inventory_shrinkage_cost_calculatorMetrics): inventory_shrinkage_cost_calculatorAnalysis {
