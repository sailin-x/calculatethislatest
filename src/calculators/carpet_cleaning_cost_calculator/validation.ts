import { carpet_cleaning_cost_calculatorInputs } from './types';

export function validateInputs(inputs: carpet_cleaning_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
