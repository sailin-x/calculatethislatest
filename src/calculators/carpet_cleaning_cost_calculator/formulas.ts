import { carpet_cleaning_cost_calculatorInputs, carpet_cleaning_cost_calculatorMetrics, carpet_cleaning_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: carpet_cleaning_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: carpet_cleaning_cost_calculatorInputs, metrics: carpet_cleaning_cost_calculatorMetrics): carpet_cleaning_cost_calculatorAnalysis {
