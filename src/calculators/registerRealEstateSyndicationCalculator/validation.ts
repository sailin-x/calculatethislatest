import { registerRealEstateSyndicationCalculatorInputs } from './types';

export function validateInputs(inputs: registerRealEstateSyndicationCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
