import { registerRealEstateSyndicationCalculatorInputs, registerRealEstateSyndicationCalculatorMetrics, registerRealEstateSyndicationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerRealEstateSyndicationCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerRealEstateSyndicationCalculatorInputs, metrics: registerRealEstateSyndicationCalculatorMetrics): registerRealEstateSyndicationCalculatorAnalysis {
