import { token_vesting_schedule_calculatorInputs, token_vesting_schedule_calculatorMetrics, token_vesting_schedule_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: token_vesting_schedule_calculatorInputs): number {
...
export function generateAnalysis(inputs: token_vesting_schedule_calculatorInputs, metrics: token_vesting_schedule_calculatorMetrics): token_vesting_schedule_calculatorAnalysis {
