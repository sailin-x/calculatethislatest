import { price_fixing_overcharge_calculatorInputs } from './types';

export function validateInputs(inputs: price_fixing_overcharge_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
