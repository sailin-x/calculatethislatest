import { price_fixing_overcharge_calculatorInputs, price_fixing_overcharge_calculatorMetrics, price_fixing_overcharge_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: price_fixing_overcharge_calculatorInputs): number {
...
export function generateAnalysis(inputs: price_fixing_overcharge_calculatorInputs, metrics: price_fixing_overcharge_calculatorMetrics): price_fixing_overcharge_calculatorAnalysis {
