import { crypto_stakingCalculatorInputs, crypto_stakingCalculatorMetrics, crypto_stakingCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: crypto_stakingCalculatorInputs): number {
...
export function generateAnalysis(inputs: crypto_stakingCalculatorInputs, metrics: crypto_stakingCalculatorMetrics): crypto_stakingCalculatorAnalysis {
