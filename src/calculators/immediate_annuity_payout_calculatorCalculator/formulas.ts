import { immediate_annuity_payout_calculatorCalculatorInputs, immediate_annuity_payout_calculatorCalculatorMetrics, immediate_annuity_payout_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: immediate_annuity_payout_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: immediate_annuity_payout_calculatorCalculatorInputs, metrics: immediate_annuity_payout_calculatorCalculatorMetrics): immediate_annuity_payout_calculatorCalculatorAnalysis {
