import { registerCarLoanCalculatorInputs, registerCarLoanCalculatorMetrics, registerCarLoanCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerCarLoanCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerCarLoanCalculatorInputs, metrics: registerCarLoanCalculatorMetrics): registerCarLoanCalculatorAnalysis {
