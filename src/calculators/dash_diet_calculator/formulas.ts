import { dash_diet_calculatorInputs, dash_diet_calculatorMetrics, dash_diet_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: dash_diet_calculatorInputs): number {
...
export function generateAnalysis(inputs: dash_diet_calculatorInputs, metrics: dash_diet_calculatorMetrics): dash_diet_calculatorAnalysis {
