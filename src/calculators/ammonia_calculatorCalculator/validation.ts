import { ammonia_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: ammonia_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
