import { ammonia_calculatorCalculatorInputs, ammonia_calculatorCalculatorMetrics, ammonia_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: ammonia_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: ammonia_calculatorCalculatorInputs, metrics: ammonia_calculatorCalculatorMetrics): ammonia_calculatorCalculatorAnalysis {
