import { landscaping_cost_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: landscaping_cost_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
