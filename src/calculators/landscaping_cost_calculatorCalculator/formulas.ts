import { landscaping_cost_calculatorCalculatorInputs, landscaping_cost_calculatorCalculatorMetrics, landscaping_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: landscaping_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: landscaping_cost_calculatorCalculatorInputs, metrics: landscaping_cost_calculatorCalculatorMetrics): landscaping_cost_calculatorCalculatorAnalysis {
