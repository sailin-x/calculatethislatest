import { stop_loss_insurance_calculatorInputs, stop_loss_insurance_calculatorMetrics, stop_loss_insurance_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: stop_loss_insurance_calculatorInputs): number {
...
export function generateAnalysis(inputs: stop_loss_insurance_calculatorInputs, metrics: stop_loss_insurance_calculatorMetrics): stop_loss_insurance_calculatorAnalysis {
