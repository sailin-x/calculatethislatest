import { stop_loss_insurance_calculatorInputs } from './types';

export function validateInputs(inputs: stop_loss_insurance_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
