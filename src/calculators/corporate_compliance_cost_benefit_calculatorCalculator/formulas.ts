import { corporate_compliance_cost_benefit_calculatorCalculatorInputs, corporate_compliance_cost_benefit_calculatorCalculatorMetrics, corporate_compliance_cost_benefit_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: corporate_compliance_cost_benefit_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: corporate_compliance_cost_benefit_calculatorCalculatorInputs, metrics: corporate_compliance_cost_benefit_calculatorCalculatorMetrics): corporate_compliance_cost_benefit_calculatorCalculatorAnalysis {
