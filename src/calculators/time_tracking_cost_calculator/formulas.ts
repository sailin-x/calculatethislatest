import { time_tracking_cost_calculatorInputs, time_tracking_cost_calculatorMetrics, time_tracking_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: time_tracking_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: time_tracking_cost_calculatorInputs, metrics: time_tracking_cost_calculatorMetrics): time_tracking_cost_calculatorAnalysis {
