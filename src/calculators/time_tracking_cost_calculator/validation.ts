import { time_tracking_cost_calculatorInputs } from './types';

export function validateInputs(inputs: time_tracking_cost_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
