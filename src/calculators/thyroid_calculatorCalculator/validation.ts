import { thyroid_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: thyroid_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
