import { out_of_home_oh_advertising_roi_calculatorInputs } from './types';

export function validateInputs(inputs: out_of_home_oh_advertising_roi_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
