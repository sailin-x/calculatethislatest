import { maximum_drawdown_calculatorInputs, maximum_drawdown_calculatorMetrics, maximum_drawdown_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: maximum_drawdown_calculatorInputs): number {
...
export function generateAnalysis(inputs: maximum_drawdown_calculatorInputs, metrics: maximum_drawdown_calculatorMetrics): maximum_drawdown_calculatorAnalysis {
