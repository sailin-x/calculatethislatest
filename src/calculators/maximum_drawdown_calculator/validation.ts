import { maximum_drawdown_calculatorInputs } from './types';

export function validateInputs(inputs: maximum_drawdown_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
