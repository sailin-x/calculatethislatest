import { jumbo_loanCalculatorInputs, jumbo_loanCalculatorMetrics, jumbo_loanCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: jumbo_loanCalculatorInputs): number {
...
export function generateAnalysis(inputs: jumbo_loanCalculatorInputs, metrics: jumbo_loanCalculatorMetrics): jumbo_loanCalculatorAnalysis {
