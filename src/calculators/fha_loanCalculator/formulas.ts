import { fha_loanCalculatorInputs, fha_loanCalculatorMetrics, fha_loanCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: fha_loanCalculatorInputs): number {
...
export function generateAnalysis(inputs: fha_loanCalculatorInputs, metrics: fha_loanCalculatorMetrics): fha_loanCalculatorAnalysis {
