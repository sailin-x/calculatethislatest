import { financial_reporting_calculatorInputs, financial_reporting_calculatorMetrics, financial_reporting_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_reporting_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_reporting_calculatorInputs, metrics: financial_reporting_calculatorMetrics): financial_reporting_calculatorAnalysis {
