import { financial_reporting_calculatorInputs } from './types';

export function validateInputs(inputs: financial_reporting_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
