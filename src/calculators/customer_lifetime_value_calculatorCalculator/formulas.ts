import { customer_lifetime_value_calculatorCalculatorInputs, customer_lifetime_value_calculatorCalculatorMetrics, customer_lifetime_value_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: customer_lifetime_value_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: customer_lifetime_value_calculatorCalculatorInputs, metrics: customer_lifetime_value_calculatorCalculatorMetrics): customer_lifetime_value_calculatorCalculatorAnalysis {
