import { portfolio_optimization_calculatorCalculatorInputs, portfolio_optimization_calculatorCalculatorMetrics, portfolio_optimization_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: portfolio_optimization_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: portfolio_optimization_calculatorCalculatorInputs, metrics: portfolio_optimization_calculatorCalculatorMetrics): portfolio_optimization_calculatorCalculatorAnalysis {
