import { government_contract_bid_no_bid_decision_calculatorCalculatorInputs, government_contract_bid_no_bid_decision_calculatorCalculatorMetrics, government_contract_bid_no_bid_decision_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: government_contract_bid_no_bid_decision_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: government_contract_bid_no_bid_decision_calculatorCalculatorInputs, metrics: government_contract_bid_no_bid_decision_calculatorCalculatorMetrics): government_contract_bid_no_bid_decision_calculatorCalculatorAnalysis {
