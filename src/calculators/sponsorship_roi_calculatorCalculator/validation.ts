import { sponsorship_roi_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: sponsorship_roi_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
