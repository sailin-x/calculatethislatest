import { sponsorship_roi_calculatorCalculatorInputs, sponsorship_roi_calculatorCalculatorMetrics, sponsorship_roi_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: sponsorship_roi_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: sponsorship_roi_calculatorCalculatorInputs, metrics: sponsorship_roi_calculatorCalculatorMetrics): sponsorship_roi_calculatorCalculatorAnalysis {
