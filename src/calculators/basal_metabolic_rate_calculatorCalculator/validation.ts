import { basal_metabolic_rate_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: basal_metabolic_rate_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
