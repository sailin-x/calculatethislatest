import { basal_metabolic_rate_calculatorCalculatorInputs, basal_metabolic_rate_calculatorCalculatorMetrics, basal_metabolic_rate_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: basal_metabolic_rate_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: basal_metabolic_rate_calculatorCalculatorInputs, metrics: basal_metabolic_rate_calculatorCalculatorMetrics): basal_metabolic_rate_calculatorCalculatorAnalysis {
