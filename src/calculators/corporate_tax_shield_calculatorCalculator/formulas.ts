import { corporate_tax_shield_calculatorCalculatorInputs, corporate_tax_shield_calculatorCalculatorMetrics, corporate_tax_shield_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: corporate_tax_shield_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: corporate_tax_shield_calculatorCalculatorInputs, metrics: corporate_tax_shield_calculatorCalculatorMetrics): corporate_tax_shield_calculatorCalculatorAnalysis {
