import { corporate_tax_shield_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: corporate_tax_shield_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
