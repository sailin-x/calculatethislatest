import { earthquake_insuranceCalculatorInputs, earthquake_insuranceCalculatorMetrics, earthquake_insuranceCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: earthquake_insuranceCalculatorInputs): number {
...
export function generateAnalysis(inputs: earthquake_insuranceCalculatorInputs, metrics: earthquake_insuranceCalculatorMetrics): earthquake_insuranceCalculatorAnalysis {
