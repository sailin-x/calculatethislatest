import { earthquake_insuranceCalculatorInputs } from './types';

export function validateInputs(inputs: earthquake_insuranceCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
