import { comprehensiveMortgageCalculatorInputs, comprehensiveMortgageCalculatorMetrics, comprehensiveMortgageCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: comprehensiveMortgageCalculatorInputs): number {
...
export function generateAnalysis(inputs: comprehensiveMortgageCalculatorInputs, metrics: comprehensiveMortgageCalculatorMetrics): comprehensiveMortgageCalculatorAnalysis {
