import { comprehensiveMortgageCalculatorInputs } from './types';

export function validateInputs(inputs: comprehensiveMortgageCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
