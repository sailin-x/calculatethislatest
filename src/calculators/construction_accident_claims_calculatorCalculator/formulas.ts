import { construction_accident_claims_calculatorCalculatorInputs, construction_accident_claims_calculatorCalculatorMetrics, construction_accident_claims_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: construction_accident_claims_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: construction_accident_claims_calculatorCalculatorInputs, metrics: construction_accident_claims_calculatorCalculatorMetrics): construction_accident_claims_calculatorCalculatorAnalysis {
