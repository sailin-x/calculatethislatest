import { out_of_home_ooh_advertising_roi_calculatorInputs, out_of_home_ooh_advertising_roi_calculatorMetrics, out_of_home_ooh_advertising_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: out_of_home_ooh_advertising_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: out_of_home_ooh_advertising_roi_calculatorInputs, metrics: out_of_home_ooh_advertising_roi_calculatorMetrics): out_of_home_ooh_advertising_roi_calculatorAnalysis {
