import { income_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: income_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
