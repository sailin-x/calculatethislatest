import { income_calculatorCalculatorInputs, income_calculatorCalculatorMetrics, income_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: income_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: income_calculatorCalculatorInputs, metrics: income_calculatorCalculatorMetrics): income_calculatorCalculatorAnalysis {
