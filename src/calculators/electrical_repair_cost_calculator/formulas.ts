import { electrical_repair_cost_calculatorInputs, electrical_repair_cost_calculatorMetrics, electrical_repair_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: electrical_repair_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: electrical_repair_cost_calculatorInputs, metrics: electrical_repair_cost_calculatorMetrics): electrical_repair_cost_calculatorAnalysis {
