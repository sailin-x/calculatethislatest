import { personal_trainer_cost_calculatorCalculatorInputs, personal_trainer_cost_calculatorCalculatorMetrics, personal_trainer_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: personal_trainer_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: personal_trainer_cost_calculatorCalculatorInputs, metrics: personal_trainer_cost_calculatorCalculatorMetrics): personal_trainer_cost_calculatorCalculatorAnalysis {
