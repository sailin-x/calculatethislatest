import { bad_faith_insurance_claim_calculatorInputs, bad_faith_insurance_claim_calculatorMetrics, bad_faith_insurance_claim_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: bad_faith_insurance_claim_calculatorInputs): number {
...
export function generateAnalysis(inputs: bad_faith_insurance_claim_calculatorInputs, metrics: bad_faith_insurance_claim_calculatorMetrics): bad_faith_insurance_claim_calculatorAnalysis {
