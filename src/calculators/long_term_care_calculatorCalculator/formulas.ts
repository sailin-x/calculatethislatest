import { long_term_care_calculatorCalculatorInputs, long_term_care_calculatorCalculatorMetrics, long_term_care_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: long_term_care_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: long_term_care_calculatorCalculatorInputs, metrics: long_term_care_calculatorCalculatorMetrics): long_term_care_calculatorCalculatorAnalysis {
