import { long_term_care_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: long_term_care_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
