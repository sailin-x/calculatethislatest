import { collateralization_ratio_calculatorCalculatorInputs, collateralization_ratio_calculatorCalculatorMetrics, collateralization_ratio_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: collateralization_ratio_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: collateralization_ratio_calculatorCalculatorInputs, metrics: collateralization_ratio_calculatorCalculatorMetrics): collateralization_ratio_calculatorCalculatorAnalysis {
