import { required_minimum_distribution_rmd_calculatorInputs, required_minimum_distribution_rmd_calculatorMetrics, required_minimum_distribution_rmd_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: required_minimum_distribution_rmd_calculatorInputs): number {
...
export function generateAnalysis(inputs: required_minimum_distribution_rmd_calculatorInputs, metrics: required_minimum_distribution_rmd_calculatorMetrics): required_minimum_distribution_rmd_calculatorAnalysis {
