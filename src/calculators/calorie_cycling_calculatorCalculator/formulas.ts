import { calorie_cycling_calculatorCalculatorInputs, calorie_cycling_calculatorCalculatorMetrics, calorie_cycling_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: calorie_cycling_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: calorie_cycling_calculatorCalculatorInputs, metrics: calorie_cycling_calculatorCalculatorMetrics): calorie_cycling_calculatorCalculatorAnalysis {
