import { calorie_cycling_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: calorie_cycling_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
