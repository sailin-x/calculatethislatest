import { self_storage_facility_roi_calculatorInputs } from './types';

export function validateInputs(inputs: self_storage_facility_roi_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
