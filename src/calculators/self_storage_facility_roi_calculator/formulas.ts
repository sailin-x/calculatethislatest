import { self_storage_facility_roi_calculatorInputs, self_storage_facility_roi_calculatorMetrics, self_storage_facility_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: self_storage_facility_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: self_storage_facility_roi_calculatorInputs, metrics: self_storage_facility_roi_calculatorMetrics): self_storage_facility_roi_calculatorAnalysis {
