import { passport_cost_calculatorCalculatorInputs, passport_cost_calculatorCalculatorMetrics, passport_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: passport_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: passport_cost_calculatorCalculatorInputs, metrics: passport_cost_calculatorCalculatorMetrics): passport_cost_calculatorCalculatorAnalysis {
