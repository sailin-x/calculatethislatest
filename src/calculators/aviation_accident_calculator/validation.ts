import { aviation_accident_calculatorInputs } from './types';

export function validateInputs(inputs: aviation_accident_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
