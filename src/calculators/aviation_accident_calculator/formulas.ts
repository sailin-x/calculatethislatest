import { aviation_accident_calculatorInputs, aviation_accident_calculatorMetrics, aviation_accident_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: aviation_accident_calculatorInputs): number {
...
export function generateAnalysis(inputs: aviation_accident_calculatorInputs, metrics: aviation_accident_calculatorMetrics): aviation_accident_calculatorAnalysis {
