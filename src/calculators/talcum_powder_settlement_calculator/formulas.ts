import { talcum_powder_settlement_calculatorInputs, talcum_powder_settlement_calculatorMetrics, talcum_powder_settlement_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: talcum_powder_settlement_calculatorInputs): number {
...
export function generateAnalysis(inputs: talcum_powder_settlement_calculatorInputs, metrics: talcum_powder_settlement_calculatorMetrics): talcum_powder_settlement_calculatorAnalysis {
