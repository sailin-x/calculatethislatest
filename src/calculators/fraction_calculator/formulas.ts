import { fraction_calculatorInputs, fraction_calculatorMetrics, fraction_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fraction_calculatorInputs): number {
...
export function generateAnalysis(inputs: fraction_calculatorInputs, metrics: fraction_calculatorMetrics): fraction_calculatorAnalysis {
