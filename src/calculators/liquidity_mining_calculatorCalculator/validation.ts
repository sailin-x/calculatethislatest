import { liquidity_mining_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: liquidity_mining_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
