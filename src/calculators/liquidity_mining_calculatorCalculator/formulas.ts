import { liquidity_mining_calculatorCalculatorInputs, liquidity_mining_calculatorCalculatorMetrics, liquidity_mining_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: liquidity_mining_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: liquidity_mining_calculatorCalculatorInputs, metrics: liquidity_mining_calculatorCalculatorMetrics): liquidity_mining_calculatorCalculatorAnalysis {
