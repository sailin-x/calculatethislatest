import { financial_security_calculatorInputs } from './types';

export function validateInputs(inputs: financial_security_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
