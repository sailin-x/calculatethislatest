import { financial_security_calculatorInputs, financial_security_calculatorMetrics, financial_security_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_security_calculatorInputs): number {
...
export function generateAnalysis(inputs: financial_security_calculatorInputs, metrics: financial_security_calculatorMetrics): financial_security_calculatorAnalysis {
