import { credit_utilization_calculatorInputs, credit_utilization_calculatorMetrics, credit_utilization_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: credit_utilization_calculatorInputs): number {
...
export function generateAnalysis(inputs: credit_utilization_calculatorInputs, metrics: credit_utilization_calculatorMetrics): credit_utilization_calculatorAnalysis {
