import { aiops_implementation_savings_calculatorInputs } from './types';

export function validateInputs(inputs: aiops_implementation_savings_calculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
