import { financial_wellness_calculatorCalculatorInputs, financial_wellness_calculatorCalculatorMetrics, financial_wellness_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_wellness_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_wellness_calculatorCalculatorInputs, metrics: financial_wellness_calculatorCalculatorMetrics): financial_wellness_calculatorCalculatorAnalysis {
