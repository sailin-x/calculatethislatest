import { affiliate_marketing_roi_calculatorInputs, affiliate_marketing_roi_calculatorMetrics, affiliate_marketing_roi_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: affiliate_marketing_roi_calculatorInputs): number {
...
export function generateAnalysis(inputs: affiliate_marketing_roi_calculatorInputs, metrics: affiliate_marketing_roi_calculatorMetrics): affiliate_marketing_roi_calculatorAnalysis {
