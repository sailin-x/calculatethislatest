import { alimony_calculatorCalculatorInputs } from './types';

export function validateInputs(inputs: alimony_calculatorCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
