import { alimony_calculatorCalculatorInputs, alimony_calculatorCalculatorMetrics, alimony_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: alimony_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: alimony_calculatorCalculatorInputs, metrics: alimony_calculatorCalculatorMetrics): alimony_calculatorCalculatorAnalysis {
