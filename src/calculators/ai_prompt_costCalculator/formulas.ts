import { ai_prompt_costCalculatorInputs, ai_prompt_costCalculatorMetrics, ai_prompt_costCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: ai_prompt_costCalculatorInputs): number {
...
export function generateAnalysis(inputs: ai_prompt_costCalculatorInputs, metrics: ai_prompt_costCalculatorMetrics): ai_prompt_costCalculatorAnalysis {
