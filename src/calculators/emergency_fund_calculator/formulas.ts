import { emergency_fund_calculatorInputs, emergency_fund_calculatorMetrics, emergency_fund_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: emergency_fund_calculatorInputs): number {
...
export function generateAnalysis(inputs: emergency_fund_calculatorInputs, metrics: emergency_fund_calculatorMetrics): emergency_fund_calculatorAnalysis {
