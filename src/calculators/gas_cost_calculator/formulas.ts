import { gas_cost_calculatorInputs, gas_cost_calculatorMetrics, gas_cost_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: gas_cost_calculatorInputs): number {
...
export function generateAnalysis(inputs: gas_cost_calculatorInputs, metrics: gas_cost_calculatorMetrics): gas_cost_calculatorAnalysis {
