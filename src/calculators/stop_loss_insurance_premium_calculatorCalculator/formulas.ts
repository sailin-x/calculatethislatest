import { stop_loss_insurance_premium_calculatorCalculatorInputs, stop_loss_insurance_premium_calculatorCalculatorMetrics, stop_loss_insurance_premium_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: stop_loss_insurance_premium_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: stop_loss_insurance_premium_calculatorCalculatorInputs, metrics: stop_loss_insurance_premium_calculatorCalculatorMetrics): stop_loss_insurance_premium_calculatorCalculatorAnalysis {
