...
export const HeartRateZone-calculator: Calculator = {
  ...
  description: 'Calculate Heart Rate Zone Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Heart Rate Zone Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Heart Rate Zone Calculator calculation',
