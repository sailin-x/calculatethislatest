import { hardness-calculatorInputs, hardness-calculatorMetrics, hardness-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: hardness-calculatorInputs): number {
...
export function generateAnalysis(inputs: hardness-calculatorInputs, metrics: hardness-calculatorMetrics): hardness-calculatorAnalysis {
