import { dental_implant_roi_calculatorInputs } from './types';
...
export function validatedental_implant_roi_calculatorInputs(inputs: dental_implant_roi_calculatorInputs): ValidationResult[] {
...
export function validatedental_implant_roi_calculatorBusinessRules(inputs: dental_implant_roi_calculatorInputs): ValidationResult[] {
