import { heart-rate-variability-calculatorInputs, heart-rate-variability-calculatorMetrics, heart-rate-variability-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: heart-rate-variability-calculatorInputs): number {
...
export function generateAnalysis(inputs: heart-rate-variability-calculatorInputs, metrics: heart-rate-variability-calculatorMetrics): heart-rate-variability-calculatorAnalysis {
