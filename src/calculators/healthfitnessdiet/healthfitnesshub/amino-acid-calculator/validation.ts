import { amino_acid_calculatorInputs } from './types';
...
export function validateamino_acid_calculatorInputs(inputs: amino_acid_calculatorInputs): ValidationResult[] {
...
export function validateamino_acid_calculatorBusinessRules(inputs: amino_acid_calculatorInputs): ValidationResult[] {
