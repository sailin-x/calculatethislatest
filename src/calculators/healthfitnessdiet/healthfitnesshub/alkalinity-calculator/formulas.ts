import { alkalinity-calculatorInputs, alkalinity-calculatorMetrics, alkalinity-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: alkalinity-calculatorInputs): number {
...
export function generateAnalysis(inputs: alkalinity-calculatorInputs, metrics: alkalinity-calculatorMetrics): alkalinity-calculatorAnalysis {
