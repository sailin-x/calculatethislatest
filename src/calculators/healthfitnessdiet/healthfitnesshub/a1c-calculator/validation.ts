import { a1c_calculatorInputs } from './types';
...
export function validatea1c_calculatorInputs(inputs: a1c_calculatorInputs): ValidationResult[] {
...
export function validatea1c_calculatorBusinessRules(inputs: a1c_calculatorInputs): ValidationResult[] {
