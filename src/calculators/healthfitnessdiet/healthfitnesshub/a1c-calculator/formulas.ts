import { a1c-calculatorInputs, a1c-calculatorMetrics, a1c-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: a1c-calculatorInputs): number {
...
export function generateAnalysis(inputs: a1c-calculatorInputs, metrics: a1c-calculatorMetrics): a1c-calculatorAnalysis {
