import { glycemic_index_calculatorInputs } from './types';
...
export function validateglycemic_index_calculatorInputs(inputs: glycemic_index_calculatorInputs): ValidationResult[] {
...
export function validateglycemic_index_calculatorBusinessRules(inputs: glycemic_index_calculatorInputs): ValidationResult[] {
