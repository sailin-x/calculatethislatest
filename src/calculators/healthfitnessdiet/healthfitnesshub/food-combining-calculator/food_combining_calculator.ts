...
export const food_combining_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Food Combining Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Food Combining Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Food Combining Calculator calculation',
