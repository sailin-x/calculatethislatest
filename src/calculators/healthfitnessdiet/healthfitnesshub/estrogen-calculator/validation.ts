import { estrogen_calculatorInputs } from './types';
...
export function validateestrogen_calculatorInputs(inputs: estrogen_calculatorInputs): ValidationResult[] {
...
export function validateestrogen_calculatorBusinessRules(inputs: estrogen_calculatorInputs): ValidationResult[] {
