import { body_fat_calculatorInputs } from './types';
...
export function validatebody_fat_calculatorInputs(inputs: body_fat_calculatorInputs): ValidationResult[] {
...
export function validatebody_fat_calculatorBusinessRules(inputs: body_fat_calculatorInputs): ValidationResult[] {
