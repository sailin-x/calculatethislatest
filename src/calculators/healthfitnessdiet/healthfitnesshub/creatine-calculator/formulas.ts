import { creatine-calculatorInputs, creatine-calculatorMetrics, creatine-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: creatine-calculatorInputs): number {
...
export function generateAnalysis(inputs: creatine-calculatorInputs, metrics: creatine-calculatorMetrics): creatine-calculatorAnalysis {
