...
export const creatine_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Creatine Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Creatine Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Creatine Calculator calculation',
