import { chlorine-calculatorInputs, chlorine-calculatorMetrics, chlorine-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: chlorine-calculatorInputs): number {
...
export function generateAnalysis(inputs: chlorine-calculatorInputs, metrics: chlorine-calculatorMetrics): chlorine-calculatorAnalysis {
