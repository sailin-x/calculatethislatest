...
export const chlorine_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Chlorine Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Chlorine Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Chlorine Calculator calculation',
