import { body_surface_area_calculatorInputs } from './types';
...
export function validatebody_surface_area_calculatorInputs(inputs: body_surface_area_calculatorInputs): ValidationResult[] {
...
export function validatebody_surface_area_calculatorBusinessRules(inputs: body_surface_area_calculatorInputs): ValidationResult[] {
