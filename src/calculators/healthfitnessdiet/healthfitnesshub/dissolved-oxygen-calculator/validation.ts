import { dissolved_oxygen_calculatorInputs } from './types';
...
export function validatedissolved_oxygen_calculatorInputs(inputs: dissolved_oxygen_calculatorInputs): ValidationResult[] {
...
export function validatedissolved_oxygen_calculatorBusinessRules(inputs: dissolved_oxygen_calculatorInputs): ValidationResult[] {
