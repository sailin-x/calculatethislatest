import { blood_pressure_calculatorInputs } from './types';
...
export function validateblood_pressure_calculatorInputs(inputs: blood_pressure_calculatorInputs): ValidationResult[] {
...
export function validateblood_pressure_calculatorBusinessRules(inputs: blood_pressure_calculatorInputs): ValidationResult[] {
