...
export const blood_pressure_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Blood Pressure Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Blood Pressure Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Blood Pressure Calculator calculation',
