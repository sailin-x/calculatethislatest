...
export const CalorieCyclingCalculator: Calculator = {
  ...
  description: 'Calculate Calorie Cycling Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Calorie Cycling Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Calorie Cycling Calculator calculation',
