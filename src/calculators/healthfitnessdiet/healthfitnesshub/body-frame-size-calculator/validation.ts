import { body_frame_size_calculatorInputs } from './types';
...
export function validatebody_frame_size_calculatorInputs(inputs: body_frame_size_calculatorInputs): ValidationResult[] {
...
export function validatebody_frame_size_calculatorBusinessRules(inputs: body_frame_size_calculatorInputs): ValidationResult[] {
