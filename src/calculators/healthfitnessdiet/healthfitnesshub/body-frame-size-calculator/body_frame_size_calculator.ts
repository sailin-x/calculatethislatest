...
export const BodyFrameSize-calculator: Calculator = {
  ...
  description: 'Calculate Body Frame Size Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Body Frame Size Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Body Frame Size Calculator calculation',
