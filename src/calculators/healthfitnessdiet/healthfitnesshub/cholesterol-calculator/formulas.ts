import { cholesterol-calculatorInputs, cholesterol-calculatorMetrics, cholesterol-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: cholesterol-calculatorInputs): number {
...
export function generateAnalysis(inputs: cholesterol-calculatorInputs, metrics: cholesterol-calculatorMetrics): cholesterol-calculatorAnalysis {
