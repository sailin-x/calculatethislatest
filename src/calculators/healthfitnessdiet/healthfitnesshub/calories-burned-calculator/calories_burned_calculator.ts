...
export const calories_burned_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate Calories Burned Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Calories Burned Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Calories Burned Calculator calculation',
