import { ammonia-calculatorInputs, ammonia-calculatorMetrics, ammonia-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: ammonia-calculatorInputs): number {
...
export function generateAnalysis(inputs: ammonia-calculatorInputs, metrics: ammonia-calculatorMetrics): ammonia-calculatorAnalysis {
