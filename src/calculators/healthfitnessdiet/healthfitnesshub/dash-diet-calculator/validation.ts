import { dash_diet_calculatorInputs } from './types';
...
export function validatedash_diet_calculatorInputs(inputs: dash_diet_calculatorInputs): ValidationResult[] {
...
export function validatedash_diet_calculatorBusinessRules(inputs: dash_diet_calculatorInputs): ValidationResult[] {
