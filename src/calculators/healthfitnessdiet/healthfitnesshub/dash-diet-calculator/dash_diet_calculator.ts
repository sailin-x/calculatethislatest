...
export const dash_diet_calculatorCalculator: Calculator = {
  ...
  description: 'Calculate DASH Diet Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your DASH Diet Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic DASH Diet Calculator calculation',
