import { baking_calculatorInputs } from './types';
...
export function validatebaking_calculatorInputs(inputs: baking_calculatorInputs): ValidationResult[] {
...
export function validatebaking_calculatorBusinessRules(inputs: baking_calculatorInputs): ValidationResult[] {
