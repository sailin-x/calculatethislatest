import { DrugRoyaltyRate-calculatorInputs, DrugRoyaltyRate-calculatorMetrics, DrugRoyaltyRate-calculatorAnalysis } from './types';
...
export function calculateResult(inputs: DrugRoyaltyRate-calculatorInputs): number {
...
export function generateAnalysis(inputs: DrugRoyaltyRate-calculatorInputs, metrics: DrugRoyaltyRate-calculatorMetrics): DrugRoyaltyRate-calculatorAnalysis {
