import { calorie_deficit_calculatorInputs } from './types';
...
export function validatecalorie_deficit_calculatorInputs(inputs: calorie_deficit_calculatorInputs): ValidationResult[] {
...
export function validatecalorie_deficit_calculatorBusinessRules(inputs: calorie_deficit_calculatorInputs): ValidationResult[] {
