...
export const CalorieDeficitCalculator: Calculator = {
  ...
  description: 'Calculate Calorie Deficit Calculator metrics with professional accuracy.',
  usageInstructions: [
    'Enter your Calorie Deficit Calculator parameters',
  ...
  examples: [
    {
      ...
      description: 'Basic Calorie Deficit Calculator calculation',
