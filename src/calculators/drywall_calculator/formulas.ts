import { drywall_calculatorInputs, drywall_calculatorMetrics, drywall_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: drywall_calculatorInputs): number {
...
export function generateAnalysis(inputs: drywall_calculatorInputs, metrics: drywall_calculatorMetrics): drywall_calculatorAnalysis {
