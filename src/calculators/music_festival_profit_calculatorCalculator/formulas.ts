import { music_festival_profit_calculatorCalculatorInputs, music_festival_profit_calculatorCalculatorMetrics, music_festival_profit_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: music_festival_profit_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: music_festival_profit_calculatorCalculatorInputs, metrics: music_festival_profit_calculatorCalculatorMetrics): music_festival_profit_calculatorCalculatorAnalysis {
