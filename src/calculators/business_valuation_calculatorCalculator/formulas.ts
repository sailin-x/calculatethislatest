import { business_valuation_calculatorCalculatorInputs, business_valuation_calculatorCalculatorMetrics, business_valuation_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: business_valuation_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: business_valuation_calculatorCalculatorInputs, metrics: business_valuation_calculatorCalculatorMetrics): business_valuation_calculatorCalculatorAnalysis {
