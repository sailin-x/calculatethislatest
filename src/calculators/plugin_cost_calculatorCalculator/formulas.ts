import { plugin_cost_calculatorCalculatorInputs, plugin_cost_calculatorCalculatorMetrics, plugin_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: plugin_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: plugin_cost_calculatorCalculatorInputs, metrics: plugin_cost_calculatorCalculatorMetrics): plugin_cost_calculatorCalculatorAnalysis {
