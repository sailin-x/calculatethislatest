import { parking_cost_calculatorCalculatorInputs, parking_cost_calculatorCalculatorMetrics, parking_cost_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: parking_cost_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: parking_cost_calculatorCalculatorInputs, metrics: parking_cost_calculatorCalculatorMetrics): parking_cost_calculatorCalculatorAnalysis {
