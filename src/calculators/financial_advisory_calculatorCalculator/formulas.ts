import { financial_advisory_calculatorCalculatorInputs, financial_advisory_calculatorCalculatorMetrics, financial_advisory_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: financial_advisory_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: financial_advisory_calculatorCalculatorInputs, metrics: financial_advisory_calculatorCalculatorMetrics): financial_advisory_calculatorCalculatorAnalysis {
