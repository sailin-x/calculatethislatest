import { registerEquityValuationCalculatorInputs, registerEquityValuationCalculatorMetrics, registerEquityValuationCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: registerEquityValuationCalculatorInputs): number {
...
export function generateAnalysis(inputs: registerEquityValuationCalculatorInputs, metrics: registerEquityValuationCalculatorMetrics): registerEquityValuationCalculatorAnalysis {
