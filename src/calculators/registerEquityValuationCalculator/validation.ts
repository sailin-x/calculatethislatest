import { registerEquityValuationCalculatorInputs } from './types';

export function validateInputs(inputs: registerEquityValuationCalculatorInputs): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
