import { marketing_attribution_model_comparison_calculatorCalculatorInputs, marketing_attribution_model_comparison_calculatorCalculatorMetrics, marketing_attribution_model_comparison_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: marketing_attribution_model_comparison_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: marketing_attribution_model_comparison_calculatorCalculatorInputs, metrics: marketing_attribution_model_comparison_calculatorCalculatorMetrics): marketing_attribution_model_comparison_calculatorCalculatorAnalysis {
