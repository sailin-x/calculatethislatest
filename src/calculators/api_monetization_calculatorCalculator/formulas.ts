import { api_monetization_calculatorCalculatorInputs, api_monetization_calculatorCalculatorMetrics, api_monetization_calculatorCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: api_monetization_calculatorCalculatorInputs): number {
...
export function generateAnalysis(inputs: api_monetization_calculatorCalculatorInputs, metrics: api_monetization_calculatorCalculatorMetrics): api_monetization_calculatorCalculatorAnalysis {
