import { fertilizer_calculatorInputs, fertilizer_calculatorMetrics, fertilizer_calculatorAnalysis } from './types';
...
export function calculateResult(inputs: fertilizer_calculatorInputs): number {
...
export function generateAnalysis(inputs: fertilizer_calculatorInputs, metrics: fertilizer_calculatorMetrics): fertilizer_calculatorAnalysis {
