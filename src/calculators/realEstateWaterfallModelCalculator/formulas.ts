import { realEstateWaterfallModelCalculatorInputs, realEstateWaterfallModelCalculatorMetrics, realEstateWaterfallModelCalculatorAnalysis } from './types';
...
export function calculateResult(inputs: realEstateWaterfallModelCalculatorInputs): number {
...
export function generateAnalysis(inputs: realEstateWaterfallModelCalculatorInputs, metrics: realEstateWaterfallModelCalculatorMetrics): realEstateWaterfallModelCalculatorAnalysis {
